...
public class LuckyMoneyHelper extends RomUpdateHelper {
    ...
    private static final boolean IS_OVERSEA_VERSION = SystemProperties.get("ro.oppo.version", "CN").equalsIgnoreCase("US");
    ...
    private class LuckyMoneyUpdateInfo extends RomUpdateHelper.UpdateInfo {
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:25:0x00a5 */
        ...
        /* JADX INFO: Multiple debug info for r8v50 'hbWidths'  java.util.ArrayList<java.lang.Integer>: [D('hbWidths' java.util.ArrayList<java.lang.Integer>), D('appType' int)] */
                    ...
                    while (true) {
                        ...
                        if (eventType3 != 1) {
                                        ...
                                        try {
                                            ...
                                            if (r11.equals(startName)) {
                                                try {
                                                    ...
                                                    hbText = hbText2;
                                                    hbLayout = hbLayout2;
                                                    hbLayoutNodes = hbLayoutNodes2;
                                                    receiverClass2 = receiverClass;
                                                    keyURLinfo3 = chatView;
                                                ...
                                                if (Contacts.ContactMethods.ProviderNames.QQ.equals(startName)) {
                                                    ...
                                                    try {
                                                        if (VERSIONINFO.equals(startName)) {
                                                            ...
                                                            parser.next();
                                                            keyDNSinfo3 = parser.getText();
                                                            appVersionItems2 = appVersionItems;
                                                            openHbActivity = openHbActivity2;
                                                            chatView2 = chatView;
                                                        } else if ("chatView".equals(startName)) {
                                                            parser.next();
                                                            chatView2 = parser.getText();
                                                            appVersionItems2 = appVersionItems;
                                                            openHbActivity = openHbActivity2;
                                                            keyDNSinfo3 = keyDNSinfo;
                                                            ...
                                                            try {
                                                                if (TAG_MM_VERSION.equals(startName)) {
                                                                    ...
                                                                    try {
                                                                        int end4 = Integer.parseInt(parser.getAttributeValue(null, "end"));
                                                                        try {
                                                                            start3 = versionMap.getOrDefault(Integer.valueOf(start3), Integer.valueOf(start3)).intValue();
                                                                            end = versionMap.getOrDefault(Integer.valueOf(end4), Integer.valueOf(end4)).intValue();
                                                                    ...
                                                                    int modeId2 = Integer.parseInt(parser.getAttributeValue(null, "id"));
                                                                    try {
                                                                        int modeEnable2 = Integer.parseInt(parser.getAttributeValue(null, "enable"));
                                                                        try {
                                                                            ArrayList<String> hbHashs5 = new ArrayList<>();
                                                                            try {
                                                                                hbWidths3 = new ArrayList<>();
                                                                                try {
                                                                                    modeEnable = modeEnable2;
                                                                                    openHbActivity = openHbActivity2;
                                                                                    hbHashs4 = hbHashs5;
                                                                                    modeId = modeId2;
                                                                                    hbWidths4 = hbWidths3;
                                                                    ...
                                                                    try {
                                                                        if ("hb_text".equals(startName)) {
                                                                            ...
                                                                            String hbLayoutNodes3 = parser.getAttributeValue(null, "nodes");
                                                                            try {
                                                                                parser.next();
                                        ...
                                        if ("Mode".equals(endName)) {
                                            if (luckMoneyMode != null) {
                                                try {
                                                    r11 = luckMoneyMode;
                                                    try {
                                                        r11.add(new LuckMoneyMode(modeId, modeEnable, hbHeights3, hbWidths4, hbHashs4, hbText2, hbLayout2, hbLayoutNodes2));
                                                        appVersionItems = appVersionItems2;
                                                        i = eventType3;
                                                        keyURLinfo = keyURLinfo4;
                                                        appType2 = appType;
                                            ...
                                            if (appVersionItems2 != null) {
                                                appVersionItems2.add(new AppVersionItem(defaultMode2, end3, defaultMode3, luckMoneyMode));
                                                appVersionItems = appVersionItems2;
                                                i = eventType3;
                                                keyURLinfo = keyURLinfo4;
                                                appType2 = appType;
                            ...
                            try {
                                ...
                                keyURLinfo2 = keyURLinfo4;
                                appType4 = appType;
                                keyDNSinfo2 = keyDNSinfo3;
                                keyURLinfo3 = chatView2;
                                start = defaultMode2;
                                end = end3;
                                start2 = modeId;
                                end2 = modeEnable;
        ...
        private void parseContentFromXMLInternal(String content) {
            ...
            try {
                ...
                try {
                    ...
                    e2 = e9;
                    Log.e(LuckyMoneyHelper.TAG, "IOException " + e2.toString());
                    if (strReader == null) {
                        strReader.close();
                    }
                    return;
