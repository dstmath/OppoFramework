...
public class DataConstants {
    ...
    public static final int DYNAMIC_EVENT = 10;
    public static final int STATIC_EVENT = 11;
    ...
    public static final int TYPE_PERIOD_DATA = 13;
    public static final int TYPE_SETTING_KEY = 14;
