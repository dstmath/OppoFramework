...
public interface INeuronSystemService extends IInterface {
    ...
    public static class Default implements INeuronSystemService {
        ...
        @Override // com.oppo.neuron.INeuronSystemService
        public void enableRecommendedApps(boolean enable, List<String> list) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INeuronSystemService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                data.enforceInterface(DESCRIPTOR);
                enableRecommendedApps(data.readInt() != 0, data.createStringArrayList());
                reply.writeNoException();
                return true;
            } else if (code == 4) {
                data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements INeuronSystemService {
            ...
            public void enableRecommendedApps(boolean enable, List<String> pkgs) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().enableRecommendedApps(enable, pkgs);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
