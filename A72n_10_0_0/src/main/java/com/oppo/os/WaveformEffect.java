...
public final class WaveformEffect implements Parcelable {
    ...
    public static final int EFFECT_ALARM_NOTIFICATION = 152;
    ...
    private static final int RTP_INDEX_ALARM_NOTIFIACATION = 59;
    ...
    static {
        ...
        WAVEFORM_EFFECT_DURATION.put(152, 11000);
    }
