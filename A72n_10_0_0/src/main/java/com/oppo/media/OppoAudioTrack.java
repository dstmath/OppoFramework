...
public class OppoAudioTrack extends AudioTrack {
    ...
    public OppoAudioTrack(int streamType, int sampleRateInHz, int channelConfig, int audioFormat, int bufferSizeInBytes, int mode, int sessionId) throws IllegalArgumentException {
        ...
        try {
            ...
            this.method_baseSetVolume = clas.getDeclaredMethod("baseSetVolume", Float.TYPE, Float.TYPE);
            ...
            this.method_native_setVolume = cls.getDeclaredMethod("native_setVolume", Float.TYPE, Float.TYPE);
    ...
    public int setStereoVolume(float leftGain, float rightGain) {
        try {
            ...
            this.method_baseSetVolume.invoke(this, Float.valueOf(leftGain), Float.valueOf(rightGain));
            return 0;
        } catch (IllegalArgumentException e) {
            e.printStackTrace();
        } catch (InvocationTargetException e2) {
