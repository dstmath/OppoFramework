...
public class OppoRIL {
    ...
    public static final String ISSUE_SYS_OEM_NW_DIAG_CAUSE_DATA_NODDS_FREQUENT_PAGING = "nodds_lte_frequent_paging";
    ...
    private static final int SYS_MTK_URC_DATA_NODDS_FREQUENT_PAGING = 603;
    ...
    private ArrayList<OppoRILRequest> mRequestsList = new ArrayList<>();
        ...
        try {
            switch (Integer.parseInt(data[0])) {
                ...
                case 89:
                    ...
                    return;
                case SYS_OEM_NW_DIAG_CAUSE_LTE_A2_RELEASE_CELL /* 108 */:
                    if (getValueFromByte(data[1], 0, 1, true) == 1) {
                        CLInfo.type = 210;
                ...
                case 133:
                    ...
                    return;
                case SYS_MTK_URC_TAU_DETACH_SERVICE_REJECT /* 233 */:
                ...
                case SYS_MTK_URC_MT_REJECT /* 256 */:
                    ...
                    return;
                case SYS_MTK_URC_LTE_NARROW_BANDWIDTH_SCELL /* 334 */:
                    if (getValueFromByte(data[1], 0, 1, true) == 1) {
                    ...
                    return;
                case SYS_MTK_URC_PCI_MODE3_INTERFERENCE /* 355 */:
                    if (getValueFromByte(data[1], 0, 1, true) == 1) {
                    ...
                    return;
                case SYS_MTK_URC_LTE_RRC_ABNORMAL_BAR /* 356 */:
                    ...
                    return;
                case SYS_MTK_URC_LTE_HANDOVER_FAILURE /* 357 */:
                ...
                case SYS_MTK_URC_AUTHENTICATION_REJECT /* 395 */:
                    ...
                    return;
                case SYS_MTK_URC_DATA_RLC_UL_RLF /* 400 */:
                    CLInfo.type = 127;
                ...
                case SYS_MTK_URC_LTE_AUTHENTICATION_REJECT /* 628 */:
                    ...
                    return;
                case SYS_MTK_URC_SCREEN_ON_TRIGGER_NW_SRCH /* 659 */:
                    ...
                    return;
                case SYS_MTK_URC_DATA_PDCP_UL_ONE_WAY_PASS /* 947 */:
                    CLInfo.type = 122;
                    ...
                    return;
                case SYS_MTK_URC_DATA_PDCP_UL_TIMEOUT /* 948 */:
                    CLInfo.type = 120;
                    ...
                    return;
                case SYS_MTK_URC_DATA_PDCP_UL_OUT_OF_BUFFER /* 949 */:
                    CLInfo.type = 121;
                    ...
                    return;
                case SYS_MTK_URC_DATA_DL_HIGH_BLER /* 970 */:
                    CLInfo.type = 123;
                    ...
                    return;
                case SYS_MTK_URC_PDP_DEACT_ERROR /* 1018 */:
                    ...
                    return;
                case SYS_MTK_URC_IA_APN_ERROR /* 1019 */:
                    CLInfo.errcode = (getValueFromByte(data[1], 0, 4, true) << 16) | (65535 & getValueFromByte(data[1], 8, 2, true));
                    CLInfo.type = 117;
    ...
    /* JADX INFO: Multiple debug info for r10v2 long: [D('mt_csfb_signal_quality' long), D('errc_rrc_rr_cause' long)] */
    ...
    /* JADX INFO: Multiple debug info for r8v4 long: [D('mt_cs_call_signal_strength' long), D('mt_cs_emm_mm_cause' long)] */
    ...
    /* JADX INFO: Multiple debug info for r5v6 long: [D('mt_call_drop_lac' long), D('mt_call_drop_cell' long)] */
    /* JADX INFO: Multiple debug info for r6v19 long: [D('current_rat_for_cs_call_drop' long), D('cs_emm_mm_cause' long)] */
    /* JADX INFO: Multiple debug info for r8v6 long: [D('cs_call_signal_strength' long), D('cs_errc_rrc_rr_cause' long)] */
    /* JADX INFO: Multiple debug info for r10v8 long: [D('cs_call_signal_quality' long), D('cs_call_drop_mcc' long)] */
    /* JADX INFO: Multiple debug info for r4v27 long: [D('cs_call_drop_cell' long), D('cs_call_drop_lac' long)] */
    /* JADX INFO: Multiple debug info for r0v19 long: [D('rssi' long), D('c2k_mt_call_drop_sid' long)] */
    ...
    /* JADX INFO: Multiple debug info for r0v22 long: [D('c2k_mt_call_drop_pn_offset' long), D('c2k_mt_call_drop_bid' long)] */
    /* JADX INFO: Multiple debug info for r10v16 long: [D('irf_pdn_cause' long), D('irf_tac' long)] */
    ...
    /* JADX INFO: Multiple debug info for r10v19 long: [D('ho_fail_signal_quality' long), D('ho_mnc' long)] */
    /* JADX INFO: Multiple debug info for r0v39 long: [D('ho_cell' long), D('ho_tac' long)] */
    /* JADX INFO: Multiple debug info for r8v26 long: [D('bar_time' long), D('bar_signal_strength' long)] */
    /* JADX INFO: Multiple debug info for r10v21 long: [D('ext_wait_time' long), D('bar_signal_quality' long)] */
    ...
    /* JADX INFO: Multiple debug info for r0v66 long: [D('mode3_tac' long), D('mode3_cell' long)] */
    /* JADX INFO: Multiple debug info for r8v34 long: [D('ul_bandwidth' long), D('signal_strength_nb' long)] */
    /* JADX INFO: Multiple debug info for r10v29 long: [D('signal_quality_nb' long), D('narrow_bandwidth_mcc' long)] */
    /* JADX INFO: Multiple debug info for r3v33 long: [D('fake_cell_bar_protocal_id' long), D('fake_ind' long)] */
    /* JADX INFO: Multiple debug info for r3v34 long: [D('fake_ind' long), D('fake_cell_mcc' long)] */
    /* JADX INFO: Multiple debug info for r3v35 long: [D('fake_cell_mnc' long), D('fake_cell_mcc' long)] */
    /* JADX INFO: Multiple debug info for r3v36 long: [D('fake_cell_mnc' long), D('fake_cell_tac' long)] */
    /* JADX INFO: Multiple debug info for r13v20 long: [D('apn_error_tac' long), D('apn_error_cell' long)] */
    /* JADX INFO: Multiple debug info for r3v56 long: [D('pdp_deact_error_tac' long), D('pdp_deact_error_cell' long)] */
    /* JADX INFO: Multiple debug info for r13v37 long: [D('pdp_act_error_cell' long), D('pdp_act_error_tac' long)] */
    ...
    /* JADX INFO: Multiple debug info for r13v56 long: [D('rau_ori_rej_cause' long), D('rau_rej_lac' long)] */
    /* JADX INFO: Multiple debug info for r10v52 long: [D('rau_rej_cell' long), D('rau_rej_mnc' long)] */
    /* JADX INFO: Multiple debug info for r13v59 long: [D('tau_rej_tac' long), D('tau_ori_rej_cause' long)] */
    /* JADX INFO: Multiple debug info for r10v63 long: [D('tau_rej_mnc' long), D('tau_rej_cell' long)] */
    ...
    /* JADX INFO: Multiple debug info for r3v101 long: [D('authen_rej_tac' long), D('authen_rej_cell' long)] */
    /* JADX INFO: Multiple debug info for r3v120 long: [D('service_rej_mnc' long), D('service_rej_tac' long)] */
    /* JADX INFO: Multiple debug info for r3v121 long: [D('service_rej_tac' long), D('service_ori_rej_cause' long)] */
    /* JADX INFO: Multiple debug info for r13v65 long: [D('service_rej_mcc' long), D('service_rej_cell' long)] */
    /* JADX INFO: Multiple debug info for r13v74 long: [D('detach_tac' long), D('detach_ori_rej_cause' long)] */
    /* JADX INFO: Multiple debug info for r10v86 long: [D('detach_cell' long), D('detach_mcc' long)] */
    /* JADX INFO: Multiple debug info for r14v11 long: [D('pdcp_ul_timeout_signal_strength' long), D('pdcp_ul_timeout_cell' long)] */
    ...
    /* JADX INFO: Multiple debug info for r14v13 long: [D('pdcp_ul_timeout_ims_exit_flag' long), D('pdcp_ul_timeout_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v18 long: [D('pdcp_ul_out_of_buf_cell' long), D('pdcp_ul_out_of_buf_signal_strength' long)] */
    /* JADX INFO: Multiple debug info for r14v19 long: [D('pdcp_ul_out_of_buf_signal_strength' long), D('pdcp_ul_out_of_buf_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v20 long: [D('pdcp_ul_out_of_buf_ims_exit_flag' long), D('pdcp_ul_out_of_buf_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v25 long: [D('pdcp_ul_one_way_pass_signal_strength' long), D('pdcp_ul_one_way_pass_cell' long)] */
    /* JADX INFO: Multiple debug info for r14v26 long: [D('pdcp_ul_one_way_pass_signal_strength' long), D('pdcp_ul_one_way_pass_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v27 long: [D('pdcp_ul_one_way_pass_ims_exit_flag' long), D('pdcp_ul_one_way_pass_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v35 long: [D('dl_high_bler_cell' long), D('dl_high_bler_signal_strength' long)] */
    /* JADX INFO: Multiple debug info for r14v36 long: [D('dl_high_bler_signal_strength' long), D('dl_high_bler_signal_quality' long)] */
    /* JADX INFO: Multiple debug info for r14v37 long: [D('dl_high_bler_signal_quality' long), D('dl_high_bler_ims_exit_flag' long)] */
    /* JADX INFO: Multiple debug info for r14v43 long: [D('vcd_ss' long), D('vcd_cid' long)] */
    /* JADX INFO: Multiple debug info for r14v44 long: [D('vcd_ss' long), D('vcd_sq' long)] */
    /* JADX INFO: Multiple debug info for r14v45 long: [D('vcd_rat' long), D('vcd_sq' long)] */
    /* JADX INFO: Multiple debug info for r8v72 long: [D('vcd_call_type' long), D('vcd_tac' long)] */
    /* JADX INFO: Multiple debug info for r8v73 long: [D('vcd_is_mt_call' long), D('vcd_call_type' long)] */
    /* JADX INFO: Multiple debug info for r5v76 long: [D('vcd_sip_call_state' long), D('vcd_mnc' long)] */
    ...
    /* JADX INFO: Multiple debug info for r3v157 long: [D('vcd_mcc' long), D('vcd_emm_mm_cause' long)] */
    /* JADX INFO: Multiple debug info for r3v158 long: [D('vcd_emm_mm_cause' long), D('vcd_errc_rrc_rr_cause' long)] */
    /* JADX INFO: Multiple debug info for r3v159 long: [D('vcd_ori_errc_rrc_rr_cause' long), D('vcd_errc_rrc_rr_cause' long)] */
    /* JADX INFO: Multiple debug info for r9v15 long: [D('lte_snr' long), D('gwl_call_quality_status' long)] */
    /* JADX INFO: Multiple debug info for r5v83 long: [D('gwl_call_quality_mnc' long), D('gwl_call_quality_signal_strength' long)] */
    /* JADX INFO: Multiple debug info for r3v193 long: [D('gwl_call_quality_lac' long), D('gwl_call_quality_signal_quality' long)] */
    ...
    /* JADX INFO: Multiple debug info for r3v201 long: [D('c2k_call_quality_nid' long), D('c2k_call_quality_rssi' long)] */
    /* JADX INFO: Multiple debug info for r3v202 long: [D('c2k_call_quality_nid' long), D('c2k_call_quality_bid' long)] */
    /* JADX INFO: Multiple debug info for r3v203 long: [D('c2k_call_quality_bid' long), D('c2k_call_dl_have_sound' long)] */
    /* JADX INFO: Multiple debug info for r3v281 long: [D('hold_a2_with_tau_num' long), D('mtk_urc_type_for_dmf' int)] */
    /* JADX INFO: Multiple debug info for r5v110 long: [D('hold_tmo_cnt_on_others' long), D('length' int)] */
    private void oppoGetDMFAppInfoFromURC(String data, CriticalLogInfo CLInfo) {
        ...
        if (mtk_urc_type_for_dmf == SYS_MTK_URC_CALL_MT_CSFB_CALL_DROP_FOR_DMFAPP) {
            ...
            long errc_rrc_rr_cause = (long) rowdata_int[11];
            ...
            long mt_cs_emm_mm_cause = (long) rowdata_int[10];
            ...
            long mt_call_drop_cell = (long) Integer.parseInt(rowdata[2]);
            logd("oppoGetDMFAppInfoFromURC, SYS_MTK_URC_DATA_MT_CS_CALL_DROP_FOR_DMFAPP,mt_cs_cc_cause:" + mt_cs_cc_cause + "mt_cs_emm_mm_cause:" + mt_cs_emm_mm_cause + "mt_cs_errc_rrc_rr_cause:" + mt_cs_errc_rrc_rr_cause);
            CLInfo.errcode = (mt_cs_call_signal_quality << 48) | (mt_cs_cc_cause << 32) | (mt_cs_emm_mm_cause << 16) | (mt_cs_errc_rrc_rr_cause & 65535);
            CLInfo.rat = current_rat_for_mt_cs_call_drop;
            CLInfo.issue = oppoGetStringFromType(19);
            CLInfo.type = 19;
            CLInfo.extra = "MCC:" + mt_call_drop_mcc + ",MNC:" + mt_call_drop_mnc + ",LAC:" + mt_call_drop_lac + ",CID:" + mt_call_drop_cell + ",signalquality:" + mt_cs_call_signal_quality + ",signalstrength:" + mt_cs_call_signal_strength + ",mt_cs_calldrop_cc_cause:" + mt_cs_cc_cause + ",mt_cs_calldrop_emm_mm_cause:" + mt_cs_emm_mm_cause + ",mt_cs_calldrop_errc_rrc_rr_cause:" + mt_cs_errc_rrc_rr_cause;
            ...
            long cs_errc_rrc_rr_cause = (long) rowdata_int[11];
            ...
            long cs_call_drop_lac2 = (long) Integer.parseInt(rowdata[2]);
            logd("oppoGetDMFAppInfoFromURC, SYS_MTK_URC_DATA_MT_CS_CALL_DROP_FOR_DMFAPP,cs_cc_cause:" + cs_cc_cause + ",cs_emm_mm_cause:" + cs_emm_mm_cause + ",cs_errc_rrc_rr_cause:" + cs_errc_rrc_rr_cause);
            CLInfo.extra = "MCC:" + cs_call_drop_mcc + ",MNC:" + cs_call_drop_mnc + ",LAC:" + cs_call_drop_lac + ",CID:" + cs_call_drop_lac2 + ",signalquality:" + cs_call_signal_quality + ",signalstrength:" + cs_call_signal_strength2 + ",cs_errc_rrc_rr_cause:" + cs_errc_rrc_rr_cause + ",cs_emm_mm_cause:" + cs_emm_mm_cause;
            if (803 == cs_errc_rrc_rr_cause || 801 == cs_errc_rrc_rr_cause || 404 == cs_errc_rrc_rr_cause || 104 == cs_errc_rrc_rr_cause || 105 == cs_errc_rrc_rr_cause || 106 == cs_errc_rrc_rr_cause || 107 == cs_errc_rrc_rr_cause || 154 == cs_errc_rrc_rr_cause || 156 == cs_errc_rrc_rr_cause || 157 == cs_errc_rrc_rr_cause || 158 == cs_errc_rrc_rr_cause) {
                cs_call_signal_strength = current_rat_for_cs_call_drop;
            } else if (161 == cs_errc_rrc_rr_cause) {
                cs_call_signal_strength = current_rat_for_cs_call_drop;
            } else if (802 == cs_errc_rrc_rr_cause || 401 == cs_errc_rrc_rr_cause) {
                CLInfo.errcode = (cs_call_signal_quality << 48) | (cs_errc_rrc_rr_cause << 32) | (cs_emm_mm_cause << 16) | (cs_errc_rrc_rr_cause & 65535);
            ...
            CLInfo.errcode = (cs_call_signal_quality << 48) | (cs_errc_rrc_rr_cause << 32) | (cs_emm_mm_cause << 16) | (65535 & cs_errc_rrc_rr_cause);
            ...
            long c2k_mt_call_drop_sid = (long) rowdata_int[3];
            long c2k_mt_call_drop_sid2 = (long) rowdata_int[4];
            long c2k_mt_call_drop_pn_offset = (long) rowdata_int[5];
            long c2k_mt_call_drop_bid = (long) rowdata_int[11];
            ...
            CLInfo.issue = oppoGetStringFromType(19);
            CLInfo.type = 19;
            CLInfo.extra = "MCC:" + c2k_mt_call_drop_mcc + ",MNC:" + ((long) Integer.parseInt(rowdata[2])) + ",SID:" + c2k_mt_call_drop_sid + ",NID:" + c2k_mt_call_drop_sid2 + ",BID:" + c2k_mt_call_drop_bid + ",signalstrength:" + rssi + ",signalquality:" + ecno + ",c2k_cause:" + c2k_cause + ",pn_offset:" + c2k_mt_call_drop_pn_offset;
            ...
            switch (mtk_urc_type_for_dmf) {
                case 101:
                    ...
                    long ho_mnc = (long) rowdata_int[11];
                    ...
                    CLInfo.rat = (long) oppoGetRatFromType(105);
                    CLInfo.issue = oppoGetStringFromType(105);
                    CLInfo.extra = "MCC:" + ho_mcc + ",MNC:" + ho_mnc + ",LAC:" + ho_tac + ",CID:" + ho_tac2 + ",signalquality:" + ho_fail_signal_quality + ",signalstrength:" + ho_fail_signal_strength;
                    return;
                case 102:
                    ...
                    long bar_signal_strength2 = (long) rowdata_int[10];
                    long bar_signal_quality2 = (long) rowdata_int[11];
                    ...
                    logd("oppoGetDMFAppInfoFromURC, SYS_MTK_URC_LTE_CELL_BAR_FOR_DMFAPP,bar_cause:" + bar_cause + "bar_time:" + bar_signal_strength2);
                    CLInfo.errcode = frequency_2;
                    CLInfo.type = 106;
                    CLInfo.rat = (long) oppoGetRatFromType(106);
                    CLInfo.issue = oppoGetStringFromType(106);
                    CLInfo.extra = "MCC:" + bar_mcc + ",MNC:" + bar_mnc + ",LAC:" + bar_tac + ",CID:" + bar_cell + ",signalquality:" + bar_signal_quality + ",signalstrength:" + bar_signal_strength + ",bar_time:" + bar_signal_strength2 + ",bar_ext_wait_time:" + bar_signal_quality2 + ",bar_cause:" + bar_cause;
                    return;
                case 103:
                ...
                case 106:
                    ...
                    long narrow_bandwidth_mcc = (long) rowdata_int[11];
                    ...
                    CLInfo.rat = (long) oppoGetRatFromType(97);
                    CLInfo.issue = oppoGetStringFromType(97);
                    CLInfo.extra = "MCC:" + narrow_bandwidth_mcc + ",MNC:" + ((long) rowdata_int[12]) + ",LAC:" + narrow_bandwidth_tac + ",CID:" + narrow_bandwidth_cell + ",signalquality:" + signal_quality_nb + ",signalstrength:" + signal_strength_nb + ",frequency:" + frequency_6 + ",ul_bandwidth:" + signal_strength_nb2 + ",dl_bandwidth:" + dl_bandwidth;
                    return;
                case 107:
                ...
                case SYS_OEM_NW_DIAG_CAUSE_LTE_A2_RELEASE_CELL /* 108 */:
                    ...
                    long fake_ind = (long) rowdata_int[7];
                    long fake_cell_mcc = (long) rowdata_int[8];
                    long fake_cell_mcc2 = (long) rowdata_int[9];
                    long fake_cell_tac = (long) rowdata_int[11];
                    logd("oppoGetDMFAppInfoFromURC, SYS_MTK_URC_LTE_FAKE_CELL_BAR_FOR_DMFAPP, bar_duration:" + fake_cell_bar_duration + ", earfcn:" + fake_cell_bar_earfcn + ", pci:" + fake_cell_bar_pci + ", cell_id:" + fake_cell_bar_cell_id + ", fake_cause:" + fake_cause + ", fake_ind:" + fake_ind + ", protocal_id:" + fake_cell_bar_protocal_id);
                    if (fake_cell_bar_duration >= 0) {
                        ...
                        CLInfo.extra = "MCC:" + fake_cell_mcc + ",MNC:" + fake_cell_mcc2 + ",LAC:" + fake_cell_tac + ",CID:" + fake_cell_bar_cell_id + ",earfcn:" + fake_cell_bar_earfcn + ",pci:" + fake_cell_bar_pci + ", fake_ind:" + fake_ind + ", protocal_id:" + fake_cell_bar_protocal_id;
                        return;
                    }
                    return;
                case 109:
                ...
                default:
                    switch (mtk_urc_type_for_dmf) {
                        case SYS_MTK_URC_IA_APN_ERROR_FOR_DMFAPP /* 201 */:
                            ...
                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_IA_APN_ERROR);
                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_IA_APN_ERROR);
                            CLInfo.extra = "MCC:" + ((long) rowdata_int[6]) + ",MNC:" + ((long) rowdata_int[7]) + ",LAC:" + apn_error_tac + ",CID:" + apn_error_cell;
                            return;
                        case SYS_MTK_URC_PDP_DEACT_ERROR_FOR_DMFAPP /* 202 */:
                            ...
                            long pdp_deact_error_cell = (long) Integer.parseInt(rowdata[2]);
                            ...
                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_PDP_DEACT_ERROR);
                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_PDP_DEACT_ERROR);
                            CLInfo.extra = "MCC:" + pdp_deact_error_mcc + ",MNC:" + pdp_deact_error_mnc + ",LAC:" + ((long) rowdata_int[9]) + ",CID:" + pdp_deact_error_cell;
                            return;
                        case SYS_MTK_URC_PDP_ACT_ERROR_FOR_DMFAPP /* 203 */:
                            long cid_3 = (long) rowdata_int[4];
                            long error_cause_3 = (long) rowdata_int[5];
                            long pdp_act_error_tac = (long) rowdata_int[9];
                            long pdp_act_error_tac2 = (long) Integer.parseInt(rowdata[2]);
                            ...
                            CLInfo.extra = "MCC:" + ((long) rowdata_int[6]) + ",MNC:" + ((long) rowdata_int[7]) + ",LAC:" + pdp_act_error_tac + ",CID:" + pdp_act_error_tac2;
                            return;
                        default:
                            switch (mtk_urc_type_for_dmf) {
                                case SYS_MTK_URC_LU_REJ_FOR_DMFAPP /* 301 */:
                                ...
                                case SYS_MTK_URC_TAU_REJ_FOR_DMFAPP /* 303 */:
                                    ...
                                    CLInfo.type = 101;
                                    CLInfo.errcode = tau_ori_rej_cause;
                                    CLInfo.rat = current_rat_for_tau;
                                    CLInfo.extra = "MCC:" + ((long) rowdata_int[6]) + ",MNC:" + tau_rej_mnc + ",LAC:" + tau_rej_tac + ",CID:" + tau_rej_cell;
                                    CLInfo.issue = oppoGetStringFromType(101);
                                    return;
                                case SYS_MTK_URC_ATTACH_REJ_FOR_DMFAPP /* 304 */:
                                    ...
                                    CLInfo.issue = oppoGetStringFromType(61);
                                    return;
                                case SYS_MTK_URC_AUTHEN_REJ_FOR_DMFAPP /* 305 */:
                                    ...
                                    CLInfo.extra = "MCC:" + authen_rej_mcc + ",MNC:" + authen_rej_mnc + ",LAC:" + authen_rej_tac + ",CID:" + authen_rej_cell;
                                    return;
                                case SYS_MTK_URC_SERVICE_REJECT_FOR_DMFAPP /* 306 */:
                                    ...
                                    long service_rej_tac = (long) rowdata_int[9];
                                    long service_ori_rej_cause = (long) rowdata_int[10];
                                    long service_rej_cell = (long) Integer.parseInt(rowdata[2]);
                                    ...
                                    CLInfo.issue = oppoGetStringFromType(102);
                                    CLInfo.type = 102;
                                    CLInfo.extra = "MCC:" + service_rej_mcc + ",MNC:" + ((long) rowdata_int[7]) + ",LAC:" + service_rej_tac + ",CID:" + service_rej_cell + ",reject_cause_for_service_rej:" + reject_cause_for_service_rej + ",reject_type_for_service_rej:" + reject_type_for_service_rej;
                                    return;
                                case SYS_MTK_URC_NETWORK_DETACH_FOR_DMFAPP /* 307 */:
                                    ...
                                    long detach_mcc2 = (long) Integer.parseInt(rowdata[2]);
                                    ...
                                    CLInfo.issue = oppoGetStringFromType(104);
                                    CLInfo.type = 104;
                                    CLInfo.extra = "MCC:" + detach_mcc + ",MNC:" + ((long) rowdata_int[7]) + ",LAC:" + detach_tac + ",CID:" + detach_mcc2 + ",detach_cause:" + detach_cause + ",detach_type:" + detach_type;
                                    return;
                                default:
                                    switch (mtk_urc_type_for_dmf) {
                                        case 401:
                                            long pdcp_ul_timeout_cell = (long) Integer.parseInt(rowdata[2]);
                                            long pdcp_ul_timeout_cell2 = (long) rowdata_int[8];
                                            long pdcp_ul_timeout_signal_quality = (long) rowdata_int[9];
                                            long pdcp_ul_timeout_signal_quality2 = (long) rowdata_int[10];
                                            CLInfo.type = 120;
                                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_TIMEOUT);
                                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_TIMEOUT);
                                            CLInfo.extra = "MCC:" + ((long) rowdata_int[4]) + ",MNC:" + ((long) rowdata_int[5]) + ",LAC:" + ((long) rowdata_int[7]) + ",CID:" + pdcp_ul_timeout_cell + ",signalstrength:" + pdcp_ul_timeout_cell2 + ",signalquality:" + pdcp_ul_timeout_signal_quality + ",ims_call_exit:" + pdcp_ul_timeout_signal_quality2;
                                            return;
                                        case 402:
                                            long pdcp_ul_out_of_buf_cell = (long) Integer.parseInt(rowdata[2]);
                                            long pdcp_ul_out_of_buf_signal_strength = (long) rowdata_int[8];
                                            long pdcp_ul_out_of_buf_signal_quality = (long) rowdata_int[9];
                                            long pdcp_ul_out_of_buf_signal_quality2 = (long) rowdata_int[10];
                                            CLInfo.type = 121;
                                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_OUT_OF_BUFFER);
                                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_OUT_OF_BUFFER);
                                            CLInfo.extra = "MCC:" + ((long) rowdata_int[4]) + ",MNC:" + ((long) rowdata_int[5]) + ",LAC:" + ((long) rowdata_int[7]) + ",CID:" + pdcp_ul_out_of_buf_cell + ",signalstrength:" + pdcp_ul_out_of_buf_signal_strength + ",signalquality:" + pdcp_ul_out_of_buf_signal_quality + ",ims_call_exit:" + pdcp_ul_out_of_buf_signal_quality2;
                                            return;
                                        case SYS_MTK_URC_DATA_PDCP_UL_ONE_WAY_PASS_FOR_DMFAPP /* 403 */:
                                            long pdcp_ul_one_way_pass_cell = (long) Integer.parseInt(rowdata[2]);
                                            long pdcp_ul_one_way_pass_cell2 = (long) rowdata_int[8];
                                            long pdcp_ul_one_way_pass_signal_quality = (long) rowdata_int[9];
                                            long pdcp_ul_one_way_pass_signal_quality2 = (long) rowdata_int[10];
                                            CLInfo.type = 122;
                                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_ONE_WAY_PASS);
                                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_PDCP_UL_ONE_WAY_PASS);
                                            CLInfo.extra = "MCC:" + ((long) rowdata_int[4]) + ",MNC:" + ((long) rowdata_int[5]) + ",LAC:" + ((long) rowdata_int[7]) + ",CID:" + pdcp_ul_one_way_pass_cell + ",signalstrength:" + pdcp_ul_one_way_pass_cell2 + ",signalquality:" + pdcp_ul_one_way_pass_signal_quality + ",ims_call_exit:" + pdcp_ul_one_way_pass_signal_quality2;
                                            return;
                                        case SYS_MTK_URC_DATA_DL_HIGH_BLER_FOR_DMFAPP /* 404 */:
                                            long dl_high_bler_cell = (long) Integer.parseInt(rowdata[2]);
                                            long dl_high_bler_signal_strength = (long) rowdata_int[8];
                                            long dl_high_bler_signal_quality = (long) rowdata_int[9];
                                            long dl_high_bler_ims_exit_flag = (long) rowdata_int[10];
                                            CLInfo.type = 123;
                                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_DL_HIGH_BLER);
                                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_DL_HIGH_BLER);
                                            CLInfo.extra = "MCC:" + ((long) rowdata_int[4]) + ",MNC:" + ((long) rowdata_int[5]) + ",LAC:" + ((long) rowdata_int[7]) + ",CID:" + dl_high_bler_cell + ",signalstrength:" + dl_high_bler_signal_strength + ",signalquality:" + dl_high_bler_signal_quality + ",ims_call_exit:" + dl_high_bler_ims_exit_flag;
                                            return;
                                        default:
                                            switch (mtk_urc_type_for_dmf) {
                                                case SYS_MTK_URC_VOLTE_CALL_DROP_FOR_DMFAPP /* 509 */:
                                                    ...
                                                    long vcd_cid2 = (long) rowdata_int[7];
                                                    long vcd_sq = (long) rowdata_int[8];
                                                    long vcd_sq2 = (long) rowdata_int[3];
                                                    long vcd_tac2 = (long) rowdata_int[9];
                                                    long vcd_call_type = (long) rowdata_int[10];
                                                    long vcd_mnc2 = (long) rowdata_int[11];
                                                    ...
                                                    long vcd_errc_rrc_rr_cause = (long) rowdata_int[16];
                                                    long vcd_errc_rrc_rr_cause2 = (long) rowdata_int[21];
                                                    ...
                                                    CLInfo.type = (long) (1 == vcd_call_type ? SYS_OEM_NW_DIAG_CAUSE_IMS_MT_CALL_DROP : SYS_OEM_NW_DIAG_CAUSE_IMS_MO_CALL_DROP);
                                                    CLInfo.rat = vcd_sq2;
                                                    CLInfo.issue = oppoGetStringFromType(1 == vcd_call_type ? SYS_OEM_NW_DIAG_CAUSE_IMS_MT_CALL_DROP : SYS_OEM_NW_DIAG_CAUSE_IMS_MO_CALL_DROP);
                                                    CLInfo.extra = "MCC:" + vcd_mcc + ",MNC:" + vcd_mnc + ",LAC:" + vcd_tac + ",CID:" + vcd_cid + ",signalquality:" + vcd_cid2 + ",signalstrength:" + vcd_sq + ",call_type:" + vcd_tac2 + ",is_mt_call:" + vcd_call_type + ",sip_call_state:" + vcd_mnc2 + ",net_type:" + vcd_net_type + ",sip_cause:" + vcd_sip_cause + ",emm_mm_cause:" + vcd_emm_mm_cause + ",errc_rrc_rr_cause:" + vcd_errc_rrc_rr_cause + ",vcd_ori_errc_rrc_rr_cause:" + vcd_errc_rrc_rr_cause2;
                                                    return;
                                                case SYS_MTK_URC_IMS_CALL_HO_FAIL_FOR_DMFAPP /* 510 */:
                                                    ...
                                                    return;
                                                case SYS_MTK_URC_CALL_GWL_CALL_QUALITY_FOR_DMFAPP /* 511 */:
                                                    ...
                                                    long gwl_call_quality_signal_strength2 = (long) Integer.parseInt(rowdata[2]);
                                                    ...
                                                    CLInfo.type = 39;
                                                    CLInfo.extra = "MCC:" + ((long) Integer.parseInt(rowdata[1])) + ",MNC:" + gwl_call_quality_signal_strength2 + ",LAC:" + gwl_call_quality_signal_quality2 + ",CID:" + gwl_call_quality_cell + ",signalquality:" + gwl_call_quality_signal_quality + ",signalstrength:" + gwl_call_quality_signal_strength + ",snr:" + lte_snr + ",dl_have_sound:" + gwl_call_dl_have_sound;
                                                    return;
                                                case 512:
                                                    ...
                                                    long c2k_call_quality_rssi2 = (long) rowdata_int[5];
                                                    long c2k_call_quality_bid = (long) rowdata_int[6];
                                                    CLInfo.errcode = (long) rowdata_int[12];
                                                    CLInfo.rat = 3;
                                                    CLInfo.issue = oppoGetStringFromType(41);
                                                    CLInfo.type = 41;
                                                    CLInfo.extra = "MCC:" + ((long) Integer.parseInt(rowdata[1])) + ",MNC:" + c2k_call_quality_mnc + ",SID:" + ((long) rowdata_int[4]) + ",NID:" + c2k_call_quality_rssi2 + ",BID:" + c2k_call_quality_bid + ",signalstrength:" + c2k_call_quality_rssi + ",signalquality:" + c2k_call_quality_ecio + ",dl_have_sound:" + ((long) rowdata_int[13]);
                                                    return;
                                                default:
                                                    switch (mtk_urc_type_for_dmf) {
                                                        case SYS_MTK_URC_CARD_DROP_FOR_DMFAPP /* 601 */:
                                                            rowdata_int[1] = Integer.parseInt(rowdata[1]);
                                                            CLInfo.type = 160;
                                                            ...
                                                            CLInfo.issue = oppoGetStringFromType(160);
                                                            return;
                                                        case SYS_MTK_URC_RF_MIPI_HW_FAILED_FOR_DMFAPP /* 602 */:
                                                            rowdata_int[1] = Integer.parseInt(rowdata[1]);
                                                            ...
                                                            return;
                                                        case SYS_MTK_URC_DATA_NODDS_FREQUENT_PAGING /* 603 */:
                                                            rowdata_int[1] = Integer.parseInt(rowdata[1]);
                                                            rowdata_int[2] = Integer.parseInt(rowdata[2]);
                                                            CLInfo.type = 141;
                                                            CLInfo.rat = (long) oppoGetRatFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_NODDS_FREQUENT_PAGING);
                                                            CLInfo.issue = oppoGetStringFromType(SYS_OEM_NW_DIAG_CAUSE_DATA_NODDS_FREQUENT_PAGING);
                                                            CLInfo.extra = "counter_of_paging_over_12:" + ((long) rowdata_int[1]) + ",total_paging:" + ((long) rowdata_int[2]);
                                                            return;
                                                        default:
                                                            switch (mtk_urc_type_for_dmf) {
                                                                case SYS_MTK_URC_3GPP_OOS_LOW_POWER_FOR_DMFAPP /* 701 */:
                                                                    rowdata_int[1] = Integer.parseInt(rowdata[1]);
                                                                    rowdata_int[2] = Integer.parseInt(rowdata[2]);
                                                                ...
                                                                case SYS_MTK_URC_SCREEN_ON_TRIGGER_NW_SRCH_FOR_DMFAPP /* 702 */:
                                                                    ...
                                                                    return;
                                                                case SYS_MTK_URC_SMART_IDLE_TIMEOUT_MONITOR_FOR_DMFAPP /* 703 */:
            ...
            long irf_tac2 = (long) rowdata_int[11];
            ...
            CLInfo.extra = "MCC:" + irf_mcc + ",MNC:" + irf_mnc + ",LAC:" + irf_tac + ",CID:" + irf_cid + ",signalquality:" + ((long) rowdata_int[7]) + ",signalstrength:" + irf_sq + ",sip_cause:" + irf_sip_cause + ",pdn_cause:" + irf_tac2;
        }
    }
        ...
        switch (type) {
            ...
            default:
                switch (type) {
                    ...
                    case SYS_OEM_NW_DIAG_CAUSE_MO_CALL_DROP /* 23 */:
                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_MO_CALL_DROP;
                    case SYS_OEM_NW_DIAG_CAUSE_MT_CALL_DROP /* 24 */:
                                ...
                                switch (type) {
                                    ...
                                    default:
                                        switch (type) {
                                            ...
                                            case SYS_OEM_NW_DIAG_CAUSE_LTE_AUTHENTICATION_REJECT /* 68 */:
                                                return ISSUE_SYS_OEM_NW_DIAG_CAUSE_LTE_AUTHENTICATION_REJECT;
                                            default:
                                                switch (type) {
                                                    case SYS_OEM_NW_DIAG_CAUSE_FAKE_BS /* 70 */:
                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_FAKE_BS;
                                                    case SYS_OEM_NW_DIAG_CAUSE_FAKE_BS_ONLY /* 71 */:
                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_FAKE_BS_ONLY;
                                                    case SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_RAT /* 72 */:
                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_RAT;
                                                    case SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_MCC /* 73 */:
                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_MCC;
                                                    case SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_MNC /* 74 */:
                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_REG_SRV_REQ_MNC;
                                                    case SYS_OEM_NW_DIAG_CAUSE_REG_SRV_ON /* 75 */:
                                                    ...
                                                    default:
                                                        switch (type) {
                                                            ...
                                                            case SYS_OEM_NW_DIAG_CAUSE_DATA_NO_AVAILABLE_APN /* 111 */:
                                                                return ISSUE_SYS_OEM_NW_DIAG_CAUSE_DATA_NO_AVAILABLE_APN;
                                                            case SYS_OEM_NW_DIAG_CAUSE_DATA_SET_UP_DATA_ERROR /* 112 */:
                                                                return ISSUE_SYS_OEM_NW_DIAG_CAUSE_DATA_SET_UP_DATA_ERROR;
                                                            case SYS_OEM_NW_DIAG_CAUSE_DATA_STALL_ERROR /* 113 */:
                                                                return ISSUE_SYS_OEM_NW_DIAG_CAUSE_DATA_STALL_ERROR;
                                                            default:
                                                                switch (type) {
                                                                    case SYS_OEM_NW_DIAG_CAUSE_DATA_RATE_LIMIT_ON_LTE /* 116 */:
                                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_DATA_RATE_LIMIT_ON_LTE;
                                                                    case SYS_OEM_NW_DIAG_CAUSE_IA_APN_ERROR /* 117 */:
                                                                        return ISSUE_SYS_OEM_NW_DIAG_CAUSE_IA_APN_ERROR;
                                                                    case SYS_OEM_NW_DIAG_CAUSE_LTE_RRC_CONN_HOLD /* 118 */:
    ...
    private int oppoGetRatFromType(int type) {
        if (!(type == 61 || type == 68 || type == 85 || type == 97 || type == 117 || type == 127 || type == 129 || type == 141)) {
