...
public class OppoSmsManagerImpl implements IOppoSmsManager {
    ...
    public boolean isSmsBlockByPolicy(Phone phone) {
        ...
        } else if (phone == null || !OppoPolicyController.getSmsReceiveRestricted(phone.getPhoneId()) || !OppoPolicyController.isOppoSimLockVersion()) {
            return false;
        } else {
            Rlog.d(NetworkDiagnoseUtils.INFO_OTHER_SMS, "isOppoSimLockVersion, SmsReceiveRestricted is true");
            return true;
        }
    }
