...
public class OppoPhoneStateMonitor {
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            OppoPhoneStateMonitor.this.mSmart5gLtePoorRsrpThres = intent.getIntExtra("ltePoorRsrpThres", -160);
            OppoPhoneStateMonitor.this.mSmart5gLtePoorRsrqThres = intent.getIntExtra("ltePoorRsrqThres", -40);
            OppoPhoneStateMonitor.this.mSmart5gLtePoorBwThres = intent.getIntExtra("ltePoorBwThres", 0);
    ...
    private ContentObserver mPrefNetworkModeObserver = new ContentObserver(this.mHandler) {
        ...
        public void onChange(boolean selfChange) {
            ...
            oppoPhoneStateMonitor.mNetworkMode = oppoPhoneStateMonitor.getNetworkModeFromDB();
    ...
    protected int mSmart5gLtePoorBwThres = 0;
    protected int mSmart5gLtePoorRsrpThres = -160;
    protected int mSmart5gLtePoorRsrqThres = -40;
        ...
        SubscriptionManager.from(this.mPhone.getContext()).addOnSubscriptionsChangedListener(new SubscriptionManager.OnSubscriptionsChangedListener(this.mHandler.getLooper()) {
            ...
            public void onSubscriptionsChanged() {
                ...
                if (OppoPhoneStateMonitor.this.mPreviousSubId != subId) {
                    ...
                    OppoPhoneStateMonitor.this.mPreviousSubId = subId;
