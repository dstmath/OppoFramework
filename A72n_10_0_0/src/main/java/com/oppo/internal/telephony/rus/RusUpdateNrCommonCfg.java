...
public final class RusUpdateNrCommonCfg extends RusBase {
    ...
    String[] mConfigParaNameArray = {"support_optimized_nr", "cellId_save_timeout", "cellId_list_size", "nrstate_smooth_delay", "nr_modem_reset_smooth_enabled", "nr_modem_reset_smooth_time", "open_restricted_dcnr"};
        ...
        if (rusData == null) {
            ...
            while (true) {
                ...
                if (index < strArr.length) {
                    ...
                    String config = "support_optimized_nr=" + this.mCfgData[0] + ";cellId_save_timeout=" + this.mCfgData[1] + ";cellId_list_size=" + this.mCfgData[2] + ";nrstate_smooth_delay=" + this.mCfgData[3] + ";nr_modem_reset_smooth_enabled=" + this.mCfgData[4] + ";nr_modem_reset_smooth_time=" + this.mCfgData[5] + ";open_restricted_dcnr=" + this.mCfgData[6] + ";";
