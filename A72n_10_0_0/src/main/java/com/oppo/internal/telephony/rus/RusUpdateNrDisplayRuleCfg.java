...
public final class RusUpdateNrDisplayRuleCfg extends RusBase {
    ...
    private final int CONFIG_LEN_DEFAULT = 5;
    private final int MAX_SLEEP_COUNT = 10;
    String[] mCfgData = new String[5];
    String[] mConfigParaNameArray = {"nr_display_rule", "lte_con_stat_delay_timer", "scg_con_stat_delay_timer", "jp_mod_timer1_delay_timer", "jp_mod_timer2_delay_timer"};
    ...
    public void executeRusCommand(HashMap<String, String> rusData, boolean isReboot) {
        if (rusData == null) {
            ...
            if (strArr2 != null && strArr2.length == 5) {
                printLog(TAG, "executeRusCommand() isReboot:" + isReboot + ",nr_display_rule:" + this.mCfgData[0] + ",lte_con_stat_delay_timer:" + this.mCfgData[1] + ",scg_con_stat_delay_timer:" + this.mCfgData[2] + ",jp_mod_timer1_delay_timer:" + this.mCfgData[3] + ",jp_mod_timer2_delay_timer:" + this.mCfgData[4]);
                if (RegionLockConstant.TEST_OP_DEFAULT.equals(this.mCfgData[0]) || "3".equals(this.mCfgData[0]) || RegionLockConstant.TEST_OP_CUANDCMCC.equals(this.mCfgData[0]) || "1".equals(this.mCfgData[0])) {
                    String updateCmd = "UPDATE_DISPLAY_RULE, " + this.mCfgData[0] + ", " + this.mCfgData[1] + ", " + this.mCfgData[2] + ", " + this.mCfgData[3] + ", " + this.mCfgData[4];
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        RusUpdateNrDisplayRuleCfg.this.mHandler = new Handler() {
