...
public class OemDeviceLock {
    ...
    protected static Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                Context context = OemDeviceLock.mContext;
                Toast.makeText(context, "update device lock status show forbid slot " + msg.arg1, 1).show();
            }
        }
    };
    ...
    private static boolean sStopRpmb = false;
