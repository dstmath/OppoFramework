...
public class OppoNetworkManagerImpl implements IOppoNetworkManager {
    ...
    public int changeFastRecovRAT(int networkType) {
        switch (networkType) {
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_MO_CALL_DROP /* 23 */:
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_MT_CALL_DROP /* 24 */:
                return 11;
            case 25:
                return 8;
            case 26:
                return 9;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_DATA_USER_DATA_ENABLE_NUM /* 27 */:
                return 10;
            case 28:
                return 12;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_DATA_PDN_ACTIVATION_DURATION /* 29 */:
                return 15;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_DATA_DISCONNECT_CALL_ERROR /* 30 */:
                return 17;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_APN_REASON_DATA_CALL_FAIL /* 31 */:
                return 19;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_NOT_APN_REASON_DATA_CALL_FAIL /* 32 */:
                return 20;
            case OppoRIL.SYS_OEM_NW_DIAG_CAUSE_SCREEN_ON_DURATION /* 33 */:
                return 22;
            default:
                return networkType;
        }
