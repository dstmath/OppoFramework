...
public interface IOppoScreenMode extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOppoScreenMode {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 10:
                        ...
                        enterPSModeOnRate(_arg0, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 12:
                        ...
                        boolean requestRefreshRateWithToken = requestRefreshRateWithToken(_arg0, data.readInt(), data.readStrongBinder());
                        reply.writeNoException();
                    ...
                    case 13:
                        ...
                        boolean gameList = getGameList(_arg02);
                        reply.writeNoException();
                    ...
                    case 15:
                        ...
                        enterPSModeOnRateWithToken(_arg0, data.readInt(), data.readStrongBinder());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IOppoScreenMode {
