...
public class ColorResolveInfoHelper {
    ...
    private void readConfigFileBackground(final int userId) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:161:0x031b, code lost:
        if ((r1 instanceof java.io.Closeable) != false) goto L_0x031d;
     */
    ...
    private void readConfigFile(int userId) {
        int event;
