...
public class ShutdownViewControl {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0) {
                ...
                if (ShutdownViewControl.this.mRoadAnimatorSet != null && ShutdownViewControl.this.mRoadAnimatorSet.isRunning()) {
                    ...
                    ShutdownViewControl.this.mRoadAnimatorSet = null;
                }
                if (ShutdownViewControl.this.mEnterAnimator != null && ShutdownViewControl.this.mEnterAnimator.isRunning()) {
                    ...
                    ShutdownViewControl.this.mEnterAnimator = null;
                }
                if (ShutdownViewControl.this.mExitAnimator != null && ShutdownViewControl.this.mExitAnimator.isRunning()) {
                    ...
                    ShutdownViewControl.this.mExitAnimator = null;
                }
            }
        }
    };
    private AnimatorSet mHandlerDownAnimator;
    private AnimatorSet mHandlerUpAnimator;
    private boolean mIsPressEmergency;
    private boolean mIsPressEmpty;
    private boolean mIsPressHandler;
    private boolean mIsPressManuallyLock;
    private OnCancelListener mOnCancelListener;
    private OnEmergencyListener mOnEmergencyListener;
    private OnRebootListener mOnRebootListener;
    ...
    private int mRebootThreshold;
    private AnimatorSet mRoadAnimatorSet;
    private ObjectAnimator mRoadShowAnimator;
    private AnimatorSet mScaleAndRatioAnimator;
    private boolean mShouldShowManuallyLock;
    private AnimatorSet mShutdownAnimator;
    private ObjectAnimator mShutdownRatioUpAnimator;
    private ObjectAnimator mShutdownScaleUpAnimator;
    private int mShutdownThreshold;
    private ShutdownView mShutdownView;
    private AnimatorSet mToBaseScaleAndRatioAnimator;
    private SpringAnimation mToBaseSpringAnimation;
    private SpringAnimation mToRebootSpringAnimation;
    ...
    private SpringAnimation mToShutdownSpringAnimation;
    ...
    private ShutdownView.TouchEventListener mTouchEventListener = new ShutdownView.TouchEventListener() {
        ...
        public boolean onDown(float downX, float downY) {
            ...
            ShutdownViewControl.this.mDownX = downX;
            ShutdownViewControl.this.mDownY = downY;
            if (ShutdownViewControl.this.mShutdownView.isPortrait()) {
                ShutdownViewControl shutdownViewControl = ShutdownViewControl.this;
                shutdownViewControl.mIsPressHandler = shutdownViewControl.mShutdownView.mHandlerRectF.contains(downX - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler, downY);
            } else {
                ShutdownViewControl shutdownViewControl2 = ShutdownViewControl.this;
                shutdownViewControl2.mIsPressHandler = shutdownViewControl2.mShutdownView.mHandlerRectF.contains(downX, downY - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler);
            }
            if (ShutdownViewControl.this.mShutdownView.isAccessibilityEnabled()) {
                ...
                shutdownViewControl3.mIsPressHandler = shutdownViewControl3.mShutdownView.mAccessibilityHandlerRect.contains(downX, downY);
            }
            if (ShutdownViewControl.this.mShutdownView.isPortrait()) {
                ShutdownViewControl shutdownViewControl4 = ShutdownViewControl.this;
                shutdownViewControl4.mIsPressEmergency = shutdownViewControl4.mShutdownView.mEmergencyBarRectF.contains((float) ((int) (downX - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler)), (float) ((int) downY));
                ShutdownViewControl shutdownViewControl5 = ShutdownViewControl.this;
                shutdownViewControl5.mIsPressEmpty = !shutdownViewControl5.mShutdownView.mBarRectF.contains(downX - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler, downY) && !ShutdownViewControl.this.mIsPressEmergency;
                ...
                shutdownViewControl6.mIsPressManuallyLock = z;
            } else {
                ShutdownViewControl shutdownViewControl7 = ShutdownViewControl.this;
                shutdownViewControl7.mIsPressEmergency = shutdownViewControl7.mShutdownView.mEmergencyBarRectF.contains((float) ((int) downX), (float) ((int) (downY - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler)));
                ShutdownViewControl shutdownViewControl8 = ShutdownViewControl.this;
                shutdownViewControl8.mIsPressEmpty = !shutdownViewControl8.mShutdownView.mBarRectF.contains(downX, downY - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler) && !ShutdownViewControl.this.mIsPressEmergency;
                ...
                shutdownViewControl9.mIsPressManuallyLock = z;
            }
        ...
        public void onMove(float moveX, float moveY) {
            if (ShutdownViewControl.this.mIsPressHandler) {
                ...
                if (distance > ((float) ViewConfiguration.get(ShutdownViewControl.this.mShutdownView.getContext()).getScaledTouchSlop())) {
                    ShutdownViewControl.this.mIsPressEmpty = false;
                }
            }
            if (ShutdownViewControl.this.mIsPressEmergency) {
                if (ShutdownViewControl.this.mShutdownView.isPortrait()) {
                    ShutdownViewControl shutdownViewControl = ShutdownViewControl.this;
                    shutdownViewControl.mIsPressEmergency = shutdownViewControl.mShutdownView.mEmergencyBarRectF.contains((float) ((int) (moveX - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler)), (float) ((int) moveY));
                } else {
                    ShutdownViewControl shutdownViewControl2 = ShutdownViewControl.this;
                    shutdownViewControl2.mIsPressEmergency = shutdownViewControl2.mShutdownView.mEmergencyBarRectF.contains((float) ((int) moveX), (float) ((int) (moveY - ShutdownViewControl.this.mShutdownView.mCanvasStranslateXForHandler)));
                }
    ...
    private void animateWhenToBase() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onManuallyLockChanged() {
