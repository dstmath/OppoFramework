...
public class ColorResolverPagerAdapterHelper implements ColorResolverGridAdapter.OnItemClickListener {
    ...
    private ColorItem getBitmapFromMemCache(String key) {
        return this.mMemoryCache.get(key);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void addBitmapToMemoryCache(String key, ColorItem appinfo) {
        ...
        public List<ColorItem> call() {
            ...
            for (ResolveInfo info : list.subList(i4, i)) {
                ...
                if (item != null) {
                    ...
                    if (dr instanceof ColorAdaptiveIconDrawable) {
                        item.setIcon(dr.getConstantState().newDrawable());
                    }
                    colorItems.add(item);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isMultiApp(ResolveInfo resolveInfo) {
