...
public final class ColorSecureKeyboardData implements Parcelable {
    public static final Parcelable.Creator<ColorSecureKeyboardData> CREATOR = new Parcelable.Creator<ColorSecureKeyboardData>() {
        /* class com.color.util.ColorSecureKeyboardData.AnonymousClass1 */
