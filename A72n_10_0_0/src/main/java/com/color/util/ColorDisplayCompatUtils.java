...
public class ColorDisplayCompatUtils {
    ...
    public float getmaxAspectRatio(ActivityInfo info) {
        ...
        if (shouldCompatAdjustForPkg(info.packageName)) {
            Slog.d(TAG, info.packageName + ", maxAspectRatio: " + info.maxAspectRatio + " >>> 1.7778");
            return 1.7778f;
        } else if (maxAspectRatio == 0.0f) {
            return maxAspectRatio;
        } else {
            Slog.d(TAG, info.packageName + ", maxAspectRatio: " + info.maxAspectRatio + " >>> 0.0");
            return 0.0f;
        }
    }
    ...
    /* access modifiers changed from: private */
    public class LocalCompatSettingsObserverPolicy extends ContentObserver {
    ...
    /* access modifiers changed from: private */
    public class LocalCutoutSettingsObserverPolicy extends ContentObserver {
    ...
    /* access modifiers changed from: private */
    public class LocalShowDialogSettingsObserverPolicy extends ContentObserver {
