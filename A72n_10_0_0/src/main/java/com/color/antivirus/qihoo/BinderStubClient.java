...
public class BinderStubClient implements IBinder {
    ...
    private static void initStatic() {
        ...
        try {
            ...
            char c = 0;
            Map<Integer, String> tmpTCodeTNameMap3 = null;
            int i = 0;
            while (i < length) {
                ...
                if (!elementParamPattern.equals("NULL")) {
                    if (sSvcName_TNameParamPatternMap_Map.containsKey(elementSvcName)) {
                        tmpTCodeTNameMap3 = sSvcName_TNameParamPatternMap_Map.get(elementSvcName);
                    } else {
                        tmpTCodeTNameMap3 = new HashMap<>();
                    }
                    if (!tmpTCodeTNameMap3.containsKey(elementTName)) {
                        tmpTCodeTNameMap3.put(elementTName, elementParamPattern);
                    }
                    tmpTCodeTNameMap2 = tmpTCodeTNameMap;
                    sSvcName_TNameParamPatternMap_Map.put(elementSvcName, tmpTCodeTNameMap3);
                } else {
                    tmpTCodeTNameMap2 = tmpTCodeTNameMap;
                    tmpTCodeTNameMap3 = tmpTCodeTNameMap3;
                }
