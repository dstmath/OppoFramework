...
public class ColorLayoutParams implements Parcelable {
    public static final Parcelable.Creator<ColorLayoutParams> CREATOR = new Parcelable.Creator<ColorLayoutParams>() {
        /* class com.color.view.ColorLayoutParams.AnonymousClass1 */
