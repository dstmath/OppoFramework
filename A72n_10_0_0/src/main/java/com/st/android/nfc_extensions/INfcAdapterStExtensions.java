            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        return true;
                    case TRANSACTION_getHceCapability /* 5 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean hceCapability = getHceCapability();
                        reply.writeNoException();
                        reply.writeInt(hceCapability ? 1 : 0);
                        return true;
                    case TRANSACTION_setRfConfiguration /* 6 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getRfConfiguration /* 7 */:
                        ...
                        return true;
                    case TRANSACTION_setRfBitmap /* 8 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_disconnectGate /* 19 */:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getAvailableHciHostList /* 20 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_sendPropTestCmd /* 29 */:
                        ...
                        return true;
                    case TRANSACTION_getCustomerData /* 30 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getNfcWalletAdapterInterface /* 31 */:
                        ...
                        return true;
                    case TRANSACTION_getNfcAdapterStDtaExtensionsInterface /* 32 */:
                        data.enforceInterface(DESCRIPTOR);
