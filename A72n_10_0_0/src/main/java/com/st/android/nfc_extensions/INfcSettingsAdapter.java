            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 4:
                        ...
                        return true;
                    case TRANSACTION_isSEConnected /* 5 */:
                        data.enforceInterface(DESCRIPTOR);
