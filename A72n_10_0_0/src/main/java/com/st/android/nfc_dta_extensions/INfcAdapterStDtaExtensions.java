            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setConnectionDevicesLimit /* 5 */:
                        data.enforceInterface(DESCRIPTOR);
                        setConnectionDevicesLimit(data.readByte(), data.readByte(), data.readByte(), data.readByte());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setListenNfcaUidMode /* 6 */:
                        data.enforceInterface(DESCRIPTOR);
                        setListenNfcaUidMode(data.readByte());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setT4atNfcdepPrio /* 7 */:
                        data.enforceInterface(DESCRIPTOR);
                        setT4atNfcdepPrio(data.readByte());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setFsdFscExtension /* 8 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg0 = true;
                        }
                    ...
                    case TRANSACTION_enableDiscovery /* 11 */:
                        ...
                        return true;
                    case TRANSACTION_disableDiscovery /* 12 */:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements INfcAdapterStDtaExtensions {
            ...
            public void setConnectionDevicesLimit(byte cdlA, byte cdlB, byte cdlF, byte cdlV) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setConnectionDevicesLimit, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
