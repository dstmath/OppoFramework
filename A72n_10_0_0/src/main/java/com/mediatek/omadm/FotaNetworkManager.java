...
public class FotaNetworkManager {
    ...
    public class NetworkReqClbk extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            ...
            synchronized (FotaNetworkManager.this) {
                FotaNetworkManager.this.mNwk = network;
        ...
        public void onLost(Network network) {
            ...
            synchronized (FotaNetworkManager.this) {
                ...
                FotaNetworkManager.this.mNwk = null;
            }
        }
