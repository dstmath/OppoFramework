            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 7:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_callSessionDeviceSwitchFailed /* 8 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_callSessionRinging /* 10 */:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_callSessionBusy /* 11 */:
                        data.enforceInterface(DESCRIPTOR);
                        callSessionBusy(IMtkImsCallSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_callSessionCalling /* 12 */:
                        data.enforceInterface(DESCRIPTOR);
