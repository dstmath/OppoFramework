            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        setCallIndication(_arg0, _arg14, _arg2, _arg3, _arg4, _arg13, data.readInt());
                    ...
                    case 7:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_updateRadioState /* 8 */:
                        data.enforceInterface(DESCRIPTOR);
                        updateRadioState(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_UpdateImsState /* 9 */:
                        data.enforceInterface(DESCRIPTOR);
                        UpdateImsState(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getConfigInterfaceEx /* 10 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeStrongBinder(iBinder);
                        return true;
                    case TRANSACTION_getMtkUtInterface /* 11 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeStrongBinder(iBinder);
                        return true;
                    case TRANSACTION_runGbaAuthentication /* 12 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_sendSms /* 17 */:
                        ...
                        sendSms(_arg03, _arg15, _arg22, _arg32, _arg42, _arg13, data.createByteArray());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_registerProprietaryImsListener /* 18 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        registerProprietaryImsListener(_arg04, _arg16, _arg23, _arg13);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isCameraAvailable /* 19 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isCameraAvailable = isCameraAvailable();
                        reply.writeNoException();
                        reply.writeInt(isCameraAvailable ? 1 : 0);
                        return true;
                    case TRANSACTION_setMTRedirect /* 20 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_fallBackAospMTFlow /* 21 */:
                        data.enforceInterface(DESCRIPTOR);
                        fallBackAospMTFlow(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setSipHeader /* 22 */:
                        data.enforceInterface(DESCRIPTOR);
                        setSipHeader(data.readInt(), data.readHashMap(getClass().getClassLoader()), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_changeEnabledCapabilities /* 23 */:
                        data.enforceInterface(DESCRIPTOR);
