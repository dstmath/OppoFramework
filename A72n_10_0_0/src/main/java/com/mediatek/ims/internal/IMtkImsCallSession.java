            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 7:
                        ...
                        return true;
                    case TRANSACTION_explicitCallTransfer /* 8 */:
                        data.enforceInterface(DESCRIPTOR);
                        explicitCallTransfer();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_unattendedCallTransfer /* 9 */:
                        data.enforceInterface(DESCRIPTOR);
                        unattendedCallTransfer(data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_deviceSwitch /* 10 */:
                        data.enforceInterface(DESCRIPTOR);
                        deviceSwitch(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_cancelDeviceSwitch /* 11 */:
                        data.enforceInterface(DESCRIPTOR);
                        cancelDeviceSwitch();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_notifyDeviceSwitchFailed /* 12 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_notifyDeviceSwitched /* 13 */:
                        data.enforceInterface(DESCRIPTOR);
                        notifyDeviceSwitched();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_resume /* 14 */:
                        data.enforceInterface(DESCRIPTOR);
                        resume();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_callTerminated /* 15 */:
                        data.enforceInterface(DESCRIPTOR);
                        callTerminated();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getHeaderCallId /* 16 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result4 = getHeaderCallId();
                        reply.writeNoException();
                        reply.writeString(_result4);
                        return true;
                    case TRANSACTION_removeLastParticipant /* 17 */:
                        data.enforceInterface(DESCRIPTOR);
                        removeLastParticipant();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setImsCallMode /* 18 */:
                        data.enforceInterface(DESCRIPTOR);
                        setImsCallMode(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_approveEccRedial /* 19 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg02 = true;
                        }
