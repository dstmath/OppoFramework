...
public final class MMTelSSTransport {
    ...
    private static String[] CB_FACILITY = {"AO", "OI", "OX", "AI", "IR"};
    ...
    private static int[] CF_REASON = {1, 2, 3, 6, 0};
    ...
    private int[] mCachePhoneId = new int[8];
    private SimservType[] mCacheSimserv = new SimservType[8];
    ...
    private long[] mLastQueried = new long[8];
    ...
    public class MMTelSSTransmitter extends Handler implements Runnable {
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:13:0x00c8 */
        /* JADX DEBUG: Multi-variable search result rejected for r18v0, resolved type: com.mediatek.ims.legacy.ss.MMTelSSTransport$MMTelSSTransmitter */
        /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: java.lang.StringBuilder */
        /* JADX DEBUG: Multi-variable search result rejected for r3v3, resolved type: java.lang.StringBuilder */
        ...
        public void handleGetCB(MMTelSSRequest rr) {
            ...
            if (cbType == 1) {
                ...
                cacheIdx = cbType == 2 ? 2 : 8;
            }
            Rlog.d(MMTelSSTransport.LOG_TAG, "handleGetCB() " + MMTelSSTransport.requestToString(reqNo) + ((String) r9) + facility + ", cbType=" + cbTypeToString(cbType) + ", serviceClass=" + serviceClassToString(serviceClass2) + ", phoneId=" + phoneId);
            if (serviceClass2 == 0) {
                try {
                    r9 = cacheIdx;
                    try {
                        response[0] = response[0] | getCB(getCache(r9, phoneId), facility, 1, phoneId);
                        response[0] = response[0] | getCB(getCache(r9, phoneId), facility, 512, phoneId);
                        cacheIdx2 = r9;
                ...
                int cacheIdx6 = cacheIdx;
                response[0] = response[0] | getCB(getCache(cacheIdx6, phoneId), facility, serviceClass2, phoneId);
                cacheIdx2 = cacheIdx6;
            }
            if (exceptionReport != null) {
                int cacheIdx7 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx8 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx9 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx10 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx11 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx12 = cacheIdx2 == 1 ? 1 : 0;
                int cacheIdx13 = cacheIdx2 == 1 ? 1 : 0;
                clearCache(cacheIdx7);
            }
            if (rr.mResult != null) {
                AsyncResult.forMessage(rr.mResult, response, exceptionReport);
                rr.mResult.sendToTarget();
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:145:0x011a */
        /* JADX WARN: Multi-variable type inference failed */
            ...
            if (!MMTelSSUtils.isPreferXcap(phoneId, MMTelSSTransport.this.mContext)) {
                ...
                try {
                    ...
                    if (reason == 5) {
                        ...
                        while (i6 < 4) {
                            try {
                                int newReason3 = MMTelSSTransport.CF_REASON[i6];
                        ...
                        if (reason == 4) {
                            ...
                            while (true) {
                                ...
                                int newReason4 = MMTelSSTransport.CF_REASON[i7];
                                if (MMTelSSTransport.mSSConfig.isNotSupportCFNotRegistered()) {
                                    c = 6;
                                    if (newReason4 == 6) {
                                        needAdd = false;
                    ...
                    if (isEmptyRules) {
                        ...
                        for (Rule rule : resultList) {
                            ...
                            mMTelSSTransmitter2 = this;
                            try {
                                if (mMTelSSTransmitter2.getCFType(rule.getConditions()) == 2 && time > 0) {
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:33:0x0141 */
        /* JADX DEBUG: Multi-variable search result rejected for r28v0, resolved type: com.mediatek.ims.legacy.ss.MMTelSSTransport$MMTelSSTransmitter */
        /* JADX WARN: Multi-variable type inference failed */
            ...
            if (MMTelSSUtils.isPreferXcap(phoneId2, MMTelSSTransport.this.mContext)) {
                if (MMTelSSTransport.this.updateNetworkInitSimServ(phoneId2)) {
                    ...
                    if (lockState == 0 || !(i2 == 5 || i2 == 3 || i2 == 4)) {
                        ...
                        List<Rule> resultOcbList2 = new ArrayList<>();
                        ...
                        if (i2 == 5) {
                            ...
                            while (i6 < i4) {
                                try {
                                    r3 = MMTelSSTransport.CB_FACILITY[i6];
                                    if (i6 < i3) {
                                        cbType2 = i2;
                                        reqNo = reqNo2;
                                        reqNo2 = i3;
                                        ...
                                        try {
                                            r3.addAll(getRuleForSetCB(ocb, r3, serviceClass3, lockState, phoneId2));
                                            i = i6;
                                            str2 = str3;
                                            phoneId = phoneId2;
                                        ...
                                        try {
                                            resultIcbList2 = resultIcbList3;
                                            resultIcbList2.addAll(getRuleForSetCB(icb, r3, serviceClass, lockState, phoneId2));
                            ...
                            if (cbType2 == 3) {
                                ...
                                while (i7 < 3) {
                                    ...
                                    resultOcbList.addAll(getRuleForSetCB(ocb, facility3, serviceClass3, lockState, phoneId2));
                                    i7++;
                                    str4 = str4;
                                }
                                str = str4;
                                ...
                                if (cbType2 == 4) {
                                    ...
                                    try {
                                        resultOcbList.addAll(getRuleForSetCB(ocb, facility, serviceClass3, lockState, phoneId2));
        ...
        public String convertToSeverTime(long[] timeSlot) {
            ...
            for (int i = 0; i < timeSlot.length; i++) {
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm");
                dateFormat.setTimeZone(TimeZone.getTimeZone("GMT+8"));
                timeSlotString = i == 0 ? dateFormat.format(date) : timeSlotString + "," + dateFormat.format(date);
            }
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                try {
                    ...
                    MMTelSSTransport.this.findAndRemoveRequestFromList(rr.mSerial);
                    ...
                    switch (rr.mRequest) {
                        ...
                        case 14:
                            ...
                            break;
                        case MMTelSSTransport.MMTELSS_REQ_SET_CF_TIME_SLOT /* 15 */:
                            handleSetCFInTimeSlot(rr);
                            break;
                        case MMTelSSTransport.MMTELSS_REQ_GET_CF_TIME_SLOT /* 16 */:
    ...
    static String requestToString(int request) {
        switch (request) {
            ...
            case 14:
                return "SET_COLR";
            case MMTELSS_REQ_SET_CF_TIME_SLOT /* 15 */:
                return "SET_CF_TIME_SLOT";
            case MMTELSS_REQ_GET_CF_TIME_SLOT /* 16 */:
