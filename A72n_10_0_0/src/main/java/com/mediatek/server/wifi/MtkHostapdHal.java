...
public class MtkHostapdHal {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:72:?, code lost:
        r1.append("iHostapd.addAccessPoint exception: ");
        r1.append(r0);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:69:0x01a5 A[ExcHandler: IllegalArgumentException (r0v38 'e' java.lang.IllegalArgumentException A[CUSTOM_DECLARE]), Splitter:B:54:0x0179] */
            ...
            try {
                ...
                try {
                    ...
                    if (config.apChannel > 0 && fixChannelFlag == 1) {
                        ifaceParams.channelParams.enableAcs = false;
                        ifaceParams.channelParams.channel = config.apChannel;
                        ifaceParams.channelParams.channel &= 65535;
                    ...
                    try {
                        ...
                        if (iHostapd != null) {
                            return checkStatusAndLogFailure(hostapdHal, iHostapd.addAccessPoint(ifaceParams, nwParams), "addAccessPoint");
                        }
                        Log.e(TAG, "addAccessPoint: Failed to get IHostapd");
                        return false;
                    } catch (RemoteException e) {
                        RemoteException e2 = e;
                        handleRemoteException(hostapdHal, e2, "addAccessPoint");
                        return false;
                    } catch (NoSuchElementException e3) {
                        NoSuchElementException e4 = e3;
    ...
    public static boolean registerCallback(IHostapdCallback callback) {
        ...
        synchronized (getLock(hostapdHal)) {
            ...
            try {
                vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd iHostapd = vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.castFrom((IHwInterface) vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService());
                if (iHostapd != null) {
                    return checkStatusAndLogFailure(hostapdHal, iHostapd.registerCallback(callback), "registerCallback");
                }
    ...
    public static boolean blockClient(String deviceAddress) {
        ...
        synchronized (getLock(hostapdHal)) {
            ...
            try {
                vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd iHostapd = vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.castFrom((IHwInterface) vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService());
                if (iHostapd != null) {
                    return checkStatusAndLogFailure(hostapdHal, iHostapd.blockClient(deviceAddress), "blockClient");
                }
    ...
    public static boolean unblockClient(String deviceAddress) {
        ...
        synchronized (getLock(hostapdHal)) {
            ...
            try {
                vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd iHostapd = vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.castFrom((IHwInterface) vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService());
                if (iHostapd != null) {
                    return checkStatusAndLogFailure(hostapdHal, iHostapd.unblockClient(deviceAddress), "unblockClient");
                }
    ...
    public static boolean updateAllowedList(String acceptMacFileContent) {
        ...
        synchronized (getLock(hostapdHal)) {
            ...
            try {
                vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd iHostapd = vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.castFrom((IHwInterface) vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService());
                if (iHostapd != null) {
                    return checkStatusAndLogFailure(hostapdHal, iHostapd.updateAllowedList(acceptMacFileContent), "updateAllowedList");
                }
    ...
    public static boolean setAllDevicesAllowed(boolean enable) {
        ...
        synchronized (getLock(hostapdHal)) {
            ...
            try {
                vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd iHostapd = vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.castFrom((IHwInterface) vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService());
                if (iHostapd != null) {
                    return checkStatusAndLogFailure(hostapdHal, iHostapd.setAllDevicesAllowed(enable), "setAllDevicesAllowed");
                }
