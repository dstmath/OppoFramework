...
public final class MtkIccFileHandler extends IccFileHandler {
    ...
    public static class MtkLoadLinearFixedContext {
        int mCountRecords;
        int mEfid;
    ...
    /* access modifiers changed from: package-private */
    public static class MtkLoadTransparentContext {
        int mEfid;
        Message mOnLoaded;
        String mPath;
    ...
    public void handleMessage(Message msg) {
        try {
            switch (msg.what) {
                ...
                case 101:
                    ...
                    if (!processException(response2, (AsyncResult) msg.obj)) {
                        ...
                        if (4 != data2[6]) {
                            ...
                            int size = (data2[3] & PplMessageManager.Type.INVALID) + ((data2[2] & PplMessageManager.Type.INVALID) << 8);
                            if (path == null) {
                ...
                case 102:
                    ...
                    if (!processException(lc.mOnLoaded, (AsyncResult) msg.obj)) {
                        ...
                        if (4 != data3[6]) {
                            ...
                            lc.mCountRecords = (((data3[2] & PplMessageManager.Type.INVALID) << 8) + (data3[3] & PplMessageManager.Type.INVALID)) / lc.mRecordSize;
                            if (lc.mLoadAll) {
                ...
                case EVENT_READ_RECORD_DONE_EX /* 103 */:
