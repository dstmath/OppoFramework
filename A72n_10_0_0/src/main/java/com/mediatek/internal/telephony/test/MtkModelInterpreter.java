...
public class MtkModelInterpreter implements Runnable, MtkSimulatedRadioControl {
    static final int CONNECTING_PAUSE_MSEC = 500;
    static final String LOG_TAG = "MtkModelInterpreter";
    ...
    ServerSocket mSS;
    MtkSimulatedGsmCallState mSimulatedCallState;

    public MtkModelInterpreter(InputStream in, OutputStream out) {
    ...
    public MtkModelInterpreter(InetSocketAddress sa) throws IOException {
        this.mPausedResponseMonitor = new Object();
    ...
    private void init() {
        ...
        this.mSimulatedCallState = new MtkSimulatedGsmCallState(this.mHandlerThread.getLooper());
    }
