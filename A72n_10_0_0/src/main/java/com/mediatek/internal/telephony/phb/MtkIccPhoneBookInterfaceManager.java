        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                if (ar.exception == null) {
                    ...
                    MtkIccPhoneBookInterfaceManager.this.mRecords = (List) ar.result;
                ...
                if (success) {
                    ...
                    mtkIccPhoneBookInterfaceManager3.mErrorCause = mtkIccPhoneBookInterfaceManager3.getErrorCauseFromException(ar2.exception);
                } else {
