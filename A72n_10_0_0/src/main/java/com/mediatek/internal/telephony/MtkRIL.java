...
public class MtkRIL extends RIL {
    ...
    public final class MtkRadioExProxyDeathRecipient implements IHwBinder.DeathRecipient {
    ...
    public static String requestToStringEx(Integer request) {
        ...
        if (intValue == 59) {
            ...
            switch (intValue) {
                case MtkGsmCdmaPhone.EVENT_IMS_UT_DONE /* 2000 */:
                ...
                case 2050:
                    ...
                    break;
                case MtkCharacterSets.CP864 /* 2051 */:
                                ...
                                default:
                                    switch (intValue) {
                                        ...
                                        case 2024:
                                            ...
                                            break;
                                        case MtkCharacterSets.GB_2312 /* 2025 */:
                                                ...
                                                default:
                                                    switch (intValue) {
                                                        case 2100:
                                                            ...
                                                            break;
                                                        case MtkCharacterSets.BIG5_HKSCS /* 2101 */:
