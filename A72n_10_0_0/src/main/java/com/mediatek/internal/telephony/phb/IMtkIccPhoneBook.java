            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case TRANSACTION_getUpbDone /* 35 */:
                        ...
                        return true;
                    case TRANSACTION_getAdnRecordsCapacity /* 36 */:
                        data.enforceInterface(DESCRIPTOR);
