...
public class MtkSIMRecords extends SIMRecords {
    ...
    private boolean isMovistarDualSim = false;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: com.mediatek.internal.telephony.uicc.MtkSIMRecords */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.mediatek.internal.telephony.uicc.MtkSIMRecords */
    /* JADX WARN: Multi-variable type inference failed */
    public void dispose() {
                        ...
                        switch (i) {
                            ...
                            case 12:
                                ...
                                if (ar3 != null && ar3.exception == null) {
                                    ...
                                    int displayCondition = data[0] & PplMessageManager.Type.INVALID;
                            ...
                            case 1005:
                                ...
                                if (ar8 != null && ar8.exception == null) {
                                    ...
                                    if (data3 != null && data3.length >= 2) {
                                        int tag = data3[0] & PplMessageManager.Type.INVALID;
                                        int len = data3[1] & PplMessageManager.Type.INVALID;
                                        ...
                                        switch (i) {
                                            ...
                                            default:
                                                switch (i) {
                                                    ...
                                                    case EVENT_GET_ALL_PNN_DONE /* 1028 */:
                                                        isRecordLoadResponse = false;
    ...
    public void handleRefresh(IccRefreshResponse refreshResponse) {
        if (refreshResponse == null) {
            ...
            if (i == 0) {
                ...
                setPhbReady(false);
                if (!this.isMovistarDualSim) {
                    handleFileUpdate(-1);
                } else {
                    Rlog.d("SIMRecords", "handleRefresh: isMovistarDualSim don't handleFileUpdate");
                }
            } else if (i == 4) {
    ...
    public void onAllRecordsLoaded() {
        ...
        if (operator != null) {
            ...
            if (operator.equals("21405") || operator.equals("21407")) {
                Rlog.d("SIMRecords", "onAllRecordsLoaded isMovistarDualSim =" + this.isMovistarDualSim);
                this.isMovistarDualSim = true;
            } else {
                this.isMovistarDualSim = false;
            }
        }
        fetchPnnAndOpl();
        fetchCPHSOns();
