...
public class RadioManager extends Handler {
    ...
    public void notifyAirplaneModeChange(boolean enabled) {
        ...
        if (radioAction == 1) {
            ...
            boolean modemPower = !enabled ? 1 : 0;
            setSilentRebootPropertyForAllModem("1");
            this.mPowerSM.updateModemPowerState(modemPower, this.mBitmapForPhoneCount, 2);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public class MSimModeChangeRunnable implements Runnable {
        int mRetryMode;
    ...
    public class PowerSM extends StateMachine {
        private int mCurrentModemCause = 0;
        public boolean mCurrentModemPower = true;
        private int mDesiredModemCause = 0;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private void updateModemPowerState(boolean power, int phoneBitMap, int cause) {
