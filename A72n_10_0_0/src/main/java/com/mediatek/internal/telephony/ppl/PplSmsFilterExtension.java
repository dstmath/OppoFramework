...
public class PplSmsFilterExtension extends ContextWrapper implements IPplSmsFilter {
    ...
    /* JADX INFO: Multiple debug info for r14v11 int: [D('pduCount' int), D('i' int)] */
    ...
    public boolean pplFilter(Bundle params) {
        ...
        if (messages == null) {
            ...
            MtkSmsMessage[] msgs = new MtkSmsMessage[i2];
            for (int i3 = 0; i3 < i2; i3++) {
                msgs[i3] = MtkSmsMessage.createFromPdu(pdus[i3], format);
            }
