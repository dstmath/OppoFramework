...
public class MtkDataConnection extends DataConnection {
    ...
    private boolean mIsSetupDataCallByCi;
    ...
    static /* synthetic */ int access$21208(MtkDataConnection x0) {
    ...
    public int connect(DataConnection.ConnectionParams cp) {
        ...
        if (OppoTelephonyFactory.getInstance().getFeature(IOppoDataManager.DEFAULT, new Object[0]).handleDataBlockControl(this.mPhone, cp, cp.mApnContext, this, 262145)) {
            return 0;
        }
    ...
    public void tearDownData(Object o) {
        ...
        if (o != null && (o instanceof DataConnection.DisconnectParams)) {
            ...
            if (discReason == 1 && apnContext != null && TextUtils.equals(apnContext.getApnType(), "default") && this.mSubController.getDefaultDataSubId() == this.mPhone.getSubId() && this.mPhone.getDataEnabledSettings().isDataEnabled() && MtkPhoneSwitcher.getInstance().getTempDataSwitchState()) {
                discReason = MtkGsmCdmaPhone.EVENT_GET_CALL_BARRING_COMPLETE;
            }
        }
    ...
    public DataConnection.SetupResult onSetupConnectionCompleted(int resultCode, DataCallResponse response, DataConnection.ConnectionParams cp) {
        ...
        if (cp.mTag != this.mTag) {
        ...
        } else if (response == null || resultCode == 4) {
            DataConnection.SetupResult result2 = DataConnection.SetupResult.ERROR_RADIO_NOT_AVAILABLE;
            result2.mFailCause = 65537;
            result = result2;
            ...
            DataConnection.SetupResult result3 = DataConnection.SetupResult.ERROR_RADIO_NOT_AVAILABLE;
    ...
    private class MtkDcDefaultState extends DataConnection.DcDefaultState {
        ...
        public void exit() {
            ...
            MtkDataConnection.this.mLastFailCause = 0;
            ...
            switch (msg.what) {
                case 262155:
                    if (MtkDataConnection.this.mIsInVoiceCall) {
                        MtkDataConnection.this.mIsSupportConcurrent = MtkDcHelper.getInstance().isDataAllowedForConcurrent(MtkDataConnection.this.mPhone.getPhoneId());
                    }
                    return MtkDataConnection.super.processMessage(msg);
                case MtkDataConnection.EVENT_IPV4_ADDRESS_REMOVED /* 262171 */:
                    if (!MtkDataConnection.VDBG) {
                        return true;
                    }
                    MtkDataConnection.this.log("DcDefaultState: ignore EVENT_IPV4_ADDRESS_REMOVED not in ActiveState");
                    return true;
                case MtkDataConnection.EVENT_IPV6_ADDRESS_REMOVED /* 262172 */:
                    if (!MtkDataConnection.VDBG) {
                        return true;
                    }
                    MtkDataConnection.this.log("DcDefaultState: ignore EVENT_IPV6_ADDRESS_REMOVED not in ActiveState");
                    return true;
                case MtkDataConnection.EVENT_ADDRESS_REMOVED /* 262173 */:
                    if (!MtkDataConnection.VDBG) {
                        return true;
                    }
                    MtkDataConnection.this.log("DcDefaultState: " + MtkDataConnection.this.getWhatToString(msg.what));
                    return true;
                case MtkDataConnection.EVENT_VOICE_CALL /* 262174 */:
                    MtkDataConnection.this.mIsInVoiceCall = msg.arg1 != 0;
                    MtkDataConnection mtkDataConnection = MtkDataConnection.this;
                    if (msg.arg2 == 0) {
                        z = false;
                    }
                    mtkDataConnection.mIsSupportConcurrent = z;
                    return true;
                case MtkDataConnection.EVENT_IPV6_ADDRESS_UPDATED /* 262176 */:
                    if (!MtkDataConnection.VDBG) {
                        return true;
                    }
                    MtkDataConnection.this.log("DcDefaultState: ignore EVENT_IPV6_ADDRESS_UPDATED not in ActiveState");
                    return true;
                case MtkDataConnection.EVENT_UPDATE_NETWORKAGENT_SSC_MODE3 /* 262178 */:
                    if (MtkDataConnection.DBG) {
                    ...
                    return true;
                case MtkDataConnection.EVENT_MTK_NR_STATE_CHANGED /* 262179 */:
            ...
            switch (msg.what) {
                ...
                case 262145:
                    ...
                    if (MtkDataConnection.this.mIsSetupDataCallByCi) {
                        MtkDataConnection.this.mIsSetupDataCallByCi = false;
                    ...
                    DataConnection.SetupResult result = MtkDataConnection.this.onSetupConnectionCompleted(resultCode, dataCallResponse, cp);
                    ...
                    if (i == 1) {
                        MtkDataConnection.this.mDcFailCause = 0;
                        ...
                        if (result.mFailCause == MtkDataConnection.RA_GET_IPV6_VALID_FAIL) {
                            ...
                            MtkDataConnection.this.mDcFailCause = MtkDataConnection.RA_GET_IPV6_VALID_FAIL;
                            MtkDataConnection mtkDataConnection4 = MtkDataConnection.this;
    ...
    private class MtkDcActiveState extends DataConnection.DcActiveState {
        ...
        public void enter() {
            ...
            mtkDataConnection2.mRestrictedNetworkOverride = z;
            MtkDataConnection mtkDataConnection3 = MtkDataConnection.this;
            mtkDataConnection3.mUnmeteredUseOnly = mtkDataConnection3.isUnmeteredUseOnly();
            if (MtkDataConnection.DBG) {
            ...
            if (MtkDataConnection.this.mConnectionParams == null || MtkDataConnection.this.mConnectionParams.mRequestType != 2) {
                ...
                ((MtkDataConnection) dcTracker).mScore = dcTracker.calculateScore();
                ...
                MtkDataConnection mtkDataConnection4 = MtkDataConnection.this;
                mtkDataConnection4.mNetworkAgent = DcNetworkAgent.createDcNetworkAgent(mtkDataConnection4, mtkDataConnection4.mPhone, MtkDataConnection.this.mNetworkInfo, MtkDataConnection.this.mScore, misc, factorySerialNumber, MtkDataConnection.this.mTransportType);
            } else {
                ...
                if (MtkDataConnection.this.mHandoverSourceNetworkAgent != null) {
                    ...
                    MtkDataConnection mtkDataConnection5 = MtkDataConnection.this;
                    mtkDataConnection5.mNetworkAgent = mtkDataConnection5.mHandoverSourceNetworkAgent;
                    DcNetworkAgent dcNetworkAgent = MtkDataConnection.this.mNetworkAgent;
                    MtkDataConnection mtkDataConnection6 = MtkDataConnection.this;
                    dcNetworkAgent.acquireOwnership(mtkDataConnection6, mtkDataConnection6.mTransportType);
                    MtkDataConnection.this.mNetworkAgent.sendNetworkCapabilities(MtkDataConnection.this.getNetworkCapabilities(), MtkDataConnection.this);
                    MtkDataConnection.this.mNetworkAgent.sendLinkProperties(MtkDataConnection.this.mLinkProperties, MtkDataConnection.this);
                    MtkDataConnection.this.mHandoverSourceNetworkAgent = null;
                } else {
                    MtkDataConnection.this.loge("Failed to get network agent from original data connection");
                    return;
                }
            }
            if (((MtkDataConnection) MtkDataConnection.this).mTransportType == 1) {
            ...
            try {
                ...
                iDataConnectionExt.onDcActivated(strArr, str);
            } catch (Exception e2) {
        ...
        public void exit() {
            ...
            try {
                ...
                iDataConnectionExt.onDcDeactivated(strArr, MtkDataConnection.this.mLinkProperties == null ? "" : MtkDataConnection.this.mLinkProperties.getInterfaceName());
            } catch (Exception e) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:121:0x040c, code lost:
            if (0 != 0) goto L_0x040e;
         */
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:128:0x0424, code lost:
            if (1 == 0) goto L_0x0427;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:129:0x0427, code lost:
            if (r0 != null) goto L_0x042c;
         */
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:132:0x0443, code lost:
            if (r5 == com.android.internal.telephony.dataconnection.DataConnection.SetupResult.ERROR_STALE) goto L_0x0471;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:134:0x044b, code lost:
            if (r12.this$0.mConnectionParams == r0) goto L_0x0471;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:135:0x044d, code lost:
            r12.this$0.loge("DcActiveState_FALLBACK_Retry: WEIRD mConnectionsParams:" + r12.this$0.mConnectionParams + " != cp:" + r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:137:0x0475, code lost:
            if (com.mediatek.internal.telephony.dataconnection.MtkDataConnection.DBG == false) goto L_0x0495;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:138:0x0477, code lost:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:149:0x04dd, code lost:
            r1 = "DcActiveState_FALLBACK_Retry: ERROR_DATA_SERVICE_SPECIFIC_ERROR result=" + r5 + " result.isRadioRestartFailure=" + android.telephony.DataFailCause.isRadioRestartFailure(r12.this$0.mPhone.getContext(), r5.mFailCause, r12.this$0.mPhone.getSubId()) + " result.isPermanentFailure=" + r12.this$0.mDct.isPermanentFailure(r5.mFailCause);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:150:0x0528, code lost:
            if (com.mediatek.internal.telephony.dataconnection.MtkDataConnection.DBG == false) goto L_0x052f;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:151:0x052a, code lost:
            r12.this$0.log(r1);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:153:0x0533, code lost:
            if (r5.mFailCause != com.mediatek.internal.telephony.dataconnection.MtkDataConnection.RA_GET_IPV6_VALID_FAIL) goto L_0x0585;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:155:0x0539, code lost:
            if (r12.this$0.mDcFcMgr == null) goto L_0x059e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:157:0x0545, code lost:
            if (r12.this$0.mDcFcMgr.isSpecificNetworkAndSimOperator(com.mediatek.internal.telephony.dataconnection.DcFailCauseManager.Operator.OP19) == false) goto L_0x059e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:158:0x0547, code lost:
            com.mediatek.internal.telephony.dataconnection.MtkDataConnection.access$21208(r12.this$0);
            r8 = r12.this$0.mDcFcMgr.getRetryTimeByIndex(r12.this$0.mRetryCount, com.mediatek.internal.telephony.dataconnection.DcFailCauseManager.Operator.OP19);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:159:0x0560, code lost:
            if (r8 >= 0) goto L_0x0575;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:161:0x0566, code lost:
            if (com.mediatek.internal.telephony.dataconnection.MtkDataConnection.DBG == false) goto L_0x056f;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:162:0x0568, code lost:
            r12.this$0.log("DcActiveState_FALLBACK_Retry: No retry but at least one IPv4 or IPv6 is accepted");
         */
        /* JADX WARNING: Code restructure failed: missing block: B:163:0x056f, code lost:
            r12.this$0.mDcFailCause = 0;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:164:0x0575, code lost:
            r12.this$0.mDcFailCause = com.mediatek.internal.telephony.dataconnection.MtkDataConnection.RA_GET_IPV6_VALID_FAIL;
            r4 = r12.this$0;
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:166:0x0589, code lost:
            if (com.mediatek.internal.telephony.dataconnection.MtkDataConnection.DBG == false) goto L_0x059e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:167:0x058b, code lost:
            r12.this$0.log("DcActiveState_FALLBACK_Retry: ERROR_DATA_SERVICE_SPECIFIC_ERROR Not retry anymore");
         */
        /* JADX WARNING: Code restructure failed: missing block: B:168:0x0593, code lost:
            r12.this$0.mDcFailCause = 0;
            r12.this$0.resetRetryCount();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:169:0x059e, code lost:
            return true;
         */
        public boolean processMessage(Message msg) {
            boolean z = true;
            switch (msg.what) {
                ...
                case 262148:
                    ...
                    if (MtkDataConnection.this.mApnContexts.containsKey(dp.mApnContext)) {
                        ...
                        if (MtkDataConnection.this.mApnContexts.size() == 1) {
                            ...
                            MtkDataConnection.this.mApnContexts.clear();
                            MtkDataConnection.this.mDisconnectParams = dp;
                            ...
                            MtkDataConnection.this.checkIfDefaultApnReferenceCountChanged();
                            MtkDataConnection.this.mDct.mtkDeactivateDataCall(dp.mApnContext);
                            MtkDataConnection.this.notifyDisconnectCompleted(dp, false);
                        }
                    } else {
                ...
                case 262153:
                    if (MtkDataConnection.DBG) {
                        MtkDataConnection.this.log("DcActiveState EVENT_LOST_CONNECTION dc=" + MtkDataConnection.this);
                    }
                    if (MtkDataConnection.this.mCause == 3111 || MtkDataConnection.this.mCause == 3367 || MtkDataConnection.this.mCause == 3982 || MtkDataConnection.this.mCause == 6695) {
                        MtkDataConnection.this.mInactiveState.setEnterNotificationParams(3982);
                    } else {
                        MtkDataConnection.this.mInactiveState.setEnterNotificationParams(65540);
                    }
                    MtkDataConnection mtkDataConnection2 = MtkDataConnection.this;
                    mtkDataConnection2.transitionTo(mtkDataConnection2.mInactiveState);
                    return true;
                ...
                case MtkDataConnection.EVENT_IPV6_ADDRESS_REMOVED /* 262172 */:
                    ...
                    if (MtkDataConnection.this.mInterfaceName != null && MtkDataConnection.this.mInterfaceName.equals(addrV6Info.mIntfName)) {
                        ...
                        if (strAddress.equalsIgnoreCase("FE80::5A:5A:5A:23")) {
                            MtkDataConnection.this.mValid = -1;
                        } else if (strAddress.equalsIgnoreCase("FE80::5A:5A:5A:22")) {
                            MtkDataConnection.this.mValid = -2;
                        } else {
                            MtkDataConnection.this.mValid = -1000;
                        }
                ...
                case MtkDataConnection.EVENT_VOICE_CALL /* 262174 */:
                    ...
                    mtkDataConnection3.mIsSupportConcurrent = z;
                    MtkDataConnection.this.updateNetworkInfoSuspendState();
                    if (MtkDataConnection.this.mNetworkAgent != null) {
                        MtkDataConnection.this.mNetworkAgent.sendNetworkInfo(MtkDataConnection.this.mNetworkInfo);
                    }
                    return true;
                case MtkDataConnection.EVENT_FALLBACK_RETRY_CONNECTION /* 262175 */:
                    if (msg.arg1 == MtkDataConnection.this.mTag) {
                        if (MtkDataConnection.this.mDataRegState == 0) {
                            ...
                            MtkDataConnection mtkDataConnection4 = MtkDataConnection.this;
                            mtkDataConnection4.connect(mtkDataConnection4.mConnectionParams);
                        } else if (MtkDataConnection.DBG) {
                ...
                case MtkDataConnection.EVENT_IPV6_ADDRESS_UPDATED /* 262176 */:
                    ...
                    if (MtkDataConnection.this.mInterfaceName != null && MtkDataConnection.this.mInterfaceName.equals(addrV6Info2.mIntfName)) {
                        ...
                        if (OsConstants.RT_SCOPE_UNIVERSE != scope || (flag & 1) == OsConstants.IFA_F_TEMPORARY || MtkDataConnection.this.mNetworkAgent == null) {
                            ...
                            MtkDataConnection.this.mGlobalV6AddrInfo = addrV6Info2;
                            MtkDataConnection.this.mNetworkAgent.sendLinkProperties(MtkDataConnection.this.mtkGetLinkProperties(), MtkDataConnection.this);
    ...
    private void onSetupFallbackConnection(DataCallResponse response, DataConnection.ConnectionParams cp) {
        if (cp.mTag != this.mTag) {
            if (DBG) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean canSendNetworkCapabilities() {
        if (MtkDcHelper.isPreferredDataPhone(this.mPhone)) {
            return true;
        }
        for (DataConnection.ConnectionParams cp : this.mApnContexts.values()) {
    ...
    public void setLostConnectionCause(int cause) {
        this.mCause = cause;
    }
