            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 15:
                        ...
                        repollIccStateForNetworkLock(_arg0, _arg14);
                        reply.writeNoException();
                        return true;
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_selfActivationAction /* 41 */:
                        ...
                        int _result26 = selfActivationAction(_arg02, _arg1, data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result26);
                        return true;
                    case TRANSACTION_getSelfActivateState /* 42 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result27 = getSelfActivateState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result27);
                        return true;
                    case TRANSACTION_getPCO520State /* 43 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result28 = getPCO520State(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result28);
                        return true;
                    case TRANSACTION_exitEmergencyCallbackMode /* 44 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean exitEmergencyCallbackMode = exitEmergencyCallbackMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(exitEmergencyCallbackMode ? 1 : 0);
                        return true;
                    case TRANSACTION_setApcModeUsingSlotId /* 45 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setApcModeUsingSlotId(_arg03, _arg15, _arg14, data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getApcInfoUsingSlotId /* 46 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getCdmaSubscriptionActStatus /* 47 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result30 = getCdmaSubscriptionActStatus(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result30);
                        return true;
                    case TRANSACTION_setIsLastEccIms /* 48 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg14 = true;
                        }
                        setIsLastEccIms(_arg14);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getIsLastEccIms /* 49 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isLastEccIms = getIsLastEccIms();
                        reply.writeNoException();
                        reply.writeInt(isLastEccIms ? 1 : 0);
                        return true;
                    case TRANSACTION_invokeOemRilRequestRaw /* 50 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        int _result31 = invokeOemRilRequestRaw(_arg04, _arg12);
                        reply.writeNoException();
                        reply.writeInt(_result31);
                        reply.writeByteArray(_arg12);
                        return true;
                    case TRANSACTION_invokeOemRilRequestRawBySlot /* 51 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        int _result32 = invokeOemRilRequestRawBySlot(_arg05, _arg16, _arg2);
                        reply.writeNoException();
                        reply.writeInt(_result32);
                        reply.writeByteArray(_arg2);
                        return true;
                    case TRANSACTION_isInCsCall /* 52 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isInCsCall = isInCsCall(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isInCsCall ? 1 : 0);
                        return true;
                    case TRANSACTION_getAllCellInfo /* 53 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_selectFemtoCell /* 59 */:
                        ...
                        boolean selectFemtoCell = selectFemtoCell(_arg07, _arg13);
                        reply.writeNoException();
                        reply.writeInt(selectFemtoCell ? 1 : 0);
                        return true;
                    case TRANSACTION_queryFemtoCellSystemSelectionMode /* 60 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result37 = queryFemtoCellSystemSelectionMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result37);
                        return true;
                    case TRANSACTION_setFemtoCellSystemSelectionMode /* 61 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 64:
                        ...
                        return true;
                    case TRANSACTION_setupPdnByType /* 65 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean z = setupPdnByType(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(z ? 1 : 0);
                        return true;
                    case TRANSACTION_getServiceStateByPhoneId /* 66 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getSuggestedPlmnList /* 69 */:
                        ...
                        return true;
                    case TRANSACTION_getMobileDataUsage /* 70 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 71:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isEmergencyNumber /* 72 */:
                        data.enforceInterface(DESCRIPTOR);
