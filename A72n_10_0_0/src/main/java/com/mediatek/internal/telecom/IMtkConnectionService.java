...
public interface IMtkConnectionService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMtkConnectionService {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 2:
                        ...
                        return true;
                    case TRANSACTION_clearMtkConnectionServiceAdapter /* 3 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 4:
                        ...
                        return true;
                    case TRANSACTION_handleOrderedOperation /* 5 */:
                        data.enforceInterface(DESCRIPTOR);
                        handleOrderedOperation(data.readString(), data.readString(), data.readString());
                        return true;
                    case TRANSACTION_explicitCallTransfer /* 6 */:
                        data.enforceInterface(DESCRIPTOR);
                        explicitCallTransfer(data.readString());
                        return true;
                    case TRANSACTION_blindAssuredEct /* 7 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 8:
                        ...
                        return true;
                    case TRANSACTION_createConference /* 9 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        return true;
                    case TRANSACTION_rejectWithCause /* 10 */:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IMtkConnectionService {
