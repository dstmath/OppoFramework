...
public interface IMultiWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMultiWindowManager {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case TRANSACTION_appErrorHandling /* 28 */:
                        ...
                        int _result3 = appErrorHandling(_arg03, _arg1, _arg2);
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case TRANSACTION_isSticky /* 29 */:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isSticky = isSticky(data.readStrongBinder());
                        reply.writeNoException();
                        reply.writeInt(isSticky ? 1 : 0);
                        return true;
                    case TRANSACTION_activityCreated /* 30 */:
                        data.enforceInterface(DESCRIPTOR);
                        activityCreated(data.readStrongBinder());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_taskAdded /* 31 */:
                        data.enforceInterface(DESCRIPTOR);
                        taskAdded(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_taskRemoved /* 32 */:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IMultiWindowManager {
