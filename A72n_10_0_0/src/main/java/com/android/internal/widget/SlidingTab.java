...
public class SlidingTab extends ViewGroup {
    ...
    public static class Slider {
        ...
        /* JADX INFO: Multiple debug info for r9v2 int: [D('left' int), D('targetDrawable' android.graphics.drawable.Drawable)] */
        /* JADX INFO: Multiple debug info for r15v8 int: [D('targetRight' int), D('rightTarget' int)] */
        /* access modifiers changed from: package-private */
