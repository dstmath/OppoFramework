            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        boolean z = getBoolean(_arg03, _arg1, data.readInt());
                        reply.writeNoException();
                    ...
                    case 7:
                        ...
                        setLockCredential(_arg04, _arg12, _arg22, _arg3, _arg4, _arg1);
                        reply.writeNoException();
                        return true;
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        setSeparateProfileChallengeEnabled(_arg05, _arg1, data.createByteArray());
                        reply.writeNoException();
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 39:
                        ...
                        byte[] _result16 = startRecoverySessionWithCertPath(_arg06, _arg13, _arg2, data.createByteArray(), data.createByteArray(), data.createTypedArrayList(KeyChainProtectionParams.CREATOR));
                        reply.writeNoException();
