    ...
    public void onPointerEvent(MotionEvent event) {
        ...
        for (int i7 = 0; i7 < NI; i7++) {
            ...
            if (ps != null) {
                ...
                ps.mToolType = event.getToolType(i7);
                if (ps.mHasBoundingBox) {
                    c = ' ';
                    ps.mBoundingLeft = event.getAxisValue(32, i7);
                    ps.mBoundingTop = event.getAxisValue(33, i7);
                    ps.mBoundingRight = event.getAxisValue(34, i7);
                    ps.mBoundingBottom = event.getAxisValue(35, i7);
                } else {
                    c = ' ';
                }
            } else {
