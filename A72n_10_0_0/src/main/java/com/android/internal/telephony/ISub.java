...
public interface ISub extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISub {
        ...
        static final int TRANSACTION_activateSubId = 51;
        ...
        static final int TRANSACTION_deactivateSubId = 52;
        static final int TRANSACTION_getAccessibleSubscriptionInfoList = 10;
        static final int TRANSACTION_getActiveDataSubscriptionId = 32;
        ...
        static final int TRANSACTION_getDefaultDataSubId = 33;
        ...
        static final int TRANSACTION_getOperatorNumericForData = 55;
        ...
        static final int TRANSACTION_getSoftSimCardSlotId = 50;
        static final int TRANSACTION_getSubId = 28;
        static final int TRANSACTION_getSubState = 53;
        ...
        static final int TRANSACTION_isCTCCard = 48;
        static final int TRANSACTION_isHasSoftSimCard = 49;
        static final int TRANSACTION_isSubscriptionEnabled = 43;
        static final int TRANSACTION_isUsimWithCsim = 54;
        ...
        static final int TRANSACTION_setAlwaysAllowMmsData = 47;
        static final int TRANSACTION_setDataRoaming = 18;
        static final int TRANSACTION_setDefaultDataSubId = 34;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 19:
                        ...
                        int _result18 = setOpportunistic(_arg13, data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 21:
                        ...
                        setPreferredDataSubscriptionId(_arg02, _arg13, ISetOpportunisticDataCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 24:
                        ...
                        removeSubscriptionsFromGroup(_arg03, _arg1, data.readString());
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        addSubscriptionsIntoGroup(_arg04, _arg12, data.readString());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                        int _result28 = getActiveDataSubscriptionId();
                        reply.writeNoException();
                        reply.writeInt(_result28);
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        int _result29 = getDefaultDataSubId();
                        reply.writeNoException();
                    ...
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                        int _result30 = getDefaultVoiceSubId();
                        reply.writeNoException();
                    ...
                    case 37:
                        data.enforceInterface(DESCRIPTOR);
                        int _result31 = getDefaultSmsSubId();
                        reply.writeNoException();
                    ...
                    case 39:
                        ...
                        int[] _result32 = getActiveSubIdList(_arg13);
                        reply.writeNoException();
                        reply.writeIntArray(_result32);
                        return true;
                    case 40:
                        data.enforceInterface(DESCRIPTOR);
                        int _result33 = setSubscriptionProperty(data.readInt(), data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result33);
                        return true;
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
                        String _result34 = getSubscriptionProperty(data.readInt(), data.readString(), data.readString());
                        reply.writeNoException();
                    ...
                    case 42:
                        ...
                        boolean subscriptionEnabled = setSubscriptionEnabled(_arg13, data.readInt());
                        reply.writeNoException();
                    ...
                    case 44:
                        data.enforceInterface(DESCRIPTOR);
                        int _result35 = getEnabledSubscriptionId(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result35);
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        int _result36 = getSimStateForSlotIndex(data.readInt());
                        reply.writeNoException();
                    ...
                    case 47:
                        ...
                        boolean alwaysAllowMmsData = setAlwaysAllowMmsData(_arg05, _arg13);
                        reply.writeNoException();
                        reply.writeInt(alwaysAllowMmsData ? 1 : 0);
                        return true;
                    case 48:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isCTCCard = isCTCCard(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isCTCCard ? 1 : 0);
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isHasSoftSimCard = isHasSoftSimCard();
                        reply.writeNoException();
                        reply.writeInt(isHasSoftSimCard ? 1 : 0);
                        return true;
                    case 50:
                        data.enforceInterface(DESCRIPTOR);
                        int _result37 = getSoftSimCardSlotId();
                        reply.writeNoException();
                    ...
                    case 53:
                        data.enforceInterface(DESCRIPTOR);
                        int _result38 = getSubState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result38);
                        return true;
                    case 54:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isUsimWithCsim = isUsimWithCsim(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(isUsimWithCsim ? 1 : 0);
                        return true;
                    case 55:
                        data.enforceInterface(DESCRIPTOR);
                        String _result39 = getOperatorNumericForData(data.readInt());
                        reply.writeNoException();
            ...
            public boolean isCTCCard(int slotId) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(48, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isCTCCard(slotId);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean isHasSoftSimCard() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(49, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isHasSoftSimCard();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public int getSoftSimCardSlotId() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(50, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getSoftSimCardSlotId();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int getSubState(int subId) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(53, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getSubState(subId);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public boolean isUsimWithCsim(int slotId) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(54, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isUsimWithCsim(slotId);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public String getOperatorNumericForData(int phoneId) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(55, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getOperatorNumericForData(phoneId);
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
