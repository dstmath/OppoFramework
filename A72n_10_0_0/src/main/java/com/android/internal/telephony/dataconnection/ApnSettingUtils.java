...
public class ApnSettingUtils {
    ...
    public static boolean mvnoMatches(IccRecords r, int mvnoType, String mvnoMatchData) {
        ...
        } else if (mvnoType == 1 && !isNrjChangeToProximus(r)) {
    ...
    public static boolean isNrjChangeToProximus(IccRecords r) {
        if (r == null || r.getIMSI() == null || !r.getIMSI().startsWith("20601") || !"4E524A31".equals(r.getGid1()) || r.getIccId() == null || !r.getIccId().startsWith("893326")) {
            return false;
        }
        return true;
    }
