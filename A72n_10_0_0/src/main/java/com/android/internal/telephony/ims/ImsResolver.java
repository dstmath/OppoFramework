...
public class ImsResolver implements ImsServiceController.ImsServiceControllerCallbacks {
    ...
    private BroadcastReceiver mAppChangedReceiver = new BroadcastReceiver() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass1 */
    ...
    private BroadcastReceiver mConfigChangedReceiver = new BroadcastReceiver() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass2 */
    ...
    private ImsServiceFeatureQueryManager.Listener mDynamicQueryListener = new ImsServiceFeatureQueryManager.Listener() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass7 */
        ...
        public void onError(ComponentName name) {
            ...
            ImsResolver.this.scheduleQueryForFeatures((ImsResolver) name, (ComponentName) ImsResolver.DELAY_DYNAMIC_QUERY_MS);
        }
    };
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
        /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$pNx4XUM9FmR6cV_MCAGiEt8F4pg */

        public final boolean handleMessage(Message message) {
            return ImsResolver.this.lambda$new$0$ImsResolver(message);
        }
    });
    private ImsServiceControllerFactory mImsServiceControllerFactory = new ImsServiceControllerFactory() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass4 */
    ...
    private ImsServiceControllerFactory mImsServiceControllerFactoryCompat = new ImsServiceControllerFactory() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass5 */
    ...
    private ImsServiceControllerFactory mImsServiceControllerFactoryStaticBindingCompat = new ImsServiceControllerFactory() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass6 */
    ...
    private SubscriptionManagerProxy mSubscriptionManagerProxy = new SubscriptionManagerProxy() {
        /* class com.android.internal.telephony.ims.ImsResolver.AnonymousClass3 */
    ...
    public static class ImsServiceInfo {
        ...
        public boolean equals(Object o) {
            ...
            if (componentName == null ? that.name != null : !componentName.equals(that.name)) {
                return false;
            }
            ...
            if (imsServiceControllerFactory != null) {
                return imsServiceControllerFactory.equals(that.controllerFactory);
            }
            if (that.controllerFactory == null) {
                return true;
            }
            return false;
        }
    ...
    public /* synthetic */ boolean lambda$new$0$ImsResolver(Message msg) {
        int i = msg.what;
        if (i == 0) {
            maybeAddedImsService((String) msg.obj);
        } else if (i == 1) {
            maybeRemovedImsService((String) msg.obj);
        } else if (i == 2) {
            carrierConfigChanged(((Integer) msg.obj).intValue());
        } else if (i == 3) {
            startDynamicQuery((ImsServiceInfo) msg.obj);
        } else if (i != 4) {
            ...
            if (isCarrierImsService) {
                ...
                if (!TextUtils.equals(this.mDeviceService, packageName)) {
                    unbindImsService(getImsServiceInfoFromCache(this.mDeviceService));
                    this.mDeviceService = packageName;
                    ImsServiceInfo deviceInfo = getImsServiceInfoFromCache(this.mDeviceService);
                    if (deviceInfo != null) {
            ...
            args.recycle();
            dynamicQueryComplete((ComponentName) args.arg1, (Set) args.arg2);
        }
        return true;
    }
    ...
    public ImsResolver(Context context, String defaultImsPackageName, int numSlots, boolean isDynamicBinding) {
        ...
        this.mBoundImsServicesByFeature = (List) Stream.generate($$Lambda$WVd6ghNMbVDukmkxia3ZwNeZzEY.INSTANCE).limit((long) this.mNumSlots).collect(Collectors.toList());
        if (this.mIsDynamicBinding) {
    ...
    public boolean overrideImsServiceConfiguration(int slotId, boolean isCarrierService, String packageName) {
        if (slotId < 0 || slotId >= this.mNumSlots) {
            ...
            Message.obtain(this.mHandler, 5, slotId, isCarrierService ? 1 : 0, packageName).sendToTarget();
            return true;
        }
    }
    ...
    private ImsServiceController getControllerByServiceInfo(Map<ComponentName, ImsServiceController> searchMap, ImsServiceInfo matchValue) {
        return searchMap.values().stream().filter(new Predicate() {
            /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$aWLlEvfonhYSfDR8cVsM6A5pmqI */
    ...
    private ImsServiceInfo getInfoByPackageName(Map<ComponentName, ImsServiceInfo> searchMap, String matchValue) {
        return searchMap.values().stream().filter(new Predicate(matchValue) {
            /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$rPjfocpARQ2sab24iic4o3kTTgw */
    ...
    private void unbindImsService(ImsServiceInfo info) {
        ...
        if (info != null && (controller = getControllerByServiceInfo(this.mActiveControllers, info)) != null) {
            try {
    ...
    private HashSet<ImsFeatureConfiguration.FeatureSlotPair> calculateFeaturesToCreate(ImsServiceInfo info) {
        ...
        if (slotId != -1) {
            imsFeaturesBySlot.addAll((Collection) info.getSupportedFeatures().stream().filter(new Predicate(slotId) {
                /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$jFhgP_NotuFSwzjQBXWuvls4x4 */
            ...
            for (int i = 0; i < this.mNumSlots; i++) {
                ...
                if (carrierImsInfo == null) {
                    imsFeaturesBySlot.addAll((Collection) info.getSupportedFeatures().stream().filter(new Predicate(i) {
                        /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$VfY5To_kbbTJevLzywTg_S1JhA */
                        private final /* synthetic */ int f$0;
                    ...
                    imsFeaturesBySlot.addAll((Collection) deviceFeatures.stream().filter(new Predicate(i) {
                        /* class com.android.internal.telephony.ims.$$Lambda$ImsResolver$kF808g2NWzNL8H1SwzDc1FxiQdQ */
                        private final /* synthetic */ int f$0;
    ...
    private void updateBoundCarrierServices(int slotId, String newPackageName) {
        if (slotId > -1 && slotId < this.mNumSlots) {
            String[] strArr = this.mCarrierServices;
            String oldPackageName = strArr[slotId];
            strArr[slotId] = newPackageName;
    ...
    public ImsServiceInfo getImsServiceInfoFromCache(String packageName) {
        ImsServiceInfo infoFilter;
        if (!TextUtils.isEmpty(packageName) && (infoFilter = getInfoByPackageName(this.mInstalledServicesCache, packageName)) != null) {
            return infoFilter;
        }
        return null;
    }
