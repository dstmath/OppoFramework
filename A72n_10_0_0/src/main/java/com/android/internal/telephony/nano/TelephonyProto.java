                        ...
                        switch (value2) {
                            default:
                                switch (value2) {
                                    ...
                                    case RilErrno.RIL_E_NOT_PROVISIONED /* 62 */:
                                    case 63:
                                    case 64:
                                    case 65:
                                    case 66:
            ...
            public Event mergeFrom(CodedInputByteBufferNano input) throws IOException {
                while (true) {
                    ...
                    switch (tag) {
                        ...
                        case TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_APN_TYPE_CONFLICT /* 112 */:
                        ...
                        case TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IFACE_AND_POL_FAMILY_MISMATCH /* 120 */:
