...
public abstract class IccFileHandler extends Handler implements IccConstants {
    ...
    public void loadEFImgLinearFixed(int recordNum, Message onLoaded) {
        this.mCi.iccIOForApp(192, IccConstants.EF_IMG, getEFPath(IccConstants.EF_IMG), recordNum, 4, 15, null, null, this.mAid, obtainMessage(11, new LoadLinearFixedContext((int) IccConstants.EF_IMG, recordNum, onLoaded)));
    }
    ...
    /* access modifiers changed from: protected */
    public boolean processException(Message response, AsyncResult ar) {
    ...
    public void oppoReadEFLinearFixedRecord(int fileid, int recordNum, int recordSize, Message onLoaded) {
        this.mCi.iccIO(178, fileid, getEFPath(fileid), recordNum, 4, recordSize, null, null, obtainMessage(7, new LoadLinearFixedContext(fileid, recordNum, onLoaded)));
    }
}
