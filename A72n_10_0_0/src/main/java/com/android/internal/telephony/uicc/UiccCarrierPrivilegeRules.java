...
public class UiccCarrierPrivilegeRules extends Handler {
    ...
    public static class TLV {
        ...
        public String parseLength(String data) {
            try {
                ...
                Rlog.d(UiccCarrierPrivilegeRules.LOG_TAG, e.toString());
            } catch (Exception e2) {
                Rlog.d(UiccCarrierPrivilegeRules.LOG_TAG, e2.toString());
            }
    ...
    public void handleMessage(Message msg) {
        ...
        if (i == 1) {
            ...
            if (ar.exception == null && ar.result != null) {
                ...
                uiccProfile.iccTransmitApduLogicalChannel(i2, 128, COMMAND, 255, 64, 0, "", obtainMessage(2, i2, this.mAIDInUse));
            ...
            if (ar2.exception != null || ar2.result == null) {
                ...
                String errorMsg2 = ar2.exception instanceof CommandException ? errorMsg + "error code : " + ((CommandException) ar2.exception).getCommandError() : errorMsg + "unknown exception : " + ar2.exception.getMessage();
                if (this.mAIDInUse == 0) {
                    updateStatusMessage(errorMsg2);
                } else {
                    updateState(2, errorMsg2);
                }
            } else {
    ...
    public void updateState(int newState, String statusMessage) {
