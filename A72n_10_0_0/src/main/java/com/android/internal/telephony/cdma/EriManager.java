...
public class EriManager {
    ...
    private void loadEriFileFromXml() {
        ...
        try {
            ...
            stream = new FileInputStream(r.getString(17039486));
        ...
        if (parser == null) {
            ...
            try {
                ...
                Rlog.e(LOG_TAG, "loadEriFileFromXml: no parser for " + eriFile + ". Exception = " + e3.toString());
            }
        }
        try {
    ...
    private EriDisplayInformation getEriDisplayInformation(int roamInd, int defRoamInd) {
        ...
        switch (roamInd) {
            case 0:
                return new EriDisplayInformation(0, 0, this.mContext.getText(17040943).toString());
            case 1:
                return new EriDisplayInformation(1, 0, this.mContext.getText(17040944).toString());
            case 2:
                return new EriDisplayInformation(2, 1, this.mContext.getText(17040948).toString());
            case 3:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040949).toString());
            case 4:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040950).toString());
            case 5:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040951).toString());
            case 6:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040952).toString());
            case 7:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040953).toString());
            case 8:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040954).toString());
            case 9:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040955).toString());
            case 10:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040945).toString());
            case 11:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040946).toString());
            case 12:
                return new EriDisplayInformation(roamInd, 0, this.mContext.getText(17040947).toString());
            default:
