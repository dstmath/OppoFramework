...
public interface ISms extends IInterface {
    ...
    public static class Default implements ISms {
        ...
        @Override // com.android.internal.telephony.ISms
        public void sendMultipartTextForSubscriberWithOptionsOem(int subId, String callingPkg, String destinationAddress, String scAddress, List<String> list, List<PendingIntent> list2, List<PendingIntent> list3, boolean persistMessageForNonDefaultSmsApp, int priority, boolean expectMore, int validityPeriod, int encodingType) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ISms {
        ...
        static final int TRANSACTION_checkSmsShortCodeDestination = 32;
        static final int TRANSACTION_copyMessageToIccEfForSubscriber = 3;
        static final int TRANSACTION_createAppSpecificSmsToken = 29;
        static final int TRANSACTION_createAppSpecificSmsTokenWithPackageInfo = 30;
        static final int TRANSACTION_disableCellBroadcastForSubscriber = 15;
        static final int TRANSACTION_disableCellBroadcastRangeForSubscriber = 17;
        static final int TRANSACTION_enableCellBroadcastForSubscriber = 14;
        static final int TRANSACTION_enableCellBroadcastRangeForSubscriber = 16;
        ...
        static final int TRANSACTION_getPremiumSmsPermission = 18;
        static final int TRANSACTION_getPremiumSmsPermissionForSubscriber = 19;
        static final int TRANSACTION_getSmsMessagesForFinancialApp = 31;
        static final int TRANSACTION_injectSmsPduForSubscriber = 10;
        static final int TRANSACTION_isImsSmsSupportedForSubscriber = 22;
        static final int TRANSACTION_isSMSPromptEnabled = 26;
        static final int TRANSACTION_isSmsSimPickActivityNeeded = 23;
        ...
        static final int TRANSACTION_sendMultipartTextForSubscriber = 11;
        static final int TRANSACTION_sendMultipartTextForSubscriberWithOptions = 12;
        static final int TRANSACTION_sendMultipartTextForSubscriberWithOptionsOem = 13;
        ...
        static final int TRANSACTION_sendTextForSubscriberWithOptionsOem = 9;
        static final int TRANSACTION_sendTextForSubscriberWithSelfPermissions = 7;
        static final int TRANSACTION_setPremiumSmsPermission = 20;
        static final int TRANSACTION_setPremiumSmsPermissionForSubscriber = 21;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            PendingIntent _arg66;
            PendingIntent _arg3;
            Uri _arg2;
            PendingIntent _arg4;
            PendingIntent _arg55;
            Uri _arg22;
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 4:
                        ...
                        sendDataForSubscriber(_arg0, _arg1, _arg25, _arg33, _arg42, _arg56, _arg6, _arg7);
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        sendDataForSubscriberWithSelfPermissions(_arg02, _arg12, _arg26, _arg34, _arg43, _arg57, _arg62, _arg72);
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 9:
                        ...
                        if (data.readInt() != 0) {
                            _arg66 = PendingIntent.CREATOR.createFromParcel(data);
                        } else {
                            _arg66 = null;
                        }
                        sendTextForSubscriberWithOptionsOem(_arg06, _arg16, _arg210, _arg38, _arg47, _arg54, _arg66, data.readInt() != 0, data.readInt(), data.readInt() != 0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        injectSmsPduForSubscriber(_arg07, _arg17, _arg211, _arg3);
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                        sendMultipartTextForSubscriberWithOptionsOem(data.readInt(), data.readString(), data.readString(), data.readString(), data.createStringArrayList(), data.createTypedArrayList(PendingIntent.CREATOR), data.createTypedArrayList(PendingIntent.CREATOR), data.readInt() != 0, data.readInt(), data.readInt() != 0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 27:
                        ...
                        if (data.readInt() != 0) {
                            _arg55 = PendingIntent.CREATOR.createFromParcel(data);
                        } else {
                            _arg55 = null;
                        }
                        sendStoredText(_arg08, _arg18, _arg2, _arg39, _arg4, _arg55);
                        reply.writeNoException();
                        return true;
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        sendStoredMultipartText(_arg09, _arg19, _arg22, data.readString(), data.createTypedArrayList(PendingIntent.CREATOR), data.createTypedArrayList(PendingIntent.CREATOR));
                        reply.writeNoException();
                        return true;
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        String _result6 = createAppSpecificSmsToken(_arg010, _arg110, _arg23);
                        reply.writeNoException();
                    ...
                    case 30:
                        ...
                        String _result7 = createAppSpecificSmsTokenWithPackageInfo(_arg011, _arg111, _arg212, _arg32);
                        reply.writeNoException();
                    ...
                    case 31:
                        ...
                        getSmsMessagesForFinancialApp(_arg012, _arg112, _arg24, IFinancialSmsCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = checkSmsShortCodeDestination(data.readInt(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
        ...
        public static class Proxy implements ISms {
            ...
            public void sendTextForSubscriberWithOptionsOem(int subId, String callingPkg, String destAddr, String scAddr, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, boolean persistMessageForNonDefaultSmsApp, int priority, boolean expectMore, int validityPeriod, int encodingType) throws RemoteException {
                ...
                try {
                    ...
                    _data2.writeInt(subId);
                    _data2.writeString(callingPkg);
                    _data2.writeString(destAddr);
                    _data2.writeString(scAddr);
                    _data2.writeString(text);
                    int i = 1;
                    if (sentIntent != null) {
                        try {
                            _data2.writeInt(1);
                            sentIntent.writeToParcel(_data2, 0);
                        } catch (Throwable th2) {
                            th = th2;
                            _reply = _reply2;
                            _data = _data2;
                    ...
                    if (deliveryIntent != null) {
                        _data2.writeInt(1);
                        deliveryIntent.writeToParcel(_data2, 0);
                    } else {
                        _data2.writeInt(0);
                    }
                    _data2.writeInt(persistMessageForNonDefaultSmsApp ? 1 : 0);
                    _data2.writeInt(priority);
                    if (!expectMore) {
                        i = 0;
                    }
                    _data2.writeInt(i);
                    _data2.writeInt(validityPeriod);
                    _data2.writeInt(encodingType);
                    if (this.mRemote.transact(9, _data2, _reply2, 0) || Stub.getDefaultImpl() == null) {
                        _reply2.readException();
                        _reply2.recycle();
                        _data2.recycle();
                        return;
                    ...
                    _data = _data2;
                    try {
                        Stub.getDefaultImpl().sendTextForSubscriberWithOptionsOem(subId, callingPkg, destAddr, scAddr, text, sentIntent, deliveryIntent, persistMessageForNonDefaultSmsApp, priority, expectMore, validityPeriod, encodingType);
                        _reply.recycle();
                        _data.recycle();
                    } catch (Throwable th3) {
                        th = th3;
            ...
            public void sendMultipartTextForSubscriberWithOptionsOem(int subId, String callingPkg, String destinationAddress, String scAddress, List<String> parts, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents, boolean persistMessageForNonDefaultSmsApp, int priority, boolean expectMore, int validityPeriod, int encodingType) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().sendMultipartTextForSubscriberWithOptionsOem(subId, callingPkg, destinationAddress, scAddress, parts, sentIntents, deliveryIntents, persistMessageForNonDefaultSmsApp, priority, expectMore, validityPeriod, encodingType);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
