...
public class CarrierKeyDownloadManager extends Handler {
    ...
    private void cleanupRenewalAlarms() {
        ...
        ((AlarmManager) this.mContext.getSystemService("alarm")).cancel(PendingIntent.getBroadcast(this.mContext, 0, new Intent(INTENT_KEY_RENEWAL_ALARM_PREFIX + slotId), 201326592));
    }
    ...
    public void resetRenewalAlarm() {
        ...
        ((AlarmManager) this.mContext.getSystemService("alarm")).set(2, minExpirationDate, PendingIntent.getBroadcast(this.mContext, 0, intent, 201326592));
                ...
                try {
                    ...
                    if (0 != 0) {
                        try {
                            ...
                            Log.e(LOG_TAG, "Exception getting certificate: " + e11);
                        }
                    }
                    throw th;
                }
