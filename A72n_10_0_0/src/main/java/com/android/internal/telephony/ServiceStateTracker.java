...
public class ServiceStateTracker extends AbstractServiceStateTracker {
        ...
        switch (msg.what) {
            ...
            case 55:
                ...
                if (ar12.exception == null) {
                    ...
                    if (((updateNrFrequencyRangeFromPhysicalChannelConfigs(list, this.mSS) || updateNrStateFromPhysicalChannelConfigs(list, this.mSS)) || RatRatcheter.updateBandwidths(getBandwidthsFromConfigs(list), this.mSS)) && getCombinedRegState(this.mSS) == 0) {
                        log("EVENT_PHYSICAL_CHANNEL_CONFIG: notify OOS:" + this.mSS);
    ...
    public void updateSpnDisplayLegacy() {
        ...
        if (this.mPhone.isPhoneTypeGsm()) {
            ...
            log("updateSpnDisplay: cdma rawPlmn = " + plmn);
            showPlmn = plmn != null;
            if (!TextUtils.isEmpty(plmn) && !TextUtils.isEmpty(wfcVoiceSpnFormat)) {
                plmn = String.format(wfcVoiceSpnFormat, plmn.trim());
