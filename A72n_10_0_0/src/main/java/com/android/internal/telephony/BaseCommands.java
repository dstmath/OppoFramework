...
public abstract class BaseCommands implements CommandsInterface {
    ...
    public RegistrantList mPsWifiStateRegistrants = new RegistrantList();
    ...
    public Object mSmlDeviceLockInfo = null;
    public RegistrantList mSmlDeviceLockInfoChanged = new RegistrantList();
    @UnsupportedAppUsage
    ...
    public void registerForVoiceRadioTechChanged(Handler h, int what, Object obj) {
        ...
        int i = this.mNewVoiceTech;
        if (i != -1) {
            this.mVoiceRadioTechChangedRegistrants.notifyRegistrants(new AsyncResult((Object) null, new int[]{i}, (Throwable) null));
        }
    }
    ...
    @Override // com.android.internal.telephony.CommandsInterface
    public void registerForPsWifiStateChanged(Handler h, int what, Object obj) {
        this.mPsWifiStateRegistrants.add(new Registrant(h, what, obj));
    }

    @Override // com.android.internal.telephony.CommandsInterface
    public void unregisterForPsWifiStateChanged(Handler h) {
        this.mPsWifiStateRegistrants.remove(h);
    }
    ...
    @Override // com.android.internal.telephony.CommandsInterface
    public void registerForSmlDeviceLockInfoChanged(Handler h, int what, Object obj) {
        Registrant r = new Registrant(h, what, obj);
        this.mSmlDeviceLockInfoChanged.add(r);
        Object obj2 = this.mSmlDeviceLockInfo;
        if (obj2 != null) {
    ...
    @Override // com.android.internal.telephony.CommandsInterface
    public void unregisterForSmlDeviceLockInfoChanged(Handler h) {
        this.mSmlDeviceLockInfoChanged.remove(h);
    }
}
