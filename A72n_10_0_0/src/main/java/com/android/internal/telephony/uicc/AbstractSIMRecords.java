...
public abstract class AbstractSIMRecords extends AbstractBaseRecords {
    ...
    public void resetImpi() {
        this.mReference.resetImpi();
    }

    @Override // com.android.internal.telephony.uicc.AbstractBaseRecords
    public String getImpi() {
        return this.mReference.getImpi();
    }

    public void fetchIMPI() {
        this.mReference.fetchIMPI();
    }
        ...
        if (i == 88) {
            ...
            switch (i) {
                case EVENT_GET_ALL_PNN_DONE /* 500 */:
                    ...
                    return;
                case EVENT_GET_ALL_OPL_DONE /* 501 */:
                    this.isRecordLoadResponse = true;
                    ...
                    return;
                case EVENT_GET_CPHSONS_DONE /* 502 */:
                    ...
                    return;
                case EVENT_GET_SHORT_CPHSONS_DONE /* 503 */:
    ...
    public void setDataAndDataroamingForOperators(String gid1) {
        this.mReference.setDataAndDataroamingForOperators(gid1);
    }
