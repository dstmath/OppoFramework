...
public class MultiSimSettingController extends Handler {
    ...
    protected boolean mSubInfoInitialized = false;
    ...
    public static MultiSimSettingController init(Context context, SubscriptionController sc) {
        ...
        synchronized (SubscriptionController.class) {
            if (sInstance == null) {
                sInstance = TelephonyComponentFactory.getInstance().inject(TelephonyComponentFactory.class.getName()).makeMultiSimSettingController(context, sc);
            } else {
    ...
    /* access modifiers changed from: protected */
    public int updatePrimarySubListAndGetChangeType(List<SubscriptionInfo> activeSubList, boolean init) {
    ...
    /* access modifiers changed from: protected */
    public void sendSubChangeNotificationIfNeeded(int change, boolean dataSelected, boolean voiceSelected, boolean smsSelected) {
    ...
    /* access modifiers changed from: protected */
    public void setUserDataEnabledForGroup(int subId, boolean enable) {
    ...
    /* access modifiers changed from: protected */
    public boolean updateDefaultValue(List<Integer> primarySubList, int oldValue, UpdateDefaultAction action) {
        int newValue = -1;
