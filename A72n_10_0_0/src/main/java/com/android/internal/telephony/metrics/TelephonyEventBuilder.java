...
public class TelephonyEventBuilder {
    ...
    public TelephonyEventBuilder setSimStateChange(SparseArray<Integer> simStates) {
        ...
        TelephonyProto.TelephonyEvent telephonyEvent2 = this.mEvent;
        telephonyEvent2.type = 18;
        telephonyEvent2.simState = new int[TelephonyManager.getDefault().getPhoneCount()];
