...
public class SipPhone extends SipPhoneBase {
    ...
    public abstract class SipAudioCallAdapter extends SipAudioCall.Listener {
        ...
        public void onError(SipAudioCall call, int errorCode, String errorMessage) {
            ...
            switch (errorCode) {
                case IccInternalInterface.ERROR_ICC_PROVIDER_EMAIL_FULL /* -12 */:
                    onError(9);
                    return;
                case IccInternalInterface.ERROR_ICC_PROVIDER_ADN_LIST_NOT_EXIST /* -11 */:
                    onError(11);
                    return;
                case IccInternalInterface.ERROR_ICC_PROVIDER_GENERIC_FAILURE /* -10 */:
                    onError(14);
                    return;
                case -9:
                case -4:
