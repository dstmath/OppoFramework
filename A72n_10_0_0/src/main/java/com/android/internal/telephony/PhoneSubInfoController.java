...
public class PhoneSubInfoController extends IPhoneSubInfo.Stub {
    ...
    private <T> T callPhoneMethodForSubIdWithReadCheck(int subId, String callingPackage, String message, CallPhoneMethodHelper<T> callMethodHelper) {
        return (T) callPhoneMethodWithPermissionCheck(subId, callingPackage, message, callMethodHelper, $$Lambda$PhoneSubInfoController$po8_4IMWtKcwFfhE86w8JrxFyiQ.INSTANCE);
    }
    ...
    private <T> T callPhoneMethodForSubIdWithReadDeviceIdentifiersCheck(int subId, String callingPackage, String message, CallPhoneMethodHelper<T> callMethodHelper) {
        return (T) callPhoneMethodWithPermissionCheck(subId, callingPackage, message, callMethodHelper, $$Lambda$PhoneSubInfoController$7qVhar26kNZifDiwBbDMBF7rSAU.INSTANCE);
    }
    ...
    private <T> T callPhoneMethodForSubIdWithReadSubscriberIdentifiersCheck(int subId, String callingPackage, String message, CallPhoneMethodHelper<T> callMethodHelper) {
        return (T) callPhoneMethodWithPermissionCheck(subId, callingPackage, message, callMethodHelper, $$Lambda$PhoneSubInfoController$Tindg8C4HeRTS8KeokNuT5s_py0.INSTANCE);
    }
    ...
    private <T> T callPhoneMethodForSubIdWithReadPhoneNumberCheck(int subId, String callingPackage, String message, CallPhoneMethodHelper<T> callMethodHelper) {
        return (T) callPhoneMethodWithPermissionCheck(subId, callingPackage, message, callMethodHelper, $$Lambda$PhoneSubInfoController$w3DDNtOVgadzMRbV4Mpy0PHCNbU.INSTANCE);
    }
