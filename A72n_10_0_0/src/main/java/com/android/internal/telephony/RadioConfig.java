...
public class RadioConfig extends Handler {
    ...
    public static RadioConfig getInstance(Context context) {
        if (sRadioConfig == null) {
            if (SystemProperties.get("ro.vendor.mtk_telephony_add_on_policy", OppoModemLogManager.DEFAULT_MODEMDUMP_POSTBACK).equals(OppoModemLogManager.DEFAULT_MODEMDUMP_POSTBACK)) {
                try {
                    Class<?> clazz = Class.forName("com.mediatek.internal.telephony.MtkRadioConfig", false, ClassLoader.getSystemClassLoader());
                    logd("class = " + clazz);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0010, code lost:
        r0 = move-exception;
     */
    /* JADX WARNING: Removed duplicated region for block: B:3:0x0010 A[ExcHandler: RemoteException | RuntimeException (r0v9 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:5:0x0013] */
    private void updateRadioConfigProxy() {
        try {
            this.mRadioConfigProxy = android.hardware.radio.config.V1_1.IRadioConfig.getService(isGetHidlServiceSync());
        ...
        try {
            if (this.mRadioConfigProxy == null) {
                try {
                    this.mRadioConfigProxy = IRadioConfig.getService(isGetHidlServiceSync());
    ...
    public boolean isSetPreferredDataCommandSupported() {
        return getRadioConfigProxy(null) != null && this.mRadioConfigVersion.greaterOrEqual(RADIO_CONFIG_HAL_VERSION_1_1);
    }
