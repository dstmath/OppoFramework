    ...
    public String getEFPath(int efid) {
        ...
        switch (efid) {
            ...
            case IccConstants.EF_IMPI /* 28418 */:
                logd("VENDOR_EDIT UsimFileHandler EF_IMPI");
                if ("O2".equals(SystemProperties.get("ro.oppo.operator")) && "EUEX".equals(SystemProperties.get("ro.oppo.regionmark")) && "GB".equals(SystemProperties.get("persist.sys.oppo.region")) && "GB".equals(SystemProperties.get("ro.oppo.euex.country"))) {
                    logd("UsimFileHandler EF_IMPI");
                    return "3F007F43";
                }
