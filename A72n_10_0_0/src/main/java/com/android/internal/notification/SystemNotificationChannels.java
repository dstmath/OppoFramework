...
public class SystemNotificationChannels {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel physicalKeyboardChannel = new NotificationChannel(PHYSICAL_KEYBOARD, context.getString(R.string.notification_channel_physical_keyboard), 4);
        ...
        channelsList.add(new NotificationChannel(DO_NOT_DISTURB, context.getString(R.string.notification_channel_do_not_disturb), 2));
