...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    /* JADX INFO: Multiple debug info for r11v10 'vis'  int: [D('vis' int), D('rightMargin' int)] */
    /* JADX INFO: Multiple debug info for r13v7 'leftMargin'  int: [D('visibilityChanged' boolean), D('leftMargin' int)] */
