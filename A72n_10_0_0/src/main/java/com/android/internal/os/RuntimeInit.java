        ...
        public void uncaughtException(Thread t, Throwable e) {
            ...
            if (!RuntimeInit.mCrashing) {
                if (RuntimeInit.mApplicationObject == null && 1000 == Process.myUid()) {
                    ...
                    if ("java.lang.OutOfMemoryError".equals(new ApplicationErrorReport.CrashInfo(e).exceptionClassName) && !"user".equals(Build.TYPE)) {
                        try {
                            Debug.dumpHprofData(new File("/data/anr", FILE_NAME).getAbsolutePath());
