...
public class BatterySipper extends OppoBaseBatterySipper implements Comparable<BatterySipper> {
    ...
    public void add(BatterySipper other) {
        ...
        this.gpsBgTimeMs += other.gpsBgTimeMs;
        this.sensorTimeMs += other.sensorTimeMs;
        this.sensorBgTimeMs += other.sensorBgTimeMs;
        this.screenHoldTimeMs += other.screenHoldTimeMs;
        this.wifiBgTtafficBytes += other.wifiBgTtafficBytes;
        this.mobileBgTtafficBytes += other.mobileBgTtafficBytes;
        this.cpuBgPowerMah += other.cpuBgPowerMah;
        this.wifiBgPowerMah += other.wifiBgPowerMah;
        this.mobileRadioBgPowerMah += other.mobileRadioBgPowerMah;
        this.gpsBgPowerMah += other.gpsBgPowerMah;
        this.sensorBgPowerMah += other.sensorBgPowerMah;
        this.cameraBgPowerMah += other.cameraBgPowerMah;
        this.cameraBgTimeMs += other.cameraBgTimeMs;
    }
