...
public interface ICabcManager extends IInterface {
    ...
    void isSunnyBrightnessMode(boolean z) throws RemoteException;
    ...
    public static class Default implements ICabcManager {
        ...
        @Override // com.android.internal.cabc.ICabcManager
        public void isSunnyBrightnessMode(boolean enable) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ICabcManager {
        ...
        static final int TRANSACTION_isSunnyBrightnessMode = 5;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                ...
                data.enforceInterface(DESCRIPTOR);
                isSunnyBrightnessMode(data.readInt() != 0);
                reply.writeNoException();
                return true;
        ...
        public static class Proxy implements ICabcManager {
            ...
            public void isSunnyBrightnessMode(boolean enable) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().isSunnyBrightnessMode(enable);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
