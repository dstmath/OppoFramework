...
public abstract class IInputConnectionWrapper extends IInputContext.Stub {
    ...
    /* JADX INFO: Multiple debug info for r0v30 int: [D('flags' int), D('ic' android.view.inputmethod.InputConnection)] */
    /* access modifiers changed from: package-private */
    public void executeMessage(Message msg) {
        ...
        if (i == 80) {
            ...
            switch (i) {
                ...
                case 20:
                    ...
                    try {
                        ...
                        if (ic3 != null) {
                            if (isActive()) {
                                callback2.setTextBeforeCursor(ic3.getTextBeforeCursor(msg.arg1, msg.arg2), callbackSeq2);
                                args2.recycle();
                                return;
                            }
                        }
                ...
                case 25:
                    ...
                    try {
                        ...
                        if (ic4 != null) {
                            if (isActive()) {
                                callback3.setSelectedText(ic4.getSelectedText(msg.arg1), callbackSeq3);
                                args3.recycle();
                                return;
                            }
                        }
                ...
                case 30:
                    ...
                    try {
                        ...
                        if (ic5 != null) {
                            if (isActive()) {
                                callback4.setCursorCapsMode(ic5.getCursorCapsMode(msg.arg1), callbackSeq4);
                                args4.recycle();
                                return;
                            }
                        }
                ...
                case 40:
                    ...
                    try {
                        ...
                        if (ic6 != null) {
                            if (isActive()) {
                                callback5.setExtractedText(ic6.getExtractedText((ExtractedTextRequest) args5.arg1, msg.arg1), callbackSeq5);
                                args5.recycle();
                                return;
                            }
                        }
                ...
                case 63:
                    ...
                    if (ic8 == null || !isActive()) {
                        ...
                        ic8.setComposingRegion(msg.arg1, msg.arg2);
                        return;
                    }
                case 65:
                    if (!isFinished()) {
                ...
                case 70:
                    ...
                    if (ic10 == null || !isActive()) {
                        ...
                        ic10.sendKeyEvent((KeyEvent) msg.obj);
                        return;
                    }
                case 90:
                ...
                case 120:
                    ...
                    try {
                        ...
                        if (ic13 != null) {
                            if (isActive()) {
                                ic13.performPrivateCommand(action, data);
                                args6.recycle();
                                return;
                            }
                        }
                ...
                case 130:
                    ...
                    if (ic14 == null || !isActive()) {
                        ...
                        ic14.clearMetaKeyStates(msg.arg1);
                        return;
                    }
                case 140:
                    ...
                    try {
                        ...
                        if (ic15 != null) {
                            if (isActive()) {
                                callback6.setRequestUpdateCursorAnchorInfoResult(ic15.requestCursorUpdates(msg.arg1), callbackSeq6);
                                args7.recycle();
                                return;
                            }
                        }
                ...
                case 150:
                    if (!isFinished()) {
                        try {
                            ...
                            if ((InputConnectionInspector.getMissingMethodFlags(ic16) & 64) == 0) {
                                ic16.closeConnection();
                            }
                            synchronized (this.mLock) {
                                this.mInputConnection = null;
                                this.mFinished = true;
                            ...
                            if (isActive()) {
                                ...
                                if (inputContentInfo != null) {
                                    if (inputContentInfo.validate()) {
                                        callback7.setCommitContentResult(ic17.commitContent(inputContentInfo, flags, (Bundle) args8.arg2), callbackSeq7);
                                        args8.recycle();
                                        return;
                                    }
                                }
                    ...
                    switch (i) {
                        case 55:
                            ...
                            if (ic18 == null || !isActive()) {
                                ...
                                ic18.commitCompletion((CompletionInfo) msg.obj);
                                return;
                            }
                        case 56:
                            ...
                            if (ic19 == null || !isActive()) {
                                ...
                                ic19.commitCorrection((CorrectionInfo) msg.obj);
                                return;
                            }
                        case 57:
                            ...
                            if (ic20 == null || !isActive()) {
                                ...
                                ic20.setSelection(msg.arg1, msg.arg2);
                                return;
                            }
                        case 58:
                            ...
                            if (ic21 == null || !isActive()) {
                                ...
                                ic21.performEditorAction(msg.arg1);
                                return;
                            }
                        case 59:
                            ...
                            if (ic22 == null || !isActive()) {
                                ...
                                ic22.performContextMenuAction(msg.arg1);
                                return;
                            }
                        case 60:
                            ...
                            if (ic23 == null || !isActive()) {
                                ...
                                ic23.setComposingText((CharSequence) msg.obj, msg.arg1);
                                return;
                            }
                        default:
            ...
            if (ic24 == null || !isActive()) {
                ...
                ic24.deleteSurroundingTextInCodePoints(msg.arg1, msg.arg2);
            }
        }
    }
