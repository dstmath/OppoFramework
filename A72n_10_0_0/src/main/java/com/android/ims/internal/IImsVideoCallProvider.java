...
public interface IImsVideoCallProvider extends IInterface {
    int getProviderId() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IImsVideoCallProvider {
        ...
        static final int TRANSACTION_getProviderId = 12;
            ...
            public int getProviderId() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(12, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getProviderId();
                    }
