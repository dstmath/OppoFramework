...
public class TouchExplorer extends BaseEventStreamTransformation implements AccessibilityGestureDetector.Listener {
    ...
    public class ReceivedPointerTracker {
        ...
        public void clear() {
            Arrays.fill(this.mReceivedPointerDownX, (float) OppoBrightUtils.MIN_LUX_LIMITI);
            Arrays.fill(this.mReceivedPointerDownY, (float) OppoBrightUtils.MIN_LUX_LIMITI);
