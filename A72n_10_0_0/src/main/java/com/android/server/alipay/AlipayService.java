...
public class AlipayService extends SystemService {
    ...
    private IHwBinder.DeathRecipient mAliPayServiceDeathRecipient = new IHwBinder.DeathRecipient() {
        ...
        public void serviceDied(long cookie) {
            ...
            AlipayService.this.mFingerprintPay = null;
        }
    };
    private IFAAModelHelper.IFAAModelUpdateInfo.IfaaModelToken mCachedModel;
    ...
    private IFAAModelHelper mIFAAModelHelper;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.android.server.alipay.AlipayService */
    ...
    private final class AlipayServiceWrapper extends IAlipayService.Stub implements IBinder.DeathRecipient {
        ...
        public byte[] alipayInvokeCommand(byte[] param) {
            if (AlipayService.this.mFingerprintPay == null) {
                ...
                alipayService.mFingerprintPay = alipayService.getAliPayService();
            }
            if (AlipayService.this.mFingerprintPay == null) {
        ...
        public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            ...
            AlipayService.this.mCachedVersion = -1;
    ...
    public IFAAModelHelper.IFAAModelUpdateInfo.IfaaModelToken findIfaaModelToken() {
        ...
        if (TemperatureProvider.SWITCH_ON.equals(SystemProperties.get("persist.version.confidential"))) {
            ...
            for (IFAAModelHelper.IFAAModelUpdateInfo.IfaaModelToken model : info.mConfiIfaaModels) {
                Iterator<String> it = model.oppoModel.iterator();
                while (true) {
                    if (it.hasNext()) {
                        if (build.startsWith(it.next())) {
                            matchedModel = model;
                            break;
                        }
                    } else {
            ...
            for (IFAAModelHelper.IFAAModelUpdateInfo.IfaaModelToken model2 : info.mPublicIfaaModels) {
    ...
    public class IFAAModelHelper extends RomUpdateHelper<IFAAModelUpdateInfo> {
        ...
        public void onUpdateInfoChanged() {
            synchronized (this) {
                AlipayService.this.mCachedVersion = -1;
                AlipayService.this.mCachedModel = null;
                this.mHasIntialized = false;
            }
        }

        /* access modifiers changed from: private */
        public class IFAAModelUpdateInfo extends RomUpdateHelper.UpdateInfo {
