...
public interface IColorAlarmManagerHelper extends IOppoCommonFeature {
    ...
    default void addAppAlarmWhiteList(List<String> list) {
    }

    default List<String> getAppAlarmWhiteList() {
        return new ArrayList();
    }

    default boolean removeAppAlarmWhiteList(List<String> list) {
        return false;
    }

    default boolean removeAllAppAlarmWhiteList() {
        return false;
    }
}
