...
public interface IColorHansManager extends IOppoCommonFeature {
    ...
    default boolean hansTopActivityIfNeeded(int targetUid, String targetPkg, int windowMode) {
        return true;
    }

    default boolean hansSecondActivityIfNeeded(int secondUid, String secondPkg, int windowMode) {
        return true;
    }
    ...
    default void addIsolatedUid(int isolatedUid, int appUid) {
    }

    default void removeIsolatedUid(int isolatedUid, int appUid) {
    }

    default void hansHandleWindowsVisible(int curUid, String curPkgName) {
    }

    default boolean isHansFreezed(int uid, String pkgName, int scene, String from) {
        return false;
    }
}
