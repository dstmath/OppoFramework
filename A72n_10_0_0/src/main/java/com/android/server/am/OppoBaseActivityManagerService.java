...
public abstract class OppoBaseActivityManagerService extends IActivityManager.Stub {
    ...
    public IColorBatteryProcessStats getColorBatteryProcessStats() {
        return OppoFeatureCache.get(IColorBatteryProcessStats.DEFAULT);
    }
    ...
    public void reportBindApplicationFinished(String pkgName, int userId, int pid) {
        OppoFeatureCache.get(IColorResourcePreloadManager.DEFAULT).notifyBindApplicationFinished(pkgName, userId, pid);
    }
}
