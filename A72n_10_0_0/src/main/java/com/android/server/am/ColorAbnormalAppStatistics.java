...
public class ColorAbnormalAppStatistics {
    ...
    private List<ColorAbnormalAppInfo> mCollectAbnormalAppInfoList = new ArrayList();
    ...
    public class CollectAbnormalAppRunnable implements Runnable {
        ...
        public void run() {
            int length;
            ColorAbnormalAppStatistics.this.collectAbnormalAppInfo((ColorAbnormalAppStatistics) this.mIsRestrict, (boolean) this.mPkgName, this.mHostType);
