...
public class ColorBroadcastManager implements IColorBroadcastManager {
    ...
    final long mTimeoutPeriodForApp = ColorSmartDozeHelper.DEBUG_GPS_EXEPTION_TIME;
        ...
        try {
            ...
            try {
                ...
                if (!r.ordered) {
                    ...
                    receiverRecord.setBroadcastTimeoutLocked((long) ColorSmartDozeHelper.DEBUG_GPS_EXEPTION_TIME);
    ...
    private boolean isResumeAndVisible(String pkgName, ProcessRecord proc) {
        synchronized (this.mAms) {
            ...
            return topApp == null || pkgName.equals(topApp.getPackageName());
        }
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateDefaultInputMethod() {
    ...
    public void informReadyToBootComplete() {
        this.mLocalHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ColorBroadcastManager.this.mFinishBootComplete = true;
            }
        }, 10000);
    }
