...
public final class AppCompactor {
    ...
    public AppCompactor(ActivityManagerService am) {
        ...
        this.mCompactThrottleSomeSome = 5000;
        this.mCompactThrottleSomeFull = 10000;
        this.mCompactThrottleFullSome = 500;
        this.mCompactThrottleFullFull = 10000;
    ...
    private void updateStatsdSampleRate() {
        ...
        this.mStatsdSampleRate = Math.min(1.0f, Math.max((float) OppoBrightUtils.MIN_LUX_LIMITI, this.mStatsdSampleRate));
    }
    ...
    public final class MemCompactionHandler extends Handler {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:104:0x028b, code lost:
            android.util.Slog.d("ActivityManager", "Skipping compaction forprocess " + r0 + " with no memory usage. Dead?");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:116:0x02d8, code lost:
            android.util.Slog.d("ActivityManager", "Skipping full compaction for process " + r4 + "; anon RSS is too small: " + r9 + "KB.");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:125:0x0343, code lost:
            android.util.Slog.d("ActivityManager", "Skipping full compaction for process " + r4 + "; abs delta is too small: " + r9 + "KB.");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:150:0x04ef, code lost:
            if (r1.this$0.mRandom.nextFloat() >= r1.this$0.mStatsdSampleRate) goto L_0x0581;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:186:0x05bd, code lost:
            r1.this$0.mLastCompactionStats.put(java.lang.Integer.valueOf(r2), new com.android.server.am.AppCompactor.LastCompactionStats(r58));
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:45:0x00d9, code lost:
            android.util.Slog.d("ActivityManager", "Skipping some compaction for " + r4 + ": too soon. throttle=" + r61.this$0.mCompactThrottleSomeSome + com.android.server.slice.SliceClientPermissions.SliceAuthority.DELIMITER + r61.this$0.mCompactThrottleSomeFull + " last=" + (r7 - r5) + "ms ago");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:59:0x0143, code lost:
            android.util.Slog.d("ActivityManager", "Skipping full compaction for " + r4 + ": too soon. throttle=" + r61.this$0.mCompactThrottleFullSome + com.android.server.slice.SliceClientPermissions.SliceAuthority.DELIMITER + r61.this$0.mCompactThrottleFullFull + " last=" + (r7 - r5) + "ms ago");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:66:0x0193, code lost:
            android.util.Slog.d("ActivityManager", "Skipping persistent compaction for " + r4 + ": too soon. throttle=" + r61.this$0.mCompactThrottlePersistent + " last=" + (r7 - r5) + "ms ago");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:73:0x01d7, code lost:
            android.util.Slog.d("ActivityManager", "Skipping bfgs compaction for " + r4 + ": too soon. throttle=" + r61.this$0.mCompactThrottleBFGS + " last=" + (r7 - r5) + "ms ago");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:93:0x0244, code lost:
            android.util.Slog.d("ActivityManager", "Skipping full compaction for process " + r4 + "; proc state is " + r13);
         */
                ...
                synchronized (AppCompactor.this.mAm) {
                    try {
                        ...
                        if (proc.setAdj <= 200) {
                            try {
                                if (ActivityManagerDebugConfig.DEBUG_COMPACTION) {
                                    Slog.d("ActivityManager", "Skipping compaction as process " + name2 + " is now perceptible.");
                                }
