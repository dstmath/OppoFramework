...
public class ColorAppStartupStatistics {
    ...
    private IColorAppStartupManager mAppStartupManager = null;
    private List<ColorAppStartupMonitorInfo> mCollectAppStartupList = new ArrayList();
    private List<ColorAppStartupMonitorInfo> mCollectPopupActivityList = new ArrayList();
