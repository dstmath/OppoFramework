...
public class EventLogTags {
    ...
    public static void writeAmPauseActivity(int user, int token, String componentName, String userLeaving, String reason) {
        EventLog.writeEvent((int) AM_PAUSE_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), componentName, userLeaving, reason);
    }
