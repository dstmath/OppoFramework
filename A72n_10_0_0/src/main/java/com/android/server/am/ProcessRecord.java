...
public class ProcessRecord extends OppoBaseProcessRecord {
    ...
    public void kill(String reason, boolean noisy) {
        ...
        if (!this.killedByAm) {
            ...
            if (this.mService != null && (noisy || this.info.uid == this.mService.mCurOomAdjUid)) {
                ...
                activityManagerService2.reportUidInfoMessageLocked(TAG, "Killing " + toShortString() + " (adj " + this.setAdj + "): " + reason, this.info.uid);
            }
            ...
            if (Process.getUidForPid(this.pid) == this.uid) {
                if (this.pid > 0) {
                    if (!(this.mCurProcState != 2 || (packageList = this.pkgList) == null || packageList.size() <= 0 || (activityManagerService = this.mService) == null || activityManagerService.mOppoAmsUtils == null)) {
                        this.mService.mOppoAmsUtils.detectForgroundExceptions(this.mService.mContext, this.pkgList.keyAt(0), reason);
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:123:0x02d9, code lost:
        ...
        com.android.server.theia.TheiaUtil.getInstance().sendTheiaEvent(r31.info.packageName, com.android.server.theia.TheiaConst.THEIA_ST_ANR, r31.mService.mContext);
        android.util.Slog.w(com.android.server.am.ProcessRecord.TAG, "TheiaAnr theia record!  " + r31.info.packageName);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:124:0x030a, code lost:
        if (r35 == null) goto L_0x0312;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:125:0x030c, code lost:
        r7 = (com.android.server.am.ProcessRecord) r35.mOwner;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:126:0x0312, code lost:
        r7 = null;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:128:0x0339, code lost:
        if (r31.mService.mAnrManager.startAnrDump(r31.mService, r31, r32, r33, r34, r7, r36, r37, getShowBackground(), r23) == false) goto L_0x033c;
     */
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:131:0x034f, code lost:
        if (r32 == null) goto L_0x035e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:133:0x035e, code lost:
        ...
        r0.append(com.android.server.connectivity.networkrecovery.dnsresolve.StringUtils.LF);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:134:0x0374, code lost:
        if (r37 == null) goto L_0x0383;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:135:0x0376, code lost:
        r0.append("Reason: ");
        r0.append(r37);
        r0.append(com.android.server.connectivity.networkrecovery.dnsresolve.StringUtils.LF);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:137:0x0385, code lost:
        if (r34 == null) goto L_0x039a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:139:0x038b, code lost:
        if (r34.equals(r32) == false) goto L_0x039a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:140:0x038d, code lost:
        r0.append("Parent: ");
        r0.append(r34);
        r0.append(com.android.server.connectivity.networkrecovery.dnsresolve.StringUtils.LF);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:142:0x03a6, code lost:
        if (isSilentAnr() == false) goto L_0x03c7;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:143:0x03a8, code lost:
        r6 = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:145:0x03ac, code lost:
        if (r6 >= com.android.server.Watchdog.NATIVE_STACKS_OF_INTEREST.length) goto L_0x03c5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:147:0x03b8, code lost:
        if (com.android.server.Watchdog.NATIVE_STACKS_OF_INTEREST[r6].equals(r31.processName) == false) goto L_0x03c2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:148:0x03ba, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:150:0x03c5, code lost:
        r6 = r0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:151:0x03c7, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:152:0x03ca, code lost:
        if (r6 != null) goto L_0x03ce;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:153:0x03cc, code lost:
        r0 = null;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:154:0x03ce, code lost:
        r0 = android.os.Process.getPidsForCommands(r6);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:156:0x03d4, code lost:
        if (r0 == null) goto L_0x03ef;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:157:0x03d6, code lost:
        r8 = new java.util.ArrayList<>(r0.length);
        r8 = r0.length;
        r9 = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:158:0x03df, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:159:0x03e1, code lost:
        ...
        r9 = r9 + 1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:160:0x03ed, code lost:
        r11 = r8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:164:0x03f2, code lost:
        if (r31.processName == null) goto L_0x0409;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:166:0x03fc, code lost:
        if (r31.processName.equals("com.oppo.camera") == false) goto L_0x0409;
     */
