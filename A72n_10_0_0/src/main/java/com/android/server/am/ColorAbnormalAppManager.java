...
public class ColorAbnormalAppManager implements IColorAbnormalAppManager {
    ...
    private ArrayList<String> mBroadcastReceiverInfo = new ArrayList<>();
    private List<ColorAnrAppInfo> mBroadcastReceiverList = new ArrayList();
    private ArrayList<String> mBroadcastTimeInfo = new ArrayList<>();
    private List<ColorAnrAppInfo> mBroadcastTimeList = new ArrayList();
    private ArrayList<String> mCountRestrictedList = new ArrayList<>();
    private Handler mHandler = null;
    private boolean mHandlerReady = false;
    private long mLastCheckBroadcastTime = 0;
    private long mLastCheckServiceTime = 0;
    ...
    private ArrayList<String> mServiceTimeInfo = new ArrayList<>();
    private List<ColorAnrAppInfo> mServiceTimeList = new ArrayList();
    ...
    private void sendBroadcastReceiver(List<ColorAnrAppInfo> list, ArrayList<String> info) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void sendTimeBroadcast(List<ColorAnrAppInfo> list, ArrayList<String> info, String type, long time, int msg) {
