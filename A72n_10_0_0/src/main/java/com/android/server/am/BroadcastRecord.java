...
public final class BroadcastRecord extends Binder implements IOppoBaseBroadcastRecord {
    ...
    private static final String TAG = "BroadcastRecord";
    ...
    private OppoReceiverRecord mReceiverRecord = null;
    int manifestCount;
    ...
    public String toString() {
        return "BroadcastRecord{" + Integer.toHexString(System.identityHashCode(this)) + " u" + this.userId + StringUtils.SPACE + this.intent.getAction() + "}";
    }
    ...
    @Override // com.android.server.am.IOppoBaseBroadcastRecord
    public void setOppoReceiverRecord(OppoReceiverRecord record) {
        this.mReceiverRecord = record;
    }

    @Override // com.android.server.am.IOppoBaseBroadcastRecord
    public OppoReceiverRecord getOppoReceiverRecord() {
        return this.mReceiverRecord;
    }

    @Override // com.android.server.am.IOppoBaseBroadcastRecord
    public void setMessageDelayFlag(boolean delay) {
        this.mMessageDelay = delay;
    }
