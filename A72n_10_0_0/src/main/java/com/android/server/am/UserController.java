...
public class UserController extends OppoBaseUserController implements Handler.Callback {
    ...
    private IColorBroadcastManager mOppoBroadcastManager;
    @GuardedBy({"mLock"})
    ...
    public /* synthetic */ void lambda$finishUserUnlocking$1$UserController(int userId, UserState uss) {
        ...
        synchronized (this.mLock) {
            if (uss.setState(1, 2)) {
                ...
                handler.sendMessageAtFrontOfQueue(handler.obtainMessage(100, userId, 0, uss));
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00cb, code lost:
        ...
        android.os.SystemProperties.set("sys.oppo.boot_completed", com.android.server.theia.NoFocusWindow.HUNG_CONFIG_ENABLE);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:102:0x021b, code lost:
        ...
        r32.mHandler.sendMessageAtTime(r32.mHandler.obtainMessage(50, r33, 0), 0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:103:0x0233, code lost:
        if (r34 == false) goto L_0x026c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:104:0x0235, code lost:
        r32.mHandler.sendMessageAtTime(r32.mHandler.obtainMessage(60, r33, r0), 1);
        r32.mHandler.removeMessages(10);
        r32.mHandler.removeMessages(30);
        r32.mHandler.sendMessageAtTime(r32.mHandler.obtainMessage(10, r0, r33, r10), 2);
        r32.mHandler.sendMessageDelayed(r32.mHandler.obtainMessage(30, r0, r33, r10), 20000);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:105:0x026c, code lost:
        if (r26 == false) goto L_0x02b7;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:67:0x0196, code lost:
        if (r32.mUserSwitchUiEnabled == false) goto L_0x01d2;
     */
            ...
            try {
                ...
                if (userInfo == null) {
                    ...
                    if (foreground && this.mUserSwitchUiEnabled) {
                        this.mInjector.getWindowManager().startFreezingScreenForUserSwitch(17432868, 17432867, 20000);
                    }
    ...
    public void sendContinueUserSwitchLU(UserState uss, int oldUserId, int newUserId) {
        ...
        Handler handler = this.mHandler;
        handler.sendMessageAtFrontOfQueue(handler.obtainMessage(20, oldUserId, newUserId, uss));
    }
    ...
    public void continueUserSwitch(UserState uss, int oldUserId, int newUserId) {
        ...
        Handler handler = this.mHandler;
        handler.sendMessageAtFrontOfQueue(handler.obtainMessage(80, newUserId, 0));
