...
public class ColorMultiAppManagerUtil {
    ...
    private static boolean DEBUG_MULTI_APP = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, false);
    ...
    private static final String TAG = ColorMultiAppManagerUtil.class.getName();
        ...
        public void onEvent(int event, String path) {
            ...
            if (e == 8) {
                if (ColorMultiAppManagerUtil.DEBUG_MULTI_APP) {
                    String str = ColorMultiAppManagerUtil.TAG;
                    Log.v(str, "file is changing: " + this.mFileName + " event= " + e);
                }
