...
public class ColorEdgeTouchManagerService implements IColorEdgeTouchManager {
    ...
    /* access modifiers changed from: private */
    public class OppoEdgeTouchHandler extends Handler {
    ...
    private boolean writeCmdInner(final List<String> commands) {
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                ColorEdgeTouchManagerService.this.writeCmdLock(commands);
            }
        });
        return true;
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean writeCmdLock(List<String> commands) {
        boolean result;
        if (commands == null || commands.isEmpty()) {
            log(TAG, "writeCmd  commands is null or empty");
            return false;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void writeTouchPanelDirection(int edgeRotation) {
