...
public class AppErrors {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:118:0x0209, code lost:
        android.util.Slog.w(com.android.server.am.AppErrors.TAG, "bug report receiver dissappeared", r0);
     */
    public void crashApplicationInner(ProcessRecord r, ApplicationErrorReport.CrashInfo crashInfo, int callingPid, int callingUid) {
        ...
        Throwable th2;
        boolean z;
        ApplicationErrorReport.CrashInfo crashInfo2;
                                    ...
                                    synchronized (this.mService) {
                                        try {
                                            ...
                                            if (res == 2) {
                                                ...
                                                try {
                                                    appErrorIntent = createAppErrorIntentLocked(r, timeMillis, crashInfo2);
                                                } catch (Throwable th5) {
                                                    th2 = th5;
                                                    ActivityManagerService.resetPriorityAfterLockedSection();
                                                    throw th2;
        ...
        OppoAppErrorsStatistics.doErrorsStatistics(this.mContext, r, crashInfo2);
    }
    ...
    public /* synthetic */ void lambda$handleAppCrashInActivityController$1$AppErrors(ApplicationErrorReport.CrashInfo crashInfo, String name, int pid, ProcessRecord r, String shortMsg, String longMsg, String stackTrace, int uid) {
        if (NoFocusWindow.HUNG_CONFIG_ENABLE.equals(SystemProperties.get("ro.debuggable", "0"))) {
    ...
    public boolean handleAppCrashLocked(ProcessRecord app, String reason, String shortMsg, String longMsg, String stackTrace, AppErrorDialog.Data data) {
        ...
        OppoFeatureCache.get(IColorAppCrashClearManager.DEFAULT).clearAppUserData(app);
        if (!app.isolated) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x0186, code lost:
        android.util.Slog.i(com.android.server.am.AppErrors.TAG, "Showing crash dialog for package " + r10 + " u" + r11);
     */
            ...
            try {
                ...
                if (!isBackground2 || showBackground) {
                    ...
                    if (this.mService.mAtmInternal.canShowErrorDialogs() || showBackground) {
                        if (!crashSilenced) {
                            if (showFirstCrash || showFirstCrashDevOption || data.repeating) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x00db, code lost:
        r12.mPackageWatchdog.onPackageFailure(r1);
     */
        ...
        synchronized (this.mService) {
            try {
                ...
                if (this.mService.mAtmInternal.canShowErrorDialogs() || showBackground) {
                    ...
                    boolean isAgingVersion = NoFocusWindow.HUNG_CONFIG_ENABLE.equals(SystemProperties.get("SPECIAL_OPPO_CONFIG", "0"));
                    if (!isDebugVersion || isAgingVersion) {
                        if (proc.anrDialog != null) {
                        ...
                        proc.anrDialog = new AppNotRespondingDialog(this.mService, this.mContext, data);
                    }
                } else {
