...
public final class UserState {
    ...
    public void setState(int newState) {
        if (newState != this.state) {
            ...
            if (this.state != 0) {
                Trace.asyncTraceEnd(64, stateToString(this.state) + StringUtils.SPACE + userId, userId);
            }
            if (newState != 5) {
                Trace.asyncTraceBegin(64, stateToString(newState) + StringUtils.SPACE + userId, userId);
            }
