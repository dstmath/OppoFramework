...
public final class IpConnectivityMetrics extends SystemService {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: com.android.server.connectivity.IpConnectivityMetrics */
    ...
    public void onBootPhase(int phase) {
        if (phase == 500) {
            ...
            try {
                Class mtkIpConnClass = new PathClassLoader("/system/framework/mediatek-framework-net.jar", getContext().getClassLoader()).loadClass("com.mediatek.net.connectivity.MtkIpConnectivityMetrics");
                Constructor clazzConstructfunc = mtkIpConnClass.getConstructor(Context.class, NetdEventListenerService.class);
                clazzConstructfunc.setAccessible(true);
                Object classObject = clazzConstructfunc.newInstance(getContext(), this.mNetdListener);
                Method method = mtkIpConnClass.getDeclaredMethod("getMtkIpConnSrv", new Class[0]);
                method.setAccessible(true);
                this.mBinder = (IBinder) method.invoke(classObject, new Object[0]);
                ...
                String str = TAG;
                Log.d(str, "No MtkIpConnectivityMetrics:" + e);
            }
        }
    }
