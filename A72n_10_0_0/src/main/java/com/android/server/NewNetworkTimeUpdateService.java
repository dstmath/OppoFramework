...
public class NewNetworkTimeUpdateService extends Binder implements NetworkTimeUpdateService {
    ...
    private IPswNewNetworkTimeUpdateServiceFeature mIPswNewNetworkTimeUpdateServiceFeature = null;
    ...
    private BroadcastReceiver mNitzReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(NewNetworkTimeUpdateService.TAG, "Received " + action);
    ...
    private IPswNewNetworkTimeUpdateServiceFeature getPswNewNetworkTimeUpdateServiceFeature() {
        if (this.mIPswNewNetworkTimeUpdateServiceFeature == null) {
            this.mIPswNewNetworkTimeUpdateServiceFeature = OppoFeatureCache.getOrCreate(IPswNewNetworkTimeUpdateServiceFeature.DEFAULT, new Object[]{this.mContext});
        }
        return this.mIPswNewNetworkTimeUpdateServiceFeature;
    }
    ...
    public void systemRunning() {
        ...
        registerForAlarms();
        getPswNewNetworkTimeUpdateServiceFeature().checkSystemTime();
    ...
    private void onPollNetworkTime(int event) {
        ...
        } else if (getPswNewNetworkTimeUpdateServiceFeature().isNeedSkipPollNetworkTime()) {
    ...
    private void onPollNetworkTimeUnderWakeLock(int event) {
        if (this.mTime.getCacheAge() >= this.mPollingIntervalMs || event == 1) {
            ...
            if (this.mDefaultNetwork != null && !this.mTime.forceRefresh()) {
    ...
    private void updateSystemClock(int event) {
        ...
        if (!forceUpdate) {
            if (getNitzAge() < this.mPollingIntervalMs) {
                ...
                return;
            } else if (Math.abs(this.mTime.currentTimeMillis() - System.currentTimeMillis()) < ((long) this.mTimeErrorThresholdMs)) {
