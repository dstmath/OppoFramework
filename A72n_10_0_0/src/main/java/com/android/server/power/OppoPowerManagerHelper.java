...
public class OppoPowerManagerHelper {
    ...
    private static boolean mOppoShutdownIng = false;
    private long MOTION_GAME_SCREEN_OFF_TIME_OUT = 5000;
    ...
    private final DisplayManager.DisplayListener mDisplayListener = new DisplayManager.DisplayListener() {
        ...
        public void onDisplayRemoved(int displayId) {
            ...
            if (OppoPowerManagerHelper.this.mMotionDisplayId == displayId) {
                synchronized (OppoPowerManagerHelper.this.mLock) {
                    ...
                    OppoPowerManagerHelper.this.mMotionDisplayId = -1;
                }
            }
        }
        ...
        public void onDisplayAdded(int displayId) {
            ...
            if (display != null) {
                ...
                if ((flags & 8) != 0 && type == 2) {
                    synchronized (OppoPowerManagerHelper.this.mLock) {
                        OppoPowerManagerHelper.this.mMotionDisplay = display;
                        OppoPowerManagerHelper.this.mMotionDisplayId = displayId;
    ...
    private OppoPowerManagerHelperHandler mHandler;
    ...
    private Display mMotionDisplay;
    private int mMotionDisplayId = -1;
    ...
    public class OppoPowerManagerHelperHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 10) {
                switch (i) {
                    case OppoPowerManagerHelper.MSG_CHECK_MOTION_GAME_DISPLAY_STATE /* 110 */:
                    ...
                    default:
                        switch (i) {
                            case OppoPowerManagerHelper.MSG_OPPO_PHONE_HEADSET_HANGUP /* 201 */:
                                ...
                                return;
                            case OppoPowerManagerHelper.MSG_BIOMETRICS_SET_ALPHA_TIMEOUT /* 202 */:
                                ...
                                return;
                            case OppoPowerManagerHelper.MSG_DUMP_WAKE_LOCKS_LIST /* 203 */:
                                synchronized (OppoPowerManagerHelper.this.mLock) {
    ...
    /* access modifiers changed from: private */
    public final class OppoPhoneHeadsetReceiver extends BroadcastReceiver {
    ...
    /* access modifiers changed from: private */
    public final class OppoMotionGameReceiver extends BroadcastReceiver {
    ...
    /* access modifiers changed from: private */
    public final class OppoShutDownReceiver extends BroadcastReceiver {
    ...
    private void setProximitySensorCalibrationEnabled(boolean enable) {
        if (DEBUG_PANIC) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setDozeLightSensorEnabled(boolean enable) {
        if (DEBUG_PANIC) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void processLightSensorEvent(float lux) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateSensorCalibrationWakeLockStatus(boolean enable) {
        PowerManager power;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void handleMotionGameDisplayState() {
                ...
                if (this.mWakefulness != 3) {
                    if (isMotionMode) {
                        this.mHandler.post(new Runnable() {
                            ...
                            public void run() {
                                OppoPowerManagerHelper.this.setDisplayStateOffForMotionGameLocked();
                            }
                        });
                    } else {
                        this.mHandler.post(new Runnable() {
                            ...
                            public void run() {
                                OppoPowerManagerHelper.this.setDisplayStateOnForMotionGameLocked(OppoPowerManagerHelper.this.mPms.getLastUpdatedBrightness());
                            }
                        });
                    }
                    return;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void scheduleUpdateMotionGameDisplatStateTask(long delay) {
        this.mHandler.removeMessages(MSG_CHECK_MOTION_GAME_DISPLAY_STATE);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void scheduleUpdateMotionGameChargeStateTask(long delay) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateChargeStateInMotionModeLocked(boolean isPowered) {
        ...
        if (!isPowered || this.mStopChargeInMotionMode) {
            ...
            if (mmi_charging_enable != 1) {
                ...
                SystemProperties.set("sys.oppo.kinect.game", "1");
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int setDisplayStateOnForMotionGameLocked(int brightness) {
        try {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int setDisplayStateOffForMotionGameLocked() {
        try {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean checkIsMotionGameModeLocked() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void scheduleUpdateMotionDisplayRefreshRateTask(long delay) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setMotionDisplayRefreshRate(float requestedRefreshRate) {
