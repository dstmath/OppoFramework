...
public class PswShutdownFeature implements IPswShutdownFeature {
    ...
    private static final int MIN_SHUTDOWN_ANIMATION_PLAY_TIME_FOR_ATT = 8000;
    ...
    private boolean mIsAnimationtimeForAtt;
    ...
    private PswShutdownFeature() {
        ...
        this.mIsAnimationtimeForAtt = false;
    ...
    public void setBeginAnimationTimeForAtt(long beginAnimTime, boolean isAtt) {
        Log.d(TAG, "setBeginAnimationTimeForAtt");
        this.mBeginAnimationTime = beginAnimTime;
        this.mIsAnimationtimeForAtt = isAtt;
    }
    ...
    public void delayForPlayAnimation() {
        ...
        if (this.mIsAnimationtimeForCmcc || this.mIsAnimationtimeForAtt) {
            Log.i(TAG, "delay for paly cmcc or att animation");
            ...
            if (j > 0) {
                ...
                if (this.mEndAnimationTime > 0) {
                    ...
                    int sleepCount = 1;
                    while (SystemProperties.get("persist.sys.rbootanim.exit", "0").equals("0") && ((long) sleepCount) < (this.mEndAnimationTime / 500) + 1) {
                        try {
                    ...
                    Log.i(TAG, "persist.sys.rbootanim.exit :" + SystemProperties.get("persist.sys.rbootanim.exit", "0"));
                    if (SystemProperties.get("persist.sys.rbootanim.exit", "0").equals("1")) {
                        SystemProperties.set("persist.sys.rbootanim.exit", "0");
                    }
                }
            }
        }
    ...
    private void playShutdownAnimation() {
        ...
        if (this.mIsAnimationtimeForAtt) {
            this.mBeginAnimationTime = SystemClock.elapsedRealtime() + 8000;
        }
    ...
    private void onCheckShutdownTimeout(boolean reboot, String reason, int shutdonwVibrateInMs, AudioAttributes vibrateAttribute) {
