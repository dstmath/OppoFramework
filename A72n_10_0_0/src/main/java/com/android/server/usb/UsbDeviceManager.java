...
public class UsbDeviceManager implements ActivityTaskManagerInternal.ScreenObserver {
    ...
    private final class UsbUEventObserver extends UEventObserver {
        ...
        public void onUEvent(UEventObserver.UEvent event) {
            ...
            Slog.v(str, "USB UEVENT: " + event.toString());
    ...
    public static abstract class UsbHandler extends Handler {
        ...
        private void setAdbEnabled(boolean enable) {
            String str = UsbDeviceManager.TAG;
            Slog.d(str, "setAdbEnabled: " + enable);
            if (enable) {
        ...
        public void updateUsbStateBroadcastIfNeeded(long functions) {
            ...
            if (!isUsbStateChanged(intent)) {
                String str = UsbDeviceManager.TAG;
                Slog.d(str, "skip broadcasting " + intent + " extras: " + intent.getExtras());
                return;
            }
            String str2 = UsbDeviceManager.TAG;
            Slog.d(str2, "broadcasting " + intent + " extras: " + intent.getExtras());
    ...
    private static final class UsbHandlerLegacy extends UsbHandler {
        ...
        private boolean waitForAdbState(String state) {
            ...
            String str = UsbDeviceManager.TAG;
            Slog.e(str, "waitForAdbState(" + state + ") FAILED: got " + value);
            return false;
        }

        private void setUsbConfig(String config) {
            String str = UsbDeviceManager.TAG;
            Slog.d(str, "setUsbConfig(" + config + ")");
        ...
        public void setEnabledFunctions(long usbFunctions, boolean forceRestart) {
            ...
            String str = UsbDeviceManager.TAG;
            Slog.d(str, "setEnabledFunctions functions=" + usbFunctions + ", forceRestart=" + forceRestart + ",usbDataUnlocked=" + usbDataUnlocked + ",mUsbDataUnlocked=" + this.mUsbDataUnlocked);
        ...
        private boolean isNormalBoot() {
            ...
            if (getSystemProperty("persist.sys.boot.reason", UiModeManagerService.Shell.NIGHT_MODE_STR_UNKNOWN).toLowerCase().contains(BackLightStat.VALUE_UPLOAD_REBOOT) || getSystemProperty("ro.boot.bootreason", UiModeManagerService.Shell.NIGHT_MODE_STR_UNKNOWN).toLowerCase().contains(BackLightStat.VALUE_UPLOAD_REBOOT)) {
                Slog.i(UsbDeviceManager.TAG, "boot reason is reboot");
                bootMode = BackLightStat.VALUE_UPLOAD_REBOOT;
            }
        ...
        private boolean trySetEnabledFunctions(long usbFunctions, boolean forceRestart) {
            ...
            if (functions == null || applyAdbFunction(functions).equals("none")) {
                ...
                String str = UsbDeviceManager.TAG;
                Slog.i(str, "trySetEnabledFunctions functions = " + functions);
            ...
            String str2 = UsbDeviceManager.TAG;
            Slog.i(str2, "Setting USB config to " + functions2);
            ...
            if (!waitForState(oemFunctions)) {
                String str3 = UsbDeviceManager.TAG;
                Slog.e(str3, "Failed to switch USB config to " + functions2);
                return false;
            }
        ...
        private String getPersistProp(boolean functions) {
            String bootMode = getSystemProperty(UsbDeviceManager.BOOT_MODE_PROPERTY, UiModeManagerService.Shell.NIGHT_MODE_STR_UNKNOWN);
            if ((bootMode.equals(BackLightStat.VALUE_UPLOAD_REBOOT) && SystemProperties.getBoolean("persist.sys.allcommode", false)) || isNormalBoot()) {
    ...
    private static final class UsbHandlerHal extends UsbHandler {
        ...
        final class ServiceNotification extends IServiceNotification.Stub {
            ...
            public void onRegistration(String fqName, String name, boolean preexisting) {
                String str = UsbDeviceManager.TAG;
                Slog.i(str, "Usb gadget hal service started " + fqName + StringUtils.SPACE + name);
        ...
        public void setEnabledFunctions(long functions, boolean forceRestart) {
            String str = UsbDeviceManager.TAG;
            Slog.d(str, "setEnabledFunctions functions=" + functions + ", forceRestart=" + forceRestart);
