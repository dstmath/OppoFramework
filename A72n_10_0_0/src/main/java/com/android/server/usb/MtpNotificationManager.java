...
class MtpNotificationManager {
    ...
    public void showNotification(UsbDevice device) {
        ...
        Notification.Builder builder = new Notification.Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(resources.getString(17041171, device.getProductName())).setContentText(resources.getString(17041170)).setSmallIcon(17303551).setCategory("sys");
