...
public class OppoUsbDeviceFeature implements IOppoUsbDeviceFeature {
    ...
    private static final String ANDROID_LOG_TAG = "PSW_Android";
    private static final boolean DBG_FUN = true;
    private static final boolean DBG_METHOD = true;
    private static final String SEND_COMMON_DCS_UPLOADER_NAME = "sendCommonDcsUploader";
    ...
    private boolean sendCommonDcsUploader(String eventId, HashMap<String, String> dataMap) {
        try {
            Class<?> cx = Class.forName(ACTIVITY_THREAD_CLASS_NAME);
            Object ret = cx.getMethod(SEND_COMMON_DCS_UPLOADER_NAME, String.class, String.class, HashMap.class).invoke(cx, ANDROID_LOG_TAG, eventId, dataMap);
            if (ret != null) {
    ...
    public void usbConfigRecord(String functions) {
        ...
        data.put("usbconfig", functions);
        sendCommonDcsUploader("mtporptp", data);
    }
