...
public class HdmiControlService extends SystemService {
    ...
    private class HdmiControlBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean isReboot = SystemProperties.get(ShutdownThread.SHUTDOWN_ACTION_PROPERTY).contains(NoFocusWindow.HUNG_CONFIG_ENABLE);
        ...
        try {
            ...
            runOnServiceThread(new Runnable() {
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:11:0x0028, code lost:
                    ...
                    r2 = new android.hardware.hdmi.HdmiHotplugEvent(r1.getId(), r6.this$0.mCecController.isConnected(r1.getId()));
                    r3 = r6.this$0.mLock;
                 */
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:14:?, code lost:
                    r6.this$0.invokeHotplugEventListenerLocked(r5, r2);
                 */
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:8:0x0018, code lost:
                    r0 = r6.this$0.mPortInfo.iterator();
                 */
                public void run() {
                    synchronized (HdmiControlService.this.mLock) {
