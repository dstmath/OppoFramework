...
public class OppoNetworkRecordHelper {
    ...
    public class RecordLastConnectedTimeComparator implements Comparator<WifiConfiguration> {
    ...
    /* access modifiers changed from: package-private */
    public class RecordConnectCountComparator implements Comparator<WifiConfiguration> {
