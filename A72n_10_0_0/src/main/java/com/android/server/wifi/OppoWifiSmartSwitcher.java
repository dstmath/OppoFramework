...
public class OppoWifiSmartSwitcher {
    ...
    /* access modifiers changed from: private */
    public final class WifiSmartSwitcherHandler extends Handler {
    ...
    public class ConnectedApInfo {
        ...
        private Integer mConnectCount = 0;
    ...
    private void handleWifiConnected() {
        ...
        if (mWifiInfo != null) {
            ...
            Integer unused = mConnectedApInfo.mConnectCount;
            ...
            for (String key : this.mConnectedApInfoHashMap.keySet()) {
                ...
                if (connectedApInfo != null) {
                    ...
                    for (String str : connectedApInfo.mBSSIDList) {
                        bssidStr = bssidStr == null ? str : bssidStr + TAG_BSSID_SEPERATOR + str;
                    }
