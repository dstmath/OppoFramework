...
public class ClientModeImpl extends StateMachine {
    ...
    private static final int DEFAULT_MAX_PERIODIC_SCAN_INTERVAL_MS = 120000;
    ...
    public static final int WIFI_DRIVER_GPS_BLANK_ON = 1;
    public static final int WIFI_DRIVER_WIFI_DISCONNECT = 2;
    public static final int WIFI_DRVIER_ANTSWAP = 0;
    ...
    private OppoArpPeer.ArpPeerChangeCallback mDADCallback = new OppoArpPeer.ArpPeerChangeCallback() {
    ...
    private OppoIPConflictDetector mDADetector = null;
    ...
    private int mIs1x1IotRouter = -1;
    private boolean mIsAutoRoaming = false;
    boolean mIsChangekeymgmt = false;
    ...
    private OppoClientModeImplUtil mOppoClientModeImplUtil;
    private OppoDhcpRecord mOppoDhcpRecord = null;
    private OppoMtuProber mOppoMtuProber;
    private OppoNfHooksHelper mOppoNfHooksHelper;
    ...
    private boolean mSmartGearFeature;
    ...
    static /* synthetic */ int access$10808(ClientModeImpl x0) {
    ...
    static /* synthetic */ int access$15508(ClientModeImpl x0) {
    ...
    static /* synthetic */ int access$4908(ClientModeImpl x0) {
    ...
    public ClientModeImpl(Context context, FrameworkFacade facade, Looper looper, UserManager userManager, WifiInjector wifiInjector, BackupManagerProxy backupManagerProxy, WifiCountryCode countryCode, WifiNative wifiNative, WrongPasswordNotifier wrongPasswordNotifier, SarManager sarManager, WifiTrafficPoller wifiTrafficPoller, LinkProbeManager linkProbeManager) {
                ...
                if (ClientModeImpl.this.mContext.getPackageManager().hasSystemFeature("oppo.common_center.wlan.assistant")) {
                    ...
                    if (isWlanAssistant) {
                        if (ClientModeImpl.this.mWifiNetworkAvailable != null) {
                            ...
                            ClientModeImpl.this.mWifiNetworkAvailable = null;
                        }
                        if (ClientModeImpl.this.mWifiNetworkStateTraker == null) {
                            ClientModeImpl clientModeImpl = ClientModeImpl.this;
                            clientModeImpl.mWifiNetworkStateTraker = clientModeImpl.makeWifiNetworkStateTracker();
                    ...
                    if (ClientModeImpl.this.mWifiNetworkStateTraker != null) {
                        ...
                        ClientModeImpl.this.mWifiNetworkStateTraker = null;
                    }
                    if (ClientModeImpl.this.mWifiNetworkAvailable == null) {
                        ClientModeImpl clientModeImpl3 = ClientModeImpl.this;
                        clientModeImpl3.mWifiNetworkAvailable = clientModeImpl3.makeWifiNetworkAvailable();
        ...
        WifiConnectivityManager.MAX_PERIODIC_SCAN_INTERVAL_MS = getRomUpdateIntegerValue("MAX_RUS_PERIODIC_SCAN_INTERVAL_MS", 120000).intValue();
        ...
        OppoWifiConnectRestriction.init(this.mContext, this.mWifiConfigManager, this, this.mWifiRomUpdateHelper, this.mScanRequestProxy);
        if (OppoWifiConnectRestriction.getInstance() != null) {
            OppoWifiConnectRestriction.getInstance().enableVerboseLogging(this.mVerboseLoggingEnabled ? 1 : 0);
        }
    }
    ...
    public void enableVerboseLogging(int verbose) {
        ...
        if (OppoWifiConnectRestriction.getInstance() != null) {
            OppoWifiConnectRestriction.getInstance().enableVerboseLogging(verbose);
        }
    }
    ...
    public String getWhatToString(int what) {
        ...
        switch (what) {
            ...
            case M_CMD_SET_POWER_SAVING_MODE /* 131487 */:
    ...
    private void fetchRssiLinkSpeedAndFrequencyNative() {
        ...
        if (pollResult != null) {
            ...
            if (newRssi == 0) {
                newRssi = this.mWifiInfo.getRssi();
            }
            if (newRssi <= -127 || newRssi >= 200) {
                this.mWifiInfo.setRssi(-127);
                updateCapabilities();
            } else {
                if (newRssi > 0 && newRssi <= 130) {
                    logd("rssi too high, reset to -1");
                    newRssi = -1;
                } else if (newRssi > 130) {
                ...
                if (this.mWifiInjector.getWifiDisconStat() != null) {
                    ...
                    this.mWifiInjector.getWifiDisconStat().syncFreq(newFrequency);
                }
    ...
    private SupplicantState handleSupplicantStateChange(Message message) {
        ...
        if (this.mLastSupplicantState == SupplicantState.COMPLETED && state == SupplicantState.DISCONNECTED && config != null && this.mWifiNative != null) {
            if (this.mWifiConfigManager.isCustomizeAutoConnectDisabled()) {
                this.mWifiNative.removeNetworkIfCurrent(this.mInterfaceName, config.networkId);
            }
            if (this.mWifiConfigManager.isAutoConnectSwitchEnable() && config.userApproved == 1001) {
                this.mWifiNative.removeNetworkIfCurrent(this.mInterfaceName, config.networkId);
            }
        }
    ...
    private void handleNetworkDisconnect() {
        ...
        if (this.mWifiInjector.getWifiDisconStat() != null) {
            this.mWifiInjector.getWifiDisconStat().startDisconnectionDetect(false, false);
        }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_ADD_OR_UPDATE_NETWORK /* 131124 */:
                    ...
                    if (saveConfig != null && config.hiddenSSID) {
                        if (currConfig != null && ClientModeImpl.this.mWifiInfo.getNetworkId() == saveConfig.networkId && "ConnectedState".equalsIgnoreCase(ClientModeImpl.this.getCurrentState().getName()) && config.macRandomizationSetting == currConfig.macRandomizationSetting) {
                            ...
                            ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) ClientModeImpl.CMD_ADD_OR_UPDATE_NETWORK, saveConfig.networkId);
                            break;
                        } else {
                    ...
                    if ((WifiConfigurationUtil.hasMacRandomizationSettingsChanged(currConfig, config) || result.hasCredentialChanged()) && ClientModeImpl.this.mWifiInfo != null && ClientModeImpl.this.mWifiInfo.getNetworkId() == config.networkId && ClientModeImpl.this.isNetworkConnecting()) {
                        ...
                        if (config.networkId == ClientModeImpl.this.mTargetNetworkId || config.networkId == ClientModeImpl.this.mLastNetworkId) {
                            ClientModeImpl.this.notifyDisconnectPktName(null, message.sendingUid, 4);
                        }
                ...
                case ClientModeImpl.CMD_ENABLE_NETWORK /* 131126 */:
                    ...
                    clientModeImpl2.replyToMessage((ClientModeImpl) message, (Message) i, removeResult);
                    break;
                ...
                case ClientModeImpl.M_CMD_SET_POWER_SAVING_MODE /* 131487 */:
                    break;
                ...
                case ClientModeImpl.CMD_ENABLE_RSSI_POLL /* 131154 */:
                    ...
                    clientModeImpl3.mEnableRssiPolling = disableOthers;
                    break;
                case ClientModeImpl.CMD_SET_SUSPEND_OPT_ENABLED /* 131158 */:
                    ...
                    if (ClientModeImpl.this.mActiveModeWarden == null) {
                        ClientModeImpl clientModeImpl4 = ClientModeImpl.this;
                        clientModeImpl4.mActiveModeWarden = clientModeImpl4.mWifiInjector.getActiveModeWarden();
                    }
                    if (ClientModeImpl.this.mActiveModeWarden != null) {
                ...
                case ClientModeImpl.CMD_REMOVE_APP_CONFIGURATIONS /* 131169 */:
                    ...
                    break;
                case ClientModeImpl.CMD_FIRMWARE_ALERT /* 131172 */:
                ...
                case ClientModeImpl.CMD_BOOT_COMPLETED /* 131206 */:
                    ...
                    if (!ClientModeImpl.this.hasLoadStore) {
                        if (!ClientModeImpl.this.mWifiConfigManager.loadFromStore()) {
                            ...
                            ClientModeImpl.this.hasLoadStore = true;
                        }
                    }
                ...
                case ClientModeImpl.CMD_INITIALIZE /* 131207 */:
                    ...
                    clientModeImpl6.replyToMessage((ClientModeImpl) message, (Message) i2, removeResult);
                    break;
                ...
                case ClientModeImpl.CMD_START_SUBSCRIPTION_PROVISIONING /* 131326 */:
                    ...
                    break;
                case ClientModeImpl.CMD_TRIGGER_MINIDUMP_ENABLE /* 131478 */:
                    ClientModeImpl.this.handleWifiMinidumpSwitch();
                    break;
                case ClientModeImpl.CMD_START_SCAN /* 131479 */:
                ...
                case WifiMonitor.PNO_SCAN_RESULTS_EVENT /* 147474 */:
                    ...
                    if (!ClientModeImpl.this.mScreenOn) {
                        ClientModeImpl.access$4908(ClientModeImpl.this);
                        break;
                    }
                    break;
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /* 147462 */:
                    ...
                    if (!(stateChangeResult == null || ClientModeImpl.this.mLastSupplicantState == (state = stateChangeResult.state))) {
                        ClientModeImpl.this.mLastSupplicantState = state;
                        break;
                    }
                case 151553:
                ...
                case 151559:
                    ...
                    break;
                case 151562:
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151564, 2);
                    break;
                case 151566:
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151567, 2);
                    break;
                case 151569:
    ...
    class ConnectModeState extends State {
        ...
        public void enter() {
            ...
            ClientModeImpl clientModeImpl = ClientModeImpl.this;
            clientModeImpl.mSmartGearFeature = clientModeImpl.mOppoClientModeImplUtil.isSmartGearEnable();
        ...
        /* JADX INFO: Multiple debug info for r2v59 int: [D('netId' int), D('ok' boolean)] */
        /* JADX INFO: Multiple debug info for r2v66 int: [D('slot' int), D('ok' boolean)] */
        /* JADX INFO: Multiple debug info for r2v76 int: [D('restoreNetid' int), D('ok' boolean)] */
        /* JADX INFO: Multiple debug info for r2v120 int: [D('netId' int), D('ok' boolean)] */
        /* JADX WARNING: Code restructure failed: missing block: B:536:0x1222, code lost:
            if (r5.isProviderOwnedNetwork(r5.mLastNetworkId, r2) != false) goto L_0x1224;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:545:0x1291, code lost:
            if (r7.isProviderOwnedNetwork(r7.mLastNetworkId, r6) != false) goto L_0x1293;
         */
        public boolean processMessage(Message message) {
            boolean ok;
            boolean ok2;
            ...
            switch (message.what) {
                case ClientModeImpl.CMD_BLUETOOTH_ADAPTER_STATE_CHANGE /* 131103 */:
                    ok = false;
                    ClientModeImpl.this.mBluetoothConnectionActive = message.arg1 != 0;
                ...
                case ClientModeImpl.CMD_ENABLE_NETWORK /* 131126 */:
                    ...
                    clientModeImpl.replyToMessage((ClientModeImpl) message, (Message) i3, i2);
                    ok = ok2;
                    break;
                case ClientModeImpl.CMD_GET_LINK_LAYER_STATS /* 131135 */:
                    ok = false;
                ...
                case ClientModeImpl.CMD_REASSOCIATE /* 131147 */:
                    ok = false;
                    ClientModeImpl clientModeImpl2 = ClientModeImpl.this;
                    clientModeImpl2.mLastConnectAttemptTimestamp = clientModeImpl2.mClock.getWallClockMillis();
                ...
                case ClientModeImpl.CMD_DISABLE_EPHEMERAL_NETWORK /* 131170 */:
                    ...
                    if (config != null && (config.networkId == ClientModeImpl.this.mTargetNetworkId || config.networkId == ClientModeImpl.this.mLastNetworkId)) {
                        ClientModeImpl.this.sendMessage(ClientModeImpl.CMD_DISCONNECT);
                        ClientModeImpl.this.notifyDisconnectPktName(null, message.sendingUid, 0);
                        break;
                    }
                case ClientModeImpl.CMD_RESET_SIM_NETWORKS /* 131173 */:
                    ok = false;
                ...
                case ClientModeImpl.CMD_START_CONNECT /* 131215 */:
                    ...
                    if (config2 != null) {
                        ...
                        if (bssidTmpReset.booleanValue()) {
                            ClientModeImpl.this.setTargetBssid(config2, tmpBssid);
                        } else {
                        ...
                        if (!ClientModeImpl.this.mWifiNative.connectToNetwork(ClientModeImpl.this.mInterfaceName, config2)) {
                            ...
                            clientModeImpl8.mLastConnectAttemptTimestamp = clientModeImpl8.mClock.getWallClockMillis();
                ...
                case ClientModeImpl.CMD_START_SUBSCRIPTION_PROVISIONING /* 131326 */:
                    ok = false;
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) message.what, ClientModeImpl.this.mPasspointManager.startSubscriptionProvisioning(message.arg1, message.getData().getParcelable(ClientModeImpl.EXTRA_OSU_PROVIDER), (IProvisioningCallback) message.obj) ? 1 : 0);
                    break;
                case ClientModeImpl.CMD_TRIGGER_RESTORE_DELAY /* 131477 */:
                    ok = false;
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /* 147459 */:
                    ...
                    if (OppoWifiConnectRestriction.getInstance() != null) {
                        WifiConfiguration lastConfig = ClientModeImpl.this.mWifiConfigManager.getConfiguredNetwork(ClientModeImpl.this.mLastNetworkId);
                        boolean isManu = ClientModeImpl.this.isManuConnect();
                        if (!OppoWifiConnectRestriction.getInstance().bssidAllowedToConnect(ClientModeImpl.this.mLastBssid, ClientModeImpl.this.mLastNetworkId)) {
                            if (isManu && lastConfig.hiddenSSID) {
                                ClientModeImpl.this.log("not allowed to connect, need to exit WS_WLAN_OppoWifiEditorFragment");
                                ClientModeImpl.this.mWifiConfigManager.sendAlertNetworksChangedBroadcast(lastConfig.networkId, lastConfig, -1, SupplicantState.COMPLETED);
                            }
                            ClientModeImpl.this.sendMessage(ClientModeImpl.CMD_DISCONNECT);
                            break;
                        }
                    ...
                    if (config3 == null) {
                        ...
                        ClientModeImpl.this.mConnectionTimeStamp = System.currentTimeMillis();
                        if (ClientModeImpl.this.mWifiInjector.getWifiDisconStat() != null) {
                            ClientModeImpl.this.mWifiInjector.getWifiDisconStat().updateConnectEvent(2);
                        }
                ...
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /* 147499 */:
                    ...
                    if (!ClientModeImpl.this.attemptWpa2FallbackConnectionIfRequired(bssid3)) {
                        if (bssid3 != null) {
                            ...
                            clientModeImpl16.mDidBlackListBSSID = clientModeImpl16.mWifiConnectivityManager.trackBssid(bssid3, false, reasonCode3);
                        }
                ...
                case 151553:
                    ...
                    ClientModeImpl.convertToQuotedSSID(config4);
                    if (OppoManuConnectManager.getInstance() != null) {
                    ...
                    if (OppoWifiConnectRestriction.getInstance() != null && !OppoWifiConnectRestriction.getInstance().netIdAllowedToConnect(netId5)) {
                        ClientModeImpl.this.loge("CONNECT_NETWORK not allowed to connect for illegal");
                        ClientModeImpl.this.mMessageHandlingStatus = -2;
                        ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151554, 0);
                        break;
                    } else {
                        ...
                        ClientModeImpl.this.mLastSelectEvtTimeStamp = System.currentTimeMillis();
                        ...
                        if (ClientModeImpl.this.connectToUserSelectNetwork(netId5, message.sendingUid, hasCredentialChanged)) {
                            ...
                            if (ClientModeImpl.this.mWifiConfigManager != null) {
                                ClientModeImpl.this.logd("Connect by CONNECT_NETWORK");
                                ClientModeImpl.this.mWifiConfigManager.statisticsStartConPkgName(message.sendingUid);
                            }
                            ...
                            if (SystemProperties.get("ro.secure", "0").equals("1") && SystemProperties.get("debug.wifi.prdebug", "0").equals("0")) {
                                ...
                                if (!ClientModeImpl.this.mVerboseLoggingEnabled) {
                                    ...
                                    ClientModeImpl.this.mFromKeylogVerbose = true;
                                }
                            }
                ...
                case 151559:
                    ...
                    if (config5 != null && config5.SSID == null && config5.networkId != -1 && ClientModeImpl.this.mWifiConfigManager.getConfiguredNetwork(config5.networkId) == null) {
                        ...
                        if (!(!ClientModeImpl.this.mWifiConfigManager.isCustomizeAutoConnectDisabled() || ClientModeImpl.this.getCurrentState() == ClientModeImpl.this.mConnectedState || ClientModeImpl.this.mWifiNative == null)) {
                ...
                case 151562:
                    ...
                    if (wpsInfo != null) {
                        ...
                        if (i4 == 0) {
                            ...
                            ClientModeImpl.this.mIsRandomMacCleared = true;
                        ...
                        if (wpsResult.status != WpsResult.Status.SUCCESS) {
                            ...
                            ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151564, 0);
                            if (OppoManuConnectManager.getInstance() == null) {
                                ok = false;
                                break;
                            } else {
                            ...
                            ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151563, (int) wpsResult);
            ...
            if (this == ClientModeImpl.this.mNetworkAgent) {
                if (status != this.mLastNetworkStatus || (status == 2 && !TextUtils.isEmpty(this.mLastRedirectUrl) && TextUtils.isEmpty(redirectUrl))) {
                    ...
                    if (status == 2) {
                        ...
                        ClientModeImpl.this.mNetworkDetectValid = false;
                        ...
                        ClientModeImpl.this.mNetworkDetectValid = true;
    ...
    class L2ConnectedState extends State {
        ...
        public void enter() {
            ClientModeImpl.this.mOppoClientModeImplUtil.resetSaeNetworkConsecutiveAssocRejectCounter();
            ClientModeImpl.access$10808(ClientModeImpl.this);
            ...
            synchronized (ClientModeImpl.this.mNetworkAgentLock) {
                ClientModeImpl.this.mNetworkAgent = new WifiNetworkAgent(ClientModeImpl.this.getHandler().getLooper(), ClientModeImpl.this.mContext, "WifiNetworkAgent", ClientModeImpl.this.mNetworkInfo, nc, ClientModeImpl.this.mLinkProperties, 5, ClientModeImpl.this.mNetworkMisc);
            }
        ...
        public void exit() {
            ...
            ClientModeImpl.this.mIs1x1IotRouter = -1;
        }

        /* JADX INFO: Multiple debug info for r1v129 int: [D('slot' int), D('currRssi' byte)] */
        /* JADX INFO: Multiple debug info for r1v232 int: [D('netId' int), D('info' android.net.wifi.RssiPacketCountInfo)] */
        public boolean processMessage(Message message) {
            ScanDetailCache scanDetailCache;
            ScanResult scanResult;
                ...
                case ClientModeImpl.CMD_START_CONNECT /* 131215 */:
                    ...
                    if (ClientModeImpl.this.mWifiInfo == null || ClientModeImpl.this.mWifiInfo.getNetworkId() != startConnectId || connectConfig == null || !ClientModeImpl.this.mWifiNative.isSameNetwork(ClientModeImpl.this.mInterfaceName, connectConfig)) {
                        if (ClientModeImpl.this.mWifiNative != null) {
                            ClientModeImpl.this.mWifiNative.disconnect(ClientModeImpl.this.mInterfaceName);
                            ClientModeImpl.this.notifyDisconnectPktName(null, message.arg2, 0);
                        }
                        return false;
                    }
                case ClientModeImpl.CMD_ASSOCIATED_BSSID /* 131219 */:
    ...
    class ObtainingIpState extends State {
        ...
        public void enter() {
            ...
            if (SystemProperties.getInt("persist.sys.wifi_secure", 0) != 1 || currentConfig.checkWifiSecureLevel()) {
                ...
                if (ClientModeImpl.this.mVerboseLoggingEnabled) {
                    ...
                    ClientModeImpl.this.log("enter ObtainingIpState netId=" + Integer.toString(ClientModeImpl.this.mLastNetworkId) + " " + key + "  roam=" + ClientModeImpl.this.mIsAutoRoaming + " static=" + isUsingStaticIp);
                }
                ...
                if (ClientModeImpl.this.mVerboseLoggingEnabled) {
                    ClientModeImpl.this.logd("[bug#1131400] ObtainingIpState enter: StartType=" + dhcpStartType + "init dhcpResult" + dhcpResult);
                }
                if (ClientModeImpl.this.mIpClient != null) {
            ...
            ClientModeImpl.this.logd("checkWifiSecureLevel is false");
            ClientModeImpl.this.mWifiNative.disconnect(ClientModeImpl.this.mInterfaceName);
            ClientModeImpl clientModeImpl2 = ClientModeImpl.this;
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_START_ROAM /* 131217 */:
                    ...
                    break;
                case ClientModeImpl.CMD_START_SCAN /* 131479 */:
                    if (((ClientModeImpl) ClientModeImpl.this).mVerboseLoggingEnabled) {
                        ClientModeImpl.this.logd("[1716726] Defer scan reques in mObtainingIpState");
                    }
                    ClientModeImpl.this.mMessageHandlingStatus = ClientModeImpl.MESSAGE_HANDLING_STATUS_DEFERRED;
                    ClientModeImpl.this.deferMessage(message);
                    break;
                case ClientModeImpl.EVENT_DHCP_STATE_CHANGE /* 131488 */:
                    ...
                    break;
                case ClientModeImpl.EVENT_DO_DUP_ARP /* 131489 */:
                    ...
                    ClientModeImpl clientModeImpl2 = ClientModeImpl.this;
                    clientModeImpl2.mDADetector = new OppoIPConflictDetector(clientModeImpl2.mContext, (NetworkAgentInfo) null, ClientModeImpl.this.mDADCallback);
                    if (ClientModeImpl.this.mDADetector != null) {
                        ClientModeImpl.this.mDADetector.doDupArp(ifaceName, myAddr, target);
                        break;
                    }
                    break;
                case ClientModeImpl.EVENT_DO_GATEWAY_DETECT /* 131490 */:
                    ...
                    ClientModeImpl clientModeImpl3 = ClientModeImpl.this;
                    clientModeImpl3.mGWDetector = new OppoIPConflictDetector(clientModeImpl3.mContext, (NetworkAgentInfo) null, ClientModeImpl.this.mGWDCallback);
                    if (ClientModeImpl.this.mGWDetector != null) {
    ...
    class CaptiveState extends State {
        ...
        public void enter() {
            ...
            ClientModeImpl clientModeImpl2 = ClientModeImpl.this;
            clientModeImpl2.mConnectedId = clientModeImpl2.mLastNetworkId;
            if (ClientModeImpl.this.mWifiNetworkStateTraker != null) {
            ...
            ClientModeImpl.this.setNetworkDetailedState(NetworkInfo.DetailedState.CAPTIVE_PORTAL_CHECK);
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_UNWANTED_NETWORK /* 131216 */:
                    if (message.arg1 == 1) {
                        ...
                        if (!ClientModeImpl.this.mOppoDhcpRecord.needSwitchDhcpServer()) {
                            ...
                            ClientModeImpl.this.mWifiNative.disconnect(ClientModeImpl.this.mInterfaceName);
                            ClientModeImpl.this.notifyDisconnectPktName(null, message.sendingUid, 6);
                            ClientModeImpl clientModeImpl5 = ClientModeImpl.this;
                            clientModeImpl5.transitionTo(clientModeImpl5.mDisconnectingState);
                            if (ClientModeImpl.this.mWifiNetworkStateTraker != null) {
                ...
                case ClientModeImpl.CMD_START_ROAM /* 131217 */:
                    ...
                    if (config != null) {
                        ClientModeImpl.this.setTargetBssid(config, bssid);
                        ...
                        if (!ClientModeImpl.this.mWifiNative.roamToNetwork(ClientModeImpl.this.mInterfaceName, config)) {
                            ...
                            ClientModeImpl clientModeImpl10 = ClientModeImpl.this;
                            clientModeImpl10.mLastConnectAttemptTimestamp = clientModeImpl10.mClock.getWallClockMillis();
                            ClientModeImpl.this.mTargetWifiConfiguration = config;
                            ClientModeImpl.this.mIsAutoRoaming = true;
                ...
                case ClientModeImpl.CMD_NETWORK_STATUS /* 131220 */:
                    if (message.arg1 == 1) {
                        ...
                        if (ClientModeImpl.this.mWifiInjector.getWifiDisconStat() != null) {
                            ClientModeImpl.this.mWifiInjector.getWifiDisconStat().updateConnectEvent(4);
                        }
                        ClientModeImpl clientModeImpl12 = ClientModeImpl.this;
                    ...
                    break;
                case ClientModeImpl.CMD_AUTO_CON_CAPTIVE /* 131482 */:
                    if (message.arg1 == 3) {
            ...
            switch (message.what) {
                case ClientModeImpl.CMD_ROAM_WATCHDOG_TIMER /* 131166 */:
                    if (ClientModeImpl.this.mRoamWatchdogCount == message.arg1) {
                        ...
                        ClientModeImpl.access$15508(ClientModeImpl.this);
                        ClientModeImpl.this.handleNetworkDisconnect();
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /* 147462 */:
                    ...
                    if (ClientModeImpl.this.mLastSupplicantState != stateChangeResult.state) {
                        ClientModeImpl.this.mLastSupplicantState = stateChangeResult.state;
                    }
    ...
    class ConnectedState extends State {
        ...
        public void enter() {
            ...
            if (ClientModeImpl.this.mWifiConfigManager != null) {
                ClientModeImpl.this.mWifiConfigManager.storethirdAPKWifiDiagnosis(null, null, true, 0);
            }
            if (OppoDataStallHelper.getInstance() != null) {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_START_ROAM /* 131217 */:
                    ...
                    if (config2 != null) {
                        ...
                        if (!ClientModeImpl.this.mWifiNative.roamToNetwork(ClientModeImpl.this.mInterfaceName, config2)) {
                            ...
                            ClientModeImpl clientModeImpl4 = ClientModeImpl.this;
                            clientModeImpl4.mLastConnectAttemptTimestamp = clientModeImpl4.mClock.getWallClockMillis();
                            ClientModeImpl.this.mTargetWifiConfiguration = config2;
                            ClientModeImpl.this.mIsAutoRoaming = true;
                ...
                case ClientModeImpl.CMD_ASSOCIATED_BSSID /* 131219 */:
                    ClientModeImpl clientModeImpl6 = ClientModeImpl.this;
                    clientModeImpl6.mLastDriverRoamAttempt = clientModeImpl6.mClock.getWallClockMillis();
                    handleStatus = false;
                    break;
                case ClientModeImpl.CMD_NETWORK_STATUS /* 131220 */:
                    if (message.arg1 == 1) {
                ...
                case ClientModeImpl.CMD_ACCEPT_UNVALIDATED /* 131225 */:
                    ...
                    break;
                case ClientModeImpl.CMD_CHECK_INTERNET_ACCESS /* 131480 */:
            ...
            switch (message.what) {
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /* 147462 */:
                    ...
                    if (stateChangeResult != null && stateChangeResult.state != null) {
                        ...
                        if (stateChangeResult.state == SupplicantState.ASSOCIATED && ClientModeImpl.this.mWifiInjector.getWifiDisconStat() != null) {
                            ClientModeImpl.this.mWifiInjector.getWifiDisconStat().updateConnectEvent(1);
                        }
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /* 147459 */:
                    ...
                    if (!success) {
                        ClientModeImpl.this.replyToMessage((ClientModeImpl) this.mSourceMessage, (Message) 151564, 0);
                    } else if (netId == -1) {
                ...
                case WifiMonitor.WPS_FAIL_EVENT /* 147465 */:
                    if (message.arg1 == 0 && message.arg2 == 0) {
                        ...
                        ClientModeImpl.this.replyToMessage((ClientModeImpl) this.mSourceMessage, (Message) 151564, message.arg1);
                        this.mSourceMessage.recycle();
                        this.mSourceMessage = null;
                        if (OppoManuConnectManager.getInstance() != null) {
                            OppoManuConnectManager.getInstance().reset();
                    ...
                    break;
                case WifiMonitor.WPS_OVERLAP_EVENT /* 147466 */:
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) this.mSourceMessage, (Message) 151564, 3);
                    this.mSourceMessage.recycle();
                    this.mSourceMessage = null;
                    if (OppoManuConnectManager.getInstance() != null) {
                        OppoManuConnectManager.getInstance().reset();
                ...
                case WifiMonitor.WPS_TIMEOUT_EVENT /* 147467 */:
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) this.mSourceMessage, (Message) 151564, 7);
                    this.mSourceMessage.recycle();
                    this.mSourceMessage = null;
                    if (OppoManuConnectManager.getInstance() != null) {
                        OppoManuConnectManager.getInstance().reset();
                ...
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /* 147499 */:
                    ...
                    break;
                case 151562:
                    ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151564, 1);
                    break;
                case 151566:
                    if (ClientModeImpl.this.mWifiNative.cancelWps(ClientModeImpl.this.mInterfaceName)) {
                        ...
                        ClientModeImpl.this.replyToMessage((ClientModeImpl) message, (Message) 151567, 0);
                    }
                    if (OppoManuConnectManager.getInstance() != null) {
                        OppoManuConnectManager.getInstance().reset();
                    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void handleWifiMinidumpSwitch() {
    ...
    public static String convertToQuotedSSID(String ssid) {
    ...
    public static void convertToQuotedSSID(WifiConfiguration config) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void enableTcpTimestamps(boolean enable, int errorThreshold) {
        try {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void changeTcpRandomTS(boolean onConnected) {
    ...
    public boolean tryOtherSsidIfSelectNetworkTimeout() {
        WifiConfiguration config = this.mWifiConfigManager.getConfiguredNetwork(this.mTargetNetworkId);
        if (config == null) {
            Log.d(TAG, "config = null, mTargetNetworkId =" + this.mTargetNetworkId);
            return false;
        }
        String ssidToAdjust = this.mWifiConfigManager.adjustHiddenSsidIfNeed(config.SSID);
        if (ssidToAdjust == null || !config.hiddenSSID) {
            return false;
        }
        if (!this.mOppoClientModeImplUtil.isScanresulContainConfigkey(this.mOppoScanResultsProxy, this.mWifiConfigManager, this.mTargetNetworkId, ssidToAdjust)) {
            Log.d(TAG, "Can not find : " + ssidToAdjust + " in scan result, just return");
            return false;
        } else if (this.mIsChangekeymgmt) {
            Log.d(TAG, "mIsChangekeymgmt is true ,just return ");
            setChangekeymgmt(false);
            return false;
        } else {
            this.mWifiConfigManager.sendAlertNetworksChangedBroadcast(this.mTargetNetworkId, config, -1, SupplicantState.COMPLETED);
            this.mWifiConfigManager.disableNetwork(config.networkId, 1000);
            config.SSID = ssidToAdjust;
            WifiConfiguration saveConfig = this.mWifiConfigManager.getConfiguredNetwork(new WifiConfiguration(config).configKey(true));
            if (saveConfig != null) {
                Log.d(TAG, "saveConfig != nul, use saveConfig, netid = " + saveConfig.networkId);
                this.mWifiConfigManager.removeNetwork(config.networkId, 1000);
                config.networkId = saveConfig.networkId;
            }
            if (!this.mWifiConfigManager.addOrUpdateNetwork(config, 1000).isSuccess()) {
                Log.d(TAG, "CONNECT_NETWORK adding/updating config=" + config + " failed");
                return false;
            }
            sendMessage(151553, config.networkId);
            Log.d(TAG, "try to connect ssid by adjusted " + ssidToAdjust);
            return true;
        }
    }

    public void setChangekeymgmt(boolean isChangekeymgmt) {
        this.mIsChangekeymgmt = isChangekeymgmt;
    }

    public void notifyBigdataEvent(String data) {
        if (data.length() > 4) {
            int id = (Integer.parseInt(data.substring(2, 4), 16) * 256) + Integer.parseInt(data.substring(0, 2), 16);
            if (id == 0) {
                Log.d(TAG, "antswap");
            } else if (id == 1) {
                Log.d(TAG, "gps blank on");
            } else if (id != 2) {
                Log.d(TAG, "wrong id = " + id);
            } else {
                Log.d(TAG, "wifi disconnect");
                if (this.mWifiInjector.getWifiDisconStat() != null) {
                    this.mWifiInjector.getWifiDisconStat().syncDisconnectionInfo(data);
                }
            }
        } else {
            Log.d(TAG, "notifyBigdataEvent has wrong data");
        }
    }

    public void notifyDisconnectPktName(String pkgName, int uid, int index) {
        if (this.mWifiInjector.getWifiDisconStat() != null) {
            this.mWifiInjector.getWifiDisconStat().syncDisconnectPktName(pkgName, uid, index);
        }
    }

    public boolean matchConnectedNetwork(int netId) {
        if (netId == this.mLastNetworkId || netId == this.mTargetNetworkId) {
            return true;
        }
        return false;
    }
    ...
    public boolean isGameMode() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "gesture_mistouch_in_game_mode", 0) == 1;
    }
}
