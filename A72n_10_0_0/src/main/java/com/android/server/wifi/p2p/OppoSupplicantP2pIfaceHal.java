...
public class OppoSupplicantP2pIfaceHal {
    ...
    private static final String TAG = OppoSupplicantP2pIfaceHal.class.getSimpleName();
    ...
    public ISupplicant getSupplicantMockable() {
        try {
    ...
    private boolean getOppoP2pIface() {
        ...
        try {
            ...
            String str2 = TAG;
            Log.e(str2, "ISupplicant.getInterface IllegalArgumentException exception: " + e2);
            supplicantServiceDiedHandler();
            return false;
        }
    }
            ...
            try {
                ...
                if (config.deviceAddress == null) {
                    ...
                    try {
                                ...
                                try {
                                    this.mIOppoSupplicantP2pIface.p2pConnect(peerAddress, provisionMethod, preSelectedPin, joinExistingGroup, persistent, groupOwnerIntent, freq, new IOppoSupplicantP2pIface.p2pConnectCallback() {
                                        ...
                                        public final void onValues(SupplicantStatus supplicantStatus, String str) {
                                            OppoSupplicantP2pIfaceHal.lambda$connect$2(OppoSupplicantP2pIfaceHal.SupplicantResult.this, supplicantStatus, str);
                                        }
                                    });
                        ...
                        Log.e(TAG, "Could not parse peer mac address.", e5);
                        return null;
                    }
                } else {
            ...
            try {
                this.mIOppoSupplicantP2pIface.addP2pNetwork(new IOppoSupplicantP2pIface.addP2pNetworkCallback() {
                    ...
                    public final void onValues(SupplicantStatus supplicantStatus, int i) {
                        OppoSupplicantP2pIfaceHal.lambda$addP2pNetwork$3(OppoSupplicantP2pIfaceHal.SupplicantResult.this, supplicantStatus, i);
                    }
                });
            } catch (RemoteException e) {
                String str = TAG;
    ...
    public static class SupplicantResult<E> {
        ...
        SupplicantResult(String methodName) {
            ...
            String str = OppoSupplicantP2pIfaceHal.TAG;
            Log.d(str, "entering " + this.mMethodName);
        }

        public void setResult(SupplicantStatus status, E value) {
            OppoSupplicantP2pIfaceHal.logCompletion(this.mMethodName, status);
            String str = OppoSupplicantP2pIfaceHal.TAG;
            Log.d(str, "leaving " + this.mMethodName + " with result = " + ((Object) value));
            this.mStatus = status;
            this.mValue = value;
        }
        ...
        public void setResult(SupplicantStatus status) {
            OppoSupplicantP2pIfaceHal.logCompletion(this.mMethodName, status);
            String str = OppoSupplicantP2pIfaceHal.TAG;
            Log.d(str, "leaving " + this.mMethodName);
            this.mStatus = status;
        }
