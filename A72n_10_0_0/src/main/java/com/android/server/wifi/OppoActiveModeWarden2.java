...
public class OppoActiveModeWarden2 {
    ...
    private OppoClientModeManager2.Listener mClientModeCallback;
    ...
    public class ModeStateMachine extends StateMachine {
        ...
        class ClientModeActiveState extends ModeActiveState {
            ...
            public boolean processMessage(Message message) {
                ...
                if (i != 0) {
                    switch (i) {
                        case OppoActiveModeWarden2.CMD_CLIENT_MODE_STOPPED /* 131375 */:
                        ...
                        case OppoActiveModeWarden2.CMD_CLIENT_MODE_FAILED /* 131376 */:
                            if (this.mListener == message.obj) {
