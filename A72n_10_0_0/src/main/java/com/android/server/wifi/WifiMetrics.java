                ...
                if (this.mPasspointManager != null) {
                    ...
                    for (ScanDetail scanDetail : scanDetails) {
                        ...
                        if (this.mWifiNetworkSelector.isSignalTooWeak(scanResult)) {
                            supporting80211mcAps = supporting80211mcAps;
                            passpointR2UniqueEss = passpointR2UniqueEss;
                            passpointR1UniqueEss = passpointR1UniqueEss;
                        } else {
                            ssids.add(matchInfo);
                            int bssids = openBssids2 + 1;
                            ...
                            if (isSavedPasspoint) {
                                savedPasspointProviderProfiles.add(null);
                    ...
                    for (Integer count : passpointR1UniqueEss.values()) {
                        ...
                        savedPasspointProviderBssids = savedPasspointProviderBssids;
                        ssids = ssids;
                    }
        ...
        synchronized (this.mLock) {
            if (!this.mWifiUsabilityStatsEntriesList.isEmpty()) {
                if (this.mScreenOn) {
                    ...
                    } else if (this.mWifiUsabilityStatsListGood.isEmpty() || this.mWifiUsabilityStatsListGood.getLast().stats[this.mWifiUsabilityStatsListGood.getLast().stats.length - 1].timeStampMs + 3600000 < this.mWifiUsabilityStatsEntriesList.getLast().timeStampMs) {
