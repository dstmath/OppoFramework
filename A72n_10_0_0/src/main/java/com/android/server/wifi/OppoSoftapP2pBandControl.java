...
public class OppoSoftapP2pBandControl {
    ...
    private void initP2pEuropeCountyList() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void initP2pOnly2GCountyList() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void initSoftapEuropeCountyList() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void initSoftapOnly2GCountyList() {
