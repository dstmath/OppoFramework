...
public class SarManager {
    ...
    private void readSarConfigs() {
        ...
        if (this.mSupportSarSensor) {
            this.mSarSensorEventFreeSpace = this.mContext.getResources().getInteger(17694943);
            this.mSarSensorEventNearBody = this.mContext.getResources().getInteger(17694944);
            this.mSarSensorEventNearHand = this.mContext.getResources().getInteger(17694945);
            this.mSarSensorEventNearHead = this.mContext.getResources().getInteger(17694946);
        }
    }
