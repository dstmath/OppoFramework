...
public abstract class OppoWifiServiceImpl extends BaseWifiService {
    ...
    public OppoWifiServiceImpl(Context context, WifiInjector wifiInjector, AsyncChannel asyncChannel) {
        ...
        context.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                OppoWifiServiceImpl.this.mWifiApState = intent.getIntExtra("wifi_state", 11);
            }
    ...
    public boolean startWifiSharing(WifiConfiguration wifiConfig) {
        ...
        if (SystemProperties.getInt("persist.sys.wifi_sharing_disable", 0) == 1) {
            Slog.d(TAG, "startWifiSharing return for spaying");
            return false;
        }
        ...
        synchronized (this.mLocalOnlyHotspotRequests) {
            ...
            return startWifiSharingInternal(wifiConfig2, 1);
        }
    }
    ...
    private OppoSoftApManager getSoftApManager() {
    ...
    public boolean setWifiRestrictionList(String packageName, List<String> list, String type) {
        ...
        if (OppoWifiConnectRestriction.getInstance() != null) {
            return OppoWifiConnectRestriction.getInstance().setWifiRestrictionList(list, type);
        }
        return false;
    }
    ...
    public List<String> getWifiRestrictionList(String packageName, String type) {
        enforceAccessPermission();
        if (OppoWifiConnectRestriction.getInstance() != null) {
            return OppoWifiConnectRestriction.getInstance().getWifiRestrictionList(type);
        }
        return null;
    }
    ...
    public boolean removeFromRestrictionList(String packageName, List<String> list, String type) {
        enforceAccessPermission();
        if (OppoWifiConnectRestriction.getInstance() != null) {
            return OppoWifiConnectRestriction.getInstance().removeFromRestrictionList(list, type);
        }
        return false;
    }
}
