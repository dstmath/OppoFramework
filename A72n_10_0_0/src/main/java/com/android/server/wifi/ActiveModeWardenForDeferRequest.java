...
public class ActiveModeWardenForDeferRequest extends ActiveModeWarden implements Handler.Callback {
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case CMD_NOTIFY_GO /* 131573 */:
                break;
            case CMD_DEFER_OFF_TIMEOUT /* 131574 */:
                Log.d(TAG, "Defer Wi-Fi off timeout");
                break;
            case CMD_GO_WIFI_OFF /* 131575 */:
                super.disableWifi();
                return true;
            case CMD_GO_SCAN_MODE /* 131576 */:
                super.enterScanOnlyMode();
                return true;
            case CMD_GO_SOFT_AP /* 131577 */:
                super.enterSoftAPMode(this.mWifiConfig);
                return true;
            case CMD_GO_SHUT_DOWN /* 131578 */:
                super.shutdownWifi();
                return true;
            case CMD_DEFER_WIFI_ON /* 131579 */:
