...
public class OppoWifiAssistantStateTraker2 extends StateMachine {
    ...
    private boolean mChangedNetwork = false;
    ...
    private OppoDualStaNotification mDualStaNotify;
    private String[] mFallbackHttpServers;
    private boolean mFeatureState = true;
    private ArrayList<String> mGatewayConflictBlackList;
    ...
    private String mLastToastConfigKey;
    ...
    private int mLowTrafficeCount = 0;
    private int mLowTrafficeThreshold = 0;
    ...
    private PendingIntent mSpeedDetectIntent;
    private int mSpeedLowCount;
    ...
    private OppoClientModeImpl2 mWifiStateMachine2;
    private int mWlanIfIndex = 1;
    ...
    public OppoWifiAssistantStateTraker2(Context c, OppoClientModeImpl2 wsm, WifiConfigManager wcs, WifiNative wnt, SupplicantStateTracker wst, WifiRomUpdateHelper wruh, Handler t, ScanRequestProxy mSrp) {
        ...
        this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(WIFI_AUTO_CHANGE_NETWORK), true, new ContentObserver(getHandler()) {
            ...
            public void onChange(boolean selfChange) {
                ...
                oppoWifiAssistantStateTraker2.mDataAutoSwitch = z;
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.net.wifi.STATE_CHANGE")) {
                    ...
                    if (networkInfo != null && networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                        ...
                        OppoWifiAssistantStateTraker2.this.mWifiConnected = true;
                    }
                    ...
                    if (OppoWifiAssistantStateTraker2.this.mChangedToData) {
                        OppoWifiAssistantStateTraker2.this.mInterInteval = 120000;
                    } else {
                        OppoWifiAssistantStateTraker2.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                    }
                    OppoWifiAssistantStateTraker2.this.mScreenOn = true;
                    ...
                    OppoWifiAssistantStateTraker2.this.mSpeedLowCount = 0;
                } else if (action.equals("android.intent.action.SCREEN_OFF")) {
                    OppoWifiAssistantStateTraker2.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                    OppoWifiAssistantStateTraker2.this.mScreenOn = false;
                    OppoWifiAssistantStateTraker2.this.mLowTrafficeCount = 0;
                    if (OppoWifiAssistantStateTraker2.this.mWifiConnected) {
                        OppoWifiAssistantStateTraker2.this.mSpeedLowCount = 0;
                        OppoWifiAssistantStateTraker2.this.mLastSpeedTime = System.currentTimeMillis();
                        OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker25 = OppoWifiAssistantStateTraker2.this;
                        oppoWifiAssistantStateTraker25.mLastTrafficBytes = TrafficStats.getRxBytes(oppoWifiAssistantStateTraker25.mInterfaceName) + TrafficStats.getTxBytes(OppoWifiAssistantStateTraker2.this.mInterfaceName);
                    ...
                    OppoWifiAssistantStateTraker2.this.mChangedToData = intent.getBooleanExtra(OppoWifiAssistantStateTraker2.EXTRA_WIFI_TO_DATA, false);
                    if (OppoWifiAssistantStateTraker2.this.mChangedToData != OppoWifiAssistantStateTraker2.this.mLastToData) {
                        if (!OppoWifiAssistantStateTraker2.this.mChangedToData) {
                            ...
                            OppoWifiAssistantStateTraker2.this.mCanTriggerData = true;
                            OppoWifiAssistantStateTraker2.this.mChangedNetwork = false;
                            OppoWifiAssistantStateTraker2.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                            ...
                            OppoWifiAssistantStateTraker2.this.mInterInteval = 120000;
                            OppoWifiAssistantStateTraker2.this.mTcpInterval = 5000;
                            ...
                            if (OppoWifiAssistantStateTraker2.this.mClickDialogSwitch) {
                                OppoWifiAssistantStateTraker2.this.mAutoSwithToData = false;
                            } else {
                                OppoWifiAssistantStateTraker2.this.mAutoSwithToData = true;
                            }
                            OppoWifiAssistantStateTraker2.this.mClickDialogSwitch = false;
                            OppoWifiAssistantStateTraker2.this.detectSwitchDataFrequence();
                            if (OppoWifiAssistantStateTraker2.this.mChangedNetwork) {
                                OppoWifiAssistantStateTraker2.this.mAutoConnDataTime = System.currentTimeMillis();
                                OppoWifiAssistantStateTraker2.this.mAutoConnWlanTime = 0;
                                OppoWifiAssistantStateTraker2.this.mAutoDataToWlanTime = 0;
                        ...
                        oppoWifiAssistantStateTraker210.mLastToData = oppoWifiAssistantStateTraker210.mChangedToData;
                    }
                    ...
                    if (intent.getIntExtra("extra_connectivity_type", -1) == 1 && intent.getBooleanExtra("extra_is_captive_portal", false)) {
                        ...
                        if (curWifiInfo != null && netStateSsid != null && curWifiInfo.getSSID().equals(netStateSsid) && (netConf = OppoWifiAssistantStateTraker2.this.getWifiConfig(netStateSsid, curWifiInfo.getBSSID())) != null && netConf.networkId == OppoWifiAssistantStateTraker2.this.mConnectedId) {
                            OppoWifiAssistantStateTraker2.this.mCaptivePortal = true;
                    ...
                    OppoWifiAssistantStateTraker2.this.mDataScore = dataScore;
                }
            }
        };
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case 131126:
                case 151553:
                    OppoWifiAssistantStateTraker2.this.mConnectId = Integer.valueOf(msg.arg1).intValue();
                    OppoWifiAssistantStateTraker2.this.mIsNewConfig = Integer.valueOf(msg.arg2).intValue();
                    ...
                    OppoWifiAssistantStateTraker2.this.mConnectKey = config != null ? config.configKey(false) : null;
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker22 = OppoWifiAssistantStateTraker2.this;
                    if (config != null) {
                        str = config.SSID;
                    }
                    oppoWifiAssistantStateTraker22.mConnectSSID = str;
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker23 = OppoWifiAssistantStateTraker2.this;
                ...
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /* 147499 */:
                    ...
                    oppoWifiAssistantStateTraker25.mConnectingkey = str;
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker26 = OppoWifiAssistantStateTraker2.this;
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /* 147459 */:
                    OppoWifiAssistantStateTraker2.this.mRoamdetectCount = 0;
                    OppoWifiAssistantStateTraker2.this.mLastNetId = msg.arg1;
                    OppoWifiAssistantStateTraker2.this.mLastBssid = (String) msg.obj;
                    ...
                    oppoWifiAssistantStateTraker27.mLastConfigkey = str;
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker28 = OppoWifiAssistantStateTraker2.this;
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /* 147462 */:
                    ...
                    OppoWifiAssistantStateTraker2.this.mConnectingId = stateReult.networkId;
                    ...
                    OppoWifiAssistantStateTraker2.this.mConnectingkey = config3 != null ? config3.configKey(false) : null;
                ...
                case 200705:
                    ...
                    OppoWifiAssistantStateTraker2.this.mLastConfigkey = config4 != null ? config4.configKey(false) : null;
                    if (msg.arg2 != 2) {
                        if (msg.arg2 == 0) {
                        ...
                        oppoWifiAssistantStateTraker212.mConnectSSID = str;
                        OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker213 = OppoWifiAssistantStateTraker2.this;
    ...
    class InitState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker2.this.logD(getName());
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker2.mWifiState = oppoWifiAssistantStateTraker2.mWifiStateMachine2.syncGetWifiState();
            OppoWifiAssistantStateTraker2.this.mLastTxBad = 0;
            OppoWifiAssistantStateTraker2.this.mLastTxGood = 0;
    ...
    class DisconnectedState extends State {
        ...
        public void enter() {
            ...
            OppoWifiAssistantStateTraker2.this.mLastNetId = -1;
            OppoWifiAssistantStateTraker2.this.mLastBssid = " ";
            OppoWifiAssistantStateTraker2.this.mUnavailableKey = " ";
            OppoWifiAssistantStateTraker2.this.mAutoSwithToData = false;
            OppoWifiAssistantStateTraker2.this.mInterResult = false;
            OppoWifiAssistantStateTraker2.this.mInternetInvalidCount = 0;
            OppoWifiAssistantStateTraker2.this.mInterChangeToInvalid = false;
            OppoWifiAssistantStateTraker2.this.mLastPktInfo = null;
            OppoWifiAssistantStateTraker2.this.mGotInternetResult = 0;
            OppoWifiAssistantStateTraker2.this.mLastDetectInter = 0;
            OppoWifiAssistantStateTraker2.this.mTrigScanCount = 0;
            OppoWifiAssistantStateTraker2.this.mDTxPkts = 0;
            OppoWifiAssistantStateTraker2.this.mdRxPkts = 0;
            OppoWifiAssistantStateTraker2.this.mIsSoftAP = false;
            OppoWifiAssistantStateTraker2.this.mCaptivePortal = false;
            OppoWifiAssistantStateTraker2.this.mResponseGotFromGateway = false;
            OppoWifiAssistantStateTraker2.this.mWifiConnected = false;
            OppoWifiAssistantStateTraker2.this.mIsFirstPktCntFetchSucceed = true;
    ...
    class CompletedState extends State {
        ...
        public void enter() {
            ...
            OppoWifiAssistantStateTraker2.this.mDisconnectedScanCount = 0;
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i == 147459) {
                ...
                if (OppoWifiAssistantStateTraker2.this.mLastNetId != msg.arg1) {
                    ...
                    OppoWifiAssistantStateTraker2.this.mLastConfigkey = config != null ? config.configKey(false) : null;
                }
            } else if (i == 200705) {
                OppoWifiAssistantStateTraker2.this.mLastBssid = (String) msg.obj;
                OppoWifiAssistantStateTraker2.this.mLastNetId = msg.arg1;
                ...
                WifiConfiguration config2 = OppoWifiAssistantStateTraker2.this.mWifiConfigManager.getConfiguredNetwork(OppoWifiAssistantStateTraker2.this.mLastNetId);
                if (config2 != null) {
                    OppoWifiAssistantStateTraker2.this.mLastConfigkey = config2.configKey(false);
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker23 = OppoWifiAssistantStateTraker2.this;
                    ...
                    if (completestate == 0) {
                        ...
                        OppoWifiAssistantStateTraker2.this.mConnectSSID = config2.SSID;
                        OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker26 = OppoWifiAssistantStateTraker2.this;
    ...
    class VerifyInternetState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker2.this.logD(getName());
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker2.mConnectedId = oppoWifiAssistantStateTraker2.mLastNetId;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker22 = OppoWifiAssistantStateTraker2.this;
    ...
    class ConnectedState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker2.this.logD(getName());
            OppoWifiAssistantStateTraker2.this.mWifiConnected = true;
            OppoWifiAssistantStateTraker2.this.mConnectTime = System.currentTimeMillis();
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker2.mConnectedId = oppoWifiAssistantStateTraker2.mLastNetId;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker22 = OppoWifiAssistantStateTraker2.this;
            ...
            if (OppoWifiAssistantStateTraker2.this.mCandidateKey.equals(OppoWifiAssistantStateTraker2.this.mLastConfigkey)) {
                OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker24 = OppoWifiAssistantStateTraker2.this;
                oppoWifiAssistantStateTraker24.mAutoConnWlanTime = oppoWifiAssistantStateTraker24.mConnectTime;
                OppoWifiAssistantStateTraker2.this.mAutoConnDataTime = 0;
                OppoWifiAssistantStateTraker2.this.mAutoDataToWlanTime = 0;
                ...
                OppoWifiAssistantStateTraker2.this.mCandidateKey = "";
            }
            OppoWifiAssistantStateTraker2.this.mTcpStatistics = 0;
            OppoWifiAssistantStateTraker2.this.mTcpInterval = OppoWiFiScanBlockPolicy.BACKGROUND_SCAN_RESULTS_INTERVAL;
            ...
            if (OppoWifiAssistantStateTraker2.this.mLastToastConfigKey == null || !OppoWifiAssistantStateTraker2.this.mLastToastConfigKey.equals(OppoWifiAssistantStateTraker2.this.mLastConfigkey) || System.currentTimeMillis() - OppoWifiAssistantStateTraker2.this.mLastToastTime >= OppoWifiAssistantStateTraker2.TOAST_STAND_OFF_TIME) {
                ...
                OppoWifiAssistantStateTraker2.this.mLastToastTime = System.currentTimeMillis();
                OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker27 = OppoWifiAssistantStateTraker2.this;
                oppoWifiAssistantStateTraker27.mLastToastConfigKey = oppoWifiAssistantStateTraker27.mLastConfigkey;
            }
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 200711:
                    ...
                    OppoWifiAssistantStateTraker2.this.detectTcpStatus();
                    return true;
                case 200712:
                    return true;
                default:
    ...
    class NetworkMonitorState extends State {
        ...
        public void enter() {
            ...
            OppoWifiAssistantStateTraker2.this.mLastTrigDataTime = System.currentTimeMillis();
            if (OppoWifiAssistantStateTraker2.this.mInterfaceName != null) {
                OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker22 = OppoWifiAssistantStateTraker2.this;
                oppoWifiAssistantStateTraker22.mLastTxPkts = oppoWifiAssistantStateTraker22.mOppoSlaManager.getWlanTcpTxPackets(1);
                OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker23 = OppoWifiAssistantStateTraker2.this;
                oppoWifiAssistantStateTraker23.mLastRxPkts = oppoWifiAssistantStateTraker23.mOppoSlaManager.getWlanTcpRxPackets(1);
            } else {
                OppoWifiAssistantStateTraker2.this.mLastTxPkts = 0;
                OppoWifiAssistantStateTraker2.this.mLastRxPkts = 0;
            }
            OppoWifiAssistantStateTraker2.this.mRxPktsLowCount = 0;
            OppoWifiAssistantStateTraker2.this.mDTxPkts = 0;
            OppoWifiAssistantStateTraker2.this.mdRxPkts = 0;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker24 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker24.mLinkInterval = oppoWifiAssistantStateTraker24.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_GOOD_LINK_SAMPL_INTERVAL", 5000).intValue();
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker25 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker25.mTrafficInteval = oppoWifiAssistantStateTraker25.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_INVALID_TRAFFIC_SAMPL_INTERVAL", Integer.valueOf((int) OppoWiFiScanBlockPolicy.BACKGROUND_SCAN_RESULTS_INTERVAL)).intValue();
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker26 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker26.mLowTrafficeThreshold = oppoWifiAssistantStateTraker26.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_LOW_TRAFFICE_THRESHOLD", 10).intValue();
            OppoWifiAssistantStateTraker2.this.mTcpInterval = 5000;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker27 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker27.mWlanInvalidThreshold = oppoWifiAssistantStateTraker27.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_WLAN_INVALID_THRESHOLD", 40).intValue();
            OppoWifiAssistantStateTraker2.this.mRoamdetectCount = 0;
            OppoWifiAssistantStateTraker2.this.mCanTriggerData = true;
            OppoWifiAssistantStateTraker2.this.mTriggerInter = false;
            OppoWifiAssistantStateTraker2.this.mChangedNetwork = false;
            OppoWifiAssistantStateTraker2.this.mClickDialogSwitch = false;
            OppoWifiAssistantStateTraker2.this.mDetectInterCount = 0;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker28 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker28.mLastInternetResult = oppoWifiAssistantStateTraker28.mInterResult;
            OppoWifiAssistantStateTraker2.this.mLinkDetectTimes = 0;
            OppoWifiAssistantStateTraker2.this.mInternetInvalidCount = 0;
            OppoWifiAssistantStateTraker2.this.mInterChangeToInvalid = false;
            OppoWifiAssistantStateTraker2.this.mLastDetectInter = 0;
            OppoWifiAssistantStateTraker2.this.mInternetStandoffTime = 0;
            OppoWifiAssistantStateTraker2.this.mTrigScanCount = 0;
            OppoWifiAssistantStateTraker2.this.mNetQulityGoodCount = 0;
            OppoWifiAssistantStateTraker2.this.mLowTrafficeCount = 0;
            OppoWifiAssistantStateTraker2.this.mOldTcpStatus = 0;
            ...
            OppoWifiAssistantStateTraker2.this.mIndex = 0;
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker29 = OppoWifiAssistantStateTraker2.this;
            oppoWifiAssistantStateTraker29.mCurrentLoss = new VolumeWeightedEMA(0.5d);
            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker210 = OppoWifiAssistantStateTraker2.this;
            ...
            switch (msg.what) {
                case 151573:
                    ...
                    if (info != null) {
                        if (OppoWifiAssistantStateTraker2.this.mWifiConnected) {
                            ...
                            OppoWifiAssistantStateTraker2.this.mLastPktInfo = info;
                            break;
                        } else {
                ...
                case 200712:
                    if (OppoWifiAssistantStateTraker2.this.mWifiConnected) {
                        ...
                        OppoWifiAssistantStateTraker2.this.mLastTrafficBytes = currentBytes;
                        OppoWifiAssistantStateTraker2.this.mLastSpeedTime = currentTime;
                    ...
                    break;
                case OppoWifiAssistantStateTraker2.EVENT_SHOW_ALERT /* 200719 */:
                ...
                case OppoWifiAssistantStateTraker2.EVENT_DISMISS_ALERT /* 200720 */:
                    ...
                    break;
                case OppoWifiAssistantStateTraker2.EVENT_DETECT_ALTERNATIVE /* 200721 */:
                    String detectConfig = (String) msg.obj;
                    OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker210 = OppoWifiAssistantStateTraker2.this;
                    oppoWifiAssistantStateTraker210.logD("decon:" + detectConfig);
                    OppoWifiAssistantStateTraker2.this.findAvailableCandidate(OppoWifiAssistantStateTraker2.this.mAssistantUtils.getNetworkRecord(detectConfig), 10, -127, false);
                    break;
                default:
                    return false;
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateRecordCaptiveState(String configKey, boolean captive, boolean save, boolean blacklistCapUrl) {
    ...
    /* JADX INFO: Multiple debug info for r4v27 int: [D('i' int), D('currentQuality' int)] */
    /* JADX INFO: Multiple debug info for r7v67 'now'  long: [D('apkinfo' java.lang.String), D('now' long)] */
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    ...
    private synchronized void updateRecordLinkQuality(RssiPacketCountInfo info) {
        ...
        if (mLastRecord != null && info != null) {
            if (info.rssi > WifiConfiguration.INVALID_RSSI) {
                ...
                String apkinfo2 = "ssid:" + mLastRecord.mConfigkey + ",net:" + mLastRecord.mNetworkValid + ",currScore:" + score + ",score:" + currentQuality + ", rssi:" + rssi + ",loss:" + df.format(loss * 100.0d) + ",total:" + dtotal + ",tcp:0";
                ...
                if (currentQuality > 79 - getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_WLAN_POLL_THRESHOLD", 15).intValue()) {
                    if (!this.mChangedNetwork) {
                        ...
                        if (currentQuality > 79 - trigWlanSetectScore) {
                            if (score <= 79 - trigWlanSetectScore && this.mLastScanTime != 0 && now2 - this.mLastScanTime > STAIC_SCAN_RESULT_AGE && this.mTrigScanCount < 3 && !this.mTriggerScan) {
                            ...
                            if (!this.mTriggerScan) {
                                ...
                                } else if (score <= 79 - trigWlanSetectScore) {
                        ...
                        if (!this.mChangedNetwork || currentQuality > 79 - wlanBadThreshold || score > 79 - wlanBadThreshold) {
                            if (this.mChangedNetwork && this.mChangedToData) {
                                ...
                                if (!mLastRecord.mNetworkValid2 && !this.mLastInternetResult && this.mChangeRssi != 0 && rssi >= -72 && currentQuality >= 50 && score >= 50 && this.mChangeScore == 10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        OppoWifiAssistantStateTraker2.this.mLastDetectInter = System.currentTimeMillis();
                        OppoWifiAssistantStateTraker2.this.mInternetDetecting = true;
                        ...
                        OppoWifiAssistantStateTraker2.this.mInternetDetecting = false;
                        ...
                        } else if (!OppoWifiAssistantStateTraker2.this.mInterResult || OppoWifiAssistantStateTraker2.this.mWifiStateMachine2 == null || OppoWifiAssistantStateTraker2.this.mWifiStateMachine2.getWifiInfo() == null || OppoWifiAssistantStateTraker2.this.mWifiStateMachine2.getWifiInfo().getRssi() < -75) {
                            OppoWifiAssistantStateTraker2.this.mInternetInvalidCount = 0;
                        } else {
    ...
    private final class NetHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoWifiAssistantStateTraker2.EVENT_UPDATE_NETWORK_STATE /* 200714 */:
                        ...
                        if (updateWifiInfo != null && netStateSsid != null && updateWifiInfo.getSSID().equals(netStateSsid)) {
                            ...
                            if (netValid || !OppoWifiAssistantStateTraker2.this.mWifiStateMachine2.isDupDhcp()) {
                                if (OppoWifiAssistantStateTraker2.this.mInterResult && !netValid) {
                                    OppoWifiAssistantStateTraker2.this.mInterChangeToInvalid = true;
                                }
                                ...
                                if (netConf != null && netConf.networkId == OppoWifiAssistantStateTraker2.this.mConnectedId) {
                                    ...
                                    OppoWifiAssistantStateTraker2.this.mInterResult = netValid;
                                    if (netValid) {
                ...
                case OppoWifiAssistantStateTraker2.EVENT_CONNECT_NETWORK /* 200715 */:
                    WifiInfo curWifiInfo = OppoWifiAssistantStateTraker2.this.mWifiStateMachine2.syncRequestConnectionInfo();
                    if (curWifiInfo != null) {
                        int netId = msg.arg1;
                        ...
                        if (OppoWifiAssistantStateTraker2.this.mCM == null) {
                            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker22 = OppoWifiAssistantStateTraker2.this;
                            oppoWifiAssistantStateTraker22.mCM = (ConnectivityManager) oppoWifiAssistantStateTraker22.mContext.getSystemService("connectivity");
                        }
                        ...
                        if (OppoWifiAssistantStateTraker2.this.mCM != null && network != null && network.netId == netId) {
                            ...
                            OppoWifiAssistantStateTraker2.this.mCurNetwork = network;
                            OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker23 = OppoWifiAssistantStateTraker2.this;
                            oppoWifiAssistantStateTraker23.mIsSoftAP = oppoWifiAssistantStateTraker23.isSoftAp(curLink);
                            return;
                        }
                        return;
                    }
                    return;
                case OppoWifiAssistantStateTraker2.EVENT_INTERNET_CHANGE /* 200722 */:
                    ...
                    OppoWifiAssistantStateTraker2.this.mInterResult = interResult;
                    ...
                    return;
                case OppoWifiAssistantStateTraker2.EVENT_CAPTIVE_PORTAL /* 200723 */:
                    ...
                    return;
                case OppoWifiAssistantStateTraker2.EVENT_SCAN_TIMEOUT /* 200724 */:
                    OppoWifiAssistantStateTraker2.this.mTriggerScan = false;
                    return;
                default:
                    return;
            }
    ...
    private class DataStateObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            if (OppoWifiAssistantStateTraker2.this.mTelephonyManager != null) {
                OppoWifiAssistantStateTraker2 oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker2.this;
                oppoWifiAssistantStateTraker2.mDataState = oppoWifiAssistantStateTraker2.mTelephonyManager.getDataEnabled();
