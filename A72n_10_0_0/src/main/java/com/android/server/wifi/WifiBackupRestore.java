...
public class WifiBackupRestore {
    ...
    public byte[] retrieveBackupDataFromConfigurations(List<WifiConfiguration> configurations) {
        ...
        try {
            ...
            XmlUtil.writeNextValue(out, "Version", Float.valueOf((float) CURRENT_BACKUP_DATA_VERSION));
    ...
    public List<WifiConfiguration> retrieveConfigurationsFromBackupData(byte[] data) {
        ...
        try {
            String versionStr = new Float(((Float) XmlUtil.readNextValueWithName(in, "Version")).floatValue()).toString();
    ...
    public static class SupplicantBackupMigration {
        ...
        /* access modifiers changed from: package-private */
        public static class SupplicantNetworks {
            ...
            public void readNetworksFromStream(BufferedReader in) {
                ...
                while (in.ready()) {
                    try {
                        ...
                        Log.e(WifiBackupRestore.TAG, "readNetworksFromStream0:" + e);
                        if (in != null) {
                            try {
                                in.close();
                                return;
                        ...
                        if (in != null) {
                            try {
                                ...
                                Log.e(WifiBackupRestore.TAG, "readNetworkFromStream3:" + ex);
                            }
                        }
                        throw th;
                    }
                ...
                sb.append("readNetworkFromStream3:");
                sb.append(ex);
                Log.e(WifiBackupRestore.TAG, sb.toString());
            }
