...
public class OppoSoftApManager extends SoftApManager {
    ...
    private static int mRecoveryRetryCount = 0;
        ...
        if (this.mLoadFromStoreReceiver == null) {
            this.mLoadFromStoreReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    OppoSoftApManager.this.blockSavedClients();
                }
            };
    ...
    private int startSoftAp(WifiConfiguration config) {
        ...
        if (SystemProperties.getInt("persist.sys.softap_disable_open", 0) == 1) {
            try {
                if (localConfig.getAuthType() == 0) {
                    Log.d(TAG, "softap_disable_open is true");
                    return 2;
                }
    ...
    public class SoftApStateMachine extends StateMachine {
        ...
        private class IdleState extends State {
            ...
            public void enter() {
                OppoSoftApManager.this.mApInterfaceName = null;
                OppoSoftApManager.this.mIfaceIsUp = false;
                OppoSoftApManager.this.mIfaceIsDestroyed = false;
            }
            ...
            public boolean processMessage(Message message) {
                if (message.what == 0) {
                    ...
                    OppoSoftApManager.this.mApInterfaceName = OppoSoftApManager.this.mWifiNative.setupInterfaceForSoftApMode(SoftApStateMachine.this.mWifiNativeInterfaceCallback);
        ...
        public class StartedState extends State {
            ...
            private class SoftApTimeoutEnabledSettingObserver extends ContentObserver {
                ...
                public void register() {
                    ...
                    OppoSoftApManager.this.mTimeoutEnabled = getValue();
                }
            ...
            private int getConfigSoftApTimeoutDelay() {
                int delay = OppoSoftApManager.this.mContext.getResources().getInteger(17694948);
            ...
            private void setNumAssociatedStations(int numStations) {
                if (OppoSoftApManager.this.mNumAssociatedStations != numStations) {
                    OppoSoftApManager.this.mNumAssociatedStations = numStations;
            ...
            public void enter() {
                ...
                OppoSoftApManager.this.mNumAssociatedStations = 0;
                OppoSoftApManager.this.mQCNumAssociatedStations = 0;
                    ...
                    switch (i) {
                        ...
                        case 6:
                            ...
                            if (OppoSoftApManager.this.mTimeoutEnabled != isEnabled) {
                                OppoSoftApManager.this.mTimeoutEnabled = isEnabled;
                                if (!OppoSoftApManager.this.mTimeoutEnabled) {
                                    cancelTimeoutMessage();
                                }
                        ...
                        case 7:
                            ...
                            OppoSoftApManager.this.updateApState(10, 13, 0);
                            OppoSoftApManager.this.mIfaceIsDestroyed = true;
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            OppoSoftApManager.this.mReportedFrequency = message.arg1;
                            OppoSoftApManager.this.mReportedBandwidth = message.arg2;
