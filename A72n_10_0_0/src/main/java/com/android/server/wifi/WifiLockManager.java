...
public class WifiLockManager {
    ...
    private synchronized boolean addLock(WifiLock lock) {
        ...
        if (findLockByBinder(lock.getBinder()) != null) {
            ...
            return false;
        } else if (OppoWifiLockHelper.getInstance(this.mContext).isInBlackList(lock.mUid, lock.mMode)) {
            return false;
        } else {
    ...
    private synchronized boolean releaseLock(IBinder binder) {
        ...
        OppoWifiLockHelper.getInstance(this.mContext).reportLockModeUsageTime(wifiLock.mUid, wifiLock.mAcqTimestamp, wifiLock.mMode);
    ...
    public void enableVerboseLogging(int verbose) {
        ...
        OppoWifiLockHelper.getInstance(this.mContext).enableVerboseLogging(verbose);
    }
