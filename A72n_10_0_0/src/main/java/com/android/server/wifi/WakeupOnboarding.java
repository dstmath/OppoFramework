                ...
                if (hashCode != -506616242) {
                    if (hashCode == 1771495157 && action.equals(WakeupNotificationFactory.ACTION_DISMISS_NOTIFICATION)) {
                        ...
                        if (c != 0) {
                            ...
                            WakeupOnboarding.this.mContext.startActivity(new Intent("android.settings.WIFI_IP_SETTINGS").addFlags(IWifiChip.ChipCapabilityMask.DUAL_BAND_DUAL_CHANNEL));
                            WakeupOnboarding.this.dismissNotification(true);
                            return;
                        } else if (c != 2) {
