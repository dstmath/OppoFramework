...
public class WifiDiagnostics extends BaseWifiDiagnostics {
    ...
    public WifiDiagnostics(Context context, WifiInjector wifiInjector, WifiNative wifiNative, BuildProperties buildProperties, LastMileLogger lastMileLogger, Clock clock) {
        super(wifiNative);
        this.RING_BUFFER_BYTE_LIMIT_SMALL = context.getResources().getInteger(17694957) * 1024;
        this.RING_BUFFER_BYTE_LIMIT_LARGE = context.getResources().getInteger(17694958) * 1024;
        int[] fatalFirmwareAlertErrorCodeArray = context.getResources().getIntArray(17236095);
    ...
    private ArrayList<String> getLogcat(int maxLines) {
        ...
        try {
            ...
            BufferedReader reader3 = new BufferedReader(new InputStreamReader(process.getErrorStream()));
            while (true) {
            ...
            try {
                ...
                this.mLog.dump("getLogcat2: ").c(ex.toString()).flush();
            }
            ...
            if (0 != 0) {
                try {
                    ...
                    this.mLog.dump("getLogcat2: ").c(ex2.toString()).flush();
                }
            }
            throw th;
        }
