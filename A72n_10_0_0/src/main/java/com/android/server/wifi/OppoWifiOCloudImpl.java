...
public class OppoWifiOCloudImpl {
    ...
    private ConcurrentHashMap<String, SimpleWifiConfig> mNetworks = new ConcurrentHashMap<>();
    ...
    private boolean isWifiOCloudSwitchOn() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private SimpleWifiConfig getInternalDeletedNetwork(int networkId) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void notifyCloudService() {
