...
public class BackgroundScanScheduler {
    ...
    private static final int[] PREDEFINED_BUCKET_PERIODS = {30000, WifiMetrics.MIN_DATA_STALL_WAIT_MS, 480000, 10000, 60000, 1920000, WifiConnectivityManager.MAX_CONNECTION_ATTEMPTS_TIME_INTERVAL_MS, 960000, 3840000, -1};
