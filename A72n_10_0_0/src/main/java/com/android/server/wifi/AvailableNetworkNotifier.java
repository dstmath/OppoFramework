...
public class AvailableNetworkNotifier {
    ...
    private void startWifiSettings() {
        ...
        this.mContext.startActivity(new Intent("android.settings.WIFI_SETTINGS").addFlags(IWifiChip.ChipCapabilityMask.DUAL_BAND_DUAL_CHANNEL));
        clearPendingNotification(false);
    }
    ...
    private class NotificationEnabledSettingObserver extends ContentObserver {
        ...
        private boolean getValue() {
            ...
            Log.d(str, "Settings toggle enabled=" + enabled);
            return enabled;
        }
    }
}
