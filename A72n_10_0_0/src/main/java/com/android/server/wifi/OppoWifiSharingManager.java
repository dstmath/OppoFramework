    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (OppoWifiSharingManager.DBG) {
                String str = OppoWifiSharingManager.TAG;
                Log.d(str, "OppoWifiSharingManager" + action);
            }
            if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
                ...
                String str2 = OppoWifiSharingManager.TAG;
                Log.d(str2, "wifi connect state = " + state);
                ...
                String str3 = OppoWifiSharingManager.TAG;
                Log.d(str3, "wifi WIFI_TO_DATA state " + isdata);
                ...
                String str4 = OppoWifiSharingManager.TAG;
                Log.d(str4, "wifi ACTION_AIRPLANE_MODE_CHANGED  airplaneModeOn = " + isAirplaneModeOn);
                if (isAirplaneModeOn) {
