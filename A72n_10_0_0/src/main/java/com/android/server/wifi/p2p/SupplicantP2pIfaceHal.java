...
public class SupplicantP2pIfaceHal {
    ...
    private ISupplicantIface addIfaceV1_1(String ifaceName) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                Log.e(TAG, "ISupplicant.addInterface IllegalArgumentException: " + e2);
                supplicantServiceDiedHandler();
                return null;
            } catch (Exception e3) {
    ...
    public boolean teardownIface(String ifaceName) {
        if (TextUtils.isEmpty(ifaceName)) {
            Log.e(TAG, "teardownIface but iface is null!");
            return false;
        }
        synchronized (this.mLock) {
            if (this.mISupplicantP2pIface != null) {
    ...
    private boolean removeIfaceV1_1(String ifaceName) {
        synchronized (this.mLock) {
            try {
                ...
                Log.e(TAG, "ISupplicant.removeInterface IllegalArgumentException: " + e2);
                supplicantServiceDiedHandler();
                return false;
            } catch (Exception e3) {
                        ...
                        for (Integer networkId : networkIds) {
                            ...
                            if (network == null) {
                                ...
                                if (!resultIsCurrent.isSuccess() || resultIsCurrent.getResult().booleanValue()) {
                                    ...
                                    SupplicantResult<Boolean> resultIsPersistent = new SupplicantResult<>("isPersistent(" + networkId + ")");
                                    try {
                                        network.isPersistent(new ISupplicantP2pNetwork.isPersistentCallback() {
                                            /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$0_B8H9Do0xObiRsvHzxZ7ZtqC6I */
                                    ...
                                    if (resultIsPersistent.isSuccess()) {
                                        if (resultIsPersistent.getResult().booleanValue()) {
                                            ...
                                            try {
                                                network.getSsid(new ISupplicantP2pNetwork.getSsidCallback() {
                                                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$7fazY1t4EDgYn5_tPSsBei_eHY */
                                            ...
                                            try {
                                                network.getBssid(new ISupplicantP2pNetwork.getBssidCallback() {
                                                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$EihnySIz3R_vaA3L7w84kU4MvI */
                                            ...
                                            try {
                                                network.isGo(new ISupplicantP2pNetwork.isGoCallback() {
                                                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$7lpN2nZur9L21hkt5taYmi4nhnE */
                                    ...
                                    removeNetwork(networkId.intValue());
                                }
                            }
                        }
                        return true;
        ...
        synchronized (this.mLock) {
            ...
            try {
                this.mISupplicantP2pIface.createNfcHandoverRequestMessage(new ISupplicantP2pIface.createNfcHandoverRequestMessageCallback() {
                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$ylq2Zzj0G6BjvfPscnPG0TmSszQ */
        ...
        synchronized (this.mLock) {
            ...
            try {
                this.mISupplicantP2pIface.createNfcHandoverSelectMessage(new ISupplicantP2pIface.createNfcHandoverSelectMessageCallback() {
                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$ocdFMmgQ2gB0lRQSXdtdcDfD13k */
        ...
        synchronized (this.mLock) {
            ...
            try {
                network.getClientList(new ISupplicantP2pNetwork.getClientListCallback() {
                    /* class com.android.server.wifi.p2p.$$Lambda$SupplicantP2pIfaceHal$Xr5EQtrqWQfUzEe8maqV0w7iV8 */
    ...
    public boolean setP2pBandLIst(OppoSoftapP2pBandControl.BandType type) {
        synchronized (this.mLock) {
            ...
            if (type == OppoSoftapP2pBandControl.BandType.BAND_2G_ONLY) {
                ...
                logd("setP2pBandLIst invalid type no need to limit band ");
                return false;
            }
