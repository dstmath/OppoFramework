...
public class OppoWifiConnectionAlert {
    ...
    private int mAdjustedSsidNetworkId = -1;
    ...
    private boolean mIsConnectingAdjustedSsid = false;
    ...
    private final ClientModeImpl mWifiStateMachine;
    ...
    private final class ConnectTimeoutHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (hidden == null) {
            ...
            } else if (OppoWifiConnectionAlert.this.mWifiStateMachine.tryOtherSsidIfSelectNetworkTimeout()) {
                Log.d(OppoWifiConnectionAlert.TAG, "try to connect similar hidden AP");
                OppoWifiConnectionAlert.this.mIsConnectingAdjustedSsid = true;
                OppoWifiConnectionAlert.this.mAdjustedSsidNetworkId = netId;
                isSaveConfigFailed = isSaveConfigFailed2;
            } else {
                if (OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect) {
                    OppoWifiConnectionAlert.this.mWifiConfigManager.enableAllNetworks();
                    ...
                    if (!OppoWifiConnectionAlert.this.getAddAndConnectHiddenAp()) {
                        ...
                        OppoWifiConnectionAlert.this.mWifiStateMachine.setChangekeymgmt(true);
                        int newNetId = -1;
                        boolean isWep = OppoWifiConnectionAlert.this.isWepAP((OppoWifiConnectionAlert) hidden);
                        boolean isWpa = OppoWifiConnectionAlert.this.isWpaAP((OppoWifiConnectionAlert) hidden);
                        ...
                        if (isWep || isWpa) {
                            ...
                            if (newNetId == -1) {
                                ...
                                if (savedConfig != null) {
                                    WifiConfigManager wifiConfigManager = OppoWifiConnectionAlert.this.mWifiConfigManager;
                                    int i3 = savedConfig.networkId;
                                    z = false;
                                    wifiConfigManager.enableNetwork(i3, false, i2);
                                } else {
                                    z = false;
                                }
                                OppoWifiConnectionAlert.this.mBackupWifiConfiguration = null;
                                OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect = z;
                            } else {
                                ...
                                oppoWifiConnectionAlert3.mOldWifiConfiguration = oppoWifiConnectionAlert3.mWifiConfigManager.getConfiguredNetwork(OppoWifiConnectionAlert.this.mOldNetIdCreatedByManuConnect.intValue());
                        ...
                        if (oppoWifiConnectionAlert5.isWepAP((OppoWifiConnectionAlert) oppoWifiConnectionAlert5.mOldWifiConfiguration)) {
                            if (found2) {
                                reason = 13;
                            } else {
                        ...
                        OppoWifiConnectionAlert.this.mNewNetIdCreateByManuConnect = -1;
                        OppoWifiConnectionAlert.this.mNetworksDisabledDuringConnect = false;
                    }
                } else {
                    isSaveConfigFailed = isSaveConfigFailed2;
                ...
                if (!OppoWifiConnectionAlert.this.isManuConnect() && OppoWifiConnectionAlert.this.mWifiNative != null && !OppoWifiConnectionAlert.this.mWifiStateMachine.isConnected()) {
                    Log.d(OppoWifiConnectionAlert.TAG, "Auto connect, can not find network: " + OppoWifiConnectionAlert.this.mConnectingNetId);
                    String interfaceName = OppoWifiConnectionAlert.this.mWifiNative.getClientInterfaceName();
                    if (interfaceName != null) {
                        OppoWifiConnectionAlert.this.mWifiNative.removeNetworkIfCurrent(interfaceName, OppoWifiConnectionAlert.this.mConnectingNetId);
                    }
                }
            }
        }
    ...
    private void handleSupplicantStateChange(StateChangeResult stateChangeResult) {
        ...
        switch (AnonymousClass1.$SwitchMap$android$net$wifi$SupplicantState[supState.ordinal()]) {
            ...
            case 9:
                ...
                if (stateChangeResult.networkId == this.mAdjustedSsidNetworkId) {
                    this.mIsConnectingAdjustedSsid = false;
                    this.mAdjustedSsidNetworkId = -1;
                    return;
                }
                return;
            case 12:
    ...
    public void setIsSelectingNetwork(boolean selectingNetwork) {
        ...
        Log.d(TAG, "mIsSelectingNetwork is " + this.mIsSelectingNetwork + ", selectingNetwork " + selectingNetwork);
    }
    ...
    private void handleNetworkConnectionFailure(int netId, int disableReason) {
        ...
        if (this.mNetworksDisabledDuringConnect) {
            ...
            if (this.mNewNetIdCreateByManuConnect.intValue() == netId) {
                ...
                if (this.mIsConnectingAdjustedSsid && isManuConnect() && netId == this.mAdjustedSsidNetworkId) {
                    this.mWifiConfigManager.setIsNewNetwork(true);
                    this.mIsConnectingAdjustedSsid = false;
                    this.mAdjustedSsidNetworkId = -1;
                }
