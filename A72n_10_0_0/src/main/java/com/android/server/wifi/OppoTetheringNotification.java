...
public class OppoTetheringNotification {
    ...
    private int mHotspotClientNums;
    private Runnable mNotifyTask = new Runnable() {
        ...
        public void run() {
            ...
            oppoTetheringNotification.mTrifficFormat = Formatter.formatFileSize(oppoTetheringNotification.mContext, sizeBytes, 8);
    ...
    private OppoTetheringStatistician mTetheringStatistician;
    private String mTrifficFormat = "0 KB";
    private int mWhatInterfaceTethering;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void oppoShowTetherStoppedNotification() {
        NotificationManager notificationManager = (NotificationManager) this.mContext.getSystemService("notification");
        createNotificationChannel(notificationManager);
        Intent intent = new Intent();
        Resources r = Resources.getSystem();
