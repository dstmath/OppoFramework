...
public class WifiController extends StateMachine {
    ...
    private boolean isSoftapStarting = false;
    private boolean isWifiSharingStarting = false;
    ...
    private boolean mIsSapScanCoexistSupported = false;
    private boolean mIsScanClientStarting = false;
    ...
    private boolean mSapScanCoexistStarting = false;
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.net.wifi.WIFI_AP_STATE_CHANGED") || action.equals("oppo.intent.action.wifi.WIFI_SHARING_STATE_CHANGED")) {
                    ...
                    if (state == 14 || state == 114) {
                        ...
                        WifiController.this.isSoftapStarting = false;
                        WifiController.this.isWifiSharingStarting = false;
                    ...
                    if (state2 == 3) {
                        ...
                        WifiController.this.mSapScanCoexistStarting = false;
                    } else if (state2 == 1) {
    ...
    private void readWifiRecoveryDelay() {
        this.mRecoveryDelayMillis = this.mContext.getResources().getInteger(17694942);
        ...
        public boolean processMessage(Message msg) {
            ...
            if (i != WifiController.CMD_EMERGENCY_MODE_CHANGED) {
                if (i != WifiController.CMD_SET_WIFI_SHARING) {
                        ...
                        case WifiController.CMD_AIRPLANE_TOGGLED /* 155657 */:
                            if (WifiController.this.mSettingsStore.isAirplaneModeOn()) {
                                if (SystemProperties.getInt("persist.sys.wifi_policy", 2) != 5) {
                                    ...
                                    WifiController.this.log("wifi always enable, do not shumdown wifi");
                                    break;
                                }
                            } else {
                            ...
                            if (!WifiController.this.mSettingsStore.isAirplaneModeOn()) {
                                if (msg.arg1 != 1) {
                                    ...
                                    if (WifiController.this.isSoftapStarting || WifiController.this.mSoftapStatus == 13) {
                                        ...
                                        wifiController4.mIsSapScanCoexistSupported = OppoSapScanCoexistManager.getInstance(wifiController4.mContext).getSapScanCoexistSupported();
                                        if (WifiController.this.mIsSapScanCoexistSupported) {
                                            if (WifiController.this.mIsScanClientStarting) {
                                                ...
                                                WifiController.this.mSapScanCoexistStarting = true;
                                        ...
                                        WifiController.this.isSoftapStarting = true;
                                        OppoWifiSwitchStats.getInstance(WifiController.this.mContext).clearWifiStateCheckMsg();
                                        break;
                                    }
                                }
                    ...
                    WifiController.this.disableOppoWifiSta2();
                    WifiController.this.isWifiSharingStarting = true;
    ...
    public class StaDisabledWithScanState extends State {
        ...
        public void enter() {
            ...
            WifiController.this.disableOppoWifiSta2();
            WifiController.this.mIsScanClientStarting = true;
        ...
        public void exit() {
            WifiController.this.mIsScanClientStarting = false;
