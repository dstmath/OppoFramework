...
public class WifiScanningServiceImpl extends IWifiScanner.Stub {
    ...
    public class WifiSingleScanStateMachine extends StateMachine implements WifiNative.ScanEventHandler {
        ...
        private RequestList<WifiScanner.ScanSettings> mBlockedScans = new RequestList<>();
        private RequestList<WifiScanner.ScanSettings> mBootingScans = new RequestList<>();
                ...
                switch (msg.what) {
                    ...
                    case WifiScanningServiceImpl.CMD_DRIVER_LOADED /* 160006 */:
                        ...
                        if (WifiSingleScanStateMachine.this.mBootingScans.size() != 0 && WifiSingleScanStateMachine.this.mPendingScans.size() == 0) {
                            ...
                            wifiSingleScanStateMachine.mPendingScans = wifiSingleScanStateMachine.mBootingScans;
