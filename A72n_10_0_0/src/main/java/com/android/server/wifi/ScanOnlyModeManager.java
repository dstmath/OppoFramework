    ...
    public class ScanOnlyModeStateMachine extends StateMachine {
        ...
        private class IdleState extends State {
            ...
            public boolean processMessage(Message message) {
                ...
                ScanOnlyModeManager.this.mClientInterfaceName = ScanOnlyModeManager.this.mWifiNative.getClientInterfaceName();
                if (ScanOnlyModeManager.this.mClientInterfaceName != null) {
                    ...
                    ScanOnlyModeManager.this.mClientInterfaceName = ScanOnlyModeManager.this.mWifiNative.setupInterfaceForClientInConnectivityMode(ScanOnlyModeStateMachine.this.mWifiNativeInterfaceCallback);
                }
