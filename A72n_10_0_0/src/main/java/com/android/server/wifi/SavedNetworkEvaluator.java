...
public class SavedNetworkEvaluator implements WifiNetworkSelector.NetworkEvaluator {
    ...
    SavedNetworkEvaluator(Context context, ScoringParams scoringParams, WifiConfigManager configManager, Clock clock, LocalLog localLog, WifiConnectivityHelper connectivityHelper, SubscriptionManager subscriptionManager) {
        ...
        this.mSameBssidAward = context.getResources().getInteger(17694924);
        this.mSameNetworkAward = context.getResources().getInteger(17694934);
        this.mLastSelectionAward = context.getResources().getInteger(17694920);
        this.mSecurityAward = context.getResources().getInteger(17694925);
        this.mBand5GHzAward = context.getResources().getInteger(17694917);
    }
