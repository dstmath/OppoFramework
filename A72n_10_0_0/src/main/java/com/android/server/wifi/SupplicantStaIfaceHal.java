...
public class SupplicantStaIfaceHal {
    ...
    private ISupplicantIface addIfaceV1_1(String ifaceName) {
        ...
        synchronized (this.mLock) {
            ...
            try {
                ...
                Log.e(TAG, "ISupplicant.addInterface IllegalArgumentException: " + e3);
                clearState();
                return null;
            } catch (Exception e4) {
                Log.e(TAG, "ISupplicant.addInterface Exception: " + e4);
                clearState();
                return null;
            }
        }
    ...
    private boolean removeIfaceV1_1(String ifaceName) {
        synchronized (this.mLock) {
            try {
                ...
                Log.e(TAG, "ISupplicant.removeInterface IllegalArgumentException: " + e3);
                clearState();
                return false;
            } catch (Exception e4) {
                Log.e(TAG, "ISupplicant.removeInterface Exception: " + e4);
                clearState();
                return false;
            } catch (Throwable th) {
                throw th;
    ...
    private SupplicantStaNetworkHal addNetwork(String ifaceName) {
        synchronized (this.mLock) {
            ...
            return getStaNetworkMockable(ifaceName, ISupplicantStaNetwork.asInterface(((ISupplicantNetwork) newNetwork.value).asBinder()), IOppoSupplicantStaNetwork.asInterface(((ISupplicantNetwork) newNetwork.value).asBinder()));
        }
    }
    ...
    public boolean reassociate(String ifaceName) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                return checkStatusAndLogFailure(status, "reassociate");
            } catch (RemoteException e) {
    ...
    public boolean manuReassociate(String ifaceName) {
        synchronized (this.mLock) {
            ...
            try {
                return checkStatusAndLogFailure(iface.manuReassociate(), "reassociate");
            } catch (RemoteException e) {
                handleRemoteException(e, "reassociate");
                return false;
            }
    ...
    public boolean reconnect(String ifaceName) {
        synchronized (this.mLock) {
            ...
            try {
                ...
                return checkStatusAndLogFailure(status, "reconnect");
            } catch (RemoteException e) {
    ...
    public class SupplicantStaIfaceHalCallback extends ISupplicantStaIfaceCallback.Stub {
        ...
        public void onDisconnected(byte[] bssid, boolean locallyGenerated, int reasonCode) {
            synchronized (SupplicantStaIfaceHal.this.mLock) {
                ...
                wifiMonitor.broadcastNetworkDisconnectionEvent(str, i, reasonCode, NativeUtil.macAddressFromByteArray(bssid));
            }
        }
    ...
    /* access modifiers changed from: private */
    public class SupplicantStaIfaceHalCallbackV1_2 extends IOppoSupplicantStaIfaceCallback.Stub {
    ...
    public boolean setOshareMod(String ifaceName, int cmd) {
        ...
        synchronized (this.mLock) {
            ...
            try {
                return checkStatusAndLogFailure(iface.setOshareMod(targetMode), "setOshareMod");
            } catch (RemoteException e) {
    ...
    private void updateNetworkConnectEvent() {
        WifiInjector wifiInjector = WifiInjector.getInstance();
        if (wifiInjector != null && wifiInjector.getWifiDisconStat() != null) {
            wifiInjector.getWifiDisconStat().updateConnectEvent(0);
        }
    }
}
