...
public class PermissionManagerService {
    ...
    private void restorePermissionState(PackageParser.Package pkg, boolean replace, String packageOfInterest, PermissionManagerServiceInternal.PermissionCallback callback) {
        ...
        PackageSetting ps3 = (PackageSetting) r8.mExtras;
        if (ps3 != null) {
            ...
            synchronized (obj3) {
                try {
                    ...
                    boolean pkgReviewRequired4 = permissionManagerService.isPackageNeedsReview(r8, ps3.getSharedUser());
                    int[] updatedUserIds3 = updatedUserIds2;
                    int i3 = 0;
                    boolean changedInstallPermission = false;
                    while (i3 < N) {
                        try {
                            String permName2 = (String) r8.requestedPermissions.get(i3);
                            ...
                            try {
                                if (PackageManagerService.DEBUG_INSTALL) {
                                    ...
                                    i = i3;
                                    try {
                                        Log.i(TAG, "Package " + r8.packageName + " checking " + permName2 + ": " + bp);
                                    } catch (Throwable th2) {
                                        th = th2;
                                        obj = obj3;
                                    }
                                    ...
                                    try {
                                        if (bp.getSourcePackageSetting() == null) {
                                            ...
                                            if (origPermissions.hasRequestedPermission(permName2)) {
                                                newImplicitPermissions = newImplicitPermissions3;
                                            } else if (!r8.implicitPermissions.contains(permName2) && !permName2.equals("android.permission.ACTIVITY_RECOGNITION")) {
                                                newImplicitPermissions = newImplicitPermissions3;
                                            } else if (!r8.implicitPermissions.contains(permName2)) {
                                                ...
                                                while (true) {
                                                    ...
                                                    if (!sp.getNewPermissions().contains(permName2)) {
                                                        ...
                                                        newImplicitPermissions3.add(permName2);
                                                        if (PackageManagerService.DEBUG_PERMISSIONS) {
                                                            newImplicitPermissions = newImplicitPermissions3;
                                                            Slog.i(TAG, permName2 + " is newly added for " + r8.packageName);
                                                        } else {
                                                            newImplicitPermissions = newImplicitPermissions3;
                                                        }
                                                    } else {
                                            ...
                                            if (r8.applicationInfo.isInstantApp() && !bp.isInstant()) {
                                                ...
                                                if (bp.isAppOp()) {
                                                    allowedSig = false;
                                                    grant = 1;
                                                    permissionManagerService.mSettings.addAppOpPackage(perm2, r8.packageName);
                                                } else {
                                                    allowedSig = false;
                                                    grant = 1;
                                                }
                                                if (bp.isNormal()) {
                                                    ...
                                                    boolean allowedSig2 = permissionManagerService.grantSignaturePermission(perm2, r8, bp, origPermissions);
                                                    if (allowedSig2) {
                                                        grant2 = 2;
                                                ...
                                                if (PackageManagerService.DEBUG_PERMISSIONS) {
                                                    ...
                                                    sb.append(r8.packageName);
                                                    Slog.i(TAG, sb.toString());
                                                } else {
                                                    pkgReviewRequired2 = pkgReviewRequired4;
                                                }
                                                if (grant2 != 1) {
                                                    if (!ps3.isSystem() && ps3.areInstallPermissionsFixed() && !bp.isRuntime() && !allowedSig && !origPermissions.hasInstallPermission(perm2) && !permissionManagerService.isNewPlatformPermissionForPackage(perm2, r8)) {
                                                        if (permissionManagerService.mOppoPackageManagerInt == null || permissionManagerService.mOppoPackageManagerInt.allowAddInstallPermForDataApp(r8.packageName)) {
                                                            Slog.d(TAG, "filter data app add install perms for " + r8.packageName);
                                                        } else {
                                                            grant2 = 1;
                                                        }
                                                    }
                                                    if (grant2 == 2) {
                                                                        ...
                                                                        try {
                                                                            if (this.mPermissionPolicyInternal.isInitialized(userId)) {
                                                                                    ...
                                                                                    try {
                                                                                        if (!CtaManagerFactory.getInstance().makeCtaManager().isPlatformPermission(bp.getSourcePackageName(), bp.getName()) || !pkgReviewRequired3) {
                                                                                            ...
                                                                                            if (str2 != null) {
                                                                                                r152 = pkg;
                                                                                                try {
                                                                                                    if (str2.equals(r152.packageName)) {
                                                                                                        z2 = replace;
                                                                                                        if (!z2) {
                                                                                                            flags2 |= 64;
                                                                                                            wasChanged = true;
                                                                                ...
                                                                                if (!permissionPolicyInitialized) {
                                                                                    ...
                                                                                    if (CtaManagerFactory.getInstance().makeCtaManager().isPlatformPermission(bp.getSourcePackageName(), bp.getName()) && pkgReviewRequired3 && (flags2 & 64) == 0 && !bp.isRemoved() && str2 != null && str2.equals(r152.packageName) && !z2) {
                                                                                        flags2 |= 64;
                                                                                        wasChanged = true;
                                                                                    }
                                                                                } else {
                                                        ...
                                                        try {
                                                            ...
                                                            int flags4 = permState3 != null ? permState3.getFlags() : 0;
                                                                    ...
                                                                    if (permissionManagerService.mPermissionPolicyInternal != null) {
                                                                        try {
                                                                            ...
                                                                            if (permissionManagerService.mPermissionPolicyInternal.isInitialized(userId2)) {
                                                                                ...
                                                                                permissionsState.updatePermissionFlags(bp, userId2, 64511, flags5);
                                                                                i6++;
                                                                                permissionManagerService = this;
                                                                                perm2 = perm2;
                                                                                length3 = length3;
                                                    ...
                                                    } else if (str3 == null || str3.equals(r8.packageName)) {
                                                        if (PackageManagerService.DEBUG_PERMISSIONS) {
                                                            Slog.i(TAG, "Not granting permission " + perm2 + " to package " + r8.packageName + " because it was previously installed without");
                                                            z = replace;
                                                            obj2 = obj3;
                                                            ps2 = ps3;
                                                            currentUserIds = currentUserIds2;
                                                    ...
                                                    try {
                                                        if (permissionsState.revokeInstallPermission(bp) != -1) {
                                                            ...
                                                            try {
                                                                Slog.i(TAG, "Un-granting permission " + perm2 + " from package " + r15.packageName + " (protectionLevel=" + bp.getProtectionLevel() + " flags=0x" + Integer.toHexString(r15.applicationInfo.flags) + ")");
                                                                changedInstallPermission = true;
                                                                updatedUserIds3 = updatedUserIds3;
                                                                i3 = i + 1;
                                                                permissionManagerService = this;
                                                            ...
                                                            if (bp.isAppOp() && PackageManagerService.DEBUG_PERMISSIONS && (str == null || str.equals(r15.packageName))) {
                                                                Slog.i(TAG, "Not granting permission " + perm2 + " to package " + r15.packageName + " (protectionLevel=" + bp.getProtectionLevel() + " flags=0x" + Integer.toHexString(r15.applicationInfo.flags) + ")");
                                                            }
                                                            updatedUserIds3 = updatedUserIds3;
                                                            i3 = i + 1;
                                                            permissionManagerService = this;
                                ...
                                if (str == null || str.equals(r15.packageName)) {
                                    if (PackageManagerService.DEBUG_PERMISSIONS) {
                                        Slog.i(TAG, "Unknown permission " + permName + " in package " + r15.packageName);
                                    }
                                }
                                updatedUserIds3 = updatedUserIds3;
                                i3 = i + 1;
                    ...
                    if (!ps3.isUpdatedSystem()) {
                        ...
                        try {
                            try {
                                int[] updatedUserIds7 = checkIfLegacyStorageOpsNeedToBeUpdated(r8, z3, setInitialGrantForNewImplicitPermissionsLocked(origPermissions, permissionsState, pkg, newImplicitPermissions3, revokePermissionsNoLongerImplicitLocked(permissionsState, r8, updatedUserIds3)));
                                if (callback != null) {
                    ...
                    try {
                        obj = obj3;
                        int[] updatedUserIds72 = checkIfLegacyStorageOpsNeedToBeUpdated(r8, z3, setInitialGrantForNewImplicitPermissionsLocked(origPermissions, permissionsState, pkg, newImplicitPermissions3, revokePermissionsNoLongerImplicitLocked(permissionsState, r8, updatedUserIds3)));
                        if (callback != null) {
                        }
                        while (r2 < r0) {
                        }
