...
public class OppoStatsNotLaunchedAppUtils {
    ...
    private FileOperatorInternal mFileOperationInternal = new FileOperatorInternal();
    private HashMap<String, Long> mNotLaunchedApps = new HashMap<>();
        ...
        if (notLaunchedAppFile.exists()) {
            this.mServicePool.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    oppoStatsNotLaunchedAppUtils.mNotLaunchedApps = oppoStatsNotLaunchedAppUtils.mFileOperationInternal.readDataFromFile(notLaunchedAppFile);
                }
            });
        }
    }
    ...
    private boolean isDcsSwitchEnable() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isNeedToUploadColdLaunchTimeToDCS(ApplicationInfo appInfo) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isCompileCompleted(ApplicationInfo appInfo) {
        if (appInfo == null) {
            return false;
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void addNotLaunchedAppLock(ApplicationInfo applicationInfo) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void removeNotLaunchedAppLock(String pkgName) {
    ...
    public class FileOperatorInternal {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0047, code lost:
            throw r3;
         */
        private void writeDataToFile(HashMap<String, Long> refreshList, File outFile) {
            if (OppoStatsNotLaunchedAppUtils.DEBUG_SWITCH) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x002d, code lost:
            throw r3;
         */
        private HashMap<String, Long> readDataFromFile(File file) {
