...
public class ColorDexMetadataManagerHelper {
    ...
    private boolean mDebugSwitch = ColorDexMetadataManager.sDebugDetail;
    ...
    private void readCompilePackageSetFromFile() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void readDexOptPackageSetFromFile() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void saveCompilePackageSetToFile() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void saveDexOptPackageSetToFile() {
                ...
                public void run() {
                    ...
                    if (outFile.exists()) {
                        try {
                            ...
                            ColorDexMetadataManagerHelper.this.mCompiledApp = (HashMap) ois.readObject();
                            if (ColorDexMetadataManagerHelper.this.mDebugSwitch) {
