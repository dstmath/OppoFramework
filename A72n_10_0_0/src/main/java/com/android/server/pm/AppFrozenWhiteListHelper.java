...
public class AppFrozenWhiteListHelper extends RomUpdateHelper {
    ...
    private ArrayList<String> mProviderWhiteList = new ArrayList<>();
    private ArrayList<String> mServiceWhiteList = new ArrayList<>();
    ...
    public void processWhiteFrozenComponent(PackageManagerService pms, String componentName, int userId) {
        ...
        if (typeCasting(pms) != null && componentName != null) {
            if (DEBUG_SHOW_INFO) {
