...
class PackageManagerShellCommand extends ShellCommand {
        ...
        try {
            ...
            switch (c) {
                ...
                case 20:
                    ...
                    pw.println("Skip pm compile on the aging version");
                    return 0;
                case 21:
    ...
    private int runList() throws RemoteException {
        ...
        switch (type.hashCode()) {
            ...
            case -997447790:
                ...
                break;
            case -807062458:
                if (type.equals(Settings.ATTR_PACKAGE)) {
                    c = 3;
                    break;
                }
                c = 65535;
    ...
    private int runListOppoFeatures() {
        PrintWriter pw = getOutPrintWriter();
        try {
            List<FeatureInfo> list = new ArrayList<>();
            FeatureInfo[] rawList = new OppoPackageManager().getOppoSystemAvailableFeatures();
            if (rawList != null) {
                if (rawList.length != 0) {
            ...
            pw.println("oppo System features not Available");
            return 0;
        } catch (RemoteException e) {
            pw.println(e.toString());
            pw.println("Error: Could not access the OppoPackageManagerService. Is the system running?");
            return 1;
        }
    }
    ...
    private int runInstall() throws RemoteException {
        ...
        try {
            if (OppoEnterpriseServiceHelper.getInstance().hasOppoEnterpriseFeature() && !OppoEnterpriseServiceHelper.getInstance().hasAdbInstallUninstallPermission()) {
                if (1 != 0) {
                    try {
                        doAbandonSession(sessionId, false);
                    } catch (Exception e2) {
    ...
    /* JADX INFO: Multiple debug info for r0v16 int: [D('installFlags' int), D('waitTillComplete' boolean)] */
    ...
    /* JADX INFO: Multiple debug info for r7v7 int: [D('compilationReason' java.lang.String), D('index' int)] */
    /* JADX INFO: Multiple debug info for r2v59 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v60 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v61 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v62 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v63 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v64 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v65 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v66 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v67 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r2v68 'opt'  java.lang.String: [D('compileByCmd' boolean), D('opt' java.lang.String)] */
    private int runCompile() throws RemoteException {
        String targetCompilerFilter;
        String targetCompilerFilter2;
        List<String> packageNames;
        boolean compilationReasonGiven;
        ...
        boolean result;
        int reason;
        boolean compileByCmd;
        char c;
        String opt;
        PrintWriter pw = getOutPrintWriter();
        boolean compileByCmd2 = this.mInterface.inPmsWhiteList((int) CompatibilityHelper.FORCE_CHOOSING_TARGETSDK_M, TemperatureProvider.SWITCH_ON, new ArrayList<>(Arrays.asList(TemperatureProvider.SWITCH_ON)));
        int uid = Binder.getCallingUid();
        if (!compileByCmd2 || uid == 1000 || uid == 0) {
            ...
            while (true) {
                ...
                if (opt2 != null) {
                    ...
                    compileByCmd2 = compileByCmd;
                } else {
                    if (checkProfilesRaw != null) {
                        if (TemperatureProvider.SWITCH_ON.equals(checkProfilesRaw)) {
                            checkProfiles = true;
                        } else if (TemperatureProvider.SWITCH_OFF.equals(checkProfilesRaw)) {
                            checkProfiles = false;
                        } else {
                    ...
                    boolean compilationReasonGiven2 = compilationReason2 != null;
                    if (!(compilerFilterGiven || compilationReasonGiven2 || compileLayouts) || ((!compilerFilterGiven && compilationReasonGiven2 && compileLayouts) || ((compilerFilterGiven && !compilationReasonGiven2 && compileLayouts) || ((compilerFilterGiven && compilationReasonGiven2 && !compileLayouts) || (compilerFilterGiven && compilationReasonGiven2 && compileLayouts))))) {
                        ...
                        if (!compilerFilterGiven) {
                            targetCompilerFilter = null;
                        } else if (!DexFile.isValidCompilerFilter(compilerFilter2)) {
                            pw.println("Error: \"" + compilerFilter2 + "\" is not a valid compilation filter.");
                            return 1;
                        } else {
                            targetCompilerFilter = compilerFilter2;
                        }
                        if (compilationReasonGiven2) {
                            int reason2 = -1;
                            int i = 0;
                            while (true) {
                            ...
                            targetCompilerFilter2 = PackageManagerServiceCompilerMapping.getCompilerFilterForReason(reason);
                        } else {
                            targetCompilerFilter2 = targetCompilerFilter;
                        }
                        if (allPackages) {
                        ...
                        for (String packageName2 : packageNames) {
                            if (clearProfileData2) {
                                compilationReasonGiven = compilationReasonGiven2;
                            ...
                            if (compileLayouts) {
                                ...
                                packageNames2 = packageNames;
                                if (secondaryDex) {
                                    result = this.mInterface.performDexOptSecondary(packageName2, targetCompilerFilter2, clearProfileData);
                                    compilerFilter = compilerFilter2;
                                } else {
                                    compilerFilter = compilerFilter2;
                                    result = this.mInterface.performDexOptMode(packageName2, checkProfiles, targetCompilerFilter2, clearProfileData, true, split);
                                }
                            }
                            if (!result) {
                            ...
                            index2 = index;
                            uid = uid;
                            compilationReasonGiven2 = compilationReasonGiven;
                            compilationReason2 = compilationReason;
            ...
            pw.println("Error: Failed to cpmpile !");
            return 1;
        }
    }
            ...
            if (opt != null) {
                ...
                if (!isBootImage) {
                    if (!Objects.equals(baseCodePath, codePath)) {
                        ...
                        Os.chmod(outputProfilePath, TemperatureProvider.HIGH_TEMPERATURE_THRESHOLD);
                ...
                Os.chmod(outputProfilePath2, TemperatureProvider.HIGH_TEMPERATURE_THRESHOLD);
                try {
                    $closeResource(null, inStream);
                    return 0;
    ...
    /* JADX INFO: Multiple debug info for r0v10 int: [D('userId' int), D('flags' int)] */
    ...
    public int runSetUserRestriction() throws RemoteException {
        ...
        String arg = getNextArg();
        if (NoFocusWindow.HUNG_CONFIG_ENABLE.equals(arg)) {
            value = true;
