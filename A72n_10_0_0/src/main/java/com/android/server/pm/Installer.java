...
public class Installer extends OppoBaseInstaller {
    ...
    public void customCmd(String path, String cmd) throws InstallerException {
        try {
            this.mInstalld.customCmd(path, cmd);
        } catch (Exception e) {
            throw InstallerException.from(e);
        }
    }

    public void backupAppData(String from, String dest, int requesetId) throws InstallerException {
        try {
            this.mInstalld.backupAppData(from, dest, requesetId);
        } catch (Exception e) {
            throw InstallerException.from(e);
        }
    }
    ...
    @Override // com.android.server.pm.OppoBaseInstaller
    public boolean updateAppProfile(String pkg, int userId, int appId, String profileName, String codePath, String dexMetadataPath) {
        ...
        try {
            return this.mInstalld.updateAppProfile(pkg, userId, appId, profileName, codePath, dexMetadataPath);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public boolean dumpAppClassAndMethod(int uid, String packageName, String profilePath, String codePath, String outputMethodPath) {
        ...
        try {
            return this.mInstalld.dumpAppClassAndMethod(uid, packageName, profilePath, codePath, outputMethodPath);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public boolean createAppProfile(int uid, String packageName, String hotMethodPath, String codePath, String outputProfilePath) {
        ...
        try {
            return this.mInstalld.createAppProfile(uid, packageName, hotMethodPath, codePath, outputProfilePath);
        } catch (Exception e) {
            return false;
        }
    }
