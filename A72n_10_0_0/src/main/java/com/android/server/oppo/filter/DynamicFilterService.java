...
public class DynamicFilterService extends SystemService {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.android.server.oppo.filter.DynamicFilterService */
    ...
    public class FilterListHelper {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0034, code lost:
            throw r3;
         */
        private void saveFilterListToFile(String filePath, FilterList filterList) {
