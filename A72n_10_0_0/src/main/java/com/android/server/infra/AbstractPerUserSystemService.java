...
public abstract class AbstractPerUserSystemService<S extends AbstractPerUserSystemService<S, M>, M extends AbstractMasterSystemService<M, S>> {
    ...
    public boolean updateLocked(boolean disabled) {
        ...
        this.mSetupComplete = NoFocusWindow.HUNG_CONFIG_ENABLE.equals(Settings.Secure.getStringForUser(getContext().getContentResolver(), "user_setup_complete", this.mUserId));
    ...
    public final CharSequence getServiceLabelLocked() {
        ...
        return serviceInfo.loadSafeLabel(getContext().getPackageManager(), OppoBrightUtils.MIN_LUX_LIMITI, 5);
    }
