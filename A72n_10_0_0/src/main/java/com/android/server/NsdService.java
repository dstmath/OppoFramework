...
public class NsdService extends INsdManager.Stub {
            ...
            public boolean processMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 69636:
                        ...
                        return true;
                    case 393217:
                        NsdService.this.replyToMessage((NsdService) msg, (Message) 393219, 0);
                        return true;
                    case 393222:
                        NsdService.this.replyToMessage((NsdService) msg, (Message) 393223, 0);
                        return true;
                    case 393225:
                        NsdService.this.replyToMessage((NsdService) msg, (Message) 393226, 0);
                        return true;
                    case 393228:
                        NsdService.this.replyToMessage((NsdService) msg, (Message) 393229, 0);
                        return true;
                    case 393234:
                        NsdService.this.replyToMessage((NsdService) msg, (Message) 393235, 0);
                        return true;
                    default:
                ...
                switch (msg.what) {
                    ...
                    case 393217:
                        ...
                        if (requestLimitReached(clientInfo)) {
                            NsdService.this.replyToMessage((NsdService) msg, (Message) 393219, 4);
                            return true;
                        }
                        int id = NsdService.this.getUniqueId();
                        if (NsdService.this.discoverServices(id, servInfo.getServiceType())) {
                            Slog.d(NsdService.TAG, "Discover " + msg.arg2 + StringUtils.SPACE + id + servInfo.getServiceType());
                            storeRequestMap(msg.arg2, id, clientInfo, msg.what);
                            NsdService.this.replyToMessage((NsdService) msg, (Message) 393218, (int) servInfo);
                            return true;
                        }
                    ...
                    case 393225:
                        ...
                        if (requestLimitReached(clientInfo3)) {
                            NsdService.this.replyToMessage((NsdService) msg, (Message) 393226, 4);
                            return true;
                        }
                        int id3 = NsdService.this.getUniqueId();
                        if (NsdService.this.registerService(id3, (NsdServiceInfo) msg.obj)) {
                            Slog.d(NsdService.TAG, "Register " + msg.arg2 + StringUtils.SPACE + id3);
                    ...
                    case 393234:
                        ...
                        if (clientInfo5.mResolvedService != null) {
                            NsdService.this.replyToMessage((NsdService) msg, (Message) 393235, 3);
                            return true;
                        }
    ...
    private boolean registerService(int regId, NsdServiceInfo service) {
        Slog.d(TAG, "registerService: " + regId + StringUtils.SPACE + service);
        String name = service.getServiceName();
        String type = service.getServiceType();
        int port = service.getPort();
        String record = Base64.encodeToString(service.getTxtRecord(), 0).replace(StringUtils.LF, "");
