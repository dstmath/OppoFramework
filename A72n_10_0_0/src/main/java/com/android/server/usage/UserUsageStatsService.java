...
public class UserUsageStatsService {
    ...
    private void rolloverStats(long currentTimeMillis) {
        ...
        while (i4 < length) {
            ...
            while (i5 < pkgCount2) {
                ...
                if (pkgStats2.mActivities.size() > 0 || !pkgStats2.mForegroundServices.isEmpty()) {
                    ...
                    continuePkgs2.add(pkgStats.mPackageName);
                    notifyStatsChanged();
                } else {
                    intervalStatsArr2 = intervalStatsArr3;
                    i3 = i5;
        ...
        while (i6 < continueCount2) {
            ...
            int i7 = 0;
            for (int length2 = intervalStatsArr4.length; i7 < length2; length2 = i) {
                int i8 = length2;
                IntervalStats stat4 = intervalStatsArr4[i7];
    ...
    public void printIntervalStats(IndentingPrintWriter pw, IntervalStats stats, boolean prettyDates, boolean skipEvents, String pkg) {
        ...
        while (true) {
            ...
            if (pkg == null || pkg.equals(usageStats.mPackageName)) {
                ...
                pw.printPair(str, Integer.valueOf(usageStats.mErrorCount));
                pw.println();
            }
            i++;
        }
        ...
        for (UsageStats usageStats2 : pkgStats.values()) {
            if (pkg == null || pkg.equals(usageStats2.mPackageName)) {
                ...
                pw.printPair(str, Integer.valueOf(usageStats2.mErrorCount));
