...
public class LinearMotorVibratorControler {
    ...
    private IOppoVibratorCallback mVibratorCallback = null;
    ...
    public boolean startCustomizeVibratorImplLocked(VibrationEffect effect, int vibUid, int vibUsageHint) {
        if (effect == null) {
            ...
            if (this.mVibratorCallback != null) {
                long timeout = effect.getDuration();
                if (timeout < 1000) {
                    timeout = 1000;
                }
                this.mVibratorCallback.onVibrationEndLocked(timeout);
            }
            return true;
    ...
    private void doLinearMotorVibratorOn(int waveformId, long timing, int strength, int uid, int usageHint) {
        Throwable th;
        Exception e;
        ...
        try {
            ...
            if (mOppoDebug) {
                ...
                try {
                    ...
                    sb.append(strength);
                    sb.append(",");
                    sb.append(useRtpMode(usageHint));
            ...
            if (!usingInputDeviceVibrators) {
                if (OppoMirrorLinearMotorVibratorManager.turnOnLinearmotorVibrator != null) {
                    OppoMirrorLinearMotorVibratorManager.turnOnLinearmotorVibrator.call((Object) null, new Object[]{Integer.valueOf(waveformId), Short.valueOf(convertEffectStrength(strength)), Boolean.valueOf(useRtpMode(usageHint))});
                } else {
    ...
    /* access modifiers changed from: private */
    public static class DcsVibrationData {
