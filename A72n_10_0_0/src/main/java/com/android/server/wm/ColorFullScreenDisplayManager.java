        ...
        if (windowManagerService != null && (displaycontent = windowManagerService.getDefaultDisplayContentLocked()) != null && displaycontent.getDisplayPolicy() != null && (displaycontent.getDisplayPolicy() instanceof OppoDisplayPolicy)) {
            ...
            switch (msg.what) {
                case 1302:
                    ...
                    if (bundle != null) {
                        mPolicy.reLayoutDisplayFullScreenWindow(true, bundle.getString(ColorResourcePreloadDatabaseHelper.PRELOAD_COLUMN_NAME), bundle.getInt("rotation"), bundle.getBoolean("needHide"), bundle.getInt(ColorResourcePreloadDatabaseHelper.PRELOAD_COLUMN_UID));
                        return;
                    }
                    return;
                case 1303:
            ...
            if (w.mAttrs == null || w.mAttrs.getTitle() == null || !w.mAttrs.getTitle().toString().contains("ColorFullScreenDisplay")) {
                ...
                if (displayContent.getDisplayPolicy() != null && (displayContent.getDisplayPolicy() instanceof OppoDisplayPolicy) && w.getAttrs() != null) {
                    ...
                    if (add) {
                        ...
                        bundle.putString(ColorResourcePreloadDatabaseHelper.PRELOAD_COLUMN_NAME, w.getAttrs().packageName);
                        ...
                        bundle.putInt(ColorResourcePreloadDatabaseHelper.PRELOAD_COLUMN_UID, w.getOwningUid());
                        msg.setData(bundle);
                        this.mWms.mH.sendMessageDelayed(msg, 0);
                    } else if (remove) {
