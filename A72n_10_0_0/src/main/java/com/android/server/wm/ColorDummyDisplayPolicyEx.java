...
public class ColorDummyDisplayPolicyEx implements IColorDisplayPolicyEx {
    ...
    public static final String KEY_SWIPE_UP_GESTURE_ROTATION_FOLLOW_SCREEN = "follow_rotation_gesture_bar_enable";
    ...
    public static final int NAV_BAR_POSITION_FOLLOW_SCREEN_DISABLE = 0;
    public static final int NAV_BAR_POSITION_FOLLOW_SCREEN_ENABLE = 1;
    ...
    protected int mNavBarPositionFollowScreenRotation = 1;
