...
public class OppoArmyController {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                if (OppoArmyController.this.mDialogForDisallow == null) {
                    ...
                    oppoArmyController.mDialogForDisallow = new BaseErrorDialog(oppoArmyController.mUiContext);
    ...
    public void systemReady() {
        new Thread(new Runnable() {
            ...
            public void run() {
                OppoArmyController.this.mCustomizeList = OppoArmyController.loadCustomizeWhiteList(OppoArmyController.CUSTOMIZE_LIST_PATH);
                OppoArmyController.this.mProtectAppList = OppoArmyController.loadCustomizeWhiteList(OppoArmyController.PROTECT_APP_LIST_PATH);
