                    ...
                    if (hashCode != -1562491215) {
                        if (hashCode == 351608024 && tagName.equals("version")) {
                            ...
                            if (c == 0) {
                                ...
                                continue;
                            } else if (Integer.parseInt(parser2.getAttributeValue(null, TYPE_TAG)) == 2) {
                                parseSecondStageRUSFile(parser2);
                                continue;
                            } else {
                                continue;
                            }
                ...
                try {
                    ...
                    if (componentName != null) {
                        ...
                        if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(activity)) {
                            return this.mFilterActivitys.contains(activity);
                        }
                    }
                } catch (Throwable e) {
            ...
            if (intent != null) {
                try {
                    ...
                    if (componentName != null) {
                        ...
                        String activity = componentName.getClassName();
                        if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(activity)) {
                            return this.mHideActivitys.contains(activity);
                        }
                    }
                } catch (Throwable e) {
                ...
                try {
                    ...
                    if (componentName != null) {
                        ...
                        if (!TextUtils.isEmpty(packageName) && !TextUtils.isEmpty(activity)) {
                            ...
                            return this.mIgnoreAppSwitchActivitys.contains(activity);
                        }
                    }
                } catch (Throwable e) {
