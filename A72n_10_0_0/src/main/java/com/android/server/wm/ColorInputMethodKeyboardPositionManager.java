...
public class ColorInputMethodKeyboardPositionManager {
    ...
    public BroadcastReceiver mRegionOrLanguageChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            colorInputMethodKeyboardPositionManager.mIsJapan = colorInputMethodKeyboardPositionManager.isJapan();
            ...
            colorInputMethodKeyboardPositionManager2.mKeyboardPosition = Settings.Secure.getIntForUser(colorInputMethodKeyboardPositionManager2.mContext.getContentResolver(), ColorInputMethodKeyboardPositionManager.KEYBOARD_POSITION, 1, -2);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void calculateMethodPaddingInfo(Resources resources) {
