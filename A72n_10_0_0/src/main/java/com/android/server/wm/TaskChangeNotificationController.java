...
public class TaskChangeNotificationController {
    ...
    static /* synthetic */ void lambda$new$18(ITaskStackListener l, Message m) throws RemoteException {
        if (m.obj != null && !((ActivityManager.TaskSnapshot) m.obj).getSnapshot().isDestroyed()) {
