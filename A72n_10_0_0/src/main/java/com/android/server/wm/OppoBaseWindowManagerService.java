...
public abstract class OppoBaseWindowManagerService extends IWindowManager.Stub {
    ...
    public void notifySfAnimationNow(boolean startStop) {
        ...
        try {
            if (this.mFlinger != null) {
                ...
                data.writeBoolean(startStop);
                this.mFlinger.transact(OppoLightsService.SF_TRANSACTION_SWITCH_MODE_CODE, data, null, 1);
                data.recycle();
            }
        } catch (RemoteException e) {
            Slog.d("WindowManager", "get SurfaceFlinger Service failed");
        }
    }
}
