...
public class ColorStartingWindowUtils {
    ...
    public static boolean useTranslucentDrawableForSplashWindow(String packageName) {
        Set<String> set;
        if (!TextUtils.isEmpty(packageName) && (set = ColorStartingWindowRUSHelper.getStartingWindowListByType(12)) != null) {
            return set.contains(packageName);
        }
        return false;
    }
