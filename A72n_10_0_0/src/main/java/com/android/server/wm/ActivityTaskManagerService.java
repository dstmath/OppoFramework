...
public class ActivityTaskManagerService extends OppoBaseActivityTaskManagerService {
    ...
    IPswOppoArmyControllerFeatrue mOppoArmyController;
                ...
                if (!freeformWindowManagement && !supportsSplitScreenMultiWindow && !supportsPictureInPicture) {
                    if (!supportsMultiDisplay) {
                        ...
                        if ((globalConfig.uiMode & 4) != 4) {
                            this.mFullscreenThumbnailScale = ((float) res.getInteger(17695004)) / ((float) globalConfig.screenWidthDp);
                        } else {
    ...
    private void start() {
        ...
        this.mOppoArmyController = OppoFeatureCache.getOrCreate(IPswOppoArmyControllerFeatrue.DEFAULT, new Object[0]);
        this.mOppoArmyService = new OppoArmyService();
        this.mOppoArmyController.init(this.mUiContext, this.mOppoArmyService);
        this.mOppoArmyService.publish(this.mUiContext);
    }
    ...
    public IPswOppoArmyControllerFeatrue getOppoArmyController() {
