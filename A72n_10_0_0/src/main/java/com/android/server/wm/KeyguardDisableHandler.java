...
public class KeyguardDisableHandler {
    ...
    KeyguardDisableHandler(Injector injector, Handler handler) {
        ...
        this.mAppTokenWatcher = new UserTokenWatcher(this.mCallback, handler, "WindowManager");
        this.mSystemTokenWatcher = new UserTokenWatcher(this.mCallback, handler, "WindowManager");
    }
