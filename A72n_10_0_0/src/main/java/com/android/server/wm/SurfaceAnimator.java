...
public class SurfaceAnimator {
    ...
    private OnAnimationFinishedCallback getFinishedCallback(Runnable animationFinishedCallback) {
        return new OnAnimationFinishedCallback(animationFinishedCallback) {
            /* class com.android.server.wm.$$Lambda$SurfaceAnimator$vdRZk66hQVbQCvVXEaQCT1kVmFc */
    ...
    public /* synthetic */ void lambda$getFinishedCallback$1$SurfaceAnimator(Runnable animationFinishedCallback, AnimationAdapter anim) {
        synchronized (this.mService.mGlobalLock) {
            try {
                ...
                if (target != null) {
                    ...
                    Runnable resetAndInvokeFinish = new Runnable(anim, animationFinishedCallback) {
                        /* class com.android.server.wm.$$Lambda$SurfaceAnimator$M9kRDTUpVS03LTqeQLQz3DnMhk */
                        ...
                        public final void run() {
                            SurfaceAnimator.this.lambda$getFinishedCallback$0$SurfaceAnimator(this.f$1, this.f$2);
                        }
                    };
    ...
    private void cancelAnimation(SurfaceControl.Transaction t, boolean restarting, boolean forwardCancel) {
        if (WindowManagerDebugConfig.DEBUG_ANIM) {
            Slog.i("WindowManager", "Cancelling animation restarting=" + restarting);
        }
    ...
    private void reset(SurfaceControl.Transaction t, boolean destroyLeash) {
        ...
        if (reparent) {
            if (WindowManagerDebugConfig.DEBUG_ANIM) {
                Slog.i("WindowManager", "Reparenting to original parent: " + parent);
            }
    ...
    private SurfaceControl createAnimationLeash(SurfaceControl surface, SurfaceControl.Transaction t, int width, int height, boolean hidden) {
        ...
        t.show(leash);
        t.setAlpha(leash, hidden ? OppoBrightUtils.MIN_LUX_LIMITI : 1.0f);
