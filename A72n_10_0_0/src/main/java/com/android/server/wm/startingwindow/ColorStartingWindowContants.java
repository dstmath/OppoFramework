...
public class ColorStartingWindowContants {
    ...
    public static final Set<String> FORCE_CLEAR_SPLASH_TOKENS = Sets.newHashSet(new String[]{"com.tencent.mm/.plugin.voip.ui.VideoActivity"});
