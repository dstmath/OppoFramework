...
public class ColorFreeformConfig {
    ...
    private static boolean sDebugSwitch = sDebugDetail;
    ...
    public List<String> getConfigList(int type) {
        ...
        synchronized (this.mConfigLock) {
            if (type == 1) {
                try {
                    return this.mFreeformPkgList;
                } catch (Throwable th) {
                    throw th;
                }
            } else if (type == 2) {
                return this.mRootPkgList;
            } else if (type == 4) {
                return this.mSecureCpnList;
            } else if (type == 8) {
                return this.mSpecialCpnList;
            } else if (type == 32) {
                return this.mNextNeddFullscreenCpnList;
            } else if (type == 16) {
                return this.mFullscreenCpnList;
            } else if (type != 64) {
                return null;
            } else {
                return this.mBlackPkgList;
            }
        }
    }
    ...
    private void readFreeformConfigFile() {
        if (sDebugSwitch) {
