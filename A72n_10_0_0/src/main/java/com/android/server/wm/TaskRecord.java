...
public class TaskRecord extends ConfigurationContainer {
                                            ...
                                            if (sourceStack.isTopStackOnDisplay() && sourceStack.topRunningActivityLocked() == r) {
                                                ...
                                                if (moveStackMode == 0) {
                                                    ...
                                                    if (toStackWindowingMode2 != 1) {
                                                        if (toStackWindowingMode2 != 4) {
                                                            if (toStackWindowingMode2 != 5) {
                                                                ...
                                                                int windowingMode = preferredStack.getWindowingMode();
                                                                int i2 = z4 ? 1 : 0;
                                                                int i3 = z4 ? 1 : 0;
                                                                int i4 = z4 ? 1 : 0;
                                                                supervisor.handleNonResizableTaskIfNeeded(this, windowingMode, i2, toStack);
                                                                return preferredStack != toStack ? z3 : z4;
                                                            }
                                                            z3 = true;
                                                            windowManager3.continueSurfaceLayout();
                                                            if (!mightReplaceWindow) {
                                                            ...
                                                            int windowingMode2 = preferredStack.getWindowingMode();
                                                            int i22 = z4 ? 1 : 0;
                                                            int i32 = z4 ? 1 : 0;
                                                            int i42 = z4 ? 1 : 0;
                                                            supervisor.handleNonResizableTaskIfNeeded(this, windowingMode2, i22, toStack);
                                                    ...
                                                    if (!Objects.equals(configBounds, toStack.getRequestedOverrideBounds())) {
                                                        ...
                                                        int windowingMode22 = preferredStack.getWindowingMode();
                                                        int i222 = z4 ? 1 : 0;
                                                        int i322 = z4 ? 1 : 0;
                                                        int i422 = z4 ? 1 : 0;
                                                        supervisor.handleNonResizableTaskIfNeeded(this, windowingMode22, i222, toStack);
                                                        if (preferredStack != toStack) {
                                                        }
                                                    } else {
                                                        if (toStackWindowingMode2 != 5) {
                                                        ...
                                                        int windowingMode222 = preferredStack.getWindowingMode();
                                                        int i2222 = z4 ? 1 : 0;
                                                        int i3222 = z4 ? 1 : 0;
                                                        int i4222 = z4 ? 1 : 0;
                                                        supervisor.handleNonResizableTaskIfNeeded(this, windowingMode222, i2222, toStack);
                                                        if (preferredStack != toStack) {
                                                        }
                                                    }
                                                } else {
    ...
    public void addActivityAtIndex(int index, ActivityRecord r) {
        ...
        if (task == null || task == this) {
            ...
            if (this.mActivities.size() > 50 && tmpAffinity != null && NoFocusWindow.HUNG_CONFIG_ENABLE.equals(SystemProperties.get("SPECIAL_OPPO_CONFIG", "0"))) {
