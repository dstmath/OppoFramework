...
public final class ColorWindowManagerServiceTransactionHelper extends ColorWindowManagerServiceCommonHelper implements IColorWindowManager {
                                    ...
                                    default:
                                        switch (code) {
                                            ...
                                            case 10059:
                                                ...
                                                setBootAnimationRotationLock(z);
                                                reply.writeNoException();
                                                return true;
                                            case 10060:
                                                data.enforceInterface("android.view.IWindowManager");
                                                pilferPointers(data.readString());
                                                reply.writeNoException();
                                                return true;
                                            default:
                                                return false;
    ...
    public int getFocusedWindowIgnoreHomeMenuKey() {
        ...
        if (colorKeyMode != 2 && colorKeyMode != 3 && colorKeyMode != 4) {
            return 0;
        }
    ...
    private int getCustomFocusedWindowIgnoreHomeMenuKey() {
        ...
        if (!(currentFocus == null || (baseLayoutParams = typeCasting(currentFocus.getAttrs())) == null)) {
            ...
            } else if (baseLayoutParams.ignoreHomeMenuKey == 3 || (currentFocus.getAttrs().memoryType & ColorMultiAppManagerService.FLAG_MULTI_APP) != 0) {
        ...
        Slog.d(TAG, "getCustomFocusedWindowIgnoreHomeMenuKey: flagIgnoreHomeTask=" + flagIgnoreHomeTask2 + ", ignoreHomeTask=" + ignoreHomeTask);
    ...
    public void pilferPointers(String name) {
        OppoBaseWindowManagerService baseWms = (OppoBaseWindowManagerService) ColorTypeCastingHelper.typeCasting(OppoBaseWindowManagerService.class, this.mWms);
        if (baseWms != null && baseWms.mColorWmsEx != null) {
            baseWms.mColorWmsEx.pilferPointers(name);
        }
    }
}
