...
import com.android.server.theia.TheiaConst;
...
public class ActivityStackSupervisor extends OppoBaseActivityStackSupervisor implements RecentTasks.Callbacks {
                                        ...
                                        try {
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    Slog.w(str, "updateServiceConnectionActivities catch NullPointerException", e5);
                                                    return true;
                                                }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v5, resolved type: com.android.server.wm.RootActivityContainer */
    ...
    public void acquireAppLaunch() {
        ...
        Hypnus hypnus = mHyp;
        if (hypnus != null) {
            hypnus.hypnusSetAction(39, 2000);
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (i) {
                ...
                case ActivityStackSupervisor.LAUNCH_TIMEOUT_MSG /* 204 */:
                    ...
                    WindowManagerService.resetPriorityAfterLockedSection();
                    ComponentName topApp = ActivityStackSupervisor.this.getTopAppName();
                    if (topApp != null) {
                        TheiaUtil.getInstance().sendTheiaEvent(topApp.getPackageName(), TheiaConst.THEIA_ST_BTF, ActivityStackSupervisor.this.mService.mContext);
                        Slog.w(ActivityStackSupervisor.TAG, "TheiaBootFail theia record!  " + topApp.getPackageName());
                        return;
                    }
                    return;
                default:
