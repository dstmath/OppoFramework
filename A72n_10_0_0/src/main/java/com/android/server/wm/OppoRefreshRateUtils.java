...
public class OppoRefreshRateUtils {
    ...
    static int getMaxRefreshRateId(Context context) {
        return context.getPackageManager().hasSystemFeature("oppo.display.screen.120hz.support") ? 3 : 1;
    }
