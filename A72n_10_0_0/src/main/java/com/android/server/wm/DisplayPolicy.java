...
public class DisplayPolicy extends OppoBaseDisplayPolicy {
    ...
    DisplayPolicy(WindowManagerService service, DisplayContent displayContent) {
        ...
        this.mSystemGestures = new SystemGesturesPointerEventListener(this.mContext, this.mHandler, new SystemGesturesPointerEventListener.Callbacks() {
            ...
            public void onSwipeFromTop() {
                if (DisplayPolicy.this.requestGameDockIfNecessary()) {
                    Slog.i("WindowManager", "Top swipe rejected by GameSpace !");
                } else if (DisplayPolicy.this.mStatusBar != null) {
                    DisplayPolicy displayPolicy = DisplayPolicy.this;
        ...
        if (this.mDisplayContent.isDefaultDisplay) {
            ...
            if (NoFocusWindow.HUNG_CONFIG_ENABLE.equals(navBarOverride)) {
    ...
    /* JADX INFO: Multiple debug info for r8v1 android.graphics.Rect: [D('sf' android.graphics.Rect), D('pfl' int)] */
    ...
    public void layoutWindowLw(WindowState win, WindowState attached, DisplayFrames displayFrames) {
        ...
        if (!this.mScreenDecorWindows.contains(win)) {
            ...
            int type2 = attrs3.type;
            int fl4 = PolicyControl.getWindowFlags(win, attrs3);
            ...
            int sysUiFl8 = this.mColorDpEx.getSysUiFlagsForSplitScreen(win, requestedSysUiFl | getImpliedSysUiFlagsForLayout(attrs3));
            ...
            Rect pf2 = windowFrames4.mParentFrame;
            Rect df3 = windowFrames4.mDisplayFrame;
            Rect of3 = windowFrames4.mOverscanFrame;
            Rect cf3 = windowFrames4.mContentFrame;
            Rect vf = windowFrames4.mVisibleFrame;
            ...
            int adjust4 = sim2 & 240;
            boolean requestedFullscreen = ((fl4 & 1024) == 0 && (requestedSysUiFl & 4) == 0) ? false : true;
            boolean layoutInScreen = (fl4 & 256) == 256;
            boolean layoutInsetDecor2 = (65536 & fl4) == 65536;
            sf3.set(displayFrames.mStable);
            if (type2 == 2011) {
                vf.set(displayFrames.mDock);
                cf3.set(displayFrames.mDock);
                of3.set(displayFrames.mDock);
                df3.set(displayFrames.mDock);
                windowFrames4.mParentFrame.set(displayFrames.mDock);
                int i6 = displayFrames.mUnrestricted.bottom;
                of3.bottom = i6;
                df3.bottom = i6;
                pf2.bottom = i6;
                int i7 = displayFrames.mStable.bottom;
                vf.bottom = i7;
                cf3.bottom = i7;
                ...
                if (windowState3 != null && this.mFocusedWindow == windowState3 && canReceiveInput(windowState3)) {
                    int i8 = this.mNavigationBarPosition;
                    if (i8 == 2) {
                        int i9 = displayFrames.mStable.right;
                        vf.right = i9;
                        cf3.right = i9;
                        of3.right = i9;
                        df3.right = i9;
                        ...
                        int i10 = displayFrames.mStable.left;
                        vf.left = i10;
                        cf3.left = i10;
                        of3.left = i10;
                        df3.left = i10;
                ...
                of3.set(displayFrames.mUnrestricted);
                df3.set(displayFrames.mUnrestricted);
                pf2.set(displayFrames.mUnrestricted);
                if (adjust4 != 16) {
                    cf3.set(displayFrames.mDock);
                } else {
                ...
                windowFrames = windowFrames4;
                adjust = adjust4;
                layoutWallpaper(displayFrames, pf2, df3, of3, cf3);
                fl = fl4;
                adjust2 = type2;
                attrs = attrs3;
                layoutInsetDecor = layoutInsetDecor2;
                ...
                if (win == this.mStatusBar) {
                ...
                } else if (type2 != 2023 || (fl4 & 1024) == 0) {
                    dcf2.set(displayFrames.mSystem);
                    boolean inheritTranslucentDecor = (attrs3.privateFlags & 512) != 0;
                    boolean isAppWindow = type2 >= 1 && type2 <= 99;
                    boolean topAtRest = win == this.mTopFullscreenOpaqueWindowState && !win.isAnimatingLw();
                    if (!isAppWindow || inheritTranslucentDecor || topAtRest) {
                        sysUiFl4 = sysUiFl8;
                    } else {
                        sysUiFl4 = sysUiFl8;
                        if ((sysUiFl4 & 4) == 0 && (fl4 & 1024) == 0 && (67108864 & fl4) == 0 && (fl4 & Integer.MIN_VALUE) == 0 && (pfl & DumpState.DUMP_INTENT_FILTER_VERIFIERS) == 0) {
                            dcf2.top = displayFrames.mStable.top;
                        }
                        if ((134217728 & fl4) == 0 && (sysUiFl4 & 2) == 0) {
                            if ((fl4 & Integer.MIN_VALUE) == 0 && (pfl & DumpState.DUMP_INTENT_FILTER_VERIFIERS) == 0) {
                    ...
                    if (!layoutInScreen || !layoutInsetDecor2) {
                        ...
                        if (layoutInScreen) {
                            ...
                            str = "WindowManager";
                            cf = cf3;
                            setAttachedWindowFrames(win, fl4, adjust, attached, false, pf2, df3, of3, cf, vf, displayFrames);
                            adjust2 = type2;
                            of = of3;
                            vf = vf;
                            adjust = adjust;
                        ...
                        if (type == 2014) {
                            ...
                            if (type == 2019) {
                                ...
                                if (this.mColorDpEx.isWindowTitleEquals(win, "BreenoSmartPanel")) {
                                    ...
                                    if (adjust2 == 2015 || adjust2 == 2036 || adjust2 == 2314 || adjust2 == 2315) {
                                        fl = fl2;
                                        if ((fl & 1024) != 0) {
                                            cf.set(displayFrames.mOverscan);
                                            of.set(displayFrames.mOverscan);
                                    ...
                                    if (adjust2 == 2021) {
                                        ...
                                        sysUiFl = sysUiFl5;
                                        if ((sysUiFl & 512) != 0 && (adjust2 == 2000 || adjust2 == 2005 || adjust2 == 2034 || adjust2 == 2033 || (adjust2 >= i2 && adjust2 <= 1999))) {
                        ...
                        sf2.set(displayFrames.mUnrestricted);
                        if (hasNavBar) {
                            int i11 = displayFrames.mDock.left;
                            cf.left = i11;
                            of.left = i11;
                            df.left = i11;
                            sf2.left = i11;
                            int i12 = displayFrames.mRestricted.right;
                            cf.right = i12;
                            of.right = i12;
                            df.right = i12;
                            sf2.right = i12;
                            int i13 = displayFrames.mRestricted.bottom;
                            cf.bottom = i13;
                            of.bottom = i13;
                            df.bottom = i13;
                            sf2.bottom = i13;
                        ...
                        if (attached != null) {
                            ...
                            cf = cf3;
                            attrs = attrs3;
                            setAttachedWindowFrames(win, fl4, adjust, attached, true, pf2, df3, of3, cf, vf, displayFrames);
                            sf2 = pf2;
                            sysUiFl = sysUiFl6;
                            of = of3;
                            vf = vf;
                            ...
                            if (type2 == 2014) {
                                ...
                                if ((33554432 & fl3) != 0) {
                                    ...
                                    if (type2 < 1 || type2 > 1999) {
                                        ...
                                        applyStableConstraints(sysUiFl7, fl3, cf2, displayFrames);
                                        if (adjust3 != 48) {
                                            vf.set(displayFrames.mCurrent);
                                            str = str4;
                                            fl = fl3;
                                ...
                                sysUiFl7 = sysUiFl6;
                                if ((sysUiFl7 & 512) == 0 || !((type2 >= i3 && type2 <= 1999) || type2 == 2020 || type2 == 2009)) {
                            ...
                            int i14 = (hasNavBar ? displayFrames.mDock : displayFrames.mUnrestricted).left;
                            of2.left = i14;
                            df2.left = i14;
                            pf.left = i14;
                            int i15 = displayFrames.mUnrestricted.top;
                            of2.top = i15;
                            df2.top = i15;
                            pf.top = i15;
                            if (hasNavBar) {
                                i4 = displayFrames.mRestricted.right;
                            } else {
                                i4 = displayFrames.mUnrestricted.right;
                            }
                            of2.right = i4;
                            df2.right = i4;
                            pf.right = i4;
                            if (hasNavBar) {
                                i5 = displayFrames.mRestricted.bottom;
                            } else {
                                i5 = displayFrames.mUnrestricted.bottom;
                            }
                            of2.bottom = i5;
                            df2.bottom = i5;
                            pf.bottom = i5;
                    ...
                    of3.set(displayFrames.mOverscan);
                    df3.set(displayFrames.mOverscan);
                    pf2.set(displayFrames.mOverscan);
                    attrs = attrs3;
                    layoutInsetDecor = layoutInsetDecor2;
                    sim = sim2;
                    sf = sf3;
            ...
            int i16 = (attached == null || layoutInScreen) ? i : i2;
            int i17 = (requestedSysUiFl & 2) != 0 ? i2 : i;
            int i18 = (attrs.isFullscreen() || !layoutInScreen || adjust2 == i2) ? i : i2;
            ...
            if (cutoutMode == 1 || !isOppoAlwaysMode) {
                ...
                if (!layoutInScreen || !layoutInsetDecor || i17 != 0 || cutoutMode != 0) {
                    sysUiFl2 = sysUiFl;
                    sysUiFl3 = 4;
                } else {
                    int i19 = this.mNavigationBarPosition;
                    sysUiFl2 = sysUiFl;
                    if (i19 == 1) {
                        sysUiFl3 = 4;
                ...
                if (adjust2 == 2011 && this.mNavigationBarPosition == sysUiFl3) {
                    displayCutoutSafeExceptMaybeBars.bottom = Integer.MAX_VALUE;
                }
                if (i16 == 0 && i18 == 0) {
                    sTmpRect.set(sf2);
            ...
            if (!((fl & 512) == 0 || adjust2 == 2010 || win.inMultiWindowMode())) {
                df.top = -10000;
                df.left = -10000;
                df.bottom = 10000;
                df.right = 10000;
            ...
            adjustOppoWindowFrame(sf2, df, of, cf, dcf, vf, attrs2, displayFrames);
            int i20 = (!shouldUseOutsets(attrs2, fl) || win.inZoomWindowingMode()) ? i : 1;
            if (!isDefaultDisplay || i20 == 0) {
                str2 = str;
            } else {
            ...
            win.computeFrameLw();
            if (adjust2 == 2011 && win.isVisibleLw() && !win.getGivenInsetsPendingLw()) {
                offsetInputMethodWindowLw(windowState, displayFrames);
            }
            if (adjust2 == 2031 && win.isVisibleLw() && !win.getGivenInsetsPendingLw()) {
