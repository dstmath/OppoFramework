            ...
            try {
                if (element.equals(TAG_WEBVIEW_PROVIDER)) {
                    ...
                    if (packageName != null) {
                        ...
                        if (description != null) {
                            WebViewProviderInfo currentProvider = new WebViewProviderInfo(packageName, description, TemperatureProvider.SWITCH_ON.equals(parser.getAttributeValue(null, TAG_AVAILABILITY)), TemperatureProvider.SWITCH_ON.equals(parser.getAttributeValue(null, TAG_FALLBACK)), readSignatures(parser));
