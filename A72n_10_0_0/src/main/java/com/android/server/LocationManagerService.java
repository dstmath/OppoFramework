...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    public static final boolean USERDEBUG_TEL_PROP = (SystemProperties.getInt(TEL_DBG_PROP, 0) == 1 && "userdebug".equals(Build.TYPE));
    ...
    private IPswFastNetworkLocation mFastNetworkLocation = null;
    ...
    private IPswOppoGnssWhiteListProxy mGnssWhiteListProxy;
    ...
    private IPswLocationStatusMonitor mLocationStatusMonitor = null;
    @GuardedBy({"mLock"})
    private final LocationUsageLogger mLocationUsageLogger;
    private final LocationWorkHandler mLocationWorkHandler;
    ...
    private IPswNlpProxy mNlpProxy = null;
    private IPswGnssDuration mOppoGnssDuration;
    private IPswLbsRepairer mOppoLbsRepairer = null;
    private IPswLocationBlacklistUtil mOppoLocationBlacklistUtil = null;
    private IPswLocationStatistics mOppoLocationStatistics = null;
    ...
    static {
        boolean z = true;
        if (IS_USER_BUILD && !Log.isLoggable(TAG, 3) && !USERDEBUG_TEL_PROP) {
            z = false;
        }
        D = z;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v45, resolved type: android.app.AppOpsManager */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r1v18, types: [android.app.AppOpsManager$OnOpChangedListener, com.android.server.LocationManagerService$1] */
    ...
    private void initializeLocked() {
        ...
        this.mLocationStatusMonitor = PswServiceFactory.getInstance().getFeature(IPswLocationStatusMonitor.DEFAULT, new Object[0]);
        ...
        this.mLocationStatusMonitor.init(this.mContext);
                    ...
                    synchronized (LocationManagerService.this.mLock) {
                        ...
                        switch (c) {
                            ...
                            case 6:
                                ...
                                LocationManagerService.this.applyRequirementsLocked((LocationManagerService) "gps");
                                break;
                        }
                    }
                }
    ...
    private boolean checkLocationAccess(int pid, int uid, String packageName, int allowedResolutionLevel) {
        ...
        if (op >= 0) {
            ...
            if (this.mAppOps.checkOp(op, uid, packageName) != 0) {
                ...
                IPswLocationStatusMonitor iPswLocationStatusMonitor = this.mLocationStatusMonitor;
                if (iPswLocationStatusMonitor != null) {
                    iPswLocationStatusMonitor.recordBgPermissionDisable(packageName);
                }
                return !mtkCheckOpForCta(op, pid, uid, packageName, allowedResolutionLevel) ? false : false;
            }
        }
        return getAllowedResolutionLevel(pid, uid) >= allowedResolutionLevel;
    }
    ...
    private void applyRequirementsLocked(LocationProvider provider) {
        ...
        boolean z;
        IPswLocationStatusMonitor iPswLocationStatusMonitor;
                    ...
                    if (isCurrentProfileLocked(UserHandle.getUserId(record.mReceiver.mCallerIdentity.mUid))) {
                        if (!checkLocationAccess(record.mReceiver.mCallerIdentity.mPid, record.mReceiver.mCallerIdentity.mUid, record.mReceiver.mCallerIdentity.mPackageName, record.mReceiver.mAllowedResolutionLevel)) {
                            ...
                            if (!provider.isUseableLocked() || isBatterySaverDisablingLocation) {
                                ...
                                if (isSettingsExemptLocked(record)) {
                                    ...
                                    if ("network".equals(provider.getName())) {
                                        ...
                                        if (iPswLbsRepairer != null) {
                                            worksource4 = worksource5;
                                            if (iPswLbsRepairer.isForegroundActivity(this.mActivityManager.getPackageImportance(record.mReceiver.mCallerIdentity.mPackageName)) && !record.mReceiver.mCallerIdentity.mPackageName.equals(PackageManagerService.PLATFORM_PACKAGE_NAME)) {
                            ...
                            if (provider.getName().equalsIgnoreCase("gps")) {
                                ...
                                if (isBlocked) {
                                    IPswLbsRepairer iPswLbsRepairer2 = this.mOppoLbsRepairer;
                                    if (iPswLbsRepairer2 != null && iPswLbsRepairer2.isForegroundActivity(this.mActivityManager.getPackageImportance(record.mReceiver.mCallerIdentity.mPackageName))) {
                                ...
                                if (isBlocked) {
                                    IPswLocationStatusMonitor iPswLocationStatusMonitor2 = this.mLocationStatusMonitor;
                                    if (iPswLocationStatusMonitor2 != null) {
                                        iPswLocationStatusMonitor2.setGpsBackgroundFlag(checkPackageName, false);
                                        this.mLocationStatusMonitor.recordLocationBlocked(checkPackageName);
                                        isForegroundOnlyMode2 = isForegroundOnlyMode;
                                        it = it;
                                        shouldThrottleRequests2 = shouldThrottleRequests;
                                        identity2 = identity;
                                    ...
                                    IPswLocationStatusMonitor iPswLocationStatusMonitor3 = this.mLocationStatusMonitor;
                                    if (iPswLocationStatusMonitor3 != null) {
                                        iPswLocationStatusMonitor3.setGpsBackgroundFlag(checkPackageName, true);
                                    }
                                }
                            }
                            ...
                            if (!providerRequest.locationSettingsIgnored && !isThrottlingExemptLocked(record.mReceiver.mCallerIdentity)) {
                                ...
                                if (interval != locationRequest.getInterval()) {
                                    ...
                                    if ("gps".equals(provider) && (iPswLocationStatusMonitor = this.mLocationStatusMonitor) != null) {
                                        iPswLocationStatusMonitor.recordLocationIntervalChanged(record.mReceiver.mCallerIdentity.mPackageName);
                                    }
                                }
                            }
    ...
    public class UpdateRecord {
        ...
        private UpdateRecord(String provider, LocationRequest request, Receiver receiver) {
            ...
            PswServiceFactory.getInstance().getFeature(IPswGnssDiagnosticTool.DEFAULT, new Object[]{LocationManagerService.this.mContext}).incomingNewGpsUsingApp(provider, this.mReceiver.mCallerIdentity.mPackageName);
        }
        ...
        private void disposeLocked(boolean removeReceiver) {
            ...
            PswServiceFactory.getInstance().getFeature(IPswGnssDiagnosticTool.DEFAULT, new Object[]{LocationManagerService.this.mContext}).removingGpsUsingApp(this.mProvider, packageName);
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:5:0x0035 */
    /* JADX DEBUG: Multi-variable search result rejected for r28v0, resolved type: com.android.server.LocationManagerService */
    ...
    public void requestLocationUpdates(LocationRequest request, ILocationListener listener, PendingIntent intent, String packageName) {
        ...
        IOppoCommonFeature iOppoCommonFeature = IPswLbsCustomize.DEFAULT;
        ?? r4 = this.mContext;
        if (!((IPswLbsCustomize) instance.getFeature(iOppoCommonFeature, new Object[]{r4})).isForceGnssDisabled()) {
            OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0]).setAction(26, Binder.getCallingUid());
            Object obj2 = this.mLock;
            synchronized (obj2) {
                try {
                    PswServiceFactory instance2 = PswServiceFactory.getInstance();
                    IOppoCommonFeature iOppoCommonFeature2 = IPswLbsCustomize.DEFAULT;
                    r4 = this.mContext;
                    if (((IPswLbsCustomize) instance2.getFeature(iOppoCommonFeature2, new Object[]{r4})).isForceGnssDisabled()) {
                        try {
                        } catch (Throwable th2) {
                            th = th2;
                            obj = obj2;
                        ...
                        try {
                            ...
                            int allowedResolutionLevel = getCallerAllowedResolutionLevel();
                            if (this.mLocationStatusMonitor != null) {
                                try {
                                    IPswLocationStatusMonitor iPswLocationStatusMonitor = this.mLocationStatusMonitor;
                                    int minimumResolutionLevelForProviderUseLocked = getMinimumResolutionLevelForProviderUseLocked(request2.getProvider());
                                    iPswLocationStatusMonitor.recordPermissionNotGranted(allowedResolutionLevel, minimumResolutionLevelForProviderUseLocked, packageName + ", " + request2.getProvider());
                                } catch (Throwable th3) {
                                    th = th3;
                                    obj = obj2;
                                }
                            ...
                            PswServiceFactory instance3 = PswServiceFactory.getInstance();
                            IOppoCommonFeature iOppoCommonFeature3 = IPswLbsCustomize.DEFAULT;
                            r4 = this.mContext;
                            ((IPswLbsCustomize) instance3.getFeature(iOppoCommonFeature3, new Object[]{r4})).getAppInfoForTr("requestLocationUpdates()", request2.getProvider(), pid2, packageName);
                            long identity = Binder.clearCallingIdentity();
                            try {
    ...
    private void requestLocationUpdatesLocked(LocationRequest request, Receiver receiver, int pid, int uid, String packageName) {
        ...
        if (name != null) {
            ...
            if (!provider.isUseableLocked() && !isSettingsExemptLocked(record) && !provider.isNetworkWhiteList(packageName)) {
                ...
                IPswLocationStatusMonitor iPswLocationStatusMonitor = this.mLocationStatusMonitor;
                if (iPswLocationStatusMonitor != null) {
                    iPswLocationStatusMonitor.recordLocationDisable(name, packageName);
                }
            }
    ...
    public boolean isLocationEnabledForUser(int userId) {
        ...
        long identity = Binder.clearCallingIdentity();
        try {
            if (this.mOppoLocationBlacklistUtil != null) {
                return this.mOppoLocationBlacklistUtil.getOppoLocationMode(userId);
            }
            boolean z = false;
    ...
    private void handleLocationChangedLocked(Location location, LocationProvider provider) {
        ...
        if (this.mProviders.contains(provider)) {
            ...
            if (lastLocationCoarseInterval2 == null) {
                lastLocationCoarseInterval2 = new Location(location);
                if (provider.isUseableLocked()) {
                    this.mLastLocationCoarseInterval.put(provider.getName(), lastLocationCoarseInterval2);
                }
            }
            long timeDiffNanos2 = location.getElapsedRealtimeNanos() - lastLocationCoarseInterval2.getElapsedRealtimeNanos();
            if (timeDiffNanos2 > 600000000000L) {
                lastLocationCoarseInterval2.set(location);
            }
            Location noGPSLocation2 = lastLocationCoarseInterval2.getExtraLocation("noGPSLocation");
            ...
            if (records2.size() != 0) {
                ...
                if (noGPSLocation2 != null) {
                    ...
                    coarseLocation = this.mLocationFudger.getOrCreate(lastLocationCoarseInterval2);
                }
                ArrayList<Receiver> deadReceivers = null;
