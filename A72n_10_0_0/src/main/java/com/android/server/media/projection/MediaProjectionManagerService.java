...
public final class MediaProjectionManagerService extends SystemService implements Watchdog.Monitor {
    ...
    private boolean isValidMediaProjection(IBinder token) {
        synchronized (this.mLock) {
            ...
            if (this.mProjectionToken != null && this.mOppoProjectionToken != null) {
                if (this.mProjectionToken.equals(token) || this.mOppoProjectionToken.equals(token)) {
                    z = true;
                }
                return z;
                ...
                return this.mOppoProjectionToken.equals(token);
            }
        }
    }
    ...
    private MediaProjectionInfo getActiveProjectionInfo() {
        synchronized (this.mLock) {
            if (this.mOppoProjectionGrant != null) {
                return this.mOppoProjectionGrant.getProjectionInfo();
