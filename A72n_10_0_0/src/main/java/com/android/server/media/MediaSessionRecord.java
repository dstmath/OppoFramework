...
public class MediaSessionRecord implements IBinder.DeathRecipient {
    private static final boolean DEBUG = (Log.isLoggable(TAG, 3) || "eng".equals(Build.TYPE) || "userdebug".equals(Build.TYPE));
    ...
    public void dump(PrintWriter pw, String prefix) {
        pw.println(prefix + this.mTag + StringUtils.SPACE + this);
