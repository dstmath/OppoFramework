...
public class ColorDeepSleepHelper implements IColorDeepSleepHelper {
    ...
    private Runnable deepSleepTask = new Runnable() {
        ...
        synchronized (this) {
            if (!this.mIsReady) {
                ...
                ctx.getContentResolver().registerContentObserver(Settings.System.getUriFor(STR_DEEPSLEEP_STATUS), false, new ContentObserver(handler) {
                    ...
                    public void onChange(boolean selfChange, Uri uri) {
                        ColorDeepSleepHelper.this.mDeepSleepStatus = Settings.System.getInt(ctx.getContentResolver(), ColorDeepSleepHelper.STR_DEEPSLEEP_STATUS, 0);
                        if (1 == ColorDeepSleepHelper.this.mDeepSleepStatus) {
                            ColorDeepSleepHelper.this.mNetWorkTypeBak = Settings.System.getInt(ctx.getContentResolver(), ColorDeepSleepHelper.STR_DEEPSLEEP_NET_TYPE, 0);
    ...
    public boolean filterDeepSleepAlarm(String pkg, String tag) {
        ...
        if (net == 0 || !OppoFeatureCache.get(IColorAlarmManagerHelper.DEFAULT).isMatchDeepSleepRule(pkg, tag, net)) {
            return false;
        }
        return true;
    }
    ...
    private int getNetworkHistory(Context ctx) {
        try {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void parseDeepSleepStatusLocked(int history) {
        if (history != 0) {
            boolean z = true;
            if (this.mInfo == null) {
                if (history != 2) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void resumeDelayedForNetworkAlarmsLocked() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void releaseWakelockForDeepSleep() {
        if (this.mDeepSleepWakeLock.isHeld()) {
