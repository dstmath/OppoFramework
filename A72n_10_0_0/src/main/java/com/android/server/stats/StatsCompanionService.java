...
public class StatsCompanionService extends IStatsCompanionService.Stub {
    ...
    private void pullProcessMemoryHighWaterMark(int tagId, long elapsedNanos, long wallClockNanos, List<StatsLogEventWrapper> pulledData) {
        ...
        SystemProperties.set("sys.rss_hwm_reset.on", NoFocusWindow.HUNG_CONFIG_ENABLE);
    }
    ...
    public StatsLogEventWrapper[] pullData(int tagId) {
        ...
        switch (tagId) {
            ...
            case 10018:
            case 10019:
            case ColorNotificationListenerService.REASON_COLOROS_FORCESTOP /* 10020 */:
            case 10030:
            case 10038:
            case 10043:
            case 10045:
            ...
            case 10017:
                ...
                break;
            case ColorNotificationListenerService.REASON_COLOROS_BPMSUSPEND /* 10021 */:
