...
public class SyncOperation {
    ...
    public PersistableBundle toJobInfoExtras() {
        ...
        jobInfoExtras.putString(IColorAppStartupManager.TYPE_PROVIDER, this.target.provider);
    ...
    static SyncOperation maybeCreateFromJobExtras(PersistableBundle jobExtras) {
        ...
        String provider = jobExtras.getString(IColorAppStartupManager.TYPE_PROVIDER);
        ...
        int reason2 = jobExtras.getInt(PhoneWindowManager.SYSTEM_DIALOG_REASON_KEY, Integer.MAX_VALUE);
