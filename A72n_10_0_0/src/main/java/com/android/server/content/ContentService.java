...
public final class ContentService extends IContentService.Stub {
                ...
                synchronized (observerNode2) {
                    try {
                        ...
                        try {
                            ...
                            pw.println(counts[1]);
                            sObserverDeathDispatcher.dump(pw, StringUtils.SPACE);
    ...
    public void registerContentObserver(Uri uri, boolean notifyForDescendants, IContentObserver observer, int userHandle, int targetSdkVersion) {
        ...
        int userHandle3 = handleIncomingUser(uri, pid, uid, 1, true, userHandle);
        String msg = ((ActivityManagerInternal) LocalServices.getService(ActivityManagerInternal.class)).checkContentProviderAccess(uri.getAuthority(), userHandle3);
        if (OppoFeatureCache.get(IColorMultiAppManager.DEFAULT).shouldChangeUserHandle(uid, msg)) {
            userHandle2 = -1;
        } else {
            if (msg != null) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00fe, code lost:
        if (r13.get(r14).observer.asBinder() == r0) goto L_0x0100;
     */
        ...
        try {
            ...
            if (request.isPeriodic()) {
                try {
                    ...
                    getSyncManager().updateOrAddPeriodicSync(info, runAtTime2, flextime, extras);
                    ...
                    if (pkgName != null) {
                        ...
                        syncMap.put("Frequency", Long.toString(runAtTime2));
    ...
    public String[] getSyncAdapterPackagesForAuthorityAsUser(String authority, int userId) {
        ...
        try {
            ...
            String[] syncAdapterPackagesForAuthorityAsUser = syncManager.getSyncAdapterPackagesForAuthorityAsUser(authority, userId);
            restoreCallingIdentity(identityToken);
        ...
        if (account == null) {
            ...
            try {
                ...
                if (pkgName != null) {
                    ...
                    syncMap.put("Frequency", Long.toString(pollFrequency2));
                    OppoStatistics.onCommon(this.mContext, "addPeriodicSync", "PeriodicSyncEvent", syncMap, false);
                }
            } finally {
                restoreCallingIdentity(identityToken);
    ...
    public static final class ObserverNode {
        ...
        private void addObserverLocked(Uri uri, int index, IContentObserver observer, boolean notifyForDescendants, Object observersLock, int uid, int pid, int userHandle) {
            if (index == countUriSegments(uri)) {
                ...
                while (iter.hasNext()) {
                    if (iter.next().observer.asBinder() == observer.asBinder()) {
