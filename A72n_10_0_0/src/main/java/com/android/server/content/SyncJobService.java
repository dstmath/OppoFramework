...
public class SyncJobService extends JobService {
    ...
    public void callJobFinishedInner(int jobId, boolean needsReschedule, String why) {
        synchronized (sLock) {
            ...
            sLogger.log("callJobFinished()", " jobid=", Integer.valueOf(jobId), " needsReschedule=", Boolean.valueOf(needsReschedule), StringUtils.SPACE, sLogger.jobParametersToString(params), " why=", why);
            if (params != null) {
