...
public class OppoSysStateManager {
    ...
    private boolean isSuperPowersaveOn = false;
    ...
    private ContentObserver mSPowersaveObserver = new ContentObserver(new Handler()) {
        /* class com.android.server.coloros.OppoSysStateManager.AnonymousClass3 */

        public void onChange(boolean selfChange) {
            OppoSysStateManager oppoSysStateManager = OppoSysStateManager.this;
            boolean z = false;
            if (Settings.System.getIntForUser(oppoSysStateManager.mContext.getContentResolver(), OppoSysStateManager.URI_SUPER_POWER_SAVE_STATE, 0, 0) == 1) {
                z = true;
            }
            oppoSysStateManager.isSuperPowersaveOn = z;
        }
    };
    ...
    public List<String> getOppoGuardElfWhiteList() {
        synchronized (this.mListOppoGuardElfWhitelist) {
            ...
            return new ArrayList(this.mListOppoGuardElfWhitelist);
        }
    }
    ...
    public List<String> getOppoGuardElfPlayback() {
        synchronized (this.mListOppoGuardElfPlayback) {
            ...
            return new ArrayList(this.mListOppoGuardElfPlayback);
        }
    }
    ...
    public List<String> getOppoGuardElfNavigation() {
        synchronized (this.mListOppoGuardElfNavigation) {
            ...
            return new ArrayList(this.mListOppoGuardElfNavigation);
        }
    }
    ...
    private boolean initIPackageManager() {
        if (this.mContext != null && this.mPkm == null) {
            this.mPkm = IPackageManager.Stub.asInterface(ServiceManager.getService(com.android.server.pm.Settings.ATTR_PACKAGE));
        }
    ...
    private void registerSuperPowersaveObserver() {
        boolean z = true;
        if (Settings.System.getIntForUser(this.mContext.getContentResolver(), URI_SUPER_POWER_SAVE_STATE, 0, 0) != 1) {
            z = false;
        }
        this.isSuperPowersaveOn = z;
    ...
    public boolean isSuperPowersaveOn() {
        return this.isSuperPowersaveOn;
    }
}
