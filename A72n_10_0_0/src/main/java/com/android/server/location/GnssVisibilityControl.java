...
public class GnssVisibilityControl {
    ...
    private static final String OPPO_NFW_PROXY_APP = "com.coloros.locationproxy";
    ...
    GnssVisibilityControl(Context context, Looper looper, GpsNetInitiatedHandler niHandler) {
        ...
        runOnHandler(new Runnable() {
            ...
            public final void run() {
                GnssVisibilityControl.m17lambda$FLGfeDaxF8J3CE9mTcOXh5j6ow(GnssVisibilityControl.this);
            }
        });
    }
    ...
    public void onConfigurationUpdated(GnssConfiguration configuration) {
        ...
        if (!nfwLocationAccessProxyApps.isEmpty()) {
            if (nfwLocationAccessProxyApps.contains(OPPO_NFW_PROXY_APP)) {
                SystemProperties.set("persist.sys.oppo.nfw.enable", NoFocusWindow.HUNG_CONFIG_ENABLE);
            }
            runOnHandler(new Runnable(nfwLocationAccessProxyApps) {
        ...
        List<String> oppoNfwLocationApps = new ArrayList<>();
        oppoNfwLocationApps.add(OPPO_NFW_PROXY_APP);
        SystemProperties.set("persist.sys.oppo.nfw.enable", NoFocusWindow.HUNG_CONFIG_ENABLE);
        runOnHandler(new Runnable(oppoNfwLocationApps) {
            /* class com.android.server.location.$$Lambda$GnssVisibilityControl$oq0nxrZYl6F22p_XqlL6xkoa_z8 */
            private final /* synthetic */ List f$1;
            ...
            public final void run() {
                GnssVisibilityControl.this.lambda$onConfigurationUpdated$5$GnssVisibilityControl(this.f$1);
            }
        });
    }
    ...
    public void lambda$onConfigurationUpdated$5$GnssVisibilityControl(List<String> nfwLocationAccessProxyApps) {
    ...
    private void showLocationIcon(ProxyAppState proxyAppState, NfwNotification nfwNotification, int uid, String proxyAppPkgName) {
        ...
        if (!this.mHandler.postDelayed(new Runnable(proxyAppPkgName) {
            /* class com.android.server.location.$$Lambda$GnssVisibilityControl$l0iJLjv4jxQfdR1suAGrOhlvKU */
            private final /* synthetic */ String f$1;
            ...
            public final void run() {
                GnssVisibilityControl.this.lambda$showLocationIcon$6$GnssVisibilityControl(this.f$1);
            }
        }, proxyAppState, 5000)) {
    ...
    public void lambda$showLocationIcon$6$GnssVisibilityControl(String proxyAppPkgName) {
        ApplicationInfo proxyAppInfo = getProxyAppInfo(proxyAppPkgName);
        if (proxyAppInfo != null) {
    ...
    private static Notification createEmergencyLocationUserNotification(Context context) {
        String firstLineText = context.getString(17040070);
        String secondLineText = context.getString(17040052);
        return new Notification.Builder(context, SystemNotificationChannels.NETWORK_ALERTS).setSmallIcon(17303561).setWhen(0).setOngoing(true).setAutoCancel(true).setColor(context.getColor(17170460)).setDefaults(0).setTicker(firstLineText + " (" + secondLineText + ")").setContentTitle(firstLineText).setContentText(secondLineText).build();
    }
    ...
    private Runnable runEventAndReleaseWakeLock(Runnable event) {
        return new Runnable(event) {
            /* class com.android.server.location.$$Lambda$GnssVisibilityControl$FY330Nqkvcde9xKEUtc2n3fVMzQ */
            ...
            public final void run() {
                GnssVisibilityControl.this.lambda$runEventAndReleaseWakeLock$7$GnssVisibilityControl(this.f$1);
            }
        };
    }

    public /* synthetic */ void lambda$runEventAndReleaseWakeLock$7$GnssVisibilityControl(Runnable event) {
        try {
            event.run();
        } finally {
            this.mWakeLock.release();
