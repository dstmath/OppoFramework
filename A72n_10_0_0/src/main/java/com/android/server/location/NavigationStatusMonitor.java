...
public class NavigationStatusMonitor extends OppoNavigationStatusMonitor implements OppoMotionDetector.DeviceIdleCallback {
    ...
    private GpsStatus.Listener mGpsStatusListener = new GpsStatus.Listener() {
        ...
        public void onGpsStatusChanged(int event) {
            ...
            navigationStatusMonitor.mGpsStatus = navigationStatusMonitor.mLocMgr.getGpsStatus(null);
        }
    };
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case NavigationStatusMonitor.MSG_START_MONITOR /* 101 */:
                    ...
                    return;
                case NavigationStatusMonitor.MSG_STOP_MONITOR /* 102 */:
                    removeMessages(NavigationStatusMonitor.MSG_DOING_MONITOR);
                    return;
                case NavigationStatusMonitor.MSG_DOING_MONITOR /* 103 */:
        ...
        public void onLocationChanged(Location location) {
            if (location.hasSpeed()) {
                synchronized (NavigationStatusMonitor.mLock) {
                    NavigationStatusMonitor.this.mSpeed = (float) (((double) location.getSpeed()) * 3.6d);
                }
            }
        }
