...
public class LocationRequestStatistics {
    ...
    public static class PackageStatistics extends OppoBasePackageStatistics {
        ...
        private void stopRequesting() {
            ...
            if (this.mNumActiveRequests == 0) {
                ...
                this.mLastStopElapsedTimeMs = SystemClock.elapsedRealtime();
                this.mLastDurationMs = this.mLastStopElapsedTimeMs - this.mLastActivitationElapsedTimeMs;
                this.mTotalDurationMs += this.mLastDurationMs;
                updateForeground(false);
            }
        }

        @Override // com.android.server.location.OppoBasePackageStatistics
        public long getLastDurationMs() {
            long currentDurationMs = this.mLastDurationMs;
            if (this.mNumActiveRequests > 0) {
                return SystemClock.elapsedRealtime() - this.mLastActivitationElapsedTimeMs;
            }
