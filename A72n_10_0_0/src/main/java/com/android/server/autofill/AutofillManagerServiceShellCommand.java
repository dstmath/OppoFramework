...
public final class AutofillManagerServiceShellCommand extends ShellCommand {
    ...
    private int setLogLevel(PrintWriter pw) {
        ...
        if (hashCode != 109935) {
            ...
            } else if (lowerCase.equals(HealthState.DEBUG)) {
                z = true;
                if (z) {
                }
            }
    ...
    private int getFullScreenMode(PrintWriter pw) {
        ...
        if (mode == null) {
            ...
            pw.println(TemperatureProvider.SWITCH_ON);
            return 0;
        } else {
            pw.println(TemperatureProvider.SWITCH_OFF);
            return 0;
        }
    }
    ...
    private int setFullScreenMode(PrintWriter pw) {
        ...
        if (hashCode != 3569038) {
            ...
            } else if (lowerCase.equals(TemperatureProvider.SWITCH_OFF)) {
                z = true;
                if (z) {
                }
            }
        } else if (lowerCase.equals(TemperatureProvider.SWITCH_ON)) {
            z = false;
            if (z) {
            }
        }
    ...
    private int setBindInstantService(PrintWriter pw) {
        ...
        int hashCode = lowerCase.hashCode();
        if (hashCode != 3569038) {
            if (hashCode == 97196323 && lowerCase.equals(TemperatureProvider.SWITCH_OFF)) {
                z = true;
                if (!z) {
