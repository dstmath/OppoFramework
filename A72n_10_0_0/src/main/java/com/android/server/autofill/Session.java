    ...
    private final IAssistDataReceiver mAssistReceiver = new IAssistDataReceiver.Stub() {
        ...
        public void onHandleAssistData(Bundle resultData) throws RemoteException {
            ...
            if (Session.this.mRemoteFillService == null) {
                ...
                session.wtf(null, "onHandleAssistData() called without a remote service. mForAugmentedAutofillOnly: %s", new Object[]{Boolean.valueOf(session.mForAugmentedAutofillOnly)});
                return;
            }
        ...
        while (i < viewsSize) {
            try {
                ...
                while (j < strArr.length) {
                    ...
                    if (score > OppoBrightUtils.MIN_LUX_LIMITI) {
        ...
        if (saveInfo == null) {
            ...
            if (requiredIds2 != null) {
                ...
                while (true) {
                    ...
                    AutofillId id2 = requiredIds2[i3];
                    if (id2 == null) {
                    ...
                    if (datasets != null) {
                        ...
                        while (i4 < datasets.size()) {
                            ...
                            while (j < savableIds.size()) {
                                AutofillId id4 = savableIds.valueAt(j);
