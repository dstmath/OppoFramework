...
public final class FillUi {
    ...
    /* JADX INFO: Multiple debug info for r5v6 'filterPattern'  java.util.regex.Pattern: [D('presentation' android.widget.RemoteViews), D('filterPattern' java.util.regex.Pattern)] */
    FillUi(Context context, FillResponse response, AutofillId focusedViewId, String filterText, OverlayControl overlayControl, CharSequence serviceLabel, Drawable serviceIcon, boolean nightMode, Callback callback) {
        ...
        ImageView iconView = (ImageView) decor.findViewById(16908744);
        if (iconView != null) {
        ...
        if (response.getAuthentication() != null) {
            ...
            if (footerPresentation2 != null) {
                LinearLayout footerContainer2 = (LinearLayout) decor.findViewById(16908742);
