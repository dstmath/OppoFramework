...
public class EnvelopeDetectorController {
    ...
    private int mEnvelopeSoundStatus;
    ...
    private ContentObserver mSoundEnableObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean b) {
            if (EnvelopeDetectorController.this.mContext != null) {
                EnvelopeDetectorController envelopeDetectorController = EnvelopeDetectorController.this;
                envelopeDetectorController.mEnvelopeSoundStatus = Settings.Secure.getIntForUser(envelopeDetectorController.mContext.getContentResolver(), EnvelopeDetectorController.ENVELOPE_NOTICE_SOUND_ENABLE, 1, -2);
            }
        }
    };
    ...
    private void setTag(Notification notification) {
    ...
    /* access modifiers changed from: private */
    public class QqDetector extends Detector {
        private QqDetector() {
            super();
        }
