...
public class FingerprintPowerManager {
    ...
    public void blockScreenOn(String wakeUpreason) {
        ...
        calculateTime(HealthState.BLOCKSCREENON, SystemClock.uptimeMillis() - startTime);
    }
    ...
    public void openAllFramesDrawForKeyguard() {
        SystemProperties.set(PROP_NAME_OPEN_ALL_FRAMES, NoFocusWindow.HUNG_CONFIG_ENABLE);
