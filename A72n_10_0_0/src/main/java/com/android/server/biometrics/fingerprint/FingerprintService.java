...
public class FingerprintService extends BiometricServiceBase implements FingerprintSwitchHelper.ISwitchUpdateListener {
    ...
    private boolean isCurrentSreenOff = true;
    private boolean isTouchDownState = false;
    ...
    private IBiometricsFingerprintClientCallback mDaemonCallback = new IBiometricsFingerprintClientCallback.Stub() {
        ...
        public void onTouchDown(final long deviceId) {
            FingerprintService.this.mTouching = true;
            ...
            FingerprintService.this.isTouchDownState = true;
            if (!FingerprintService.this.mOpticalFingerprintSupport || FingerprintService.this.mWindowMgr == null || FingerprintService.this.mWindowMgr.getDefaultDisplay() == null || FingerprintService.this.mWindowMgr.getDefaultDisplay().getState() != 1) {
                if (FingerprintService.this.mOpticalFingerprintIsShowing) {
                    if (FingerprintService.this.mLCDHighLightFileExist) {
                        ...
                        FingerprintService.this.notifyDispFingerLayer(0);
                    }
        ...
        public void onTouchUp(final long deviceId) {
            FingerprintService.this.mTouching = false;
            FingerprintService.this.isTouchDownState = false;
            if (FingerprintService.this.mOpticalFingerprintIsShowing) {
                if (FingerprintService.this.mLCDHighLightFileExist) {
                    FingerprintService.this.writeLcdHighLightPath(0);
                } else {
                    FingerprintService.this.notifyDispFingerLayer(1);
                }
    ...
    private IFingerprintCommandCallback mFingerprintCommandCallback = null;
    ...
    private IUnLocker mIUnLocker = new IUnLocker() {
        ...
        public void onScreenOff(boolean isOff) {
            FingerprintService.this.isCurrentSreenOff = isOff;
    ...
    private boolean mLCDHighLightFileExist = false;
    ...
    private final SparseIntArray mMistakeTouchFailAttempts = new SparseIntArray();
    private IOpticalFingerprintEventListener mOpticalFingerprintEventListener;
    private boolean mOpticalFingerprintIsHighLight = false;
    private boolean mOpticalFingerprintIsShowing = false;
    private IOpticalFingerprintListener mOpticalFingerprintListener = null;
    ...
    private boolean mSideFingerprintSupport = false;
    private boolean mSystemReady = false;
    private ArrayList<JSONObject> mTagList = new ArrayList<>();
    ...
    private boolean isAppClientInTopPackage() {
    ...
    public class IfingerprintHalService extends IFingerprintHalService.Stub {
    ...
    /* access modifiers changed from: private */
    public final class FingerprintAuthClient extends BiometricServiceBase.AuthenticationClientImpl {
        private long mOpId;
    ...
    private final class FingerprintServiceWrapper extends IFingerprintService.Stub {
        ...
        public void authenticate(IBinder token, long opId, int groupId, IFingerprintServiceReceiver receiver, int flags, String opPackageName) {
            ...
            if (!opPackageName.equals("com.coloros.safecenter") && FingerprintService.this.mSideFingerprintSupport) {
        ...
        public byte[] alipayInvokeCommand(byte[] param) {
            if (FingerprintService.this.mFingerprintPay == null) {
                FingerprintService fingerprintService = FingerprintService.this;
                fingerprintService.mFingerprintPay = fingerprintService.getAliPayService();
            }
            if (FingerprintService.this.mFingerprintPay == null) {
        ...
        public int regsiterFingerprintCmdCallback(IFingerprintCommandCallback callback) {
            ...
            FingerprintService.this.mFingerprintCommandCallback = callback;
            return 0;
        }
        ...
        public int unregsiterFingerprintCmdCallback(IFingerprintCommandCallback callback) {
            ...
            FingerprintService.this.mFingerprintCommandCallback = null;
            return 0;
        }
        ...
        public int regsiterOpticalFingerprintListener(IOpticalFingerprintListener listener) {
            ...
            FingerprintService.this.mOpticalFingerprintListener = listener;
            return 0;
        }
        ...
        public int unregsiterOpticalFingerprintListener() {
            ...
            FingerprintService.this.mOpticalFingerprintListener = null;
            return 0;
        }
    }
    ...
    public class ServiceListenerImpl implements BiometricServiceBase.ServiceListener {
        ...
        public void onAuthenticationFailed(long deviceId) throws RemoteException {
            if (this.mFingerprintServiceReceiver != null) {
                ClientMonitor client = FingerprintService.this.getCurrentClient();
                if (FingerprintService.this.mOpticalFingerprintSupport || !FingerprintService.this.mIsNearState || !FingerprintService.this.isCurrentSreenOff || FingerprintService.this.mMistakeTouchFailAttempts.get(ActivityManager.getCurrentUser(), 0) <= 3 || client == null || !FingerprintService.this.isKeyguard(client.getOwnerString())) {
                    this.mFingerprintServiceReceiver.onAuthenticationFailed(deviceId);
                    return;
                }
                this.mFingerprintServiceReceiver.onError(deviceId, 17, 0);
                LogUtil.d("FingerprintService", "onAuthenticationFailed not send to keyguard when NearState and screenoff");
            }
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: com.android.server.biometrics.fingerprint.FingerprintService */
    ...
    private void resetFailedAttemptsForUser(boolean clearAttemptCounter, int userId) {
        ...
        if (!this.mOpticalFingerprintSupport) {
            this.mMistakeTouchFailAttempts.put(userId, 0);
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isFingerprintClient(String packageName) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void writeLcdHighLightPath(final int value) {
        if (this.mOpticalFingerprintSupport) {
            this.mHandlerSub.post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (value == 1) {
                            FingerprintService.this.mOpticalFingerprintIsHighLight = true;
                        } else {
                            FingerprintService.this.mOpticalFingerprintIsHighLight = false;
                        }
                        try {
                            bufWriter2.close();
                        } catch (IOException e) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int notifyDispFingerLayer(int value) {
        int result;
        if (!this.mOpticalFingerprintSupport) {
        ...
        try {
            IBinder flinger = ServiceManager.getService(OppoLightsService.SURFACE_FLINGER);
            if (flinger != null) {
    ...
    public String codeToString(int operationCode) {
        ...
        switch (operationCode) {
            ...
            case OPERATION_PAUSE_ENROLL /* 264 */:
    ...
    public void handleAuthenticated(long deviceId, int fingerId, int groupId, ArrayList<Byte> tokenByte) {
        ...
        if (client != null && (client instanceof AuthenticationClient)) {
            ...
            if (this.mUnlockController == null || !isKeyguard(client.getOwnerString())) {
                ...
                if (!this.mOpticalFingerprintSupport && this.mIsNearState && this.isCurrentSreenOff) {
                    if (fingerId == 0) {
                        SparseIntArray sparseIntArray = this.mMistakeTouchFailAttempts;
                        sparseIntArray.put(groupId, sparseIntArray.get(groupId, 0) + 1);
                    }
                    LogUtil.d("FingerprintService", "handleAuthenticated mMistakeTouchFailAttempts = " + this.mMistakeTouchFailAttempts.get(groupId, 0));
                    if (this.mMistakeTouchFailAttempts.get(groupId, 0) > 3 && fingerId != 0) {
                        this.mUnlockController.dispatchAuthenticated(new Fingerprint("", groupId, 0, deviceId), tokenByte);
                        cancelAuthenticationInternal(client.getToken(), "android_for_anti_touch");
                        return;
                    }
                }
    ...
    /* access modifiers changed from: protected */
    public abstract class FingerprintEnrollClient extends BiometricServiceBase.EnrollClientImpl {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void startSetFingerKeymode(IBinder token, int groupId, boolean restricted, int enable) {
        IBiometricsFingerprint daemon = getFingerprintDaemon();
        if (daemon == null) {
