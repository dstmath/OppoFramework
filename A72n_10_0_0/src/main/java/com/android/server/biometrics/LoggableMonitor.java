...
public abstract class LoggableMonitor {
    ...
    public final void logOnAcquired(Context context, int acquiredInfo, int vendorCode, int targetUserId) {
        ...
        Slog.v(TAG, "Acquired! Modality: " + statsModality() + ", User: " + targetUserId + ", IsCrypto: " + isCryptoOperation() + ", Action: " + statsAction() + ", Client: " + statsClient() + ", AcquiredInfo: " + acquiredInfo + ", VendorCode: " + vendorCode);
    ...
    public final void logOnError(Context context, int error, int vendorCode, int targetUserId) {
        Slog.v(TAG, "Error! Modality: " + statsModality() + ", User: " + targetUserId + ", IsCrypto: " + isCryptoOperation() + ", Action: " + statsAction() + ", Client: " + statsClient() + ", Error: " + error + ", VendorCode: " + vendorCode);
    ...
    public final void logOnAuthenticated(Context context, boolean authenticated, boolean requireConfirmation, int targetUserId, boolean isBiometricPrompt) {
        ...
        Slog.v(TAG, "Authenticated! Modality: " + statsModality() + ", User: " + targetUserId + ", IsCrypto: " + isCryptoOperation() + ", Client: " + statsClient() + ", RequireConfirmation: " + requireConfirmation + ", State: " + authState + ", Latency: " + latency);
    ...
    public final void logOnEnrolled(int targetUserId, long latency, boolean enrollSuccessful) {
        Slog.v(TAG, "Enrolled! Modality: " + statsModality() + ", User: " + targetUserId + ", Client: " + statsClient() + ", Latency: " + latency + ", Success: " + enrollSuccessful);
