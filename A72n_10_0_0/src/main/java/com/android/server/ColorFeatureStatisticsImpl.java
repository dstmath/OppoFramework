...
public class ColorFeatureStatisticsImpl extends ColorFeatureStatistics {
    ...
    private int FINISH_EXECUTION;
    private String METHOD_NAME;
    private int START_EXECUTION;
    ...
    public ColorFeatureStatisticsImpl() {
        ...
        this.TOTAL_COUNT = ColorResourcePreloadDatabaseHelper.PRELOAD_COLUMN_TOTAL_COUNT;
    ...
    private void recordInfo(int m, String feature, String method, long time) {
        long[] tmpInfo;
