...
public class MtkConnectivityService extends ConnectivityService {
    ...
    private static boolean sIsAutoTethering = SystemProperties.getBoolean("persist.vendor.net.auto.tethering", false);
    ...
    private OppoDualWifiSta2CaptivePortalControl mDualWifiSta2CaptivePortalControl;
    ...
    public static class LegacyTypeTracker {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x003c, code lost:
            com.android.server.MtkConnectivityService.log("Other network available for type " + r6 + ", sending connected broadcast");
            r1 = r0.get(0);
    ...
    protected MtkConnectivityService(Context context, INetworkManagementService netManager, INetworkStatsService statsService, INetworkPolicyManager policyManager, IDnsResolver dnsresolver, IpConnectivityLog logger, INetd netd) {
        ...
        String[] naStrings2 = context.getResources().getStringArray(17236107);
    ...
    public class NetworkStateTrackerHandler extends Handler {
        ...
        public NetworkStateTrackerHandler(Looper looper) {
            super(looper);
            MtkConnectivityService.this = r1;
        }
        ...
        private boolean maybeHandleNetworkMonitorMessage(Message msg) {
            ...
            if (i != MtkConnectivityService.EVENT_NOTIFY_PRIVATE_DNS_STATUS) {
                int i2 = 2;
                switch (i) {
                    case MtkConnectivityService.EVENT_NETWORK_TESTED /* 41 */:
                        ...
                        break;
                    case MtkConnectivityService.EVENT_PRIVATE_DNS_CONFIG_RESOLVED /* 42 */:
                        ...
                        break;
                    case MtkConnectivityService.EVENT_PROVISIONING_NOTIFICATION /* 43 */:
                        int netId = msg.arg2;
                ...
                OppoConnectivityServiceHelper oppoConnectivityServiceHelper = MtkConnectivityService.this.mCsHelper;
                int i3 = msg.arg1;
                if (msg.arg2 > 0) {
                    z = true;
                }
                oppoConnectivityServiceHelper.handleNotifyPrivateDnsStatus(i3, z, nai4, MtkConnectivityService.this.mDnsManager);
            }
            return true;
        }
    ...
    public class NetworkMonitorCallbacks extends INetworkMonitorCallbacks.Stub {
        ...
        public void notifyNetworkPrepareCaptive(int testResult, String redirectUrl, boolean isDualWifiSta2) {
            if (isDualWifiSta2) {
                ...
                OppoAutoConCaptivePortalControl oppoAutoConCaptivePortalControl = MtkConnectivityService.this.mAutoConCaptivePortalControl;
                NetworkAgentInfo networkAgentInfoForNetId = MtkConnectivityService.this.getNetworkAgentInfoForNetId(this.mNetId);
                OppoAutoConCaptivePortalControl unused = MtkConnectivityService.this.mAutoConCaptivePortalControl;
                oppoAutoConCaptivePortalControl.checkNetworkTestStatus(networkAgentInfoForNetId, 1, redirectUrlBundle2);
            }
        }
        ...
        public void notifyNetworkShowPortal(int testResult, String redirectUrl, boolean isDualWifiSta2) {
            if (isDualWifiSta2) {
                ...
                NetworkAgentInfo networkAgentInfoForNetId = MtkConnectivityService.this.getNetworkAgentInfoForNetId(this.mNetId);
                OppoAutoConCaptivePortalControl unused = MtkConnectivityService.this.mAutoConCaptivePortalControl;
                oppoAutoConCaptivePortalControl.checkNetworkTestStatus(networkAgentInfoForNetId, 2, redirectUrlBundle2);
            }
        }
    ...
    public /* synthetic */ void lambda$startCaptivePortalAppInternal$4$MtkConnectivityService(Intent appIntent) {
    ...
    /* renamed from: com.android.server.MtkConnectivityService$9 */
            ...
            if (i != MtkConnectivityService.EVENT_CLEAR_NET_TRANSITION_WAKELOCK) {
                if (i == MtkConnectivityService.EVENT_APPLY_GLOBAL_HTTP_PROXY) {
                    ...
                    if (i == 100) {
                        ...
                        networkAgent.handleRegisterNetworkRequest(new NetworkRequestInfo(null, ((MtkConnectivityService) networkAgent).mDefaultRequest, new Binder()));
                    } else if (i != MtkConnectivityService.EVENT_NOTIFY_NETWORK_CONNECTED) {
                        switch (i) {
                            case MtkConnectivityService.EVENT_PROXY_HAS_CHANGED /* 16 */:
                                MtkConnectivityService.this.handleApplyDefaultProxy((ProxyInfo) msg.obj);
                                return;
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_FACTORY /* 17 */:
                                MtkConnectivityService.this.handleRegisterNetworkFactory((NetworkFactoryInfo) msg.obj);
                                return;
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_AGENT /* 18 */:
                                ...
                                return;
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_REQUEST /* 19 */:
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_LISTENER /* 21 */:
                            ...
                            case 20:
                                ...
                                return;
                            case MtkConnectivityService.EVENT_RELEASE_NETWORK_REQUEST /* 22 */:
                                MtkConnectivityService.this.handleReleaseNetworkRequest((NetworkRequest) msg.obj, msg.arg1, false);
                                return;
                            case MtkConnectivityService.EVENT_UNREGISTER_NETWORK_FACTORY /* 23 */:
                                MtkConnectivityService.this.handleUnregisterNetworkFactory((Messenger) msg.obj);
                                return;
                            case MtkConnectivityService.EVENT_EXPIRE_NET_TRANSITION_WAKELOCK /* 24 */:
                                break;
                            case MtkConnectivityService.EVENT_SYSTEM_READY /* 25 */:
                                MtkConnectivityService.this.mMultipathPolicyTracker.start();
                                return;
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_REQUEST_WITH_INTENT /* 26 */:
                            case MtkConnectivityService.EVENT_REGISTER_NETWORK_LISTENER_WITH_INTENT /* 31 */:
                                MtkConnectivityService.this.handleRegisterNetworkRequestWithIntent(msg);
                                return;
                            case MtkConnectivityService.EVENT_RELEASE_NETWORK_REQUEST_WITH_INTENT /* 27 */:
                                MtkConnectivityService.this.handleReleaseNetworkRequestWithIntent((PendingIntent) msg.obj, msg.arg1);
                                return;
                            case MtkConnectivityService.EVENT_SET_ACCEPT_UNVALIDATED /* 28 */:
                                ...
                                return;
                            case MtkConnectivityService.EVENT_PROMPT_UNVALIDATED /* 29 */:
                                MtkConnectivityService.this.handlePromptUnvalidated((Network) msg.obj);
                                return;
                            case MtkConnectivityService.EVENT_CONFIGURE_ALWAYS_ON_NETWORKS /* 30 */:
                                MtkConnectivityService.this.handleConfigureAlwaysOnNetworks();
                                return;
                            default:
                                switch (i) {
                                    case MtkConnectivityService.EVENT_SET_AVOID_UNVALIDATED /* 35 */:
                                        MtkConnectivityService.this.handleSetAvoidUnvalidated((Network) msg.obj);
                                        return;
                                    case MtkConnectivityService.EVENT_REVALIDATE_NETWORK /* 36 */:
                                        break;
                                    case MtkConnectivityService.EVENT_PRIVATE_DNS_SETTINGS_CHANGED /* 37 */:
                                        MtkConnectivityService.this.handlePrivateDnsSettingsChanged();
                                        return;
                                    case MtkConnectivityService.EVENT_PRIVATE_DNS_VALIDATION_UPDATE /* 38 */:
                                        MtkConnectivityService.this.handlePrivateDnsValidationUpdate((DnsManager.PrivateDnsValidationUpdate) msg.obj);
                                        return;
                                    case MtkConnectivityService.EVENT_UID_RULES_CHANGED /* 39 */:
                                    ...
                                    default:
                                        switch (i) {
                                            case 528395:
                                                ((MtkConnectivityService) MtkConnectivityService.this).mKeepaliveTracker.handleStartKeepalive(msg);
                                                return;
                                            case 528396:
    ...
    public boolean prepareVpn(String oldPackage, String newPackage, int userId) {
        if ("1".equalsIgnoreCase(SystemProperties.get("persist.sys.vpn_disable", "0"))) {
            Slog.d(TAG, "prepareVpn, the VPN can't be estabilshed as the switch disable");
            return false;
        }
    ...
    public void startLegacyVpn(VpnProfile profile) {
        if ("1".equalsIgnoreCase(SystemProperties.get("persist.sys.vpn_disable", "0"))) {
            Slog.d(TAG, "startLegacyVpn, the VPN can't be estabilshed as the switch disable");
            return;
        }
        int user = UserHandle.getUserId(Binder.getCallingUid());
    ...
    public class NetworkRequestInfo implements IBinder.DeathRecipient {
        ...
        NetworkRequestInfo(NetworkRequest r, PendingIntent pi) {
            MtkConnectivityService.this = r2;
            this.request = r;
            r2.ensureNetworkRequestHasType(this.request);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: com.android.server.MtkConnectivityService */
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    ...
                    if (newNetwork.getCurrentScore() != score2) {
                        Slog.e(TAG, String.format("BUG: %s changed score during rematch: %d -> %d", newNetwork.name(), Integer.valueOf(score2), Integer.valueOf(newNetwork.getCurrentScore())));
                    }
    ...
    private void updateNetworkInfo(NetworkAgentInfo networkAgent, NetworkInfo newInfo, boolean isNewCreated) {
        NetworkInfo oldInfo;
        int i;
    ...
    public /* synthetic */ void lambda$factoryReset$6$MtkConnectivityService() {
        IpMemoryStore.getMemoryStore(this.mContext).factoryReset();
    }

    /* access modifiers changed from: private */
    public class ConnectivityServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, Intent intent) {
            if (intent != null) {
                String action = intent.getAction();
                String str = MtkConnectivityService.TAG;
                Slog.d(str, "received intent ==> " + action);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: com.android.server.MtkConnectivityService */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public class SimOperatorReceiver extends BroadcastReceiver {
    ...
    public NetworkRequest getCelluarNetworkRequest() {
        ...
        for (NetworkRequestInfo nri : ((HashMap) this.mNetworkRequests.clone()).values()) {
            ...
            boolean isRequest = nri.request.isRequest();
            if (isInternet && isCellular2 && isDefaultNetwork && !isForeground && isRequest) {
                if (WLAN_ASSIST_DBG) {
        ...
        if (value != null && name != null) {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    return;
                case EVENT_CLEAR_NET_TRANSITION_WAKELOCK /* 8 */:
                    this.INTERNAL_SERVERS[2] = value;
                    return;
                case EVENT_APPLY_GLOBAL_HTTP_PROXY /* 9 */:
                    this.EXTERNAL_SERVERS[0] = value;
                    return;
                case INVALID_SCORE /* 10 */:
