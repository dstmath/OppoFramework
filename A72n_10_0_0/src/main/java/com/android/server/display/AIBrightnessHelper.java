...
public class AIBrightnessHelper {
    ...
    private AIBrightnessClient mAIBrightnessClient;
    private BrightnessChangeListener mBrightnessChangeListener;
    ...
    private boolean mNeedUpgradeModel = false;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (((action.hashCode() == -2128145023 && action.equals("android.intent.action.SCREEN_OFF")) ? (char) 0 : 65535) == 0) {
                if (AIBrightnessHelper.this.mNeedUpgradeModel) {
                    ...
                    AIBrightnessHelper.this.mNeedUpgradeModel = false;
    ...
    private void prepareUpgradeModel(Context context) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void upgradeModel(Context context) {
    ...
    public static class AIBrightnessClient {
        ...
        /* access modifiers changed from: package-private */
        public void setLux(float lux) {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "setLux", new Class[]{Float.TYPE}, new Object[]{Float.valueOf(lux)});
        }

        /* access modifiers changed from: package-private */
        public void setBrightnessByUser(float brightness) {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "setBrightnessByUser", new Class[]{Float.TYPE}, new Object[]{Float.valueOf(brightness)});
        }

        /* access modifiers changed from: package-private */
        public void reset() {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "resetByUser", null, null);
        }

        /* access modifiers changed from: package-private */
        public void setCallbackHandler(Handler handler) {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "setCallbackHandler", new Class[]{Handler.class}, new Object[]{handler});
        }
        ...
        public void onScreenEvent(boolean isScreenOn) {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "onScreenEvent", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(isScreenOn)});
        }

        /* access modifiers changed from: package-private */
        public void setStateChanged(int msgId, Bundle extraData) {
            ReflectUtils.invoke(this.mMethodHashMap, this.mInstance, this.mClass, "setStateChanged", new Class[]{Integer.TYPE, Bundle.class}, new Object[]{Integer.valueOf(msgId), extraData});
        }
    }

    /* access modifiers changed from: private */
    public static class AIBrightnessAppContext {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private AIBrightnessClient createAIBrightnessClient(String deviceName) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private AIBrightnessClient upgradeAIBrightnessClient(String deviceName, Bundle outsideBundle) {
            AIBrightnessClient controller = null;
            if (this.mControllerClass == null) {
                return null;
            }
