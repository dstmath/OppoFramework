...
public interface IOppoBrightness extends IOppoCommonFeature {
    ...
    default int get_SW_EXT_BTN_MAX_4095() {
        return 0;
    }

    default boolean getHBM_SW_EXT_BTN_MAX_4095_5119_Support() {
        return false;
    }

    default int getHBM_SW_EXT_BTN_MAX_4095_5119() {
        return 0;
    }

    default String getTopPackageName() {
        return null;
    }

    default int getFrontCameraBrightness() {
        return 0;
    }
    ...
    default int getFinalMaxBrightness() {
        return OppoBrightUtils.ELEVEN_BITS_MAXBRIGHTNESS;
    }
}
