...
public class ColorAutomaticBrightnessController extends ColorDummyAutomaticBrightnessController {
    static boolean DEBUG = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, (boolean) DEBUG_PRETEND_LIGHT_SENSOR_ABSENT);
    ...
    private AIBrightnessModel mAIBrightnessModel;
    private AIBrightnessModelUpgradeReceiver mAIBrightnessModelUpgradeReceiver;
    private AnimatorRateDelegate mAnimatorRateDelegate;
    private BrightBoostDelegate mBrightBoostDelegate;
    private ColorBaseBrightnessMappingStrategy mBrightnessMapper;
    private IColorAutomaticBrightnessController.Callbacks mCallbacks;
    ...
    private boolean mIsFakeLux = DEBUG_PRETEND_LIGHT_SENSOR_ABSENT;
            ...
            if (ColorAutomaticBrightnessController.this.mLightSensorEnabled) {
                ...
                if (event.values[0] <= ColorAutomaticBrightnessController.MIN_LUX_LIMITI || event.values[0] >= ColorAutomaticBrightnessController.MAX_LUX_LIMITI || time - this.mPrevTime >= ((long) (ColorAutomaticBrightnessController.this.mNormalLightSensorRate / 4))) {
                    ...
                    if (ColorAutomaticBrightnessController.this.mIsFakeLux) {
                        lux = (float) ColorAutomaticBrightnessController.this.mFakeLux;
                    ...
                    if (Math.abs(lux - ColorAutomaticBrightnessController.this.mLastObservedLux) > 100.0f) {
                        ...
                        ColorAutomaticBrightnessController.this.mLastObservedLux = lux;
                    }
                ...
                } else if (ColorAutomaticBrightnessController.DEBUG) {
    ...
    private boolean mNeedUpgradeModel = DEBUG_PRETEND_LIGHT_SENSOR_ABSENT;
    private int mNormalLightSensorRate;
    private boolean mProximityNear = DEBUG_PRETEND_LIGHT_SENSOR_ABSENT;
    ...
    private final SensorEventListener mProximitySensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (((double) event.values[0]) == 0.0d) {
                ColorAutomaticBrightnessController.this.mProximityNear = true;
                ...
                ColorAutomaticBrightnessController.this.mProximityNear = ColorAutomaticBrightnessController.DEBUG_PRETEND_LIGHT_SENSOR_ABSENT;
            }
            if (this.mPrevProximityNear && !ColorAutomaticBrightnessController.this.mProximityNear) {
                ColorAutomaticBrightnessController.this.mProximitySensorChangeTime = time;
            }
    ...
    public void setFakeLux(boolean fakelux, int lux) {
        this.mIsFakeLux = fakelux;
        this.mFakeLux = lux;
    }
    ...
    public void dump(PrintWriter pw) {
        ...
        DEBUG = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, (boolean) DEBUG_PRETEND_LIGHT_SENSOR_ABSENT);
    }
    ...
    public void updateAutoBrightness(boolean sendUpdate) {
        ...
        if (DEBUG) {
            Slog.d(TAG, "autoBrightness=" + newScreenAutoBrightness + ",mAIBrightness=" + this.mAIBrightness + ",mCameraMode = " + this.mCameraDelegate.getCameraMode());
        }
        ...
        if (OppoFeatureCache.getOrCreate(IOppoBrightness.DEFAULT, new Object[0]).getFrontCameraBrightness() != 0) {
            newScreenAutoBrightness2 = OppoFeatureCache.getOrCreate(IOppoBrightness.DEFAULT, new Object[0]).getFrontCameraBrightness();
        }
        if (this.mScreenAutoBrightness != newScreenAutoBrightness2 || this.mCameraDelegate.getCameraMode() == 1 || this.mCameraDelegate.getCameraUseAdjustmentSetting()) {
            Slog.i(TAG, "updateAutoBrightness: Auto, sendUpdate = " + sendUpdate + ", adjustment = " + this.mScreenAutoBrightnessAdjustment + ", AIBrightness = " + this.mAIBrightness + ", adjustManualBright = " + newScreenAutoBrightness2);
    ...
    private void upgradeAIBrightnessModel() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onTargetBrightnessChanged(float brightness) {
