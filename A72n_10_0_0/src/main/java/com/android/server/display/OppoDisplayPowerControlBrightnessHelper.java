...
public class OppoDisplayPowerControlBrightnessHelper {
    ...
    private static long manulDurationTime = System.currentTimeMillis();
    ...
    private DisplayPowerController mDpc = null;
    private IBinder mFlinger = null;
    private DisplayBrightnessHandler mHandler = null;
    private float mLastManulBrightness = 127.0f;
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 101) {
                ...
                if (OppoDisplayPowerControlBrightnessHelper.this.mReportMap == null) {
                    OppoDisplayPowerControlBrightnessHelper.this.mReportMap = new HashMap();
                }
                ...
                long unused2 = OppoDisplayPowerControlBrightnessHelper.manulDurationTime = System.currentTimeMillis();
                if (OppoDisplayPowerControlBrightnessHelper.this.mAutomaticBrightnessController != null) {
                    ...
                    oppoDisplayPowerControlBrightnessHelper.mLastManulBrightness = (float) oppoDisplayPowerControlBrightnessHelper.mAutomaticBrightnessController.mScreenAutoBrightness;
                }
