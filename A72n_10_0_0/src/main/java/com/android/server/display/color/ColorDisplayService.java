...
public final class ColorDisplayService extends SystemService {
    ...
    private static final float[] MATRIX_GRAYSCALE = {0.2126f, 0.2126f, 0.2126f, OppoBrightUtils.MIN_LUX_LIMITI, 0.7152f, 0.7152f, 0.7152f, OppoBrightUtils.MIN_LUX_LIMITI, 0.0722f, 0.0722f, 0.0722f, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, 1.0f};
    static final float[] MATRIX_IDENTITY = new float[16];
    private static final float[] MATRIX_INVERT_COLOR = {0.402f, -0.598f, -0.599f, OppoBrightUtils.MIN_LUX_LIMITI, -1.174f, -0.174f, -1.175f, OppoBrightUtils.MIN_LUX_LIMITI, -0.228f, -0.228f, 0.772f, OppoBrightUtils.MIN_LUX_LIMITI, 1.0f, 1.0f, 1.0f, 1.0f};
    ...
    private void applyTint(final TintController tintController, boolean immediate) {
        ...
        tintController.getAnimator().addUpdateListener(new ValueAnimator.AnimatorUpdateListener(tintController, dtm) {
            /* class com.android.server.display.color.$$Lambda$ColorDisplayService$vYQ6V9BCs0kEJS5w3O0iVFsyXDQ */
            private final /* synthetic */ TintController f$1;
            private final /* synthetic */ DisplayTransformManager f$2;
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ColorDisplayService.this.lambda$applyTint$0$ColorDisplayService(this.f$1, this.f$2, valueAnimator);
            }
        });
        tintController.getAnimator().addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (!this.mIsCancelled) {
                    ColorServiceFactory.getInstance().getColorEyeProtectManager().setColorMatrix(tintController.getLevel(), to, ColorDisplayService.this.getContext(), dtm);
                }
    ...
    public /* synthetic */ void lambda$applyTint$0$ColorDisplayService(TintController tintController, DisplayTransformManager dtm, ValueAnimator animator) {
        ColorServiceFactory.getInstance().getColorEyeProtectManager().setColorMatrix(tintController.getLevel(), (float[]) animator.getAnimatedValue(), getContext(), dtm);
    }
    ...
    private boolean isColorModeAvailable(int colorMode) {
        int[] availableColorModes = getContext().getResources().getIntArray(17235995);
