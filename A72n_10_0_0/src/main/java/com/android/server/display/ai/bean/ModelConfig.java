...
public class ModelConfig {
    ...
    public String toString() {
        return this.device + '\n' + this.reviseXChangePoint + '\n' + this.reviseX + '\n' + this.reviseXMultiple + '\n' + this.stableUpMinPercent + '\n' + this.stableUpSelfPercent + '\n' + this.stableDownMinPercent + '\n' + this.stableDownSelfPercent + '\n' + this.stableSmallChangePercent + '\n' + this.stableSmallChangeTargetPercent + '\n' + this.dragExpandMultipleRight + '\n' + this.dragExpandMultipleLeft + '\n' + this.deltaUpScale + '\n' + this.deltaDownScale + '\n' + this.frameDuration + '\n' + this.minBrightnessChange + '\n' + this.maxBrightnessChange + '\n' + this.speedMultipleInDistance + '\n' + this.splinePointSize + '\n' + this.defaultBrightness + '\n' + Arrays.toString(this.xs) + '\n' + Arrays.toString(this.ys) + '\n' + this.normalMaxBrightness + '\n' + this.stableRightMinLux + '\n' + this.stableSmallRightMinLux + '\n' + Arrays.toString(this.hbmMinXs) + '\n' + Arrays.toString(this.hbmXs) + '\n' + Arrays.toString(this.hbmMaxXs) + '\n' + Arrays.toString(this.hbmYs) + '\n' + Arrays.toString(this.dayHours) + '\n' + Arrays.toString(this.nightHours) + "\nMinLevel config : day=" + this.minLightInDNM[1] + " normal=" + this.minLightInDNM[0] + " night=" + this.ys[0];
    }
}
