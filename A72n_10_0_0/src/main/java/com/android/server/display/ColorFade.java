            ...
            synchronized (this) {
                if (this.mSurfaceControl != null) {
                    ...
                    if (i == 0) {
                        ...
                        t.setMatrix(this.mSurfaceControl, 1.0f, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, 1.0f);
                    } else if (i == 1) {
                        t.setPosition(this.mSurfaceControl, OppoBrightUtils.MIN_LUX_LIMITI, (float) displayInfo.logicalHeight);
                        t.setMatrix(this.mSurfaceControl, OppoBrightUtils.MIN_LUX_LIMITI, -1.0f, 1.0f, OppoBrightUtils.MIN_LUX_LIMITI);
                    } else if (i == 2) {
                        t.setPosition(this.mSurfaceControl, (float) displayInfo.logicalWidth, (float) displayInfo.logicalHeight);
                        t.setMatrix(this.mSurfaceControl, -1.0f, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, -1.0f);
                    } else if (i == 3) {
                        t.setPosition(this.mSurfaceControl, (float) displayInfo.logicalWidth, OppoBrightUtils.MIN_LUX_LIMITI);
                        t.setMatrix(this.mSurfaceControl, OppoBrightUtils.MIN_LUX_LIMITI, 1.0f, -1.0f, OppoBrightUtils.MIN_LUX_LIMITI);
                    }
                }
            }
