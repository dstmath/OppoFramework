...
public class OppoDisplayPowerHelper {
    ...
    private final DisplayPowerController mDpc;
    private final OppoDisplayPowerHelperHandler mHandler;
    ...
    public void unblockScreenOnByBiometrics(String reason) {
        ...
        if (reason.contains("blackGestureWake") || reason.contains("android.server.wm:SCREEN_ON_FLAG")) {
            ...
            SystemProperties.set("sys.power.screenon.delay", NoFocusWindow.HUNG_CONFIG_ENABLE);
        }
        synchronized (this.mBlockReasonList) {
