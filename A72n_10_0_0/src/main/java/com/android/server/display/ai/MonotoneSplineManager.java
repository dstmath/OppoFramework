...
public class MonotoneSplineManager {
    ...
    private AppSwitchDetectorUtil.IAppSwitchListener mAppSwitchListener = new AppSwitchDetectorUtil.IAppSwitchListener() {
        ...
        public void onAppSwitchToForeground(String pkgName) {
            if (TextUtils.isEmpty(pkgName) || !MonotoneSplineManager.this.mSplines.containsKey(pkgName)) {
                MonotoneSplineManager.this.mCurrentSplineName = BrightnessConstants.DEFAULT_SPLINE;
            } else {
                MonotoneSplineManager.this.mCurrentSplineName = pkgName;
            }
    ...
    private String mCurrentSplineName = BrightnessConstants.DEFAULT_SPLINE;
    private AtomicBoolean mIsBooted = new AtomicBoolean();
    private AtomicBoolean mIsInitiated = new AtomicBoolean();
    private ModelConfig mModelConfig;
    private ISplineListener mSplineListener;
    private Map<String, Spline> mSplines = new ConcurrentHashMap();
    ...
    public synchronized void resetSplines() {
        ...
        if (needReset) {
            ...
            if (defaultSpline.isTrained()) {
                ...
                if (dragPoint != null) {
                    defaultSpline.drag(dragPoint.x, dragPoint.y);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void registerAppSwitchEvent() {
    ...
    public class Spline {
        ...
        private volatile List<BrightnessPoint> mPoints;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private synchronized String updateSpline(Context context, String name, List<BrightnessPoint> trainedPoints) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private BrightnessPoint drag(float x, float y) {
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private synchronized List<BrightnessPoint> updateSplineWithPoint(BrightnessPoint point) {
            float leftX;
            float rightX;
        ...
        /* access modifiers changed from: private */
        /* access modifiers changed from: public */
        private List<BrightnessPoint> generateMonotonePoints(List<BrightnessPoint> points) {
        ...
        public class DragSpline {
            ...
            private List<BrightnessPoint> mDragUniformPoints = null;
            ...
            /* access modifiers changed from: private */
            /* access modifiers changed from: public */
            private BrightnessPoint getDragPoint() {
                return this.mDragPoint;
            }

            /* access modifiers changed from: private */
            /* access modifiers changed from: public */
            private List<BrightnessPoint> getDragPoints() {
                return this.mDragPoints;
            }

            /* access modifiers changed from: private */
            /* access modifiers changed from: public */
            private List<BrightnessPoint> getDragUniformPoints() {
                return this.mDragUniformPoints;
            }

            /* access modifiers changed from: private */
            /* access modifiers changed from: public */
            private String getDragPointDumpString() {
