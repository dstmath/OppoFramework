...
public class OppoAutomaticBrightnessController {
    ...
    private static boolean mDeviceLandScape = false;
    private static OppoBrightUtils mOppoBrightUtils;
    public static boolean mProximityNear = false;
    private static boolean mScreenLandScape = false;
    ...
    private float mAutoAmbientLuxValue = OppoBrightUtils.MIN_LUX_LIMITI;
                ...
                if (tempOrient != 4) {
                    ...
                    if (tempOrient != this.mOrientation) {
                        ...
                        if (this.mPrevScreenLandeScape && !OppoAutomaticBrightnessController.mScreenLandScape) {
                            OppoAutomaticBrightnessController.this.mScreenLandScapeTime = time;
                        }
                        if (this.mPrevScreenLandeScape != OppoAutomaticBrightnessController.mScreenLandScape) {
    ...
    private long mDeviceLandScapeTime = -1;
    private final SensorEventListener mDeviceOriListener = new SensorEventListener() {
            ...
            if (tempOrition != 4) {
                ...
                if (tempOrition != this.mDeviceOritation) {
                    ...
                    if (this.mPrevDeviceLandScape && !OppoAutomaticBrightnessController.mDeviceLandScape) {
                        OppoAutomaticBrightnessController.this.mDeviceLandScapeTime = time;
                    }
                    if (this.mPrevDeviceLandScape != OppoAutomaticBrightnessController.mDeviceLandScape) {
    ...
    private Sensor mDeviceOriSensor;
            ...
            if (OppoAutomaticBrightnessController.this.mLightSensorEnabled) {
                ...
                if (event.values[0] <= OppoBrightUtils.MIN_LUX_LIMITI || event.values[0] >= 31000.0f || time - this.mPrevTime >= ((long) (OppoAutomaticBrightnessController.this.mNormalLightSensorRate / 4))) {
                    ...
                    if (OppoBrightUtils.mBrightnessBoost == 2 || !OppoAutomaticBrightnessController.mProximityNear || OppoBrightUtils.DEBUG_PRETEND_PROX_SENSOR_ABSENT || lux >= OppoAutomaticBrightnessController.this.lux_max || OppoAutomaticBrightnessController.this.mBacklightStatus != 0) {
                        ...
                        OppoAutomaticBrightnessController.this.mSkipCount = 0;
                        OppoBrightUtils unused7 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                        ...
                        if (OppoAutomaticBrightnessController.mOppoBrightUtils.isAIBrightnessOpen()) {
                            ...
                            OppoAutomaticBrightnessController.this.mAmbientLux = lux;
                        ...
                        if (OppoAutomaticBrightnessController.this.mBacklightStatus != 0 || lux < OppoAutomaticBrightnessController.this.lux_min || lux >= OppoAutomaticBrightnessController.this.lux_max) {
                            if (OppoAutomaticBrightnessController.this.mBacklightStatus == 1) {
                                if (lux >= OppoAutomaticBrightnessController.this.lux_beforemin && lux < OppoAutomaticBrightnessController.this.lux_beforemax) {
                                    OppoAutomaticBrightnessController.this.mBacklightStatus = 2;
                                    OppoAutomaticBrightnessController.this.mSensorLux = lux;
                                    ...
                                    OppoAutomaticBrightnessController.this.mBacklightStatus = 0;
                                    OppoAutomaticBrightnessController oppoAutomaticBrightnessController = OppoAutomaticBrightnessController.this;
                                    oppoAutomaticBrightnessController.lux_min = oppoAutomaticBrightnessController.lux_beforemin;
                                    OppoAutomaticBrightnessController oppoAutomaticBrightnessController2 = OppoAutomaticBrightnessController.this;
                                    oppoAutomaticBrightnessController2.lux_max = oppoAutomaticBrightnessController2.lux_beforemax;
                                    OppoAutomaticBrightnessController oppoAutomaticBrightnessController3 = OppoAutomaticBrightnessController.this;
                                    oppoAutomaticBrightnessController3.marea = oppoAutomaticBrightnessController3.mareabefore;
                                    OppoAutomaticBrightnessController.this.mLastObservedLux = lux;
                                    if (OppoAutomaticBrightnessController.DEBUG) {
                            ...
                            OppoBrightUtils unused9 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                            if (i == 1) {
                                ...
                                oppoAutomaticBrightnessController4.mDeltaLux = lux - oppoAutomaticBrightnessController4.mLastObservedLux;
                            }
                            if (OppoAutomaticBrightnessController.DEBUG) {
                            ...
                            oppoAutomaticBrightnessController5.mAutoAmbientLuxValue = oppoAutomaticBrightnessController5.mLastObservedLux;
                            OppoAutomaticBrightnessController.this.mLastObservedLux = lux;
                            OppoAutomaticBrightnessController.this.mSensorLux = lux;
                            int ii = 0;
                            while (true) {
                                OppoBrightUtils unused10 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                if (ii >= OppoBrightUtils.BRIGHTNESS_STEPS) {
                                    break;
                                }
                                OppoBrightUtils unused11 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                if (lux <= OppoBrightUtils.mAutoBrightnessLux[ii]) {
                                    OppoBrightUtils unused12 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    ...
                                    OppoBrightUtils unused13 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    oppoAutomaticBrightnessController6.lux_min = OppoBrightUtils.mAutoBrightnessLuxMinLimit[ii];
                                    OppoAutomaticBrightnessController oppoAutomaticBrightnessController7 = OppoAutomaticBrightnessController.this;
                                    OppoBrightUtils unused14 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    oppoAutomaticBrightnessController7.lux_max = OppoBrightUtils.mAutoBrightnessLuxMaxLimit[ii];
                                    OppoAutomaticBrightnessController.this.marea = ii;
                                    break;
                                }
                                OppoBrightUtils unused15 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                float[] fArr = OppoBrightUtils.mAutoBrightnessLux;
                                OppoBrightUtils unused16 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                if (lux > fArr[OppoBrightUtils.BRIGHTNESS_STEPS - 1]) {
                                    ...
                                    OppoBrightUtils unused19 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    float[] fArr3 = OppoBrightUtils.mAutoBrightnessLuxMinLimit;
                                    OppoBrightUtils unused20 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    oppoAutomaticBrightnessController8.lux_min = fArr3[OppoBrightUtils.BRIGHTNESS_STEPS - 1];
                                    OppoAutomaticBrightnessController oppoAutomaticBrightnessController9 = OppoAutomaticBrightnessController.this;
                                    OppoBrightUtils unused21 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    float[] fArr4 = OppoBrightUtils.mAutoBrightnessLuxMaxLimit;
                                    OppoBrightUtils unused22 = OppoAutomaticBrightnessController.mOppoBrightUtils;
                                    oppoAutomaticBrightnessController9.lux_max = fArr4[OppoBrightUtils.BRIGHTNESS_STEPS - 1];
                                    ...
                                    oppoAutomaticBrightnessController10.marea = OppoBrightUtils.BRIGHTNESS_STEPS - 1;
                                    break;
                                }
                                ii++;
                            }
                            ...
                            OppoAutomaticBrightnessController.this.mBacklightStatus = 1;
    ...
    private OppoMinimumBrightnessHelper mMinimumBrightnessHelper;
    ...
    private final SensorEventListener mProximitySensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
                ...
                if (OppoAutomaticBrightnessController.mProximityNear) {
                    if (!OppoBrightUtils.DEBUG_PRETEND_PROX_SENSOR_ABSENT) {
                        ...
                        if (!OppoBrightUtils.mManualSetAutoBrightness) {
                            OppoAutomaticBrightnessController.this.mRecentLightSamples = 0;
                            OppoAutomaticBrightnessController.this.mAmbientLightRingBuffer.clear();
                            OppoAutomaticBrightnessController.this.mHandler.removeMessages(1);
                            OppoAutomaticBrightnessController.this.lux_min = OppoBrightUtils.MIN_LUX_LIMITI;
                            OppoAutomaticBrightnessController.this.lux_max = OppoBrightUtils.MIN_LUX_LIMITI;
                        }
                    }
                    if (OppoAutomaticBrightnessController.DEBUG) {
            ...
            if (this.mPrevProximityNear && !OppoAutomaticBrightnessController.mProximityNear) {
                OppoAutomaticBrightnessController.this.mProximitySensorChangeTime = time;
            }
    ...
    private long mScreenLandScapeTime = -1;
    private float mSensorLux = OppoBrightUtils.MIN_LUX_LIMITI;
    ...
    private final SensorEventListener mTelePhoneProximityListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (this.prevNear && !this.proxNear) {
                OppoAutomaticBrightnessController.this.mVirProxSensorChangeTime = time;
            }
    ...
    private long mVirProxSensorChangeTime = 0;
    ...
    public void init(Context context) {
        ...
        if (mOppoBrightUtils.isSunnyBrightnessSupport()) {
            this.mMinimumBrightnessHelper = new OppoMinimumBrightnessHelper(this, context, this.mHandler);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x015b, code lost:
        if (com.android.server.display.OppoBrightUtils.mCameraUseAdjustmentSetting != false) goto L_0x015d;
     */
        ...
        if (this.mAmbientLuxValid || this.mManulBrightnessSlide) {
            ...
            if (this.mManulBrightnessSlide) {
                ...
                if (OppoBrightUtils.mManualBrightness != 0) {
                    ...
                    mOppoBrightUtils.setManualBrightnessFlag(true);
                    return;
                }
                return;
            }
            ...
            if (mOppoBrightUtils.isSunnyBrightnessSupport()) {
                newScreenAutoBrightness2 = this.mMinimumBrightnessHelper.checkMiniumBrightness(newScreenAutoBrightness2);
            }
                ...
                try {
                    ...
                    if (info.topActivity != null) {
                        ...
                        if (OppoAutomaticBrightnessController.this.mForegroundAppPackageName == null || !OppoAutomaticBrightnessController.this.mForegroundAppPackageName.equals(packageName)) {
                            OppoAutomaticBrightnessController.this.mPendingForegroundAppPackageName = packageName;
                            OppoAutomaticBrightnessController.this.mPendingForegroundAppCategory = -1;
                            try {
                                ApplicationInfo app = OppoAutomaticBrightnessController.this.mPackageManager.getApplicationInfo(packageName, DumpState.DUMP_CHANGES);
                                OppoAutomaticBrightnessController.this.mPendingForegroundAppCategory = app.category;
    ...
    public final class AutomaticBrightnessHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 13) {
                ...
                OppoAutomaticBrightnessController.this.mRotateStart = false;
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateAIAutoBrightness() {
        if (!this.mManulBrightnessSlide) {
            this.mAmbientLuxValid = true;
            updateAutoBrightness(true);
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void registerProxSensorListener() {
        Thread thread = new Thread(new Runnable() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void unRegisterProxSensorListener() {
    ...
    public void setForceUpdate(boolean enable) {
        this.forceUpdate = enable;
    }
}
