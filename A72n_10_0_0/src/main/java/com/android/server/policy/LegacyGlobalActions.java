...
public class LegacyGlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    private ActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302447, 17302449, 17040067, 17040066, 17040065) {
        ...
        String[] defaultActions = this.mContext.getResources().getStringArray(17236036);
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302795, 17040059) {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302201, 17040052) {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302282, 17040050) {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302835, 17040063) {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040054) {
        ...
        if (um.isUserSwitcherEnabled()) {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    ...
                    items.add(new SinglePressAction(17302670, icon, sb.toString()) {
    ...
    public class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            super(17302300, 17302299, 17040062, 17040061, 17040060);
        }
    ...
    public static class SilentModeTriStateAction implements Action, View.OnClickListener {
        private final int[] ITEM_IDS = {16909196, 16909197, 16909198};
        private final AudioManager mAudioManager;
        private final Context mContext;
        ...
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            View v = inflater.inflate(17367159, parent, false);
