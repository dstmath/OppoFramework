...
public interface WindowManagerPolicy extends WindowManagerPolicyConstants {
    ...
    int getNavBarHeight(int i, int i2);
    ...
    default int getSubWindowLayerFromTypeLw(int type) {
        switch (type) {
            ...
            case 1002:
                return 2;
            case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_SYSTEM /* 1004 */:
                return -1;
            case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_LOST_FOUND /* 1005 */:
                return 3;
            default:
    ...
    default int hookWindowLayerFromTypeLw(int type, boolean canAddInternalSystemWindow) {
        return 0;
    }
}
