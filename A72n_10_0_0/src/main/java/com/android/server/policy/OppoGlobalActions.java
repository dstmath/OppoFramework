...
public class OppoGlobalActions extends GlobalActions {
    ...
    private ShutdownViewControl.OnCancelListener mOnCancel = new ShutdownViewControl.OnCancelListener() {
    ...
    private ShutdownViewControl.OnEmergencyListener mOnEmergency = new ShutdownViewControl.OnEmergencyListener() {
    ...
    private ShutdownViewControl.OnRebootListener mOnReboot = new ShutdownViewControl.OnRebootListener() {
    ...
    private ShutdownViewControl.OnShutdownListener mOnShutDown = new ShutdownViewControl.OnShutdownListener() {
    ...
    private ShutdownViewControl mShutdownViewControl;
    ...
    /* access modifiers changed from: private */
    public class InnovativeV2HAction implements Action {
        ...
        @Override // com.android.server.policy.OppoGlobalActions.Action
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            OppoGlobalActions.this.mShutdownViewControl = new ShutdownViewControl(context);
