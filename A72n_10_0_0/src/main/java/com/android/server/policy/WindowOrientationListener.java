...
public abstract class WindowOrientationListener {
    ...
    private static final boolean LOG = SystemProperties.getBoolean("debug.orientation.log", true);
    ...
    final class OrientationSensorJudge extends OrientationJudge {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0023, code lost:
            if (com.android.server.policy.WindowOrientationListener.LOG == false) goto L_0x0046;
         */
