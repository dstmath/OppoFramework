...
public class VibratorService extends IVibratorService.Stub implements InputManager.InputDeviceListener {
    ...
    private IOppoVibratorFeature mOppoVibrateFeature = null;
    ...
    VibratorService(Context context) {
        ...
        VibrationEffect clickEffect = createEffectFromResource(17236092);
    ...
    public void vibrate(int uid, String opPkg, VibrationEffect effect, int usageHint, String reason, IBinder token) {
        ...
        OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0]).setAction(54, Binder.getCallingUid());
