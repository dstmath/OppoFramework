...
public class LockdownVpnTracker {
    ...
    private void handleStateChangedLocked() {
        ...
        Slog.d(TAG, "handleStateChanged: egress=" + (egressInfo == null ? null : ConnectivityManager.getNetworkTypeName(egressInfo.getType())) + StringUtils.SPACE + this.mAcceptedEgressIface + "->" + (egressProp == null ? null : egressProp.getInterfaceName()));
        ...
        if (this.mErrorCount > 4) {
            showNotification(17041212, 17303774);
            ...
            if (vpnInfo.isConnected() && vpnConfig != null) {
                ...
                if (!TextUtils.equals(iface, this.mAcceptedIface) || !sourceAddrs.equals(this.mAcceptedSourceAddr)) {
                    ...
                    showNotification(17041209, 17303773);
            ...
            showNotification(17041210, 17303774);
