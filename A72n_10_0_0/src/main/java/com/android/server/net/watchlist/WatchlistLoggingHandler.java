...
public class WatchlistLoggingHandler extends Handler {
    ...
    private void tryAggregateRecords(long lastRecordTime) {
        ...
        try {
            ...
            sb.append("Milliseconds spent on tryAggregateRecords(): ");
            sb.append(endTime - startTime);
            Slog.i(str, sb.toString());
        } catch (SQLiteDatabaseCorruptException e) {
            Slog.w(TAG, "Database exception", e);
            endTime = System.currentTimeMillis();
            str = TAG;
            sb = new StringBuilder();
        } catch (Throwable th) {
            ...
            String str4 = TAG;
            Slog.i(str4, "Milliseconds spent on tryAggregateRecords(): " + (endTime4 - startTime));
            throw th;
        }
    }
