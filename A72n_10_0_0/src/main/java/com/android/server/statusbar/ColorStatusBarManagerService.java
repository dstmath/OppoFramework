...
public class ColorStatusBarManagerService extends StatusBarManagerService implements IColorStatusBarManager {
    ...
    private static final List<String> ONE_KEY_LOCK_SCREEN_WHITE_LIST = Arrays.asList("com.coloros.onekeylockscreen", AppBrightnessStat.DEFAULT_LAUNCHER_APP);
    ...
    private void updateNavBarVisibility(int navBarVis) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateNavBarVisibility(int navBarVis, String title) {
        IColorStatusBar iColorStatusBar = this.mColorStatusBar;
        if (iColorStatusBar != null) {
            try {
