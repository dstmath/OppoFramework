...
public final class Utf8 {
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        /* JADX INFO: Multiple debug info for r6v10 long: [D('outIx' long), D('outLimit' long)] */
        /* access modifiers changed from: package-private */
        @Override // com.google.protobuf.Utf8.Processor
        public int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            char c;
            ...
            while (inIx < inLimit) {
                ...
                if (c4 < c && outIx < outLimit2) {
                    ...
                    if (outIx <= outLimit2 - 4) {
                        if (inIx + 1 != inLimit) {
                            ...
                            if (Character.isSurrogatePair(c4, low)) {
                                ...
                                long outIx4 = outLimit3 + 1;
                                UNSAFE.putByte(out, outLimit3, (byte) (((codePoint >>> 12) & 63) | 128));
                                long outIx5 = outIx4 + 1;
                                c2 = 128;
                                UNSAFE.putByte(out, outIx4, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                UNSAFE.putByte(out, outIx5, (byte) ((codePoint & 63) | 128));
                                outIx = outIx5 + 1;
                            }
                        }
                    ...
                    UNSAFE.putByte(out, outIx6, (byte) ((c4 & '?') | 128));
                    str2 = str3;
                    outIx = outIx6 + 1;
                    j2 = 1;
                    outLimit = outLimit2;
        ...
        /* JADX INFO: Multiple debug info for r6v9 long: [D('outIx' long), D('outLimit' long)] */
        /* access modifiers changed from: package-private */
        @Override // com.google.protobuf.Utf8.Processor
        public void encodeUtf8Direct(CharSequence in, ByteBuffer out) {
            char c;
