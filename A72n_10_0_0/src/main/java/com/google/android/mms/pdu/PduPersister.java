            ...
            if (ContentType.TEXT_PLAIN.equals(contentType)) {
                                    ...
                                    try {
                                        ...
                                        if (os3 != null) {
                                            try {
                                                ...
                                                Log.e(TAG, "IOException while closing: " + os3, e11);
                                            }
                                        }
                                        if (is2 != null) {
                                            try {
                                                ...
                                                Log.e(TAG, "IOException while closing: " + is2, e12);
                                            }
                                        }
                                        if (drmConvertSession != null) {
                                            drmConvertSession.close(null);
                    ...
                    try {
                        ...
                        if (os3 != null) {
                            try {
                                ...
                                Log.e(TAG, "IOException while closing: " + os3, e22);
                            }
                        }
                        if (0 != 0) {
                            try {
                                ...
                                Log.e(TAG, "IOException while closing: " + ((Object) null), e23);
                            }
                        }
                        if (drmConvertSession != null) {
                            drmConvertSession.close(null);
                ...
                if (os3 != null) {
                    try {
                        ...
                        Log.e(TAG, "IOException while closing: " + os3, e26);
                    }
                }
                if (is2 != null) {
                    try {
                        ...
                        Log.e(TAG, "IOException while closing: " + is2, e27);
                    }
                }
                if (drmConvertSession == null) {
                    drmConvertSession.close(null);
