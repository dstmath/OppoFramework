...
public class DrmConvertSession {
    ...
    public static DrmConvertSession open(Context context, String mimeType) {
        ...
        if (!(context == null || mimeType == null || mimeType.equals(PhoneConfigurationManager.SSSS))) {
            try {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    e = e;
                    result = 492;
                    str = "Failed to close File:" + filename + ".";
                }
            ...
            Log.w(TAG, "Could not close convertsession. Convertsession: " + this.mConvertSessionId, e12);
            return 491;
        }
        Log.w(TAG, str, e);
        return result;
