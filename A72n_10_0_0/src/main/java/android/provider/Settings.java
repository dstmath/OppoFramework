...
public final class Settings {
    ...
    public static final String GOV_FORWARDCALL_SETTING_DISABLE = "forward_call_setting_disable";
    ...
    public static final class System extends NameValueTable implements OppoSettings.Mtk_System, OppoSettings.Qcom_System, OppoSettings.Oppo_System {
        ...
        private static final SettingsValidators.Validator SCREEN_AUTO_BRIGHTNESS_ADJ_VALIDATOR = new SettingsValidators.InclusiveFloatRangeValidator(-1.0f, 4095.0f);
        ...
        private static final SettingsValidators.Validator SCREEN_BRIGHTNESS_VALIDATOR = new SettingsValidators.InclusiveIntegerRangeValidator(0, 4095);
