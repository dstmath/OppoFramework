...
public final class OppoSettings {
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "MTK ADD [Originally defined in Settings.Global in Settings.java ]", property = OppoHook.OppoRomType.MTK)
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "MTK ADD [Originally defined in Settings.Secure in Settings.java ]", property = OppoHook.OppoRomType.MTK)
    public interface Mtk_Secure {
        ...
        public static final String OPPO_SMS_NOTIFICATION_SOUND_VIBRATE_TYPE = "oppo_sms_notification_sound_vibrate_type";
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "MTK ADD [Originally defined in Settings.System in Settings.java ]", property = OppoHook.OppoRomType.MTK)
    public interface Mtk_System {
        ...
        @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "QCOM DEFINED, OMIT ONE", property = OppoHook.OppoRomType.MTK)
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "OPPO ADD [Originally defined in Settings.System in Settings.java ]", property = OppoHook.OppoRomType.OPPO)
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "QCOM ADD [Originally defined in Settings.Global in Settings.java ]", property = OppoHook.OppoRomType.QCOM)
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "QCOM ADD [Originally defined in Settings.System in Settings.java ]", property = OppoHook.OppoRomType.QCOM)
