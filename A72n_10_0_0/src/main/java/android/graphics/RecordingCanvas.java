...
public final class RecordingCanvas extends DisplayListCanvas {
    ...
    @Override // android.graphics.BaseCanvas, android.graphics.Canvas, android.graphics.OppoBaseBaseCanvas
    ...
    @Override // android.graphics.Canvas, android.graphics.OppoBaseBaseCanvas
    public int getWidth() {
        return this.mWidth;
    }
    ...
    private void setOppoStatistics(int size) {
        try {
            Log.v("setOppoStatistics", "draw_bitmap_size = " + size);
            HashMap<String, String> logMap = new HashMap<>();
            logMap.put("packageName", ActivityThread.currentOpPackageName());
            logMap.put(DumpHeapActivity.KEY_SIZE, String.valueOf(size));
            ActivityThread.sendCommonDcsUploader("PSW_Android", "draw_bitmap_size", logMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
