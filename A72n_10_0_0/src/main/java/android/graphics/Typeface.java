...
public class Typeface extends OppoBaseTypeface {
    ...
    static {
        ...
        ColorTypefaceInjector.COLOROSUI_MEDIUM = create("sans-serif-medium", 0);
    ...
    public static final class CustomFallbackBuilder {
        ...
        public Typeface build() {
            ...
            return new Typeface(Typeface.nativeCreateFromArray(ptrArray, weight, (fontStyle2 == null || fontStyle2.getSlant() == 0) ? 0 : 1));
        }
    }
