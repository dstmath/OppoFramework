...
public class RadialGradient extends Shader {
    ...
    public Shader getDarkModeShader() {
        Shader copy = ((IColorDarkModeManager) OppoFeatureCache.getOrCreate(IColorDarkModeManager.DEFAULT, new Object[0])).getDarkModeRadialGradient(this.mX, this.mY, this.mRadius, convertColors(this.mColorLongs), this.mCenterColor, this.mPositions, this.mEdgeColor, this.mTileMode);
