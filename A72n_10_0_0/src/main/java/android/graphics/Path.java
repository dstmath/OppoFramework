...
public class Path extends OppoBasePath {
    ...
    public Path(Path src) {
        ...
        if (src != null) {
            ...
            Region region = src.rects;
            if (region != null) {
                this.rects = new Region(region);
            }
            setIsAddRect(src);
        }
        ...
        if (this != src) {
            ...
            if (this.isSimplePath) {
                ...
                if (region2 == null || (region = src.rects) == null) {
                    Region region3 = this.rects;
                    if (region3 == null || src.rects != null) {
                        Region region4 = src.rects;
                        if (region4 != null) {
                            this.rects = new Region(region4);
                            return;
                        }
                        return;
                    }
