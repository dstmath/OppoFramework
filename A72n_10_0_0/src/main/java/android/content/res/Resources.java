...
public class Resources extends ColorBaseResources {
    ...
    public TypedArray obtainAttributes(AttributeSet set, int[] attrs) {
        ...
        array.mXml = parser;
        return ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).replaceTypedArray(this.mResourcesImpl, array);
    }
    ...
    @Override // android.content.res.ColorBaseResources
    ...
    @Override // android.content.res.ColorBaseResources
    public ColorBaseResourcesImpl getColorImpl() {
        return getImpl();
    }

    public void switchResources(Resources res) {
        this.mResourcesImpl = res.mResourcesImpl;
    }
}
