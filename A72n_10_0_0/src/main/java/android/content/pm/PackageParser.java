...
public class PackageParser extends ColorBasePackageParser {
                                ...
                                if (tagName.equals("permission")) {
                                    ...
                                    if (tagName.equals(TAG_USES_PERMISSION_SDK_M)) {
                                        ...
                                        while (true) {
                                            ...
                                            if (type2 == 1) {
                                                break;
                                            } else if (type2 == 3 && parser.getDepth() <= innerDepth) {
                                                break;
    ...
    private boolean parseBaseApplication(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        if (TextUtils.isEmpty(r14.staticSharedLibName)) {
            r14.activities.add(packageParser.generateAppDetailsHiddenActivity(r14, flags, strArr, r14.baseHardwareAccelerated));
        }
        if (hasActivityOrder) {
            Collections.sort(r14.activities, $$Lambda$PackageParser$0aobsT7Zf7WVZCqMZ5z2clAuQf4.INSTANCE);
        }
        if (hasReceiverOrder) {
            Collections.sort(r14.receivers, $$Lambda$PackageParser$0DZRgzfgaIMpCOhJqjw6PUiU5vw.INSTANCE);
        }
        if (hasServiceOrder) {
            Collections.sort(r14.services, $$Lambda$PackageParser$M9fHqS_eEp1oYkuKJhRHOGUxf8.INSTANCE);
        }
    ...
    /* JADX INFO: Multiple debug info for r0v18 android.content.pm.ActivityInfo: [D('a' android.content.pm.PackageParser$Activity), D('parsedComponent' android.content.pm.ComponentInfo)] */
                            ...
                            if (tagName.equals("service")) {
                                ...
                                if (parser.getName().equals("meta-data")) {
                                    ...
                                    if (tagName.equals("uses-static-library")) {
                                        ...
                                        int i8 = z ? 1 : 0;
                                        int i9 = z ? 1 : 0;
                                        String lname = sa2.getNonResourceString(i5);
