...
public class ActivityInfo extends OppoBaseActivityInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ActivityInfo> CREATOR = new Parcelable.Creator<ActivityInfo>() {
        /* class android.content.pm.ActivityInfo.AnonymousClass1 */
    ...
    public int getRealConfigChanged() {
        if (this.name != null && ActivityThread.inCptWhiteList(MetricsProto.MetricsEvent.ACTION_PERMISSION_REVOKE_USE_SIP, this.name)) {
            this.configChanges |= 1152;
        }
    ...
    public static final String lockTaskLaunchModeToString(int lockTaskLaunchMode2) {
        if (lockTaskLaunchMode2 == 0) {
            return "LOCK_TASK_LAUNCH_MODE_DEFAULT";
        }
        if (lockTaskLaunchMode2 == 1) {
            return "LOCK_TASK_LAUNCH_MODE_NEVER";
        }
        if (lockTaskLaunchMode2 == 2) {
            return "LOCK_TASK_LAUNCH_MODE_ALWAYS";
        }
        if (lockTaskLaunchMode2 == 3) {
    ...
    @Override // android.os.Parcelable, android.content.pm.OppoBaseActivityInfo, android.content.pm.ComponentInfo, android.content.pm.PackageItemInfo
