...
public class PackageUserState extends OppoBasePackageUserState {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:28:0x003f A[RETURN] */
    ...
    public boolean isEnabled(ComponentInfo componentInfo, int flags) {
        ...
        if (i != 0) {
            if (i == 2 || i == 3) {
                boolean filterForFreeze = false;
                if (this.enabled == 2 && this.oppoFreezeState == 2 && (1073741824 & flags) != 0) {
                    filterForFreeze = true;
                }
                if (!filterForFreeze) {
                    return false;
                }
