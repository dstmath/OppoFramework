...
public interface IOppoEngineerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOppoEngineerManager {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 9:
                        ...
                        boolean serialPortState = setSerialPortState(_arg2);
                        reply.writeNoException();
                    ...
                    case 12:
                        ...
                        boolean disablePartionWriteProtect = disablePartionWriteProtect(_arg2);
                        reply.writeNoException();
                    ...
                    case 56:
                        ...
                        boolean saveOppoUsageRecords = saveOppoUsageRecords(_arg0, _arg1, _arg2);
                        reply.writeNoException();
        ...
        public static class Proxy implements IOppoEngineerManager {
