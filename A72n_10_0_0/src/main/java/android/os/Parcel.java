...
public final class Parcel {
    ...
    public static final Parcelable.Creator<String> STRING_CREATOR = new Parcelable.Creator<String>() {
        /* class android.os.Parcel.AnonymousClass1 */
    ...
    private void updateNativeSize(long newNativeSize) {
        if (this.mOwnsNativeParcelObject) {
            ...
            long j = this.mNativeSize;
            if (newNativeSize != j) {
                int delta = (int) (newNativeSize - j);
                if (delta > 0) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: android.util.SparseArray<T extends android.os.Parcelable> */
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends Parcelable> SparseArray<T> createTypedSparseArray(Parcelable.Creator<T> creator) {
        ...
        for (int i = 0; i < count; i++) {
            array.append(readInt(), (Parcelable) readTypedObject(creator));
        }
        return array;
    }

    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: android.util.ArrayMap<java.lang.String, T extends android.os.Parcelable> */
    /* JADX WARN: Multi-variable type inference failed */
    public final <T extends Parcelable> ArrayMap<String, T> createTypedArrayMap(Parcelable.Creator<T> creator) {
        ...
        for (int i = 0; i < count; i++) {
            map.append(readString(), (Parcelable) readTypedObject(creator));
        }
        return map;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: java.util.List<T extends android.os.Parcelable> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final <T extends Parcelable> T readParcelable(ClassLoader loader) {
        ...
        return creator instanceof Parcelable.ClassLoaderCreator ? (T) ((Parcelable) ((Parcelable.ClassLoaderCreator) creator).createFromParcel(this, loader)) : (T) ((Parcelable) creator.createFromParcel(this));
    }
        ...
        synchronized (mCreators) {
            ...
            if (creator == null) {
                ...
                if (Parcelable.class.isAssignableFrom(parcelableClass)) {
                    ...
                    } else if (Parcelable.Creator.class.isAssignableFrom(f.getType())) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v1, resolved type: T extends android.os.Parcelable[] */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    private final Serializable readSerializable(final ClassLoader loader) {
        ...
        try {
            return (Serializable) new ObjectInputStream(new ByteArrayInputStream(createByteArray())) {
                /* class android.os.Parcel.AnonymousClass2 */
