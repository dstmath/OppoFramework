...
public final class OppoUsageManager {
    ...
    public int getFileSize(String path) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.getFileSize(path);
            } catch (RemoteException exce) {
    ...
    public byte[] readOppoFile(String path, int startPosition, int length) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.readOppoFile(path, startPosition, length);
            } catch (RemoteException exce) {
                Log.e(TAG, "readOppoFile failed!", exce);
                return null;
            }
        } else {
            Log.w(TAG, "readOppoFile:service not publish!");
            return null;
        }
    }
    ...
    public int saveOppoFile(int fileMax, String path, int offset, boolean append, int length, byte[] data) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.saveOppoFile(fileMax, path, offset, append, length, data);
            } catch (RemoteException exce) {
                Log.e(TAG, "saveOppoFile failed!", exce);
                return -1;
            }
        } else {
            Log.w(TAG, "saveOppoFile:service not publish!");
            return -1;
        }
    }
    ...
    public int saveEntireOppoFile(String sourcePath, String targetPath, boolean deleteSource) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.saveEntireOppoFile(sourcePath, targetPath, deleteSource);
            } catch (RemoteException exce) {
                Log.e(TAG, "saveEntireOppoFile failed!", exce);
                return -1;
            }
        } else {
            Log.w(TAG, "saveEntireOppoFile:service not publish!");
            return -1;
        }
    }
    ...
    public boolean readEntireOppoFile(String sourcePath, String targetPath, boolean deleteSource) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.readEntireOppoFile(sourcePath, targetPath, deleteSource);
            } catch (RemoteException exce) {
                Log.e(TAG, "readEntireOppoFile failed!", exce);
                return false;
            }
        } else {
            Log.w(TAG, "readEntireOppoFile:service not publish!");
            return false;
        }
    }
    ...
    public boolean deleteOppoFile(String filePath) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.deleteOppoFile(filePath);
            } catch (RemoteException exce) {
                Log.e(TAG, "deleteOppoFile failed!", exce);
                return false;
            }
        } else {
            Log.w(TAG, "deleteOppoFile:service not publish!");
            return false;
        }
    }
    ...
    public boolean saveEntireOppoDir(String sourceDir, String targetDir, boolean deleteSource) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.saveEntireOppoDir(sourceDir, targetDir, deleteSource);
            } catch (RemoteException exce) {
                Log.e(TAG, "saveEntireOppoDir failed!", exce);
                return false;
            }
        } else {
            Log.w(TAG, "saveEntireOppoDir:service not publish!");
            return false;
        }
    }
    ...
    public boolean readEntireOppoDir(String sourceDir, String targetDir, boolean deleteSource) {
        ...
        if (iOppoUsageService != null) {
            try {
                return iOppoUsageService.readEntireOppoDir(sourceDir, targetDir, deleteSource);
            } catch (RemoteException exce) {
                Log.e(TAG, "saveEntireOppoDir failed!", exce);
                return false;
            }
