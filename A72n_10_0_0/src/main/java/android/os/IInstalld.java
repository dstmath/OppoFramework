...
public interface IInstalld extends IInterface {
    ...
    void backupAppData(String str, String str2, int i) throws RemoteException;
    ...
    boolean createAppProfile(int i, String str, String str2, String str3, String str4) throws RemoteException;
    ...
    void customCmd(String str, String str2) throws RemoteException;
    ...
    boolean dumpAppClassAndMethod(int i, String str, String str2, String str3, String str4) throws RemoteException;
    ...
    boolean updateAppProfile(String str, int i, int i2, String str2, String str3, String str4) throws RemoteException;
    ...
    public static class Default implements IInstalld {
        ...
        @Override // android.os.IInstalld
        public boolean updateAppProfile(String packageName, int userId, int appId, String profileName, String codePath, String dexMetadata) throws RemoteException {
            return false;
        }

        @Override // android.os.IInstalld
        public boolean dumpAppClassAndMethod(int uid, String packageName, String profilePath, String codePath, String outputMethodPath) throws RemoteException {
            return false;
        }

        @Override // android.os.IInstalld
        public boolean createAppProfile(int uid, String packageName, String hotMethodPath, String codePath, String outputProfilePath) throws RemoteException {
            return false;
        }

        @Override // android.os.IInstalld
        public void customCmd(String apkPath, String cmd) throws RemoteException {
        }

        @Override // android.os.IInstalld
        public void backupAppData(String apkPath, String to, int requestid) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IInstalld {
        ...
        static final int TRANSACTION_backupAppData = 49;
        ...
        static final int TRANSACTION_createAppProfile = 47;
        ...
        static final int TRANSACTION_customCmd = 48;
        ...
        static final int TRANSACTION_dumpAppClassAndMethod = 46;
        ...
        static final int TRANSACTION_updateAppProfile = 45;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        boolean updateAppProfile = updateAppProfile(data.readString(), data.readInt(), data.readInt(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(updateAppProfile ? 1 : 0);
                        return true;
                    case 46:
                        data.enforceInterface(DESCRIPTOR);
                        boolean dumpAppClassAndMethod = dumpAppClassAndMethod(data.readInt(), data.readString(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(dumpAppClassAndMethod ? 1 : 0);
                        return true;
                    case 47:
                        data.enforceInterface(DESCRIPTOR);
                        boolean createAppProfile = createAppProfile(data.readInt(), data.readString(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(createAppProfile ? 1 : 0);
                        return true;
                    case 48:
                        data.enforceInterface(DESCRIPTOR);
                        customCmd(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        backupAppData(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IInstalld {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            boolean updateAppProfile = Stub.getDefaultImpl().updateAppProfile(packageName, userId, appId, profileName, codePath, dexMetadata);
                            _reply.recycle();
                            _data.recycle();
            ...
            public boolean dumpAppClassAndMethod(int uid, String packageName, String profilePath, String codePath, String outputMethodPath) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        _data.writeString(outputMethodPath);
                        try {
                            boolean _result = false;
                            ...
                            boolean dumpAppClassAndMethod = Stub.getDefaultImpl().dumpAppClassAndMethod(uid, packageName, profilePath, codePath, outputMethodPath);
                            _reply.recycle();
                            _data.recycle();
            ...
            public boolean createAppProfile(int uid, String packageName, String hotMethodPath, String codePath, String outputProfilePath) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        _data.writeString(packageName);
                        try {
                            _data.writeString(hotMethodPath);
                            try {
                                _data.writeString(codePath);
                            } catch (Throwable th3) {
                                th = th3;
                    ...
                    try {
                        _data.writeString(outputProfilePath);
                        try {
                            boolean _result = false;
                            ...
                            boolean createAppProfile = Stub.getDefaultImpl().createAppProfile(uid, packageName, hotMethodPath, codePath, outputProfilePath);
                            _reply.recycle();
                            _data.recycle();
            ...
            public void customCmd(String apkPath, String cmd) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().customCmd(apkPath, cmd);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void backupAppData(String apkPath, String to, int requestid) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().backupAppData(apkPath, to, requestid);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
