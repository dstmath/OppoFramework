...
public interface IVoldListener extends IInterface {
    ...
    public static class Default implements IVoldListener {
        ...
        @Override // android.os.IVoldListener
        public void onDiskStateChanged(String volId) throws RemoteException {
        }

        @Override // android.os.IVoldListener
        public void onVolumeChecked(String volId, int type, String diskId, String partGuid) throws RemoteException {
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                        onDiskStateChanged(data.readString());
                        return true;
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                        onVolumeChecked(data.readString(), data.readInt(), data.readString(), data.readString());
                        return true;
                    default:
            ...
            public void onDiskStateChanged(String volId) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(11, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onDiskStateChanged(volId);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onVolumeChecked(String volId, int type, String diskId, String partGuid) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(12, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onVolumeChecked(volId, type, diskId, partGuid);
                    }
                } finally {
                    _data.recycle();
                }
