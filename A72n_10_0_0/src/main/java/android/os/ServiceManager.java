...
public final class ServiceManager {
    ...
    public static IBinder getService(String name) {
        try {
            ...
            if (service == null) {
                service = Binder.allowBlocking(rawGetService(name));
            }
            if (service == null || !((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).checkNeedReplace(name)) {
                return service;
            }
            return ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).getOrCreateFakeBinder(service, name);
