...
public abstract class RuntimePermissionPresenterService extends Service {
    ...
    public final IBinder onBind(Intent intent) {
        return new IRuntimePermissionPresenter.Stub() {
            ...
            static /* synthetic */ void lambda$getAppPermissions$0(Object rec$, String x$0, RemoteCallback x$1) {
                ((RuntimePermissionPresenterService) rec$).getAppPermissions(x$0, x$1);
            }
        };
    }
