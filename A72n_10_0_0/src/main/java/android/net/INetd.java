            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case TRANSACTION_getOemNetd /* 94 */:
                        ...
                        return true;
                    case TRANSACTION_setIPv6DnsConfiguation /* 95 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg010 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        setIPv6DnsConfiguation(_arg010, _arg1, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 96:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 109:
                        ...
                        return true;
                    case TRANSACTION_setNetworkRestrictionMode /* 110 */:
                        data.enforceInterface(DESCRIPTOR);
