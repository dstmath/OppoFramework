...
public class LowpanInterface {
    ...
    public void form(LowpanProvision provision) {
        try {
    ...
    public void join(LowpanProvision provision) {
        try {
    ...
    public void attach(LowpanProvision provision) {
        try {
    ...
    public LowpanCommissioningSession startCommissioningSession(LowpanBeaconInfo beaconInfo) {
        try {
    ...
    public void addOnMeshPrefix(IpPrefix prefix, int flags) {
        try {
    ...
    public void addExternalRoute(IpPrefix prefix, int flags) {
        try {
