...
public abstract class IpMemoryStoreClient {
    ...
    static /* synthetic */ void lambda$findL2Key$6(IIpMemoryStore service, NetworkAttributes attributes, OnL2KeyResponseListener listener) throws RemoteException {
        service.findL2Key(attributes.toParcelable(), OnL2KeyResponseListener.toAIDL(listener));
    }
    ...
    static /* synthetic */ void lambda$retrieveBlob$15(IIpMemoryStore service, String l2Key, String clientId, String name, OnBlobRetrievedListener listener) throws RemoteException {
        service.retrieveBlob(l2Key, clientId, name, OnBlobRetrievedListener.toAIDL(listener));
    }
