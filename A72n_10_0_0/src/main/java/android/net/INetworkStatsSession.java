...
public interface INetworkStatsSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkStatsSession {
        ...
        static final int TRANSACTION_getIncrementForNetwork = 8;
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 8:
                        ...
                        NetworkStats _result8 = getIncrementForNetwork(_arg07);
                        reply.writeNoException();
                        if (_result8 != null) {
                            reply.writeInt(1);
            ...
            public NetworkStats getIncrementForNetwork(NetworkTemplate template) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(8, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getIncrementForNetwork(template);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = NetworkStats.CREATOR.createFromParcel(_reply);
