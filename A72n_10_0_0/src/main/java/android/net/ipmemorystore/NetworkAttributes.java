...
public class NetworkAttributes {
    ...
    public float getNetworkGroupSamenessConfidence(NetworkAttributes o) {
        float samenessScore = samenessContribution(300.0f, this.assignedV4Address, o.assignedV4Address) + samenessContribution(0.0f, this.assignedV4AddressExpiry, o.assignedV4AddressExpiry) + samenessContribution(300.0f, this.groupHint, o.groupHint) + samenessContribution(WEIGHT_DNSADDRESSES, this.dnsAddresses, o.dnsAddresses) + samenessContribution(WEIGHT_MTU, this.mtu, o.mtu);
    ...
    public String toString() {
        StringJoiner resultJoiner = new StringJoiner(StringUtils.SPACE, "{", "}");
