...
public interface IWifiManager extends IInterface {
    ...
    public static class Default implements IWifiManager {
        ...
        @Override // android.net.wifi.IWifiManager
        public boolean setWifiRestrictionList(String callingPackage, List<String> list, String type) throws RemoteException {
            return false;
        }

        @Override // android.net.wifi.IWifiManager
        public List<String> getWifiRestrictionList(String callingPackage, String type) throws RemoteException {
            return null;
        }

        @Override // android.net.wifi.IWifiManager
        public boolean removeFromRestrictionList(String callingPackage, List<String> list, String type) throws RemoteException {
            return false;
        }

        @Override // android.net.wifi.IWifiManager
        public void notifyGameModeState(boolean state, String packageName) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IWifiManager {
        ...
        static final int TRANSACTION_getWifiRestrictionList = 125;
        ...
        static final int TRANSACTION_notifyGameModeState = 127;
        ...
        static final int TRANSACTION_removeFromRestrictionList = 126;
        ...
        static final int TRANSACTION_setWifiRestrictionList = 124;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 16:
                        ...
                        deauthenticateNetwork(_arg015, _arg014);
                        reply.writeNoException();
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 18:
                        ...
                        boolean enableNetwork = enableNetwork(_arg016, _arg014, data.readString());
                        reply.writeNoException();
                    ...
                    case 26:
                        ...
                        boolean wifiEnabled = setWifiEnabled(_arg017, _arg014);
                        reply.writeNoException();
                    ...
                    case 34:
                        ...
                        boolean acquireWifiLock = acquireWifiLock(_arg018, _arg12, _arg2, _arg3);
                        reply.writeNoException();
                    ...
                    case 35:
                        ...
                        updateWifiLockWorkSource(_arg019, _arg1);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 54:
                        ...
                        enableTdlsWithMacAddress(_arg021, _arg014);
                        reply.writeNoException();
                        return true;
                    case 55:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 58:
                        ...
                        enableWifiConnectivityManager(_arg014);
                        reply.writeNoException();
                        return true;
                    case 59:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 72:
                        ...
                        boolean slaAppState = setSlaAppState(_arg022, _arg014);
                        reply.writeNoException();
                    ...
                    case 82:
                        ...
                        int _result31 = enableDualStaByForce(_arg014);
                        reply.writeNoException();
                    ...
                    case 95:
                        ...
                        setNetworkCaptiveState(_arg014);
                        reply.writeNoException();
                        return true;
                    case 96:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 105:
                        ...
                        boolean allDevicesAllowed = setAllDevicesAllowed(_arg023, _arg014);
                        reply.writeNoException();
                    ...
                    case 114:
                        ...
                        List<String> _result42 = getWifiOCloudData(_arg014);
                        reply.writeNoException();
                    ...
                    case 116:
                        ...
                        removeNetworkByGlobalId(_arg024, _arg13, _arg014);
                        reply.writeNoException();
                        return true;
                    case 117:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 124:
                        data.enforceInterface(DESCRIPTOR);
                        boolean wifiRestrictionList = setWifiRestrictionList(data.readString(), data.createStringArrayList(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(wifiRestrictionList ? 1 : 0);
                        return true;
                    case 125:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _result43 = getWifiRestrictionList(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeStringList(_result43);
                        return true;
                    case 126:
                        data.enforceInterface(DESCRIPTOR);
                        boolean removeFromRestrictionList = removeFromRestrictionList(data.readString(), data.createStringArrayList(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(removeFromRestrictionList ? 1 : 0);
                        return true;
                    case 127:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        notifyGameModeState(_arg014, data.readString());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IWifiManager {
            ...
            public boolean setWifiRestrictionList(String callingPackage, List<String> list, String type) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(124, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setWifiRestrictionList(callingPackage, list, type);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public List<String> getWifiRestrictionList(String callingPackage, String type) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(125, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getWifiRestrictionList(callingPackage, type);
                    }
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    _reply.recycle();
            ...
            public boolean removeFromRestrictionList(String callingPackage, List<String> list, String type) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(126, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().removeFromRestrictionList(callingPackage, list, type);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void notifyGameModeState(boolean state, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().notifyGameModeState(state, packageName);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
