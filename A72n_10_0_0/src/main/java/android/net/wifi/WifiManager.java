...
import oppo.net.wifi.WifiHotspotManager;
...
public class WifiManager {
    ...
    public static final int DEFAULT_WIFI_SHARING_NETWORK_ID = -1000;
    @SystemApi
    ...
    public static final long WIFI_FEATURE_DBDC = 8589934592L;
    ...
    private static final String WIFI_FEATURE_WIFI_DBDC = "oppo.wifi.dbdc";
    ...
    public static final String WIFI_SHARING_STATE_CHANGED_ACTION = "oppo.intent.action.wifi.WIFI_SHARING_STATE_CHANGED";
    public static final int WIFI_SHARING_STATE_DISABLED = 111;
    public static final int WIFI_SHARING_STATE_DISABLING = 110;
    public static final int WIFI_SHARING_STATE_ENABLED = 113;
    public static final int WIFI_SHARING_STATE_ENABLING = 112;
    public static final int WIFI_SHARING_STATE_FAILED = 114;
    private static long WIFI_SIGNAL = 93837565;
    ...
    static {
        long j = WIFI_SIGNAL;
        OPPO_MIN_RSSI = (((int) j) / 1000000) * -1;
        OPPO_MIDDLE1_RSSI = (((int) (j % TimeUtils.NANOS_PER_MS)) / 10000) * -1;
        OPPO_MIDDLE2_RSSI = (((int) (j % JobInfo.MIN_BACKOFF_MILLIS)) / 100) * -1;
        OPPO_MAX_RSSI = (((int) j) % 100) * -1;
    }
    ...
    public WifiManager(Context context, IWifiManager service, Looper looper) {
        ...
        this.mWifiHotspotManager = new WifiHotspotManager(service);
    }
    ...
    public boolean isDBSSupported() {
        return this.mContext.getPackageManager().hasSystemFeature(WIFI_FEATURE_WIFI_DBDC);
    }

    public boolean isWIFI6Supported() {
        return this.mContext.getPackageManager().hasSystemFeature("oppo.wlan.wifi6.support");
    }
    ...
    public boolean saveConfiguration() {
        ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(68, Binder.getCallingUid());
        return false;
    }
    ...
    public static int calculateSignalLevel(int rssi, int numLevels) {
        if (numLevels == 5) {
            int i = OPPO_MIDDLE1_RSSI;
            if (rssi <= i) {
                return 1;
            }
            if (rssi > i && rssi <= OPPO_MIDDLE2_RSSI) {
                return 2;
            }
    ...
    public List<HotspotClient> getHotspotClients() {
        return this.mWifiHotspotManager.getHotspotClients();
    }

    public List<HotspotClient> getBlockedHotspotClients() {
        return this.mWifiHotspotManager.getBlockedHotspotClients();
    }

    public boolean blockClient(HotspotClient client) {
        return this.mWifiHotspotManager.blockClient(client);
    }

    public boolean unblockClient(HotspotClient client) {
        return this.mWifiHotspotManager.unblockClient(client);
    }
    ...
    public boolean startWifiSharing(WifiConfiguration wifiConfig) {
        try {
            return this.mService.startWifiSharing(wifiConfig);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean stopWifiSharing() {
        try {
            return this.mService.stopWifiSharing();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public WifiConfiguration getWifiSharingConfiguration() {
        try {
            return this.mService.getWifiSharingConfiguration();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean setWifiSharingConfiguration(WifiConfiguration wifiConfig) {
        try {
            this.mService.setWifiSharingConfiguration(wifiConfig);
            return true;
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    /* access modifiers changed from: private */
    public class StaStateCallbackProxy extends IStaStateCallback.Stub {
        ...
        @Override // android.net.wifi.IStaStateCallback
        public void onStaToBeOff() {
            if (WifiManager.this.mVerboseLoggingEnabled) {
                Log.v(WifiManager.TAG, "StaStateCallbackProxy: onStaToBeOff");
            }
            this.mHandler.post(new Runnable() {
                /* class android.net.wifi.$$Lambda$WifiManager$StaStateCallbackProxy$9XmQJIMCmQWVaqMac1LgNg2oOp0 */

                public final void run() {
                    WifiManager.StaStateCallbackProxy.this.lambda$onStaToBeOff$0$WifiManager$StaStateCallbackProxy();
                }
            });
        }

        public /* synthetic */ void lambda$onStaToBeOff$0$WifiManager$StaStateCallbackProxy() {
            this.mCallback.onStaToBeOff();
        }
    }

    public void registerStaStateCallback(StaStateCallback callback, Handler handler) {
        if (callback != null) {
            Log.v(TAG, "registerStaStateCallback: callback=" + callback + ", handler=" + handler);
            try {
                this.mService.registerStaStateCallback(new Binder(), new StaStateCallbackProxy(handler == null ? this.mContext.getMainLooper() : handler.getLooper(), callback), callback.hashCode());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        } else {
    ...
    public void unregisterStaStateCallback(StaStateCallback callback) {
        if (callback != null) {
            Log.v(TAG, "unregisterStaStateCallback: callback=" + callback);
            try {
                this.mService.unregisterStaStateCallback(callback.hashCode());
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        } else {
    ...
    public boolean setSlaAppState(String pkgName, boolean enabled) {
        try {
            return this.mService.setSlaAppState(pkgName, enabled);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public boolean getSlaAppState(String pkgName) {
        try {
            return this.mService.getSlaAppState(pkgName);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public boolean isSlaSupported() {
        try {
            return this.mService.isSlaSupported();
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public boolean isDualStaSupported() {
        try {
            return this.mService.isDualStaSupported();
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public int enableDualSta() {
        try {
            return this.mService.enableDualSta();
        } catch (RemoteException e) {
            return -1;
        }
    }

    public int enableDualStaByForce(boolean force) {
        try {
            return this.mService.enableDualStaByForce(force);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    public WifiInfo getOppoSta2ConnectionInfo() {
        try {
            return this.mService.getOppoSta2ConnectionInfo(this.mContext.getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public String getOppoSta2CurConfigKey() {
        try {
            return this.mService.getOppoSta2CurConfigKey();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<String> getWifiOCloudData(boolean dirtyOnly) {
        try {
            return this.mService.getWifiOCloudData(dirtyOnly);
        } catch (RemoteException e) {
            return null;
        }
    }

    public void updateGlobalId(int itemId, String globalId) {
        try {
    ...
    public void setPowerSavingMode(boolean mode) {
        ...
        try {
            iWifiManager.setPowerSavingMode(mode);
        } catch (RemoteException e) {
        }
    }
    ...
    public void setNetworkCaptiveState(boolean captiveState) {
        try {
            this.mService.setNetworkCaptiveState(captiveState);
        } catch (RemoteException e) {
        }
    }
    ...
    public boolean getNetworkEverCaptiveState() {
        try {
            return this.mService.getNetworkEverCaptiveState();
        } catch (RemoteException e) {
            return false;
        }
    }

    public boolean setWifiRestrictionList(String packageName, List<String> list, String type) {
        try {
            return this.mService.setWifiRestrictionList(packageName, list, type);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public List<String> getWifiRestrictionList(String packageName, String type) {
        try {
            return this.mService.getWifiRestrictionList(packageName, type);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public boolean removeFromRestrictionList(String packageName, List<String> list, String type) {
        try {
            return this.mService.removeFromRestrictionList(packageName, list, type);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void notifyGameModeState(boolean state, String packageName) {
        try {
            this.mService.notifyGameModeState(state, packageName);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
