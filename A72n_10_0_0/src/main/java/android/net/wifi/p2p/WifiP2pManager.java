        ...
        public class P2pHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.SET_FREQ_BAND_TYPE_FAILED /* 139376 */:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.SET_FREQ_BAND_TYPE_SUCCESS /* 139375 */:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.RESPONSE_DEVICE_INFO /* 139362 */:
                        ...
                        return;
                    case WifiP2pManager.ADD_PERSISTENT_GROUP_FAILED /* 139367 */:
                        if (listener != null) {
                            ((ActionListener) listener).onFailure(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_ADD_PERSISTENT_GROUP /* 139369 */:
