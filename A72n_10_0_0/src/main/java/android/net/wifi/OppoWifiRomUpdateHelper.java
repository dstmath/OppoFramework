...
public class OppoWifiRomUpdateHelper extends OppoRomUpdateHelper implements IWifiRomUpdateHelper {
    ...
    private String[] mLmParams = {"1350#1200#0#4#17f10304", "1400#1250#0#4#17f10305", "1800#1250#0#4#17f10306", "1800#1250#0#4#17f10307"};
    private String[] mMtuServer = {"conn1.oppomobile.com", "conn2.oppomobile.com", "www.baidu.com", "www.jd.com", "www.taobao.com", "www.qq.com"};
    private String[] mSkipDestroySocketApps = {"com.tencent.mm", "com.tencent.mobileqq", "com.alibaba.android.rimet"};
    private String[] mSlaApps = {"com.heytap.browser", "com.android.browser", "com.coloros.browser", "com.UCMobile", "com.tencent.mm", "com.tencent.mobileqq", "com.sina.weibo", "com.netease.newsreader.activity", "com.ss.android.article.news", "com.jingdong.app.mall", "com.taobao.taobao", "com.tmall.wireless", "com.achievo.vipshop", "com.xunmeng.pinduoduo", "com.baidu.tieba", "com.qzone", "com.zhihu.android", "com.xingin.xhs", "com.baidu.browser.apps", "com.tencent.mtt", "com.eg.android.AlipayGphone", "me.ele", "com.sankuai.meituan", "com.sankuai.meituan.takeoutnew", "com.dianping.v1", "com.moji.mjweather", "ctrip.android.view", "com.Qunar", "com.tencent.news", "com.tencent.reading"};
                    ...
                    if (eventType != 0) {
                        if (eventType == 2) {
                            ...
                            if ("NETWORK_SLA_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaApps = mText.split(",");
                            } else if ("NETWORK_SLA_APPS_EXP".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaAppsExp = mText.split(",");
                            } else if ("NETWORK_SLA_BLACK_LIST".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaBlackList = mText.split(",");
                            } else if ("NETWORK_SLA_GAME_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaGameApps = mText.split(",");
                            } else if ("NETWORK_SLA_GAME_APPS_EXP".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaGameAppsExp = mText.split(",");
                            } else if ("NETWORK_SLA_ENABLED_MCC".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaEnabledMCC = mText.split(",");
                            } else if ("OPPO_DUAL_STA_DISABLED_MCC".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDualStaDisableMcc = mText.split(",");
                            } else if ("NETWORK_SLA_PARAMS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSlaParams = mText.split(",");
                                ...
                                OppoWifiRomUpdateHelper.this.mSlaGameParams = mText.split(",");
                            } else if ("NETWORK_DUAL_STA_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDualStaApps = mText.split(",");
                            } else if ("NETWORK_DUAL_STA_APPS_EXP".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDualStaAppsExp = mText.split(",");
                            } else if ("NETWORK_DUAL_STA_BLACK_LIST".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDualStaBlackList = mText.split(",");
                            } else if ("NETWORK_WECHAT_LM_PARAMS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mLmParams = mText.split(",");
                            } else if ("NETWORK_VIDEO_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mVideoApps = mText.split(",");
                            } else if ("NETWORK_DOWNLOAD_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDownloadApps = mText.split(",");
                            } else if ("NETWORK_DUAL_STA_CAP_HOST_BLACK_LIST".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mDualStaCapHostBlackList = mText.split(",");
                            } else if ("NETWORK_SKIP_DESTROY_SOCKET_APPS".equals(mTagName)) {
                                OppoWifiRomUpdateHelper.this.mSkipDestroySocketApps = mText.split(",");
