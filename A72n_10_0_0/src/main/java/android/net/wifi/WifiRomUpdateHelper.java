...
public class WifiRomUpdateHelper extends RomUpdateHelper {
    ...
    public static final String CONNECT_RESTRICTION_APP = "CONNECT_RESTRICTION_APP";
    ...
    public static final String MAX_RUS_PERIODIC_SCAN_INTERVAL_MS = "MAX_RUS_PERIODIC_SCAN_INTERVAL_MS";
    ...
    private String[] mDownloadApps = null;
    private String[] mDualStaApps = {"com.heytap.browser", BrowserContract.AUTHORITY, "com.coloros.browser", "com.UCMobile", LMManager.MM_PACKAGENAME, LMManager.QQ_PACKAGENAME, "com.sina.weibo", "com.netease.newsreader.activity", "com.ss.android.article.news", "com.jingdong.app.mall", "com.taobao.taobao", "com.tmall.wireless", "com.achievo.vipshop", "com.xunmeng.pinduoduo", "com.baidu.tieba", "com.qzone", "com.zhihu.android", "com.xingin.xhs", "com.baidu.browser.apps", "com.tencent.mtt", "com.eg.android.AlipayGphone", "me.ele", "com.sankuai.meituan", "com.sankuai.meituan.takeoutnew", "com.dianping.v1", "com.moji.mjweather", "ctrip.android.view", "com.Qunar", "com.tencent.news", "com.tencent.reading", "com.tencent.qqlive", "com.youku.phone", "com.qiyi.video", "com.sohu.sohuvideo", "com.tencent.android.qqdownloader", "com.oppo.market", "com.nearme.gamecenter", "com.xunlei.downloadprovider", "tv.danmaku.bili", "com.ss.android.ugc.aweme", "com.smile.gifmaker", "air.tv.douyu.android", "com.ss.android.ugc.live", "com.hunantv.imgo.activity", "com.ss.android.article.video", "com.duowan.kiwi", "com.netease.cloudmusic", "com.kugou.android", "com.tencent.qqmusic"};
    private String[] mDualStaAppsExp = {"com.whatsapp", "in.mohalla.sharechat", "app.buzz.share", "com.facebook.orca", "com.UCMobile.intl", "com.mcent.browser", "com.redefine.welike", "com.instagram.android", "com.heytap.browser", BrowserContract.AUTHORITY, "com.coloros.browser", "com.android.chrome", "com.facebook.katana", "org.mozilla.firefox", "com.opera.browser"};
    private String[] mDualStaBlackList = null;
    private String[] mDualStaCapHostBlackList = null;
    private String[] mDualStaDisableMcc = {"200-299"};
    private HashMap<String, String> mKeyValuePair = new HashMap<>();
    private String[] mLmParams = {"1350#1200#0#4#17f10304", "1360#1250#0#4#17f10305", "1500#1250#0#4#17f10306"};
    private String[] mMtuServer = {"conn1.oppomobile.com", "conn2.oppomobile.com", "www.baidu.com", "www.jd.com", "www.taobao.com", "www.qq.com"};
    private String[] mSkipDestroySocketApps = {LMManager.MM_PACKAGENAME, LMManager.QQ_PACKAGENAME, "com.alibaba.android.rimet"};
    private String[] mSlaApps = {"com.heytap.browser", BrowserContract.AUTHORITY, "com.coloros.browser", "com.UCMobile", LMManager.MM_PACKAGENAME, LMManager.QQ_PACKAGENAME, "com.sina.weibo", "com.netease.newsreader.activity", "com.ss.android.article.news", "com.jingdong.app.mall", "com.taobao.taobao", "com.tmall.wireless", "com.achievo.vipshop", "com.xunmeng.pinduoduo", "com.baidu.tieba", "com.qzone", "com.zhihu.android", "com.xingin.xhs", "com.baidu.browser.apps", "com.tencent.mtt", "com.eg.android.AlipayGphone", "me.ele,com.sankuai.meituan", "com.sankuai.meituan.takeoutnew", "com.dianping.v1", "com.moji.mjweather", "ctrip.android.view", "com.Qunar", "com.tencent.news", "com.tencent.reading"};
    private String[] mSlaAppsExp = {"com.whatsapp", "in.mohalla.sharechat", "app.buzz.share", "com.facebook.orca", "com.UCMobile.intl", "com.mcent.browser", "com.redefine.welike", "com.instagram.android", BrowserContract.AUTHORITY, "com.coloros.browser", "com.android.chrome", "com.facebook.katana", "org.mozilla.firefox", "com.opera.browser", "com.heytap.browser"};
    private String[] mSlaBlackList = null;
    private String[] mSlaEnabledMCC = {"460", "404-405-406"};
    private String[] mSlaGameApps = {"not.defined", "com.tencent.tmgp.sgame", "com.tencent.tmgp.pubgmhd"};
    private String[] mSlaGameAppsExp = {"not.defined", "not.defined", "com.tencent.ig"};
    private String[] mSlaGameParams = {"4#8#0000000100010003", "4#8#000003e900040003", "5#5#0864100118", "5#5#0865100018"};
    private String[] mSlaParams = {"200", "500", "1000", "500", "230", "200", "220", "55", "75", "2000", "2000", "200", "55"};
    ...
    private String[] mVideoApps = null;
    ...
    private void setSmartBWParams(String text) {
        String[] params;
                    ...
                    if (eventType != 0) {
                        if (eventType == 2) {
                            ...
                            if ("NETWORK_SLA_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_APPS_EXP".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaAppsExp = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_BLACK_LIST".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaBlackList = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_GAME_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaGameApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_GAME_APPS_EXP".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaGameAppsExp = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_ENABLED_MCC".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaEnabledMCC = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("OPPO_DUAL_STA_DISABLED_MCC".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDualStaDisableMcc = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SLA_PARAMS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSlaParams = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                                ...
                                WifiRomUpdateHelper.this.mSlaGameParams = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_DUAL_STA_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDualStaApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_DUAL_STA_APPS_EXP".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDualStaAppsExp = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_DUAL_STA_BLACK_LIST".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDualStaBlackList = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_WECHAT_LM_PARAMS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mLmParams = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_SKIP_DESTROY_SOCKET_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mSkipDestroySocketApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_VIDEO_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mVideoApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_DOWNLOAD_APPS".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDownloadApps = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
                            } else if ("NETWORK_DUAL_STA_CAP_HOST_BLACK_LIST".equals(mTagName)) {
                                WifiRomUpdateHelper.this.mDualStaCapHostBlackList = mText.split(SmsManager.REGEX_PREFIX_DELIMITER);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setSpeedRttParams(String text) {
        String[] params;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setDefaultMacRandomizationSetting(String value) {
        int result = 0;
        try {
