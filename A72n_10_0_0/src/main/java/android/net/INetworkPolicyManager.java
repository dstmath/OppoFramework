            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 13:
                        ...
                        onTetheringChanged(_arg04, _arg03);
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 23:
                        ...
                        boolean isUidNetworkingBlocked = isUidNetworkingBlocked(_arg05, _arg03);
                        reply.writeNoException();
                        reply.writeInt(isUidNetworkingBlocked ? 1 : 0);
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        boolean gameSpaceMode = getGameSpaceMode();
                        reply.writeNoException();
                        reply.writeInt(gameSpaceMode ? 1 : 0);
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
        ...
        public static class Proxy implements INetworkPolicyManager {
            ...
            public boolean getGameSpaceMode() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(24, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getGameSpaceMode();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void setGameSpaceMode(boolean gameMode) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setGameSpaceMode(gameMode);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
