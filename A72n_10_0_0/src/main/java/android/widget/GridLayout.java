...
public class GridLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r8v3 android.widget.GridLayout$Interval: [D('targetHeight' int), D('rowSpan' android.widget.GridLayout$Interval)] */
    /* JADX INFO: Multiple debug info for r0v15 int: [D('cy' int), D('alignmentOffsetY' int)] */
    /* access modifiers changed from: protected */
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (cx2 < N) {
            ...
            if (c.getVisibility() == 8) {
                ...
                c.layout(cx, alignmentOffsetY2, cx + width, alignmentOffsetY2 + height);
            }
            cx2 = i + 1;
            gridLayout = this;
