...
public class RelativeLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r19v1 int: [D('layoutDirection' int), D('bottom' int)] */
    /* JADX INFO: Multiple debug info for r3v3 int: [D('myHeight' int), D('bottom' int)] */
    ...
    public static class DependencyGraph {
        ...
        /* JADX INFO: Multiple debug info for r3v4 java.util.ArrayDeque<android.widget.RelativeLayout$DependencyGraph$Node>: [D('roots' java.util.ArrayDeque<android.widget.RelativeLayout$DependencyGraph$Node>), D('i' int)] */
