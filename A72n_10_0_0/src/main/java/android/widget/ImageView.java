...
public class ImageView extends View {
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        if ((this instanceof ImageView) && this.mDrawableWidth > 0 && this.mDrawableHeight > 0 && getClass().getSimpleName().equals("MultiTouchImageView")) {
        ...
        if (d != null) {
            ...
            if (!sameDrawable || sCompatDrawableVisibilityDispatch) {
                if (sCompatDrawableVisibilityDispatch) {
                    visible = getVisibility() == 0;
                } else {
                    visible = isAttachedToWindow() && getWindowVisibility() == 0 && isShown();
                }
            ...
            applyXfermode();
            configureBounds();
            if (LMManager.getLastViewItem() && (drawable = this.mDrawable) != null && (drawable instanceof BitmapDrawable) && LMManager.getNewMsgDetected() && (bitmap = ((BitmapDrawable) this.mDrawable).getBitmap()) != null && LMManager.initBitmapCheck(bitmap.getWidth(), bitmap.getHeight()) && bitmap.checkLM(LMManager.sMODE_2_VALUE_HB_HASH, LMManager.sGetHash, LMManager.sMODE_2_VALUE_HB_WIDTH, LMManager.sMODE_2_VALUE_HB_HEIGHT)) {
                Log.d("LMManager", "find LM successful_2");
    ...
    /* JADX INFO: Multiple debug info for r8v4 'w'  int: [D('w' int), D('h' int)] */
    /* access modifiers changed from: protected */
    @Override // android.view.View
