...
public class ListView extends AbsListView {
    ...
    /* JADX INFO: Multiple debug info for r1v9 boolean: [D('index' int), D('dataChanged' boolean)] */
    ...
    /* JADX INFO: Multiple debug info for r13v20 int: [D('listBottom' int), D('nextIndex' int)] */
                        ...
                        if (!drawDividers2 || bottom2 >= listBottom2) {
                            ...
                            if (adapter2.isEnabled(itemIndex)) {
                                if (headerDividers || (!isHeader && nextIndex >= headerCount)) {
                                    if (isLastItem || (adapter2.isEnabled(nextIndex) && (footerDividers2 || (!isFooter && nextIndex < footerLimit)))) {
                                        bounds.top = bottom2;
                    ...
                    if ((headerDividers || !isHeader2) && (footerDividers2 || !isFooter2)) {
                        ...
                        if (drawDividers2) {
                            ...
                            if (top > effectivePaddingTop2) {
                                ...
                                start = start2;
                                int previousIndex = itemCount4 - 1;
                                if (!adapter.isEnabled(itemCount4)) {
