...
public class GridView extends AbsListView {
    ...
    /* JADX INFO: Multiple debug info for r10v0 int: [D('rowDelta' int), D('invertedSelection' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v1 boolean: [D('index' int), D('dataChanged' boolean)] */
    /* access modifiers changed from: protected */
    ...
    /* JADX INFO: Multiple debug info for r4v7 int: [D('w' int), D('childBottom' int)] */
    ...
    /* access modifiers changed from: protected */
    @Override // android.view.OppoBaseView, android.widget.AbsListView, android.view.View
