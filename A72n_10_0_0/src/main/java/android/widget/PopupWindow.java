...
public class PopupWindow {
    ...
    public boolean findDropDownPosition(View anchor, WindowManager.LayoutParams outParams, int xOffset, int yOffset, int width, int height, int gravity, boolean allowScroll) {
        ...
        if (!fitsVertical || !fitsHorizontal) {
            ...
            char c = r19 == true ? 1 : 0;
            char c2 = r19 == true ? 1 : 0;
            char c3 = r19 == true ? 1 : 0;
            char c4 = r19 == true ? 1 : 0;
            layoutParams = layoutParams2;
            tryFitVertical(outParams, yOffset2, height2, anchorHeight, drawingLocation[c], screenLocation[r19], displayFrame.top, displayFrame.bottom, this.mClipToScreen);
