...
public final class Magnifier {
    ...
    static Builder createBuilderWithOldMagnifierDefaults(View view) {
        ...
        params.mWidth = ((IColorMagnifierHooks) OppoFeatureCache.getOrCreate(IColorMagnifierHooks.DEFAULT, new Object[0])).getMagnifierWidth(a, context);
        params.mHeight = ((IColorMagnifierHooks) OppoFeatureCache.getOrCreate(IColorMagnifierHooks.DEFAULT, new Object[0])).getMagnifierHeight(a, context);
