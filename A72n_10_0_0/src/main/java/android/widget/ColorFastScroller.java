...
class ColorFastScroller extends FastScroller {
    private static Property<View, Integer> BOTTOM = new IntProperty<View>("bottom") {
        /* class android.widget.ColorFastScroller.AnonymousClass7 */
    ...
    private static Property<View, Integer> LEFT = new IntProperty<View>("left") {
        /* class android.widget.ColorFastScroller.AnonymousClass4 */
    ...
    private static Property<View, Integer> RIGHT = new IntProperty<View>("right") {
        /* class android.widget.ColorFastScroller.AnonymousClass6 */
    ...
    private static Property<View, Integer> TOP = new IntProperty<View>("top") {
        /* class android.widget.ColorFastScroller.AnonymousClass5 */
    ...
    private final Runnable mDeferHide = new Runnable() {
        /* class android.widget.ColorFastScroller.AnonymousClass1 */
    ...
    private final Animator.AnimatorListener mSwitchPrimaryListener = new AnimatorListenerAdapter() {
        /* class android.widget.ColorFastScroller.AnonymousClass2 */

        public void onAnimationEnd(Animator animation) {
            ColorFastScroller colorFastScroller = ColorFastScroller.this;
            colorFastScroller.mShowingPrimary = !colorFastScroller.mShowingPrimary;
        }
    };
    ...
    public ColorFastScroller(AbsListView listView, int styleResId) {
        ...
        this.mMinimumTouchTarget = listView.getResources().getDimensionPixelSize(17105152);
        setStyle(styleResId);
    ...
    public void setStyle(int resId) {
        ...
        if (absListView != null) {
            TypedArray ta = absListView.getContext().obtainStyledAttributes(null, R.styleable.FastScroll, 16843767, resId);
    ...
    private void transitionToHidden() {
        ...
        groupAnimatorOfFloat(View.TRANSLATION_X, (float) (this.mLayoutFromRight ? this.mThumbImage.getWidth() : -this.mThumbImage.getWidth()), this.mThumbImage, this.mTrackImage).setDuration(300);
        this.mDecorAnimation = new AnimatorSet();
        this.mDecorAnimation.playTogether(fadeOut);
        this.mDecorAnimation.addListener(new AnimatorListenerAdapter() {
            /* class android.widget.ColorFastScroller.AnonymousClass3 */

            public void onAnimationEnd(Animator animation) {
                if (ColorFastScroller.this.mState == 3) {
                    ColorFastScroller.this.mState = 0;
                }
            }
        });
    ...
    private void transitionToVisible() {
        ...
        groupAnimatorOfFloat(View.TRANSLATION_X, 0.0f, this.mThumbImage, this.mTrackImage).setDuration(150);
        this.mDecorAnimation = new AnimatorSet();
    ...
    private float getPosFromItemCount(int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        if (visibleItemCount != 0) {
            if (totalItemCount != 0) {
                if ((sectionIndexer == null || (objArr = this.mSections) == null || objArr.length <= 0) ? false : true) {
                    if (this.mMatchDragPosition) {
                        ...
                        if (this.mList.getClipToPadding()) {
                            ...
                            int maxSize2 = lastChild.getHeight() + bottomPadding;
                        ...
                        return result + ((1.0f - result) * (((float) currentVisibleSize) / ((float) totalItemCount2)));
                    }
                }
                ...
                if (child2 == null || child2.getHeight() == 0) {
                    ...
                    opporesult = (((float) firstVisibleItem) + (((float) (this.mList.getPaddingTop() - child2.getTop())) / ((float) child2.getHeight()))) / ((float) (totalItemCount - (this.mList.getHeight() / child2.getHeight())));
                }
                if (opporesult > 1.0f) {
                    return 1.0f;
                }
    ...
    public boolean onTouchEvent(MotionEvent me) {
        ...
        } else if (isPointInside(me.getX(), me.getY()) && !this.mList.isInScrollingContainer() && this.mState != 0) {
            beginDrag();
            return true;
        }
        return false;
