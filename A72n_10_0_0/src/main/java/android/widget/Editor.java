...
public class Editor {
    ...
    /* JADX INFO: Multiple debug info for r6v7 int: [D('urlSpan' android.text.style.URLSpan), D('selectionEnd' int)] */
    /* access modifiers changed from: package-private */
    ...
    public void invalidateActionModeAsync() {
        TextView textView = this.mTextView;
        if (textView == null || (textView.getSelectionEnd() >= 0 && this.mTextView.getSelectionEnd() >= 0)) {
    ...
    /* JADX INFO: Multiple debug info for r1v3 int: [D('newCursorPosition' int), D('i' int)] */
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    ...
    public final class SelectionHandleView extends HandleView {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:71:0x0130, code lost:
            if (r23.this$0.mTextView.canScrollHorizontally(r15 ? -1 : 1) != false) goto L_0x0132;
         */
        @Override // android.widget.Editor.HandleView
        public void updatePosition(float x, float y, boolean fromTouchScreen) {
            boolean isExpanding;
