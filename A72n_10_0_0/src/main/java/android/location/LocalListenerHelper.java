...
abstract class LocalListenerHelper<TListener> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: android.location.LocalListenerHelper<TListener> */
        ...
        for (final Map.Entry<TListener, Handler> listener : listeners) {
            if (listener.getValue() == null) {
                ...
                listener.getValue().post(new Runnable() {
                    /* class android.location.LocalListenerHelper.AnonymousClass1 */
