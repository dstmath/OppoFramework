...
public interface ILocationManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILocationManager {
        ...
        static final int TRANSACTION_enableVerboseLogging = 50;
        ...
        static final int TRANSACTION_getInUsePackagesList = 53;
        static final int TRANSACTION_getLastLocation = 5;
        static final int TRANSACTION_getLocAppsOp = 51;
        ...
        static final int TRANSACTION_getVerboseLoggingLevel = 49;
        ...
        static final int TRANSACTION_setLocAppsOp = 52;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        ILocationListener _arg18 = ILocationListener.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg2 = PendingIntent.CREATOR.createFromParcel(data);
                        } else {
                            _arg2 = null;
                        }
                        requestLocationUpdates(_arg0, _arg18, _arg2, data.readString());
                    ...
                    case 2:
                        ...
                        removeUpdates(_arg09, _arg1, data.readString());
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 9:
                        data.enforceInterface(DESCRIPTOR);
                        double _arg010 = data.readDouble();
                        ...
                        String _result2 = getFromLocation(_arg010, _arg19, _arg25, _arg3, arrayList);
                        reply.writeNoException();
                    ...
                    case 10:
                        ...
                        String _result3 = getFromLocationName(_arg011, _arg110, _arg26, _arg32, _arg4, _arg5, _arg6, arrayList2);
                        reply.writeNoException();
                    ...
                    case 23:
                        ...
                        boolean startGnssBatch = startGnssBatch(_arg012, _arg17, data.readString());
                        reply.writeNoException();
                    ...
                    case 28:
                        ...
                        List<String> _result9 = getProviders(_arg07, _arg17);
                        reply.writeNoException();
                    ...
                    case 29:
                        ...
                        String _result10 = getBestProvider(_arg08, _arg17);
                        reply.writeNoException();
                    ...
                    case 34:
                        ...
                        setExtraLocationControllerPackageEnabled(_arg17);
                        reply.writeNoException();
                        return true;
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 38:
                        ...
                        addTestProvider(_arg013, _arg14, data.readString());
                        reply.writeNoException();
                        return true;
                    case 39:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 40:
                        ...
                        setTestProviderLocation(_arg014, _arg15, data.readString());
                        reply.writeNoException();
                        return true;
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setTestProviderEnabled(_arg015, _arg17, data.readString());
                        reply.writeNoException();
                        return true;
                    case 42:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 44:
                        ...
                        setTestProviderStatus(_arg016, _arg111, _arg23, data.readLong(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean sendExtraCommand = sendExtraCommand(_arg017, _arg112, _arg24);
                        reply.writeNoException();
                    ...
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                        int _result17 = getVerboseLoggingLevel();
                        reply.writeNoException();
                    ...
                    case 51:
                        ...
                        LocAppsOp _arg113 = new LocAppsOp();
                        getLocAppsOp(_arg018, _arg113);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 52:
                        ...
                        if (data.readInt() != 0) {
                            _arg16 = LocAppsOp.CREATOR.createFromParcel(data);
                        } else {
                            _arg16 = null;
                        }
                        setLocAppsOp(_arg019, _arg16);
                        reply.writeNoException();
                        return true;
                    case 53:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _result18 = getInUsePackagesList();
                        reply.writeNoException();
        ...
        public static class Proxy implements ILocationManager {
            ...
            public void getLocAppsOp(int flag, LocAppsOp locAppsOp) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().getLocAppsOp(flag, locAppsOp);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setLocAppsOp(int cmd, LocAppsOp locAppsOp) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setLocAppsOp(cmd, locAppsOp);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
