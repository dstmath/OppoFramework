...
public class LocationManager {
    ...
    public boolean setProviderEnabledForUser(String provider, boolean enabled, UserHandle userHandle) {
        ...
        sb.append(enabled ? "+" : NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
        sb.append(provider);
    ...
    public Location getLastKnownLocation(String provider) {
        ...
        try {
            ...
            Log.e(TAG, "ClassCastException:" + packageName, e2);
            throw e2;
        } catch (Exception e3) {
            Log.e(TAG, "Exception:" + packageName, e3);
            throw e3;
        }
    }
    ...
    public void getLocAppsOp(int flag, LocAppsOp locAppsOp) {
        try {
            this.mService.getLocAppsOp(flag, locAppsOp);
        } catch (RemoteException e) {
            Log.e(TAG, "RemoteException", e);
        }
    }
    ...
    public void setLocAppsOp(int cmd, LocAppsOp locAppsOp) {
        try {
            this.mService.setLocAppsOp(cmd, locAppsOp);
        } catch (RemoteException e) {
            Log.e(TAG, "RemoteException", e);
        }
    }
    ...
    public List<String> getInUsePackagesList() {
        try {
            return this.mService.getInUsePackagesList();
        } catch (RemoteException e) {
            Log.e(TAG, "RemoteException", e);
            return null;
        }
