...
public final class GestureUtils {
    ...
    /* JADX INFO: Multiple debug info for r3v3 int: [D('size' int), D('stroke' android.gesture.GestureStroke)] */
    /* JADX INFO: Multiple debug info for r5v2 float[]: [D('gestureWidth' float), D('pts' float[])] */
    /* JADX INFO: Multiple debug info for r5v19 float: [D('pts' float[]), D('ypos' float)] */
