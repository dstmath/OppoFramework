...
public final class SmsManager extends OppoSmsManager {
    ...
    public static Bundle getMmsConfig(BaseBundle config) {
        ...
        filtered.putBoolean(CONFIG_MMS_ROAMING_AUTO_RETRIEVE_BY_DEFAULT, config.getBoolean(CONFIG_MMS_ROAMING_AUTO_RETRIEVE_BY_DEFAULT));
        filtered.putBoolean(CONFIG_SMS_ENCODING_CHANGEABLE, config.getBoolean(CONFIG_SMS_ENCODING_CHANGEABLE));
        filtered.putBoolean(CONFIG_GROUP_CHAT_DEFAULTS_TO_MMS, config.getBoolean(CONFIG_GROUP_CHAT_DEFAULTS_TO_MMS));
        filtered.putBoolean(CONFIG_ALLOW_CHANGING_MMS_ROAMING_AUTO_RETRIEVE, config.getBoolean(CONFIG_ALLOW_CHANGING_MMS_ROAMING_AUTO_RETRIEVE));
        return filtered;
    }
