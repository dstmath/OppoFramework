...
public class CarrierConfigManager {
    ...
    public static final class Gps {
        ...
        public static PersistableBundle getDefaults() {
            ...
            defaults.putString(KEY_SUPL_MODE_STRING, WifiEnterpriseConfig.ENGINE_ENABLE);
            defaults.putString(KEY_SUPL_ES_STRING, WifiEnterpriseConfig.ENGINE_ENABLE);
            defaults.putString(KEY_LPP_PROFILE_STRING, WifiEnterpriseConfig.ENGINE_DISABLE);
            defaults.putString(KEY_USE_EMERGENCY_PDN_FOR_EMERGENCY_SUPL_STRING, WifiEnterpriseConfig.ENGINE_ENABLE);
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_VILTE_DATA_IS_METERED_BOOL, false);
        sDefaults.putBoolean(KEY_CARRIER_WFC_IMS_AVAILABLE_BOOL, false);
        ...
        sDefaults.putBoolean(KEY_IGNORE_SIM_NETWORK_LOCKED_EVENTS_BOOL, true);
        ...
        sDefaults.putStringArray(KEY_CARRIER_METERED_APN_TYPES_STRINGS, new String[]{PhoneConstants.APN_TYPE_DEFAULT, PhoneConstants.APN_TYPE_MMS, PhoneConstants.APN_TYPE_DUN, PhoneConstants.APN_TYPE_SUPL});
        sDefaults.putStringArray(KEY_CARRIER_METERED_ROAMING_APN_TYPES_STRINGS, new String[]{PhoneConstants.APN_TYPE_DEFAULT, PhoneConstants.APN_TYPE_MMS, PhoneConstants.APN_TYPE_DUN, PhoneConstants.APN_TYPE_SUPL});
        sDefaults.putIntArray(KEY_ONLY_SINGLE_DC_ALLOWED_INT_ARRAY, new int[]{4, 5, 6, 7, 8, 12});
        sDefaults.putStringArray(KEY_GSM_ROAMING_NETWORKS_STRING_ARRAY, null);
        sDefaults.putStringArray(KEY_GSM_NONROAMING_NETWORKS_STRING_ARRAY, null);
        sDefaults.putString(KEY_CONFIG_IMS_PACKAGE_OVERRIDE_STRING, IsRsaOpeartor());
        ...
        if (SystemProperties.get("ro.vendor.mtk_telephony_add_on_policy", WifiEnterpriseConfig.ENGINE_DISABLE).equals(WifiEnterpriseConfig.ENGINE_DISABLE)) {
            try {
                Class.forName("mediatek.telephony.MtkCarrierConfigManager", false, ClassLoader.getSystemClassLoader()).getMethod("putDefault", PersistableBundle.class).invoke(null, sDefaults);
            } catch (Exception e) {
                Rlog.w(TAG, "No MtkCarrierConfigManager! Do nothing. - " + e);
            }
        }
        OppoCarrierConfigManager.putDefault(sDefaults);
    }
    ...
    private static String IsRsaOpeartor() {
        try {
            if (SystemProperties.get("ro.oppo.rsa3.support", "false").equals("true")) {
                return "com.google.android.ims";
            }
            return null;
        } catch (Exception e) {
            Rlog.e(TAG, "Error getsystemproperties");
            return null;
        }
    }
}
