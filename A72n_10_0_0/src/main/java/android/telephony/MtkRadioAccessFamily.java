...
public class MtkRadioAccessFamily {
    ...
    public static int getRafFromNetworkType(int type) {
        switch (type) {
            ...
            case 16:
                return 98307;
            case MtkPhoneNumberFormatUtil.FORMAT_THAILAND /* 17 */:
                return 364547;
            case MtkPhoneNumberFormatUtil.FORMAT_VIETNAM /* 18 */:
                return 115591;
            case MtkPhoneNumberFormatUtil.FORMAT_PORTUGAL /* 19 */:
                return 349060;
            case MtkPhoneNumberFormatUtil.FORMAT_POLAND /* 20 */:
                return 381831;
            case MtkPhoneNumberFormatUtil.FORMAT_AUSTRALIA /* 21 */:
                return 125951;
            case MtkPhoneNumberFormatUtil.FORMAT_NEW_ZEALAND /* 22 */:
                return 392191;
            case MtkPhoneNumberFormatUtil.FORMAT_BRAZIL /* 23 */:
                return 524288;
            case 24:
                return 790528;
            case 25:
            ...
            default:
                switch (type) {
                    ...
                    case 102:
                        return LTE;
                    case MtkRILConstants.NETWORK_MODE_CDMA_GSM /* 103 */:
                        return 32843;
                    case MtkRILConstants.NETWORK_MODE_CDMA_EVDO_GSM /* 104 */:
                        return 43131;
                    case MtkRILConstants.NETWORK_MODE_LTE_CDMA_EVDO_GSM /* 105 */:
                        return 309371;
                    default:
                        return 0;
                }
