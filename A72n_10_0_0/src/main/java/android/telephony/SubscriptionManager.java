...
public class SubscriptionManager {
            ...
            public void handleMessage(Message msg) {
                ...
                if (SubscriptionManager.IS_DEBUG_BUILD) {
                    ...
                    if (durationUptime2 > 200) {
                        OnSubscriptionsChangedListener onSubscriptionsChangedListener = OnSubscriptionsChangedListener.this;
                        onSubscriptionsChangedListener.log("Cost " + durationUptime2 + "ms in OnSubscriptionsChangedListener.this=" + OnSubscriptionsChangedListener.this + " this.mHandler=" + OnSubscriptionsChangedListener.this.mHandler);
                    }
                }
            }
        }
    ...
    public static int getPhoneId(int subId) {
        ...
        } else if (subId > -2 - TelephonyManager.getDefault().getSimCount()) {
            return -2 - subId;
        } else {
            return -1;
        }
    ...
    public static String getPhoneNumber(int subId, Context context) {
        String phoneNum = "";
        try {
            phoneNum = ((TelephonyManager) context.getSystemService("phone")).getLine1Number(subId);
            Log.w(LOG_TAG, "getPhoneNumber phoneNum=" + phoneNum);
            return phoneNum;
        } catch (Exception e) {
            Log.w(LOG_TAG, "getPhoneNumber catch error" + e);
            return phoneNum;
        }
    }
    ...
    public static boolean isVsimEnabled(int subId) {
        ...
        try {
            ...
            if (isValidSlotIndex(slotId) && iSub.getSoftSimCardSlotId() == slotId) {
                return true;
            }
            return false;
        } catch (Exception e) {
    ...
    public static String getOperatorNumericForData(int subId) {
        ...
        try {
            ...
            if (iSub != null) {
                result = iSub.getOperatorNumericForData(phoneId);
            }
            return result;
        } catch (Exception e) {
            e.printStackTrace();
