...
public class ChangeBounds extends Transition {
    ...
    /* JADX INFO: Multiple debug info for r13v3 int: [D('startWidth' int), D('startParent' android.view.ViewGroup)] */
    /* JADX INFO: Multiple debug info for r14v3 int: [D('endParent' android.view.ViewGroup), D('startHeight' int)] */
    /* JADX INFO: Multiple debug info for r7v4 int: [D('endWidth' int), D('startBounds' android.graphics.Rect)] */
    /* JADX INFO: Multiple debug info for r6v4 int: [D('endBounds' android.graphics.Rect), D('endHeight' int)] */
    /* JADX INFO: Multiple debug info for r11v5 'clipAnimator'  android.animation.ObjectAnimator: [D('clipAnimator' android.animation.ObjectAnimator), D('startBottom' int)] */
            ...
            if (!changeBounds.mResizeClip) {
                ...
                if (numChanges != 2) {
                    if (startLeft != endLeft2) {
                        ...
                        return ObjectAnimator.ofObject(view2, (Property<View, V>) BOTTOM_RIGHT_ONLY_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startRight, (float) startBottom, (float) endRight, (float) endBottom));
                    }
                    return ObjectAnimator.ofObject(view, (Property<View, V>) TOP_LEFT_ONLY_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startLeft, (float) startTop2, (float) endLeft2, (float) endTop));
                } else if (startWidth == endWidth && startHeight == endHeight) {
                    return ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startLeft, (float) startTop2, (float) endLeft2, (float) endTop));
                } else {
                    final ViewBounds viewBounds = new ViewBounds(view2);
                    ObjectAnimator topLeftAnimator = ObjectAnimator.ofObject(viewBounds, (Property<ViewBounds, V>) TOP_LEFT_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startLeft, (float) startTop2, (float) endLeft2, (float) endTop));
                    ObjectAnimator bottomRightAnimator = ObjectAnimator.ofObject(viewBounds, (Property<ViewBounds, V>) BOTTOM_RIGHT_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startRight, (float) startBottom, (float) endRight, (float) endBottom));
                ...
                if (startLeft == endLeft2 && startTop2 == endTop) {
                    ...
                    startTop = startTop2;
                    endLeft = endLeft2;
                    positionAnimator = ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, getPathMotion().getPath((float) startLeft, (float) startTop2, (float) endLeft2, (float) endTop));
                }
                if (startClip == null) {
                    i = 0;
