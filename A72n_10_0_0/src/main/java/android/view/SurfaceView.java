...
public class SurfaceView extends View implements ViewRootImpl.WindowStoppedCallback {
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:199:0x04d0  */
    /* JADX WARNING: Removed duplicated region for block: B:221:0x0550 A[Catch:{ all -> 0x0547, all -> 0x055e }] */
    /* JADX WARNING: Removed duplicated region for block: B:223:0x0556 A[Catch:{ all -> 0x0547, all -> 0x055e }] */
    /* JADX WARNING: Removed duplicated region for block: B:231:0x0580 A[SYNTHETIC, Splitter:B:231:0x0580] */
    /* JADX WARNING: Removed duplicated region for block: B:291:0x06b5 A[Catch:{ Exception -> 0x06d1 }] */
    /* JADX WARNING: Removed duplicated region for block: B:311:0x06f5 A[Catch:{ Exception -> 0x074d }] */
    public void updateSurface() {
        ...
        if (this.mHaveFrame) {
            ...
            if (viewRoot4 == null || viewRoot4.mSurface == null) {
                ...
                if (myWidth <= 200 || myHeight3 <= 200 || !this.mSurfaceExt.isResolutionTuningPackage()) {
                    myHeight = myHeight3;
                    myHeight2 = myWidth;
                } else {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        SurfaceControl.closeTransaction();
                                        boolean redrawNeeded3 = sizeChanged || creating;
                                        try {
