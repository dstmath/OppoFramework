...
public final class AccessibilityManager {
    ...
    private static final ArrayList<String> mAllowsPackage = new ArrayList<>(Arrays.asList(LMManager.MM_PACKAGENAME));
    ...
    private boolean isSpecialProcess(String strProcName) {
        ...
        return strPidName != null && strPidName.equals(strProcName);
    }
    ...
    /* JADX INFO: Multiple debug info for r2v1 int: [D('userId' int), D('myLooper' android.os.Looper)] */
    ...
    private void setStateLocked(int stateFlags) {
        ...
        this.mIsDirectEnabled = directEnabled;
