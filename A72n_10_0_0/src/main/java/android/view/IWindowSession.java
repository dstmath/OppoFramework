            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 22:
                        ...
                        Bundle _result5 = sendWallpaperCommand(_arg012, _arg114, _arg27, _arg36, _arg46, _arg5, data.readInt() != 0);
                        reply.writeNoException();
                        if (_result5 != null) {
                            reply.writeInt(1);
                    ...
                    case 23:
                        ...
                        wallpaperCommandComplete(_arg013, _arg12);
                        reply.writeNoException();
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onRectangleOnScreenRequested(_arg014, _arg13);
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 30:
                        ...
                        reparentDisplayContent(_arg015, _arg14, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 31:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 32:
                        ...
                        updateTapExcludeRegion(_arg016, _arg115, _arg26);
                        reply.writeNoException();
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
