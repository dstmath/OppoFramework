...
public class TextureView extends OppoBaseTextureView {
    ...
    /* access modifiers changed from: protected */
    @Override // android.view.View, android.view.OppoBaseTextureView
    @UnsupportedAppUsage
    ...
    public TextureLayer getTextureLayer() {
        ...
        if (this.mLayer == null) {
            ...
            if (surfaceTextureListener2 != null && createNewSurface) {
                surfaceTextureListener2.onSurfaceTextureAvailable(this.mSurface, getWidth(), getHeight());
            }
        ...
        if (this.mCallBackSizeChangeWhenLayerUpdate && sizeChangeWhenUpdateLayer && (surfaceTextureListener = this.mListener) != null) {
            surfaceTextureListener.onSurfaceTextureSizeChanged(this.mSurface, getWidth(), getHeight());
        }
        return this.mLayer;
    }
    ...
    /* access modifiers changed from: protected */
    public boolean onDestroyHardwareResources() {
