...
public class PathInterpolator extends BaseInterpolator implements NativeInterpolatorFactory {
    ...
    /* JADX INFO: Multiple debug info for r4v7 float: [D('fraction' float), D('componentIndex' int)] */
    /* JADX INFO: Multiple debug info for r6v1 float: [D('x' float), D('componentIndex' int)] */
    /* JADX INFO: Multiple debug info for r7v1 float: [D('componentIndex' int), D('y' float)] */
