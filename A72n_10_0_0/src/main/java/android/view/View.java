...
public class View extends OppoBaseView implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v19, resolved type: com.color.util.ColorReflectDataUtils */
    ...
    /* JADX INFO: Multiple debug info for r5v1 int: [D('canScrollLeft' boolean), D('rightMask' int)] */
    ...
    public RenderNode updateDisplayListIfDirty() {
        ...
        if ((this.mPrivateFlags & 32768) != 0 && renderNode.hasDisplayList() && !this.mRecreateDisplayList) {
            ...
            if (getClass().getName().contains("com.douban.frodo")) {
                layerType = 2;
            }
    ...
    /* JADX INFO: Multiple debug info for r0v23 float: [D('scale' float), D('clear' boolean)] */
    ...
    /* JADX INFO: Multiple debug info for r9v2 android.view.View$ScrollabilityCache: [D('scrollabilityCache' android.view.View$ScrollabilityCache), D('offsetRequired' boolean)] */
    /* JADX INFO: Multiple debug info for r6v1 int: [D('length' int), D('drawLeft' boolean)] */
                    ...
                    try {
                        ...
                        if (token2 != null) {
                            try {
                                ...
                                token = token2;
                                try {
                                    Log.e(str, "Unable to initiate drag", e2);
                                    if (token == null) {
                                    }
                                    session.kill();
                                    return false;
