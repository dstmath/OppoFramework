...
public final class DisplayInfo implements Parcelable {
    ...
    public void getLogicalMetrics(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration) {
        ...
        if (ActivityThread.sIsDisplayCompatApp && ActivityThread.sCompatDensity != outMetrics.densityDpi) {
            Log.d("DisplayInfo", "DisplayCompat: getLogicalMetrics, change out=" + outMetrics + " to " + ActivityThread.sCompatDensity + " caller:" + Debug.getCallers(10));
    ...
    private void getMetricsWithSize(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration, int width, int height) {
        ...
        if (!compatInfo.equals(CompatibilityInfo.DEFAULT_COMPATIBILITY_INFO)) {
            compatInfo.applyToDisplayMetrics(outMetrics);
        } else if (ActivityThread.sIsDisplayCompatApp && ActivityThread.sCompatDensity != outMetrics.densityDpi) {
            Log.d("DisplayInfo", "DisplayCompat: getMetricsWithSize, change out=" + outMetrics + " to " + ActivityThread.sCompatDensity + " caller:" + Debug.getCallers(10));
            compatInfo.applyToDisplayMetrics(outMetrics);
        }
    }
