    ...
    public SpannableStringBuilder replace(int start, int end, CharSequence tb, int tbstart, int tbend) {
        ...
        if (adjustSelection) {
            ...
            if (selectionStart <= start || selectionStart >= end) {
                ...
                int selectionStart2 = start + Math.toIntExact((((long) newLen) * ((long) (selectionStart - start))) / ((long) origLen));
                textWatchers = textWatchers2;
            ...
            if (selectionEnd <= start || selectionEnd >= end) {
                ...
                int selectionEnd3 = start + Math.toIntExact((((long) newLen) * ((long) (selectionEnd - start))) / ((long) origLen));
                changed = true;
