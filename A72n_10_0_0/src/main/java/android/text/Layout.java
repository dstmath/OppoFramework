...
public abstract class Layout {
    ...
    /* JADX INFO: Multiple debug info for r0v5 int: [D('lbaseline' int), D('right' int)] */
    /* JADX INFO: Multiple debug info for r4v4 int: [D('paraAlign' android.text.Layout$Alignment), D('length' int)] */
    /* JADX INFO: Multiple debug info for r5v13 'dir'  int: [D('dir' int), D('ltop' int)] */
    /* JADX INFO: Multiple debug info for r5v14 'ltop'  int: [D('dir' int), D('ltop' int)] */
                                ...
                                while (n2 < length) {
                                    if (spans4[n2] instanceof LeadingMarginSpan) {
                                        ...
                                        if (ltop3 == -1) {
                                            ...
                                            dir4 = ltop3;
                                            ltop = ltop2;
                                            margin.drawLeadingMargin(canvas, paint3, right, ltop3, ltop, lbaseline2, lbottom, buf3, start2, end, isFirstParaLine, this);
                                            ...
                                            useFirstLineMargin3 = useFirstLineMargin2;
                                            layout2 = this;
                                            margin.drawLeadingMargin(canvas, paint3, left, dir4, ltop, lbaseline2, lbottom, buf2, start2, end, isFirstParaLine, this);
