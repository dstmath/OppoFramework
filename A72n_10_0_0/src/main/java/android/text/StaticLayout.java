...
public class StaticLayout extends Layout {
    ...
    public static final class Builder {
        ...
        public ITextJustificationHooks mBuilderJustificationHooksImpl = ((ITextJustificationHooks) ColorFrameworkFactory.getInstance().getFeature(ITextJustificationHooks.DEFAULT, new Object[0]));
    ...
    private StaticLayout(Builder b) {
        ...
        this.mMaxLineHeight = -1;
        this.mMaximumVisibleLineCount = Integer.MAX_VALUE;
        this.mTextJustificationHooksImpl = b.mBuilderJustificationHooksImpl;
        if (b.mEllipsize != null) {
            Layout.Ellipsizer e = (Layout.Ellipsizer) getText();
            e.mLayout = this;
    ...
    /* JADX INFO: Multiple debug info for r14v3 android.graphics.text.LineBreaker: [D('firstWidthLineCount' int), D('lineBreaker' android.graphics.text.LineBreaker)] */
    /* JADX INFO: Multiple debug info for r2v5 'ellipsize'  android.text.TextUtils$TruncateAt: [D('paraStart' int), D('ellipsize' android.text.TextUtils$TruncateAt)] */
    /* JADX INFO: Multiple debug info for r4v10 'textDir'  android.text.TextDirectionHeuristic: [D('textDir' android.text.TextDirectionHeuristic), D('spanStart' int)] */
    /* JADX INFO: Multiple debug info for r0v33 'bufStart'  int: [D('fmAscent' int), D('bufStart' int)] */
    /* JADX INFO: Multiple debug info for r1v11 'source'  java.lang.CharSequence: [D('paraEnd' int), D('source' java.lang.CharSequence)] */
    /* JADX INFO: Multiple debug info for r7v6 'fm'  android.graphics.Paint$FontMetricsInt: [D('fm' android.graphics.Paint$FontMetricsInt), D('variableTabStops' float[])] */
    /* JADX INFO: Multiple debug info for r12v9 android.graphics.Paint$FontMetricsInt: [D('firstWidth' int), D('fm' android.graphics.Paint$FontMetricsInt)] */
    /* JADX INFO: Multiple debug info for r49v3 int: [D('fmDescent' int), D('fmBottom' int), D('fmAscent' int)] */
    /* JADX INFO: Multiple debug info for r3v36 int[]: [D('breaks' int[]), D('constraints' android.graphics.text.LineBreaker$ParagraphConstraints)] */
    /* JADX INFO: Multiple debug info for r3v37 float[]: [D('breaks' int[]), D('lineWidths' float[])] */
    /* JADX INFO: Multiple debug info for r3v38 float[]: [D('lineWidths' float[]), D('ascents' float[])] */
    /* JADX INFO: Multiple debug info for r3v39 float[]: [D('ascents' float[]), D('descents' float[])] */
    /* JADX INFO: Multiple debug info for r3v40 boolean[]: [D('descents' float[]), D('hasTabs' boolean[])] */
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Removed duplicated region for block: B:101:0x02f2 A[LOOP:6: B:100:0x02f0->B:101:0x02f2, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:132:0x03be  */
    /* JADX WARNING: Removed duplicated region for block: B:180:0x0621 A[LOOP:2: B:52:0x0186->B:180:0x0621, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:192:0x060e A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:97:0x02b7  */
    ...
    public void generate(Builder b, boolean includepad, boolean trackpad) {
        ...
        if (staticLayout2.mTextJustificationHooksImpl == null) {
            staticLayout2.mTextJustificationHooksImpl = (ITextJustificationHooks) ColorFrameworkFactory.getInstance().getFeature(ITextJustificationHooks.DEFAULT, new Object[0]);
        }
        ...
        if (source3 instanceof PrecomputedText) {
            ...
            int checkResult = precomputed.checkResultUsable(bufStart3, fmBottom4, textDir3, paint3, b.mBreakStrategy, b.mHyphenationFrequency);
            if (checkResult != 0) {
                if (checkResult == 1) {
                    paragraphInfo2 = PrecomputedText.create(precomputed, new PrecomputedText.Params.Builder(paint3).setBreakStrategy(b.mBreakStrategy).setHyphenationFrequency(b.mHyphenationFrequency).setTextDirection(textDir3).build()).getParagraphInfo();
        ...
        if (paragraphInfo2 == null) {
            paragraphInfo = PrecomputedText.createMeasuredParagraphs(source3, new PrecomputedText.Params(paint3, textDir3, b.mBreakStrategy, b.mHyphenationFrequency), bufStart3, fmBottom4, false);
        } else {
        ...
        while (true) {
            ...
            if (spanned4 != null) {
                LeadingMarginSpan[] sp = (LeadingMarginSpan[]) getParagraphSpans(spanned4, paraStart, paraEnd, LeadingMarginSpan.class);
                ...
                bufStart2 = bufStart3;
                source2 = source3;
                LineHeightSpan[] chooseHt2 = (LineHeightSpan[]) getParagraphSpans(spanned4, paraStart, paraEnd, LineHeightSpan.class);
                if (chooseHt2.length == 0) {
                    ...
                    for (int i5 = 0; i5 < chooseHt2.length; i5++) {
                        int o = spanned4.getSpanStart(chooseHt2[i5]);
                        if (o < paraStart) {
            ...
            float[] variableTabStops2 = null;
            if (spanned4 != null) {
                TabStopSpan[] spans = (TabStopSpan[]) getParagraphSpans(spanned4, paraStart, paraEnd, TabStopSpan.class);
                if (spans.length > 0) {
                    ...
                    constraints.setIndent((float) firstWidth, firstWidthLineCount);
                    ...
                    res = lineBreaker3.computeLineBreaks(measuredPara.getMeasuredText(), constraints, staticLayout2.mLineCount);
                    ...
                    while (spanEnd < paraEnd) {
                        ...
                        if (fm5.bottom > fmBottom5) {
                            fmBottom5 = fm5.bottom;
                        ...
                        while (true) {
                            ...
                            fmAscent = fmAscent3;
                            if (paraStart + breaks[breakIndex] >= spanEnd) {
                                break;
                            }
                            breakIndex++;
                            fmAscent3 = fmAscent;
                        ...
                        int here = fmDescent2;
                        int v2 = v;
                        int bufStart4 = fmAscent;
                        int fmDescent4 = breakIndex;
                        int fmBottom6 = fmBottom5;
                        int fmBottom7 = fmDescent3;
                        while (fmDescent4 < breakCount2 && breaks[fmDescent4] + paraStart <= spanEnd2) {
                            int endPos = breaks[fmDescent4] + paraStart;
                            boolean moreChars = endPos < fmBottom4 ? z : breakCount3;
                            if (fallbackLineSpacing) {
                                fmBottom = fmBottom6;
                                fmBottom2 = Math.min(bufStart4, Math.round(ascents[fmDescent4]));
                            } else {
                                fmBottom = fmBottom6;
                                fmBottom2 = bufStart4;
                            }
                            if (fallbackLineSpacing) {
                                descent = Math.max(fmBottom7, Math.round(descents[fmDescent4]));
                            } else {
                                descent = fmBottom7;
                            }
                            float builderParaSpacingAdded = staticLayout2.mTextJustificationHooksImpl.getLayoutParaSpacingAdded(this, b, moreChars, source2, endPos);
                            v2 = out(source2, here, endPos, fmBottom2, (int) (((float) descent) + builderParaSpacingAdded), fmTop3, (int) (((float) fmBottom) + builderParaSpacingAdded), v2, spacingmult, spacingadd, chooseHt, chooseHtv, fm5, hasTabs[fmDescent4], hyphenEdits[fmDescent4], needMultiply, measuredPara, fmBottom4, includepad, trackpad, addLastLineSpacing, chs, paraStart, ellipsize2, ellipsizedWidth3, lineWidths[fmDescent4], paint2, moreChars);
                            if (endPos < spanEnd2) {
                                fm3 = fm5;
                                int fmTop4 = fm3.top;
                                fmAscent2 = fm3.bottom;
                                fmBottom3 = fm3.ascent;
                                fmDescent = fm3.descent;
                                fmTop3 = fmTop4;
                            } else {
                                fm3 = fm5;
                                fmTop3 = breakCount3;
                                fmDescent = breakCount3;
                                fmBottom3 = breakCount3;
                                fmAscent2 = breakCount3;
                            }
                            here = endPos;
                            int breakIndex3 = fmDescent4 + 1;
                            if (staticLayout2.mLineCount < staticLayout2.mMaximumVisibleLineCount || !staticLayout2.mEllipsized) {
                                bufStart2 = bufStart2;
                                source2 = source2;
                                ellipsize2 = ellipsize2;
                                spanEnd2 = spanEnd2;
                                staticLayout2 = staticLayout2;
                                fmDescent4 = breakIndex3;
                                fmBottom6 = fmAscent2;
                                bufStart4 = fmBottom3;
                                fmBottom7 = fmDescent;
            ...
            res = lineBreaker32.computeLineBreaks(measuredPara2.getMeasuredText(), constraints, staticLayout2.mLineCount);
            breakCount = res.getLineCount();
            if (lineBreakCapacity2 >= breakCount) {
            }
            i = 0;
        ...
        if (staticLayout.mLineCount < staticLayout.mMaximumVisibleLineCount) {
            MeasuredParagraph measuredPara3 = MeasuredParagraph.buildForBidi(source, bufEnd, bufEnd, textDir, null);
            paint.getFontMetricsInt(fm2);
            out(source, bufEnd, bufEnd, fm2.ascent, fm2.descent, fm2.top, fm2.bottom, fmTop, spacingmult, spacingadd, null, null, fm2, false, 0, needMultiply, measuredPara3, bufEnd, includepad, trackpad, addLastLineSpacing, null, bufStart, ellipsize, ellipsizedWidth, 0.0f, paint, false);
        }
    }
    ...
    private int out(CharSequence text, int start, int end, int above, int below, int top, int bottom, int v, float spacingmult, float spacingadd, LineHeightSpan[] chooseHt, int[] chooseHtv, Paint.FontMetricsInt fm, boolean hasTab, int hyphenEdit, boolean needMultiply, MeasuredParagraph measured, int bufEnd, boolean includePad, boolean trackPad, boolean addLastLineLineSpacing, char[] chs, int widthStart, TextUtils.TruncateAt ellipsize, float ellipsisWidth, float textWidth, TextPaint paint, boolean moreChars) {
        ...
        if (ellipsize != null) {
            ...
            if ((((((this.mMaximumVisibleLineCount != i2 || !moreChars) && (!firstLine2 || moreChars)) || ellipsize == TextUtils.TruncateAt.MARQUEE) && (firstLine2 || ((!currentLineIsTheLastVisibleOne && moreChars) || ellipsize != TextUtils.TruncateAt.END))) ? i : i2) != 0) {
                i4 = widthStart;
        ...
        if (this.mTextJustificationHooksImpl.lineShouldIncludeFontPad(firstLine, this)) {
            if (trackPad) {
        ...
        if (this.mTextJustificationHooksImpl.lineNeedMultiply(needMultiply, addLastLineLineSpacing, lastCharIsNewLine, this)) {
