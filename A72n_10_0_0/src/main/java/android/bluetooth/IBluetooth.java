...
public interface IBluetooth extends IInterface {
    ...
    public static class Default implements IBluetooth {
        ...
        @Override // android.bluetooth.IBluetooth
        public void setBLBlackOrWhiteList(List<String> list, int btCustomizeMode, boolean enable) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IBluetooth {
        ...
        static final int TRANSACTION_setBLBlackOrWhiteList = 78;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 28:
                        ...
                        boolean createBondOutOfBand = createBondOutOfBand(_arg03, _arg13, _arg2);
                        reply.writeNoException();
                    ...
                    case 45:
                        ...
                        boolean pin = setPin(_arg018, _arg22, data.readInt(), data.createByteArray());
                        reply.writeNoException();
                    ...
                    case 46:
                        ...
                        boolean passkey = setPasskey(_arg019, _arg22, data.readInt(), data.createByteArray());
                        reply.writeNoException();
                    ...
                    case 47:
                        ...
                        boolean pairingConfirmation = setPairingConfirmation(_arg020, _arg22);
                        reply.writeNoException();
                    ...
                    case 49:
                        ...
                        boolean silenceMode = setSilenceMode(_arg022, _arg22);
                        reply.writeNoException();
                    ...
                    case 71:
                        data.enforceInterface(DESCRIPTOR);
                        IBluetoothMetadataListener _arg034 = IBluetoothMetadataListener.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg12 = BluetoothDevice.CREATOR.createFromParcel(data);
                        } else {
                            _arg12 = null;
                        }
                        boolean registerMetadataListener = registerMetadataListener(_arg034, _arg12);
                        reply.writeNoException();
                    ...
                    case 78:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _arg035 = data.createStringArrayList();
                        int _arg14 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg22 = true;
                        }
                        setBLBlackOrWhiteList(_arg035, _arg14, _arg22);
                        reply.writeNoException();
                        return true;
                    default:
        ...
        public static class Proxy implements IBluetooth {
            ...
            public void requestActivityInfo(ResultReceiver result) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(75, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
            ...
            public void setBLBlackOrWhiteList(List<String> addressList, int btCustomizeMode, boolean enable) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setBLBlackOrWhiteList(addressList, btCustomizeMode, enable);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
