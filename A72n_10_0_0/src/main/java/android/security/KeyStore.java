...
public class KeyStore implements IOppoKeyStoreEx {
        ...
        try {
            ...
            if (appId != null) {
                ...
                try {
                    ...
                    e3 = e5;
                    try {
                        Log.e(TAG, "GetKeyCharacteristics completed with exception", e3);
                        this.mBinder.asBinder().unlinkToDeath(promise, 0);
                        return 4;
                    } catch (Throwable th) {
                        e = th;
    ...
    public int importWrappedKey(String wrappedKeyAlias, byte[] wrappedKey, String wrappingKeyAlias, byte[] maskingKey, KeymasterArguments args, long rootSid, long fingerprintSid, int uid, KeyCharacteristics outCharacteristics) {
        ...
        try {
            ...
            try {
                ...
                e2 = e4;
                Log.e(TAG, "ImportWrappedKey completed with exception", e2);
                return 4;
            }
            try {
        ...
        try {
            ...
            if (appId != null) {
                ...
                try {
                    ...
                    e3 = e5;
                    try {
                        Log.e(TAG, "ExportKey completed with exception", e3);
                        this.mBinder.asBinder().unlinkToDeath(promise, 0);
                        return null;
                    } catch (Throwable th) {
                        e = th;
        ...
        try {
            ...
            if (entropy != null) {
                ...
                try {
                    ...
                    e3 = e5;
                    try {
                        Log.e(TAG, "Begin completed with exception", e3);
                        this.mBinder.asBinder().unlinkToDeath(promise, 0);
                        return null;
                    } catch (Throwable th) {
                        e = th;
        ...
        try {
            ...
            if (entropy != null) {
                ...
                try {
                    ...
                    e3 = e5;
                    try {
                        Log.e(TAG, "Finish completed with exception", e3);
                        this.mBinder.asBinder().unlinkToDeath(promise, 0);
                        return null;
                    } catch (Throwable th) {
                        e = th;
    ...
    @Override // android.security.IOppoKeyStoreEx
    ...
    private long getFaceOnlySid() {
        ...
        if (this.mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_FACE) && (faceManager = (FaceManager) this.mContext.getSystemService(FaceManager.class)) != null) {
