...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
    ...
    /* JADX INFO: Multiple debug info for r9v16 byte[]: [D('i' int), D('chainBytes' byte[])] */
    ...
    private void setPrivateKeyEntry(String alias, PrivateKey key, Certificate[] chain, KeyStore.ProtectionParameter param) throws KeyStoreException {
        ...
        try {
            ...
            if (chain.length > 1) {
                ...
                for (int i3 = 0; i3 < certsBytes.length; i3++) {
                    try {
                        ...
                        throw new KeyStoreException("Failed to encode certificate #" + i3, e2);
                    }
                }
            ...
            throw new KeyStoreException("Failed to encode certificate #0", e5);
        }
    }
