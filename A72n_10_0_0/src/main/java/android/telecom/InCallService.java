...
public abstract class InCallService extends Service {
    ...
    private final String LOG_TAG_FROM = "IInCallService-->";
    private final Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (InCallService.this.mPhone != null || msg.what == 1) {
                switch (msg.what) {
                    case 1:
                        InCallService.this.logDebug("handleMessage MSG_SET_IN_CALL_ADAPTER");
                ...
                Log.w("IInCallService-->", "handleMessage msg.what = " + msg.what, new Object[0]);
            }
        }
    };
    ...
    public final void doMtkAction(Bundle params) {
        Phone phone = this.mPhone;
        if (phone != null) {
            phone.doMtkAction(params);
        }
    }

    /* access modifiers changed from: package-private */
    public void logDebug(String logString) {
        Log.i("IInCallService-->", logString, new Object[0]);
    }
}
