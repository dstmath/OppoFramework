...
final class ApkSigningBlockUtils {
    ...
    /* JADX INFO: Multiple debug info for r8v12 byte[]: [D('concatenationOfChunkCountAndChunkDigests' byte[]), D('chunkContentPrefix' byte[])] */
    /* JADX INFO: Multiple debug info for r7v7 java.security.MessageDigest: [D('md' java.security.MessageDigest), D('digestAlgorithm' int)] */
                ...
                while (inputRemaining > 0) {
                    ...
                    try {
                        ...
                        while (i5 < digestAlgorithms.length) {
                            ...
                            byte[] chunkContentPrefix2 = digestsOfChunks[i5];
                            int expectedDigestSizeBytes = getContentDigestAlgorithmOutputSizeBytes(digestAlgorithm);
                            MessageDigest md = mds[i5];
                            int actualDigestSizeBytes = md.digest(chunkContentPrefix2, (chunkIndex3 * expectedDigestSizeBytes) + 5, expectedDigestSizeBytes);
