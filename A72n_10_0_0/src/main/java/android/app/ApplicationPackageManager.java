...
public class ApplicationPackageManager extends OppoBaseApplicationPackageManager {
    @VisibleForTesting
    ...
    @Override // android.app.OppoBaseApplicationPackageManager
    ...
    public PackageInfo getPackageInfo(String packageName, int flags) throws PackageManager.NameNotFoundException {
        PackageInfo pi = getPackageInfoAsUser(packageName, flags, this.mContext.getUserId());
        checkAndLogMultiApp(pi == null, this.mContext, packageName, "getPackageInfo");
        return pi;
    }
    ...
    public ActivityInfo getActivityInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            checkAndLogMultiApp(true, this.mContext, className, "getActivityInfo");
    ...
    public ActivityInfo getReceiverInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            checkAndLogMultiApp(true, this.mContext, className, "getReceiverInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public ServiceInfo getServiceInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            checkAndLogMultiApp(true, this.mContext, className, "getServiceInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public ProviderInfo getProviderInfo(ComponentName className, int flags) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            checkAndLogMultiApp(true, this.mContext, className, "getProviderInfo");
            throw new PackageManager.NameNotFoundException(className.toString());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public List<PackageInfo> getInstalledPackagesAsUser(int flags, int userId) {
        int userId2 = ColorMultiAppManager.getInstance().getCorrectUserId(userId);
        try {
            ParceledListSlice<PackageInfo> parceledList = this.mPM.getInstalledPackages(updateFlagsForPackage(flags, userId2), userId2);
            if (parceledList == null) {
                return Collections.emptyList();
            }
            return parceledList.getList();
    ...
    public List<ApplicationInfo> getInstalledApplicationsAsUser(int flags, int userId) {
        try {
            List<ApplicationInfo> infoList = ColorMultiAppManager.getInstance().getInstalledApplications(this.mPM, flags, userId);
            if (infoList != null) {
                return infoList;
            }
    ...
    public List<ResolveInfo> queryIntentActivitiesAsUser(Intent intent, int flags, int userId) {
        int userId2 = ColorMultiAppManager.getInstance().getCorrectUserId(userId);
        try {
            ParceledListSlice<ResolveInfo> parceledList = this.mPM.queryIntentActivities(intent, intent.resolveTypeIfNeeded(this.mContext.getContentResolver()), updateFlagsForComponent(flags, userId2, intent), userId2);
            if (parceledList == null) {
                return Collections.emptyList();
            }
            return parceledList.getList();
    ...
    public ProviderInfo resolveContentProviderAsUser(String name, int flags, int userId) {
        try {
            ProviderInfo info = ColorMultiAppManager.getInstance().resolveContentProviderAsUser(this.mPM, this.mContext, name, flags, userId);
            if (info != null) {
                return info;
            }
    ...
    public Drawable getDefaultActivityIcon() {
        ...
        return ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).getDefaultActivityIcon(contextImpl, contextImpl.getResources());
    }

    @Override // android.content.pm.PackageManager, android.app.OppoBaseApplicationPackageManager
    public Drawable getApplicationIcon(ApplicationInfo info) {
        Drawable drawable = super.getApplicationIcon(info);
        if (drawable != null) {
            return drawable;
        }
    ...
    public Drawable getUserBadgedIcon(Drawable icon, UserHandle user) {
        Drawable multiBadge = super.getMultiAppUserBadgedIcon(user);
        if (multiBadge != null) {
            return getBadgedDrawable(icon, multiBadge, null, false);
        }
    ...
    public PackageInstaller getPackageInstaller() {
        ...
        synchronized (this.mLock) {
            if (this.mInstaller == null) {
                try {
                    this.mInstaller = new PackageInstaller(antiVirusQihooReplaceInstaller(this.mPM.getPackageInstaller()), this.mContext.getPackageName(), getUserId());
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
            }
    ...
    public Drawable loadUnbadgedItemIcon(PackageItemInfo itemInfo, ApplicationInfo appInfo) {
        ...
        if (itemInfo.packageName != null) {
            if (((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).isColorIcons()) {
                drawable = ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).loadPackageItemIcon(itemInfo, this, appInfo, true);
            } else {
    ...
    public Drawable getCachedIconForThemeHelper(String packageName, int id) {
        return getCachedIcon(new ResourceName(packageName, id));
    }

    @Override // android.app.OppoBaseApplicationPackageManager
    public ColorBaseResources getColorBaseResourcesForThemeHelper(ApplicationInfo app) throws PackageManager.NameNotFoundException {
        return getResourcesForApplication(app);
    }

    @Override // android.app.OppoBaseApplicationPackageManager
    public void putCachedIconForThemeHelper(String packageName, int id, Drawable dr) {
        putCachedIcon(new ResourceName(packageName, id), dr);
    }

    @Override // android.content.pm.PackageManager
    public void clearCachedIconForActivity(ComponentName activityName) throws PackageManager.NameNotFoundException {
        try {
            ActivityInfo itemInfo = getActivityInfo(activityName, 1024);
            if (itemInfo != null) {
                synchronized (sSync) {
                    ResourceName name = new ResourceName(itemInfo.packageName, itemInfo.getIconResource());
                    if (sIconCache.get(name) != null) {
                        sIconCache.remove(name);
                        Log.i(TAG, "clearCachedIconForActivity name :" + name.packageName);
                    } else {
                        for (int i = sIconCache.size() - 1; i >= 0; i--) {
                            ResourceName nm = sIconCache.keyAt(i);
                            if (nm.packageName.equals(itemInfo.packageName)) {
                                sIconCache.removeAt(i);
                                Log.i(TAG, "clearCachedIconForActivity name :" + nm.packageName);
                            }
                        }
                    }
                }
            ...
            Log.e(TAG, "clearCachedIconForActivity error :" + ex.getMessage());
        }
    }
    ...
    public int callInstalldCmd(String path, String cmd) {
        try {
            return this.mPM.callInstalldCmd(path, cmd);
        } catch (RemoteException e) {
    ...
    @Override // android.content.pm.PackageManager
    public void backupAppData(String src, String packageName, String dest, int requesetId) {
        try {
            this.mPM.backupAppData(src, packageName, dest, requesetId);
        } catch (RemoteException e) {
            Log.e(TAG, "backupAppData failed,e:" + e);
        }
    }
}
