...
public final class LoadedApk {
    ...
    public static final class ServiceDispatcher {
        ...
        public void connected(ComponentName name, IBinder service, boolean dead) {
            ...
            } else if (name.getClassName().equals("com.android.systemui.ImageWallpaper") || name.getClassName().equals("com.android.wallpaper.livepicker.lwpService.Find0WallpaperService")) {
                this.mActivityThread.postAtFrontOfQueue(new RunConnection(name, service, 0, dead));
            } else {
