...
public class ColorActivityTaskManager extends ColorBaseActivityTaskManager implements IColorActivityTaskManager {
    ...
    public void setPackagesState(Map<String, Integer> packageMap) throws RemoteException {
        ...
        try {
            ...
            this.mRemote.transact(IColorActivityTaskManager.UPDATE_APP_STATE_FOR_INTERCEPT, data, reply, 0);
            reply.readException();
        } finally {
            data.recycle();
            reply.recycle();
    ...
    public boolean registerLockScreenCallback(IColorLockScreenCallback callback) throws RemoteException {
        ...
        try {
            ...
            this.mRemote.transact(IColorActivityTaskManager.REGISTER_LOCKSCREEN_CALLBACK, data, reply, 0);
            reply.readException();
            return Boolean.valueOf(reply.readString()).booleanValue();
        } finally {
            data.recycle();
    ...
    public boolean unregisterLockScreenCallback(IColorLockScreenCallback callback) throws RemoteException {
        ...
        try {
            data.writeInterfaceToken(IColorBaseActivityTaskManager.DESCRIPTOR);
            data.writeStrongBinder(callback != null ? callback.asBinder() : null);
            this.mRemote.transact(IColorActivityTaskManager.UNREGISTER_LOCKSCREEN_CALLBACK, data, reply, 0);
            reply.readException();
            return Boolean.valueOf(reply.readString()).booleanValue();
        } finally {
            data.recycle();
    ...
    public boolean registerKeyEventObserver(String observerFingerPrint, IColorKeyEventObserver observer, int listenFlag) throws RemoteException {
        ...
        try {
            ...
            this.mRemote.transact(IColorActivityTaskManager.REGISTER_KEY_EVENT_OBSERVER, data, reply, 0);
            reply.readException();
            return Boolean.valueOf(reply.readString()).booleanValue();
        } finally {
            data.recycle();
    ...
    public boolean unregisterKeyEventObserver(String observerFingerPrint) throws RemoteException {
        ...
        try {
            data.writeInterfaceToken(IColorBaseActivityTaskManager.DESCRIPTOR);
            data.writeString(observerFingerPrint);
            this.mRemote.transact(IColorActivityTaskManager.UNREGISTER_KEY_EVENT_OBSERVER, data, reply, 0);
            reply.readException();
            return Boolean.valueOf(reply.readString()).booleanValue();
        } finally {
            data.recycle();
    ...
    public void setGimbalLaunchPkg(String pkgName) throws RemoteException {
        ...
        try {
            data.writeInterfaceToken(IColorBaseActivityTaskManager.DESCRIPTOR);
            data.writeString(pkgName);
            this.mRemote.transact(IColorActivityTaskManager.SET_GIMBAL_LAUNCH_PKG, data, reply, 0);
            reply.readException();
        } finally {
            data.recycle();
            reply.recycle();
