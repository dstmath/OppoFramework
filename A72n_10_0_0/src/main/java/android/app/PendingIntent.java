    ...
    public static PendingIntent getActivity(Context context, int requestCode, Intent intent, int flags, Bundle options) {
        ...
        try {
            ...
            try {
                ...
                IIntentSender target = service.getIntentSender(2, packageName, null, null, requestCode, intentArr, strArr, flags, options, context.getUserId());
                if (target != null) {
    ...
    public static PendingIntent getActivityAsUser(Context context, int requestCode, Intent intent, int flags, Bundle options, UserHandle user) {
        ...
        try {
            ...
            try {
                ...
                IIntentSender target = service.getIntentSender(2, packageName, null, null, requestCode, intentArr, strArr, flags, options, user.getIdentifier());
                if (target != null) {
                    return new PendingIntent(target);
                }
                return null;
