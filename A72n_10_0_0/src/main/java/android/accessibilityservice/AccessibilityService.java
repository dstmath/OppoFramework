...
public abstract class AccessibilityService extends Service {
    ...
    public final IBinder onBind(Intent intent) {
        ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(114, Binder.getCallingUid());
