...
public class FaceManager implements BiometricAuthenticator, BiometricFaceConstants {
    ...
    private IFaceServiceReceiver mServiceReceiver = new IFaceServiceReceiver.Stub() {
        ...
        public void onAuthenticationSucceeded(long deviceId, Face face, int userId) {
            Log.d(FaceManager.TAG, "onAuthenticationSucceeded!");
            if ("com.android.systemui".equals(FaceManager.this.mContext.getOpPackageName())) {
                FaceManager.this.sendAuthenticatedSucceeded(face, userId);
            } else {
        ...
        public void onAuthenticationFailed(long deviceId) {
            Log.d(FaceManager.TAG, "onAuthenticationFailed!");
            FaceManager.this.mHandler.obtainMessage(103).sendToTarget();
        }

        @Override // android.hardware.face.IFaceServiceReceiver
        public void onError(long deviceId, int error, int vendorCode) {
            Log.d(FaceManager.TAG, "onError!");
        ...
        public void onProgressChanged(long deviceId, int progressInfo) {
            FaceManager.this.mHandler.obtainMessage(999, progressInfo, 0, Long.valueOf(deviceId)).sendToTarget();
        }
    };
    ...
    public FaceManager(Context context, IFaceService service) {
        ...
        if (this.mService == null) {
            Log.v(TAG, "FaceAuthenticationManagerService was null");
        }
        ...
        if (callback != null) {
            ...
            if (this.mService != null) {
                try {
                    ...
                    Log.d(TAG, "FaceManager#authenticate");
    ...
    public void enroll(int userId, byte[] token, CancellationSignal cancel, EnrollmentCallback callback, int[] disabledFeatures) {
        enroll(token, cancel, callback, disabledFeatures);
    }
    ...
    public void setFeature(int userId, int feature, boolean enabled, byte[] token, SetFeatureCallback callback) {
        setFeature(feature, enabled, token, callback);
    }
    ...
    public void notifyFirstUnlockWhenBoot(boolean isFirstUnlockInPasswordOnlyMode) {
        ...
        if (iFaceService != null) {
            try {
                iFaceService.notifyFirstUnlockWhenBoot(isFirstUnlockInPasswordOnlyMode);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setPreviewFrame(Rect rect) {
        ...
        if (iFaceService != null) {
            try {
                iFaceService.setPreviewFrame(this.mToken, rect);
            } catch (RemoteException e) {
    ...
    public int setPreviewSurface(Surface surface) {
        ...
        try {
            return iFaceService.setPreviewSurface(this.mToken, surface);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void resetFaceDaemon() {
        ...
        if (iFaceService != null) {
            try {
                ...
                Log.v(TAG, "Remote exception in resetFaceDaemon: ", e);
            }
        } else {
            Log.w(TAG, "resetFaceDaemon: Service not connected!");
        }
    }
    ...
    public int getFaceProcessMemory() {
        ...
        if (iFaceService != null) {
            try {
                ...
                Log.v(TAG, "Remote exception in getFaceProcessMemory: ", e);
                return -1;
            }
        } else {
            Log.w(TAG, "getFaceProcessMemory: Service not connected!");
            return -1;
        }
    }
    ...
    public int getEnrollmentTotalTimes() {
        ...
        try {
            return iFaceService.getEnrollmentTotalTimes(this.mToken);
        } catch (RemoteException e) {
    ...
    public static String getAcquiredString(Context context, int acquireInfo, int vendorCode) {
        ...
        Log.w(TAG, "Invalid acquired message: " + acquireInfo + ", " + vendorCode);
        return null;
    }
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 999) {
                ...
                FaceManager.this.sendProgressResult(((Long) msg.obj).longValue(), msg.arg1);
            }
            Trace.endSection();
        }
    }
    ...
    private void sendErrorResult(long deviceId, int errMsgId, int vendorCode) {
        Log.d(TAG, "sendErrorResult and errMsgId = " + errMsgId);
    ...
    private void sendAuthenticatedSucceeded(Face face, int userId) {
        if (this.mAuthenticationCallback != null) {
            Log.d(TAG, "sendAuthenticatedSucceeded!");
    ...
    private void sendAuthenticatedFailed() {
        if (this.mAuthenticationCallback != null) {
            Log.d(TAG, "sendAuthenticatedFailed!");
    ...
    private void sendAcquiredResult(long deviceId, int acquireInfo, int vendorCode) {
        Log.d(TAG, "sendAcquiredResult and acquireInfo = " + acquireInfo);
        AuthenticationCallback authenticationCallback = this.mAuthenticationCallback;
        if (authenticationCallback != null) {
    ...
    private void sendProgressResult(long deviceId, int progressInfo) {
        Log.d(TAG, "sendProgressResult");
        EnrollmentCallback enrollmentCallback = this.mEnrollmentCallback;
        if (enrollmentCallback != null) {
            enrollmentCallback.onProgressChanged(progressInfo);
            return;
        }
        AuthenticationCallback authenticationCallback = this.mAuthenticationCallback;
        if (authenticationCallback != null) {
            authenticationCallback.onProgressChanged(progressInfo);
        }
    }
}
