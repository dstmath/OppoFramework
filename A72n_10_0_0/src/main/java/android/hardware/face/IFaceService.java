...
public interface IFaceService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFaceService {
        ...
        static final int TRANSACTION_getFaceProcessMemory = 32;
        ...
        static final int TRANSACTION_resetFaceDaemon = 31;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 20:
                        ...
                        setFeature(_arg02, _arg0, data.createByteArray(), IFaceServiceReceiver.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
