...
public final class Sensor {
    ...
    public static final int TYPE_AOD_LIGHT = 65610;
    @UnsupportedAppUsage
    ...
    public static final int TYPE_OPPO_AMD = 65613;
    public static final int TYPE_OPPO_FFD = 65614;
    public static final int TYPE_OPPO_FREE_FALL = 65611;
    public static final int TYPE_OPPO_PEDO_MINUTE = 65615;
    public static final int TYPE_OPPO_PROXIMITY_FAKE = 65626;
    public static final int TYPE_OPPO_SAR = 65608;
    public static final int TYPE_OPPO_TILT_DETECTOR = 65612;
    @Deprecated
    ...
    private static final int[] sSensorReportingModes = {0, 3, 3, 3, 3, 16, 1, 1, 1, 3, 3, 5, 1, 1, 6, 4, 6, 1, 1, 1, 5, 1, 1, 1, 1, 1, 1, 1, 16, 1, 1, 1, 2, 16, 1, 6};
    ...
    public boolean isDirectChannelTypeSupported(int sharedMemType) {
        return sharedMemType != 1 ? sharedMemType == 2 && (this.mFlags & 2048) > 0 : (this.mFlags & 1024) > 0;
    }
