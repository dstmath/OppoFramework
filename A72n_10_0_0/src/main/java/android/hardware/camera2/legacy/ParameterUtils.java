...
public class ParameterUtils {
    ...
    public static int getClosestAvailableZoomCrop(Camera.Parameters params, Rect activeArray, Size streamSize, Rect cropRegion, Rect reportedCropRegion, Rect previewCropRegion) {
        ...
        if (DEBUG) {
            Log.v(TAG, "getClosestAvailableZoomCrop - actualCrop = " + actualCrop2);
    ...
    /* JADX INFO: Multiple debug info for r10v2 android.graphics.Rect: [D('normalizedAreaUnbounded' android.hardware.Camera$Area), D('reportedMetering' android.graphics.Rect)] */
