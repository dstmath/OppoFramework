...
public class CameraDeviceImpl extends CameraDevice implements IBinder.DeathRecipient {
    ...
    private final Runnable mCallOnClosed = new Runnable() {
        ...
        public void run() {
            ...
            if (!this.mClosedOnce) {
                ...
                CameraDeviceImpl.this.mDisconnectTime = System.currentTimeMillis();
    ...
    private final Runnable mCallOnOpened = new Runnable() {
         ...
         */
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001f, code lost:
            r4.this$0.mDeviceCallback.onOpened(r4.this$0);
            r4.this$0.mConnectTime = java.lang.System.currentTimeMillis();
            r4.this$0.addInfo(0);
         */
    ...
    private void addInfo(long disconnectTime) {
