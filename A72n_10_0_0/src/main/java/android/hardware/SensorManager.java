...
public abstract class SensorManager {
    ...
    public Sensor getDefaultSensor(int type) {
        ...
        if (type == 8 || type == 17 || type == 22 || type == 23 || type == 24 || type == 25 || type == 26 || type == 32 || type == 65612 || type == 65626 || type == 65613 || type == 65608 || type == 65610 || type == 65611 || type == 65614 || type == 65615) {
            wakeUpSensor = true;
        }
        for (Sensor sensor : l) {
    ...
    public void updateSensorConfing() {
        updateSensorConfingImpl();
    }
