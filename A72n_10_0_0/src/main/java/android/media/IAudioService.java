...
public interface IAudioService extends IInterface {
    int OppoGetDeviceForStream(int i) throws RemoteException;
    ...
    int getOppoStreamVolume(int i, String str) throws RemoteException;
    ...
    int getScoStartcount(IBinder iBinder) throws RemoteException;
    ...
    void removeMode(int i, String str) throws RemoteException;
    ...
    public static class Default implements IAudioService {
        ...
        @Override // android.media.IAudioService
        public int getOppoStreamVolume(int streamType, String callingPackage) throws RemoteException {
            return 0;
        }

        @Override // android.media.IAudioService
        public int getScoStartcount(IBinder cb) throws RemoteException {
            return 0;
        }
        ...
        @Override // android.media.IAudioService
        public void removeMode(int pid, String caller) throws RemoteException {
        }
        ...
        @Override // android.media.IAudioService
        public int OppoGetDeviceForStream(int stream) throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_OppoGetDeviceForStream = 103;
        static final int TRANSACTION_abandonAudioFocus = 50;
        ...
        static final int TRANSACTION_getBluetoothName = 104;
        static final int TRANSACTION_getCurrentAudioFocus = 52;
        ...
        static final int TRANSACTION_getOppoStreamVolume = 98;
        static final int TRANSACTION_getParameters = 106;
        ...
        static final int TRANSACTION_getScoClientInfo = 102;
        static final int TRANSACTION_getScoStartcount = 99;
        ...
        static final int TRANSACTION_getUiSoundsStreamType = 59;
        static final int TRANSACTION_getVibrateSetting = 32;
        static final int TRANSACTION_getVolumeIndexForAttributes = 20;
        static final int TRANSACTION_handleBluetoothA2dpDeviceConfigChange = 61;
        ...
        static final int TRANSACTION_isBluetoothA2dpOn = 48;
        static final int TRANSACTION_isBluetoothScoAvailableOffCall = 46;
        ...
        static final int TRANSACTION_oppoGetMode = 100;
        ...
        static final int TRANSACTION_setParameters = 105;
        ...
        static final int TRANSACTION_startBluetoothSco = 53;
        ...
        static final int TRANSACTION_unregisterAudioFocusClient = 51;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 98:
                    return "getOppoStreamVolume";
                case 99:
                    return "getScoStartcount";
                case 100:
                    return "oppoGetMode";
                case 101:
                    return "removeMode";
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        playerAttributes(_arg017, _arg1);
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 12:
                        ...
                        forceRemoteSubmixFullVolume(_arg22, data.readStrongBinder());
                        reply.writeNoException();
                        return true;
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 14:
                        ...
                        setMasterMute(_arg22, data.readInt(), data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 25:
                        ...
                        setMicrophoneMute(_arg22, data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 41:
                        ...
                        avrcpSupportsAbsoluteVolume(_arg018, _arg22);
                        return true;
                    case 42:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                    ...
                    case 46:
                        ...
                        reply.writeNoException();
                        reply.writeInt(isBluetoothScoAvailableOffCall ? 1 : 0);
                        return true;
                    case 47:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                    ...
                    case 50:
                        data.enforceInterface(DESCRIPTOR);
                        IAudioFocusDispatcher _arg019 = IAudioFocusDispatcher.Stub.asInterface(data.readStrongBinder());
                        ...
                        int _result17 = abandonAudioFocus(_arg019, _arg13, _arg2, data.readString());
                        reply.writeNoException();
                    ...
                    case 65:
                        data.enforceInterface(DESCRIPTOR);
                        IVolumeController _arg020 = IVolumeController.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg22 = true;
                        }
                        notifyVolumeControllerVisible(_arg020, _arg22);
                        reply.writeNoException();
                        return true;
                    case 66:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 69:
                        ...
                        int _result22 = setHdmiSystemAudioSupported(_arg22);
                        reply.writeNoException();
                    ...
                    case 86:
                        ...
                        int _result29 = getFocusRampTimeMs(_arg021, _arg12);
                        reply.writeNoException();
                    ...
                    case 88:
                        ...
                        playerHasOpPlayAudio(_arg022, _arg22);
                        return true;
                    case 89:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        setBluetoothHearingAidDeviceConnectionState(_arg013, _arg14, _arg22, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 90:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 98:
                        data.enforceInterface(DESCRIPTOR);
                        int _result33 = getOppoStreamVolume(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result33);
                        return true;
                    case 99:
                        data.enforceInterface(DESCRIPTOR);
                        int _result34 = getScoStartcount(data.readStrongBinder());
                        reply.writeNoException();
                        reply.writeInt(_result34);
                        return true;
                    case 100:
                        data.enforceInterface(DESCRIPTOR);
                        int _result35 = oppoGetMode();
                        reply.writeNoException();
                        reply.writeInt(_result35);
                        return true;
                    case 101:
                        data.enforceInterface(DESCRIPTOR);
                        removeMode(data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 102:
                        data.enforceInterface(DESCRIPTOR);
                        String _result36 = getScoClientInfo();
                        reply.writeNoException();
                        reply.writeString(_result36);
                        return true;
                    case 103:
                        data.enforceInterface(DESCRIPTOR);
                        int _result37 = OppoGetDeviceForStream(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result37);
                        return true;
                    case 104:
                        data.enforceInterface(DESCRIPTOR);
                        String _result38 = getBluetoothName();
                        reply.writeNoException();
                    ...
                    case 106:
                        data.enforceInterface(DESCRIPTOR);
                        String _result39 = getParameters(data.readString());
                        reply.writeNoException();
        ...
        public static class Proxy implements IAudioService {
            ...
            public boolean isBluetoothScoAvailableOffCall() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(46, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isBluetoothScoAvailableOffCall();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public int getOppoStreamVolume(int streamType, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(98, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getOppoStreamVolume(streamType, callingPackage);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int getScoStartcount(IBinder cb) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(99, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getScoStartcount(cb);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int oppoGetMode() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(100, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().oppoGetMode();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public void removeMode(int pid, String caller) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().removeMode(pid, caller);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public String getScoClientInfo() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(102, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getScoClientInfo();
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public int OppoGetDeviceForStream(int stream) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(103, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().OppoGetDeviceForStream(stream);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
