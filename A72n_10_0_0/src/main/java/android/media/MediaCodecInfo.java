...
public final class MediaCodecInfo {
    ...
    public static final class VideoCapabilities {
        ...
        private boolean supports(Integer width, Integer height, Number rate) {
            ...
            if (!ok3 || !this.mBlockCountRange.contains((Range<Integer>) Integer.valueOf(blockCount)) || !this.mBlockAspectRatioRange.contains((Range<Rational>) new Rational(widthInBlocks, heightInBlocks)) || !this.mAspectRatioRange.contains((Range<Rational>) new Rational(width.intValue(), height.intValue()))) {
                ok2 = false;
            }
