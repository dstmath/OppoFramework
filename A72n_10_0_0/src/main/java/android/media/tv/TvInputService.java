...
public abstract class TvInputService extends Service {
    ...
    public static abstract class Session implements KeyEvent.Callback {
        ...
        private void notifyTimeShiftStartPositionChanged(final long timeMs) {
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.Session.AnonymousClass11 */
        ...
        private void notifyTimeShiftCurrentPositionChanged(final long timeMs) {
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.Session.AnonymousClass12 */
        ...
        public void layoutSurface(final int left, final int top, final int right, final int bottom) {
            ...
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.Session.AnonymousClass13 */
    ...
    public static abstract class RecordingSession {
        ...
        public void notifyTuned(final Uri channelUri) {
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.RecordingSession.AnonymousClass1 */
        ...
        public void notifyRecordingStopped(final Uri recordedProgramUri) {
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.RecordingSession.AnonymousClass2 */
        ...
        public void notifyError(final int error) {
            ...
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.RecordingSession.AnonymousClass3 */

                public void run() {
                    try {
                        if (RecordingSession.this.mSessionCallback != null) {
                            RecordingSession.this.mSessionCallback.onError(error);
                        }
                    } catch (RemoteException e) {
        ...
        public void notifySessionEvent(final String eventType, final Bundle eventArgs) {
            Preconditions.checkNotNull(eventType);
            executeOrPostRunnableOnMainThread(new Runnable() {
                /* class android.media.tv.TvInputService.RecordingSession.AnonymousClass4 */
