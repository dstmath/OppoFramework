...
public class AudioManager {
    ...
    public void adjustStreamVolume(int streamType, int direction, int flags) {
        ...
        try {
            ...
            if (streamType == 3 && direction == -100) {
                ...
                String lState = OppoAtlasManager.getInstance(getContext()).getParameters(keys);
    ...
    public int getStreamMaxVolume(int streamType) {
        ...
        try {
            String value = OppoAtlasManager.getInstance(null).getParameters("get_listinfo_byname=oppo-getStreamMaxVolume=" + getContext().getOpPackageName());
            if (value == null) {
                return service.getStreamMaxVolume(streamType);
            }
            Log.d(TAG, "getStreamMaxVolume, value = " + value + " streamType " + streamType + " from " + getContext().getOpPackageName());
            try {
    ...
    public int getStreamVolume(int streamType) {
        ...
        try {
            ...
            if (streamType == 3) {
                state = OppoAtlasManager.getInstance(getContext()).getParameters(OppoAtlasManagerDefine.KEY_AUDIO_GET_DO_MUSIC_MUTE);
                Log.d(TAG, "get_do_mute_music = " + state);
                state2 = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=oppo-getstreamvolume=" + packageName);
            }
            String state4 = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=limit-getstreamvolume=" + packageName);
            if ((packageName != null && packageName.equals("com.android.bluetooth")) || ((state != null && state.equalsIgnoreCase("true")) || (state2 != null && state2.equalsIgnoreCase("true") && !isStreamMute(3)))) {
                return service.getOppoStreamVolume(streamType, packageName);
            }
            if (state4 == null || !state4.equals("true")) {
                int index2 = service.getStreamVolume(streamType);
                Log.d(TAG, "getStreamVolume packageName=" + packageName + ", index=" + index2 + ", streamType=" + streamType);
                return index2;
            }
            String state3 = OppoAtlasManager.getInstance(getContext()).getParameters("get_stream_volume=getvolume-check-delay=" + packageName + "=" + streamType);
            if (state3 == null || state3.equals(CallerInfo.UNKNOWN_NUMBER)) {
                int index = service.getStreamVolume(streamType);
                if (state3 != null) {
                    OppoAtlasManager.getInstance(getContext()).getParameters("set_stream_volume=getvolume-check-delay=" + packageName + "=" + index);
                }
                Log.d(TAG, "getStreamVolume normal, volume index=" + index);
                return index;
            }
            Log.d(TAG, "getStreamVolume too fast, volume index=" + state3 + ", package=" + packageName);
            return Integer.parseInt(state3);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    private static boolean isPublicStreamType(int streamType) {
        if (streamType == 0 || streamType == 1 || streamType == 2 || streamType == 3 || streamType == 4 || streamType == 5 || streamType == 8 || streamType == 10) {
            return true;
        }
        return false;
    }
    ...
    public void setRingerMode(int ringerMode) {
        if (isValidRingerMode(ringerMode)) {
            ...
            try {
                ...
                if (ringerMode == 0) {
                    String result = OppoAtlasManager.getInstance(getContext()).getParameters("call_interface_invalid=" + getContext().getOpPackageName() + "=setRingerMode");
    ...
    public void setStreamVolume(int streamType, int index, int flags) {
        ...
        try {
            ...
            if (streamType == 3 && (result = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=control=setStreamVolume")) != null && result.equalsIgnoreCase("true")) {
    ...
    public void setSpeakerphoneOn(boolean on) {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("get_speaker_authority=");
            sb.append(getContext().getOpPackageName());
            String keys = sb.toString();
            String mAuthoriyStr = OppoAtlasManager.getInstance(getContext()).getParameters(keys);
    ...
    public boolean isBluetoothScoAvailableOffCall() {
        ...
        if (service != null) {
            try {
                retval = service.isBluetoothScoAvailableOffCall();
            } catch (RemoteException e) {
                Log.e(TAG, "In isBluetoothScoAvailableOffCall() remote exception");
            }
        }
    ...
    public void startBluetoothSco() {
        ...
        try {
            Log.d(TAG, "startBluetoothSco from " + getContext().getOpPackageName());
    ...
    public void stopBluetoothSco() {
        ...
        IAudioService service = getService();
        try {
            Log.d(TAG, "stopBluetoothSco from " + getContext().getOpPackageName());
    ...
    public void setBluetoothScoOn(boolean on) {
        ...
        IAudioService service = getService();
        try {
            String result = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=control=setBluetoothScoOn");
            if (result != null && result.equalsIgnoreCase("true")) {
    ...
    public boolean isBluetoothScoOn() {
        ...
        try {
            ...
            try {
                String value = OppoAtlasManager.getInstance(null).getParameters("get_listinfo_byname=sco-on-delay=" + getContext().getOpPackageName());
                if (value != null) {
                    int delayTime = Integer.parseInt(value);
                    int count = service.getScoStartcount(this.mICallBack);
                    Log.d(TAG, "isBluetoothScoOn: getScoStartcount = " + count);
                    if (delayTime > 0 && delayTime < 1000 && count > 0) {
    ...
    public void setMicrophoneMute(boolean on) {
        ...
        IAudioService service = getService();
        try {
            String result = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=control=setMicrophoneMute");
            if (result != null && result.equalsIgnoreCase("true")) {
                String keys = "get_device_change_authority=" + getContext().getOpPackageName();
                String mAuthoriyStr = OppoAtlasManager.getInstance(getContext()).getParameters(keys);
    ...
    public int oppoGetMode() {
        try {
            int mode = getService().oppoGetMode();
    ...
    public int OppoGetDeviceForStream(int stream) {
        try {
            int device = getService().OppoGetDeviceForStream(stream);
    ...
    public String getBluetoothName() {
        try {
            return getService().getBluetoothName();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void removeMode(int pid, String caller) {
        try {
            getService().removeMode(pid, caller);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setParameters(String keyValuePairs) {
        if (keyValuePairs.startsWith("oppoMuteStream")) {
            String state = OppoAtlasManager.getInstance(getContext()).getParameters("get_listinfo_byname=control=muteGameVolume");
            if (state != null && state.equalsIgnoreCase("true")) {
                String value = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=oppo-muteStreamVolume=" + getContext().getOpPackageName());
                if (value != null && value.equals("true")) {
                    Log.d(TAG, "setParameters: " + keyValuePairs + " PackageName: " + getContext().getOpPackageName());
                } else {
                    return;
                }
            } else {
        ...
        } else if (keyValuePairs.startsWith("restoreVolumeBeforeSafeMediaVolume")) {
            try {
                getService().setParameters(keyValuePairs);
                return;
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        } else if (keyValuePairs.startsWith("dialog")) {
            try {
                getService().setParameters(keyValuePairs);
                return;
            } catch (RemoteException e2) {
        ...
        } else if (keyValuePairs.startsWith("OPLUS_AUDIO_SET_")) {
            if (keyValuePairs.startsWith("OPLUS_AUDIO_SET_MUTE_PHONE")) {
                String state2 = OppoAtlasManager.getInstance(getContext()).getParameters("get_listinfo_byname=control=muteCustomPhone");
                if (state2 != null && state2.equalsIgnoreCase("true")) {
                    String value2 = OppoAtlasManager.getInstance(getContext()).getParameters("check_listinfo_byname=oppo-muteCustomPhone=" + getContext().getOpPackageName());
    ...
    public String getParameters(String keys) {
        ...
        try {
            return getService().getParameters(keys);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x007f, code lost:
        r0.waitForResult(200);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x0086, code lost:
        if (android.media.AudioManager.DEBUG == false) goto L_0x0096;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x008c, code lost:
        if (r0.receivedResult() != false) goto L_0x0096;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x008e, code lost:
        android.util.Log.e(android.media.AudioManager.TAG, "requestAudio response from ext policy timed out, denying request");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0096, code lost:
        r5 = r16.mFocusRequestsLock;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0098, code lost:
        monitor-enter(r5);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:39:?, code lost:
        r16.mFocusRequestsAwaitingResult.remove(r14);
     */
    ...
    public static int oppoResetAudioPortGeneration() {
        int generation;
        synchronized (sAudioPortGeneration) {
            generation = sAudioPortGeneration.intValue();
            sAudioPortGeneration = 0;
