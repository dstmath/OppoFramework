...
public final class NfcAdapter {
    ...
    public void enableForegroundDispatch(Activity activity, PendingIntent intent, IntentFilter[] filters, String[][] techLists) {
        ...
        if (activity == null || intent == null) {
            ...
            ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(149, Binder.getCallingUid());
    ...
    @UnsupportedAppUsage
    public boolean setABFListenTechMask(int techMask) {
        try {
            if (sService != null) {
                return sService.setABFListenTechMask(techMask);
            }
            return false;
        } catch (RemoteException e) {
            attemptDeadServiceRecovery(e);
