...
public class ApduServiceInfo extends OppoBaseApduServiceInfo implements Parcelable {
    @UnsupportedAppUsage
    public static final Parcelable.Creator<ApduServiceInfo> CREATOR = new Parcelable.Creator<ApduServiceInfo>() {
        ...
        public ApduServiceInfo createFromParcel(Parcel source) {
            ...
            int serviceState = source.readInt();
            new byte[1][0] = 0;
            return new ApduServiceInfo(info, description, staticAidGroups, dynamicAidGroups, requiresUnlock, bannerResource, uid, settingsActivityName, offHostName, staticOffHostName, serviceState, source.createByteArray());
        }
    ...
    public ApduServiceInfo(ResolveInfo info, String description, ArrayList<AidGroup> staticAidGroups, ArrayList<AidGroup> dynamicAidGroups, boolean requiresUnlock, int bannerResource, int uid, String settingsActivityName, String offHost, String staticOffHost) {
        ...
        this.mOnHost = offHost != null ? false : z;
    ...
    public ApduServiceInfo(ResolveInfo info, String description, ArrayList<AidGroup> staticAidGroups, ArrayList<AidGroup> dynamicAidGroups, boolean requiresUnlock, int bannerResource, int uid, String settingsActivityName, String offHost, String staticOffHost, int serviceState, byte[] banner) {
        boolean z = true;
        this.mService = info;
        this.mServiceState = 2;
        this.mDescription = description;
    ...
    public ApduServiceInfo(PackageManager pm, ResolveInfo info, boolean onHost) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (eventType2 != i3 || parser.getDepth() > depth) {
                if (eventType2 == 1) {
                    break;
                }
                String tagName2 = parser.getName();
                if (eventType2 == i2 && "aid-group".equals(tagName2) && currentGroup2 == null) {
                    TypedArray groupAttrs = res.obtainAttributes(attrs, R.styleable.AidGroup);
                    String groupCategory = groupAttrs.getString(1);
                    String groupDescription = groupAttrs.getString(i);
    ...
    @Override // android.nfc.cardemulation.OppoBaseApduServiceInfo
