...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r1v23 int: [D('childHeight' int), D('childHeightSpec' int)] */
    /* access modifiers changed from: protected */
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (heightMode2 == Integer.MIN_VALUE && childHeightSpec4 > layoutHeight2) {
                    layoutHeight2 = Math.min(childHeightSpec4, maxLayoutHeight2);
                }
