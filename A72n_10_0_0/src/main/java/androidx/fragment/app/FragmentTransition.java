...
public class FragmentTransition {
    ...
    /* JADX INFO: Multiple debug info for r6v5 'inEpicenter'  android.graphics.Rect: [D('outSharedElements' androidx.collection.ArrayMap<java.lang.String, android.view.View>), D('inEpicenter' android.graphics.Rect)] */
