...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2 {
    ...
    /* JADX INFO: Multiple debug info for r1v1 int: [D('overScrollMode' int), D('top' int)] */
    /* JADX INFO: Multiple debug info for r2v2 int: [D('bottom' int), D('canScrollHorizontal' boolean)] */
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (nsvHost.isEnabled() && (scrollRange = nsvHost.getScrollRange()) > 0) {
                ...
                if (nsvHost.getScrollY() > 0) {
                    info.addAction(IdentityHashMap.DEFAULT_SIZE);
                }
