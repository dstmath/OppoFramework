...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        /* JADX INFO: Multiple debug info for r1v8 int: [D('index' int), D('doubled' okhttp3.internal.framed.Header[])] */
        ...
        public ByteString readByteString() throws IOException {
            ...
            boolean huffmanDecode = (firstByte & Opcodes.IOR) == 128;
    ...
    public static final class Writer {
        ...
        Writer(Buffer out2) {
            this(SETTINGS_HEADER_TABLE_SIZE, out2);
        }

        Writer(int headerTableSizeSetting2, Buffer out2) {
        ...
        /* JADX INFO: Multiple debug info for r2v3 int: [D('index' int), D('doubled' okhttp3.internal.framed.Header[])] */
        ...
        public void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (staticIndex != null) {
                    ...
                    int dynamicIndex = Util.indexOf(this.dynamicTable, header);
                    if (dynamicIndex != -1) {
                        writeInt((dynamicIndex - this.nextHeaderIndex) + Hpack.STATIC_HEADER_TABLE.length, Hpack.PREFIX_7_BITS, Opcodes.IOR);
                    } else {
        ...
        public void writeInt(int value, int prefixMask, int bits) {
            ...
            while (value2 >= 128) {
                this.out.writeByte((value2 & Hpack.PREFIX_7_BITS) | Opcodes.IOR);
                value2 >>>= 7;
            }
