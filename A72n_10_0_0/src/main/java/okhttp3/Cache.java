        ...
        public Entry(Source in) throws IOException {
            try {
                ...
                if (isHttps()) {
                    ...
                    if (blank.length() <= 0) {
                        this.handshake = Handshake.get(!source.exhausted() ? TlsVersion.forJavaName(source.readUtf8LineStrict()) : tlsVersion, CipherSuite.forJavaName(source.readUtf8LineStrict()), readCertificateList(source), readCertificateList(source));
                    } else {
