...
public class ColorFrameworkFactoryImpl extends ColorFrameworkFactory {
    ...
    public <T extends IOppoCommonFeature> T getFeature(T def, Object... vars) {
        ...
        switch (AnonymousClass1.$SwitchMap$android$common$OppoFeatureList$OppoIndex[def.index().ordinal()]) {
            case 1:
                return (T) OppoFeatureManager.getTraceMonitor(getColorThemeManager());
            case 2:
                return (T) OppoFeatureManager.getTraceMonitor(getColorAccidentallyTouchHelper());
            case 3:
                return (T) OppoFeatureManager.getTraceMonitor(getColorDirectViewHelper(vars));
            case 4:
                return (T) OppoFeatureManager.getTraceMonitor(getColorViewHooks(vars));
            case AlgorithmBinderCode.BIND_EVENT_HANDLE /* 5 */:
                return (T) OppoFeatureManager.getTraceMonitor(getColorCommonInjector());
            case 6:
                return (T) OppoFeatureManager.getTraceMonitor(getColorViewRootUtil(vars));
            case 7:
                return (T) OppoFeatureManager.getTraceMonitor(getColorFontManager(vars));
            case ColorUxIconConstants.IconTheme.THEME_MATERIAL_RADIUS_PX /* 8 */:
                return (T) OppoFeatureManager.getTraceMonitor(getColorListHooks());
            case 9:
                return (T) OppoFeatureManager.getTraceMonitor(getColorTextViewRTLUtilForUG());
            case 10:
                return (T) OppoFeatureManager.getTraceMonitor(getColorOverScrollerHelper(vars));
            case 11:
                return (T) OppoFeatureManager.getTraceMonitor(getColorFavoriteManager());
            case ColorUxIconConstants.IconTheme.ICON_RADIUS_BIT_LENGTH /* 12 */:
                return (T) OppoFeatureManager.getTraceMonitor(getColorScreenShotEuclidManager());
            case 13:
                return (T) OppoFeatureManager.getTraceMonitor(getColorDarkModeManager());
            case 14:
                return (T) OppoFeatureManager.getTraceMonitor(getColorInputMethodServiceUtils());
            case 15:
                return (T) OppoFeatureManager.getTraceMonitor(getColorResolverManager());
            case 16:
                return (T) OppoFeatureManager.getTraceMonitor(getTextJustificationHooks());
            case 17:
                return (T) OppoFeatureManager.getTraceMonitor(getColorFtHooks());
            case 18:
                return (T) OppoFeatureManager.getTraceMonitor(getColorMagnifierHooks());
            case 19:
                return (T) OppoFeatureManager.getTraceMonitor(getColorAlertControllerEuclidManger());
            case 20:
                return (T) OppoFeatureManager.getTraceMonitor(getColorDeepThinkerManager(vars));
            case 21:
                return (T) OppoFeatureManager.getTraceMonitor(getColorBurmeseZgFlagHooks());
            case 22:
                return (T) OppoFeatureManager.getTraceMonitor(getColorThemeStyle(vars));
            case 23:
                return (T) OppoFeatureManager.getTraceMonitor(getColorAntiVirusBehaviorManager(vars));
            default:
