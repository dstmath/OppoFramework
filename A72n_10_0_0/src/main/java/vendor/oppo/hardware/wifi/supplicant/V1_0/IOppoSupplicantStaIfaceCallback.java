...
public interface IOppoSupplicantStaIfaceCallback extends ISupplicantStaIfaceCallback {
    ...
    static IOppoSupplicantStaIfaceCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOppoSupplicantStaIfaceCallback getService(boolean retry) throws RemoteException {
