...
public interface IOppoSupplicantStaIface extends ISupplicantStaIface {
    ...
    static IOppoSupplicantStaIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOppoSupplicantStaIface getService(boolean retry) throws RemoteException {
