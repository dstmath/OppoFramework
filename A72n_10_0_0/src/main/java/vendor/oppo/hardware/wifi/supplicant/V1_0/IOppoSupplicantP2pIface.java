...
public interface IOppoSupplicantP2pIface extends ISupplicantP2pIface {
    ...
    static IOppoSupplicantP2pIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IOppoSupplicantP2pIface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IOppoSupplicantP2pIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOppoSupplicantP2pIface getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IOppoSupplicantP2pIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IOppoSupplicantP2pIface getService() throws RemoteException {
