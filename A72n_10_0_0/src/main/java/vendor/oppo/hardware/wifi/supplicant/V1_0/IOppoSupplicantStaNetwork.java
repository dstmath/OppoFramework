...
public interface IOppoSupplicantStaNetwork extends ISupplicantStaNetwork {
    ...
    SupplicantStatus setDeleteblankGbkSsid(ArrayList<Byte> arrayList) throws RemoteException;

    SupplicantStatus setDeleteblankSsid(ArrayList<Byte> arrayList) throws RemoteException;
    ...
    static IOppoSupplicantStaNetwork asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IOppoSupplicantStaNetwork castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IOppoSupplicantStaNetwork getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOppoSupplicantStaNetwork getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IOppoSupplicantStaNetwork getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IOppoSupplicantStaNetwork getService() throws RemoteException {
    ...
    public static final class Proxy implements IOppoSupplicantStaNetwork {
        ...
        @Override // vendor.oppo.hardware.wifi.supplicant.V1_0.IOppoSupplicantStaNetwork
        public SupplicantStatus setDeleteblankSsid(ArrayList<Byte> ssid) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IOppoSupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt8Vector(ssid);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // vendor.oppo.hardware.wifi.supplicant.V1_0.IOppoSupplicantStaNetwork
        public SupplicantStatus setDeleteblankGbkSsid(ArrayList<Byte> ssid) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IOppoSupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeInt8Vector(ssid);
            HwParcel _hidl_reply = new HwParcel();
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 90:
                    ...
                    _hidl_request.enforceInterface(IOppoSupplicantStaNetwork.kInterfaceName);
                    SupplicantStatus _hidl_out_status52 = setDeleteblankSsid(_hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 91:
                    ...
                    _hidl_request.enforceInterface(IOppoSupplicantStaNetwork.kInterfaceName);
                    SupplicantStatus _hidl_out_status53 = setDeleteblankGbkSsid(_hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
