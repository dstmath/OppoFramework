...
public interface IEngineer extends IBase {
    ...
    static IEngineer asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IEngineer castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IEngineer getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IEngineer getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    static IEngineer getService(String serviceName) throws RemoteException {
