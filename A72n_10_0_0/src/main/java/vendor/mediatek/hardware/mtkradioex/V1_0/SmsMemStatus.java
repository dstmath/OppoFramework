...
public final class SmsMemStatus {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != SmsMemStatus.class) {
            return false;
        }
        SmsMemStatus other = (SmsMemStatus) otherObject;
        if (this.used == other.used && this.total == other.total) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<SmsMemStatus> readVectorFromParcel(HwParcel parcel) {
        ArrayList<SmsMemStatus> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 8), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            SmsMemStatus _hidl_vec_element = new SmsMemStatus();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.used = _hidl_blob.getInt32(0 + _hidl_offset);
        this.total = _hidl_blob.getInt32(4 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SmsMemStatus> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(0 + _hidl_offset, this.used);
        _hidl_blob.putInt32(4 + _hidl_offset, this.total);
    }
}
