...
public final class OperatorInfoWithAct {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.lac.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 56 + 0, false);
        this.act = _hidl_blob.getString(_hidl_offset + 72);
        parcel.readEmbeddedBuffer((long) (this.act.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 72 + 0, false);
    }
