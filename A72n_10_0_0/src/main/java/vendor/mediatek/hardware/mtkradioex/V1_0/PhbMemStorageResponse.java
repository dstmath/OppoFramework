...
public final class PhbMemStorageResponse {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.storage = _hidl_blob.getString(_hidl_offset + 0);
        parcel.readEmbeddedBuffer((long) (this.storage.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
