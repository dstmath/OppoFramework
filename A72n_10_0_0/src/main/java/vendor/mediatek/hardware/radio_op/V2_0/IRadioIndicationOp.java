...
public interface IRadioIndicationOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@2.0::IRadioIndicationOp";
    ...
    public static final class Proxy implements IRadioIndicationOp {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@2.0::IRadioIndicationOp]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndicationOp {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-120, 68, 42, -112, 50, 117, -123, 42, 88, -28, -124, 52, -112, -1, 102, -78, -46, Byte.MAX_VALUE, -70, -8, 53, -42, 90, -86, 34, 72, 22, 34, -114, -28, 57, -37}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
