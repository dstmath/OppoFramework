...
public interface IRadioOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@1.1::IRadioOp";
    ...
    static IRadioOp asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IRadioOp castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IRadioOp getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IRadioOp getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IRadioOp getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IRadioOp getService() throws RemoteException {
    ...
    public static final class Proxy implements IRadioOp {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@1.1::IRadioOp]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioOp {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-14, 35, 84, 39, 12, 100, -101, 90, -16, -48, -13, 38, 40, 22, 77, -110, -23, -87, 124, -90, 51, 15, 112, 57, -83, -58, 62, 67, 100, -91, 50, 85}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
