...
public interface IRadioIndicationOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@1.1::IRadioIndicationOp";
    ...
    public static final class Proxy implements IRadioIndicationOp {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@1.1::IRadioIndicationOp]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndicationOp {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioIndicationOp.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{64, 56, 121, 67, 122, 63, -127, 9, -116, -1, 52, 55, -100, 36, 0, 23, -55, -122, 124, 100, 126, 75, 107, 96, 58, 101, -124, 118, -87, -42, -9, -40}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
