...
public interface ILbs extends IBase {
    ...
    static ILbs asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static ILbs castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static ILbs getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ILbs getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ILbs getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ILbs getService() throws RemoteException {
