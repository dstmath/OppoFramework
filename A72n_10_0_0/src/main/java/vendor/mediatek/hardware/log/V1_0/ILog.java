...
public interface ILog extends IBase {
    ...
    static ILog asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static ILog castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static ILog getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ILog getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ILog getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ILog getService() throws RemoteException {
