...
public interface ISoter extends IBase {
    ...
    static ISoter asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static ISoter castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static ISoter getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static ISoter getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static ISoter getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static ISoter getService() throws RemoteException {
