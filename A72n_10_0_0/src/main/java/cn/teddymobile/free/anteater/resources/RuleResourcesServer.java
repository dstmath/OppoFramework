...
public class RuleResourcesServer {
    ...
    private String getRule(String packageName) {
        String str;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onQueryResult(Context context, String rule, QueryCallback callback) {
        if (callback != null) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateCache(Context context, boolean update, String tag) {
        String str;
        String str2;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateCallback(String packageName, QueryCallback callback) {
        long start = SystemClock.uptimeMillis();
