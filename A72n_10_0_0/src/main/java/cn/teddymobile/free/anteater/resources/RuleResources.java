...
public class RuleResources {
    ...
    private void updateRules(Context context) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void loadFromCache(Context context, InitCallback callback) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x0114, code lost:
        return;
     */
    private void loadFromProvider(Context context, InitCallback callback) {
        String str;
        String str2;
        synchronized (this.mRuleList) {
