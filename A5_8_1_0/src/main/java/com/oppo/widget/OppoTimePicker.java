...
public class OppoTimePicker extends FrameLayout {
    ...
    public OppoTimePicker(Context context, AttributeSet attrs) {
        this(context, attrs, 201393154);
    }

    public OppoTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(201917443, this, DEFAULT_ENABLED_STATE);
        ...
        this.mOppoHourSpinner.setOnValueChangedListener(new OnValueChangeListener() {
            public void onValueChange(OppoNumberPicker spinner, int oldVal, int newVal) {
                ...
                if (ColorAccessibilityUtil.isTalkbackEnabled(OppoTimePicker.this.getContext())) {
                    String accessDate;
                    OppoTimePicker.this.mAccessHour = spinner.getValue();
                    if (OppoTimePicker.this.is24HourView()) {
                        if (OppoTimePicker.this.mHourText.getVisibility() == 8) {
                            accessDate = OppoTimePicker.this.mAccessHour + " " + OppoTimePicker.this.mAccessMinute;
                        } else {
                            accessDate = OppoTimePicker.this.mAccessHour + ((String) OppoTimePicker.this.mHourText.getText()) + OppoTimePicker.this.mAccessMinute + OppoTimePicker.this.mMinuteText.getText();
                        }
                    } else if (OppoTimePicker.this.mHourText.getVisibility() == 8) {
                        accessDate = OppoTimePicker.this.mAccessAm + OppoTimePicker.this.mAccessHour + " " + OppoTimePicker.this.mAccessMinute;
                    } else {
                        accessDate = OppoTimePicker.this.mAccessAm + OppoTimePicker.this.mAccessHour + ((String) OppoTimePicker.this.mHourText.getText()) + OppoTimePicker.this.mAccessMinute + OppoTimePicker.this.mMinuteText.getText();
                    }
                    OppoTimePicker.this.announceForAccessibility(accessDate);
                }
            }
        });
        ...
        this.mOppoMinuteSpinner.setOnValueChangedListener(new OnValueChangeListener() {
            public void onValueChange(OppoNumberPicker spinner, int oldVal, int newVal) {
                ...
                if (ColorAccessibilityUtil.isTalkbackEnabled(OppoTimePicker.this.getContext())) {
                    String accessDate;
                    OppoTimePicker.this.mAccessMinute = spinner.getValue();
                    if (OppoTimePicker.this.is24HourView()) {
                        if (OppoTimePicker.this.mHourText.getVisibility() == 8) {
                            accessDate = OppoTimePicker.this.mAccessHour + " " + OppoTimePicker.this.mAccessMinute;
                        } else {
        ...
        if (amPmView instanceof Button) {
            ...
            this.mAmPmButton.setOnClickListener(new OnClickListener() {
                public void onClick(View button) {
                    button.requestFocus();
                    OppoTimePicker.this.mIsAm = OppoTimePicker.this.mIsAm ^ 1;
            ...
            this.mOppoAmPmSpinner.setOnValueChangedListener(new OnValueChangeListener() {
                public void onValueChange(OppoNumberPicker picker, int oldVal, int newVal) {
                    ...
                    if (ColorAccessibilityUtil.isTalkbackEnabled(OppoTimePicker.this.getContext())) {
                        String accessDate;
                        OppoTimePicker.this.mAccessAm = OppoTimePicker.this.mAmPmStrings[picker.getValue()];
                        if (OppoTimePicker.this.is24HourView()) {
                            if (OppoTimePicker.this.mHourText.getVisibility() == 8) {
                                accessDate = OppoTimePicker.this.mAccessHour + " " + OppoTimePicker.this.mAccessMinute;
                            } else {
        ...
        if (ColorAccessibilityUtil.isTalkbackEnabled(this.mContext)) {
            this.mAccessHour = this.mOppoHourSpinner.getValue();
            this.mAccessMinute = this.mOppoMinuteSpinner.getValue();
            if (!is24HourView()) {
                this.mAccessAm = this.mAmPmStrings[this.mOppoAmPmSpinner.getValue()];
                Log.i("oppotimePicker", "accessAm = " + this.mAccessAm + " mOppoAmPmSpinner.getValue()= " + this.mOppoAmPmSpinner.getValue());
            }
        }
    }
