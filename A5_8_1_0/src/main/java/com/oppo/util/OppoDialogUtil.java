...
public class OppoDialogUtil {
    ...
    private void setButtonBackground(int whichButtons, int option) {
        switch (whichButtons) {
            case 1:
    ...
    public void setDialogButtonFlag(Window mWindow, int option) {
        int flag = 0;
        this.mButtonPositive = (Button) mWindow.findViewById(16908313);
        this.mButtonNegative = (Button) mWindow.findViewById(16908314);
        this.mButtonNeutral = (Button) mWindow.findViewById(16908315);
    ...
    public void setDialogDrag(AlertController ac, Window window, int option) {
