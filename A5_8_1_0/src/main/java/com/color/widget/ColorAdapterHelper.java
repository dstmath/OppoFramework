...
class ColorAdapterHelper implements com.color.widget.ColorOpReorderer.Callback {
    ...
    final ColorOpReorderer mOpReorderer;
    ...
    ColorAdapterHelper(Callback callback) {
        this(callback, false);
    }

    ColorAdapterHelper(Callback callback, boolean disableRecycler) {
        ...
        this.mOpReorderer = new ColorOpReorderer(this);
    }

    ColorAdapterHelper addUpdateOp(UpdateOp... ops) {
