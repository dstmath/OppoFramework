...
import android.widget.OppoOverScroller;
import com.color.widget.ColorAdapterHelper.Callback;
import com.color.widget.ColorAdapterHelper.UpdateOp;
...
public class ColorRecyclerView extends ViewGroup {
    static final boolean ALLOW_SIZE_IN_UNSPECIFIED_SPEC;
    private static final int[] CLIP_TO_PADDING_ATTR = new int[]{16842987};
    private static final boolean DEBUG = false;
    private static final boolean DEBUG_INCONSISTENCY = false;
    ...
    final int SCROLLING;
    private ColorRecyclerViewAccessibilityDelegate mAccessibilityDelegate;
    private final AccessibilityManager mAccessibilityManager;
    private OnItemTouchListener mActiveOnItemTouchListener;
    private Adapter mAdapter;
    ColorAdapterHelper mAdapterHelper;
    private boolean mAdapterUpdateDuringMeasure;
    private EdgeEffect mBottomGlow;
    private ChildDrawingOrderCallback mChildDrawingOrderCallback;
    ColorChildHelper mChildHelper;
    ...
    private OppoOverScroller mScroller;
    final State mState;
    ...
    final ColorViewInfoStore mViewInfoStore;
    ...
    public static abstract class LayoutManager {
        ...
        ColorRecyclerView mRecyclerView;
        ...
        void setRecyclerView(ColorRecyclerView recyclerView) {
        ...
        void setMeasureSpecs(int wSpec, int hSpec) {
            ...
            if (this.mWidthMode == 0 && (ColorRecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC ^ 1) != 0) {
                this.mWidth = 0;
            }
            this.mHeight = MeasureSpec.getSize(hSpec);
            this.mHeightMode = MeasureSpec.getMode(hSpec);
            if (this.mHeightMode == 0 && (ColorRecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC ^ 1) != 0) {
                this.mHeight = 0;
            }
        }
        ...
        void dispatchAttachedToWindow(ColorRecyclerView view) {
            this.mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(ColorRecyclerView view, Recycler recycler) {
        ...
        public void onAttachedToWindow(ColorRecyclerView view) {
        }

        @Deprecated
        public void onDetachedFromWindow(ColorRecyclerView view) {
        }

        public void onDetachedFromWindow(ColorRecyclerView view, Recycler recycler) {
        ...
        public void onLayoutChildren(Recycler recycler, State state) {
            Log.e(ColorRecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
        }
        ...
        public void smoothScrollToPosition(ColorRecyclerView recyclerView, State state, int position) {
            Log.e(ColorRecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }
        ...
        public void endAnimation(View view) {
            if (this.mRecyclerView.mItemAnimator != null) {
                this.mRecyclerView.mItemAnimator.endAnimation(ColorRecyclerView.getChildViewHolderInt(view));
            }
        }
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ViewHolder holder = ColorRecyclerView.getChildViewHolderInt(child);
        ...
        public int getItemViewType(View view) {
            return ColorRecyclerView.getChildViewHolderInt(view).getItemViewType();
        }
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                View child = getChildAt(i);
                ViewHolder vh = ColorRecyclerView.getChildViewHolderInt(child);
        ...
        public void ignoreView(View view) {
            ...
            ViewHolder vh = ColorRecyclerView.getChildViewHolderInt(view);
            vh.addFlags(128);
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ViewHolder viewHolder = ColorRecyclerView.getChildViewHolderInt(view);
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                ViewHolder vh = ColorRecyclerView.getChildViewHolderInt(scrap);
                if (!vh.shouldIgnore()) {
        ...
        public void measureChildWithMargins(View child, int widthUsed, int heightUsed) {
            ...
            Rect insets = this.mRecyclerView.getItemDecorInsetsForChild(child);
            heightUsed += insets.top + insets.bottom;
            int widthSpec = getChildMeasureSpec(getWidth(), (((getPaddingLeft() + getPaddingRight()) + lp.leftMargin) + lp.rightMargin) + (widthUsed + (insets.left + insets.right)), lp.width, canScrollHorizontally());
            int heightSpec = getChildMeasureSpec(getHeight(), (((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin) + heightUsed, lp.height, canScrollVertically());
            if (shouldMeasureChild(child, widthSpec, heightSpec, lp)) {
                child.measure(widthSpec, heightSpec);
            }
        }
        ...
        public boolean requestChildRectangleOnScreen(ColorRecyclerView parent, View child, Rect rect, boolean immediate) {
            int dx;
            int dy;
        ...
        @Deprecated
        public boolean onRequestChildFocus(ColorRecyclerView parent, View child, View focused) {
            return !isSmoothScrolling() ? parent.isComputingLayout() : true;
        }

        public boolean onRequestChildFocus(ColorRecyclerView parent, State state, View child, View focused) {
        ...
        public boolean onAddFocusables(ColorRecyclerView recyclerView, ArrayList<View> arrayList, int direction, int focusableMode) {
            return false;
        }

        public void onItemsChanged(ColorRecyclerView recyclerView) {
        }

        public void onItemsAdded(ColorRecyclerView recyclerView, int positionStart, int itemCount) {
        }

        public void onItemsRemoved(ColorRecyclerView recyclerView, int positionStart, int itemCount) {
        }

        public void onItemsUpdated(ColorRecyclerView recyclerView, int positionStart, int itemCount) {
        }

        public void onItemsUpdated(ColorRecyclerView recyclerView, int positionStart, int itemCount, Object payload) {
            onItemsUpdated(recyclerView, positionStart, itemCount);
        }

        public void onItemsMoved(ColorRecyclerView recyclerView, int from, int to, int itemCount) {
        }
        ...
        public void removeAndRecycleAllViews(Recycler recycler) {
            for (int i = getChildCount() - 1; i >= 0; i--) {
                if (!ColorRecyclerView.getChildViewHolderInt(getChildAt(i)).shouldIgnore()) {
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state, AccessibilityEvent event) {
            boolean z = true;
            AccessibilityRecord record = event;
        ...
        void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfo info) {
            ViewHolder vh = ColorRecyclerView.getChildViewHolderInt(host);
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColorRecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(0, 1);
            properties.spanCount = a.getInt(2, 1);
            properties.reverseLayout = a.getBoolean(3, false);
            properties.stackFromEnd = a.getBoolean(4, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(ColorRecyclerView recyclerView) {
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            private void runIfNecessary(ColorRecyclerView recyclerView) {
                ...
                if (this.changed) {
                    ...
                    if (this.consecutiveUpdates > 10) {
                        Log.e(ColorRecyclerView.TAG, "Smooth Scroll action is being updated too frequently. Make sure you are not changing it unless necessary");
                    }
                    this.changed = false;
                } else {
                    this.consecutiveUpdates = 0;
        ...
        void start(ColorRecyclerView recyclerView, LayoutManager layoutManager) {
            this.mRecyclerView = recyclerView;
        ...
        private void onAnimation(int dx, int dy) {
            ColorRecyclerView recyclerView = this.mRecyclerView;
            ...
            if (this.mTargetView != null) {
                if (getChildPosition(this.mTargetView) == this.mTargetPosition) {
                    ...
                    Log.e(ColorRecyclerView.TAG, "Passed over target position while smooth scrolling.");
                    this.mTargetView = null;
                }
            }
            if (this.mRunning) {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            holder.setFlags(1, GL10.GL_ALWAYS);
        ...
        public void onAttachedToRecyclerView(ColorRecyclerView recyclerView) {
        }

        public void onDetachedFromRecyclerView(ColorRecyclerView recyclerView) {
        }
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimatorListener {
        /* synthetic */ ItemAnimatorRestoreListener(ColorRecyclerView this$0, ItemAnimatorRestoreListener -this1) {
            this();
        }
        ...
        public void onAnimationFinished(ViewHolder item) {
            ...
            if (!item.shouldBeKeptAsChild() && !ColorRecyclerView.this.removeAnimatingView(item.itemView) && item.isTmpDetached()) {
                ColorRecyclerView.this.removeDetachedView(item.itemView, false);
            }
        }
    }

    public static abstract class ItemDecoration {
        public void onDraw(Canvas c, ColorRecyclerView parent, State state) {
            onDraw(c, parent);
        }
        ...
        public void onDrawOver(Canvas c, ColorRecyclerView parent, State state) {
            onDrawOver(c, parent);
        }

        @Deprecated
        public void onDrawOver(Canvas c, ColorRecyclerView parent) {
        }
        ...
        public void getItemOffsets(Rect outRect, View view, ColorRecyclerView parent, State state) {
    ...
    public interface OnItemTouchListener {
        boolean onInterceptTouchEvent(ColorRecyclerView colorRecyclerView, MotionEvent motionEvent);

        void onRequestDisallowInterceptTouchEvent(boolean z);

        void onTouchEvent(ColorRecyclerView colorRecyclerView, MotionEvent motionEvent);
    }

    public static abstract class OnScrollListener {
        public void onScrollStateChanged(ColorRecyclerView recyclerView, int newState) {
        }

        public void onScrolled(ColorRecyclerView recyclerView, int dx, int dy) {
        }
    }
    ...
    public static class RecycledViewPool {
        ...
        public ViewHolder getRecycledView(int viewType) {
            ArrayList<ViewHolder> scrapHeap = (ArrayList) this.mScrap.get(viewType);
            if (scrapHeap == null || (scrapHeap.isEmpty() ^ 1) == 0) {
                return null;
            }
    ...
    public final class Recycler {
        ...
        boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            boolean z = true;
            if (holder.isRemoved()) {
                return ColorRecyclerView.this.mState.isPreLayout();
            }
            if (holder.mPosition < 0 || holder.mPosition >= ColorRecyclerView.this.mAdapter.getItemCount()) {
                Log.e(ColorRecyclerView.TAG, "Inconsistency detected. Invalid view holder adapter position" + holder);
                return false;
            } else if (!ColorRecyclerView.this.mState.isPreLayout() && ColorRecyclerView.this.mAdapter.getItemViewType(holder.mPosition) != holder.getItemViewType()) {
                return false;
            } else {
                if (!ColorRecyclerView.this.mAdapter.hasStableIds()) {
                    return true;
                }
                if (holder.getItemId() != ColorRecyclerView.this.mAdapter.getItemId(holder.mPosition)) {
                    z = false;
                }
                return z;
            }
        ...
        public void bindViewToPosition(View view, int position) {
            boolean z = true;
            ViewHolder holder = ColorRecyclerView.getChildViewHolderInt(view);
            if (holder == null) {
                throw new IllegalArgumentException("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter");
            }
            int offsetPosition = ColorRecyclerView.this.mAdapterHelper.findPositionOffset(position);
            if (offsetPosition < 0 || offsetPosition >= ColorRecyclerView.this.mAdapter.getItemCount()) {
                Log.e(ColorRecyclerView.TAG, "Inconsistency detected. Invalid item position " + position + "(offset:" + offsetPosition + ")." + "state:" + ColorRecyclerView.this.mState.getItemCount());
                return;
            }
            LayoutParams rvLayoutParams;
            holder.mOwnerRecyclerView = ColorRecyclerView.this;
            ColorRecyclerView.this.mAdapter.bindViewHolder(holder, offsetPosition);
            attachAccessibilityDelegate(view);
            if (ColorRecyclerView.this.mState.isPreLayout()) {
                holder.mPreLayoutPosition = position;
            }
            android.view.ViewGroup.LayoutParams lp = holder.itemView.getLayoutParams();
            if (lp == null) {
                rvLayoutParams = (LayoutParams) ColorRecyclerView.this.generateDefaultLayoutParams();
                holder.itemView.setLayoutParams(rvLayoutParams);
            } else if (ColorRecyclerView.this.checkLayoutParams(lp)) {
                rvLayoutParams = (LayoutParams) lp;
            } else {
                rvLayoutParams = (LayoutParams) ColorRecyclerView.this.generateLayoutParams(lp);
                holder.itemView.setLayoutParams(rvLayoutParams);
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int position) {
            if (position < 0 || position >= ColorRecyclerView.this.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("invalid position " + position + ". State " + "item count is " + ColorRecyclerView.this.mState.getItemCount());
            } else if (ColorRecyclerView.this.mState.isPreLayout()) {
                return ColorRecyclerView.this.mAdapterHelper.findPositionOffset(position);
            } else {
                return position;
            }
        }
        ...
        View getViewForPosition(int position, boolean dryRun) {
            if (position < 0 || position >= ColorRecyclerView.this.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("Invalid item position " + position + "(" + position + "). Item count:" + ColorRecyclerView.this.mState.getItemCount());
            }
            int offsetPosition;
            LayoutParams rvLayoutParams;
                ...
                if (holder != null) {
                    if (validateViewHolderForOffsetPosition(holder)) {
                        ...
                        if (!dryRun) {
                            holder.addFlags(4);
                            if (holder.isScrap()) {
                                ColorRecyclerView.this.removeDetachedView(holder.itemView, false);
                                holder.unScrap();
            ...
            if (holder == null) {
                offsetPosition = ColorRecyclerView.this.mAdapterHelper.findPositionOffset(position);
                if (offsetPosition < 0 || offsetPosition >= ColorRecyclerView.this.mAdapter.getItemCount()) {
                    Log.w(ColorRecyclerView.TAG, "Inconsistency detected. Invalid item position " + position + "(offset:" + offsetPosition + ")." + "state:" + ColorRecyclerView.this.mState.getItemCount());
                    return null;
                }
                int type = ColorRecyclerView.this.mAdapter.getItemViewType(offsetPosition);
                if (ColorRecyclerView.this.mAdapter.hasStableIds()) {
                    holder = getScrapViewForId(ColorRecyclerView.this.mAdapter.getItemId(offsetPosition), type, dryRun);
                    if (holder != null) {
                ...
                if (holder == null && this.mViewCacheExtension != null) {
                    ...
                    if (view != null) {
                        holder = ColorRecyclerView.this.getChildViewHolder(view);
                        if (holder == null) {
                ...
                if (holder == null) {
                    ...
                    if (holder != null) {
                        ...
                        if (ColorRecyclerView.FORCE_INVALIDATE_DISPLAY_LIST) {
                            invalidateDisplayListInt(holder);
                        }
                    }
                }
                if (holder == null) {
                    holder = ColorRecyclerView.this.mAdapter.createViewHolder(ColorRecyclerView.this, type);
                }
            }
            if (fromScrap && (ColorRecyclerView.this.mState.isPreLayout() ^ 1) != 0 && holder.hasAnyOfTheFlags(8192)) {
                holder.setFlags(0, 8192);
                if (ColorRecyclerView.this.mState.mRunSimpleAnimations) {
                    ColorRecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, ColorRecyclerView.this.mItemAnimator.recordPreLayoutInformation(ColorRecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT, holder.getUnmodifiedPayloads()));
                }
            }
            boolean bound = false;
            if (ColorRecyclerView.this.mState.isPreLayout() && holder.isBound()) {
                holder.mPreLayoutPosition = position;
        ...
        private void attachAccessibilityDelegate(View itemView) {
            if (ColorRecyclerView.this.mAccessibilityManager != null && ColorRecyclerView.this.mAccessibilityManager.isEnabled() && itemView.getImportantForAccessibility() == 0) {
        ...
        void recycleViewInternal(View view) {
            recycleViewHolderInternal(ColorRecyclerView.getChildViewHolderInt(view));
        }
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                if (ColorRecyclerView.this.mAdapter == null || !transientStatePreventsRecycling) {
                    forceRecycle = false;
                } else {
                    forceRecycle = ColorRecyclerView.this.mAdapter.onFailedToRecycleView(holder);
                }
                ...
                ColorRecyclerView.this.mViewInfoStore.removeViewHolder(holder);
        ...
        void scrapView(View view) {
            ViewHolder holder = ColorRecyclerView.getChildViewHolderInt(view);
            if (!holder.hasAnyOfTheFlags(12) && (holder.isUpdated() ^ 1) == 0 && !ColorRecyclerView.this.canReuseUpdatedViewHolder(holder)) {
                if (this.mChangedScrap == null) {
                    this.mChangedScrap = new ArrayList();
                }
                holder.setScrapContainer(this, true);
                this.mChangedScrap.add(holder);
            } else if (!holder.isInvalid() || (holder.isRemoved() ^ 1) == 0 || (ColorRecyclerView.this.mAdapter.hasStableIds() ^ 1) == 0) {
            ...
            if (this.mChangedScrap != null) {
                ...
                if (changedScrapSize != 0) {
                    ...
                    if (ColorRecyclerView.this.mAdapter.hasStableIds()) {
                        int offsetPosition = ColorRecyclerView.this.mAdapterHelper.findPositionOffset(position);
                        if (offsetPosition > 0 && offsetPosition < ColorRecyclerView.this.mAdapter.getItemCount()) {
                            long id = ColorRecyclerView.this.mAdapter.getItemId(offsetPosition);
                            i = 0;
                            while (i < changedScrapSize) {
                                holder = (ViewHolder) this.mChangedScrap.get(i);
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            while (i < scrapCount) {
                ...
                if (holder.wasReturnedFromScrap() || holder.getLayoutPosition() != position || (holder.isInvalid() ^ 1) == 0 || (!ColorRecyclerView.this.mState.mInPreLayout && (holder.isRemoved() ^ 1) == 0)) {
                    i++;
                } else if (type == -1 || holder.getItemViewType() == type) {
                    holder.addFlags(32);
                    return holder;
                } else {
                    Log.e(ColorRecyclerView.TAG, "Scrap view for position " + position + " isn't dirty but has" + " wrong view type! (found " + holder.getItemViewType() + " but expected " + type + ")");
                    if (!dryRun) {
                        View view = ColorRecyclerView.this.mChildHelper.findHiddenNonRemovedView(position, type);
                        if (view != null) {
                            ViewHolder vh = ColorRecyclerView.getChildViewHolderInt(view);
                            ColorRecyclerView.this.mChildHelper.unhide(view);
                            int layoutIndex = ColorRecyclerView.this.mChildHelper.indexOfChild(view);
                            if (layoutIndex == -1) {
                                throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + vh);
                            }
                            ColorRecyclerView.this.mChildHelper.detachViewFromParent(layoutIndex);
                            scrapView(view);
                            vh.addFlags(8224);
                            return vh;
                        }
            ...
            for (i = this.mAttachedScrap.size() - 1; i >= 0; i--) {
                ...
                if (holder.getItemId() == id && (holder.wasReturnedFromScrap() ^ 1) != 0) {
                    if (type == holder.getItemViewType()) {
                        holder.addFlags(32);
                        if (holder.isRemoved() && !ColorRecyclerView.this.mState.isPreLayout()) {
        ...
        void dispatchViewRecycled(ViewHolder holder) {
            if (ColorRecyclerView.this.mRecyclerListener != null) {
                ColorRecyclerView.this.mRecyclerListener.onViewRecycled(holder);
            }
            if (ColorRecyclerView.this.mAdapter != null) {
                ColorRecyclerView.this.mAdapter.onViewRecycled(holder);
            }
            if (ColorRecyclerView.this.mState != null) {
                ColorRecyclerView.this.mViewInfoStore.removeViewHolder(holder);
            }
        }
        ...
        void setRecycledViewPool(RecycledViewPool pool) {
            ...
            if (pool != null) {
                this.mRecyclerPool.attach(ColorRecyclerView.this.getAdapter());
            }
        }
        ...
        void markKnownViewsInvalid() {
            if (ColorRecyclerView.this.mAdapter == null || !ColorRecyclerView.this.mAdapter.hasStableIds()) {
                recycleAndClearCachedViews();
                return;
            }
            int cachedCount = this.mCachedViews.size();
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        /* synthetic */ RecyclerViewDataObserver(ColorRecyclerView this$0, RecyclerViewDataObserver -this1) {
            this();
        }
        ...
        public void onChanged() {
            ColorRecyclerView.this.assertNotInLayoutOrScroll(null);
            if (ColorRecyclerView.this.mAdapter.hasStableIds()) {
                ColorRecyclerView.this.mState.mStructureChanged = true;
                ColorRecyclerView.this.setDataSetChangedAfterLayout();
            } else {
                ColorRecyclerView.this.mState.mStructureChanged = true;
                ColorRecyclerView.this.setDataSetChangedAfterLayout();
            }
            if (!ColorRecyclerView.this.mAdapterHelper.hasPendingUpdates()) {
        ...
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) {
            ColorRecyclerView.this.assertNotInLayoutOrScroll(null);
            if (ColorRecyclerView.this.mAdapterHelper.onItemRangeChanged(positionStart, itemCount, payload)) {
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            ColorRecyclerView.this.assertNotInLayoutOrScroll(null);
            if (ColorRecyclerView.this.mAdapterHelper.onItemRangeInserted(positionStart, itemCount)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            ColorRecyclerView.this.assertNotInLayoutOrScroll(null);
            if (ColorRecyclerView.this.mAdapterHelper.onItemRangeRemoved(positionStart, itemCount)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            ColorRecyclerView.this.assertNotInLayoutOrScroll(null);
            if (ColorRecyclerView.this.mAdapterHelper.onItemRangeMoved(fromPosition, toPosition, itemCount)) {
                triggerUpdateProcessor();
            }
        }

        void triggerUpdateProcessor() {
            if (ColorRecyclerView.this.mPostUpdatesOnAnimation && ColorRecyclerView.this.mHasFixedSize && ColorRecyclerView.this.mIsAttached) {
                ColorRecyclerView.this.postOnAnimation(ColorRecyclerView.this.mUpdateChildViewsRunnable);
                return;
            }
            ColorRecyclerView.this.mAdapterUpdateDuringMeasure = true;
            ColorRecyclerView.this.requestLayout();
        }
    }
    ...
    public class SimpleOnItemTouchListener implements OnItemTouchListener {
        public boolean onInterceptTouchEvent(ColorRecyclerView rv, MotionEvent e) {
            return false;
        }

        public void onTouchEvent(ColorRecyclerView rv, MotionEvent e) {
        }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public ViewFlinger() {
            ColorRecyclerView.this.mScroller = new OppoOverScroller(ColorRecyclerView.this.getContext(), ColorRecyclerView.sQuinticInterpolator);
        }
        ...
        public void run() {
            ...
            OppoOverScroller scroller = ColorRecyclerView.this.mScroller;
            SmoothScroller smoothScroller = ColorRecyclerView.this.mLayout.mSmoothScroller;
            if (scroller.computeScrollOffset()) {
                int deltaY;
                if (ColorRecyclerView.this.mScrollType == 3 && ColorRecyclerView.this.mOverScrollEnable) {
                    int scrollY = ColorRecyclerView.this.mScrollY;
                    int currY = scroller.getCurrY();
                    deltaY = currY - scrollY;
                    int overScrollDistance = deltaY;
                    if (ColorRecyclerView.this.overScrollBy(0, deltaY, 0, scrollY, 0, 0, 0, ColorRecyclerView.this.mOverflingDistance, false)) {
                ...
                int overscrollY = 0;
                if (ColorRecyclerView.this.mAdapter != null) {
                    ColorRecyclerView.this.eatRequestLayout();
                    ColorRecyclerView.this.onEnterLayoutOrScroll();
                    if (dx != 0) {
                        hresult = ColorRecyclerView.this.mLayout.scrollHorizontallyBy(dx, ColorRecyclerView.this.mRecycler, ColorRecyclerView.this.mState);
                        overscrollX = dx - hresult;
                    }
                    if (dy != 0) {
                        vresult = ColorRecyclerView.this.mLayout.scrollVerticallyBy(dy, ColorRecyclerView.this.mRecycler, ColorRecyclerView.this.mState);
                        overscrollY = dy - vresult;
                    }
                    ColorRecyclerView.this.repositionShadowingViews();
                    ColorRecyclerView.this.onExitLayoutOrScroll();
                    ColorRecyclerView.this.resumeRequestLayout(false);
                    if (!(smoothScroller == null || (smoothScroller.isPendingInitialRun() ^ 1) == 0 || !smoothScroller.isRunning())) {
                        int adapterSize = ColorRecyclerView.this.mState.getItemCount();
                        if (adapterSize == 0) {
                            smoothScroller.stop();
                ...
                if (ColorRecyclerView.this.getOverScrollMode() != 2) {
                    ColorRecyclerView.this.considerReleasingGlowsOnScroll(dx, dy);
                }
                if (!(overscrollX == 0 && overscrollY == 0)) {
                    int vel = (int) scroller.getCurrVelocity();
                    deltaY = scroller.getCurrY() - ColorRecyclerView.this.mScrollY;
                    if (ColorRecyclerView.this.mOverScrollEnable) {
                        ColorRecyclerView.this.mScrollType = 3;
                        ColorRecyclerView.this.overScrollBy(0, overscrollY, 0, ColorRecyclerView.this.mScrollY, 0, 0, 0, ColorRecyclerView.this.mOverflingDistance, false);
                        ColorRecyclerView.this.mScroller.notifyVerticalEdgeReached(ColorRecyclerView.this.mScrollY, 0, ColorRecyclerView.this.mOverflingDistance);
                    }
                    int velX = 0;
                    if (overscrollX != x) {
                    ...
                    if (ColorRecyclerView.this.getOverScrollMode() != 2) {
                        ColorRecyclerView.this.absorbGlows(velX, velY);
                    }
                    if ((velX != 0 || overscrollX == x || scroller.getFinalX() == 0) && ((velY != 0 || overscrollY == y || scroller.getFinalY() == 0) && !ColorRecyclerView.this.mOverScrollEnable)) {
                        scroller.abortAnimation();
                    }
                }
                if (!(hresult == 0 && vresult == 0)) {
                    ColorRecyclerView.this.dispatchOnScrolled(hresult, vresult);
                }
                if (!ColorRecyclerView.this.awakenScrollBars()) {
                    ColorRecyclerView.this.invalidate();
                }
                boolean fullyConsumedVertical = (dy == 0 || !ColorRecyclerView.this.mLayout.canScrollVertically()) ? false : vresult == dy;
                boolean fullyConsumedHorizontal = (dx == 0 || !ColorRecyclerView.this.mLayout.canScrollHorizontally()) ? false : hresult == dx;
                ...
                if (!scroller.isFinished() && (fullyConsumedAny2 ^ 1) == 0) {
                    postOnAnimation();
                } else if (!(ColorRecyclerView.this.mScrollType == 3 && (ColorRecyclerView.this.mOverScrollEnable ^ 1) == 0)) {
                    ColorRecyclerView.this.setScrollState(0);
                }
            } else if (ColorRecyclerView.this.mScrollY != 0 && ColorRecyclerView.this.mOverScrollEnable) {
                startSpringback();
            }
        ...
        void startSpringback() {
            if (ColorRecyclerView.this.mScroller.springBack(ColorRecyclerView.this.mScrollX, ColorRecyclerView.this.mScrollY, 0, 0, 0, ColorRecyclerView.this.getScrollRange())) {
                ColorRecyclerView.this.postInvalidateOnAnimation();
        ...
        void postOnAnimation() {
            ...
            ColorRecyclerView.this.postOnAnimation(this);
        }
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mLastFlingX = 0;
            if (ColorRecyclerView.this.mOverScrollEnable) {
                ColorRecyclerView.this.mScroller.fling(0, 0, velocityX, velocityY, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            } else {
                ColorRecyclerView.this.mScroller.fling(0, 0, velocityX, velocityY, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            }
            postOnAnimation();
        ...
        public void Overfling(int velocityX, int velocityY) {
            ColorRecyclerView.this.setScrollState(2);
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            this.mLastFlingY = velocityY < 0 ? Integer.MAX_VALUE : 0;
            ColorRecyclerView.this.mScroller.fling(0, 0, velocityX, velocityY, 0, Integer.MAX_VALUE, 0, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            int containerSize = horizontal ? ColorRecyclerView.this.getWidth() : ColorRecyclerView.this.getHeight();
        ...
        public void smoothScrollBy(int dx, int dy, int duration) {
            smoothScrollBy(dx, dy, duration, null);
        }

        public void smoothScrollBy(int dx, int dy, int duration, Interpolator interpolator) {
            if (ColorRecyclerView.this.mInterpolator != interpolator) {
                ColorRecyclerView.this.mInterpolator = interpolator;
                ColorRecyclerView.this.mScroller = new OppoOverScroller(ColorRecyclerView.this.getContext());
            }
            ColorRecyclerView.this.setScrollState(2);
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
            ColorRecyclerView.this.mScroller.startScroll(0, 0, dx, dy, duration);
            postOnAnimation();
        }

        public void stop() {
            ColorRecyclerView.this.removeCallbacks(this);
            ColorRecyclerView.this.mScroller.abortAnimation();
        }
    }
    ...
    public static abstract class ViewHolder {
        ...
        int mItemViewType = -1;
        int mOldPosition = -1;
        ColorRecyclerView mOwnerRecyclerView;
    ...
    public ColorRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoStore = new ColorViewInfoStore();
        this.mUpdateChildViewsRunnable = new Runnable() {
            public void run() {
                if (ColorRecyclerView.this.mFirstLayoutComplete && !ColorRecyclerView.this.isLayoutRequested()) {
                    if (!ColorRecyclerView.this.mIsAttached) {
                        ColorRecyclerView.this.requestLayout();
                    } else if (ColorRecyclerView.this.mLayoutFrozen) {
                        ColorRecyclerView.this.mLayoutRequestEaten = true;
                    } else {
                        ColorRecyclerView.this.consumePendingUpdateOperations();
                    }
                }
        ...
        this.mItemAnimator = new ColorDefaultItemAnimator();
        this.mScrollState = 0;
        ...
        this.mItemAnimatorRunner = new Runnable() {
            public void run() {
                if (ColorRecyclerView.this.mItemAnimator != null) {
                    ColorRecyclerView.this.mItemAnimator.runPendingAnimations();
                }
                ColorRecyclerView.this.mPostedAnimatorRunner = false;
            }
        };
        this.mViewInfoProcessCallback = new ProcessCallback() {
            public void processDisappeared(ViewHolder viewHolder, ItemHolderInfo info, ItemHolderInfo postInfo) {
                ColorRecyclerView.this.mRecycler.unscrapView(viewHolder);
                ColorRecyclerView.this.animateDisappearance(viewHolder, info, postInfo);
            }

            public void processAppeared(ViewHolder viewHolder, ItemHolderInfo preInfo, ItemHolderInfo info) {
                ColorRecyclerView.this.animateAppearance(viewHolder, preInfo, info);
            }

            public void processPersistent(ViewHolder viewHolder, ItemHolderInfo preInfo, ItemHolderInfo postInfo) {
                viewHolder.setIsRecyclable(false);
                if (ColorRecyclerView.this.mDataSetHasChangedAfterLayout) {
                    if (ColorRecyclerView.this.mItemAnimator.animateChange(viewHolder, viewHolder, preInfo, postInfo)) {
                        ColorRecyclerView.this.postAnimationRunner();
                    }
                } else if (ColorRecyclerView.this.mItemAnimator.animatePersistence(viewHolder, preInfo, postInfo)) {
                    ColorRecyclerView.this.postAnimationRunner();
                }
            }

            public void unused(ViewHolder viewHolder) {
                ColorRecyclerView.this.mLayout.removeAndRecycleView(viewHolder.itemView, ColorRecyclerView.this.mRecycler);
            }
        };
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, R.styleable.ColorRecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(1);
            a.recycle();
            createLayoutManager(context, layoutManagerName, attrs, defStyle, 0);
        }
        initOppoProperty(context);
        this.mScroller = new OppoOverScroller(context);
        this.mMinimumVelocity = ViewConfiguration.get(this.mContext).getScaledMinimumFlingVelocity();
    }

    public OppoOverScroller getScroller() {
        return this.mScroller;
    }

    public void setOverScrollEnable(boolean enable) {
        this.mOverScrollEnable = enable;
    }
    ...
    public void setAccessibilityDelegateCompat(ColorRecyclerViewAccessibilityDelegate accessibilityDelegate) {
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return ColorRecyclerView.class.getPackage().getName() + '.' + className;
    }

    private void initChildrenHelper() {
        this.mChildHelper = new ColorChildHelper(new Callback() {
            public int getChildCount() {
                return ColorRecyclerView.this.getChildCount();
            }

            public void addView(View child, int index) {
                ColorRecyclerView.this.addView(child, index);
                ColorRecyclerView.this.dispatchChildAttached(child);
            }
            ...
            public void removeViewAt(int index) {
                View child = ColorRecyclerView.this.getChildAt(index);
                if (child != null) {
                    ColorRecyclerView.this.dispatchChildDetached(child);
                }
                ColorRecyclerView.this.removeViewAt(index);
            }

            public View getChildAt(int offset) {
                return ColorRecyclerView.this.getChildAt(offset);
            }

            public void removeAllViews() {
                int count = getChildCount();
                for (int i = 0; i < count; i++) {
                    ColorRecyclerView.this.dispatchChildDetached(getChildAt(i));
                }
            ...
            public void attachViewToParent(View child, int index, android.view.ViewGroup.LayoutParams layoutParams) {
                ...
                ColorRecyclerView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                if (view != null) {
                    ...
                    if (vh != null) {
                        if (!vh.isTmpDetached() || (vh.shouldIgnore() ^ 1) == 0) {
                            vh.addFlags(GL10.GL_DEPTH_BUFFER_BIT);
                        } else {
                            throw new IllegalArgumentException("called detach on an already detached child " + vh);
                        }
                    }
                }
                ColorRecyclerView.this.detachViewFromParent(offset);
            }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new ColorAdapterHelper(new Callback() {
            public ViewHolder findViewHolder(int position) {
                ViewHolder vh = ColorRecyclerView.this.findViewHolderForPosition(position, true);
                if (vh == null || ColorRecyclerView.this.mChildHelper.isHidden(vh.itemView)) {
                    return null;
                }
                return vh;
            }
            ...
            public void offsetPositionsForRemovingInvisible(int start, int count) {
                ColorRecyclerView.this.offsetPositionRecordsForRemove(start, count, true);
                ColorRecyclerView.this.mItemsAddedOrRemoved = true;
                State state = ColorRecyclerView.this.mState;
            ...
            public void offsetPositionsForRemovingLaidOutOrNewView(int positionStart, int itemCount) {
                ColorRecyclerView.this.offsetPositionRecordsForRemove(positionStart, itemCount, false);
                ColorRecyclerView.this.mItemsAddedOrRemoved = true;
            }

            public void markViewHoldersUpdated(int positionStart, int itemCount, Object payload) {
                ColorRecyclerView.this.viewRangeUpdate(positionStart, itemCount, payload);
                ColorRecyclerView.this.mItemsChanged = true;
            }
            ...
            void dispatchUpdate(UpdateOp op) {
                switch (op.cmd) {
                    case 1:
                        ColorRecyclerView.this.mLayout.onItemsAdded(ColorRecyclerView.this, op.positionStart, op.itemCount);
                        return;
                    case 2:
                        ColorRecyclerView.this.mLayout.onItemsRemoved(ColorRecyclerView.this, op.positionStart, op.itemCount);
                        return;
                    case 4:
                        ColorRecyclerView.this.mLayout.onItemsUpdated(ColorRecyclerView.this, op.positionStart, op.itemCount, op.payload);
                        return;
                    case 8:
                        ColorRecyclerView.this.mLayout.onItemsMoved(ColorRecyclerView.this, op.positionStart, op.itemCount, 1);
                        return;
                    default:
                        return;
                }
            ...
            public void offsetPositionsForAdd(int positionStart, int itemCount) {
                ColorRecyclerView.this.offsetPositionRecordsForInsert(positionStart, itemCount);
                ColorRecyclerView.this.mItemsAddedOrRemoved = true;
            }

            public void offsetPositionsForMove(int from, int to) {
                ColorRecyclerView.this.offsetPositionRecordsForMove(from, to);
                ColorRecyclerView.this.mItemsAddedOrRemoved = true;
            }
        });
    }
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            ...
            if (y != 0 && (!this.mOverScrollEnable || ((this.mScrollY >= 0 || y <= 0) && (this.mScrollY <= 0 || y >= 0)))) {
        ...
        if (dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, this.mScrollOffset)) {
            ...
            if (ev != null) {
                ...
                if (this.mOverScrollEnable) {
                    if (!(unconsumedY == 0 && this.mScrollY == 0)) {
                        this.mScrollType = 2;
                    }
                    int overScrollDistance = unconsumedY;
                    overScrollDistance = calcRealOverScrollDist(unconsumedY);
                    if ((this.mScrollY < 0 && y > 0) || (this.mScrollY > 0 && y < 0)) {
                        overScrollDistance = calcRealOverScrollDist(y);
                    }
    ...
    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        onOverScrolled(scrollX + deltaX, scrollY + deltaY, false, false);
        return false;
    }
    ...
    public void addOnItemTouchListenerSy(OnItemTouchListener listener) {
        if (this.mOnItemTouchListeners.size() > 0) {
            for (int i = this.mOnItemTouchListeners.size() - 1; i >= 0; i--) {
                removeOnItemTouchListener((OnItemTouchListener) this.mOnItemTouchListeners.get(i));
            }
        }
        this.mOnItemTouchListeners.add(listener);
    }
        ...
        if (dispatchOnItemTouch(e)) {
            ...
            switch (action) {
                case 0:
                    ...
                    this.mLastTouchY = x;
                    this.mInitialTouchY = x;
                    if (!this.mScroller.isFinished() && this.mOverScrollEnable) {
                    ...
                    startNestedScroll(nestedScrollAxis);
                    Log.i("testScroll", "   MotionEvent.ACTION_DOWN:    mScrollY: " + this.mScrollY);
                    break;
                case 1:
                    if (!this.mOverScrollEnable) {
                    ...
                    if (this.mScrollType != 2 || !this.mOverScrollEnable) {
                ...
                case 3:
                    if (this.mOverScrollEnable) {
                        if (this.mScroller.springBack(this.mScrollX, this.mScrollY, 0, 0, 0, getScrollRange())) {
                            postInvalidateOnAnimation();
                            Log.e("testScroll", "   MotionEvent.ACTION_CANCEL:    postInvalidateOnAnimation: ");
                        }
                        Log.e("testScroll", "   MotionEvent.ACTION_CANCEL:    mScrollY: " + this.mScrollY);
                    }
                    cancelTouch();
                    break;
                case 5:
            ...
            if (!(eventAddedToVelocityTracker || (this.mOverScrollEnable ^ 1) == 0)) {
                this.mVelocityTracker.addMovement(vtev);
            }
            vtev.recycle();
            return true;
    ...
    public void computeScroll() {
        if (!this.mOverScrollEnable) {
            ...
            if (!(oldX == x && oldY == y)) {
                ...
                if (overscrollMode != 0) {
                    if (overscrollMode != 1 || range <= 0) {
                    }
                }
                if (this.mScrollType == 2 || this.mScrollType == 3) {
    ...
    void defaultOnMeasure(int widthSpec, int heightSpec) {
        setMeasuredDimension(LayoutManager.chooseSize(widthSpec, getPaddingLeft() + getPaddingRight(), getMinimumHeight()), LayoutManager.chooseSize(heightSpec, getPaddingTop() + getPaddingBottom(), getMinimumHeight()));
    }
    ...
    private void recoverFocusFromState() {
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && (hasFocus() ^ 1) == 0) {
            if (!isFocused()) {
                View focusedChild = getFocusedChild();
                if (focusedChild == null || (this.mChildHelper.isHidden(focusedChild) ^ 1) != 0) {
                    return;
                }
            }
            ...
            if (focusTarget != null && !focusTarget.itemView.hasFocus() && (focusTarget.itemView.hasFocusable() ^ 1) == 0) {
    ...
    private void animateAppearance(ViewHolder itemHolder, ItemHolderInfo preLayoutInfo, ItemHolderInfo postLayoutInfo) {
    ...
    private void animateDisappearance(ViewHolder holder, ItemHolderInfo preLayoutInfo, ItemHolderInfo postLayoutInfo) {
    ...
    public void draw(Canvas c) {
        ...
        if (null == null && this.mItemAnimator != null && this.mItemDecorations.size() > 0 && this.mItemAnimator.isRunning()) {
