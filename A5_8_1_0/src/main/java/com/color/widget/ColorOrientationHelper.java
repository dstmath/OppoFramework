...
public abstract class ColorOrientationHelper {
    ...
    /* synthetic */ ColorOrientationHelper(LayoutManager layoutManager, ColorOrientationHelper -this1) {
        this(layoutManager);
    }
    ...
    private ColorOrientationHelper(LayoutManager layoutManager) {
    ...
    public static ColorOrientationHelper createOrientationHelper(LayoutManager layoutManager, int orientation) {
        switch (orientation) {
            case 0:
    ...
    public static ColorOrientationHelper createHorizontalHelper(LayoutManager layoutManager) {
        return new ColorOrientationHelper(layoutManager) {
    ...
    public static ColorOrientationHelper createVerticalHelper(LayoutManager layoutManager) {
        return new ColorOrientationHelper(layoutManager) {
            public int getEndAfterPadding() {
