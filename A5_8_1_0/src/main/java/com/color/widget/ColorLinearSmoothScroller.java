...
import com.color.widget.ColorRecyclerView.SmoothScroller;
import com.color.widget.ColorRecyclerView.SmoothScroller.Action;
...
public class ColorLinearSmoothScroller extends SmoothScroller {
    ...
    public ColorLinearSmoothScroller(Context context) {
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        ...
        if (layoutManager == null || (layoutManager.canScrollVertically() ^ 1) != 0) {
            return 0;
        }
    ...
    public int calculateDxToMakeVisible(View view, int snapPreference) {
        LayoutManager layoutManager = getLayoutManager();
        if (layoutManager == null || (layoutManager.canScrollHorizontally() ^ 1) != 0) {
            return 0;
        }
        LayoutParams params = (LayoutParams) view.getLayoutParams();
