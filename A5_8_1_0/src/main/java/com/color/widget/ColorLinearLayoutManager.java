...
import com.color.widget.ColorRecyclerView.LayoutManager.Properties;
import com.color.widget.ColorRecyclerView.LayoutParams;
import com.color.widget.ColorRecyclerView.Recycler;
import com.color.widget.ColorRecyclerView.SmoothScroller.ScrollVectorProvider;
import com.color.widget.ColorRecyclerView.State;
import com.color.widget.ColorRecyclerView.ViewHolder;
import com.color.widget.help.ColorItemTouchHelper.ViewDropHandler;
import com.oppo.media.MediaFile;
import java.util.List;

public class ColorLinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    int mOrientation;
    ColorOrientationHelper mOrientationHelper;
    ...
    class AnchorInfo {
        ...
        void assignCoordinateFromPadding() {
            ...
            if (this.mLayoutFromEnd) {
                endAfterPadding = ColorLinearLayoutManager.this.mOrientationHelper.getEndAfterPadding();
            } else {
                endAfterPadding = ColorLinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
            }
        ...
        public void assignFromViewAndKeepVisibleRect(View child) {
            int spaceChange = ColorLinearLayoutManager.this.mOrientationHelper.getTotalSpaceChange();
            if (spaceChange >= 0) {
                assignFromView(child);
                return;
            }
            this.mPosition = ColorLinearLayoutManager.this.getPosition(child);
            int startMargin;
            if (this.mLayoutFromEnd) {
                int previousEndMargin = (ColorLinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - spaceChange) - ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child);
                this.mCoordinate = ColorLinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - previousEndMargin;
                if (previousEndMargin > 0) {
                    int estimatedChildStart = this.mCoordinate - ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(child);
                    int layoutStart = ColorLinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
                    startMargin = estimatedChildStart - (layoutStart + Math.min(ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child) - layoutStart, 0));
                    if (startMargin < 0) {
                        this.mCoordinate += Math.min(previousEndMargin, -startMargin);
                    }
                }
            } else {
                int childStart = ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child);
                startMargin = childStart - ColorLinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
                this.mCoordinate = childStart;
                if (startMargin > 0) {
                    int endMargin = (ColorLinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - Math.min(0, (ColorLinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - spaceChange) - ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child))) - (childStart + ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(child));
                    if (endMargin < 0) {
        ...
        public void assignFromView(View child) {
            if (this.mLayoutFromEnd) {
                this.mCoordinate = ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child) + ColorLinearLayoutManager.this.mOrientationHelper.getTotalSpaceChange();
            } else {
                this.mCoordinate = ColorLinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child);
            }
            this.mPosition = ColorLinearLayoutManager.this.getPosition(child);
        }
    }
    ...
    public ColorLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
    ...
    public ColorLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        this.mReverseLayout = false;
        this.mShouldReverseLayout = false;
        this.mStackFromEnd = false;
        this.mSmoothScrollbarEnabled = true;
    ...
    public void smoothScrollToPosition(ColorRecyclerView recyclerView, State state, int position) {
        ColorLinearSmoothScroller linearSmoothScroller = new ColorLinearSmoothScroller(recyclerView.getContext());
    ...
    void ensureLayoutState() {
        ...
        if (this.mOrientationHelper == null) {
            this.mOrientationHelper = ColorOrientationHelper.createOrientationHelper(this, this.mOrientation);
        }
    }
    ...
    private int computeScrollOffset(State state) {
        ...
        ensureLayoutState();
        return ColorScrollbarHelper.computeScrollOffset(state, this.mOrientationHelper, findFirstVisibleChildClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleChildClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollExtent(State state) {
        ...
        ensureLayoutState();
        return ColorScrollbarHelper.computeScrollExtent(state, this.mOrientationHelper, findFirstVisibleChildClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleChildClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollRange(State state) {
        ...
        ensureLayoutState();
        return ColorScrollbarHelper.computeScrollRange(state, this.mOrientationHelper, findFirstVisibleChildClosestToStart(this.mSmoothScrollbarEnabled ^ 1, true), findFirstVisibleChildClosestToEnd(this.mSmoothScrollbarEnabled ^ 1, true), this, this.mSmoothScrollbarEnabled);
    }
