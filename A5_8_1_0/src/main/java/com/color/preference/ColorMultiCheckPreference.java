...
public class ColorMultiCheckPreference extends MultiCheckPreference {
    ...
    public ColorMultiCheckPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public ColorMultiCheckPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ColorMultiCheckPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 16842897);
    }

    public ColorMultiCheckPreference(Context context) {
        this(context, null);
    }
