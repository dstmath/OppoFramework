...
public class ColorMultiSelectListPreference extends MultiSelectListPreference {
    ...
    public ColorMultiSelectListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public ColorMultiSelectListPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ColorMultiSelectListPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 16842897);
    }

    public ColorMultiSelectListPreference(Context context) {
        this(context, null);
    }
