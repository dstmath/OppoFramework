...
public interface IColorLongshot extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IColorLongshot {
        ...
        private static class Proxy implements IColorLongshot {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    start(com.color.screenshot.IColorLongshotCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    stop();
                ...
                case 3:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg0 = (ColorLongshotEvent) ColorLongshotEvent.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
