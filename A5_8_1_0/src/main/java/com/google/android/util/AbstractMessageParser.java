...
public abstract class AbstractMessageParser {
    /* renamed from: -com-google-android-util-AbstractMessageParser$Token$TypeSwitchesValues */
    private static final /* synthetic */ int[] f1xd645f97b = null;
    ...
    /* renamed from: -getcom-google-android-util-AbstractMessageParser$Token$TypeSwitchesValues */
    private static /* synthetic */ int[] m1xfa83c857() {
        if (f1xd645f97b != null) {
            return f1xd645f97b;
        }
        ...
        for (Part part : this.parts) {
            ...
            for (Token token : part.getTokens()) {
                if (token.isHtml()) {
                    ...
                    switch (m1xfa83c857()[token.getType().ordinal()]) {
                        case 1:
