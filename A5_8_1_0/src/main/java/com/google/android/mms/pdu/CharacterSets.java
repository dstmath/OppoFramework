...
public class CharacterSets {
    ...
    static final /* synthetic */ boolean f20-assertionsDisabled = (CharacterSets.class.desiredAssertionStatus() ^ 1);
    ...
    static {
        if (f20-assertionsDisabled || MIBENUM_NUMBERS.length == MIME_NAMES.length) {
