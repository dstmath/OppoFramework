...
public final class IMSCM_CONN_MESSAGE {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.pOutboundProxy.getBytes().length + 1), _hidl_blob.handle(), (0 + _hidl_offset) + 0, false);
        ...
        parcel.readEmbeddedBuffer((long) (this.pCallId.getBytes().length + 1), _hidl_blob.handle(), (32 + _hidl_offset) + 0, false);
        int _hidl_vec_size = _hidl_blob.getInt32((48 + _hidl_offset) + 8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 1), _hidl_blob.handle(), (48 + _hidl_offset) + 0, true);
        this.pMessage.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMSCM_CONN_MESSAGE> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((IMSCM_CONN_MESSAGE) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 64));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putString(_hidl_offset + 0, this.pOutboundProxy);
