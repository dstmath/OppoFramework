...
public interface IImsCmService extends IBase {
    public static final String kInterfaceName = "com.qualcomm.qti.imscmservice@1.0::IImsCmService";
    ...
    public static final class Proxy implements IImsCmService {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of com.qualcomm.qti.imscmservice@1.0::IImsCmService]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IImsCmService {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IImsCmService.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList(Arrays.asList(new byte[][]{new byte[]{(byte) 120, (byte) -43, (byte) 100, (byte) -76, (byte) 28, (byte) -38, (byte) 42, (byte) -81, (byte) 27, (byte) 117, (byte) 73, (byte) 13, (byte) -41, (byte) 31, (byte) -15, (byte) -55, (byte) 81, (byte) -102, (byte) -59, (byte) -59, (byte) 53, (byte) -49, (byte) -62, (byte) 41, (byte) 74, (byte) -59, (byte) 39, (byte) -15, (byte) 66, (byte) 122, (byte) 44, (byte) -93}, new byte[]{(byte) -67, (byte) -38, (byte) -74, (byte) 24, (byte) 77, (byte) 122, (byte) 52, (byte) 109, (byte) -90, (byte) -96, (byte) 125, (byte) -64, (byte) -126, (byte) -116, (byte) -15, (byte) -102, (byte) 105, (byte) 111, (byte) 76, (byte) -86, (byte) 54, (byte) 17, (byte) -59, (byte) 31, (byte) 46, (byte) 20, (byte) 86, (byte) 90, (byte) 20, (byte) -76, (byte) 15, (byte) -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 9:
                    ...
                    _hidl_reply.send();
                    return;
                case IMSCM_STATUSCODE.IMSCM_SERVICE_DIED /*10*/:
                    _hidl_request.enforceInterface(IImsCmService.kInterfaceName);
    ...
    int InitializeService(String str, IImsCmServiceListener iImsCmServiceListener, int i) throws RemoteException;

    int addListener(long j, IImsCmServiceListener iImsCmServiceListener) throws RemoteException;

    IHwBinder asBinder();

    int closeConnection(long j, IImsCMConnection iImsCMConnection) throws RemoteException;

    int closeService(long j) throws RemoteException;

    IImsCMConnection createConnection(long j, IImsCMConnectionListener iImsCMConnectionListener, String str) throws RemoteException;

    int getConfiguration(long j, int i, int i2) throws RemoteException;
    ...
    int methodResponse(long j, String str, short s, int i) throws RemoteException;

    void notifySyspropsChanged() throws RemoteException;

    void ping() throws RemoteException;

    int removeListener(long j, IImsCmServiceListener iImsCmServiceListener) throws RemoteException;

    void setHALInstrumentation() throws RemoteException;

    int triggerDeRegistration(long j, int i) throws RemoteException;

    int triggerRegistration(long j, int i) throws RemoteException;
