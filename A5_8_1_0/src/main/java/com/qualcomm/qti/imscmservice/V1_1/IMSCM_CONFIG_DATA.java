...
public final class IMSCM_CONFIG_DATA {
    ...
    public final void readFromParcel(HwParcel parcel) {
        readEmbeddedFromParcel(parcel, parcel.readBuffer(360), 0);
    }
    ...
    public static final ArrayList<IMSCM_CONFIG_DATA> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 360), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            IMSCM_CONFIG_DATA _hidl_vec_element = new IMSCM_CONFIG_DATA();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 360));
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.autoConfig.readEmbeddedFromParcel(parcel, _hidl_blob, 336 + _hidl_offset);
    }

    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob(360);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMSCM_CONFIG_DATA> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * 360);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((IMSCM_CONFIG_DATA) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 360));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.autoConfig.writeEmbeddedToBlob(_hidl_blob, 336 + _hidl_offset);
    }
}
