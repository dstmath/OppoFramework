...
import com.qualcomm.qcnvitems.BaseQmiTypes.BaseQmiItemType;
import com.qualcomm.qcnvitems.BaseQmiTypes.BaseQmiStructType;
import com.qualcomm.qcnvitems.BaseQmiTypes.QmiBase;
...
public class QmiItemTypes {
    ...
    public static class QmiString extends BaseQmiItemType {
        ...
        public QmiString(byte[] bArray) throws InvalidParameterException {
            ...
            try {
                this.mVal = new String(b, "US-ASCII");
