...
public interface IDebugReportService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDebugReportService {
        ...
        private static class Proxy implements IDebugReportService {
            ...
            public void registerForDebugReporting(IDebugReportCallback callback) throws RemoteException {
            ...
            public void unregisterForDebugReporting(IDebugReportCallback callback) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public static IDebugReportService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IDebugReportService)) {
                return new Proxy(obj);
            }
            return (IDebugReportService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    registerForDebugReporting(com.qti.debugreport.IDebugReportCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterForDebugReporting(com.qti.debugreport.IDebugReportCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
