...
public interface ISessionStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISessionStatusCallback {
        ...
        private static class Proxy implements ISessionStatusCallback {
            ...
            public void onBatchingStatusCb(int status) throws RemoteException {
        ...
        public static ISessionStatusCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ISessionStatusCallback)) {
                return new Proxy(obj);
            }
            return (ISessionStatusCallback) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onBatchingStatusCb(data.readInt());
                    return true;
                case 1598968902:
