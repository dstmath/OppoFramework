...
final class ConscryptEngineSocket extends OpenSSLSocketImpl {
    /* renamed from: -javax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues */
    private static final /* synthetic */ int[] f0-javax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues = null;
    ...
    /* renamed from: com.android.org.conscrypt.ConscryptEngineSocket$1 */
    static class AnonymousClass1 extends HandshakeListener {
        final /* synthetic */ ConscryptEngineSocket val$socket;

        AnonymousClass1(ConscryptEngineSocket conscryptEngineSocket) {
            this.val$socket = conscryptEngineSocket;
        }

        public void onHandshakeFinished() {
            this.val$socket.onHandshakeFinished();
        }
    }

    private final class SSLInputStream extends InputStream {
        /* renamed from: -javax-net-ssl-SSLEngineResult$StatusSwitchesValues */
        private static final /* synthetic */ int[] f1-javax-net-ssl-SSLEngineResult$StatusSwitchesValues = null;
        ...
        /* renamed from: -getjavax-net-ssl-SSLEngineResult$StatusSwitchesValues */
        private static /* synthetic */ int[] m1-getjavax-net-ssl-SSLEngineResult$StatusSwitchesValues() {
            if (f1-javax-net-ssl-SSLEngineResult$StatusSwitchesValues != null) {
                return f1-javax-net-ssl-SSLEngineResult$StatusSwitchesValues;
            }
            ...
            f1-javax-net-ssl-SSLEngineResult$StatusSwitchesValues = iArr;
            return iArr;
        }
        ...
        private int readInternal(byte[] b, int off, int len) throws IOException {
            ...
            while (this.fromEngine.remaining() <= 0) {
                ...
                this.fromEngine.flip();
                switch (m1-getjavax-net-ssl-SSLEngineResult$StatusSwitchesValues()[engineResult.getStatus().ordinal()]) {
                    case 1:
    ...
    /* renamed from: -getjavax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues */
    private static /* synthetic */ int[] m0-getjavax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues() {
        if (f0-javax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues != null) {
            return f0-javax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues;
        }
        ...
        f0-javax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static ConscryptEngine newEngine(SSLParametersImpl sslParameters, ConscryptEngineSocket socket) {
        ...
        engine.setHandshakeListener(new AnonymousClass1(socket));
    ...
    /* JADX WARNING: Missing block: B:18:0x003e, code:
            switch(-getjavax-net-ssl-SSLEngineResult$HandshakeStatusSwitchesValues()[r9.engine.getHandshakeStatus().ordinal()]) {
                case 1: goto L_0x009b;
                case 2: goto L_0x0092;
                case com.android.org.conscrypt.ct.CTConstants.CERTIFICATE_LENGTH_BYTES :int: goto L_0x006f;
    ...
    /* JADX WARNING: Missing block: B:20:0x0060, code:
            throw new java.lang.IllegalStateException("Unknown handshake status: " + r9.engine.getHandshakeStatus());
     */
    /* JADX WARNING: Missing block: B:38:0x0079, code:
            if (com.android.org.conscrypt.ConscryptEngineSocket.SSLInputStream.-wrap0(r9.in, com.android.org.conscrypt.EmptyArray.BYTE, 0, 0) >= 0) goto L_0x002c;
     */
    /* JADX WARNING: Missing block: B:40:0x0084, code:
            throw com.android.org.conscrypt.SSLUtils.toSSLHandshakeException(new java.io.EOFException());
     */
    /* JADX WARNING: Missing block: B:41:0x0085, code:
            com.android.org.conscrypt.ConscryptEngineSocket.SSLOutputStream.-wrap1(r9.out, EMPTY_BUFFER);
            com.android.org.conscrypt.ConscryptEngineSocket.SSLOutputStream.-wrap0(r9.out);
     */
