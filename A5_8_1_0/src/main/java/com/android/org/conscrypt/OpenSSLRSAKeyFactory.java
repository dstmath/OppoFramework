...
public final class OpenSSLRSAKeyFactory extends KeyFactorySpi {
    ...
    protected <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> keySpec) throws InvalidKeySpecException {
        RSAPublicKey rsaKey;
        byte[] encoded;
        RSAPrivateCrtKey rsaKey2;
        RSAPrivateKey rsaKey3;
        if (key == null) {
            ...
            rsaKey2 = (RSAPrivateCrtKey) key;
            return new RSAPrivateCrtKeySpec(rsaKey2.getModulus(), rsaKey2.getPublicExponent(), rsaKey2.getPrivateExponent(), rsaKey2.getPrimeP(), rsaKey2.getPrimeQ(), rsaKey2.getPrimeExponentP(), rsaKey2.getPrimeExponentQ(), rsaKey2.getCrtCoefficient());
        } else if ((key instanceof RSAPrivateCrtKey) && RSAPrivateKeySpec.class.isAssignableFrom(keySpec)) {
            rsaKey2 = (RSAPrivateCrtKey) key;
            return new RSAPrivateKeySpec(rsaKey2.getModulus(), rsaKey2.getPrivateExponent());
        } else if ((key instanceof RSAPrivateKey) && RSAPrivateKeySpec.class.isAssignableFrom(keySpec)) {
            rsaKey3 = (RSAPrivateKey) key;
            return new RSAPrivateKeySpec(rsaKey3.getModulus(), rsaKey3.getPrivateExponent());
            ...
            if (privKey instanceof RSAPrivateCrtKey) {
                rsaKey2 = (RSAPrivateCrtKey) privKey;
                return new RSAPrivateCrtKeySpec(rsaKey2.getModulus(), rsaKey2.getPublicExponent(), rsaKey2.getPrivateExponent(), rsaKey2.getPrimeP(), rsaKey2.getPrimeQ(), rsaKey2.getPrimeExponentP(), rsaKey2.getPrimeExponentQ(), rsaKey2.getCrtCoefficient());
            }
            ...
            rsaKey3 = (RSAPrivateKey) engineGeneratePrivate(new PKCS8EncodedKeySpec(encoded));
            return new RSAPrivateKeySpec(rsaKey3.getModulus(), rsaKey3.getPrivateExponent());
