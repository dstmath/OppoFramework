...
public final class FramedStream {
    ...
    static final /* synthetic */ boolean f5-assertionsDisabled = (FramedStream.class.desiredAssertionStatus() ^ 1);
    ...
    final class FramedDataSink implements Sink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f6-assertionsDisabled = (FramedDataSink.class.desiredAssertionStatus() ^ 1);
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            if (f6-assertionsDisabled || !Thread.holdsLock(FramedStream.this)) {
                this.sendBuffer.write(source, byteCount);
                while (this.sendBuffer.size() >= EMIT_BUFFER_SIZE) {
                    emitDataFrame(f6-assertionsDisabled);
                }
                return;
            }
        ...
        private void emitDataFrame(boolean outFinished) throws IOException {
            long toWrite;
            boolean z = f6-assertionsDisabled;
    ...
    private final class FramedDataSource implements Source {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f7-assertionsDisabled = (FramedDataSource.class.desiredAssertionStatus() ^ 1);
        final /* synthetic */ boolean $assertionsDisabled;
        private boolean closed;
        private boolean finished;
     ...
     */
        ...
        void receive(BufferedSource in, long byteCount) throws IOException {
            if (f7-assertionsDisabled || !Thread.holdsLock(FramedStream.this)) {
                while (byteCount > 0) {
                    boolean finished;
    ...
    public void reply(List<Header> responseHeaders, boolean out) throws IOException {
        if (f5-assertionsDisabled || !Thread.holdsLock(this)) {
