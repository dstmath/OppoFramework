...
public interface ImsUtInterface {
    ...
    void queryCallBarring(int i, int i2, Message message);
    ...
    void setSuppServiceIndication(Handler handler, int i, Object obj);

    void unSetSuppServiceIndication(Handler handler);
    ...
    void updateCallBarring(int i, int i2, int i3, Message message, String[] strArr);
