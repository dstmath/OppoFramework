...
public class VideoPauseTracker {
    ...
    public void clearPauseRequests() {
        Log.v(this, "clearPauseRequests", new Object[0]);
        synchronized (this.mPauseRequestsLock) {
    ...
    /* renamed from: lambda$-com_android_ims_internal_VideoPauseTracker_7966 */
    /* synthetic */ String m0lambda$-com_android_ims_internal_VideoPauseTracker_7966(Integer source) {
