...
public interface IImsUt extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsUt {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    _result = queryCallBarringForServiceClass(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    _result = updateCallBarringForServiceClass(data.readInt(), data.readInt(), data.readInt(), data.createStringArray());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _result = queryCFForServiceClass(data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
    ...
    int updateCallBarringForServiceClass(int i, int i2, int i3, String[] strArr) throws RemoteException;
