...
public class AudioService extends Stub implements TouchExplorationStateChangeListener, AccessibilityServicesStateChangeListener {
    ...
    private ServiceListener mBluetoothProfileServiceListener = new ServiceListener() {
        /* JADX WARNING: Missing block: B:64:0x01c9, code:
            if (com.android.server.audio.AudioService.-get34(r18.this$0) == 4) goto L_0x012b;
     */
    ...
    private boolean mIsExportPrjversion = false;
    ...
    private class AudioServiceBroadcastReceiver extends BroadcastReceiver {
        ...
        /* JADX WARNING: Missing block: B:39:0x00f3, code:
            if (com.android.server.audio.AudioService.-get34(r20.this$0) == 5) goto L_0x00c0;
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
     ...
     */
        /* JADX WARNING: Missing block: B:17:0x0037, code:
            if (r13 != com.android.server.audio.AudioService.-wrap4(r11.this$0, r11.mStreamType)) goto L_0x0081;
     */
     ...
     */
        /* JADX WARNING: Missing block: B:21:0x0042, code:
            r0 = com.android.server.audio.AudioService.-get43(r11.this$0)[r6];
     */
        /* JADX WARNING: Missing block: B:22:0x004c, code:
            if (r6 == r11.mStreamType) goto L_0x0076;
     */
        /* JADX WARNING: Missing block: B:24:0x0054, code:
            if (com.android.server.audio.AudioService.mStreamVolumeAlias[r6] != r11.mStreamType) goto L_0x0076;
     */
        /* JADX WARNING: Missing block: B:25:0x0056, code:
            if (r1 != false) goto L_0x0060;
     */
        /* JADX WARNING: Missing block: B:27:0x005e, code:
            if ((r0.hasIndexForDevice(r13) ^ 1) == 0) goto L_0x0076;
     */
     ...
     */
        /* JADX WARNING: Missing block: B:30:0x006d, code:
            r0.setIndex(r5, com.android.server.audio.AudioService.-wrap4(r11.this$0, r6), r14);
     */
    ...
    public AudioService(Context context) {
        ...
        this.mIsExportPrjversion = isExportPrjversion();
    ...
    private boolean isExportPrjversion() {
        if (SystemProperties.get("sys.oppo.mm.prjversion", "default").equals("18301")) {
            return true;
        }
        return false;
    }
                            ...
                            if (isMuteAdjust) {
                                ...
                                if (direction == 1) {
                                    if ((checkSafeMediaVolume(streamTypeAlias, aliasIndex + step, device) ^ 1) != 0) {
                                        ...
                                        int tempflags = flags;
                                        if ((flags & 1) == 0 && (tempflags & 1024) == 0) {
                                            if ((callingPackage.equals("com.oppo.engineermode") ^ 1) != 0) {
                                                Log.d(TAG, "adjustStreamVolume postDisplaySafeVolumeWarning flags = " + tempflags);
                                                tempflags |= 1024;
                                            }
                                        }
    ...
    private void setStreamVolume(int streamType, int index, int flags, String callingPackage, String caller, int uid) {
        ...
        if (!this.mUseFixedVolume) {
            ...
            if ((device & 896) != 0 || (flags & 64) == 0) {
                ...
                if (this.mAppOps.noteOp(STREAM_VOLUME_OPS[streamTypeAlias], uid, callingPackage) == 0) {
                    if (isAndroidNPlus(callingPackage) && wouldToggleZenMode(getNewRingerMode(streamTypeAlias, index, flags)) && (this.mNm.isNotificationPolicyAccessGrantedForPackage(callingPackage) ^ 1) != 0) {
                        ...
                        synchronized (this.mSafeMediaVolumeState) {
                            ...
                            if (checkSafeMediaVolume(streamTypeAlias, index, device)) {
                                ...
                                if ((flags & 1) == 0 && (tempflags & 1024) == 0) {
                                    if ((callingPackage.equals("com.oppo.engineermode") ^ 1) != 0) {
                                        Log.d(TAG, "setStreamVolume postDisplaySafeVolumeWarning flags = " + tempflags);
                                        tempflags |= 1024;
                                    }
                                }
                                this.mVolumeController.postDisplaySafeVolumeWarning(tempflags);
    ...
    private int setModeInt(int mode, IBinder cb, int pid, String caller) {
        ...
        do {
            ...
            if (mode != 0) {
                if (hdlr == null) {
                    SetModeDeathHandler setModeDeathHandler = new SetModeDeathHandler(cb, pid);
                }
                try {
    ...
    public void setBluetoothA2dpOn(boolean on) {
        ...
        synchronized (this.mBluetoothA2dpEnabledLock) {
            Log.d(TAG, "setBluetoothScoOn mBluetoothA2dpEnabled = " + this.mBluetoothA2dpEnabled + ", on = " + on + ", mIsExportPrjversion = " + this.mIsExportPrjversion);
            if (!(this.mIsExportPrjversion && this.mBluetoothA2dpEnabled == on)) {
    ...
    private boolean isMusicVolumeDefault() {
        int musicVolumeDefault = Secure.getInt(this.mContext.getContentResolver(), "default_volume_type", 0);
        Log.d(TAG, "musicVolumeDefault :" + musicVolumeDefault);
        if (musicVolumeDefault != 0) {
            return true;
        }
        return false;
    }
    ...
    /* JADX WARNING: Missing block: B:58:0x024d, code:
            return false;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private int checkSendBecomingNoisyIntent(int device, int state, int musicDevice) {
        ...
        if (state == 0 && (this.mBecomingNoisyIntentDevices & device) != 0) {
            ...
            if ((device == musicDevice || isInCommunication()) && device == devices) {
                ...
                delay = SystemProperties.getInt("vendor.audio.noisy.broadcast.delay", CompatibilityHelper.FORCE_DELAY_TO_USE_POST);
            }
        }
