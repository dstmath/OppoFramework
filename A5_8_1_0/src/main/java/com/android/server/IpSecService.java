...
public class IpSecService extends Stub {
    ...
    @GuardedBy("this")
    private final ManagedResourceArray<SpiRecord> mSpiRecords = new ManagedResourceArray(this, null);
    @GuardedBy("this")
    private final ManagedResourceArray<TransformRecord> mTransformRecords = new ManagedResourceArray(this, null);
    @GuardedBy("this")
    private final ManagedResourceArray<UdpSocketRecord> mUdpSocketRecords = new ManagedResourceArray(this, null);
    ...
    private class ManagedResourceArray<T extends ManagedResource> {
        ...
        /* synthetic */ ManagedResourceArray(IpSecService this$0, ManagedResourceArray -this1) {
            this();
        }
    ...
    private void connectNativeNetdService() {
        new Thread() {
            public void run() {
                synchronized (IpSecService.this) {
                    NetdService.get(FaceDaemonWrapper.TIMEOUT_FACED_BINDERCALL_CHECK);
                }
            }
        }.start();
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x006c A:{PHI: r4 , Splitter: B:15:0x001f, ExcHandler: java.io.IOException (e java.io.IOException)} */
    ...
    public synchronized IpSecTransformResponse createTransportModeTransform(IpSecConfig c, IBinder binder) throws RemoteException {
        ...
        if (encapType != 0) {
            socketRecord = (UdpSocketRecord) this.mUdpSocketRecords.get(c.getEncapLocalResourceId());
