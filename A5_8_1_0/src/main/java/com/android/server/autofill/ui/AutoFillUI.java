...
public final class AutoFillUI {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_3272 */
    /* synthetic */ void m128lambda$-com_android_server_autofill_ui_AutoFillUI_3272(AutoFillUiCallback callback) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_3592 */
    /* synthetic */ void m129lambda$-com_android_server_autofill_ui_AutoFillUI_3592(AutoFillUiCallback callback) {
        if (this.mCallback == callback) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_4184 */
    /* synthetic */ void m130lambda$-com_android_server_autofill_ui_AutoFillUI_4184(AutoFillUiCallback callback, CharSequence message) {
        if (this.mCallback == callback) {
            hideAllUiThread(callback);
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_4872 */
    /* synthetic */ void m131lambda$-com_android_server_autofill_ui_AutoFillUI_4872(AutoFillUiCallback callback, String filterText) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_6451 */
    /* synthetic */ void m132lambda$-com_android_server_autofill_ui_AutoFillUI_6451(AutoFillUiCallback callback, FillResponse response, AutofillId focusedId, String filterText, LogMaker log) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_9969 */
    /* synthetic */ void m133lambda$-com_android_server_autofill_ui_AutoFillUI_9969(AutoFillUiCallback callback, final PendingUi pendingSaveUi, CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, String packageName, SaveInfo info, ValueFinder valueFinder, LogMaker log) {
        if (callback == this.mCallback) {
            hideAllUiThread(callback);
            final LogMaker logMaker = log;
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_AutoFillUI_12114 */
    /* synthetic */ void m127lambda$-com_android_server_autofill_ui_AutoFillUI_12114(int operation, IBinder token) {
