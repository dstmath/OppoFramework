...
final class SaveUi {
    ...
    SaveUi(Context context, PendingUi pendingUi, CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, String packageName, SaveInfo info, ValueFinder valueFinder, OverlayControl overlayControl, OnSaveListener listener) {
        ...
        if ((type & 1) != 0) {
            arraySet.add(context.getString(17039573));
        }
        if ((type & 2) != 0) {
            arraySet.add(context.getString(17039570));
        }
        if ((type & 4) != 0) {
            arraySet.add(context.getString(17039571));
        }
        if ((type & 8) != 0) {
            arraySet.add(context.getString(17039574));
        }
        if ((type & 16) != 0) {
            arraySet.add(context.getString(17039572));
        }
        switch (arraySet.size()) {
            case 1:
                this.mTitle = Html.fromHtml(context.getString(17039569, new Object[]{arraySet.valueAt(0), serviceLabel}), 0);
                break;
            case 2:
                this.mTitle = Html.fromHtml(context.getString(17039567, new Object[]{arraySet.valueAt(0), arraySet.valueAt(1), serviceLabel}), 0);
                break;
            case 3:
                this.mTitle = Html.fromHtml(context.getString(17039568, new Object[]{arraySet.valueAt(0), arraySet.valueAt(1), arraySet.valueAt(2), serviceLabel}), 0);
                break;
            default:
                this.mTitle = Html.fromHtml(context.getString(17039566, new Object[]{serviceLabel}), 0);
                break;
        }
        ...
        if (info.getNegativeActionStyle() == 1) {
            noButton.setText(17040808);
        } else {
            noButton.setText(17039565);
        }
        noButton.setOnClickListener(new -$Lambda$At7ghLP7ePb8IjX4T-3J791grHE((byte) 1, this, info));
        view.findViewById(16908732).setOnClickListener(new com.android.server.autofill.ui.-$Lambda$lWFJV62mVsorLi23UkgJkVRbfB8.AnonymousClass1(this));
        ...
        params.width = -1;
        params.accessibilityTitle = context.getString(17039564);
        params.windowAnimations = 16974601;
        show();
    }

    /* renamed from: lambda$-com_android_server_autofill_ui_SaveUi_10978 */
    /* synthetic */ void m138lambda$-com_android_server_autofill_ui_SaveUi_10978(SaveInfo info, View v) {
        this.mListener.onCancel(info.getNegativeActionListener());
    }

    /* renamed from: lambda$-com_android_server_autofill_ui_SaveUi_11152 */
    /* synthetic */ void m139lambda$-com_android_server_autofill_ui_SaveUi_11152(View v) {
        this.mListener.onSave();
    }

    /* renamed from: lambda$-com_android_server_autofill_ui_SaveUi_11481 */
    /* synthetic */ void m140lambda$-com_android_server_autofill_ui_SaveUi_11481(DialogInterface d) {
