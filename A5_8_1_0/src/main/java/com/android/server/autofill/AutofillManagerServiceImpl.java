...
final class AutofillManagerServiceImpl {
    ...
    /* renamed from: lambda$-com_android_server_autofill_AutofillManagerServiceImpl_4247 */
    /* synthetic */ void m123xe395bc77(Message msg) {
        switch (msg.what) {
            case 1:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x00d5 A:{Splitter: B:5:0x0068, ExcHandler: java.lang.RuntimeException (r1_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:19:0x00d5, code:
            r1 = move-exception;
     */
    /* JADX WARNING: Missing block: B:20:0x00d6, code:
            android.util.Slog.e(TAG, "Bad autofill service name " + r0 + ": " + r1);
     */
    /* JADX WARNING: Missing block: B:21:0x00fb, code:
            return;
     */
    ...
    private void assertCallerLocked(ComponentName componentName) {
        ...
        try {
            int packageUid = pm.getPackageUidAsUser(componentName.getPackageName(), UserHandle.getCallingUserId());
    ...
    /* JADX WARNING: Missing block: B:16:0x004f, code:
            if (com.android.server.autofill.Helper.sDebug == false) goto L_0x007f;
     */
    /* JADX WARNING: Missing block: B:17:0x0051, code:
            android.util.Slog.d(TAG, "No pending Save UI for token " + r9 + " and operation " + android.util.DebugUtils.flagsToString(android.view.autofill.AutofillManager.class, "PENDING_UI_OPERATION_", r8));
     */
