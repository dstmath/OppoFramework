...
final class Session implements FillServiceCallbacks, Listener, AutoFillUiCallback {
    ...
    /* JADX WARNING: Missing block: B:32:0x0080, code:
            r5 = r1.toString();
     */
    /* JADX WARNING: Missing block: B:33:0x0084, code:
            return r5;
     */
    /* JADX WARNING: Missing block: B:34:0x0085, code:
            android.util.Slog.w(TAG, "getValueAsString(): no autofill options for id " + r11);
     */
    ...
    /* JADX WARNING: Missing block: B:16:0x0042, code:
            if (r7.getDatasets() == null) goto L_0x004e;
     */
    /* JADX WARNING: Missing block: B:18:0x004c, code:
            if (r7.getDatasets().isEmpty() == false) goto L_0x0057;
     */
    /* JADX WARNING: Missing block: B:20:0x0052, code:
            if (r7.getAuthentication() != null) goto L_0x0057;
     */
    ...
    /* JADX WARNING: Missing block: B:27:0x005e, code:
            r2 = newLogMaker(907, r9).setType(10);
     */
    /* JADX WARNING: Missing block: B:28:0x006e, code:
            if (r7.getDatasets() != null) goto L_0x0083;
     */
    /* JADX WARNING: Missing block: B:29:0x0070, code:
            r5.mMetricsLogger.write(r2.addTaggedData(909, java.lang.Integer.valueOf(r1)));
     */
    ...
    /* renamed from: lambda$-com_android_server_autofill_Session_24580 */
    /* synthetic */ void m124lambda$-com_android_server_autofill_Session_24580(int requestId, int datasetIndex, Dataset dataset) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_Session_27469 */
    /* synthetic */ void m125lambda$-com_android_server_autofill_Session_27469(IntentSender intentSender) {
        try {
            synchronized (this.mLock) {
    ...
    /* JADX WARNING: Missing block: B:10:0x002e, code:
            if (r17 == null) goto L_0x003e;
     */
    /* JADX WARNING: Missing block: B:12:0x0034, code:
            if (r17.isText() == false) goto L_0x003e;
     */
    /* JADX WARNING: Missing block: B:13:0x0036, code:
            r3 = r17.getTextValue().toString();
     */
    /* JADX WARNING: Missing block: B:14:0x003e, code:
            getUiForShowing().showFillUi(r16, r15, r3, r14.mService.getServicePackageName(), r14.mComponentName.getPackageName(), r14);
            r1 = r14.mLock;
     */
    ...
    /* JADX WARNING: Missing block: B:18:0x005e, code:
            if (r14.mUiShownTime != 0) goto L_0x00e6;
     */
    /* JADX WARNING: Missing block: B:19:0x0060, code:
            r14.mUiShownTime = android.os.SystemClock.elapsedRealtime();
            r8 = r14.mUiShownTime - r14.mStartTime;
     */
    /* JADX WARNING: Missing block: B:20:0x006e, code:
            if (com.android.server.autofill.Helper.sDebug == false) goto L_0x0092;
     */
    /* JADX WARNING: Missing block: B:21:0x0070, code:
            r11 = new java.lang.StringBuilder("1st UI for ").append(r14.mActivityToken).append(" shown in ");
            android.util.TimeUtils.formatDuration(r8, r11);
            android.util.Slog.d(TAG, r11.toString());
     */
    /* JADX WARNING: Missing block: B:22:0x0092, code:
            r7 = new java.lang.StringBuilder("id=").append(r14.id).append(" app=").append(r14.mActivityToken).append(" svc=").append(r14.mService.getServicePackageName()).append(" latency=");
            android.util.TimeUtils.formatDuration(r8, r7);
            r14.mUiLatencyHistory.log(r7.toString());
            r14.mMetricsLogger.write(newLogMaker(1136).addTaggedData(1145, java.lang.Long.valueOf(r8)));
     */
    /* JADX WARNING: Missing block: B:23:0x00e6, code:
            monitor-exit(r1);
     */
    /* JADX WARNING: Missing block: B:24:0x00e7, code:
            return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
