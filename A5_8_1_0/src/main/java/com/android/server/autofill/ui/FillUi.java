...
final class FillUi {
    ...
    final class AnchoredWindow implements OnTouchListener {
        ...
        public void show(LayoutParams params) {
            ...
            try {
                ...
                params.accessibilityTitle = this.mContentView.getContext().getString(17039558);
    ...
    private final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                text = FillUi.this.mContext.getString(17039559);
            } else {
    ...
    private final class AutofillWindowPresenter extends Stub {
        ...
        /* renamed from: lambda$-com_android_server_autofill_ui_FillUi$AutofillWindowPresenter_13643 */
        /* synthetic */ void m137xc9b1d009(LayoutParams p) {
            ...
            return new Filter() {
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    for (int i = 0; i < itemCount; i++) {
                        ...
                        if ((value == null && item.mDataset.getAuthentication() == null) || (value != null && value.toLowerCase().startsWith(constraintLowerCase))) {
    ...
    FillUi(Context context, FillResponse response, AutofillId focusedViewId, String filterText, OverlayControl overlayControl, Callback callback) {
        ...
        this.mListView = (ListView) decor.findViewById(16908725);
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_FillUi_5115 */
    /* synthetic */ void m134lambda$-com_android_server_autofill_ui_FillUi_5115(FillResponse response, View v) {
        this.mCallback.onResponsePicked(response);
    }

    /* renamed from: lambda$-com_android_server_autofill_ui_FillUi_7197 */
    /* synthetic */ void m135lambda$-com_android_server_autofill_ui_FillUi_7197(AdapterView adapterView, View view, int position, long id) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_ui_FillUi_7794 */
    /* synthetic */ void m136lambda$-com_android_server_autofill_ui_FillUi_7794(int oldCount, int count) {
        if (!this.mDestroyed) {
            if (count <= 0) {
                if (Helper.sDebug) {
