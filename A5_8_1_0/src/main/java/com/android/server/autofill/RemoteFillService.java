...
final class RemoteFillService implements DeathRecipient {
    ...
    private static abstract class PendingRequest implements Runnable {
        ...
        /* JADX WARNING: Missing block: B:11:0x000d, code:
            ...
            r0 = (com.android.server.autofill.RemoteFillService) r6.mWeakService.get();
     */
        /* JADX WARNING: Missing block: B:12:0x0037, code:
            if (r0 == null) goto L_0x006b;
     */
        /* JADX WARNING: Missing block: B:13:0x0039, code:
            android.util.Slog.w(com.android.server.autofill.RemoteFillService.LOG_TAG, getClass().getSimpleName() + " timed out after " + com.android.server.face.FaceDaemonWrapper.TIMEOUT_FACED_BINDERCALL_CHECK + " ms");
            onTimeout(r0);
     */
        /* JADX WARNING: Missing block: B:14:0x006b, code:
            return;
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        /* renamed from: lambda$-com_android_server_autofill_RemoteFillService$PendingRequest_16563 */
        /* synthetic */ void m120x7a9992cd() {
     ...
     */
        /* JADX WARNING: Missing block: B:14:?, code:
            com.android.server.autofill.RemoteFillService.-get0(r1).onFillRequest(r6.mRequest, r6.mCallback);
     */
        /* JADX WARNING: Missing block: B:19:0x0042, code:
            r0 = move-exception;
     */
        /* JADX WARNING: Missing block: B:20:0x0043, code:
            android.util.Slog.e(com.android.server.autofill.RemoteFillService.LOG_TAG, "Error calling on fill request", r0);
            com.android.server.autofill.RemoteFillService.-wrap0(r1, r6, null);
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            synchronized (this.mLock) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_RemoteFillService_10790 */
    /* synthetic */ void m116lambda$-com_android_server_autofill_RemoteFillService_10790(PendingRequest pendingRequest, int requestFlags, FillResponse response, int callingUid) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_RemoteFillService_11195 */
    /* synthetic */ void m117lambda$-com_android_server_autofill_RemoteFillService_11195(PendingRequest pendingRequest, CharSequence message) {
        if (handleResponseCallbackCommon(pendingRequest)) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_RemoteFillService_11516 */
    static /* synthetic */ void m115lambda$-com_android_server_autofill_RemoteFillService_11516(ICancellationSignal cancellationSignal) {
        try {
    ...
    /* renamed from: lambda$-com_android_server_autofill_RemoteFillService_11852 */
    /* synthetic */ void m118lambda$-com_android_server_autofill_RemoteFillService_11852(PendingRequest pendingRequest) {
        if (handleResponseCallbackCommon(pendingRequest)) {
    ...
    /* renamed from: lambda$-com_android_server_autofill_RemoteFillService_12197 */
    /* synthetic */ void m119lambda$-com_android_server_autofill_RemoteFillService_12197(PendingRequest pendingRequest, CharSequence message) {
        if (handleResponseCallbackCommon(pendingRequest)) {
