...
final class UiModeManagerService extends SystemService {
    ...
    public void onStart() {
        ...
        this.mDefaultUiModeType = res.getInteger(17694770);
        if (res.getInteger(17694753) == 1) {
            z = true;
        } else {
            z = false;
        }
        this.mCarModeKeepsScreenOn = z;
        if (res.getInteger(17694772) == 1) {
            z2 = true;
        }
        this.mDeskModeKeepsScreenOn = z2;
        this.mEnableCarDockLaunch = res.getBoolean(17956948);
        this.mUiModeLocked = res.getBoolean(17956983);
        this.mNightModeLocked = res.getBoolean(17956982);
        ...
        this.mNightMode = Secure.getInt(context.getContentResolver(), "ui_night_mode", res.getInteger(17694766));
    ...
    /* renamed from: lambda$-com_android_server_UiModeManagerService_9177 */
    /* synthetic */ void m32lambda$-com_android_server_UiModeManagerService_9177() {
    ...
    private void adjustStatusBarCarModeLocked() {
        ...
        if (this.mCarModeEnabled) {
            ...
            this.mNotificationManager.notifyAsUser(null, 10, new Builder(context, SystemNotificationChannels.CAR_MODE).setSmallIcon(17303418).setDefaults(4).setOngoing(true).setWhen(0).setColor(context.getColor(17170763)).setContentTitle(context.getString(17039619)).setContentText(context.getString(17039618)).setContentIntent(PendingIntent.getActivityAsUser(context, 0, carModeOffIntent, 0, null, UserHandle.CURRENT)).build(), UserHandle.ALL);
            return;
        }
