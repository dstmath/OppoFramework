...
public class SyntheticPasswordManager {
    ...
    /* renamed from: lambda$-com_android_server_locksettings_SyntheticPasswordManager_12018 */
    /* synthetic */ void m72x9d7aed77(int status, WeaverConfig config) {
    ...
    /* renamed from: lambda$-com_android_server_locksettings_SyntheticPasswordManager_14916 */
    static /* synthetic */ void m71x9d7bf7fc(VerifyCredentialResponse[] response, int slot, int status, WeaverReadResponse readResponse) {
        switch (status) {
            case 0:
