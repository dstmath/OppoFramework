...
public class CarServiceHelperService extends SystemService {
    ...
    private final ICarServiceHelperImpl mHelper = new ICarServiceHelperImpl(this, null);

    private class ICarServiceHelperImpl extends Stub {
        /* synthetic */ ICarServiceHelperImpl(CarServiceHelperService this$0, ICarServiceHelperImpl -this1) {
            this();
        }
