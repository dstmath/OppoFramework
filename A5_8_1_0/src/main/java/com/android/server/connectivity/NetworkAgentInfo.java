...
public class NetworkAgentInfo implements Comparable<NetworkAgentInfo> {
    ...
    private static final /* synthetic */ int[] f67-android-net-NetworkRequest$TypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m101-getandroid-net-NetworkRequest$TypeSwitchesValues() {
        if (f67-android-net-NetworkRequest$TypeSwitchesValues != null) {
            return f67-android-net-NetworkRequest$TypeSwitchesValues;
        }
        ...
        f67-android-net-NetworkRequest$TypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void updateRequestCounts(boolean add, NetworkRequest request) {
        int delta = add ? 1 : -1;
        switch (m101-getandroid-net-NetworkRequest$TypeSwitchesValues()[request.type.ordinal()]) {
            case 1:
    ...
    public void updateClat(INetworkManagementService netd) {
        if (Nat464Xlat.requiresClat(this) && (this.networkCapabilities.hasCapability(12) || this.networkCapabilities.hasCapability(0))) {
            maybeStartClat(netd);
        } else {
            maybeStopClat();
        }
