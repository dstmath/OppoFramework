...
public final class IpConnectivityMetrics extends SystemService {
    ...
    /* renamed from: lambda$-com_android_server_connectivity_IpConnectivityMetrics_10868 */
    static /* synthetic */ int m152xea83d7(Context ctx) {
    ...
    private static ArrayMap<Class<?>, TokenBucket> makeRateLimitingBuckets() {
        ...
        map.put(ApfProgramEvent.class, new TokenBucket(OppoBrightUtils.SPECIAL_AMBIENT_LIGHT_HORIZON, 50));
        return map;
    }
}
