...
public class TetherInterfaceStateMachine extends StateMachine {
    ...
    class TetheredState extends BaseServingState {
        ...
        private void cleanupUpstreamInterface(String upstreamIface) {
            ...
            try {
                ...
                if (TetherInterfaceStateMachine.this.mV6OnlyTetherEnabled) {
                    String ClatPrefix = "v4-";
                    if (upstreamIface.startsWith("v4-", 0)) {
                        TetherInterfaceStateMachine.this.mNMService.stopInterfaceForwarding(TetherInterfaceStateMachine.this.mIfaceName, upstreamIface.substring("v4-".length()));
                    }
                }
            } catch (Exception e2) {
            }
                    ...
                    if (!(TetherInterfaceStateMachine.this.mMyUpstreamIfaceName == null && newUpstreamIfaceName == null) && (TetherInterfaceStateMachine.this.mMyUpstreamIfaceName == null || !TetherInterfaceStateMachine.this.mMyUpstreamIfaceName.equals(newUpstreamIfaceName))) {
                        ...
                        if (newUpstreamIfaceName != null) {
                            try {
                                ...
                                if (TetherInterfaceStateMachine.this.mV6OnlyTetherEnabled) {
                                    String ClatPrefix = "v4-";
                                    if (newUpstreamIfaceName.startsWith("v4-", 0)) {
                                        TetherInterfaceStateMachine.this.mNMService.startInterfaceForwarding(TetherInterfaceStateMachine.this.mIfaceName, newUpstreamIfaceName.substring("v4-".length()));
                                    }
                                }
                            } catch (Exception e) {
    ...
    public TetherInterfaceStateMachine(String ifaceName, Looper looper, int interfaceType, SharedLog log, INetworkManagementService nMService, INetworkStatsService statsService, IControlsTethering tetherController) {
        ...
        resetLinkProperties();
        this.mV6OnlyTetherEnabled = false;
        this.mLastError = 0;
    ...
    public TetherInterfaceStateMachine(String ifaceName, Looper looper, int interfaceType, SharedLog log, INetworkManagementService nMService, INetworkStatsService statsService, IControlsTethering tetherController, boolean V6OnlyTetherEnabled) {
        super(ifaceName, looper);
        this.mLog = log.forSubComponent(ifaceName);
        this.mNMService = nMService;
        this.mStatsService = statsService;
        ...
        this.mInterfaceType = interfaceType;
        resetLinkProperties();
        this.mV6OnlyTetherEnabled = V6OnlyTetherEnabled;
        this.mLastError = 0;
        this.mServingMode = 1;
        this.mInitialState = new InitialState();
        this.mLocalHotspotState = new LocalHotspotState();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0042 A:{Splitter: B:12:0x0030, ExcHandler: android.os.ServiceSpecificException (r4_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Removed duplicated region for block: B:30:0x00a9 A:{Splitter: B:27:0x0097, ExcHandler: android.os.ServiceSpecificException (r4_1 'e' java.lang.Exception)} */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x00d6 A:{Splitter: B:32:0x00d2, ExcHandler: android.os.ServiceSpecificException (e android.os.ServiceSpecificException)} */
    /* JADX WARNING: Missing block: B:15:0x0042, code:
            r4 = move-exception;
     */
    /* JADX WARNING: Missing block: B:16:0x0043, code:
            r10.mLog.e("Failed to remove local dns IP " + r3 + ": " + r4);
     */
    /* JADX WARNING: Missing block: B:30:0x00a9, code:
            r4 = move-exception;
     */
    /* JADX WARNING: Missing block: B:31:0x00aa, code:
            r10.mLog.e("Failed to add local dns IP " + r3 + ": " + r4);
            r12.remove(r1);
     */
    /* JADX WARNING: Missing block: B:36:0x00d7, code:
            r10.mLog.e("Failed to update local DNS caching server");
     */
