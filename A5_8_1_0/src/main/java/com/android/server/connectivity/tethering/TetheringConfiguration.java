...
public class TetheringConfiguration {
    ...
    public TetheringConfiguration(Context ctx, SharedLog log) {
        ...
        this.tetherableUsbRegexs = ctx.getResources().getStringArray(17236046);
        if (SystemProperties.getInt("persist.vendor.fst.softap.en", 0) == 1) {
            String fstInterfaceName = SystemProperties.get("persist.vendor.fst.data.interface", "bond0");
            this.tetherableWifiRegexs = new String[]{fstInterfaceName};
        } else {
            this.tetherableWifiRegexs = ctx.getResources().getStringArray(17236047);
        }
        this.tetherableBluetoothRegexs = ctx.getResources().getStringArray(17236043);
    ...
    private static String[] getDhcpRanges(Context ctx) {
        String[] fromResource = ctx.getResources().getStringArray(17236044);
