...
public class UpstreamNetworkMonitor {
    ...
    private static class TypeStatePair {
        ...
        /* synthetic */ TypeStatePair(TypeStatePair -this0) {
            this();
        }
    ...
    private TypeStatePair findFirstAvailableUpstreamByType(Iterable<NetworkState> netStates, Iterable<Integer> preferredTypes) {
        ...
        for (Integer intValue : preferredTypes) {
            ...
            try {
                ...
                for (NetworkState value : netStates) {
                    if (type != 4) {
                        try {
                            if (type != cm().getActiveNetworkInfo().getType()) {
                                continue;
                            }
