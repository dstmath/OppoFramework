...
public class NetdEventListenerService extends Stub {
    ...
    private static int wakeupEventIndex(long cursor) {
        return (int) Math.abs(cursor % OppoDeviceStorageMonitorService.KB_BYTES);
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_NetdEventListenerService_8935 */
    static /* synthetic */ Object m158xe91d8e8a(ConnectStats x) {
        return x;
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_NetdEventListenerService_8987 */
    static /* synthetic */ Object m159xe91d8f27(DnsEvent x) {
        return x;
    }
