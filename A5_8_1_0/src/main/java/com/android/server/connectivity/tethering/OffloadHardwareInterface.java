...
public class OffloadHardwareInterface {
    ...
    private static class CbResults {
        ...
        /* synthetic */ CbResults(CbResults -this0) {
            this();
        }
    ...
    private static class TetheringOffloadCallback extends Stub {
        ...
        /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface$TetheringOffloadCallback_10626 */
        /* synthetic */ void m69x20a349f5(int event) {
            switch (event) {
                case 1:
        ...
        /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface$TetheringOffloadCallback_11706 */
        /* synthetic */ void m70x20a3c1d7(NatTimeoutUpdate params) {
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_4483 */
    static /* synthetic */ void m61x698ce745(CbResults results, boolean success, String errMsg) {
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_4988 */
    /* synthetic */ void m68x698cfa0f(boolean success, String errMsg) {
        if (!success) {
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_5729 */
    static /* synthetic */ void m62x698d6633(ForwardedStats stats, long rxBytes, long txBytes) {
        if (rxBytes <= 0) {
            rxBytes = 0;
        }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_6440 */
    static /* synthetic */ void m63x698dcf84(CbResults results, boolean success, String errMsg) {
        results.success = success;
        results.errMsg = errMsg;
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_7086 */
    static /* synthetic */ void m64x698e3561(CbResults results, boolean success, String errMsg) {
        results.success = success;
        results.errMsg = errMsg;
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_8155 */
    static /* synthetic */ void m65x698ead23(CbResults results, boolean success, String errMsg) {
        results.success = success;
        results.errMsg = errMsg;
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_8802 */
    static /* synthetic */ void m66x698ec6cc(CbResults results, boolean success, String errMsg) {
        results.success = success;
        results.errMsg = errMsg;
    }
    ...
    /* renamed from: lambda$-com_android_server_connectivity_tethering_OffloadHardwareInterface_9458 */
    static /* synthetic */ void m67x698f2cc8(CbResults results, boolean success, String errMsg) {
        results.success = success;
        results.errMsg = errMsg;
    }
