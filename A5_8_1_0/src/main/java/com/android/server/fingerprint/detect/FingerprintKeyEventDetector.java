...
public class FingerprintKeyEventDetector implements IFingerprintKeyEventListener {
    ...
    private static final /* synthetic */ int[] f247x1e1d3b2f = null;
    ...
    private static /* synthetic */ int[] m172x15ba55d3() {
        if (f247x1e1d3b2f != null) {
            return f247x1e1d3b2f;
        }
    ...
    private void dealKeyEventHappenend(FingerprintKeyEventData keyeventData) {
        switch (m172x15ba55d3()[keyeventData.getKeyEventType().ordinal()]) {
            case 1:
