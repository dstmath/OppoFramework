...
public class AccessibilityManagerService extends Stub {
    ...
    private static final ComponentName sDirectAccessibilityServiceComponentName = new ComponentName("com.coloros.colordirectservice", "com.coloros.colordirectservice.ColorTextAccessibilityService");
    ...
    private boolean mNeedShowMagnificationDialog = true;
    ...
    private final class MainHandler extends Handler {
        ...
        /* renamed from: lambda$-com_android_server_accessibility_AccessibilityManagerService$MainHandler_114090 */
        static /* synthetic */ void m108x642a703e(int relevantEventTypes, IAccessibilityManagerClient client) {
            try {
        ...
        private void announceNewUserIfNeeded() {
            synchronized (AccessibilityManagerService.this.mLock) {
                if (AccessibilityManagerService.this.getCurrentUserStateLocked().isHandlingAccessibilityEvents()) {
                    ...
                    String message = AccessibilityManagerService.this.mContext.getString(17041038, new Object[]{userManager.getUserInfo(AccessibilityManagerService.this.mCurrentUserId).name});
        ...
        /* renamed from: lambda$-com_android_server_accessibility_AccessibilityManagerService$MainHandler_116339 */
        static /* synthetic */ void m109x642b638e(int clientState, IAccessibilityManagerClient client) {
            try {
    ...
    final class SecurityPolicy {
            ...
            if (windowCount > 0) {
                ...
                for (i = 0; i < windowCount; i++) {
                    ...
                    if (AccessibilityManagerService.this.mWindowsForAccessibilityCallback != null) {
                        window = AccessibilityManagerService.this.mWindowsForAccessibilityCallback.populateReportedWindow(windowInfo);
                    } else {
                        window = null;
                    }
                    if (window != null) {
        ...
        public int resolveCallingUserIdEnforcingPermissionsLocked(int userId) {
            ...
            if (callingUid != 0 && callingUid != 1000 && callingUid != OppoArpPeer.ARP_FIRST_RESPONSE_TIMEOUT) {
        ...
        public boolean isCallerInteractingAcrossUsers(int userId) {
            int callingUid = Binder.getCallingUid();
            if (Binder.getCallingPid() == Process.myPid() || callingUid == OppoArpPeer.ARP_FIRST_RESPONSE_TIMEOUT || userId == -2 || userId == -3) {
                return true;
            }
            return false;
        }
    ...
    class Service extends IAccessibilityServiceConnection.Stub implements ServiceConnection, DeathRecipient, KeyEventFilter, FingerprintGestureClient {
        ...
        public Service(int userId, ComponentName componentName, AccessibilityServiceInfo accessibilityServiceInfo) {
            ...
            int -get24 = AccessibilityManagerService.sIdCounter;
            AccessibilityManagerService.sIdCounter = -get24 + 1;
            this.mId = -get24;
     ...
     */
        /* JADX WARNING: Missing block: B:42:?, code:
            com.android.server.accessibility.AccessibilityManagerService.-get14(r22.this$0).userActivity(android.os.SystemClock.uptimeMillis(), 3, 0);
     */
        /* JADX WARNING: Missing block: B:43:0x00a7, code:
            if (r14 == null) goto L_0x00b4;
     */
        /* JADX WARNING: Missing block: B:44:0x00a9, code:
            ((android.app.ActivityManagerInternal) com.android.server.LocalServices.getService(android.app.ActivityManagerInternal.class)).setFocusedActivity(r14);
     */
        /* JADX WARNING: Missing block: B:45:0x00b4, code:
            r3.performAccessibilityAction(r24, r26, r27, r28, r29, r22.mFetchFlags, r11, r30);
     */
        /* JADX WARNING: Missing block: B:47:0x00cb, code:
            return true;
     */
     ...
     */
        /* JADX WARNING: Missing block: B:10:?, code:
            com.android.server.accessibility.AccessibilityManagerService.-get14(r9.this$0).userActivity(android.os.SystemClock.uptimeMillis(), 3, 0);
     */
     ...
     */
        ...
        /* JADX WARNING: Missing block: B:9:0x0011, code:
            r2 = r6.this$0.getMagnificationController();
            r3 = registerMagnificationIfNeeded(r2);
            r0 = android.os.Binder.clearCallingIdentity();
     */
        /* JADX WARNING: Missing block: B:11:?, code:
            r4 = r2.getCenterX();
        ...
        public void resetLocked() {
            ...
            if (this.mService != null) {
                try {
                    ...
                    Slog.e(AccessibilityManagerService.LOG_TAG, "Unable to unlinkToDeath", e2);
                }
                this.mService = null;
            }
     ...
     */
        /* JADX WARNING: Missing block: B:33:0x0074, code:
            r8.recycle();
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        ...
        private void sendDownAndUpKeyEvents(int keyCode) {
            ...
            down.recycle();
            InputEvent up = KeyEvent.obtain(downTime, SystemClock.uptimeMillis(), 1, keyCode, 0, 0, -1, 0, 8, UsbTerminalTypes.TERMINAL_USB_STREAMING, null);
    ...
    private class UserState {
        ...
        public int getClientState() {
            ...
            if (isDirectAccessibilityEnable()) {
                return clientState | 16;
            }
            return clientState;
        }

        public boolean isDirectAccessibilityEnable() {
            return !this.mEnabledServices.isEmpty() ? this.mEnabledServices.contains(AccessibilityManagerService.sDirectAccessibilityServiceComponentName) : false;
        }
    ...
    public long addClient(IAccessibilityManagerClient client, int userId) {
        ...
        synchronized (this.mLock) {
            ...
            of = IntPair.of(i, userState.mLastSentRelevantEventTypes);
            return of;
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_accessibility_AccessibilityManagerService_64070 */
    /* synthetic */ void m107xb0c4a53(UserState userState, int finalRelevantEventTypes) {
        broadcastToClients(userState, new -$Lambda$kXhldx_ZxidxR4suyNIbZ545MMw((byte) 2, finalRelevantEventTypes));
    }

    /* renamed from: lambda$-com_android_server_accessibility_AccessibilityManagerService_64124 */
    static /* synthetic */ void m106xb0c4d7d(int finalRelevantEventTypes, IAccessibilityManagerClient client) {
        try {
    ...
    private void showEnableTouchExplorationDialog(final Service service) {
        synchronized (this.mLock) {
            ...
            if (state.mIsTouchExplorationEnabled) {
                ...
                }).setTitle(17039836).setMessage(this.mContext.getString(17039835, new Object[]{label})).create();
    ...
    private void ensureWindowsAvailableTimed() {
        synchronized (this.mLock) {
            ...
            while (this.mSecurityPolicy.mWindows == null) {
                long remainMillis = FaceDaemonWrapper.TIMEOUT_FACED_BINDERCALL_CHECK - (SystemClock.uptimeMillis() - startMillis);
                if (remainMillis <= 0) {
                    return;
                }
                try {
