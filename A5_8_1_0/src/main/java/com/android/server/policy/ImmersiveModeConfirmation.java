...
public class ImmersiveModeConfirmation {
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909109)).setOnClickListener(new OnClickListener() {
    ...
    public ImmersiveModeConfirmation(Context context) {
        ...
        this.mWindowManager = (WindowManager) this.mContext.getSystemService(OppoProcessManager.RESUME_REASON_VISIBLE_WINDOW_STR);
    }
    ...
    public FrameLayout.LayoutParams getBubbleLayoutParams() {
        return new FrameLayout.LayoutParams(this.mContext.getResources().getDimensionPixelSize(17105056), -2, 49);
    }
