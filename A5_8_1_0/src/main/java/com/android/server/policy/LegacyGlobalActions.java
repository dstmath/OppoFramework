...
class LegacyGlobalActions implements OnDismissListener, OnClickListener {
    ...
    private static abstract class SinglePressAction implements Action {
        ...
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            ...
            TextView statusView = (TextView) v.findViewById(16909317);
    ...
    private class BugReportAction extends SinglePressAction implements LongPressAction {
        ...
        public String getStatus() {
            return LegacyGlobalActions.this.mContext.getString(17039598, new Object[]{VERSION.RELEASE, Build.ID});
        }
    }
    ...
    private class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            super(17302271, 17302270, 17039955, 17039954, 17039953);
        }
    ...
    private static class SilentModeTriStateAction implements Action, View.OnClickListener {
        private final int[] ITEM_IDS = new int[]{16909118, 16909119, 16909120};
        private final AudioManager mAudioManager;
        private final Context mContext;
    ...
    public LegacyGlobalActions(Context context, WindowManagerFuncs windowManagerFuncs, Runnable onDismiss) {
        ...
        this.mShowSilentToggle = this.mContext.getResources().getBoolean(17957051) ^ 1;
    ...
    private GlobalActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302397, 17302399, 17039960, 17039959, 17039958) {
            void onToggle(boolean on) {
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302723, 17039952) {
            public void onPress() {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302177, 17039946) {
            public void onPress() {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302256, 17039944) {
            public void onPress() {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302753, 17039956) {
            public void onPress() {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17039948) {
            public void onPress() {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    ...
                    if (currentUser == null) {
                        ...
                        items.add(new SinglePressAction(17302614, icon, (user.name != null ? user.name : "Primary") + (isCurrentUser ? " ✔" : "")) {
                            public void onPress() {
                                try {
