...
public class AccessibilityShortcutController {
    ...
    public static String getTargetServiceComponentNameString(Context context, int userId) {
        ...
        return context.getString(17039659);
    }
    ...
    public void performAccessibilityShortcut() {
        ...
        if (vibrator != null && vibrator.hasVibrator()) {
            vibrator.vibrate(PhoneWindowManager.getLongIntArray(this.mContext.getResources(), 17236017), -1, VIBRATION_ATTRIBUTES);
        }
    ...
    private AlertDialog createShortcutWarningDialog(int userId) {
        ...
        return this.mFrameworkObjectProvider.getAlertDialogBuilder(ActivityThread.currentActivityThread().getSystemUiContext()).setTitle(17039439).setMessage(String.format(this.mContext.getString(17039438), new Object[]{serviceInfo.getResolveInfo().loadLabel(this.mContext.getPackageManager()).toString()})).setCancelable(false).setPositiveButton(17040146, null).setNegativeButton(17039797, new com.android.server.policy.-$Lambda$k6uOVlk6EqgDgfUMuhedgW8Qb2I.AnonymousClass1(userId, this)).setOnCancelListener(new -$Lambda$k6uOVlk6EqgDgfUMuhedgW8Qb2I(userId, this)).create();
    }

    /* renamed from: lambda$-com_android_server_policy_AccessibilityShortcutController_10031 */
    /* synthetic */ void m110x4afd6771(int userId, DialogInterface d, int which) {
        Secure.putStringForUser(this.mContext.getContentResolver(), "accessibility_shortcut_target_service", "", userId);
    }

    /* renamed from: lambda$-com_android_server_policy_AccessibilityShortcutController_10363 */
    /* synthetic */ void m111x4afd7313(int userId, DialogInterface d) {
