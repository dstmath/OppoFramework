...
public abstract class WindowOrientationListener {
    ...
    final class OrientationSensorJudge extends OrientationJudge {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (WindowOrientationListener.LOG) {
                Slog.v(WindowOrientationListener.TAG, "onSensorChanged mDesiredRotation = " + this.mDesiredRotation + " newRotation = " + newRotation);
            }
            if (newRotation >= 0) {
                WindowOrientationListener.this.onProposedRotationChanged(newRotation);
            }
    ...
    private WindowOrientationListener(Context context, Handler handler, int rate) {
        ...
        this.MSG_DISABLE = FingerprintAcquiredInfo.ACQUIRED_ALREADY_ENROLLED;
    ...
    void sendDisable() {
        this.switchHandler.sendEmptyMessageDelayed(FingerprintAcquiredInfo.ACQUIRED_ALREADY_ENROLLED, 1000);
    }

    void sendEnable() {
        this.switchHandler.removeMessages(FingerprintAcquiredInfo.ACQUIRED_ALREADY_ENROLLED);
    }
