...
public class PerformUnifiedRestoreTask implements BackupRestoreTask {
    /* renamed from: -com-android-server-backup-restore-UnifiedRestoreStateSwitchesValues */
    private static final /* synthetic */ int[] f169x277f39c2 = null;
    ...
    /* renamed from: -getcom-android-server-backup-restore-UnifiedRestoreStateSwitchesValues */
    private static /* synthetic */ int[] m148x90233866() {
        if (f169x277f39c2 != null) {
            return f169x277f39c2;
        }
    ...
    public void execute() {
        switch (m148x90233866()[this.mState.ordinal()]) {
            case 1:
                if (this.mFinished) {
    ...
    private void dispatchNextRestore() {
        ...
        try {
            ...
            if (pkgName == null) {
                ...
                try {
                    this.mCurrentPackage = this.backupManagerService.getPackageManager().getPackageInfo(pkgName, 64);
                    if (metaInfo.versionCode > this.mCurrentPackage.versionCode) {
                        if ((this.mCurrentPackage.applicationInfo.flags & DumpState.DUMP_INTENT_FILTER_VERIFIERS) == 0) {
                            Slog.w(RefactoredBackupManagerService.TAG, "Package " + pkgName + ": " + ("Source version " + metaInfo.versionCode + " > installed version " + this.mCurrentPackage.versionCode));
