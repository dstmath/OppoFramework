...
public final class CompatibilitySchemeListInfo {
    ...
    private final ArrayList<CompatibilitySchemeInfo> mMsm8953SchemeList = new ArrayList<CompatibilitySchemeInfo>() {
        {
    ...
    private final ArrayList<CompatibilitySchemeInfo> mMt6763SchemeList = new ArrayList<CompatibilitySchemeInfo>() {
        {
            add(new CompatibilitySchemeInfo("107753", 0, null));
            add(new CompatibilitySchemeInfo("108753", 1, null));
            add(new CompatibilitySchemeInfo("109753", 2, null));
    ...
    private final ArrayList<CompatibilitySchemeInfo> mMt6771SchemeList = new ArrayList<CompatibilitySchemeInfo>() {
        {
            add(new CompatibilitySchemeInfo("1159531", 0, null));
            add(new CompatibilitySchemeInfo("1160512", 0, null));
            add(new CompatibilitySchemeInfo("1144146", 0, null));
    ...
    private final ArrayList<CompatibilitySchemeInfo> mSdm660SchemeList = new ArrayList<CompatibilitySchemeInfo>() {
        {
            add(new CompatibilitySchemeInfo("1160512", 0, null));
            add(new CompatibilitySchemeInfo("1160473", 0, null));
            add(new CompatibilitySchemeInfo("1160176", 0, null));
    ...
    private final ArrayList<CompatibilitySchemeInfo> mSdm845SchemeList = new ArrayList<CompatibilitySchemeInfo>() {
        {
            add(new CompatibilitySchemeInfo("1159531", 0, null));
            add(new CompatibilitySchemeInfo("1160512", 0, null));
            add(new CompatibilitySchemeInfo("1144146", 0, null));
    ...
    private class CompatibilitySchemeInfo {
        public int mAndVer;
    ...
    public void dump(PrintWriter pw, String[] args) {
        ...
        if (cmd == null) {
            dumpAll(pw);
            dumpCurrent(pw);
        } else if ("a".equals(cmd) || "all".equals(cmd)) {
            dumpAll(pw);
        } else if (OppoCrashClearManager.CLEAR_TIME.equals(cmd) || "current".equals(cmd)) {
            dumpCurrent(pw);
    ...
    private void dumpEachVersion(PrintWriter pw, int version) {
        ...
        dumpMsg.append(" list:\n");
        for (CompatibilitySchemeInfo info : tmp) {
    ...
    private void dumpCurrent(PrintWriter pw) {
        ArrayList<CompatibilitySchemeInfo> tmp = (ArrayList) this.mPlfListMap.get(SystemProperties.get("ro.board.platform", ""));
        if (tmp == null) {
