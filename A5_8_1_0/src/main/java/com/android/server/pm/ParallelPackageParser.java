...
class ParallelPackageParser implements AutoCloseable {
    ...
    private final ExecutorService mService = ConcurrentUtils.newFixedThreadPool(6, "package-parsing-thread", -2);
    ...
    /* renamed from: lambda$-com_android_server_pm_ParallelPackageParser_3950 */
    /* synthetic */ void m86lambda$-com_android_server_pm_ParallelPackageParser_3950(File scanFile, int parseFlags) {
