...
final class DefaultPermissionGrantPolicy {
        ...
        synchronized (this.mService.mPackages) {
            ...
            if (ActivityManager.isLowRamDeviceStatic()) {
                ...
                if (globalSearchPickerPackage != null && doesPackageSupportRuntimePermissions(globalSearchPickerPackage)) {
                    grantRuntimePermissionsLPw(globalSearchPickerPackage, MICROPHONE_PERMISSIONS, false, userId);
                    grantRuntimePermissionsLPw(globalSearchPickerPackage, LOCATION_PERMISSIONS, false, userId);
                }
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00ce A:{Catch:{ XmlPullParserException -> 0x00ce, XmlPullParserException -> 0x00ce }, Splitter: B:38:0x00cd, ExcHandler: org.xmlpull.v1.XmlPullParserException (e org.xmlpull.v1.XmlPullParserException)} */
