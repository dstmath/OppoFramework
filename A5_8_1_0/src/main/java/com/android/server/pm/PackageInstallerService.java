...
public class PackageInstallerService extends Stub {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0090 A:{PHI: r10 , Splitter: B:1:0x0006, ExcHandler: java.io.IOException (r9_1 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:22:0x0090, code:
            r9 = move-exception;
     */
    /* JADX WARNING: Missing block: B:24:?, code:
            android.util.Slog.wtf(TAG, "Failed reading install sessions", r9);
     */
            ...
            switch (params.mode) {
                ...
                case 2:
                    ...
                    synchronized (this.mSessions) {
                        ...
                        } else if (((long) this.mHistoricalSessionsByInstaller.get(callingUid)) >= 1048576) {
