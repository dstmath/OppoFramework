...
public class LauncherAppsService extends SystemService {
    ...
    static class LauncherAppsImpl extends Stub {
            ...
            private void onShortcutChangedInner(String packageName, int userId) {
                ...
                try {
                    ...
                    for (int i = 0; i < n; i++) {
                        ...
                        if (LauncherAppsImpl.this.isEnabledProfileOf(user, cookie.user, "onShortcutChanged") || userId == 999) {
        ...
        private boolean canAccessProfile(String callingPackage, int targetUserId, String message) {
            ...
            if ((callingUserId == 0 && targetUserId == OppoMultiAppManager.USER_ID) || targetUserId == callingUserId) {
                return true;
            }
