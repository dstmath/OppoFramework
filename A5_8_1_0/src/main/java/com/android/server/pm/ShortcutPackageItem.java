...
abstract class ShortcutPackageItem {
    ...
    public void lambda$-com_android_server_pm_ShortcutService_125293() {
    ...
    public void lambda$-com_android_server_pm_ShortcutUser_11105() {
        if (this.mPackageInfo.isShadow()) {
            ShortcutService s = this.mShortcutUser.mService;
    ...
    public void -com_android_server_pm_ShortcutService-mthref-7() {
    }
}
