...
public class InputManagerService extends Stub implements Monitor {
    ...
    public InputManagerService(Context context) {
        ...
        String doubleTouchGestureEnablePath = context.getResources().getString(17039670);
    ...
    private void showMissingKeyboardLayoutNotification(InputDevice device) {
        if (!this.mKeyboardLayoutNotificationShown) {
            ...
            this.mNotificationManager.notifyAsUser(null, 19, new Builder(this.mContext, SystemNotificationChannels.PHYSICAL_KEYBOARD).setContentTitle(r.getString(17040828)).setContentText(r.getString(17040827)).setContentIntent(keyboardLayoutIntent).setSmallIcon(17302725).setColor(this.mContext.getColor(17170763)).build(), UserHandle.ALL);
    ...
    private int getVirtualKeyQuietTimeMillis() {
        return this.mContext.getResources().getInteger(17694870);
    }
