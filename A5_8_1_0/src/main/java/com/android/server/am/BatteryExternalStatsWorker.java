...
class BatteryExternalStatsWorker implements ExternalStatsSync {
    ...
    /* renamed from: lambda$-com_android_server_am_BatteryExternalStatsWorker_2654 */
    static /* synthetic */ Thread m28lambda$-com_android_server_am_BatteryExternalStatsWorker_2654(Runnable r) {
    ...
    private void updateExternalStatsLocked(String reason, int updateFlags) {
            ...
            if (this.mWifiManager != null) {
                try {
                    ...
                    try {
                        ...
                        wifiReceiver = synchronousResultReceiver;
        ...
        if ((updateFlags & 8) != 0) {
            ...
            if (adapter != null) {
                bluetoothReceiver = new SynchronousResultReceiver(OppoProcessManager.RESUME_REASON_BLUETOOTH_STR);
