...
final class ReceiverRecord {
    ...
    /* JADX WARNING: Missing block: B:32:0x013f, code:
            if (r0 == null) goto L_0x017a;
     */
    /* JADX WARNING: Missing block: B:35:0x0143, code:
            if (r10.curApp == null) goto L_0x017a;
     */
    /* JADX WARNING: Missing block: B:37:0x014b, code:
            if (com.android.server.am.OppoProcessManagerHelper.checkProcessWhileBroadcastTimeout(r10.curApp) == false) goto L_0x0162;
     */
    ...
    /* JADX WARNING: Missing block: B:54:?, code:
            ...
            r10.mLooper = null;
     */
    /* JADX WARNING: Missing block: B:56:0x017b, code:
            r1 = move-exception;
     */
        ...
        synchronized (this) {
            ...
            if (this.curApp != null) {
                synchronized (this.curApp.receiverRecords) {
                    try {
                        z = ActivityManagerDebugConfig.DEBUG_BROADCAST;
