...
final class ProcessRecord {
    ...
    void dump(PrintWriter pw, String prefix) {
        ...
        pw.print(" lastPss=");
        DebugUtils.printSizeValue(pw, this.lastPss * OppoDeviceStorageMonitorService.KB_BYTES);
        pw.print(" lastSwapPss=");
        DebugUtils.printSizeValue(pw, this.lastSwapPss * OppoDeviceStorageMonitorService.KB_BYTES);
        pw.print(" lastCachedPss=");
        DebugUtils.printSizeValue(pw, this.lastCachedPss * OppoDeviceStorageMonitorService.KB_BYTES);
        pw.print(" lastCachedSwapPss=");
        DebugUtils.printSizeValue(pw, this.lastCachedSwapPss * OppoDeviceStorageMonitorService.KB_BYTES);
        pw.println();
        pw.print(prefix);
        pw.print("cached=");
