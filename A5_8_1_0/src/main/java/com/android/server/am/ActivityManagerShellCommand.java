...
final class ActivityManagerShellCommand extends ShellCommand {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (line.length() <= 0) {
                        ...
                        if (OppoCrashClearManager.CLEAR_TIME.equals(line) || "continue".equals(line)) {
                            resumeController(0);
                        ...
                        this.mPw.println("Invalid command: " + line);
                    } else if (OppoCrashClearManager.CLEAR_TIME.equals(line) || "continue".equals(line)) {
                        resumeController(0);
                    } else if ("k".equals(line) || "kill".equals(line)) {
                        resumeController(1);
                    } else {
    ...
    int runNoHomeScreen(PrintWriter pw) throws RemoteException {
        ...
        pw.println(res.getBoolean(17956988));
        return 0;
    }
