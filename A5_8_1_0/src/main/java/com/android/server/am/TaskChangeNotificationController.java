...
class TaskChangeNotificationController {
    ...
    /* renamed from: lambda$-com_android_server_am_TaskChangeNotificationController_4415 */
    static /* synthetic */ void m27x18229892(ITaskStackListener l, Message m) throws RemoteException {
        boolean z = false;
        if (m.arg1 != 0) {
            z = true;
        }
