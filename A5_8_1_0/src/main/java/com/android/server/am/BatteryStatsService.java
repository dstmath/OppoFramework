...
public final class BatteryStatsService extends Stub implements LowPowerModeListener, PlatformIdleStateCallback {
    ...
    /* renamed from: lambda$-com_android_server_am_BatteryStatsService_33781 */
    /* synthetic */ void m35lambda$-com_android_server_am_BatteryStatsService_33781(int plugType, int status, int health, int level, int temp, int volt, int chargeUAh, int chargeFullUAh) {
        synchronized (this.mStats) {
    ...
    /* renamed from: lambda$-com_android_server_am_BatteryStatsService_35168 */
    /* synthetic */ void m36lambda$-com_android_server_am_BatteryStatsService_35168(int status, int health, int plugType, int level, int temp, int volt, int chargeUAh, int chargeFullUAh) {
        synchronized (this.mStats) {
            this.mStats.setBatteryStateLocked(this.mContext, status, health, plugType, level, temp, volt, chargeUAh, chargeFullUAh);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:178:0x0363 A:{Splitter: B:170:0x0310, ExcHandler: java.io.IOException (r20_0 'e' java.lang.Throwable)} */
    /* JADX WARNING: Removed duplicated region for block: B:208:0x0422 A:{Splitter: B:202:0x03d8, ExcHandler: java.io.IOException (r20_1 'e' java.lang.Throwable)} */
    /* JADX WARNING: Missing block: B:178:0x0363, code:
            r20 = move-exception;
     */
     ...
     */
    /* JADX WARNING: Missing block: B:208:0x0422, code:
            r20 = move-exception;
     */
            ...
            if (args != null) {
                ...
                while (i < args.length) {
                    ...
                    if ("--checkin".equals(arg)) {
                        ...
                        this.mWorker.scheduleSync(OppoDynamicLogManager.INVOKE_DUMP_NAME, 31);
                    } else if ("--write".equals(arg)) {
                        awaitUninterruptibly(this.mWorker.scheduleSync(OppoDynamicLogManager.INVOKE_DUMP_NAME, 31));
                        synchronized (this.mStats) {
                                ...
                                if (this.mStats.mCheckinFile.exists()) {
                                    try {
                                        ...
                                        if (raw != null) {
                                            ...
                                            checkinStats = new BatteryStatsImpl(null, this.mStats.mHandler, null, this.mUserManagerUserInfoProvider);
