...
class MtpNotificationManager {
    ...
    void showNotification(UsbDevice device) {
        ...
        String title = resources.getString(17041023, new Object[]{device.getProductName()});
        Builder builder = new Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(title).setContentText(resources.getString(17041022)).setSmallIcon(17303460).setCategory("sys");
