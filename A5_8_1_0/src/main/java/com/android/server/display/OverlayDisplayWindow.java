...
final class OverlayDisplayWindow implements Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039802, new Object[]{this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi)});
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039801);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        int i;
        int i2 = 0;
        this.mWindowContent = LayoutInflater.from(this.mContext).inflate(17367199, null);
        this.mWindowContent.setOnTouchListener(this.mOnTouchListener);
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909129);
        this.mTextureView.setPivotX(OppoBrightUtils.MIN_LUX_LIMITI);
        this.mTextureView.setPivotY(OppoBrightUtils.MIN_LUX_LIMITI);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909130);
    ...
    private void clearLiveState() {
        this.mLiveTranslationX = OppoBrightUtils.MIN_LUX_LIMITI;
        this.mLiveTranslationY = OppoBrightUtils.MIN_LUX_LIMITI;
