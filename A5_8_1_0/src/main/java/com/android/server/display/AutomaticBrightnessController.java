...
class AutomaticBrightnessController {
    ...
    /* JADX WARNING: Missing block: B:21:0x00d8, code:
            if (com.android.server.display.OppoBrightUtils.mBrightnessBoost == 2) goto L_0x00cd;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
            ...
            if (!this.mLightSensorEnabled) {
                ...
                if (OppoBrightUtils.mBrightnessBoost == 1) {
                    Thread thread = new Thread(new Runnable() {
                        public void run() {
                            AutomaticBrightnessController.this.mSensorManager.registerListener(AutomaticBrightnessController.this.mLightSensorListener, AutomaticBrightnessController.this.mLightSensor, AutomaticBrightnessController.this.mNormalLightSensorRate * 1000, AutomaticBrightnessController.this.mHandler);
                            AutomaticBrightnessController.this.mSensorManager.registerListener(AutomaticBrightnessController.this.mProximitySensorListener, AutomaticBrightnessController.this.mProximitySensor, AutomaticBrightnessController.this.mNormalLightSensorRate * 1000, AutomaticBrightnessController.this.mHandler);
                        }
                    ...
                    if (DEBUG) {
                        String str = TAG;
                        StringBuilder append = new StringBuilder().append("setLightSensorEnabled     mBrightnessBoost = ");
                        OppoBrightUtils oppoBrightUtils2 = mOppoBrightUtils;
                        Slog.e(str, append.append(OppoBrightUtils.mBrightnessBoost).toString());
                    }
                    oppoBrightUtils = mOppoBrightUtils;
    ...
    /* JADX WARNING: Missing block: B:59:0x01cb, code:
            if (com.android.server.display.OppoBrightUtils.mCameraUseAdjustmentSetting != false) goto L_0x008b;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
