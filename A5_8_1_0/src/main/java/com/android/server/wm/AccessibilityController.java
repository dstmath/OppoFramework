...
final class AccessibilityController {
    ...
    private static final class DisplayMagnifier {
        ...
        private static final String FEATURE_SCREEN = "com.oppo.feature.screen.heteromorphism";
        private static final String LOG_TAG = "WindowManager";
        private static final int SCREEN_HETEROMORPHISM_HEIGHT = 80;
        private final MagnificationCallbacks mCallbacks;
        private final Context mContext;
        private boolean mForceShowMagnifiableBounds = false;
        private final Handler mHandler;
        private boolean mIsSpecialScreen;
        ...
        private final class MagnifiedViewport {
            ...
            private final class ViewportWindow {
                ...
                public ViewportWindow(Context context) {
                    ...
                    context.getTheme().resolveAttribute(16843664, new TypedValue(), true);
                    int borderColor = context.getResources().getColor(201720905);
                ...
                private void initTextPaint(Context context) {
                    this.mTextPaint.setColor(context.getResources().getColor(201720904));
                    this.mCenterY = (int) context.getResources().getDimension(201655561);
                }
                ...
                /* JADX WARNING: Missing block: B:32:0x00fa, code:
     ...
     */
                    ...
                    synchronized (DisplayMagnifier.this.mWindowManagerService.mWindowMap) {
                        try {
                            ...
                            if (this.mInvalidated) {
                                ...
                                this.mTips = this.mContext.getResources().getString(201590153);
                                try {
                                    MagnifiedViewport.this.mWindowManager.getDefaultDisplay().getRealSize(MagnifiedViewport.this.mTempPoint);
                                } catch (OutOfResourcesException e3) {
                                }
                                this.mCenterX = MagnifiedViewport.this.mTempPoint.x / 2;
                                this.mTextPaint.setTextSize(this.mContext.getResources().getDimension(201655560));
                                canvas.save();
                                StaticLayout layout = new StaticLayout(this.mTips, this.mTextPaint, MagnifiedViewport.this.mWindowManager.getDefaultDisplay().getWidth() - (this.mCenterY * 2), Alignment.ALIGN_CENTER, 1.0f, OppoBrightUtils.MIN_LUX_LIMITI, true);
                                int height = this.mCenterY;
                                if (DisplayMagnifier.this.mIsSpecialScreen) {
                                    height += 80;
                                }
                                canvas.translate((float) this.mCenterY, (float) height);
                                layout.draw(canvas);
                                canvas.restore();
            ...
            public MagnifiedViewport() {
                this.mWindowManager = (WindowManager) DisplayMagnifier.this.mContext.getSystemService(OppoProcessManager.RESUME_REASON_VISIBLE_WINDOW_STR);
            ...
            public void recomputeBoundsLocked() {
                ...
                for (int i = visibleWindows.size() - 1; i >= 0; i--) {
                    ...
                    if (windowState.mAttrs.type != 2027 && (windowState.mAttrs.privateFlags & DumpState.DUMP_DEXOPT) == 0) {
                        ...
                        if (!DisplayMagnifier.this.mWindowManagerService.mPolicy.canMagnifyWindow(windowState.mAttrs.type) || (windowState.mAttrs.getTitle().toString().contains("OPPORC") ^ 1) == 0) {
            ...
            private void populateWindowsOnScreenLocked(SparseArray<WindowState> outWindows) {
                DisplayMagnifier.this.mWindowManagerService.getDefaultDisplayContentLocked().forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 0, outWindows), false);
            }

            /* renamed from: lambda$-com_android_server_wm_AccessibilityController$DisplayMagnifier$MagnifiedViewport_31691 */
            static /* synthetic */ void m263xba8cd1c4(SparseArray outWindows, WindowState w) {
        ...
        public DisplayMagnifier(WindowManagerService windowManagerService, MagnificationCallbacks callbacks) {
            ...
            this.mIsSpecialScreen = this.mContext.getPackageManager().hasSystemFeature(FEATURE_SCREEN);
        ...
        public MagnificationSpec getMagnificationSpecForWindowLocked(WindowState windowState) {
            ...
            if (spec == null || (spec.isNop() ^ 1) == 0 || (this.mWindowManagerService.mPolicy.canMagnifyWindow(windowState.mAttrs.type) && !windowState.mAttrs.getTitle().toString().contains("OPPORC"))) {
                return spec;
            }
            return null;
        }
     ...
     */
            ...
            synchronized (this.mWindowManagerService.mWindowMap) {
                try {
                    ...
                    if (this.mWindowManagerService.mCurrentFocus == null) {
                        ...
                        Rect boundsInScreen;
                        WindowInfo window;
                        ((WindowManager) this.mContext.getSystemService(OppoProcessManager.RESUME_REASON_VISIBLE_WINDOW_STR)).getDefaultDisplay().getRealSize(this.mTempPoint);
                        int screenWidth = this.mTempPoint.x;
                        int screenHeight = this.mTempPoint.y;
        ...
        private void populateVisibleWindowsOnScreenLocked(SparseArray<WindowState> outWindows) {
            this.mWindowManagerService.getDefaultDisplayContentLocked().forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 1, outWindows), false);
        }

        /* renamed from: lambda$-com_android_server_wm_AccessibilityController$WindowsForAccessibilityObserver_63762 */
        static /* synthetic */ void m264x5704f50(SparseArray outWindows, WindowState w) {
            if (w.isVisibleLw()) {
                outWindows.put(w.mLayer, w);
            }
        }
    ...
    private static void populateTransformationMatrixLocked(WindowState windowState, Matrix outMatrix) {
        ...
        sTempFloats[6] = OppoBrightUtils.MIN_LUX_LIMITI;
        sTempFloats[7] = OppoBrightUtils.MIN_LUX_LIMITI;
        sTempFloats[8] = 1.0f;
