...
class WindowStateAnimator {
    ...
    void cancelExitAnimationForNextAnimationLocked() {
        ...
        if (this.mAnimation != null) {
            ...
            if (DEBUG_ANIM || WindowManagerDebugConfig.DEBUG_WMS) {
    ...
    boolean finishDrawingLocked() {
        ...
        if (DEBUG_SURFACE_TRACE || DEBUG_ANIM || SHOW_TRANSACTIONS || DEBUG_ORIENTATION || WindowManagerDebugConfig.DEBUG_WMS) {
