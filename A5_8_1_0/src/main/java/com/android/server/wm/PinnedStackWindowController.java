...
public class PinnedStackWindowController extends StackWindowController {
    ...
    /* renamed from: lambda$-com_android_server_wm_PinnedStackWindowController_5117 */
    /* synthetic */ void m51lambda$-com_android_server_wm_PinnedStackWindowController_5117(Rect fromBounds, Rect finalToBounds, int animationDuration, int finalSchedulePipModeChangedState, boolean fromFullscreen, boolean toFullscreen) {
        if (this.mContainer != null) {
