...
public class MediaSessionRecord implements DeathRecipient {
     ...
     */
        ...
        public ParceledListSlice getQueue() {
            ParceledListSlice -get19;
            synchronized (MediaSessionRecord.this.mLock) {
                -get19 = MediaSessionRecord.this.mQueue;
            }
            return -get19;
        }
    ...
    class SessionCb {
        ...
        public boolean sendMediaButton(KeyEvent keyEvent, int sequenceId, ResultReceiver cb) {
            ...
            try {
                Log.d(MediaSessionRecord.TAG, "sendMediaButton() keyEvent = " + keyEvent);
        ...
        public void prepare() {
            try {
                Log.d(MediaSessionRecord.TAG, "prepare()");
                this.mCb.onPrepare();
            } catch (RemoteException e) {
        ...
        public void play() {
            try {
                Log.d(MediaSessionRecord.TAG, "play()");
                this.mCb.onPlay();
            } catch (RemoteException e) {
        ...
        public void pause() {
            try {
                Log.d(MediaSessionRecord.TAG, "pause()");
                this.mCb.onPause();
            } catch (RemoteException e) {
        ...
        public void stop() {
            try {
                Log.d(MediaSessionRecord.TAG, "stop()");
                this.mCb.onStop();
            } catch (RemoteException e) {
        ...
        public void next() {
            try {
                Log.d(MediaSessionRecord.TAG, "next()");
                this.mCb.onNext();
            } catch (RemoteException e) {
        ...
        public void previous() {
            try {
                Log.d(MediaSessionRecord.TAG, "previous()");
                this.mCb.onPrevious();
            } catch (RemoteException e) {
        ...
        public void fastForward() {
            try {
                Log.d(MediaSessionRecord.TAG, "fastForward()");
        ...
        public void rewind() {
            try {
                Log.d(MediaSessionRecord.TAG, "rewind()");
                this.mCb.onRewind();
            } catch (RemoteException e) {
        ...
        public void seekTo(long pos) {
            try {
                Log.d(MediaSessionRecord.TAG, "seekTo() pos = " + pos);
        ...
        public void adjustVolume(int direction) {
            try {
                Log.d(MediaSessionRecord.TAG, "adjustVolume() direction = " + direction);
        ...
        public void setVolumeTo(int value) {
            try {
                Log.d(MediaSessionRecord.TAG, "setVolumeTo() value = " + value);
