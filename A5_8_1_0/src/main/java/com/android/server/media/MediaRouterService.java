                ...
                public void dispatchAudioRoutesChanged(AudioRoutesInfo newRoutes) {
                    ...
                    synchronized (MediaRouterService.this.mLock) {
                        ...
                        if (!TextUtils.equals(newRoutes.bluetoothName, MediaRouterService.this.mCurAudioRoutesInfo.bluetoothName)) {
                            ...
                            Log.d(MediaRouterService.TAG, "mGlobalBluetoothA2dpOn=" + MediaRouterService.this.mGlobalBluetoothA2dpOn + ", newRoutes.bluetoothName=" + newRoutes.bluetoothName + ", mCurAudioRoutesInfo.bluetoothName" + MediaRouterService.this.mCurAudioRoutesInfo.bluetoothName);
                            if (MediaRouterService.this.mGlobalBluetoothA2dpOn) {
                                try {
                                    MediaRouterService.this.mAudioService.setBluetoothA2dpOn(MediaRouterService.this.mGlobalBluetoothA2dpOn);
                                } catch (RemoteException e) {
                                    Slog.w(MediaRouterService.TAG, "RemoteException while calling setBluetoothA2dpOn.");
                                }
                            }
