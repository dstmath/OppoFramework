...
public class VrManagerService extends SystemService implements EnabledComponentChangeListener {
    ...
    private void updateVrModeAllowedLocked() {
        boolean allowed = this.mSystemSleepFlags == 7 ? this.mUserUnlocked : false;
    ...
    /* JADX WARNING: Missing block: B:27:0x00cd, code:
            if ((java.util.Objects.equals(r26, r20.mCurrentVrModeComponent) ^ 1) == 0) goto L_0x00cf;
     */
    /* JADX WARNING: Missing block: B:29:0x00d9, code:
            if (r20.mRunning2dInVr != r22) goto L_0x00db;
     */
    /* JADX WARNING: Missing block: B:30:0x00db, code:
            r15 = true;
     */
    /* JADX WARNING: Missing block: B:31:0x00dc, code:
            r20.mCurrentVrModeComponent = r26;
            r20.mRunning2dInVr = r22;
            r20.mVrAppProcessId = r25;
     */
    /* JADX WARNING: Missing block: B:32:0x00f8, code:
            if (r20.mCurrentVrModeUser == r24) goto L_0x0101;
     */
    /* JADX WARNING: Missing block: B:33:0x00fa, code:
            r20.mCurrentVrModeUser = r24;
            r15 = true;
     */
    /* JADX WARNING: Missing block: B:35:0x0107, code:
            if (r20.mCurrentVrService == null) goto L_0x01e1;
     */
    /* JADX WARNING: Missing block: B:36:0x0109, code:
            r10 = r20.mCurrentVrService.getComponent().getPackageName();
     */
    /* JADX WARNING: Missing block: B:37:0x0117, code:
            updateDependentAppOpsLocked(r10, r20.mCurrentVrModeUser, r13, r12);
     */
    /* JADX WARNING: Missing block: B:38:0x0126, code:
            if (r20.mCurrentVrService == null) goto L_0x0148;
     */
    /* JADX WARNING: Missing block: B:39:0x0128, code:
            if (r15 == false) goto L_0x0148;
     */
    /* JADX WARNING: Missing block: B:40:0x012a, code:
            r5 = r20.mCurrentVrModeComponent;
            r4 = r22;
            r14 = r25;
            r2 = r22;
            r3 = r25;
            r20.mCurrentVrService.sendEvent(new com.android.server.vr.VrManagerService.AnonymousClass6(r20));
     */
    /* JADX WARNING: Missing block: B:41:0x0148, code:
            if (r11 != false) goto L_0x014d;
     */
    /* JADX WARNING: Missing block: B:42:0x014a, code:
            logStateLocked();
     */
    /* JADX WARNING: Missing block: B:43:0x014d, code:
            android.os.Binder.restoreCallingIdentity(r8);
     */
    /* JADX WARNING: Missing block: B:44:0x0150, code:
            return r16;
     */
    /* JADX WARNING: Missing block: B:56:0x01e1, code:
            r10 = null;
     */
    ...
    private ManagedApplicationService createVrListenerService(ComponentName component, int userId) {
        ...
        return ManagedApplicationService.build(this.mContext, component, userId, 17041064, "android.settings.VR_LISTENER_SETTINGS", sBinderChecker, true, retryType, this.mHandler, this.mEventCallback);
    }
    ...
    private void setVrMode(boolean enabled, ComponentName targetPackageName, int userId, int processId, ComponentName callingPackage) {
        synchronized (this.mLock) {
            ...
            boolean running2dInVr = !enabled ? this.mPersistentVrModeEnabled : false;
            if (running2dInVr) {
