...
public class DiskStatsService extends Binder {
    ...
    private void reportFreeSpace(File path, String name, PrintWriter pw, ProtoOutputStream proto, int folderType) {
        try {
            ...
            if (proto != null) {
                ...
                proto.write(1116691496962L, (avail * bsize) / OppoDeviceStorageMonitorService.KB_BYTES);
                proto.write(1116691496963L, (total * bsize) / OppoDeviceStorageMonitorService.KB_BYTES);
                proto.end(freeSpaceToken);
            } else {
                pw.print(name);
                pw.print("-Free: ");
                pw.print((avail * bsize) / OppoDeviceStorageMonitorService.KB_BYTES);
                pw.print("K / ");
                pw.print((total * bsize) / OppoDeviceStorageMonitorService.KB_BYTES);
                pw.print("K total = ");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:2:0x00dd A:{Splitter: B:0:0x0000, ExcHandler: java.io.IOException (r0_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:2:0x00dd, code:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:3:0x00de, code:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:12:0x019f A:{Splitter: B:0:0x0000, ExcHandler: java.io.IOException (r9_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:12:0x019f, code:
            r9 = move-exception;
     */
    /* JADX WARNING: Missing block: B:13:0x01a0, code:
            android.util.Log.w(TAG, "exception reading diskstats cache file", r9);
     */
    ...
    private void reportCachedValuesProto(ProtoOutputStream proto) {
        try {
            ...
            proto.write(1116691496970L, json.getLong(DiskStatsFileLogger.APP_DATA_SIZE_AGG_KEY));
            ...
            if (len == appSizesArray.length() && len == appDataSizesArray.length() && len == cacheSizesArray.length()) {
                for (int i = 0; i < len; i++) {
                    ...
                    proto.write(1116691496964L, appDataSizesArray.getLong(i));
