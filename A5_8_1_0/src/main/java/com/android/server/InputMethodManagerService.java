...
public class InputMethodManagerService extends Stub implements ServiceConnection, Callback {
    ...
    static boolean DEBUG = SystemProperties.getBoolean(PROP_IMELOG, false);
    static boolean DEBUG_IME_ACTIVE = false;
    static boolean DEBUG_IME_ACTIVE_LIGHT = true;
    static boolean DEBUG_RESTORE = false;
    static boolean DEBUG_SHOW_SOFTINPUT = true;
    ...
    private static class ImeSubtypeListAdapter extends ArrayAdapter<ImeSubtypeListItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RadioButton radioButton = (RadioButton) view.findViewById(16909189);
    ...
    public InputMethodManagerService(Context context) {
        ...
        this.mSlotIme = this.mContext.getString(17040910);
    ...
    public void systemRunning(StatusBarManagerService statusBar) {
        synchronized (this.mMethodMap) {
            ...
            if (!this.mSystemReady) {
                ...
                this.mShowOngoingImeSwitcherForPhones = this.mRes.getBoolean(17957093);
    ...
    InputBindResult startInputInnerLocked() {
        ...
        if (this.mSystemReady) {
            ...
            this.mCurIntent.putExtra("android.intent.extra.client_label", 17040051);
    ...
    /* JADX WARNING: Missing block: B:23:0x0097, code:
            return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onServiceConnected(ComponentName name, IBinder service) {
    ...
    private void updateSystemUiLocked(IBinder token, int vis, int backDisposition) {
        if (calledWithValidToken(token)) {
            ...
            if (imi != null && needsToShowImeSwitcher) {
                CharSequence title = this.mRes.getText(17040826);
    ...
    private InputBindResult windowGainedFocus(int startInputReason, IInputMethodClient client, IBinder windowToken, int controlFlags, int softInputMode, int windowFlags, EditorInfo attribute, IInputContext inputContext, int missingMethods) {
        ...
        try {
            synchronized (this.mMethodMap) {
                if (DEBUG) {
                    Slog.v(TAG, "windowGainedFocus: reason=" + InputMethodClient.getStartInputReason(startInputReason) + " client=" + client.asBinder() + " inputContext=" + inputContext + " missingMethods=" + InputConnectionInspector.getMissingMethodFlagsAsString(missingMethods) + " attribute=" + attribute + " controlFlags=#" + Integer.toHexString(controlFlags) + " softInputMode=" + InputMethodClient.softInputModeToString(softInputMode) + " windowFlags=#" + Integer.toHexString(windowFlags));
                }
                ClientState cs = (ClientState) this.mClients.get(client.asBinder());
                if (cs == null) {
                    throw new IllegalArgumentException("unknown client " + client.asBinder());
    ...
    void buildInputMethodListLocked(boolean resetDefaultEnabledIme) {
        ...
        if (this.mSystemReady) {
            ...
            List<ResolveInfo> services = pm.queryIntentServicesAsUser(new Intent("android.view.InputMethod"), 1073774720, this.mSettings.getCurrentUserId());
            ...
            for (i = 0; i < services.size(); i++) {
                ...
                if ("android.permission.BIND_INPUT_METHOD".equals(si.permission)) {
                    ...
                    try {
                        ...
                        if (DEBUG) {
                            Slog.d(TAG, "Found an input method " + inputMethodInfo);
                        }
                    } catch (Exception e) {
            ...
            if (resetDefaultEnabledIme) {
                ...
                for (i = 0; i < N; i++) {
                    InputMethodInfo imi = (InputMethodInfo) defaultEnabledIme.get(i);
                    if (DEBUG) {
    ...
    /* JADX WARNING: Missing block: B:14:0x0084, code:
            return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void showInputMethodMenu(boolean showAuxSubtypes) {
        ...
        synchronized (this.mMethodMap) {
            ...
            if (immis == null || immis.size() == 0) {
                ...
                this.mDialogBuilder = new Builder(new ContextThemeWrapper(ActivityThread.currentActivityThread().getSystemUiContext(), 201523202));
                ...
                this.mSwitchingDialogTitleView.findViewById(16908919).setVisibility(this.mWindowManagerInternal.isHardKeyboardAvailable() ? 0 : 8);
                Switch hardKeySwitch = (Switch) this.mSwitchingDialogTitleView.findViewById(16908920);
            ...
            return;
     */
                    /* JADX WARNING: Missing block: B:39:0x00d5, code:
            return;
     */
                    /* Code decompiled incorrectly, please refer to instructions dump. */
                                ...
                                if (InputMethodManagerService.this.mSubtypeIds != null && InputMethodManagerService.this.mSubtypeIds.length > which) {
                                    ...
                                    if (im != null) {
                                        ...
                                        if (!(im.getPackageName() == null || serviceInfo == null || serviceInfo.applicationInfo == null)) {
                                            ...
                                            if (appInfo.oppoFreezeState == 2 || appInfo.oppoFreezeState == 1) {
                                                long callingId = Binder.clearCallingIdentity();
                                                try {
                                                    InputMethodManagerService.this.mIPackageManager.oppoUnFreezePackage(im.getPackageName(), 0, 1, 0, "android");
                                                } catch (RemoteException e) {
                                                    Slog.e(InputMethodManagerService.TAG, "Failed to undis " + im.getPackageName() + " for set default inputmethod");
                                                } catch (Throwable th) {
                                                    Binder.restoreCallingIdentity(callingId);
                                                }
                                                Slog.i(InputMethodManagerService.TAG, "oppo-undis " + im.getPackageName() + " for set default inputmethod");
                                                Binder.restoreCallingIdentity(callingId);
                                            }
                                        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x0377 A:{Splitter: B:26:0x032d, ExcHandler: java.io.IOException (r5_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x0397 A:{Splitter: B:31:0x0357, ExcHandler: java.io.IOException (r5_1 'e' java.lang.Exception)} */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x03b0 A:{Splitter: B:36:0x036d, ExcHandler: java.io.IOException (r5_2 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:39:0x0377, code:
            r5 = move-exception;
     */
    /* JADX WARNING: Missing block: B:40:0x0378, code:
            r10.println("Failed to dump input method client: " + r5);
     */
    /* JADX WARNING: Missing block: B:42:0x0397, code:
            r5 = move-exception;
     */
    /* JADX WARNING: Missing block: B:43:0x0398, code:
            r10.println("Failed to dump input method client in focused window: " + r5);
     */
    /* JADX WARNING: Missing block: B:44:0x03b0, code:
            r5 = move-exception;
     */
    /* JADX WARNING: Missing block: B:45:0x03b1, code:
            r10.println("Failed to dump input method service: " + r5);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, pw) && !dynamicallyConfigImeLogTag(fd, pw, args)) {
            ClientState client;
