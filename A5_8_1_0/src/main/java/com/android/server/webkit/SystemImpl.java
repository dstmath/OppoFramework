...
public class SystemImpl implements SystemInterface {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x0056 A:{PHI: r11 , Splitter: B:1:0x000c, ExcHandler: org.xmlpull.v1.XmlPullParserException (r6_0 'e' java.lang.Exception)} */
    ...
    private SystemImpl() {
        ...
        try {
            parser = AppGlobals.getInitialApplication().getResources().getXml(18284549);
