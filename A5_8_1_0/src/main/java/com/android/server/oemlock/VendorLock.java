...
class VendorLock extends OemLock {
    ...
    /* renamed from: lambda$-com_android_server_oemlock_VendorLock_2991 */
    static /* synthetic */ void m186lambda$-com_android_server_oemlock_VendorLock_2991(Integer[] requestStatus, Boolean[] allowedByCarrier, int status, boolean allowed) {
    ...
    /* renamed from: lambda$-com_android_server_oemlock_VendorLock_4760 */
    static /* synthetic */ void m187lambda$-com_android_server_oemlock_VendorLock_4760(Integer[] requestStatus, Boolean[] allowedByDevice, int status, boolean allowed) {
        requestStatus[0] = Integer.valueOf(status);
