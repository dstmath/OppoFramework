...
final class PackageTrackerHelperImpl implements ClockHelper, ConfigHelper, PackageManagerHelper {
    ...
    public boolean isTrackingEnabled() {
        return this.mContext.getResources().getBoolean(17957043);
    }

    public String getUpdateAppPackageName() {
        return this.mContext.getResources().getString(17039711);
    }

    public String getDataAppPackageName() {
        return this.mContext.getResources().getString(17039710);
    }

    public int getCheckTimeAllowedMillis() {
        return this.mContext.getResources().getInteger(17694864);
    }

    public int getFailedCheckRetryCount() {
        return this.mContext.getResources().getInteger(17694863);
    }
