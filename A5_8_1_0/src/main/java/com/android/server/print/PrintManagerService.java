...
public final class PrintManagerService extends SystemService {
     ...
     */
        ...
        private int resolveCallingAppEnforcingPermissions(int appId) {
            ...
            if (appId == callingAppId || callingAppId == OppoArpPeer.ARP_FIRST_RESPONSE_TIMEOUT || callingAppId == 1000 || this.mContext.checkCallingPermission("com.android.printspooler.permission.ACCESS_ALL_PRINT_JOBS") == 0) {
                return appId;
            }
