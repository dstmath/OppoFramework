...
public final class NotificationRecord {
    ...
    private Light calculateLights() {
        ...
        if ((this.sbn.getNotification().flags & 1) != 0) {
    ...
    private long[] calculateVibration() {
        long[] defaultVibration = NotificationManagerService.getLongArray(this.mContext.getResources(), 17235998, 17, NotificationManagerService.DEFAULT_VIBRATE_PATTERN);
        long[] vibration = (this.mPreChannelsNotification || !getChannel().shouldVibrate()) ? null : getChannel().getVibrationPattern() == null ? defaultVibration : getChannel().getVibrationPattern();
        if (!this.mPreChannelsNotification) {
            return vibration;
        }
    ...
    private int calculateImportance() {
        ...
        if (this.mPreChannelsNotification && (importance == JobSchedulerShellCommand.CMD_ERR_NO_PACKAGE || (getChannel().getUserLockedFields() & 4) == 0)) {
    ...
    public void copyRankingInformation(NotificationRecord previous) {
        ...
        if (previous.sbn.getOverrideGroupKey() != null && (this.sbn.isAppGroup() ^ 1) != 0) {
    ...
    private String getUserExplanation() {
        if (this.mUserExplanation == null) {
            this.mUserExplanation = this.mContext.getResources().getString(17040049);
        }
    ...
    private String getPeopleExplanation() {
        if (this.mPeopleExplanation == null) {
            this.mPeopleExplanation = this.mContext.getResources().getString(17040048);
        }
