...
public final class DreamManagerService extends SystemService {
    ...
    private void startDreamLocked(ComponentName name, boolean isTest, boolean canDoze, int userId) {
        ...
        } else if (this.mContext.getPackageManager().isClosedSuperFirewall() || name == null || !OppoFreeFormManagerService.FREEFORM_CALLER_PKG.equals(name.getPackageName())) {
    ...
    /* renamed from: lambda$-com_android_server_dreams_DreamManagerService_15097 */
    /* synthetic */ void m169lambda$-com_android_server_dreams_DreamManagerService_15097(Binder newToken, ComponentName name, boolean isTest, boolean canDoze, int userId, WakeLock wakeLock) {
