        ...
        try {
            ...
            try {
                if (this.mContext.bindServiceAsUser(intent, this.mCurrentDream, 67108865, new UserHandle(userId))) {
                    ...
                    this.mHandler.postDelayed(this.mStopUnconnectedDreamRunnable, FaceDaemonWrapper.TIMEOUT_FACED_BINDERCALL_CHECK);
            ...
            if (!immediate) {
                if (this.mCurrentDream.mWakingGently) {
                    ...
                    try {
                        ...
                        this.mHandler.postDelayed(this.mStopStubbornDreamRunnable, FaceDaemonWrapper.TIMEOUT_FACED_BINDERCALL_CHECK);
                        Trace.traceEnd(131072);
                        return;
