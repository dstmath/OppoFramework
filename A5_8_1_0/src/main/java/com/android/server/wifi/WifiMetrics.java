...
public class WifiMetrics {
    ...
    private static final /* synthetic */ int[] f182-android-net-wifi-SupplicantStateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m95-getandroid-net-wifi-SupplicantStateSwitchesValues() {
        if (f182-android-net-wifi-SupplicantStateSwitchesValues != null) {
            return f182-android-net-wifi-SupplicantStateSwitchesValues;
        }
        ...
        f182-android-net-wifi-SupplicantStateSwitchesValues = iArr;
        return iArr;
    }
                ...
                if (this.mPasspointManager != null) {
                    ...
                    if (isFullBand) {
                            ...
                            if (!this.mWifiNetworkSelector.isSignalTooWeak(scanResult)) {
                                ...
                                if (networkDetail.isInterworking()) {
                                    ...
                                    if (validBssid) {
                                        ...
                                        Integer countObj;
                                        if (networkDetail.getHSRelease() == HSRelease.R1) {
                                            countObj = (Integer) passpointR1UniqueEss.get(uniqueEss);
                                            passpointR1UniqueEss.put(uniqueEss, Integer.valueOf((countObj == null ? 0 : countObj.intValue()) + 1));
                                        } else if (networkDetail.getHSRelease() == HSRelease.R2) {
                                            countObj = (Integer) passpointR2UniqueEss.get(uniqueEss);
                                            passpointR2UniqueEss.put(uniqueEss, Integer.valueOf((countObj == null ? 0 : countObj.intValue()) + 1));
                                        }
                                    }
                                }
                                ssids.add(matchInfo);
                        ...
                        for (Integer count : passpointR1UniqueEss.values()) {
                            incrementPasspointPerUniqueEss(this.mObservedHotspotR1ApsPerEssInScanHistogram, count.intValue());
                        }
                        for (Integer count2 : passpointR2UniqueEss.values()) {
                            incrementPasspointPerUniqueEss(this.mObservedHotspotR2ApsPerEssInScanHistogram, count2.intValue());
                        }
                        return;
                    }
                    wifiLog = this.mWifiLogProto;
    ...
    private void consolidateProto(boolean incremental) {
        ...
        synchronized (this.mLock) {
            ...
            ConnectToNetworkNotificationAndActionCount keyVal2;
            for (ConnectionEvent event : this.mConnectionEventList) {
            ...
            for (i = 0; i < this.mWifiAlertReasonCounts.size(); i++) {
                ...
                keyVal3.reason = this.mWifiAlertReasonCounts.keyAt(i);
                keyVal3.count = this.mWifiAlertReasonCounts.valueAt(i);
            ...
            for (i = 0; i < this.mConnectToNetworkNotificationCount.size(); i++) {
                keyVal2 = new ConnectToNetworkNotificationAndActionCount();
                keyVal2.notification = this.mConnectToNetworkNotificationCount.keyAt(i);
                keyVal2.recommender = 1;
                keyVal2.count = this.mConnectToNetworkNotificationCount.valueAt(i);
                notificationCountArray[i] = keyVal2;
            }
            ...
            for (i = 0; i < this.mConnectToNetworkNotificationActionCount.size(); i++) {
                ...
                keyVal2.notification = key / 1000;
                keyVal2.action = key % 1000;
                keyVal2.recommender = 1;
                keyVal2.count = this.mConnectToNetworkNotificationActionCount.valueAt(i);
                notificationActionCountArray[i] = keyVal2;
            }
    ...
    public static int supplicantStateToBit(SupplicantState state) {
        switch (m95-getandroid-net-wifi-SupplicantStateSwitchesValues()[state.ordinal()]) {
            case 1:
                return 64;
            case 2:
                return 32;
