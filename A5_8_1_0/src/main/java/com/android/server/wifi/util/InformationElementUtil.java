...
public class InformationElementUtil {
    ...
    public static class Capabilities {
        ...
        private static final short WAPI_VERSION = (short) 1;
        private static final int WPA2_AKM_EAP = 28053248;
        private static final int WPA2_AKM_EAP_SHA256 = 95162112;
        private static final int WPA2_AKM_FILS_SHA256 = 246157056;
        private static final int WPA2_AKM_FILS_SHA384 = 262934272;
                    ...
                    for (i = (short) 0; i < akmCount; i++) {
                        switch (buf.getInt()) {
                            ...
                            case WPA2_AKM_PSK_SHA256 /*111939328*/:
                                ...
                                break;
                            case WPA2_AKM_FILS_SHA256 /*246157056*/:
                                rsnKeyManagement.add(Integer.valueOf(8));
                                break;
                            case WPA2_AKM_FILS_SHA384 /*262934272*/:
                                rsnKeyManagement.add(Integer.valueOf(9));
                                break;
                            default:
                                break;
                        }
        ...
        private void parseWapiElement(InformationElement ie) {
            ...
            try {
                ...
                for (i = (short) 0; i < akmCount; i++) {
                    ...
                    switch (akm) {
                        case 24253440:
                            wapiKeyManagement.add(Integer.valueOf(11));
                            break;
                        case WAPI_AKM_PSK /*41030656*/:
                            wapiKeyManagement.add(Integer.valueOf(10));
                            break;
                        default:
                            Log.w("IE_Capabilities", "Unknown WAPI AKM: " + Integer.toHexString(akm));
                            break;
                    }
                }
                boolean isEmpty = wapiKeyManagement.isEmpty();
                this.keyManagement.add(wapiKeyManagement);
                short cipherCount = buf.getShort();
                ArrayList<Integer> wapiPairwiseCipher = new ArrayList();
                for (i = (short) 0; i < cipherCount; i++) {
                    wapiPairwiseCipher.add(Integer.valueOf(parseWapiCipher(buf.getInt())));
                }
                this.pairwiseCipher.add(wapiPairwiseCipher);
                this.groupCipher.add(Integer.valueOf(parseWapiCipher(buf.getInt())));
            } catch (BufferUnderflowException e) {
        ...
        private static int parseWapiCipher(int cipher) {
            switch (cipher) {
                case 24253440:
                    return 4;
                default:
                    Log.w("IE_Capabilities", "Unknown WAPI cipher suite: " + Integer.toHexString(cipher));
                    return 0;
            }
        }
