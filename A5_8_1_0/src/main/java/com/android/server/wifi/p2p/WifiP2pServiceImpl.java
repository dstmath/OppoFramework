...
public class WifiP2pServiceImpl extends Stub {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pServiceImpl.IPM_PROVISIONING_SUCCESS /*143393*/:
                        ...
                        try {
                            ...
                            P2pStateMachine.this.loge("IllegalStateException maybe group is removed " + e3);
                            break;
                        }
                        break;
                    case WifiP2pServiceImpl.IPM_PROVISIONING_FAILURE /*143394*/:
                    ...
                    case 139271:
                        ...
                        if (WifiP2pServiceImpl.this.mP2pConnectFreq != 0) {
                            ...
                            if (config.wps.setup != 0) {
                                P2pStateMachine.this.logd("Force wps=" + config.wps.setup + " to pbc ");
                                config.wps.setup = 0;
                            }
                            if (WifiP2pServiceImpl.DBG) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_WifiP2pServiceImpl_23003 */
    /* synthetic */ void m106lambda$-com_android_server_wifi_p2p_WifiP2pServiceImpl_23003(IBinder binder) {
        if (DBG) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_WifiP2pServiceImpl_23835 */
    /* synthetic */ void m107lambda$-com_android_server_wifi_p2p_WifiP2pServiceImpl_23835() {
        if (DBG) {
    ...
    public void setNfcTriggered(boolean enable) {
        ...
        if (enable) {
            ...
            WifiConnectivityManager.setPeriodicScanIntervalMs(enable);
            wifiP2pNative.setP2pSsidPostfix("-" + getSsidPostfix(this.mThisDevice.deviceName));
        }
    ...
    public void setMiracastMode(int mode) {
        ...
        if (this.mWifiChannel != null) {
            this.mWifiChannel.sendMessage(SET_MIRACAST_MODE, mode);
        } else {
