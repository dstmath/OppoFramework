...
public class WifiP2pNative {
    ...
    public boolean p2pFind(int timeout, int freq) {
        return this.mSupplicantP2pIfaceHal.find(timeout, freq);
    }
    ...
    public String p2pConnect(WifiP2pConfig config, boolean joinExistingGroup, int freq) {
        return this.mSupplicantP2pIfaceHal.connect(config, joinExistingGroup, freq);
    }
    ...
    public void setP2pChannelSetAt5G() {
        this.mSupplicantP2pIfaceHal.setP2pChannel(1, 149);
    }

    public int addNetwork() {
        return this.mSupplicantP2pIfaceHal.addP2pNetwork();
    }

    public boolean setNetworkVariable(int netId, String name, String value) {
        return this.mSupplicantP2pIfaceHal.setNetworkVariable(netId, name, value);
    }
}
