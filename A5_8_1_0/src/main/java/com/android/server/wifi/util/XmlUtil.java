...
public class XmlUtil {
    ...
    public static class IpConfigurationXmlUtil {
        ...
        private static final /* synthetic */ int[] f179-android-net-IpConfiguration$IpAssignmentSwitchesValues = null;
        /* renamed from: -android-net-IpConfiguration$ProxySettingsSwitchesValues */
        private static final /* synthetic */ int[] f180-android-net-IpConfiguration$ProxySettingsSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m57-getandroid-net-IpConfiguration$IpAssignmentSwitchesValues() {
            if (f179-android-net-IpConfiguration$IpAssignmentSwitchesValues != null) {
                return f179-android-net-IpConfiguration$IpAssignmentSwitchesValues;
            }
            ...
            f179-android-net-IpConfiguration$IpAssignmentSwitchesValues = iArr;
            return iArr;
        }

        /* renamed from: -getandroid-net-IpConfiguration$ProxySettingsSwitchesValues */
        private static /* synthetic */ int[] m58-getandroid-net-IpConfiguration$ProxySettingsSwitchesValues() {
            if (f180-android-net-IpConfiguration$ProxySettingsSwitchesValues != null) {
                return f180-android-net-IpConfiguration$ProxySettingsSwitchesValues;
            }
            ...
            f180-android-net-IpConfiguration$ProxySettingsSwitchesValues = iArr;
            return iArr;
        }
        ...
        public static void writeToXml(XmlSerializer out, IpConfiguration ipConfiguration) throws XmlPullParserException, IOException {
            ...
            switch (m57-getandroid-net-IpConfiguration$IpAssignmentSwitchesValues()[ipConfiguration.ipAssignment.ordinal()]) {
                case 2:
            ...
            switch (m58-getandroid-net-IpConfiguration$ProxySettingsSwitchesValues()[ipConfiguration.proxySettings.ordinal()]) {
                case 2:
        ...
        public static IpConfiguration parseFromXml(XmlPullParser in, int outerTagDepth) throws XmlPullParserException, IOException {
            ...
            switch (m57-getandroid-net-IpConfiguration$IpAssignmentSwitchesValues()[ipAssignment.ordinal()]) {
                case 1:
                case 3:
                    break;
                case 2:
            ...
            switch (m58-getandroid-net-IpConfiguration$ProxySettingsSwitchesValues()[proxySettings.ordinal()]) {
                case 1:
                case 4:
                    break;
                case 2:
    ...
    public static class WifiConfigurationXmlUtil {
        ...
        public static Pair<String, WifiConfiguration> parseFromXml(XmlPullParser in, int outerTagDepth) throws XmlPullParserException, IOException {
            BitSet allowedKeyMgmts;
            WifiConfiguration configuration = new WifiConfiguration();
            String configKeyInData = null;
            String mAliases = null;
            while (!XmlUtil.isNextSectionEnd(in, outerTagDepth)) {
                String[] valueName = new String[1];
                String value = XmlUtil.readCurrentValue(in, valueName);
                if (valueName[0] == null) {
                ...
                } else if (str.equals(XML_TAG_SHARE_THIS_AP)) {
                    configuration.shareThisAp = ((Boolean) value).booleanValue();
                ...
                } else if (str.equals(XML_TAG_WAPI_PSK_TYPE)) {
                    configuration.wapiPskType = ((Integer) value).intValue();
                } else if (str.equals(XML_TAG_WAPI_PSK)) {
                    configuration.wapiPsk = value;
                } else if (str.equals(XML_TAG_WAPI_CERT_SEL_MODE)) {
                    configuration.wapiCertSelMode = ((Integer) value).intValue();
                } else if (str.equals(XML_TAG_WAPI_CERT_SEL)) {
                    configuration.wapiCertSel = value;
                ...
                } else if (str.equals(XML_TAG_LAST_CONNECTED)) {
                    configuration.lastConnected = ((Long) value).longValue();
                } else if (!str.equals(XML_TAG_SIM_SLOT)) {
            ...
            if (configKeyInData != null && configKeyInData.endsWith("WAPI_PSK")) {
                if (configuration.allowedKeyManagement.nextSetBit(0) != 190) {
                    allowedKeyMgmts = new BitSet(WifiConfigManager.SCAN_CACHE_ENTRIES_MAX_SIZE);
                    allowedKeyMgmts.set(190);
                    configuration.allowedKeyManagement = allowedKeyMgmts;
                }
                if (configuration.preSharedKey != null) {
                    configuration.allowedProtocols = BitSet.valueOf(new byte[]{(byte) 11});
                    if (configuration.preSharedKey.startsWith("\"") && configuration.preSharedKey.endsWith("\"")) {
                        configuration.wapiPskType = 0;
                        configuration.wapiPsk = configuration.preSharedKey;
                    } else {
                        configuration.wapiPskType = 1;
                        configuration.wapiPsk = "\"" + configuration.preSharedKey + "\"";
                    }
            ...
            if (configKeyInData != null && configKeyInData.endsWith("WAPI_CERT")) {
                if (configuration.allowedKeyManagement.nextSetBit(0) != 191) {
                    allowedKeyMgmts = new BitSet(WifiConfigManager.SCAN_CACHE_ENTRIES_MAX_SIZE);
                    allowedKeyMgmts.set(191);
                    configuration.allowedKeyManagement = allowedKeyMgmts;
                }
                if (configuration.wapiCertSel == null && mAliases != null) {
                    configuration.allowedProtocols = BitSet.valueOf(new byte[]{(byte) 11});
                    configuration.wapiCertSelMode = 1;
                    configuration.wapiCertSel = mAliases;
                }
            }
    ...
    public static class WifiEnterpriseConfigXmlUtil {
        ...
        public static WifiEnterpriseConfig parseFromXml(XmlPullParser in, int outerTagDepth) throws XmlPullParserException, IOException {
            ...
            while (!XmlUtil.isNextSectionEnd(in, outerTagDepth)) {
                ...
                } else if (str.equals(XML_TAG_SIMNUM)) {
                    int sim_num;
                    try {
