...
public class ANQPParser {
    /* renamed from: -com-android-server-wifi-hotspot2-anqp-Constants$ANQPElementTypeSwitchesValues */
    private static final /* synthetic */ int[] f186xab943a9d = null;
    public static final int VENDOR_SPECIFIC_HS20_OI = 5271450;
    public static final int VENDOR_SPECIFIC_HS20_TYPE = 17;

    /* renamed from: -getcom-android-server-wifi-hotspot2-anqp-Constants$ANQPElementTypeSwitchesValues */
    private static /* synthetic */ int[] m99x30553c41() {
        if (f186xab943a9d != null) {
            return f186xab943a9d;
        }
    ...
    public static ANQPElement parseElement(ANQPElementType infoID, ByteBuffer payload) throws ProtocolException {
        switch (m99x30553c41()[infoID.ordinal()]) {
            case 1:
