...
final /* synthetic */ class -$Lambda$2ItOdD6JCrqoTLRQamUOtCfYAAM implements Callback {
    ...
    final /* synthetic */ class AnonymousClass1 implements Runnable {
        ...
        private final /* synthetic */ void $m$0() {
            ((OpenNetworkNotifier) this.f1-$f0).m26lambda$-com_android_server_wifi_OpenNetworkNotifier_16544();
        }

        private final /* synthetic */ void $m$1() {
            ((OpenNetworkNotifier) this.f1-$f0).m25lambda$-com_android_server_wifi_OpenNetworkNotifier_13963();
        }

        private final /* synthetic */ void $m$2() {
            ((OpenNetworkNotifier) this.f1-$f0).m24lambda$-com_android_server_wifi_OpenNetworkNotifier_13081();
        }
    ...
    private final /* synthetic */ boolean $m$0(Message arg0) {
        return ((OpenNetworkNotifier) this.f0-$f0).m27lambda$-com_android_server_wifi_OpenNetworkNotifier_8777(arg0);
    }
