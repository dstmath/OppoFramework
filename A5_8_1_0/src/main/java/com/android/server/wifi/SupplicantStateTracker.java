...
public class SupplicantStateTracker extends StateMachine {
    ...
    private static final /* synthetic */ int[] f181-android-net-wifi-SupplicantStateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m94-getandroid-net-wifi-SupplicantStateSwitchesValues() {
        if (f181-android-net-wifi-SupplicantStateSwitchesValues != null) {
            return f181-android-net-wifi-SupplicantStateSwitchesValues;
        }
        ...
        f181-android-net-wifi-SupplicantStateSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void transitionOnSupplicantStateChange(StateChangeResult stateChangeResult) {
        ...
        switch (m94-getandroid-net-wifi-SupplicantStateSwitchesValues()[supState.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 7:
    ...
    private void sendSupplicantStateChangedBroadcast(SupplicantState state, boolean failedAuth, int reasonCode) {
        int supplState;
        switch (m94-getandroid-net-wifi-SupplicantStateSwitchesValues()[state.ordinal()]) {
            case 1:
                supplState = 7;
                break;
            case 2:
