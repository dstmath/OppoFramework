...
public class NativeUtil {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x003a A:{ExcHandler: java.nio.BufferUnderflowException (e java.nio.BufferUnderflowException), Splitter: B:7:0x002a} */
