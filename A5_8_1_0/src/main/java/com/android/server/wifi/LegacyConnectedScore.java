...
public class LegacyConnectedScore extends ConnectedScore {
    ...
    LegacyConnectedScore(Context context, WifiConfigManager wifiConfigManager, Clock clock) {
        ...
        this.mBadLinkSpeed24 = context.getResources().getInteger(17694902);
        this.mBadLinkSpeed5 = context.getResources().getInteger(17694903);
        this.mGoodLinkSpeed24 = context.getResources().getInteger(17694908);
        this.mGoodLinkSpeed5 = context.getResources().getInteger(17694909);
    ...
    private int calculateScore(WifiInfo wifiInfo) {
        ...
        if (wifiInfo.linkStuckCount > 1) {
            score = 1 - ((wifiInfo.linkStuckCount - 1) * 2);
        }
