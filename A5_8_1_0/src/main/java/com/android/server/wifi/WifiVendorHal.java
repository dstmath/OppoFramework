...
public class WifiVendorHal {
    ...
    private static final int[][] sStaFeatureCapabilityTranslation = new int[][]{new int[]{2, 128}, new int[]{4, 256}, new int[]{32, 2}, new int[]{1024, 512}, new int[]{4096, 1024}, new int[]{8192, StaIfaceCapabilityMask.TDLS_OFFCHANNEL}, new int[]{65536, 4}, new int[]{VendorKeyMgmtMask.FILS_SHA384, 8}, new int[]{1048576, 8192}, new int[]{2097152, 4096}, new int[]{8388608, 16}, new int[]{16777216, 32}, new int[]{33554432, 64}};
     ...
     */
        ...
        /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_102562 */
        /* synthetic */ void m46x8c745a64(WifiDebugRingBufferStatus status, ArrayList data) {
     ...
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_104225 */
        /* synthetic */ void m47x8c753766(ArrayList debugData, int errorCode) {
            synchronized (WifiVendorHal.sLock) {
    ...
    public void enableVerboseLogging(boolean verbose) {
        synchronized (sLock) {
            ...
            this.mHalDeviceManager.enableVerboseLogging(SystemProperties.getInt("vendor.qcom.wifi.debug", 0));
        }
    }
    ...
    public boolean startConcurrentVendorHal(boolean isStaMode) {
        synchronized (sLock) {
            boolean isApIfaceExist = this.mIWifiApIface != null;
            boolean isStaIfaceExist = this.mIWifiStaIface != null;
            boolean boolResult;
            if (isStaIfaceExist && isStaMode) {
                boolResult = boolResult(false);
                return boolResult;
            } else if (!isApIfaceExist || (isStaMode ^ 1) == 0) {
                IWifiIface iface;
                if (!(isStaIfaceExist || (isApIfaceExist ^ 1) == 0)) {
                    if ((this.mHalDeviceManager.start() ^ 1) != 0) {
                        boolResult = startFailedTo("start the vendor HAL");
                        return boolResult;
                    }
                }
                ...
                if (isStaIfaceExist || (isApIfaceExist ^ 1) == 0 || (registerChipCallback() ^ 1) == 0) {
                    this.mLog.i("Concurrent Vendor Hal started successfully");
                    return true;
                }
                boolResult = startFailedTo("register chip callback");
                return boolResult;
    ...
    public boolean stopVendorHalIface(boolean isSta) {
        synchronized (sLock) {
            if (isSta) {
                if (this.mIWifiStaIface != null && this.mHalDeviceManager.removeIface(this.mIWifiStaIface)) {
                    this.mIWifiStaIface = null;
                    this.mIWifiRttController = null;
                    this.mLog.i("Vendor Hal for STA stopped");
                    return true;
                }
            }
            if (!isSta) {
                if (this.mIWifiApIface != null && this.mHalDeviceManager.removeIface(this.mIWifiApIface)) {
                    this.mIWifiApIface = null;
                    this.mLog.i("Vendor Hal for AP stopped");
                    return true;
                }
            }
            this.mLog.e("Failed to stop Vendor Hal. Ignoring!!");
            return false;
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_19593 */
    /* synthetic */ void m29lambda$-com_android_server_wifi_WifiVendorHal_19593(ScanCapabilities out, MutableBoolean ans, WifiStatus status, StaBackgroundScanCapabilities cap) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_29156 */
    /* synthetic */ void m30lambda$-com_android_server_wifi_WifiVendorHal_29156(AnonymousClass1AnswerBox answer, WifiStatus status, StaLinkLayerStats stats) {
        if (ok(status)) {
            answer.value = stats;
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_36949 */
    /* synthetic */ void m31lambda$-com_android_server_wifi_WifiVendorHal_36949(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
            feat.value = wifiFeatureMaskFromChipCapabilities(capabilities);
        }
    }

    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_37253 */
    /* synthetic */ void m32lambda$-com_android_server_wifi_WifiVendorHal_37253(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_38745 */
    /* synthetic */ void m33lambda$-com_android_server_wifi_WifiVendorHal_38745(AnonymousClass2AnswerBox box, WifiStatus status, android.hardware.wifi.V1_0.RttCapabilities capabilities) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_55127 */
    /* synthetic */ void m34lambda$-com_android_server_wifi_WifiVendorHal_55127(AnonymousClass3AnswerBox answer, WifiStatus status, RttResponder info) {
        if (ok(status)) {
            answer.value = info;
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_59881 */
    /* synthetic */ void m35lambda$-com_android_server_wifi_WifiVendorHal_59881(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_60394 */
    /* synthetic */ void m36lambda$-com_android_server_wifi_WifiVendorHal_60394(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
            this.mChannelsForBandSupport = Boolean.valueOf(false);
        }
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_62281 */
    /* synthetic */ void m37lambda$-com_android_server_wifi_WifiVendorHal_62281(AnonymousClass5AnswerBox box, WifiStatus status, StaApfPacketFilterCapabilities capabilities) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_69198 */
    /* synthetic */ void m38lambda$-com_android_server_wifi_WifiVendorHal_69198(WifiStatus status, ChipDebugInfo chipDebugInfo) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_72141 */
    /* synthetic */ void m39lambda$-com_android_server_wifi_WifiVendorHal_72141(AnonymousClass6AnswerBox ans, WifiStatus status, ArrayList ringBuffers) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_73412 */
    /* synthetic */ void m40lambda$-com_android_server_wifi_WifiVendorHal_73412(AnonymousClass7AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_74106 */
    /* synthetic */ void m41lambda$-com_android_server_wifi_WifiVendorHal_74106(AnonymousClass8AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
            ans.value = NativeUtil.byteArrayFromArrayList(blob);
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_78973 */
    /* synthetic */ void m42lambda$-com_android_server_wifi_WifiVendorHal_78973(TxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_80760 */
    /* synthetic */ void m43lambda$-com_android_server_wifi_WifiVendorHal_80760(RxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_88201 */
    /* synthetic */ void m44lambda$-com_android_server_wifi_WifiVendorHal_88201(AnonymousClass9AnswerBox ans, WifiStatus status, WifiDebugHostWakeReasonStats stats) {
        if (ok(status)) {
            ans.value = stats;
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_WifiVendorHal_89828 */
    /* synthetic */ void m45lambda$-com_android_server_wifi_WifiVendorHal_89828(RoamingCapabilities out, MutableBoolean ok, WifiStatus status, StaRoamingCapabilities cap) {
        if (ok(status)) {
