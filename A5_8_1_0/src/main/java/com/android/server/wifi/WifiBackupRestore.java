...
public class WifiBackupRestore {
            ...
            public WifiConfiguration createWifiConfiguration() {
                ...
                if (this.mParsedIdStrLine != null) {
                    ...
                    if (idString != null) {
                        ...
                        String configKey = (String) extras.get(SupplicantStaNetworkHal.ID_STRING_KEY_CONFIG_KEY);
                        ...
                        if (Integer.parseInt((String) extras.get(SupplicantStaNetworkHal.ID_STRING_KEY_CREATOR_UID)) >= 10000) {
    ...
    private WifiConfiguration parseWifiConfigurationFromXmlAndValidateConfigKey(XmlPullParser in, int outerTagDepth) throws XmlPullParserException, IOException {
        ...
        if (!(configKeyParsed.equals(configKeyCalculated) || (transformConfigKeyParsed(configKeyParsed).equals(configKeyCalculated) ^ 1) == 0)) {
    ...
    private String transformConfigKeyParsed(String configKeyParsed) {
        ...
        sb.append(ssid).append("-").append(keyMgmt);
        return sb.toString();
    }
