...
import com.android.server.wifi.p2p.-$Lambda$gT4KmMIiMXRpxldJVwXfElmESAo.AnonymousClass21;
...
public class SupplicantP2pIfaceHal {
    ...
    private IOppoSupplicantP2pIface mISupplicantP2pIface = null;
    ...
    private static class SupplicantResult<E> {
        ...
        public void lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_93462(SupplicantStatus status, E value) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5055 */
    /* synthetic */ void m104lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5055(long cookie) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5445 */
    /* synthetic */ void m105lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_5445(long cookie) {
    ...
    /* JADX WARNING: Missing block: B:47:0x00c5, code:
            if (registerCallback(r10.mCallback) != false) goto L_0x00d4;
     */
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_10558 */
    static /* synthetic */ void m100lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_10558(ArrayList supplicantIfaces, SupplicantStatus status, ArrayList ifaces) {
        if (status.code != 0) {
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_11664 */
    static /* synthetic */ void m101lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_11664(SupplicantResult supplicantIface, SupplicantStatus status, ISupplicantIface iface) {
        if (status.code != 0) {
            Log.e(TAG, "Failed to get ISupplicantIface " + status.code);
        } else {
            supplicantIface.lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_93462(status, iface);
        }
    }
    ...
    protected IOppoSupplicantP2pIface getP2pIfaceMockable(ISupplicantIface iface) {
        return IOppoSupplicantP2pIface.asInterface(iface.asBinder());
    }
    ...
    public boolean find(int timeout, int freq) {
        synchronized (this.mLock) {
            if (!checkSupplicantP2pIfaceAndLogFailure("find")) {
                ...
                try {
                    result.setResult(this.mISupplicantP2pIface.p2pFind(timeout, freq));
                } catch (RemoteException e) {
                    Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                    supplicantServiceDiedHandler();
                }
    ...
    private boolean setOperChannel(int operChannel, int operRegClass, int cfgOperChannel) {
        synchronized (this.mLock) {
            if (checkSupplicantP2pIfaceAndLogFailure("setOperChannel")) {
                SupplicantResult<Void> result = new SupplicantResult("setOperChannel(" + operChannel + ", " + operRegClass + "," + cfgOperChannel + ")");
                try {
                    result.setResult(this.mISupplicantP2pIface.setOperChannel(operChannel, operRegClass, cfgOperChannel));
                } catch (RemoteException e) {
                    Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                    supplicantServiceDiedHandler();
                }
        ...
        synchronized (this.mLock) {
            if (!checkSupplicantP2pIfaceAndLogFailure("setSsidPostfix")) {
                ...
                try {
                    ...
                    SupplicantResult<String> result = new SupplicantResult("connect(" + config.deviceAddress + ", " + freq + ")");
                    try {
                        this.mISupplicantP2pIface.p2pConnect(peerAddress, provisionMethod, preSelectedPin, joinExistingGroup, persistent, goIntent, freq, new AnonymousClass21(result));
                    } catch (RemoteException e) {
                        Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                        supplicantServiceDiedHandler();
                    }
    ...
    public boolean setNetworkVariable(int netId, String name, String value) {
        synchronized (this.mLock) {
            if (checkSupplicantP2pIfaceAndLogFailure("setNetworkVariable")) {
                SupplicantResult<Void> result = new SupplicantResult("setNetworkVariable(" + netId + ", " + name + ", " + value + ")");
                try {
                    result.setResult(this.mISupplicantP2pIface.setNetworkVariable(netId, name, value));
                } catch (RemoteException e) {
                    Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                    supplicantServiceDiedHandler();
                }
    ...
    public int addP2pNetwork() {
        synchronized (this.mLock) {
            if (checkSupplicantP2pIfaceAndLogFailure("addP2pNetwork")) {
                SupplicantResult<Integer> result = new SupplicantResult("addP2pNetwork()");
                try {
                    this.mISupplicantP2pIface.addP2pNetwork(new AnonymousClass20(result));
                } catch (RemoteException e) {
                    Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                    supplicantServiceDiedHandler();
                }
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_44221 */
    static /* synthetic */ void m102lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_44221(SupplicantResult result, SupplicantStatus status, byte[] address) {
        ...
        result.lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_93462(status, parsedAddress);
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_45853 */
    static /* synthetic */ void m103lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_45853(SupplicantResult result, SupplicantStatus status, ArrayList ssid) {
        ...
        result.lambda$-com_android_server_wifi_p2p_SupplicantP2pIfaceHal_93462(status, ssidString);
    }
            ...
            if (checkSupplicantP2pIfaceAndLogFailure("setListenChannel")) {
                ...
                if (operatingChannel < 0 || operatingChannel > 165) {
                    ...
                    if (operatingChannel >= 1 && operatingChannel <= 165) {
                        ...
                        range1.min = OppoManuConnectManager.UID_DEFAULT;
                        range1.max = freq - 5;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:98:0x00c6 A:{SYNTHETIC} */
                        ...
                        if ("upnp".equals(data[0])) {
                            ...
                            if (!(data[1] == null || data[2] == null)) {
                                try {
                                    ...
                                    result3.setResult(this.mISupplicantP2pIface.addBonjourService(request, response));
                                    result2 = result3;
                                } catch (Exception e4) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:99:0x00c6 A:{SYNTHETIC} */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00be A:{SYNTHETIC, Splitter: B:44:0x00be} */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00be A:{SYNTHETIC, Splitter: B:44:0x00be} */
    /* JADX WARNING: Removed duplicated region for block: B:99:0x00c6 A:{SYNTHETIC} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
        ...
        synchronized (this.mLock) {
            if (!checkSupplicantP2pIfaceAndLogFailure("startWpsPinDisplay")) {
                ...
                try {
                    ...
                    try {
                        this.mISupplicantP2pIface.startWpsPinDisplay(groupIfName, macAddress, new AnonymousClass13(result));
                    } catch (RemoteException e) {
                        Log.e(TAG, "ISupplicantP2pIface exception: " + e);
                        supplicantServiceDiedHandler();
                    }
