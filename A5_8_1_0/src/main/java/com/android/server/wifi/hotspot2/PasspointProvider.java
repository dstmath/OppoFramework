...
public class PasspointProvider {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x0026 A:{ExcHandler: java.security.cert.CertificateEncodingException (e java.security.cert.CertificateEncodingException), Splitter: B:3:0x0004} */
