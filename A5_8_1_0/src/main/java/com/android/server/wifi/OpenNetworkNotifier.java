...
public class OpenNetworkNotifier {
    ...
    private class NotificationEnabledSettingObserver extends ContentObserver {
        ...
        private boolean getValue() {
            boolean enabled = OpenNetworkNotifier.this.mFrameworkFacade.getIntegerSetting(OpenNetworkNotifier.this.mContext, "wifi_networks_available_notification_on", 1) == 1;
            OpenNetworkNotifier.this.mWifiMetrics.setIsWifiNetworksAvailableNotificationEnabled(enabled);
            return enabled;
        }
    }

    private class OpenNetworkNotifierStoreData implements DataSource {
        /* synthetic */ OpenNetworkNotifierStoreData(OpenNetworkNotifier this$0, OpenNetworkNotifierStoreData -this1) {
            this();
        }
    ...
    OpenNetworkNotifier(Context context, Looper looper, FrameworkFacade framework, Clock clock, WifiMetrics wifiMetrics, WifiConfigManager wifiConfigManager, WifiConfigStore wifiConfigStore, WifiStateMachine wifiStateMachine, OpenNetworkRecommender openNetworkRecommender, ConnectToNetworkNotificationBuilder connectToNetworkNotificationBuilder) {
        ...
        wifiConfigStore.registerStoreData(new SsidSetStoreData(STORE_DATA_IDENTIFIER, new OpenNetworkNotifierStoreData(this, null)));
    ...
    /* renamed from: lambda$-com_android_server_wifi_OpenNetworkNotifier_8777 */
    /* synthetic */ boolean m27lambda$-com_android_server_wifi_OpenNetworkNotifier_8777(Message msg) {
        switch (msg.what) {
            case 151554:
    ...
    /* renamed from: lambda$-com_android_server_wifi_OpenNetworkNotifier_13081 */
    /* synthetic */ void m24lambda$-com_android_server_wifi_OpenNetworkNotifier_13081() {
        if (this.mState == 3) {
            clearPendingNotification(true);
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_OpenNetworkNotifier_13963 */
    /* synthetic */ void m25lambda$-com_android_server_wifi_OpenNetworkNotifier_13963() {
        if (this.mState == 4) {
            clearPendingNotification(false);
        }
    }
    ...
    /* renamed from: lambda$-com_android_server_wifi_OpenNetworkNotifier_16544 */
    /* synthetic */ void m26lambda$-com_android_server_wifi_OpenNetworkNotifier_16544() {
        if (this.mState == 2) {
