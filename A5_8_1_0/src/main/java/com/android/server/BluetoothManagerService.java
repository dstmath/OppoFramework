...
class BluetoothManagerService extends Stub {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    break;
                case 20:
                    BluetoothManagerService.this.mCallbacks.register(msg.obj);
                    break;
                case 21:
                    BluetoothManagerService.this.mCallbacks.unregister((IBluetoothManagerCallback) msg.obj);
                    break;
                case 30:
                    BluetoothManagerService.this.mStateChangeCallbacks.register(msg.obj);
                    break;
                case 31:
                ...
                case 100:
                    ...
                    if (!BluetoothManagerService.this.mTryBindOnBindTimeout) {
                        Slog.e(BluetoothManagerService.TAG, " Trying to Bind again");
                    ...
                    try {
                        ...
                        if (BluetoothManagerService.this.mBluetooth != null) {
                            ...
                            if (str != null && address != null) {
                                BluetoothManagerService.this.storeNameAndAddress(str, address);
                                if (this.mGetNameAddressOnly) {
                                    unbind = true;
                                }
                            } else if (msg.arg1 < 3) {
    ...
    /* JADX WARNING: Missing block: B:46:0x0078, code:
            if (r11 != false) goto L_0x007c;
     */
    /* JADX WARNING: Missing block: B:47:0x007a, code:
            if (r12 == false) goto L_0x0084;
     */
    /* JADX WARNING: Missing block: B:48:0x007c, code:
            android.os.SystemClock.sleep(300);
     */
    /* JADX WARNING: Missing block: B:49:0x0081, code:
            r1 = r1 + 1;
     */
