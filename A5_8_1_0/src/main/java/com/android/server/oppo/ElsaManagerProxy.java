...
public class ElsaManagerProxy implements IElsaManager {
    ...
    public int elsaAddDependApp(int uid, int uidDepend) throws RemoteException {
        Parcel _data = Parcel.obtain();
        Parcel _reply = Parcel.obtain();
        int result = 0;
        try {
    ...
    public int elsaRemoveDependApp(int uid, int uidDepend) throws RemoteException {
        Parcel _data = Parcel.obtain();
        Parcel _reply = Parcel.obtain();
        int result = 0;
        try {
