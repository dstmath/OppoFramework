...
public interface IElsaManager extends IInterface {
    ...
    public static final int TRANSACTION_ELSA_ADD_DEPEND_APP = 109;
    ...
    public static final int TRANSACTION_ELSA_NOTIFY_APP_SWITCH = 111;
    public static final int TRANSACTION_ELSA_REMOVE_DEPEND_APP = 110;
    public static final int TRANSACTION_ELSA_RESUME = 108;
    ...
    int elsaAddDependApp(int i, int i2) throws RemoteException;
    ...
    int elsaNotifyAppSwitch(int i, String str, int i2, String str2) throws RemoteException;

    int elsaRemoveDependApp(int i, int i2) throws RemoteException;

    void elsaResume(int i, int i2, int i3, int i4, String str) throws RemoteException;
