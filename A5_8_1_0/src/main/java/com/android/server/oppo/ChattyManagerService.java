...
public class ChattyManagerService {
    ...
    private boolean mDynLog = false;
    private boolean mDynProp = false;
                ...
                switch (msg.what) {
                    case 0:
                        ...
                        if (strMsg != null) {
                            ...
                            if (Integer.parseInt(args[0]) == 1 && args.length == 4) {
                    ...
                    case 6:
                        ...
                        if (ChattyManagerService.this.mAlarmManager != null) {
                            ChattyManagerService.this.mAlarmManager.setRepeating(1, (ChattyManagerService.this.mBootTime * 1000) + 10800000, 10800000, PendingIntent.getBroadcast(ChattyManagerService.this.mContext, 0, new Intent(ChattyManagerService.CHATTY_UPDATE_ACTION), 0));
                        }
    ...
    class StateReceiver extends BroadcastReceiver {
        public static final String ACTION_MTKLOGGER_STATE_CHANGED = "oppo.intent.action.StartOrStopLogcat";
    ...
    boolean isCompressionNeeded() {
        ...
        if (new File(FILE_LOG_PATH).exists()) {
            ...
            if (now - time > UnixCalendar.DAY_IN_MILLIS) {
                if (DEBUG) {
