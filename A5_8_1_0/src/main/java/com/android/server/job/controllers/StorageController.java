        ...
        public void onReceiveInternal(Intent intent) {
            ...
            if ("android.intent.action.DEVICE_STORAGE_LOW".equals(action)) {
                if (StorageController.DEBUG) {
                    Slog.d(StorageController.TAG, "Available storage too low to do work. @ " + SystemClock.elapsedRealtime());
                }
                this.mStorageLow = true;
            } else if ("android.intent.action.DEVICE_STORAGE_OK".equals(action)) {
                if (StorageController.DEBUG) {
                    Slog.d(StorageController.TAG, "Available stoage high enough to do work. @ " + SystemClock.elapsedRealtime());
                }
