...
public class LegacyVpnInfo implements Parcelable {
    ...
    private static final /* synthetic */ int[] f134-android-net-NetworkInfo$DetailedStateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m40-getandroid-net-NetworkInfo$DetailedStateSwitchesValues() {
        if (f134-android-net-NetworkInfo$DetailedStateSwitchesValues != null) {
            return f134-android-net-NetworkInfo$DetailedStateSwitchesValues;
        }
        ...
        f134-android-net-NetworkInfo$DetailedStateSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static int stateFromNetworkInfo(NetworkInfo info) {
        switch (m40-getandroid-net-NetworkInfo$DetailedStateSwitchesValues()[info.getDetailedState().ordinal()]) {
            case 1:
                return 3;
            case 2:
                return 2;
