    ...
    private synchronized void setNiNotification(GpsNiNotification notif) {
        ...
        if (notificationManager != null) {
            ...
            if (this.mNiNotificationBuilder == null) {
                this.mNiNotificationBuilder = new Builder(this.mContext, SystemNotificationChannels.NETWORK_ALERTS).setSmallIcon(R.drawable.stat_sys_gps_on).setWhen(0).setOngoing(true).setAutoCancel(true).setColor(this.mContext.getColor(R.color.system_notification_accent_color));
            }
            if (this.mPlaySounds) {
