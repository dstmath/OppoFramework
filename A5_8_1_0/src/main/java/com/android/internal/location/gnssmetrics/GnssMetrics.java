...
public class GnssMetrics {
    ...
    private Statistics locationFailureStatistics = new Statistics(this, null);
    private String logStartInElapsedRealTime;
    private Statistics positionAccuracyMeterStatistics = new Statistics(this, null);
    private Statistics timeToFirstFixSecStatistics = new Statistics(this, null);
    private Statistics topFourAverageCn0Statistics = new Statistics(this, null);
    ...
    private class Statistics {
        ...
        /* synthetic */ Statistics(GnssMetrics this$0, Statistics -this1) {
            this();
        }
    ...
    public String dumpGnssMetricsAsText() {
        ...
        s.append("GNSS_KPI_START").append(10);
