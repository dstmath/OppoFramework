...
public class PhoneWindow extends Window implements Callback {
    ...
    private int mReplacedNavigationBarColor;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        updateSepicalWindowNavigationBarColor(newConfig);
    }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (!this.mForcedNavigationBarColor) {
            ...
            if (navigationBarColor != 0) {
                ...
                if (isUseDefaultNavigationBarColor(pkg, this.mActivityName)) {
        ...
        if (getContainer() == null) {
            ...
            if (this.mDecor != null) {
                this.mDecor.mLastClipToOutline = this.mClipToOutline;
            }
        ...
        if (getContainer() == null) {
            ...
            if (this.mDecor.mStackId == 2) {
                this.mDecor.setClipToOutline(true);
            } else {
    ...
    public void setNavigationBarColor(int color) {
        ...
        if (isUseDefaultNavigationBarColor(getContext().getPackageName(), this.mActivityName)) {
            this.mNavigationBarColor = NAVIGATION_BAR_COLOR_GRAY;
        } else {
            this.mNavColorIsAppCustom = true;
        }
    ...
    private boolean isUseDefaultNavigationBarColor(String pkg, String activityName) {
        if ("com.google.android.setupwizard".equals(pkg) || "com.google.android.apps.gsa.staticplugins.opa.errorui.OpaErrorActivity".equals(this.mActivityName) || "com.google.android.apps.gsa.velour.dynamichosts.TransparentVelvetDynamicHostActivity".equals(this.mActivityName) || "com.google.android.finsky.setup.VpaSelectionOptionalStepActivity".equals(this.mActivityName) || "com.google.android.finsky.setupui.VpaSelectionOptionalStepActivity".equals(this.mActivityName) || "com.google.android.apps.gsa.staticplugins.opa.setupwizard.SetupWizardActivity".equals(this.mActivityName) || "com.google.android.play.games".equals(pkg) || "com.google.android.googlequicksearchbox".equals(pkg) || "com.google.android.gms".equals(pkg)) {
            return true;
        }
        return false;
    }

    private void updateSepicalWindowNavigationBarColor(Configuration newConfig) {
        if ("com.tencent.qqlive.ona.activity.VideoDetailActivity".equals(this.mActivityName)) {
            if (DEBUG_OPPO_SYSTEMBAR) {
                Log.i(TAG, "updateSepicalWindowNavigationBarColor mActivityName:" + this.mActivityName + " newConfig.orientation:" + newConfig.orientation + " mReplacedNavigationBarColor:" + this.mReplacedNavigationBarColor);
            }
            if (this.mLastOrientation != newConfig.orientation) {
                if (newConfig.orientation == 2) {
                    this.mReplacedNavigationBarColor = this.mNavigationBarColor;
                    this.mNavigationBarColor = -16777216;
                } else {
                    this.mNavigationBarColor = this.mReplacedNavigationBarColor;
                }
