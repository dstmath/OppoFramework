...
import android.view.GestureAreaDetection;
...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    private final GestureAreaDetection mGestureAreaDetection;
    ...
    DecorView(Context context, int featureId, PhoneWindow window, LayoutParams params) {
        ...
        initResizingPaints();
        this.mGestureAreaDetection = new GestureAreaDetection(context, this);
    }
    ...
    public boolean isLongPressSwipe() {
        return this.mGestureAreaDetection.isLongPressSwipe();
    }

    public boolean dispatchTouchEvent(MotionEvent ev) {
        Window.Callback cb = this.mWindow.getCallback();
        int oldAction = ev.getAction();
        if (this.mGestureAreaDetection.dispatchTouchEvent(ev, isHandlingTouchEvent())) {
            ev.setAction(3);
    ...
    protected void onAttachedToWindow() {
        ...
        this.mGestureAreaDetection.onAttached(this.mWindow.getAttributes().type);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        this.mGestureAreaDetection.onDetached();
        PanelFeatureState st = this.mWindow.getPanelState(0, false);
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (this.mStackId != workspaceId) {
            ...
            if (this.mStackId == 1 && (this.mLastClipToOutline ^ 1) != 0) {
                setClipToOutline(this.mLastClipToOutline);
            }
