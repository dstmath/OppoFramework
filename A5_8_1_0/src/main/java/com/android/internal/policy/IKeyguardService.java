...
public interface IKeyguardService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeyguardService {
        ...
        static final int TRANSACTION_onSystemReadyForColorOS = 24;
        static final int TRANSACTION_requestKeyguard = 25;
        static final int TRANSACTION_setColorOSKeyguardService = 23;
