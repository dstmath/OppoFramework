...
public class ActionMenuItemView extends TextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "Suying.You@Plf.SDK, 2017-12-23 : [-private] Modify to talkBack accessibility", property = OppoRomType.ROM)
    void updateTextButtonVisibility() {
        boolean visible = setTitleText();
