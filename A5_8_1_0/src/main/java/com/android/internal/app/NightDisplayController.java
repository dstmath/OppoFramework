...
public final class NightDisplayController {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0029 A:{ExcHandler: java.time.DateTimeException (e java.time.DateTimeException), Splitter: B:6:0x0018} */
