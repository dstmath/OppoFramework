...
public class ChooserActivity extends ResolverActivity {
    ...
    final String[] mPackageNamesSupportAppSplitArray = new String[]{"com.tencent.mm", "com.tencent.mobileqq"};
    final ArrayList<String> mPackageNamesSupportAppSplitList = new ArrayList(Arrays.asList(this.mPackageNamesSupportAppSplitArray));
    ...
    public class ChooserListAdapter extends ResolveListAdapter {
        ...
        public ChooserListAdapter(Context context, List<Intent> payloadIntents, Intent[] initialIntents, List<ResolveInfo> rList, int launchedFromUid, boolean filterLastUsed, ResolverListController resolverListController) {
            super(context, payloadIntents, initialIntents, rList, launchedFromUid, filterLastUsed, resolverListController);
        ...
        public void onListRebuilt() {
            ...
            ChooserActivity.this.setResolverConent();
        }
        ...
        public TargetInfo targetInfoForPosition(int position, boolean filtered) {
            return super.targetInfoForPosition(position, filtered);
        }
    ...
    private void modifyTargetIntent(Intent in) {
        ...
        if (("android.intent.action.SEND".equals(action) || "android.intent.action.SEND_MULTIPLE".equals(action)) && in.getType() != null && (in.getType().contains("text/plain") || in.getType().contains("application/octet-stream"))) {
            in.addFlags(134742016);
            Log.d(TAG, "modifyTargetIntent  add FLAG_ACTIVITY_NEW_DOCUMENT & FLAG_ACTIVITY_MULTIPLE_TASK");
        }
