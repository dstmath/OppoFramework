...
public class AlertController {
    ...
    private static boolean mOnlyList = false;
    ...
    public static class AlertParams {
        ...
        private void createListView(AlertController dialog) {
            ...
            if (this.mHasMessage || (this.mIsTitle ^ 1) == 0) {
                AlertController.mOnlyList = false;
            } else {
                AlertController.mOnlyList = true;
            }
            if (!this.mIsMultiChoice) {
                ...
                if (AlertController.isCustomAdapter(isOppoStyle) && isDialogThree && this.mAdapter == null) {
    ...
    public static class RecycleListView extends ListView {
        ...
        private void clipTopRound(Canvas canvas) {
            if (this.mIsOppoStyle && (AlertController.mOnlyList ^ 1) == 0) {
                if (this.mPath1 == null) {
                ...
                this.mPathArc.addArc(new RectF(0.0f, (float) (getTop() + offY), (float) this.mRadius, (float) ((getTop() + offY) + this.mRadius)), 180.0f, 270.0f);
                canvas.clipPath(this.mPathArc, Op.UNION);
                this.mPathArc.reset();
                this.mPathArc.addArc(new RectF((float) (getRight() - this.mRadius), (float) (getTop() + offY), (float) getRight(), (float) ((getTop() + offY) + this.mRadius)), 270.0f, 360.0f);
                canvas.clipPath(this.mPathArc, Op.UNION);
            }
        }
    }
