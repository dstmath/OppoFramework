...
public interface ILMServiceManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILMServiceManager {
        ...
        private static class Proxy implements ILMServiceManager {
            ...
            public Bundle getModeData(int type, int versionCode) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    Bundle _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = enableBoost(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result2) {
                        i = 1;
                    }
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result3 = getModeData(data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
