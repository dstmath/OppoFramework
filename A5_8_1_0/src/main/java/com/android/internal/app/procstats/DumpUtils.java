...
public final class DumpUtils {
    ...
    public static final String[] STATE_NAMES_CSV = new String[]{"pers", "top", "impfg", "impbg", "backup", "heavy", TileService.EXTRA_SERVICE, "service-rs", "receiver", CalendarCache.TIMEZONE_TYPE_HOME, "lastact", "cch-activity", "cch-aclient", "cch-empty"};
