...
public interface ILockSettings extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILockSettings {
        ...
        static final int TRANSACTION_getPassword = 29;
        ...
        static final int TRANSACTION_sanitizePassword = 28;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            long _result2;
            String _result3;
            VerifyCredentialResponse _result4;
            switch (code) {
                case 1:
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getString(data.readString(), data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = checkCredential(data.readString(), data.readInt(), data.readInt(), com.android.internal.widget.ICheckCredentialProgressCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = verifyCredential(data.readString(), data.readInt(), data.readLong(), data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, 1);
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = verifyTiedProfileChallenge(data.readString(), data.readInt(), data.readLong(), data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, 1);
