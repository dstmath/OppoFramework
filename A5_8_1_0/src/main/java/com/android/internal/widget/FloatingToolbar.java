...
public final class FloatingToolbar {
    ...
    @OppoHook(level = OppoHookType.CHANGE_BASE_CLASS, note = "YuJun.Feng@Plf.SDK, 2017-09-07 : Modify for oppo style toolBar", property = OppoRomType.ROM)
    ...
    private static final class FloatingToolbarPopup {
        ...
        private final OnComputeInternalInsetsListener mInsetsComputer = new -$Lambda$Go7JgWogXNLsQcgF5KW1dT_OHSc((byte) 1, this);
        ...
        /* renamed from: lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_15267 */
        /* synthetic */ void m42xf896940d(InternalInsetsInfo info) {
        ...
        private ImageButton createOverflowButton() {
            ...
            overflowButton.setOnClickListener(new com.android.internal.widget.-$Lambda$nZD8NeHZxo4kFQHu5zIWiAfZj2s.AnonymousClass1(this, overflowButton));
            return overflowButton;
        }

        /* renamed from: lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_66153 */
        /* synthetic */ void m43xf8dd7a0d(ImageButton overflowButton, View v) {
            if (this.mIsOverflowOpen) {
        ...
        private OverflowPanel createOverflowPanel() {
            ...
            overflowPanel.setOnItemClickListener(new com.android.internal.widget.-$Lambda$nZD8NeHZxo4kFQHu5zIWiAfZj2s.AnonymousClass2(this, overflowPanel));
            return overflowPanel;
        }

        /* renamed from: lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_67518 */
        /* synthetic */ void m44xf8ddfcf9(OverflowPanel overflowPanel, AdapterView adapterView, View view, int position, long id) {
        ...
        private AnimationListener createOverflowAnimationListener() {
            return new AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    FloatingToolbarPopup.this.mContentContainer.post(new -$Lambda$5qwWzot5fpA60Kn5ry4ls-knvBk((byte) 1, this));
                }

                /* renamed from: lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup$13_69244 */
                /* synthetic */ void m45x323087f9() {
                    FloatingToolbarPopup.this.setPanelsStatesAtRestingPosition();
                    FloatingToolbarPopup.this.setContentAreaAsTouchableSurface();
                }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "YuJun.Feng@Plf.SDK, 2017-09-07 : Modify for oppo style toolBar", property = OppoRomType.ROM)
