...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-09-01 : [-private] Modify for SearchView Animation", property = OppoRomType.ROM)
    HomeView mExpandedHomeLayout;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-06-17 : [-private] Modify for SplitMenu", property = OppoRomType.ROM)
    ExpandedActionViewMenuPresenter mExpandedMenuPresenter;
    private CharSequence mHomeDescription;
    private int mHomeDescriptionRes;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-31 : [-private] Modify for ActionBar Title", property = OppoRomType.ROM)
    HomeView mHomeLayout;
    private Drawable mIcon;
    private boolean mIncludeTabs;
    private final int mIndeterminateProgressStyle;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "Jianhua.Lin@Plf.SDK : [-private] Modify for ProgressBar", property = OppoRomType.ROM)
    ProgressBar mIndeterminateProgressView;
    ...
    LinearLayout mListNavLayout;
    private Drawable mLogo;
    private ActionMenuItem mLogoNavItem;
    private boolean mMenuPrepared;
    private OnItemSelectedListener mNavItemSelectedListener;
    private int mNavigationMode;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-07-10 : [-private] Modify for SplitMenu", property = OppoRomType.ROM)
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK : [-private] Modify for SplitMenu", property = OppoRomType.ROM)
    ScrollingTabContainerView mTabScrollView;
    private Runnable mTabSelector;
    private CharSequence mTitle;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-05 : [-private] Modify for ActionBar Title", property = OppoRomType.ROM)
    LinearLayout mTitleLayout;
    private final int mTitleStyleRes;
    private TextView mTitleView;
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-31 : [-private] Modify for ActionBar Title", property = OppoRomType.ROM)
    final OnClickListener mUpClickListener = new OnClickListener() {
        public void onClick(View v) {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-28 : [-private] Modify for ActionBar Title", property = OppoRomType.ROM)
    ViewGroup mUpGoerFive;
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-31 : [-private] Modify for ActionBar Title", property = OppoRomType.ROM)
    static class HomeView extends FrameLayout {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-09-01 : [-private] Modify for SearchView Animation", property = OppoRomType.ROM)
    void setHomeButtonEnabled(boolean enable, boolean recordState) {
        if (recordState) {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JiFeng.Tan@Plf.SDK, 2015-10-26 : Modify to resolve layout error for rtl language; JianHui.Yu@Plf.SDK, 2017-09-29 : [-private] Modify for resolve layout error for rtl language", property = OppoRomType.ROM)
    void updateHomeAccessibility(boolean homeEnabled) {
        if (homeEnabled) {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JiFeng.Tan@Plf.SDK, 2015-10-26 : Modify to resolve layout error for rtl language; JianHui.Yu@Plf.SDK, 2017-09-29 : [-private] Modify for resolve layout error for rtl language", property = OppoRomType.ROM)
    CharSequence buildHomeContentDescription() {
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Changwei.Li@Plf.SDK, 2015-05-25 : Modify for oppo tab width", property = OppoRomType.ROM)
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int i;
                ...
                switch (this.mNavigationMode) {
                    ...
                    case 2:
                        if (this.mTabScrollView != null) {
                            ...
                            availableWidth = Math.max(0, availableWidth - itemPaddingSize);
                            leftOfCenter = Math.max(0, leftOfCenter - itemPaddingSize);
                            measureChildView(this.mTabScrollView, availableWidth, height, 0);
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Xiaokang.Feng@Plf.SDK : Modify for oppoStyle ActionBarTitle; JianHui.Yu@Plf.SDK, 2015-08-28 : Add for ActionBar Title", property = OppoRomType.ROM)
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (contentHeight > 0) {
            ...
            if (customView != null) {
                ...
                xpos = hookSetCustomViewPosX(ablp, xpos, hgravity, navWidth);
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "JianHui.Yu@Plf.SDK, 2015-08-28 : Add for ActionBar Title", property = OppoRomType.ROM)
