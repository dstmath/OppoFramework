...
public class InputMethodUtils {
    ...
    public static class InputMethodSettings {
        ...
        private final SimpleStringSplitter mInputMethodSplitter = new SimpleStringSplitter(':');
    ...
    public static ArrayMap<String, ArraySet<String>> parseInputMethodsAndSubtypesString(String inputMethodsAndSubtypesString) {
        ...
        for (Pair<String, ArrayList<String>> ime : InputMethodSettings.buildInputMethodsAndSubtypeList(inputMethodsAndSubtypesString, new SimpleStringSplitter(':'), new SimpleStringSplitter(';'))) {
