...
public interface IStatusBarService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBarService {
        ...
        static final int TRANSACTION_exitSplitScreen = 37;
        static final int TRANSACTION_expandNotificationsPanel = 1;
        static final int TRANSACTION_expandSettingsPanel = 12;
        static final int TRANSACTION_getTopIsFullscreen = 35;
        static final int TRANSACTION_handleOpeningSpecialApp = 36;
        static final int TRANSACTION_handleSystemKey = 32;
        static final int TRANSACTION_notifyMultiWindowFocusChanged = 38;
        ...
        static final int TRANSACTION_setNavigationBarColor = 39;
        static final int TRANSACTION_setShortcutsPanelState = 34;
        static final int TRANSACTION_setStatusBarFunction = 41;
        ...
        static final int TRANSACTION_toggleSplitScreen = 40;
        static final int TRANSACTION_topIsFullscreen = 33;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 41:
                    data.enforceInterface("com.android.internal.statusbar.IStatusBarService");
                    _result = setStatusBarFunction(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 1598968902:
