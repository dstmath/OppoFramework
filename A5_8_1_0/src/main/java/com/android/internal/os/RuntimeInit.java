...
public class RuntimeInit {
    ...
    private static class LoggingHandler implements UncaughtExceptionHandler {
        ...
        private void checkToInstallGr(String appPkgName) {
            ...
            if (OppoAutoInstallManager.canShowDialog(appPkgName).booleanValue()) {
                ...
                OppoAutoInstallManager.doGr(null, null, appPkgName, "DO_GR_DOWN_INSTALL");
        ...
        private void checkToReinstall(String appPkgName) {
            ...
            OppoAutoInstallManager.doGr(null, null, appPkgName, "DO_GR_REINSTALL");
            OppoAutoInstallManager.exit(appPkgName);
        }
            ...
            if (!RuntimeInit.mCrashing) {
                if (RuntimeInit.mApplicationObject == null) {
                    ...
                    if (processName != null) {
                        ...
                        if (OppoAutoInstallManager.isInnerVersion.booleanValue()) {
                            String msg = e.getMessage();
                            if (msg != null) {
                                if ((msg.contains("does not have package com.google.android.gsf") || msg.contains("Failed to find provider com.google.android.gsf.gservices")) && (OppoAutoInstallManager.grExists().booleanValue() ^ 1) != 0) {
    ...
    protected static Runnable applicationInit(int targetSdkVersion, String[] argv, ClassLoader classLoader) {
        ...
        if (!"true".equals(SystemProperties.get("persist.oppo.disable.compatibility"))) {
            z = false;
        }
        runtime.setDisableCompatbilityFlag(z);
