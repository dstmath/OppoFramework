...
public interface IConnectionServiceAdapter extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectionServiceAdapter {
        ...
        private static class Proxy implements IConnectionServiceAdapter {
            ...
            public void resetCdmaConnectionTime(String callIdi, Info sessionInfo) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 34:
                    ...
                    resetCdmaConnectionTime(_arg0, _arg1);
                    return true;
                case 1598968902:
    ...
    void resetCdmaConnectionTime(String str, Info info) throws RemoteException;
