...
public interface ITelecomService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelecomService {
        ...
        static final int TRANSACTION_addNewOutgoingCall = 49;
        ...
        static final int TRANSACTION_colorInteractWithTelecomService = 48;
        ...
        static final int TRANSACTION_oppoCancelMissedCallsNotification = 50;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 50:
                    ...
                    oppoCancelMissedCallsNotification(_arg05, _arg1);
                    reply.writeNoException();
                    return true;
                case 1598968902:
