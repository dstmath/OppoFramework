...
public interface CommandsInterface {
    ...
    void OppoExpSetRegionForRilEcclist(Message message);

    void OppoGetMdmBaseBand(Message message);

    void OppoGetRffeDevInfo(int i, Message message);

    void OppoSetTddLte(int i, Message message);
    ...
    void getBandMode(Message message);
    ...
    void oppoCtlModemFeature(int[] iArr, Message message);

    void oppoGetASDIVState(int i, Message message);

    void oppoGetEsnChangeFlag(Message message);

    int oppoGetPreferredNetworkType();

    void oppoGetRadioInfo(Message message);

    String oppoGetRilTopMsg();

    void oppoGetTxRxInfo(int i, Message message);

    void oppoLockGSMArfcn(int i, Message message);

    void oppoLockLteCell(int i, int i2, Message message);

    void oppoNoticeUpdateVolteFr(int i, Message message);

    int oppoResetRilCount();

    void oppoRffeCmd(int[] iArr, Message message);

    void oppoSetFilterArfcn(int i, int i2, Message message);

    void oppoUpdateFakeBsWeight(int[] iArr, Message message);

    void oppoUpdatePplmnList(byte[] bArr, Message message);

    void oppoUpdateVolteFr2(int i, int i2, int i3, int i4, Message message);
    ...
    void registerForLteCAState(Handler handler, int i, Object obj);
    ...
    void setFactoryModeModemGPIO(int i, int i2, Message message);

    void setFactoryModeNvProcess(int i, Message message);
    ...
    void setModemCrash(Message message);
    ...
    void unregisterForLteCAState(Handler handler);
