...
public class IccCardStatus {
    ...
    public String toString() {
        ...
        sb.append("IccCardState {").append(this.mCardState).append(",").append(this.mUniversalPinState).append(",num_apps=").append(this.mApplications.length);
        ...
        sb.append(",mSimHotswapState=").append(this.mSimHotswapState);
        sb.append("}");
        return sb.toString();
    }
}
