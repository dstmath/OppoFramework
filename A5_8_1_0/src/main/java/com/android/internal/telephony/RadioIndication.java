...
import android.hardware.radio.V1_1.IRadioIndication.Stub;
...
public class RadioIndication extends Stub {
    ...
    public void onUssd(int indicationType, int ussdModeType, String msg) {
        this.mRil.processIndication(indicationType);
        this.mRil.unsljLogMore(1006, SpnOverride.MVNO_TYPE_NONE + ussdModeType);
        String[] resp = new String[]{SpnOverride.MVNO_TYPE_NONE + ussdModeType, msg};
    ...
    public void currentSignalStrength(int indicationType, SignalStrength signalStrength) {
        this.mRil.processIndication(indicationType);
        android.telephony.SignalStrength ss = RIL.convertHalSignalStrength(signalStrength);
