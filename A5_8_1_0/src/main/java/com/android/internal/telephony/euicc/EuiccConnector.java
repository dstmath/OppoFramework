...
public class EuiccConnector extends StateMachine implements ServiceConnection {
    ...
    private class AvailableState extends State {
        /* synthetic */ AvailableState(EuiccConnector this$0, AvailableState -this1) {
            this();
        }
    ...
    private class BindingState extends State {
        /* synthetic */ BindingState(EuiccConnector this$0, BindingState -this1) {
            this();
        }
    ...
    private class ConnectedState extends State {
        /* synthetic */ ConnectedState(EuiccConnector this$0, ConnectedState -this1) {
            this();
        }
                    ...
                    switch (message.what) {
                        case 100:
                            EuiccConnector.this.mEuiccService.getEid(-1, new Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$1_27371 */
                                /* synthetic */ void m36x51d09a3d(BaseEuiccCommandCallback callback, String eid) {
                        ...
                        case 101:
                            ...
                            EuiccConnector.this.mEuiccService.getDownloadableSubscriptionMetadata(-1, request.mSubscription, request.mForceDeactivateSim, new IGetDownloadableSubscriptionMetadataCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$2_28578 */
                                /* synthetic */ void m37x86b75166(BaseEuiccCommandCallback callback, GetDownloadableSubscriptionMetadataResult result) {
                        ...
                        case 102:
                            ...
                            EuiccConnector.this.mEuiccService.downloadSubscription(-1, request2.mSubscription, request2.mSwitchAfterDownload, request2.mForceDeactivateSim, new IDownloadSubscriptionCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$3_29724 */
                                /* synthetic */ void m38xbb9e07e9(BaseEuiccCommandCallback callback, int result) {
                        ...
                        case EuiccConnector.CMD_GET_EUICC_PROFILE_INFO_LIST /*103*/:
                            EuiccConnector.this.mEuiccService.getEuiccProfileInfoList(-1, new IGetEuiccProfileInfoListCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$4_30676 */
                                /* synthetic */ void m39xf08e4030(BaseEuiccCommandCallback callback, GetEuiccProfileInfoListResult result) {
                                    ((GetEuiccProfileInfoListCommandCallback) callback).onListComplete(result);
                                    EuiccConnector.this.onCommandEnd(callback);
                                }
                            });
                            break;
                        case EuiccConnector.CMD_GET_DEFAULT_DOWNLOADABLE_SUBSCRIPTION_LIST /*104*/:
                            EuiccConnector.this.mEuiccService.getDefaultDownloadableSubscriptionList(-1, message.obj.mForceDeactivateSim, new IGetDefaultDownloadableSubscriptionListCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$5_31902 */
                                /* synthetic */ void m40x2574fa36(BaseEuiccCommandCallback callback, GetDefaultDownloadableSubscriptionListResult result) {
                                    ((GetDefaultListCommandCallback) callback).onGetDefaultListComplete(result);
                                    EuiccConnector.this.onCommandEnd(callback);
                                }
                            });
                            break;
                        case EuiccConnector.CMD_GET_EUICC_INFO /*105*/:
                            EuiccConnector.this.mEuiccService.getEuiccInfo(-1, new IGetEuiccInfoCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$6_32764 */
                                /* synthetic */ void m41x5a5ba310(BaseEuiccCommandCallback callback, EuiccInfo euiccInfo) {
                        ...
                        case 106:
                            EuiccConnector.this.mEuiccService.deleteSubscription(-1, message.obj.mIccid, new IDeleteSubscriptionCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$7_33731 */
                                /* synthetic */ void m42x8f425250(BaseEuiccCommandCallback callback, int result) {
                        ...
                        case EuiccConnector.CMD_SWITCH_TO_SUBSCRIPTION /*107*/:
                            ...
                            EuiccConnector.this.mEuiccService.switchToSubscription(-1, request3.mIccid, request3.mForceDeactivateSim, new ISwitchToSubscriptionCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$8_34755 */
                                /* synthetic */ void m43xc4290232(BaseEuiccCommandCallback callback, int result) {
                                    ((SwitchCommandCallback) callback).onSwitchComplete(result);
                                    EuiccConnector.this.onCommandEnd(callback);
                                }
                            });
                            break;
                        case EuiccConnector.CMD_UPDATE_SUBSCRIPTION_NICKNAME /*108*/:
                            ...
                            EuiccConnector.this.mEuiccService.updateSubscriptionNickname(-1, request4.mIccid, request4.mNickname, new IUpdateSubscriptionNicknameCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$9_35803 */
                                /* synthetic */ void m44xf90fb4f6(BaseEuiccCommandCallback callback, int result) {
                        ...
                        case EuiccConnector.CMD_ERASE_SUBSCRIPTIONS /*109*/:
                            EuiccConnector.this.mEuiccService.eraseSubscriptions(-1, new IEraseSubscriptionsCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$10_36674 */
                                /* synthetic */ void m34x7e90dcad(BaseEuiccCommandCallback callback, int result) {
                        ...
                        case EuiccConnector.CMD_RETAIN_SUBSCRIPTIONS /*110*/:
                            EuiccConnector.this.mEuiccService.retainSubscriptionsForFactoryReset(-1, new IRetainSubscriptionsForFactoryResetCallback.Stub() {
                                ...
                                /* renamed from: lambda$-com_android_internal_telephony_euicc_EuiccConnector$ConnectedState$11_37560 */
                                /* synthetic */ void m35xb3778869(BaseEuiccCommandCallback callback, int result) {
    ...
    private class DisconnectedState extends State {
        /* synthetic */ DisconnectedState(EuiccConnector this$0, DisconnectedState -this1) {
            this();
        }
        ...
        public boolean processMessage(Message message) {
            if (message.what == 4) {
                ...
                boolean isSameComponent = bestComponent == null ? EuiccConnector.this.mSelectedComponent != null : EuiccConnector.this.mSelectedComponent != null ? Objects.equals(bestComponent.getComponentName(), EuiccConnector.this.mSelectedComponent.getComponentName()) : true;
                boolean forceRebind;
                if (bestComponent != null) {
                    forceRebind = Objects.equals(bestComponent.packageName, affectedPackage);
                } else {
                    forceRebind = false;
                }
    ...
    private class EuiccPackageMonitor extends PackageMonitor {
        /* synthetic */ EuiccPackageMonitor(EuiccConnector this$0, EuiccPackageMonitor -this1) {
            this();
        }
    ...
    private class UnavailableState extends State {
        /* synthetic */ UnavailableState(EuiccConnector this$0, UnavailableState -this1) {
            this();
        }
    ...
    private static BaseEuiccCommandCallback getCallback(Message message) {
        switch (message.what) {
            ...
            case CMD_GET_DEFAULT_DOWNLOADABLE_SUBSCRIPTION_LIST /*104*/:
            ...
            case CMD_UPDATE_SUBSCRIPTION_NICKNAME /*108*/:
