...
public class CarrierKeyDownloadManager {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:53:0x0183 A:{SYNTHETIC, Splitter: B:53:0x0183} */
            ...
            while (true) {
                ...
                try {
                    ...
                    if (i < keys.length()) {
                        ...
                        PemReader pemReader = new PemReader(new BufferedReader(new InputStreamReader(new ByteArrayInputStream(cert.getBytes()))));
                        Pair<PublicKey, Long> keyInfo = getKeyInformation(pemReader.readPemObject().getContent());
                        pemReader.close();
                    ...
                    if (reader != null) {
                        try {
                            ...
                            Log.e(LOG_TAG, "Exception getting certificate: " + e32);
                        }
                    }
                } catch (Exception e5) {
                    e32 = e5;
                    ...
                    try {
                        ...
                        if (reader != null) {
                            try {
                                ...
                                Log.e(LOG_TAG, "Exception getting certificate: " + e322);
                            }
                        }
                    } catch (Throwable th2) {
                        th = th2;
                    ...
                    if (reader != null) {
                        try {
                            ...
                            Log.e(LOG_TAG, "Exception getting certificate: " + e3222);
                        }
                    }
                    throw th;
                }
