...
public class SuppServiceNotification {
    ...
    public String toString() {
        return super.toString() + " mobile" + (this.notificationType == 0 ? " originated " : " terminated ") + " code: " + this.code + " index: " + this.index + " history: " + this.history + " \"" + PhoneNumberUtils.stringFromStringAndTOA(this.number, this.type) + "\" ";
    }
}
