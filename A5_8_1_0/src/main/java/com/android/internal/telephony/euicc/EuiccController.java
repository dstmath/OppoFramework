...
public class EuiccController extends Stub {
    ...
    class GetMetadataCommandCallback implements com.android.internal.telephony.euicc.EuiccConnector.GetMetadataCommandCallback {
        ...
        public void onGetMetadataComplete(GetDownloadableSubscriptionMetadataResult result) {
            ...
            EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(this.mCallbackIntent, resultCode, extrasIntent);
        }

        public void onEuiccServiceUnavailable() {
            EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(this.mCallbackIntent, 2, null);
        }
    ...
    class DownloadSubscriptionGetMetadataCommandCallback extends GetMetadataCommandCallback {
        ...
        public void onGetMetadataComplete(GetDownloadableSubscriptionMetadataResult result) {
            ...
            if (result.result == -1) {
                ...
                EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(this.mCallbackIntent, 1, extrasIntent);
    ...
    void downloadSubscriptionPrivileged(long callingToken, DownloadableSubscription subscription, boolean switchAfterDownload, boolean forceDeactivateSim, String callingPackage, PendingIntent callbackIntent) {
        ...
        this.mConnector.downloadSubscription(subscription, switchAfterDownload, forceDeactivateSim, new DownloadCommandCallback() {
            public void onDownloadComplete(int result) {
                ...
                EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(pendingIntent, resultCode, extrasIntent);
            }

            public void onEuiccServiceUnavailable() {
                EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(pendingIntent, 2, null);
            }
        });
    }
    ...
    public void deleteSubscription(int subscriptionId, String callingPackage, PendingIntent callbackIntent) {
        ...
        try {
            ...
            if (sub == null) {
                ...
                lambda$-com_android_internal_telephony_euicc_EuiccController_38558(callbackIntent, 2, null);
                return;
            }
            if (!callerCanWriteEmbeddedSubscriptions) {
        ...
        this.mConnector.deleteSubscription(iccid, new DeleteCommandCallback() {
            public void onDeleteComplete(int result) {
                ...
                switch (result) {
                    ...
                    default:
                        extrasIntent.putExtra("android.telephony.euicc.extra.EMBEDDED_SUBSCRIPTION_DETAILED_CODE", result);
                        EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(callbackIntent, 2, extrasIntent);
                        return;
                }
            }

            public void onEuiccServiceUnavailable() {
                EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(callbackIntent, 2, null);
            }
        });
    }
        ...
        if (subscriptionId != -1) {
            ...
            if (callerCanWriteEmbeddedSubscriptions) {
                if ((canManageActiveSubscription(callingPackage) ^ 1) != 0) {
                    ...
                    lambda$-com_android_internal_telephony_euicc_EuiccController_38558(callbackIntent, 1, extrasIntent);
                    Binder.restoreCallingIdentity(token);
                    return;
                }
            }
            ...
            try {
                ...
                this.mConnector.updateSubscriptionNickname(sub.getIccId(), nickname, new UpdateNicknameCommandCallback() {
                    public void onUpdateNicknameComplete(int result) {
                        ...
                        EuiccController.this.lambda$-com_android_internal_telephony_euicc_EuiccController_38558(callbackIntent, resultCode, extrasIntent);
                    }
    ...
    public void lambda$-com_android_internal_telephony_euicc_EuiccController_38558(PendingIntent callbackIntent, int resultCode, Intent extrasIntent) {
        try {
