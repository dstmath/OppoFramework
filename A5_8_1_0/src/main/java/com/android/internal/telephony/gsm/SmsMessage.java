...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SubmitPdu getSubmitPduOem(String scAddress, String destinationAddress, String message, boolean statusReportRequested, int validityPeriod, int encodingType, int languageTable, int languageShiftTable) {
        return getSubmitPdu(scAddress, destinationAddress, message, statusReportRequested, null, encodingType, languageTable, languageShiftTable, validityPeriod);
    }
    ...
    public static TextEncodingDetails calculateLengthOem(CharSequence msgBody, boolean use7bitOnly, int encodingType) {
        CharSequence newMsgBody = null;
        if (Resources.getSystem().getBoolean(R.bool.config_sms_force_7bit_encoding)) {
            newMsgBody = Sms7BitEncodingTranslator.translate(msgBody);
        }
