...
public interface ITelephonyRegistry extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephonyRegistry {
        ...
        private static class Proxy implements ITelephonyRegistry {
            ...
            public void notifyVoLteServiceStateChanged(int phoneId, int subId, VoLteServiceState lteState) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 25:
                    ...
                    return true;
                case 26:
                    VoLteServiceState _arg25;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg25 = (VoLteServiceState) VoLteServiceState.CREATOR.createFromParcel(data);
                    } else {
                        _arg25 = null;
                    }
                    notifyVoLteServiceStateChanged(_arg0, _arg1, _arg25);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void notifyVoLteServiceStateChanged(int i, int i2, VoLteServiceState voLteServiceState) throws RemoteException;
