...
public class ResultException extends CatException {
    ...
    private static final /* synthetic */ int[] f24-com-android-internal-telephony-cat-ResultCodeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m26-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues() {
        if (f24-com-android-internal-telephony-cat-ResultCodeSwitchesValues != null) {
            return f24-com-android-internal-telephony-cat-ResultCodeSwitchesValues;
        }
        ...
        f24-com-android-internal-telephony-cat-ResultCodeSwitchesValues = iArr;
        return iArr;
    }

    public ResultException(ResultCode result) {
        switch (m26-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues()[result.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            default:
                ...
                this.mExplanation = SpnOverride.MVNO_TYPE_NONE;
                return;
        }
    }
