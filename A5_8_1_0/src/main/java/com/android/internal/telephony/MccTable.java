...
public final class MccTable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x00a2 A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x01bb A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x019d A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Removed duplicated region for block: B:27:0x00a2 A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x019d A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x01bb A:{Catch:{ Exception -> 0x018b }} */
    /* JADX WARNING: Missing block: B:56:0x0177, code:
            if (r18.equals("om") != false) goto L_0x0179;
     */
    ...
    private static boolean isInvalidOperatorNumeric(String operatorNumeric) {
        ...
        return operatorNumeric.startsWith(ServiceStateTracker.INVALID_MCC);
    }
    ...
    private static void setWifiCountryCodeFromMcc(Context context, int mcc) {
        ...
        if (mcc == 0 && subIds != null && subIds.length > 0) {
            for (int subId : subIds) {
                if (!isInvalidOperatorNumeric(tm.getNetworkOperatorForPhone(SubscriptionController.getInstance().getPhoneId(subId)))) {
                    Slog.d(LOG_TAG, "operatornumeric is valid, Do not overwrite");
