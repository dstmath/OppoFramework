...
public class NotificationChannelController {
    ...
    private static void createAll(Context context) {
        new NotificationChannel(CHANNEL_ID_ALERT, context.getText(17040374), 3).setSound(System.DEFAULT_NOTIFICATION_URI, new Builder().setUsage(5).build());
        new NotificationChannel(CHANNEL_ID_MOBILE_DATA_STATUS, context.getText(17040373), 2).setBlockableSystem(true);
        ((NotificationManager) context.getSystemService(NotificationManager.class)).createNotificationChannels(Arrays.asList(new NotificationChannel[]{new NotificationChannel(CHANNEL_ID_CALL_FORWARD, context.getText(17040366), 2), new NotificationChannel(CHANNEL_ID_SMS, context.getText(17040381), 4), new NotificationChannel(CHANNEL_ID_WFC, context.getText(17040387), 2), alertChannel, mobileDataStatusChannel}));
    ...
    private static void migrateVoicemailNotificationSettings(Context context) {
        NotificationChannel voiceMailChannel = new NotificationChannel(CHANNEL_ID_VOICE_MAIL, context.getText(17040385), 3);
