...
public class TelephonyMetrics {
    ...
    private static final /* synthetic */ int[] f5xb32e9020 = null;
    ...
    private static /* synthetic */ int[] m5-getcom-android-internal-telephony-Call$StateSwitchesValues() {
    ...
    private static /* synthetic */ int[] m6x3549e7c4() {
        if (f5xb32e9020 != null) {
            return f5xb32e9020;
        }
    ...
    private synchronized void printAllMetrics(PrintWriter rawWriter) {
        ...
        for (TelephonyEvent event : this.mTelephonyEvents) {
            ...
            pw.println(SpnOverride.MVNO_TYPE_NONE);
        }
        pw.decreaseIndent();
    ...
    static int roundSessionStart(long timestamp) {
        return (int) ((timestamp / RIL.DEFAULT_DUP_SMS_KEPP_PERIOD) * 5);
    }
    ...
    private void convertConnectionToRilCall(GsmCdmaConnection conn, RilCall call) {
        ...
        switch (m5-getcom-android-internal-telephony-Call$StateSwitchesValues()[conn.getState().ordinal()]) {
            case 1:
                call.state = 2;
                break;
            case 2:
    ...
    public void writePhoneState(int phoneId, PhoneConstants.State phoneState) {
        int state;
        switch (m6x3549e7c4()[phoneState.ordinal()]) {
            case 1:
                state = 1;
                break;
            case 2:
    ...
    public void writeImsCallState(int phoneId, ImsCallSession session, State callState) {
        int state;
        switch (m5-getcom-android-internal-telephony-Call$StateSwitchesValues()[callState.ordinal()]) {
            case 1:
                state = 2;
                break;
            case 2:
