...
public final class BearerData {
    ...
    public static TextEncodingDetails calcTextEncodingDetailsOem(CharSequence msg, boolean force7BitEncoding, boolean isEntireMsg, int encodingType) {
        int septets = countAsciiSeptets(msg, force7BitEncoding);
        if (encodingType == 3) {
        ...
        if (septets == -1 || septets > 160) {
            ...
            ted = calcTextEncodingDetails(msg, force7BitEncoding, true);
