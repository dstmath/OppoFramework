            ...
            if (extTelephony != null) {
                try {
                    if (extTelephony.isVendorApkAvailable("com.qualcomm.qti.networksetting")) {
                        notificationIntent.setComponent(new ComponentName("com.qualcomm.qti.networksetting", "com.qualcomm.qti.networksetting.MobileNetworkSettings"));
                        settingsIntent = PendingIntent.getActivity(context, 0, notificationIntent, 1073741824);
                        title = context.getText(17039410);
                        details = context.getText(17039409);
                    ...
                    notificationIntent.setComponent(new ComponentName("com.android.phone", "com.android.phone.MobileNetworkSettings"));
                }
            }
            notificationIntent.setComponent(new ComponentName("com.android.phone", "com.android.phone.MobileNetworkSettings"));
            settingsIntent = PendingIntent.getActivity(context, 0, notificationIntent, 1073741824);
