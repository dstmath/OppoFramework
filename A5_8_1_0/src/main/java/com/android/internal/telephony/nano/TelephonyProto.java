...
public interface TelephonyProto {
    ...
    public static final class ImsReasonInfo extends ExtendableMessageNano<ImsReasonInfo> {
        ...
        public ImsReasonInfo clear() {
            this.reasonCode = 0;
            this.extraCode = 0;
            this.extraMessage = SpnOverride.MVNO_TYPE_NONE;
            this.unknownFieldData = null;
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (!this.extraMessage.equals(SpnOverride.MVNO_TYPE_NONE)) {
    ...
    public static final class RilDataCall extends ExtendableMessageNano<RilDataCall> {
        ...
        public RilDataCall clear() {
            this.cid = 0;
            this.type = 0;
            this.iframe = SpnOverride.MVNO_TYPE_NONE;
            this.unknownFieldData = null;
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (!this.iframe.equals(SpnOverride.MVNO_TYPE_NONE)) {
    ...
    public static final class TelephonyEvent extends ExtendableMessageNano<TelephonyEvent> {
        ...
        public static final class ModemRestart extends ExtendableMessageNano<ModemRestart> {
            ...
            public ModemRestart clear() {
                this.basebandVersion = SpnOverride.MVNO_TYPE_NONE;
                this.reason = SpnOverride.MVNO_TYPE_NONE;
                this.unknownFieldData = null;
                this.cachedSize = -1;
                return this;
            }
            ...
            public void writeTo(CodedOutputByteBufferNano output) throws IOException {
                if (!this.basebandVersion.equals(SpnOverride.MVNO_TYPE_NONE)) {
                    output.writeString(1, this.basebandVersion);
                }
                if (!this.reason.equals(SpnOverride.MVNO_TYPE_NONE)) {
        ...
        public static final class RilSetupDataCall extends ExtendableMessageNano<RilSetupDataCall> {
            ...
            public RilSetupDataCall clear() {
                this.rat = -1;
                this.dataProfile = 0;
                this.apn = SpnOverride.MVNO_TYPE_NONE;
                this.type = 0;
                this.unknownFieldData = null;
                this.cachedSize = -1;
                return this;
            ...
            public void writeTo(CodedOutputByteBufferNano output) throws IOException {
                ...
                if (!this.apn.equals(SpnOverride.MVNO_TYPE_NONE)) {
    ...
    public static final class TelephonyServiceState extends ExtendableMessageNano<TelephonyServiceState> {
        ...
        public static final class TelephonyOperator extends ExtendableMessageNano<TelephonyOperator> {
            ...
            public TelephonyOperator clear() {
                this.alphaLong = SpnOverride.MVNO_TYPE_NONE;
                this.alphaShort = SpnOverride.MVNO_TYPE_NONE;
                this.numeric = SpnOverride.MVNO_TYPE_NONE;
                this.unknownFieldData = null;
                this.cachedSize = -1;
                return this;
            }
            ...
            public void writeTo(CodedOutputByteBufferNano output) throws IOException {
                if (!this.alphaLong.equals(SpnOverride.MVNO_TYPE_NONE)) {
                    output.writeString(1, this.alphaLong);
                }
                if (!this.alphaShort.equals(SpnOverride.MVNO_TYPE_NONE)) {
                    output.writeString(2, this.alphaShort);
                }
                if (!this.numeric.equals(SpnOverride.MVNO_TYPE_NONE)) {
