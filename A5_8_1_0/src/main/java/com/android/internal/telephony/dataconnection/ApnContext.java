...
public class ApnContext {
    ...
    public boolean isProvisioningApn() {
        String provisioningApn = this.mPhone.getContext().getResources().getString(17040336);
    ...
    public void resetErrorCodeRetries() {
        ...
        String[] config = this.mPhone.getContext().getResources().getStringArray(17235994);
