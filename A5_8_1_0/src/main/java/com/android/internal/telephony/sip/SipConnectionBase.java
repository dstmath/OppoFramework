...
abstract class SipConnectionBase extends Connection {
    ...
    private static final /* synthetic */ int[] f49-com-android-internal-telephony-Call$StateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m46-getcom-android-internal-telephony-Call$StateSwitchesValues() {
        if (f49-com-android-internal-telephony-Call$StateSwitchesValues != null) {
            return f49-com-android-internal-telephony-Call$StateSwitchesValues;
        }
        ...
        f49-com-android-internal-telephony-Call$StateSwitchesValues = iArr;
        return iArr;
    }
    ...
    protected void setState(State state) {
        ...
        switch (m46-getcom-android-internal-telephony-Call$StateSwitchesValues()[state.ordinal()]) {
            case 1:
