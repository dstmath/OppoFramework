...
public abstract class BaseCommands implements CommandsInterface {
    ...
    protected RegistrantList mLteCARegistrants = new RegistrantList();
    ...
    public void setFactoryModeNvProcess(int cmd, Message response) {
    }
    ...
    public void registerForLteCAState(Handler h, int what, Object obj) {
        ...
        if (this.mLteCaInfo != null) {
            r.notifyRegistrant(new AsyncResult(null, this.mLteCaInfo, null));
        }
    }
