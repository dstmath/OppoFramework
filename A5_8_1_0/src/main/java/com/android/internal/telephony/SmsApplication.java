...
public final class SmsApplication {
    ...
    public static String[] OEM_PACKAGE_ALLOW_WRITE_SMS = new String[]{"com.oppo.engineermode", "com.coloros.findmyphone", "com.coloros.backuprestore", "com.nearme.sync", "com.coloros.speechassist", "com.coloros.speechassist.engine", "com.android.settings", "com.coloros.cloud"};
    ...
    private static void setDefaultApplicationInternal(String packageName, Context context, int userId) {
        ...
        if (packageName == null || oldPackageName == null || !packageName.equals(oldPackageName)) {
            ...
            if (applicationData != null) {
                AppOpsManager appOps = (AppOpsManager) context.getSystemService("appops");
                if (!(oldPackageName == null || ("com.android.mms".equals(oldPackageName) ^ 1) == 0)) {
                    try {
