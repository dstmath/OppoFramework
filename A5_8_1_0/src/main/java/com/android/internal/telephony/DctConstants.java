...
public class DctConstants {
    ...
    public static final int CMD_DELAY_SETUP_DATA = 270438;
    ...
    public static final int EVENT_OEM_SCREEN_CHANGED = 270437;
    ...
    public static final int EVENT_RAC_UPDATE = 270436;
