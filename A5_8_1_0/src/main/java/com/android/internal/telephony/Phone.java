...
public abstract class Phone extends Handler implements PhoneInternalInterface {
        ...
        if (ar.exception == null && ar.result != null) {
            try {
                if (ar.result[0] == 0) {
                    ...
                    if (!(mss == null || mss.getVoiceRegState() == 0 || mss.getDataRegState() == 0)) {
                        Rlog.d(LOG_TAG, "onCheckForNetworkSelectionModeAutomatic, set exception error for pop-up");
    ...
    /* renamed from: notifyDisconnectP */
    protected void -wrap2(Connection cn) {
    ...
    public boolean getCallForwardingIndicator() {
        if (getPhoneType() != 2 || (isUtEnabled() ^ 1) == 0) {
            ...
            if (getCallForwardingIndicatorFromSharedPref() != 1) {
    ...
    private void updateImsPhone() {
        ...
        if (this.mImsServiceReady && this.mImsPhone == null) {
            ...
            this.mDcTracker.registerOnImsCallStateChange();
    ...
    public void oppoGetASDIVState(int rat, Message response) {
        this.mCi.oppoGetASDIVState(rat, response);
    }
}
