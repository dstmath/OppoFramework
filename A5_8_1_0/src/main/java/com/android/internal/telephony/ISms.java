...
public interface ISms extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISms {
        ...
        static final int TRANSACTION_activateCellBroadcastSmsForSubscriber = 34;
        ...
        static final int TRANSACTION_getCellBroadcastSmsConfigForSubscriber = 31;
        ...
        static final int TRANSACTION_queryCellBroadcastSmsActivationForSubscriber = 33;
        ...
        static final int TRANSACTION_setCellBroadcastSmsConfigForSubscriber = 32;
        ...
        private static class Proxy implements ISms {
            ...
            public void sendTextForSubscriberWithOptions(int subId, String callingPkg, String destAddr, String scAddr, String text, PendingIntent sentIntent, PendingIntent deliveryIntent, boolean persistMessageForNonDefaultSmsApp, int priority, boolean isExpectMore, int validityPeriod) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    ...
                    sendTextForSubscriberWithOptions(_arg0, _arg1, _arg2, _arg3, _arg42, _arg52, _arg6, data.readInt() != 0, data.readInt(), data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    sendTextForSubscriberWithOptionsOem(_arg0, _arg1, _arg2, _arg3, _arg42, _arg52, _arg6, data.readInt() != 0, data.readInt(), data.readInt() != 0, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 10:
                ...
                case 29:
                    ...
                    _result3 = createAppSpecificSmsToken(_arg0, _arg1, _arg23);
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getSmsCapacityOnIccForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    SmsCbConfigInfo[] _result5 = getCellBroadcastSmsConfigForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeTypedArray(_result5, 1);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setCellBroadcastSmsConfigForSubscriber(data.readInt(), (SmsCbConfigInfo[]) data.createTypedArray(SmsCbConfigInfo.CREATOR), (SmsCbConfigInfo[]) data.createTypedArray(SmsCbConfigInfo.CREATOR));
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    _result = queryCellBroadcastSmsActivationForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    _result = activateCellBroadcastSmsForSubscriber(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 1598968902:
