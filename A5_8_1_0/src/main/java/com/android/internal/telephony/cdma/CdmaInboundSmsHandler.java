...
public class CdmaInboundSmsHandler extends InboundSmsHandler {
    private final boolean mCheckForDuplicatePortsInOmadmWapPush = Resources.getSystem().getBoolean(17956941);
    ...
    protected int dispatchMessageRadioSpecific(SmsMessageBase smsb) {
        ...
        if (DataCallFailCause.OEM_DCFAILCAUSE_4 == teleService) {
