...
public final class RusUpdateQcomEhplmn extends RusBase {
    ...
    private static final String TAG = "RusUpdateQcomEhplmn";
    private static final int TYPE_CMCCPLMN = 0;
    private static final int TYPE_CTPLMN = 2;
    private static final int TYPE_CUPLMN = 1;
    private static final int UPDATE_EHPLMN = 2;
    private static final int mPlmnIndex_count = 12;
    private static final String mPlmnIndex_end = "/QcomEhplmn>";
    private static final String mPlmnIndex_start = "<QcomEhplmn";
    private static final String mPlmnInfoFileName = "qual_update_ehplmn.xml";
    ...
    public int valiateAndUpatePlmn() {
        ...
        try {
            this.mPlmnContent = createNetworkRomupdateXmlFile(providerContent, mPlmnInfoFileName, mPlmnIndex_start, mPlmnIndex_end, 12);
            ...
            try {
                ...
                XmlUtils.beginDocument(confparser, "QcomEhplmn");
