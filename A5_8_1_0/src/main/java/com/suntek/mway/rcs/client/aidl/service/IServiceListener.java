...
public interface IServiceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServiceListener {
        private static final String DESCRIPTOR = "com.suntek.mway.rcs.client.aidl.service.IServiceListener";
        static final int TRANSACTION_onServiceConnected = 1;
        static final int TRANSACTION_onServiceDisconnected = 2;

        private static class Proxy implements IServiceListener {
        ...
        public static IServiceListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IServiceListener)) {
                return new Proxy(obj);
            }
            return (IServiceListener) iin;
        }
