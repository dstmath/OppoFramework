...
class TextLine {
    ...
    private static final class DecorationInfo {
        ...
        /* synthetic */ DecorationInfo(DecorationInfo -this0) {
            this();
        }
        ...
        if (c != null) {
            ...
            if (numDecorations != 0) {
                for (int i = 0; i < numDecorations; i++) {
                    ...
                    DecorationInfo info = (DecorationInfo) decorations.get(i);
            ...
            if (needsSpanMeasurement) {
                ...
                while (i < measureLimit) {
                    ...
                    if (replacement != null) {
                        ...
                        handleReplacement = handleReplacement(replacement, wp, i, mlimit, runIsRtl, c, x, top, y, bottom, fmi, z);
                    } else {
                        boolean z2;
                        ...
                        activePaint.setHyphenEdit(adjustHyphenEdit(activeStart, activeEnd, this.mPaint.getHyphenEdit()));
                        z2 = needWidth || activeEnd < measureLimit;
                        handleReplacement = handleText(activePaint, activeStart, activeEnd, i, inext, runIsRtl, c, x, top, y, bottom, fmi, z2, Math.min(activeEnd, mlimit), this.mDecorations);
                    }
                    x += handleReplacement;
                    i = inext;
                }
