...
public abstract class BaseKeyListener extends MetaKeyKeyListener implements KeyListener {
    ...
    private static final /* synthetic */ int[] f51-android-text-method-TextKeyListener$CapitalizeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m28-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues() {
        if (f51-android-text-method-TextKeyListener$CapitalizeSwitchesValues != null) {
            return f51-android-text-method-TextKeyListener$CapitalizeSwitchesValues;
        }
        ...
        f51-android-text-method-TextKeyListener$CapitalizeSwitchesValues = iArr;
        return iArr;
    }
    ...
    static int makeTextContentType(Capitalize caps, boolean autoText) {
        int contentType = 1;
        switch (m28-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues()[caps.ordinal()]) {
            case 1:
                contentType = SmsEnvelope.SERVICE_CATEGORY_CMAS_EXTREME_THREAT;
                break;
            case 2:
                contentType = 16385;
                break;
