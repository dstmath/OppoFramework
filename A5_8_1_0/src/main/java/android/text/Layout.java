...
public abstract class Layout {
    ...
    private static final /* synthetic */ int[] f49-android-text-Layout$AlignmentSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m27-getandroid-text-Layout$AlignmentSwitchesValues() {
        if (f49-android-text-Layout$AlignmentSwitchesValues != null) {
            return f49-android-text-Layout$AlignmentSwitchesValues;
        }
        ...
        f49-android-text-Layout$AlignmentSwitchesValues = iArr;
        return iArr;
    }
    ...
    public boolean shouldClampCursor(int line) {
        boolean z = true;
        switch (m27-getandroid-text-Layout$AlignmentSwitchesValues()[getParagraphAlignment(line).ordinal()]) {
            case 1:
                return true;
            case 2:
