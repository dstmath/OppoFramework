...
public final class Formatter {
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "JiFeng.Tan@Plf.SDK : Modify for bug:1335710", property = OppoRomType.ROM)
    private static String formatFileSize(Context context, long sizeBytes, int flags) {
        if (context == null) {
            return "";
        }
        String colorFormat = ColorFormatter.formatFileSize(context, sizeBytes, flags);
