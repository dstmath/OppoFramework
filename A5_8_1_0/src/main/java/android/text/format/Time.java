...
public class Time {
    ...
    private boolean parse3339Internal(String s) {
        ...
        if (len >= 19) {
            ...
            checkChar(s, 13, ColorAccessibilityUtil.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
            int minute = getChar(s, 14, 10) + getChar(s, 15, 1);
            checkChar(s, 16, ColorAccessibilityUtil.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
