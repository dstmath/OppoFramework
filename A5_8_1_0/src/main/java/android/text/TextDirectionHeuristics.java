...
import com.color.view.ColorWindowManager.LayoutParams;
...
public class TextDirectionHeuristics {
    ...
    private static int isRtlCodePoint(int codePoint) {
        switch (Character.getDirectionality(codePoint)) {
            case (byte) -1:
                if ((1424 > codePoint || codePoint > LayoutParams.TYPE_SYSTEM_LONGSHOT) && ((64285 > codePoint || codePoint > 64975) && ((65008 > codePoint || codePoint > 65023) && ((65136 > codePoint || codePoint > 65279) && ((67584 > codePoint || codePoint > 69631) && (124928 > codePoint || codePoint > 126975)))))) {
