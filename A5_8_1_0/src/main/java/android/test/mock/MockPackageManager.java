...
public class MockPackageManager extends PackageManager {
    ...
    public boolean isSecurePayApp(String name) {
        throw new UnsupportedOperationException();
    }
    ...
    public Drawable getApplicationIconCache(String packageName) {
        throw new UnsupportedOperationException();
    }
    ...
    public Drawable getApplicationIconCacheOrignal(String packageName) {
        throw new UnsupportedOperationException();
    }
    ...
    public Drawable getActivityIconCache(ComponentName componentName) {
        throw new UnsupportedOperationException();
    }
    ...
    public void addDisallowUninstallApps(List<String> list) {
        throw new UnsupportedOperationException();
    }

    public void removeDisallowUninstallApps(List<String> list) {
        throw new UnsupportedOperationException();
    }
    ...
    public void addInstallPackageWhitelist(int mode, List<String> list) {
        throw new UnsupportedOperationException();
    }

    public void addInstallPackageBlacklist(int mode, List<String> list) {
        throw new UnsupportedOperationException();
    }
}
