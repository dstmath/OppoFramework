...
public class TelephonyManager {
    ...
    private static final /* synthetic */ int[] f30x22a12f3f = null;
    ...
    public static final int NETWORK_TYPE_LTE_CA = 139;
    ...
    private static /* synthetic */ int[] m22xa4bc86e3() {
        if (f30x22a12f3f != null) {
            return f30x22a12f3f;
        }
    ...
    public int getPhoneCount() {
        switch (m22xa4bc86e3()[getMultiSimConfiguration().ordinal()]) {
            case 1:
            case 2:
                return 2;
            case 3:
    ...
    public String getNetworkOperatorName() {
        return getNetworkOperatorName(getSubIdOem());
    }

    private int getSubIdOem() {
    ...
    public String getNetworkOperator() {
        try {
            return getNetworkOperatorForPhone(SubscriptionManager.getPhoneId(SubscriptionManager.getDefaultDataSubscriptionId()));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String getSimSerialNumber(int subId) {
        SeempLog.record_str(MetricsEvent.PREMIUM_SMS_ACCESS, "" + subId);
        try {
            IPhoneSubInfo info = getSubscriberInfo();
            if (info == null) {
                return null;
    ...
    public String getSubscriberId(int subId) {
        SeempLog.record_str(MetricsEvent.ACTION_WINDOW_DOCK_RESIZE, "" + subId);
        try {
            IPhoneSubInfo info = getSubscriberInfo();
            if (info == null) {
                return null;
    ...
    public void listen(PhoneStateListener listener, int events) {
        if (this.mContext == null) {
            Log.e(TAG, "listen: mContext is null. do not register.");
            return;
        }
        try {
            ...
            Log.e(TAG, "listen: RemoteException");
        } catch (NullPointerException e2) {
