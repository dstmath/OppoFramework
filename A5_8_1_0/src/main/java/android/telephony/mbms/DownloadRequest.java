...
public final class DownloadRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            return new DownloadRequest(this.fileServiceId, this.source, this.subscriptionId, this.appIntent, this.version, null);
        }
    }
    ...
    /* synthetic */ DownloadRequest(Parcel in, DownloadRequest -this1) {
        this(in);
    }

    /* synthetic */ DownloadRequest(String fileServiceId, Uri source, int sub, String appIntent, int version, DownloadRequest -this5) {
        this(fileServiceId, source, sub, appIntent, version);
    }
