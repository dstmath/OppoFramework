        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    _result = registerStateCallback(_arg0, android.telephony.mbms.IDownloadStateCallback.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 6:
                    ...
                    _result = unregisterStateCallback(_arg0, android.telephony.mbms.IDownloadStateCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 7:
                ...
                case 9:
                    ...
                    _result = getDownloadStatus(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 10:
                    ...
                    _result = resetDownloadKnowledge(_arg0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 11:
