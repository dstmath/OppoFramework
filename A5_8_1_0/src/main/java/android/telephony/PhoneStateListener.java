...
public class PhoneStateListener {
    ...
    public PhoneStateListener(int subId, int slotId) {
        this(Integer.valueOf(subId), Looper.myLooper());
        this.mSlotId = slotId;
    }
    ...
    public int getSubscripitonId() {
        return this.mSubId.intValue();
    }

    public void setSubscripitonId(int subId) {
