...
public class CellBroadcastMessage implements Parcelable {
    ...
    public static CellBroadcastMessage createFromCursor(Cursor cursor) {
        ...
        return new CellBroadcastMessage(new SmsCbMessage(format, geoScope, serialNum, smsCbLocation, category, language, body, priority, etwsInfo, cmasInfo), cursor.getLong(cursor.getColumnIndexOrThrow(Calls.DATE)), cursor.getInt(cursor.getColumnIndexOrThrow("read")) != 0);
    }
    ...
    public ContentValues getContentValues() {
        ...
        cv.put(Calls.DATE, Long.valueOf(this.mDeliveryTime));
