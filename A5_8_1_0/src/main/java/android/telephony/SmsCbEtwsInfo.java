...
public class SmsCbEtwsInfo implements Parcelable {
    ...
    public int hashCode() {
        int hash = this.mWarningType * 4;
        hash += this.mEmergencyUserAlert ? (hash * 8) + 7 : (hash * 6) + 5;
        return hash + (this.mActivatePopup ? (hash * 12) + 15 : (hash * 10) + 13);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || ((o instanceof SmsCbEtwsInfo) ^ 1) != 0) {
            return false;
        }
        SmsCbEtwsInfo other = (SmsCbEtwsInfo) o;
        if (this.mWarningType != other.mWarningType || this.mEmergencyUserAlert != other.mEmergencyUserAlert) {
            z = false;
        } else if (this.mActivatePopup != other.mActivatePopup) {
            z = false;
        }
        return z;
    }
