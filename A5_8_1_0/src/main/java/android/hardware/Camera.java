...
public class Camera {
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
        ...
        if ("off".equals(SystemProperties.get("oppo.camera.hypnus.contrl", "on")) || "android".equals(ActivityThread.currentOpPackageName()) || "com.android.cts.managedprofile".equals(ActivityThread.currentOpPackageName())) {
