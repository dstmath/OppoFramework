...
public interface IInputManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputManager {
        ...
        static final int TRANSACTION_createInputForwarder = 30;
        static final int TRANSACTION_disableInputDevice = 5;
        static final int TRANSACTION_dumpInputDispatcher = 21;
        ...
        private static class Proxy implements IInputManager {
            ...
            public String dumpInputDispatcher() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    InputDevice _result5 = getInputDevice(data.readInt());
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    TouchCalibration _result7 = getTouchCalibrationForInputDevice(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 14:
                    ...
                    _result4 = getCurrentKeyboardLayoutForInputDevice(_arg0);
                    reply.writeNoException();
    ...
    String dumpInputDispatcher() throws RemoteException;
