...
public class GeomagneticField {
    ...
    static final /* synthetic */ boolean f75-assertionsDisabled = (GeomagneticField.class.desiredAssertionStatus() ^ 1);
    ...
    private static class LegendreTable {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f76-assertionsDisabled = (LegendreTable.class.desiredAssertionStatus() ^ 1);
        ...
        public LegendreTable(int maxN, float thetaRad) {
            ...
            while (n <= maxN) {
                ...
                while (m <= n) {
                    ...
                    } else if (f76-assertionsDisabled || (n > 1 && m < n - 1)) {
    ...
    public GeomagneticField(float gdLatitudeDeg, float gdLongitudeDeg, float altitudeMeters, long timeMillis) {
        ...
        if (f75-assertionsDisabled || G_COEFF.length == H_COEFF.length) {
            int m;
