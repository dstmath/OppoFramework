...
public interface IWifiChip extends android.hardware.wifi.V1_0.IWifiChip {
    ...
    public static abstract class Stub extends HwBinder implements IWifiChip {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IWifiChip.kInterfaceName, android.hardware.wifi.V1_0.IWifiChip.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
