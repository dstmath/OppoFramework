...
public interface ICameraService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraService {
        ...
        static final int TRANSACTION_checkCameraAlive = 15;
        ...
        static final int TRANSACTION_setOtherAppStickerSelect = 16;
        static final int TRANSACTION_setOtherAppVideoBeauty = 17;
        ...
        private static class Proxy implements ICameraService {
            ...
            public int checkCameraAlive(int cameraId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setOtherAppStickerSelect(String select_name) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(select_name);
            ...
            public void setOtherAppVideoBeauty(int level) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = connect(android.hardware.ICameraClient.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = connectLegacy(android.hardware.ICameraClient.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeStrongBinder(_result2 != null ? _result2.asBinder() : null);
                    return true;
                case 6:
                ...
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    _result = checkCameraAlive(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    setOtherAppStickerSelect(data.readString());
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    setOtherAppVideoBeauty(data.readInt());
                    reply.writeNoException();
                    return true;
    ...
    int checkCameraAlive(int i) throws RemoteException;
    ...
    void setOtherAppStickerSelect(String str) throws RemoteException;

    void setOtherAppVideoBeauty(int i) throws RemoteException;
