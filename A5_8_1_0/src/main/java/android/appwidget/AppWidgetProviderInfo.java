...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x001c A:{Splitter: B:1:0x0001, ExcHandler: android.content.pm.PackageManager.NameNotFoundException (e android.content.pm.PackageManager$NameNotFoundException)} */
