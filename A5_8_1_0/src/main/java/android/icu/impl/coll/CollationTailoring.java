...
public final class CollationTailoring {
    ...
    static final /* synthetic */ boolean f88-assertionsDisabled = (CollationTailoring.class.desiredAssertionStatus() ^ 1);
    ...
    CollationTailoring(Reference<CollationSettings> baseSettings) {
        ...
        } else if (!f88-assertionsDisabled && ((CollationSettings) baseSettings.readOnly()).reorderCodes.length != 0) {
            throw new AssertionError();
        } else if (!f88-assertionsDisabled && ((CollationSettings) baseSettings.readOnly()).reorderTable != null) {
            throw new AssertionError();
        } else if (f88-assertionsDisabled || ((CollationSettings) baseSettings.readOnly()).minHighNoReorder == 0) {
    ...
    void setRules(String r) {
        if (f88-assertionsDisabled || (this.rules == null && this.rulesResource == null)) {
            this.rules = r;
            return;
        }
        throw new AssertionError();
