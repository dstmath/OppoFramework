...
public final class FCDUTF16CollationIterator extends UTF16CollationIterator {
    ...
    static final /* synthetic */ boolean f98-assertionsDisabled = (FCDUTF16CollationIterator.class.desiredAssertionStatus() ^ 1);
    ...
    private void switchToForward() {
        int i;
        if (!f98-assertionsDisabled && ((this.checkDir >= 0 || this.seq != this.rawSeq) && (this.checkDir != 0 || this.pos != this.limit))) {
    ...
    private void nextSegment() {
        if (f98-assertionsDisabled || (this.checkDir > 0 && this.seq == this.rawSeq && this.pos != this.limit)) {
            int p = this.pos;
            int prevCC = 0;
            do {
                int q = p;
            ...
            this.segmentLimit = p;
            this.limit = p;
            if (f98-assertionsDisabled || this.pos != this.limit) {
                this.checkDir = 0;
                return;
            }
            throw new AssertionError();
    ...
    private void switchToBackward() {
        int i;
        if (!f98-assertionsDisabled && ((this.checkDir <= 0 || this.seq != this.rawSeq) && (this.checkDir != 0 || this.pos != this.start))) {
            throw new AssertionError();
        } else if (this.checkDir > 0) {
            i = this.pos;
            this.segmentLimit = i;
    ...
    private void previousSegment() {
        if (f98-assertionsDisabled || (this.checkDir < 0 && this.seq == this.rawSeq && this.pos != this.start)) {
            int p = this.pos;
            int nextCC = 0;
            do {
                int q = p;
            ...
            this.segmentStart = p;
            this.start = p;
            if (f98-assertionsDisabled || this.pos != this.start) {
                this.checkDir = 0;
                return;
            }
            throw new AssertionError();
