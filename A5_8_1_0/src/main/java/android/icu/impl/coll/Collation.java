...
public final class Collation {
    ...
    static final /* synthetic */ boolean f70-assertionsDisabled = (Collation.class.desiredAssertionStatus() ^ 1);
    ...
    static long ceFromSimpleCE32(int ce32) {
        if (f70-assertionsDisabled || (ce32 & 255) < 192) {
    ...
    static long ceFromCE32(int ce32) {
        ...
        if (f70-assertionsDisabled || (tertiary & 15) == 2) {
    ...
    static long decTwoBytePrimaryByOneStep(long basePrimary, boolean isCompressible, int step) {
        if (f70-assertionsDisabled || (step > 0 && step <= 127)) {
