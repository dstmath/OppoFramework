...
public final class TailoredSet {
    ...
    static final /* synthetic */ boolean f99-assertionsDisabled = (TailoredSet.class.desiredAssertionStatus() ^ 1);
    ...
    public void forData(CollationData d) {
        ...
        if (f99-assertionsDisabled || this.baseData != null) {
    ...
    private void handleCE32(int start, int end, int ce32) {
        if (f99-assertionsDisabled || ce32 != 192) {
    ...
    private void compare(int c, int ce32, int baseCE32) {
        ...
        if (Collation.isSpecialCE32(ce32)) {
            ...
            if (!f99-assertionsDisabled && tag == 8) {
                throw new AssertionError();
            } else if (!f99-assertionsDisabled && tag == 9) {
                throw new AssertionError();
            } else if (!f99-assertionsDisabled && tag == 14) {
                throw new AssertionError();
            }
        }
        tag = -1;
        if (Collation.isSpecialCE32(baseCE32)) {
            ...
            if (!f99-assertionsDisabled && baseTag == 8) {
                throw new AssertionError();
            } else if (!f99-assertionsDisabled && baseTag == 9) {
                throw new AssertionError();
            }
        }
        baseTag = -1;
    ...
    private void comparePrefixes(int c, CharSequence p, int pidx, CharSequence q, int qidx) {
        ...
        while (true) {
            ...
            if (!Utility.sameObjects(tp, none) || !Utility.sameObjects(bp, none)) {
                ...
                if (cmp < 0) {
                    if (f99-assertionsDisabled || te != null) {
                    ...
                    setPrefix(tp);
                    if (f99-assertionsDisabled || !(te == null || be == null)) {
                ...
                } else if (f99-assertionsDisabled || be != null) {
