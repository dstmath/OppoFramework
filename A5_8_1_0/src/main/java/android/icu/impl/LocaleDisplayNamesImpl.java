...
public class LocaleDisplayNamesImpl extends LocaleDisplayNames {
    ...
    private static final /* synthetic */ int[] f20x3d2c68e = null;
    /* renamed from: -android-icu-text-DisplayContext$TypeSwitchesValues */
    private static final /* synthetic */ int[] f21-android-icu-text-DisplayContext$TypeSwitchesValues = null;
    ...
    private static class Cache {
        /* renamed from: -android-icu-text-DisplayContext$TypeSwitchesValues */
        private static final /* synthetic */ int[] f22-android-icu-text-DisplayContext$TypeSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m5-getandroid-icu-text-DisplayContext$TypeSwitchesValues() {
            if (f22-android-icu-text-DisplayContext$TypeSwitchesValues != null) {
                return f22-android-icu-text-DisplayContext$TypeSwitchesValues;
            }
            ...
            f22-android-icu-text-DisplayContext$TypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        public LocaleDisplayNames get(ULocale locale, DisplayContext... contexts) {
            ...
            for (DisplayContext contextItem : contexts) {
                switch (m5-getandroid-icu-text-DisplayContext$TypeSwitchesValues()[contextItem.type().ordinal()]) {
                    case 1:
    ...
    private static /* synthetic */ int[] m3x6c76c532() {
        if (f20x3d2c68e != null) {
            return f20x3d2c68e;
        }
    ...
    /* renamed from: -getandroid-icu-text-DisplayContext$TypeSwitchesValues */
    private static /* synthetic */ int[] m4-getandroid-icu-text-DisplayContext$TypeSwitchesValues() {
        if (f21-android-icu-text-DisplayContext$TypeSwitchesValues != null) {
            return f21-android-icu-text-DisplayContext$TypeSwitchesValues;
        }
        int[] iArr = new int[Type.values().length];
        try {
            iArr[Type.CAPITALIZATION.ordinal()] = 1;
        ...
        f21-android-icu-text-DisplayContext$TypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public LocaleDisplayNamesImpl(ULocale locale, DisplayContext... contexts) {
        ...
        DisplayContext substituteHandling = DisplayContext.SUBSTITUTE;
        for (DisplayContext contextItem : contexts) {
            switch (m4-getandroid-icu-text-DisplayContext$TypeSwitchesValues()[contextItem.type().ordinal()]) {
                case 1:
    ...
    public DisplayContext getContext(Type type) {
        switch (m4-getandroid-icu-text-DisplayContext$TypeSwitchesValues()[type.ordinal()]) {
            case 1:
    ...
    public static boolean haveData(DataTableType type) {
        switch (m3x6c76c532()[type.ordinal()]) {
            case 1:
