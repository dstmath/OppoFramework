...
public class LocaleValidityChecker {
    /* renamed from: -android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues */
    private static final /* synthetic */ int[] f102-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues = null;
    /* renamed from: -android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues */
    private static final /* synthetic */ int[] f103-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues = null;
    /* renamed from: -android-icu-impl-locale-LocaleValidityChecker$SpecialCaseSwitchesValues */
    private static final /* synthetic */ int[] f104xbda2f04f = null;
    ...
    /* renamed from: -getandroid-icu-impl-ValidIdentifiers$DatatypeSwitchesValues */
    private static /* synthetic */ int[] m24-getandroid-icu-impl-ValidIdentifiers$DatatypeSwitchesValues() {
        if (f102-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues != null) {
            return f102-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues;
        }
        ...
        f102-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues */
    private static /* synthetic */ int[] m25-getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues() {
        if (f103-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues != null) {
            return f103-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues;
        }
        ...
        f103-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-impl-locale-LocaleValidityChecker$SpecialCaseSwitchesValues */
    private static /* synthetic */ int[] m26x211efcf3() {
        if (f104xbda2f04f != null) {
            return f104xbda2f04f;
        }
        ...
        if (isValid(Datatype.language, language, where)) {
            ...
            for (Character c : extensionKeys) {
                try {
                    ...
                    switch (m24-getandroid-icu-impl-ValidIdentifiers$DatatypeSwitchesValues()[datatype.ordinal()]) {
                        case 1:
                        case 2:
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                if (subtag.length() == 2 && (tBuffer == null || subtag.charAt(1) <= '9')) {
                    ...
                    typeCount++;
                    switch (m25-getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues()[valueType.ordinal()]) {
                        case 1:
                            if (typeCount != 1) {
                    ...
                    switch (m26x211efcf3()[specialCase.ordinal()]) {
                        case 1:
                            continue;
                        case 2:
                            try {
