...
public class LocaleExtensions {
    ...
    static final /* synthetic */ boolean f100-assertionsDisabled = (LocaleExtensions.class.desiredAssertionStatus() ^ 1);
    ...
    public Set<String> getUnicodeLocaleAttributes() {
        ...
        if (f100-assertionsDisabled || (ext instanceof UnicodeLocaleExtension)) {
