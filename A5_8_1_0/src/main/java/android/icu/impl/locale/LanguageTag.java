...
public class LanguageTag {
    ...
    static final /* synthetic */ boolean f19-assertionsDisabled = (LanguageTag.class.desiredAssertionStatus() ^ 1);
    ...
    public static LanguageTag parse(String languageTag, ParseStatus sts) {
        ...
        if (isGrandfathered) {
            if (!f19-assertionsDisabled && !itr.isDone()) {
                throw new AssertionError();
            } else if (f19-assertionsDisabled || !sts.isError()) {
