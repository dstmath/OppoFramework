...
public class CurrencyData {
    ...
    public static final class CurrencySpacingInfo {
        ...
        static final /* synthetic */ boolean f13-assertionsDisabled = (CurrencySpacingInfo.class.desiredAssertionStatus() ^ 1);
        ...
        public enum SpacingPattern {
            ...
            private SpacingPattern(int value) {
                if (!f14-assertionsDisabled && value != ordinal()) {
        ...
        public CurrencySpacingInfo(String... strings) {
            if (f13-assertionsDisabled || strings.length == 6) {
                int k = 0;
