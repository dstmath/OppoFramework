...
public class TimeZoneGenericNames implements Serializable, Freezable<TimeZoneGenericNames> {
    ...
    private static final /* synthetic */ int[] f65x63d98256 = null;
    /* renamed from: -android-icu-text-TimeZoneNames$NameTypeSwitchesValues */
    private static final /* synthetic */ int[] f66-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f67-assertionsDisabled = (TimeZoneGenericNames.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m19xcc7d80fa() {
        if (f65x63d98256 != null) {
            return f65x63d98256;
        }
    ...
    private static /* synthetic */ int[] m20-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
        if (f66-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
            return f66-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
        }
        ...
        f66-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public String getDisplayName(TimeZone tz, GenericNameType type, long date) {
        ...
        switch (m19xcc7d80fa()[type.ordinal()]) {
            case 1:
    ...
    private String formatGenericNonLocationName(TimeZone tz, GenericNameType type, long date) {
        if (f67-assertionsDisabled || type == GenericNameType.LONG || type == GenericNameType.SHORT) {
    ...
    private GenericMatchInfo createGenericMatchInfo(MatchInfo matchInfo) {
        ...
        switch (m20-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[matchInfo.nameType().ordinal()]) {
            case 1:
        ...
        if (tzID == null) {
            ...
            if (f67-assertionsDisabled || mzID != null) {
                tzID = this._tznames.getReferenceZoneID(mzID, getTargetRegion());
            } else {
                throw new AssertionError();
            }
        }
        if (f67-assertionsDisabled || tzID != null) {
