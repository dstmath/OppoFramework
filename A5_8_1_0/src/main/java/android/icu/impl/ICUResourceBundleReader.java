...
public final class ICUResourceBundleReader {
    ...
    static final /* synthetic */ boolean f23-assertionsDisabled = (ICUResourceBundleReader.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class ResourceCache {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f24-assertionsDisabled = (ResourceCache.class.desiredAssertionStatus() ^ 1);
        ...
        private static final class Level {
            /* renamed from: -assertionsDisabled */
            static final /* synthetic */ boolean f25-assertionsDisabled = (Level.class.desiredAssertionStatus() ^ 1);
            int[] keys;
            int levelBitsList;
            int mask;
            int shift;
            ...
            Level(int levelBitsList, int shift) {
                ...
                if (f25-assertionsDisabled || bits != 0) {
                    int length = 1 << bits;
                    this.mask = length - 1;
        ...
        private static final Object putIfCleared(Object[] values, int index, Object item, int size) {
            ...
            if (f24-assertionsDisabled || size >= 24) {
        ...
        ResourceCache(int maxOffset) {
            if (f24-assertionsDisabled || maxOffset != 0) {
     ...
     */
        ...
        synchronized Object get(int res) {
            if (f24-assertionsDisabled || ICUResourceBundleReader.RES_GET_OFFSET(res) != 0) {
                Object value;
                if (this.length >= 0) {
    ...
    String getStringV2(int res) {
        if (f23-assertionsDisabled || RES_GET_TYPE(res) == 6) {
            int offset = RES_GET_OFFSET(res);
            if (f23-assertionsDisabled || offset != 0) {
