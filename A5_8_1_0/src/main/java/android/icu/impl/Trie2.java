...
public abstract class Trie2 implements Iterable<Range> {
    ...
    private static final /* synthetic */ int[] f32-android-icu-impl-Trie2$ValueWidthSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m7-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues() {
        if (f32-android-icu-impl-Trie2$ValueWidthSwitchesValues != null) {
            return f32-android-icu-impl-Trie2$ValueWidthSwitchesValues;
        }
        ...
        f32-android-icu-impl-Trie2$ValueWidthSwitchesValues = iArr;
        return iArr;
    }
        ...
        try {
            ...
            switch (header.signature) {
                ...
                case 1416784178:
                    ...
                    switch (m7-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues()[width.ordinal()]) {
                        case 1:
                            This.data32 = null;
