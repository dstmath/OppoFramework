...
public class Trie2Writable extends Trie2 {
    ...
    static final /* synthetic */ boolean f37-assertionsDisabled = (Trie2Writable.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m10-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues() {
    ...
    private void freeze(Trie2 dest, ValueWidth valueBits) {
        ...
        switch (m10-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues()[valueBits.ordinal()]) {
            case 1:
                if (f37-assertionsDisabled || destIdx2 == dataMove) {
