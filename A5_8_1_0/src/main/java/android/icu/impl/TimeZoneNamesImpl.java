...
public class TimeZoneNamesImpl extends TimeZoneNames {
    ...
    private static class NameSearchHandler implements ResultHandler<NameInfo> {
        ...
        static final /* synthetic */ boolean f60-assertionsDisabled = (NameSearchHandler.class.desiredAssertionStatus() ^ 1);
        ...
        public boolean handlePrefixMatch(int matchLength, Iterator<NameInfo> values) {
            while (values.hasNext()) {
                ...
                if (this._nameTypes == null || (this._nameTypes.contains(ninfo.type) ^ 1) == 0) {
                    ...
                    } else if (f60-assertionsDisabled || ninfo.mzID != null) {
    ...
    private static class ZNames {
        /* renamed from: -android-icu-impl-TimeZoneNamesImpl$ZNames$NameTypeIndexSwitchesValues */
        private static final /* synthetic */ int[] f61x1bd5c820 = null;
        /* renamed from: -android-icu-text-TimeZoneNames$NameTypeSwitchesValues */
        private static final /* synthetic */ int[] f62-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
        ...
        /* renamed from: -getandroid-icu-impl-TimeZoneNamesImpl$ZNames$NameTypeIndexSwitchesValues */
        private static /* synthetic */ int[] m17xeb74adc4() {
            if (f61x1bd5c820 != null) {
                return f61x1bd5c820;
            }
        ...
        private static /* synthetic */ int[] m18-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
            if (f62-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
                return f62-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
            }
            ...
            f62-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
            return iArr;
        }

        private static int getNameTypeIndex(NameType type) {
            switch (m18-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[type.ordinal()]) {
                case 1:
                ...
                default:
                    try {
                        throw new AssertionError("No NameTypeIndex match for " + type + " class is " + type.getClass().toString() + " SHORT_STANDARD =" + NameType.SHORT_STANDARD);
        ...
        private static NameType getNameType(int index) {
            switch (m17xeb74adc4()[NameTypeIndex.values[index].ordinal()]) {
                case 1:
    ...
    private static final class ZNamesLoader extends Sink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f63-assertionsDisabled = (ZNamesLoader.class.desiredAssertionStatus() ^ 1);
        ...
        void loadNames(ICUResourceBundle zoneStrings, String key) {
            if (!f63-assertionsDisabled && zoneStrings == null) {
                throw new AssertionError();
            } else if (!f63-assertionsDisabled && key == null) {
                throw new AssertionError();
            } else if (f63-assertionsDisabled || key.length() > 0) {
                this.names = null;
                try {
        ...
        private void setNameIfEmpty(Key key, Value value) {
            ...
            if (index != null) {
                if (f63-assertionsDisabled || index.ordinal() < 7) {
        ...
        public void put(Key key, Value value, boolean noFallback) {
            ...
            while (namesTable.getKeyAndValue(i, key, value)) {
                if (f63-assertionsDisabled || value.getType() == 0) {
    ...
    private final class ZoneStringsLoader extends Sink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f64-assertionsDisabled = (ZoneStringsLoader.class.desiredAssertionStatus() ^ 1);
        ...
        public void put(Key key, Value value, boolean noFallback) {
            ...
            while (timeZonesTable.getKeyAndValue(j, key, value)) {
                if (f64-assertionsDisabled || !value.isNoInheritanceMarker()) {
                    if (value.getType() == 2) {
