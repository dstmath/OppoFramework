...
public class TZDBTimeZoneNames extends TimeZoneNames {
    ...
    private static class TZDBNameSearchHandler implements ResultHandler<TZDBNameInfo> {
        ...
        static final /* synthetic */ boolean f58-assertionsDisabled = (TZDBNameSearchHandler.class.desiredAssertionStatus() ^ 1);
        ...
        TZDBNameSearchHandler(EnumSet<NameType> nameTypes, String region) {
            ...
            if (f58-assertionsDisabled || region != null) {
                this._region = region;
                return;
            }
    ...
    private static class TZDBNames {
        ...
        private static final /* synthetic */ int[] f59-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m16-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
            if (f59-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
                return f59-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
            }
            ...
            f59-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        String getName(NameType type) {
            ...
            String name = null;
            switch (m16-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[type.ordinal()]) {
                case 1:
                    name = this._names[1];
                    break;
                case 2:
