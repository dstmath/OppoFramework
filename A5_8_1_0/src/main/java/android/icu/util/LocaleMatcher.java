...
public class LocaleMatcher {
    ...
    public static class LanguageMatcherData implements Freezable<LanguageMatcherData> {
        ...
        private static final /* synthetic */ int[] f134-android-icu-util-LocaleMatcher$LevelSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m35-getandroid-icu-util-LocaleMatcher$LevelSwitchesValues() {
            if (f134-android-icu-util-LocaleMatcher$LevelSwitchesValues != null) {
                return f134-android-icu-util-LocaleMatcher$LevelSwitchesValues;
            }
            ...
            f134-android-icu-util-LocaleMatcher$LevelSwitchesValues = iArr;
            return iArr;
        }
        ...
        private LanguageMatcherData addDistance(String desired, String supported, int percent, boolean oneway, String comment) {
            ...
            switch (m35-getandroid-icu-util-LocaleMatcher$LevelSwitchesValues()[desiredLen.ordinal()]) {
                case 1:
