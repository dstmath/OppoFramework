...
public class GenderInfo {
    /* renamed from: -android-icu-util-GenderInfo$GenderSwitchesValues */
    private static final /* synthetic */ int[] f132-android-icu-util-GenderInfo$GenderSwitchesValues = null;
    /* renamed from: -android-icu-util-GenderInfo$ListGenderStyleSwitchesValues */
    private static final /* synthetic */ int[] f133-android-icu-util-GenderInfo$ListGenderStyleSwitchesValues = null;
    ...
    /* renamed from: -getandroid-icu-util-GenderInfo$GenderSwitchesValues */
    private static /* synthetic */ int[] m33-getandroid-icu-util-GenderInfo$GenderSwitchesValues() {
        if (f132-android-icu-util-GenderInfo$GenderSwitchesValues != null) {
            return f132-android-icu-util-GenderInfo$GenderSwitchesValues;
        }
        ...
        f132-android-icu-util-GenderInfo$GenderSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-util-GenderInfo$ListGenderStyleSwitchesValues */
    private static /* synthetic */ int[] m34-getandroid-icu-util-GenderInfo$ListGenderStyleSwitchesValues() {
        if (f133-android-icu-util-GenderInfo$ListGenderStyleSwitchesValues != null) {
            return f133-android-icu-util-GenderInfo$ListGenderStyleSwitchesValues;
        }
        ...
        f133-android-icu-util-GenderInfo$ListGenderStyleSwitchesValues = iArr;
        return iArr;
    }
    ...
    public Gender getListGender(List<Gender> genders) {
        ...
        switch (m34-getandroid-icu-util-GenderInfo$ListGenderStyleSwitchesValues()[this.style.ordinal()]) {
            case 1:
            ...
            case 2:
                ...
                for (Gender gender2 : genders) {
                    switch (m33-getandroid-icu-util-GenderInfo$GenderSwitchesValues()[gender2.ordinal()]) {
                        case 1:
                            if (!hasMale) {
                                hasFemale = true;
                                break;
