...
public abstract class UResourceBundle extends ResourceBundle {
    /* renamed from: -android-icu-util-UResourceBundle$RootTypeSwitchesValues */
    private static final /* synthetic */ int[] f1-android-icu-util-UResourceBundle$RootTypeSwitchesValues = null;
    ...
    /* renamed from: -getandroid-icu-util-UResourceBundle$RootTypeSwitchesValues */
    private static /* synthetic */ int[] m0-getandroid-icu-util-UResourceBundle$RootTypeSwitchesValues() {
        if (f1-android-icu-util-UResourceBundle$RootTypeSwitchesValues != null) {
            return f1-android-icu-util-UResourceBundle$RootTypeSwitchesValues;
        }
        ...
        f1-android-icu-util-UResourceBundle$RootTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    protected static UResourceBundle instantiateBundle(String baseName, String localeName, ClassLoader root, boolean disableFallback) {
        switch (m0-getandroid-icu-util-UResourceBundle$RootTypeSwitchesValues()[getRootType(baseName, root).ordinal()]) {
            case 1:
