...
public abstract class TimeZone implements Serializable, Cloneable, Freezable<TimeZone> {
    ...
    static final /* synthetic */ boolean f28-assertionsDisabled = (TimeZone.class.desiredAssertionStatus() ^ 1);
    ...
    private String _getDisplayName(int style, boolean daylight, ULocale locale) {
        ...
        } else if (f28-assertionsDisabled || style == 1 || style == 0 || style == 6) {
            date = System.currentTimeMillis();
        ...
        if (f28-assertionsDisabled || result != null) {
            return result;
        }
        throw new AssertionError();
    }
