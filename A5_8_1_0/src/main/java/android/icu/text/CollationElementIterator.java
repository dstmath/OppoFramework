...
public final class CollationElementIterator {
    ...
    static final /* synthetic */ boolean f105-assertionsDisabled = (CollationElementIterator.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class MaxExpSink implements CESink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f106-assertionsDisabled = (MaxExpSink.class.desiredAssertionStatus() ^ 1);
        ...
        public void handleExpansion(long[] ces, int start, int length) {
            if (length > 1) {
                ...
                if (lastHalf == 0) {
                    ...
                    if (!f106-assertionsDisabled && lastHalf == 0) {
    ...
    public int getOffset() {
        ...
        if (f105-assertionsDisabled || i < this.offsets_.size()) {
