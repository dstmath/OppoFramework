...
public class SimpleDateFormat extends DateFormat {
    ...
    private static final /* synthetic */ int[] f80-android-icu-text-DisplayContextSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f81-assertionsDisabled = (SimpleDateFormat.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m22-getandroid-icu-text-DisplayContextSwitchesValues() {
        if (f80-android-icu-text-DisplayContextSwitchesValues != null) {
            return f80-android-icu-text-DisplayContextSwitchesValues;
        }
        ...
        f80-android-icu-text-DisplayContextSwitchesValues = iArr;
        return iArr;
    }
        ...
        if (patternCharIndex != -1) {
            ...
            switch (patternCharIndex) {
                ...
                case 36:
                    ...
                    if (f81-assertionsDisabled || periodType != null) {
                        int index;
                        toAppend = null;
            ...
            if (fieldNum == 0 && capitalizationContext != null && UCharacter.isLowerCase(buf.codePointAt(bufstart))) {
                ...
                switch (m22-getandroid-icu-text-DisplayContextSwitchesValues()[capitalizationContext.ordinal()]) {
                    case 1:
                        titlecase = true;
                        break;
                    case 2:
    ...
    public void parse(String text, Calendar cal, ParsePosition parsePos) {
        ...
        if (output.value != null) {
            ...
            if (cal.isSet(10) || (cal.isSet(11) ^ 1) == 0) {
                ...
                if (!f81-assertionsDisabled && (hourOfDay < 0 || hourOfDay > 23)) {
                    throw new AssertionError();
