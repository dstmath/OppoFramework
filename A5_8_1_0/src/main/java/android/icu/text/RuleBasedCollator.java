...
public final class RuleBasedCollator extends Collator {
    ...
    static final /* synthetic */ boolean f111-assertionsDisabled = (RuleBasedCollator.class.desiredAssertionStatus() ^ 1);
    ...
    public RuleBasedCollator setMaxVariable(int group) {
        ...
        if (f111-assertionsDisabled || varTop != 0) {
    ...
    private void internalSetVariableTop(long varTop) {
        if (varTop != ((CollationSettings) this.settings.readOnly()).variableTop) {
            ...
            if (f111-assertionsDisabled || (v != 0 && v >= varTop)) {
                varTop = v;
    ...
    public long[] internalGetCEs(CharSequence str) {
        ...
        try {
            ...
            if (f111-assertionsDisabled || (length >= 0 && iter.getCE(length) == Collation.NO_CE)) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!f111-assertionsDisabled && thisIsRoot && otherIsRoot) {
            throw new AssertionError();
    ...
    private void adoptTailoring(CollationTailoring t) {
        if (f111-assertionsDisabled || (this.settings == null && this.data == null && this.tailoring == null)) {
            this.data = t.data;
            this.settings = t.settings.clone();
            this.tailoring = t;
    ...
    void setLocale(ULocale valid, ULocale actual) {
        ...
        if (Utility.objectEquals(actual, this.tailoring.actualLocale)) {
            this.actualLocaleIsSameAsValid = false;
        } else if (f111-assertionsDisabled || Utility.objectEquals(actual, valid)) {
