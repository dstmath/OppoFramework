...
public class PluralFormat extends UFormat {
    ...
    static final /* synthetic */ boolean f122-assertionsDisabled = (PluralFormat.class.desiredAssertionStatus() ^ 1);
    ...
    private final class PluralSelectorAdapter implements PluralSelector {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f123-assertionsDisabled = (PluralSelectorAdapter.class.desiredAssertionStatus() ^ 1);
    ...
    static int findSubMessage(MessagePattern pattern, int partIndex, PluralSelector selector, Object context, double number) {
        ...
        while (true) {
            ...
            if (type == Type.ARG_LIMIT) {
                ...
                break;
            } else if (f122-assertionsDisabled || type == Type.ARG_SELECTOR) {
