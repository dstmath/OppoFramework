...
public final class RelativeDateTimeFormatter {
    /* renamed from: -android-icu-text-RelativeDateTimeFormatter$RelativeDateTimeUnitSwitchesValues */
    private static final /* synthetic */ int[] f126x8fde38b3 = null;
    ...
    private static final class RelDateTimeDataSink extends Sink {
        ...
        private static final /* synthetic */ int[] f127-android-icu-text-RelativeDateTimeFormatter$StyleSwitchesValues = null;
        int pastFutureIndex;
        ...
        private static /* synthetic */ int[] m32x1891118d() {
            if (f127-android-icu-text-RelativeDateTimeFormatter$StyleSwitchesValues != null) {
                return f127-android-icu-text-RelativeDateTimeFormatter$StyleSwitchesValues;
            }
            ...
            f127-android-icu-text-RelativeDateTimeFormatter$StyleSwitchesValues = iArr;
            return iArr;
        }
        ...
        private static int styleSuffixLength(Style style) {
            switch (m32x1891118d()[style.ordinal()]) {
                case 1:
                    return 7;
                case 2:
                    return 6;
    ...
    /* renamed from: -getandroid-icu-text-RelativeDateTimeFormatter$RelativeDateTimeUnitSwitchesValues */
    private static /* synthetic */ int[] m31x149f3a57() {
        if (f126x8fde38b3 != null) {
            return f126x8fde38b3;
        }
    ...
    public String formatNumeric(double offset, RelativeDateTimeUnit unit) {
        ...
        switch (m31x149f3a57()[unit.ordinal()]) {
            case 1:
