...
class QuantityFormatter {
    ...
    static final /* synthetic */ boolean f120-assertionsDisabled = (QuantityFormatter.class.desiredAssertionStatus() ^ 1);
    ...
    public String format(double number, NumberFormat numberFormat, PluralRules pluralRules) {
        ...
        if (formatter == null) {
            ...
            if (!f120-assertionsDisabled && formatter == null) {
    ...
    public SimpleFormatter getByVariant(CharSequence variant) {
        if (f120-assertionsDisabled || isValid()) {
