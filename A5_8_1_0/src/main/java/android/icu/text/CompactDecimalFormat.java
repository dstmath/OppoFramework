...
public class CompactDecimalFormat extends DecimalFormat {
    ...
    private static final /* synthetic */ int[] f119xc9609b6e = null;
    ...
    private static /* synthetic */ int[] m29x2869bf4a() {
        if (f119xc9609b6e != null) {
            return f119xc9609b6e;
        }
    ...
    private Data getData(ULocale locale, CompactStyle style) {
        ...
        switch (m29x2869bf4a()[style.ordinal()]) {
            case 1:
