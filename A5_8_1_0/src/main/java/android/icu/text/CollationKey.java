...
public final class CollationKey implements Comparable<CollationKey> {
    ...
    static final /* synthetic */ boolean f117-assertionsDisabled = (CollationKey.class.desiredAssertionStatus() ^ 1);
    ...
    public CollationKey(String source, RawCollationKey key) {
        ...
        if (f117-assertionsDisabled || this.m_key_[this.m_length_] == (byte) 0) {
            this.m_hashCode_ = 0;
            return;
        }
    ...
    public CollationKey merge(CollationKey source) {
        ...
        if (f117-assertionsDisabled || rindex == result.length - 1) {
