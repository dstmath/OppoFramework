...
public class SelectFormat extends Format {
    ...
    static final /* synthetic */ boolean f125-assertionsDisabled = (SelectFormat.class.desiredAssertionStatus() ^ 1);
    ...
    static int findSubMessage(MessagePattern pattern, int partIndex, String keyword) {
        ...
        while (true) {
            ...
            if (type == Type.ARG_LIMIT) {
                ...
                break;
            } else if (f125-assertionsDisabled || type == Type.ARG_SELECTOR) {
