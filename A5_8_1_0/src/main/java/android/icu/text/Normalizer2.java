...
public abstract class Normalizer2 {
    ...
    private static final /* synthetic */ int[] f31-android-icu-text-Normalizer2$ModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m6-getandroid-icu-text-Normalizer2$ModeSwitchesValues() {
        if (f31-android-icu-text-Normalizer2$ModeSwitchesValues != null) {
            return f31-android-icu-text-Normalizer2$ModeSwitchesValues;
        }
        ...
        f31-android-icu-text-Normalizer2$ModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static Normalizer2 getInstance(InputStream data, String name, Mode mode) {
        ...
        switch (m6-getandroid-icu-text-Normalizer2$ModeSwitchesValues()[mode.ordinal()]) {
            case 1:
