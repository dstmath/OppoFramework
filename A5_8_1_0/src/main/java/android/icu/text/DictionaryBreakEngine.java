...
abstract class DictionaryBreakEngine implements LanguageBreakEngine {
    ...
    static class DequeI {
        ...
        static final /* synthetic */ boolean f115-assertionsDisabled = (DequeI.class.desiredAssertionStatus() ^ 1);
        ...
        void offer(int v) {
            if (f115-assertionsDisabled || this.lastIdx > 0) {
                int[] iArr = this.data;
        ...
        int pop() {
            if (f115-assertionsDisabled || size() > 0) {
                int[] iArr = this.data;
