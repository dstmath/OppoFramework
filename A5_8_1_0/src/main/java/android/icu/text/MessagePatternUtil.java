...
public final class MessagePatternUtil {
    ...
    private static final /* synthetic */ int[] f121-android-icu-text-MessagePattern$ArgTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m30-getandroid-icu-text-MessagePattern$ArgTypeSwitchesValues() {
        if (f121-android-icu-text-MessagePattern$ArgTypeSwitchesValues != null) {
            return f121-android-icu-text-MessagePattern$ArgTypeSwitchesValues;
        }
        ...
        f121-android-icu-text-MessagePattern$ArgTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static ArgNode buildArgNode(MessagePattern pattern, int start, int limit) {
        ...
        start++;
        switch (m30-getandroid-icu-text-MessagePattern$ArgTypeSwitchesValues()[argType.ordinal()]) {
            case 1:
