        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    _arg7 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg8 = (ComponentName) ComponentName.CREATOR.createFromParcel(data);
                    } else {
                        _arg8 = null;
                    }
                    _result = startSession(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 3:
                ...
                case 6:
                    ...
                    _result = updateOrRestartSession(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 7:
