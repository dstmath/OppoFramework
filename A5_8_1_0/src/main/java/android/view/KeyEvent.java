...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public final boolean dispatch(Callback receiver, DispatcherState state, Object target) {
        if (InputLog.isOpenAllLog() && (DEBUG ^ 1) != 0) {
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "Jianhua.Lin@Plf.SDK : Add for accidentally touch", property = OppoRomType.ROM)
    public final void resetCanceled() {
        this.mFlags &= -33;
    }
}
