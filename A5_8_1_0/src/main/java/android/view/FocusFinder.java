...
public class FocusFinder {
    ...
    static final class FocusSorter {
        ...
        /* renamed from: lambda$-android_view_FocusFinder$FocusSorter_31343 */
        /* synthetic */ int m8lambda$-android_view_FocusFinder$FocusSorter_31343(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        /* renamed from: lambda$-android_view_FocusFinder$FocusSorter_31803 */
        /* synthetic */ int m9lambda$-android_view_FocusFinder$FocusSorter_31803(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = (Rect) this.mRectByView.get(first);
    ...
    /* renamed from: lambda$-android_view_FocusFinder_1877 */
    static /* synthetic */ View m6lambda$-android_view_FocusFinder_1877(View r, View v) {
        return isValidId(v.getNextFocusForwardId()) ? v.findUserSetNextFocus(r, 2) : null;
    }

    /* renamed from: lambda$-android_view_FocusFinder_2135 */
    static /* synthetic */ View m7lambda$-android_view_FocusFinder_2135(View r, View v) {
