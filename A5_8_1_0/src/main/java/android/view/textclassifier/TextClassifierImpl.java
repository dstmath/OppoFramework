    ...
    private String getVersionInfo() {
        synchronized (this.mSmartSelectionLock) {
            ...
            if (this.mLocale != null) {
                format = String.format("%s_v%d", new Object[]{this.mLocale.toLanguageTag(), Integer.valueOf(this.mVersion)});
                return format;
            }
            format = "";
            return format;
    ...
    private ParcelFileDescriptor getFdLocked(Locale locale) throws FileNotFoundException {
        ...
        if (updateFd != null) {
            ...
            if (factoryFd == null) {
                ...
                int factoryVersion = SmartSelection.getVersion(factoryFd.getFd());
