...
public final class TextSelection {
    ...
    public static final class Builder {
        ...
        public TextSelection build() {
            return new TextSelection(this.mStartIndex, this.mEndIndex, this.mEntityConfidence, this.mLogSource, this.mVersionInfo, null);
        }
    }

    /* synthetic */ TextSelection(int startIndex, int endIndex, EntityConfidence entityConfidence, String logSource, String versionInfo, TextSelection -this5) {
        this(startIndex, endIndex, entityConfidence, logSource, versionInfo);
    }
