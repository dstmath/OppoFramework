...
public final class TextClassification {
    ...
    public static final class Builder {
        ...
        public TextClassification build() {
            return new TextClassification(this.mText, this.mIcon, this.mLabel, this.mIntent, this.mOnClickListener, this.mEntityConfidence, this.mLogType, this.mVersionInfo, null);
        }
    }

    /* synthetic */ TextClassification(String text, Drawable icon, String label, Intent intent, OnClickListener onClickListener, EntityConfidence entityConfidence, int logType, String versionInfo, TextClassification -this8) {
        this(text, icon, label, intent, onClickListener, entityConfidence, logType, versionInfo);
    }
