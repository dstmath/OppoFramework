...
public final class Display {
    ...
    public void getSize(Point outSize) {
        synchronized (this) {
            ...
            if (isInFullScreenMode()) {
                if (this.mTempMetrics.widthPixels == this.mDisplayInfo.appWidth && this.mTempMetrics.heightPixels == this.mDisplayInfo.appHeight) {
                    outSize.x = this.mDisplayInfo.logicalWidth;
                    outSize.y = this.mDisplayInfo.logicalHeight;
                }
            } else if (isInFullScreenModeWithoutGroove() && this.mTempMetrics.widthPixels == this.mDisplayInfo.appWidth && this.mTempMetrics.heightPixels == this.mDisplayInfo.appHeight) {
    ...
    public void getMetrics(DisplayMetrics outMetrics) {
        synchronized (this) {
            ...
            if (isInFullScreenMode()) {
                ...
                this.mDisplayInfo.getAppMetrics(outMetrics, getDisplayAdjustments());
            } else if (this.mTempMetrics.widthPixels == this.mDisplayInfo.appWidth && this.mTempMetrics.heightPixels == this.mDisplayInfo.appHeight) {
                this.mDisplayInfo.getLogicalMetrics(outMetrics, CompatibilityInfo.DEFAULT_COMPATIBILITY_INFO, null);
    ...
    public void getRealSize(Point outSize) {
        int i = PreciseDisconnectCause.SIP_SERVER_ERROR;
        synchronized (this) {
            updateDisplayInfoLocked();
            outSize.x = this.mDisplayInfo.logicalWidth;
            outSize.y = this.mDisplayInfo.logicalHeight;
