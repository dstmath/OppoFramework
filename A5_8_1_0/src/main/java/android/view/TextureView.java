...
public class TextureView extends View {
    ...
    private static final String PKG_NAME_OF_GENGMEI_APP = "com.wanmeizhensuo.zhensuo";
    private static final String PKG_NAME_OF_WUBABANGJOB_APP = "com.wuba.bangjob";
    private boolean mCallBackSizeChangeWhenLayerUpdate;
    ...
    private boolean mNeedUpdateLayer;
    private boolean mOpaque;
    private boolean mReleaseTextureWhenDestory;
    ...
    public TextureView(Context context, AttributeSet attrs) {
        ...
        this.mReleaseTextureWhenDestory = false;
        this.mCallBackSizeChangeWhenLayerUpdate = false;
        checkFlagForUpdateLayer(context);
    }
    ...
    private void checkFlagForUpdateLayer(Context context) {
        if (context != null) {
            String pkgName = context.getPackageName();
            if (pkgName != null && !pkgName.isEmpty()) {
                if (pkgName.contains(PKG_NAME_OF_GENGMEI_APP) || pkgName.contains(PKG_NAME_OF_WUBABANGJOB_APP)) {
                    this.mNeedUpdateLayer = false;
                    Log.d(LOG_TAG, "mNeedUpdateLayer = false : " + pkgName);
                }
            }
        }
    }
    ...
    protected void destroyHardwareResources() {
        ...
        if (this.mReleaseTextureWhenDestory) {
            releaseSurfaceTexture();
            destroyHardwareLayer();
    ...
    HardwareLayer getHardwareLayer() {
        boolean sizeChangeWhenUpdateLayer = false;
        if (this.mLayer == null) {
            ...
            sizeChangeWhenUpdateLayer = true;
            this.mLayer.setLayerPaint(this.mLayerPaint);
        }
        ...
        if (this.mCallBackSizeChangeWhenLayerUpdate && sizeChangeWhenUpdateLayer && this.mListener != null) {
            this.mListener.onSurfaceTextureSizeChanged(this.mSurface, getWidth(), getHeight());
        }
        return this.mLayer;
    }
