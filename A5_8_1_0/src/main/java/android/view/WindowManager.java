...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        public static final int PRIVATE_FLAG_APP_CUSTOM_NAVIGATION_BAR = 33554432;
        ...
        @OppoHook(level = OppoHookType.NEW_FIELD, note = "JianHui.Yu@ROM.SDK, 2017-11-08 : Add for Longshot 5.0", property = OppoRomType.ROM)
        public final ColorLayoutParams mColorLayoutParams;
        ...
        public LayoutParams() {
            ...
            this.mTitle = null;
            this.mColorLayoutParams = new ColorLayoutParams();
            this.type = 2;
            this.format = -1;
        }
