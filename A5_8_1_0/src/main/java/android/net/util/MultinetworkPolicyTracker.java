...
public class MultinetworkPolicyTracker {
    ...
    /* renamed from: lambda$-android_net_util_MultinetworkPolicyTracker_2908 */
    /* synthetic */ void m99lambda$-android_net_util_MultinetworkPolicyTracker_2908(Runnable avoidBadWifiCallback) {
    ...
    public boolean updateAvoidBadWifi() {
        boolean z;
        boolean settingAvoidBadWifi = LocationManagerService.OPPO_FAKE_LOCATOIN_SWITCH_ON.equals(getAvoidBadWifiSetting());
