...
public class IpManager extends StateMachine {
    ...
    private static final /* synthetic */ int[] f45-android-net-LinkProperties$ProvisioningChangeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m96-getandroid-net-LinkProperties$ProvisioningChangeSwitchesValues() {
        if (f45-android-net-LinkProperties$ProvisioningChangeSwitchesValues != null) {
            return f45-android-net-LinkProperties$ProvisioningChangeSwitchesValues;
        }
        ...
        f45-android-net-LinkProperties$ProvisioningChangeSwitchesValues = iArr;
        return iArr;
    }
    ...
    IpManager(Context context, String ifName, Callback callback, INetworkManagementService nwService, INetd netd) {
        ...
        this.mNetlinkTracker = new NetlinkTracker(this.mInterfaceName, new com.android.server.net.NetlinkTracker.Callback() {
            ...
            /* renamed from: lambda$-android_net_ip_IpManager$2_26954 */
            /* synthetic */ void m98lambda$-android_net_ip_IpManager$2_26954(String msg) {
    ...
    /* renamed from: lambda$-android_net_ip_IpManager_27235 */
    /* synthetic */ void m97lambda$-android_net_ip_IpManager_27235() {
    ...
    private void dispatchCallback(ProvisioningChange delta, LinkProperties newLp) {
        switch (m96-getandroid-net-LinkProperties$ProvisioningChangeSwitchesValues()[delta.ordinal()]) {
            case 1:
                recordMetric(1);
                this.mCallback.onProvisioningSuccess(newLp);
                return;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:4:0x0015 A:{Splitter: B:1:0x0002, ExcHandler: java.lang.IllegalStateException (r0_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Removed duplicated region for block: B:4:0x0015 A:{Splitter: B:1:0x0002, ExcHandler: java.lang.IllegalStateException (r0_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:4:0x0015, code:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:5:0x0016, code:
            logError("Unable to change interface settings: %s", r0);
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x0042 A:{Splitter: B:8:0x002e, ExcHandler: android.os.ServiceSpecificException (r2_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:11:0x0042, code:
            r2 = move-exception;
     */
    /* JADX WARNING: Missing block: B:12:0x0043, code:
            logError("failed to add %s to %s: %s", r0, r10.mInterfaceName, r2);
     */
