    ...
    public static AndroidHttpClient newInstance(String userAgent, Context context) {
        ...
        try {
            ...
            if (userAgent.contains("Android-Mms")) {
                ...
                Method getBoolean = systemProperties.getDeclaredMethod("getBoolean", new Class[]{String.class, Boolean.TYPE});
                getBoolean.setAccessible(true);
                if (((Boolean) getBoolean.invoke(systemProperties.newInstance(), new Object[]{"persist.sys.permission.enable", Boolean.valueOf(false)})).booleanValue()) {
                    Method getService = Class.forName("android.os.ServiceManager").getDeclaredMethod("getService", new Class[]{String.class});
                    getService.setAccessible(true);
                    IBinder permisisonBinder = (IBinder) getService.invoke(systemProperties.newInstance(), new Object[]{"permission"});
                    Method asInterface = Class.forName("android.os.IPermissionController$Stub").getDeclaredMethod("asInterface", new Class[]{IBinder.class});
                    asInterface.setAccessible(true);
                    Method checkPermission = Class.forName("android.os.IPermissionController").getDeclaredMethod("checkPermission", new Class[]{String.class, Integer.TYPE, Integer.TYPE});
                    checkPermission.setAccessible(true);
                    Boolean checkResult = (Boolean) checkPermission.invoke(asInterface.invoke(null, new Object[]{permisisonBinder}), new Object[]{"android.permission.SEND_MMS", Integer.valueOf(Process.myPid()), Integer.valueOf(Process.myUid())});
