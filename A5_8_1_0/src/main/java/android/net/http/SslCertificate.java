...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate(17367275, null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909379)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909381)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909383)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909255)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16908763)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16908765)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16908767)).setText(issuedBy.getUName());
        }
        ((TextView) certificateView.findViewById(16908983)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16908852)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909262)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909260)).setText(getDigest(this.mX509Certificate, "SHA1"));
