...
public class LowpanCommissioningSession {
    ...
    private final ILowpanInterfaceListener mInternalCallback = new InternalCallback(this, null);
    ...
    private class InternalCallback extends Stub {
        /* synthetic */ InternalCallback(LowpanCommissioningSession this$0, InternalCallback -this1) {
            this();
        }
        ...
        public void onStateChanged(String value) {
            if (!LowpanCommissioningSession.this.mIsClosed) {
                if (value.equals("offline") || value.equals("fault")) {
        ...
        /* renamed from: lambda$-android_net_lowpan_LowpanCommissioningSession$InternalCallback_2366 */
        /* synthetic */ void m47xc1833cb6(byte[] packet) {
            synchronized (LowpanCommissioningSession.this) {
    ...
    /* renamed from: lambda$-android_net_lowpan_LowpanCommissioningSession_4529 */
    /* synthetic */ void m46lambda$-android_net_lowpan_LowpanCommissioningSession_4529() {
