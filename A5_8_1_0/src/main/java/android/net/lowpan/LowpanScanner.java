...
public class LowpanScanner {
    ...
    public static abstract class Callback {
        /* renamed from: onNetScanBeacon */
        public void lambda$-android_net_lowpan_LowpanScanner$1_5692(LowpanBeaconInfo beacon) {
        }

        public void onEnergyScanResult(LowpanEnergyScanResult result) {
        }

        /* renamed from: onScanFinished */
        public void lambda$-android_net_lowpan_LowpanScanner$2_9089() {
        }
    }
    ...
    public void startEnergyScan() throws LowpanException {
        try {
            this.mBinder.startEnergyScan(createScanOptionMap(), new ILowpanEnergyScanCallback.Stub() {
                ...
                /* renamed from: lambda$-android_net_lowpan_LowpanScanner$2_8042 */
                static /* synthetic */ void m45lambda$-android_net_lowpan_LowpanScanner$2_8042(Callback callback, int channel, int rssi) {
                    if (callback != null) {
