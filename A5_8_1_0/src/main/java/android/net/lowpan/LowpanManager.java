...
public class LowpanManager {
    ...
    public void registerCallback(final Callback cb, final Handler handler) throws LowpanException {
        ILowpanManagerListener.Stub listenerBinder = new ILowpanManagerListener.Stub() {
            ...
            /* renamed from: lambda$-android_net_lowpan_LowpanManager$2_8833 */
            /* synthetic */ void m28lambda$-android_net_lowpan_LowpanManager$2_8833(ILowpanInterface ifaceService, Callback cb) {
            ...
            /* renamed from: lambda$-android_net_lowpan_LowpanManager$2_9391 */
            /* synthetic */ void m29lambda$-android_net_lowpan_LowpanManager$2_9391(ILowpanInterface ifaceService, Callback cb) {
                LowpanInterface iface = LowpanManager.this.getInterface(ifaceService);
                if (iface != null) {
