...
public interface IConnectivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectivityManager {
        ...
        static final int TRANSACTION_getCacheAge = 87;
        static final int TRANSACTION_getCaptivePortalServerUrl = 75;
        static final int TRANSACTION_getCelluarNetworkRequest = 83;
        static final int TRANSACTION_getCurrentTimeMillis = 88;
        ...
        static final int TRANSACTION_getTelephonyPowerLost = 78;
        static final int TRANSACTION_getTelephonyPowerState = 76;
        ...
        static final int TRANSACTION_hasCache = 86;
        static final int TRANSACTION_isActiveNetworkMetered = 18;
        static final int TRANSACTION_isAlreadyUpdated = 77;
        ...
        static final int TRANSACTION_measureDataState = 82;
        ...
        static final int TRANSACTION_setAlreadyUpdated = 80;
        ...
        static final int TRANSACTION_setTelephonyPowerLost = 81;
        static final int TRANSACTION_setTelephonyPowerState = 79;
        ...
        static final int TRANSACTION_shouldKeepCelluarNetwork = 84;
        ...
        static final int TRANSACTION_updateDataNetworkConfig = 85;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 24:
                    ...
                    startTethering(_arg04, _arg13, data.readInt() != 0, data.readString());
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 87:
                    data.enforceInterface(DESCRIPTOR);
                    _result10 = getCacheAge();
                    reply.writeNoException();
                    reply.writeLong(_result10);
                    return true;
                case 88:
                    data.enforceInterface(DESCRIPTOR);
                    _result10 = getCurrentTimeMillis();
                    reply.writeNoException();
                    reply.writeLong(_result10);
                    return true;
