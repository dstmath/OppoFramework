...
public class WifiP2pManager {
        ...
        class P2pHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.SET_WFDR2_INFO_FAILED /*139347*/:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.SET_WFDR2_INFO_SUCCEEDED /*139348*/:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.RESPONSE_GET_HANDOVER_MESSAGE /*139341*/:
                        ...
                        return;
                    case WifiP2pManager.ADD_PERSISTENT_GROUP_FAILED /*139362*/:
                        if (listener != null) {
                            ((ActionListener) listener).onFailure(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_ADD_PERSISTENT_GROUP /*139364*/:
                        group = (WifiP2pGroup) message.obj;
                        if (listener != null) {
                            ((AddPersistentGroupListener) listener).onAddPersistentGroupAdded(group);
                            return;
                        }
                        return;
                    default:
    ...
    public void setWFDR2Info(Channel c, WifiP2pWfdInfo wfdInfo, ActionListener listener) {
        checkChannel(c);
        try {
            this.mService.checkConfigureWifiDisplayPermission();
        } catch (RemoteException e) {
