...
public class WifiManager {
    ...
    private static int OPPO_MAX_RSSI = ((((int) WIFI_SIGNAL) % 100) * -1);
    private static int OPPO_MIDDLE1_RSSI = ((((int) (WIFI_SIGNAL % 1000000)) / 10000) * -1);
    private static int OPPO_MIDDLE2_RSSI = ((((int) (WIFI_SIGNAL % JobInfo.MIN_BACKOFF_MILLIS)) / 100) * -1);
    private static int OPPO_MIN_RSSI = ((((int) WIFI_SIGNAL) / 1000000) * -1);
    ...
    public static final int WIFI_FEATURE_DBS = 8388608;
    ...
    public boolean isExtendingNetworkCoverage() {
        try {
            return this.mService.isExtendingNetworkCoverage();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isDBSSupported() {
        return isFeatureSupported(8388608);
    }
    ...
    public boolean getWifiStaSapConcurrency() {
        try {
            return this.mService.getWifiStaSapConcurrency();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<WifiDevice> getConnectedStations() {
        try {
            return this.mService.getConnectedStations();
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    public boolean startRxSensTest(WifiConfiguration config, String ip) {
        try {
            return this.mService.startRxSensTest(config, ip);
        } catch (RemoteException e) {
            return false;
        }
    }
