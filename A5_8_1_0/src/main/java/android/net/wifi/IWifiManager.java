...
public interface IWifiManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWifiManager {
        ...
        static final int TRANSACTION_allowDevice = 82;
        static final int TRANSACTION_blockClient = 78;
        ...
        static final int TRANSACTION_disallowDevice = 83;
        ...
        static final int TRANSACTION_getAllowedDevices = 84;
        static final int TRANSACTION_getBlockedHotspotClients = 75;
        static final int TRANSACTION_getClientDeviceName = 77;
        static final int TRANSACTION_getClientIp = 76;
        ...
        static final int TRANSACTION_getHotspotClients = 74;
        ...
        static final int TRANSACTION_isAllDevicesAllowed = 80;
        ...
        static final int TRANSACTION_setAllDevicesAllowed = 81;
        ...
        static final int TRANSACTION_setPowerSavingMode = 87;
        ...
        static final int TRANSACTION_startApWps = 73;
        static final int TRANSACTION_startLocalOnlyHotspot = 43;
        static final int TRANSACTION_startRxSensTest = 85;
        ...
        private static class Proxy implements IWifiManager {
            ...
            public List<WifiDevice> getConnectedStations() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isExtendingNetworkCoverage() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 71:
                    data.enforceInterface(DESCRIPTOR);
                    List<WifiDevice> _result17 = getConnectedStations();
                    reply.writeNoException();
                    reply.writeTypedList(_result17);
                    return true;
                case 72:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = isExtendingNetworkCoverage();
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 73:
    ...
    List<WifiDevice> getConnectedStations() throws RemoteException;
    ...
    boolean isExtendingNetworkCoverage() throws RemoteException;
