...
public interface IInterfaceEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInterfaceEventCallback {
        ...
        static final int TRANSACTION_OnSoftApClientEvent = 5;
        ...
        private static class Proxy implements IInterfaceEventCallback {
            ...
            public void OnSoftApClientEvent(byte[] client_mac_addr, boolean connect_status) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeByteArray(client_mac_addr);
                    if (!connect_status) {
                        i = 0;
                    }
                    _data.writeInt(i);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    OnSoftApClientEvent(data.createByteArray(), data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void OnSoftApClientEvent(byte[] bArr, boolean z) throws RemoteException;
}
