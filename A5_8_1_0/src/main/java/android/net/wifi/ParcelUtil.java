...
public class ParcelUtil {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:7:0x001a A:{Splitter: B:4:0x000c, ExcHandler: java.security.NoSuchAlgorithmException (e java.security.NoSuchAlgorithmException)} */
