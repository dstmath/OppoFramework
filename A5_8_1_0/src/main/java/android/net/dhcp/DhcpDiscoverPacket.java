...
class DhcpDiscoverPacket extends DhcpPacket {
    ...
    DhcpDiscoverPacket(int transId, short secs, byte[] clientMac, boolean broadcast, boolean rapidCommit) {
        super(transId, secs, INADDR_ANY, INADDR_ANY, INADDR_ANY, INADDR_ANY, clientMac, broadcast, rapidCommit);
    }
    ...
    void finishPacket(ByteBuffer buffer) {
        ...
        if (this.mRapidCommit) {
            DhcpPacket.addTlv(buffer, (byte) 80);
        }
