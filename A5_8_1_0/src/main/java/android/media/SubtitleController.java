...
public class SubtitleController {
    ...
    static final /* synthetic */ boolean f85-assertionsDisabled = (SubtitleController.class.desiredAssertionStatus() ^ 1);
    ...
    private void checkAnchorLooper() {
        if (!f85-assertionsDisabled && this.mHandler == null) {
            throw new AssertionError("Should have a looper already");
        } else if (!f85-assertionsDisabled && Looper.myLooper() != this.mHandler.getLooper()) {
