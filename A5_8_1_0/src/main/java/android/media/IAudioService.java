...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_getOppoStreamVolume = 76;
        ...
        static final int TRANSACTION_oppoGetMode = 77;
        ...
        static final int TRANSACTION_removeMode = 79;
        ...
        static final int TRANSACTION_setDebugLog = 78;
        ...
        private static class Proxy implements IAudioService {
            ...
            public void setDebugLog(boolean on) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = oppoGetMode();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    setDebugLog(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 79:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void setDebugLog(boolean z) throws RemoteException;
