...
public class Paint {
    ...
    private static final String[] FliterCTSList = new String[]{"android.theme.app", "android.graphics.cts", "android.text.cts", "android.widget.cts", "android.uirendering.cts", "com.myshenyang"};
    ...
    private static boolean isCheckCTS = false;
