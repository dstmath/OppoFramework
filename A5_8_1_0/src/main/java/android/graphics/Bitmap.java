...
public final class Bitmap implements Parcelable {
    ...
    private static final /* synthetic */ int[] f10-android-graphics-Bitmap$ConfigSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m1-getandroid-graphics-Bitmap$ConfigSwitchesValues() {
        if (f10-android-graphics-Bitmap$ConfigSwitchesValues != null) {
            return f10-android-graphics-Bitmap$ConfigSwitchesValues;
        }
        ...
        f10-android-graphics-Bitmap$ConfigSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static Bitmap createBitmap(Bitmap source, int x, int y, int width, int height, Matrix m, boolean filter) {
        ...
        if (y + height > source.getHeight()) {
            ...
            if (config != null) {
                switch (m1-getandroid-graphics-Bitmap$ConfigSwitchesValues()[config.ordinal()]) {
                    case 1:
    ...
    public boolean compress(CompressFormat format, int quality, OutputStream stream) {
        ...
        if (stream == null) {
            ...
            if (mHM != null && (this.mWidth > 1000 || this.mHeight > 1000)) {
                mHM.hypnusSetSignatureAction(20, 50, Hypnus.getLocalSignature());
            }
