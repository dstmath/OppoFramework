...
public class GradientDrawable extends Drawable {
    ...
    private static final /* synthetic */ int[] f74xb1a9edf6 = null;
    ...
    private static /* synthetic */ int[] m33x5d85c3d2() {
        if (f74xb1a9edf6 != null) {
            return f74xb1a9edf6;
        }
        ...
        if (this.mGradientIsDirty) {
            ...
            if (gradientColors != null) {
                ...
                if (st.mGradient == 0) {
                    ...
                    switch (m33x5d85c3d2()[st.mOrientation.ordinal()]) {
                        case 1:
                            x0 = r.left;
                            y0 = r.bottom;
                            x1 = level * r.right;
