...
public class AdaptiveIconDrawable extends Drawable implements Callback {
    ...
    AdaptiveIconDrawable(LayerState state, Resources res) {
        ...
        if (sMask == null) {
            sMask = PathParser.createPathFromPathData(Resources.getSystem().getString(17039693));
        }
        this.mMask = PathParser.createPathFromPathData(Resources.getSystem().getString(17039693));
