...
public class Typeface {
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JiFeng.Tan@Plf.SDK, 2015-10-12 : [-private +public] Modify for webview flipfont (from Fei.Wang@Plf.GraphicTech)", property = OppoRomType.ROM)
