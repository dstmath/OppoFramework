...
public abstract class ColorSpace {
    ...
    public static class Rgb extends ColorSpace {
        ...
        /* renamed from: lambda$-android_graphics_ColorSpace$Rgb_113213 */
        static /* synthetic */ double m31lambda$-android_graphics_ColorSpace$Rgb_113213(double gamma, double x) {
            if (x < 0.0d) {
                x = 0.0d;
            }
        ...
        /* renamed from: lambda$-android_graphics_ColorSpace$Rgb_113354 */
        static /* synthetic */ double m32lambda$-android_graphics_ColorSpace$Rgb_113354(double gamma, double x) {
            if (x < 0.0d) {
                x = 0.0d;
            }
    ...
    static {
        ...
        sNamedColorSpaces[Named.EXTENDED_SRGB.ordinal()] = new Rgb("scRGB-nl IEC 61966-2-2:2003", SRGB_PRIMARIES, ILLUMINANT_D65, -$Lambda$ZrP-zejiEXAqfwV-MyP5lE9mYC8.$INST$0, -$Lambda$ZrP-zejiEXAqfwV-MyP5lE9mYC8.$INST$1, -0.799f, 2.399f, Named.EXTENDED_SRGB.ordinal(), null);
