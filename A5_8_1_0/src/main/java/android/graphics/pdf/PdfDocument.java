...
public class PdfDocument {
    ...
    public static final class Page {
        ...
        /* synthetic */ Page(Canvas canvas, PageInfo pageInfo, Page -this2) {
    ...
    public static final class PageInfo {
        ...
        /* synthetic */ PageInfo(PageInfo -this0) {
            this();
        }
    ...
    public Page startPage(PageInfo pageInfo) {
        ...
        this.mCurrentPage = new Page(new PdfCanvas(nativeStartPage(this.mNativeDocument, pageInfo.mPageWidth, pageInfo.mPageHeight, pageInfo.mContentRect.left, pageInfo.mContentRect.top, pageInfo.mContentRect.right, pageInfo.mContentRect.bottom)), pageInfo, null);
