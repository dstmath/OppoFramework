...
public final class RemoteConnection {
    ...
    public static abstract class Callback {
        ...
        public void lambda$-android_telecom_RemoteConnection_57723(RemoteConnection connection) {
        }

        /* renamed from: onRttInitiationFailure */
        public void lambda$-android_telecom_RemoteConnection_58084(RemoteConnection connection, int reason) {
        }

        /* renamed from: onRttSessionRemotelyTerminated */
        public void lambda$-android_telecom_RemoteConnection_58451(RemoteConnection connection) {
        }

        /* renamed from: onRemoteRttRequest */
        public void lambda$-android_telecom_RemoteConnection_58806(RemoteConnection connection) {
        }
    }
