...
public final class JsonReader implements Closeable {
    /* renamed from: -android-util-JsonScopeSwitchesValues */
    private static final /* synthetic */ int[] f53-android-util-JsonScopeSwitchesValues = null;
    ...
    /* renamed from: -getandroid-util-JsonScopeSwitchesValues */
    private static /* synthetic */ int[] m30-getandroid-util-JsonScopeSwitchesValues() {
        if (f53-android-util-JsonScopeSwitchesValues != null) {
            return f53-android-util-JsonScopeSwitchesValues;
        }
        ...
        f53-android-util-JsonScopeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public JsonToken peek() throws IOException {
        ...
        switch (m30-getandroid-util-JsonScopeSwitchesValues()[peekStack().ordinal()]) {
            case 1:
