...
public final class ArrayMap<K, V> implements Map<K, V> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x004d A:{ExcHandler: java.lang.ClassCastException (e java.lang.ClassCastException), Splitter: B:12:0x001e} */
    /* JADX WARNING: Removed duplicated region for block: B:51:0x00cb A:{ExcHandler: java.lang.ClassCastException (e java.lang.ClassCastException), Splitter: B:42:0x009e} */
            ...
            synchronized (cls) {
                if (mTwiceBaseCache != null) {
                    ...
                    try {
                        ...
                        this.mArray = array;
                        mTwiceBaseCacheSize--;
                        if (this.mHashes != null && this.mHashes.length == 8 && this.mArray.length == 16) {
                        }
            ...
            synchronized (cls) {
                if (mBaseCache != null) {
                    ...
                    try {
                        ...
                        this.mArray = array;
                        mBaseCacheSize--;
                        if (this.mHashes != null && this.mHashes.length == 4 && this.mArray.length == 8) {
                        }
    ...
    private static void freeArrays(int[] hashes, Object[] array, int size) {
        Class cls;
        int i;
        if (hashes.length == 8 && array.length == 16) {
            cls = ArrayMap.class;
            synchronized (cls) {
        ...
        } else if (hashes.length == 4 && array.length == 8) {
            cls = ArrayMap.class;
            synchronized (cls) {
