...
public final class JsonWriter implements Closeable {
    ...
    private static final /* synthetic */ int[] f52-android-util-JsonScopeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m29-getandroid-util-JsonScopeSwitchesValues() {
        if (f52-android-util-JsonScopeSwitchesValues != null) {
            return f52-android-util-JsonScopeSwitchesValues;
        }
        ...
        f52-android-util-JsonScopeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void beforeValue(boolean root) throws IOException {
        switch (m29-getandroid-util-JsonScopeSwitchesValues()[peek().ordinal()]) {
            case 1:
