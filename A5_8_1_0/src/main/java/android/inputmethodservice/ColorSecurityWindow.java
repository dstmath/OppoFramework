...
public class ColorSecurityWindow extends Dialog {
    ...
    public ColorSecurityWindow(Context context, String name, int theme, Callback callback, android.view.KeyEvent.Callback keyEventCallback, DispatcherState dispatcherState, int windowType, int gravity, boolean takesFocus) {
        super(context, theme);
        this.mName = name;
    ...
    private void initDockWindow() {
        ...
        getWindow().setFlags(windowSetFlags, windowModFlags | 8192);
    }
}
