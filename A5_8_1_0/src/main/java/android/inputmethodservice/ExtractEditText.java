...
public class ExtractEditText extends EditText {
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Jianhua.Lin@Plf.SDK : Modify for stopTextActionMode when sharing text", property = OppoRomType.ROM)
    public boolean onTextContextMenuItem(int id) {
        ...
        if (id == R.id.copy || id == R.id.paste || id == R.id.shareText) {
            stopTextActionMode();
        }
        return true;
    }
