...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public int diff(Configuration delta, boolean compareUndefined, boolean publicOnly) {
        ...
        if ((compareUndefined || delta.appBounds != null) && this.appBounds != delta.appBounds && (this.appBounds == null || (!(publicOnly || (this.appBounds.equals(delta.appBounds) ^ 1) == 0) || (publicOnly && !(this.appBounds.width() == delta.appBounds.width() && this.appBounds.height() == delta.appBounds.height()))))) {
            changed |= 1024;
        }
    ...
    public static boolean needNewResources(int configChanges, int interestingChanges) {
        if ((configChanges & ((Integer.MIN_VALUE | interestingChanges) | 1073741824)) == 0) {
