...
public abstract class PackageManagerInternal {
    ...
    public abstract boolean inCptWhiteList(int i, String str);

    public abstract boolean inPmsWhiteList(int i, String str, List<String> list);

    public abstract void initAndVerifyOppoFreezeInfo();
    ...
    public abstract int oppoFreezePackageInternal(String str, int i, int i2, int i3, String str2);

    public abstract int oppoUnFreezePackageInternal(String str, int i, int i2, int i3, String str2);
    ...
    public abstract void sendCptUpload(String str, String str2, int i);
