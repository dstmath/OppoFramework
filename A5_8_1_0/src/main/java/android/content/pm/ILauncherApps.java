        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        _arg4 = (UserHandle) UserHandle.CREATOR.createFromParcel(data);
                    } else {
                        _arg4 = null;
                    }
                    startActivityAsUser(_arg0, _arg12, _arg22, _arg3, _arg4);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    showAppDetailsAsUser(_arg0, _arg12, _arg22, _arg3, _arg4);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    if (data.readInt() != 0) {
                        _arg32 = (UserHandle) UserHandle.CREATOR.createFromParcel(data);
                    } else {
                        _arg32 = null;
                    }
                    ApplicationInfo _result4 = getApplicationInfo(_arg0, _arg1, _arg24, _arg32);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 10:
                    ...
                    List _arg33 = data.readArrayList(getClass().getClassLoader());
                    if (data.readInt() != 0) {
                        _arg42 = (ComponentName) ComponentName.CREATOR.createFromParcel(data);
                    } else {
                        _arg42 = null;
                    }
                    int _arg5 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg6 = (UserHandle) UserHandle.CREATOR.createFromParcel(data);
                    } else {
                        _arg6 = null;
                    }
                    _result = getShortcuts(_arg0, _arg13, _arg23, _arg33, _arg42, _arg5, _arg6);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 11:
                    ...
                    pinShortcuts(_arg0, _arg1, _arg25, _arg32);
                    reply.writeNoException();
                    return true;
                case 12:
                    Rect _arg34;
                    ...
                    _arg23 = data.readString();
                    if (data.readInt() != 0) {
                        _arg34 = (Rect) Rect.CREATOR.createFromParcel(data);
                    } else {
                        _arg34 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    _result2 = startShortcut(_arg0, _arg1, _arg23, _arg34, _arg43, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    int _result5 = getShortcutIconResId(data.readString(), data.readString(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ParcelFileDescriptor _result6 = getShortcutIconFd(data.readString(), data.readString(), data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 17:
                    ...
                    IntentSender _result7 = getShortcutConfigActivityIntent(_arg0, _arg12, _arg2);
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
