...
public abstract class PackageManager {
    ...
    public static final String FEATURE_FACE_CLOSEEYE_DETECT = "oppo.face.closeeye.detect";
    ...
    public abstract int getOppoFreezePackageState(String str, int i);

    public abstract List<String> getOppoFreezedPackageList(int i);

    public abstract int getOppoPackageFreezeFlag(String str, int i);
    ...
    public abstract boolean inOppoFreezePackageList(String str, int i);
    ...
    public abstract int oppoFreezePackage(String str, int i, int i2, int i3);

    public abstract int oppoUnFreezePackage(String str, int i, int i2, int i3);
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "wurun.zhou@Apps.Theme : Add for oppo rom theme. we can make ConvertIcon Useless", property = OppoRomType.ROM)
