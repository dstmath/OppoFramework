...
public class PackageItemInfo {
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Changwei.Li@Plf.SDK : Modify for we can make ConvertIcon Useless", property = OppoRomType.ROM)
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "Changwei.Li@Plf.SDK : Add for we can make ConvertIcon Useless", property = OppoRomType.ROM)
