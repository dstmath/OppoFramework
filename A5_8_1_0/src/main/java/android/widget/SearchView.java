...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public void setQuery(CharSequence query, boolean submit) {
        ...
        if (submit && (TextUtils.isEmpty(query) ^ 1) != 0) {
            onSubmitQuery();
        }
    }
    ...
    public void updateCloseButton() {
        ...
        this.mCloseButton.setVisibility(showClose != 0 ? 0 : 8);
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "Suying.You@Plf.SDK, 2017-10-1 : add for ColorSearchView", property = OppoRomType.ROM)
