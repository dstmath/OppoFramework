...
public class DatePicker extends FrameLayout {
    ...
    /* renamed from: lambda$-android_widget_DatePicker_6867 */
    /* synthetic */ void m33lambda$-android_widget_DatePicker_6867(Context context, DatePicker v, int y, int m, int d) {
