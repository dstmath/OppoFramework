        ...
        public void onValueSelected(int pickerType, int newValue, boolean autoAdvance) {
            ...
            switch (pickerType) {
                case 0:
                    ...
                    TimePickerClockDelegate.this.setHourInternal(newValue, 1, isTransition ^ 1, true);
                    if (isTransition != 0) {
