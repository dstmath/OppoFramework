...
public class TextView extends View implements OnPreDrawListener {
    ...
    private static final /* synthetic */ int[] f0-android-text-Layout$AlignmentSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m1-getandroid-text-Layout$AlignmentSwitchesValues() {
        if (f0-android-text-Layout$AlignmentSwitchesValues != null) {
            return f0-android-text-Layout$AlignmentSwitchesValues;
        }
        ...
        f0-android-text-Layout$AlignmentSwitchesValues = iArr;
        return iArr;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x0281 A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:23:0x0276} */
    /* JADX WARNING: Removed duplicated region for block: B:115:0x05ce A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:110:0x05c0} */
                            ...
                            if (!autotext && autocap == -1) {
                                ...
                                switch (autocap) {
                                    ...
                                    case 3:
                                        ...
                                        inputType = SmsEnvelope.SERVICE_CATEGORY_CMAS_EXTREME_THREAT;
                                        break;
                                    default:
                                        cap = Capitalize.NONE;
                                        break;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:41:0x0155 A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:20:0x007a} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    @Deprecated
    ...
    public void setTypeface(Typeface tf) {
        Typeface replacedTypeface = OppoFontUtils.flipTypeface(tf);
        Typeface paintTypeface = this.mTextPaint.getTypeface();
        if (paintTypeface != tf && paintTypeface != replacedTypeface) {
    ...
    public void setInputType(int type) {
        ...
        if (isPassword) {
            setTransformationMethod(PasswordTransformationMethod.getInstance());
            setTypefaceFromAttrs(null, null, 1, 0);
    ...
    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "Suying.You@Plf.SDK : [-private +public] Modify for the security keyboard", property = OppoRomType.ROM)
    ...
    public boolean bringPointIntoView(int offset) {
        ...
        switch (m1-getandroid-text-Layout$AlignmentSwitchesValues()[layout.getParagraphAlignment(line).ordinal()]) {
            case 2:
                grav = 1;
                break;
            case 3:
    ...
    public boolean onKeyShortcut(int keyCode, KeyEvent event) {
        if (!event.hasModifiers(4096)) {
            if (event.hasModifiers(SmsEnvelope.SERVICE_CATEGORY_CMAS_EXTREME_THREAT)) {
                switch (keyCode) {
                    case 50:
                        if (canPaste()) {
    ...
    private boolean performAccessibilityActionClick(Bundle arguments) {
        ...
        if (isClickable() || isLongClickable()) {
            ...
            if (this.mText != null && (this.mText instanceof Spannable) && this.mLinksClickable && this.mAutoLinkMask != 0 && ColorAccessibilityUtil.isTalkbackEnabled(getContext())) {
                ClickableSpan[] links = (ClickableSpan[]) ((Spannable) this.mText).getSpans(0, this.mText.length(), ClickableSpan.class);
                if (links.length > 0) {
                    links[0].onClick(this);
                }
            }
            if (this.mText != null && (this.mText instanceof Spannable) && ColorContextUtil.isColorStyle(getContext()) && ColorAccessibilityUtil.isTalkbackEnabled(getContext())) {
                ColorClickableSpan[] links2 = (ColorClickableSpan[]) ((Spannable) this.mText).getSpans(0, this.mText.length(), ColorClickableSpan.class);
                if (links2.length > 0) {
                    links2[0].onClick(this);
                }
            }
            performClick();
            handled = true;
