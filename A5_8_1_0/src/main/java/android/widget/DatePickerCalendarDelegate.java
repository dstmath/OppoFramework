...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    /* renamed from: lambda$-android_widget_DatePickerCalendarDelegate_11048 */
    /* synthetic */ void m34lambda$-android_widget_DatePickerCalendarDelegate_11048(View v) {
        tryVibrate();
        switch (v.getId()) {
            case R.id.date_picker_header_date /*16908815*/:
                setCurrentView(0);
                return;
            case R.id.date_picker_header_year /*16908816*/:
                setCurrentView(1);
                return;
            default:
                return;
    ...
    /* renamed from: lambda$-android_widget_DatePickerCalendarDelegate_13424 */
    /* synthetic */ void m35lambda$-android_widget_DatePickerCalendarDelegate_13424() {
