...
final class SelectionActionModeHelper {
    ...
    private static final class SelectionTracker {
        ...
        private final LogAbandonRunnable mDelayedLogAbandon = new LogAbandonRunnable(this, null);
        ...
        private final class LogAbandonRunnable implements Runnable {
            ...
            /* synthetic */ LogAbandonRunnable(SelectionTracker this$1, LogAbandonRunnable -this1) {
                this();
            }
    ...
    public void startActionModeAsync(boolean adjustSelection) {
        ...
        int i = adjustSelection & isSuggestSelectionEnabledForEditableText;
