...
public class ScrollBarDrawable extends Drawable implements Callback {
    ...
    @OppoHook(level = OppoHookType.NEW_FIELD, note = "JianHui.Yu@Plf.SDK, 2016-12-12 : Add for ScrollBar Effect", property = OppoRomType.ROM)
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "JianHui.Yu@Plf.SDK, 2016-12-12 : Add for ScrollBar Effect", property = OppoRomType.ROM)
