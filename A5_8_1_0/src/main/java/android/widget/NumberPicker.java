...
public class NumberPicker extends LinearLayout {
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 17367196;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResId = attributesArray.getResourceId(2, 17367196);
        this.mHasSelectorWheel = layoutResId != 17367196;
