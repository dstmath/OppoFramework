...
@RemoteView
public class ColorNotificationProgressBar extends View {
    ...
    private final FloatProperty<ColorNotificationProgressBar> VISUAL_PROGRESS;
    ...
    private class AccessibilityEventSender implements Runnable {
        /* synthetic */ AccessibilityEventSender(ColorNotificationProgressBar this$0, AccessibilityEventSender -this1) {
            this();
        }
        ...
        public void run() {
            ColorNotificationProgressBar.this.sendAccessibilityEvent(4);
        }
    }
    ...
    private class RefreshProgressRunnable implements Runnable {
        /* synthetic */ RefreshProgressRunnable(ColorNotificationProgressBar this$0, RefreshProgressRunnable -this1) {
            this();
        }
        ...
        public void run() {
            synchronized (ColorNotificationProgressBar.this) {
                int count = ColorNotificationProgressBar.this.mRefreshData.size();
                for (int i = 0; i < count; i++) {
                    RefreshData rd = (RefreshData) ColorNotificationProgressBar.this.mRefreshData.get(i);
                    ColorNotificationProgressBar.this.doRefreshProgress(rd.id, rd.progress, rd.fromUser, true, rd.animate);
                    rd.recycle();
                }
                ColorNotificationProgressBar.this.mRefreshData.clear();
                ColorNotificationProgressBar.this.mRefreshIsPosted = false;
            }
        }
    }
    ...
    public ColorNotificationProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 201524242);
    }
    ...
    public ColorNotificationProgressBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.VISUAL_PROGRESS = new FloatProperty<ColorNotificationProgressBar>("visual_progress") {
            public void setValue(ColorNotificationProgressBar object, float value) {
                object.setVisualProgress(R.id.progress, value);
                object.mVisualProgress = value;
            }

            public Float get(ColorNotificationProgressBar object) {
        ...
        Drawable progressDrawable = context.getDrawable(201852198);
        ...
        setIndeterminate(this.mOnlyIndeterminate);
    ...
    public CharSequence getAccessibilityClassName() {
        return ColorNotificationProgressBar.class.getName();
    }
