...
public class OverScroller {
    ...
    static class SplineOverScroller {
        ...
        @OppoHook(level = OppoHookType.CHANGE_CODE, note = "XiaoKang.Feng@Plf.SDK : Modify for ArrayIndexOutOfBoundsException", property = OppoRomType.ROM)
        boolean update() {
            ...
            if (currentTime == 0) {
                ...
                if (!(this.mPerf == null || (this.mIsPerfLockAcquired ^ 1) == 0)) {
