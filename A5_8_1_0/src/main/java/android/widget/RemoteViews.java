...
public class RemoteViews implements Parcelable, Filter {
    ...
    final String[] mApplicationDisReapplayArray;
    final ArrayList<String> mApplicationDisReapplayArrayList;
    ...
    protected RemoteViews(ApplicationInfo application, int layoutId) {
        ...
        this.mApplicationDisReapplayArray = new String[]{"com.jio.media.jiobeats", "com.maxmpz.audioplayer"};
        this.mApplicationDisReapplayArrayList = new ArrayList(Arrays.asList(this.mApplicationDisReapplayArray));
        ...
        recalculateMemoryUsage();
        if (application != null && application.processName != null && this.mApplicationDisReapplayArrayList.contains(application.processName)) {
            setReapplyDisallowed();
        }
    }
