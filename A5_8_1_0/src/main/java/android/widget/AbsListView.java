...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, OnGlobalLayoutListener, FilterListener, OnTouchModeChangeListener, RemoteAdapterConnectionCallback {
    ...
    static final int[] LONG_FORMAT = new int[]{8224};
    ...
    private class WindowRunnnable {
        ...
        public void rememberWindowAttachCount() {
            this.mOriginalAttachCount = AbsListView.this.-wrap5();
        }

        public boolean sameWindow() {
            return AbsListView.this.-wrap5() == this.mOriginalAttachCount;
        }
    }
    ...
    private class CheckForKeyLongPress extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            if (AbsListView.this.isPressed() && AbsListView.this.mSelectedPosition >= 0) {
                ...
                if (sameWindow() && (AbsListView.this.getRootView().isLongPressSwipe() ^ 1) != 0) {
    ...
    private class CheckForLongPress extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            if (child != null) {
                ...
                boolean handled = false;
                if (!(!sameWindow() || (AbsListView.this.mDataChanged ^ 1) == 0 || (AbsListView.this.getRootView().isLongPressSwipe() ^ 1) == 0)) {
    ...
    private final class CheckForTap implements Runnable {
        ...
        public void run() {
            if (AbsListView.this.mTouchMode == 0) {
                AbsListView.this.mTouchMode = 1;
                View child = AbsListView.this.getChildAt(AbsListView.this.mMotionPosition - AbsListView.this.mFirstPosition);
                AbsListView.this.mPresedChild = child;
                if (child != null && (child.hasExplicitFocusable() ^ 1) != 0) {
                    int -wrap3;
                    boolean runTap;
                    AbsListView.this.mLayoutMode = 0;
                    if (!AbsListView.this.mIsMutiPoint) {
                        -wrap3 = AbsListView.this.isInIgnoreArea(AbsListView.this.mDownX);
                    } else if (AbsListView.this.isInIgnoreArea(AbsListView.this.mDownX)) {
                        -wrap3 = AbsListView.this.isInIgnoreArea(AbsListView.this.mPointDownX);
                    } else {
                        runTap = false;
                        if (!AbsListView.this.mDataChanged || (AbsListView.this.isOppoStyle() && (AbsListView.this.mHasIgnore ^ 1) == 0 && !runTap)) {
                            AbsListView.this.mTouchMode = 2;
                        }
    ...
    private class FlingRunnable implements Runnable {
        ...
        @OppoHook(level = OppoHookType.NEW_FIELD, note = "XiaoKang.Feng@Plf.SDK : Modify for Scroll Interpolator", property = OppoRomType.ROM)
        ...
        FlingRunnable() {
            this.mScroller = OppoOverScroller.newInstance(AbsListView.this.getContext());
        }
        ...
        @OppoHook(level = OppoHookType.NEW_METHOD, note = "XiaoKang.Feng@Plf.SDK : Modify for Scroll Interpolator", property = OppoRomType.ROM)
        void startScroll(int distance, int duration, boolean linear, boolean suppressEndFlingStateChangeCall, Interpolator interpolator) {
            boolean z;
        ...
        @OppoHook(level = OppoHookType.CHANGE_CODE, note = "XiaoKang.Feng@Plf.SDK : Modify for Scroll Interpolator", property = OppoRomType.ROM)
        ...
        void endFling() {
            ...
            if (!VMRuntime.getRuntime().getDisableCompatbilityFlag() && AbsListView.isEnableEndFlingProtect) {
        ...
        @OppoHook(level = OppoHookType.CHANGE_CODE, note = "LiangJing.Fu@ROM.SDK : Modify for use the main thread when scrolling; JianHui.Yu@ROM.SDK, 2018-03-01 : Modify for Longshot 5.0", property = OppoRomType.ROM)
        public void run() {
            ...
            switch (AbsListView.this.mTouchMode) {
                ...
                case 6:
                    ...
                    if (!AbsListView.this.-wrap2(0, currY - scrollY, 0, scrollY, 0, 0, 0, AbsListView.this.mOverflingDistance, false)) {
                        AbsListView.this.invalidate();
                        AbsListView.this.postOnAnimation(this);
                        break;
                    }
            ...
            if (atEnd) {
                if (motionView != null) {
                    AbsListView.this.-wrap2(0, -(delta - (motionView.getTop() - oldTop)), 0, AbsListView.this.mScrollY, 0, 0, 0, AbsListView.this.mOverflingDistance, false);
                }
                if (more) {
                    edgeReached(delta);
                }
            } else if (!more || (atEnd ^ 1) == 0) {
                endFling();
            } else {
                if (atEdge) {
                    AbsListView.this.invalidate();
    ...
    class RecycleBin {
        ...
        private void removeDetachedView(View child, boolean animate) {
            ...
            AbsListView.this.-wrap7(child, animate);
        }
    }
    ...
    private void initAbsListView() {
        ...
        if (OPTS_INPUT) {
            ...
            if (touchslopprop <= 0.0d) {
                this.mMoveAcceleration = this.mTouchSlop;
            } else if (touchslopprop < TOUCH_SLOP_MIN) {
                this.mMoveAcceleration = (int) (((double) this.mTouchSlop) * TOUCH_SLOP_MIN);
            } else if (touchslopprop < TOUCH_SLOP_MIN || touchslopprop >= TOUCH_SLOP_MAX) {
                this.mMoveAcceleration = this.mTouchSlop;
            } else {
                this.mMoveAcceleration = (int) (((double) this.mTouchSlop) * touchslopprop);
            }
        }
        ...
        if (!VMRuntime.getRuntime().getDisableCompatbilityFlag()) {
    ...
    private boolean startScrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        boolean isFarEnough = OPTS_INPUT ? this.mIsFirstTouchMoveEvent ? distance > this.mMoveAcceleration : distance > this.mTouchSlop : distance > this.mTouchSlop;
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "LiangJing.Fu@ROM.SDK, 2013-01-21 : Modify for spring effect; JianHui.Yu@ROM.SDK, 2018-03-01 : Modify for Longshot 5.0", property = OppoRomType.ROM)
    private void scrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        if (this.mTouchMode == 3) {
                ...
                if (motionView != null) {
                    ...
                    if (atEdge) {
                        ...
                        if (dispatchNestedScroll(0, overscroll - incrementalDeltaY, 0, overscroll, this.mScrollOffset)) {
                            ...
                            boolean atOverscrollEdge = -wrap2(0, overscroll, 0, this.mScrollY, 0, 0, 0, this.mOverscrollDistance, true);
            ...
            if (overScrollDistance != 0) {
                -wrap2(0, overScrollDistance, 0, this.mScrollY, 0, 0, 0, this.mOverscrollDistance, true);
                overscrollMode = getOverScrollMode();
                if (overscrollMode == 0 || (overscrollMode == 1 && (contentFits() ^ 1) != 0)) {
                    if (rawDeltaY > 0) {
            ...
            switch (actionMasked) {
                ...
                case 2:
                    if (this.mHasIgnore && isOppoStyle()) {
                        ...
                        if (count != 1 || (isInIgnoreArea((int) ev.getX(0)) ^ 1) == 0) {
                            if (count > 1) {
                                onTouchMove(ev, vtev);
                                break;
                            }
                ...
                case 5:
                    ...
                    boolean onTouchDown = (!this.mIsMutiPoint || (isInIgnoreArea(x) ^ 1) == 0) ? false : isInIgnoreArea(this.mDownX);
                ...
                case 6:
                    ...
                    boolean onTouchUP = (!this.mIsMutiPoint || (isInIgnoreArea(x) ^ 1) == 0) ? false : isInIgnoreArea(this.mDownX);
            ...
            case 2:
                ...
                if (child != null) {
                    ...
                    if (!isInIgnoreArea(this.mUpX)) {
                        if ((isInIgnoreArea(this.mDownX) ^ 1) != 0) {
                            perform = true;
                            if (!(!inList || (child.hasExplicitFocusable() ^ 1) == 0 || (isOppoStyle() && (this.mHasIgnore ^ 1) == 0 && !perform))) {
                                if (this.mPerformClick == null) {
                    ...
                    if (this.mIsMutiPoint) {
                        if ((isInIgnoreArea(this.mPointUpX) ^ 1) != 0) {
                            perform = isInIgnoreArea(this.mPointDownX) ^ 1;
                            if (this.mPerformClick == null) {
                            }
                            performClick = this.mPerformClick;
                            performClick.mClickMotionPosition = motionPosition;
    ...
    public void draw(Canvas canvas) {
        int i = 0;
        super.draw(canvas);
        if (this.mEdgeGlowTop != null && (isColorStyle() ^ 1) != 0) {
            int width;
            int height;
            int translateX;
            int translateY;
            ...
            if (this.mEdgeGlowBottom != null && (this.mEdgeGlowBottom.isFinished() ^ 1) != 0) {
                restoreCount = canvas.save();
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "XiaoKang.Feng@Plf.SDK : Modify for Scroll Interpolator", property = OppoRomType.ROM)
    void smoothScrollBy(int distance, int duration, boolean linear, boolean suppressEndFlingStateChangeCall, Interpolator interpolator) {
        if (this.mFlingRunnable == null) {
            this.mFlingRunnable = new FlingRunnable();
        }
        int firstPos = this.mFirstPosition;
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "Xiaokang.Feng@ROM.SDK, 2018-02-20 : Add for BUG 1287453", property = OppoRomType.ROM)
