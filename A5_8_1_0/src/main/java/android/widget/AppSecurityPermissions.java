...
public class AppSecurityPermissions {
    ...
    static class MyPermissionGroupInfo extends PermissionGroupInfo {
        ...
        @OppoHook(level = OppoHookType.CHANGE_CODE, note = "wurun.zhou@Apps.Theme : Modify for oppo rom theme. make convertIcon useless here", property = OppoRomType.ROM)
        public Drawable loadGroupIcon(Context context, PackageManager pm) {
            if (this.icon != 0) {
                return loadIcon(pm, false);
            }
    ...
    private static class PermissionGroupInfoComparator implements Comparator<MyPermissionGroupInfo> {
        ...
        /* synthetic */ PermissionGroupInfoComparator(PermissionGroupInfoComparator -this0) {
            this();
        }
