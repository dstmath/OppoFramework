...
public class GrantCredentialsPermissionActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final TextView authTokenTypeView = (TextView) findViewById(16908722);
            ...
            findViewById(16908703).setOnClickListener(this);
            findViewById(16908831).setOnClickListener(this);
            LinearLayout packagesListView = (LinearLayout) findViewById(16909133);
            ...
            ((TextView) findViewById(16908654)).setText(this.mAccount.name);
            ((TextView) findViewById(16908657)).setText(accountTypeLabel);
    ...
    private View newPackageView(String packageLabel) {
        View view = this.mInflater.inflate(17367202, null);
        ((TextView) view.findViewById(16909132)).setText(packageLabel);
        return view;
    }
