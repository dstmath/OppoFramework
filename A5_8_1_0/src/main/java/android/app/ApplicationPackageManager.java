...
public class ApplicationPackageManager extends PackageManager {
    ...
    private final PackageDeleteObserver mPackageDeleleteObserver = new PackageDeleteObserver(this, null);
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "wurun.zhou@App.Theme : Modify for rom theme", property = OppoRomType.ROM)
    ...
    public int oppoFreezePackage(String pkgName, int userId, int freezeFlag, int flag) {
        try {
            return this.mPM.oppoFreezePackage(pkgName, userId, freezeFlag, flag, this.mContext.getOpPackageName());
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
    ...
    public int oppoUnFreezePackage(String pkgName, int userId, int freezeFlag, int flag) {
        try {
            return this.mPM.oppoUnFreezePackage(pkgName, userId, freezeFlag, flag, this.mContext.getOpPackageName());
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
    ...
    public int getOppoFreezePackageState(String pkgName, int userId) {
        try {
            return this.mPM.getOppoFreezePackageState(pkgName, userId);
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
    ...
    public boolean inOppoFreezePackageList(String pkgName, int userId) {
        try {
            return this.mPM.inOppoFreezePackageList(pkgName, userId);
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
    ...
    public List<String> getOppoFreezedPackageList(int userId) {
        try {
            return this.mPM.getOppoFreezedPackageList(userId);
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
    ...
    public int getOppoPackageFreezeFlag(String pkgName, int userId) {
        try {
            return this.mPM.getOppoPackageFreezeFlag(pkgName, userId);
        } catch (RemoteException e) {
            throw new RuntimeException("Package manager has died", e);
        }
    }
