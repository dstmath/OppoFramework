...
public class ProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mProgressStyle == 1) {
            ...
            this.mProgressNumber = (TextView) view.findViewById(16909182);
            this.mProgressPercent = (TextView) view.findViewById(16909183);
            setView(view);
        } else {
            view = inflater.inflate(a.getResourceId(18, 17367233), null);
            this.mProgress = (ProgressBar) view.findViewById(android.R.id.progress);
