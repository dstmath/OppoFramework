...
public class JobInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public JobInfo build() {
            if (this.mJobService == null || this.mJobService.getPackageName() == null || (this.mJobService.getPackageName().contains(".cts") ^ 1) == 0 || (this.mJobService.getPackageName().contains("cts.") ^ 1) == 0) {
            ...
            } else if (!(this.mHasEarlyConstraint || (this.mHasLateConstraint ^ 1) == 0 || this.mConstraintFlags != 0 || this.mNetworkType != 0 || this.mTriggerContentUris != null || (this.mRequiresBattIdle ^ 1) == 0 || (this.mRequiresProtectFore ^ 1) == 0 || (this.mHasCpuConstraint ^ 1) == 0 || (this.mIsOppoJob ^ 1) == 0)) {
                throw new IllegalArgumentException("You're trying to build a job with no constraints, this is not allowed.");
            }
            if (this.mIsPeriodic) {
    ...
    public boolean isSystemApp() {
        return this.isNotSysApp ^ 1;
    }

    public void setSysApp(boolean isSys) {
        this.isNotSysApp = isSys ^ 1;
    }
