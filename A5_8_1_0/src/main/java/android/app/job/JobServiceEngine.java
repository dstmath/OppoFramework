    ...
    class JobHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1001:
                    try {
                        boolean onUpdateJobParameters = JobServiceEngine.this.onUpdateJobParameters(params);
                        return;
                    } catch (Exception e22) {
                        Log.e(JobServiceEngine.TAG, "Application unable to handle onUpdateJobParameters.", e22);
