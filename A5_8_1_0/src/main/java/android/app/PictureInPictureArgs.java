...
public final class PictureInPictureArgs implements Parcelable {
    ...
    /* synthetic */ PictureInPictureArgs(Rational aspectRatio, List actions, Rect sourceRectHint, PictureInPictureArgs -this3) {
        this(aspectRatio, actions, sourceRectHint);
    }
