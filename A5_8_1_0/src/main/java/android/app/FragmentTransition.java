...
class FragmentTransition {
    ...
    /* renamed from: lambda$-android_app_FragmentTransition_18686 */
    static /* synthetic */ void m15lambda$-android_app_FragmentTransition_18686(Transition enterTransition, View nonExistentView, Fragment inFragment, ArrayList sharedElementsIn, ArrayList enteringViews, ArrayList exitingViews, Transition exitTransition) {
        if (enterTransition != null) {
    ...
    /* renamed from: lambda$-android_app_FragmentTransition_26843 */
    static /* synthetic */ void m16lambda$-android_app_FragmentTransition_26843(Fragment inFragment, Fragment outFragment, boolean inIsPop, ArrayMap inSharedElements, View epicenterView, Rect epicenter) {
    ...
    private static TransitionSet configureSharedElementsOrdered(ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Transition enterTransition, Transition exitTransition) {
        ...
        View view = sceneRoot;
        OneShotPreDrawListener.add(view, new android.app.-$Lambda$3eJ3p8XnIxdVOnT82Ns3R0V5ZQE.AnonymousClass2(inIsPop, nameOverrides, sharedElementTransition, fragments, sharedElementsIn, nonExistentView, inFragment, outFragment, sharedElementsOut, enterTransition, inEpicenter));
        return sharedElementTransition;
    }

    /* renamed from: lambda$-android_app_FragmentTransition_32404 */
    static /* synthetic */ void m17lambda$-android_app_FragmentTransition_32404(ArrayMap nameOverrides, TransitionSet finalSharedElementTransition, FragmentContainerTransition fragments, ArrayList sharedElementsIn, View nonExistentView, Fragment inFragment, Fragment outFragment, boolean inIsPop, ArrayList sharedElementsOut, Transition enterTransition, Rect inEpicenter) {
