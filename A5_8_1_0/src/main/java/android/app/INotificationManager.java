...
public interface INotificationManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INotificationManager {
        ...
        static final int TRANSACTION_getEnableNavigationApps = 94;
        ...
        static final int TRANSACTION_getNavigationMode = 91;
        ...
        static final int TRANSACTION_isDriveNavigationMode = 92;
        static final int TRANSACTION_isNavigationMode = 93;
        ...
        static final int TRANSACTION_isSuppressedByDriveMode = 95;
        ...
        static final int TRANSACTION_setSuppressedByDriveMode = 96;
        static final int TRANSACTION_setZenMode = 71;
        static final int TRANSACTION_shouldInterceptSound = 89;
        static final int TRANSACTION_shouldKeepAlive = 90;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 60:
                    ...
                    _result = isNotificationListenerAccessGranted(_arg03);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 61:
                    ...
                    _result = isNotificationListenerAccessGrantedForUser(_arg03, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 62:
                    ...
                    _result = isNotificationAssistantAccessGranted(_arg03);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 63:
                    ...
                    setNotificationListenerAccessGranted(_arg03, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationAssistantAccessGranted(_arg03, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationListenerAccessGrantedForUser(_arg03, data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 66:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationAssistantAccessGrantedForUser(_arg03, data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 67:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 81:
                    ...
                    String _result14 = addAutomaticZenRule(_arg06);
                    reply.writeNoException();
                ...
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    _result = shouldKeepAlive(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 91:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getNavigationMode(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 92:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isDriveNavigationMode(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 93:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isNavigationMode(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    String[] _result16 = getEnableNavigationApps(data.readInt());
                    reply.writeNoException();
                    reply.writeStringArray(_result16);
                    return true;
                case 95:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isSuppressedByDriveMode(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 96:
                    data.enforceInterface(DESCRIPTOR);
                    setSuppressedByDriveMode(data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    return true;
