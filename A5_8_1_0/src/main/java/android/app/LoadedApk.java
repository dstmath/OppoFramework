...
public final class LoadedApk {
    ...
    static final /* synthetic */ boolean f55-assertionsDisabled = (LoadedApk.class.desiredAssertionStatus() ^ 1);
    ...
    static final class ReceiverDispatcher {
        ...
        final class Args extends PendingResult {
            ...
            /* renamed from: lambda$-android_app_LoadedApk$ReceiverDispatcher$Args_56044 */
            /* synthetic */ void m19lambda$-android_app_LoadedApk$ReceiverDispatcher$Args_56044() {
    ...
    void installSystemApplicationInfo(ApplicationInfo info, ClassLoader classLoader) {
        if (f55-assertionsDisabled || info.packageName.equals("android")) {
    ...
    public static void makePaths(ActivityThread activityThread, boolean isBundledApp, ApplicationInfo aInfo, List<String> outZipPaths, List<String> outLibPaths) {
        ...
        if (outLibPaths != null) {
            ...
            if ((aInfo.privateFlags & 2097152) != 0) {
                outLibPaths.add(System.getProperty("java.library.path"));
            }
        }
    ...
    private void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        if (!this.mPackageName.equals("android")) {
            ...
            if (this.mApplicationInfo.isSystemApp()) {
                isBundledApp = this.mApplicationInfo.isUpdatedSystemApp() ^ 1;
            } else {
                isBundledApp = false;
            }
