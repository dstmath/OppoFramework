...
public class Notification implements Parcelable {
    ...
    public static abstract class Style {
        ...
        protected RemoteViews getStandardView(int layoutId) {
            ...
            if (this.mBigContentTitle == null || !this.mBigContentTitle.equals("")) {
                contentView.setViewVisibility(16909010, 0);
            } else {
                contentView.setViewVisibility(16909010, 8);
            }
            return contentView;
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            if (this.mSummaryTextSet) {
                contentView.setTextViewText(16909336, this.mBuilder.processTextSpans(this.mBuilder.processLegacyText(this.mSummaryText)));
                this.mBuilder.setTextViewColorSecondary(contentView, 16909336);
                contentView.setViewVisibility(16909336, 0);
            }
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification toAdopt) {
            ...
            this.mTintActionButtons = res.getBoolean(17957044);
            if (res.getBoolean(17956960)) {
                boolean z;
        ...
        private void bindProfileBadge(RemoteViews contentView) {
            ...
            if (profileBadge != null) {
                contentView.setImageViewBitmap(16909177, profileBadge);
                contentView.setViewVisibility(16909177, 0);
                if (isColorized()) {
                    contentView.setDrawableParameters(16909177, false, -1, getPrimaryTextColor(), Mode.SRC_ATOP, -1);
                }
            }
        }
        ...
        private void resetStandardTemplate(RemoteViews contentView) {
            ...
            contentView.setViewVisibility(16909209, 8);
            contentView.setViewVisibility(R.id.title, 8);
            contentView.setTextViewText(R.id.title, null);
            contentView.setViewVisibility(16909336, 8);
            contentView.setTextViewText(16909336, null);
            contentView.setViewVisibility(16909363, 8);
            contentView.setTextViewText(16909363, null);
        }

        private void resetNotificationHeader(RemoteViews contentView) {
            contentView.setBoolean(16909095, "setExpanded", false);
            contentView.setTextViewText(16908715, null);
            contentView.setViewVisibility(16908785, 8);
            contentView.setViewVisibility(16908924, 8);
            contentView.setTextViewText(16908924, null);
            contentView.setViewVisibility(16908925, 8);
            contentView.setViewVisibility(16909369, 8);
            contentView.setViewVisibility(16909365, 8);
            contentView.setImageViewIcon(16909177, null);
            contentView.setViewVisibility(16909177, 8);
        }

        private void resetContentMargins(RemoteViews contentView) {
            contentView.setViewLayoutMarginEndDimen(16909010, 0);
            contentView.setViewLayoutMarginEndDimen(16909336, 0);
        }
        ...
        private RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p) {
            ...
            contentView.setViewVisibility(16909092, 8);
            contentView.setViewVisibility(16909093, 8);
        ...
        private void updateBackgroundColor(RemoteViews contentView) {
            if (isColorized()) {
                contentView.setInt(16909318, "setBackgroundColor", getBackgroundColor());
            } else {
                contentView.setInt(16909318, "setBackgroundResource", 0);
            }
        }
        ...
        void setContentMinHeight(RemoteViews remoteView, boolean hasMinHeight) {
            ...
            remoteView.setInt(16909096, "setMinimumHeight", minHeight);
        }
        ...
        private boolean handleProgressBar(boolean hasProgress, RemoteViews contentView, Bundle ex) {
            ...
            contentView.setProgressBackgroundTintList(R.id.progress, ColorStateList.valueOf(this.mContext.getColor(17170669)));
            if (this.mN.color != 0) {
        ...
        private void bindLargeIcon(RemoteViews contentView) {
            ...
            if (this.mN.mLargeIcon != null) {
                contentView.setViewVisibility(16909209, 0);
                contentView.setImageViewIcon(16909209, this.mN.mLargeIcon);
                processLargeLegacyIcon(this.mN.mLargeIcon, contentView);
                contentView.setViewLayoutMarginEndDimen(16909010, 17105159);
                contentView.setViewLayoutMarginEndDimen(16909336, 17105159);
                contentView.setViewLayoutMarginEndDimen(R.id.progress, 17105159);
                ...
                contentView.setViewVisibility(16909199, i);
                if (action != null) {
                    int contrastColor = resolveContrastColor();
                    contentView.setDrawableParameters(16909199, true, -1, contrastColor, Mode.SRC_ATOP, -1);
                    contentView.setDrawableParameters(16909199, false, -1, NotificationColorUtil.isColorLight(contrastColor) ? -16777216 : -1, Mode.SRC_ATOP, -1);
                    contentView.setOnClickPendingIntent(16909209, action.actionIntent);
                    contentView.setOnClickPendingIntent(16909199, action.actionIntent);
                    contentView.setRemoteInputs(16909209, action.mRemoteInputs);
                    contentView.setRemoteInputs(16909199, action.mRemoteInputs);
                }
            }
            if (this.mN.mLargeIcon != null) {
                i = 0;
            ...
            contentView.setViewVisibility(16909210, i);
        }
        ...
        private void bindExpandButton(RemoteViews contentView) {
            ...
            contentView.setDrawableParameters(16908850, false, -1, color, Mode.SRC_ATOP, -1);
            contentView.setInt(16909095, "setOriginalNotificationColor", color);
        }
        ...
        private void bindHeaderChronometerAndTime(RemoteViews contentView) {
            if (showsTimeOrChronometer()) {
                ...
                setTextViewColorSecondary(contentView, 16909369);
                if (this.mN.extras.getBoolean(Notification.EXTRA_SHOW_CHRONOMETER)) {
                    contentView.setViewVisibility(16908785, 0);
                    contentView.setLong(16908785, "setBase", this.mN.when + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(16908785, "setStarted", true);
                    contentView.setChronometerCountDown(16908785, this.mN.extras.getBoolean(Notification.EXTRA_CHRONOMETER_COUNT_DOWN));
                    setTextViewColorSecondary(contentView, 16908785);
                    return;
                }
                contentView.setViewVisibility(16909365, 0);
                contentView.setLong(16909365, "setTime", this.mN.when);
                setTextViewColorSecondary(contentView, 16909365);
                return;
            }
            Log.d(Notification.TAG, "mN.when = " + this.mN.when + ", mN.creationTime = " + this.mN.creationTime);
            contentView.setLong(16909365, "setTime", this.mN.when != 0 ? this.mN.when : this.mN.creationTime);
        }
        ...
        private void bindHeaderText(RemoteViews contentView) {
            ...
            if (headerText != null) {
                contentView.setTextViewText(16908924, processTextSpans(processLegacyText(headerText)));
                setTextViewColorSecondary(contentView, 16908924);
                contentView.setViewVisibility(16908924, 0);
                contentView.setViewVisibility(16908925, 0);
                setTextViewColorSecondary(contentView, 16908925);
            }
        }
        ...
        public String loadHeaderAppName() {
            ...
            if (TextUtils.isEmpty(name) && this.mN.extras.containsKey(Notification.EXTRA_SUBSTITUTE_APP_NAME)) {
        ...
        private void bindHeaderAppName(RemoteViews contentView, boolean ambient) {
            contentView.setTextViewText(16908715, loadHeaderAppName());
            if (!isColorized() || (ambient ^ 1) == 0) {
                contentView.setTextColor(16908715, ambient ? resolveAmbientColor() : resolveContrastColor());
            } else {
                setTextViewColorPrimary(contentView, 16908715);
            }
        }
        ...
        private void resetStandardTemplateWithActions(RemoteViews big) {
            ...
            big.setViewVisibility(16909097, 8);
            ...
            big.setTextViewText(16909100, null);
            big.setViewLayoutMarginBottomDimen(16909091, 0);
        }
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p) {
            ...
            big.setBoolean(16908681, "setEmphasizedMode", false);
            if (N > 0) {
                big.setViewVisibility(16908682, 0);
                big.setViewVisibility(16908681, 0);
                big.setViewLayoutMarginBottomDimen(16909091, 17105148);
                if (N > 3) {
                    N = 3;
                }
                for (int i2 = 0; i2 < N; i2++) {
                    ...
                    big.addView(16908681, generateActionButton(action, false, i2 % 2 != 0, p.ambient));
                }
            } else {
            ...
            if (!(p.ambient || !validRemoteInput || replyText == null || replyText.length <= 0 || (TextUtils.isEmpty(replyText[0]) ^ 1) == 0)) {
                big.setViewVisibility(16909097, 0);
                big.setTextViewText(16909098, processTextSpans(replyText[0]));
                setTextViewColorSecondary(big, 16909098);
                if (replyText.length > 1 && (TextUtils.isEmpty(replyText[1]) ^ 1) != 0) {
                    big.setViewVisibility(16909099, 0);
                    big.setTextViewText(16909099, processTextSpans(replyText[1]));
                    setTextViewColorSecondary(big, 16909099);
                    if (replyText.length > 2 && (TextUtils.isEmpty(replyText[2]) ^ 1) != 0) {
                        big.setViewVisibility(16909100, 0);
                        big.setTextViewText(16909100, processTextSpans(replyText[2]));
                        setTextViewColorSecondary(big, 16909100);
                    }
                }
            }
            return big;
        ...
        public RemoteViews makeAmbientNotification() {
            return applyStandardTemplateWithActions(17367181, this.mParams.reset().ambient(true).fillTextsFrom(this).hasProgress(false));
        }

        private void hideLine1Text(RemoteViews result) {
            if (result != null) {
                result.setViewVisibility(16909363, 8);
            }
        }

        public static void makeHeaderExpanded(RemoteViews result) {
            if (result != null) {
                result.setBoolean(16909095, "setExpanded", true);
            }
        }
        ...
        private RemoteViews makePublicView(boolean ambient) {
            ...
            if (ambient) {
                publicExtras.putCharSequence(Notification.EXTRA_TITLE, this.mContext.getString(17040391));
                view = makeAmbientNotification();
            } else {
                publicExtras.putCharSequence(Notification.EXTRA_TITLE, this.mContext.getString(17040391));
                view = applyStandardTemplate(getBaseLayoutResource());
                view.setBoolean(16909095, "setExpandOnlyOnButton", true);
            }
        ...
        public RemoteViews makeLowPriorityContentView(boolean useRegularSubtext) {
            ...
            header.setBoolean(16909095, "setAcceptAllTouches", true);
            if (summary != null) {
        ...
        private CharSequence createSummaryText() {
            ...
            if (!(titleText == null || contentText == null)) {
                summary.append(bidi.unicodeWrap(this.mContext.getText(17040389)));
            }
            if (contentText != null) {
        ...
        private RemoteViews generateActionButton(Action action, boolean emphazisedMode, boolean oddAction, boolean ambient) {
            ...
            if (emphazisedMode) {
                ...
                if (isColorized()) {
                    ...
                    if (oddAction) {
                        emphasizedActionLayoutResource = 17170662;
                    } else {
                        emphasizedActionLayoutResource = 17170663;
                    }
                    bgColor = context.getColor(emphasizedActionLayoutResource);
                }
                button.setDrawableParameters(16908760, true, -1, bgColor, Mode.SRC_ATOP, -1);
                ...
                button.setTextViewText(16908658, processTextSpans(title));
                setTextViewColorPrimary(button, 16908658);
                if (outResultColor != null && outResultColor[0] != null) {
                    ...
                    button.setTextColor(16908658, resolveContrastColor());
                }
            } else {
                button.setTextViewText(16908658, processTextSpans(processLegacyText(action.title)));
                if (isColorized() && (ambient ^ 1) != 0) {
                    setTextViewColorPrimary(button, 16908658);
                } else if (this.mN.color != 0 && this.mTintActionButtons) {
                    button.setTextColor(16908658, ambient ? resolveAmbientColor() : resolveContrastColor());
                }
            }
            return button;
        }
                ...
                if (resultSpan2 instanceof TextAppearanceSpan) {
                    ...
                    if (textColor != null) {
                        ...
                        for (int i3 = 0; i3 < newColors.length; i3++) {
                            newColors[i3] = NotificationColorUtil.ensureLargeTextContrast(colors[i3], background, this.mInNightMode);
                        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private void buildIntoRemoteViewContent(RemoteViews remoteViews, RemoteViews customContent) {
            if (customContent != null) {
                ...
                remoteViews.removeAllViewsExceptId(16909096, R.id.progress);
                remoteViews.addView(16909096, customContent, 0);
            ...
            remoteViews.setViewLayoutMarginEndDimen(16909096, endMargin);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews generateMediaActionButton(Action action, int color) {
            ...
            button.setDrawableParameters(16908658, false, -1, tintColor, Mode.SRC_ATOP, -1);
            if (!tombstone) {
                button.setOnClickPendingIntent(16908658, action.actionIntent);
            }
            button.setContentDescription(16908658, action.title);
        ...
        private RemoteViews makeMediaContentView() {
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    view.addView(16909035, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i]), getPrimaryHighlightColor()));
                }
            }
            handleImage(view);
            int endMargin = 17105156;
            ...
            view.setViewLayoutMarginEndDimen(16909096, endMargin);
            return view;
        }
        ...
        private RemoteViews makeMediaBigContentView() {
            ...
            RemoteViews big = this.mBuilder.applyStandardTemplate(17367184, false);
            if (actionCount > 0) {
                big.removeAllViews(16909035);
                for (int i = 0; i < actionCount; i++) {
                    big.addView(16909035, generateMediaActionButton((Action) this.mBuilder.mActions.get(i), getPrimaryHighlightColor()));
                }
            }
            handleImage(big);
            return big;
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public RemoteViews makeContentView(boolean increasedHeight) {
            return buildIntoRemoteView(super.makeContentView(false), 16909094, this.mBuilder.mN.contentView);
        }
        ...
        private RemoteViews makeBigContentViewWithCustomContent(RemoteViews customRemoteView) {
            ...
            if (remoteViews != null) {
                return buildIntoRemoteView(remoteViews, 16909096, customRemoteView);
            }
            if (customRemoteView != this.mBuilder.mN.contentView) {
                return buildIntoRemoteView(super.makeContentView(false), 16909094, customRemoteView);
            }
            return null;
        }
    ...
    public static class InboxStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            int[] rowIds = new int[]{16908950, 16908951, 16908952, 16908953, 16908954, 16908955, 16908956};
            ...
            if (onlyViewId != 0) {
                contentView.setViewPadding(onlyViewId, 0, this.mBuilder.mContext.getResources().getDimensionPixelSize(17105193), 0, 0);
            }
            return contentView;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        private void fixTitleAndTextExtras(Bundle extras) {
            ...
            if (TextUtils.isEmpty(this.mConversationTitle)) {
                ...
                BidiFormatter bidi = BidiFormatter.getInstance();
                title = this.mBuilder.mContext.getString(17040394, bidi.unicodeWrap(this.mConversationTitle), bidi.unicodeWrap(m.mSender));
            }
            if (title != null) {
        ...
        public RemoteViews makeBigContentView() {
            ...
            int i = 0;
            contentView.setViewLayoutMarginBottomDimen(16909010, hasTitle ? 17105185 : 0);
            String str = "setNumIndentLines";
            int i2 = !this.mBuilder.mN.hasLargeIcon() ? 0 : hasTitle ? 1 : 2;
            contentView.setInt(16909101, str, i2);
            ...
            while (firstMessage + i < this.mMessages.size() && i < rowIds.length) {
                m = (Message) this.mMessages.get(firstMessage + i);
                rowId2 = rowIds[i];
            ...
            contentView.setInt(16909101, "setContractedChildId", contractedChildId);
            return contentView;
        }
    ...
    /* renamed from: lambda$-android_app_Notification_87011 */
    /* synthetic */ void m6lambda$-android_app_Notification_87011(Parcel parcel, PendingIntent intent, Parcel out, int outFlags) {
        if (parcel == out) {
            synchronized (this.mAllPendingIntentsLock) {
