...
public final class Vr2dDisplayProperties implements Parcelable {
    ...
    /* synthetic */ Vr2dDisplayProperties(int width, int height, int dpi, int flags, int removedFlags, Vr2dDisplayProperties -this5) {
        this(width, height, dpi, flags, removedFlags);
    }
