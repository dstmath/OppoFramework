...
public interface IActivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityManager {
        ...
        static final int TRANSACTION_addDisallowedRunningApp = 295;
        static final int TRANSACTION_addInstrumentationResults = 35;
        static final int TRANSACTION_addPackageDependency = 89;
        static final int TRANSACTION_adjustSplitScreen = 300;
        static final int TRANSACTION_allowToUseSdcard = 298;
        static final int TRANSACTION_appDexOpt = 291;
        ...
        static final int TRANSACTION_finishNotOrderReceiver = 305;
        ...
        static final int TRANSACTION_getAllTopPkgName = 303;
        ...
        static final int TRANSACTION_getDisallowedRunningApp = 297;
        static final int TRANSACTION_getDockTopAppName = 301;
        static final int TRANSACTION_getFocusedStackId = 211;
        static final int TRANSACTION_getFreeFormAppInfo = 304;
        ...
        static final int TRANSACTION_getTopAppName = 294;
        ...
        static final int TRANSACTION_removeDisallowedRunningApp = 296;
        ...
        static final int TRANSACTION_setOppoKinectActivityController = 292;
        ...
        static final int TRANSACTION_startActivityForFreeform = 302;
        ...
        private static class Proxy implements IActivityManager {
            ...
            public void appDexOpt(boolean start) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_appDexOpt, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setOppoKinectActivityController(IOppoKinectActivityController watcher) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(iBinder);
                    this.mRemote.transact(Stub.TRANSACTION_setOppoKinectActivityController, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public ComponentName getTopAppName() throws RemoteException {
                ...
                try {
                    ComponentName _result;
                    _data.writeInterfaceToken("android.app.IActivityManager");
                    this.mRemote.transact(Stub.TRANSACTION_getTopAppName, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (ComponentName) ComponentName.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public boolean addDisallowedRunningApp(List<String> appPkgNamesList) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_addDisallowedRunningApp, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean removeDisallowedRunningApp(List<String> appPkgNamesList) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("android.app.IActivityManager");
                    _data.writeStringList(appPkgNamesList);
                    this.mRemote.transact(Stub.TRANSACTION_removeDisallowedRunningApp, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public List<String> getDisallowedRunningApp() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("android.app.IActivityManager");
                    this.mRemote.transact(Stub.TRANSACTION_getDisallowedRunningApp, _data, _reply, 0);
                    _reply.readException();
            ...
            public void allowToUseSdcard(boolean allow) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_allowToUseSdcard, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void finishNotOrderReceiver(IBinder who, int hasCode, int resultCode, String resultData, Bundle map, boolean abortBroadcast) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(305, _data, null, 1);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    if (data.readInt() != 0) {
                        _arg35 = (IntentFilter) IntentFilter.CREATOR.createFromParcel(data);
                    } else {
                        _arg35 = null;
                    }
                    _result3 = registerReceiver(_arg02, _arg1, _arg28, _arg35, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 8:
                    ...
                    IIntentReceiver _arg36 = android.content.IIntentReceiver.Stub.asInterface(data.readStrongBinder());
                    _arg42 = data.readInt();
                    _arg5 = data.readString();
                    if (data.readInt() != 0) {
                    ...
                    _result = broadcastIntent(_arg02, _arg13, _arg22, _arg36, _arg42, _arg5, _arg63, _arg72, _arg82, _arg9, data.readInt() != 0, data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 9:
                ...
                case 14:
                    ...
                    if (data.readInt() != 0) {
                        _arg37 = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(data);
                    } else {
                        _arg37 = null;
                    }
                    activityStopped(_arg0, _arg14, _arg29, _arg37);
                    return true;
                case 15:
                    data.enforceInterface("android.app.IActivityManager");
                ...
                case 67:
                    ...
                    _arg24 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg38 = (Notification) Notification.CREATOR.createFromParcel(data);
                    } else {
                        _arg38 = null;
                    }
                    setServiceForeground(_arg04, _arg15, _arg24, _arg38, data.readInt());
                    reply.writeNoException();
                    return true;
                case 68:
                    data.enforceInterface("android.app.IActivityManager");
                ...
                case 80:
                    ...
                    if (data.readInt() != 0) {
                        _arg39 = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg39 = null;
                    }
                    _result2 = profileControl(_arg08, _arg12, _arg27, _arg39, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 81:
                ...
                case 95:
                    ...
                    return true;
                case 96:
                    ParcelableCrashInfo _arg310;
                    data.enforceInterface("android.app.IActivityManager");
                    _arg0 = data.readStrongBinder();
                    _arg1 = data.readString();
                    _arg27 = data.readInt() != 0;
                    if (data.readInt() != 0) {
                        _arg310 = (ParcelableCrashInfo) ParcelableCrashInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg310 = null;
                    }
                    _result2 = handleApplicationWtf(_arg0, _arg1, _arg27, _arg310);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 97:
                ...
                case 111:
                    ...
                    _arg22 = data.readString();
                    if (data.readInt() != 0) {
                        _arg311 = (Uri) Uri.CREATOR.createFromParcel(data);
                    } else {
                        _arg311 = null;
                    }
                    grantUriPermissionFromOwner(_arg0, _arg12, _arg22, _arg311, data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 112:
                    Uri _arg111;
                ...
                case 113:
                    ...
                    return true;
                case 114:
                    ParcelFileDescriptor _arg65;
                    data.enforceInterface("android.app.IActivityManager");
                    _arg08 = data.readString();
                    _arg12 = data.readInt();
                    _arg27 = data.readInt() != 0;
                    _arg34 = data.readInt() != 0;
                    boolean _arg46 = data.readInt() != 0;
                    _arg5 = data.readString();
                    if (data.readInt() != 0) {
                        _arg65 = (ParcelFileDescriptor) ParcelFileDescriptor.CREATOR.createFromParcel(data);
                    } else {
                        _arg65 = null;
                    }
                    _result2 = dumpHeap(_arg08, _arg12, _arg27, _arg34, _arg46, _arg5, _arg65);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 115:
                    ...
                    _result = startActivities(_arg02, _arg1, _arg211, _arg312, _arg4, _arg52, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 116:
                ...
                case 157:
                    ...
                    if (data.readInt() != 0) {
                        _arg313 = (AssistContent) AssistContent.CREATOR.createFromParcel(data);
                    } else {
                        _arg313 = null;
                    }
                    if (data.readInt() != 0) {
                        _arg47 = (Uri) Uri.CREATOR.createFromParcel(data);
                    } else {
                        _arg47 = null;
                    }
                    reportAssistContextExtras(_arg0, _arg14, _arg212, _arg313, _arg47);
                    reply.writeNoException();
                    return true;
                case 158:
                    data.enforceInterface("android.app.IActivityManager");
                ...
                case 187:
                    ...
                    IVoiceInteractor _arg66 = com.android.internal.app.IVoiceInteractor.Stub.asInterface(data.readStrongBinder());
                    _arg7 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg8 = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result = startVoiceActivity(_arg08, _arg12, _arg24, _arg33, _arg43, _arg55, _arg66, _arg7, _arg8, _arg9, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 188:
                ...
                case 199:
                    ...
                    if (data.readInt() != 0) {
                        _arg314 = (Bitmap) Bitmap.CREATOR.createFromParcel(data);
                    } else {
                        _arg314 = null;
                    }
                    _result = addAppTask(_arg0, _arg13, _arg213, _arg314);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 200:
                ...
                case 205:
                    ...
                    _result2 = launchAssistIntent(_arg07, _arg12, _arg22, _arg315, _arg44);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 206:
                ...
                case 238:
                    ...
                    _arg34 = data.readInt() != 0;
                    if (data.readInt() != 0) {
                        _arg45 = (Rect) Rect.CREATOR.createFromParcel(data);
                    } else {
                        _arg45 = null;
                    }
                    _result2 = moveTaskToDockedStack(_arg03, _arg12, _arg27, _arg34, _arg45);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 239:
                ...
                case 252:
                    ...
                    resizeDockedStack(_arg09, _arg16, _arg214, _arg316, _arg45);
                    reply.writeNoException();
                    return true;
                case 253:
                ...
                case 280:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_restartUserInBackground /*281*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result = restartUserInBackground(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_cancelTaskWindowTransition /*282*/:
                    data.enforceInterface("android.app.IActivityManager");
                    cancelTaskWindowTransition(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_cancelTaskThumbnailTransition /*283*/:
                    data.enforceInterface("android.app.IActivityManager");
                    cancelTaskThumbnailTransition(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getTaskSnapshot /*284*/:
                    data.enforceInterface("android.app.IActivityManager");
                    ...
                    return true;
                case TRANSACTION_scheduleApplicationInfoChanged /*285*/:
                    data.enforceInterface("android.app.IActivityManager");
                    scheduleApplicationInfoChanged(data.createStringArrayList(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setPersistentVrThread /*286*/:
                    data.enforceInterface("android.app.IActivityManager");
                    setPersistentVrThread(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_waitForNetworkStateUpdate /*287*/:
                    data.enforceInterface("android.app.IActivityManager");
                    waitForNetworkStateUpdate(data.readLong());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setDisablePreviewScreenshots /*288*/:
                    data.enforceInterface("android.app.IActivityManager");
                    setDisablePreviewScreenshots(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getLastResumedActivityUserId /*289*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result = getLastResumedActivityUserId();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_backgroundWhitelistUid /*290*/:
                    data.enforceInterface("android.app.IActivityManager");
                    backgroundWhitelistUid(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_appDexOpt /*291*/:
                    data.enforceInterface("android.app.IActivityManager");
                    appDexOpt(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setOppoKinectActivityController /*292*/:
                    data.enforceInterface("android.app.IActivityManager");
                    setOppoKinectActivityController(android.app.IOppoKinectActivityController.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setShowWhenLocked /*293*/:
                    data.enforceInterface("android.app.IActivityManager");
                    setShowWhenLocked(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getTopAppName /*294*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result5 = getTopAppName();
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                    ...
                    return true;
                case TRANSACTION_addDisallowedRunningApp /*295*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result2 = addDisallowedRunningApp(data.createStringArrayList());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_removeDisallowedRunningApp /*296*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result2 = removeDisallowedRunningApp(data.createStringArrayList());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_getDisallowedRunningApp /*297*/:
                    data.enforceInterface("android.app.IActivityManager");
                    _result10 = getDisallowedRunningApp();
                    reply.writeNoException();
                    reply.writeStringList(_result10);
                    return true;
                case TRANSACTION_allowToUseSdcard /*298*/:
                    data.enforceInterface("android.app.IActivityManager");
                    allowToUseSdcard(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setTurnScreenOn /*299*/:
                    data.enforceInterface("android.app.IActivityManager");
                ...
                case 300:
                    data.enforceInterface("android.app.IActivityManager");
                    _result2 = adjustSplitScreen(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 301:
                    data.enforceInterface("android.app.IActivityManager");
                    _result5 = getDockTopAppName();
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 302:
                    ...
                    _result = startActivityForFreeform(_arg07, _arg14, data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 303:
                    data.enforceInterface("android.app.IActivityManager");
                    _result10 = getAllTopPkgName();
                    reply.writeNoException();
                    reply.writeStringList(_result10);
                    return true;
                case 304:
                    data.enforceInterface("android.app.IActivityManager");
                    ApplicationInfo _result36 = getFreeFormAppInfo();
                    reply.writeNoException();
                    if (_result36 != null) {
                        reply.writeInt(1);
                ...
                case 305:
                    ...
                    finishNotOrderReceiver(_arg0, _arg12, _arg24, _arg3, _arg44, data.readInt() != 0);
                    return true;
    ...
    boolean adjustSplitScreen(int i, int i2) throws RemoteException;

    void allowToUseSdcard(boolean z) throws RemoteException;

    void appDexOpt(boolean z) throws RemoteException;
