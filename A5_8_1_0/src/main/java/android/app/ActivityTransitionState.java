    ...
    public boolean startExitBackTransition(Activity activity) {
        ...
        if (!this.mHasExited) {
            ...
            if (!delayExitBack || decor == null) {
                ...
                OneShotPreDrawListener.add(decor, new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 1, this, activity));
            }
        }
        return true;
    }

    /* renamed from: lambda$-android_app_ActivityTransitionState_12157 */
    /* synthetic */ void m2lambda$-android_app_ActivityTransitionState_12157(Activity activity) {
        if (this.mReturnExitCoordinator != null) {
            this.mReturnExitCoordinator.startExit(activity.mResultCode, activity.mResultData);
        }
    }
