...
abstract class ActivityTransitionCoordinator extends ResultReceiver {
    ...
    protected void lambda$-android_app_ActivityTransitionCoordinator_27955(ArrayList<View> snapshots) {
        if (this.mListener != null) {
    ...
    protected void lambda$-android_app_ActivityTransitionCoordinator_39609(int visibility) {
        int numSharedElements = this.mSharedElements.size();
        for (int i = 0; i < numSharedElements; i++) {
