...
public final class RecoverableSecurityException extends SecurityException implements Parcelable {
    ...
    public static class LocalDialog extends DialogFragment {
        ...
        /* renamed from: lambda$-android_app_RecoverableSecurityException$LocalDialog_8805 */
        static /* synthetic */ void m10x866ef9a6(RecoverableSecurityException e, DialogInterface dialog, int which) {
            try {
    ...
    public RecoverableSecurityException(Throwable cause, CharSequence userMessage, CharSequence userActionTitle, PendingIntent userAction) {
        this(cause, userMessage, new RemoteAction(Icon.createWithResource("android", 17302716), userActionTitle, userActionTitle, userAction));
    }
