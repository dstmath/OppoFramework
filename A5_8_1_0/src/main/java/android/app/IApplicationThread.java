...
public interface IApplicationThread extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IApplicationThread {
        ...
        private static class Proxy implements IApplicationThread {
            ...
            public void scheduleReceiver(Intent intent, ActivityInfo info, CompatibilityInfo compatInfo, int resultCode, String data, Bundle extras, boolean sync, int sendingUser, int processState, int hasCode) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    scheduleResumeActivity(_arg0, _arg1, _arg2, _arg33);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    ...
                    _arg22 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg34 = (ActivityInfo) ActivityInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg34 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    if (data.readInt() != 0) {
                        _arg16 = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg16 = null;
                    }
                    scheduleLaunchActivity(_arg02, _arg15, _arg22, _arg34, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg122, _arg132, _arg142, _arg152, _arg16);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    if (data.readInt() != 0) {
                        _arg17 = (ActivityInfo) ActivityInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg17 = null;
                    }
                    if (data.readInt() != 0) {
                        _arg23 = (CompatibilityInfo) CompatibilityInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg23 = null;
                    }
                    _arg3 = data.readInt();
                    ...
                    scheduleReceiver(_arg02, _arg17, _arg23, _arg3, _arg42, _arg52, data.readInt() != 0, data.readInt(), data.readInt(), data.readInt());
                    return true;
                case 10:
                    ServiceInfo _arg18;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        _arg18 = (ServiceInfo) ServiceInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg18 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    scheduleCreateService(_arg0, _arg18, _arg23, data.readInt());
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    return true;
                case 12:
                    ApplicationInfo _arg19;
                    ComponentName _arg35;
                    ProfilerInfo _arg43;
                    ...
                    if (data.readInt() != 0) {
                        _arg19 = (ApplicationInfo) ApplicationInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg19 = null;
                    }
                    List<ProviderInfo> _arg25 = data.createTypedArrayList(ProviderInfo.CREATOR);
                    if (data.readInt() != 0) {
                        _arg35 = (ComponentName) ComponentName.CREATOR.createFromParcel(data);
                    } else {
                        _arg35 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    if (data.readInt() != 0) {
                        _arg162 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _arg162 = null;
                    }
                    bindApplication(_arg03, _arg19, _arg25, _arg35, _arg43, _arg52, _arg62, _arg72, _arg82, _arg92, _arg102, _arg112, _arg123, _arg133, _arg143, _arg153, _arg162, data.readString());
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleExit();
                ...
                case 15:
                    ...
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        _arg110 = (ParceledListSlice) ParceledListSlice.CREATOR.createFromParcel(data);
                    } else {
                        _arg110 = null;
                    }
                ...
                case 21:
                    ...
                    scheduleRegisteredReceiver(_arg08, _arg12, _arg22, _arg32, _arg44, data.readInt() != 0, data.readInt() != 0, data.readInt(), data.readInt());
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleLowMemory();
                    return true;
                case 23:
                    Configuration _arg111;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        _arg111 = (Configuration) Configuration.CREATOR.createFromParcel(data);
                    } else {
                        _arg111 = null;
                    }
                    scheduleActivityConfigurationChanged(_arg0, _arg111);
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg24 = (Configuration) Configuration.CREATOR.createFromParcel(data);
                    } else {
                        _arg24 = null;
                    }
                    scheduleActivityMovedToDisplay(_arg0, _arg1, _arg24);
                    return true;
                case 25:
                    Configuration _arg63;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    List<ResultInfo> _arg113 = data.createTypedArrayList(ResultInfo.CREATOR);
                    ...
                    scheduleRelaunchActivity(_arg0, _arg113, _arg26, _arg3, _arg45, _arg5, _arg63, data.readInt() != 0);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 27:
                    ...
                    if (data.readInt() != 0) {
                        _arg114 = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg114 = null;
                    }
                    profilerControl(_arg05, _arg114, data.readInt());
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    ...
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        _arg115 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _arg115 = null;
                    }
                ...
                case 35:
                    ...
                    _arg32 = data.readString();
                    if (data.readInt() != 0) {
                        _arg46 = (ParcelFileDescriptor) ParcelFileDescriptor.CREATOR.createFromParcel(data);
                    } else {
                        _arg46 = null;
                    }
                    dumpHeap(_arg05, _arg14, _arg2, _arg32, _arg46);
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 38:
                    ...
                    setHttpProxy(_arg03, _arg116, _arg27, _arg36);
                    return true;
                case 39:
                    Bundle _arg09;
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 42:
                    ...
                    if (data.readInt() != 0) {
                        _arg117 = (MemoryInfo) MemoryInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg117 = null;
                    }
                    dumpMemInfo(_arg04, _arg117, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.createStringArray());
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 56:
                    ...
                    scheduleMultiWindowModeChanged(_arg0, _arg14, _arg24);
                    return true;
                case 57:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    ...
                    schedulePictureInPictureModeChanged(_arg0, _arg14, _arg24);
                    return true;
                case 58:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void scheduleReceiver(Intent intent, ActivityInfo activityInfo, CompatibilityInfo compatibilityInfo, int i, String str, Bundle bundle, boolean z, int i2, int i3, int i4) throws RemoteException;
