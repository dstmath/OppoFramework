...
public final class WallpaperColors implements Parcelable {
    ...
    public static WallpaperColors fromBitmap(Bitmap bitmap) {
        ...
        while (i < swatchesSize) {
            ...
            return new WallpaperColors(primary, null, null, hints | 4);
        }
        hints = calculateDarkHints(bitmap);
        if (shouldRecycle) {
        }
    ...
    /* renamed from: lambda$-android_app_WallpaperColors_6256 */
    static /* synthetic */ boolean m18lambda$-android_app_WallpaperColors_6256(float minColorArea, Swatch s) {
