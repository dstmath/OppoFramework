...
public class RecyclerView extends ViewGroup {
    ...
    public static abstract class LayoutManager {
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (vh != null && vh.getPosition() == position && (vh.shouldIgnore() ^ 1) != 0 && (this.mRecyclerView.mState.isPreLayout() || (vh.isRemoved() ^ 1) != 0)) {
                    return child;
                }
            }
            return null;
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ...
            if (!viewHolder.shouldIgnore()) {
                if (!viewHolder.isInvalid() || (viewHolder.isRemoved() ^ 1) == 0 || (viewHolder.isChanged() ^ 1) == 0 || (this.mRecyclerView.mAdapter.hasStableIds() ^ 1) == 0) {
                    detachViewAt(index);
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimatorListener {
        /* synthetic */ ItemAnimatorRestoreListener(RecyclerView this$0, ItemAnimatorRestoreListener -this1) {
            this();
        }
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                if (holder.isRecyclable()) {
                    ...
                    if (!holder.isInvalid() && ((RecyclerView.this.mState.mInPreLayout || (holder.isRemoved() ^ 1) != 0) && (holder.isChanged() ^ 1) != 0)) {
                        if (this.mCachedViews.size() == this.mViewCacheMax && (this.mCachedViews.isEmpty() ^ 1) != 0) {
                            int i = 0;
        ...
        void scrapView(View view) {
            ...
            if (holder.isChanged() && (RecyclerView.this.supportsChangeAnimations() ^ 1) == 0) {
        ...
        void unscrapView(ViewHolder holder) {
            if (holder.isChanged() && (RecyclerView.this.supportsChangeAnimations() ^ 1) == 0 && this.mChangedScrap != null) {
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            while (i < scrapCount) {
                ...
                if (holder.wasReturnedFromScrap() || holder.getPosition() != position || (holder.isInvalid() ^ 1) == 0 || (!RecyclerView.this.mState.mInPreLayout && (holder.isRemoved() ^ 1) == 0)) {
                    i++;
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        /* synthetic */ RecyclerViewDataObserver(RecyclerView this$0, RecyclerViewDataObserver -this1) {
            this();
        }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (scroller.isFinished() || (fullyConsumedScroll ^ 1) != 0) {
    ...
    public static abstract class ViewHolder {
        ...
        public final boolean isRecyclable() {
            if ((this.mFlags & 16) == 0) {
                return ViewCompat.hasTransientState(this.itemView) ^ 1;
            }
            return false;
        }
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        boolean animationTypeSupported = (!this.mItemsAddedOrRemoved || (this.mItemsChanged ^ 1) == 0) ? !this.mItemsAddedOrRemoved ? this.mItemsChanged ? supportsChangeAnimations() : false : true : true;
    ...
    void dispatchLayout() {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            if (this.mState.mOldChangedHolders != null) {
                ...
                for (i = 0; i < count; i++) {
                    holder = getChildViewHolderInt(this.mChildHelper.getChildAt(i));
                    if (!(!holder.isChanged() || (holder.isRemoved() ^ 1) == 0 || (holder.shouldIgnore() ^ 1) == 0)) {
        ...
        if (this.mState.mRunSimpleAnimations) {
            ...
            if (postLayoutCount > 0) {
                for (i = postLayoutCount - 1; i >= 0; i--) {
                    ...
                    if (this.mState.mPreLayoutHolderMap.isEmpty() || (this.mState.mPreLayoutHolderMap.containsKey(itemHolder) ^ 1) != 0) {
        ...
        resumeRequestLayout(false);
        this.mLayout.removeAndRecycleScrapInt(this.mRecycler, this.mState.mRunPredictiveAnimations ^ 1);
            ...
            if (!(holder == null || holder.shouldIgnore())) {
                if (holder.isRemoved() || holder.isInvalid()) {
                    ...
                    if (holder.getItemViewType() != this.mAdapter.getItemViewType(holder.mPosition)) {
                        holder.addFlags(4);
                        requestLayout();
                    } else if (holder.isChanged() && (supportsChangeAnimations() ^ 1) == 0) {
                        requestLayout();
                    } else {
