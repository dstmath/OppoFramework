...
public class LinearLayoutManager extends LayoutManager {
    ...
    private boolean updateAnchorFromChildren(State state, AnchorInfo anchorInfo) {
        ...
        if (!state.isPreLayout() && supportsPredictiveItemAnimations()) {
            boolean notVisible = this.mOrientationHelper.getDecoratedStart(referenceChild) < this.mOrientationHelper.getEndAfterPadding() ? this.mOrientationHelper.getDecoratedEnd(referenceChild) < this.mOrientationHelper.getStartAfterPadding() ? true : DEBUG : true;
            if (notVisible) {
                int endAfterPadding;
                if (anchorInfo.mLayoutFromEnd) {
