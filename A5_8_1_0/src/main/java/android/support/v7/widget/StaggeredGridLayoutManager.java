...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private class AnchorInfo {
        ...
        /* synthetic */ AnchorInfo(StaggeredGridLayoutManager this$0, AnchorInfo -this1) {
            this();
        }
    ...
    class Span {
        ...
        /* synthetic */ Span(StaggeredGridLayoutManager this$0, int index, Span -this2) {
            this(index);
        }
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        while (layoutState.hasMore(state) && (this.mRemainingSpans.isEmpty() ^ 1) != 0) {
            Span currentSpan;
            int start;
            int end;
            int otherStart;
