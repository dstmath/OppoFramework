...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_INDEX_4X6 = new MediaSize("NA_INDEX_4X6", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_4x6, 4000, OppoTelephonyConstant.POLL_DORMANT_MILLIS);
