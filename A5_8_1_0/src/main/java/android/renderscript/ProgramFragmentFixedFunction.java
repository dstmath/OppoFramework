...
public class ProgramFragmentFixedFunction extends ProgramFragment {
    ...
    public static class Builder {
        ...
        private static final /* synthetic */ int[] f27xfae8e800 = null;
        /* renamed from: -android-renderscript-ProgramFragmentFixedFunction$Builder$FormatSwitchesValues */
        private static final /* synthetic */ int[] f28x8940bbef = null;
        ...
        private static /* synthetic */ int[] m18x537010a4() {
            if (f27xfae8e800 != null) {
                return f27xfae8e800;
            }
        ...
        private static /* synthetic */ int[] m19x9c9feecb() {
            if (f28x8940bbef != null) {
                return f28x8940bbef;
            }
        ...
        private void buildShaderString() {
            ...
            for (int i = 0; i < this.mNumTextures; i++) {
                switch (m18x537010a4()[this.mSlots[i].env.ordinal()]) {
                    case 1:
                        this.mShader += "  col = texture2D(UNI_Tex0, t0);\n";
                        break;
                    case 2:
                        switch (m19x9c9feecb()[this.mSlots[i].format.ordinal()]) {
                            case 1:
