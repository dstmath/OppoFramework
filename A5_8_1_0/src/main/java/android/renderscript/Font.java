...
public class Font extends BaseObj {
    /* renamed from: -android-renderscript-Font$StyleSwitchesValues */
    private static final /* synthetic */ int[] f26-android-renderscript-Font$StyleSwitchesValues = null;
    ...
    /* renamed from: -getandroid-renderscript-Font$StyleSwitchesValues */
    private static /* synthetic */ int[] m17-getandroid-renderscript-Font$StyleSwitchesValues() {
        if (f26-android-renderscript-Font$StyleSwitchesValues != null) {
            return f26-android-renderscript-Font$StyleSwitchesValues;
        }
        ...
        f26-android-renderscript-Font$StyleSwitchesValues = iArr;
        return iArr;
    }
    ...
    static String getFontFileName(String familyName, Style style) {
        ...
        if (family != null) {
            switch (m17-getandroid-renderscript-Font$StyleSwitchesValues()[style.ordinal()]) {
                case 1:
