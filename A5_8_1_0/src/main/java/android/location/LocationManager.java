...
public class LocationManager {
    ...
    private class ListenerTransport extends ILocationListener.Stub {
        ...
        private void forceFinishCallback() {
            Log.w(LocationManager.TAG, "forceFinishCallback");
            synchronized (this) {
                if (this.mFinishHandler == null) {
                    this.mFinishHandler = new Handler(LocationManager.this.mContext.getMainLooper()) {
                        public void handleMessage(Message msg) {
                            ListenerTransport.this._handleMessage(msg);
                        }
                    };
            ...
            this.mFinishHandler.obtainMessage(10).sendToTarget();
        }
