...
public interface ILocationManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILocationManager {
        ...
        static final int TRANSACTION_enableVerboseLogging = 46;
        ...
        static final int TRANSACTION_getLocAppsOp = 43;
        static final int TRANSACTION_getNavigationPackagesList = 47;
        ...
        static final int TRANSACTION_getVerboseLoggingLevel = 45;
        ...
        static final int TRANSACTION_setLocAppsOp = 44;
        ...
        private static class Proxy implements ILocationManager {
            ...
            public void getLocAppsOp(int flag, LocAppsOp locAppsOp) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        locAppsOp.readFromParcel(_reply);
                    }
                    _reply.recycle();
                    _data.recycle();
                } catch (Throwable th) {
            ...
            public void setLocAppsOp(int cmd, LocAppsOp locAppsOp) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (locAppsOp != null) {
                        _data.writeInt(1);
                        locAppsOp.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
            ...
            public List<String> getNavigationPackagesList() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    ILocationListener _arg14 = android.location.ILocationListener.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        _arg2 = (PendingIntent) PendingIntent.CREATOR.createFromParcel(data);
                    } else {
                        _arg2 = null;
                    }
                    requestLocationUpdates(_arg0, _arg14, _arg2, data.readString());
                ...
                case 2:
                    ...
                    removeUpdates(_arg05, _arg1, data.readString());
                    reply.writeNoException();
                    return true;
                case 3:
                    Geofence _arg15;
                    ...
                    if (data.readInt() != 0) {
                        _arg15 = (Geofence) Geofence.CREATOR.createFromParcel(data);
                    } else {
                        _arg15 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    requestGeofence(_arg0, _arg15, _arg2, data.readString());
                    reply.writeNoException();
                    return true;
                case 4:
                    Geofence _arg06;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg06 = (Geofence) Geofence.CREATOR.createFromParcel(data);
                    } else {
                        _arg06 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    removeGeofence(_arg06, _arg1, data.readString());
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    _result2 = getFromLocation(_arg07, _arg12, _arg23, _arg3, _arg4);
                    reply.writeNoException();
                ...
                case 26:
                    ...
                    _arg02 = data.readString();
                    if (data.readInt() != 0) {
                        _arg16 = (Criteria) Criteria.CREATOR.createFromParcel(data);
                    } else {
                        _arg16 = null;
                    }
                    _result = providerMeetsCriteria(_arg02, _arg16);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 27:
                ...
                case 30:
                    ...
                    _arg02 = data.readString();
                    if (data.readInt() != 0) {
                        _arg17 = (ProviderProperties) ProviderProperties.CREATOR.createFromParcel(data);
                    } else {
                        _arg17 = null;
                    }
                    addTestProvider(_arg02, _arg17, data.readString());
                    reply.writeNoException();
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 32:
                    ...
                    _arg02 = data.readString();
                    if (data.readInt() != 0) {
                        _arg18 = (Location) Location.CREATOR.createFromParcel(data);
                    } else {
                        _arg18 = null;
                    }
                    setTestProviderLocation(_arg02, _arg18, data.readString());
                    reply.writeNoException();
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 36:
                    ...
                    setTestProviderStatus(_arg02, _arg19, _arg22, data.readLong(), data.readString());
                    reply.writeNoException();
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 38:
                    ...
                    _result = sendExtraCommand(_arg02, _arg110, _arg22);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    if (_arg22 != null) {
                        reply.writeInt(1);
                ...
                case 39:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg08 = (Location) Location.CREATOR.createFromParcel(data);
                    } else {
                        _arg08 = null;
                    }
                    reportLocation(_arg08, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    _arg04 = data.readInt();
                    _arg13 = new LocAppsOp();
                    getLocAppsOp(_arg04, _arg13);
                    reply.writeNoException();
                    if (_arg13 != null) {
                        reply.writeInt(1);
                ...
                case 44:
                    ...
                    _arg04 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg13 = (LocAppsOp) LocAppsOp.CREATOR.createFromParcel(data);
                    } else {
                        _arg13 = null;
                    }
                    setLocAppsOp(_arg04, _arg13);
                    reply.writeNoException();
                    return true;
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getVerboseLoggingLevel();
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 46:
                ...
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getNavigationPackagesList();
                    reply.writeNoException();
                    reply.writeStringList(_result4);
                    return true;
    ...
    void getLocAppsOp(int i, LocAppsOp locAppsOp) throws RemoteException;

    List<String> getNavigationPackagesList() throws RemoteException;
    ...
    void setLocAppsOp(int i, LocAppsOp locAppsOp) throws RemoteException;
