...
class MtpPropertyGroup {
    ...
    private String queryAudio(int id, String column) {
        Cursor cursor = null;
        try {
            cursor = this.mProvider.query(Media.getContentUri(this.mVolumeName), new String[]{DownloadManager.COLUMN_ID, column}, ID_WHERE, new String[]{Integer.toString(id)}, null, null);
            String str;
            if (cursor == null || !cursor.moveToNext()) {
                str = "";
                if (cursor != null) {
