...
public final class Settings {
    ...
    private static class NameValueCache {
        ...
        /* JADX WARNING: Missing block: B:34:0x0065, code:
            if (android.provider.Settings.isInSystemServer() == false) goto L_0x0173;
     */
        /* JADX WARNING: Missing block: B:36:0x006f, code:
            if (android.os.Binder.getCallingUid() == android.os.Process.myUid()) goto L_0x0173;
     */
        /* JADX WARNING: Missing block: B:37:0x0071, code:
            r18 = android.os.Binder.clearCallingIdentity();
     */
        /* JADX WARNING: Missing block: B:39:?, code:
            r11 = r2.call(r22.getPackageName(), r21.mCallGetCommand, r23, r8);
     */
     ...
     */
        /* JADX WARNING: Missing block: B:42:0x0086, code:
            if (r11 == null) goto L_0x0105;
     */
        /* JADX WARNING: Missing block: B:43:0x0088, code:
            r20 = r11.getString("value");
     */
        /* JADX WARNING: Missing block: B:44:0x008f, code:
            if (r16 == false) goto L_0x00db;
     */
        /* JADX WARNING: Missing block: B:45:0x0091, code:
            monitor-enter(r21);
     */
        /* JADX WARNING: Missing block: B:46:0x0092, code:
            if (r17 == false) goto L_0x00cf;
     */
        /* JADX WARNING: Missing block: B:48:?, code:
            r10 = (android.util.MemoryIntArray) r11.getParcelable(android.provider.Settings.CALL_METHOD_TRACK_GENERATION_KEY);
            r15 = r11.getInt(android.provider.Settings.CALL_METHOD_GENERATION_INDEX_KEY, -1);
     */
        /* JADX WARNING: Missing block: B:49:0x00a5, code:
            if (r10 == null) goto L_0x00cf;
     */
        /* JADX WARNING: Missing block: B:50:0x00a7, code:
            if (r15 < 0) goto L_0x00cf;
     */
        /* JADX WARNING: Missing block: B:51:0x00a9, code:
            r14 = r11.getInt(android.provider.Settings.CALL_METHOD_GENERATION_KEY, 0);
     */
        /* JADX WARNING: Missing block: B:52:0x00b5, code:
            if (r21.mGenerationTracker == null) goto L_0x00be;
     */
        /* JADX WARNING: Missing block: B:53:0x00b7, code:
            r21.mGenerationTracker.destroy();
     */
        /* JADX WARNING: Missing block: B:54:0x00be, code:
            r21.mGenerationTracker = new android.provider.Settings.GenerationTracker(r10, r15, r14, new android.provider.-$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 7, r21));
     */
        /* JADX WARNING: Missing block: B:55:0x00cf, code:
            r21.mValues.put(r23, r20);
     */
        /* JADX WARNING: Missing block: B:57:?, code:
            monitor-exit(r21);
     */
        /* JADX WARNING: Missing block: B:58:0x00db, code:
            return r20;
     */
        /* JADX WARNING: Missing block: B:97:0x0173, code:
            r11 = r2.call(r22.getPackageName(), r21.mCallGetCommand, r23, r8);
     */
        ...
        /* renamed from: lambda$-android_provider_Settings$NameValueCache_71934 */
        /* synthetic */ void m3lambda$-android_provider_Settings$NameValueCache_71934() {
            synchronized (this) {
    ...
    public static final class Secure extends NameValueTable implements Mtk_Secure {
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Global.CAPTIVE_PORTAL_MODE);
     ...
     */
        ...
        private static final boolean setLocationModeForUser(ContentResolver cr, int mode, int userId) {
            synchronized (Settings.mLocationSettingsLock) {
                ...
                if (!setLocationProviderEnabledForUser(cr, "gps", gps, userId)) {
                    nlpSuccess = false;
                }
            }
        }
    ...
    public static final class System extends NameValueTable implements Mtk_System, Qcom_System, Oppo_System {
        ...
        private static final Validator SCREEN_AUTO_BRIGHTNESS_ADJ_VALIDATOR = new InclusiveFloatRangeValidator(-1.0f, 2047.0f);
        ...
        private static final Validator SCREEN_BRIGHTNESS_VALIDATOR = new InclusiveIntegerRangeValidator(0, 2047);
        ...
        public static int getInt(ContentResolver cr, String name, int def) {
            ...
            if (userId == MetricsEvent.ASSIST_GESTURE_TRIGGERED && OppoMultiLauncherUtil.getInstance().isMultiApp(cr.getPackageName())) {
                userId = 0;
            }
            return getIntForUser(cr, name, def, userId);
        }
