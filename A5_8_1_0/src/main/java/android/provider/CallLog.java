...
public class CallLog {
    ...
    public static class Calls implements BaseColumns {
        ...
        public static final Integer FEATURES_ASSISTED_DIALING_USED = Integer.valueOf(16);
                ...
                if (cursor != null) {
                    try {
                        if (cursor.getCount() > 0 && cursor.moveToFirst()) {
                            ...
                            if (duration >= 10000 && ((callType == 2 || callType == 1001) && TextUtils.isEmpty(ci.normalizedNumber))) {
        ...
        public static String getLastOutgoingCall(Context context) {
            ...
            Cursor cursor = null;
            try {
                cursor = resolver.query(CONTENT_URI, new String[]{"number"}, "type = 2 OR type = 1001", null, "date DESC LIMIT 1");
                String str;
