...
public interface INetworkManagementService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkManagementService {
        ...
        static final int TRANSACTION_getNetworkStatsUidDetailWithPids = 74;
        ...
        static final int TRANSACTION_oppoExcuteFirewallCmd = 90;
        ...
        private static class Proxy implements INetworkManagementService {
            ...
            public void oppoExcuteFirewallCmd(int ipTarget, String chain, String cmd) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(ipTarget);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 87:
                    data.enforceInterface(DESCRIPTOR);
                    int _result6 = removeRoutesFromLocalNetwork(data.createTypedArrayList(RouteInfo.CREATOR));
                    reply.writeNoException();
                ...
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    oppoExcuteFirewallCmd(data.readInt(), data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
    ...
    void oppoExcuteFirewallCmd(int i, String str, String str2) throws RemoteException;
