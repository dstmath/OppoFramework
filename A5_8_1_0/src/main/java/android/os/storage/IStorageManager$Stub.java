...
import android.os.storage.IStorageEventListener.Stub;
import com.android.internal.os.AppFuseMount;

public abstract class IStorageManager$Stub extends Binder implements IStorageManager {
    ...
    private static class Proxy implements IStorageManager {
        ...
        public String getInterfaceDescriptor() {
            return IStorageManager$Stub.DESCRIPTOR;
        }
        ...
        public void registerListener(IStorageEventListener listener) throws RemoteException {
            ...
            try {
                _data.writeInterfaceToken(IStorageManager$Stub.DESCRIPTOR);
                if (listener != null) {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        switch (code) {
            case 1:
                ...
                registerListener(Stub.asInterface(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case 2:
                data.enforceInterface(DESCRIPTOR);
                unregisterListener(Stub.asInterface(data.readStrongBinder()));
                reply.writeNoException();
                return true;
            case 3:
                data.enforceInterface(DESCRIPTOR);
