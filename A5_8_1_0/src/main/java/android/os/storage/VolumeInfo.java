...
public class VolumeInfo implements Parcelable {
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, boolean reportUnmounted) {
        ...
        return new StorageVolume(this.id, mtpStorageId, userPath, description, isPrimary(), removable, emulated, mtpReserveSize, false, maxFileSize, new UserHandle(userId), derivedFsUuid, envState, this.readOnlyType);
    }
