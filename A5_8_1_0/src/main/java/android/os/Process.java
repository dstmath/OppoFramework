...
public class Process {
    ...
    public static final int SKIP_FLAG = 65536;
    ...
    public static final native void setCgroupProcsProcessGroup(int i, int i2, int i3) throws IllegalArgumentException, SecurityException;
    ...
    public static final native void setProcessGroupWithExtraFlag(int i, int i2, int i3) throws IllegalArgumentException, SecurityException;

    public static final native boolean setSwappiness(int i, boolean z);

    public static final native int setSystemServerCoredump(int i);
