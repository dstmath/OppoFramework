...
public abstract class BatteryStats implements Parcelable {
    ...
    private static final /* synthetic */ int[] f61-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m24xe0235176() {
        if (f61-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues != null) {
            return f61-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues;
        }
        ...
        f61-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    static {
        ...
        int i = 3;
        r7[16] = new BitDescription(56, i, "phone_signal_strength", "Pss", SignalStrength.SIGNAL_STRENGTH_NAMES, new String[]{"0", WifiEnterpriseConfig.ENGINE_ENABLE, "2", "3", "4"});
    ...
    public final void dumpCheckinLocked(Context context, PrintWriter pw, int which, int reqUid, boolean wifiOnly) {
        ...
        if (sippers != null && sippers.size() > 0) {
            ...
            for (i = 0; i < sippers.size(); i++) {
                ...
                uid = 0;
                switch (m24xe0235176()[bs.drainType.ordinal()]) {
                    case 1:
        ...
        for (iu = 0; iu < NU; iu++) {
            ...
            if (reqUid < 0 || uid == reqUid) {
                ...
                for (iw = wakelocks.size() - 1; iw >= 0; iw--) {
                    wl = (Wakelock) wakelocks.valueAt(iw);
                    stringBuilder.setLength(0);
                    String linePrefix = printWakeLockCheckin(stringBuilder, wl.getWakeTime(1), rawRealtime, FullBackup.FILES_TREE_TOKEN, which, "");
    ...
    public final void dumpLocked(Context context, PrintWriter pw, String prefix, int which, int reqUid, boolean wifiOnly) {
        ...
        for (iu = 0; iu < NU; iu++) {
            ...
            if (reqUid < 0 || uid == reqUid || uid == 1000) {
                ...
                ArrayMap<String, SparseIntArray> completions = u.getJobCompletionStats();
                for (int ic = completions.size() - 1; ic >= 0; ic--) {
                    SparseIntArray types = (SparseIntArray) completions.valueAt(ic);
                    if (types != null) {
                        pw.print(prefix);
