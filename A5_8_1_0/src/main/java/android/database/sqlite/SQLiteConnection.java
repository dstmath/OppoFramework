...
public final class SQLiteConnection implements OnCancelListener {
    ...
    static final /* synthetic */ boolean f70-assertionsDisabled = (SQLiteConnection.class.desiredAssertionStatus() ^ 1);
    ...
    private void setWalModeFromConfiguration() {
        if (!this.mConfiguration.isInMemoryDb() && (this.mIsReadOnlyConnection ^ 1) != 0) {
            ...
            } else if ((this.mConfiguration.openFlags & 1073741824) != 0) {
    ...
    private void detachCancellationSignal(CancellationSignal cancellationSignal) {
        ...
        if (f70-assertionsDisabled || this.mCancellationSignalAttachCount > 0) {
            this.mCancellationSignalAttachCount--;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0100 A:{Splitter: B:4:0x0035, ExcHandler: all (th java.lang.Throwable)} */
