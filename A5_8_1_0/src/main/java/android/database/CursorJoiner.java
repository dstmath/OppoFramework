...
public final class CursorJoiner implements Iterator<Result>, Iterable<Result> {
    /* renamed from: -android-database-CursorJoiner$ResultSwitchesValues */
    private static final /* synthetic */ int[] f66-android-database-CursorJoiner$ResultSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f67-assertionsDisabled = (CursorJoiner.class.desiredAssertionStatus() ^ 1);
    ...
    /* renamed from: -getandroid-database-CursorJoiner$ResultSwitchesValues */
    private static /* synthetic */ int[] m30-getandroid-database-CursorJoiner$ResultSwitchesValues() {
        if (f66-android-database-CursorJoiner$ResultSwitchesValues != null) {
            return f66-android-database-CursorJoiner$ResultSwitchesValues;
        }
        ...
        f66-android-database-CursorJoiner$ResultSwitchesValues = iArr;
        return iArr;
    }
    ...
    public boolean hasNext() {
        ...
        if (this.mCompareResultIsValid) {
            switch (m30-getandroid-database-CursorJoiner$ResultSwitchesValues()[this.mCompareResult.ordinal()]) {
                case 1:
    ...
    public Result next() {
        if (hasNext()) {
            incrementCursors();
            if (f67-assertionsDisabled || hasNext()) {
                ...
                if (hasLeft && hasRight) {
                    ...
                    this.mCompareResult = Result.LEFT;
                } else if (f67-assertionsDisabled || hasRight) {
                    this.mCompareResult = Result.RIGHT;
                } else {
    ...
    private static void populateValues(String[] values, Cursor cursor, int[] columnIndicies, int startingIndex) {
        if (f67-assertionsDisabled || startingIndex == 0 || startingIndex == 1) {
