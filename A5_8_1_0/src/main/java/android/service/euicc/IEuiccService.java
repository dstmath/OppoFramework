        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg1 = (DownloadableSubscription) DownloadableSubscription.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    downloadSubscription(_arg0, _arg1, data.readInt() != 0, data.readInt() != 0, android.service.euicc.IDownloadSubscriptionCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    ...
                    getDownloadableSubscriptionMetadata(_arg0, _arg1, data.readInt() != 0, android.service.euicc.IGetDownloadableSubscriptionMetadataCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
