...
public interface IOppoSupplicantStaNetwork extends ISupplicantVendorStaNetwork {
    ...
    public static abstract class Stub extends HwBinder implements IOppoSupplicantStaNetwork {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IOppoSupplicantStaNetwork.kInterfaceName, ISupplicantVendorStaNetwork.kInterfaceName, ISupplicantStaNetwork.kInterfaceName, ISupplicantNetwork.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case StatusCode.REJECT_WITH_SCHEDULE /*83*/:
                    ...
                    _hidl_out_status = setGbkSsid(_hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
