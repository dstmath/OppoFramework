...
public interface IOppoSupplicantP2pIface extends ISupplicantP2pIface {
    ...
    public static abstract class Stub extends HwBinder implements IOppoSupplicantP2pIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IOppoSupplicantP2pIface.kInterfaceName, ISupplicantP2pIface.kInterfaceName, ISupplicantIface.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 54:
                    ...
                    hwParcel = _hidl_reply;
                    p2pConnect(peerAddress, _hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readInt32(), _hidl_request.readInt32(), new p2pConnectCallback() {
                        public void onValues(SupplicantStatus status, String generatedPin) {
                            hwParcel.writeStatus(0);
                            status.writeToParcel(hwParcel);
                            hwParcel.writeString(generatedPin);
                ...
                case 55:
                    _hidl_request.enforceInterface(IOppoSupplicantP2pIface.kInterfaceName);
                    _hidl_out_status = p2pFind(_hidl_request.readInt32(), _hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 56:
                    _hidl_request.enforceInterface(IOppoSupplicantP2pIface.kInterfaceName);
                    _hidl_out_status = setOperChannel(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 57:
                    _hidl_request.enforceInterface(IOppoSupplicantP2pIface.kInterfaceName);
                    _hidl_out_status = setNetworkVariable(_hidl_request.readInt32(), _hidl_request.readString(), _hidl_request.readString());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
