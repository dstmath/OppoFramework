...
public final class Point {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.x))), Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.y)))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.x = _hidl_blob.getFloat(0 + _hidl_offset);
        this.y = _hidl_blob.getFloat(4 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<Point> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((Point) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putFloat(0 + _hidl_offset, this.x);
        _hidl_blob.putFloat(4 + _hidl_offset, this.y);
    }
}
