...
public interface IBiometricsFingerprint extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFingerprint {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList(Arrays.asList(new byte[][]{new byte[]{(byte) -64, (byte) 99, (byte) -119, (byte) -123, (byte) 12, (byte) -21, (byte) -101, (byte) -44, (byte) 61, (byte) -78, (byte) -69, (byte) 3, (byte) 82, (byte) -75, (byte) 15, (byte) 125, (byte) -38, (byte) -91, (byte) -44, (byte) 74, (byte) 69, (byte) -59, (byte) -90, (byte) 86, (byte) -6, (byte) -80, (byte) 44, (byte) -85, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, Byte.MIN_VALUE, (byte) -113, (byte) 70}, new byte[]{(byte) -67, (byte) -38, (byte) -74, (byte) 24, (byte) 77, (byte) 122, (byte) 52, (byte) 109, (byte) -90, (byte) -96, (byte) 125, (byte) -64, UsbASFormat.EXT_FORMAT_TYPE_II, (byte) -116, (byte) -15, (byte) -102, (byte) 105, (byte) 111, (byte) 76, (byte) -86, (byte) 54, UsbDescriptor.CLASSID_BILLBOARD, (byte) -59, (byte) 31, (byte) 46, (byte) 20, (byte) 86, (byte) 90, (byte) 20, (byte) -76, (byte) 15, (byte) -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 12:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = pauseEnroll();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 13:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = continueEnroll();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 14:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = setTouchEventListener();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 15:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = dynamicallyConfigLog(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 16:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = pauseIdentify();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 17:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = continueIdentify();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 18:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = getAlikeyStatus();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 19:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_result = getEnrollmentTotalTimes();
                    _hidl_reply.writeStatus(0);
                ...
                case 20:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_debugErrno = setScreenState(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno);
                    _hidl_reply.send();
                    return;
                case 21:
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    _hidl_out_result = getEngineeringInfo(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_result);
                    _hidl_reply.send();
                    return;
