...
public interface ISupplicantVendorStaIfaceCallback extends ISupplicantStaIfaceCallback {
    public static final String kInterfaceName = "vendor.qti.hardware.wifi.supplicant@1.0::ISupplicantVendorStaIfaceCallback";
    ...
    public static final class Proxy implements ISupplicantVendorStaIfaceCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.wifi.supplicant@1.0::ISupplicantVendorStaIfaceCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantVendorStaIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{ISupplicantVendorStaIfaceCallback.kInterfaceName, ISupplicantStaIfaceCallback.kInterfaceName, "android.hidl.base@1.0::IBase"}));
        }
