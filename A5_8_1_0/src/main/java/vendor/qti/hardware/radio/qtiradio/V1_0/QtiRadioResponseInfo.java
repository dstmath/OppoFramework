...
public final class QtiRadioResponseInfo {
    public int error;
    public int serial;
    public int type;
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != QtiRadioResponseInfo.class) {
            return false;
        }
        QtiRadioResponseInfo other = (QtiRadioResponseInfo) otherObject;
        return this.type == other.type && this.serial == other.serial && this.error == other.error;
    }
    ...
    public static final ArrayList<QtiRadioResponseInfo> readVectorFromParcel(HwParcel parcel) {
        ArrayList<QtiRadioResponseInfo> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 12), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            QtiRadioResponseInfo _hidl_vec_element = new QtiRadioResponseInfo();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<QtiRadioResponseInfo> _hidl_vec) {
