...
public class MessageHeader {
    ...
    public synchronized String getHeaderNamesInList() {
        ...
        for (int i = 0; i < this.nkeys; i++) {
            joiner.-java_util_stream_Collectors-mthref-8(this.keys[i]);
        }
        return joiner.-java_util_stream_Collectors-mthref-10();
    }
    ...
    public synchronized Map<String, List<String>> filterAndAddHeaders(String[] excludeList, Map<String, List<String>> include) {
        ...
        while (true) {
            ...
            if (skipIt) {
                ...
                l.-java_util_stream_SpinedBuffer-mthref-0(this.values[i]);
            }
        }
        if (include != null) {
