...
class JarFileFactory implements URLJarFileCloseController {
    ...
    static final /* synthetic */ boolean f254-assertionsDisabled = (JarFileFactory.class.desiredAssertionStatus() ^ 1);
    ...
    private JarFile getCachedJarFile(URL url) {
        if (f254-assertionsDisabled || Thread.holdsLock(instance)) {
