...
public abstract class BaseCalendar extends AbstractCalendar {
    ...
    static final /* synthetic */ boolean f86-assertionsDisabled = (BaseCalendar.class.desiredAssertionStatus() ^ 1);
    ...
    public long getFixedDate(int year, int month, int dayOfMonth, Date cache) {
        boolean isJan1 = (month == 1 && dayOfMonth == 1) ? true : f86-assertionsDisabled;
    ...
    public void getCalendarDateFromFixedDate(CalendarDate date, long fixedDate) {
        ...
        if (f86-assertionsDisabled || dayOfWeek > 0) {
