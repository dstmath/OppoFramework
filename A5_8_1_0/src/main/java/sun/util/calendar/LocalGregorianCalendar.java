...
public class LocalGregorianCalendar extends BaseCalendar {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:6:0x002e A:{ExcHandler: java.io.IOException (r11_0 'e' java.lang.Throwable), Splitter: B:0:0x0000} */
    /* JADX WARNING: Missing block: B:6:0x002e, code:
            r11 = move-exception;
     */
    /* JADX WARNING: Missing block: B:8:0x0036, code:
            throw new java.lang.InternalError(r11);
     */
    ...
    static LocalGregorianCalendar getLocalGregorianCalendar(String name) {
        try {
            ...
            while (eraTokens.hasMoreTokens()) {
                ...
                eras.-java_util_stream_SpinedBuffer-mthref-0(new Era(eraName, abbr, since, localTime));
            }
            if (eras.isEmpty()) {
