...
public final class BaseLocale {
    ...
    private static class Cache extends LocaleObjectCache<Key, BaseLocale> {
        ...
        static final /* synthetic */ boolean f142-assertionsDisabled = (Cache.class.desiredAssertionStatus() ^ 1);

        protected Key normalizeKey(Key key) {
            if (f142-assertionsDisabled || (key.lang.get() != null && key.scrt.get() != null && key.regn.get() != null && key.vart.get() != null)) {
        ...
        protected BaseLocale createObject(Key key) {
            return new BaseLocale((String) key.lang.get(), (String) key.scrt.get(), (String) key.regn.get(), (String) key.vart.get(), null);
        }
    }

    private static final class Key {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f143-assertionsDisabled = (Key.class.desiredAssertionStatus() ^ 1);
        ...
        private Key(String language, String region) {
            if (f143-assertionsDisabled || (language.intern() == language && region.intern() == region)) {
