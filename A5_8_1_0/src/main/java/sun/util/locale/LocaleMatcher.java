...
public final class LocaleMatcher {
    public static List<Locale> filter(List<LanguageRange> priorityList, Collection<Locale> locales, FilteringMode mode) {
        ...
        for (Locale locale : locales) {
            tags.-java_util_stream_SpinedBuffer-mthref-0(locale.toLanguageTag());
        }
        ...
        for (String tag : filteredTags) {
            filteredLocales.-java_util_stream_SpinedBuffer-mthref-0(Locale.forLanguageTag(tag));
        }
            ...
            for (String tag : tags) {
                ...
                if (tag2.startsWith(range)) {
                    ...
                    if ((tag2.length() == len || tag2.charAt(len) == '-') && (list.contains(tag2) ^ 1) != 0) {
                        list.-java_util_stream_SpinedBuffer-mthref-0(tag2);
                    }
                }
            }
        }
    ...
    public static List<LanguageRange> parse(String ranges) {
        ...
        while (true) {
            ...
            if (!tempList.contains(r)) {
                ...
                list.add(index, lr);
                numOfRanges++;
                tempList.-java_util_stream_SpinedBuffer-mthref-0(r);
                ...
                if (!(equivalent == null || (tempList.contains(equivalent) ^ 1) == 0)) {
                    ...
                    numOfRanges++;
                    tempList.-java_util_stream_SpinedBuffer-mthref-0(equivalent);
                }
                ...
                if (equivalents != null) {
                    for (String equiv : equivalents) {
                        if (!tempList.contains(equiv)) {
                            ...
                            numOfRanges++;
                            tempList.-java_util_stream_SpinedBuffer-mthref-0(equiv);
                        }
    ...
    public static List<LanguageRange> mapEquivalents(List<LanguageRange> priorityList, Map<String, List<String>> map) {
        ...
        for (LanguageRange lr : priorityList) {
                ...
                if (keyMap.containsKey(r)) {
                    ...
                    if (equivalents != null) {
                        ...
                        for (String equivalent : equivalents) {
                            list.-java_util_stream_SpinedBuffer-mthref-0(new LanguageRange(equivalent.toLowerCase() + range.substring(len), lr.getWeight()));
                        }
                    }
                } else {
                    int index = r.lastIndexOf(45);
            ...
            if (!hasEquivalent) {
                list.-java_util_stream_SpinedBuffer-mthref-0(lr);
            }
        }
        return list;
    }
