...
public class LocaleExtensions {
    ...
    static final /* synthetic */ boolean f155-assertionsDisabled = (LocaleExtensions.class.desiredAssertionStatus() ^ 1);
    ...
    public Set<String> getUnicodeLocaleAttributes() {
        ...
        if (f155-assertionsDisabled || (ext instanceof UnicodeLocaleExtension)) {
