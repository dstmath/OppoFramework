...
class UnixAsynchronousSocketChannelImpl extends AsynchronousSocketChannelImpl implements PollableChannel {
    ...
    static final /* synthetic */ boolean f274-assertionsDisabled = (UnixAsynchronousSocketChannelImpl.class.desiredAssertionStatus() ^ 1);
    ...
    private void updateEvents() {
        if (f274-assertionsDisabled || Thread.holdsLock(this.updateLock)) {
            int events = 0;
            if (this.readPending) {
                events = Net.POLLIN | 0;
            }
