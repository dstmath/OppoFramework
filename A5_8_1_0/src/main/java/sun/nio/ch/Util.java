...
public class Util {
    ...
    static final /* synthetic */ boolean f258-assertionsDisabled = (Util.class.desiredAssertionStatus() ^ 1);
    ...
    private static class BufferCache {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f259-assertionsDisabled = (BufferCache.class.desiredAssertionStatus() ^ 1);
        ...
        ByteBuffer removeFirst() {
            if (f259-assertionsDisabled || this.count > 0) {
    ...
    static void offerFirstTemporaryDirectBuffer(ByteBuffer buf) {
        if (!f258-assertionsDisabled && buf == null) {
            throw new AssertionError();
