...
public class ThreadLocalCoders {
    ...
    private static Cache decoderCache = new Cache(3) {
        ...
        static final /* synthetic */ boolean f45-assertionsDisabled = (AnonymousClass1.class.desiredAssertionStatus() ^ 1);
    ...
    private static Cache encoderCache = new Cache(3) {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f46-assertionsDisabled = (AnonymousClass2.class.desiredAssertionStatus() ^ 1);
