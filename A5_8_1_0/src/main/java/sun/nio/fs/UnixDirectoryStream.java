...
class UnixDirectoryStream implements DirectoryStream<Path> {
    ...
    private class UnixDirectoryIterator implements Iterator<Path> {
        ...
        static final /* synthetic */ boolean f281-assertionsDisabled = (UnixDirectoryIterator.class.desiredAssertionStatus() ^ 1);
        ...
        private Path readNextEntry() {
            if (f281-assertionsDisabled || Thread.holdsLock(this)) {
                Path entry;
                while (true) {
