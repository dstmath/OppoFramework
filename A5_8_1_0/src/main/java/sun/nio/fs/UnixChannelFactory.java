...
class UnixChannelFactory {
    ...
    protected static class Flags {
        /* renamed from: -java-nio-file-StandardOpenOptionSwitchesValues */
        private static final /* synthetic */ int[] f279-java-nio-file-StandardOpenOptionSwitchesValues = null;
        boolean append;
        boolean create;
        boolean createNew;
        ...
        /* renamed from: -getjava-nio-file-StandardOpenOptionSwitchesValues */
        private static /* synthetic */ int[] m153-getjava-nio-file-StandardOpenOptionSwitchesValues() {
            if (f279-java-nio-file-StandardOpenOptionSwitchesValues != null) {
                return f279-java-nio-file-StandardOpenOptionSwitchesValues;
            }
            ...
            f279-java-nio-file-StandardOpenOptionSwitchesValues = iArr;
            return iArr;
        }
        ...
        static Flags toFlags(Set<? extends OpenOption> options) {
            ...
            for (Object option : options) {
                if (option instanceof StandardOpenOption) {
                    switch (m153-getjava-nio-file-StandardOpenOptionSwitchesValues()[((StandardOpenOption) option).ordinal()]) {
                        case 1:
                            flags.append = true;
                            break;
                        case 2:
