...
abstract class AbstractPoller implements Runnable {
    /* renamed from: -sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues */
    private static final /* synthetic */ int[] f269-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues = null;
    ...
    /* renamed from: -getsun-nio-fs-AbstractPoller$RequestTypeSwitchesValues */
    private static /* synthetic */ int[] m150-getsun-nio-fs-AbstractPoller$RequestTypeSwitchesValues() {
        if (f269-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues != null) {
            return f269-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues;
        }
        ...
        f269-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues = iArr;
        return iArr;
    }
        ...
        synchronized (this.requestList) {
            while (true) {
                ...
                if (req != null) {
                    ...
                    switch (m150-getsun-nio-fs-AbstractPoller$RequestTypeSwitchesValues()[req.type().ordinal()]) {
                        case 1:
