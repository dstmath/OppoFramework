...
abstract class UnixFileSystem extends FileSystem {
    ...
    private class FileStoreIterator implements Iterator<FileStore> {
        ...
        static final /* synthetic */ boolean f275-assertionsDisabled = (FileStoreIterator.class.desiredAssertionStatus() ^ 1);
        ...
        private FileStore readNext() {
            if (f275-assertionsDisabled || Thread.holdsLock(this)) {
