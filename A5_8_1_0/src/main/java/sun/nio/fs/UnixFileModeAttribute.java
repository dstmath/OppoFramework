...
class UnixFileModeAttribute {
    /* renamed from: -java-nio-file-attribute-PosixFilePermissionSwitchesValues */
    private static final /* synthetic */ int[] f278-java-nio-file-attribute-PosixFilePermissionSwitchesValues = null;
    ...
    /* renamed from: -getjava-nio-file-attribute-PosixFilePermissionSwitchesValues */
    private static /* synthetic */ int[] m152-getjava-nio-file-attribute-PosixFilePermissionSwitchesValues() {
        if (f278-java-nio-file-attribute-PosixFilePermissionSwitchesValues != null) {
            return f278-java-nio-file-attribute-PosixFilePermissionSwitchesValues;
        }
        ...
        f278-java-nio-file-attribute-PosixFilePermissionSwitchesValues = iArr;
        return iArr;
    }
    ...
    static int toUnixMode(Set<PosixFilePermission> perms) {
        ...
        for (PosixFilePermission perm : perms) {
            if (perm != null) {
                switch (m152-getjava-nio-file-attribute-PosixFilePermissionSwitchesValues()[perm.ordinal()]) {
                    case 1:
