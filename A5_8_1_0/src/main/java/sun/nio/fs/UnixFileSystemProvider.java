...
public abstract class UnixFileSystemProvider extends AbstractFileSystemProvider {
    /* renamed from: -java-nio-file-AccessModeSwitchesValues */
    private static final /* synthetic */ int[] f273-java-nio-file-AccessModeSwitchesValues = null;
    private static final String USER_DIR = "user.dir";
    private final UnixFileSystem theFileSystem = newFileSystem(System.getProperty(USER_DIR));

    /* renamed from: -getjava-nio-file-AccessModeSwitchesValues */
    private static /* synthetic */ int[] m151-getjava-nio-file-AccessModeSwitchesValues() {
        if (f273-java-nio-file-AccessModeSwitchesValues != null) {
            return f273-java-nio-file-AccessModeSwitchesValues;
        }
        ...
        f273-java-nio-file-AccessModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public void checkAccess(Path obj, AccessMode... modes) throws IOException {
        ...
        if (modes.length == 0) {
            ...
            while (i < length) {
                switch (m151-getjava-nio-file-AccessModeSwitchesValues()[modes[i].ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
                        r = true;
