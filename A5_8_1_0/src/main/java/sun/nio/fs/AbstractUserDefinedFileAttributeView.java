...
abstract class AbstractUserDefinedFileAttributeView implements UserDefinedFileAttributeView, DynamicFileAttributeView {
    ...
    static final /* synthetic */ boolean f270-assertionsDisabled = (AbstractUserDefinedFileAttributeView.class.desiredAssertionStatus() ^ 1);
    ...
    public final Map<String, Object> readAttributes(String[] attributes) throws IOException {
        ...
        while (i < length) {
            ...
            if (name.equals("*")) {
                ...
                names.-java_util_stream_SpinedBuffer-mthref-0(name);
                i++;
            }
        }
