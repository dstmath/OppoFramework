...
public final class ProviderList {
    ...
    private final class ServiceList extends AbstractList<Service> {
        ...
        private void addService(Service s) {
            ...
            if (this.services == null) {
                ...
                this.services.-java_util_stream_SpinedBuffer-mthref-0(this.firstService);
            }
            this.services.-java_util_stream_SpinedBuffer-mthref-0(s);
        }
    ...
    private ProviderList() {
        ...
        while (true) {
            ...
            if (!configList.contains(config)) {
                configList.-java_util_stream_SpinedBuffer-mthref-0(config);
            }
            i++;
        }
    ...
    ProviderList getJarList(String[] jarClassNames) {
        ...
        for (String className : jarClassNames) {
            ...
            newConfigs.-java_util_stream_SpinedBuffer-mthref-0(newConfig);
        }
    ...
    public List<Service> getServices(String type, List<String> algorithms) {
        ...
        for (String alg : algorithms) {
            ids.-java_util_stream_SpinedBuffer-mthref-0(new ServiceId(type, alg));
        }
