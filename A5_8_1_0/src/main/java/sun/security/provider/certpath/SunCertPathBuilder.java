...
public final class SunCertPathBuilder extends CertPathBuilderSpi {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x003c A:{ExcHandler: java.security.GeneralSecurityException (r7_0 'e' java.lang.Exception), Splitter: B:1:0x000f} */
    ...
    private void buildForward(List<List<Vertex>> adjacencyList, LinkedList<X509Certificate> certPathList, boolean searchAllCertStores) throws GeneralSecurityException, IOException {
        ...
        adjacencyList.clear();
        adjacencyList.-java_util_stream_SpinedBuffer-mthref-0(new LinkedList());
        ...
        for (Vertex vertex : vertices) {
            ...
            try {
                ...
                if (builder.isPathCompleted(cert)) {
                    ...
                    checkers.-java_util_stream_SpinedBuffer-mthref-0(policyChecker);
                    checkers.-java_util_stream_SpinedBuffer-mthref-0(new AlgorithmChecker(builder.trustAnchor));
                    ...
                    if (nextState.keyParamsNeeded()) {
                        ...
                        checkers.-java_util_stream_SpinedBuffer-mthref-0(basicChecker2);
                    }
                    ...
                    if (this.buildParams.revocationEnabled() && (revCheckerAdded ^ 1) != 0) {
                        checkers.-java_util_stream_SpinedBuffer-mthref-0(new RevocationChecker(builder.trustAnchor, this.buildParams));
                    }
                ...
                adjList.-java_util_stream_SpinedBuffer-mthref-0(new LinkedList());
    ...
    private static List<Vertex> addVertices(Collection<X509Certificate> certs, List<List<Vertex>> adjList) {
        ...
        for (X509Certificate cert : certs) {
            l.-java_util_stream_SpinedBuffer-mthref-0(new Vertex(cert));
        }
        return l;
    }
