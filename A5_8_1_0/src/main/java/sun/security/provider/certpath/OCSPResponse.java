...
public final class OCSPResponse {
    ...
    private static final /* synthetic */ int[] f284xf6fa7e2 = null;
    ...
    private static /* synthetic */ int[] m155x1b752fbe() {
        if (f284xf6fa7e2 != null) {
            return f284xf6fa7e2;
        }
                    ...
                    if (seqCert.isContextSpecific((byte) 0)) {
                        ...
                        while (i < derCerts.length) {
                            try {
                                ...
                                this.certs.-java_util_stream_SpinedBuffer-mthref-0(cert);
                                if (debug != null) {
    ...
    void verify(List<CertId> certIds, X509Certificate issuerCert, X509Certificate responderCert, Date date, byte[] nonce) throws CertPathValidatorException {
        switch (m155x1b752fbe()[this.responseStatus.ordinal()]) {
            case 1:
            case 3:
            ...
            case 2:
                ...
                if (this.signerCert == null) {
                    try {
                        this.certs.-java_util_stream_SpinedBuffer-mthref-0(X509CertImpl.toImpl(issuerCert));
                        if (responderCert != null) {
                            this.certs.-java_util_stream_SpinedBuffer-mthref-0(X509CertImpl.toImpl(responderCert));
                        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:13:0x003a A:{ExcHandler: java.security.InvalidKeyException (r0_0 'e' java.lang.Throwable), Splitter: B:0:0x0000} */
    /* JADX WARNING: Removed duplicated region for block: B:13:0x003a A:{ExcHandler: java.security.InvalidKeyException (r0_0 'e' java.lang.Throwable), Splitter: B:0:0x0000} */
