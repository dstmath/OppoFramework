...
public final class PKIXCertPathValidator extends CertPathValidatorSpi {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:34:0x00b8 A:{ExcHandler: java.security.cert.CertificateException (e java.security.cert.CertificateException), Splitter: B:6:0x002a} */
    ...
    private static PKIXCertPathValidatorResult validate(TrustAnchor anchor, ValidatorParams params) throws CertPathValidatorException {
        ...
        certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(new AlgorithmChecker(anchor));
        certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(new KeyChecker(certPathLen, params.targetCertConstraints()));
        certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(new ConstraintsChecker(certPathLen));
        int i = certPathLen;
        ...
        certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(pc);
        BasicChecker bc = new BasicChecker(anchor, params.date(), params.sigProvider(), false);
        certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(bc);
        ...
        if (params.revocationEnabled() && (revCheckerAdded ^ 1) != 0) {
            certPathCheckers.-java_util_stream_SpinedBuffer-mthref-0(new RevocationChecker(anchor, params));
        }
