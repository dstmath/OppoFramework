...
class RevocationChecker extends PKIXRevocationChecker {
    /* renamed from: -java-security-cert-PKIXRevocationChecker$OptionSwitchesValues */
    private static final /* synthetic */ int[] f285-java-security-cert-PKIXRevocationChecker$OptionSwitchesValues = null;
    /* renamed from: -sun-security-provider-certpath-RevocationChecker$ModeSwitchesValues */
    private static final /* synthetic */ int[] f286x65a5a97b = null;
    ...
    private static /* synthetic */ int[] m156x8d2b448e() {
        if (f285-java-security-cert-PKIXRevocationChecker$OptionSwitchesValues != null) {
            return f285-java-security-cert-PKIXRevocationChecker$OptionSwitchesValues;
        }
        ...
        f285-java-security-cert-PKIXRevocationChecker$OptionSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getsun-security-provider-certpath-RevocationChecker$ModeSwitchesValues */
    private static /* synthetic */ int[] m157xce49a81f() {
        if (f286x65a5a97b != null) {
            return f286x65a5a97b;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x00e8 A:{ExcHandler: java.security.InvalidAlgorithmParameterException (r1_0 'e' java.lang.Object), Splitter: B:23:0x009c} */
    ...
    void init(TrustAnchor anchor, ValidatorParams params) throws CertPathValidatorException {
        ...
        for (Object option : options) {
            switch (m156x8d2b448e()[option.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        try {
            this.certStores.-java_util_stream_SpinedBuffer-mthref-0(CertStore.getInstance("Collection", new CollectionCertStoreParameters(params.certificates())));
        } catch (Object e) {
        }
    }
    ...
    private void check(X509Certificate xcert, Collection<String> unresolvedCritExts, PublicKey pubKey, boolean crlSignFlag) throws CertPathValidatorException {
        ...
        try {
            if (!this.onlyEE || xcert.getBasicConstraints() == -1) {
                switch (m157xce49a81f()[this.mode.ordinal()]) {
                    case 1:
                    case 3:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x009a A:{ExcHandler: java.security.cert.CertificateException (r14_0 'e' java.lang.Exception), Splitter: B:0:0x0000} */
    /* JADX WARNING: Removed duplicated region for block: B:17:0x009a A:{ExcHandler: java.security.cert.CertificateException (r14_0 'e' java.lang.Exception), Splitter: B:0:0x0000} */
