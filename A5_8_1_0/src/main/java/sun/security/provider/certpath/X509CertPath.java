...
public class X509CertPath extends CertPath {
    ...
    static {
        ...
        list.-java_util_stream_SpinedBuffer-mthref-0(PKIPATH_ENCODING);
        list.-java_util_stream_SpinedBuffer-mthref-0(PKCS7_ENCODING);
        ...
        try {
            ...
            try {
                for (int i = seq.length - 1; i >= 0; i--) {
                    certList.-java_util_stream_SpinedBuffer-mthref-0((X509Certificate) certFac.generateCertificate(new ByteArrayInputStream(seq[i].toByteArray())));
                }
