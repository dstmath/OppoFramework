...
public class DisabledAlgorithmConstraints extends AbstractAlgorithmConstraints {
    ...
    private static class KeySizeConstraint extends Constraint {
        /* renamed from: -sun-security-util-DisabledAlgorithmConstraints$Constraint$OperatorSwitchesValues */
        private static final /* synthetic */ int[] f283x540df0da = null;
        private int maxSize;
        private int minSize;
        private int prohibitedSize = -1;

        /* renamed from: -getsun-security-util-DisabledAlgorithmConstraints$Constraint$OperatorSwitchesValues */
        private static /* synthetic */ int[] m154xc6bdcb6() {
            if (f283x540df0da != null) {
                return f283x540df0da;
            }
        ...
        public KeySizeConstraint(String algo, Operator operator, int length) {
            ...
            super();
            this.algorithm = algo;
            switch (m154xc6bdcb6()[operator.ordinal()]) {
                case 1:
                    this.minSize = 0;
