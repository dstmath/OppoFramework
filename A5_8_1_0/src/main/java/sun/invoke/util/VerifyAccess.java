...
public class VerifyAccess {
    ...
    static final /* synthetic */ boolean f39-assertionsDisabled = (VerifyAccess.class.desiredAssertionStatus() ^ 1);
    ...
    public static boolean isMemberAccessible(Class<?> refc, Class<?> defc, int mods, Class<?> lookupClass, int allowedModes) {
        ...
        if (!f39-assertionsDisabled && ((allowedModes & 1) == 0 || (allowedModes & -16) != 0)) {
            ...
            switch (mods & 7) {
                case 0:
                    if (f39-assertionsDisabled || !defc.isInterface()) {
                        if ((allowedModes & 8) != 0) {
    ...
    public static String getPackageName(Class<?> cls) {
        if (f39-assertionsDisabled || !cls.isArray()) {
