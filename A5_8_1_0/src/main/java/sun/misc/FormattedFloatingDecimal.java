...
public class FormattedFloatingDecimal {
    ...
    static final /* synthetic */ boolean f144-assertionsDisabled = (FormattedFloatingDecimal.class.desiredAssertionStatus() ^ 1);
    /* renamed from: -sun-misc-FormattedFloatingDecimal$FormSwitchesValues */
    private static final /* synthetic */ int[] f145-sun-misc-FormattedFloatingDecimal$FormSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m84-getsun-misc-FormattedFloatingDecimal$FormSwitchesValues() {
        if (f145-sun-misc-FormattedFloatingDecimal$FormSwitchesValues != null) {
            return f145-sun-misc-FormattedFloatingDecimal$FormSwitchesValues;
        }
        ...
        f145-sun-misc-FormattedFloatingDecimal$FormSwitchesValues = iArr;
        return iArr;
    }
    ...
    private FormattedFloatingDecimal(int precision, Form form, BinaryToASCIIConverter fdConverter) {
        ...
        int exp;
        switch (m84-getsun-misc-FormattedFloatingDecimal$FormSwitchesValues()[form.ordinal()]) {
            case 1:
                exp = decExp;
