...
final class DexPathList {
    ...
    static class Element {
        ...
        public String toString() {
            if (this.dexFile == null) {
                ...
                String str = this.path != null ? this.path.isDirectory() ? "directory \"" : "zip file \"" : "zip file \"";
                return stringBuilder.append(str).append(this.path).append("\"").toString();
    ...
    /* renamed from: lambda$-dalvik_system_DexPathList_3307 */
    static /* synthetic */ boolean m36lambda$-dalvik_system_DexPathList_3307(ByteBuffer v) {
        return v == null;
    }
