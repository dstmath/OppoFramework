...
public final class VMRuntime {
    ...
    private boolean disableCompatibilityFlag = false;
    ...
    private native void setDisableCompatibilityFlagNative(boolean z);
    ...
    public synchronized void setDisableCompatbilityFlag(boolean disableCptFlag) {
        this.disableCompatibilityFlag = disableCptFlag;
        setDisableCompatibilityFlagNative(this.disableCompatibilityFlag);
    }

    public synchronized boolean getDisableCompatbilityFlag() {
        return this.disableCompatibilityFlag;
    }
