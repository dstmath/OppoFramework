...
public class ProxySelectorRoutePlanner implements HttpRoutePlanner {
    /* renamed from: -java-net-Proxy$TypeSwitchesValues */
    private static final /* synthetic */ int[] f0-java-net-Proxy$TypeSwitchesValues = null;
    protected ProxySelector proxySelector;
    protected SchemeRegistry schemeRegistry;

    /* renamed from: -getjava-net-Proxy$TypeSwitchesValues */
    private static /* synthetic */ int[] m0-getjava-net-Proxy$TypeSwitchesValues() {
        if (f0-java-net-Proxy$TypeSwitchesValues != null) {
            return f0-java-net-Proxy$TypeSwitchesValues;
        }
        ...
        f0-java-net-Proxy$TypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    protected Proxy chooseProxy(List<Proxy> proxies, HttpHost target, HttpRequest request, HttpContext context) {
        ...
        while (result == null && i < proxies.size()) {
            ...
            switch (m0-getjava-net-Proxy$TypeSwitchesValues()[p.type().ordinal()]) {
                case 1:
                case 2:
                    result = p;
                    break;
