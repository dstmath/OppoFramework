...
public class Cipher {
    ...
    private static final /* synthetic */ int[] f80-javax-crypto-Cipher$InitTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m35-getjavax-crypto-Cipher$InitTypeSwitchesValues() {
        if (f80-javax-crypto-Cipher$InitTypeSwitchesValues != null) {
            return f80-javax-crypto-Cipher$InitTypeSwitchesValues;
        }
        ...
        f80-javax-crypto-Cipher$InitTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    static CipherSpiAndProvider tryTransformWithProvider(InitParams initParams, String[] tokenizedTransformation, NeedToSet type, Service service) throws InvalidKeyException, InvalidAlgorithmParameterException {
        try {
            ...
            if (initParams != null) {
                switch (m35-getjavax-crypto-Cipher$InitTypeSwitchesValues()[initParams.initType.ordinal()]) {
                    case 1:
