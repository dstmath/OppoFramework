...
public abstract class CharsetDecoder {
    ...
    static final /* synthetic */ boolean f19-assertionsDisabled = (CharsetDecoder.class.desiredAssertionStatus() ^ 1);
    ...
    public final CoderResult decode(ByteBuffer in, CharBuffer out, boolean endOfInput) {
        ...
        while (true) {
            try {
                ...
                } else if (!f19-assertionsDisabled) {
