...
public abstract class CharsetEncoder {
    ...
    static final /* synthetic */ boolean f20-assertionsDisabled = (CharsetEncoder.class.desiredAssertionStatus() ^ 1);
    ...
    protected CharsetEncoder(Charset cs, float averageBytesPerChar, float maxBytesPerChar, byte[] replacement) {
        this(cs, averageBytesPerChar, maxBytesPerChar, replacement, f20-assertionsDisabled);
    }
    ...
    public final CoderResult encode(CharBuffer in, ByteBuffer out, boolean endOfInput) {
        ...
        while (true) {
            try {
                ...
                } else if (!f20-assertionsDisabled) {
