...
class FileTreeWalker implements Closeable {
    ...
    static final /* synthetic */ boolean f69-assertionsDisabled = (FileTreeWalker.class.desiredAssertionStatus() ^ 1);
    /* renamed from: -java-nio-file-FileVisitOptionSwitchesValues */
    private static final /* synthetic */ int[] f70-java-nio-file-FileVisitOptionSwitchesValues = null;
    ...
    /* renamed from: -getjava-nio-file-FileVisitOptionSwitchesValues */
    private static /* synthetic */ int[] m28-getjava-nio-file-FileVisitOptionSwitchesValues() {
        if (f70-java-nio-file-FileVisitOptionSwitchesValues != null) {
            return f70-java-nio-file-FileVisitOptionSwitchesValues;
        }
        ...
        f70-java-nio-file-FileVisitOptionSwitchesValues = iArr;
        return iArr;
    }
    ...
    FileTreeWalker(Collection<FileVisitOption> options, int maxDepth) {
        ...
        for (FileVisitOption option : options) {
            switch (m28-getjava-nio-file-FileVisitOptionSwitchesValues()[option.ordinal()]) {
                case 1:
                    fl = true;
                default:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x002f A:{ExcHandler: java.io.IOException (e java.io.IOException), Splitter: B:9:0x0022} */
    ...
    Event walk(Path file) {
        ...
        if (f69-assertionsDisabled || ev != null) {
            return ev;
        }
