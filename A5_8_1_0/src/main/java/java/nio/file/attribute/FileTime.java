...
public final class FileTime implements Comparable<FileTime> {
    /* renamed from: -java-util-concurrent-TimeUnitSwitchesValues */
    private static final /* synthetic */ int[] f73-java-util-concurrent-TimeUnitSwitchesValues = null;
    ...
    /* renamed from: -getjava-util-concurrent-TimeUnitSwitchesValues */
    private static /* synthetic */ int[] m31-getjava-util-concurrent-TimeUnitSwitchesValues() {
        if (f73-java-util-concurrent-TimeUnitSwitchesValues != null) {
            return f73-java-util-concurrent-TimeUnitSwitchesValues;
        }
        ...
        f73-java-util-concurrent-TimeUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public Instant toInstant() {
        if (this.instant == null) {
            long secs;
            int nanos = 0;
            switch (m31-getjava-util-concurrent-TimeUnitSwitchesValues()[this.unit.ordinal()]) {
                case 1:
