...
public abstract class AbstractSelectableChannel extends SelectableChannel {
    ...
    static final /* synthetic */ boolean f59-assertionsDisabled = (AbstractSelectableChannel.class.desiredAssertionStatus() ^ 1);
    ...
    private void addKey(SelectionKey k) {
        if (f59-assertionsDisabled || Thread.holdsLock(this.keyLock)) {
            int i = 0;
