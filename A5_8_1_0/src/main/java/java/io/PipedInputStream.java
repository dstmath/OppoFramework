...
public class PipedInputStream extends InputStream {
    ...
    static final /* synthetic */ boolean f21-assertionsDisabled = (PipedInputStream.class.desiredAssertionStatus() ^ 1);
    ...
    public PipedInputStream(PipedOutputStream src, int pipeSize) throws IOException {
        this.closedByWriter = f21-assertionsDisabled;
        this.closedByReader = f21-assertionsDisabled;
        this.connected = f21-assertionsDisabled;
        this.in = -1;
        this.out = 0;
        initPipe(pipeSize);
        connect(src);
    ...
    synchronized void receive(byte[] b, int off, int len) throws IOException {
        ...
        while (bytesToTransfer > 0) {
            ...
            if (f21-assertionsDisabled || nextTransferAmount > 0) {
