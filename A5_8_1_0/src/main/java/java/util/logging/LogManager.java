...
public class LogManager {
    ...
    static final /* synthetic */ boolean f192-assertionsDisabled = (LogManager.class.desiredAssertionStatus() ^ 1);
    ...
    private static class Beans {
        ...
        static boolean isBeansPresent() {
            if (propertyChangeListenerClass == null || propertyChangeEventClass == null) {
                return LogManager.f192-assertionsDisabled;
            }
            return true;
        }

        /* JADX WARNING: Removed duplicated region for block: B:14:0x002f A:{ExcHandler: java.lang.InstantiationException (r1_0 'x' java.lang.Object), Splitter: B:0:0x0000} */
    ...
    class LoggerContext {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f194-assertionsDisabled = (LoggerContext.class.desiredAssertionStatus() ^ 1);
        ...
        final boolean requiresDefaultLoggers() {
            boolean requiresDefaultLoggers = getOwner() == LogManager.manager ? true : LogManager.f192-assertionsDisabled;
        ...
        private void ensureDefaultLogger(Logger logger) {
            if (requiresDefaultLoggers() && logger != null && (logger == Logger.global || logger == LogManager.this.rootLogger)) {
                if (!this.namedLoggers.containsKey(logger.getName())) {
                    addLocalLogger(logger, (boolean) LogManager.f192-assertionsDisabled);
                }
            } else if (!f194-assertionsDisabled && logger != null) {
            ...
            AccessController.doPrivileged(new PrivilegedAction<Void>() {
                public Void run() {
                    if (!(logger == owner.rootLogger || owner.getBooleanProperty(name + ".useParentHandlers", true))) {
                        logger.setUseParentHandlers(LogManager.f192-assertionsDisabled);
                    }
                    return null;
                }
            });
    ...
    final class LoggerWeakRef extends WeakReference<Logger> {
        private boolean disposed = LogManager.f192-assertionsDisabled;
        private String name;
    ...
    private LogManager(Void checked) {
        ...
        this.initializedCalled = f192-assertionsDisabled;
        this.initializationDone = f192-assertionsDisabled;
    ...
    final void ensureLogManagerInitialized() {
        if (!this.initializationDone && this == manager) {
            synchronized (this) {
                boolean isRecursiveInitialization = this.initializedCalled ? true : f192-assertionsDisabled;
                if (!f192-assertionsDisabled && !this.initializedCalled && this.initializationDone) {
                    ...
                    if (!this.initializationDone) {
                        ...
                        try {
                            PrivilegedAction anonymousClass2 = new PrivilegedAction<Object>() {
                                /* renamed from: -assertionsDisabled */
                                static final /* synthetic */ boolean f193-assertionsDisabled = (AnonymousClass2.class.desiredAssertionStatus() ^ 1);

                                public Object run() {
                                    if (!f193-assertionsDisabled && LogManager.this.rootLogger != null) {
                                        throw new AssertionError();
                                    } else if (f193-assertionsDisabled || (LogManager.this.initializedCalled && !LogManager.this.initializationDone)) {
        ...
        if (l != null) {
            ...
            synchronized (this.listenerMap) {
                ...
                if (value != null) {
                    ...
                    } else if (f192-assertionsDisabled || i > 1) {
    ...
    Logger demandLogger(String name, String resourceBundleName, Class<?> caller) {
        ...
        if (result == null) {
            Logger newLogger = new Logger(name, resourceBundleName, caller, this, f192-assertionsDisabled);
    ...
    public boolean addLogger(Logger logger) {
        ...
        if (!getUserContext().addLocalLogger(logger, this)) {
            return f192-assertionsDisabled;
        }
    ...
    public void readConfiguration(InputStream ins) throws IOException, SecurityException {
        ...
        if (map != null) {
            if (f192-assertionsDisabled || Beans.isBeansPresent()) {
        ...
        synchronized (this) {
            this.initializedGlobalHandlers = f192-assertionsDisabled;
        }
    }
