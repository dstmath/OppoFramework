...
public class Logger {
    ...
    static final /* synthetic */ boolean f195-assertionsDisabled = (Logger.class.desiredAssertionStatus() ^ 1);
    ...
    protected Logger(String name, String resourceBundleName) {
        this(name, resourceBundleName, null, LogManager.getLogManager(), f195-assertionsDisabled);
    }
    ...
    public static Logger getAnonymousLogger(String resourceBundleName) {
        ...
        Logger result = new Logger(null, resourceBundleName, VMStack.getStackClass1(), manager, f195-assertionsDisabled);
    ...
    private void doLog(LogRecord lr, String rbname) {
        ...
        if (rbname != null) {
            ...
            lr.setResourceBundle(findResourceBundle(rbname, f195-assertionsDisabled));
        }
        log(lr);
    }
    ...
    final boolean isLevelInitialized() {
        return this.levelObject != null ? true : f195-assertionsDisabled;
    }
    ...
    public boolean isLoggable(Level level) {
        if (level.intValue() < this.levelValue || this.levelValue == offValue) {
            return f195-assertionsDisabled;
        }
        return true;
    }
    ...
    private synchronized void setupResourceInfo(String name, Class<?> callersClass) {
        ...
        if (lb.resourceBundleName != null) {
            ...
            } else if (f195-assertionsDisabled || lb.userBundle == null) {
