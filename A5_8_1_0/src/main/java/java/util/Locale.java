...
public final class Locale implements Cloneable, Serializable {
    ...
    static final /* synthetic */ boolean f12-assertionsDisabled = (Locale.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m16-getjava-util-Locale$CategorySwitchesValues() {
    ...
    public static Locale getDefault(Category category) {
        switch (m16-getjava-util-Locale$CategorySwitchesValues()[category.ordinal()]) {
            case 1:
    ...
    public boolean hasExtensions() {
        return this.localeExtensions != null ? true : f12-assertionsDisabled;
    }
    ...
    private static boolean isUnicodeExtensionKey(String s) {
        return s.length() == 2 ? LocaleUtils.isAlphaNumericString(s) : f12-assertionsDisabled;
    }
