...
public class LinkedBlockingDeque<E> extends AbstractQueue<E> implements BlockingDeque<E>, Serializable {
    ...
    private class DescendingItr extends AbstractItr {
        /* synthetic */ DescendingItr(LinkedBlockingDeque this$0, DescendingItr -this1) {
            this();
        }
    ...
    private class Itr extends AbstractItr {
        /* synthetic */ Itr(LinkedBlockingDeque this$0, Itr -this1) {
            this();
        }
    ...
    public boolean removeFirstOccurrence(Object o) {
        ...
        try {
            for (Node<E> p = this.first; p != null; p = p.next) {
                if (o.lambda$-java_util_function_Predicate_4628(p.item)) {
                    unlink(p);
                    return true;
                }
            }
