...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final class TreeBin<K, V> extends Node<K, V> {
        ...
        static final /* synthetic */ boolean f103-assertionsDisabled = (TreeBin.class.desiredAssertionStatus() ^ 1);
     ...
     */
        ...
        TreeBin(TreeNode<K, V> b) {
            ...
            this.root = r;
            if (!f103-assertionsDisabled && !checkInvariants(this.root)) {
        ...
        private final void contendedLock() {
            boolean waiting = f103-assertionsDisabled;
            while (true) {
     ...
     */
        ...
        final TreeNode<K, V> putTreeVal(int h, K k, V v) {
            Class kc = null;
            boolean searched = f103-assertionsDisabled;
            ...
            if (!(r == null || r.right == null)) {
                ...
                if (!(rl == null || rl.left == null)) {
                    ...
                    try {
                        ...
                        unlockRoot();
                        if (f103-assertionsDisabled || checkInvariants(this.root)) {
                            return f103-assertionsDisabled;
                        }
                        throw new AssertionError();
                    } catch (Throwable th) {
                        unlockRoot();
                ...
                if (xp != null) {
                    ...
                    if (xp == xppl) {
                        ...
                        if (xppr == null || !xppr.red) {
                            ...
                            if (xp != null) {
                                xp.red = f103-assertionsDisabled;
                                if (xpp != null) {
                                    xpp.red = true;
                            ...
                            xppr.red = f103-assertionsDisabled;
                            xp.red = f103-assertionsDisabled;
                            xpp.red = true;
                            x = xpp;
                        }
                        ...
                        xppl.red = f103-assertionsDisabled;
                        xp.red = f103-assertionsDisabled;
                        xpp.red = true;
                        x = xpp;
                    }
            ...
            while (x != null && x != root) {
                ...
                if (xp == null) {
                    ...
                    if (xpl == x) {
                        ...
                        if (xpr != null && xpr.red) {
                            xpr.red = f103-assertionsDisabled;
                            xp.red = true;
                            root = rotateLeft(root, xp);
                            xp = x.parent;
                        ...
                        if (xpr == null) {
                            ...
                            if ((sr == null || (sr.red ^ 1) != 0) && (sl == null || (sl.red ^ 1) != 0)) {
                                ...
                                if (sr == null || (sr.red ^ 1) != 0) {
                                    if (sl != null) {
                                        sl.red = f103-assertionsDisabled;
                                    }
                                    xpr.red = true;
                                ...
                                if (xpr != null) {
                                    xpr.red = xp == null ? f103-assertionsDisabled : xp.red;
                                    sr = xpr.right;
                                    if (sr != null) {
                                        sr.red = f103-assertionsDisabled;
                                    }
                                }
                                if (xp != null) {
                                    xp.red = f103-assertionsDisabled;
                        ...
                        if (xpl != null && xpl.red) {
                            xpl.red = f103-assertionsDisabled;
                            xp.red = true;
                            root = rotateRight(root, xp);
                            xp = x.parent;
                        ...
                        if (xpl == null) {
                            ...
                            if ((sl == null || (sl.red ^ 1) != 0) && (sr == null || (sr.red ^ 1) != 0)) {
                                ...
                                if (xpl != null) {
                                    xpl.red = xp == null ? f103-assertionsDisabled : xp.red;
                                    sl = xpl.left;
                                    if (sl != null) {
                                        sl.red = f103-assertionsDisabled;
                                    }
