...
public class Collections {
    ...
    static class CheckedList<E> extends CheckedCollection<E> implements List<E> {
        ...
        /* renamed from: lambda$-java_util_Collections$CheckedList_142882 */
        /* synthetic */ Object m4lambda$-java_util_Collections$CheckedList_142882(UnaryOperator operator, Object e) {
    ...
    private static class CheckedMap<K, V> implements Map<K, V>, Serializable {
        ...
        /* renamed from: lambda$-java_util_Collections$CheckedMap_146492 */
        /* synthetic */ Object m5lambda$-java_util_Collections$CheckedMap_146492(BiFunction func, Object k, Object v) {
        ...
        /* renamed from: lambda$-java_util_Collections$CheckedMap_150612 */
        /* synthetic */ Object m6lambda$-java_util_Collections$CheckedMap_150612(Function mappingFunction, Object k) {
        ...
        /* renamed from: lambda$-java_util_Collections$CheckedMap_151435 */
        /* synthetic */ Object m7lambda$-java_util_Collections$CheckedMap_151435(BiFunction remappingFunction, Object v1, Object v2) {
    ...
    private static class CopiesList<E> extends AbstractList<E> implements RandomAccess, Serializable {
        ...
        static final /* synthetic */ boolean f4-assertionsDisabled = (CopiesList.class.desiredAssertionStatus() ^ 1);
        private static final long serialVersionUID = 2739099268398711800L;
        final E element;
        final int n;

        CopiesList(int n, E e) {
            if (f4-assertionsDisabled || n >= 0) {
                this.n = n;
                this.element = e;
                return;
            }
        ...
        public boolean contains(Object obj) {
            return this.n != 0 ? Collections.eq(obj, this.element) : f4-assertionsDisabled;
        }
        ...
        /* renamed from: lambda$-java_util_Collections$CopiesList_199111 */
        /* synthetic */ Object m8lambda$-java_util_Collections$CopiesList_199111(int i) {
            return this.element;
        }
        ...
        /* renamed from: lambda$-java_util_Collections$CopiesList_199260 */
        /* synthetic */ Object m9lambda$-java_util_Collections$CopiesList_199260(int i) {
            return this.element;
        }
    ...
    private static class ReverseComparator2<T> implements Comparator<T>, Serializable {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f5-assertionsDisabled = (ReverseComparator2.class.desiredAssertionStatus() ^ 1);
        private static final long serialVersionUID = 4374092139857L;
        final Comparator<T> cmp;

        ReverseComparator2(Comparator<T> cmp) {
            if (f5-assertionsDisabled || cmp != null) {
                this.cmp = cmp;
                return;
            }
            throw new AssertionError();
    ...
    public static <T> boolean replaceAll(List<T> list, T oldVal, T newVal) {
        ...
        if (size >= 11 && !(list instanceof RandomAccess)) {
            ...
            if (oldVal == null) {
                ...
                for (i = 0; i < size; i++) {
                    if (oldVal.lambda$-java_util_function_Predicate_4628(itr.next())) {
                        itr.set(newVal);
                        result = true;
                    }
                }
            ...
            for (i = 0; i < size; i++) {
                if (oldVal.lambda$-java_util_function_Predicate_4628(list.get(i))) {
                    list.set(i, newVal);
                    result = true;
                }
            }
    ...
    public static int frequency(Collection<?> c, Object o) {
        ...
        if (o == null) {
            ...
            for (Object e2 : c) {
                if (o.lambda$-java_util_function_Predicate_4628(e2)) {
                    result++;
                }
            }
        }
