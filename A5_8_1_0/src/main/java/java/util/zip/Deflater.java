...
public class Deflater {
    ...
    static final /* synthetic */ boolean f191-assertionsDisabled = (Deflater.class.desiredAssertionStatus() ^ 1);
    ...
    public Deflater(int level) {
        this(level, f191-assertionsDisabled);
    }

    public Deflater() {
        this(-1, f191-assertionsDisabled);
    }
    ...
    public boolean needsInput() {
        boolean z = f191-assertionsDisabled;
        synchronized (this.zsRef) {
            if (this.len <= 0) {
                z = true;
            }
    ...
    public void reset() {
        synchronized (this.zsRef) {
            ...
            this.finish = f191-assertionsDisabled;
            this.finished = f191-assertionsDisabled;
            this.len = 0;
            this.off = 0;
            this.bytesWritten = 0;
            this.bytesRead = 0;
    ...
    private void ensureOpen() {
        if (!f191-assertionsDisabled && !Thread.holdsLock(this.zsRef)) {
