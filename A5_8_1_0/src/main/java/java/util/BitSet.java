...
public class BitSet implements Cloneable, Serializable {
    ...
    static final /* synthetic */ boolean f49-assertionsDisabled = (BitSet.class.desiredAssertionStatus() ^ 1);
    ...
    private transient boolean sizeIsSticky = f49-assertionsDisabled;
    private long[] words;
    ...
    private void checkInvariants() {
        if (!f49-assertionsDisabled && this.wordsInUse != 0 && this.words[this.wordsInUse - 1] == 0) {
            throw new AssertionError();
        } else if (!f49-assertionsDisabled && (this.wordsInUse < 0 || this.wordsInUse > this.words.length)) {
            throw new AssertionError();
        } else if (!f49-assertionsDisabled && this.wordsInUse != this.words.length && this.words[this.wordsInUse] != 0) {
            throw new AssertionError();
        }
    }
    ...
    public BitSet() {
        initWords(64);
        this.sizeIsSticky = f49-assertionsDisabled;
    }
    ...
    public BitSet get(int fromIndex, int toIndex) {
        ...
        boolean wordAligned = (fromIndex & BIT_INDEX_MASK) == 0 ? true : f49-assertionsDisabled;
        int i = 0;
    ...
    public boolean isEmpty() {
        return this.wordsInUse == 0 ? true : f49-assertionsDisabled;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        recalculateWordsInUse();
        boolean z = (this.words.length <= 0 || this.words[this.words.length - 1] != 0) ? f49-assertionsDisabled : true;
        this.sizeIsSticky = z;
        checkInvariants();
    }
    ...
    public IntStream stream() {
        return StreamSupport.intStream(new -$Lambda$_AqhqkT4X2P3dexV7i-4bO_fGpk(this), 16469, f49-assertionsDisabled);
    }

    /* renamed from: lambda$-java_util_BitSet_41972 */
    /* synthetic */ OfInt m24lambda$-java_util_BitSet_41972() {
        return Spliterators.spliterator(new PrimitiveIterator.OfInt() {
            int next = BitSet.this.nextSetBit(0);

            public boolean hasNext() {
                return this.next != -1 ? true : BitSet.f49-assertionsDisabled;
            }
