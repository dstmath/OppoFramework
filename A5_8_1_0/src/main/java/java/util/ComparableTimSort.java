...
class ComparableTimSort {
    ...
    static final /* synthetic */ boolean f141-assertionsDisabled = (ComparableTimSort.class.desiredAssertionStatus() ^ 1);
    ...
    static void sort(Object[] a, int lo, int hi, Object[] work, int workBase, int workLen) {
        if (f141-assertionsDisabled || (a != null && lo >= 0 && lo <= hi && hi <= a.length)) {
            ...
            if (nRemaining >= 2) {
                ...
                if (f141-assertionsDisabled || lo == hi) {
                    ts.mergeForceCollapse();
                    if (!f141-assertionsDisabled && ts.stackSize != 1) {
    ...
    private static void binarySort(Object[] a, int lo, int hi, int start) {
        if (f141-assertionsDisabled || (lo <= start && start <= hi)) {
            if (start == lo) {
                start++;
            }
            while (start < hi) {
                ...
                int left = lo;
                int right = start;
                if (f141-assertionsDisabled || lo <= right) {
                    while (left < right) {
                    ...
                    if (f141-assertionsDisabled || left == right) {
                        int n = start - left;
                        switch (n) {
                            case 1:
                                break;
    ...
    private static int minRunLength(int n) {
        if (f141-assertionsDisabled || n >= 0) {
            int r = 0;
            while (n >= 32) {
                r |= n & 1;
                n >>= 1;
    ...
    private void mergeAt(int i) {
        if (!f141-assertionsDisabled && this.stackSize < 2) {
            throw new AssertionError();
        } else if (!f141-assertionsDisabled && i < 0) {
            throw new AssertionError();
        } else if (f141-assertionsDisabled || i == this.stackSize - 2 || i == this.stackSize - 3) {
            int base1 = this.runBase[i];
            int len1 = this.runLen[i];
            int base2 = this.runBase[i + 1];
            int len2 = this.runLen[i + 1];
            if (!f141-assertionsDisabled && (len1 <= 0 || len2 <= 0)) {
                throw new AssertionError();
            } else if (f141-assertionsDisabled || base1 + len1 == base2) {
    ...
    private static int gallopLeft(Comparable<Object> key, Object[] a, int base, int len, int hint) {
        if (f141-assertionsDisabled || (len > 0 && hint >= 0 && hint < len)) {
            int lastOfs = 0;
            int ofs = 1;
            int maxOfs;
            ...
            if (f141-assertionsDisabled || (-1 <= lastOfs && lastOfs < ofs && ofs <= len)) {
                lastOfs++;
                while (lastOfs < ofs) {
                ...
                if (f141-assertionsDisabled || lastOfs == ofs) {
                    return ofs;
                }
                throw new AssertionError();
            }
    ...
    private void mergeLo(int base1, int len1, int base2, int len2) {
        if (f141-assertionsDisabled || (len1 > 0 && len2 > 0 && base1 + len1 == base2)) {
            Object a = this.a;
            ...
            if (len2 == 0) {
                ...
                while (true) {
                    ...
                    int count2 = 0;
                    do {
                        if (f141-assertionsDisabled || (len1 > 1 && len2 > 0)) {
                ...
                } else if (!f141-assertionsDisabled && len2 != 0) {
                    throw new AssertionError();
                } else if (f141-assertionsDisabled || len1 > 1) {
                    System.arraycopy(tmp, cursor1, a, dest, len1);
                } else {
                    throw new AssertionError();
                }
        ...
        if (f141-assertionsDisabled || (len1 > 0 && len2 > 0 && base1 + len1 == base2)) {
            ...
            if (len1 == 0) {
                ...
                while (true) {
                    ...
                    int count2 = 0;
                    do {
                        if (f141-assertionsDisabled || (len1 > 0 && len2 > 1)) {
                ...
                this.minGallop = minGallop;
                if (len2 == 1) {
                    if (f141-assertionsDisabled || len1 > 0) {
                        i -= len1;
                    ...
                    throw new IllegalArgumentException("Comparison method violates its general contract!");
                } else if (!f141-assertionsDisabled && len1 != 0) {
                    throw new AssertionError();
                } else if (f141-assertionsDisabled || len2 > 0) {
