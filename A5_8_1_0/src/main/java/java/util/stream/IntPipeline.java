...
public abstract class IntPipeline<E_IN> extends AbstractPipeline<E_IN, Integer, IntStream> implements IntStream {
    ...
    public static abstract class StatelessOp<E_IN> extends IntPipeline<E_IN> {
        ...
        static final /* synthetic */ boolean f215-assertionsDisabled = (StatelessOp.class.desiredAssertionStatus() ^ 1);

        public StatelessOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f215-assertionsDisabled && upstream.getOutputShape() != inputShape) {
    ...
    public static abstract class StatefulOp<E_IN> extends IntPipeline<E_IN> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f216-assertionsDisabled = (StatefulOp.class.desiredAssertionStatus() ^ 1);
        ...
        public StatefulOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f216-assertionsDisabled && upstream.getOutputShape() != inputShape) {
                throw new AssertionError();
            }
        }
            ...
            public Sink<Integer> opWrapSink(int flags, Sink<Long> sink) {
                return new ChainedInt<Long>(sink) {
                    public void accept(int t) {
                        this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0((long) t);
                    }
                };
            }
        };
        ...
        return new StatelessOp<Integer>(this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Integer> opWrapSink(int flags, Sink<Integer> sink) {
                ...
                return new ChainedInt<Integer>(sink) {
                    public void accept(int t) {
                        this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(intUnaryOperator.applyAsInt(t));
                    }
                };
            }
        };
        ...
        return new java.util.stream.ReferencePipeline.StatelessOp<Integer, U>(this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Integer> opWrapSink(int flags, Sink<U> sink) {
                ...
                return new ChainedInt<U>(sink) {
                    public void accept(int t) {
                        this.downstream.-java_util_stream_SortedOps$RefSortingSink-mthref-0(intFunction.apply(t));
                    }
                };
            }
        };
    ...
    public final LongStream mapToLong(IntToLongFunction mapper) {
        ...
        return new java.util.stream.LongPipeline.StatelessOp<Integer>(this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Integer> opWrapSink(int flags, Sink<Long> sink) {
                ...
                return new ChainedInt<Long>(sink) {
                    public void accept(int t) {
                        this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(intToLongFunction.applyAsLong(t));
                    }
                };
            }
        };
        ...
        return new StatelessOp<Integer>(this, StreamShape.INT_VALUE, (StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) | StreamOpFlag.NOT_SIZED) {
            public Sink<Integer> opWrapSink(int flags, Sink<Integer> sink) {
                ...
                return new ChainedInt<Integer>(sink) {
                    ...
                    /* renamed from: lambda$-java_util_stream_IntPipeline$7$1_11907 */
                    /* synthetic */ void m136lambda$-java_util_stream_IntPipeline$7$1_11907(int i) {
                        this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(i);
                    }
                };
            }
        };
                ...
                return new ChainedInt<Integer>(sink) {
                    ...
                    public void accept(int t) {
                        if (intPredicate.test(t)) {
                            this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(t);
                        }
                    }
                };
            }
    ...
    /* renamed from: lambda$-java_util_stream_IntPipeline_15510 */
    static /* synthetic */ void m134lambda$-java_util_stream_IntPipeline_15510(long[] ll, int i) {
        ll[0] = ll[0] + 1;
        ll[1] = ll[1] + ((long) i);
    }

    /* renamed from: lambda$-java_util_stream_IntPipeline_15671 */
    static /* synthetic */ void m135lambda$-java_util_stream_IntPipeline_15671(long[] ll, long[] rr) {
        ll[0] = ll[0] + rr[0];
        ll[1] = ll[1] + rr[1];
    }
