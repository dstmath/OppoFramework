...
class StreamSpliterators {
    ...
    static abstract class ArrayBuffer {
        ...
        static final class OfRef<T> extends ArrayBuffer implements Consumer<T> {
            ...
            public void forEach(Consumer<? super T> action, long fence) {
                for (int i = 0; ((long) i) < fence; i++) {
                    action.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.array[i]);
                }
            }
        }
    ...
    static final class DistinctSpliterator<T> implements Spliterator<T>, Consumer<T> {
        ...
        public boolean tryAdvance(Consumer<? super T> action) {
            while (this.s.tryAdvance(this)) {
                if (this.seen.putIfAbsent(mapNull(this.tmpSlot), Boolean.TRUE) == null) {
                    action.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.tmpSlot);
                    this.tmpSlot = null;
                    return true;
                }
            }
        ...
        /* renamed from: lambda$-java_util_stream_StreamSpliterators$DistinctSpliterator_46149 */
        /* synthetic */ void m138x559c8077(Consumer action, Object t) {
            if (this.seen.putIfAbsent(mapNull(t), Boolean.TRUE) == null) {
                action.-java_util_stream_SortedOps$RefSortingSink-mthref-0(t);
            }
        }
    ...
    static final class DoubleWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Double, OfDouble> implements Spliterator.OfDouble {
        ...
        /* renamed from: lambda$-java_util_stream_StreamSpliterators$DoubleWrappingSpliterator_16351 */
        /* synthetic */ boolean m139xdd52a83c() {
    ...
    static abstract class InfiniteSupplyingSpliterator<T> implements Spliterator<T> {
        ...
        static final class OfRef<T> extends InfiniteSupplyingSpliterator<T> {
            ...
            public boolean tryAdvance(Consumer<? super T> action) {
                Objects.requireNonNull(action);
                action.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.s.lambda$-java_util_stream_Collectors_49198());
                return true;
            }
    ...
    static final class IntWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Integer, OfInt> implements Spliterator.OfInt {
        ...
        /* renamed from: lambda$-java_util_stream_StreamSpliterators$IntWrappingSpliterator_12402 */
        /* synthetic */ boolean m140x5e3b06a7() {
            return this.spliterator.tryAdvance(this.bufferSink);
        }
    ...
    static final class LongWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Long, OfLong> implements Spliterator.OfLong {
        ...
        /* renamed from: lambda$-java_util_stream_StreamSpliterators$LongWrappingSpliterator_14357 */
        /* synthetic */ boolean m141xd775d779() {
            return this.spliterator.tryAdvance(this.bufferSink);
        }
    ...
    static abstract class SliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        static final /* synthetic */ boolean f224-assertionsDisabled = (SliceSpliterator.class.desiredAssertionStatus() ^ 1);
        long fence;
        long index;
        T_SPLITR s;
        ...
        static final class OfDouble extends OfPrimitive<Double, java.util.Spliterator.OfDouble, DoubleConsumer> implements java.util.Spliterator.OfDouble {
            /* renamed from: lambda$-java_util_stream_StreamSpliterators$SliceSpliterator$OfDouble_31710 */
            static /* synthetic */ void m142x4d2420fb(double e) {
            }
        ...
        static final class OfInt extends OfPrimitive<Integer, java.util.Spliterator.OfInt, IntConsumer> implements java.util.Spliterator.OfInt {
            /* renamed from: lambda$-java_util_stream_StreamSpliterators$SliceSpliterator$OfInt_29662 */
            static /* synthetic */ void m143x7f7e1aa(int e) {
            }
        ...
        static final class OfLong extends OfPrimitive<Long, java.util.Spliterator.OfLong, LongConsumer> implements java.util.Spliterator.OfLong {
            /* renamed from: lambda$-java_util_stream_StreamSpliterators$SliceSpliterator$OfLong_30670 */
            static /* synthetic */ void m144xec82b040(long e) {
            }
        ...
        static final class OfRef<T> extends SliceSpliterator<T, Spliterator<T>> implements Spliterator<T> {
            /* renamed from: lambda$-java_util_stream_StreamSpliterators$SliceSpliterator$OfRef_25294 */
            static /* synthetic */ void m145xb2dc172d(Object obj) {
            }

            /* renamed from: lambda$-java_util_stream_StreamSpliterators$SliceSpliterator$OfRef_26203 */
            static /* synthetic */ void m146xb2dc8a74(Object obj) {
            }
        ...
        SliceSpliterator(T_SPLITR s, long sliceOrigin, long sliceFence, long origin, long fence) {
            if (f224-assertionsDisabled || s.hasCharacteristics(16384)) {
                this.s = s;
    ...
    static abstract class UnorderedSliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f225-assertionsDisabled = (UnorderedSliceSpliterator.class.desiredAssertionStatus() ^ 1);
        ...
        static abstract class OfPrimitive<T, T_CONS, T_BUFF extends OfPrimitive<T_CONS>, T_SPLITR extends java.util.Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>> extends UnorderedSliceSpliterator<T, T_SPLITR> implements java.util.Spliterator.OfPrimitive<T, T_CONS, T_SPLITR> {
            ...
            public boolean tryAdvance(T_CONS action) {
                ...
                return UnorderedSliceSpliterator.f225-assertionsDisabled;
            }
        ...
        UnorderedSliceSpliterator(T_SPLITR s, long skip, long limit) {
            long j;
            this.s = s;
            this.unlimited = limit < 0 ? true : f225-assertionsDisabled;
            if (limit >= 0) {
                j = limit;
            } else {
                j = 0;
        ...
        protected final long acquirePermits(long numElements) {
            if (f225-assertionsDisabled || numElements > 0) {
    ...
    static final class WrappingSpliterator<P_IN, P_OUT> extends AbstractWrappingSpliterator<P_IN, P_OUT, SpinedBuffer<P_OUT>> {
        ...
        /* renamed from: lambda$-java_util_stream_StreamSpliterators$WrappingSpliterator_10555 */
        /* synthetic */ boolean m147x5c6ed919() {
            return this.spliterator.tryAdvance(this.bufferSink);
        }
        ...
        public boolean tryAdvance(Consumer<? super P_OUT> consumer) {
            ...
            boolean hasNext = doAdvance();
            if (hasNext) {
                consumer.-java_util_stream_SortedOps$RefSortingSink-mthref-0(((SpinedBuffer) this.buffer).get(this.nextToConsume));
            }
            return hasNext;
        }
