...
public abstract class AbstractPipeline<E_IN, E_OUT, S extends BaseStream<E_OUT, S>> extends PipelineHelper<E_OUT> implements BaseStream<E_OUT, S> {
    ...
    static final /* synthetic */ boolean f200-assertionsDisabled = (AbstractPipeline.class.desiredAssertionStatus() ^ 1);
    ...
    final <R> R evaluate(TerminalOp<E_OUT, R> terminalOp) {
        if (!f200-assertionsDisabled && getOutputShape() != terminalOp.inputShape()) {
    ...
    final Spliterator<E_OUT> sourceStageSpliterator() {
        if (this != this.sourceStage) {
            ...
            if (this.sourceStage.sourceSpliterator != null) {
                ...
                s = (Spliterator) this.sourceStage.sourceSupplier.lambda$-java_util_stream_Collectors_49198();
    ...
    public final S sequential() {
        this.sourceStage.parallel = f200-assertionsDisabled;
        return this;
    }
    ...
    /* renamed from: lambda$-java_util_stream_AbstractPipeline_14339 */
    /* synthetic */ Spliterator m101lambda$-java_util_stream_AbstractPipeline_14339() {
    ...
    private Spliterator<?> sourceSpliterator(int terminalFlags) {
        ...
        if (this.sourceStage.sourceSpliterator != null) {
            ...
            spliterator = (Spliterator) this.sourceStage.sourceSupplier.lambda$-java_util_stream_Collectors_49198();
            this.sourceStage.sourceSupplier = null;
        } else {
            throw new IllegalStateException(MSG_CONSUMED);
        }
    ...
    /* renamed from: lambda$-java_util_stream_AbstractPipeline_20439 */
    static /* synthetic */ Spliterator m100lambda$-java_util_stream_AbstractPipeline_20439(Spliterator sourceSpliterator) {
        return sourceSpliterator;
    }
