...
final class Nodes {
    ...
    private static final /* synthetic */ int[] f203-java-util-stream-StreamShapeSwitchesValues = null;
    ...
    private static class ArrayNode<T> implements Node<T> {
        ...
        public void forEach(Consumer<? super T> consumer) {
            for (int i = 0; i < this.curSize; i++) {
                consumer.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.array[i]);
            }
        }
    ...
    private static final class DoubleFixedNodeBuilder extends DoubleArrayNode implements Builder.OfDouble {
        ...
        static final /* synthetic */ boolean f204-assertionsDisabled = (DoubleFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        DoubleFixedNodeBuilder(long size) {
            super(size);
            if (!f204-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
    ...
    private static final class DoubleSpinedNodeBuilder extends SpinedBuffer.OfDouble implements OfDouble, Builder.OfDouble {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f205-assertionsDisabled = (DoubleSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        ...
        public Spliterator.OfDouble spliterator() {
            if (f205-assertionsDisabled || !this.building) {
    ...
    private static final class FixedNodeBuilder<T> extends ArrayNode<T> implements Builder<T> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f206-assertionsDisabled = (FixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        FixedNodeBuilder(long size, IntFunction<T[]> generator) {
            super(size, generator);
            if (!f206-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
                throw new AssertionError();
            }
        }
    ...
    private static final class IntFixedNodeBuilder extends IntArrayNode implements Builder.OfInt {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f207-assertionsDisabled = (IntFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        IntFixedNodeBuilder(long size) {
            super(size);
            if (!f207-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
                throw new AssertionError();
            }
        }
    ...
    private static final class IntSpinedNodeBuilder extends SpinedBuffer.OfInt implements OfInt, Builder.OfInt {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f208-assertionsDisabled = (IntSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
        ...
        public Spliterator.OfInt spliterator() {
            if (f208-assertionsDisabled || !this.building) {
                return super.spliterator();
            }
            throw new AssertionError((Object) "during building");
        }
    ...
    private static final class LongFixedNodeBuilder extends LongArrayNode implements Builder.OfLong {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f209-assertionsDisabled = (LongFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        LongFixedNodeBuilder(long size) {
            super(size);
            if (!f209-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
                throw new AssertionError();
            }
        }
    ...
    private static final class LongSpinedNodeBuilder extends SpinedBuffer.OfLong implements OfLong, Builder.OfLong {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f210-assertionsDisabled = (LongSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
        ...
        public Spliterator.OfLong spliterator() {
            if (f210-assertionsDisabled || !this.building) {
                return super.spliterator();
            }
            throw new AssertionError((Object) "during building");
        }
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>, K extends SizedCollectorTask<P_IN, P_OUT, T_SINK, K>> extends CountedCompleter<Void> implements Sink<P_OUT> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f211-assertionsDisabled = (SizedCollectorTask.class.desiredAssertionStatus() ^ 1);
        protected int fence;
        protected final PipelineHelper<P_OUT> helper;
        protected int index;
        ...
        SizedCollectorTask(Spliterator<P_IN> spliterator, PipelineHelper<P_OUT> helper, int arrayLength) {
            if (f211-assertionsDisabled || spliterator.hasCharacteristics(16384)) {
        ...
        public void compute() {
            ...
            if (f211-assertionsDisabled || task.offset + task.length < Nodes.MAX_ARRAY_SIZE) {
    ...
    private static final class SpinedNodeBuilder<T> extends SpinedBuffer<T> implements Node<T>, Builder<T> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f212-assertionsDisabled = (SpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
        ...
        public Spliterator<T> spliterator() {
            if (f212-assertionsDisabled || !this.building) {
                return super.spliterator();
            }
            throw new AssertionError((Object) "during building");
        }
    ...
    private static /* synthetic */ int[] m126-getjava-util-stream-StreamShapeSwitchesValues() {
        if (f203-java-util-stream-StreamShapeSwitchesValues != null) {
            return f203-java-util-stream-StreamShapeSwitchesValues;
        }
        ...
        f203-java-util-stream-StreamShapeSwitchesValues = iArr;
        return iArr;
    }
    ...
    static <T> Node<T> emptyNode(StreamShape shape) {
        switch (m126-getjava-util-stream-StreamShapeSwitchesValues()[shape.ordinal()]) {
            case 1:
