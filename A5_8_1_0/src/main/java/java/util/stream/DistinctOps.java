...
final class DistinctOps {
    ...
    static <T> ReferencePipeline<T, T> makeRef(AbstractPipeline<?, T, ?> upstream) {
        return new StatefulOp<T, T>(upstream, StreamShape.REFERENCE, StreamOpFlag.IS_DISTINCT | StreamOpFlag.NOT_SIZED) {
            ...
            /* renamed from: lambda$-java_util_stream_DistinctOps$1_3835 */
            static /* synthetic */ void m137lambda$-java_util_stream_DistinctOps$1_3835(AtomicBoolean seenNull, ConcurrentHashMap map, Object t) {
                if (t == null) {
                    seenNull.set(true);
                } else {
