...
public abstract class DoublePipeline<E_IN> extends AbstractPipeline<E_IN, Double, DoubleStream> implements DoubleStream {
    ...
    public static abstract class StatelessOp<E_IN> extends DoublePipeline<E_IN> {
        ...
        static final /* synthetic */ boolean f201-assertionsDisabled = (StatelessOp.class.desiredAssertionStatus() ^ 1);

        public StatelessOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f201-assertionsDisabled && upstream.getOutputShape() != inputShape) {
    ...
    public static abstract class StatefulOp<E_IN> extends DoublePipeline<E_IN> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f202-assertionsDisabled = (StatefulOp.class.desiredAssertionStatus() ^ 1);
        ...
        public StatefulOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f202-assertionsDisabled && upstream.getOutputShape() != inputShape) {
                throw new AssertionError();
            }
        }
        ...
        return new java.util.stream.ReferencePipeline.StatelessOp<Double, U>(this, StreamShape.DOUBLE_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Double> opWrapSink(int flags, Sink<U> sink) {
                ...
                return new ChainedDouble<U>(sink) {
                    public void accept(double t) {
                        this.downstream.-java_util_stream_SortedOps$RefSortingSink-mthref-0(doubleFunction.apply(t));
                    }
                };
            }
        };
        ...
        return new java.util.stream.IntPipeline.StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Double> opWrapSink(int flags, Sink<Integer> sink) {
                ...
                return new ChainedDouble<Integer>(sink) {
                    public void accept(double t) {
                        this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(doubleToIntFunction.applyAsInt(t));
                    }
                };
            }
        };
        ...
        return new java.util.stream.LongPipeline.StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Double> opWrapSink(int flags, Sink<Long> sink) {
                ...
                return new ChainedDouble<Long>(sink) {
                    public void accept(double t) {
                        this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(doubleToLongFunction.applyAsLong(t));
                    }
                };
            }
        };
        ...
        return new StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE, (StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) | StreamOpFlag.NOT_SIZED) {
            public Sink<Double> opWrapSink(int flags, Sink<Double> sink) {
                ...
                return new ChainedDouble<Double>(sink) {
                    ...
                    /* renamed from: lambda$-java_util_stream_DoublePipeline$5$1_10563 */
                    /* synthetic */ void m106lambda$-java_util_stream_DoublePipeline$5$1_10563(double i) {
    ...
    /* renamed from: lambda$-java_util_stream_DoublePipeline_14331 */
    static /* synthetic */ void m102lambda$-java_util_stream_DoublePipeline_14331(double[] ll, double d) {
        Collectors.sumWithCompensation(ll, d);
        ll[2] = ll[2] + d;
    }

    /* renamed from: lambda$-java_util_stream_DoublePipeline_14530 */
    static /* synthetic */ void m103lambda$-java_util_stream_DoublePipeline_14530(double[] ll, double[] rr) {
    ...
    /* renamed from: lambda$-java_util_stream_DoublePipeline_15880 */
    static /* synthetic */ void m104lambda$-java_util_stream_DoublePipeline_15880(double[] ll, double d) {
        ll[2] = ll[2] + 1.0d;
        Collectors.sumWithCompensation(ll, d);
        ll[3] = ll[3] + d;
    }

    /* renamed from: lambda$-java_util_stream_DoublePipeline_16123 */
    static /* synthetic */ void m105lambda$-java_util_stream_DoublePipeline_16123(double[] ll, double[] rr) {
        Collectors.sumWithCompensation(ll, rr[0]);
        Collectors.sumWithCompensation(ll, rr[1]);
        ll[2] = ll[2] + rr[2];
        ll[3] = ll[3] + rr[3];
