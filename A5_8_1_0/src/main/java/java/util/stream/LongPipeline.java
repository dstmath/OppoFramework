...
public abstract class LongPipeline<E_IN> extends AbstractPipeline<E_IN, Long, LongStream> implements LongStream {
    ...
    public static abstract class StatelessOp<E_IN> extends LongPipeline<E_IN> {
        ...
        static final /* synthetic */ boolean f213-assertionsDisabled = (StatelessOp.class.desiredAssertionStatus() ^ 1);

        public StatelessOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f213-assertionsDisabled && upstream.getOutputShape() != inputShape) {
    ...
    public static abstract class StatefulOp<E_IN> extends LongPipeline<E_IN> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f214-assertionsDisabled = (StatefulOp.class.desiredAssertionStatus() ^ 1);
        ...
        public StatefulOp(AbstractPipeline<?, E_IN, ?> upstream, StreamShape inputShape, int opFlags) {
            super(upstream, opFlags);
            if (!f214-assertionsDisabled && upstream.getOutputShape() != inputShape) {
                throw new AssertionError();
            }
        }
        ...
        return new StatelessOp<Long>(this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Long> opWrapSink(int flags, Sink<Long> sink) {
                ...
                return new ChainedLong<Long>(sink) {
                    public void accept(long t) {
                        this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(longUnaryOperator.applyAsLong(t));
                    }
                };
            }
        };
        ...
        return new java.util.stream.ReferencePipeline.StatelessOp<Long, U>(this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Long> opWrapSink(int flags, Sink<U> sink) {
                ...
                return new ChainedLong<U>(sink) {
                    public void accept(long t) {
                        this.downstream.-java_util_stream_SortedOps$RefSortingSink-mthref-0(longFunction.apply(t));
                    }
                };
            }
        };
        ...
        return new java.util.stream.IntPipeline.StatelessOp<Long>(this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
            public Sink<Long> opWrapSink(int flags, Sink<Integer> sink) {
                ...
                return new ChainedLong<Integer>(sink) {
                    public void accept(long t) {
                        this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(longToIntFunction.applyAsInt(t));
                    }
                };
            }
        };
        ...
        return new StatelessOp<Long>(this, StreamShape.LONG_VALUE, (StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) | StreamOpFlag.NOT_SIZED) {
            public Sink<Long> opWrapSink(int flags, Sink<Long> sink) {
                ...
                return new ChainedLong<Long>(sink) {
                    ...
                    /* renamed from: lambda$-java_util_stream_LongPipeline$6$1_11125 */
                    /* synthetic */ void m129lambda$-java_util_stream_LongPipeline$6$1_11125(long i) {
                        this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(i);
                    }
                };
            }
        };
                ...
                return new ChainedLong<Long>(sink) {
                    ...
                    public void accept(long t) {
                        if (longPredicate.test(t)) {
                            this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(t);
                        }
                    }
                };
            }
    ...
    /* renamed from: lambda$-java_util_stream_LongPipeline_14701 */
    static /* synthetic */ void m127lambda$-java_util_stream_LongPipeline_14701(long[] ll, long i) {
        ll[0] = ll[0] + 1;
        ll[1] = ll[1] + i;
    }

    /* renamed from: lambda$-java_util_stream_LongPipeline_14862 */
    static /* synthetic */ void m128lambda$-java_util_stream_LongPipeline_14862(long[] ll, long[] rr) {
        ll[0] = ll[0] + rr[0];
        ll[1] = ll[1] + rr[1];
    }
