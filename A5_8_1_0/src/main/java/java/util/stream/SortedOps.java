...
final class SortedOps {
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                ...
                while (i < length) {
                    ...
                    this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(anInt);
                    i++;
                }
            } else {
                length = ints.length;
                while (i < length) {
                    this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(ints[i]);
                    i++;
                }
            }
            this.downstream.end();
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                ...
                while (i < length) {
                    ...
                    this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(aLong);
                    i++;
                }
            } else {
                length = longs.length;
                while (i < length) {
                    this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(longs[i]);
                    i++;
                }
            }
            this.downstream.end();
    ...
    private static final class SizedIntSortingSink extends AbstractIntSortingSink {
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                for (i = 0; i < this.offset && (this.downstream.cancellationRequested() ^ 1) != 0; i++) {
                    this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(this.array[i]);
                }
            } else {
                for (i = 0; i < this.offset; i++) {
                    this.downstream.-java_util_stream_ReferencePipeline$8$1-mthref-0(this.array[i]);
    ...
    private static final class SizedLongSortingSink extends AbstractLongSortingSink {
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                for (i = 0; i < this.offset && (this.downstream.cancellationRequested() ^ 1) != 0; i++) {
                    this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(this.array[i]);
                }
            } else {
                for (i = 0; i < this.offset; i++) {
                    this.downstream.-java_util_stream_ReferencePipeline$10$1-mthref-0(this.array[i]);
    ...
    private static final class SizedRefSortingSink<T> extends AbstractRefSortingSink<T> {
        ...
        public void end() {
            ...
            if (this.cancellationWasRequested) {
                for (i = 0; i < this.offset && (this.downstream.cancellationRequested() ^ 1) != 0; i++) {
                    this.downstream.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.array[i]);
                }
            } else {
                for (i = 0; i < this.offset; i++) {
                    this.downstream.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.array[i]);
