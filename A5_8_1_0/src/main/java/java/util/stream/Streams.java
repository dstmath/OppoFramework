...
final class Streams {
    ...
    static final class RangeLongSpliterator implements OfLong {
        ...
        static final /* synthetic */ boolean f236-assertionsDisabled = (RangeLongSpliterator.class.desiredAssertionStatus() ^ 1);
        ...
        private RangeLongSpliterator(long from, long upTo, int last) {
            if (f236-assertionsDisabled || (upTo - from) + ((long) last) > 0) {
                this.from = from;
                this.upTo = upTo;
                this.last = last;
                return;
        ...
        public boolean tryAdvance(LongConsumer consumer) {
            ...
            if (i < this.upTo) {
                ...
                return f236-assertionsDisabled;
            } else {
                this.last = 0;
                consumer.-java_util_stream_StreamSpliterators$LongWrappingSpliterator-mthref-1(i);
                return true;
    ...
    static final class StreamBuilderImpl<T> extends AbstractStreamBuilderImpl<T, Spliterator<T>> implements Stream.Builder<T> {
        ...
        public boolean tryAdvance(Consumer<? super T> action) {
            ...
            action.-java_util_stream_SortedOps$RefSortingSink-mthref-0(this.first);
            this.count = -1;
            return true;
        }
