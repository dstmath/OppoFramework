...
class TimSort<T> {
    ...
    static final /* synthetic */ boolean f147-assertionsDisabled = (TimSort.class.desiredAssertionStatus() ^ 1);
    ...
    static <T> void sort(T[] a, int lo, int hi, Comparator<? super T> c, T[] work, int workBase, int workLen) {
        if (f147-assertionsDisabled || (c != null && a != null && lo >= 0 && lo <= hi && hi <= a.length)) {
            ...
            if (nRemaining >= 2) {
                ...
                if (f147-assertionsDisabled || lo == hi) {
                    ts.mergeForceCollapse();
                    if (!f147-assertionsDisabled && ts.stackSize != 1) {
    ...
    private static <T> void binarySort(T[] a, int lo, int hi, int start, Comparator<? super T> c) {
        if (f147-assertionsDisabled || (lo <= start && start <= hi)) {
            if (start == lo) {
                start++;
            }
            while (start < hi) {
                ...
                int left = lo;
                int right = start;
                if (f147-assertionsDisabled || lo <= right) {
                    while (left < right) {
                    ...
                    if (f147-assertionsDisabled || left == right) {
                        int n = start - left;
                        switch (n) {
                            case 1:
                                break;
    ...
    private static int minRunLength(int n) {
        if (f147-assertionsDisabled || n >= 0) {
            int r = 0;
            while (n >= 32) {
                r |= n & 1;
                n >>= 1;
    ...
    private void mergeAt(int i) {
        if (!f147-assertionsDisabled && this.stackSize < 2) {
            throw new AssertionError();
        } else if (!f147-assertionsDisabled && i < 0) {
            throw new AssertionError();
        } else if (f147-assertionsDisabled || i == this.stackSize - 2 || i == this.stackSize - 3) {
            int base1 = this.runBase[i];
            int len1 = this.runLen[i];
            int base2 = this.runBase[i + 1];
            int len2 = this.runLen[i + 1];
            if (!f147-assertionsDisabled && (len1 <= 0 || len2 <= 0)) {
                throw new AssertionError();
            } else if (f147-assertionsDisabled || base1 + len1 == base2) {
    ...
    private static <T> int gallopLeft(T key, T[] a, int base, int len, int hint, Comparator<? super T> c) {
        if (f147-assertionsDisabled || (len > 0 && hint >= 0 && hint < len)) {
            int lastOfs = 0;
            int ofs = 1;
            int maxOfs;
            ...
            if (f147-assertionsDisabled || (-1 <= lastOfs && lastOfs < ofs && ofs <= len)) {
                lastOfs++;
                while (lastOfs < ofs) {
                ...
                if (f147-assertionsDisabled || lastOfs == ofs) {
                    return ofs;
                }
                throw new AssertionError();
            }
     ...
     */
    /* JADX WARNING: Missing block: B:53:0x00e1, code:
            throw new java.lang.AssertionError();
     */
    /* JADX WARNING: Missing block: B:80:0x0155, code:
            if (r20 >= 0) goto L_0x0159;
     */
    /* JADX WARNING: Missing block: B:81:0x0157, code:
            r20 = 0;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void mergeLo(int base1, int len1, int base2, int len2) {
        if (f147-assertionsDisabled || (len1 > 0 && len2 > 0 && base1 + len1 == base2)) {
            Object a = this.a;
            ...
            if (len2 == 0) {
                ...
                while (true) {
                    ...
                    int count2 = 0;
                    do {
                        if (f147-assertionsDisabled || (len1 > 1 && len2 > 0)) {
                ...
                } else if (!f147-assertionsDisabled && len2 != 0) {
                    throw new AssertionError();
                } else if (f147-assertionsDisabled || len1 > 1) {
                    System.arraycopy(tmp, cursor1, a, dest, len1);
                } else {
                    throw new AssertionError();
                }
    ...
    /* JADX WARNING: Missing block: B:34:0x00b2, code:
            if (r27 != 1) goto L_0x0190;
     */
    /* JADX WARNING: Missing block: B:36:0x00b6, code:
            if (-assertionsDisabled != false) goto L_0x017e;
     */
    ...
    /* JADX WARNING: Missing block: B:39:0x00bf, code:
            throw new java.lang.AssertionError();
     */
    /* JADX WARNING: Missing block: B:52:0x00f1, code:
            throw new java.lang.AssertionError();
     */
    ...
    /* JADX WARNING: Missing block: B:79:0x0174, code:
            r22 = 0;
     */
    /* JADX WARNING: Missing block: B:81:0x017e, code:
            r20 = r20 - r25;
            java.lang.System.arraycopy(r3, (r16 - r25) + 1, r3, r20 + 1, r25);
            r3[r20] = r9[r18];
     */
    /* JADX WARNING: Missing block: B:82:0x018f, code:
            return;
     */
    /* JADX WARNING: Missing block: B:83:0x0190, code:
            if (r27 != 0) goto L_0x019b;
     */
    /* JADX WARNING: Missing block: B:85:0x019a, code:
            throw new java.lang.IllegalArgumentException("Comparison method violates its general contract!");
     */
    /* JADX WARNING: Missing block: B:87:0x019d, code:
            if (-assertionsDisabled != false) goto L_0x01a7;
     */
    /* JADX WARNING: Missing block: B:88:0x019f, code:
            if (r25 == 0) goto L_0x01a7;
     */
    /* JADX WARNING: Missing block: B:90:0x01a6, code:
            throw new java.lang.AssertionError();
     */
    /* JADX WARNING: Missing block: B:92:0x01a9, code:
            if (-assertionsDisabled != false) goto L_0x01b3;
     */
    /* JADX WARNING: Missing block: B:93:0x01ab, code:
            if (r27 > 0) goto L_0x01b3;
     */
    /* JADX WARNING: Missing block: B:95:0x01b2, code:
            throw new java.lang.AssertionError();
     */
    /* JADX WARNING: Missing block: B:96:0x01b3, code:
            java.lang.System.arraycopy(r9, r10, r3, r20 - (r27 - 1), r27);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
        ...
        if (f147-assertionsDisabled || (len1 > 0 && len2 > 0 && base1 + len1 == base2)) {
            ...
            if (len1 == 0) {
                ...
                while (true) {
                    ...
                    int count2 = 0;
                    do {
                        if (f147-assertionsDisabled || (len1 > 0 && len2 > 1)) {
