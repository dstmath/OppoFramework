...
public final class Formatter implements Closeable, Flushable {
    ...
    private class FormatSpecifier implements FormatString {
        ...
        static final /* synthetic */ boolean f10-assertionsDisabled = (FormatSpecifier.class.desiredAssertionStatus() ^ 1);
        ...
        private void print(StringBuilder sb, double value, Locale l, Flags f, char c, int precision, boolean neg) throws IOException {
            ...
            if (c == 'e') {
                ...
                sign = exp[0];
                if (f10-assertionsDisabled || sign == '+' || sign == '-') {
                    sb.append(sign);
        ...
        private char[] addZeros(char[] v, int prec) {
            ...
            if (!f10-assertionsDisabled && outPrec > prec) {
                throw new AssertionError();
        ...
        private String hexDouble(double d, int prec) {
            ...
            if (f10-assertionsDisabled || (prec >= 1 && prec <= 12)) {
                ...
                if (f10-assertionsDisabled || (shiftDistance >= 1 && shiftDistance < 53)) {
                    ...
                    } else if (f10-assertionsDisabled) {
                        return null;
                    } else {
                        throw new AssertionError();
                    }
     ...
     */
        ...
        private void print(StringBuilder sb, BigDecimal value, Locale l, Flags f, char c, int precision, boolean neg) throws IOException {
            ...
            } else if (c == 'a' && !f10-assertionsDisabled) {
                throw new AssertionError();
            }
        }
