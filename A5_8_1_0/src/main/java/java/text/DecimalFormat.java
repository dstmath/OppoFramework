...
public class DecimalFormat extends NumberFormat {
    ...
    private static final /* synthetic */ int[] f84-java-math-RoundingModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m38-getjava-math-RoundingModeSwitchesValues() {
        if (f84-java-math-RoundingModeSwitchesValues != null) {
            return f84-java-math-RoundingModeSwitchesValues;
        }
        ...
        f84-java-math-RoundingModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static int convertRoundingMode(RoundingMode rm) {
        switch (m38-getjava-math-RoundingModeSwitchesValues()[rm.ordinal()]) {
            case 1:
                return 2;
            case 2:
                return 1;
