...
public class BigDecimal extends Number implements Comparable<BigDecimal>, Serializable {
    ...
    private static final /* synthetic */ int[] f18-java-math-RoundingModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m2-getjava-math-RoundingModeSwitchesValues() {
        if (f18-java-math-RoundingModeSwitchesValues != null) {
            return f18-java-math-RoundingModeSwitchesValues;
        }
        ...
        f18-java-math-RoundingModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static int roundingBehavior(int parityBit, int fraction, RoundingMode roundingMode) {
        switch (m2-getjava-math-RoundingModeSwitchesValues()[roundingMode.ordinal()]) {
            case 1:
