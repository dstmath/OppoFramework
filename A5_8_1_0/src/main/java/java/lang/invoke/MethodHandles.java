...
public class MethodHandles {
    ...
    public static final class Lookup {
        ...
        static final /* synthetic */ boolean f38-assertionsDisabled = (Lookup.class.desiredAssertionStatus() ^ 1);
        ...
        private static MethodType initMethodType(MethodType constructorType) {
            if (f38-assertionsDisabled || constructorType.rtype() != Void.TYPE) {
        ...
        private MethodHandle findAccessor(Field field, Class<?> refc, Class<?> fieldType, int kind, boolean performAccessChecks) throws IllegalAccessException {
            ...
            boolean isStaticKind = (kind == 9 || kind == 10) ? true : f38-assertionsDisabled;
            int modifiers = field.getModifiers();
            if (Modifier.isStatic(modifiers) != isStaticKind) {
                throw new IllegalAccessException("Field " + field + " is " + (isStaticKind ? "not " : "") + "static");
            }
            boolean isSetterKind = (kind == 8 || kind == 10) ? true : f38-assertionsDisabled;
        ...
        private boolean hasPrivateAccess() {
            return (this.allowedModes & 2) != 0 ? true : f38-assertionsDisabled;
        }
        ...
        String accessFailedMessage(Class<?> refc, Class<?> defc, int mods) {
            ...
            if (!Modifier.isPublic(defc.getModifiers())) {
                classOK = f38-assertionsDisabled;
            } else if (defc != refc) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x003e A:{ExcHandler: java.lang.NoSuchMethodException (r1_0 'exception' java.lang.Object), Splitter: B:6:0x0026} */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:9:0x0043 A:{ExcHandler: java.lang.NoSuchMethodException (r1_0 'exception' java.lang.Object), Splitter: B:6:0x0026} */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0021 A:{ExcHandler: java.lang.NoSuchMethodException (r0_0 'e' java.lang.Object), Splitter: B:5:0x0011} */
