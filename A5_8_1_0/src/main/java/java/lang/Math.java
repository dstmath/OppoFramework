...
public final class Math {
    ...
    static final /* synthetic */ boolean f6-assertionsDisabled = (Math.class.desiredAssertionStatus() ^ 1);
    ...
    public static double ulp(double d) {
        ...
        switch (exp) {
            ...
            case 1024:
                return abs(d);
            default:
                if (f6-assertionsDisabled || (exp <= 1023 && exp >= -1022)) {
                    exp -= 52;
                    if (exp >= -1022) {
    ...
    public static float ulp(float f) {
        ...
        switch (exp) {
            ...
            case 128:
                return abs(f);
            default:
                if (f6-assertionsDisabled || (exp <= 127 && exp >= -126)) {
                    exp -= 23;
                    if (exp >= -126) {
    ...
    static double powerOfTwoD(int n) {
        if (f6-assertionsDisabled || (n >= -1022 && n <= 1023)) {
    ...
    static float powerOfTwoF(int n) {
        if (f6-assertionsDisabled || (n >= -126 && n <= 127)) {
