...
class DateTimeTextProvider {
    ...
    private static final /* synthetic */ int[] f120-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m77-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f120-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f120-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f120-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public Iterator<Entry<String, Long>> getTextIterator(Chronology chrono, TemporalField field, TextStyle style, Locale locale) {
        ...
        int fieldIndex;
        switch (m77-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
                fieldIndex = 9;
                break;
            case 2:
