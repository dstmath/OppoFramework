...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime<LocalDate>, Serializable {
    ...
    private static final /* synthetic */ int[] f76-java-time-temporal-ChronoUnitSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m32-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f76-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f76-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f76-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public LocalDateTime plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m32-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:
