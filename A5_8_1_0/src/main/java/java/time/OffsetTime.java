...
public final class OffsetTime implements Temporal, TemporalAdjuster, Comparable<OffsetTime>, Serializable {
    ...
    private static final /* synthetic */ int[] f88-java-time-temporal-ChronoUnitSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m40-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f88-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f88-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f88-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public long until(Temporal endExclusive, TemporalUnit unit) {
        ...
        switch (m40-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:
