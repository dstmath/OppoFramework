...
final class ChronoZonedDateTimeImpl<D extends ChronoLocalDate> implements ChronoZonedDateTime<D>, Serializable {
    ...
    private static final /* synthetic */ int[] f106-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m63-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f106-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f106-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f106-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ChronoZonedDateTime<D> with(TemporalField field, long newValue) {
        ...
        switch (m63-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
            case 1:
