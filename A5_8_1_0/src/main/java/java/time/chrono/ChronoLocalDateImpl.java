...
abstract class ChronoLocalDateImpl<D extends ChronoLocalDate> implements ChronoLocalDate, Temporal, TemporalAdjuster, Serializable {
    ...
    private static final /* synthetic */ int[] f100-java-time-temporal-ChronoUnitSwitchesValues = null;
    private static final long serialVersionUID = 6282433883239719096L;

    /* renamed from: -getjava-time-temporal-ChronoUnitSwitchesValues */
    private static /* synthetic */ int[] m56-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f100-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f100-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f100-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public D plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m56-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:
