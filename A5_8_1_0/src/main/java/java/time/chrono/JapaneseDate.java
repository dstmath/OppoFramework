...
public final class JapaneseDate extends ChronoLocalDateImpl<JapaneseDate> implements ChronoLocalDate, Serializable {
    ...
    private static final /* synthetic */ int[] f112-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m69-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f112-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f112-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f112-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(TemporalField field) {
        ...
        if (isSupported(field)) {
            ...
            switch (m69-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
                case 5:
    ...
    public long getLong(TemporalField field) {
        ...
        switch (m69-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
