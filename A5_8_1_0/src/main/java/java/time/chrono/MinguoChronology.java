...
public final class MinguoChronology extends AbstractChronology implements Serializable {
    ...
    private static final /* synthetic */ int[] f110-java-time-temporal-ChronoFieldSwitchesValues = null;
    public static final MinguoChronology INSTANCE = new MinguoChronology();
    static final int YEARS_DIFFERENCE = 1911;
    private static final long serialVersionUID = 1039765215346859963L;

    /* renamed from: -getjava-time-temporal-ChronoFieldSwitchesValues */
    private static /* synthetic */ int[] m67-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f110-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f110-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f110-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(ChronoField field) {
        ValueRange range;
        switch (m67-getjava-time-temporal-ChronoFieldSwitchesValues()[field.ordinal()]) {
            case 1:
