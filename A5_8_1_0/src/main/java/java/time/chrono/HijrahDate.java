...
public final class HijrahDate extends ChronoLocalDateImpl<HijrahDate> implements ChronoLocalDate, Serializable {
    ...
    private static final /* synthetic */ int[] f108-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m65-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f108-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f108-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f108-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(TemporalField field) {
        ...
        if (isSupported(field)) {
            ...
            switch (m65-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
                case 3:
    ...
    public long getLong(TemporalField field) {
        ...
        switch (m65-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
