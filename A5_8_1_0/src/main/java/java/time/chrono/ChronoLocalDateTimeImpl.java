...
final class ChronoLocalDateTimeImpl<D extends ChronoLocalDate> implements ChronoLocalDateTime<D>, Temporal, TemporalAdjuster, Serializable {
    ...
    private static final /* synthetic */ int[] f101-java-time-temporal-ChronoUnitSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m57-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f101-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f101-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f101-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ChronoLocalDateTimeImpl<D> plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m57-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:
