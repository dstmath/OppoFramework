...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    ...
    private static final /* synthetic */ int[] f107-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m64-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f107-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f107-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f107-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(ChronoField field) {
        ...
        ChronoField f = field;
        switch (m64-getjava-time-temporal-ChronoFieldSwitchesValues()[field.ordinal()]) {
            case 1:
