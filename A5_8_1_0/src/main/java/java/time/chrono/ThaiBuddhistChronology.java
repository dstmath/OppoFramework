...
public final class ThaiBuddhistChronology extends AbstractChronology implements Serializable {
    ...
    private static final /* synthetic */ int[] f109-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m66-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f109-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f109-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f109-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(ChronoField field) {
        ValueRange range;
        switch (m66-getjava-time-temporal-ChronoFieldSwitchesValues()[field.ordinal()]) {
            case 1:
