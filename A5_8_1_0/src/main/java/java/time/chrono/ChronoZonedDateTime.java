...
public interface ChronoZonedDateTime<D extends ChronoLocalDate> extends Temporal, Comparable<ChronoZonedDateTime<?>> {
    ...
    public static final /* synthetic */ int[] f105-java-time-temporal-ChronoFieldSwitchesValues = null;

    /* renamed from: -getjava-time-temporal-ChronoFieldSwitchesValues */
    private static /* synthetic */ int[] m60-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f105-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f105-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f105-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    int get(TemporalField field) {
        ...
        switch (m60-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
