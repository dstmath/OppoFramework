...
public final class JapaneseChronology extends AbstractChronology implements Serializable {
    ...
    private static final /* synthetic */ int[] f111-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m68-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f111-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f111-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f111-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(ChronoField field) {
        Calendar jcal;
        switch (m68-getjava-time-temporal-ChronoFieldSwitchesValues()[field.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
