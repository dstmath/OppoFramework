...
public final class MinguoDate extends ChronoLocalDateImpl<MinguoDate> implements ChronoLocalDate, Serializable {
    ...
    private static final /* synthetic */ int[] f113-java-time-temporal-ChronoFieldSwitchesValues = null;
    private static final long serialVersionUID = 1300372329181994526L;
    private final transient LocalDate isoDate;

    /* renamed from: -getjava-time-temporal-ChronoFieldSwitchesValues */
    private static /* synthetic */ int[] m75-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f113-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f113-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f113-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(TemporalField field) {
        ...
        if (isSupported(field)) {
            ...
            switch (m75-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
                case 1:
                case 2:
                case 3:
    ...
    public long getLong(TemporalField field) {
        ...
        switch (m75-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 4:
