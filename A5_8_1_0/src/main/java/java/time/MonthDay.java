...
public final class MonthDay implements TemporalAccessor, TemporalAdjuster, Comparable<MonthDay>, Serializable {
    ...
    private static final /* synthetic */ int[] f89-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m41-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f89-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f89-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f89-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public long getLong(TemporalField field) {
        ...
        switch (m41-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
