...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedHashIterator(LinkedHashMap this$0, LinkedHashIterator linkedHashIterator) {
            this();
        }
    ...
    private class EntryIterator extends LinkedHashIterator<Entry<K, V>> {
        /* synthetic */ EntryIterator(LinkedHashMap this$0, EntryIterator entryIterator) {
            this();
        }
    ...
    private class KeyIterator extends LinkedHashIterator<K> {
        /* synthetic */ KeyIterator(LinkedHashMap this$0, KeyIterator keyIterator) {
            this();
        }
    ...
    private class ValueIterator extends LinkedHashIterator<V> {
        /* synthetic */ ValueIterator(LinkedHashMap this$0, ValueIterator valueIterator) {
            this();
        }
