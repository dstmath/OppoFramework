...
public abstract class PipelineHelper<P_OUT> {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.util.stream.PipelineHelper.<init>():void, dex: 
    ...
    public PipelineHelper() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.util.stream.PipelineHelper.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: java.util.stream.PipelineHelper.<init>():void");
    }
