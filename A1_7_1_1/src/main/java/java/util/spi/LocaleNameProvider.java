...
public abstract class LocaleNameProvider extends LocaleServiceProvider {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.util.spi.LocaleNameProvider.<init>():void, dex: 
    ...
    protected LocaleNameProvider() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.util.spi.LocaleNameProvider.<init>():void, dex: 
        */
