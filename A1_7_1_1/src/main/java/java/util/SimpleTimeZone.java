...
public class SimpleTimeZone extends TimeZone {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.util.SimpleTimeZone.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.util.SimpleTimeZone.<clinit>():void, dex: 
        */
    ...
    private byte[] packRules() {
        ...
        rules[0] = (byte) this.startDay;
        rules[1] = (byte) this.startDayOfWeek;
        rules[2] = (byte) this.endDay;
        rules[3] = (byte) this.endDayOfWeek;
        rules[4] = (byte) this.startTimeMode;
        rules[5] = (byte) this.endTimeMode;
        return rules;
    }
