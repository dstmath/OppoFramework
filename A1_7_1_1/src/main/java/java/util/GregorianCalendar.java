...
public class GregorianCalendar extends Calendar {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: java.util.GregorianCalendar.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: java.util.GregorianCalendar.<clinit>():void, dex: 
        */
    ...
    public boolean isLeapYear(int year) {
        boolean z = true;
        if ((year & 3) != 0) {
            return f59-assertionsDisabled;
        }
        if (year > this.gregorianCutoverYear) {
            if (year % 100 == 0 && year % 400 != 0) {
                z = f59-assertionsDisabled;
            }
            return z;
        } else if (year < this.gregorianCutoverYearJulian) {
            return true;
        } else {
            boolean gregorian = this.gregorianCutoverYear == this.gregorianCutoverYearJulian ? getCalendarDate(this.gregorianCutoverDate).getMonth() < 3 ? true : f59-assertionsDisabled : year == this.gregorianCutoverYear ? true : f59-assertionsDisabled;
            ...
            switch (field) {
                ...
                case 5:
                    ...
                    if (!f59-assertionsDisabled) {
                        if ((d.getMonth() + -1 == internalGet(2) ? 1 : null) == null) {
                ...
                case 11:
                    ...
                    if (internalGet(5) != d2.getDayOfMonth()) {
                        ...
                        if (field == 10) {
                            if (!f59-assertionsDisabled) {
                                if ((internalGet(9) == 1 ? 1 : null) == null) {
                                    throw new AssertionError();
                                }
                            }
                            d2.addHours(12);
    ...
    public int getActualMaximum(int field) {
        ...
        switch (field) {
            ...
            case 6:
                ...
                if (!f59-assertionsDisabled) {
                    if ((nextJan1 >= cal.getFixedDate(date.getNormalizedYear(), date.getMonth(), date.getDayOfMonth(), date) ? 1 : null) == null) {
                        throw new AssertionError();
                    }
                }
    ...
    private int computeFields(int fieldMask, int tzMask) {
        ...
        if (fixedDate >= this.gregorianCutoverDate) {
            ...
            if (!f59-assertionsDisabled) {
                Object obj = this.cachedFixedDate != Long.MIN_VALUE ? gcal.getFixedDate(this.gdate.getNormalizedYear(), this.gdate.getMonth(), this.gdate.getDayOfMonth(), this.gdate) == this.cachedFixedDate ? 1 : null : 1;
                if (obj == null) {
            ...
            if (!f59-assertionsDisabled) {
                if ((this.cdate.getDayOfWeek() > 0 ? 1 : null) == null) {
    ...
    private final boolean isCutoverYear(int normalizedYear) {
        return normalizedYear == (this.calsys == gcal ? this.gregorianCutoverYear : this.gregorianCutoverYearJulian) ? true : f59-assertionsDisabled;
    }

    private final long getFixedDateJan1(Date date, long fixedDate) {
        if (!f59-assertionsDisabled) {
            int i = date.getNormalizedYear() != this.gregorianCutoverYear ? date.getNormalizedYear() == this.gregorianCutoverYearJulian ? 1 : 0 : 1;
            if (i == 0) {
                throw new AssertionError();
            }
        }
    ...
    private static final int getRolledValue(int value, int amount, int min, int max) {
        Object obj = 1;
        if (!f59-assertionsDisabled) {
            Object obj2 = (value < min || value > max) ? null : 1;
            if (obj2 == null) {
                throw new AssertionError();
            }
        }
