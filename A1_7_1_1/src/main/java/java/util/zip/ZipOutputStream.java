...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants {
    ...
    private static class XEntry {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: java.util.zip.ZipOutputStream.XEntry.<init>(java.util.zip.ZipEntry, long):void, dex: 
        ...
        public XEntry(java.util.zip.ZipEntry r1, long r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: java.util.zip.ZipOutputStream.XEntry.<init>(java.util.zip.ZipEntry, long):void, dex: 
            */
