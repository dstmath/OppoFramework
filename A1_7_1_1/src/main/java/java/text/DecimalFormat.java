...
public class DecimalFormat extends NumberFormat {
    ...
    private static final /* synthetic */ int[] f66-java-math-RoundingModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m53-getjava-math-RoundingModeSwitchesValues() {
        if (f66-java-math-RoundingModeSwitchesValues != null) {
            return f66-java-math-RoundingModeSwitchesValues;
        }
        ...
        f66-java-math-RoundingModeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.text.DecimalFormat.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.text.DecimalFormat.<clinit>():void, dex: 
        */
    ...
    private static int convertRoundingMode(RoundingMode rm) {
        switch (m53-getjava-math-RoundingModeSwitchesValues()[rm.ordinal()]) {
            case 1:
                return 2;
            case 2:
                return 1;
