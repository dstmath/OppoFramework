...
public class MGF1ParameterSpec implements AlgorithmParameterSpec {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.security.spec.MGF1ParameterSpec.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.security.spec.MGF1ParameterSpec.<clinit>():void, dex: 
        */
