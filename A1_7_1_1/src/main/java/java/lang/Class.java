...
public final class Class<T> implements Serializable, GenericDeclaration, Type, AnnotatedElement {
    ...
    private static class Caches {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: java.lang.Class.Caches.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: java.lang.Class.Caches.<clinit>():void, dex: 
            */
    ...
    private Method getPublicMethodRecursive(String name, Class<?>[] parameterTypes) {
        ...
        for (Class<?> c = this; c != null; c = c.getSuperclass()) {
            result = c.getDeclaredMethodInternal(name, parameterTypes);
