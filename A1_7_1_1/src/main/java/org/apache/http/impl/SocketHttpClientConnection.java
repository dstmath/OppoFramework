...
public class SocketHttpClientConnection extends AbstractHttpClientConnection implements HttpInetConnection {
    ...
    protected void bind(Socket socket, HttpParams params) throws IOException {
        if (socket == null) {
            ...
            if (buffersize > 0) {
                ...
                if (System.getProperty("socket.rx.buffer.size", "").length() != 0) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x001b A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:4:0x000b} */
