...
public abstract class PskKeyManager implements PSKKeyManager {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.PskKeyManager.<init>():void, dex: 
    ...
    public PskKeyManager() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.PskKeyManager.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.PskKeyManager.<init>():void");
    }
