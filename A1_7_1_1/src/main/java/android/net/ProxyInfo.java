...
public class ProxyInfo implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.ProxyInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.ProxyInfo.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.ProxyInfo.<clinit>():void");
    }

    /* synthetic */ ProxyInfo(String host, int port, String exclList, String[] parsedExclList, ProxyInfo proxyInfo) {
