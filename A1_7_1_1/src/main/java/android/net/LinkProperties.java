...
public final class LinkProperties implements Parcelable {
    public static final Creator<LinkProperties> CREATOR = null;
    ...
    public enum ProvisioningChange {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.LinkProperties.ProvisioningChange.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.LinkProperties.ProvisioningChange.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.LinkProperties.ProvisioningChange.<clinit>():void");
        }
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.LinkProperties.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.LinkProperties.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.LinkProperties.<clinit>():void");
    }
    ...
    public LinkProperties(LinkProperties source) {
        ...
        if (source != null) {
            ...
            synchronized (this.mDnses) {
                ArrayList<InetAddress> tmpDnsList = new ArrayList();
                for (InetAddress i : source.getDnsServers()) {
                    tmpDnsList.add(i);
                }
                this.mDnses.addAll(tmpDnsList);
            }
    ...
    public List<InetAddress> getDnsServers() {
        ...
        synchronized (this.mDnses) {
            unmodifiableList = Collections.unmodifiableList(this.mDnses);
        }
