...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    private static final String NOT_CACHED = null;
    ...
    static abstract class AbstractPart {
        ...
        static class Representation {
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.Uri.AbstractPart.Representation.<init>():void, dex: 
            ...
            Representation() {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.Uri.AbstractPart.Representation.<init>():void, dex: 
                */
                throw new UnsupportedOperationException("Method not decompiled: android.net.Uri.AbstractPart.Representation.<init>():void");
            }
        }
    ...
    private static class HierarchicalUri extends AbstractHierarchicalUri {
        ...
        /* synthetic */ HierarchicalUri(String scheme, Part authority, PathPart path, Part query, Part fragment, HierarchicalUri hierarchicalUri) {
    ...
    private static class OpaqueUri extends Uri {
        ...
        /* synthetic */ OpaqueUri(String scheme, Part ssp, Part fragment, OpaqueUri opaqueUri) {
    ...
    static class Part extends AbstractPart {
        static final Part EMPTY = null;
        static final Part NULL = null;
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.Uri.Part.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.Uri.Part.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.Uri.Part.<clinit>():void");
        }

        /* synthetic */ Part(String encoded, String decoded, Part part) {
    ...
    static class PathPart extends AbstractPart {
        static final PathPart EMPTY = null;
        static final PathPart NULL = null;
        private PathSegments pathSegments;

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.Uri.PathPart.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.Uri.PathPart.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.Uri.PathPart.<clinit>():void");
        }
    ...
    static class PathSegments extends AbstractList<String> implements RandomAccess {
        static final PathSegments EMPTY = null;
        final String[] segments;
        final int size;

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.Uri.PathSegments.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.Uri.PathSegments.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.Uri.PathSegments.<clinit>():void");
        }
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        /* synthetic */ StringUri(String uriString, StringUri stringUri) {
            this(uriString);
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.net.Uri.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.net.Uri.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.net.Uri.<clinit>():void");
    }
    ...
    public static Uri fromFile(File file) {
        ...
        return new HierarchicalUri("file", Part.EMPTY, PathPart.fromDecoded(file.getAbsolutePath()), Part.NULL, Part.NULL, null);
    }
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) {
        ...
        if (!("false".equals(flag) || WifiEnterpriseConfig.ENGINE_DISABLE.equals(flag))) {
            z = true;
        }
        return z;
    }
