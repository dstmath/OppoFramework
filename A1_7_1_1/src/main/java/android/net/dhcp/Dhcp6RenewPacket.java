...
class Dhcp6RenewPacket extends Dhcp6Packet {
    Dhcp6RenewPacket(byte[] transId, byte[] clientMac) {
        super(transId, INADDR_ANY, INADDR_ANY, INADDR_ANY, clientMac);
    }

    public String toString() {
        return super.toString() + " RENEW, desired IP " + this.mRequestedIp + "', param list length " + (this.mRequestedParams == null ? 0 : this.mRequestedParams.length);
    }
