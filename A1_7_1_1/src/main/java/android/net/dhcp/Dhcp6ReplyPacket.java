...
class Dhcp6ReplyPacket extends Dhcp6Packet {
    ...
    Dhcp6ReplyPacket(byte[] transId, Inet6Address serverIp, Inet6Address requestAddress, byte[] clientMac) {
    ...
    public String toString() {
        ...
        return s + " Reply: your new IP " + this.mRequestedIp + ", netmask " + this.mSubnetMask + ", gateway " + this.mGateway + dnsServers + ", lease time " + this.mLeaseTime;
    }
