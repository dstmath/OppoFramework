...
public class NetworkPolicyManager {
    public static final String ACTION_NETWORK_OVERLIMIT_CHANGED = "com.mediatek.server.action.ACTION_NETWORK_OVERLIMIT_CHANGED";
    public static final String ACTION_POLICY_CREATED = "com.mediatek.server.action.ACTION_POLICY_CREATED";
    ...
    public boolean getNetworkTemplateOverWarning(String subscriberId) {
        try {
            return this.mService.getNetworkTemplateOverWarning(subscriberId);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean getNetworkTemplateOverLimit(String subscriberId) {
        try {
            return this.mService.getNetworkTemplateOverLimit(subscriberId);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
