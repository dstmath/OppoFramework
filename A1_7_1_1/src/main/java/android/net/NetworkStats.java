...
public class NetworkStats implements Parcelable {
    ...
    private class DataComparator implements Comparator {
        private boolean mProcessRootUid;
        private int mTotalSize;
        final /* synthetic */ NetworkStats this$0;

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.net.NetworkStats.DataComparator.<init>(android.net.NetworkStats, boolean, int):void, dex: 
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 10 more
            */
        public DataComparator(android.net.NetworkStats r1, boolean r2, int r3) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.net.NetworkStats.DataComparator.<init>(android.net.NetworkStats, boolean, int):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.NetworkStats.DataComparator.<init>(android.net.NetworkStats, boolean, int):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.net.NetworkStats.DataComparator.compare(java.lang.Object, java.lang.Object):int, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public int compare(java.lang.Object r1, java.lang.Object r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.net.NetworkStats.DataComparator.compare(java.lang.Object, java.lang.Object):int, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.NetworkStats.DataComparator.compare(java.lang.Object, java.lang.Object):int");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00ef in method: android.net.NetworkStats.DataComparator.isProcessRootUid():boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean isProcessRootUid() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00ef in method: android.net.NetworkStats.DataComparator.isProcessRootUid():boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.net.NetworkStats.DataComparator.isProcessRootUid():boolean");
        }
    }
    ...
    public static class Entry {
        ...
        public Entry(String iface, int uid, int set, int tag, long rxBytes, long rxPackets, long txBytes, long txPackets, long operations) {
            this(iface, uid, set, tag, 0, rxBytes, rxPackets, txBytes, txPackets, -1, null, operations);
        }

        public Entry(String iface, int uid, int set, int tag, int roaming, long rxBytes, long rxPackets, long txBytes, long txPackets, long pid, String comm, long operations) {
            this.iface = iface;
            this.uid = uid;
            this.set = set;
            this.tag = tag;
        ...
        public boolean equals(Object o) {
            ...
            Entry e = (Entry) o;
            if (this.uid == e.uid && this.set == e.set && this.tag == e.tag && this.roaming == e.roaming && this.rxBytes == e.rxBytes && this.rxPackets == e.rxPackets && this.txBytes == e.txBytes && this.txPackets == e.txPackets && this.operations == e.operations && (this.comm == null ? e.comm != null : !this.comm.equals(e.comm))) {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.net.NetworkStats.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.net.NetworkStats.<clinit>():void, dex: 
        */
    ...
    public NetworkStats addValues(String iface, int uid, int set, int tag, int roaming, long rxBytes, long rxPackets, long txBytes, long txPackets, long operations) {
        return addValues(new Entry(iface, uid, set, tag, roaming, rxBytes, rxPackets, txBytes, txPackets, -1, null, operations));
    }

    public NetworkStats addValues(String iface, int uid, int set, int tag, long rxBytes, long rxPackets, long txBytes, long txPackets, long pid, String comm, long operations) {
        return addValues(new Entry(iface, uid, set, tag, 0, rxBytes, rxPackets, txBytes, txPackets, pid, comm, operations));
    }
    ...
    public NetworkStats combineValues(String iface, int uid, int set, int tag, long rxBytes, long rxPackets, long txBytes, long txPackets, long pid, String comm, long operations) {
        return combineValues(new Entry(iface, uid, set, tag, 0, rxBytes, rxPackets, txBytes, txPackets, pid, comm, operations));
    }
    ...
    public NetworkStats combineValues(Entry entry) {
        ...
        if (this.containExtendData == 0) {
            i = findIndex(entry.iface, entry.uid, entry.set, entry.tag, entry.roaming);
        } else {
            i = findIndexWithProcName(entry.iface, entry.uid, entry.set, entry.tag, entry.comm);
        }
        if (i == -1) {
            addValues(entry);
        } else {
    ...
    public int findIndexWithProcName(String iface, int uid, int set, int tag, String procName) {
        ...
        int i = 0;
        while (i < this.size) {
            if (procName.equals(this.comms[i]) && uid == this.uid[i] && set == this.set[i] && tag == this.tag[i] && Objects.equals(iface, this.iface[i])) {
                return i;
            }
            i++;
        }
    ...
    public int findIndexHintedWithProcessInfo(String iface, int uid, int set, int tag, int roaming, int hintIndex, long pid, String processName) {
        if (!isContainExtendData()) {
            return findIndexHinted(iface, uid, set, tag, roaming, hintIndex);
        }
        for (int offset = 0; offset < this.size; offset++) {
            int i;
            int halfOffset = offset / 2;
            ...
            if (uid == this.uid[i] && set == this.set[i] && tag == this.tag[i] && roaming == this.roaming[i] && Objects.equals(iface, this.iface[i]) && processName != null && this.comms[i] != null && processName.equals(this.comms[i])) {
                return i;
            }
        }
        return -1;
    ...
    public void spliceOperationsFrom(NetworkStats stats) {
        for (int i = 0; i < this.size; i++) {
            int j = stats.findIndex(this.iface[i], this.uid[i], this.set[i], this.tag[i], this.roaming[i]);
            if (j == -1) {
                this.operations[i] = 0;
            } else {
    ...
    public static <C> NetworkStats subtract(NetworkStats left, NetworkStats right, NonMonotonicObserver<C> observer, C cookie, NetworkStats recycle) {
        ...
        while (i < left.size) {
            ...
            if (containExtendData) {
                j = right.findIndexHintedWithProcessInfo(entry.iface, entry.uid, entry.set, entry.tag, entry.roaming, i, entry.pid, entry.comm);
            } else {
                j = right.findIndexHinted(entry.iface, entry.uid, entry.set, entry.tag, entry.roaming, i);
            }
            if (j == -1) {
    ...
    public NetworkStats replaceValues(Entry entry) {
        int i = findIndex(entry.iface, entry.uid, entry.set, entry.tag, entry.roaming);
        if (i == -1) {
            Log.w(TAG, "replaceValues entry " + entry.iface + " is not found, create new!");
            addValues(entry);
        } else {
    ...
    public void logoutData(String prefix) {
        StringBuilder builder = new StringBuilder();
        if (prefix == null) {
            prefix = NetworkCapabilities.MATCH_ALL_REQUESTS_NETWORK_SPECIFIER;
        }
    ...
    public NetworkStats getSpecifiedTopRecords(int countForRootUid, int countForNonRootUid) {
        ...
        try {
            ...
            doGetTopRecords(countForRootUid, new DataComparator(this, true, totalSize), targetRes);
            doGetTopRecords(countForNonRootUid, new DataComparator(this, false, totalSize), targetRes);
            return targetRes;
        } catch (Exception e) {
