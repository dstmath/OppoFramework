...
public interface IConnectivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectivityManager {
        ...
        static final int TRANSACTION_getCurrentTimeMillis = 94;
        ...
        static final int TRANSACTION_getNetworkIfCreated = 80;
        ...
        static final int TRANSACTION_getTelephonyPowerLost = 86;
        static final int TRANSACTION_getTelephonyPowerState = 84;
        ...
        static final int TRANSACTION_getTetheredIfacePairs = 76;
        static final int TRANSACTION_getTetheredIfaces = 27;
        static final int TRANSACTION_getTetheringErroredIfaces = 28;
        static final int TRANSACTION_getTetheringIpv6Enable = 79;
        static final int TRANSACTION_getVpnConfig = 43;
        static final int TRANSACTION_getWebLocation = 83;
        static final int TRANSACTION_isActiveNetworkMetered = 18;
        static final int TRANSACTION_isAlreadyUpdated = 85;
        static final int TRANSACTION_isFirewallEnabled = 82;
        static final int TRANSACTION_isNetworkSupported = 11;
        static final int TRANSACTION_isTetheringChangeDone = 77;
        ...
        static final int TRANSACTION_monitorHttpRedirect = 81;
        ...
        static final int TRANSACTION_releaseNetworkRequest = 65;
        ...
        static final int TRANSACTION_requestLinkProperties = 63;
        static final int TRANSACTION_requestNetwork = 58;
        static final int TRANSACTION_requestNetworkCapabilities = 64;
        static final int TRANSACTION_requestRouteToHostAddress = 19;
        static final int TRANSACTION_setAcceptUnvalidated = 66;
        static final int TRANSACTION_setAirplaneMode = 53;
        static final int TRANSACTION_setAlreadyUpdated = 88;
        ...
        static final int TRANSACTION_setTelephonyPowerLost = 89;
        static final int TRANSACTION_setTelephonyPowerState = 87;
        static final int TRANSACTION_setTetheringIpv6Enable = 78;
        ...
        private static class Proxy implements IConnectivityManager {
            ...
            public void requestLinkProperties(NetworkRequest networkRequest) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void requestNetworkCapabilities(NetworkRequest networkRequest) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    NetworkInfo[] _result10 = getAllNetworkInfo();
                    reply.writeNoException();
                ...
                case 24:
                    ...
                    startTethering(_arg05, _arg13, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 60:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg09 = (PendingIntent) PendingIntent.CREATOR.createFromParcel(data);
                    } else {
                        _arg09 = null;
                    }
                ...
                case 63:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (NetworkRequest) NetworkRequest.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    requestLinkProperties(_arg04);
                    reply.writeNoException();
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    requestNetworkCapabilities(_arg04);
                    reply.writeNoException();
                    return true;
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 76:
                    data.enforceInterface(DESCRIPTOR);
                    _result6 = getTetheredIfacePairs();
                    reply.writeNoException();
                    reply.writeStringArray(_result6);
                    return true;
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isTetheringChangeDone();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    setTetheringIpv6Enable(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 79:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getTetheringIpv6Enable();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 80:
                    ...
                    _result = getNetworkIfCreated(_arg04);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 81:
                    data.enforceInterface(DESCRIPTOR);
                    monitorHttpRedirect(data.readString());
                    reply.writeNoException();
                    return true;
                case 82:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 83:
                    data.enforceInterface(DESCRIPTOR);
                    _result8 = getWebLocation();
                    reply.writeNoException();
                    reply.writeString(_result8);
                    return true;
                case 84:
                    data.enforceInterface(DESCRIPTOR);
                    _result8 = getTelephonyPowerState();
                    reply.writeNoException();
                    reply.writeString(_result8);
                    return true;
                case 85:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isAlreadyUpdated();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 86:
                ...
                case 88:
                    data.enforceInterface(DESCRIPTOR);
                    setAlreadyUpdated(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 89:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = measureDataState(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 91:
                    data.enforceInterface(DESCRIPTOR);
                    _result9 = getCelluarNetworkRequest();
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
                        _result9.writeToParcel(reply, 1);
                ...
                case 92:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = shouldKeepCelluarNetwork(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 93:
                ...
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    long _result22 = getCurrentTimeMillis();
                    reply.writeNoException();
    ...
    void requestLinkProperties(NetworkRequest networkRequest) throws RemoteException;
    ...
    void requestNetworkCapabilities(NetworkRequest networkRequest) throws RemoteException;
