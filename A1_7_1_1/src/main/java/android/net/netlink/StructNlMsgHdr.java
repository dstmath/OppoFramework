...
public class StructNlMsgHdr {
    ...
    public String toString() {
        String typeStr = IElsaManager.EMPTY_PACKAGE + this.nlmsg_type + "(" + NetlinkConstants.stringForNlMsgType(this.nlmsg_type) + ")";
        return "StructNlMsgHdr{ nlmsg_len{" + this.nlmsg_len + "}, " + "nlmsg_type{" + typeStr + "}, " + "nlmsg_flags{" + (IElsaManager.EMPTY_PACKAGE + this.nlmsg_flags + "(" + stringForNlMsgFlags(this.nlmsg_flags) + ")") + ")}, " + "nlmsg_seq{" + this.nlmsg_seq + "}, " + "nlmsg_pid{" + this.nlmsg_pid + "} " + "}";
    }
}
