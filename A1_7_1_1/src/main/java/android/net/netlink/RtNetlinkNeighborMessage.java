...
public class RtNetlinkNeighborMessage extends NetlinkMessage {
    ...
    public String toString() {
        String str;
        StringBuilder append = new StringBuilder().append("RtNetlinkNeighborMessage{ nlmsghdr{").append(this.mHeader == null ? IElsaManager.EMPTY_PACKAGE : this.mHeader.toString()).append("}, ").append("ndmsg{").append(this.mNdmsg == null ? IElsaManager.EMPTY_PACKAGE : this.mNdmsg.toString()).append("}, ").append("destination{").append(this.mDestination == null ? IElsaManager.EMPTY_PACKAGE : this.mDestination.getHostAddress()).append("} ").append("linklayeraddr{").append(NetlinkConstants.hexify(this.mLinkLayerAddr)).append("} ").append("probes{").append(this.mNumProbes).append("} ").append("cacheinfo{");
