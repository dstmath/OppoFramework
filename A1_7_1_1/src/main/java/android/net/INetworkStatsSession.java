...
public interface INetworkStatsSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkStatsSession {
        ...
        static final int TRANSACTION_getHistoryForUidWithPids = 11;
        static final int TRANSACTION_getHistoryIntervalForUid = 6;
        static final int TRANSACTION_getIncrementForNetwork = 12;
        ...
        static final int TRANSACTION_getSummaryForAllUidWithPids = 10;
        ...
        private static class Proxy implements INetworkStatsSession {
            ...
            public NetworkStats getSummaryForAllUidWithPids(NetworkTemplate template, long start, long end, boolean includeTags) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public NetworkStatsHistory getHistoryForUidWithPids(NetworkTemplate template, int uid, int set, int tag, int fields) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    NetworkStatsHistory _result;
            ...
            public NetworkStats getIncrementForNetwork(NetworkTemplate template) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    NetworkStats _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    long _result4 = getMobileTotalBytes(data.readInt(), data.readLong(), data.readLong());
                    reply.writeNoException();
                ...
                case 10:
                    ...
                    _result = getSummaryForAllUidWithPids(_arg0, data.readLong(), data.readLong(), data.readInt() != 0);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 11:
                    ...
                    _result2 = getHistoryForUidWithPids(_arg0, data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
                ...
                case 12:
                    ...
                    _result = getIncrementForNetwork(_arg0);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
    ...
    NetworkStatsHistory getHistoryForUidWithPids(NetworkTemplate networkTemplate, int i, int i2, int i3, int i4) throws RemoteException;
    ...
    NetworkStats getIncrementForNetwork(NetworkTemplate networkTemplate) throws RemoteException;
    ...
    NetworkStats getSummaryForAllUidWithPids(NetworkTemplate networkTemplate, long j, long j2, boolean z) throws RemoteException;
