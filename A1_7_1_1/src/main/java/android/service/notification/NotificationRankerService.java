...
public abstract class NotificationRankerService extends NotificationListenerService {
    ...
    public static final int REASON_COLOROS_BPMSUSPEND = 21;
    public static final int REASON_COLOROS_FORCESTOP = 20;
    ...
    private class NotificationRankingServiceWrapper extends NotificationListenerWrapper {
        /* synthetic */ NotificationRankingServiceWrapper(NotificationRankerService this$0, NotificationRankingServiceWrapper notificationRankingServiceWrapper) {
            this();
        }
    ...
    public final IBinder onBind(Intent intent) {
        if (this.mWrapper == null) {
            this.mWrapper = new NotificationRankingServiceWrapper(this, null);
        }
