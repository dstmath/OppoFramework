...
public class ZenModeConfig implements Parcelable {
    ...
    public static class ZenRule implements Parcelable {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.service.notification.ZenModeConfig.ZenRule.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.service.notification.ZenModeConfig.ZenRule.<clinit>():void, dex: 
            */
        ...
        public int hashCode() {
            ...
            objArr[1] = Boolean.valueOf(this.snoozing);
            objArr[2] = this.name;
            objArr[3] = Integer.valueOf(this.zenMode);
            objArr[4] = this.conditionId;
            objArr[5] = this.condition;
            objArr[6] = this.component;
            objArr[7] = this.id;
            objArr[8] = Long.valueOf(this.creationTime);
            objArr[9] = this.enabler;
            return Objects.hash(objArr);
        }

        public boolean isAutomaticActive() {
            return (!this.enabled || this.snoozing || this.component == null) ? false : isTrueOrUnknown();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.service.notification.ZenModeConfig.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.service.notification.ZenModeConfig.<clinit>():void, dex: 
        */
    ...
    public int hashCode() {
        ...
        objArr[0] = Boolean.valueOf(this.allowCalls);
        objArr[1] = Boolean.valueOf(this.allowRepeatCallers);
        objArr[2] = Boolean.valueOf(this.allowMessages);
        objArr[3] = Integer.valueOf(this.allowCallsFrom);
        objArr[4] = Integer.valueOf(this.allowMessagesFrom);
        objArr[5] = Boolean.valueOf(this.allowReminders);
        objArr[6] = Boolean.valueOf(this.allowEvents);
        objArr[7] = Boolean.valueOf(this.allowWhenScreenOff);
        objArr[8] = Boolean.valueOf(this.allowWhenScreenOn);
        objArr[9] = Integer.valueOf(this.user);
        objArr[10] = this.automaticRules;
        objArr[11] = this.manualRule;
        return Objects.hash(objArr);
    }
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes, int userHandle, boolean shortVersion) {
        ...
        if (minutes < 60) {
            num = minutes;
            if (shortVersion) {
                summaryResId = 18087964;
            } else {
                summaryResId = 18087963;
            }
            objArr = new Object[2];
            objArr[0] = Integer.valueOf(minutes);
            objArr[1] = formattedTime;
            ...
            objArr = new Object[1];
            objArr[0] = formattedTime;
            line2 = res.getString(17040840, objArr);
        } else if (minutes < DAY_MINUTES) {
            num = Math.round(((float) minutes) / 60.0f);
            if (shortVersion) {
                summaryResId = 18087966;
            } else {
                summaryResId = 18087965;
            }
            objArr = new Object[2];
    ...
    public static Condition toNextAlarmCondition(Context context, long now, long alarm, int userHandle) {
        ...
        objArr[0] = formattedTime;
        return new Condition(toCountdownConditionId(alarm), "", res.getString(17040841, objArr), "", 0, 1, 1);
    }
    ...
    public static Uri toScheduleConditionId(ScheduleInfo schedule) {
        return new Builder().scheme("condition").authority(SYSTEM_AUTHORITY).appendPath(SCHEDULE_PATH).appendQueryParameter("days", toDayList(schedule.days)).appendQueryParameter("start", schedule.startHour + "." + schedule.startMinute).appendQueryParameter("end", schedule.endHour + "." + schedule.endMinute).appendQueryParameter("exitAtAlarm", String.valueOf(schedule.exitAtAlarm)).build();
    }
    ...
    public static Uri toEventConditionId(EventInfo event) {
        return new Builder().scheme("condition").authority(SYSTEM_AUTHORITY).appendPath("event").appendQueryParameter("userId", Long.toString((long) event.userId)).appendQueryParameter("calendar", event.calendar != null ? event.calendar : "").appendQueryParameter("reply", Integer.toString(event.reply)).build();
    }
    ...
    public static String newRuleId() {
        return UUID.randomUUID().toString().replace(Aas.ENCODE_SYMBOL, "");
    }
    ...
    private static String getConditionLine(Context context, ZenModeConfig config, int userHandle, boolean useLine1, boolean shortVersion) {
        ...
        if (config.manualRule != null) {
            ...
            if (config.manualRule.enabler != null) {
                ...
                summary = context.getString(17040842);
            } else {
        ...
        for (ZenRule automaticRule : config.automaticRules.values()) {
            if (automaticRule.isAutomaticActive()) {
                if (summary.isEmpty()) {
                    ...
                    objArr[0] = summary;
                    objArr[1] = automaticRule.name;
                    summary = resources.getString(17040844, objArr);
                }
            }
        }
        return summary;
