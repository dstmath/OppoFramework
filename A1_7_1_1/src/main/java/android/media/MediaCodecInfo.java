...
public final class MediaCodecInfo {
    ...
    public static final class CodecCapabilities {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.CodecCapabilities.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.CodecCapabilities.<clinit>():void, dex: 
            */
        ...
        public final boolean isFormatSupported(MediaFormat format) {
            ...
            for (Feature feat : getValidFeatures()) {
                ...
                if (yesNo != null) {
                    if (yesNo.intValue() == 1) {
                        if (!isFeatureSupported(feat.mName)) {
                            return false;
                        }
                    }
                    if (yesNo.intValue() == 0) {
        ...
        public static CodecCapabilities createFromProfileLevel(String mime, int profile, int level) {
            ...
            CodecProfileLevel[] codecProfileLevelArr = new CodecProfileLevel[1];
        ...
        CodecCapabilities(CodecProfileLevel[] profLevs, int[] colFmts, boolean encoder, int flags, MediaFormat defaultFormat, MediaFormat info) {
            ...
            if (profLevs.length == 0 && this.mMime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_VP9)) {
                ...
                profLevs = new CodecProfileLevel[1];
                profLevs[0] = profLev;
            }
    ...
    public static final class EncoderCapabilities {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.EncoderCapabilities.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.EncoderCapabilities.<clinit>():void, dex: 
            */
    ...
    public static final class VideoCapabilities {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.media.MediaCodecInfo.VideoCapabilities.updateLimits():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        private void updateLimits() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.media.MediaCodecInfo.VideoCapabilities.updateLimits():void, dex: 
            */
        ...
        private boolean supports(Integer width, Integer height, Number rate) {
            ...
            if (!ok || rate == null || rate.intValue() == 0) {
                return ok;
            }
        ...
        private Map<Size, Range<Long>> getMeasuredFrameRates(Map<String, Object> map) {
            ...
            for (String key : map.keySet()) {
                if (key.startsWith("measured-frame-rate-")) {
                    ...
                    String[] temp = key.split(Aas.ENCODE_SYMBOL);
                    if (temp.length == 5) {
        ...
        private void applyLevelLimits() {
            ...
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AVC)) {
                ...
                maxBps = 64000;
                int maxDPBBlocks = MediaFile.FILE_TYPE_RMVB;
                            ...
                            for (CodecProfileLevel profileLevel222 : profileLevels) {
                                ...
                                switch (profileLevel222.level) {
                                    ...
                                    case 2:
                                        ...
                                        H = 18;
                                        BR = 2;
                                        MBPS = MediaFile.FILE_TYPE_RMVB * 15;
                                        break;
                                    case 4:
                                        strict = true;
                                        FR = 30;
                                        ...
                                        H = 18;
                                        BR = 6;
                                        MBPS = MediaFile.FILE_TYPE_RMVB * 30;
                                        break;
                                    case 8:
                                        strict = true;
                                        FR = 30;
                                    ...
                                    case 32:
                                        ...
                                        H = 18;
                                        BR = 64;
                                        MBPS = MediaFile.FILE_TYPE_RMVB * 50;
                                        break;
                                    case 64:
                                        minW = 1;
                                        minH = 1;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.media.MediaCodecInfo.<clinit>():void, dex: 
        */
