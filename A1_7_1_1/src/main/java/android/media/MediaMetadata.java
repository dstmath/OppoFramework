...
public final class MediaMetadata implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus registerCount: 6 in method: android.media.MediaMetadata.<clinit>():void, dex:  in method: android.media.MediaMetadata.<clinit>():void, dex: 
        	...
        	at jadx.api.JavaClass.decompile(JavaClass.java:62)
        	at jadx.api.JadxDecompiler.lambda$appendSourcesSave$0(JadxDecompiler.java:200)
        Caused by: jadx.core.utils.exceptions.DecodeException: bogus registerCount: 6 in method: android.media.MediaMetadata.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus registerCount: 6 in method: android.media.MediaMetadata.<clinit>():void, dex:  in method: android.media.MediaMetadata.<clinit>():void, dex: 
        */
