...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_getOppoStreamVolume = 67;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isAppInFocus(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 40:
                ...
                case 48:
                    ...
                    _result2 = setBluetoothA2dpDeviceConnectionState(_arg03, data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 49:
                ...
                case 58:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (AudioPolicyConfig) AudioPolicyConfig.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    String _result5 = registerAudioPolicy(_arg04, android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 61:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (VolumePolicy) VolumePolicy.CREATOR.createFromParcel(data);
                    } else {
                        _arg05 = null;
                    }
                    setVolumePolicy(_arg05);
                    reply.writeNoException();
                    return true;
                case 62:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setAudioPathToFMTx(data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 66:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setAudioPathOutofFMTx();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 67:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getOppoStreamVolume(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
