...
public class BitmapDrawable extends Drawable {
    ...
    /* synthetic */ BitmapDrawable(BitmapState state, Resources res, BitmapDrawable bitmapDrawable) {
        this(state, res);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (bitmap != null) {
            ...
            if (shader == null) {
                if (needMirroring) {
                    canvas.save();
                    canvas.translate((float) ((this.mDstRect.right - this.mDstRect.left) + (this.mOpticalInsets.left * 2)), TonemapCurve.LEVEL_BLACK);
    ...
    private void updateShaderMatrix(Bitmap bitmap, Paint paint, Shader shader, boolean needMirroring) {
        ...
        if (!(sourceDensity == 0 || sourceDensity == targetDensity)) {
            needScaling = true;
        }
    ...
    public void getOutline(Outline outline) {
        ...
        if (opaqueOverShape) {
            ...
            alpha = TonemapCurve.LEVEL_BLACK;
        }
