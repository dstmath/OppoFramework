...
public final class DrawableInflater {
    private static final HashMap<String, Constructor<? extends Drawable>> CONSTRUCTOR_MAP = null;
    private final ClassLoader mClassLoader;
    private final Resources mRes;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.DrawableInflater.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.DrawableInflater.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.graphics.drawable.DrawableInflater.<clinit>():void");
    }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Xiaokang.Feng@Plf.SDK : Modify for ColorMatrixDrawable", property = OppoRomType.ROM)
    private Drawable inflateFromTag(String name) {
        ...
        if (name.equals("color-matrix")) {
            return new ColorMatrixDrawable();
        }
        return null;
    }
