...
public class GradientDrawable extends Drawable {
    /* renamed from: -android-graphics-drawable-GradientDrawable$OrientationSwitchesValues */
    private static final /* synthetic */ int[] f14xb1a9edf6 = null;
    ...
    public enum Orientation {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.GradientDrawable.Orientation.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.GradientDrawable.Orientation.<clinit>():void, dex: 
            */
    ...
    /* renamed from: -getandroid-graphics-drawable-GradientDrawable$OrientationSwitchesValues */
    private static /* synthetic */ int[] m210x5d85c3d2() {
        if (f14xb1a9edf6 != null) {
            return f14xb1a9edf6;
        }
    ...
    public void draw(Canvas canvas) {
        if (ensureValidRect()) {
            ...
            if (!haveStroke || !haveFill || st.mShape == 2 || currStrokeAlpha >= 255) {
                ...
                boolean z = this.mAlpha < 255 || colorFilter != null;
                useLayer = z;
            }
            if (useLayer) {
        ...
        if (this.mGradientIsDirty) {
            ...
            if (gradientColors != null) {
                ...
                if (st.mGradient == 0) {
                    ...
                    switch (m210x5d85c3d2()[st.mOrientation.ordinal()]) {
                        case 1:
                            x0 = r.left;
                            y0 = r.bottom;
                            x1 = level * r.right;
    ...
    private void updateGradientDrawableGradient(Resources r, TypedArray a) throws XmlPullParserException {
        ...
        if (st.mGradient == 0) {
            int angle = ((int) a.getFloat(3, (float) st.mAngle)) % IActivityManager.SET_VR_MODE_TRANSACTION;
            if (angle % 45 != 0) {
