...
public class AnimatedStateListDrawable extends StateListDrawable {
    ...
    private static class AnimatableTransition extends Transition {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.<init>(android.graphics.drawable.Animatable):void, dex: 
        ...
        public AnimatableTransition(android.graphics.drawable.Animatable r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.<init>(android.graphics.drawable.Animatable):void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.start():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public void start() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.start():void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.stop():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public void stop() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.graphics.drawable.AnimatedStateListDrawable.AnimatableTransition.stop():void, dex: 
            */
    ...
    private static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable ad, boolean reversed, boolean hasReversibleFlag) {
            ...
            iArr[0] = fromFrame;
            iArr[1] = toFrame;
            ObjectAnimator anim = ObjectAnimator.ofInt((Object) ad, "currentIndex", iArr);
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.graphics.drawable.AnimatedStateListDrawable.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.graphics.drawable.AnimatedStateListDrawable.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.graphics.drawable.AnimatedStateListDrawable.<clinit>():void");
    }

    /* synthetic */ AnimatedStateListDrawable(AnimatedStateListState state, Resources res, AnimatedStateListDrawable animatedStateListDrawable) {
        this(state, res);
    }
