...
public abstract class Drawable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.Drawable.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.graphics.drawable.Drawable.<clinit>():void, dex: 
        */
    ...
    public static Drawable createFromStream(InputStream is, String srcName) {
        Trace.traceBegin(32768, srcName != null ? srcName : "Unknown drawable");
        try {
    ...
    public static Drawable createFromPath(String pathName) {
        ...
        Trace.traceBegin(32768, pathName);
        try {
