...
public class PointF implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.graphics.PointF.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.graphics.PointF.<clinit>():void, dex: 
        */
    ...
    public int hashCode() {
        int result;
        int i = 0;
        if (this.x != TonemapCurve.LEVEL_BLACK) {
            result = Float.floatToIntBits(this.x);
        } else {
            result = 0;
        }
        int i2 = result * 31;
        if (this.y != TonemapCurve.LEVEL_BLACK) {
