        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    ...
                    setVirtualDisplaySurface(_arg0, _arg1);
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 20:
                    ...
                    waitWifiDisplayConnection(_arg02);
                    reply.writeNoException();
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    suspendWifiDisplay(_arg03, _arg1);
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    sendUibcInputEvent(data.readString());
                    reply.writeNoException();
                    return true;
