...
public interface ICameraService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraService {
        ...
        static final int TRANSACTION_checkCameraAlive = 16;
        ...
        static final int TRANSACTION_getExternalDeviceListener = 17;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ICameraDeviceUser _result5 = connectDevice(android.hardware.camera2.ICameraDeviceCallbacks.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    CameraMetadataNative _result6 = getCameraCharacteristics(data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getLegacyParameters(data.readInt());
                    reply.writeNoException();
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getProperty(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    setProperty(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    IBinder _result9 = getExternalDeviceListener();
                    reply.writeNoException();
