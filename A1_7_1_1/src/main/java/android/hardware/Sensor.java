...
public final class Sensor {
    ...
    public static final String STRING_TYPE_PRESSURE_UNCALIBRATED = "android.sensor.pressure_uncalibrated";
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.hardware.Sensor.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.hardware.Sensor.<clinit>():void, dex: 
        */
    ...
    private boolean setType(int value) {
        ...
        switch (this.mType) {
            ...
            case 32:
                ...
                return true;
            case 46:
                this.mStringType = STRING_TYPE_FLOOR_COUNT;
                return true;
            case 50:
                this.mStringType = STRING_TYPE_PRESSURE_UNCALIBRATED;
                return true;
            default:
                return false;
        }
