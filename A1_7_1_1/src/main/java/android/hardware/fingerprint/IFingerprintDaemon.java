...
public interface IFingerprintDaemon extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFingerprintDaemon {
        ...
        static final int TRANSACTION_cancelGetEngineeringInfo = 24;
        ...
        static final int TRANSACTION_continueEnroll = 15;
        static final int TRANSACTION_continueIdentify = 19;
        static final int TRANSACTION_dynamicallyConfigLog = 17;
        static final int TRANSACTION_enroll = 3;
        static final int TRANSACTION_getAlikeyStatus = 20;
        static final int TRANSACTION_getAuthenticatorId = 7;
        static final int TRANSACTION_getEngineeringInfo = 23;
        ...
        static final int TRANSACTION_pauseEnroll = 14;
        static final int TRANSACTION_pauseIdentify = 18;
        ...
        static final int TRANSACTION_setScreenState = 22;
        static final int TRANSACTION_setTouchEventListener = 16;
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.hardware.fingerprint.IFingerprintDaemon.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean, dex: 
        ...
        public boolean onTransact(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) throws android.os.RemoteException {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.hardware.fingerprint.IFingerprintDaemon.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.hardware.fingerprint.IFingerprintDaemon.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    ...
    int cancelGetEngineeringInfo() throws RemoteException;

    int cancelTouchEventListener() throws RemoteException;
    ...
    void dynamicallyConfigLog(int i) throws RemoteException;
    ...
    void setScreenState(int i) throws RemoteException;
