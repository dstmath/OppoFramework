...
public class CameraCaptureSessionImpl extends CameraCaptureSession implements CameraCaptureSessionCore {
    ...
    private class AbortDrainListener implements DrainListener {
        /* synthetic */ AbortDrainListener(CameraCaptureSessionImpl this$0, AbortDrainListener abortDrainListener) {
            this();
        }
    ...
    private class IdleDrainListener implements DrainListener {
        /* synthetic */ IdleDrainListener(CameraCaptureSessionImpl this$0, IdleDrainListener idleDrainListener) {
            this();
        }
    ...
    private class SequenceDrainListener implements DrainListener {
        /* synthetic */ SequenceDrainListener(CameraCaptureSessionImpl this$0, SequenceDrainListener sequenceDrainListener) {
            this();
        }
    ...
    CameraCaptureSessionImpl(int id, Surface input, List<Surface> outputs, StateCallback callback, Handler stateHandler, CameraDeviceImpl deviceImpl, Handler deviceStateHandler, boolean configureSuccess) {
        if (outputs == null || outputs.isEmpty()) {
            ...
            this.mSequenceDrainer = new TaskDrainer(this.mDeviceHandler, new SequenceDrainListener(this, null), "seq");
    ...
    public void finishDeferredConfiguration(List<OutputConfiguration> deferredOutputConfigs) throws CameraAccessException {
        this.mDeviceImpl.finishDeferredConfig(deferredOutputConfigs);
    }
