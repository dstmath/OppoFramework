...
public final class CameraCharacteristics extends CameraMetadata<Key<?>> {
    ...
    public static final class Key<T> {
        ...
        public String toString() {
            ...
            return String.format("CameraCharacteristics.Key(%s)", objArr);
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.hardware.camera2.CameraCharacteristics.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.hardware.camera2.CameraCharacteristics.<clinit>():void, dex: 
        */
