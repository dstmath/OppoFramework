...
public interface ICameraDeviceUser extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraDeviceUser {
        ...
        private static class Proxy implements ICameraDeviceUser {
            ...
            public void setDeferredConfiguration(int streamId, OutputConfiguration outputConfiguration) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 18:
                    ...
                    setDeferredConfiguration(_arg03, _arg1);
                    reply.writeNoException();
                    return true;
    ...
    void setDeferredConfiguration(int i, OutputConfiguration outputConfiguration) throws RemoteException;
