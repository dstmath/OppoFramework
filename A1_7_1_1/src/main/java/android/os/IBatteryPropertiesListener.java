    ...
    public static abstract class Stub extends Binder implements IBatteryPropertiesListener {
        ...
        private static class Proxy implements IBatteryPropertiesListener {
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.<init>(android.os.IBinder):void, dex: 
            ...
            Proxy(android.os.IBinder r1) {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.<init>(android.os.IBinder):void, dex: 
                */
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.asBinder():android.os.IBinder, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            public android.os.IBinder asBinder() {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.asBinder():android.os.IBinder, dex: 
                */
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.batteryPropertiesChanged(android.os.BatteryProperties):void, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            public void batteryPropertiesChanged(android.os.BatteryProperties r1) throws android.os.RemoteException {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.os.IBatteryPropertiesListener.Stub.Proxy.batteryPropertiesChanged(android.os.BatteryProperties):void, dex: 
                */
