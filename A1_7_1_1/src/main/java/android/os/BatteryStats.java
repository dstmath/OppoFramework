...
public abstract class BatteryStats implements Parcelable {
    /* renamed from: -com-android-internal-os-BatterySipper$DrainTypeSwitchesValues */
    private static final /* synthetic */ int[] f6-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues = null;
    ...
    public static final int DUMP_OPPO_FEATURE = Integer.MIN_VALUE;
    ...
    class AnonymousClass1 implements Comparator<TimerEntry> {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.os.BatteryStats.1.<init>(android.os.BatteryStats):void, dex: 
        ...
        AnonymousClass1(android.os.BatteryStats r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.os.BatteryStats.1.<init>(android.os.BatteryStats):void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e4 in method: android.os.BatteryStats.1.compare(android.os.BatteryStats$TimerEntry, android.os.BatteryStats$TimerEntry):int, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public int compare(android.os.BatteryStats.TimerEntry r1, android.os.BatteryStats.TimerEntry r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e4 in method: android.os.BatteryStats.1.compare(android.os.BatteryStats$TimerEntry, android.os.BatteryStats$TimerEntry):int, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.os.BatteryStats.1.compare(java.lang.Object, java.lang.Object):int, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public /* bridge */ /* synthetic */ int compare(java.lang.Object r1, java.lang.Object r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.os.BatteryStats.1.compare(java.lang.Object, java.lang.Object):int, dex: 
            */
    ...
    public static abstract class Counter {
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Counter.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public Counter() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Counter.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.os.BatteryStats.Counter.<init>():void");
        }
    ...
    public static final class HistoryEventTracker {
        ...
        public HistoryEventTracker() {
            this.mActiveEvents = new HashMap[21];
        }
                ...
                if (rec.stepDetails != null) {
                    if (checkin) {
                        ...
                        if (total > 0) {
                            ...
                            objArr[0] = Float.valueOf((((float) totalRun) / ((float) total)) * 100.0f);
    ...
    static final class TimerEntry {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.os.BatteryStats.TimerEntry.<init>(java.lang.String, int, android.os.BatteryStats$Timer, long):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        TimerEntry(java.lang.String r1, int r2, android.os.BatteryStats.Timer r3, long r4) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.os.BatteryStats.TimerEntry.<init>(java.lang.String, int, android.os.BatteryStats$Timer, long):void, dex: 
            */
    ...
    public static abstract class Uid {
        ...
        public static abstract class Proc {
            ...
            public static class ExcessivePower {
                ...
                /*  JADX ERROR: Method load error
                    jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.Proc.ExcessivePower.<init>():void, dex: 
                    	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                    	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                    	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                    	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                ...
                public ExcessivePower() {
                    /*
                    // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.Proc.ExcessivePower.<init>():void, dex: 
                    */
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.Proc.<init>():void, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            public Proc() {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.Proc.<init>():void, dex: 
                */
        ...
        public static class ScreenPowerApk {
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.ScreenPowerApk.<init>():void, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                ...
                Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
                	...
                	... 11 more
                */
            public ScreenPowerApk() {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.ScreenPowerApk.<init>():void, dex: 
                */
                throw new UnsupportedOperationException("Method not decompiled: android.os.BatteryStats.Uid.ScreenPowerApk.<init>():void");
            }
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.Uid.<clinit>():void, dex: 
            */
    ...
    /* renamed from: -getcom-android-internal-os-BatterySipper$DrainTypeSwitchesValues */
    private static /* synthetic */ int[] m45xe0235176() {
        if (f6-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues != null) {
            return f6-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues;
        }
        ...
        f6-com-android-internal-os-BatterySipper$DrainTypeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.BatteryStats.<clinit>():void, dex: 
        */
    ...
    public final String formatRatioLocked(long num, long den) {
        ...
        Object[] objArr = new Object[1];
        objArr[0] = Float.valueOf(perc);
        this.mFormatter.format("%.1f%%", objArr);
        return this.mFormatBuilder.toString();
    }

    protected final String formatBytesLocked(long bytes) {
        this.mFormatBuilder.setLength(0);
        if (bytes < 1024) {
            return bytes + "B";
        }
        ...
        if (bytes < 1048576) {
            objArr = new Object[1];
            objArr[0] = Double.valueOf(((double) bytes) / 1024.0d);
            this.mFormatter.format("%.2fKB", objArr);
            return this.mFormatBuilder.toString();
        } else if (bytes < 1073741824) {
            objArr = new Object[1];
            objArr[0] = Double.valueOf(((double) bytes) / 1048576.0d);
            this.mFormatter.format("%.2fMB", objArr);
            return this.mFormatBuilder.toString();
        } else {
            objArr = new Object[1];
            objArr[0] = Double.valueOf(((double) bytes) / 1.073741824E9d);
    ...
    private static final void dumpTimer(PrintWriter pw, int uid, String category, String type, Timer timer, long rawRealtime, int which) {
        if (timer != null) {
            ...
            if (totalTime != 0) {
                ...
                objArr[0] = Long.valueOf(totalTime);
    ...
    public final void dumpCheckinLocked(Context context, PrintWriter pw, int which, int reqUid, boolean wifiOnly) {
        ...
        objArr2[0] = Long.valueOf(mobileRxTotalBytes);
        objArr2[1] = Long.valueOf(mobileTxTotalBytes);
        objArr2[2] = Long.valueOf(wifiRxTotalBytes);
        objArr2[3] = Long.valueOf(wifiTxTotalBytes);
        objArr2[4] = Long.valueOf(mobileRxTotalPackets);
        objArr2[5] = Long.valueOf(mobileTxTotalPackets);
        objArr2[6] = Long.valueOf(wifiRxTotalPackets);
        objArr2[7] = Long.valueOf(wifiTxTotalPackets);
        objArr2[8] = Long.valueOf(btRxTotalBytes);
        objArr2[9] = Long.valueOf(btTxTotalBytes);
        dumpLine(pw, 0, category, str2, objArr2);
        ...
        objArr2[0] = Long.valueOf(wifiOnTime / 1000);
        objArr2[1] = Long.valueOf(wifiRunningTime / 1000);
        ...
        str2 = MISC_DATA;
        objArr2 = new Object[21];
        objArr2[0] = Long.valueOf(screenOnTime / 1000);
        objArr2[1] = Long.valueOf(phoneOnTime / 1000);
        objArr2[2] = Long.valueOf(fullWakeLockTimeTotal / 1000);
        objArr2[3] = Long.valueOf(partialWakeLockTimeTotal / 1000);
        objArr2[4] = Long.valueOf(getMobileRadioActiveTime(rawRealtime, which) / 1000);
        objArr2[5] = Long.valueOf(getMobileRadioActiveAdjustedTime(which) / 1000);
        objArr2[6] = Long.valueOf(interactiveTime / 1000);
        objArr2[7] = Long.valueOf(powerSaveModeEnabledTime / 1000);
        objArr2[8] = Integer.valueOf(connChanges);
        objArr2[9] = Long.valueOf(deviceIdleModeFullTime / 1000);
        objArr2[10] = Integer.valueOf(getDeviceIdleModeCount(2, which));
        objArr2[11] = Long.valueOf(deviceIdlingTime / 1000);
        objArr2[12] = Integer.valueOf(getDeviceIdlingCount(2, which));
        objArr2[13] = Integer.valueOf(getMobileRadioActiveCount(which));
        objArr2[14] = Long.valueOf(getMobileRadioActiveUnknownTime(which) / 1000);
        objArr2[15] = Long.valueOf(deviceIdleModeLightTime / 1000);
        objArr2[16] = Integer.valueOf(getDeviceIdleModeCount(1, which));
        objArr2[17] = Long.valueOf(deviceLightIdlingTime / 1000);
        objArr2[18] = Integer.valueOf(getDeviceIdlingCount(1, which));
        objArr2[19] = Long.valueOf(getLongestDeviceIdleModeTime(1));
        objArr2[20] = Long.valueOf(getLongestDeviceIdleModeTime(2));
        dumpLine(pw, 0, category, str2, objArr2);
        ...
        objArr2[0] = Long.valueOf(getPhoneSignalScanningTime(rawRealtime, which) / 1000);
        dumpLine(pw, 0, category, str2, objArr2);
        for (i = 0; i < 5; i++) {
        ...
        if (which == 2) {
            ...
            objArr2[0] = Integer.valueOf(getDischargeStartLevel());
            objArr2[1] = Integer.valueOf(getDischargeCurrentLevel());
            dumpLine(pw, 0, category, str2, objArr2);
        }
        if (which == 2) {
            str2 = BATTERY_DISCHARGE_DATA;
            objArr2 = new Object[6];
            objArr2[0] = Integer.valueOf(getDischargeStartLevel() - getDischargeCurrentLevel());
            objArr2[1] = Integer.valueOf(getDischargeStartLevel() - getDischargeCurrentLevel());
            objArr2[2] = Integer.valueOf(getDischargeAmountScreenOn());
            objArr2[3] = Integer.valueOf(getDischargeAmountScreenOff());
            objArr2[4] = Long.valueOf(dischargeCount / 1000);
            objArr2[5] = Long.valueOf(dischargeScreenOffCount / 1000);
            dumpLine(pw, 0, category, str2, objArr2);
        } else {
            str2 = BATTERY_DISCHARGE_DATA;
            objArr2 = new Object[6];
            objArr2[0] = Integer.valueOf(getLowDischargeAmountSinceCharge());
            objArr2[1] = Integer.valueOf(getHighDischargeAmountSinceCharge());
            objArr2[2] = Integer.valueOf(getDischargeAmountScreenOnSinceCharge());
            objArr2[3] = Integer.valueOf(getDischargeAmountScreenOffSinceCharge());
            objArr2[4] = Long.valueOf(dischargeCount / 1000);
            objArr2[5] = Long.valueOf(dischargeScreenOffCount / 1000);
            dumpLine(pw, 0, category, str2, objArr2);
        }
        if (reqUid < 0) {
            ...
            if (kernelWakelocks.size() > 0) {
                for (Entry<String, ? extends Timer> ent : kernelWakelocks.entrySet()) {
                    ...
                    objArr2 = new Object[2];
                    objArr2[0] = ent.getKey();
                    objArr2[1] = stringBuilder.toString();
                    dumpLine(pw, 0, category, str2, objArr2);
                }
            }
            ...
            if (wakeupReasons.size() > 0) {
                for (Entry<String, ? extends Timer> ent2 : wakeupReasons.entrySet()) {
                    ...
                    objArr = new Object[3];
                    objArr[0] = "\"" + ((String) ent2.getKey()) + "\"";
                    objArr[1] = Long.valueOf((500 + totalTimeMicros) / 1000);
        ...
        if (sippers != null && sippers.size() > 0) {
            ...
            objArr2[0] = BatteryStatsHelper.makemAh(batteryStatsHelper.getPowerProfile().getBatteryCapacity());
            objArr2[1] = BatteryStatsHelper.makemAh(batteryStatsHelper.getComputedPower());
            objArr2[2] = BatteryStatsHelper.makemAh(batteryStatsHelper.getMinDrainedPower());
            objArr2[3] = BatteryStatsHelper.makemAh(batteryStatsHelper.getMaxDrainedPower());
            dumpLine(pw, 0, category, str2, objArr2);
            for (i = 0; i < sippers.size(); i++) {
                String label;
                BatterySipper bs = (BatterySipper) sippers.get(i);
                uid = 0;
                switch (m45xe0235176()[bs.drainType.ordinal()]) {
                    case 1:
                ...
                objArr2 = new Object[2];
                objArr2[0] = label;
                objArr2[1] = BatteryStatsHelper.makemAh(bs.totalPowerMah);
        ...
        for (iu = 0; iu < NU; iu++) {
            ...
            if (reqUid < 0 || uid == reqUid) {
                ...
                if (mobileBytesRx > 0 || mobileBytesTx > 0 || wifiBytesRx > 0 || wifiBytesTx > 0 || mobilePacketsRx > 0 || mobilePacketsTx > 0 || wifiPacketsRx > 0 || wifiPacketsTx > 0 || mobileActiveTime > 0 || mobileActiveCount > 0 || btBytesRx > 0 || btBytesTx > 0 || mobileWakeup > 0 || wifiWakeup > 0) {
                    ...
                    objArr2[0] = Long.valueOf(mobileBytesRx);
                    objArr2[1] = Long.valueOf(mobileBytesTx);
                    objArr2[2] = Long.valueOf(wifiBytesRx);
                    objArr2[3] = Long.valueOf(wifiBytesTx);
                    objArr2[4] = Long.valueOf(mobilePacketsRx);
                    objArr2[5] = Long.valueOf(mobilePacketsTx);
                    objArr2[6] = Long.valueOf(wifiPacketsRx);
                    objArr2[7] = Long.valueOf(wifiPacketsTx);
                    objArr2[8] = Long.valueOf(mobileActiveTime);
                    objArr2[9] = Integer.valueOf(mobileActiveCount);
                    objArr2[10] = Long.valueOf(btBytesRx);
                    objArr2[11] = Long.valueOf(btBytesTx);
                    objArr2[12] = Long.valueOf(mobileWakeup);
                    objArr2[13] = Long.valueOf(wifiWakeup);
                    dumpLine(pw, uid, category, str2, objArr2);
                }
                ...
                if (!(fullWifiLockOnTime == 0 && wifiScanTime == 0 && wifiScanCount == 0 && uidWifiRunningTime == 0)) {
                    ...
                    objArr2[0] = Long.valueOf(fullWifiLockOnTime);
                    objArr2[1] = Long.valueOf(wifiScanTime);
                    objArr2[2] = Long.valueOf(uidWifiRunningTime);
                    objArr2[3] = Integer.valueOf(wifiScanCount);
                    objArr2[4] = Integer.valueOf(0);
                ...
                for (iw = wakelocks.size() - 1; iw >= 0; iw--) {
                    wl = (Wakelock) wakelocks.valueAt(iw);
                    stringBuilder.setLength(0);
                    String linePrefix = printWakeLockCheckin(stringBuilder, wl.getWakeTime(2), rawRealtime, "w", which, printWakeLockCheckin(stringBuilder, wl.getWakeTime(0), rawRealtime, TtmlUtils.TAG_P, which, printWakeLockCheckin(stringBuilder, wl.getWakeTime(1), rawRealtime, FullBackup.FILES_TREE_TOKEN, which, "")));
                ...
                for (int isy = syncs.size() - 1; isy >= 0; isy--) {
                    ...
                    if (totalTime != 0) {
                        ...
                        objArr2[0] = syncs.keyAt(isy);
                        objArr2[1] = Long.valueOf(totalTime);
                ...
                for (int ise = 0; ise < NSE; ise++) {
                    ...
                    if (timer != null) {
                        ...
                        if (totalTime != 0) {
                            str2 = SENSOR_DATA;
                            objArr2 = new Object[3];
                            objArr2[0] = Integer.valueOf(sensorNumber);
                            objArr2[1] = Long.valueOf(totalTime);
                            objArr2[2] = Integer.valueOf(count);
                            dumpLine(pw, uid, category, str2, objArr2);
                        }
                ...
                if (userCpuTimeUs > 0 || systemCpuTimeUs > 0 || powerCpuMaUs > 0) {
                    str2 = CPU_DATA;
                    objArr2 = new Object[3];
                    objArr2[0] = Long.valueOf(userCpuTimeUs / 1000);
                    objArr2[1] = Long.valueOf(systemCpuTimeUs / 1000);
                    objArr2[2] = Long.valueOf(powerCpuMaUs / 1000);
                    dumpLine(pw, uid, category, str2, objArr2);
                }
                ...
                for (int ipr = processStats.size() - 1; ipr >= 0; ipr--) {
                    ...
                    if (userMillis != 0 || systemMillis != 0 || foregroundMillis != 0 || starts != 0 || numAnrs != 0 || numCrashes != 0) {
                        str2 = PROCESS_DATA;
                        objArr2 = new Object[7];
                        objArr2[0] = processStats.keyAt(ipr);
                        objArr2[1] = Long.valueOf(userMillis);
                        objArr2[2] = Long.valueOf(systemMillis);
                        objArr2[3] = Long.valueOf(foregroundMillis);
                        objArr2[4] = Integer.valueOf(starts);
                        objArr2[5] = Integer.valueOf(numAnrs);
                        objArr2[6] = Integer.valueOf(numCrashes);
                        dumpLine(pw, uid, category, str2, objArr2);
                    }
                }
                ...
                for (int ipkg = packageStats.size() - 1; ipkg >= 0; ipkg--) {
                    ...
                    for (int isvc = serviceStats.size() - 1; isvc >= 0; isvc--) {
                        ...
                        if (startTime != 0 || starts != 0 || launches != 0) {
                            str2 = APK_DATA;
                            objArr2 = new Object[6];
                            objArr2[0] = Integer.valueOf(wakeups);
                            objArr2[1] = packageStats.keyAt(ipkg);
                            objArr2[2] = serviceStats.keyAt(isvc);
                            objArr2[3] = Long.valueOf(startTime / 1000);
                            objArr2[4] = Integer.valueOf(starts);
                            objArr2[5] = Integer.valueOf(launches);
                            dumpLine(pw, uid, category, str2, objArr2);
                        }
                    }
                }
    ...
    public final void dumpLocked(Context context, PrintWriter pw, String prefix, int which, int reqUid) {
        dumpLocked(context, pw, prefix, which, reqUid, BatteryStatsHelper.checkWifiOnly(context), false);
    }

    /* JADX WARNING: Removed duplicated region for block: B:256:0x13fc  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void dumpLocked(Context context, PrintWriter pw, String prefix, int which, int reqUid, boolean wifiOnly, boolean oppoFeature) {
        int i;
        long time;
        int iu;
        Uid u;
        ...
        for (iu = 0; iu < NU; iu++) {
            ...
            if (reqUid < 0 || uid == reqUid || uid == 1000) {
                ...
                long wifiWakeup = u.getWifiRadioApWakeupCount(which);
                if (oppoFeature) {
                    boolean hasUidScreenDate = false;
                    i = 0;
                    while (i < 5) {
                        if (0 != u.getUidScreenBrightnessTime(i, rawRealtime, which)) {
                            hasUidScreenDate = true;
                            if (hasUidScreenDate) {
                                sb.setLength(0);
                                sb.append("    Screen brightnesses:");
                                for (i = 0; i < 5; i++) {
                                    time = u.getUidScreenBrightnessTime(i, rawRealtime, which);
                                    if (time != 0) {
                                        sb.append("\n      ");
                                        sb.append(prefix);
                                        sb.append(SCREEN_BRIGHTNESS_NAMES[i]);
                                ...
                                pw.println();
                                if (isSystemUid(uid)) {
                                    Map<String, ? extends ScreenPowerApk> screenPowerApks = u.getScreenPowerApks();
                                    if (screenPowerApks != null && screenPowerApks.size() > 0) {
                                        sb.setLength(0);
                                        sb.append("    APK Screen brightnesses:");
                                        for (Entry<String, ? extends ScreenPowerApk> ent3 : screenPowerApks.entrySet()) {
                                            ScreenPowerApk apk = (ScreenPowerApk) ent3.getValue();
                                            sb.append("\n      ");
                                            sb.append((String) ent3.getKey());
                                            sb.append(":\n        ");
                                            for (i = 0; i < 5; i++) {
                                                time = apk.getScreenBrightnessTime(i, rawRealtime, which);
                                                if (time != 0) {
                                                    sb.append(SCREEN_BRIGHTNESS_NAMES[i]);
                                                    sb.append("  ");
                                                    formatTimeMs(sb, time / 1000);
                ...
                boolean uidActivity = printTimer(pw, sb, u.getBluetoothScanTimer(), rawRealtime, which, prefix, "Bluetooth Scan");
                if (u.hasUserActivity()) {
                    boolean hasData = false;
                    for (i = 0; i < 4; i++) {
                        int val = u.getUserActivityCount(i, which);
                ...
                for (iw = wakelocks.size() - 1; iw >= 0; iw--) {
                    ...
                    str = printWakeLock(sb, wl.getWakeTime(18), rawRealtime, "draw", which, printWakeLock(sb, wl.getWakeTime(2), rawRealtime, Context.WINDOW_SERVICE, which, printWakeLock(sb, wl.getWakeTime(0), rawRealtime, "partial", which, printWakeLock(sb, wl.getWakeTime(1), rawRealtime, "full", which, ": "))));
                    sb.append(" realtime");
                    pw.println(sb.toString());
                    uidActivity = true;
                    countWakelock++;
        ...
        if (diff != 0) {
            ...
            for (BitDescription bd : descriptions) {
                if ((bd.mask & diff) != 0) {
                    ...
                    if (bd.shift < 0) {
                        pw.print((bd.mask & newval) != 0 ? "+" : Aas.ENCODE_SYMBOL);
    ...
    public void dumpLocked(Context context, PrintWriter pw, int flags, int reqUid, long histStart) {
        ...
        if (!filtering || (flags & 6) != 0) {
            ...
            if (!(filtering && (flags & 2) == 0)) {
                ...
                dumpLocked(context, pw, "", 0, reqUid, (flags & 64) != 0, (Integer.MIN_VALUE & flags) != 0);
                pw.println();
            }
        }
    }
    ...
    public void dumpCheckinLocked(Context context, PrintWriter pw, List<ApplicationInfo> apps, int flags, long histStart) {
        ...
        objArr[0] = CHECKIN_VERSION;
        objArr[1] = Integer.valueOf(getParcelVersion());
        objArr[2] = getStartPlatformVersion();
        objArr[3] = getEndPlatformVersion();
        dumpLine(pw, 0, "i", str, objArr);
