...
public class Handler {
    ...
    private final class MessengerImpl extends Stub {
        /* synthetic */ MessengerImpl(Handler this$0, MessengerImpl messengerImpl) {
            this();
        }
    ...
    public final void sendMonitorMessage(Message msg, long delayMillis, long executiontimeout, long pendingtimeout, String msgLoggerName) {
        if (MessageMonitorLogger.mMsgLoggerHandler != null) {
            MonitorMSGInfo msgMonitorInfo = new MonitorMSGInfo();
            ...
            if (pendingtimeout > 100) {
                try {
                    MessageMonitorLogger.mMsgLoggerHandler.sendMessageDelayed(MessageMonitorLogger.mMsgLoggerHandler.obtainMessage(MessageMonitorLogger.START_MONITOR_PENDING_TIMEOUT_MSG, msgMonitorInfo), delayMillis + pendingtimeout);
    ...
    public final void removeMonitorMessage(int what) {
        for (Message msg : MessageMonitorLogger.monitorMsg.keySet()) {
            if (msg.what == what) {
                MonitorMSGInfo monitorMsg = (MonitorMSGInfo) MessageMonitorLogger.monitorMsg.get(msg);
