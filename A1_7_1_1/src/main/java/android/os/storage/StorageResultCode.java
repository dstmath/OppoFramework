...
public class StorageResultCode {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.os.storage.StorageResultCode.<init>():void, dex: 
    ...
    public StorageResultCode() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.os.storage.StorageResultCode.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.os.storage.StorageResultCode.<init>():void");
    }
}
