...
public interface INetworkManagementService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkManagementService {
        ...
        static final int TRANSACTION_addBridge = 116;
        static final int TRANSACTION_addBridgeInterface = 118;
        ...
        static final int TRANSACTION_addVpnUidRanges = 66;
        static final int TRANSACTION_allowProtect = 86;
        static final int TRANSACTION_attachPppd = 33;
        static final int TRANSACTION_clearBridgeMac = 120;
        static final int TRANSACTION_clearDefaultNetId = 82;
        static final int TRANSACTION_clearFirewallChain = 106;
        static final int TRANSACTION_clearInterfaceAddresses = 7;
        static final int TRANSACTION_clearIotFirewall = 112;
        static final int TRANSACTION_clearPermission = 85;
        static final int TRANSACTION_clearRouteIpv6 = 98;
        static final int TRANSACTION_clearSipInfo = 111;
        static final int TRANSACTION_clearSourceRouteIpv6 = 100;
        static final int TRANSACTION_clearVolteIotFirewall = 114;
        static final int TRANSACTION_createPhysicalNetwork = 74;
        static final int TRANSACTION_createVirtualNetwork = 75;
        static final int TRANSACTION_deleteBridge = 117;
        static final int TRANSACTION_deleteBridgeInterface = 119;
        ...
        static final int TRANSACTION_disableNatIpv6 = 94;
        static final int TRANSACTION_disablePPPOE = 92;
        static final int TRANSACTION_enableIpv6 = 12;
        static final int TRANSACTION_enableNat = 30;
        static final int TRANSACTION_enableNatIpv6 = 93;
        static final int TRANSACTION_enableUdpForwarding = 103;
        static final int TRANSACTION_getDnsForwarders = 27;
        static final int TRANSACTION_getInterfaceConfig = 5;
        static final int TRANSACTION_getInterfaceRxThrottle = 108;
        static final int TRANSACTION_getInterfaceTxThrottle = 109;
        static final int TRANSACTION_getIpForwardingEnabled = 18;
        static final int TRANSACTION_getIpv6ForwardingEnabled = 96;
        ...
        static final int TRANSACTION_getNetworkStatsUidDetailWithPids = 77;
        static final int TRANSACTION_getSipInfo = 110;
        static final int TRANSACTION_getUsbClient = 104;
        static final int TRANSACTION_isBandwidthControlEnabled = 53;
        static final int TRANSACTION_isClatdStarted = 70;
        static final int TRANSACTION_isFirewallEnabled = 59;
        static final int TRANSACTION_isNetworkActive = 73;
        ...
        static final int TRANSACTION_registerNetworkActivityListener = 71;
        ...
        static final int TRANSACTION_removeNetwork = 76;
        static final int TRANSACTION_removeRoute = 15;
        static final int TRANSACTION_removeRoutesFromLocalNetwork = 90;
        static final int TRANSACTION_removeVpnUidRanges = 67;
        static final int TRANSACTION_setAccessPoint = 38;
        static final int TRANSACTION_setAllowOnlyVpnForUids = 91;
        static final int TRANSACTION_setDataSaverModeEnabled = 51;
        static final int TRANSACTION_setDefaultNetId = 81;
        static final int TRANSACTION_setDhcpv6Enabled = 102;
        static final int TRANSACTION_setDnsConfigurationForNetwork = 56;
        static final int TRANSACTION_setDnsForwarders = 26;
        static final int TRANSACTION_setDnsServersForNetwork = 57;
        static final int TRANSACTION_setFirewallChainEnabled = 65;
        static final int TRANSACTION_setFirewallEgressDestRule = 62;
        static final int TRANSACTION_setFirewallEgressProtoRule = 101;
        static final int TRANSACTION_setFirewallEgressSourceRule = 61;
        static final int TRANSACTION_setFirewallEnabled = 58;
        static final int TRANSACTION_setFirewallInterfaceRule = 60;
        static final int TRANSACTION_setFirewallUidChainRule = 105;
        static final int TRANSACTION_setFirewallUidRule = 63;
        static final int TRANSACTION_setFirewallUidRules = 64;
        ...
        static final int TRANSACTION_setInterfaceThrottle = 107;
        static final int TRANSACTION_setInterfaceUp = 9;
        static final int TRANSACTION_setIotFirewall = 113;
        static final int TRANSACTION_setIpForwardingEnabled = 19;
        static final int TRANSACTION_setIpv6ForwardingEnabled = 95;
        ...
        static final int TRANSACTION_setRouteIpv6 = 97;
        static final int TRANSACTION_setSourceRouteIpv6 = 99;
        ...
        static final int TRANSACTION_setVolteIotFirewall = 115;
        static final int TRANSACTION_shutdown = 17;
        static final int TRANSACTION_startAccessPoint = 36;
        static final int TRANSACTION_startClatd = 68;
        ...
        static final int TRANSACTION_stopClatd = 69;
        ...
        static final int TRANSACTION_unregisterNetworkActivityListener = 72;
        ...
        private static class Proxy implements INetworkManagementService {
            ...
            public NetworkStats getNetworkStatsUidDetailWithPids(int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    NetworkStats _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getNetworkStatsUidDetailWithPids(data.readInt());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
                ...
                case 93:
                    data.enforceInterface(DESCRIPTOR);
                    enableNatIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    disableNatIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 95:
                    data.enforceInterface(DESCRIPTOR);
                    setIpv6ForwardingEnabled(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 96:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getIpv6ForwardingEnabled();
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 97:
                    data.enforceInterface(DESCRIPTOR);
                    setRouteIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 98:
                    data.enforceInterface(DESCRIPTOR);
                    clearRouteIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 99:
                    data.enforceInterface(DESCRIPTOR);
                    setSourceRouteIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 100:
                    data.enforceInterface(DESCRIPTOR);
                    clearSourceRouteIpv6(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 101:
                    data.enforceInterface(DESCRIPTOR);
                    setFirewallEgressProtoRule(data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 102:
                    data.enforceInterface(DESCRIPTOR);
                    setDhcpv6Enabled(data.readInt() != 0, data.readString());
                    reply.writeNoException();
                    return true;
                case 103:
                    data.enforceInterface(DESCRIPTOR);
                    enableUdpForwarding(data.readInt() != 0, data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 104:
                    data.enforceInterface(DESCRIPTOR);
                    getUsbClient(data.readString());
                    reply.writeNoException();
                    return true;
                case 105:
                    data.enforceInterface(DESCRIPTOR);
                    setFirewallUidChainRule(data.readInt(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 106:
                    data.enforceInterface(DESCRIPTOR);
                    clearFirewallChain(data.readString());
                    reply.writeNoException();
                    return true;
                case 107:
                    data.enforceInterface(DESCRIPTOR);
                    setInterfaceThrottle(data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 108:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getInterfaceRxThrottle(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case 109:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getInterfaceTxThrottle(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4);
                    return true;
                case 110:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getSipInfo(data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeStringArray(_result);
                    return true;
                case 111:
                    data.enforceInterface(DESCRIPTOR);
                    clearSipInfo(data.readString());
                    reply.writeNoException();
                    return true;
                case 112:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 114:
                    data.enforceInterface(DESCRIPTOR);
                    clearVolteIotFirewall(data.readString());
                    reply.writeNoException();
                    return true;
                case 115:
                    data.enforceInterface(DESCRIPTOR);
                    setVolteIotFirewall(data.readString());
                    reply.writeNoException();
                    return true;
                case 116:
                    data.enforceInterface(DESCRIPTOR);
                    addBridge(data.readString());
                    reply.writeNoException();
                    return true;
                case 117:
                    data.enforceInterface(DESCRIPTOR);
                    deleteBridge(data.readString());
                    reply.writeNoException();
                    return true;
                case 118:
                    data.enforceInterface(DESCRIPTOR);
                    addBridgeInterface(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 119:
                    data.enforceInterface(DESCRIPTOR);
                    deleteBridgeInterface(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 120:
                    data.enforceInterface(DESCRIPTOR);
                    clearBridgeMac(data.readString());
                    reply.writeNoException();
                    return true;
    ...
    NetworkStats getNetworkStatsUidDetailWithPids(int i) throws RemoteException;
