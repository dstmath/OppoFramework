...
abstract class ActivityTransitionCoordinator extends ResultReceiver {
    ...
    private static class FixedEpicenterCallback extends EpicenterCallback {
        ...
        /* synthetic */ FixedEpicenterCallback(FixedEpicenterCallback fixedEpicenterCallback) {
            this();
        }
    ...
    private static class GhostViewListeners implements OnPreDrawListener {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.<init>(android.view.View, android.view.View, android.view.ViewGroup):void, dex: 
        ...
        public GhostViewListeners(android.view.View r1, android.view.View r2, android.view.ViewGroup r3) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.<init>(android.view.View, android.view.View, android.view.ViewGroup):void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: null in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.getView():android.view.View, dex:  in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.getView():android.view.View, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            	...
            	at jadx.api.JavaClass.decompile(JavaClass.java:62)
            	at jadx.api.JadxDecompiler.lambda$appendSourcesSave$0(JadxDecompiler.java:200)
            Caused by: jadx.core.utils.exceptions.DecodeException: null in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.getView():android.view.View, dex: 
        ...
        public android.view.View getView() {
            /*
            // Can't load method instructions: Load method exception: null in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.getView():android.view.View, dex:  in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.getView():android.view.View, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.onPreDraw():boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean onPreDraw() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.app.ActivityTransitionCoordinator.GhostViewListeners.onPreDraw():boolean, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.ActivityTransitionCoordinator.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.ActivityTransitionCoordinator.<clinit>():void, dex: 
        */
    ...
    private void startInputWhenTransitionsComplete() {
        if (DEBUG_PANIC) {
            Log.d(TAG, "startInputWhenTransitionsComplete, view complete:" + this.mViewsTransitionComplete + ", element complete:" + this.mSharedElementTransitionComplete);
        }
