...
public interface IAlarmManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlarmManager {
        ...
        static final int TRANSACTION_getTriggeredAlarms = 10;
        ...
        private static class Proxy implements IAlarmManager {
            ...
            public Map getTriggeredAlarms() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    removeFromAms(data.readString());
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _result = lookForPackageFromAms(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    Map _result4 = getTriggeredAlarms();
                    reply.writeNoException();
    ...
    Map getTriggeredAlarms() throws RemoteException;
