...
class ApplicationThreadProxy implements IApplicationThread {
    ...
    public void scheduleNewIntent(List<ReferrerIntent> intents, IBinder token, boolean andPause) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
    ...
    public final void scheduleReceiver(Intent intent, ActivityInfo info, CompatibilityInfo compatInfo, int resultCode, String resultData, Bundle map, boolean sync, int sendingUser, int processState, int hasCode) throws RemoteException {
        int i = 0;
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        intent.writeToParcel(data, 0);
    ...
    public void dumpMessageHistory() throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        this.mRemote.transact(102, data, null, 1);
        data.recycle();
    }
    ...
    public void enableLooperLog() throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        this.mRemote.transact(103, data, null, 1);
        data.recycle();
    }
    ...
    public void dumpAllMessageHistory() throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        this.mRemote.transact(106, data, null, 1);
        data.recycle();
    }
    ...
    public void configActivityLogTag(String tag, boolean on) throws RemoteException {
        ...
        this.mRemote.transact(107, data, null, 1);
        data.recycle();
    }

    public final int getBroadcastState(int flag) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeInt(flag);
        this.mRemote.transact(401, data, reply, 0);
        reply.readException();
    ...
    public final void openActivityLog(boolean on) throws RemoteException {
        Parcel data = Parcel.obtain();
        data.writeInterfaceToken(IApplicationThread.descriptor);
        data.writeInt(on ? 1 : 0);
        this.mRemote.transact(402, data, null, 1);
        data.recycle();
    }
}
