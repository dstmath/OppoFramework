...
public interface IActivityManager extends IInterface {
    public static final int AAL_SET_AAL_ENABLED = 511;
    public static final int AAL_SET_AAL_MODE = 510;
    ...
    public static final int ADD_DISALLOWED_RUNNING_APP_TRANSACTION = 852;
    public static final int ADD_PACKAGE_DEPENDENCY_TRANSACTION = 95;
    public static final int ALLOW_TO_USE_SDCARD_TRANSACTION = 855;
    public static final int APP_DEXOPT_TRANSACTION = 804;
    public static final int APP_JUNK_TRANSACTION = 806;
    ...
    public static final int FINISH_NOT_ORDER_RECEIVER_TRANSACTION = 803;
    ...
    public static final int FORCE_KILL_PACKAGE_TRANSACTION = 501;
    ...
    public static final int GET_DISALLOWED_RUNNING_APP_TRANSACTION = 854;
    public static final int GET_DOCK_APP_NAME_TRANSACTION = 808;
    ...
    public static final int GET_INFO_PACKAGE_LIST_FROM_PID_TRANSACTION = 507;
    public static final int GET_INFO_PROCESSES_WITH_ADJ_TRANSACTION = 508;
    ...
    public static final int GET_PROCESS_PSWAP_TRANSACTION = 406;
    ...
    public static final int GET_STICKY_WINDOW_TRANSACTION = 505;
    ...
    public static final int GET_TOP_APP_NAME_TRANSACTION = 802;
    ...
    public static final int IS_TOP_RUNNING_TASK_DOCKABLE = 809;
    ...
    public static final int OPPO_ACTIVITY_FIRST_CALL_TRANSACTION = 801;
    public static final int OPPO_ACTIVITY_FIRST_CALL_TRANSACTION_CUSTOMIZE = 851;
    public static final int OPPO_ADJUST_SPLIT = 807;
    ...
    public static final int READY_TO_GET_CONTENT_PROVIDER_TRANSACTION = 509;
    ...
    public static final int REMOVE_DISALLOWED_RUNNING_APP_TRANSACTION = 853;
    ...
    public static final int RESTORE_WINDOW_TRANSACTION = 506;
    ...
    public static final int SET_ACTIVITY_OPPOKINECT_CONTROLLER_TRANSACTION = 805;
    ...
    public static final int SET_STICK_WINDOW_TRANSACTION = 504;
    ...
    public static final int SET_WALLPAPER_PROCESS = 502;
    ...
    public static final int UPDATE_WALLPAPER_STATE = 503;
    ...
    public static class ContentProviderHolder implements Parcelable {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.ContentProviderHolder.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.ContentProviderHolder.<clinit>():void, dex: 
            */
        ...
        /* synthetic */ ContentProviderHolder(Parcel source, ContentProviderHolder contentProviderHolder) {
            this(source);
        }
    ...
    public static class WaitResult implements Parcelable {
        ...
        static class AnonymousClass1 implements Creator<WaitResult> {
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.WaitResult.1.<init>():void, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            AnonymousClass1() {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.WaitResult.1.<init>():void, dex: 
                */
                throw new UnsupportedOperationException("Method not decompiled: android.app.IActivityManager.WaitResult.1.<init>():void");
            }

            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.app.IActivityManager.WaitResult.1.createFromParcel(android.os.Parcel):java.lang.Object, dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            public /* bridge */ /* synthetic */ java.lang.Object createFromParcel(android.os.Parcel r1) {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.app.IActivityManager.WaitResult.1.createFromParcel(android.os.Parcel):java.lang.Object, dex: 
                */
                throw new UnsupportedOperationException("Method not decompiled: android.app.IActivityManager.WaitResult.1.createFromParcel(android.os.Parcel):java.lang.Object");
            }

            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.app.IActivityManager.WaitResult.1.newArray(int):java.lang.Object[], dex: 
                	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
                	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            ...
            public /* bridge */ /* synthetic */ java.lang.Object[] newArray(int r1) {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.app.IActivityManager.WaitResult.1.newArray(int):java.lang.Object[], dex: 
                */
                throw new UnsupportedOperationException("Method not decompiled: android.app.IActivityManager.WaitResult.1.newArray(int):java.lang.Object[]");
            }
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.WaitResult.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.IActivityManager.WaitResult.<clinit>():void, dex: 
            */
    ...
    boolean canBypassWorkChallenge(PendingIntent pendingIntent) throws RemoteException;
    ...
    void forceKillPackage(String str, int i, String str2) throws RemoteException;
    ...
    String[] getPackageListFromPid(int i) throws RemoteException;
    ...
    long[] getProcessPswap(int[] iArr) throws RemoteException;

    List<ProcessErrorStateInfo> getProcessesInErrorState() throws RemoteException;

    ArrayMap<Integer, ArrayList<Integer>> getProcessesWithAdj() throws RemoteException;
    ...
    boolean isStickyByMtk(IBinder iBinder) throws RemoteException;

    boolean isTopActivityImmersive() throws RemoteException;

    boolean isTopOfTask(IBinder iBinder) throws RemoteException;

    boolean isTopRunningTaskDockable() throws RemoteException;
    ...
    int readyToGetContentProvider(IApplicationThread iApplicationThread, String str, int i) throws RemoteException;
    ...
    void setWallpaperProcess(ComponentName componentName) throws RemoteException;
    ...
    void updateWallpaperState(boolean z) throws RemoteException;
