...
public class JobInfo implements Parcelable {
    ...
    private final boolean hasCpuConstraint;
    private final boolean hasEarlyConstraint;
    private final boolean hasLateConstraint;
    private final long initialBackoffMillis;
    private long intervalMillis;
    private boolean isNotSysApp;
    ...
    private final boolean requireBattIdle;
    private final boolean requireCharging;
    private final boolean requireDeviceIdle;
    private final boolean requireProtectFore;
    ...
    public static final class Builder {
        ...
        private String mOppoExtraStr;
        private int mPriority = 0;
        private int mProtectForeType;
        ...
        public Builder setRequiresBattIdle(boolean requiresBattIdle, int extra) {
            this.mRequiresBattIdle = requiresBattIdle;
            return this;
        }

        public Builder setOppoJob(boolean isOppoJob) {
            this.mIsOppoJob = isOppoJob;
            return this;
        }

        public Builder setRequiresProtectFore(boolean requiresProtectFore) {
            setRequiresProtectFore(requiresProtectFore, 0);
            return this;
        }

        public Builder setRequiresProtectFore(boolean requiresProtectFore, int type) {
            this.mRequiresProtectFore = requiresProtectFore;
            this.mProtectForeType = type;
            return this;
        }

        public Builder setHasCpuConstraint(boolean hasCpuConstraint) {
            this.mHasCpuConstraint = hasCpuConstraint;
            return this;
        }

        public Builder setOppoExtraStr(String str) {
            this.mOppoExtraStr = str;
            return this;
        }

        public JobInfo build() {
            if (this.mJobService == null || this.mJobService.getPackageName() == null || this.mJobService.getPackageName().contains(".cts") || this.mJobService.getPackageName().contains("cts.")) {
            ...
            } else if (!(this.mHasEarlyConstraint || this.mHasLateConstraint || this.mRequiresCharging || this.mRequiresDeviceIdle || this.mNetworkType != 0 || this.mTriggerContentUris != null || this.mRequiresBattIdle || this.mRequiresProtectFore || this.mHasCpuConstraint || this.mIsOppoJob)) {
                throw new IllegalArgumentException("You're trying to build a job with no constraints, this is not allowed.");
            }
    ...
    public static final class TriggerContentUri implements Parcelable {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.job.JobInfo.TriggerContentUri.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.job.JobInfo.TriggerContentUri.<clinit>():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.app.job.JobInfo.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.app.job.JobInfo.<clinit>():void, dex: 
        */
    ...
    private JobInfo(Parcel in) {
        ...
        this.requireProtectFore = z;
        if (in.readInt() == 1) {
            z = true;
        } else {
            z = false;
        }
        this.hasCpuConstraint = z;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(i);
        if (this.requireProtectFore) {
            i = 1;
        } else {
            i = 0;
        }
        out.writeInt(i);
        if (this.hasCpuConstraint) {
            i = 1;
        } else {
            i = 0;
        }
