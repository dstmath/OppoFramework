...
public interface IApplicationThread extends IInterface {
    ...
    public static final int CONFIG_ACTIVITY_LOG_TAG = 107;
    ...
    public static final int DUMP_ALL_MESSAGE_HISTORY_TRANSACTION = 106;
    ...
    public static final int DUMP_MESSAGE_HISTORY_TRANSACTION = 102;
    public static final int DUMP_PROVIDER_TRANSACTION = 45;
    public static final int DUMP_SERVICE_TRANSACTION = 22;
    public static final int ENABLE_LOOPER_LOG = 103;
    ...
    public static final int OPEN_ACTIVITY_LOG_TRANSACTION = 402;
    public static final int OPPO_GET_BROADCAST_STATE_TRANSACTION = 401;
    ...
    void configActivityLogTag(String str, boolean z) throws RemoteException;
    ...
    int getBroadcastState(int i) throws RemoteException;
