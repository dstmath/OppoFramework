...
public class LayoutTransition {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.animation.LayoutTransition.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.animation.LayoutTransition.<clinit>():void, dex: 
        */
    ...
    public LayoutTransition() {
        ...
        if (defaultChangeIn == null) {
            ...
            propertyValuesHolderArr[0] = pvhLeft;
            propertyValuesHolderArr[1] = pvhTop;
            propertyValuesHolderArr[2] = pvhRight;
            propertyValuesHolderArr[3] = pvhBottom;
            propertyValuesHolderArr[4] = pvhScrollX;
            propertyValuesHolderArr[5] = pvhScrollY;
            defaultChangeIn = ObjectAnimator.ofPropertyValuesHolder(obj, propertyValuesHolderArr);
