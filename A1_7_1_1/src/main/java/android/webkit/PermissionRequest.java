...
public abstract class PermissionRequest {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.webkit.PermissionRequest.<init>():void, dex: 
    ...
    public PermissionRequest() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.webkit.PermissionRequest.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.webkit.PermissionRequest.<init>():void");
    }
