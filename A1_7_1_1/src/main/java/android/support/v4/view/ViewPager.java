...
public class ViewPager extends ViewGroup {
    ...
    private boolean BACK_AND_FORTH_ANIMATION;
    ...
    private boolean mDragToRightPage;
    ...
    public static class SavedState extends BaseSavedState {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.support.v4.view.ViewPager.SavedState.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.support.v4.view.ViewPager.SavedState.<clinit>():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.support.v4.view.ViewPager.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.support.v4.view.ViewPager.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewPager.<clinit>():void");
    }
    ...
    public ViewPager(Context context) {
        ...
        this.BACK_AND_FORTH_ANIMATION = true;
        initViewPager();
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:126:0x042a  */
    ...
    protected void onPageScrolled(int position, float offset, int offsetPixels) {
        ...
        if (!(this.mOnPageDraggedListener == null || this.mOverScrolled || this.mScrollState == 0)) {
            int scrollTo = -1;
            int scrollFrom = -1;
        ...
        switch (action) {
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (dx != 0.0f) {
                        if (!isGutterDrag(this.mLastMotionX, dx)) {
