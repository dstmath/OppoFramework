...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final Interpolator EASE_INTERPOLATOR = null;
    private static final Interpolator END_CURVE_INTERPOLATOR = null;
    static final int LARGE = 0;
    private static final Interpolator LINEAR_INTERPOLATOR = null;
    private static final float MAX_PROGRESS_ARC = 0.8f;
    private static final float NUM_POINTS = 5.0f;
    private static final Interpolator START_CURVE_INTERPOLATOR = null;
    ...
    private static class EndCurveInterpolator extends AccelerateDecelerateInterpolator {
        /* synthetic */ EndCurveInterpolator(EndCurveInterpolator endCurveInterpolator) {
            this();
        }
    ...
    private static class StartCurveInterpolator extends AccelerateDecelerateInterpolator {
        /* synthetic */ StartCurveInterpolator(StartCurveInterpolator startCurveInterpolator) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.support.v4.widget.MaterialProgressDrawable.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.support.v4.widget.MaterialProgressDrawable.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.MaterialProgressDrawable.<clinit>():void");
    }

    public MaterialProgressDrawable(Context context, View parent) {
        int[] iArr = new int[1];
        iArr[0] = ViewCompat.MEASURED_STATE_MASK;
        this.COLORS = iArr;
    ...
    private void setupAnimators() {
        ...
        Animation animation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                float minProgressArc = (float) Math.toRadians(((double) ring.getStrokeWidth()) / (ring.getCenterRadius() * 6.283185307179586d));
                ...
                ring.setStartTrim(startingTrim + (MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime) * MaterialProgressDrawable.MAX_PROGRESS_ARC));
                ring.setRotation(startingRotation + (0.25f * interpolatedTime));
                MaterialProgressDrawable.this.setRotation((144.0f * interpolatedTime) + ((MaterialProgressDrawable.this.mRotationCount / 5.0f) * 720.0f));
            }
        };
