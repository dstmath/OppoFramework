...
public class ViewDragHelper {
    private static final int BASE_SETTLE_DURATION = 320;
    ...
    private static final int MAX_SETTLE_DURATION = 750;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.support.v4.widget.ViewDragHelper.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.support.v4.widget.ViewDragHelper.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.widget.ViewDragHelper.<clinit>():void");
    }
    ...
    private int computeAxisDuration(int delta, int velocity, int motionRange) {
        ...
        if (velocity > 0) {
            ...
            duration = (int) (((((float) Math.abs(delta)) / ((float) motionRange)) + 1.0f) * 320.0f);
        }
    ...
    /* JADX WARNING: Missing block: B:39:0x01f3, code:
            if (r11 != r13) goto L_0x0202;
     */
    ...
    /* JADX WARNING: Missing block: B:41:0x0237, code:
