...
public class LinearLayoutManager extends LayoutManager {
    ...
    static class SavedState implements Parcelable {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.support.v7.widget.LinearLayoutManager.SavedState.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.support.v7.widget.LinearLayoutManager.SavedState.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.LinearLayoutManager.SavedState.<clinit>():void");
        }
    ...
    private void layoutForPredictiveAnimations(Recycler recycler, State state, int startOffset, int endOffset) {
        if (state.willRunPredictiveAnimations() && getChildCount() != 0 && !state.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            for (int i = 0; i < scrapSize; i++) {
                ...
                if (((scrap.getPosition() < firstChildPos ? true : DEBUG) != this.mShouldReverseLayout ? -1 : 1) == -1) {
    ...
    protected void updateLayoutState(int layoutDirection, int requiredSpace, boolean canUseExistingSpace, State state) {
        int fastScrollSpace;
        int i = -1;
        int i2 = 1;
    ...
    protected int scrollBy(int dy, Recycler recycler, State state) {
        ...
        if (dt >= 0) {
            ...
            if (this.mShouldReverseLayout) {
                for (i = childCount - 1; i >= 0; i--) {
                    if (this.mOrientationHelper.getDecoratedEnd(getChildAt(i)) > dt) {
    ...
    protected int fill(Recycler recycler, LayoutState layoutState, State state, boolean stopOnFocusable) {
    ...
    public int findFirstVisibleItemPosition() {
        View child = findOneVisibleChild(0, getChildCount(), DEBUG);
    ...
    public View onFocusSearchFailed(View focused, int focusDirection, Recycler recycler, State state) {
        ...
        View nextFocus;
        ensureLayoutState();
        updateLayoutState(layoutDir, (int) (((float) this.mOrientationHelper.getTotalSpace()) * MAX_SCROLL_FACTOR), DEBUG, state);
        this.mLayoutState.mScrollingOffset = Integer.MIN_VALUE;
        this.mLayoutState.mRecycle = DEBUG;
    ...
    public void offsetChildren(int amount) {
        this.mOrientationHelper.offsetChildren(amount);
    }
}
