...
public class DefaultItemAnimator extends ItemAnimator {
    ...
    private static class ChangeInfo {
        ...
        /* synthetic */ ChangeInfo(ViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY, int toX, int toY, ChangeInfo changeInfo) {
    ...
    private static class MoveInfo {
        ...
        /* synthetic */ MoveInfo(ViewHolder holder, int fromX, int fromY, int toX, int toY, MoveInfo moveInfo) {
