...
public final class Palette {
    ...
    public boolean equals(Object o) {
        ...
        if (!this.mSwatches == null ? this.mSwatches.equals(palette.mSwatches) : palette.mSwatches == null) {
            return false;
        }
        if (!this.mDarkMutedSwatch == null ? this.mDarkMutedSwatch.equals(palette.mDarkMutedSwatch) : palette.mDarkMutedSwatch == null) {
            return false;
        }
        if (!this.mDarkVibrantSwatch == null ? this.mDarkVibrantSwatch.equals(palette.mDarkVibrantSwatch) : palette.mDarkVibrantSwatch == null) {
            return false;
        }
        if (!this.mLightMutedColor == null ? this.mLightMutedColor.equals(palette.mLightMutedColor) : palette.mLightMutedColor == null) {
            return false;
        }
        if (!this.mLightVibrantSwatch == null ? this.mLightVibrantSwatch.equals(palette.mLightVibrantSwatch) : palette.mLightVibrantSwatch == null) {
            return false;
        }
        if (this.mMutedSwatch == null ? palette.mMutedSwatch == null : this.mMutedSwatch.equals(palette.mMutedSwatch)) {
            return this.mVibrantSwatch == null ? palette.mVibrantSwatch == null : this.mVibrantSwatch.equals(palette.mVibrantSwatch);
        } else {
            return false;
        }
    }
