...
public final class SQLiteDebug {
    ...
    public static class DbStats {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.database.sqlite.SQLiteDebug.DbStats.<init>(java.lang.String, long, long, int, int, int, int):void, dex: 
        ...
        public DbStats(java.lang.String r1, long r2, long r4, int r6, int r7, int r8, int r9) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.database.sqlite.SQLiteDebug.DbStats.<init>(java.lang.String, long, long, int, int, int, int):void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.database.sqlite.SQLiteDebug.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.database.sqlite.SQLiteDebug.<clinit>():void, dex: 
        */
