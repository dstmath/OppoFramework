...
public final class SQLiteConnection implements OnCancelListener {
    ...
    private boolean mEnableDefaultWALMode;
    private final boolean mIsPrimaryConnection;
    private final boolean mIsReadOnlyConnection;
    private String mOldJournalMode;
    private String mOldSyncMode;
    ...
    private static final class OperationLog {
        ...
        /* synthetic */ OperationLog(OperationLog operationLog) {
            this();
        }
        ...
        private boolean endOperationDeferLogLocked(int cookie) {
            ...
            if (Trace.isTagEnabled(Trace.TRACE_TAG_DATABASE)) {
                Trace.asyncTraceEnd(Trace.TRACE_TAG_DATABASE, operation.getTraceMethodName(), operation.mCookie);
            }
            operation.mEndTime = SystemClock.uptimeMillis();
            operation.mFinished = true;
            return operation.mEndTime - operation.mStartTime >= 500;
        }
    ...
    private static final class PreparedStatement {
        ...
        /* synthetic */ PreparedStatement(PreparedStatement preparedStatement) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.database.sqlite.SQLiteConnection.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.database.sqlite.SQLiteConnection.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.database.sqlite.SQLiteConnection.<clinit>():void");
    }
    ...
    private SQLiteConnection(SQLiteConnectionPool pool, SQLiteDatabaseConfiguration configuration, int connectionId, boolean primaryConnection) {
        ...
        this.mEnableDefaultWALMode = false;
        this.mOldJournalMode = "";
        this.mOldSyncMode = "";
        this.mPool = pool;
        ...
        this.mEnableDefaultWALMode = SystemProperties.getBoolean("persist.sys.sqlite_db_wal", false);
    ...
    private void setWalModeFromConfiguration() {
        if (!this.mConfiguration.isInMemoryDb() && !this.mIsReadOnlyConnection) {
            if ((this.mConfiguration.openFlags & 536870912) != 0) {
                ...
                if (this.mEnableDefaultWALMode) {
                    this.mOldJournalMode = "WAL";
                    this.mOldSyncMode = SQLiteGlobal.getWALSyncMode();
                }
            } else if (this.mEnableDefaultWALMode) {
                this.mOldJournalMode = SQLiteGlobal.getDefaultJournalMode();
                this.mOldSyncMode = SQLiteGlobal.getDefaultSyncMode();
                if (this.mConfiguration.path.endsWith("database_test.db") || this.mConfiguration.path.endsWith("databasetest1") || this.mConfiguration.path.endsWith("databasetest2")) {
                    setJournalMode(this.mOldJournalMode);
                    setSyncMode(this.mOldSyncMode);
                    return;
                }
                setJournalMode("WAL");
                setSyncMode("FULL");
                ...
                try {
                    ...
                    if (oldLocale == null || !oldLocale.equals(newLocale)) {
                        ...
                        try {
                            ...
                            objArr[0] = newLocale;
                            execute("INSERT INTO android_metadata (locale) VALUES(?)", objArr, null);
