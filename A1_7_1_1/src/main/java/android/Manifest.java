...
public final class Manifest {
    ...
    public static final class permission {
        ...
        public static final String ACCESS_EPHEMERAL_APPS = "android.permission.ACCESS_EPHEMERAL_APPS";
        ...
        public static final String ACCESS_MTK_MMHW = "mediatek.permission.ACCESS_MTK_MMHW";
        ...
        public static final String BIND_NOTIFICATION_RANKER_SERVICE = "android.permission.BIND_NOTIFICATION_RANKER_SERVICE";
        ...
        public static final String MANAGE_FACE = "oppo.permission.MANAGE_FACE";
        ...
        public static final String RESET_FACE_LOCKOUT = "oppo.permission.RESET_FACE_LOCKOUT";
        ...
        public static final String USE_FACE = "oppo.permission.USE_FACE";
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.Manifest.permission.<init>():void, dex: 
        ...
        public permission() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.Manifest.permission.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.Manifest.permission.<init>():void");
        }
    }
    ...
    public static final class permission_group {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.Manifest.permission_group.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public permission_group() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.Manifest.permission_group.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.Manifest.permission_group.<init>():void");
        }
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.Manifest.<init>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    public Manifest() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.Manifest.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.Manifest.<init>():void");
    }
}
