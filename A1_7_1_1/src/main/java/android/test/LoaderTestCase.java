...
public class LoaderTestCase extends AndroidTestCase {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.test.LoaderTestCase.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.test.LoaderTestCase.<clinit>():void, dex: 
        */
