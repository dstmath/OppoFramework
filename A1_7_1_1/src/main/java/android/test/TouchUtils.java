...
public class TouchUtils {
    ...
    private static class ViewStateSnapshot {
        ...
        /* synthetic */ ViewStateSnapshot(ViewGroup viewGroup, ViewStateSnapshot viewStateSnapshot) {
            this(viewGroup);
        }
        ...
        public int hashCode() {
            ...
            return ((((((i2 + i) * 31) + this.mFirstTop) * 31) + this.mLastBottom) * 31) + this.mChildCount;
        }
    }
