...
public class MockContentProvider extends ContentProvider {
    ...
    private class InversionIContentProvider implements IContentProvider {
        /* synthetic */ InversionIContentProvider(MockContentProvider this$0, InversionIContentProvider inversionIContentProvider) {
            this();
        }
        ...
        public Cursor query(String callingPackage, Uri url, String[] projection, String selection, String[] selectionArgs, String sortOrder, ICancellationSignal cancellationSignal) throws RemoteException {
            return MockContentProvider.this.query(url, projection, selection, selectionArgs, sortOrder);
        }
