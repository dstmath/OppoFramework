...
public class CdmaCellLocation extends CellLocation {
    ...
    public boolean isEmpty() {
        if ((this.mBaseStationId == -1 || this.mBaseStationId == 0) && this.mBaseStationLatitude == Integer.MAX_VALUE && this.mBaseStationLongitude == Integer.MAX_VALUE && (this.mSystemId == -1 || this.mSystemId == 0)) {
            return this.mNetworkId == -1 || this.mNetworkId == 0;
        } else {
            return false;
        }
    }
