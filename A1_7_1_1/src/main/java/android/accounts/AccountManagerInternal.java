...
public abstract class AccountManagerInternal {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.accounts.AccountManagerInternal.<init>():void, dex: 
    ...
    public AccountManagerInternal() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.accounts.AccountManagerInternal.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.accounts.AccountManagerInternal.<init>():void");
    }
