...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet> {
    ...
    private static final VersionInfo NO_VERSION = null;
    ...
    public enum ComparisonStyle {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.ComparisonStyle.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.ComparisonStyle.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.ComparisonStyle.<clinit>():void");
        }
    }
    ...
    public static class EntryRange {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.EntryRange.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        EntryRange() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.EntryRange.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRange.<init>():void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRange.toString():java.lang.String, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public java.lang.String toString() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRange.toString():java.lang.String, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRange.toString():java.lang.String");
        }
    }

    private class EntryRangeIterable implements Iterable<EntryRange> {
        final /* synthetic */ UnicodeSet this$0;

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.EntryRangeIterable.<init>(android.icu.text.UnicodeSet):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 10 more
            */
        private EntryRangeIterable(android.icu.text.UnicodeSet r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.EntryRangeIterable.<init>(android.icu.text.UnicodeSet):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterable.<init>(android.icu.text.UnicodeSet):void");
        }

        /* synthetic */ EntryRangeIterable(UnicodeSet this$0, EntryRangeIterable entryRangeIterable) {
            this(this$0);
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.UnicodeSet.EntryRangeIterable.iterator():java.util.Iterator<android.icu.text.UnicodeSet$EntryRange>, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e5
            	...
            	... 10 more
            */
        public java.util.Iterator<android.icu.text.UnicodeSet.EntryRange> iterator() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.UnicodeSet.EntryRangeIterable.iterator():java.util.Iterator<android.icu.text.UnicodeSet$EntryRange>, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterable.iterator():java.util.Iterator<android.icu.text.UnicodeSet$EntryRange>");
        }
    }
    ...
    private class EntryRangeIterator implements Iterator<EntryRange> {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.EntryRangeIterator.<init>(android.icu.text.UnicodeSet):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 10 more
            */
        private EntryRangeIterator(android.icu.text.UnicodeSet r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.EntryRangeIterator.<init>(android.icu.text.UnicodeSet):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterator.<init>(android.icu.text.UnicodeSet):void");
        }

        /* synthetic */ EntryRangeIterator(UnicodeSet this$0, EntryRangeIterator entryRangeIterator) {
            this(this$0);
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRangeIterator.hasNext():boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean hasNext() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRangeIterator.hasNext():boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterator.hasNext():boolean");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRangeIterator.next():android.icu.text.UnicodeSet$EntryRange, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public android.icu.text.UnicodeSet.EntryRange next() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.EntryRangeIterator.next():android.icu.text.UnicodeSet$EntryRange, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterator.next():android.icu.text.UnicodeSet$EntryRange");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.text.UnicodeSet.EntryRangeIterator.next():java.lang.Object, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public /* bridge */ /* synthetic */ java.lang.Object next() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.text.UnicodeSet.EntryRangeIterator.next():java.lang.Object, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.EntryRangeIterator.next():java.lang.Object");
        }
    ...
    private static class NumericValueFilter implements Filter {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e7 in method: android.icu.text.UnicodeSet.NumericValueFilter.<init>(double):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e7
            	...
            	... 10 more
            */
        NumericValueFilter(double r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e7 in method: android.icu.text.UnicodeSet.NumericValueFilter.<init>(double):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.NumericValueFilter.<init>(double):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: null in method: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean, dex:  in method: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            	...
            	at jadx.api.JavaClass.decompile(JavaClass.java:62)
            	at jadx.api.JadxDecompiler.lambda$appendSourcesSave$0(JadxDecompiler.java:200)
            Caused by: jadx.core.utils.exceptions.DecodeException: null in method: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean, dex: 
        ...
        public boolean contains(int r1) {
            /*
            // Can't load method instructions: Load method exception: null in method: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean, dex:  in method: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.NumericValueFilter.contains(int):boolean");
        }
    }
    ...
    private static class ScriptExtensionsFilter implements Filter {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e6 in method: android.icu.text.UnicodeSet.ScriptExtensionsFilter.<init>(int):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e6
            	...
            	... 10 more
            */
        ScriptExtensionsFilter(int r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e6 in method: android.icu.text.UnicodeSet.ScriptExtensionsFilter.<init>(int):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.ScriptExtensionsFilter.<init>(int):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.ScriptExtensionsFilter.contains(int):boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean contains(int r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e3 in method: android.icu.text.UnicodeSet.ScriptExtensionsFilter.contains(int):boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.ScriptExtensionsFilter.contains(int):boolean");
        }
    }
    ...
    public enum SpanCondition {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.SpanCondition.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.SpanCondition.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.SpanCondition.<clinit>():void");
        }
    }
    ...
    private static class VersionFilter implements Filter {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.VersionFilter.<init>(android.icu.util.VersionInfo):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 10 more
            */
        VersionFilter(android.icu.util.VersionInfo r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.icu.text.UnicodeSet.VersionFilter.<init>(android.icu.util.VersionInfo):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.VersionFilter.<init>(android.icu.util.VersionInfo):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.UnicodeSet.VersionFilter.contains(int):boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean contains(int r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.UnicodeSet.VersionFilter.contains(int):boolean, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.VersionFilter.contains(int):boolean");
        }
    }

    public static abstract class XSymbolTable implements SymbolTable {
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.XSymbolTable.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public XSymbolTable() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.UnicodeSet.XSymbolTable.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.XSymbolTable.<init>():void");
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.text.UnicodeSet.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.text.UnicodeSet.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.icu.text.UnicodeSet.<clinit>():void");
    }
    ...
    public UnicodeSet applyPattern(String pattern, ParsePosition pos, SymbolTable symbols, int options) {
        ...
        if (pos == null) {
            parsePositionWasNull = true;
        } else {
            parsePositionWasNull = false;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:131:0x0319  */
    /* JADX WARNING: Removed duplicated region for block: B:75:0x01d5  */
    /* JADX WARNING: Removed duplicated region for block: B:76:0x01d7  */
    /* JADX WARNING: Removed duplicated region for block: B:162:0x0400  */
    ...
    /* JADX WARNING: Missing block: B:7:0x0029, code:
            if (r0 > r12.buffer[r7 - 1]) goto L_0x003f;
     */
    /* JADX WARNING: Missing block: B:8:0x002b, code:
            r6 = r7 - 1;
            r0 = max(r12.list[r3], r12.buffer[r6]);
     */
    /* JADX WARNING: Missing block: B:9:0x0039, code:
            r2 = r3 + 1;
            r15 = r15 ^ 1;
            r4 = r5;
     */
    ...
    /* JADX WARNING: Missing block: B:14:0x0054, code:
            if (r1 > r12.buffer[r7 - 1]) goto L_0x0068;
     */
    ...
    /* JADX WARNING: Missing block: B:28:0x00b8, code:
            if (r0 == 1114112) goto L_0x0073;
     */
    /* JADX WARNING: Missing block: B:29:0x00ba, code:
            r6 = r7 + 1;
            r12.buffer[r7] = r0;
     */
     ...
     */
    /* JADX WARNING: Missing block: B:36:0x00ee, code:
            r4 = r5 + 1;
            r1 = r13[r5];
            r15 = r15 ^ 2;
            r6 = r7;
     ...
     */
    /* JADX WARNING: Missing block: B:40:0x010d, code:
            r6 = r7 + 1;
            r12.buffer[r7] = r1;
            r4 = r5 + 1;
            r1 = r13[r5];
            ...
            r2 = r3;
     */
    /* JADX WARNING: Missing block: B:41:0x011c, code:
            if (r0 >= r1) goto L_0x012a;
     */
    /* JADX WARNING: Missing block: B:42:0x011e, code:
            r2 = r3 + 1;
            r0 = r12.list[r3];
            r15 = r15 ^ 1;
            r6 = r7;
            r4 = r5;
     */
    /* JADX WARNING: Missing block: B:43:0x012a, code:
            if (r0 == 1114112) goto L_0x0073;
     */
    /* JADX WARNING: Missing block: B:44:0x012c, code:
            r2 = r3 + 1;
            r0 = r12.list[r3];
            r15 = r15 ^ 1;
            r4 = r5 + 1;
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0015: SWITCH  (r15_1 'polarity' int) k:[0, 1, 2, 3] t:[0x001f, 0x00d9, 0x010b, 0x00b6] in method: android.icu.text.UnicodeSet.add(int[], int, int):android.icu.text.UnicodeSet, dex: 
...
*/
    ...
    /* JADX WARNING: Missing block: B:11:0x004d, code:
            ...
            r15 = r15 ^ 2;
     */
    /* JADX WARNING: Missing block: B:12:0x0062, code:
    ...
    /* JADX WARNING: Missing block: B:15:0x0076, code:
            ...
            r2 = r3;
     */
    /* JADX WARNING: Missing block: B:16:0x0084, code:
            if (r0 == 1114112) goto L_0x0039;
     */
    ...
    /* JADX WARNING: Missing block: B:19:0x009d, code:
            ...
            r4 = r5;
     */
    /* JADX WARNING: Missing block: B:20:0x00a9, code:
            if (r1 >= r0) goto L_0x00ba;
     */
    /* JADX WARNING: Missing block: B:21:0x00ab, code:
            r6 = r7 + 1;
            r12.buffer[r7] = r1;
            r4 = r5 + 1;
            r1 = r13[r5];
            ...
            r2 = r3;
     */
    /* JADX WARNING: Missing block: B:22:0x00ba, code:
            if (r0 == 1114112) goto L_0x0039;
     */
    /* JADX WARNING: Missing block: B:23:0x00bc, code:
            r2 = r3 + 1;
            r0 = r12.list[r3];
            r15 = r15 ^ 1;
            r4 = r5 + 1;
     ...
     */
    /* JADX WARNING: Missing block: B:25:0x00cf, code:
            r4 = r5 + 1;
            r1 = r13[r5];
            r15 = r15 ^ 2;
            r6 = r7;
            r2 = r3;
     */
    /* JADX WARNING: Missing block: B:26:0x00d9, code:
            if (r0 >= r1) goto L_0x00ec;
     */
    /* JADX WARNING: Missing block: B:27:0x00db, code:
            r6 = r7 + 1;
            r12.buffer[r7] = r0;
            r2 = r3 + 1;
            r0 = r12.list[r3];
            ...
            r4 = r5;
     */
    /* JADX WARNING: Missing block: B:28:0x00ec, code:
            if (r0 == 1114112) goto L_0x0039;
     */
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0015: SWITCH  (r15_1 'polarity' int) k:[0, 1, 2, 3] t:[0x001f, 0x009b, 0x00cd, 0x0062] in method: android.icu.text.UnicodeSet.retain(int[], int, int):android.icu.text.UnicodeSet, dex: 
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:228)
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:205)
	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:100)
	at jadx.core.codegen.RegionGen.makeRegion(RegionGen.java:50)
...
*/
    ...
    public UnicodeSet applyPropertyAlias(String propertyAlias, String valueAlias, SymbolTable symbols) {
        ...
        if (valueAlias.length() > 0) {
            ...
            if ((p < 0 || p >= 57) && ((p < 4096 || p >= UProperty.INT_LIMIT) && (p < 8192 || p >= UProperty.MASK_LIMIT))) {
                switch (p) {
                    case 12288:
        ...
        if ((attribute & 6) != 0) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if ((attribute & 2) != 0) {
                    ...
                    for (cp = start; cp <= end; cp++) {
                        addCaseMapping(foldSet, csp.toFullLower(cp, null, full, root, locCache), full);
                        addCaseMapping(foldSet, csp.toFullTitle(cp, null, full, root, locCache), full);
                        addCaseMapping(foldSet, csp.toFullUpper(cp, null, full, root, locCache), full);
    ...
    public UnicodeSet cloneAsThawed() {
        UnicodeSet result = new UnicodeSet(this);
        if (!f6-assertionsDisabled) {
            if ((result.isFrozen() ? null : 1) == null) {
                throw new AssertionError();
            }
        }
        return result;
    ...
    public final <T extends CharSequence> boolean containsSome(Iterable<T> collection) {
        return !containsNone((Iterable) collection);
    }
    ...
    public int compareTo(UnicodeSet o, ComparisonStyle style) {
        ...
        int i4 = 0;
        while (true) {
            int result = this.list[i4] - o.list[i4];
            if (result != 0) {
                if (this.list[i4] == 1114112) {
                    if (this.strings.isEmpty()) {
                        return 1;
                    }
                    return compare((String) this.strings.first(), o.list[i4]);
                } else if (o.list[i4] != 1114112) {
                    if ((i4 & 1) != 0) {
                        result = -result;
                    }
                    return result;
                    ...
                    return -compare((String) o.strings.first(), this.list[i4]);
                }
            } else if (this.list[i4] == 1114112) {
