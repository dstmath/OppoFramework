...
public final class AlphabeticIndex<V> implements Iterable<Bucket<V>> {
    ...
    public static class Bucket<V> implements Iterable<Record<V>> {
        ...
        public enum LabelType {
            ...
            /*  JADX ERROR: Method load error
                jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.AlphabeticIndex.Bucket.LabelType.<clinit>():void, dex: 
            ...
            static {
                /*
                // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.AlphabeticIndex.Bucket.LabelType.<clinit>():void, dex: 
                */
    ...
    public static class Record<V> {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.-get0(android.icu.text.AlphabeticIndex$Record):java.lang.CharSequence, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            */
        /* renamed from: -get0 */
        static /* synthetic */ java.lang.CharSequence m57-get0(android.icu.text.AlphabeticIndex.Record r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.-get0(android.icu.text.AlphabeticIndex$Record):java.lang.CharSequence, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.AlphabeticIndex.Record.-get0(android.icu.text.AlphabeticIndex$Record):java.lang.CharSequence");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.icu.text.AlphabeticIndex.Record.<init>(java.lang.CharSequence, java.lang.Object):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 6 more
            */
        private Record(java.lang.CharSequence r1, V r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.icu.text.AlphabeticIndex.Record.<init>(java.lang.CharSequence, java.lang.Object):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.AlphabeticIndex.Record.<init>(java.lang.CharSequence, java.lang.Object):void");
        }
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.getData():V, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public V getData() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.getData():V, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.AlphabeticIndex.Record.getData():V");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.getName():java.lang.CharSequence, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public java.lang.CharSequence getName() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.getName():java.lang.CharSequence, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.AlphabeticIndex.Record.getName():java.lang.CharSequence");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.toString():java.lang.String, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public java.lang.String toString() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.icu.text.AlphabeticIndex.Record.toString():java.lang.String, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.text.AlphabeticIndex.Record.toString():java.lang.String");
        }
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.text.AlphabeticIndex.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.text.AlphabeticIndex.<clinit>():void, dex: 
        */
    ...
    private AlphabeticIndex(ULocale locale, RuleBasedCollator collator) {
        this.recordComparator = new Comparator<Record<V>>() {
            public int compare(Record<V> o1, Record<V> o2) {
                return AlphabeticIndex.this.collatorOriginal.compare((Object) Record.m57-get0(o1), (Object) Record.m57-get0(o2));
            }
        };
    ...
    private boolean addChineseIndexCharacters() {
        ...
        try {
            ...
            for (String s : contractions) {
                if (f89-assertionsDisabled || s.startsWith(BASE)) {
        ...
        if (this.buckets == null) {
            ...
            if (this.inputList != null && !this.inputList.isEmpty()) {
                ...
                for (Record<V> r : this.inputList) {
                    while (upperBoundary != null && this.collatorPrimaryOnly.compare((Object) Record.m57-get0(r), (Object) upperBoundary) >= 0) {
