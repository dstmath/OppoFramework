...
public abstract class FilteredBreakIteratorBuilder {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.text.FilteredBreakIteratorBuilder.<init>():void, dex: 
    ...
    protected FilteredBreakIteratorBuilder() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.text.FilteredBreakIteratorBuilder.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.icu.text.FilteredBreakIteratorBuilder.<init>():void");
    }
