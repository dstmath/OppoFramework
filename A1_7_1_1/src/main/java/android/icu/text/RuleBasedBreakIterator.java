...
public class RuleBasedBreakIterator extends BreakIterator {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.text.RuleBasedBreakIterator.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.text.RuleBasedBreakIterator.<clinit>():void, dex: 
        */
            ...
            if (current < rangeEnd && (category & 16384) == 0) {
                ...
                if (lbe != null) {
                    ...
                    if (!f43-assertionsDisabled) {
                        if ((this.fText.getIndex() > startingIdx ? 1 : null) == null) {
    ...
    private int handleNext(short[] stateTable) {
        ...
        while (state != 0) {
            ...
            } else if (stateTable[row + 0] != (short) 0) {
                lookaheadStatus = 0;
            }
        }
        if (result != initialPosition) {
    ...
    private int handlePrevious(short[] stateTable) {
        ...
        while (true) {
            ...
            if (stateTable[row + 1] != (short) 0) {
                ...
                lookaheadStatus = stateTable[row + 1];
            } else if (!(stateTable[row + 0] == (short) 0 || lookAheadHardBreak)) {
                lookaheadStatus = 0;
            }
            if (state == 0) {
                break;
