...
public final class RuleBasedCollator extends Collator {
    ...
    static final /* synthetic */ boolean f88-assertionsDisabled = false;
    ...
    private static final class CollationBuffer {
        ...
        /* synthetic */ CollationBuffer(CollationData data, CollationBuffer collationBuffer) {
            this(data);
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.text.RuleBasedCollator.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.text.RuleBasedCollator.<clinit>():void, dex: 
        */
    ...
    private final void internalBuildTailoring(String rules) throws Exception {
        ...
        try {
            ...
            clsArr[0] = CollationTailoring.class;
            Constructor constructor = builderClass.getConstructor(clsArr);
            Object[] objArr = new Object[1];
            objArr[0] = base;
            Object builder = constructor.newInstance(objArr);
            Class[] clsArr2 = new Class[1];
            clsArr2[0] = String.class;
            Method parseAndBuild = builderClass.getMethod("parseAndBuild", clsArr2);
            Object[] objArr2 = new Object[1];
            objArr2[0] = rules;
            CollationTailoring t = (CollationTailoring) parseAndBuild.invoke(builder, objArr2);
            t.actualLocale = null;
            adoptTailoring(t);
    ...
    void setLocale(ULocale valid, ULocale actual) {
        ...
        if (Utility.objectEquals(actual, this.tailoring.actualLocale)) {
            this.actualLocaleIsSameAsValid = false;
        } else if (f88-assertionsDisabled || Utility.objectEquals(actual, valid)) {
