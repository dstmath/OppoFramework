...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    /* renamed from: -android-icu-util-Calendar$CalTypeSwitchesValues */
    private static final /* synthetic */ int[] f54-android-icu-util-Calendar$CalTypeSwitchesValues = null;
    ...
    private enum CalType {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.util.Calendar.CalType.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.util.Calendar.CalType.<clinit>():void, dex: 
            */
    ...
    /* renamed from: -getandroid-icu-util-Calendar$CalTypeSwitchesValues */
    private static /* synthetic */ int[] m54-getandroid-icu-util-Calendar$CalTypeSwitchesValues() {
        if (f54-android-icu-util-Calendar$CalTypeSwitchesValues != null) {
            return f54-android-icu-util-Calendar$CalTypeSwitchesValues;
        }
        ...
        f54-android-icu-util-Calendar$CalTypeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.util.Calendar.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.util.Calendar.<clinit>():void, dex: 
        */
    ...
    private static Calendar createInstance(ULocale locale) {
        ...
        Calendar cal;
        switch (m54-getandroid-icu-util-Calendar$CalTypeSwitchesValues()[calType.ordinal()]) {
            case 1:
    ...
    public final int getRelatedYear() {
        ...
        switch (m54-getandroid-icu-util-Calendar$CalTypeSwitchesValues()[type.ordinal()]) {
            case 2:
                return year - 2637;
            case 3:
                return year + 284;
    ...
    private static DateFormat formatHelper(Calendar cal, ULocale loc, int dateStyle, int timeStyle) {
        if (timeStyle < -1 || timeStyle > 3) {
            ...
            if (timeStyle >= 0 && dateStyle >= 0) {
                ...
                objArr[0] = patternData.patterns[timeStyle];
                objArr[1] = patternData.patterns[dateStyle + 4];
    ...
    private static WeekData getWeekDataForRegionInternal(String region) {
        ...
        UResourceBundle weekDataInfo = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "supplementalData", ICUResourceBundle.ICU_DATA_CLASS_LOADER).get("weekData");
        try {
    ...
    protected void computeTime() {
        ...
        if (this.stamp[15] >= 2 || this.stamp[16] >= 2) {
            ...
            if (zoneOffset == this.zone.getOffset(tmpTime)) {
                ...
                if (!f55-assertionsDisabled) {
                    if ((this.skippedWallTime == 2 ? 1 : null) == null) {
    ...
    protected int computeZoneOffset(long millis, int millisInDay) {
        ...
        if (this.zone instanceof BasicTimeZone) {
            ...
            if (this.repeatedWallTime == 1) {
                ...
                if (!f55-assertionsDisabled) {
                    if ((offsetDelta < -21600000 ? 1 : null) == null) {
