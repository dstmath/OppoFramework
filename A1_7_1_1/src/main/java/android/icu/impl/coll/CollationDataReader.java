...
final class CollationDataReader {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.coll.CollationDataReader.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.coll.CollationDataReader.<clinit>():void, dex: 
        */
        ...
        if (base == null || base.getUCAVersion() == tailoring.getUCAVersion()) {
            ...
            if (length < 4) {
                ...
                if (!f73-assertionsDisabled) {
                    if ((reorderRangesLength < reorderCodesLength ? 1 : null) == null) {
