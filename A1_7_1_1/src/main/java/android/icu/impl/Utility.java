...
public final class Utility {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Utility.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Utility.<clinit>():void, dex: 
        */
    ...
    public static final byte[] RLEStringToByteArray(String s) {
        ...
        int ai = 0;
        int i = 2;
        while (ai < length && i < stringLength) {
            int i2;
            byte b;
            int ai2;
            if (nextChar) {
