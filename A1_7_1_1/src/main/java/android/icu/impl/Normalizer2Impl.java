...
public final class Normalizer2Impl {
    ...
    public static final class Hangul {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.Hangul.<init>():void, dex: 
        ...
        public Hangul() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.Hangul.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.impl.Normalizer2Impl.Hangul.<init>():void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.Hangul.getRawDecomposition(int, java.lang.Appendable):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 0073
            	...
            	... 10 more
            */
        public static void getRawDecomposition(int r1, java.lang.Appendable r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.Hangul.getRawDecomposition(int, java.lang.Appendable):void, dex: 
            */
    ...
    public static final class UTF16Plus {
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.UTF16Plus.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public UTF16Plus() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.UTF16Plus.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.icu.impl.Normalizer2Impl.UTF16Plus.<init>():void");
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.icu.impl.Normalizer2Impl.<clinit>():void, dex: 
        */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:106:0x0210  */
    ...
    public boolean hasCompBoundaryAfter(int c, boolean onlyContiguous, boolean testInert) {
        ...
        while (true) {
            ...
            if (isDecompNoAlgorithmic(norm16)) {
                ...
                if ((firstUnit & 32) != 0) {
                    z = false;
                } else if (onlyContiguous && firstUnit > Opcodes.OP_CHECK_CAST_JUMBO) {
                    z = false;
                }
                return z;
            }
