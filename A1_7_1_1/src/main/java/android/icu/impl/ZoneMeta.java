...
public final class ZoneMeta {
    /* renamed from: -android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues */
    private static final /* synthetic */ int[] f31-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues = null;
    ...
    private static class CustomTimeZoneCache extends SoftCache<Integer, SimpleTimeZone, int[]> {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.ZoneMeta.CustomTimeZoneCache.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.ZoneMeta.CustomTimeZoneCache.<clinit>():void, dex: 
            */
        ...
        protected SimpleTimeZone createInstance(Integer key, int[] data) {
            ...
            if (!f33-assertionsDisabled) {
                i = (data[1] < 0 || data[1] > 23) ? 0 : 1;
                if (i == 0) {
                    throw new AssertionError();
                }
            }
            if (!f33-assertionsDisabled) {
                i = (data[2] < 0 || data[2] > 59) ? 0 : 1;
                if (i == 0) {
                    throw new AssertionError();
                }
            }
            if (!f33-assertionsDisabled) {
                i = (data[3] < 0 || data[3] > 59) ? 0 : 1;
                if (i == 0) {
                    throw new AssertionError();
                }
            }
            ...
            SimpleTimeZone tz = new SimpleTimeZone((data[0] * ((((data[1] * 60) + data[2]) * 60) + data[3])) * 1000, ZoneMeta.formatCustomID(i2, i3, i4, z));
            tz.freeze();
            return tz;
        }
    }
    ...
    /* renamed from: -getandroid-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues */
    private static /* synthetic */ int[] m10-getandroid-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues() {
        if (f31-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues != null) {
            return f31-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues;
        }
        ...
        f31-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.ZoneMeta.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.ZoneMeta.<clinit>():void, dex: 
        */
    ...
    public static Set<String> getAvailableIDs(SystemTimeZoneType type, String region, Integer rawOffset) {
        Set<String> baseSet;
        switch (m10-getandroid-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues()[type.ordinal()]) {
            case 1:
    ...
    private static synchronized String[] getZoneIDs() {
        ...
        synchronized (ZoneMeta.class) {
            if (ZONEIDS == null) {
                try {
                    ZONEIDS = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER).getStringArray(kNAMES);
                } catch (MissingResourceException e) {
                }
            }
            if (ZONEIDS == null) {
        ...
        if (canonical == null) {
            ...
            if (canonical == null) {
                try {
                    ...
                    if (zoneIdx >= 0) {
                        UResourceBundle zone = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER).get(kZONES).get(zoneIdx);
                        if (zone.getType() == 7) {
    ...
    public static String getRegion(String tzid) {
        ...
        if (region == null) {
            ...
            if (zoneIdx >= 0) {
                try {
                    UResourceBundle regions = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER).get(kREGIONS);
    ...
    public static String getCanonicalCountry(String tzid, Output<Boolean> isPrimary) {
        ...
        if (singleZone.booleanValue()) {
            ...
            try {
                String primaryZone = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "metaZones").get("primaryZones").getString(country);
    ...
    private static String getShortIDFromCanonical(String canonicalID) {
        String shortID = null;
        try {
            return UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "keyTypeData", ICUResourceBundle.ICU_DATA_CLASS_LOADER).get("typeMap").get("timezone").getString(canonicalID.replace('/', ':'));
        } catch (MissingResourceException e) {
            return shortID;
        }
    }
