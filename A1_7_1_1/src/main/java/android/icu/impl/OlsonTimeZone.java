...
public class OlsonTimeZone extends BasicTimeZone {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.OlsonTimeZone.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.icu.impl.OlsonTimeZone.<clinit>():void, dex: 
        */
            ...
            synchronized (this) {
                if (this.canonicalID == null) {
                    ...
                    if (!f26-assertionsDisabled) {
                        if ((this.canonicalID != null ? 1 : null) == null) {
    ...
    public TimeZoneRule[] getTimeZoneRules() {
        ...
        if (this.finalZone != null) {
            if (this.finalZone.useDaylightTime()) {
                ...
                rules[idx2] = new TimeArrayTimeZoneRule(str, rawOffset, 0, jArr, 2);
                idx2 = idx;
            }
        }
        return rules;
