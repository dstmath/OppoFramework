...
public class Allocation extends BaseObj {
    ...
    private static final /* synthetic */ int[] f19-android-graphics-Bitmap$ConfigSwitchesValues = null;
    ...
    public enum MipmapControl {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.renderscript.Allocation.MipmapControl.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.renderscript.Allocation.MipmapControl.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.renderscript.Allocation.MipmapControl.<clinit>():void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e6 in method: android.renderscript.Allocation.MipmapControl.<init>(java.lang.String, int, int):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e6
            	...
            	... 10 more
            */
        private MipmapControl(int r3) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e6 in method: android.renderscript.Allocation.MipmapControl.<init>(java.lang.String, int, int):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.renderscript.Allocation.MipmapControl.<init>(java.lang.String, int, int):void");
        }
    }
    ...
    private static /* synthetic */ int[] m221-getandroid-graphics-Bitmap$ConfigSwitchesValues() {
        if (f19-android-graphics-Bitmap$ConfigSwitchesValues != null) {
            return f19-android-graphics-Bitmap$ConfigSwitchesValues;
        }
        ...
        f19-android-graphics-Bitmap$ConfigSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00eb in method: android.renderscript.Allocation.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00eb in method: android.renderscript.Allocation.<clinit>():void, dex: 
        */
    ...
    public void syncAll(int srcLocation) {
        try {
            Trace.traceBegin(131072, "syncAll");
            switch (srcLocation) {
                case 1:
                case 2:
    ...
    public void ioSend() {
        try {
            Trace.traceBegin(131072, "ioSend");
            if ((this.mUsage & 64) == 0) {
    ...
    public void ioReceive() {
        try {
            Trace.traceBegin(131072, "ioReceive");
            if ((this.mUsage & 32) == 0) {
    ...
    public void copyFrom(BaseObj[] d) {
        try {
            Trace.traceBegin(131072, "copyFrom");
            this.mRS.validate();
            validateIsObject();
    ...
    private void validateBitmapFormat(Bitmap b) {
        ...
        switch (m221-getandroid-graphics-Bitmap$ConfigSwitchesValues()[bc.ordinal()]) {
            case 1:
    ...
    private void copyFromUnchecked(Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copyFromUnchecked");
            this.mRS.validate();
    ...
    public void copyFrom(Bitmap b) {
        try {
            ...
            if (b.getConfig() == null) {
                ...
                new Canvas(newBitmap).drawBitmap(b, (float) TonemapCurve.LEVEL_BLACK, (float) TonemapCurve.LEVEL_BLACK, null);
                copyFrom(newBitmap);
                return;
            }
    ...
    private void copy1DRangeFromUnchecked(int off, int count, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy1DRangeFromUnchecked");
    ...
    public void copy1DRangeFrom(int off, int count, Allocation data, int dataOff) {
        Trace.traceBegin(131072, "copy1DRangeFrom");
        int i = off;
        int i2 = count;
        int i3 = dataOff;
    ...
    void copy2DRangeFromUnchecked(int xoff, int yoff, int w, int h, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy2DRangeFromUnchecked");
            this.mRS.validate();
    ...
    public void copy2DRangeFrom(int xoff, int yoff, int w, int h, Object array) {
        try {
            Trace.traceBegin(131072, "copy2DRangeFrom");
    ...
    public void copy2DRangeFrom(int xoff, int yoff, Bitmap data) {
        try {
            ...
            if (data.getConfig() == null) {
                ...
                new Canvas(newBitmap).drawBitmap(data, (float) TonemapCurve.LEVEL_BLACK, (float) TonemapCurve.LEVEL_BLACK, null);
    ...
    private void copy3DRangeFromUnchecked(int xoff, int yoff, int zoff, int w, int h, int d, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy3DRangeFromUnchecked");
            this.mRS.validate();
    ...
    public void copy3DRangeFrom(int xoff, int yoff, int zoff, int w, int h, int d, Object array) {
        try {
            Trace.traceBegin(131072, "copy3DRangeFrom");
    ...
    public void copyTo(Bitmap b) {
        try {
            Trace.traceBegin(131072, "copyTo");
            this.mRS.validate();
            validateBitmapFormat(b);
            validateBitmapSize(b);
    ...
    private void copy1DRangeToUnchecked(int off, int count, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy1DRangeToUnchecked");
            int dataSize = this.mType.mElement.getBytesSize() * count;
            boolean usePadding = false;
            if (this.mAutoPadding && this.mType.getElement().getVectorSize() == 3) {
                usePadding = true;
    ...
    void copy2DRangeToUnchecked(int xoff, int yoff, int w, int h, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy2DRangeToUnchecked");
            this.mRS.validate();
            validate2DRange(xoff, yoff, w, h);
            int dataSize = (this.mType.mElement.getBytesSize() * w) * h;
            boolean usePadding = false;
    ...
    private void copy3DRangeToUnchecked(int xoff, int yoff, int zoff, int w, int h, int d, Object array, DataType dt, int arrayLen) {
        try {
            Trace.traceBegin(131072, "copy3DRangeToUnchecked");
            this.mRS.validate();
            validate3DRange(xoff, yoff, zoff, w, h, d);
            int dataSize = ((this.mType.mElement.getBytesSize() * w) * h) * d;
            boolean usePadding = false;
    ...
    public static Allocation createTyped(RenderScript rs, Type type, MipmapControl mips, int usage) {
        try {
            Trace.traceBegin(131072, "createTyped");
            rs.validate();
            if (type.getID(rs) == 0) {
    ...
    public static Allocation createSized(RenderScript rs, Element e, int count, int usage) {
        try {
            Trace.traceBegin(131072, "createSized");
            rs.validate();
    ...
    public static Allocation createFromBitmap(RenderScript rs, Bitmap b, MipmapControl mips, int usage) {
        try {
            Trace.traceBegin(131072, "createFromBitmap");
            rs.validate();
            if (b.getConfig() != null) {
    ...
    public static Allocation[] createAllocations(RenderScript rs, Type t, int usage, int numAlloc) {
        try {
            Trace.traceBegin(131072, "createAllocations");
            rs.validate();
            if (t.getID(rs) == 0) {
                throw new RSInvalidStateException("Bad Type");
            }
    ...
    static Allocation createFromAllocation(RenderScript rs, Allocation alloc) {
        try {
            Trace.traceBegin(131072, "createFromAllcation");
            rs.validate();
            if (alloc.getID(rs) == 0) {
