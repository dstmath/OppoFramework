...
public final class ParcelableCall implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.telecom.ParcelableCall.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.telecom.ParcelableCall.<clinit>():void, dex: 
        */
    ...
    public String toString() {
        ...
        objArr[0] = this.mId;
        objArr[1] = this.mParentCallId;
        objArr[2] = this.mChildCallIds;
        objArr[3] = Integer.valueOf(this.mHandlePresentation);
        objArr[4] = this.mVideoCallProvider;
        objArr[5] = Integer.valueOf(this.mVideoState);
        return String.format("[%s, parent:%s, children:%s, handlePresentation:%s,videoCallProvider:%s, videoState:%s]", objArr);
    }
}
