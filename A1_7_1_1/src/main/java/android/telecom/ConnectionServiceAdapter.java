...
final class ConnectionServiceAdapter implements DeathRecipient {
    ...
    void addAdapter(IConnectionServiceAdapter adapter) {
        ...
        if (this.mAdapters.add(adapter)) {
            try {
                ...
                Log.e((Object) this, e, "addAdapter catch Exception trying to linkToDeath!", new Object[0]);
    ...
    void queryRemoteConnectionServices(RemoteServiceCallback callback) {
        Log.d((Object) this, "queryRemoteConnectionServices mAdapters.size() = " + this.mAdapters.size(), new Object[0]);
    ...
    void handleCreateConferenceComplete(String conferenceId, ConnectionRequest request, ParcelableConference conference) {
        Log.v((Object) this, "handleCreateConferenceComplete: %s, %s", conferenceId, conference);
        for (IConnectionServiceAdapter adapter : this.mAdapters) {
            try {
