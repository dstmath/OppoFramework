...
public final class InCallAdapter {
    ...
    public void startVoiceRecording() {
        try {
            this.mAdapter.startVoiceRecording();
        } catch (RemoteException e) {
        }
    }
    ...
    public void stopVoiceRecording() {
        try {
            this.mAdapter.stopVoiceRecording();
        } catch (RemoteException e) {
        }
    }
    ...
    public void setSortedIncomingCallList(List<String> list) {
        try {
            this.mAdapter.setSortedIncomingCallList(list);
        } catch (RemoteException e) {
        }
    }
    ...
    public void explicitCallTransfer(String callId) {
        try {
            this.mAdapter.explicitCallTransfer(callId);
        } catch (RemoteException e) {
        }
    }
    ...
    public void explicitCallTransfer(String callId, String number, int type) {
        try {
            this.mAdapter.blindAssuredEct(callId, number, type);
        } catch (RemoteException e) {
        }
    }
    ...
    public void hangupAllHoldCalls() {
        try {
            this.mAdapter.hangupAllHoldCalls();
        } catch (RemoteException e) {
        }
    }
    ...
    public void hangupActiveAndAnswerWaiting() {
        try {
            this.mAdapter.hangupActiveAndAnswerWaiting();
        } catch (RemoteException e) {
        }
    }
    ...
    public void updatePowerForSmartBook(boolean onOff) {
        try {
            this.mAdapter.updatePowerForSmartBook(onOff);
        } catch (RemoteException e) {
        }
    }
    ...
    public void inviteConferenceParticipants(String conferenceCallId, List<String> numbers) {
        try {
            this.mAdapter.inviteConferenceParticipants(conferenceCallId, numbers);
        } catch (RemoteException e) {
        }
    }
}
