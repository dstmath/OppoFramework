...
public class TelecomManager {
    ...
    public String getSystemDialerPackage() {
        try {
            if (isServiceConnected()) {
                ...
                Slog.wtf(TAG, "TelecomService disappear unexpected!!! mTelecomServiceOverride = " + this.mTelecomServiceOverride + ", Context.getSystemService: " + this.mContext.getSystemService("telecom") + ", ServiceManager.getService: " + ServiceManager.getService("telecom"), new Throwable());
                return null;
            }
        } catch (RemoteException e) {
    ...
    public boolean isInVideoCall() {
        try {
            if (isServiceConnected()) {
                return getTelecomService().isInVideoCall(this.mContext.getOpPackageName());
            }
        } catch (RemoteException e) {
