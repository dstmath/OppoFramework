...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public OppoExtraConfiguration mOppoExtraConfiguration;
    public int mcc;
    public int mnc;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.res.Configuration.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.res.Configuration.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.res.Configuration.<clinit>():void");
    }

    /* synthetic */ Configuration(Parcel source, Configuration configuration) {
        this(source);
    }
    ...
    public Configuration() {
        this.mOppoExtraConfiguration = null;
    ...
    public static boolean needNewResources(int configChanges, int interestingChanges) {
        if (((1073741824 | interestingChanges) & configChanges) == 0) {
            return OppoExtraConfiguration.needNewResources(configChanges);
        }
        return true;
    }
    ...
    public static String resourceQualifierString(Configuration config) {
        ...
        switch (config.screenLayout & 15) {
            case 1:
                ...
                break;
            case 2:
                parts.add(Parameters.CAPTURE_MODE_NORMAL);
                break;
            case 3:
                parts.add("large");
                break;
        ...
        return TextUtils.join(Aas.ENCODE_SYMBOL, parts);
    }
