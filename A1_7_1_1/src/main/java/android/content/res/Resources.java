...
public class Resources {
    ...
    public final class Theme {
        ...
        /* synthetic */ Theme(Resources this$0, Theme theme) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.res.Resources.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.res.Resources.<clinit>():void, dex: 
        */
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Suying.You@Plf.SDK : Modify for rom theme. Modify the packagename of the third party, and decompress the zipFile of data/string ", property = OppoRomType.ROM)
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "YaoJun.Luo@Plf.SDK : Add for rom theme.  ConvertIcon; Xiaokang.Feng@Plf.SDK : Add for rom ConvertIcon", property = OppoRomType.ROM)
