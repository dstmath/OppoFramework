...
public class RestrictionEntry implements Parcelable {
    public static final Creator<RestrictionEntry> CREATOR = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.RestrictionEntry.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.RestrictionEntry.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.RestrictionEntry.<clinit>():void");
    }
