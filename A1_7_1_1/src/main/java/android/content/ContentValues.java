...
public final class ContentValues implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.ContentValues.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.ContentValues.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.ContentValues.<clinit>():void");
    }

    /* synthetic */ ContentValues(HashMap values, ContentValues contentValues) {
        this(values);
    }
