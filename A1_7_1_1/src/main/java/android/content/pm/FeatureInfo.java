...
public class FeatureInfo implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.pm.FeatureInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.pm.FeatureInfo.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.pm.FeatureInfo.<clinit>():void");
    }

    /* synthetic */ FeatureInfo(Parcel source, FeatureInfo featureInfo) {
        this(source);
    }
