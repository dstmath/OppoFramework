...
public class ServiceInfo extends ComponentInfo implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.content.pm.ServiceInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.content.pm.ServiceInfo.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.pm.ServiceInfo.<clinit>():void");
    }

    /* synthetic */ ServiceInfo(Parcel source, ServiceInfo serviceInfo) {
        this(source);
    }
