...
public abstract class PackageManager {
    ...
    public static final int FIND_BOTH_LIBRARIES = 110;
    ...
    public static class LegacyPackageInstallObserver extends PackageInstallObserver {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.content.pm.PackageManager.LegacyPackageInstallObserver.<init>(android.content.pm.IPackageInstallObserver):void, dex: 
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e8
            	...
            	... 10 more
            */
        public LegacyPackageInstallObserver(android.content.pm.IPackageInstallObserver r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.content.pm.PackageManager.LegacyPackageInstallObserver.<init>(android.content.pm.IPackageInstallObserver):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.content.pm.PackageManager.LegacyPackageInstallObserver.<init>(android.content.pm.IPackageInstallObserver):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.content.pm.PackageManager.LegacyPackageInstallObserver.onPackageInstalled(java.lang.String, int, java.lang.String, android.os.Bundle):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
            ...
            Caused by: java.lang.IllegalArgumentException: bogus opcode: 00e5
            	...
            	... 10 more
            */
        public void onPackageInstalled(java.lang.String r1, int r2, java.lang.String r3, android.os.Bundle r4) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.content.pm.PackageManager.LegacyPackageInstallObserver.onPackageInstalled(java.lang.String, int, java.lang.String, android.os.Bundle):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.content.pm.PackageManager.LegacyPackageInstallObserver.onPackageInstalled(java.lang.String, int, java.lang.String, android.os.Bundle):void");
        }
    }
    ...
    public abstract void addDisallowUninstallApps(List<String> list);

    public abstract void addInstallPackageBlacklist(int i, List<String> list);

    public abstract void addInstallPackageWhitelist(int i, List<String> list);

    public abstract void addInstallSource(String str);
    ...
    public abstract int checkAPKSignatures(String str);

    public abstract void checkEMMApkRuntimePermission(ComponentName componentName) throws SecurityException;
    ...
    public abstract void deleteInstallSource(String str);
    ...
    public abstract void enableInstallSource(boolean z);
    ...
    public abstract Drawable getActivityIconCache(ComponentName componentName) throws NameNotFoundException;

    public abstract Map getActivityIconsCache(IPackageDeleteObserver iPackageDeleteObserver);
    ...
    public abstract Bitmap getAppIconBitmap(String str);

    public abstract Map getAppIconsCache(boolean z);
    ...
    public abstract Drawable getApplicationIconCache(ApplicationInfo applicationInfo);

    public abstract Drawable getApplicationIconCache(String str) throws NameNotFoundException;

    @Deprecated
    public abstract Drawable getApplicationIconCacheAll(ApplicationInfo applicationInfo);

    public abstract Drawable getApplicationIconCacheOrignal(ApplicationInfo applicationInfo);

    public abstract Drawable getApplicationIconCacheOrignal(String str) throws NameNotFoundException;
    ...
    public abstract Drawable getEphemeralApplicationIcon(String str);
    ...
    public abstract Drawable getManagedUserBadgedDrawable(Drawable drawable, Rect rect, int i);

    public abstract int getMoveStatus(int i);

    public abstract String getNameForUid(int i);

    public abstract FeatureInfo[] getOppoSystemAvailableFeatures();
    ...
    public abstract boolean isFullFunctionMode();
    ...
    public abstract boolean isSecurePayApp(String str);
    ...
    public abstract boolean prohibitChildInstallation(int i, boolean z);
    ...
    public abstract void removeDisallowUninstallApps(List<String> list);
    ...
    public abstract boolean setEphemeralCookie(byte[] bArr);
    ...
    public PackageInfo getPackageArchiveInfo(String archiveFilePath, int flags) {
        ...
        if ((flags & MATCH_ENCRYPTION_AWARE_AND_UNAWARE) == 0) {
    ...
    public Drawable loadItemIcon(PackageItemInfo itemInfo, ApplicationInfo appInfo, boolean isConvertEnable) {
        return loadItemIcon(itemInfo, appInfo);
    }
}
