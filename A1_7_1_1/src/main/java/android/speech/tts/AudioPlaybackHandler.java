...
class AudioPlaybackHandler {
    ...
    private final Thread mHandlerThread = new Thread(new MessageLoop(this, null), "TTS.AudioPlaybackThread");
    ...
    private final class MessageLoop implements Runnable {
        /* synthetic */ MessageLoop(AudioPlaybackHandler this$0, MessageLoop messageLoop) {
            this();
        }
