...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    private static final int LAST_KEYCODE = 283;
    @Deprecated
    ...
    public static class DispatcherState {
        ...
        public void reset(Object target) {
            if (this.mDownTarget == target) {
                if (KeyEvent.DEBUG) {
                    Log.v(KeyEvent.TAG, "Reset in " + target + ": " + this);
                }
                this.mDownKeyCode = 0;
                this.mDownTarget = null;
            }
        ...
        public void startTracking(KeyEvent event, Object target) {
            ...
            if (KeyEvent.DEBUG) {
                Log.v(KeyEvent.TAG, "Start trackingt in " + target + ": " + this);
            }
        ...
        public void handleUpEvent(KeyEvent event) {
            ...
            if (KeyEvent.DEBUG) {
                Log.v(KeyEvent.TAG, "Handle key up " + event + ": " + this);
            }
            int index = this.mActiveLongPresses.indexOfKey(keyCode);
            if (index >= 0) {
                if (KeyEvent.DEBUG) {
                    Log.v(KeyEvent.TAG, "  Index: " + index);
                }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.KeyEvent.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.KeyEvent.<clinit>():void, dex: 
        */
    ...
    public final boolean dispatch(Callback receiver, DispatcherState state, Object target) {
        if (InputLog.isOpenAllLog() && !DEBUG) {
            DEBUG = InputLog.isOpenAllLog();
            Log.d(TAG, " change DEBUG = " + DEBUG);
        }
        switch (this.mAction) {
            case 0:
