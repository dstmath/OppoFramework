...
public class BaseInputConnection implements InputConnection {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.inputmethod.BaseInputConnection.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.inputmethod.BaseInputConnection.<clinit>():void, dex: 
        */
    ...
    public Editable getEditable() {
        if (this.mEditable == null) {
            this.mEditable = Factory.getInstance().newEditable(PhoneConstants.MVNO_TYPE_NONE);
    ...
    private void ensureDefaultComposingSpans() {
        if (this.mDefaultComposingSpans == null) {
            ...
            if (context != null) {
                ...
                int[] iArr = new int[1];
                iArr[0] = R.attr.candidatesTextStyleSpans;
                TypedArray ta = theme.obtainStyledAttributes(iArr);
