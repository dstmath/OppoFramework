...
public class RenderNode {
    ...
    private RenderNode(String name, View owningView) {
        ...
        if (this.mOwningView instanceof SurfaceView) {
            nRequestPositionUpdates(this.mNativeRenderNode, (SurfaceView) this.mOwningView);
        }
    }
    ...
    void onRenderNodeDetached() {
        discardDisplayList();
        if (this.mOwningView != null) {
            this.mOwningView.onRenderNodeDetached(this);
        }
    }
