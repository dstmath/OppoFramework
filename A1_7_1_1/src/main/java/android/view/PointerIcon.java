...
public final class PointerIcon implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.PointerIcon.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.PointerIcon.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.PointerIcon.<clinit>():void");
    }

    /* synthetic */ PointerIcon(int type, PointerIcon pointerIcon) {
        this(type);
    }
