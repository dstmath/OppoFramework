...
public class GraphicBuffer implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.GraphicBuffer.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.GraphicBuffer.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.GraphicBuffer.<clinit>():void");
    }

    /* synthetic */ GraphicBuffer(int width, int height, int format, int usage, long nativeObject, GraphicBuffer graphicBuffer) {
