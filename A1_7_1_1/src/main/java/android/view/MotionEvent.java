...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    @OppoHook(level = OppoHookType.NEW_FIELD, note = "Jianhua.Lin@Plf.SDK : Add for accidentally touch", property = OppoRomType.ROM)
    private boolean mIsCreatedTouchEvent;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.view.MotionEvent.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.view.MotionEvent.<clinit>():void, dex: 
        */
    ...
    private MotionEvent() {
        this.mIsCreatedTouchEvent = false;
    }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Jianhua.Lin@Plf.SDK : Modify for Add for accidentally touch", property = OppoRomType.ROM)
    public final boolean isTouchEvent() {
        if (this.mIsCreatedTouchEvent) {
            return true;
        }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Jun.Zhang@Plf.Framework, modify for catch IllegalArgumentException", property = OppoRomType.ROM)
    public final float getX(int pointerIndex) {
        try {
            return nativeGetAxisValue(this.mNativePtr, 0, pointerIndex, Integer.MIN_VALUE);
        } catch (IllegalArgumentException e) {
            Log.d("MotionEvent", "MotionEvent is IllegalArgumentException " + e);
            return 0.0f;
        }
    }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "Jun.Zhang@Plf.Framework, 2014-08-21: modify for drag screen", property = OppoRomType.ROM)
    public final float getRawX() {
        if (OppoScreenDragUtil.isOffsetState()) {
            return OppoScreenDragUtil.getOffsetPosX(nativeGetRawAxisValue(this.mNativePtr, 0, 0, Integer.MIN_VALUE));
        }
    ...
    public final float getRawY() {
        if (OppoScreenDragUtil.isOffsetState()) {
            return OppoScreenDragUtil.getOffsetPosY(nativeGetRawAxisValue(this.mNativePtr, 1, 0, Integer.MIN_VALUE));
        }
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "Jun.Zhang@Plf.Framework,2014.09.01:Add for drag screen", property = OppoRomType.OPPO)
    ...
    @OppoHook(level = OppoHookType.NEW_FIELD, note = "Jianhua.Lin@Plf.SDK : Add for accidentally touch", property = OppoRomType.ROM)
    public void setCreatedTouchEvent(boolean isCreatedTouchEvent) {
        this.mIsCreatedTouchEvent = isCreatedTouchEvent;
    }
}
