...
public final class WindowManagerGlobal {
    ...
    public void addView(View view, ViewGroup.LayoutParams params, Display display, Window parentWindow) {
        if (view == null) {
            ...
            if (this.mRoots.size() > 32) {
                ...
                if (SystemProperties.getBoolean("persist.sys.assert.panic", false) && !(OppoThemeResources.FRAMEWORK_PACKAGE.equals(wparams.packageName) && wparams.packageName == null)) {
    ...
    public void doTraversal(View view, boolean immediate) {
        ...
        synchronized (this.mLock) {
            ((ViewRootImpl) this.mRoots.get(findViewLocked(view, true))).doTraversal();
        }
    }
            ...
            while (i < count) {
                if ((view == null || this.mViews.get(i) != view) && (token == null || ((LayoutParams) this.mParams.get(i)).token == token)) {
                    ...
                    if (who != null) {
                        ...
                        Log.e(TAG, PhoneConstants.MVNO_TYPE_NONE, leak);
                    }
