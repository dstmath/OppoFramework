...
public final class InputDevice implements Parcelable {
    ...
    public static final class MotionRange {
        ...
        /* synthetic */ MotionRange(int axis, int source, float min, float max, float flat, float fuzz, float resolution, MotionRange motionRange) {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.InputDevice.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.InputDevice.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.InputDevice.<clinit>():void");
    }

    /* synthetic */ InputDevice(Parcel in, InputDevice inputDevice) {
        this(in);
    }
