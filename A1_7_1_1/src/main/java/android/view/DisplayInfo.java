...
public final class DisplayInfo implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.DisplayInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.DisplayInfo.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.DisplayInfo.<clinit>():void");
    }

    /* synthetic */ DisplayInfo(Parcel source, DisplayInfo displayInfo) {
        this(source);
    }
    ...
    private void getMetricsWithSize(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration, int width, int height) {
        ...
        if (currentPackageName == null || !(ColorDisplayCompatUtils.getInstance().shouldCompatAdjustForPkg(currentPackageName) || currentPackageName.equals("android.dpi.cts") || currentPackageName.equals("android.dpi2.cts"))) {
