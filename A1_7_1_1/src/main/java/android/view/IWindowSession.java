...
public interface IWindowSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowSession {
        ...
        static final int TRANSACTION_setLastSurfaceAppName = 34;
        ...
        private static class Proxy implements IWindowSession {
            ...
            public void setLastSurfaceAppName(String name) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    ...
                    _arg6 = new Rect();
                    repositionChild(_arg0, _arg1, _arg22, _arg3, _arg42, _arg53, _arg6);
                    reply.writeNoException();
                    if (_arg6 != null) {
                        reply.writeInt(1);
                        _arg6.writeToParcel(reply, 1);
                ...
                case 19:
                    ...
                    _result2 = performDrag(_arg0, _arg17, _arg22, _arg33, _arg45, _arg54, _arg64, _arg72);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 20:
                ...
                case 27:
                    ...
                    _arg42 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg55 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _arg55 = null;
                    }
                    Bundle _result4 = sendWallpaperCommand(_arg02, _arg18, _arg22, _arg3, _arg42, _arg55, data.readInt() != 0);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    setLastSurfaceAppName(data.readString());
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void setLastSurfaceAppName(String str) throws RemoteException;
