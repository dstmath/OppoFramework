...
public final class ThreadedRenderer {
    ...
    private static class ProcessInitializer {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.ThreadedRenderer.ProcessInitializer.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.ThreadedRenderer.ProcessInitializer.<clinit>():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.ThreadedRenderer.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.ThreadedRenderer.<clinit>():void, dex: 
        */
    ...
    private void updateViewTreeDisplayList(View view) {
        ...
        if ((view.mPrivateFlags & Integer.MIN_VALUE) == Integer.MIN_VALUE) {
            z = true;
        } else {
            z = false;
        }
