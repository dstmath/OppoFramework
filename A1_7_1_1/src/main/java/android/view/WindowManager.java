...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        public static final Creator<LayoutParams> CREATOR = null;
        ...
        public static final int FLAG_EX_PQ_MASK = 16777216;
        public static final int FLAG_EX_PQ_ON = 16777216;
        ...
        public static final int PRIVATE_FLAG_FORCE_CUSTOM_STATUS_BAR = 134217728;
        public static final int PRIVATE_FLAG_FORCE_DECOR_VIEW_VISIBILITY = 16384;
        public static final int PRIVATE_FLAG_FORCE_DRAW_NAVIGATION_BAR_BACKGROUND = 1073741824;
        ...
        public static final int PRIVATE_FLAG_STARTING_WINDOW_IMMERSIVE_NAVIGATION = 536870912;
        public static final int PRIVATE_FLAG_STATUS_BAR_LIGHT = 67108864;
        ...
        public static final int PRIVATE_FLAG_WINDOW_IS_IMMERSIVE_NAVIGATION = 268435456;
        ...
        @OppoHook(level = OppoHookType.NEW_FIELD, note = "Jun.Zhang@Plf.Framework,2014.09.01: Add for drag screen", property = OppoRomType.ROM)
        ...
        public static final int TYPE_TOP_MOST = 2037;
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.WindowManager.LayoutParams.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.WindowManager.LayoutParams.<clinit>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.view.WindowManager.LayoutParams.<clinit>():void");
        }
        ...
        public final void setTitle(CharSequence title) {
            if (title == null) {
                title = PhoneConstants.MVNO_TYPE_NONE;
            }
            this.mTitle = TextUtils.stringOrSpannedString(title);
        }

        public final CharSequence getTitle() {
            return this.mTitle != null ? this.mTitle : PhoneConstants.MVNO_TYPE_NONE;
        }
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(this.navigationBarVisibility);
        ...
        public LayoutParams(Parcel in) {
            ...
            this.navigationBarVisibility = in.readInt();
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            if (this.ignoreHomeMenuKey != o.ignoreHomeMenuKey) {
                this.ignoreHomeMenuKey = o.ignoreHomeMenuKey;
            }
            if (this.isDisableStatusBar != o.isDisableStatusBar) {
                this.isDisableStatusBar = o.isDisableStatusBar;
            }
            if (this.memoryType != o.memoryType) {
                this.memoryType = o.memoryType;
            }
            if (this.navigationBarVisibility != o.navigationBarVisibility) {
                this.navigationBarVisibility = o.navigationBarVisibility;
                changes |= 16384;
            }
            ...
            return changes | 16384;
        }

        public String debug(String output) {
            Log.d("Debug", output + "Contents of " + this + ":");
            Log.d("Debug", super.debug(PhoneConstants.MVNO_TYPE_NONE));
            Log.d("Debug", PhoneConstants.MVNO_TYPE_NONE);
        ...
        public String toString() {
            ...
            if (this.memoryType != 0) {
                ...
                sb.append(this.memoryType);
            }
            if (this.navigationBarVisibility != 0) {
                sb.append(" navbarVis=0x");
                sb.append(Integer.toHexString(this.navigationBarVisibility));
            }
            if (this.systemUiVisibility != 0) {
                sb.append(" navbarColor=0x");
