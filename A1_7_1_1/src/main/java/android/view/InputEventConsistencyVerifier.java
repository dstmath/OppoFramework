...
public final class InputEventConsistencyVerifier {
    ...
    private static final class KeyState {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.InputEventConsistencyVerifier.KeyState.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.InputEventConsistencyVerifier.KeyState.<clinit>():void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.view.InputEventConsistencyVerifier.KeyState.<init>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        private KeyState() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.view.InputEventConsistencyVerifier.KeyState.<init>():void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.view.InputEventConsistencyVerifier.KeyState.<init>():void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.view.InputEventConsistencyVerifier.KeyState.obtain(int, int, int):android.view.InputEventConsistencyVerifier$KeyState, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public static android.view.InputEventConsistencyVerifier.KeyState obtain(int r1, int r2, int r3) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.view.InputEventConsistencyVerifier.KeyState.obtain(int, int, int):android.view.InputEventConsistencyVerifier$KeyState, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.view.InputEventConsistencyVerifier.KeyState.recycle():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public void recycle() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.view.InputEventConsistencyVerifier.KeyState.recycle():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.view.InputEventConsistencyVerifier.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.view.InputEventConsistencyVerifier.<clinit>():void, dex: 
        */
                ...
                switch (action) {
                    ...
                    case 11:
                        ...
                        if (this.mButtonsPressed != buttonState) {
                            objArr = new Object[2];
                            objArr[0] = Integer.valueOf(buttonState);
                            objArr[1] = Integer.valueOf(this.mButtonsPressed);
                            problem(String.format("Reported button state differs from expected button state based on press and release events. Is 0x%08x but expected 0x%08x.", objArr));
                            break;
                        }
                        break;
                    case 12:
    ...
    private void ensureMetaStateIsNormalized(int metaState) {
        ...
        if (normalizedMetaState != metaState) {
            ...
            objArr[0] = Integer.valueOf(metaState);
            objArr[1] = Integer.valueOf(normalizedMetaState);
            problem(String.format("Metastate not normalized.  Was 0x%08x but expected 0x%08x.", objArr));
        }
    }
