...
public interface IOppoWindowManager extends IColorLongshotWindowManager {
    ...
    public static final int GET_LONGSHOT_VIEW_INFO = 10021;
    public static final int GET_LONGSHOT_VIEW_INFO_ASYNC = 10029;
    ...
    public static final int IS_SIM_UNLOCK_RUNNING = 10009;
    ...
    public static final int LONGSHOT_ANALYSIS_VIEW = 10026;
    ...
    public static final int RM_ADD_STATUSBAR_RUNNABLE = 10008;
    public static final int SET_MAGNIFICATION_SPEC_EX = 10015;
    public static final int SHOW_STATUSBAR = 10007;
    ...
    void rm_add_StatusBarRunnable(int i) throws RemoteException;
