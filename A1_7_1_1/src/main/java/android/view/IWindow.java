...
public interface IWindow extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindow {
        ...
        static final int TRANSACTION_enableLog = 15;
        static final int TRANSACTION_enableLogLight = 18;
        static final int TRANSACTION_executeCommand = 1;
        static final int TRANSACTION_isUserDefinedToast = 17;
        ...
        static final int TRANSACTION_updateWindowNavigationBarColor = 19;
        ...
        private static class Proxy implements IWindow {
            ...
            public void dumpInputDispatchingStatus() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("android.view.IWindow");
            ...
            public boolean isUserDefinedToast() throws RemoteException {
                Parcel _data = Parcel.obtain();
            ...
            public void enableLogLight(boolean enable) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("android.view.IWindow");
            ...
            public void updateWindowNavigationBarColor(int color) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("android.view.IWindow");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    resized(_arg02, _arg12, _arg22, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, data.readInt() != 0, data.readInt() != 0);
                    return true;
                case 3:
                    data.enforceInterface("android.view.IWindow");
                ...
                case 17:
                    data.enforceInterface("android.view.IWindow");
                    boolean _result = isUserDefinedToast();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 18:
                    data.enforceInterface("android.view.IWindow");
                    enableLogLight(data.readInt() != 0);
                    return true;
                case 19:
                    data.enforceInterface("android.view.IWindow");
                    updateWindowNavigationBarColor(data.readInt());
                    return true;
                case 1598968902:
    ...
    void dumpInputDispatchingStatus() throws RemoteException;

    void enableLog(boolean z) throws RemoteException;

    void enableLogLight(boolean z) throws RemoteException;

    void executeCommand(String str, String str2, ParcelFileDescriptor parcelFileDescriptor) throws RemoteException;

    boolean isUserDefinedToast() throws RemoteException;
    ...
    void updateWindowNavigationBarColor(int i) throws RemoteException;
