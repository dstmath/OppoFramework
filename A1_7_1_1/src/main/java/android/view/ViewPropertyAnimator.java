...
public class ViewPropertyAnimator {
    ...
    private class AnimatorEventListener implements AnimatorListener, AnimatorUpdateListener {
        /* synthetic */ AnimatorEventListener(ViewPropertyAnimator this$0, AnimatorEventListener animatorEventListener) {
            this();
        }
    ...
    public ViewPropertyAnimator withLayer() {
        ...
        if (this.mOldLayerType == -1) {
            currentLayerType = this.mView.getLayerType();
            this.mOldLayerType = currentLayerType;
        } else {
            currentLayerType = this.mOldLayerType;
        }
        this.mPendingCleanupAction = new Runnable() {
            public void run() {
                ViewPropertyAnimator.this.mView.setLayerType(currentLayerType, null);
                ViewPropertyAnimator.this.mOldLayerType = -1;
            }
        };
