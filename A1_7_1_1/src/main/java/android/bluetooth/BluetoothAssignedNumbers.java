...
public class BluetoothAssignedNumbers {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.bluetooth.BluetoothAssignedNumbers.<init>():void, dex: 
    ...
    private BluetoothAssignedNumbers() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.bluetooth.BluetoothAssignedNumbers.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.bluetooth.BluetoothAssignedNumbers.<init>():void");
    }
}
