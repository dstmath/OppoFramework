...
public abstract class Transition implements Cloneable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.transition.Transition.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.transition.Transition.<clinit>():void, dex: 
        */
    ...
    public String toString() {
        return toString(PhoneConstants.MVNO_TYPE_NONE);
    }
