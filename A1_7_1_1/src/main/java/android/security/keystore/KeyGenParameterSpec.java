...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec {
    private static final Date DEFAULT_CERT_NOT_AFTER = null;
    private static final Date DEFAULT_CERT_NOT_BEFORE = null;
    private static final BigInteger DEFAULT_CERT_SERIAL_NUMBER = null;
    private static final X500Principal DEFAULT_CERT_SUBJECT = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.security.keystore.KeyGenParameterSpec.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.security.keystore.KeyGenParameterSpec.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.security.keystore.KeyGenParameterSpec.<clinit>():void");
    }
