...
public final class NetworkSecurityConfigProvider extends Provider {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.security.net.config.NetworkSecurityConfigProvider.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.security.net.config.NetworkSecurityConfigProvider.<clinit>():void, dex: 
        */
