...
public class Location implements Parcelable {
    ...
    private static class BearingDistanceCache {
        ...
        /* synthetic */ BearingDistanceCache(BearingDistanceCache bearingDistanceCache) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.location.Location.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.location.Location.<clinit>():void, dex: 
        */
    ...
    public Location(String provider) {
        ...
        this.mAccuracy = TonemapCurve.LEVEL_BLACK;
        this.mExtras = null;
    ...
    public String toString() {
        ...
        objArr[0] = Double.valueOf(this.mLatitude);
        objArr[1] = Double.valueOf(this.mLongitude);
        s.append(String.format(" %.6f,%.6f", objArr));
        if (hasAccuracy()) {
            objArr = new Object[1];
            objArr[0] = Float.valueOf(this.mAccuracy);
