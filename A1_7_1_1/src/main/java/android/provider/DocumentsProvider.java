    ...
    private Bundle callUnchecked(String method, String arg, Bundle extras) throws FileNotFoundException {
        ...
        if (this.mAuthority.equals(authority)) {
            ...
            if (DocumentsContract.METHOD_IS_CHILD_DOCUMENT.equals(method)) {
                ...
                Bundle bundle = out;
                String str2 = "uri";
                bundle.putParcelable(str2, DocumentsContract.buildDocumentUriMaybeUsingTree(documentUri, createDocument(documentId, extras.getString("mime_type"), extras.getString("_display_name"))));
