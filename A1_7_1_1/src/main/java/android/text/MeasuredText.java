...
class MeasuredText {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.text.MeasuredText.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.text.MeasuredText.<clinit>():void, dex: 
        */
    ...
    float addStyleRun(TextPaint paint, int len, FontMetricsInt fm) {
        ...
        if (fm != null) {
            paint.getFontMetricsInt(this.mChars, fm, this.mPos, len);
        }
        int p = this.mPos;
        this.mPos = p + len;
        float[] widths = null;
