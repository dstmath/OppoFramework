...
public class ArrowKeyMovementMethod extends BaseMovementMethod implements MovementMethod {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.text.method.ArrowKeyMovementMethod.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.text.method.ArrowKeyMovementMethod.<clinit>():void, dex: 
        */
