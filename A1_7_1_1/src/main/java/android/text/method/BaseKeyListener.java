...
public abstract class BaseKeyListener extends MetaKeyKeyListener implements KeyListener {
    /* renamed from: -android-text-method-TextKeyListener$CapitalizeSwitchesValues */
    private static final /* synthetic */ int[] f6-android-text-method-TextKeyListener$CapitalizeSwitchesValues = null;
    ...
    /* renamed from: -getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues */
    private static /* synthetic */ int[] m47-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues() {
        if (f6-android-text-method-TextKeyListener$CapitalizeSwitchesValues != null) {
            return f6-android-text-method-TextKeyListener$CapitalizeSwitchesValues;
        }
        ...
        f6-android-text-method-TextKeyListener$CapitalizeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.text.method.BaseKeyListener.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.text.method.BaseKeyListener.<clinit>():void, dex: 
        */
    ...
    static int makeTextContentType(Capitalize caps, boolean autoText) {
        int contentType = 1;
        switch (m47-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues()[caps.ordinal()]) {
            case 1:
                contentType = 4097;
                break;
            case 2:
