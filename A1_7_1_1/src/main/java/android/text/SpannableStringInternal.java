...
abstract class SpannableStringInternal {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.text.SpannableStringInternal.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.text.SpannableStringInternal.<clinit>():void, dex: 
        */
    ...
    private final void copySpans(Spanned src, int start, int end) {
        ...
        for (int i = 0; i < spans.length; i++) {
            ...
            int flagsEnd = fl & 15;
            if (!(isInvalidParagraphStart(st, (fl & 240) >> 4) || isInvalidParagraphEnd(en, flagsEnd))) {
