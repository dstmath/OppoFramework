...
public class Toolbar extends ViewGroup {
    ...
    class AnonymousClass3 implements OnClickListener {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.widget.Toolbar.3.<init>(android.widget.Toolbar):void, dex: 
        ...
        AnonymousClass3(android.widget.Toolbar r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.widget.Toolbar.3.<init>(android.widget.Toolbar):void, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.widget.Toolbar.3.<init>(android.widget.Toolbar):void");
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.widget.Toolbar.3.onClick(android.view.View):void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public void onClick(android.view.View r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.widget.Toolbar.3.onClick(android.view.View):void, dex: 
            */
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        /* synthetic */ ExpandedActionViewMenuPresenter(Toolbar this$0, ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter) {
            this(this$0);
        }

        private ExpandedActionViewMenuPresenter(Toolbar this$0) {
            this.this$0 = this$0;
        }
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (this.this$0.mExpandedActionView.getParent() != this.this$0) {
                ...
                lp.gravity = (this.this$0.mButtonGravity & 112) | Gravity.START;
                lp.mViewType = 2;
    ...
    static class SavedState extends BaseSavedState {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.widget.Toolbar.SavedState.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.widget.Toolbar.SavedState.<clinit>():void, dex: 
            */
    ...
    private void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new AnonymousClass3(this));
        }
    }
