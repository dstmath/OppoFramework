...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class AnonymousClass1 extends ForwardingListener {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.widget.ListPopupWindow.1.<init>(android.widget.ListPopupWindow, android.view.View):void, dex: 
        ...
        AnonymousClass1(android.widget.ListPopupWindow r1, android.view.View r2) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.widget.ListPopupWindow.1.<init>(android.widget.ListPopupWindow, android.view.View):void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.widget.ListPopupWindow.1.getPopup():com.android.internal.view.menu.ShowableListMenu, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public com.android.internal.view.menu.ShowableListMenu getPopup() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.widget.ListPopupWindow.1.getPopup():com.android.internal.view.menu.ShowableListMenu, dex: 
            */
            throw new UnsupportedOperationException("Method not decompiled: android.widget.ListPopupWindow.1.getPopup():com.android.internal.view.menu.ShowableListMenu");
        }
    }
    ...
    class AnonymousClass2 implements Runnable {
        ...
        AnonymousClass2(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    class AnonymousClass3 implements OnItemSelectedListener {
        ...
        AnonymousClass3(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    private class ListSelectorHider implements Runnable {
        ...
        private ListSelectorHider(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    private class PopupDataSetObserver extends DataSetObserver {
        ...
        private PopupDataSetObserver(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    private class PopupScrollListener implements OnScrollListener {
        ...
        private PopupScrollListener(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    private class ResizePopupRunnable implements Runnable {
        ...
        private ResizePopupRunnable(ListPopupWindow this$0) {
            this.this$0 = this$0;
        }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "JianHui.Yu@Plf.SDK, 2015-08-07 : Modify for ColorOS PopupWindow", property = OppoRomType.ROM)
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a.recycle();
        this.mPopup = createPopupWindow(context, attrs, defStyleAttr, defStyleRes);
    ...
    public android.view.View.OnTouchListener createDragToOpenListener(android.view.View r2) {
        /*
        r1 = this;
        r0 = new android.widget.ListPopupWindow$1;
        r0.<init>(r1, r2);
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.ListPopupWindow.createDragToOpenListener(android.view.View):android.view.View$OnTouchListener");
    }

    @OppoHook(level = OppoHookType.CHANGE_ACCESS, note = "JianHui.Yu@Plf.SDK, 2015-08-08 : [-private] Modify for List NavigationMode", property = OppoRomType.ROM)
    int buildDropDown() {
        int padding;
        int otherHeights = 0;
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new AnonymousClass2(this);
            ...
            this.mDropDownList.setOnItemSelectedListener(new AnonymousClass3(this));
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "JianHui.Yu@Plf.SDK, 2015-08-07 : Add for ColorOS PopupWindow", property = OppoRomType.ROM)
