...
public class LinearLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public String debug(String output) {
            return output + "LinearLayout.LayoutParams={ width=" + android.view.ViewGroup.LayoutParams.sizeToString(this.width) + ", height=" + android.view.ViewGroup.LayoutParams.sizeToString(this.height) + ", leftMargin=" + this.leftMargin + ", rightMargin=" + this.rightMargin + ", topMargin=" + this.topMargin + ", bottomMargin=" + this.bottomMargin + ", weight=" + this.weight + (this.gravity != -1 ? ", gravity=" + Integer.toHexString(this.gravity) : PhoneConstants.MVNO_TYPE_NONE) + " }";
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.widget.LinearLayout.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.widget.LinearLayout.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.LinearLayout.<clinit>():void");
    }
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass1: " + i + ", child=" + child + ", this=" + this);
                }
                ...
                if (heightMode == 1073741824 && useExcessSpace) {
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1: " + i + ", child=" + child + ", this=" + this + ", " + "status=Skipped, mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
                    }
                    skippedMeasure = true;
                } else {
                    if (useExcessSpace) {
                        lp.height = -2;
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-1: " + i + ", child=" + child + ", this=" + this + ", " + "status=Modified, LayoutParams.height change to WRAP_CONTENT");
                        }
                    }
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-2: " + i + ", child=" + child + ", this=" + this + ", " + "status=Measured, mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
                    }
                }
                ...
                if (i >= baselineChildIndex || lp.weight <= 0.0f) {
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1: " + i + ", child=" + child + ", this=" + this + ", " + "matchWidth=" + matchWidth + ", matchWidthLocally=" + matchWidthLocally + ", " + "weightedMaxWidth=" + weightedMaxWidth + ", alternativeMaxWidth=" + alternativeMaxWidth);
                    }
                    i += getChildrenSkipCount(child, i);
                } else {
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.1, this=" + this + ", " + "maxWidth=" + maxWidth + ", weightedMaxWidth=" + weightedMaxWidth + ", alternativeMaxWidth=" + alternativeMaxWidth + ", " + "mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
        }
        ...
        if (useLargestChild && (heightMode == Integer.MIN_VALUE || heightMode == 0)) {
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.1.5, this=" + this + ", largestChildHeight=" + largestChildHeight + ", mTotalLength=" + this.mTotalLength);
            }
        }
        ...
        int i2 = heightSize - this.mTotalLength;
        if (this.mAllowInconsistentMeasurement) {
            consumedExcessSpace = 0;
        }
        int remainingExcess = i2 + consumedExcessSpace;
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.2, this=" + this + ", " + "remainingExcess=" + remainingExcess + ", " + "heightSize=" + heightSize + ", mTotalLength=" + this.mTotalLength);
        }
        if (skippedMeasure || (remainingExcess != 0 && totalWeight > 0.0f)) {
            ...
            for (i = 0; i < count; i++) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass2: " + i + ", " + "child=" + child + ", this=" + this);
                    }
                    lp = (LayoutParams) child.getLayoutParams();
                    ...
                    if (childWeight > 0.0f) {
                        ...
                        if (this.mUseLargestChild && heightMode != 1073741824) {
                            ...
                            if (DBG && sDebugLayout) {
                                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-1-2: " + i + ", child=" + child + ", this=" + this + ", " + "status=Measured, share=" + share + ", mTotalLength=" + this.mTotalLength);
                            }
                        } else {
                            childHeight = share;
                            if (DBG && sDebugLayout) {
                                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-1-1: " + i + ", child=" + child + ", this=" + this + ", " + "status=Measured, share=" + share + ", childHeight=" + share + ", mTotalLength=" + this.mTotalLength);
                            }
                        }
                    ...
                    } else if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-2: " + i + ", child=" + child + ", this=" + this + ", " + "status=Skipped" + ", mTotalLength=" + this.mTotalLength);
                    }
                    margin = lp.leftMargin + lp.rightMargin;
                    measuredWidth = child.getMeasuredWidth() + margin;
                    maxWidth = Math.max(maxWidth, measuredWidth);
            ...
            this.mTotalLength += this.mPaddingTop + this.mPaddingBottom;
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-1, this=" + this + ", " + "maxWidth=" + maxWidth + ", weightedMaxWidth=" + weightedMaxWidth + ", alternativeMaxWidth=" + alternativeMaxWidth + ", mTotalLength=" + this.mTotalLength);
            }
        } else {
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (i = 0; i < count; i++) {
                    child = getVirtualChildAt(i);
                    if (!(child == null || child.getVisibility() == 8)) {
                        float childExtra = ((LayoutParams) child.getLayoutParams()).weight;
                        if (childExtra > 0.0f) {
                        ...
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-2: " + i + ", child=" + child + ", this=" + this + ", " + (childExtra > 0.0f ? "status=Measured" : "status=Skipped"));
                        }
                    }
                }
            }
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-2, this=" + this + ", " + "maxWidth=" + maxWidth + ", weightedMaxWidth=" + weightedMaxWidth + ", alternativeMaxWidth=" + alternativeMaxWidth + ", mTotalLength=" + this.mTotalLength + ", useLargestChild=" + useLargestChild);
            }
        }
        ...
        if (matchWidth) {
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.3, this=" + this + ", uniformWidth=" + getMeasuredWidth() + ", this=" + this);
            }
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i2 < count) {
            ...
            if (child == null) {
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass1: " + i2 + ", child=" + child + ", this=" + this);
                }
                ...
                if (widthMode == 1073741824 && useExcessSpace) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1-1: " + i2 + ", child=" + child + ", this=" + this + ", " + "status=Measured(BaselineAligned), mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
                        }
                    } else {
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1-2: " + i2 + ", child=" + child + ", this=" + this + ", " + "status=Skipped, mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
                        }
                        skippedMeasure = true;
                    }
                } else {
                    if (useExcessSpace) {
                        lp.width = -2;
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-1: " + i2 + ", child=" + child + ", this=" + this + ", " + "status=Modified, LayoutParams.height change to WRAP_CONTENT");
                        }
                    }
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-2: " + i2 + ", child=" + child + ", this=" + this + ", " + "status=Measured, mTotalLength=" + this.mTotalLength + ", totalWeight=" + totalWeight);
                    }
                }
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1: " + i2 + ", child=" + child + ", this=" + this + ", " + "maxHeight=" + maxHeight + ", matchHeightLocally=" + matchHeightLocally + ", " + "weightedMaxHeight=" + weightedMaxHeight + ", alternativeMaxHeight=" + alternativeMaxHeight);
                }
                i2 += getChildrenSkipCount(child, i2);
            }
            i2++;
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.1, this=" + this + ", maxHeight = " + maxHeight + ", " + "weightedMaxHeight = " + weightedMaxHeight + ", alternativeMaxHeight = " + alternativeMaxHeight + ", " + "mTotalLength=" + this.mTotalLength);
        }
        if (this.mTotalLength > 0 && hasDividerBeforeChildAt(count)) {
            this.mTotalLength += this.mDividerWidth;
        }
        ...
        if (useLargestChild && (widthMode == Integer.MIN_VALUE || widthMode == 0)) {
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.1.5, this=" + this + ", largestChildWidth=" + largestChildWidth + ", mTotalLength=" + this.mTotalLength);
            }
        }
        ...
        i = widthSize - this.mTotalLength;
        if (this.mAllowInconsistentMeasurement) {
            usedExcessSpace = 0;
        }
        int remainingExcess = i + usedExcessSpace;
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.2 (Horizontal), this=" + this + ", remainingExcess = " + remainingExcess + ", " + "widthSize = " + widthSize + ", mTotalLength = " + this.mTotalLength);
        }
        if (skippedMeasure || (remainingExcess != 0 && totalWeight > 0.0f)) {
            float remainingWeightSum = this.mWeightSum > 0.0f ? this.mWeightSum : totalWeight;
            maxAscent[3] = -1;
            ...
            for (i2 = 0; i2 < count; i2++) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass2: " + i2 + ", child=" + child + ", this=" + this);
                    }
                    lp = (LayoutParams) child.getLayoutParams();
                    float childWeight = lp.weight;
                    if (childWeight > 0.0f) {
                        ...
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-3: " + i2 + ", child=" + child + ", this=" + this + ", mTotalLength=" + this.mTotalLength);
                    }
                    if (isExactly) {
            ...
            this.mTotalLength += this.mPaddingLeft + this.mPaddingRight;
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-1, this=" + this + ", " + "maxHeight=" + maxHeight + ", weightedMaxHeight=" + weightedMaxHeight + ", alternativeMaxHeight=" + alternativeMaxHeight + ", mTotalLength=" + this.mTotalLength);
            }
            if (!(maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1)) {
                maxHeight = Math.max(maxHeight, Math.max(maxAscent[3], Math.max(maxAscent[0], Math.max(maxAscent[1], maxAscent[2]))) + Math.max(maxDescent[3], Math.max(maxDescent[0], Math.max(maxDescent[1], maxDescent[2]))));
            }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (i2 = 0; i2 < count; i2++) {
                    ...
                    if (!(child == null || child.getVisibility() == 8)) {
                        ...
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-2: " + i2 + ", child=" + child + ", this=" + this + ", " + (childExtra > 0.0f ? "status=Measured" : "status=Skipped"));
                        }
                    }
                }
            }
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-2, this=" + this + ", " + "maxHeight=" + maxHeight + ", weightedMaxHeight=" + weightedMaxHeight + ", alternativeMaxHeight=" + alternativeMaxHeight + ", mTotalLength=" + this.mTotalLength + ", useLargestChild=" + useLargestChild);
            }
        }
        ...
        if (matchHeight) {
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.3 (Horizontal), this=" + this + ", uniformHeight=" + getMeasuredHeight());
            }
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                if (!isLayoutRtl() && hasDividerBeforeChildAt(childIndex)) {
