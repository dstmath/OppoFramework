...
public class Switch extends CompoundButton {
    ...
    private static final FloatProperty<Switch> THUMB_POS = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.widget.Switch.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.widget.Switch.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.Switch.<clinit>():void");
    }
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "JianHui.Yu@Plf.SDK, 2015-07-28 : Modify for ColorOS3.0", property = OppoRomType.ROM)
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int switchWidth = getSwithWidth(paddingLeft, paddingRight);
    ...
    @OppoHook(level = OppoHookType.NEW_METHOD, note = "JianHui.Yu@Plf.SDK, 2015-10-19 : Add for ColorOS3.0", property = OppoRomType.ROM)
    private int getSwithWidth(int paddingLeft, int paddingRight) {
        return Math.max(this.mSwitchMinWidth, (((int) (((float) this.mThumbWidth) * (isOppoStyle() ? 1.5f : 2.0f))) + paddingLeft) + paddingRight);
    }
}
