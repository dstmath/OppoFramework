...
public abstract class Filter {
    ...
    private Handler mResultHandler = new ResultsHandler(this, null);
    ...
    private static class RequestArguments {
        ...
        /* synthetic */ RequestArguments(RequestArguments requestArguments) {
            this();
        }
    ...
    private class ResultsHandler extends Handler {
        /* synthetic */ ResultsHandler(Filter this$0, ResultsHandler resultsHandler) {
            this();
        }
    ...
    public CharSequence convertResultToString(Object resultValue) {
        return resultValue == null ? PhoneConstants.MVNO_TYPE_NONE : resultValue.toString();
    }
}
