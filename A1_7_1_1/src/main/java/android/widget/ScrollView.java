...
public class ScrollView extends FrameLayout {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.widget.ScrollView.SavedState.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.widget.ScrollView.SavedState.<clinit>():void, dex: 
            */
    ...
    private int getScrollRange() {
        ...
        return Math.max(0, child.getHeight() - ((((getHeight() - this.mPaddingBottom) - this.mPaddingTop) - lp.topMargin) - lp.bottomMargin));
    }
