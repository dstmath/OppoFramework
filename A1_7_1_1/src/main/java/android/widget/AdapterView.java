...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            AdapterView.this.setDataChanged(true);
    ...
    private class SelectionNotifier implements Runnable {
        /* synthetic */ SelectionNotifier(AdapterView this$0, SelectionNotifier selectionNotifier) {
            this();
        }
    ...
    void rememberSyncState() {
        if (getChildCount() > 0) {
            ...
            if (this.mSelectedPosition >= 0) {
                ...
                this.mSyncRowId = this.mNextSelectedRowId;
                setSyncPosition(this.mNextSelectedPosition);
                if (v != null) {
            ...
            setSyncPosition(this.mFirstPosition);
            if (v != null) {
                this.mSpecificTop = v.getTop();
            }
            this.mSyncMode = 1;
    ...
    boolean setDataChanged(boolean changed) {
        boolean ret = this.mDataChanged != changed;
        this.mDataChanged = changed;
        return ret;
    }

    boolean setSyncPosition(int pos) {
        boolean ret = this.mSyncPosition != pos;
        this.mSyncPosition = pos;
        return ret;
    }
}
