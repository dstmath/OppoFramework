...
public class SpellChecker implements SpellCheckerSessionListener {
    ...
    private class SpellParser {
        ...
        /* synthetic */ SpellParser(SpellChecker this$0, SpellParser spellParser) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.widget.SpellChecker.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.widget.SpellChecker.<clinit>():void, dex: 
        */
