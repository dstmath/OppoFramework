...
public class ProgressBar extends View {
    ...
    private class AccessibilityEventSender implements Runnable {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: android.widget.ProgressBar.AccessibilityEventSender.<init>(android.widget.ProgressBar):void, dex: 
        ...
        private AccessibilityEventSender(android.widget.ProgressBar r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: android.widget.ProgressBar.AccessibilityEventSender.<init>(android.widget.ProgressBar):void, dex: 
            */
        ...
        /* synthetic */ AccessibilityEventSender(ProgressBar this$0, AccessibilityEventSender accessibilityEventSender) {
            this(this$0);
        }

        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: android.widget.ProgressBar.AccessibilityEventSender.run():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public void run() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: android.widget.ProgressBar.AccessibilityEventSender.run():void, dex: 
            */
    ...
    private static class ProgressTintInfo {
        ...
        /* synthetic */ ProgressTintInfo(ProgressTintInfo progressTintInfo) {
            this();
        }
    ...
    private static class RefreshData {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.widget.ProgressBar.RefreshData.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.widget.ProgressBar.RefreshData.<clinit>():void, dex: 
            */
    ...
    static class SavedState extends BaseSavedState {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android.widget.ProgressBar.SavedState.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android.widget.ProgressBar.SavedState.<clinit>():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: android.widget.ProgressBar.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: android.widget.ProgressBar.<clinit>():void, dex: 
        */
    ...
    private synchronized void doRefreshProgress(int id, int progress, boolean fromUser, boolean callBackToApp, boolean animate) {
        ...
        synchronized (this) {
            ...
            if (isPrimary && animate) {
                Property property = this.VISUAL_PROGRESS;
                float[] fArr = new float[1];
                fArr[0] = scale;
                ObjectAnimator animator = ObjectAnimator.ofFloat(this, property, fArr);
    ...
    synchronized boolean setProgressInternal(int progress, boolean fromUser, boolean animate) {
        if (DBG) {
            Log.d(LOG_TAG, "setProgress, old = " + this.mProgress + ", new = " + progress + ", max = " + this.mMax + ", backtrace = " + Debug.getCallers(5) + ", this = " + this);
        }
        if (this.mIndeterminate) {
            return false;
        }
    ...
    public synchronized void setSecondaryProgress(int secondaryProgress) {
        if (DBG) {
            Log.d(LOG_TAG, "setSecondaryProgress, old = " + this.mSecondaryProgress + ", new = " + secondaryProgress + ", max = " + this.mMax + ", backtrace = " + Debug.getCallers(5) + ", this = " + this);
        }
        if (!this.mIndeterminate) {
    ...
    public synchronized void setMax(int max) {
        if (DBG) {
            Log.d(LOG_TAG, "setMax, old = " + this.mMax + ", new = " + max + ", backtrace = " + Debug.getCallers(5) + ", this = " + this);
        }
        if (max < 0) {
            max = 0;
        }
    ...
    public void invalidateDrawable(Drawable dr) {
        if (!this.mInDrawing) {
            if (dr == this.mProgressDrawable || dr == this.mIndeterminateDrawable) {
