    ...
    public static abstract class Stub extends Binder implements INfcAdapter {
        ...
        private static class Proxy implements INfcAdapter {
            ...
            public INfcAdapterGsmaExtras getNfcAdapterGsmaExtrasInterface() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    INfcAdapterGsmaExtras _result = com.mediatek.nfcgsma_extras.INfcAdapterGsmaExtras.Stub.asInterface(_reply.readStrongBinder());
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    INfcAdapterGsmaExtras _result7 = getNfcAdapterGsmaExtrasInterface();
                    reply.writeNoException();
                    reply.writeStrongBinder(_result7 != null ? _result7.asBinder() : null);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getModeFlag(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 23:
