...
public final class ZoneInfo extends TimeZone {
    ...
    private static class CheckedArithmeticException extends Exception {
        /* synthetic */ CheckedArithmeticException(CheckedArithmeticException checkedArithmeticException) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: libcore.util.ZoneInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: libcore.util.ZoneInfo.<clinit>():void, dex: 
        */
