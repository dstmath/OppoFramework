...
public final class AnnotatedElements {
    ...
    public static <T extends Annotation> T[] getDeclaredAnnotationsByType(AnnotatedElement element, Class<T> annotationClass) {
        if (annotationClass == null) {
            throw new NullPointerException("annotationClass");
        }
        Annotation[] annotations = element.getDeclaredAnnotations();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x00d9 A:{ExcHandler: java.lang.IllegalAccessException (r2_0 'e' java.lang.ReflectiveOperationException), Splitter: B:18:0x00c5} */
