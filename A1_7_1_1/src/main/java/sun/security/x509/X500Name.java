...
public class X500Name implements GeneralNameInterface, Principal {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: null in method: sun.security.x509.X500Name.<clinit>():void, dex: 
        ...
        Caused by: java.lang.NullPointerException
        	at jadx.core.dex.instructions.FillArrayNode.<init>(FillArrayNode.java:25)
        	at jadx.core.dex.instructions.InsnDecoder.fillArray(InsnDecoder.java:616)
        	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:557)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: null in method: sun.security.x509.X500Name.<clinit>():void, dex: 
        */
    ...
    public X500Principal asX500Principal() {
        if (this.x500Principal == null) {
            try {
                ...
                args[0] = this;
                this.x500Principal = (X500Principal) principalConstructor.newInstance(args);
            } catch (Exception e) {
