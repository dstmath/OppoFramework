...
public class AVA implements DerEncoder {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: sun.security.x509.AVA.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: sun.security.x509.AVA.<clinit>():void, dex: 
        */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:64:0x0139 A:{LOOP_END, LOOP:2: B:63:0x0137->B:64:0x0139} */
    ...
    private DerValue parseString(Reader in, int c, int format, StringBuilder temp) throws IOException {
        ...
        do {
            ...
            if (c == 92) {
                ...
                } else if (!(format == 1 && specialCharsAll.indexOf((char) c) == -1) && (format != 2 || specialChars.indexOf((char) c) != -1 || c == 92 || c == 34)) {
                    if (format == 3) {
                        if (c == 32) {
