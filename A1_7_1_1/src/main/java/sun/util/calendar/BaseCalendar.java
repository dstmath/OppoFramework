...
public abstract class BaseCalendar extends AbstractCalendar {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: sun.util.calendar.BaseCalendar.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: sun.util.calendar.BaseCalendar.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: sun.util.calendar.BaseCalendar.<clinit>():void");
    }
    ...
    public long getFixedDate(int year, int month, int dayOfMonth, Date cache) {
        boolean isJan1 = (month == 1 && dayOfMonth == 1) ? true : f61-assertionsDisabled;
