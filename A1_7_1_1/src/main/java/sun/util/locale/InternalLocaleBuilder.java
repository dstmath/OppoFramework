...
public final class InternalLocaleBuilder {
    ...
    static final class CaseInsensitiveString {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e8 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.<init>(java.lang.String):void, dex: 
        ...
        CaseInsensitiveString(java.lang.String r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e8 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.<init>(java.lang.String):void, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.equals(java.lang.Object):boolean, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public boolean equals(java.lang.Object r1) {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.equals(java.lang.Object):boolean, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.hashCode():int, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public int hashCode() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.hashCode():int, dex: 
            */
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.value():java.lang.String, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        public java.lang.String value() {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 00e5 in method: sun.util.locale.InternalLocaleBuilder.CaseInsensitiveString.value():java.lang.String, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: sun.util.locale.InternalLocaleBuilder.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: sun.util.locale.InternalLocaleBuilder.<clinit>():void, dex: 
        */
    ...
    public InternalLocaleBuilder setLocale(BaseLocale base, LocaleExtensions localeExtensions) throws LocaleSyntaxException {
        ...
        if (language.equals("ja") && region.equals("JP") && variant.equals("JP")) {
            if (f76-assertionsDisabled || "japanese".equals(localeExtensions.getUnicodeLocaleType("ca"))) {
                variant = "";
            } else {
                throw new AssertionError();
            }
        } else if (language.equals("th") && region.equals("TH") && variant.equals("TH")) {
            if (f76-assertionsDisabled || "thai".equals(localeExtensions.getUnicodeLocaleType("nu"))) {
                variant = "";
            } else {
                throw new AssertionError();
            }
