...
public class FDBigInt {
    ...
    static final /* synthetic */ boolean f27-assertionsDisabled = false;
    int[] data;
    int nWords;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: sun.misc.FDBigInt.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: sun.misc.FDBigInt.<clinit>():void, dex: 
        */
    ...
    public FDBigInt sub(FDBigInt other) {
        ...
        if (f27-assertionsDisabled || dataInRangeIsZero(i, m, other)) {
    ...
    public long longValue() {
        ...
        if (f27-assertionsDisabled || dataInRangeIsZero(2, this.nWords, this)) {
            if (!f27-assertionsDisabled) {
