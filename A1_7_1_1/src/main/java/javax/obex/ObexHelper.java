...
public final class ObexHelper {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: javax.obex.ObexHelper.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: javax.obex.ObexHelper.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: javax.obex.ObexHelper.<clinit>():void");
    }
    ...
    public static byte[] convertToByteArray(long l) {
        byte[] b = new byte[4];
        b[0] = (byte) ((int) ((l >> 24) & 255));
        b[1] = (byte) ((int) ((l >> 16) & 255));
        b[2] = (byte) ((int) ((l >> 8) & 255));
        b[3] = (byte) ((int) (255 & l));
        return b;
    }
