...
public abstract class ExemptionMechanismSpi {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: javax.crypto.ExemptionMechanismSpi.<init>():void, dex: 
    ...
    public ExemptionMechanismSpi() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: javax.crypto.ExemptionMechanismSpi.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: javax.crypto.ExemptionMechanismSpi.<init>():void");
    }
