...
/*  JADX ERROR: NullPointerException in pass: ExtractFieldInit
    ...
    */
public class Cipher {
    /* renamed from: -javax-crypto-Cipher$InitTypeSwitchesValues */
    private static final /* synthetic */ int[] f56-javax-crypto-Cipher$InitTypeSwitchesValues = null;
    ...
    enum InitType {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.InitType.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.InitType.<clinit>():void, dex: 
            */
    ...
    enum NeedToSet {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.NeedToSet.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.NeedToSet.<clinit>():void, dex: 
            */
    ...
    class SpiAndProviderUpdater {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:4:0x0006 A:{ExcHandler: java.security.InvalidKeyException (r0_0 'e' java.security.GeneralSecurityException), Splitter: B:1:0x0001} */
    ...
    /* renamed from: -getjavax-crypto-Cipher$InitTypeSwitchesValues */
    private static /* synthetic */ int[] m51-getjavax-crypto-Cipher$InitTypeSwitchesValues() {
        if (f56-javax-crypto-Cipher$InitTypeSwitchesValues != null) {
            return f56-javax-crypto-Cipher$InitTypeSwitchesValues;
        }
        ...
        f56-javax-crypto-Cipher$InitTypeSwitchesValues = iArr;
        return iArr;
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: javax.crypto.Cipher.<clinit>():void, dex: 
        */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:7:0x0029 A:{ExcHandler: java.security.InvalidKeyException (r1_0 'e' java.security.GeneralSecurityException), Splitter: B:1:0x0007} */
    ...
    static CipherSpiAndProvider tryTransformWithProvider(InitParams initParams, String[] tokenizedTransformation, NeedToSet type, Service service) throws InvalidKeyException, InvalidAlgorithmParameterException {
        try {
            ...
            if (initParams != null) {
                switch (m51-getjavax-crypto-Cipher$InitTypeSwitchesValues()[initParams.initType.ordinal()]) {
                    case 1:
