...
final class DexPathList {
    ...
    static class Element {
        ...
        public String toString() {
            ...
            String str = (this.dir == null || this.dir.getPath().isEmpty()) ? "" : ", dir \"" + this.dir + "\"";
    ...
    private static Element[] makeDexElements(ArrayList<File> files, File optimizedDirectory, ArrayList<IOException> suppressedExceptions) {
        return makePathElements((List) files, optimizedDirectory, (List) suppressedExceptions);
    }
    ...
    private static Element[] makeElements(List<File> files, File optimizedDirectory, List<IOException> suppressedExceptions, boolean ignoreDexFiles, ClassLoader loader) {
        ...
        for (File file : files) {
            ...
            if (zip == null && dex == null) {
                ...
                elements[elementsPos2] = new Element(dir, false, zip, dex);
            }
        }
