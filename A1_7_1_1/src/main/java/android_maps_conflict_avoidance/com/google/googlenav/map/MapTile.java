...
public class MapTile {
    private static final byte[] CJPG_HEADER = null;
    protected static final byte[] LAYER_DATA_HEADER = null;
    ...
    private static final Hashtable unicolorTiles = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android_maps_conflict_avoidance.com.google.googlenav.map.MapTile.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android_maps_conflict_avoidance.com.google.googlenav.map.MapTile.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android_maps_conflict_avoidance.com.google.googlenav.map.MapTile.<clinit>():void");
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.location != null) {
            return this.location.equals(imageTile.location);
        }
        if (imageTile.location != null) {
            return false;
        }
        return true;
    }
