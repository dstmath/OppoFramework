...
public class ProtoBuf {
    ...
    private static final SimpleCounter NULL_COUNTER = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: android_maps_conflict_avoidance.com.google.common.io.protocol.ProtoBuf.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: android_maps_conflict_avoidance.com.google.common.io.protocol.ProtoBuf.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: android_maps_conflict_avoidance.com.google.common.io.protocol.ProtoBuf.<clinit>():void");
    }

    public ProtoBuf(ProtoBufType type) {
        this.cachedSize = Integer.MIN_VALUE;
        this.msgType = type;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:53:0x0190 A:{RETURN} */
                ...
                if (wireType != 4) {
                    ...
                    switch (wireType) {
                        ...
                        case OverlayItem.ITEM_STATE_SELECTED_MASK /*2*/:
                            ...
                            if (tagType != 27) {
                                byte[] data = total == 0 ? EMPTY_BYTE_ARRAY : new byte[total];
                                int pos = 0;
                                while (pos < total) {
                        ...
                        case LayoutParams.LEFT /*3*/:
                            ...
                            if (this.msgType == null) {
                                ...
                                protoBufType = (ProtoBufType) this.msgType.getData(tag);
                            }
                            ProtoBuf group = new ProtoBuf(protoBufType);
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (wireType) {
                ...
                case LayoutParams.RIGHT /*5*/:
                    ...
                    break;
                case OverlayItem.ITEM_STATE_SELECTED_MASK /*2*/:
                    Object o = getObject(tag, i, getType(tag) == 27 ? 16 : 25);
