...
public class GLImpl implements GL10, GL10Ext, GL11, GL11Ext, GL11ExtensionPack {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.google.android.gles_jni.GLImpl.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.google.android.gles_jni.GLImpl.<clinit>():void, dex: 
        */
    ...
    private static boolean allowIndirectBuffers(String appName) {
        ...
        Log.e("OpenGLES", String.format("Application %s (SDK target %d) called a GL11 Pointer method with an indirect Buffer.", objArr));
        if (version <= 3) {
            return true;
        }
        return false;
    ...
    public void glNormalPointer(int type, int stride, Buffer pointer) {
        ...
        if ((type == GL10.GL_FLOAT || type == 5120 || type == GL10.GL_SHORT || type == GL10.GL_FIXED) && stride >= 0) {
