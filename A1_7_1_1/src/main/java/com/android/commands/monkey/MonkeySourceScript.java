...
public class MonkeySourceScript implements MonkeyEventSource {
    ...
    private static int LONGPRESS_WAIT_TIME = 0;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.commands.monkey.MonkeySourceScript.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.commands.monkey.MonkeySourceScript.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.commands.monkey.MonkeySourceScript.<clinit>():void");
    }
    ...
    public MonkeySourceScript(Random random, String filename, long throttle, boolean randomizeThrottle, long profileWaitTime, long deviceSleepTime) {
        ...
        this.mReadScriptLineByLine = false;
        ...
        this.mScriptStartTime = -1;
        this.mMonkeyStartTime = -1;
    ...
    private void handleEvent(String s, String[] args) {
        ...
        if (s.indexOf(EVENT_KEYWORD_KEY) >= 0 && args.length == 8) {
            ...
            if (s.indexOf(EVENT_KEYWORD_ACTIVITY) >= 0 && args.length >= 2) {
                ...
                if (args.length > 2) {
                    try {
                        ...
                        System.err.println("// " + e72.toString());
                        return;
                    }
                }
                if (args.length == 2) {
            ...
            try {
                ...
                System.err.println("// " + e722.toString());
            }
        }
    }
