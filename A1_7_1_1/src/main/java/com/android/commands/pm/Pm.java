...
public final class Pm {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.commands.pm.Pm.showUsage():int, dex: 
    ...
    private static int showUsage() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.commands.pm.Pm.showUsage():int, dex: 
        */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0083 A:{Splitter: B:10:0x0030, ExcHandler: android.content.pm.PackageParser.PackageParserException (r12_0 'e' java.lang.Exception)} */
            ...
            if (opt == null) {
                ...
                if ((flags & 8) != 0) {
                    ...
                    try {
                        ...
                        this.mAm.addSharedAccountsFromParentUser(parentUserId, userId);
                    } catch (RemoteException e) {
                        System.err.println(e.toString());
                        System.err.println(PM_NOT_RUNNING_ERR);
                        return 1;
                    ...
                    info = this.mUm.createProfileForUser(arg, flags, userId);
                }
                if (info != null) {
