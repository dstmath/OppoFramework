...
public class UiAutomatorTestRunner {
    ...
    private class FakeInstrumentationWatcher implements IInstrumentationWatcher {
        ...
        /* synthetic */ FakeInstrumentationWatcher(UiAutomatorTestRunner this$0, FakeInstrumentationWatcher fakeInstrumentationWatcher) {
            this();
        }
    ...
    private class SimpleResultPrinter extends ResultPrinter implements ResultReporter {
        ...
        public void printUnexpectedError(Throwable t) {
            if (this.mFullOutput) {
                ...
                getWriter().printf("Test run aborted due to unexpected exeption: %s", objArr);
    ...
    private class WatcherResultPrinter implements ResultReporter {
        ...
        public void addError(Test test, Throwable t) {
            ...
            objArr[REPORT_VALUE_RESULT_START] = BaseTestRunner.getFilteredTrace(t);
            this.mTestResult.putString("stream", String.format("\nError in %s:\n%s", objArr));
        ...
        public void print(TestResult result, long runTime, Bundle testOutput) {
            ...
            objArr[REPORT_VALUE_RESULT_START] = this.mStream.toString();
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.testrunner.UiAutomatorTestRunner.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.testrunner.UiAutomatorTestRunner.<clinit>():void, dex: 
        */
    ...
    public UiAutomatorTestRunner() {
        ...
        this.mWatcher = new FakeInstrumentationWatcher(this, null);
    ...
    protected void start() {
        ...
        try {
            ...
            try {
                ...
                Log.i(LOGTAG, "all case run finished going to quit, HandlerThread quit result : " + this.mHandlerThread.quitSafely());
                try {
                    this.mHandlerThread.join();
