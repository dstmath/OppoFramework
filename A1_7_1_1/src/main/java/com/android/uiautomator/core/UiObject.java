...
public class UiObject {
    ...
    private static boolean sRetryWhileWatcherMatched;
    private final Configurator mConfig;
    private final UiSelector mSelector;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.core.UiObject.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.core.UiObject.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.uiautomator.core.UiObject.<clinit>():void");
    }
    ...
    public String getText() throws UiObjectNotFoundException {
        ...
        Object[] objArr = new Object[1];
        objArr[0] = retVal;
        Log.d(str, String.format("getText() = %s", objArr));
        return retVal;
    }
    ...
    public String getClassName() throws UiObjectNotFoundException {
        ...
        Object[] objArr = new Object[1];
        objArr[0] = retVal;
        Log.d(str, String.format("getClassName() = %s", objArr));
        return retVal;
    }
    ...
    public boolean performTwoPointerGesture(Point startPoint1, Point startPoint2, Point endPoint1, Point endPoint2, int steps) {
        ...
        p2.size = 1.0f;
        points2[steps + 1] = p2;
        PointerCoords[][] pointerCoordsArr = new PointerCoords[2][];
        pointerCoordsArr[0] = points1;
        pointerCoordsArr[1] = points2;
        return performMultiPointerGesture(pointerCoordsArr);
    }
