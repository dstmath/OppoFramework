...
public class UiScrollable extends UiCollection {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.core.UiScrollable.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.uiautomator.core.UiScrollable.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.uiautomator.core.UiScrollable.<clinit>():void");
    }
    ...
    public UiObject getChildByDescription(UiSelector childPattern, String text, boolean allowScrollSearch) throws UiObjectNotFoundException {
        ...
        objArr[0] = childPattern;
        objArr[1] = text;
        objArr[2] = Boolean.valueOf(allowScrollSearch);
        Tracer.trace(objArr);
        if (text != null) {
    ...
    public UiObject getChildByInstance(UiSelector childPattern, int instance) throws UiObjectNotFoundException {
        Object[] objArr = new Object[2];
        objArr[0] = childPattern;
        objArr[1] = Integer.valueOf(instance);
        Tracer.trace(objArr);
    ...
    public UiScrollable setMaxSearchSwipes(int swipes) {
        Object[] objArr = new Object[1];
        objArr[0] = Integer.valueOf(swipes);
        Tracer.trace(objArr);
    ...
    public boolean scrollToBeginning(int maxSwipes, int steps) throws UiObjectNotFoundException {
        Object[] objArr = new Object[2];
        objArr[0] = Integer.valueOf(maxSwipes);
        objArr[1] = Integer.valueOf(steps);
        Tracer.trace(objArr);
    ...
    public UiScrollable setSwipeDeadZonePercentage(double swipeDeadZonePercentage) {
        Object[] objArr = new Object[1];
        objArr[0] = Double.valueOf(swipeDeadZonePercentage);
        Tracer.trace(objArr);
