...
public class UiAutomationShellWrapper {
    ...
    private class DummyActivityController extends Stub {
        /* synthetic */ DummyActivityController(UiAutomationShellWrapper this$0, DummyActivityController dummyActivityController) {
            this();
        }
    ...
    public void disconnect() {
        if (this.mHandlerThread.isAlive()) {
            ...
            Log.i(TAG, "disconnect finished, HandlerThread Quit result " + this.mHandlerThread.quitSafely());
            try {
