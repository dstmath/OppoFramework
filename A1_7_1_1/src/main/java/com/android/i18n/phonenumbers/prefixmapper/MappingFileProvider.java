...
public class MappingFileProvider implements Externalizable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.i18n.phonenumbers.prefixmapper.MappingFileProvider.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.i18n.phonenumbers.prefixmapper.MappingFileProvider.<clinit>():void, dex: 
        */
    ...
    String getFileName(int countryCallingCode, String language, String script, String region) {
        if (language.length() == 0 || this.countryCallingCodes == null || this.availableLanguages == null) {
            return "";
        }
