...
public final class TrustManagerImpl extends X509ExtendedTrustManager {
    ...
    private static class ExtendedKeyUsagePKIXCertPathChecker extends PKIXCertPathChecker {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.ExtendedKeyUsagePKIXCertPathChecker.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.ExtendedKeyUsagePKIXCertPathChecker.<clinit>():void, dex: 
            */
        ...
        /* synthetic */ ExtendedKeyUsagePKIXCertPathChecker(boolean clientAuth, X509Certificate leaf, ExtendedKeyUsagePKIXCertPathChecker extendedKeyUsagePKIXCertPathChecker) {
    ...
    private static class TrustAnchorComparator implements Comparator<TrustAnchor> {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.TrustAnchorComparator.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.TrustAnchorComparator.<clinit>():void, dex: 
            */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.<clinit>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.api.JadxDecompiler.processClass(JadxDecompiler.java:292)
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.org.conscrypt.TrustManagerImpl.<clinit>():void, dex: 
        */
    ...
    private List<X509Certificate> verifyChain(List<X509Certificate> untrustedChain, List<TrustAnchor> trustAnchorChain, String host, boolean clientAuth) throws CertificateException {
        ...
        try {
            ...
            params.addCertPathChecker(new ExtendedKeyUsagePKIXCertPathChecker(clientAuth, (X509Certificate) untrustedChain.get(0), null));
