...
public final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getCurveByName(String curveName) {
        ...
        EC_GROUP groupRef = new EC_GROUP(ctx);
        NativeCrypto.EC_GROUP_set_point_conversion_form(groupRef, 4);
        NativeCrypto.EC_GROUP_set_asn1_flag(groupRef, 0);
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec params) throws InvalidAlgorithmParameterException {
        ...
        if (field instanceof ECFieldFp) {
            ...
            try {
                ...
                EC_GROUP ec_group = new EC_GROUP(group);
                NativeCrypto.EC_GROUP_set_point_conversion_form(ec_group, 4);
                return new OpenSSLECGroupContext(ec_group);
    ...
    public ECParameterSpec getECParameterSpec() {
        ...
        ECParameterSpec spec = new ECParameterSpec(new EllipticCurve(field, a, b), new OpenSSLECPointContext(this, new EC_POINT(NativeCrypto.EC_GROUP_get_generator(this.groupCtx))).getECPoint(), new BigInteger(NativeCrypto.EC_GROUP_get_order(this.groupCtx)), new BigInteger(NativeCrypto.EC_GROUP_get_cofactor(this.groupCtx)).intValue());
