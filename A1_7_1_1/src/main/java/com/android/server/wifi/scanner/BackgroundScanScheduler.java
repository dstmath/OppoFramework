...
public class BackgroundScanScheduler {
    ...
    private static final int EXPONENTIAL_BACK_OFF_BUCKET_IDX = 0;
    private static final int NUM_OF_REGULAR_BUCKETS = 0;
    private static final int PERIOD_MIN_GCD_MS = 10000;
    private static final int[] PREDEFINED_BUCKET_PERIODS = null;
    private static final String TAG = "BackgroundScanScheduler";
    private final BucketList mBuckets;
    private final ChannelHelper mChannelHelper;
    private int mMaxApPerScan;
    private int mMaxBatch;
    private int mMaxBuckets;
    private int mMaxChannelsPerBucket;
    private ScanSettings mSchedule;
    private final Map<WifiScanner.ScanSettings, Bucket> mSettingsToScheduledBucket;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.scanner.BackgroundScanScheduler.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.scanner.BackgroundScanScheduler.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.scanner.BackgroundScanScheduler.<clinit>():void");
    }
    ...
    public BackgroundScanScheduler(ChannelHelper channelHelper) {
        this.mMaxBuckets = 8;
        this.mMaxChannelsPerBucket = 16;
        this.mMaxBatch = 10;
        this.mMaxApPerScan = 32;
        this.mBuckets = new BucketList();
        this.mSettingsToScheduledBucket = new HashMap();
        ...
        for (Bucket bucket : bucketList) {
            ...
            for (WifiScanner.ScanSettings settings : bucket.getSettingsList()) {
                ...
                if (settings.hiddenNetworkIds != null) {
                    for (int valueOf : settings.hiddenNetworkIds) {
