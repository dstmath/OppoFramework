...
public class Policy {
    ...
    private static class MinBackhaul {
        ...
        /* synthetic */ MinBackhaul(OMANode node, MinBackhaul minBackhaul) {
            this(node);
        }
    ...
    private static class PreferredRoamingPartner {
        ...
        /* synthetic */ PreferredRoamingPartner(OMANode node, PreferredRoamingPartner preferredRoamingPartner) {
            this(node);
        }
    ...
    public Policy(OMANode node) throws OMAException {
        ...
        if (rpNode == null) {
            ...
            for (OMANode instance : rpNode.getChildren()) {
                ...
                this.mPreferredRoamingPartners.add(new PreferredRoamingPartner(instance, null));
            }
        }
        ...
        if (bhtNode == null) {
            ...
            for (OMANode instance2 : bhtNode.getChildren()) {
                ...
                this.mMinBackhaulThresholds.add(new MinBackhaul(instance2, null));
            }
        }
