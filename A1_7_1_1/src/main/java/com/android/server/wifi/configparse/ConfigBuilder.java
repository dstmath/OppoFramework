...
public class ConfigBuilder {
    ...
    private static final /* synthetic */ int[] f10-com-android-server-wifi-anqp-eap-EAP$EAPMethodIDSwitchesValues = null;
    /* renamed from: -com-android-server-wifi-anqp-eap-NonEAPInnerAuth$NonEAPTypeSwitchesValues */
    private static final /* synthetic */ int[] f11x4565a7a7 = null;
    ...
    private static /* synthetic */ int[] m10x55a4ef8b() {
        if (f10-com-android-server-wifi-anqp-eap-EAP$EAPMethodIDSwitchesValues != null) {
            return f10-com-android-server-wifi-anqp-eap-EAP$EAPMethodIDSwitchesValues;
        }
        ...
        f10-com-android-server-wifi-anqp-eap-EAP$EAPMethodIDSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getcom-android-server-wifi-anqp-eap-NonEAPInnerAuth$NonEAPTypeSwitchesValues */
    private static /* synthetic */ int[] m11xba111b4b() {
        if (f11x4565a7a7 != null) {
            return f11x4565a7a7;
        }
    ...
    private static WifiConfiguration buildConfig(HomeSP homeSP, X509Certificate caCert, List<X509Certificate> clientChain, PrivateKey key) throws IOException, GeneralSecurityException {
        ...
        switch (m10x55a4ef8b()[eapMethodID.ordinal()]) {
            case 1:
            case 2:
            case 3:
                if (!(key == null && clientChain == null && caCert == null)) {
                    Log.i(TAG, "Client/CA cert and/or key unnecessarily included with " + eapMethodID + " profile");
                }
                return buildSIMConfig(homeSP);
            case 4:
                return buildTLSConfig(homeSP, clientChain, key, caCert);
            case 5:
    ...
    private static void setAnonymousIdentityToNaiRealm(WifiConfiguration config, Credential credential) {
        config.enterpriseConfig.setAnonymousIdentity("anonymous@" + credential.getRealm());
    }

    private static WifiConfiguration buildTTLSConfig(HomeSP homeSP, X509Certificate caCert) throws IOException {
    ...
    private static WifiConfiguration buildTLSConfig(HomeSP homeSP, List<X509Certificate> clientChain, PrivateKey clientKey, X509Certificate caCert) throws IOException, GeneralSecurityException {
        Credential credential = homeSP.getCredential();
    ...
    private static int remapInnerMethod(NonEAPType type) throws IOException {
        switch (m11xba111b4b()[type.ordinal()]) {
            case 2:
                return 2;
            case 3:
                return 3;
