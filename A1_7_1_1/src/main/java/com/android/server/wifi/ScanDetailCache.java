...
public class ScanDetailCache {
    ...
    private ConcurrentHashMap<String, ScanDetail> mMap = new ConcurrentHashMap(16, 0.75f, 2);
    private ConcurrentHashMap<String, PasspointMatchInfo> mPasspointMatches = new ConcurrentHashMap(16, 0.75f, 2);
