...
public class WifiNetworkRecord {
    ...
    public WifiNetworkRecord(String configkey, String bssid, int netid, int rssi, int connSuccCout, int connFailCount, long accessNetTime, long lastuseTime, int netFailCount, int maxSpeed, boolean networkValid, WifiConfiguration wcf) {
    ...
    public WifiNetworkRecord(String configkey, String bssid, int netid, int rssi, int bestRssi, int connSuccCout, int connFailCount, long accessNetTime, long lastuseTime, int netFailCount, int maxSpeed, int averageSpeed, String position, boolean is5G, boolean networkValid, WifiConfiguration wcf) {
        this.mConfigkey = configkey;
        this.mBssid = bssid;
        this.mNetid = netid;
        this.mRssi = rssi;
    ...
    public WifiNetworkRecord(WifiNetworkRecord mwr) {
