...
public class MOTree {
    ...
    private static class NodeData {
        ...
        /* synthetic */ NodeData(String name, NodeData nodeData) {
            this(name);
        }
    ...
    public MOTree(XMLNode node, String urn) throws IOException, SAXException {
        ...
        this.mUrn = urn;
        this.mDtdRev = dtdRev;
        this.mRoot = new ManagementTreeRoot(node, dtdRev);
        ...
        if (node.getTag().equals(NodeTag)) {
            ...
            for (XMLNode child : node.getChildren()) {
                ...
                if (tag.equals(NodeNameTag)) {
                    ...
                    curValue = new NodeData(child.getText(), null);
                    ...
                    context = getNextNode(getNextNode(child, TypeTag), DDFNameTag).getText();
                    if (context == null) {
