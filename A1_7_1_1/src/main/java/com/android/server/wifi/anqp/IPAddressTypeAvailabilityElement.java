...
public class IPAddressTypeAvailabilityElement extends ANQPElement {
    ...
    public enum IPv4Availability {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.anqp.IPAddressTypeAvailabilityElement.IPv4Availability.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.anqp.IPAddressTypeAvailabilityElement.IPv4Availability.<clinit>():void, dex: 
            */
    ...
    public enum IPv6Availability {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.anqp.IPAddressTypeAvailabilityElement.IPv6Availability.<clinit>():void, dex: 
            	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:254)
            	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.anqp.IPAddressTypeAvailabilityElement.IPv6Availability.<clinit>():void, dex: 
            */
