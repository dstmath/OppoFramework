...
public class PasspointMatchInfo implements Comparable<PasspointMatchInfo> {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.hotspot2.PasspointMatchInfo.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.wifi.hotspot2.PasspointMatchInfo.<clinit>():void, dex: 
        */
