...
public class FrameworkFacade {
    ...
    public BaseWifiLogger makeRealLogger(Context context, WifiStateMachine stateMachine, WifiNative wifiNative, BuildProperties buildProperties) {
    ...
    public SoftApManager makeSoftApManager(Context context, Looper looper, WifiNative wifiNative, INetworkManagementService nmService, ConnectivityManager cm, String countryCode, ArrayList<Integer> allowed2GChannels, Listener listener) {
        return new SoftApManager(looper, wifiNative, nmService, countryCode, allowed2GChannels, listener);
    }
    ...
    public void makeSupplicantWifiStatemachine(SupplicantStateTracker sst, WifiStateMachine wsm) {
        sst.setSupplicantWifistatemachine(wsm);
    }

    public void setWifiConfigManagerStatemachine(WifiConfigManager wcm, WifiStateMachine wsm) {
        wcm.mWifiStateMachine = wsm;
    }
}
