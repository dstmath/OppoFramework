...
public class TaskPersister {
    ...
    private static class WriteQueueItem {
        /* synthetic */ WriteQueueItem(WriteQueueItem writeQueueItem) {
            this();
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:63:0x0118 A:{SYNTHETIC} */
                                    ...
                                    if (task != null) {
                                        ...
                                        if (this.mStackSupervisor.anyTaskForIdLocked(taskId, false, 0) != null) {
                                            ...
                                            if (userId != task.userId) {
                                                Slog.e(TAG, "Task with userId " + task.userId + " found in " + userTasksDir.getAbsolutePath());
                                            } else {
    ...
    public static void removeAllTasksRecordForReboot(int userId) {
