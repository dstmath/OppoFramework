...
public final class ProcessStatsService extends Stub {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.am.ProcessStatsService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.am.ProcessStatsService.<clinit>():void, dex: 
        */
    ...
    public ProcessStatsService(ActivityManagerService am, File file) {
        ...
        if (this.mCtmFlag) {
            ProcessStats.setName(this.mCtmName);
        }
            ...
            if (isCsv) {
                ...
                if (isCheckin || isCompact) {
                    ...
                    if (dumpDetails || dumpFullDetails) {
                        processStats2.dumpLocked(pw, reqPackage, now, !dumpFullDetails, dumpAll, activeOnly);
                        if (dumpAll) {
                            pw.print("  mFile=");
                ...
                if (dumpAll || isCheckin) {
                    this.mWriteLock.lock();
                    try {
                        files = getCommittedFiles(0, false, !isCheckin);
                        if (files != null) {
