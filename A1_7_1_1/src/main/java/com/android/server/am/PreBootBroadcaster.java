        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    CharSequence title = context.getText(17040313);
                    ...
                    notifManager.notifyAsUser(PreBootBroadcaster.TAG, 0, new Builder(PreBootBroadcaster.this.mService.mContext).setSmallIcon(17303262).setWhen(0).setOngoing(true).setTicker(title).setDefaults(0).setPriority(2).setColor(context.getColor(17170523)).setContentTitle(title).setContentIntent(contentIntent).setVisibility(1).setProgress(max, index, false).build(), UserHandle.of(PreBootBroadcaster.this.mUserId));
                    return;
                case 2:
    ...
    public void sendNext() {
        if (this.mIndex >= this.mTargets.size()) {
            ...
            if (this.mProgress != null) {
                ...
                this.mProgress.setProgress(this.mIndex, this.mTargets.size(), this.mService.mContext.getString(17040317, new Object[]{label}));
            }
