...
public class EventLogTags {
    ...
    public static void writeAmPauseActivity(int user, int token, String componentName, String reason) {
        EventLog.writeEvent(AM_PAUSE_ACTIVITY, new Object[]{Integer.valueOf(user), Integer.valueOf(token), componentName, reason});
    }
    ...
    public static void writeAmFocusedActivity(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_FOCUSED_ACTIVITY, new Object[]{Integer.valueOf(user), componentName, reason});
    }
    ...
    public static void writeAmPss(int pid, int uid, String processName, long pss, long uss, long swappss) {
        EventLog.writeEvent(AM_PSS, new Object[]{Integer.valueOf(pid), Integer.valueOf(uid), processName, Long.valueOf(pss), Long.valueOf(uss), Long.valueOf(swappss)});
    }
