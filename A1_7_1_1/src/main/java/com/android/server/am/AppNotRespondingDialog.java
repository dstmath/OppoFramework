    ...
    public AppNotRespondingDialog(ActivityManagerService service, Context context, ProcessRecord app, ActivityRecord activity, boolean aboveSystem) {
        ...
        if (app.pkgList.size() == 1) {
            ...
            if (name2 != null) {
                ...
                setTitle(string);
                setButton(-3, res.getText(17040296), this.mHandler.obtainMessage(1));
                setButton(-2, res.getText(17040298), this.mHandler.obtainMessage(2));
                if (app.errorReportReceiver != null) {
                    setButton(-3, res.getText(17040297), this.mHandler.obtainMessage(3));
                }
                if (aboveSystem) {
