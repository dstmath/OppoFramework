...
public class VoiceInteractionManagerService extends SystemService {
     ...
     */
            ...
            return;
     */
            /* JADX WARNING: Missing block: B:43:0x00da, code:
            return;
     */
        ...
        public void initForUser(int userHandle) {
            ...
            if (!(this.mEnableService || curInteractorStr == null || TextUtils.isEmpty(curInteractorStr))) {
                ...
                curInteractorStr = IElsaManager.EMPTY_PACKAGE;
            }
            if (curRecognizer != null) {
                IPackageManager pm = AppGlobals.getPackageManager();
                Object interactorInfo = null;
                Object recognizerInfo = null;
        ...
        private String getForceVoiceInteractionServicePackage(Resources res) {
            String interactorPackage = res.getString(17039466);
        ...
        /* JADX WARNING: Removed duplicated region for block: B:17:0x005a A:{Splitter: B:15:0x004a, ExcHandler: java.lang.RuntimeException (r7_0 'e' java.lang.Exception)} */
        /* JADX WARNING: Missing block: B:17:0x005a, code:
            r7 = move-exception;
     */
        /* JADX WARNING: Missing block: B:18:0x005b, code:
            android.util.Slog.wtf(com.android.server.voiceinteraction.VoiceInteractionManagerService.TAG, "Bad voice interaction service name " + r6, r7);
            r5 = null;
            r8 = null;
     */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        ...
        void setCurInteractor(ComponentName comp, int userHandle) {
            Secure.putStringForUser(VoiceInteractionManagerService.this.mContext.getContentResolver(), "voice_interaction_service", comp != null ? comp.flattenToShortString() : IElsaManager.EMPTY_PACKAGE, userHandle);
        ...
        void setCurRecognizer(ComponentName comp, int userHandle) {
            Secure.putStringForUser(VoiceInteractionManagerService.this.mContext.getContentResolver(), "voice_recognition_service", comp != null ? comp.flattenToShortString() : IElsaManager.EMPTY_PACKAGE, userHandle);
        ...
        ComponentName getCurAssistant(int userHandle) {
            ...
            Slog.d(VoiceInteractionManagerService.TAG, "getCurAssistant curAssistant=" + curAssistant + " user=" + userHandle);
