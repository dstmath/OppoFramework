...
public class ComprehensiveCountryDetector extends CountryDetectorBase {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.location.ComprehensiveCountryDetector.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.location.ComprehensiveCountryDetector.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.location.ComprehensiveCountryDetector.<clinit>():void");
    }
    ...
    void runAfterDetection(Country country, Country detectedCountry, boolean notifyChange, boolean startLocationBasedDetection) {
        ...
        if (DEBUG) {
            String str2 = TAG;
            StringBuilder append = new StringBuilder().append("startLocationBasedDetection=").append(startLocationBasedDetection).append(" detectCountry=");
            if (detectedCountry != null) {
                str = "(source: " + detectedCountry.getSource() + ", countryISO: " + detectedCountry.getCountryIso() + ")";
            }
            Slog.d(str2, append.append(str).append(" isAirplaneModeOff()=").append(isAirplaneModeOff()).append(" mListener=").append(this.mListener).append(" isGeoCoderImplemnted()=").append(isGeoCoderImplemented()).toString());
        }
    ...
    private void notifyIfCountryChanged(Country country, Country detectedCountry) {
        if (detectedCountry != null && this.mListener != null) {
            if (country == null || !country.equals(detectedCountry)) {
                if (DEBUG) {
                    Slog.d(TAG, IElsaManager.EMPTY_PACKAGE + country + " --> " + detectedCountry);
                }
