...
public class MmsServiceBroker extends SystemService {
    ...
    private final class BinderService extends Stub {
        ...
        /* synthetic */ BinderService(MmsServiceBroker this$0, BinderService binderService) {
            this();
        }
        ...
        public void sendMessage(int subId, String callingPkg, Uri contentUri, String locationUrl, Bundle configOverrides, PendingIntent sentIntent) throws RemoteException {
            ...
            MmsServiceBroker.this.mContext.enforceCallingPermission(OppoPermissionConstants.PERMISSION_SEND_SMS, "Send MMS message");
        ...
        public void downloadMessage(int subId, String callingPkg, String locationUrl, Uri contentUri, Bundle configOverrides, PendingIntent downloadedIntent) throws RemoteException {
            ...
            MmsServiceBroker.this.mContext.enforceCallingPermission(OppoPermissionConstants.PERMISSION_RECEIVE_MMS, "Download MMS message");
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.MmsServiceBroker.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.MmsServiceBroker.<clinit>():void, dex: 
        */
    ...
    private IMms getOrConnectService() {
        synchronized (this) {
            ...
            long shouldEnd = SystemClock.elapsedRealtime() + 4000;
            for (long waitTime = 4000; waitTime > 0; waitTime = shouldEnd - SystemClock.elapsedRealtime()) {
                try {
                    wait(waitTime);
