...
final class LogicalDisplay {
    private static final double ANTI_OVERSCAN_RATIO = 1.0d;
    ...
    public void configureDisplayInTransactionLocked(DisplayDevice device, boolean isBlanked) {
        ...
        if (displayDeviceInfo.type == 3) {
            displayRectWidth = (int) (((double) displayRectWidth) * ANTI_OVERSCAN_RATIO);
            displayRectHeight = (int) (((double) displayRectHeight) * ANTI_OVERSCAN_RATIO);
        }
