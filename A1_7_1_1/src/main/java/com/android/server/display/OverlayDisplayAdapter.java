...
final class OverlayDisplayAdapter extends DisplayAdapter {
    ...
    private final class OverlayDisplayHandle implements Listener {
        ...
        public void dumpLocked(PrintWriter pw) {
            ...
            if (this.mWindow != null) {
                ...
                ipw.increaseIndent();
                DumpUtils.dumpAsync(OverlayDisplayAdapter.this.mUiHandler, this.mWindow, ipw, IElsaManager.EMPTY_PACKAGE, 200);
            }
        }
    }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.display.OverlayDisplayAdapter.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.display.OverlayDisplayAdapter.<clinit>():void, dex: 
        */
    ...
    public OverlayDisplayAdapter(SyncRoot syncRoot, Context context, Handler handler, DisplayAdapter.Listener listener, Handler uiHandler) {
        ...
        this.mCurrentOverlaySetting = IElsaManager.EMPTY_PACKAGE;
            ...
            while (true) {
                ...
                if (displayMatcher.matches()) {
                    ...
                    if (!modes.isEmpty()) {
                        ...
                        String name = resources.getString(17040660, objArr);
