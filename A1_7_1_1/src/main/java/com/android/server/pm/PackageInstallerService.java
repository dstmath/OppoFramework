...
public class PackageInstallerService extends Stub {
    ...
    @GuardedBy("mSessions")
    private final SparseBooleanArray mAllocatedSessions;
    ...
    static class PackageDeleteObserverAdapter extends PackageDeleteObserver {
        ...
        public PackageDeleteObserverAdapter(Context context, IntentSender target, String packageName, boolean showNotification, int userId) {
            ...
            if (showNotification) {
                this.mNotification = PackageInstallerService.buildSuccessNotification(this.mContext, this.mContext.getResources().getString(17040835), packageName, userId);
            } else {
        ...
        public void onPackageDeleted(String basePackageName, int returnCode, String msg) {
            if (1 == returnCode && this.mNotification != null) {
                ((NotificationManager) this.mContext.getSystemService(NotificationManagerService.NOTIFICATON_TITLE_NAME)).notify(basePackageName, 0, this.mNotification);
            }
            Intent fillIn = new Intent();
            fillIn.putExtra("android.content.pm.extra.PACKAGE_NAME", this.mPackageName);
        ...
        public void onPackageInstalled(String basePackageName, int returnCode, String msg, Bundle extras) {
            if (1 == returnCode && this.mShowNotification) {
                ...
                if (notification != null) {
                    ((NotificationManager) this.mContext.getSystemService(NotificationManagerService.NOTIFICATON_TITLE_NAME)).notify(basePackageName, 0, notification);
                }
            }
            Intent fillIn = new Intent();
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.pm.PackageInstallerService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.pm.PackageInstallerService.<clinit>():void, dex: 
        */
    ...
    public PackageInstallerService(Context context, PackageManagerService pm) {
        ...
        this.mAllocatedSessions = new SparseBooleanArray();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0081 A:{Splitter: B:1:0x0007, ExcHandler: java.io.IOException (r3_0 'e' java.lang.Exception), PHI: r4 } */
            ...
            switch (params.mode) {
                ...
                case 2:
                    ...
                    synchronized (this.mSessions) {
                        ...
                        } else if (((long) getSessionCount(this.mHistoricalSessions, callingUid)) >= MAX_HISTORICAL_SESSIONS) {
    ...
    private static Notification buildSuccessNotification(Context context, String contentText, String basePackageName, int userId) {
        ...
        return new Builder(context).setSmallIcon(17302278).setColor(context.getResources().getColor(17170523)).setContentTitle(packageInfo.applicationInfo.loadLabel(pm)).setContentText(contentText).setStyle(new BigTextStyle().bigText(contentText)).setLargeIcon(ImageUtils.buildScaledBitmap(packageInfo.applicationInfo.loadIcon(pm), context.getResources().getDimensionPixelSize(17104901), context.getResources().getDimensionPixelSize(17104902))).build();
    }
