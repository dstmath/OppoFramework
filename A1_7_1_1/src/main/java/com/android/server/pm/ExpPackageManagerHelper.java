...
public class ExpPackageManagerHelper {
    private static final ArrayMap<String, String> APP_NEED_DEL_DEPS = null;
    private static final boolean DEBUG = false;
    private static final String TAG = "ExpPackageManagerHelper";

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.server.pm.ExpPackageManagerHelper.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.server.pm.ExpPackageManagerHelper.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.pm.ExpPackageManagerHelper.<clinit>():void");
    }
