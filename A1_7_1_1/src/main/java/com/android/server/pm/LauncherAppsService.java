    ...
    static class LauncherAppsImpl extends Stub {
        ...
        private class MyPackageMonitor extends PackageMonitor implements ShortcutChangeListener {
            ...
            final /* synthetic */ class -void_onShortcutChanged_java_lang_String_packageName_int_userId_LambdaImpl0 implements Runnable {
                ...
                public /* synthetic */ -void_onShortcutChanged_java_lang_String_packageName_int_userId_LambdaImpl0(String str, int i) {
                    this.val$packageName = str;
                    this.val$userId = i;
                }

                public void run() {
                    MyPackageMonitor.this.-com_android_server_pm_LauncherAppsService$LauncherAppsImpl$MyPackageMonitor_lambda$1(this.val$packageName, this.val$userId);
                }
            }

            /* synthetic */ MyPackageMonitor(LauncherAppsImpl this$1, MyPackageMonitor myPackageMonitor) {
                this();
            }
            ...
            public void onShortcutChanged(String packageName, int userId) {
                LauncherAppsImpl.this.postToPackageMonitorHandler(new -void_onShortcutChanged_java_lang_String_packageName_int_userId_LambdaImpl0(packageName, userId));
            }
        ...
        public boolean startShortcut(String callingPackage, String packageName, String shortcutId, Rect sourceBounds, Bundle startActivityOptions, int userId) {
            ...
            if (isUserEnabled(userId)) {
                ...
                Intent[] intents = this.mShortcutServiceInternal.createShortcutIntents(getCallingUserId(), callingPackage, packageName, shortcutId, userId);
                if (intents == null || intents.length == 0) {
                    return false;
                }
                intents[0].addFlags(268435456);
                intents[0].setSourceBounds(sourceBounds);
                return startShortcutIntentsAsPublisher(intents, packageName, startActivityOptions, userId);
            }
