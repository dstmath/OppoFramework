...
class ShortcutUser {
    ...
    final /* synthetic */ class -void_attemptToRestoreIfNeededAndSave_com_android_server_pm_ShortcutService_s_java_lang_String_packageName_int_packageUserId_LambdaImpl0 implements Consumer {
        public void accept(Object arg0) {
            ((ShortcutPackageItem) arg0).-com_android_server_pm_ShortcutUser_lambda$3();
        }
    }

    final /* synthetic */ class -void_detectLocaleChange__LambdaImpl0 implements Consumer {
        public void accept(Object arg0) {
            ShortcutUser.m45-com_android_server_pm_ShortcutUser_lambda$2((ShortcutPackage) arg0);
        }
    }
    ...
    final /* synthetic */ class -void_forPackageItem_java_lang_String_packageName_int_packageUserId_java_util_function_Consumer_callback_LambdaImpl0 implements Consumer {
        ...
        public void accept(Object arg0) {
            ShortcutUser.m44-com_android_server_pm_ShortcutUser_lambda$1(this.val$packageUserId, this.val$packageName, this.val$callback, (ShortcutPackageItem) arg0);
        }
    }

    final /* synthetic */ class -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl0 implements Consumer {
        private /* synthetic */ ShortcutService val$s;

        public /* synthetic */ -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl0(ShortcutService shortcutService) {
            this.val$s = shortcutService;
        }

        public void accept(Object arg0) {
            ShortcutUser.this.m46-com_android_server_pm_ShortcutUser_lambda$4(this.val$s, (ShortcutLauncher) arg0);
        }
    }

    final /* synthetic */ class -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl1 implements Consumer {
        private /* synthetic */ ShortcutService val$s;

        public /* synthetic */ -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl1(ShortcutService shortcutService) {
            this.val$s = shortcutService;
        }

        public void accept(Object arg0) {
            ShortcutUser.this.m47-com_android_server_pm_ShortcutUser_lambda$5(this.val$s, (ShortcutPackage) arg0);
        }
    }
    ...
    public ShortcutPackage getPackageShortcutsIfExists(String packageName) {
        ...
        if (ret != null) {
            ret.-com_android_server_pm_ShortcutUser_lambda$3();
        }
        return ret;
    }
    ...
    /* renamed from: -com_android_server_pm_ShortcutUser_lambda$1 */
    static /* synthetic */ void m44-com_android_server_pm_ShortcutUser_lambda$1(int packageUserId, String packageName, Consumer callback, ShortcutPackageItem spi) {
    ...
    public void onCalledByPublisher(String packageName) {
        -com_android_server_pm_ShortcutService_lambda$13();
    ...
    public void -com_android_server_pm_ShortcutService_lambda$13() {
    ...
    /* renamed from: -com_android_server_pm_ShortcutUser_lambda$2 */
    static /* synthetic */ void m45-com_android_server_pm_ShortcutUser_lambda$2(ShortcutPackage pkg) {
    ...
    public void attemptToRestoreIfNeededAndSave(ShortcutService s, String packageName, int packageUserId) {
        forPackageItem(packageName, packageUserId, new -void_attemptToRestoreIfNeededAndSave_com_android_server_pm_ShortcutService_s_java_lang_String_packageName_int_packageUserId_LambdaImpl0());
    }
    ...
    public void mergeRestoredFile(ShortcutUser restored) {
        ...
        restored.forAllLaunchers(new -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl0(s));
        restored.forAllPackages(new -void_mergeRestoredFile_com_android_server_pm_ShortcutUser_restored_LambdaImpl1(s));
        restored.mLaunchers.clear();
        restored.mPackages.clear();
    }

    /* renamed from: -com_android_server_pm_ShortcutUser_lambda$4 */
    /* synthetic */ void m46-com_android_server_pm_ShortcutUser_lambda$4(ShortcutService s, ShortcutLauncher sl) {
        if (!s.isPackageInstalled(sl.getPackageName(), getUserId()) || s.shouldBackupApp(sl.getPackageName(), getUserId())) {
            addLauncher(sl);
        }
    }

    /* renamed from: -com_android_server_pm_ShortcutUser_lambda$5 */
    /* synthetic */ void m47-com_android_server_pm_ShortcutUser_lambda$5(ShortcutService s, ShortcutPackage sp) {
