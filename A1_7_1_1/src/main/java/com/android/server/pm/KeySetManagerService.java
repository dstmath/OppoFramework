...
public class KeySetManagerService {
    ...
    class PublicKeyHandle {
        ...
        /* synthetic */ PublicKeyHandle(KeySetManagerService this$0, long id, int refCount, PublicKey key, PublicKeyHandle publicKeyHandle) {
    ...
    void writeKeySetManagerServiceLPr(XmlSerializer serializer) throws IOException {
        ...
        serializer.attribute(null, CompatibilityHelper.VERSION_NAME, Integer.toString(1));
    ...
    void readKeySetsLPw(XmlPullParser parser, ArrayMap<Long, Integer> keySetRefCounts) throws XmlPullParserException, IOException {
        ...
        String recordedVersionStr = parser.getAttributeValue(null, CompatibilityHelper.VERSION_NAME);
        int type;
