...
public class ClipRectTBAnimation extends ClipRectAnimation {
    ...
    public boolean getTransformation(long currentTime, Transformation outTransformation) {
        ...
        float normalizedTime = duration != 0 ? ((float) (currentTime - (getStartTime() + startOffset))) / ((float) duration) : currentTime < getStartTime() ? OppoBrightUtils.MIN_LUX_LIMITI : 1.0f;
