...
class TaskPositioner implements DimLayerUser {
    ...
    private final class WindowPositionerEventReceiver extends BatchedInputEventReceiver {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:16:0x0036 A:{Catch:{ Exception -> 0x00b4, all -> 0x0153 }} */
        /* JADX WARNING: Removed duplicated region for block: B:16:0x0036 A:{Catch:{ Exception -> 0x00b4, all -> 0x0153 }} */
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.wm.TaskPositioner.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.wm.TaskPositioner.<clinit>():void, dex: 
        */
