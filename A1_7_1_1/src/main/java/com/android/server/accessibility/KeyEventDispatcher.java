...
public class KeyEventDispatcher {
    ...
    private final Pool<PendingKeyEvent> mPendingEventPool = new SimplePool(10);
    ...
    private class Callback implements android.os.Handler.Callback {
        /* synthetic */ Callback(KeyEventDispatcher this$0, Callback callback) {
            this();
        }
    ...
    private static final class PendingKeyEvent {
        ...
        /* synthetic */ PendingKeyEvent(PendingKeyEvent pendingKeyEvent) {
            this();
        }
    ...
    public KeyEventDispatcher(Handler handlerToSendKeyEventsToInputFilter, int messageTypeForSendKeyEvent, Object lock, PowerManager powerManager) {
        ...
        this.mKeyEventTimeoutHandler = new Handler(this.mHandlerToSendKeyEventsToInputFilter.getLooper(), new Callback(this, null));
        this.mLock = lock;
    ...
    public boolean notifyKeyEventLocked(KeyEvent event, int policyFlags, List<Service> boundServices) {
        ...
        for (int i = 0; i < boundServices.size(); i++) {
            ...
            if (!(!service.mRequestFilterKeyEvents || service.mServiceInterface == null || (service.mAccessibilityServiceInfo.getCapabilities() & 8) == 0)) {
                try {
