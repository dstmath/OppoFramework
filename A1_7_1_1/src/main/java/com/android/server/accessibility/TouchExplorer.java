...
class TouchExplorer implements EventStreamTransformation, Listener {
    ...
    private final class ExitGestureDetectionModeDelayed implements Runnable {
        /* synthetic */ ExitGestureDetectionModeDelayed(TouchExplorer this$0, ExitGestureDetectionModeDelayed exitGestureDetectionModeDelayed) {
            this();
        }
    ...
    class ReceivedPointerTracker {
        ...
        public void clear() {
            Arrays.fill(this.mReceivedPointerDownX, OppoBrightUtils.MIN_LUX_LIMITI);
            Arrays.fill(this.mReceivedPointerDownY, OppoBrightUtils.MIN_LUX_LIMITI);
            ...
            this.mLastReceivedUpPointerDownX = OppoBrightUtils.MIN_LUX_LIMITI;
            this.mLastReceivedUpPointerDownY = OppoBrightUtils.MIN_LUX_LIMITI;
        }
        ...
        private void handleReceivedPointerUp(int pointerIndex, MotionEvent event) {
            ...
            this.mReceivedPointersDown &= ~pointerFlag;
            this.mReceivedPointerDownX[pointerId] = OppoBrightUtils.MIN_LUX_LIMITI;
            this.mReceivedPointerDownY[pointerId] = OppoBrightUtils.MIN_LUX_LIMITI;
    ...
    private int computeClickLocation(Point outLocation) {
        ...
        } else if (this.mAms.getAccessibilityFocusClickPointInScreen(outLocation)) {
            return 1;
        } else {
            return 0;
        }
