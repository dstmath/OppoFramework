...
public class ColorOSDeviceIdleHelper {
    ...
    private static final String SAVED_WHITE_LIST_USER_SET_XML_PATH = "/data/system/doze_wl_user_set_local.xml";
    ...
    private static final String SYSTEM_XML_PATH = "/system/etc/sys_deviceidle_whitelist.xml";
    ...
    private volatile boolean mAutoPowerModesEnabled;
    private BroadcastReceiver mBroadcastReceiver;
    ContentObserver mConstants;
    private Context mContext;
    private long mDelayWeakWhiteListInactive;
    private DeviceIdleController mDeviceIdleController;
    DeviceIdleStatistics mDeviceIdleStatistics;
    private WorkerHandler mHandler;
    private boolean mHasAlarmPending;
    private boolean mIsDeepIdleEntered;
    private boolean mIsLightIdleEntered;
    private final Object mLock;
    private PackageManager mPackageManager;
    private PowerManager mPowerManager;
    private boolean mRestrictWeakListApp;
    private int mThreshHourRestrictWeakList;
    private long mTimestampScreenoff;
    private long mTotalIntervalToIdle;
    private PendingIntent mUploadIntent;
    private UsageStatsManagerInternal mUsageStats;
    private WakeLock mWakelock;
    private PendingIntent mWeakListIntent;
    private ArrayList<String> mWeakWhiteList;
    private ArrayList<String> mWeakWhiteListThisTime;
    private ArrayList<String> mWhiteListAll;
    ...
    class DeviceIdleStatistics {
        ...
        void onDeepIdleStart() {
            if (ColorOSDeviceIdleHelper.OPPODEBUG) {
    ...
    private class WorkerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (ColorOSDeviceIdleHelper.OPPODEBUG) {
                Slog.d(ColorOSDeviceIdleHelper.TAG, "msg=" + msg.what);
            }
            if (msg.what == 1) {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.ColorOSDeviceIdleHelper.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.ColorOSDeviceIdleHelper.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.ColorOSDeviceIdleHelper.<clinit>():void");
    }

    public ColorOSDeviceIdleHelper(Context context, DeviceIdleController controller, ContentObserver constants) {
        this.mWhiteListAll = new ArrayList();
        this.mWeakWhiteList = new ArrayList();
        this.mWeakWhiteListThisTime = new ArrayList();
        this.mDelayWeakWhiteListInactive = 1800000;
        this.mIsDeepIdleEntered = false;
        this.mIsLightIdleEntered = false;
        this.mLock = new Object();
        this.mHasAlarmPending = false;
        ...
        if (dozeLocalConfig == 1) {
            ...
            this.mAutoPowerModesEnabled = context.getResources().getBoolean(17956883);
        }
    ...
    private void addPkgToDeviceIdleController(ArrayList<String> listPkg) {
        for (int i = 0; i < listPkg.size(); i++) {
            ...
            if (pkgName != null && !this.mDeviceIdleController.isPowerSaveWhitelistAppInternal(pkgName) && this.mDeviceIdleController.addPowerSaveWhitelistAppInternal(pkgName) && OPPODEBUG) {
    ...
    private void getListFromProvider(ArrayList<String> whiteListAll, ArrayList<String> whiteListWeak) {
        ...
        try {
            ...
            cursor = this.mContext.getContentResolver().query(CONTENT_URI_WHITE_LIST, projection, "filtername=\"sys_deviceidle_whitelist\"", null, null);
    ...
    private void getListFromSystem(ArrayList<String> whiteListAll, ArrayList<String> whiteListWeak) {
        Exception e;
        Throwable th;
        if (whiteListAll.isEmpty() || whiteListWeak.isEmpty()) {
            ...
            if (!(pkgName == null || this.mWhiteListAll.contains(pkgName))) {
                ...
                if (!this.mDeviceIdleController.isPowerSaveWhitelistAppInternal(pkgName)) {
                    if (this.mDeviceIdleController.addPowerSaveWhitelistAppInternal(pkgName)) {
                        ...
                        Slog.d(TAG, "whiteListChanged: not installed " + pkgName);
                    }
                }
            }
        }
