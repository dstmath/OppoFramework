...
public final class MediaProjectionManagerService extends SystemService implements Monitor {
    ...
    private final class BinderService extends Stub {
        /* synthetic */ BinderService(MediaProjectionManagerService this$0, BinderService binderService) {
            this();
        }
    ...
    private class MediaRouterCallback extends SimpleCallback {
        /* synthetic */ MediaRouterCallback(MediaProjectionManagerService this$0, MediaRouterCallback mediaRouterCallback) {
            this();
        }
