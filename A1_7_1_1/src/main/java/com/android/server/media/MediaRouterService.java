...
public final class MediaRouterService extends Stub implements Monitor {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.media.MediaRouterService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.media.MediaRouterService.<clinit>():void, dex: 
        */
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                pw.println();
                userRecord.dump(pw, IElsaManager.EMPTY_PACKAGE);
            }
        }
    }
