...
public class ImmersiveModeConfirmation {
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909190)).setOnClickListener(new OnClickListener() {
            ...
            if (ActivityManager.isHighEndGfx()) {
                ...
                cling.setAlpha(OppoBrightUtils.MIN_LUX_LIMITI);
                cling.setTranslationY(-96.0f * density);
                postOnAnimation(new Runnable() {
                    public void run() {
                        cling.animate().alpha(1.0f).translationY(OppoBrightUtils.MIN_LUX_LIMITI).setDuration(250).setInterpolator(ClingWindowView.this.mInterpolator).withLayer().start();
    ...
    private final class H extends Handler {
        ...
        /* synthetic */ H(ImmersiveModeConfirmation this$0, H h) {
            this();
        }
    ...
    public ImmersiveModeConfirmation(Context context) {
        ...
        this.mPanicThresholdMs = (long) context.getResources().getInteger(17694865);
    ...
    public void immersiveModeChangedLw(String pkg, boolean isImmersiveMode, boolean userSetupComplete, boolean navBarEmpty) {
        ...
        } else if (!PolicyControl.disableImmersiveConfirmation(pkg) && !this.mConfirmed && userSetupComplete && !this.mVrModeEnabled && !navBarEmpty && !UserManager.isDeviceInDemoMode(this.mContext)) {
    ...
    public LayoutParams getClingWindowLayoutParams() {
        LayoutParams lp = new LayoutParams(-1, -1, 2014, 16777472, -3);
        lp.privateFlags |= 16;
        lp.setTitle(TAG);
