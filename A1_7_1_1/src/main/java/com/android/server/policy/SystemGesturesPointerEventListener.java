...
public class SystemGesturesPointerEventListener implements PointerEventListener {
    ...
    private final class FlingGestureDetector extends SimpleOnGestureListener {
        /* synthetic */ FlingGestureDetector(SystemGesturesPointerEventListener this$0, FlingGestureDetector flingGestureDetector) {
            this();
        }
    ...
    public SystemGesturesPointerEventListener(Context context, Callbacks callbacks) {
        ...
        this.mSwipeStartThreshold = ((Context) checkNull("context", context)).getResources().getDimensionPixelSize(17104921);
