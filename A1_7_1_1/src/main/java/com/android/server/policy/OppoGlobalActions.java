...
/*  JADX ERROR: NullPointerException in pass: ExtractFieldInit
    java.lang.NullPointerException
    	...
    	at jadx.api.JadxDecompiler.lambda$appendSourcesSave$0(JadxDecompiler.java:200)
    */
class OppoGlobalActions implements ComponentCallbacks {
    ...
    private OnEmergencyListener mOnEmergency;
    private OnShutDownListener mOnShutDown;
    ...
    private PowerViewContainer powerView;
    ...
    private class InnovativeV2HAction implements Action {
        ...
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            this.view = inflater.inflate(201917502, parent, false);
            ColorGlobalActionView itemView = (ColorGlobalActionView) this.view.findViewById(201458828);
            if (itemView != null) {
    ...
    private class MyAdapter extends BaseAdapter {
        /* synthetic */ MyAdapter(OppoGlobalActions this$0, MyAdapter myAdapter) {
            this();
        }
    ...
    private static class PowerViewContainer extends LinearLayout {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            ...
            this.mStatusBarManager.setShortcutsPanelState(0);
            ...
            if (event.getAction() == 1) {
                ...
                if (!(state == null || !isTracking || isCanceled || this == null)) {
                    removePowerPicture();
                    return true;
                }
            }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.policy.OppoGlobalActions.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.policy.OppoGlobalActions.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.policy.OppoGlobalActions.<clinit>():void");
    }
    ...
    public OppoGlobalActions(Context context, WindowManagerFuncs windowManagerFuncs) {
        ...
        this.mBroadcastReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                if ("android.intent.action.CLOSE_SYSTEM_DIALOGS".equals(action) || "android.intent.action.SCREEN_OFF".equals(action)) {
                    ...
                    if (!PhoneWindowManager.SYSTEM_DIALOG_REASON_GLOBAL_ACTIONS.equals(reason) && !PhoneWindowManager.SYSTEM_DIALOG_REASON_RECENT_APPS.equals(reason)) {
        ...
        this.mHandler = new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 0:
                        if (OppoGlobalActions.this.powerView != null) {
        ...
        this.mOnShutDown = new OnShutDownListener() {
        ...
        this.mOnCancel = new OnCancelListener() {
            public void onCancel() {
                OppoGlobalActions.this.mHandler.sendEmptyMessageDelayed(0, 0);
            }
        };
        this.mOnEmergency = new OnEmergencyListener() {
    ...
    public void showDialog(boolean keyguardShowing, boolean isDeviceProvisioned) {
        ...
        if (this.powerView == null) {
            ...
            this.mStatusBarManager.setShortcutsPanelState(1);
            handleShow();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (this.mPreviousOrientation != newConfig.orientation) {
            removePowerView();
        }
    }
    ...
    private void handleShow() {
        this.powerView = (PowerViewContainer) View.inflate(this.mContext, 201917521, null);
        LayoutParams lp = new LayoutParams(-1, -1, 2300, 198912, -3);
        initialize();
        try {
            this.powerView.getViewRootImpl();
            ViewRootImpl.addConfigCallback(this);
            this.mWindowManager.addView(this.powerView, lp);
            this.powerView.deliveryValue(this.mWindowManager);
            this.powerView.setOnChangeListener(new OnChangeListener() {
                public void onChange() {
                    OppoGlobalActions.this.powerView = null;
                }
            });
    ...
    private void setGaussianBlur() {
        ...
        dims[0] = (float) this.mDisplayMetrics.widthPixels;
        dims[1] = (float) this.mDisplayMetrics.heightPixels;
        ...
        if (this.mScreenBitmap != null) {
            ...
            this.mScreenBitmap = GaussianBlur.getInstance().generateGaussianBitmap(this.mScreenBitmap, 0.3f, false);
            BitmapDrawable mBitmapDrawable = new BitmapDrawable(this.mContext.getResources(), this.mScreenBitmap);
            if (mBitmapDrawable != null && this.powerView != null) {
                this.powerView.setBackgroundDrawable(mBitmapDrawable);
                return;
            }
            return;
        }
        if (this.powerView != null) {
            this.powerView.setBackgroundColor(mDefaultBackground);
        }
    }
    ...
    private void initialize() {
        ...
        if (isMultiUser) {
            ...
            for (final UserInfo user : users) {
                ...
                this.mItems.add(new SinglePressAction(201852032, (user.name != null ? user.name : "Primary") + (isCurrentUser ? " ✔" : IElsaManager.EMPTY_PACKAGE)) {
                    public void onPress() {
                        try {
        ...
        for (i = 0; i < this.mAdapter.getCount() && this.powerView != null; i++) {
            this.powerView.addView(this.mAdapter.getView(i, null, null));
        }
    ...
    public void removePowerView() {
        if (this.powerView != null) {
            try {
                if (this.powerView.isAttachedToWindow()) {
                    this.mWindowManager.removeView(this.powerView);
                    this.mStatusBarManager.setShortcutsPanelState(0);
                    this.powerView = null;
                }
            } catch (Exception exce) {
