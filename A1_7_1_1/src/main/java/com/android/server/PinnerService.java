...
public final class PinnerService extends SystemService {
    ...
    private final long MAX_CAMERA_PIN_SIZE = 52428800;
    ...
    private final class BinderService extends Binder {
        /* synthetic */ BinderService(PinnerService this$0, BinderService binderService) {
            this();
        }
    ...
    public PinnerService(Context context) {
        ...
        this.mShouldPinCamera = context.getResources().getBoolean(17957043);
    ...
    private void handlePinOnStart() {
        String[] filesToPin = this.mContext.getResources().getStringArray(17236044);
        synchronized (this) {
    ...
    private boolean pinCamera(int userHandle) {
        ...
        PinnedFile pf = pinFile(camAPK, 0, 0, 52428800);
        if (pf == null) {
        ...
        String odex = null;
        try {
            odex = DexFile.getDexFileOutputPath(cameraInfo.getBaseCodePath(), arch);
        } catch (IOException e) {
        }
        if (odex == null) {
            return true;
        }
        pf = pinFile(odex, 0, 0, 52428800);
        if (pf != null) {
            this.mPinnedCameraFiles.add(pf);
        }
        return true;
