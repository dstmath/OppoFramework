...
class Owners {
    ...
    private static abstract class FileReadWriter {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:23:0x006e A:{Splitter: B:4:0x0012, ExcHandler: org.xmlpull.v1.XmlPullParserException (r1_0 'e' java.lang.Exception), PHI: r3 } */
     ...
     */
        /* JADX WARNING: Missing block: B:25:?, code:
            android.util.Slog.e(com.android.server.devicepolicy.Owners.TAG, "Error parsing device-owner file", r1);
     */
    ...
    static class OwnerInfo {
        ...
        public OwnerInfo(String name, String packageName, boolean userRestrictionsMigrated, String remoteBugreportUri, String remoteBugreportHash) {
            ...
            this.admin = new ComponentName(packageName, IElsaManager.EMPTY_PACKAGE);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x005f A:{Splitter: B:4:0x0008, ExcHandler: org.xmlpull.v1.XmlPullParserException (r13_0 'e' java.lang.Exception)} */
    /* JADX WARNING: Missing block: B:14:0x005f, code:
            r13 = move-exception;
     */
    /* JADX WARNING: Missing block: B:15:0x0060, code:
            android.util.Slog.e(TAG, "Error parsing device-owner file", r13);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
            ...
            while (true) {
                ...
                if (type == 1) {
                    ...
                    if (tag.equals(TAG_DEVICE_OWNER)) {
                        this.mDeviceOwner = new OwnerInfo(parser.getAttributeValue(null, ATTR_NAME), parser.getAttributeValue(null, ATTR_PACKAGE), false, null, null);
