...
public class GestureLauncherService extends SystemService {
    ...
    private final class GestureEventListener implements SensorEventListener {
        /* synthetic */ GestureEventListener(GestureLauncherService this$0, GestureEventListener gestureEventListener) {
            this();
        }
    ...
    private void registerCameraLaunchGesture(Resources resources) {
        if (!this.mRegistered) {
            ...
            int cameraLaunchGestureId = resources.getInteger(17694883);
            if (cameraLaunchGestureId != -1) {
                this.mRegistered = false;
                String sensorName = resources.getString(17039468);
    ...
    public static boolean isCameraLaunchEnabled(Resources resources) {
        boolean configSet;
        if (resources.getInteger(17694883) != -1) {
            configSet = true;
        } else {
            configSet = false;
        }
    ...
    public static boolean isCameraDoubleTapPowerEnabled(Resources resources) {
        return resources.getBoolean(17957034);
    }
    ...
    public boolean interceptPowerKeyDown(KeyEvent event, boolean interactive, MutableBoolean outLaunched) {
        ...
        synchronized (this) {
            ...
            if (this.mCameraDoubleTapPowerEnabled && doubleTapInterval < 300) {
                launched = true;
