...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
    ...
    private class PeopleRankingReconsideration extends RankingReconsideration {
        ...
        /* synthetic */ PeopleRankingReconsideration(ValidateNotificationPeople this$0, Context context, String key, LinkedList pendingLookups, PeopleRankingReconsideration peopleRankingReconsideration) {
        ...
        public void work() {
            ...
            if (this.mRecord != null) {
                ValidateNotificationPeople.this.mUsageStats.registerPeopleAffinity(this.mRecord, this.mContactAffinity > 0.0f, this.mContactAffinity == ValidateNotificationPeople.STARRED_CONTACT, false);
            }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.notification.ValidateNotificationPeople.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.notification.ValidateNotificationPeople.<clinit>():void, dex: 
        */
    ...
    private PeopleRankingReconsideration validatePeople(Context context, String key, Bundle extras, float[] affinityOut) {
        ...
        int personIdx = 0;
        while (personIdx < people.length && personIdx < 10) {
