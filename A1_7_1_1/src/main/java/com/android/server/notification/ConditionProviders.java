...
public class ConditionProviders extends ManagedServices {
    ...
    private final ArraySet<String> mSystemConditionProviderNames = safeSet(PropConfig.getStringArray(this.mContext, "system.condition.providers", 17236040));
    ...
    private static class ConditionRecord {
        ...
        /* synthetic */ ConditionRecord(Uri id, ComponentName component, ConditionRecord conditionRecord) {
            this(id, component);
        }
    ...
    /* JADX WARNING: Missing block: B:24:0x0068, code:
            if (r9.mCallback == null) goto L_0x0071;
     */
