...
public class RankingHelper implements RankingConfig {
    ...
    private static class Record {
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.notification.RankingHelper.Record.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.notification.RankingHelper.Record.<clinit>():void, dex: 
            */
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (r == null) {
                ...
                for (int j = 0; j < currentSize; j++) {
                    Slog.d(TAG, "j: " + j + ",record: " + ((String) this.mRecords.keyAt(j)));
    ...
    public void sort(ArrayList<NotificationRecord> notificationList) {
        ...
        synchronized (this.mProxyByGroupTmp) {
            ...
            for (i = 0; i < N; i++) {
                ...
                } else if (groupSortKey.equals(IElsaManager.EMPTY_PACKAGE)) {
    ...
    public void onPackagesChanged(boolean removingPackage, String[] pkgList) {
        if (removingPackage && pkgList != null && pkgList.length != 0 && !this.mRestoredWithoutUids.isEmpty()) {
            PackageManager pm = this.mContext.getPackageManager();
