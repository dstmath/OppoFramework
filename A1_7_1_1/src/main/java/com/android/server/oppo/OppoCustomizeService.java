...
public class OppoCustomizeService extends Stub {
    ...
    private ArrayList<String> mProtectApplist;

    private class PackageDataObserver extends IPackageDataObserver.Stub {
        /* synthetic */ PackageDataObserver(OppoCustomizeService this$0, PackageDataObserver packageDataObserver) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.oppo.OppoCustomizeService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.oppo.OppoCustomizeService.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.oppo.OppoCustomizeService.<clinit>():void");
    }

    public OppoCustomizeService(Context context) {
        this.clearList = new ArrayList();
        this.mProtectApplist = new ArrayList();
    ...
    /* JADX WARNING: Missing block: B:24:0x007a, code:
            if (r6.equals("OTG_ENABLED") == false) goto L_0x0042;
     */
