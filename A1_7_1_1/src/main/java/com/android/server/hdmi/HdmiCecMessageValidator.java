...
public final class HdmiCecMessageValidator {
    ...
    private class PhysicalAddressValidator implements ParameterValidator {
        /* synthetic */ PhysicalAddressValidator(HdmiCecMessageValidator this$0, PhysicalAddressValidator physicalAddressValidator) {
            this();
        }
    ...
    private class ReportPhysicalAddressValidator implements ParameterValidator {
        /* synthetic */ ReportPhysicalAddressValidator(HdmiCecMessageValidator this$0, ReportPhysicalAddressValidator reportPhysicalAddressValidator) {
            this();
        }
    ...
    private class RoutingChangeValidator implements ParameterValidator {
        /* synthetic */ RoutingChangeValidator(HdmiCecMessageValidator this$0, RoutingChangeValidator routingChangeValidator) {
            this();
        }
    ...
    private class SystemAudioModeRequestValidator extends PhysicalAddressValidator {
        /* synthetic */ SystemAudioModeRequestValidator(HdmiCecMessageValidator this$0, SystemAudioModeRequestValidator systemAudioModeRequestValidator) {
            this();
        }
    ...
    public HdmiCecMessageValidator(HdmiControlService service) {
        ...
        addValidationInfo(OppoGameSpaceManager.MSG_SEND_GAME_STOP, oneByteValidator, 1);
