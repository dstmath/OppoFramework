...
final class HdmiCecLocalDeviceTv extends HdmiCecLocalDevice {
    ...
    private void notifyArcStatusToAudioService(boolean enabled) {
        this.mService.getAudioManager().setWiredDeviceConnectionState(DumpState.DUMP_DOMAIN_PREFERRED, enabled ? 1 : 0, IElsaManager.EMPTY_PACKAGE, IElsaManager.EMPTY_PACKAGE);
    }
    ...
    /* JADX WARNING: Missing block: B:15:0x0034, code:
            if (r0.isEmpty() == false) goto L_0x004f;
     */
