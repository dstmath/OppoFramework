...
public final class HdmiControlService extends SystemService {
    ...
    private final class BinderService extends Stub {
        /* synthetic */ BinderService(HdmiControlService this$0, BinderService binderService) {
            this();
        }
        ...
        public HdmiDeviceInfo getActiveSource() {
            ...
            if (activeSource.isValid()) {
                return new HdmiDeviceInfo(activeSource.logicalAddress, activeSource.physicalAddress, -1, -1, 0, IElsaManager.EMPTY_PACKAGE);
            }
    ...
    private final class CecMessageBuffer {
        ...
        /* synthetic */ CecMessageBuffer(HdmiControlService this$0, CecMessageBuffer cecMessageBuffer) {
            this();
        }
    ...
    private class HdmiControlBroadcastReceiver extends BroadcastReceiver {
        /* synthetic */ HdmiControlBroadcastReceiver(HdmiControlService this$0, HdmiControlBroadcastReceiver hdmiControlBroadcastReceiver) {
            this();
        }
    ...
    private void registerContentObserver() {
        ...
        for (String s : new String[]{"hdmi_control_enabled", "hdmi_control_auto_wakeup_enabled", "hdmi_control_auto_device_off_enabled", "mhl_input_switching_enabled", "mhl_power_charge_enabled"}) {
