...
public class SyncManager {
    ...
    final /* synthetic */ class -void__init__android_content_Context_context_boolean_factoryTest_LambdaImpl0 implements OnAppPermissionChangeListener {
        public void onAppPermissionChanged(Account arg0, int arg1) {
            SyncManager.this.m22-com_android_server_content_SyncManager_lambda$2(arg0, arg1);
        }
    }

    final /* synthetic */ class -void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_long_minDelayMillis_LambdaImpl0 implements OnResultListener {
        private /* synthetic */ AccountAndUser val$account;
        private /* synthetic */ String val$authority;
        private /* synthetic */ Bundle val$finalExtras;
        private /* synthetic */ long val$minDelayMillis;
        private /* synthetic */ int val$reason;
        private /* synthetic */ int val$targetSyncState;
        private /* synthetic */ int val$userId;

        public /* synthetic */ -void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_long_minDelayMillis_LambdaImpl0(AccountAndUser accountAndUser, int i, int i2, String str, Bundle bundle, int i3, long j) {
            this.val$account = accountAndUser;
            this.val$userId = i;
            this.val$reason = i2;
            this.val$authority = str;
            this.val$finalExtras = bundle;
            this.val$targetSyncState = i3;
            this.val$minDelayMillis = j;
        }

        public void onResult(Bundle arg0) {
            SyncManager.this.m23-com_android_server_content_SyncManager_lambda$3(this.val$account, this.val$userId, this.val$reason, this.val$authority, this.val$finalExtras, this.val$targetSyncState, this.val$minDelayMillis, arg0);
        }
    }
    ...
    private static class AccountSyncStats {
        ...
        /* synthetic */ AccountSyncStats(String name, AccountSyncStats accountSyncStats) {
            this(name);
        }
    ...
    class ActiveSyncContext extends Stub implements ServiceConnection, DeathRecipient {
        ...
        boolean bindToSyncAdapter(ComponentName serviceComponent, int userId) {
            ...
            intent.putExtra("android.intent.extra.client_label", 17040507);
            intent.putExtra("BINDSERVICE_FROM_SYNC", true);
    ...
    private static class AuthoritySyncStats {
        ...
        /* synthetic */ AuthoritySyncStats(String name, AuthoritySyncStats authoritySyncStats) {
            this(name);
        }
    ...
    static class PrintTable {
        ...
        void set(int row, int col, Object... values) {
            ...
            for (int i = this.mTable.size(); i <= row; i++) {
                ...
                for (int j = 0; j < this.mCols; j++) {
                    list[j] = IElsaManager.EMPTY_PACKAGE;
                }
            }
        ...
        void writeTo(PrintWriter out) {
            ...
            for (int col = 0; col < this.mCols; col++) {
                ...
                objArr[0] = Integer.valueOf(maxLength);
                formats[col] = String.format("%%-%ds", objArr);
            }
        ...
        private void printRow(PrintWriter out, String[] formats, Object[] row) {
            ...
            for (int j = 0; j < rowLength; j++) {
                String str = formats[j];
                Object[] objArr = new Object[1];
                objArr[0] = row[j].toString();
                out.printf(String.format(str, objArr), new Object[0]);
                out.print("  ");
            }
            out.println();
        }
    ...
    class SyncHandler extends Handler {
            ...
            try {
                ...
                switch (msg.what) {
                    ...
                    case 8:
                        ...
                        Log.w("SyncManager", String.format("Detected sync making no progress for %s. cancelling.", objArr));
        ...
        private void updateRunningAccountsH(EndPoint syncTargets) {
            ...
            synchronized (SyncManager.this.mActiveSyncContexts) {
            ...
            AccountAndUser[] -get14 = SyncManager.this.mRunningAccounts;
            int i = 0;
            int length = -get14.length;
            while (i < length) {
                AccountAndUser aau = -get14[i];
                ...
                switch (computeSyncOpState(syncOperation)) {
                    ...
                    case 2:
                        ...
                        if (SyncManager.this.mPackageManagerInternal.wasPackageEverLaunched(packageName, userId)) {
                            SyncManager.this.mAccountManagerInternal.requestAccountAccess(syncOperation.target.account, packageName, userId, new RemoteCallback(new SyncManager$SyncHandler$-void_updateOrAddPeriodicSyncH_com_android_server_content_SyncStorageEngine$EndPoint_target_long_pollFrequency_long_flex_android_os_Bundle_extras_LambdaImpl0(this, target, pollFrequency, flex, extras)));
                            return;
                        }
                        return;
                    default:
        ...
        /* renamed from: -com_android_server_content_SyncManager$SyncHandler_lambda$1 */
        /* synthetic */ void m24-com_android_server_content_SyncManager$SyncHandler_lambda$1(EndPoint target, long pollFrequency, long flex, Bundle extras, Bundle result) {
        ...
        private boolean dispatchSyncOperation(SyncOperation op) {
            ...
            if (targetComponent != null) {
                pkgName = targetComponent.getPackageName();
            }
            if (OppoAbnormalAppManager.getInstance().isScreenOffRestrictApp(pkgName)) {
                Log.d("SyncManager", "dispatchSyncOperation: pkg{" + pkgName + "} is screen off Restrict App, skip sync!!!");
                return false;
            } else if (!SyncManager.this.mColorOsLowPowerModeEnabled.get() || op == null || op.reason != -4 || targetUid < 10000 || SyncManager.this.mTopPkg.equals(pkgName)) {
                ...
                if (op != null && op.reason == -4) {
                    ...
                    if (OppoProcessManagerHelper.isDelayAppSync(targetUid, pkg)) {
                        Log.i("SyncManager", "dispatchSyncOperation: pkg{" + pkg + "} for bpm, skip sync");
                        return false;
                    }
                }
                if (op.reason == -4) {
                    ...
                    if (OppoListManager.getInstance().isInAccountSyncWhiteList(pkgName)) {
                        syncMap.put("SyncResult", "ALLOW");
                        OppoStatistics.onCommon(SyncManager.this.mContext, "AccountSyncManageID", "AccountSyncManageEvent", syncMap, false);
                    } else {
                        Log.d("SyncManager", "dispatchSyncOperation: pkg{" + pkgName + "} is not allow to do sync automatically, skip sync!!!");
                        syncMap.put("SyncResult", "DENY");
                        OppoStatistics.onCommon(SyncManager.this.mContext, "AccountSyncManageID", "AccountSyncManageEvent", syncMap, false);
                        return false;
                    }
                } else if (op.reason == -8 || op.reason >= 0) {
                    syncMap = new HashMap();
                    syncMap.put("PackageName", pkgName);
                    syncMap.put("SyncResult", "USERSTART");
                    OppoStatistics.onCommon(SyncManager.this.mContext, "AccountSyncManageID", "AccountSyncManageEvent", syncMap, false);
                }
                ...
                if (activeSyncContext.bindToSyncAdapter(targetComponent, info.userId)) {
                    syncMap = new HashMap();
                    syncMap.put("PackageName", pkgName);
                    syncMap.put("SyncWay", Integer.toString(op.reason));
                    OppoStatistics.onCommon(SyncManager.this.mContext, "AccountSyncTag", "AccountSyncEventID", syncMap, false);
                    return true;
                }
                ...
                Log.d("SyncManager", "dispatchSyncOperation: skip pkg(" + pkgName + "). is low power mode");
                return false;
            }
        }
        ...
        private void installHandleTooManyDeletesNotification(Account account, String authority, long numDeletes, int userId) {
            if (SyncManager.this.mNotificationMgr != null) {
                ...
                if (providerInfo != null) {
                    ...
                    clickIntent.putExtra(OppoProcessManager.RESUME_REASON_PROVIDER_STR, authorityName.toString());
                    ...
                    if (isActivityAvailable(clickIntent)) {
                        ...
                        CharSequence tooManyDeletesDescFormat = SyncManager.this.mContext.getResources().getText(17039627);
                        Context contextForUser = SyncManager.this.getContextForUser(user);
                        Builder contentTitle = new Builder(contextForUser).setSmallIcon(17303260).setTicker(SyncManager.this.mContext.getString(17039625)).setWhen(System.currentTimeMillis()).setColor(contextForUser.getColor(17170523)).setContentTitle(contextForUser.getString(17039626));
    ...
    private class SyncTimeTracker {
        ...
        /* synthetic */ SyncTimeTracker(SyncManager this$0, SyncTimeTracker syncTimeTracker) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.content.SyncManager.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.content.SyncManager.<clinit>():void, dex: 
        */
    ...
    public SyncManager(Context context, boolean factoryTest) {
        ...
        this.mBootCompletedReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                SyncManager.this.mPowerManagerInternal = (PowerManagerInternal) LocalServices.getService(PowerManagerInternal.class);
                SyncManager.this.mPowerManagerInternal.registerColorOsLowPowerModeObserver(new LowPowerModeListener() {
                    public void onLowPowerModeChanged(boolean enabled) {
                        SyncManager.this.onLowPowerModeChangedInternal(enabled);
                    }
                });
                SyncManager.this.mColorOsLowPowerModeEnabled.set(SyncManager.this.mPowerManagerInternal.getColorOsLowPowerModeEnabled());
                OppoProtectEyeManagerService.setActivityChangedListener(SyncManager.this.mActivityChangedListener);
            }
        };
        ...
        this.mActivityChangedListener = new ActivityChangedListener() {
            public void onActivityChanged(String prePkg, String nextPkg) {
                if (nextPkg != null && !nextPkg.equals(SyncManager.this.mTopPkg) && !"com.coloros.recents".equals(nextPkg)) {
                    SyncManager.this.mTopPkg = nextPkg;
                }
            }
        };
        ...
        if (factoryTest) {
            ...
            this.mNotificationMgr = (NotificationManager) context.getSystemService(NotificationManagerService.NOTIFICATON_TITLE_NAME);
        }
    ...
    /* renamed from: -com_android_server_content_SyncManager_lambda$2 */
    /* synthetic */ void m22-com_android_server_content_SyncManager_lambda$2(Account account, int uid) {
    ...
    private void scheduleSync(Account requestedAccount, int userId, int reason, String requestedAuthority, Bundle extras, int targetSyncState, long minDelayMillis) {
        ...
        if (requestedAccount == null) {
            ...
            accounts2 = new AccountAndUser[1];
            accounts2[0] = new AccountAndUser(requestedAccount, userId);
        } else {
                                ...
                                if (isSyncable == 3) {
                                    ...
                                    try {
                                        if (this.mPackageManagerInternal.wasPackageEverLaunched(packageName, userId)) {
                                            this.mAccountManagerInternal.requestAccountAccess(account.account, packageName, userId, new RemoteCallback(new -void_scheduleSync_android_accounts_Account_requestedAccount_int_userId_int_reason_java_lang_String_requestedAuthority_android_os_Bundle_extras_int_targetSyncState_long_minDelayMillis_LambdaImpl0(account, userId, reason, authority, finalExtras, targetSyncState, minDelayMillis)));
                                        }
                                    ...
                                    if ((targetSyncState == -2 || targetSyncState == isSyncable) && (((SyncAdapterType) syncAdapterInfo.type).supportsUploading() || !uploadOnly)) {
                                        ...
                                        if (syncAllowed) {
                                            ...
                                            if (isSyncable == -1) {
                                                ...
                                                if (isLoggable) {
                                                    Slog.v("SyncManager", "scheduleSync: delay until " + delayUntil + ", source " + source + ", account " + account + ", authority " + authority + ", extras " + extras);
                                                }
    ...
    /* renamed from: -com_android_server_content_SyncManager_lambda$3 */
    /* synthetic */ void m23-com_android_server_content_SyncManager_lambda$3(AccountAndUser account, int userId, int reason, String authority, Bundle finalExtras, int targetSyncState, long minDelayMillis, Bundle result) {
        if (result != null) {
    ...
    protected void dumpSyncState(PrintWriter pw) {
        ...
        pw.print(this.mSyncHandler.mSyncTimeTracker.mLastWasSyncing ? IElsaManager.EMPTY_PACKAGE : "not ");
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                numArr[0] = account.account.name;
                numArr[1] = Integer.valueOf(account.userId);
                numArr[2] = account.account.type;
                pw.printf("Account %s u%d %s\n", numArr);
                pw.println("=======================================================================");
                PrintTable printTable = new PrintTable(12);
                String[] strArr = new Object[12];
                strArr[0] = "Authority";
                strArr[1] = "Syncable";
                strArr[2] = "Enabled";
                strArr[3] = "Delay";
                ...
                for (ServiceInfo<SyncAdapterType> syncAdapterType : sorted) {
                    if (((SyncAdapterType) syncAdapterType.type).accountType.equals(account.account.type)) {
                        ...
                        strArr = new Object[3];
                        strArr[0] = authority;
                        strArr[1] = Integer.valueOf(settings.syncable);
                        strArr[2] = Boolean.valueOf(settings.enabled);
                        printTable.set(row, 0, strArr);
                        Integer[] numArr2 = new Object[7];
                        numArr2[0] = Integer.valueOf(status.numSourceLocal);
                        numArr2[1] = Integer.valueOf(status.numSourcePoll);
                        numArr2[2] = Integer.valueOf(status.numSourcePeriodic);
                        numArr2[3] = Integer.valueOf(status.numSourceServer);
                        numArr2[4] = Integer.valueOf(status.numSourceUser);
                        numArr2[5] = Integer.valueOf(status.numSyncs);
                        numArr2[6] = DateUtils.formatElapsedTime(status.totalElapsedTime / 1000);
                        printTable.set(row, 4, numArr2);
                        int i4 = row;
                        if (settings.delayUntil > now) {
                            ...
                            if (settings.backoffTime > now) {
                                ...
                                printTable.set(i4, 12, strArr);
                                i4 = i3 + 1;
                                Long[] lArr = new Object[1];
                                lArr[0] = Long.valueOf(settings.backoffDelay / 1000);
                                printTable.set(i3, 12, lArr);
                            }
                        }
                        if (status.lastSuccessTime != 0) {
                            i3 = i4 + 1;
                            strArr = new Object[1];
                            strArr[0] = SyncStorageEngine.SOURCES[status.lastSuccessSource] + " " + "SUCCESS";
                            printTable.set(i4, 11, strArr);
                            i4 = i3 + 1;
                            strArr = new Object[1];
                            strArr[0] = formatTime(status.lastSuccessTime);
                            printTable.set(i3, 11, strArr);
                        }
                        if (status.lastFailureTime != 0) {
                            i3 = i4 + 1;
                            strArr = new Object[1];
                            strArr[0] = SyncStorageEngine.SOURCES[status.lastFailureSource] + " " + "FAILURE";
                            printTable.set(i4, 11, strArr);
                            i4 = i3 + 1;
                            strArr = new Object[1];
                            strArr[0] = formatTime(status.lastFailureTime);
                            printTable.set(i3, 11, strArr);
                            i3 = i4 + 1;
                            Object[] objArr = new Object[1];
    ...
    private void dumpRecentHistory(PrintWriter pw) {
        ...
        if (items != null && items.size() > 0) {
            ...
            if (totalElapsedTime > 0) {
                pw.println();
                Long[] lArr = new Object[2];
                lArr[0] = Long.valueOf(totalTimes);
                lArr[1] = Long.valueOf(totalElapsedTime / 1000);
                ...
                objArr = new Object[1];
                objArr[0] = Integer.valueOf(maxLength + 2);
                ...
                for (AuthoritySyncStats authoritySyncStats2 : arrayList) {
                    ...
                    objArr = new Object[2];
                    objArr[0] = Long.valueOf(elapsedTime / 1000);
                    objArr[1] = Long.valueOf((100 * elapsedTime) / totalElapsedTime);
                    String timeStr = String.format("%ds/%d%%", objArr);
                    objArr = new Object[2];
                    ...
                    strArr[1] = timesStr;
                    strArr[2] = timeStr;
                    pw.printf(authorityFormat, strArr);
                    ...
                    for (AccountSyncStats stats : arrayList2) {
                        ...
                        objArr[0] = Long.valueOf(elapsedTime / 1000);
                        objArr[1] = Long.valueOf((100 * elapsedTime) / totalElapsedTime);
                        timeStr = String.format("%ds/%d%%", objArr);
                        objArr = new Object[2];
                        objArr[0] = Integer.valueOf(times);
                        objArr[1] = Long.valueOf(((long) (times * 100)) / totalTimes);
                        ...
                        strArr[1] = timesStr;
                        strArr[2] = timeStr;
                        pw.printf(accountFormat, strArr);
                    }
                    pw.println(str);
                }
            }
            ...
            for (i = 0; i < N; i++) {
                ...
                if (lastEventTime == null) {
                    diffString = IElsaManager.EMPTY_PACKAGE;
                } else {
                    ...
                    if (diff < 60) {
                        ...
                        objArr = new Object[2];
                        objArr[0] = Long.valueOf(diff / 60);
                        objArr[1] = Long.valueOf(diff % 60);
                        diffString = String.format("%02d:%02d", objArr);
                    } else {
                        long sec = diff % DEFAULT_MAX_SYNC_RETRY_TIME_IN_SECONDS;
                        objArr = new Object[3];
                        objArr[0] = Long.valueOf(diff / DEFAULT_MAX_SYNC_RETRY_TIME_IN_SECONDS);
    ...
    String getPackageName(EndPoint endpoint) {
        ServiceInfo<SyncAdapterType> syncAdapterInfo = this.mSyncAdapters.getServiceInfo(SyncAdapterType.newKey(endpoint.provider, endpoint.account.type), endpoint.userId);
        if (syncAdapterInfo == null) {
            return null;
        }
    ...
    public String getPackageNameForEndPoint(EndPoint endpoint) {
        return getPackageName(endpoint);
    }
