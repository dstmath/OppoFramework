...
public class UsageStatsService extends SystemService implements StatsUpdatedListener {
    ...
    private final class BinderService extends Stub {
        /* synthetic */ BinderService(UsageStatsService this$0, BinderService binderService) {
            this();
        }
        ...
        public void setAppInactive(String packageName, boolean idle, int userId) {
            try {
                userId = ActivityManagerNative.getDefault().handleIncomingUser(Binder.getCallingPid(), Binder.getCallingUid(), userId, false, true, "setAppIdle", null);
    ...
    private class DeviceStateReceiver extends BroadcastReceiver {
        /* synthetic */ DeviceStateReceiver(UsageStatsService this$0, DeviceStateReceiver deviceStateReceiver) {
            this();
        }
    ...
    private final class LocalService extends UsageStatsManagerInternal {
        /* synthetic */ LocalService(UsageStatsService this$0, LocalService localService) {
            this();
        }
        ...
        public void updateAutoPowerSaveEnable(boolean enable) {
            if (enable != UsageStatsService.this.mRusAutoPowerSaveEnable) {
                UsageStatsService.this.mRusAutoPowerSaveEnable = enable;
                UsageStatsService.this.postOneTimeCheckIdleStates();
                Slog.d(UsageStatsService.TAG, "updateAutoPowerSaveEnable: mRusAutoPowerSaveEnable=" + UsageStatsService.this.mRusAutoPowerSaveEnable);
            }
        }
    }

    private class PackageReceiver extends BroadcastReceiver {
        /* synthetic */ PackageReceiver(UsageStatsService this$0, PackageReceiver packageReceiver) {
            this();
        }
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void updateSettings() {
            synchronized (UsageStatsService.this.mLock) {
                ...
                UsageStatsService.this.mAppIdleParoleIntervalMillis = this.mParser.getLong(KEY_PAROLE_INTERVAL, 86400000);
    ...
    private class UserActionsReceiver extends BroadcastReceiver {
        /* synthetic */ UserActionsReceiver(UsageStatsService this$0, UserActionsReceiver userActionsReceiver) {
            this();
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.usage.UsageStatsService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.usage.UsageStatsService.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.usage.UsageStatsService.<clinit>():void");
    }
        ...
        this.mDisplayListener = new DisplayListener() {
            ...
            public void onDisplayChanged(int displayId) {
                if (displayId == 0) {
                    ...
                    synchronized (UsageStatsService.this.mLock) {
                        UsageStatsService.this.mAppIdleHistory.updateDisplayLocked(displayOn, SystemClock.elapsedRealtime());
                    }
                }
            }
        };
    ...
    public void onStart() {
        ...
        if (this.mUsageStatsDir.exists()) {
            ...
            if (dozeConfigLocal == 1) {
                ...
                this.mRusAutoPowerSaveEnable = getContext().getResources().getBoolean(17956883);
            }
    ...
    /* JADX WARNING: Missing block: B:17:0x004f, code:
            if (r13.mEventType != 7) goto L_0x0045;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private boolean isAppIdleFiltered(String packageName, int appId, int userId, long elapsedRealtime) {
        if (packageName == null || !this.mAppIdleEnabled || appId < 10000 || packageName.equals("android") || !this.mRusAutoPowerSaveEnable) {
            return false;
        }
        ...
        try {
            ...
            for (i = apps.size() - 1; i >= 0; i--) {
                ...
                if (index < 0) {
                    ...
                    uidStates.setValueAt(index, (idle ? DumpState.DUMP_INSTALLS : 0) + (uidStates.valueAt(index) + 1));
                }
            }
            int numIdle = 0;
    ...
    private boolean isDeviceProvisioningPackage(String packageName) {
        String deviceProvisioningPackage = getContext().getResources().getString(17039478);
    ...
    private void flushToDiskLocked() {
        if (LocationManagerService.OPPO_FAKE_LOCATOIN_SWITCH_ON.equals(SystemProperties.get("SPECIAL_OPPO_CONFIG", "0"))) {
            Slog.i("cwt", "it is a aging version, not doing flush to disk");
            return;
        }
        int userCount = this.mUserState.size();
        for (int i = 0; i < userCount; i++) {
            ...
            while (eventType != 1) {
                switch (eventType) {
                    case 2:
                        ...
                        if (ColorOSDeviceIdleHelper.TAG_AUTO_POWER_SAVE_MODES_ENABLED.equals(strName)) {
                            try {
