...
public class NetworkScoreService extends Stub {
    ...
    private class NetworkScorerPackageMonitor extends PackageMonitor {
        ...
        /* synthetic */ NetworkScorerPackageMonitor(NetworkScoreService this$0, String mRegisteredPackage, NetworkScorerPackageMonitor networkScorerPackageMonitor) {
    ...
    void systemReady() {
        ...
        if (Global.getInt(cr, "network_scoring_provisioned", 0) == 0) {
            String defaultPackage = this.mContext.getResources().getString(17039462);
