...
public final class TvInputManagerService extends SystemService {
    ...
    private final class BinderService extends Stub {
        /* synthetic */ BinderService(TvInputManagerService this$0, BinderService binderService) {
            this();
        }
     ...
     */
        ...
        public ParcelFileDescriptor openDvbDevice(DvbDeviceInfo info, int device) throws RemoteException {
            ...
            switch (device) {
                case 0:
                    objArr = new Object[2];
                    objArr[0] = Integer.valueOf(info.getAdapterId());
                    objArr[1] = Integer.valueOf(info.getDeviceId());
                    deviceFileName = String.format("/dev/dvb%d.demux%d", objArr);
                    break;
                case 1:
                    objArr = new Object[2];
                    objArr[0] = Integer.valueOf(info.getAdapterId());
                    objArr[1] = Integer.valueOf(info.getDeviceId());
                    deviceFileName = String.format("/dev/dvb%d.dvr%d", objArr);
                    break;
                case 2:
                    objArr = new Object[2];
                    objArr[0] = Integer.valueOf(info.getAdapterId());
                    objArr[1] = Integer.valueOf(info.getDeviceId());
                    deviceFileName = String.format("/dev/dvb%d.frontend%d", objArr);
                    break;
                default:
                    try {
                ...
                for (i = 0; i < TvInputManagerService.this.mUserStates.size(); i++) {
                    ...
                    for (Entry<IBinder, ClientState> entry2 : userState.clientStateMap.entrySet()) {
                        ...
                        for (IBinder token : client.sessionTokens) {
                            pw.println(IElsaManager.EMPTY_PACKAGE + token);
                        }
                        pw.decreaseIndent();
                    ...
                    for (Entry<ComponentName, ServiceState> entry3 : userState.serviceStateMap.entrySet()) {
                        ...
                        for (IBinder token2 : service.sessionTokens) {
                            pw.println(IElsaManager.EMPTY_PACKAGE + token2);
                        }
                        pw.decreaseIndent();
    ...
    private final class HardwareListener implements Listener {
        /* synthetic */ HardwareListener(TvInputManagerService this$0, HardwareListener hardwareListener) {
            this();
        }
    ...
    private final class InputServiceConnection implements ServiceConnection {
        ...
        /* synthetic */ InputServiceConnection(TvInputManagerService this$0, ComponentName component, int userId, InputServiceConnection inputServiceConnection) {
    ...
    private final class ServiceCallback extends ITvInputServiceCallback.Stub {
        ...
        public void removeHardwareInput(String inputId) {
            ...
            synchronized (TvInputManagerService.this.mLock) {
                ...
                Iterator<TvInputInfo> it = TvInputManagerService.this.getServiceStateLocked(this.mComponent, this.mUserId).hardwareInputList.iterator();
                while (it.hasNext()) {
    ...
    private final class ServiceState {
        ...
        /* synthetic */ ServiceState(TvInputManagerService this$0, ComponentName component, int userId, ServiceState serviceState) {
            this(component, userId);
        }
    ...
    private final class SessionState implements DeathRecipient {
        ...
        /* synthetic */ SessionState(TvInputManagerService this$0, IBinder sessionToken, String inputId, ComponentName componentName, boolean isRecordingSession, ITvInputClient client, int seq, int callingUid, int userId, SessionState sessionState) {
    ...
    private static final class TvInputState {
        ...
        /* synthetic */ TvInputState(TvInputState tvInputState) {
            this();
        }
    ...
    private static final class UserState {
        ...
        /* synthetic */ UserState(Context context, int userId, UserState userState) {
            this(context, userId);
        }
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.tv.TvInputManagerService.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.tv.TvInputManagerService.<clinit>():void, dex: 
        */
    ...
    private void registerBroadcastReceivers() {
        new PackageMonitor() {
            ...
            /* JADX WARNING: Removed duplicated region for block: B:15:0x0075 A:{Splitter: B:9:0x0060, ExcHandler: android.os.RemoteException (r1_0 'e' java.lang.Exception)} */
            /* JADX WARNING: Missing block: B:8:0x001e, code:
            r2 = new java.util.ArrayList();
            r4 = "package_name=?";
            r5 = new java.lang.String[1];
            r5[0] = r11;
            r2.add(android.content.ContentProviderOperation.newDelete(android.media.tv.TvContract.Channels.CONTENT_URI).withSelection(r4, r5).build());
            r2.add(android.content.ContentProviderOperation.newDelete(android.media.tv.TvContract.Programs.CONTENT_URI).withSelection(r4, r5).build());
            r2.add(android.content.ContentProviderOperation.newDelete(android.media.tv.TvContract.WatchedPrograms.CONTENT_URI).withSelection(r4, r5).build());
     */
            /* JADX WARNING: Missing block: B:10:?, code:
            r3 = com.android.server.tv.TvInputManagerService.-wrap0(r10.this$0, getChangingUserId()).applyBatch("android.media.tv", r2);
     */
            /* JADX WARNING: Missing block: B:11:0x0071, code:
            return;
     */
     ...
     */
            ...
            android.util.Slog.e(com.android.server.tv.TvInputManagerService.TAG, "error in applyBatch", r1);
     */
            /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void updateServiceConnectionLocked(ComponentName component, int userId) {
        ...
        if (serviceState != null) {
            ...
            boolean shouldBind = userId == this.mCurrentUserId ? serviceState.sessionTokens.isEmpty() ? serviceState.isHardware : true : !serviceState.sessionTokens.isEmpty();
