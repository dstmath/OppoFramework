...
class TvInputHardwareManager implements Callback {
    ...
    private final class HdmiDeviceEventListener extends Stub {
        /* synthetic */ HdmiDeviceEventListener(TvInputHardwareManager this$0, HdmiDeviceEventListener hdmiDeviceEventListener) {
            this();
        }
    ...
    private final class HdmiHotplugEventListener extends IHdmiHotplugEventListener.Stub {
        /* synthetic */ HdmiHotplugEventListener(TvInputHardwareManager this$0, HdmiHotplugEventListener hdmiHotplugEventListener) {
            this();
        }
    ...
    private final class HdmiSystemAudioModeChangeListener extends IHdmiSystemAudioModeChangeListener.Stub {
        /* synthetic */ HdmiSystemAudioModeChangeListener(TvInputHardwareManager this$0, HdmiSystemAudioModeChangeListener hdmiSystemAudioModeChangeListener) {
            this();
        }
    ...
    private class ListenerHandler extends Handler {
        ...
        /* synthetic */ ListenerHandler(TvInputHardwareManager this$0, ListenerHandler listenerHandler) {
            this();
        }
    ...
    private class TvInputHardwareImpl extends ITvInputHardware.Stub {
        ...
        private String mOverrideAudioAddress = IElsaManager.EMPTY_PACKAGE;
        private int mOverrideAudioType = 0;
        private boolean mReleased = false;
        private float mSourceVolume = OppoBrightUtils.MIN_LUX_LIMITI;
        ...
        private void updateAudioConfigLocked() {
            ...
            if (this.mAudioSource.gains().length > 0 && volume != this.mCommittedVolume) {
                ...
                if (sourceGain != null) {
                    ...
                    int[] gainValues = new int[1];
                    gainValues[0] = gainValue;
            ...
            if (shouldRecreateAudioPatch) {
                ...
                audioPortConfigArr[0] = sourceConfig;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 00e9 in method: com.android.server.tv.TvInputHardwareManager.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 00e9 in method: com.android.server.tv.TvInputHardwareManager.<clinit>():void, dex: 
        */
    ...
    public TvInputHardwareManager(Context context, Listener listener) {
        ...
        this.mHdmiHotplugEventListener = new HdmiHotplugEventListener(this, null);
        this.mHdmiDeviceEventListener = new HdmiDeviceEventListener(this, null);
        this.mHdmiSystemAudioModeChangeListener = new HdmiSystemAudioModeChangeListener(this, null);
        ...
        this.mHandler = new ListenerHandler(this, null);
