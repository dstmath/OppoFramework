...
public abstract class IntentResolver<F extends IntentFilter, R> {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.IntentResolver.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.IntentResolver.<clinit>():void, dex: 
        */
    ...
    public List<R> queryIntentFromList(Intent intent, String resolvedType, boolean defaultOnly, ArrayList<F[]> listCut, int userId) {
        ...
        boolean debug = !localLOGV ? (intent.getFlags() & 8) != 0 : true;
        ...
        while (i < N) {
            ...
            if (filter != null) {
                ...
                if (excludingStopped && isFilterStopped(filter, userId)) {
                    ...
                    if (filter.getAutoVerify() && (localVerificationLOGV || debug)) {
