...
public class UsbDebuggingManager {
            ...
            switch (msg.what) {
                ...
                case 3:
                    ...
                    if (fingerprints.equals(UsbDebuggingManager.this.mFingerprints)) {
                        ...
                        if (UsbDebuggingManager.this.mThread != null) {
                            UsbDebuggingManager.this.mThread.sendResponse(PowerStatusReport.OK);
                            return;
                        }
                        return;
                    }
                ...
                case 4:
                    ...
                    return;
                case 5:
                    Slog.e(UsbDebuggingManager.TAG, "MESSAGE_ADB_CONFIRM mIsPrivilege:" + UsbDebuggingManager.this.mIsPrivilege);
                    if (SystemProperties.getInt("persist.sys.adb.engineermode", 1) == 1) {
                        if (UsbDebuggingManager.this.mIsPrivilege) {
                            if (UsbDebuggingManager.this.mThread != null) {
                                UsbDebuggingManager.this.mThread.sendResponse("NO");
                            }
                            UsbDebuggingManager.this.mIsPrivilege = false;
                            return;
                            ...
                            key = (String) msg.obj;
                            fingerprints = UsbDebuggingManager.this.getFingerprints(key);
                            if (!IElsaManager.EMPTY_PACKAGE.equals(fingerprints)) {
    ...
    private void startConfirmation(String key, String fingerprints) {
        ...
        if (userInfo.isAdmin()) {
            componentString = Resources.getSystem().getString(17039458);
        } else {
            componentString = Resources.getSystem().getString(17039459);
        }
