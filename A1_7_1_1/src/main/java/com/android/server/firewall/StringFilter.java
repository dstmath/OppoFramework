...
abstract class StringFilter implements Filter {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.firewall.StringFilter.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.firewall.StringFilter.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.firewall.StringFilter.<clinit>():void");
    }

    /* synthetic */ StringFilter(ValueProvider valueProvider, StringFilter stringFilter) {
        this(valueProvider);
    }
