...
public class NativeDaemonEvent {
    ...
    public boolean isClassOk() {
        return this.mCode >= DisplayTransformManager.LEVEL_COLOR_MATRIX_GRAYSCALE && this.mCode < 300;
    }

    public boolean isClassServerError() {
        return this.mCode >= DisplayTransformManager.LEVEL_COLOR_MATRIX_COLOR && this.mCode < 500;
    }
