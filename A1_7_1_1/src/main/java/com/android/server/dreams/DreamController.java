...
final class DreamController {
    ...
    private final class DreamRecord implements DeathRecipient, ServiceConnection {
        ...
        final Runnable mReleaseWakeLockIfNeeded = new DreamController$DreamRecord$-void__init__com_android_server_dreams_DreamController_this$0_android_os_Binder_token_android_content_ComponentName_name_boolean_isTest_boolean_canDoze_int_userId_android_os_PowerManager$WakeLock_wakeLock_LambdaImpl0(this);
        ...
        public DreamRecord(Binder token, ComponentName name, boolean isTest, boolean canDoze, int userId, WakeLock wakeLock) {
            ...
            DreamController.this.mHandler.postDelayed(this.mReleaseWakeLockIfNeeded, 10000);
        }
    ...
    public void startDream(Binder token, ComponentName name, boolean isTest, boolean canDoze, int userId, WakeLock wakeLock) {
        stopDream(true);
        Trace.traceBegin(524288, "startDream");
        try {
    ...
    public void stopDream(boolean immediate) {
        if (this.mCurrentDream != null) {
            ...
            Trace.traceBegin(524288, "stopDream");
            if (!immediate) {
