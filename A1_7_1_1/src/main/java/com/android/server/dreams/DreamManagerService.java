...
public final class DreamManagerService extends SystemService {
    ...
    final /* synthetic */ class -void_startDreamLocked_android_content_ComponentName_name_boolean_isTest_boolean_canDoze_int_userId_LambdaImpl0 implements Runnable {
        private /* synthetic */ boolean val$canDoze;
        private /* synthetic */ boolean val$isTest;
        private /* synthetic */ ComponentName val$name;
        private /* synthetic */ Binder val$newToken;
        private /* synthetic */ int val$userId;
        private /* synthetic */ WakeLock val$wakeLock;

        public /* synthetic */ -void_startDreamLocked_android_content_ComponentName_name_boolean_isTest_boolean_canDoze_int_userId_LambdaImpl0(Binder binder, ComponentName componentName, boolean z, boolean z2, int i, WakeLock wakeLock) {
        ...
        public void run() {
            DreamManagerService.this.m25-com_android_server_dreams_DreamManagerService_lambda$1(this.val$newToken, this.val$name, this.val$isTest, this.val$canDoze, this.val$userId, this.val$wakeLock);
        }
    }

    private final class BinderService extends Stub {
        /* synthetic */ BinderService(DreamManagerService this$0, BinderService binderService) {
            this();
        }
    ...
    private final class LocalService extends DreamManagerInternal {
        /* synthetic */ LocalService(DreamManagerService this$0, LocalService localService) {
            this();
        }
    ...
    private void dumpInternal(PrintWriter pw) {
        ...
        }, pw, IElsaManager.EMPTY_PACKAGE, 200);
    }
    ...
    private void startDreamLocked(ComponentName name, boolean isTest, boolean canDoze, int userId) {
        if (!Objects.equal(this.mCurrentDreamName, name) || this.mCurrentDreamIsTest != isTest || this.mCurrentDreamCanDoze != canDoze || this.mCurrentDreamUserId != userId) {
            if (this.mContext.getPackageManager().isFullFunctionMode() || name == null || !"com.android.systemui".equals(name.getPackageName())) {
                ...
                this.mHandler.post(wakeLock.wrap(new -void_startDreamLocked_android_content_ComponentName_name_boolean_isTest_boolean_canDoze_int_userId_LambdaImpl0(newToken, name, isTest, canDoze, userId, wakeLock)));
            }
        }
    }

    /* renamed from: -com_android_server_dreams_DreamManagerService_lambda$1 */
    /* synthetic */ void m25-com_android_server_dreams_DreamManagerService_lambda$1(Binder newToken, ComponentName name, boolean isTest, boolean canDoze, int userId, WakeLock wakeLock) {
