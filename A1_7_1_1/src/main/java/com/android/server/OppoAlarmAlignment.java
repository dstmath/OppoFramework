...
class OppoAlarmAlignment {
    ...
    class AlignClockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(OppoAlarmAlignment.ACTION_ALIGN_TICK)) {
                if (OppoAlarmAlignment.this.mAlarmMS.mInteractive || OppoAlarmAlignment.this.mSysState.isCharging()) {
    ...
    public void reScheduleAlignTick() {
        if (!this.mAlarmMS.mInteractive && !this.mSysState.isCharging() && this.mNeedAlign) {
    ...
    public void alignWithSys(Alarm a) {
        if (!this.mAlarmMS.mInteractive && this.mNeedAlign && !this.mSysState.isCharging() && (a.flags & 1) == 0) {
