...
public class PolicyManager implements ISwitchUpdateListener {
    ...
    private final SecrecyConfig mSecrecyConfig;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.server.secrecy.policy.PolicyManager.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.server.secrecy.policy.PolicyManager.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.secrecy.policy.PolicyManager.<clinit>():void");
    }
    ...
    public PolicyManager() {
        this.mSecrecyConfig = SecrecyConfig.getInstance();
    }
    ...
    public void status(FileDescriptor fd, PrintWriter pw) {
        ...
        synchronized (mLock) {
            ...
            if (this.mIsEncryptApp && this.mIsEncryptLog) {
                z2 = this.mIsEncryptAdb;
            } else {
                z2 = false;
            }
            pw.println(append.append(z2).toString());
            ...
            StringBuilder append2 = new StringBuilder().append("decrypt_all=");
            if (!(this.mIsEncryptApp || this.mIsEncryptLog || this.mIsEncryptAdb)) {
                z = true;
            }
            pw.println(append2.append(z).toString());
        }
    }
