...
public interface IStatusBar extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBar {
        ...
        static final int TRANSACTION_exitSplitScreen = 38;
        static final int TRANSACTION_handleSystemNavigationKey = 34;
        ...
        static final int TRANSACTION_notifyMultiWindowFocusChanged = 39;
        static final int TRANSACTION_notifyMultiWindowModeChanged = 40;
        ...
        static final int TRANSACTION_setNavigationBarColor = 41;
        static final int TRANSACTION_setShortcutsPanelState = 36;
        ...
        static final int TRANSACTION_toggleSplitScreenMode = 37;
        static final int TRANSACTION_topAppWindowChanged = 8;
        static final int TRANSACTION_topIsFullscreen = 35;
