...
public class TelephonyDevController extends Handler {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.TelephonyDevController.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.TelephonyDevController.<clinit>():void, dex: 
        */
    ...
    private static void updateOrInsert(HardwareConfig hw, ArrayList<HardwareConfig> list) {
        synchronized (mLock) {
            ...
            for (int i = 0; i < size; i++) {
                if (((HardwareConfig) list.get(i)).uuid.compareTo(hw.uuid) == 0) {
                    list.remove(i);
                    break;
                }
            }
