...
public class SmsStorageMonitor extends Handler {
    ...
    boolean mPendingIccFullNotify = false;
    Phone mPhone;
    ...
    private final BroadcastReceiver mResultReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (intent.getAction().equals("android.intent.action.BOOT_COMPLETED") && SmsStorageMonitor.this.mPendingIccFullNotify) {
                SmsStorageMonitor.this.handleIccFull();
                SmsStorageMonitor.this.mPendingIccFullNotify = false;
            }
        }
    };
