...
public interface ITelephonyRegistry extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephonyRegistry {
        ...
        static final int TRANSACTION_notifyCallStateForPhoneInfo = 7;
        ...
        static final int TRANSACTION_notifyLteAccessStratumChanged = 29;
        ...
        static final int TRANSACTION_notifyPsNetworkTypeChanged = 30;
        static final int TRANSACTION_notifyServiceStateForPhoneId = 8;
        static final int TRANSACTION_notifySharedDefaultApnStateChanged = 31;
        ...
        static final int TRANSACTION_notifyVoLteServiceStateChanged = 27;
        ...
        private static class Proxy implements ITelephonyRegistry {
            ...
            public void notifyCallStateForPhoneInfo(int phoneType, int phoneId, int subId, int state, String incomingNumber) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(phoneType);
                    _data.writeInt(phoneId);
                    _data.writeInt(subId);
                    _data.writeInt(state);
                    _data.writeString(incomingNumber);
            ...
            public void notifyLteAccessStratumChanged(String state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void notifyPsNetworkTypeChanged(int nwType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(nwType);
            ...
            public void notifySharedDefaultApnStateChanged(boolean isSharedDefaultApn) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (isSharedDefaultApn) {
                        i = 1;
                    }
                    _data.writeInt(i);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    notifyCallStateForPhoneInfo(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
                case 8:
                    ServiceState _arg2;
                ...
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    notifyLteAccessStratumChanged(data.readString());
                    reply.writeNoException();
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    notifyPsNetworkTypeChanged(data.readInt());
                    reply.writeNoException();
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    notifySharedDefaultApnStateChanged(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void notifyLteAccessStratumChanged(String str) throws RemoteException;
    ...
    void notifyPsNetworkTypeChanged(int i) throws RemoteException;

    void notifyServiceStateForPhoneId(int i, int i2, ServiceState serviceState) throws RemoteException;

    void notifySharedDefaultApnStateChanged(boolean z) throws RemoteException;
