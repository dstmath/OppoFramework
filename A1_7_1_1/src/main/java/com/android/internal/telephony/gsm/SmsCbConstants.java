...
public class SmsCbConstants {
    ...
    public static final int MESSAGE_ID_GSMA_ALLOCATED_CHANNEL_50 = 50;
    ...
    public static final int MESSAGE_ID_GSMA_ALLOCATED_CHANNEL_928 = 928;
    public static final int MESSAGE_ID_PWS_FIRST_IDENTIFIER = 4352;
    public static final int MESSAGE_ID_PWS_LAST_IDENTIFIER = 6399;
    public static final int REGION_CHILE = 730;
    public static final int REGION_TAIWAN = 466;
    public static final int REGION_UNDEFINED = 0;
    ...
    public static final int[] spcialChannelInChile = null;
    public static final int[] spcialChannelInTaiwan = null;
    public static final int[] specificRegionList = null;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.gsm.SmsCbConstants.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.gsm.SmsCbConstants.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.gsm.SmsCbConstants.<clinit>():void");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.gsm.SmsCbConstants.<init>():void, dex: 
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:118)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:248)
        	at jadx.core.ProcessClass.process(ProcessClass.java:29)
        	at jadx.core.ProcessClass.lambda$processDependencies$0(ProcessClass.java:51)
    ...
    private SmsCbConstants() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.gsm.SmsCbConstants.<init>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.gsm.SmsCbConstants.<init>():void");
    }
}
