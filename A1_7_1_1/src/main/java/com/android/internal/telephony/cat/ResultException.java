...
public class ResultException extends CatException {
    ...
    private static final /* synthetic */ int[] f33-com-android-internal-telephony-cat-ResultCodeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m126-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues() {
        if (f33-com-android-internal-telephony-cat-ResultCodeSwitchesValues != null) {
            return f33-com-android-internal-telephony-cat-ResultCodeSwitchesValues;
        }
        ...
        f33-com-android-internal-telephony-cat-ResultCodeSwitchesValues = iArr;
        return iArr;
    }

    public ResultException(ResultCode result) {
        switch (m126-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues()[result.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            default:
                ...
                this.mExplanation = UsimPBMemInfo.STRING_NOT_SET;
                return;
        }
    }
