...
public interface ITelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephony {
        ...
        static final int TRANSACTION_canChangeDtmfToneLength = 118;
        static final int TRANSACTION_carrierActionSetMeteredApnsEnabled = 143;
        static final int TRANSACTION_carrierActionSetRadioEnabled = 144;
        static final int TRANSACTION_checkCarrierPrivilegesForPackage = 102;
        static final int TRANSACTION_checkCarrierPrivilegesForPackageAnyPhone = 103;
        ...
        static final int TRANSACTION_disableVisualVoicemailSmsFilter = 63;
        ...
        static final int TRANSACTION_enableVideoCalling = 116;
        static final int TRANSACTION_enableVisualVoicemailSmsFilter = 62;
        static final int TRANSACTION_endCall = 3;
        static final int TRANSACTION_endCallForSubscriber = 4;
        static final int TRANSACTION_factoryReset = 130;
        static final int TRANSACTION_getActivePhoneType = 48;
        static final int TRANSACTION_getActivePhoneTypeForSlot = 49;
        static final int TRANSACTION_getAidForAppType = 137;
        static final int TRANSACTION_getAllCellInfo = 75;
        static final int TRANSACTION_getAllowedCarriers = 142;
        ...
        static final int TRANSACTION_getCarrierPackageNamesForIntentAndPhone = 104;
        static final int TRANSACTION_getCarrierPrivilegeStatus = 101;
        ...
        static final int TRANSACTION_getCdmaMdn = 99;
        static final int TRANSACTION_getCdmaMin = 100;
        static final int TRANSACTION_getCdmaPrlVersion = 139;
        static final int TRANSACTION_getCellLocation = 40;
        static final int TRANSACTION_getCellNetworkScanResults = 92;
        static final int TRANSACTION_getDataActivity = 44;
        static final int TRANSACTION_getDataActivityForSubscriber = 45;
        static final int TRANSACTION_getDataEnabled = 96;
        static final int TRANSACTION_getDataNetworkType = 68;
        static final int TRANSACTION_getDataNetworkTypeForSubscriber = 69;
        static final int TRANSACTION_getDataState = 46;
        static final int TRANSACTION_getDataStateForSubscriber = 47;
        static final int TRANSACTION_getDefaultSim = 77;
        static final int TRANSACTION_getDeviceId = 126;
        static final int TRANSACTION_getDeviceSoftwareVersionForSlot = 128;
        static final int TRANSACTION_getEsn = 138;
        static final int TRANSACTION_getIccAtr = 147;
        static final int TRANSACTION_getImeiForSlot = 127;
        static final int TRANSACTION_getLine1AlphaTagForDisplay = 107;
        static final int TRANSACTION_getLine1NumberForDisplay = 106;
        static final int TRANSACTION_getLocaleFromDefaultSim = 131;
        static final int TRANSACTION_getLteOnCdmaMode = 73;
        static final int TRANSACTION_getLteOnCdmaModeForSubscriber = 74;
        static final int TRANSACTION_getMergedSubscriberIds = 108;
        static final int TRANSACTION_getNeighboringCellInfo = 41;
        static final int TRANSACTION_getNetworkType = 66;
        static final int TRANSACTION_getNetworkTypeForSubscriber = 67;
        static final int TRANSACTION_getPackagesWithCarrierPrivileges = 136;
        static final int TRANSACTION_getPcscfAddress = 97;
        static final int TRANSACTION_getPreferredNetworkType = 89;
        static final int TRANSACTION_getRadioAccessFamily = 115;
        static final int TRANSACTION_getServiceStateForSubscriber = 133;
        static final int TRANSACTION_getSubIdForPhoneAccount = 129;
        static final int TRANSACTION_getSystemVisualVoicemailSmsFilterSettings = 65;
        static final int TRANSACTION_getTelephonyHistograms = 140;
        static final int TRANSACTION_getTetherApnRequired = 90;
        static final int TRANSACTION_getVisualVoicemailSmsFilterSettings = 64;
        static final int TRANSACTION_getVoiceMessageCount = 58;
        static final int TRANSACTION_getVoiceMessageCountForSubscriber = 59;
        static final int TRANSACTION_getVoiceNetworkTypeForSubscriber = 70;
        static final int TRANSACTION_getVoicemailRingtoneUri = 134;
        static final int TRANSACTION_getVtDataUsage = 145;
        static final int TRANSACTION_handlePinMmi = 24;
        static final int TRANSACTION_handlePinMmiForSubscriber = 25;
        static final int TRANSACTION_hasIccCard = 71;
        static final int TRANSACTION_hasIccCardUsingSlotId = 72;
        static final int TRANSACTION_iccCloseLogicalChannel = 79;
        static final int TRANSACTION_iccExchangeSimIO = 82;
        static final int TRANSACTION_iccExchangeSimIOEx = 148;
        static final int TRANSACTION_iccOpenLogicalChannel = 78;
        static final int TRANSACTION_iccTransmitApduBasicChannel = 81;
        static final int TRANSACTION_iccTransmitApduLogicalChannel = 80;
        static final int TRANSACTION_invokeOemRilRequestRaw = 111;
        static final int TRANSACTION_isDataConnectivityPossible = 39;
        static final int TRANSACTION_isHearingAidCompatibilitySupported = 121;
        static final int TRANSACTION_isIdle = 12;
        static final int TRANSACTION_isIdleForSubscriber = 13;
        static final int TRANSACTION_isImsRegistered = 122;
        ...
        static final int TRANSACTION_isTtyModeSupported = 120;
        static final int TRANSACTION_isVideoCallingEnabled = 117;
        static final int TRANSACTION_isVideoTelephonyAvailable = 125;
        static final int TRANSACTION_isVisualVoicemailEnabled = 61;
        static final int TRANSACTION_isVoicemailVibrationEnabled = 135;
        static final int TRANSACTION_isVolteAvailable = 124;
        static final int TRANSACTION_isWifiCallingAvailable = 123;
        static final int TRANSACTION_isWorldPhone = 119;
        static final int TRANSACTION_loadEFLinearFixedAll = 150;
        static final int TRANSACTION_loadEFTransparent = 149;
        static final int TRANSACTION_needMobileRadioShutdown = 112;
        static final int TRANSACTION_needsOtaServiceProvisioning = 56;
        static final int TRANSACTION_nvReadItem = 84;
        static final int TRANSACTION_nvResetConfig = 87;
        static final int TRANSACTION_nvWriteCdmaPrl = 86;
        static final int TRANSACTION_nvWriteItem = 85;
        static final int TRANSACTION_requestModemActivityInfo = 132;
        static final int TRANSACTION_sendEnvelopeWithStatus = 83;
        static final int TRANSACTION_setAllowedCarriers = 141;
        static final int TRANSACTION_setCellInfoListRate = 76;
        static final int TRANSACTION_setDataEnabled = 95;
        static final int TRANSACTION_setImsRegistrationState = 98;
        static final int TRANSACTION_setLine1NumberForDisplayForSubscriber = 105;
        static final int TRANSACTION_setNetworkSelectionModeAutomatic = 91;
        static final int TRANSACTION_setNetworkSelectionModeManual = 93;
        static final int TRANSACTION_setOperatorBrandOverride = 109;
        static final int TRANSACTION_setPolicyDataEnableForSubscriber = 151;
        static final int TRANSACTION_setPolicyDataEnabled = 146;
        static final int TRANSACTION_setPreferredNetworkType = 94;
        static final int TRANSACTION_setRadio = 28;
        static final int TRANSACTION_setRadioCapability = 114;
        static final int TRANSACTION_setRadioForSubscriber = 29;
        static final int TRANSACTION_setRadioPower = 30;
        static final int TRANSACTION_setRoamingOverride = 110;
        static final int TRANSACTION_setVisualVoicemailEnabled = 60;
        static final int TRANSACTION_setVoiceMailNumber = 57;
        static final int TRANSACTION_shutdownMobileRadios = 113;
        ...
        private static class Proxy implements ITelephony {
            ...
            public void setVisualVoicemailEnabled(String callingPackage, PhoneAccountHandle accountHandle, boolean enabled) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("com.android.internal.telephony.ITelephony");
            ...
            public boolean isVisualVoicemailEnabled(String callingPackage, PhoneAccountHandle accountHandle) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("com.android.internal.telephony.ITelephony");
            ...
            public VisualVoicemailSmsFilterSettings getSystemVisualVoicemailSmsFilterSettings(String packageName, int subId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    VisualVoicemailSmsFilterSettings _result;
            ...
            public int setAllowedCarriers(int slotId, List<CarrierIdentifier> carriers) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("com.android.internal.telephony.ITelephony");
            ...
            public List<CarrierIdentifier> getAllowedCarriers(int slotId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("com.android.internal.telephony.ITelephony");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            VisualVoicemailSmsFilterSettings _result5;
            byte[] _result6;
            String[] _result7;
            ...
            switch (code) {
                ...
                case 40:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    Bundle _result9 = getCellLocation(data.readString());
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
                ...
                case 60:
                    ...
                    setVisualVoicemailEnabled(_arg0, _arg1, data.readInt() != 0);
                    return true;
                case 61:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _arg0 = data.readString();
                    ...
                    _result = isVisualVoicemailEnabled(_arg0, _arg1);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 62:
                    ...
                    if (data.readInt() != 0) {
                        _arg2 = (VisualVoicemailSmsFilterSettings) VisualVoicemailSmsFilterSettings.CREATOR.createFromParcel(data);
                    } else {
                        _arg2 = null;
                    }
                    enableVisualVoicemailSmsFilter(_arg0, _arg12, _arg2);
                    reply.writeNoException();
                    return true;
                case 63:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                ...
                case 64:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result5 = getVisualVoicemailSmsFilterSettings(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 65:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result5 = getSystemVisualVoicemailSmsFilterSettings(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 78:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    IccOpenLogicalChannelResponse _result12 = iccOpenLogicalChannel(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 82:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result6 = iccExchangeSimIO(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                ...
                case 92:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    CellNetworkScanResult _result13 = getCellNetworkScanResults(data.readInt());
                    reply.writeNoException();
                    if (_result13 != null) {
                        reply.writeInt(1);
                ...
                case 93:
                    ...
                    if (data.readInt() != 0) {
                        _arg13 = (OperatorInfo) OperatorInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg13 = null;
                    }
                    _result = setNetworkSelectionModeManual(_arg03, _arg13, data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 94:
                ...
                case 104:
                    ...
                    _result8 = getCarrierPackageNamesForIntentAndPhone(_arg04, data.readInt());
                    reply.writeNoException();
                ...
                case 111:
                    ...
                    _result3 = invokeOemRilRequestRaw(_arg05, _arg14);
                    reply.writeNoException();
                    reply.writeInt(_result3);
                ...
                case 129:
                    ...
                    _result3 = getSubIdForPhoneAccount(_arg06);
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 130:
                ...
                case 133:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    ServiceState _result14 = getServiceStateForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result14 != null) {
                        reply.writeInt(1);
                ...
                case 134:
                    ...
                    Uri _result15 = getVoicemailRingtoneUri(_arg02);
                    reply.writeNoException();
                    if (_result15 != null) {
                        reply.writeInt(1);
                ...
                case 135:
                    ...
                    _result = isVoicemailVibrationEnabled(_arg02);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 136:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result8 = getPackagesWithCarrierPrivileges();
                    reply.writeNoException();
                    reply.writeStringList(_result8);
                    return true;
                case 137:
                ...
                case 140:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    List<TelephonyHistogram> _result16 = getTelephonyHistograms();
                    reply.writeNoException();
                    reply.writeTypedList(_result16);
                    return true;
                case 141:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result3 = setAllowedCarriers(data.readInt(), data.createTypedArrayList(CarrierIdentifier.CREATOR));
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 142:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    List<CarrierIdentifier> _result17 = getAllowedCarriers(data.readInt());
                    reply.writeNoException();
                ...
                case 148:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result6 = iccExchangeSimIOEx(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeByteArray(_result6);
                    return true;
                case 149:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result6 = loadEFTransparent(data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeByteArray(_result6);
                    return true;
                case 150:
                    data.enforceInterface("com.android.internal.telephony.ITelephony");
                    _result8 = loadEFLinearFixedAll(data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeStringList(_result8);
                    return true;
                case 151:
    ...
    VisualVoicemailSmsFilterSettings getSystemVisualVoicemailSmsFilterSettings(String str, int i) throws RemoteException;
    ...
    boolean isVisualVoicemailEnabled(String str, PhoneAccountHandle phoneAccountHandle) throws RemoteException;
    ...
    void setVisualVoicemailEnabled(String str, PhoneAccountHandle phoneAccountHandle, boolean z) throws RemoteException;
