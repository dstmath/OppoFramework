...
public interface ISms extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISms {
        ...
        static final int TRANSACTION_activateCellBroadcastSmsForSubscriber = 43;
        static final int TRANSACTION_copyMessageToIccEfForSubscriber = 3;
        static final int TRANSACTION_copyTextMessageToIccCardForSubscriber = 26;
        ...
        static final int TRANSACTION_getAllMessagesFromIccEfByModeForSubscriber = 25;
        static final int TRANSACTION_getAllMessagesFromIccEfForSubscriber = 1;
        static final int TRANSACTION_getCellBroadcastLangsForSubscriber = 48;
        static final int TRANSACTION_getCellBroadcastRangesForSubscriber = 46;
        static final int TRANSACTION_getCellBroadcastSmsConfigForSubscriber = 40;
        static final int TRANSACTION_getImsSmsFormatForSubscriber = 21;
        static final int TRANSACTION_getMessageFromIccEfForSubscriber = 39;
        ...
        static final int TRANSACTION_getSmsParametersForSubscriber = 37;
        static final int TRANSACTION_getSmsSimMemoryStatusForSubscriber = 30;
        static final int TRANSACTION_injectSmsPduForSubscriber = 8;
        static final int TRANSACTION_insertRawMessageToIccCardForSubscriber = 34;
        static final int TRANSACTION_insertTextMessageToIccCardForSubscriber = 33;
        static final int TRANSACTION_isImsSmsSupportedForSubscriber = 18;
        static final int TRANSACTION_isSMSPromptEnabled = 22;
        static final int TRANSACTION_isSmsReadyForSubscriber = 28;
        static final int TRANSACTION_isSmsSimPickActivityNeeded = 19;
        static final int TRANSACTION_queryCellBroadcastSmsActivationForSubscriber = 42;
        static final int TRANSACTION_removeCellBroadcastMsgForSubscriber = 44;
        ...
        static final int TRANSACTION_sendDataWithOriginalPortForSubscriber = 27;
        static final int TRANSACTION_sendMultipartTextForSubscriber = 9;
        static final int TRANSACTION_sendMultipartTextWithEncodingTypeForSubscriber = 32;
        static final int TRANSACTION_sendMultipartTextWithExtraParamsForSubscriber = 36;
        ...
        static final int TRANSACTION_sendTextWithEncodingTypeForSubscriber = 31;
        static final int TRANSACTION_sendTextWithExtraParamsForSubscriber = 35;
        static final int TRANSACTION_setCellBroadcastLangsForSubscriber = 47;
        static final int TRANSACTION_setCellBroadcastSmsConfigForSubscriber = 41;
        static final int TRANSACTION_setEtwsConfigForSubscriber = 45;
        ...
        static final int TRANSACTION_setSmsMemoryStatusForSubscriber = 29;
        static final int TRANSACTION_setSmsParametersForSubscriber = 38;
        ...
        private static class Proxy implements ISms {
            ...
            public IccSmsStorageStatus getSmsSimMemoryStatusForSubscriber(int subId, String callingPkg) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    IccSmsStorageStatus _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    _data.writeString(callingPkg);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (IccSmsStorageStatus) IccSmsStorageStatus.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public SimSmsInsertStatus insertTextMessageToIccCardForSubscriber(int subId, String callingPkg, String scAddress, String address, List<String> text, int status, long timestamp) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    SimSmsInsertStatus _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    _data.writeString(callingPkg);
                    _data.writeString(scAddress);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (SimSmsInsertStatus) SimSmsInsertStatus.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public SimSmsInsertStatus insertRawMessageToIccCardForSubscriber(int subId, String callingPkg, int status, byte[] pdu, byte[] smsc) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    SimSmsInsertStatus _result;
            ...
            public SmsParameters getSmsParametersForSubscriber(int subId, String callingPkg) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    SmsParameters _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    _data.writeString(callingPkg);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (SmsParameters) SmsParameters.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public boolean setSmsParametersForSubscriber(int subId, String callingPkg, SmsParameters params) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public SmsCbConfigInfo[] getCellBroadcastSmsConfigForSubscriber(int subId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    _reply.readException();
                    SmsCbConfigInfo[] _result = (SmsCbConfigInfo[]) _reply.createTypedArray(SmsCbConfigInfo.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean setCellBroadcastSmsConfigForSubscriber(int subId, SmsCbConfigInfo[] channels, SmsCbConfigInfo[] languages) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(subId);
                    _data.writeTypedArray(channels, 0);
                    _data.writeTypedArray(languages, 0);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            Uri _arg22;
            int _arg53;
            SimSmsInsertStatus _result5;
            Bundle _arg54;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAllMessagesFromIccEfForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeTypedList(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = updateMessageOnIccEfForSubscriber(data.readInt(), data.readString(), data.readInt(), data.readInt(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = copyMessageToIccEfForSubscriber(data.readInt(), data.readString(), data.readInt(), data.createByteArray(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 4:
                ...
                case 7:
                    ...
                    sendTextForSubscriberWithSelfPermissions(_arg0, _arg1, _arg2, _arg3, _arg42, _arg52, _arg6, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 8:
                ...
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = enableCellBroadcastRangeForSubscriber(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = disableCellBroadcastRangeForSubscriber(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getPremiumSmsPermission(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getPremiumSmsPermissionForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 16:
                ...
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isImsSmsSupportedForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isSmsSimPickActivityNeeded(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getPreferredSmsSubscription();
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getImsSmsFormatForSubscriber(data.readInt());
                    reply.writeNoException();
                ...
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAllMessagesFromIccEfByModeForSubscriber(data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeTypedList(_result);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = copyTextMessageToIccCardForSubscriber(data.readInt(), data.readString(), data.readString(), data.readString(), data.createStringArrayList(), data.readInt(), data.readLong());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 27:
                    ...
                    sendDataWithOriginalPortForSubscriber(_arg0, _arg1, _arg2, _arg3, _arg4, _arg53, _arg62, _arg7, _arg8);
                    reply.writeNoException();
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isSmsReadyForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    setSmsMemoryStatusForSubscriber(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    IccSmsStorageStatus _result6 = getSmsSimMemoryStatusForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 31:
                    ...
                    sendTextWithEncodingTypeForSubscriber(_arg0, _arg1, _arg2, _arg3, _arg42, _arg53, _arg6, _arg7, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    sendMultipartTextWithEncodingTypeForSubscriber(data.readInt(), data.readString(), data.readString(), data.readString(), data.createStringArrayList(), data.readInt(), data.createTypedArrayList(PendingIntent.CREATOR), data.createTypedArrayList(PendingIntent.CREATOR), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = insertTextMessageToIccCardForSubscriber(data.readInt(), data.readString(), data.readString(), data.readString(), data.createStringArrayList(), data.readInt(), data.readLong());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = insertRawMessageToIccCardForSubscriber(data.readInt(), data.readString(), data.readInt(), data.createByteArray(), data.createByteArray());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 35:
                    ...
                    sendTextWithExtraParamsForSubscriber(_arg0, _arg1, _arg2, _arg3, _arg42, _arg54, _arg6, _arg7, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _arg2 = data.readString();
                    _arg3 = data.readString();
                    List<String> _arg44 = data.createStringArrayList();
                    if (data.readInt() != 0) {
                        _arg54 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        _arg54 = null;
                    }
                    sendMultipartTextWithExtraParamsForSubscriber(_arg0, _arg1, _arg2, _arg3, _arg44, _arg54, data.createTypedArrayList(PendingIntent.CREATOR), data.createTypedArrayList(PendingIntent.CREATOR), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    SmsParameters _result7 = getSmsParametersForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                    ...
                    return true;
                case 38:
                    SmsParameters _arg23;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    _arg1 = data.readString();
                    if (data.readInt() != 0) {
                        _arg23 = (SmsParameters) SmsParameters.CREATOR.createFromParcel(data);
                    } else {
                        _arg23 = null;
                    }
                    _result2 = setSmsParametersForSubscriber(_arg0, _arg1, _arg23);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    SmsRawData _result8 = getMessageFromIccEfForSubscriber(data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(1);
                ...
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    SmsCbConfigInfo[] _result9 = getCellBroadcastSmsConfigForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeTypedArray(_result9, 1);
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setCellBroadcastSmsConfigForSubscriber(data.readInt(), (SmsCbConfigInfo[]) data.createTypedArray(SmsCbConfigInfo.CREATOR), (SmsCbConfigInfo[]) data.createTypedArray(SmsCbConfigInfo.CREATOR));
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = queryCellBroadcastSmsActivationForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = activateCellBroadcastSmsForSubscriber(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = removeCellBroadcastMsgForSubscriber(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setEtwsConfigForSubscriber(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 46:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getCellBroadcastRangesForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = setCellBroadcastLangsForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 48:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getCellBroadcastLangsForSubscriber(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case 1598968902:
    ...
    SmsCbConfigInfo[] getCellBroadcastSmsConfigForSubscriber(int i) throws RemoteException;
    ...
    SmsParameters getSmsParametersForSubscriber(int i, String str) throws RemoteException;

    IccSmsStorageStatus getSmsSimMemoryStatusForSubscriber(int i, String str) throws RemoteException;

    void injectSmsPduForSubscriber(int i, byte[] bArr, String str, PendingIntent pendingIntent) throws RemoteException;

    SimSmsInsertStatus insertRawMessageToIccCardForSubscriber(int i, String str, int i2, byte[] bArr, byte[] bArr2) throws RemoteException;

    SimSmsInsertStatus insertTextMessageToIccCardForSubscriber(int i, String str, String str2, String str3, List<String> list, int i2, long j) throws RemoteException;
    ...
    boolean setCellBroadcastSmsConfigForSubscriber(int i, SmsCbConfigInfo[] smsCbConfigInfoArr, SmsCbConfigInfo[] smsCbConfigInfoArr2) throws RemoteException;
    ...
    boolean setSmsParametersForSubscriber(int i, String str, SmsParameters smsParameters) throws RemoteException;
