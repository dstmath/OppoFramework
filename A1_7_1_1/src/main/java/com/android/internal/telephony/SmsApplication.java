...
public final class SmsApplication {
    ...
    public static String[] OEM_PACKAGE_ALLOW_WRITE_SMS = null;
    public static String[] OEM_PACKAGE_ALLOW_WRITE_SMS_THIRD_APP = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.SmsApplication.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.telephony.SmsApplication.<clinit>():void, dex: 
        */
    ...
    private static Collection<SmsApplicationData> getApplicationCollectionInternal(Context context, int userId) {
        ...
        for (ResolveInfo resolveInfo22 : packageManager.queryIntentServicesAsUser(new Intent("android.intent.action.RESPOND_VIA_MESSAGE", Uri.fromParts(SCHEME_SMSTO, UsimPBMemInfo.STRING_NOT_SET, null)), 0, userId)) {
        ...
        for (ResolveInfo resolveInfo222 : packageManager.queryIntentActivitiesAsUser(new Intent("android.intent.action.SENDTO", Uri.fromParts(SCHEME_SMSTO, UsimPBMemInfo.STRING_NOT_SET, null)), 0, userId)) {
    ...
    private static SmsApplicationData getApplication(Context context, boolean updateIfNeeded, int userId) {
        ...
        if (updateIfNeeded && applicationData == null) {
            applicationData = getApplicationForPackage(applications, context.getResources().getString(17039431));
        ...
        if (applicationData != null) {
            ...
            if (updateIfNeeded) {
                ...
                if (specialApps != null) {
                    for (String assignWriteSmsPermissionToSystemApp : specialApps) {
                        assignWriteSmsPermissionToSystemApp(context, packageManager, appOps, assignWriteSmsPermissionToSystemApp);
                    }
                }
    ...
    private static void replacePreferredActivity(PackageManager packageManager, ComponentName componentName, int userId, String scheme) {
        List<ResolveInfo> resolveInfoList = packageManager.queryIntentActivitiesAsUser(new Intent("android.intent.action.SENDTO", Uri.fromParts(scheme, UsimPBMemInfo.STRING_NOT_SET, null)), 65600, userId);
    ...
    public static boolean shouldWriteMessageForPackage(String packageName, Context context) {
        ...
        try {
            ...
            String[] smsFilterPackages = new String[10];
            smsFilterPackages[0] = "com.color.safecenter";
            smsFilterPackages[1] = "com.oppo.trafficmonitor";
            smsFilterPackages[2] = "com.oppo.activation";
            smsFilterPackages[3] = "com.nxp.wallet.oppo";
            smsFilterPackages[4] = "com.iflytek.cmcc";
            smsFilterPackages[5] = "com.oppo.yellowpage";
            smsFilterPackages[6] = "com.oppo.systemhelper";
            smsFilterPackages[7] = "com.oppo.usercenter";
            smsFilterPackages[8] = "com.coloros.activation";
            smsFilterPackages[9] = "com.coloros.findmyphone";
