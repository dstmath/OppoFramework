...
public class HardwareConfig {
    ...
    public boolean hasCsimPhbEnhanceCapability() {
    ...
    private boolean isAutoSetupIms() {
    ...
    public boolean hasModemSupportEdallow() {
        return SystemProperties.get("ro.mtk_ril_mode").equals("c6m_1rild") || SystemProperties.getInt("ro.mtk_data_config", 0) == 1;
    }
