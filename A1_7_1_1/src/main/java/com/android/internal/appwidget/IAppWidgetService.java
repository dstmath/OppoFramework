...
public interface IAppWidgetService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppWidgetService {
        ...
        static final int TRANSACTION_getAppWidgetOfHost = 25;
        static final int TRANSACTION_getAppWidgetOptions = 12;
        static final int TRANSACTION_getAppWidgetViews = 7;
        static final int TRANSACTION_getEnabledWidgets = 26;
        ...
        private static class Proxy implements IAppWidgetService {
            ...
            public List<ComponentName> getEnabledWidgets() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    int _result5 = allocateAppWidgetId(data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    IntentSender _result7 = createAppWidgetConfigIntentSender(data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 10:
                    ...
                    updateAppWidgetIds(_arg0, _arg1, _arg2);
                    reply.writeNoException();
                    return true;
                case 11:
                    Bundle _arg23;
                ...
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result8 = getAppWidgetOptions(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(1);
                ...
                case 13:
                    ...
                    partiallyUpdateAppWidgetIds(_arg0, _arg1, _arg2);
                    reply.writeNoException();
                    return true;
                case 14:
                    RemoteViews _arg13;
                    ...
                    if (data.readInt() != 0) {
                        _arg13 = (RemoteViews) RemoteViews.CREATOR.createFromParcel(data);
                    } else {
                        _arg13 = null;
                    }
                ...
                case 20:
                    ...
                    _result3 = bindAppWidgetId(_arg0, _arg12, _arg24, _arg3, _arg4);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 21:
                    ...
                    bindRemoteViewsService(_arg0, _arg12, _arg22, data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    unbindRemoteViewsService(_arg0, _arg12, _arg22);
                    reply.writeNoException();
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result2 = getAppWidgetIds(_arg02);
                    reply.writeNoException();
                    reply.writeIntArray(_result2);
                    return true;
                case 24:
                ...
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getAppWidgetOfHost(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeTypedList(_result4);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getEnabledWidgets();
                    reply.writeNoException();
                    reply.writeTypedList(_result4);
                    return true;
                case 1598968902:
    ...
    List<ComponentName> getEnabledWidgets() throws RemoteException;
