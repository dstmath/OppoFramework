...
public class StateMachine {
    ...
    public static class LogRec {
        ...
        public String toString() {
            ...
            sb.append(" what=");
            String what = this.mSm != null ? this.mSm.getWhatToString(this.mWhat) : PhoneConstants.MVNO_TYPE_NONE;
    ...
    private static class SmHandler extends Handler {
        ...
        private class HaltingState extends State {
            /* synthetic */ HaltingState(SmHandler this$1, HaltingState haltingState) {
                this();
            }
        ...
        private class QuittingState extends State {
            /* synthetic */ QuittingState(SmHandler this$1, QuittingState quittingState) {
                this();
            }
        ...
        private class StateInfo {
            ...
            /* synthetic */ StateInfo(SmHandler this$1, StateInfo stateInfo) {
                this();
            }
        ...
        /*  JADX ERROR: Method load error
            jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.util.StateMachine.SmHandler.<clinit>():void, dex: 
        ...
        static {
            /*
            // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.util.StateMachine.SmHandler.<clinit>():void, dex: 
            */
        ...
        /* synthetic */ SmHandler(Looper looper, StateMachine sm, SmHandler smHandler) {
            this(looper, sm);
        }
        ...
        private final IState getCurrentState() {
            int tmpIndex = this.mStateStackTopIndex;
            if (tmpIndex >= 0) {
                return this.mStateStack[tmpIndex].state;
            }
            this.mSm.log("tyl tmpIndex = " + tmpIndex + " index out of bound!!");
            return this.mStateStack[0].state;
        }

        private final StateInfo addState(State state, State parent) {
            if (this.mDbg) {
                this.mSm.log("addStateInternal: E state=" + state.getName() + ",parent=" + (parent == null ? PhoneConstants.MVNO_TYPE_NONE : parent.getName()));
            }
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        if (curState != null) {
            pw.println("curState=" + curState.getName());
        } else {
            pw.println("curState=null");
        }
    }
