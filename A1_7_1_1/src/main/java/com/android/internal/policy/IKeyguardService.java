...
public interface IKeyguardService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeyguardService {
        ...
        static final int TRANSACTION_dispatchWakeUp = 24;
        ...
        static final int TRANSACTION_onSystemReadyForColorOS = 22;
        static final int TRANSACTION_onWakeUp = 25;
        static final int TRANSACTION_requestKeyguard = 23;
        static final int TRANSACTION_setColorOSKeyguardService = 21;
        ...
        private static class Proxy implements IKeyguardService {
            ...
            public void setColorOSKeyguardService(IColorOSKeyguardService callback) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onSystemReadyForColorOS(boolean keyguardDone) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void dispatchWakeUp(boolean isWakeUpByFingerprint) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onWakeUp(String wakeUpReason) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(wakeUpReason);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    setColorOSKeyguardService(com.android.internal.policy.IColorOSKeyguardService.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    onSystemReadyForColorOS(data.readInt() != 0);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    dispatchWakeUp(data.readInt() != 0);
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    onWakeUp(data.readString());
                    return true;
                case 1598968902:
    ...
    void dispatchWakeUp(boolean z) throws RemoteException;
    ...
    void onSystemReadyForColorOS(boolean z) throws RemoteException;

    void onWakeUp(String str) throws RemoteException;

    void requestKeyguard(String str) throws RemoteException;

    void setColorOSKeyguardService(IColorOSKeyguardService iColorOSKeyguardService) throws RemoteException;
