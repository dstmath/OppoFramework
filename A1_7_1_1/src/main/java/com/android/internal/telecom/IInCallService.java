...
public interface IInCallService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInCallService {
        ...
        static final int TRANSACTION_onStorageFull = 12;
        ...
        static final int TRANSACTION_updateRecordState = 11;
        ...
        private static class Proxy implements IInCallService {
            ...
            public void updateRecordState(int state, int customValue) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(state);
                    _data.writeInt(customValue);
            ...
            public void onStorageFull() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    updateRecordState(data.readInt(), data.readInt());
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    onStorageFull();
    ...
    void onStorageFull() throws RemoteException;
    ...
    void updateRecordState(int i, int i2) throws RemoteException;
}
