...
public interface IInCallAdapter extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInCallAdapter {
        ...
        static final int TRANSACTION_blindAssuredEct = 31;
        static final int TRANSACTION_conference = 12;
        static final int TRANSACTION_disconnectCall = 3;
        static final int TRANSACTION_explicitCallTransfer = 24;
        static final int TRANSACTION_hangupActiveAndAnswerWaiting = 27;
        static final int TRANSACTION_hangupAll = 25;
        static final int TRANSACTION_hangupAllHoldCalls = 26;
        static final int TRANSACTION_holdCall = 4;
        static final int TRANSACTION_inviteConferenceParticipants = 29;
        ...
        static final int TRANSACTION_setSortedIncomingCallList = 30;
        static final int TRANSACTION_splitFromConference = 13;
        static final int TRANSACTION_startVoiceRecording = 22;
        static final int TRANSACTION_stopDtmfTone = 9;
        static final int TRANSACTION_stopVoiceRecording = 23;
        ...
        static final int TRANSACTION_updatePowerForSmartBook = 28;
        ...
        private static class Proxy implements IInCallAdapter {
            ...
            public void startVoiceRecording() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void stopVoiceRecording() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void hangupAllHoldCalls() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void hangupActiveAndAnswerWaiting() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void updatePowerForSmartBook(boolean onOff) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setSortedIncomingCallList(List<String> list) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    updatePowerForSmartBook(data.readInt() != 0);
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    setSortedIncomingCallList(data.createStringArrayList());
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void hangupActiveAndAnswerWaiting() throws RemoteException;

    void hangupAll() throws RemoteException;

    void hangupAllHoldCalls() throws RemoteException;
    ...
    void setSortedIncomingCallList(List<String> list) throws RemoteException;

    void splitFromConference(String str) throws RemoteException;

    void startVoiceRecording() throws RemoteException;

    void stopDtmfTone(String str) throws RemoteException;

    void stopVoiceRecording() throws RemoteException;
    ...
    void updatePowerForSmartBook(boolean z) throws RemoteException;
}
