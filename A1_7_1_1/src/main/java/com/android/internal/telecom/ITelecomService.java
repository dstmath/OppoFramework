...
public interface ITelecomService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelecomService {
        ...
        static final int TRANSACTION_addNewOutgoingCall = 47;
        ...
        static final int TRANSACTION_colorInteractWithTelecomService = 46;
        ...
        static final int TRANSACTION_getVideoCallCapablePhoneAccounts = 44;
        static final int TRANSACTION_getVoiceMailNumber = 18;
        static final int TRANSACTION_getVolteCallCapablePhoneAccounts = 43;
        ...
        static final int TRANSACTION_isInVideoCall = 45;
        ...
        private static class Proxy implements ITelecomService {
            ...
            public List<PhoneAccountHandle> getVolteCallCapablePhoneAccounts() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public List<PhoneAccountHandle> getVideoCallCapablePhoneAccounts() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getVolteCallCapablePhoneAccounts();
                    reply.writeNoException();
                    reply.writeTypedList(_result2);
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getVideoCallCapablePhoneAccounts();
                    reply.writeNoException();
                    reply.writeTypedList(_result2);
                    return true;
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = isInVideoCall(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 46:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = colorInteractWithTelecomService(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeString(_result5);
                    return true;
                case 47:
    ...
    List<PhoneAccountHandle> getVideoCallCapablePhoneAccounts() throws RemoteException;

    String getVoiceMailNumber(PhoneAccountHandle phoneAccountHandle, String str) throws RemoteException;

    List<PhoneAccountHandle> getVolteCallCapablePhoneAccounts() throws RemoteException;
