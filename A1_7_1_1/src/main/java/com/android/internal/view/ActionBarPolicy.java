...
public class ActionBarPolicy {
    ...
    public int getMaxActionButtons() {
        ...
        if (width >= 500 || ((width > DisplayMetrics.DENSITY_XXXHIGH && height > 480) || (width > 480 && height > DisplayMetrics.DENSITY_XXXHIGH))) {
            return 4;
        }
        if (width >= 360) {
            return 3;
    ...
    public boolean hasEmbeddedTabs() {
        ...
        if (configuration.orientation != 2 && width < 480 && (width < DisplayMetrics.DENSITY_XXXHIGH || height < 480)) {
            z = false;
        }
        return z;
    }
