...
public class FloatingActionMode extends ActionMode {
    ...
    public FloatingActionMode(Context context, Callback2 callback, View originatingView) {
        ...
        this.mPreviousViewPortOnScreen = new Rect();
    ...
    private void repositionToolbar() {
        ...
        this.mOriginatingView.getWindowVisibleDisplayFrame(this.mViewPortOnScreen);
        if (isContentRectWithinBounds()) {
            ...
            if (!(this.mContentRectOnScreen.equals(this.mPreviousContentRectOnScreen) && this.mViewPortOnScreen.equals(this.mPreviousViewPortOnScreen))) {
        ...
        this.mPreviousViewPortOnScreen.set(this.mViewPortOnScreen);
    }

    private boolean isContentRectWithinBounds() {
        DisplayMetrics metrics = this.mContext.getApplicationContext().getResources().getDisplayMetrics();
        this.mScreenRect.set(0, 0, metrics.widthPixels, metrics.heightPixels);
