...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    @OppoHook(level = OppoHookType.CHANGE_CODE, note = "JiFeng.Tan@EXP.Midware.Framework, 2016-08-03 : Modify for SplitMenu", property = OppoRomType.ROM)
    public BaseMenuPresenter(Context context, int menuLayoutRes, int itemLayoutRes) {
        this.mSystemContext = context;
        this.mSystemInflater = LayoutInflater.from(context);
        this.mMenuLayoutRes = menuLayoutRes;
        if (ColorContextUtil.isOppoStyle(this.mSystemContext) && menuLayoutRes == R.layout.action_menu_layout) {
            this.mMenuLayoutRes = 201917528;
        }
