...
public class MenuBuilder implements Menu {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.view.menu.MenuBuilder.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.view.menu.MenuBuilder.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.view.menu.MenuBuilder.<clinit>():void");
    }
    ...
    public List<MenuPresenter> removeMenuPresenters(List<Class<?>> classList) {
        List<MenuPresenter> presenters = new ArrayList();
        for (WeakReference<MenuPresenter> ref : this.mPresenters) {
            MenuPresenter presenter = (MenuPresenter) ref.get();
    ...
    public void restoreMenuPresenters(List<MenuPresenter> presenters) {
        for (MenuPresenter presenter : presenters) {
            this.mPresenters.add(new WeakReference(presenter));
        }
    }
