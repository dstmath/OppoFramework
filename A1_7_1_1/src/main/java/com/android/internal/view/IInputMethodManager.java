...
public interface IInputMethodManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputMethodManager {
        ...
        static final int TRANSACTION_notifyUserAction = 32;
        static final int TRANSACTION_refreshImeWindowVisibilityLocked = 35;
        static final int TRANSACTION_registerSuggestionSpansForNotification = 20;
        static final int TRANSACTION_removeClient = 7;
        static final int TRANSACTION_sendCharacterToCurClient = 34;
        ...
        static final int TRANSACTION_switchInputMethodFromWindowManager = 33;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    switchInputMethodFromWindowManager(data.readInt() != 0);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    sendCharacterToCurClient(data.readInt());
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void refreshImeWindowVisibilityLocked() throws RemoteException;
    ...
    void switchInputMethodFromWindowManager(boolean z) throws RemoteException;
