...
public final class VerifyCredentialResponse implements Parcelable {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.widget.VerifyCredentialResponse.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.widget.VerifyCredentialResponse.<clinit>():void, dex: 
        */
    ...
    /* synthetic */ VerifyCredentialResponse(int responseCode, int timeout, byte[] payload, VerifyCredentialResponse verifyCredentialResponse) {
