...
public final class ProcessState {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.internal.app.procstats.ProcessState.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.internal.app.procstats.ProcessState.<clinit>():void, dex: 
        */
    ...
    public void dumpSummary(PrintWriter pw, String prefix, int[] screenStates, int[] memStates, int[] procStates, long now, long totalTime) {
        ...
        int[] iArr = new int[1];
        iArr[0] = 0;
        dumpProcessSummaryDetails(pw, prefix, "    Persistent: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 1;
        dumpProcessSummaryDetails(pw, prefix, "           Top: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 2;
        dumpProcessSummaryDetails(pw, prefix, "        Imp Fg: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 3;
        dumpProcessSummaryDetails(pw, prefix, "        Imp Bg: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 4;
        dumpProcessSummaryDetails(pw, prefix, "        Backup: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 5;
        dumpProcessSummaryDetails(pw, prefix, "     Heavy Wgt: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 6;
        dumpProcessSummaryDetails(pw, prefix, "       Service: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 7;
        dumpProcessSummaryDetails(pw, prefix, "    Service Rs: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 8;
        dumpProcessSummaryDetails(pw, prefix, "      Receiver: ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 9;
        dumpProcessSummaryDetails(pw, prefix, "        (Home): ", screenStates, memStates, iArr, now, totalTime, true);
        iArr = new int[1];
        iArr[0] = 10;
        dumpProcessSummaryDetails(pw, prefix, "    (Last Act): ", screenStates, memStates, iArr, now, totalTime, true);
