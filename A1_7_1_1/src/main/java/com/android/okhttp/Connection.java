...
public final class Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0048 A:{Splitter: B:17:0x0029, ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException)} */
    /* JADX WARNING: Removed duplicated region for block: B:27:0x003f  */
    /* JADX WARNING: Failed to process nested try/catch */
    /* JADX WARNING: Missing block: B:16:0x0021, code:
            java.lang.System.out.println("Close in OkHttp");
     */
    /* JADX WARNING: Missing block: B:19:0x002b, code:
            if (r5.socket == null) goto L_0x0032;
     */
    /* JADX WARNING: Missing block: B:20:0x002d, code:
            r5.socket.shutdownOutput();
     */
    ...
    private void connectTls(int readTimeout, int writeTimeout, Request request, ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            sslSocket = (SSLSocket) address.getSslSocketFactory().createSocket(this.socket, address.getRfc2732Host(), address.getUriPort(), true);
