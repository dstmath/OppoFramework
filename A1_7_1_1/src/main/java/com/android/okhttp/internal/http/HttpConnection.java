...
public final class HttpConnection {
    ...
    private abstract class AbstractSource implements Source {
        ...
        /* synthetic */ AbstractSource(HttpConnection this$0, AbstractSource abstractSource) {
            this();
        }
        ...
        protected final void unexpectedEndOfInput() {
            if (HttpConnection.this.connection.getSocket() != null) {
                try {
                    HttpConnection.this.connection.getSocket().shutdownInput();
                } catch (Exception e) {
                }
                try {
                    HttpConnection.this.connection.getSocket().shutdownOutput();
                } catch (Exception e2) {
                }
            }
    ...
    private final class ChunkedSink implements Sink {
        ...
        /* synthetic */ ChunkedSink(HttpConnection this$0, ChunkedSink chunkedSink) {
            this();
        }
    ...
    private final class FixedLengthSink implements Sink {
        ...
        /* synthetic */ FixedLengthSink(HttpConnection this$0, long bytesRemaining, FixedLengthSink fixedLengthSink) {
            this(bytesRemaining);
        }
    ...
    private class UnknownLengthSource extends AbstractSource {
        ...
        /* synthetic */ UnknownLengthSource(HttpConnection this$0, UnknownLengthSource unknownLengthSource) {
            this();
        }
