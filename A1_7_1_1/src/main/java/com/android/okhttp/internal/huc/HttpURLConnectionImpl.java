...
public class HttpURLConnectionImpl extends HttpURLConnection {
    ...
    private static final Set<String> METHODS = null;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.android.okhttp.internal.huc.HttpURLConnectionImpl.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.android.okhttp.internal.huc.HttpURLConnectionImpl.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.okhttp.internal.huc.HttpURLConnectionImpl.<clinit>():void");
    }
    ...
    public void setWriteTimeout(int timeoutMillis) {
        this.client.setWriteTimeout((long) timeoutMillis, TimeUnit.MILLISECONDS);
    }
        ...
        while (System.currentTimeMillis() <= stopTime) {
            if (execute(true)) {
                ...
                if (requestBody == null || (requestBody instanceof RetryableSink)) {
                    ...
                    this.httpEngine = newHttpEngine(followUp.method(), this.httpEngine.close(), (RetryableSink) requestBody, response);
                } else {
    ...
    private boolean execute(boolean readResponse) throws IOException {
        ...
        try {
            ...
            if (this.httpEngine.getConnection() != null) {
                handshake = this.httpEngine.getConnection().getHandshake();
            }
