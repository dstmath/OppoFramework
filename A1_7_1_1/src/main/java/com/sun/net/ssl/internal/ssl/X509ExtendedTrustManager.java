...
public abstract class X509ExtendedTrustManager implements X509TrustManager {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.sun.net.ssl.internal.ssl.X509ExtendedTrustManager.<init>():void, dex: 
    ...
    protected X509ExtendedTrustManager() {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.sun.net.ssl.internal.ssl.X509ExtendedTrustManager.<init>():void, dex: 
        */
