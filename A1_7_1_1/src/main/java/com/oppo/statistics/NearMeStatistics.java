...
public class NearMeStatistics {
    ...
    private static final Pattern EVENTID_PATTERN = null;
    ...
    private static PageVisitAgent sPageVisitAgent;
    private static ExecutorService sSingleThreadExecutor;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: bogus opcode: 0073 in method: com.oppo.statistics.NearMeStatistics.<clinit>():void, dex: 
    ...
    static {
        /*
        // Can't load method instructions: Load method exception: bogus opcode: 0073 in method: com.oppo.statistics.NearMeStatistics.<clinit>():void, dex: 
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oppo.statistics.NearMeStatistics.<clinit>():void");
    }
