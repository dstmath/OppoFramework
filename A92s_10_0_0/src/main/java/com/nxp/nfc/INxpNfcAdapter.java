            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        DefaultRouteSet(_arg02, _arg13, _arg2, _arg3);
                    ...
                    case 2:
                        ...
                        MifareDesfireRouteSet(_arg03, _arg14, _arg22, _arg33);
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        MifareCLTRouteSet(_arg04, _arg15, _arg23, _arg32);
                        reply.writeNoException();
                        return true;
                    case 4:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getActiveSecureElementList /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int[] _result2 = getActiveSecureElementList(data.readString());
                        reply.writeNoException();
                        reply.writeIntArray(_result2);
                        return true;
                    case TRANSACTION_getNxpNfcAdapterExtrasInterface /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_mPOSSetReaderMode /*{ENCODED_INT: 7}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _arg05 = data.readString();
                        if (data.readInt() != 0) {
                            _arg12 = true;
                        }
                        int _result4 = mPOSSetReaderMode(_arg05, _arg12);
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case TRANSACTION_mPOSGetReaderMode /*{ENCODED_INT: 8}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean mPOSGetReaderMode = mPOSGetReaderMode(data.readString());
                        reply.writeNoException();
                        reply.writeInt(mPOSGetReaderMode ? 1 : 0);
                        return true;
                    case TRANSACTION_stopPoll /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        stopPoll(data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_changeDiscoveryTech /*{ENCODED_INT: 10}*/:
                        data.enforceInterface(DESCRIPTOR);
                        changeDiscoveryTech(data.readStrongBinder(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_startPoll /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        startPoll(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getFWVersion /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result5 = getFWVersion();
                        reply.writeNoException();
                        reply.writeByteArray(_result5);
                        return true;
                    case TRANSACTION_readerPassThruMode /*{ENCODED_INT: 13}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result6 = readerPassThruMode(data.readByte(), data.readByte());
                        reply.writeNoException();
                        reply.writeByteArray(_result6);
                        return true;
                    case TRANSACTION_transceiveAppData /*{ENCODED_INT: 14}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result7 = transceiveAppData(data.createByteArray());
                        reply.writeNoException();
                        reply.writeByteArray(_result7);
                        return true;
                    case TRANSACTION_setConfig /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = setConfig(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result8);
                        return true;
                    case TRANSACTION_selectUicc /*{ENCODED_INT: 16}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result9 = selectUicc(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result9);
                        return true;
                    case TRANSACTION_getMaxAidRoutingTableSize /*{ENCODED_INT: 17}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result10 = getMaxAidRoutingTableSize();
                        reply.writeNoException();
                        reply.writeInt(_result10);
                        return true;
                    case TRANSACTION_getCommittedAidRoutingTableSize /*{ENCODED_INT: 18}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result11 = getCommittedAidRoutingTableSize();
                        reply.writeNoException();
                        reply.writeInt(_result11);
                        return true;
                    case TRANSACTION_getSelectedUicc /*{ENCODED_INT: 19}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result12 = getSelectedUicc();
                        reply.writeNoException();
                        reply.writeInt(_result12);
                        return true;
                    case TRANSACTION_updateServiceState /*{ENCODED_INT: 20}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result13 = updateServiceState(data.readInt(), data.readHashMap(getClass().getClassLoader()));
                        reply.writeNoException();
                        reply.writeInt(_result13);
                        return true;
                    case TRANSACTION_activateSeInterface /*{ENCODED_INT: 21}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result14 = activateSeInterface();
                        reply.writeNoException();
                        reply.writeInt(_result14);
                        return true;
                    case TRANSACTION_deactivateSeInterface /*{ENCODED_INT: 22}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result15 = deactivateSeInterface();
                        reply.writeNoException();
                        reply.writeInt(_result15);
                        return true;
                    case TRANSACTION_setFieldDetectMode /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg0 = true;
                        }
                        int _result16 = setFieldDetectMode(_arg0);
                        reply.writeNoException();
                        reply.writeInt(_result16);
                        return true;
                    case TRANSACTION_isFieldDetectEnabled /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isFieldDetectEnabled = isFieldDetectEnabled();
                        reply.writeNoException();
                        reply.writeInt(isFieldDetectEnabled ? 1 : 0);
                        return true;
                    case TRANSACTION_doWriteT4tData /*{ENCODED_INT: 25}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result17 = doWriteT4tData(data.createByteArray(), data.createByteArray(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result17);
                        return true;
                    case TRANSACTION_doReadT4tData /*{ENCODED_INT: 26}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _result18 = doReadT4tData(data.createByteArray());
                        reply.writeNoException();
                        reply.writeByteArray(_result18);
                        return true;
                    case TRANSACTION_nfcSelfTest /*{ENCODED_INT: 27}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result19 = nfcSelfTest(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result19);
                        return true;
                    case TRANSACTION_changeRfParams /*{ENCODED_INT: 28}*/:
                        data.enforceInterface(DESCRIPTOR);
                        byte[] _arg06 = data.createByteArray();
                        if (data.readInt() != 0) {
                            _arg1 = true;
                        }
                        int _result20 = changeRfParams(_arg06, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result20);
                        return true;
                    case TRANSACTION_changeRfParamsByConfig /*{ENCODED_INT: 29}*/:
                        data.enforceInterface(DESCRIPTOR);
