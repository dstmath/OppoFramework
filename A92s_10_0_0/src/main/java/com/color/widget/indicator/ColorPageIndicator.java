...
public class ColorPageIndicator extends FrameLayout implements IPagerIndicator {
    ...
    /* access modifiers changed from: private */
    public float mFinalLeft;
    /* access modifiers changed from: private */
    public float mFinalRight;
    ...
    /* access modifiers changed from: private */
    public boolean mIsAnimatorCanceled;
    private boolean mIsClickable;
    private boolean mIsPaused;
    private boolean mIsStrokeStyle;
    private int mLastPosition;
    /* access modifiers changed from: private */
    public boolean mNeedSettlePositionTemp;
    /* access modifiers changed from: private */
    public OnIndicatorDotClickListener mOnDotClickListener;
    private ValueAnimator mTraceAnimator;
    private int mTraceDotColor;
    /* access modifiers changed from: private */
    public float mTraceLeft;
    private Paint mTracePaint;
    /* access modifiers changed from: private */
    public RectF mTraceRect;
    /* access modifiers changed from: private */
    public float mTraceRight;
    /* access modifiers changed from: private */
    public boolean mTranceCutTailRight;
    private int mWidth;
        ...
        this.mTraceAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (!ColorPageIndicator.this.mIsAnimatorCanceled) {
                    ...
                    boolean unused = ColorPageIndicator.this.mNeedSettlePositionTemp = false;
                    boolean unused2 = ColorPageIndicator.this.mIsAnimated = true;
                    ColorPageIndicator.this.invalidate();
                }
                boolean unused3 = ColorPageIndicator.this.mIsAnimating = false;
            }

            @Override // android.animation.Animator.AnimatorListener, android.animation.AnimatorListenerAdapter
            public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
                boolean unused = ColorPageIndicator.this.mIsAnimatorCanceled = false;
                ColorPageIndicator colorPageIndicator = ColorPageIndicator.this;
                float unused2 = colorPageIndicator.mTraceLeft = colorPageIndicator.mTraceRect.left;
                ColorPageIndicator colorPageIndicator2 = ColorPageIndicator.this;
                float unused3 = colorPageIndicator2.mTraceRight = colorPageIndicator2.mTraceRect.right;
            }
        });
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, com.color.widget.indicator.ColorPageIndicator, int]
     candidates:
    ...
    private View buildDot(boolean stroke, int color) {
        ...
        if (Build.VERSION.SDK_INT > 16) {
            ...
            dotView.setBackground(resources.getDrawable(i2));
        } else {
                ...
                dot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (ColorPageIndicator.this.mOnDotClickListener != null) {
                            boolean unused = ColorPageIndicator.this.mNeedSettlePositionTemp = true;
                            boolean unused2 = ColorPageIndicator.this.mIsAnimated = false;
