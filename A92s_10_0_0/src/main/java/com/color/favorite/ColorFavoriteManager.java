...
public class ColorFavoriteManager implements IColorFavoriteManager {
    ...
    public static final boolean NOTIFY_DEBUG = SystemProperties.getBoolean("feature.favorite.notify", false);
    ...
    private static class FavoriteQueryCallback extends ColorFavoriteQueryCallback {
