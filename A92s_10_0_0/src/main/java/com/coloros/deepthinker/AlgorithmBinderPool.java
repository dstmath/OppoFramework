...
public class AlgorithmBinderPool {
    ...
    private ServiceConnection mBinderPoolConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            IAlgorithmBinderPool unused = AlgorithmBinderPool.this.mBinderPool = IAlgorithmBinderPool.Stub.asInterface(service);
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if (legalState) {
                IAlgorithmBinderPool unused = AlgorithmBinderPool.this.mBinderPool = null;
    ...
    public void deliveryOnServiceDied() {
        for (ServiceStateObserver observer : this.mStateObservers.keySet()) {
            if (observer != null) {
    ...
    /* access modifiers changed from: private */
    public String logState(int state) {
        if (state == 0) {
            return "InitState";
        }
        if (state == 1) {
