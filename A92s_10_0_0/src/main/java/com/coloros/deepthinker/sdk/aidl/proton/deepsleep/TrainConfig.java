...
public class TrainConfig implements Parcelable {
    ...
    public static final Parcelable.Creator<TrainConfig> CREATOR = new Parcelable.Creator<TrainConfig>() {
        ...
        public TrainConfig createFromParcel(Parcel source) {
            ...
            int unused = trainConfig.mClusterMinPoints = source.readInt();
            double unused2 = trainConfig.mClusterEps = source.readDouble();
            int unused3 = trainConfig.mDayForPredict = source.readInt();
            int unused4 = trainConfig.mType = source.readInt();
            return trainConfig;
        }
    ...
    public double mClusterEps;
    /* access modifiers changed from: private */
    public int mClusterMinPoints;
    /* access modifiers changed from: private */
    public int mDayForPredict;
    /* access modifiers changed from: private */
    public int mType = -1;
