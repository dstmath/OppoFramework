...
public class DeepSleepCluster implements Parcelable, Cloneable {
    ...
    public static final Parcelable.Creator<DeepSleepCluster> CREATOR = new Parcelable.Creator<DeepSleepCluster>() {
        ...
        public DeepSleepCluster createFromParcel(Parcel source) {
            ...
            double unused = cluster.mSleepTimePeriod = source.readDouble();
            double unused2 = cluster.mWakeTimePeriod = source.readDouble();
            double unused3 = cluster.mMaxDistance = source.readDouble();
            int unused4 = cluster.mClusterId = source.readInt();
            int unused5 = cluster.mClusterNum = source.readInt();
            double unused6 = cluster.mSleepMinValue = source.readDouble();
            double unused7 = cluster.mSleepMaxValue = source.readDouble();
            double unused8 = cluster.mWakeMinValue = source.readDouble();
            double unused9 = cluster.mWakeMaxValue = source.readDouble();
            return cluster;
        }
    ...
    /* access modifiers changed from: private */
    public int mClusterNum = 0;
    /* access modifiers changed from: private */
    public double mMaxDistance = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mSleepMaxValue = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mSleepMinValue = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mSleepTimePeriod = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mWakeMaxValue = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mWakeMinValue = DEFAULT_MAX_DISTANCE;
    /* access modifiers changed from: private */
    public double mWakeTimePeriod = DEFAULT_MAX_DISTANCE;
