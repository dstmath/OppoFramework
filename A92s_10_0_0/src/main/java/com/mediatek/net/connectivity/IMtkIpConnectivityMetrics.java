            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 2:
                        ...
                        return true;
                    case TRANSACTION_registerMtkSocketEventCallback /*{ENCODED_INT: 3}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_unregisterMtkSocketEventCallback /*{ENCODED_INT: 4}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_updateCtaAppStatus /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        updateCtaAppStatus(data.readInt(), data.readInt() != 0);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setSpeedDownload /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
