            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 14:
                        ...
                        return true;
                    case TRANSACTION_setOutputSurfaces /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        return true;
                    case TRANSACTION_addOutputParameter /*{ENCODED_INT: 17}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_setInputsyncMode /*{ENCODED_INT: 18}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getInputsyncMode /*{ENCODED_INT: 19}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 20:
                        ...
                        int _result19 = setOutputsyncMode(_arg09, _arg14);
                        reply.writeNoException();
                        reply.writeInt(_result19);
                        return true;
                    case TRANSACTION_getOutputsyncMode /*{ENCODED_INT: 21}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean outputsyncMode = getOutputsyncMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(outputsyncMode ? 1 : 0);
                        return true;
                    case TRANSACTION_setBaseParameter /*{ENCODED_INT: 22}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        return true;
                    case TRANSACTION_dequeueAndQueueBuf /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
