...
public class WorldPhoneOm extends Handler implements IWorldPhone {
    ...
    /* access modifiers changed from: private */
    public static int sSimLockedSlotId = -1;
    /* access modifiers changed from: private */
    ...
    private Runnable mFddStandByTimerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (WorldPhoneOm.sBtSapState == 0) {
                ...
                boolean unused3 = WorldPhoneOm.this.handleSwitchModem(101);
                return;
            }
    ...
    private Runnable mTddStandByTimerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (WorldPhoneOm.sBtSapState == 0) {
                ...
                boolean unused3 = WorldPhoneOm.this.handleSwitchModem(100);
                return;
            }
    ...
    /* access modifiers changed from: private */
    public void handleWorldPhoneTest(int fakeUserType, int fakeRegion) {
