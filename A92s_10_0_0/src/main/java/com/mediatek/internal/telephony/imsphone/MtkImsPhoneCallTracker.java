...
public class MtkImsPhoneCallTracker extends ImsPhoneCallTracker implements ImsPullCall {
    ...
    public static final boolean SENLOG = TextUtils.equals(Build.TYPE, DataSubConstants.REASON_MOBILE_DATA_ENABLE_USER);
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public MtkImsConnectionStateListener mImsStateListener = new MtkImsConnectionStateListener() {
        ...
        public void onImsEmergencyCapabilityChanged(boolean eccSupport) {
            ...
            boolean unused = MtkImsPhoneCallTracker.this.mIsImsEccSupported = eccSupport;
        ...
        public void onWifiPdnOOSStateChanged(int oosState) {
            ...
            int unused = MtkImsPhoneCallTracker.this.mWifiPdnOOSState = oosState;
        }
    ...
    /* access modifiers changed from: private */
    public MtkIncomingCallChecker mIncomingCallCheker = null;
    ...
    /* access modifiers changed from: private */
    public boolean mIsImsEccSupported = false;
        ...
        public void onSubscriptionsChanged() {
            ...
            if (SubscriptionManager.isValidSubscriptionId(MtkImsPhoneCallTracker.this.mPhone.getSubId())) {
                if (!MtkImsPhoneCallTracker.this.mRoamingVariablesInited) {
                    boolean unused = MtkImsPhoneCallTracker.this.mRoamingVariablesInited = true;
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 102:
                onDataRoamingOff();
                return;
            case EVENT_ROAMING_SETTING_CHANGE /*{ENCODED_INT: 103}*/:
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("com.android.ims.IMS_INCOMING_CALL_INDICATION")) {
                ...
                if (phoneId == MtkImsPhoneCallTracker.this.mPhone.getPhoneId()) {
                    MtkIncomingCallChecker unused = MtkImsPhoneCallTracker.this.mIncomingCallCheker = new MtkIncomingCallChecker("ims_call_pre_check", intent);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, java.lang.String, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
     arg types: [com.android.internal.telephony.imsphone.ImsPhone, java.lang.String, com.mediatek.internal.telephony.imsphone.MtkImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, int]
     candidates:
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, com.android.ims.ImsCall, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, java.lang.String, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void */
    /* access modifiers changed from: package-private */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, java.lang.String, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
     arg types: [com.android.internal.telephony.imsphone.ImsPhone, java.lang.String, com.mediatek.internal.telephony.imsphone.MtkImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean]
     candidates:
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, com.android.ims.ImsCall, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, java.lang.String, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void */
    /* access modifiers changed from: protected */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, com.android.ims.ImsCall, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
     arg types: [com.android.internal.telephony.imsphone.ImsPhone, com.android.ims.ImsCall, com.mediatek.internal.telephony.imsphone.MtkImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean]
     candidates:
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, java.lang.String, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void
      com.mediatek.internal.telephony.imsphone.MtkImsPhoneConnection.<init>(com.android.internal.telephony.Phone, com.android.ims.ImsCall, com.android.internal.telephony.imsphone.ImsPhoneCallTracker, com.android.internal.telephony.imsphone.ImsPhoneCall, boolean):void */
    /* access modifiers changed from: protected */
    ...
    public String getVtInterface() {
        ...
        log("[SubId=" + this.mPhone.getSubId() + "] getVtInterface(): " + vtIf);
        return vtIf;
    }
