...
public final class MtkRetryManager extends RetryManager {
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.telephony.action.CARRIER_CONFIG_CHANGED")) {
                ...
                int unused = MtkRetryManager.this.mSameApnRetryCount = sameApnRetryCountTemp;
                long unused2 = MtkRetryManager.this.mModemSuggestedDelay = modemSuggestedDelayTemp;
                int unused3 = MtkRetryManager.this.mCurrentApnIndex = currentApnIndexTemp;
            }
        }
    };
    ...
    public void configureRetryOnly() {
        MtkRetryManager.super.configureRetry();
    }
