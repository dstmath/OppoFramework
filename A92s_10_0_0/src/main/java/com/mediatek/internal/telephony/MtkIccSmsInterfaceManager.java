...
public class MtkIccSmsInterfaceManager extends IccSmsInterfaceManager {
    ...
    public boolean mInsertMessageSuccess;
    /* access modifiers changed from: private */
    public boolean mInserted;
            ...
            switch (msg.what) {
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar.exception == null) {
                            ...
                            if (MtkIccSmsInterfaceManager.this.mSimMemStatus == null) {
                                MtkIccSmsStorageStatus unused = MtkIccSmsInterfaceManager.this.mSimMemStatus = new MtkIccSmsStorageStatus();
                            }
                ...
                case 102:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mSimInsertLock) {
                        boolean unused2 = MtkIccSmsInterfaceManager.this.mInsertMessageSuccess = ar2.exception == null;
                        if (MtkIccSmsInterfaceManager.this.mInsertMessageSuccess) {
                            try {
                                int index = ((int[]) ar2.result)[0];
                                StringBuilder sb = new StringBuilder();
                                MtkSimSmsInsertStatus access$600 = MtkIccSmsInterfaceManager.this.smsInsertRet;
                                sb.append(access$600.indexInIcc);
                                sb.append(index);
                                sb.append(MtkIccSmsInterfaceManager.INDEXT_SPLITOR);
                                access$600.indexInIcc = sb.toString();
                            ...
                            MtkSimSmsInsertStatus access$6002 = MtkIccSmsInterfaceManager.this.smsInsertRet;
                            sb2.append(access$6002.indexInIcc);
                            sb2.append("-1,");
                            access$6002.indexInIcc = sb2.toString();
                        }
                        boolean unused3 = MtkIccSmsInterfaceManager.this.mInserted = true;
                        MtkIccSmsInterfaceManager.this.mSimInsertLock.notifyAll();
                    }
                    return;
                case MtkIccSmsInterfaceManager.EVENT_GET_SMS_PARAMS /*{ENCODED_INT: 103}*/:
                    AsyncResult ar3 = (AsyncResult) msg.obj;
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar3.exception == null) {
                            try {
                                MtkSmsParameters unused4 = MtkIccSmsInterfaceManager.this.mSmsParams = (MtkSmsParameters) ar3.result;
                            ...
                            MtkSmsParameters unused5 = MtkIccSmsInterfaceManager.this.mSmsParams = null;
                        }
                        MtkIccSmsInterfaceManager.this.mMtkLock.notifyAll();
                    }
                    return;
                case 104:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar4.exception == null) {
                            boolean unused6 = MtkIccSmsInterfaceManager.this.mSmsParamsSuccess = true;
                        } else {
                            MtkIccSmsInterfaceManager.this.log("[EFsmsp fail to set sms params");
                            boolean unused7 = MtkIccSmsInterfaceManager.this.mSmsParamsSuccess = false;
                        }
                        MtkIccSmsInterfaceManager.this.mMtkLock.notifyAll();
                    }
                    return;
                        ...
                        if (ar5.exception == null) {
                            try {
                                ...
                                if (rawData[0] == 0) {
                                    ...
                                    SmsRawData unused8 = MtkIccSmsInterfaceManager.this.mSmsRawData = null;
                                } else {
                                    SmsRawData unused9 = MtkIccSmsInterfaceManager.this.mSmsRawData = new SmsRawData(rawData);
                                }
                            } catch (ClassCastException e3) {
                                MtkIccSmsInterfaceManager.this.log("fail to get sms raw data ClassCastException");
                                e3.printStackTrace();
                                SmsRawData unused10 = MtkIccSmsInterfaceManager.this.mSmsRawData = null;
                            }
                        } else {
                            MtkIccSmsInterfaceManager.this.log("fail to get sms raw data rild");
                            SmsRawData unused11 = MtkIccSmsInterfaceManager.this.mSmsRawData = null;
                        }
                        MtkIccSmsInterfaceManager.this.mMtkLock.notifyAll();
                    }
                    return;
                case MtkIccSmsInterfaceManager.EVENT_GET_BROADCAST_ACTIVATION_DONE /*{ENCODED_INT: 106}*/:
                    ...
                    return;
                case MtkIccSmsInterfaceManager.EVENT_REMOVE_BROADCAST_MSG_DONE /*{ENCODED_INT: 107}*/:
                    ...
                    return;
                case MtkIccSmsInterfaceManager.EVENT_GET_BROADCAST_CONFIG_CHANNEL_DONE /*{ENCODED_INT: 108}*/:
                    AsyncResult ar8 = (AsyncResult) msg.obj;
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar8.exception == null) {
                            ArrayList<SmsBroadcastConfigInfo> mList = (ArrayList) ar8.result;
                            for (i++; i < mList.size(); i++) {
                                SmsBroadcastConfigInfo cbConfig = mList.get(i);
                                if (cbConfig.getFromServiceId() == cbConfig.getToServiceId()) {
                                    String unused12 = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig + cbConfig.getFromServiceId();
                                } else {
                                    String unused13 = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig + cbConfig.getFromServiceId() + "-" + cbConfig.getToServiceId();
                                }
                                if (i + 1 != mList.size()) {
                                    String unused14 = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig = MtkIccSmsInterfaceManager.this.mSmsCbChannelConfig + MtkIccSmsInterfaceManager.INDEXT_SPLITOR;
                                }
                            }
                ...
                case 110:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar10.exception == null) {
                            String unused15 = MtkIccSmsInterfaceManager.this.mSmsCbLanguageConfig = (String) ar10.result;
                            String unused16 = MtkIccSmsInterfaceManager.this.mSmsCbLanguageConfig = MtkIccSmsInterfaceManager.this.mSmsCbLanguageConfig != null ? MtkIccSmsInterfaceManager.this.mSmsCbLanguageConfig : "";
                ...
                case 112:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar11.exception == null) {
                            String unused17 = MtkIccSmsInterfaceManager.this.mSmscAddress = (String) ar11.result;
                        } else {
                ...
                case 113:
                    ...
                    return;
                case MtkIccSmsInterfaceManager.EVENT_MTK_LOAD_DONE /*{ENCODED_INT: 115}*/:
                    AsyncResult ar13 = (AsyncResult) msg.obj;
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLoadLock) {
                        if (ar13.exception == null) {
                            List unused18 = MtkIccSmsInterfaceManager.this.mSms = MtkIccSmsInterfaceManager.this.buildValidRawData((ArrayList) ar13.result);
                            ...
                            List unused19 = MtkIccSmsInterfaceManager.this.mSms = null;
                        }
                        MtkIccSmsInterfaceManager.this.mMtkLoadLock.notifyAll();
                    }
                    return;
                case MtkIccSmsInterfaceManager.EVENT_MTK_UPDATE_DONE /*{ENCODED_INT: 116}*/:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        ...
                        if (MtkIccSmsInterfaceManager.this.mMtkSuccess) {
                            try {
                                ...
                                MtkSimSmsInsertStatus access$000 = MtkIccSmsInterfaceManager.this.smsInsertRet2;
                                sb3.append(access$000.indexInIcc);
                                sb3.append(index2);
                                sb3.append(MtkIccSmsInterfaceManager.INDEXT_SPLITOR);
                                access$000.indexInIcc = sb3.toString();
                            ...
                            MtkSimSmsInsertStatus access$0002 = MtkIccSmsInterfaceManager.this.smsInsertRet2;
                            sb4.append(access$0002.indexInIcc);
                            sb4.append("-1,");
                            access$0002.indexInIcc = sb4.toString();
                        }
                        MtkIccSmsInterfaceManager.this.mMtkLock.notifyAll();
                    }
                    ...
                    return;
                case MtkIccSmsInterfaceManager.EVENT_SMS_WIPE_DONE /*{ENCODED_INT: 117}*/:
                    ...
                    synchronized (MtkIccSmsInterfaceManager.this.mMtkLock) {
                        if (ar15.exception == null) {
                            try {
                                ...
                                MtkSimSmsInsertStatus access$0003 = MtkIccSmsInterfaceManager.this.smsInsertRet2;
                                sb5.append(access$0003.indexInIcc);
                                sb5.append(index3);
                                sb5.append(MtkIccSmsInterfaceManager.INDEXT_SPLITOR);
                                access$0003.indexInIcc = sb5.toString();
                            ...
                            MtkSimSmsInsertStatus access$0004 = MtkIccSmsInterfaceManager.this.smsInsertRet2;
                            sb6.append(access$0004.indexInIcc);
                            sb6.append("-1,");
                            access$0004.indexInIcc = sb6.toString();
                        }
    ...
    /* access modifiers changed from: private */
    public final Object mSimInsertLock = new Object();
    /* access modifiers changed from: private */
    public MtkIccSmsStorageStatus mSimMemStatus;
    /* access modifiers changed from: private */
    public List<SmsRawData> mSms;
    private SmsBroadcastConfigInfo[] mSmsCBConfig = null;
    /* access modifiers changed from: private */
    public String mSmsCbChannelConfig = "";
    /* access modifiers changed from: private */
    public String mSmsCbLanguageConfig = "";
    /* access modifiers changed from: private */
    public MtkSmsParameters mSmsParams = null;
    /* access modifiers changed from: private */
    public boolean mSmsParamsSuccess = false;
    /* access modifiers changed from: private */
    public SmsRawData mSmsRawData = null;
    ...
    /* access modifiers changed from: private */
    public String mSmscAddress = "";
    /* access modifiers changed from: private */
    public Bundle mSmscAddressBundle = new Bundle();
    /* access modifiers changed from: private */
    public MtkSimSmsInsertStatus smsInsertRet = new MtkSimSmsInsertStatus(0, "");
    /* access modifiers changed from: private */
    public MtkSimSmsInsertStatus smsInsertRet2 = new MtkSimSmsInsertStatus(0, "");
    ...
    public void sendMultipartTextWithExtraParams(String callingPackage, String destAddr, String scAddr, List<String> parts, Bundle extraParams, List<PendingIntent> sentIntents, List<PendingIntent> deliveryIntents, boolean persistMessageForNonDefaultSmsApp) {
        ...
        if (this.mAppOps.noteOp(20, Binder.getCallingUid(), callingPackage) == 0) {
            ...
            for (int i = 0; i < parts.size(); i++) {
                ...
                sendTextWithOptions(callingPackage, destAddr2, scAddr, singlePart, singleSentIntent, singleDeliveryIntent, persistMessageForNonDefaultSmsApp, -1, false, validityPeriod);
            }
        }
    }
    ...
    public List<SmsRawData> getAllMessagesFromIccEfByMode(String callingPackage, int mode) {
        ...
        synchronized (this.mMtkLoadLock) {
            ...
            List<SmsRawData> list2 = this.mSms;
            return list2;
        }
    }
