...
public class IWlanNetworkService extends NetworkService {
    ...
    public IWifiOffloadService sWifiOffloadService = null;
    ...
    private class IWlanNetworkServiceProvider extends NetworkService.NetworkServiceProvider {
            ...
            this.mHandler = new Handler(this.mLooper, IWlanNetworkService.this) {
                ...
                public void handleMessage(Message message) {
                    ...
                    if (i == 1) {
                        ...
                        int unused = IWlanNetworkServiceProvider.this.mWfcState = state;
        ...
        public NetworkRegistrationInfo createRegistrationState(int state) {
            ...
            return new NetworkRegistrationInfo(2, 2, regState, accessNetworkTechnology, 0, false, IWlanNetworkService.this.getAvailableServices(regState, 2, false), (CellIdentity) null, 0, false, false, false, new LteVopsSupportInfo(1, 1), false);
        }
    }
    ...
    private class IWifiOffloadServiceDeathRecipient implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            IWifiOffloadService unused = IWlanNetworkService.this.sWifiOffloadService = null;
