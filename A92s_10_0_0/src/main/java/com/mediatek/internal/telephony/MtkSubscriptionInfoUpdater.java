...
public class MtkSubscriptionInfoUpdater extends SubscriptionInfoUpdater {
    ...
    private final BroadcastReceiver mMtkReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.intent.action.LOCALE_CHANGED")) {
                ...
                int unused = MtkSubscriptionInfoUpdater.this.oldDensityDpi = MtkSubscriptionInfoUpdater.mContext.getResources().getConfiguration().densityDpi;
    ...
    public int mReadIccIdCount = 0;
    /* access modifiers changed from: private */
    public Runnable mReadIccIdPropertyRunnable = new Runnable() {
        ...
        if (i == 3) {
            ...
            switch (i) {
                ...
                case 102:
                    ...
                    return;
                case EVENT_SIM_NO_CHANGED /*{ENCODED_INT: 103}*/:
                    if (checkAllIccIdReady()) {
                        updateSubscriptionInfoIfNeed();
                        return;
                    }
                ...
                case 105:
                    ...
                    this.mCommonSlotResetDone = false;
                    return;
                case EVENT_SIM_MOUNT_CHANGED /*{ENCODED_INT: 106}*/:
    ...
    public synchronized void updateSubscriptionInfoByIccId(int slotIndex, boolean updateEmbeddedSubs) {
        ...
        UiccSlot[] uiccSlots = uiccController2.getUiccSlots();
        if (uiccSlots != null && updateEmbeddedSubs) {
            List<Integer> cardIds = new ArrayList<>();
            int length = uiccSlots.length;
            int i2 = 0;
            while (i2 < length) {
                UiccSlot uiccSlot = uiccSlots[i2];
                if (uiccSlot == null || uiccSlot.getUiccCard() == null) {
                    uiccController = uiccController2;
                } else {
                    try {
                        uiccController = uiccController2;
                        try {
                            cardIds.add(Integer.valueOf(uiccController2.convertToPublicCardId(uiccSlot.getUiccCard().getCardId())));
                        ...
                        i2++;
                        uiccController2 = uiccController;
                    }
                }
                i2++;
                uiccController2 = uiccController;
