...
public class MtkDcHelper extends Handler {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action != null && action.equals("android.intent.action.PHONE_STATE")) {
                ...
                if (phoneState.equals(TelephonyManager.EXTRA_STATE_IDLE)) {
                    ...
                    boolean unused = MtkDcHelper.this.mIsPhoneOffhook = false;
    ...
    public int mCallingPhoneId = -1;
    private Context mContext;
    /* access modifiers changed from: private */
    public int mDsdaMode = 0;
    /* access modifiers changed from: private */
    public boolean mGwsdDualSimStatus = false;
    ...
    /* access modifiers changed from: private */
    public int mPrevCallingPhoneId = -1;
    /* access modifiers changed from: private */
    public Handler mRspHandler = new Handler() {
            ...
            if (eventId == 10) {
                ...
                if (eventId != 30) {
                    if (eventId == 40) {
                        ...
                        Call.SrvccState unused = MtkDcHelper.this.mSrvccState = Call.SrvccState.NONE;
                    } else if (eventId == 50) {
                        AsyncResult ar = (AsyncResult) msg.obj;
                        if (ar != null && ar.result != null) {
                            int unused2 = MtkDcHelper.this.mDsdaMode = ((Integer) ar.result).intValue();
                        ...
                        if (Integer.parseInt(callAdditionalInfo[0]) == 4) {
                            ...
                            boolean unused3 = mtkDcHelper.mGwsdDualSimStatus = z;
                            MtkDcHelper.logd("MT_CALL_RQ, mtCallRq = " + mtCallRq + ", mGwsdDualSimStatus = " + MtkDcHelper.this.mGwsdDualSimStatus);
                            return;
                        }
                        return;
                    } else if (MtkDcHelper.this.mCallingPhoneId != -1) {
                        boolean unused4 = MtkDcHelper.this.mIsPhoneOffhook = true;
                ...
                boolean unused5 = MtkDcHelper.this.mIsPhoneOffhook = false;
                Call.SrvccState preSrvccState = MtkDcHelper.this.mSrvccState;
                AsyncResult ar2 = (AsyncResult) msg.obj;
                if (ar2 == null || ar2.result == null) {
                    Call.SrvccState unused6 = MtkDcHelper.this.mSrvccState = Call.SrvccState.NONE;
                } else {
                    Call.SrvccState unused7 = MtkDcHelper.this.mSrvccState = (Call.SrvccState) ar2.result;
                }
                ...
                if (!MtkDcHelper.this.isInSRVCC() || preSrvccState == Call.SrvccState.NONE) {
                    ...
                    if (MtkDcHelper.MTK_SVLTE_SUPPORT && MtkDcHelper.this.mPrevCallingPhoneId != -1) {
                        ...
                        int unused8 = MtkDcHelper.this.mCallingPhoneId = restCallingPhoneId;
                        int unused9 = MtkDcHelper.this.mPrevCallingPhoneId = -1;
                    ...
                    int unused10 = MtkDcHelper.this.mCallingPhoneId = -1;
                    if (MtkDcHelper.MTK_SVLTE_SUPPORT && restCallingPhoneId != -1) {
                        int unused11 = MtkDcHelper.this.mCallingPhoneId = restCallingPhoneId;
                ...
                if (MtkDcHelper.MTK_SVLTE_SUPPORT && MtkDcHelper.this.mCallingPhoneId != -1) {
                    ...
                    int unused12 = mtkDcHelper2.mPrevCallingPhoneId = mtkDcHelper2.mCallingPhoneId;
                    MtkDcHelper.logd("SVLTE Voice Call2 Started, save first mPrevCallingPhoneId = " + MtkDcHelper.this.mPrevCallingPhoneId);
                }
                int unused13 = MtkDcHelper.this.mCallingPhoneId = phoneId;
    ...
    /* access modifiers changed from: private */
    public Call.SrvccState mSrvccState = Call.SrvccState.NONE;
    ...
    /* access modifiers changed from: private */
    public void onCheckIfRetriggerDataAllowed(int phoneId) {
