        ...
        try {
            ...
            if (i == 1) {
                ...
                switch (i) {
                    ...
                    case EVENT_PHB_LOAD_DONE /*{ENCODED_INT: 103}*/:
                    ...
                    case 104:
                        ...
                        if (ar9.exception == null) {
                            ...
                            while (i3 < entries2.length) {
                                MtkAdnRecord adn6 = getAdnRecordFromPhbEntry(entries2[i3]);
                                if (adn6 != null) {
                    ...
                    case 105:
                        ...
                        for (int i4 = 0; i4 < readInfo2[2]; i4++) {
                            this.mAdns.add(i4, new MtkAdnRecord(this.mEf, i4 + 1, "", ""));
                        }
