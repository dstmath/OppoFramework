...
public class MtkUsimPhoneBookManager extends UsimPhoneBookManager {
    ...
    public ArrayList<MtkAdnRecord> mPhoneBookRecords;
    ...
    /* access modifiers changed from: private */
    public Message pendingResponse;
                ...
                switch (msg.what) {
                    case 90:
                        ...
                        if (MtkUsimPhoneBookManager.this.pendingResponse != null) {
                            ...
                            Message unused = MtkUsimPhoneBookManager.this.pendingResponse = null;
                            return;
                        }
                        return;
                    case 91:
    ...
    public ArrayList<MtkAdnRecord> loadEfFilesFromUsim(Object object) {
        ...
        synchronized (this.mLock) {
            ...
            if (!this.mPhoneBookRecords.isEmpty()) {
                ...
                ArrayList<MtkAdnRecord> recordsIfLoaded = this.mAdnCache.getRecordsIfLoaded(28474, null);
                return recordsIfLoaded;
            }
        }
    }
    ...
    private void readAnrFileAndWait(int recId) {
        ...
        if (arrayList != null && arrayList.size() != 0) {
            ...
            int index = 0;
            while (index < this.mPbrRecords.get(recId).mAnrIndex) {
                File anrFile = files.get((index * 256) + 196);
                if (anrFile == null) {
                    index++;
                } else if (anrFile.getParentTag() == 169) {
    ...
    private boolean readAdnFileAndWait(int recId) {
        ...
        if (arrayList != null && arrayList.size() > recId) {
            int unused = this.mPbrRecords.get(recId).mMasterFileRecordNum = this.mPhoneBookRecords.size() - previousSize;
        }
        ...
        if (i == EVENT_GET_RECORDS_SIZE_DONE) {
            ...
            switch (i) {
                ...
                case 21:
                    ...
                    return;
                case EVENT_EMAIL_RECORD_LOAD_OPTMZ_DONE /*{ENCODED_INT: 22}*/:
                    ...
                    return;
                case EVENT_ANR_RECORD_LOAD_OPTMZ_DONE /*{ENCODED_INT: 23}*/:
                    ...
                    return;
                case EVENT_SNE_RECORD_LOAD_OPTMZ_DONE /*{ENCODED_INT: 24}*/:
                    ...
                    return;
                case EVENT_QUERY_EMAIL_AVAILABLE_OPTMZ_DONE /*{ENCODED_INT: 25}*/:
                    ...
                    return;
                case EVENT_QUERY_ANR_AVAILABLE_OPTMZ_DONE /*{ENCODED_INT: 26}*/:
                    ...
                    return;
                case EVENT_QUERY_SNE_AVAILABLE_OPTMZ_DONE /*{ENCODED_INT: 27}*/:
                    ...
                    return;
                case EVENT_AAS_LOAD_DONE_OPTMZ /*{ENCODED_INT: 28}*/:
    ...
    private class PbrRecord {
        /* access modifiers changed from: private */
        public int mAnrIndex = 0;
        /* access modifiers changed from: private */
        public SparseArray<File> mFileIds = new SparseArray<>();
        /* access modifiers changed from: private */
        public int mMasterFileRecordNum;
        ...
        public void parseEfAndSFI(SimTlv tlv, int parentTag) {
            ...
            do {
                ...
                switch (tag2) {
                    ...
                    case 200:
                    case 201:
                    case ExternalSimConstants.EVENT_TYPE_RECEIVE_RSIM_AUTH_RSP /*{ENCODED_INT: 202}*/:
                    case ExternalSimConstants.EVENT_TYPE_RSIM_AUTH_DONE /*{ENCODED_INT: 203}*/:
                        byte[] data = tlv.getData();
                        if (data.length >= 2 && data.length <= 3) {
                            ...
                            int efid = ((data[0] & PplMessageManager.Type.INVALID) << 8) | (data[1] & 255);
                            if (tag2 == 196) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0090, code lost:
        logi("removeUsimGroupById result is " + r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:64:0x015e, code lost:
        logi("addContactToGroup end adnIndex is " + r18 + " to grp " + r19);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00e9, code lost:
        logi("updateContactToGroups end grpIdList is " + r10 + " to grp list count " + r11.length);
     */
        ...
        if (file.getParentTag() == 168) {
            ...
            if (size != null) {
                ...
                if (size.length == 3) {
                    ...
                    if (tag == 202) {
                        int i4 = nOffset2;
                        while (i4 < this.mEmailFileSize + nOffset2) {
                            try {
            ...
            if (arrayList != null && arrayList.size() > recId4) {
                if (this.mIapFileList.get(recId4).size() != 0) {
                    ...
                    if (!(nMax3 == 195 || nMax3 == 196)) {
                        ...
                        int i2 = nOffset;
                        while (i2 < this.mEmailFileSize + nOffset) {
                            try {
                            ...
                            while (i3 < nMax2) {
                                try {
                                    ...
                                    if (arec.getAlphaTag().length() > 0 || arec.getNumber().length() > 0) {
                                        int index = iapList.get(i3 - nOffset)[type2Index] & 255;
                                        if (index <= 0) {
                                            recId2 = recId4;
                                            files = files2;
                                            iapFile = iapFile2;
    ...
    public int updateSneByAdnIndex(String sne, int adnIndex, MtkAdnRecord oldAdn) {
        ...
        if (arrayList != null) {
            if (arrayList.size() != 0) {
                ...
                SparseArray<File> files = this.mPbrRecords.get(pbrRecNum2).mFileIds;
                if (files != null) {
                    if (files.get(195) != null) {
                        ArrayList<MtkAdnRecord> arrayList2 = this.mPhoneBookRecords;
                        if (arrayList2 != null) {
                            if (!arrayList2.isEmpty()) {
                                if (oldAdn != null) {
                                ...
                                synchronized (obj2) {
                                    if (sne != null) {
                                        try {
                                            if (sne.length() == 0) {
                                                ...
                                                logi("updateSneByAdnIndex end sne is " + sne + ",adnIndex " + adnIndex);
                                                return this.mResult;
                                            }
                                        } catch (Throwable th2) {
                                            th = th2;
                                    ...
                                    if (oldSne != null) {
                                        if (oldSne.length() != 0) {
                                            this.mCi.deleteUPBEntry(2, pbrRecNum, adnIndex, msg);
                                            this.mLock.wait();
                                            logi("updateSneByAdnIndex end sne is " + sne + ",adnIndex " + adnIndex);
                                            return this.mResult;
                                        }
    ...
    /* access modifiers changed from: private */
    public void clearAllEFPbcControlInformation(int efid, int recordSize, int recordCount) {
    ...
    /* access modifiers changed from: private */
    public void resetEFpbcControlInfor(int efid, int numRecords) {
