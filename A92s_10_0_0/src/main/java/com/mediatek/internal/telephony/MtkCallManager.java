...
public class MtkCallManager extends CallManager {
    ...
    public class MtkCallManagerHandler extends CallManager.CallManagerHandler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (!MtkCallManager.this.getActiveFgCallState(((Connection) ((AsyncResult) msg.obj).result).getCall().getPhone().getSubId()).isDialing() && !MtkCallManager.this.hasMoreThanOneRingingCall()) {
