...
public class MtkUiccController extends UiccController {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:92:0x0418, code lost:
        return;
     */
                        ...
                        if (i != 5 && i != 6) {
                            ...
                            switch (i) {
                                ...
                                case 102:
                                    ...
                                    editorOff.commit();
                                    break;
                                case EVENT_SIM_MISSING /*{ENCODED_INT: 103}*/:
                                ...
                                case 105:
                                    ...
                                    break;
                                case EVENT_GET_ICC_STATUS_DONE_FOR_SIM_RECOVERY /*{ENCODED_INT: 106}*/:
                                    mtkLog("Received EVENT_GET_ICC_STATUS_DONE_FOR_SIM_RECOVERY");
                                    onGetIccCardStatusDone((AsyncResult) msg.obj, index);
                                    break;
                                case EVENT_SIM_PLUG_OUT /*{ENCODED_INT: 107}*/:
                                    ...
                                    break;
                                case EVENT_SIM_PLUG_IN /*{ENCODED_INT: 108}*/:
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case 114:
                                            ...
                                            return;
                                        case EVENT_CARD_DETECTED_IND /*{ENCODED_INT: 115}*/:
