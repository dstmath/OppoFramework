...
public class DataSubSelector {
    ...
    public static String ACTION_BOOT_COMPLETE = "android.intent.action.BOOT_COMPLETED";
    /* access modifiers changed from: private */
    public static String ACTION_SUBSIDY_LOCK_STATE_CHANGE = "com.mediatek.subsidy_lock.state_change";
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action != null) {
                ...
                if (action.equals("android.telephony.action.SIM_APPLICATION_STATE_CHANGED")) {
                    ...
                    boolean unused = DataSubSelector.this.mAirplaneModeOn = intent.getBooleanExtra("state", false);
                    ...
                    if (!DataSubSelector.this.mAirplaneModeOn) {
                        if (DataSubSelector.this.mIsNeedWaitAirplaneModeOff) {
                            boolean unused2 = DataSubSelector.this.mIsNeedWaitAirplaneModeOff = false;
                            DataSubSelector.this.handleAirPlaneModeOff(intent);
                        }
                        if (DataSubSelector.this.mIsNeedWaitAirplaneModeOffRoaming) {
                            boolean unused3 = DataSubSelector.this.mIsNeedWaitAirplaneModeOffRoaming = false;
                        }
                    }
    ...
    /* access modifiers changed from: private */
    public boolean mIsNeedWaitAirplaneModeOff = false;
    /* access modifiers changed from: private */
    public boolean mIsNeedWaitAirplaneModeOffRoaming = false;
