...
public class MtkServiceStateTracker extends ServiceStateTracker {
    ...
    public boolean mForceBroadcastServiceState = false;
    ...
    /* access modifiers changed from: private */
    public String mLastPSRegisteredPLMN = null;
    private int mLastPhoneGetNitz = -1;
    /* access modifiers changed from: private */
    public String mLastRegisteredPLMN = null;
    ...
    private BroadcastReceiver mMtkIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("android.telephony.action.CARRIER_CONFIG_CHANGED")) {
                ...
                boolean unused = MtkServiceStateTracker.this.mAlarmSwitch = false;
                ...
                if (slotId == MtkServiceStateTracker.this.mPhone.getPhoneId()) {
                    ...
                    if (!MtkServiceStateTracker.this.mPhone.isPhoneTypeGsm()) {
                        if (1 == simState) {
                            String unused2 = MtkServiceStateTracker.this.mMdn = null;
                        }
                    } else if (simState == 1) {
                        String unused3 = MtkServiceStateTracker.this.mLastRegisteredPLMN = null;
                        String unused4 = MtkServiceStateTracker.this.mLastPSRegisteredPLMN = null;
                    }
                }
                ...
                try {
                    OpTelephonyCustomizationFactoryBase unused5 = MtkServiceStateTracker.this.mTelephonyCustomizationFactory = OpTelephonyCustomizationUtils.getOpFactory(MtkServiceStateTracker.this.mPhone.getContext());
                    IServiceStateTrackerExt unused6 = MtkServiceStateTracker.this.mServiceStateTrackerExt = MtkServiceStateTracker.this.mTelephonyCustomizationFactory.makeServiceStateTrackerExt(MtkServiceStateTracker.this.mPhone.getContext());
    ...
    /* access modifiers changed from: private */
    public IServiceStateTrackerExt mServiceStateTrackerExt = null;
    /* access modifiers changed from: private */
    public OpTelephonyCustomizationFactoryBase mTelephonyCustomizationFactory = null;
    ...
    /* access modifiers changed from: private */
    public Handler mtkHandler;
    private HandlerThread mtkHandlerThread = new HandlerThread("MtkHandlerThread");
    private int oosFlag = -1;
    /* access modifiers changed from: private */
    public MtkServiceState turboSS = new MtkServiceState();
    /* access modifiers changed from: private */
    public SignalStrength turboSig = null;
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 2) {
                ...
                if (i == 3) {
                    ...
                    MtkServiceStateTracker mtkServiceStateTracker2 = MtkServiceStateTracker.this;
                    SignalStrength unused = mtkServiceStateTracker2.turboSig = new MtkSignalStrength(mtkServiceStateTracker2.mPhone.getPhoneId(), (SignalStrength) ar.result);
                    ...
                    NetworkRegistrationInfo networkRegState = new NetworkRegistrationInfo(1, 1, voiceRegState.regState, networkType, voiceRegState.reasonForDenial, false, (List) null, (CellIdentity) null, voiceRegState.cssSupported, voiceRegState.roamingIndicator, voiceRegState.systemIsInPrl, voiceRegState.defaultRoamingIndicator);
                    ...
                    NetworkRegistrationInfo networkRegState2 = new NetworkRegistrationInfo(2, 1, dataRegState.base.regState, networkType2, dataRegState.base.reasonDataDenied, false, (List) null, (CellIdentity) null, dataRegState.base.maxDataCalls, nrIndicators.isDcNrRestricted, nrIndicators.isNrAvailable, nrIndicators.isEndcAvailable, new LteVopsSupportInfo(1, 1), isUsingCarrierAggregation);
                    ...
                    switch (i) {
                        case MtkServiceStateTracker.EVENT_RIL_READY /*{ENCODED_INT: 120}*/:
                            MtkServiceStateTracker.this.mCi.registerForNetworkStateChanged(MtkServiceStateTracker.this.mtkHandler, 2, (Object) null);
                            break;
                        case MtkServiceStateTracker.EVENT_UPDATE_PLMN /*{ENCODED_INT: 121}*/:
                            ...
                            if (((NetworkRegistrationManager) MtkServiceStateTracker.this.mRegStateManagers.get(1)).isServiceConnected()) {
                                ...
                                if (!MtkServiceStateTracker.this.mSubscriptionController.setPlmnSpn(MtkServiceStateTracker.this.mPhone.getPhoneId(), mtkplmn.showPlmn, mtkplmn.plmn, mtkplmn.showSpn, mtkplmn.spn)) {
                                    boolean unused2 = MtkServiceStateTracker.this.mSpnUpdatePending = true;
                                    return;
                                }
                                return;
                                ...
                                if ((MtkServiceStateTracker.this.turboSS.getVoiceRegState() == 0 && !MtkServiceStateTracker.this.turboSS.getVoiceRoaming()) || (MtkServiceStateTracker.this.turboSS.getDataRegState() == 0 && !MtkServiceStateTracker.this.turboSS.getDataRoaming())) {
                                    ...
                                    MtkServiceState unused3 = MtkServiceStateTracker.this.turboSS = new MtkServiceState();
                        ...
                        case MtkServiceStateTracker.EVENT_RESTART_TURBO /*{ENCODED_INT: 122}*/:
                            break;
                        case MtkServiceStateTracker.EVENT_CHECK_POLL_SERVICE /*{ENCODED_INT: 123}*/:
            ...
            if (((NetworkRegistrationManager) MtkServiceStateTracker.this.mRegStateManagers.get(1)).isServiceConnected() || this.stop) {
                MtkServiceStateTracker.this.log("MtkHandler: stop MTK turbo");
                MtkServiceStateTracker.this.mCi.unregisterForNetworkStateChanged(MtkServiceStateTracker.this.mtkHandler);
                return;
            }
            ...
            if (i == 11) {
                ...
                switch (i) {
                    ...
                    case 102:
                        ...
                        return;
                    case EVENT_PS_NETWORK_STATE_CHANGED /*{ENCODED_INT: 103}*/:
                    ...
                    case 105:
                        ...
                        return;
                    case EVENT_ICC_REFRESH /*{ENCODED_INT: 106}*/:
                        if (this.mPhone.isPhoneTypeGsm()) {
                        ...
                        return;
                    case EVENT_IMEI_LOCK /*{ENCODED_INT: 107}*/:
                        if (this.mPhone.isPhoneTypeGsm()) {
    ...
    private void onPsNetworkStateChangeResult(AsyncResult ar) {
        ...
        if (info.length >= 4) {
            log("onPsNetworkStateChangeResult, mPsRegState:" + this.mPsRegState + ",newUrcState:" + newUrcState + ",info[0]:" + info[0] + ",info[1]:" + info[1] + ",info[2]:" + info[2] + ",info[3]:" + info[3]);
        } else {
            log("onPsNetworkStateChangeResult, mPsRegState:" + this.mPsRegState + ",newUrcState:" + newUrcState + ",info[0]:" + info[0] + ",info[1]:" + info[1] + ",info[2]:" + info[2]);
        }
    ...
    /* JADX INFO: Multiple debug info for r5v11 android.telephony.CellIdentity: [D('mMtkNewSS' mediatek.telephony.MtkServiceState), D('tempCellId' android.telephony.CellIdentity)] */
    /* JADX INFO: Multiple debug info for r4v39 int: [D('hasPlmnChange' boolean), D('transport' int)] */
    /* access modifiers changed from: protected */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:252:0x05ec  */
    /* JADX WARNING: Removed duplicated region for block: B:259:0x062c  */
    /* JADX WARNING: Removed duplicated region for block: B:265:0x06b2  */
    /* JADX WARNING: Removed duplicated region for block: B:268:0x06e7  */
    /* JADX WARNING: Removed duplicated region for block: B:271:0x06fc  */
    /* JADX WARNING: Removed duplicated region for block: B:278:0x0747  */
    /* JADX WARNING: Removed duplicated region for block: B:280:0x074d  */
    /* JADX WARNING: Removed duplicated region for block: B:282:0x0761  */
    /* JADX WARNING: Removed duplicated region for block: B:284:0x0768  */
    /* JADX WARNING: Removed duplicated region for block: B:291:0x0781  */
    /* JADX WARNING: Removed duplicated region for block: B:295:0x0792  */
    /* JADX WARNING: Removed duplicated region for block: B:303:0x07d8  */
    /* JADX WARNING: Removed duplicated region for block: B:304:0x07fb  */
    /* JADX WARNING: Removed duplicated region for block: B:315:0x0847  */
    /* JADX WARNING: Removed duplicated region for block: B:316:0x084e  */
    /* JADX WARNING: Removed duplicated region for block: B:324:0x088c  */
    /* JADX WARNING: Removed duplicated region for block: B:327:0x08ee  */
    /* JADX WARNING: Removed duplicated region for block: B:333:0x0907  */
    /* JADX WARNING: Removed duplicated region for block: B:335:0x091e  */
    /* JADX WARNING: Removed duplicated region for block: B:338:0x0931  */
    /* JADX WARNING: Removed duplicated region for block: B:361:0x09a5  */
    /* JADX WARNING: Removed duplicated region for block: B:363:0x09aa  */
    /* JADX WARNING: Removed duplicated region for block: B:374:0x09c9  */
    /* JADX WARNING: Removed duplicated region for block: B:376:0x09d0  */
    /* JADX WARNING: Removed duplicated region for block: B:378:0x09d7  */
    /* JADX WARNING: Removed duplicated region for block: B:380:0x09de  */
    /* JADX WARNING: Removed duplicated region for block: B:382:0x09e5  */
    /* JADX WARNING: Removed duplicated region for block: B:392:0x0a28  */
    /* JADX WARNING: Removed duplicated region for block: B:394:0x0a35  */
    /* JADX WARNING: Removed duplicated region for block: B:397:0x0a46  */
    /* JADX WARNING: Removed duplicated region for block: B:406:0x0a91  */
    /* JADX WARNING: Removed duplicated region for block: B:409:0x0a99  */
    /* JADX WARNING: Removed duplicated region for block: B:412:0x0aa9  */
                    ...
                    if (this.mSS.getDataRoaming() || !mFinalMtkNewSS.getDataRoaming()) {
                        ...
                        if (this.mSS.getDataRoamingType() != mFinalMtkNewSS.getDataRoamingType()) {
                            ...
                            if (!hasVoiceRegStateChanged || anyDataRegChanged) {
                                ...
                                hasDataRoamingOn = hasNrStateChanged2;
    ...
    public void mtkRegisterAllDataDisconnected() {
        ...
        boolean isDefaultDataDisconnected = ProxyController.getInstance().areAllDataDisconnected(dds);
        log("powerOffRadioSafely: apm:" + isAirplaneModeOn + ", dds:" + dds + ", mSubId:" + this.mPhone.getSubId() + ", shutdown:" + isDeviceShuttingDown() + ", isDefaultDataDisconnected:" + isDefaultDataDisconnected);
        if (dds == this.mPhone.getSubId() || ((!isAirplaneModeOn && !isDeviceShuttingDown()) || isDefaultDataDisconnected)) {
            synchronized (this) {
                log("powerOffRadioSafely: register EVENT_ALL_DATA_DISCONNECTED for self phone");
                this.mPhone.registerForAllDataDisconnected(this, 49);
