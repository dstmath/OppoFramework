...
public class MtkCatService extends CatService implements MtkAppInterface {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("com.mediatek.intent.action.IVSR_NOTIFY")) {
                if (MtkCatService.this.mSlotId == intent.getIntExtra("slot", 0) && intent.getStringExtra("action").equals("start")) {
                    ...
                    boolean unused = MtkCatService.this.isIvsrBootUp = true;
                ...
                boolean unused2 = MtkCatService.this.isDisplayTextDisabled = true;
                ...
                if (id == MtkCatService.this.mSlotId) {
                    int unused3 = MtkCatService.this.simState = intent.getIntExtra("android.telephony.extra.SIM_STATE", 0);
                    int unused4 = MtkCatService.this.simIdfromIntent = id;
                ...
                if ("PLUGOUT".equals(reason) && slotId == MtkCatService.this.mSlotId) {
                    ...
                    boolean unused5 = MtkCatService.this.mHasShownCUMessage = false;
                }
            }
        }
    };
    /* access modifiers changed from: private */
    public boolean isDisplayTextDisabled = false;
    /* access modifiers changed from: private */
    public boolean isIvsrBootUp = false;
    private BipService mBipService = null;
    /* access modifiers changed from: private */
    public boolean mHasShownCUMessage = false;
    ...
    Handler mTimeoutHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 15) {
                ...
                boolean unused = MtkCatService.this.isDisplayTextDisabled = false;
            } else if (i == 46) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.lang.String, com.android.internal.telephony.cat.CatCmdMessage]
     candidates:
    ...
    /* access modifiers changed from: private */
    public void handleDBHandler(int sim_id) {
