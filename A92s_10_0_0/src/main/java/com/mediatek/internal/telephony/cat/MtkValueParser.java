...
abstract class MtkValueParser {
    ...
    static Item retrieveItem(ComprehensionTlv ctlv) throws ResultException {
        ...
        try {
            return new Item(rawValue[valueIndex] & 255, IccUtils.adnStringFieldToString(rawValue, valueIndex + 1, removeInvalidCharInItemTextString(rawValue, valueIndex, length - 1)));
