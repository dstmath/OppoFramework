...
public class ExternalSimManager {
    ...
    /* access modifiers changed from: private */
    public static int sPreferedAkaSlot = -1;
    /* access modifiers changed from: private */
    public static int sPreferedRsimSlot = -1;
    /* access modifiers changed from: private */
    public CommandsInterface[] mCi = null;
    /* access modifiers changed from: private */
    public Context mContext = null;
    /* access modifiers changed from: private */
    public VsimEvenHandler mEventHandler = null;
    /* access modifiers changed from: private */
    public VsimIndEventHandler mIndHandler = null;
    /* access modifiers changed from: private */
            ...
            if (!action.equals("android.intent.action.ACTION_SET_RADIO_CAPABILITY_DONE") || ExternalSimManager.this.mSetCapabilityDone != 1) {
                if (action.equals("android.intent.action.ACTION_SET_RADIO_CAPABILITY_FAILED") && ExternalSimManager.this.mSetCapabilityDone == 1) {
                    synchronized (ExternalSimManager.this.mLock) {
                        int unused = ExternalSimManager.this.mSetCapabilityDone = 3;
                ...
                synchronized (ExternalSimManager.this.mLock) {
                    int unused2 = ExternalSimManager.this.mSetCapabilityDone = 2;
                    ExternalSimManager.this.sendCapabilityDoneEvent();
                }
    ...
    /* access modifiers changed from: private */
    public int mSetCapabilityDone = 0;
    private int mUserMainPhoneId = -1;
    /* access modifiers changed from: private */
    public boolean mUserRadioOn = false;
    ...
    private ExternalSimManager(Context context, CommandsInterface[] ci) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                VsimEvenHandler unused = externalSimManager.mEventHandler = new VsimEvenHandler();
                ExternalSimManager externalSimManager2 = ExternalSimManager.this;
                VsimIndEventHandler unused2 = externalSimManager2.mIndHandler = new VsimIndEventHandler();
    ...
    public void startRecoveryTimer() {
        ...
        while (i < TelephonyManager.getDefault().getSimCount()) {
            ...
            if (persist == null || persist.length() <= 0 || !String.valueOf(2).equals(persist)) {
                i++;
            } else if (this.mRecoveryTimer == null) {
    ...
    public void disableAllVsimWithResetModem() {
        ...
        if (vsimEvenHandler != null) {
            int unused = vsimEvenHandler.retryIfRadioUnavailable(null);
        }
    ...
    public static class VsimEvent {
        ...
        public int getInt() {
            ...
            synchronized (this) {
                if (this.mData.length >= 4) {
                    ret = ((this.mData[this.mReadOffset + 3] & PplMessageManager.Type.INVALID) << 24) | ((this.mData[this.mReadOffset + 2] & PplMessageManager.Type.INVALID) << PplControlData.STATUS_WIPE_REQUESTED) | ((this.mData[this.mReadOffset + 1] & PplMessageManager.Type.INVALID) << 8) | (this.mData[this.mReadOffset] & 255);
                    this.mReadOffset += 4;
                }
            }
            return ret;
        ...
        public int getShort() {
            int ret;
            synchronized (this) {
                ret = ((this.mData[this.mReadOffset + 1] & PplMessageManager.Type.INVALID) << 8) | (this.mData[this.mReadOffset] & 255);
                this.mReadOffset += 2;
            }
            return ret;
        }
    ...
    public class VsimIoThread extends Thread {
        ...
        private int readInt() throws IOException {
            ...
            if (this.mInput.read(tempBuf, 0, 4) >= 0) {
                return ((tempBuf[1] & PplMessageManager.Type.INVALID) << 8) | (tempBuf[3] << 24) | ((tempBuf[2] & PplMessageManager.Type.INVALID) << PplControlData.STATUS_WIPE_REQUESTED) | (tempBuf[0] & PplMessageManager.Type.INVALID);
            }
    ...
    public class VsimEvenHandler extends Handler {
        ...
        /* access modifiers changed from: private */
        public Runnable mTryResetModemRunnable = new Runnable() {
        ...
        /* access modifiers changed from: private */
        public VsimEvent[] mWaitingEvent = null;
                    ...
                    if (!(-1 == rsim || i == rsim || -1 == akaSim || i == akaSim)) {
                        ...
                        if (telephony != null) {
                            if (!turnOn) {
                                try {
                                    if (telephony.isRadioOnForSubscriber(subId, ExternalSimManager.this.mContext.getOpPackageName())) {
                                        boolean unused = ExternalSimManager.this.mUserRadioOn = true;
                            ...
                            if (true == turnOn && ExternalSimManager.this.mUserRadioOn) {
                                boolean unused2 = ExternalSimManager.this.mUserRadioOn = false;
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        if (result8 < 0) {
                                            ...
                                            try {
                                                int unused5 = ExternalSimManager.this.mSetCapabilityDone = 1;
                                                if (!switchModemCapability(slotId)) {
                                                    int unused6 = ExternalSimManager.this.mSetCapabilityDone = 0;
                                                    int unused7 = ExternalSimManager.sPreferedRsimSlot = -1;
                                                    result3 = result8;
                                                    try {
                                                    ...
                                                    if (ExternalSimManager.this.mSetCapabilityDone == 3) {
                                                        int unused8 = ExternalSimManager.sPreferedRsimSlot = -1;
                                                        i = 0;
                                                        sendVsimNotification(slotId, event.mTransactionId, 7, simType, null);
                                                        result5 = -2;
                                                    } else {
                                                    ...
                                                    try {
                                                        int unused9 = ExternalSimManager.this.mSetCapabilityDone = i;
                                                        result6 = result5;
        ...
        public void dispatchCallback(VsimEvent event) {
            synchronized (getLock(event.getMessageId())) {
                ...
                if (msgId == 1009) {
                    ...
                    sendRsimAuthProgressEvent(201);
                    int unused = event.mMessageId = ExternalSimConstants.MSG_ID_UICC_APDU_REQUEST;
                    TelephonyManager.getDefault();
