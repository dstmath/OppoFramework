            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 14:
                        ...
                        setForegroundSports();
                        return true;
                    case TRANSACTION_setSysInfo /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 20:
                        ...
                        return true;
                    case TRANSACTION_updateMultiDuplicatePacketLink /*{ENCODED_INT: 21}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_setPredictInfo /*{ENCODED_INT: 22}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setPredictInfo(data.readString(), data.readInt());
                        return true;
                    case TRANSACTION_perfLockAcquire /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result2 = perfLockAcquire(data.readInt(), data.readInt(), data.createIntArray());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case TRANSACTION_perfLockRelease /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
                        perfLockRelease(data.readInt());
                        return true;
                    case TRANSACTION_querySysInfo /*{ENCODED_INT: 25}*/:
                        data.enforceInterface(DESCRIPTOR);
