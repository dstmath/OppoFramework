    ...
    private static String searchTargetPath(String target) {
        ...
        if (target.endsWith(".apk")) {
            ...
            if (!TextUtils.isEmpty(RSC_SYSTEM_APK_PATH)) {
                searchFolders = new String[]{RSC_SYSTEM_APK_PATH + "/app/", RSC_PRODUCT_APK_PATH + "/app/", SYSTEM_APK_PATH, PRODUCT_APK_PATH, CUSTOM_APK_PATH};
            } else {
                searchFolders = new String[]{SYSTEM_APK_PATH, PRODUCT_APK_PATH, CUSTOM_APK_PATH};
            }
        } else {
