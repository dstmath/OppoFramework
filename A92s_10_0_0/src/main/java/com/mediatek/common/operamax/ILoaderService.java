            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 19:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_removeAllDirectedHeaderFields /*{ENCODED_INT: 20}*/:
                        data.enforceInterface(DESCRIPTOR);
                        removeAllDirectedHeaderFields();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isHeaderFieldDirected /*{ENCODED_INT: 21}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getDirectedHeaderFieldList /*{ENCODED_INT: 22}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String[] _result5 = getDirectedHeaderFieldList();
                        reply.writeNoException();
                        reply.writeStringArray(_result5);
                        return true;
                    case TRANSACTION_setCompressLevel /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setCompressLevel(data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getCompressLevel /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
