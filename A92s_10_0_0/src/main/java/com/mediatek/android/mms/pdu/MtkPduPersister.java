...
public class MtkPduPersister extends PduPersister {
    ...
    /* JADX INFO: Multiple debug info for r11v2 long: [D('persistPdu_t' long), D('values' android.content.ContentValues)] */
    /* JADX INFO: Multiple debug info for r10v2 long: [D('addressMap' java.util.HashMap<java.lang.Integer, com.google.android.mms.pdu.EncodedStringValue[]>), D('persistAddress_t' long)] */
    /* JADX INFO: Multiple debug info for r11v3 android.content.ContentValues: [D('values' android.content.ContentValues), D('msgId' long)] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{android.content.ContentValues.put(java.lang.String, java.lang.Boolean):void}
     arg types: [java.lang.String, int]
     candidates:
