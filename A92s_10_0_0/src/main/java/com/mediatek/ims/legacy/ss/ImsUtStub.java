...
public class ImsUtStub extends ImsUtImplBase {
    ...
    /* access modifiers changed from: private */
    public boolean mIsInVoLteCall = false;
    /* access modifiers changed from: private */
    public boolean mIsNeedImsDereg = false;
    /* access modifiers changed from: private */
    ...
    public static ImsUtStub getInstance(Context context, int phoneId, ImsService service) {
        synchronized (sImsUtStubs) {
            if (sImsUtStubs.containsKey(Integer.valueOf(phoneId))) {
                ImsUtStub m = sImsUtStubs.get(Integer.valueOf(phoneId));
                return m;
            }
            sImsUtStubs.put(Integer.valueOf(phoneId), new ImsUtStub(context, phoneId, service));
            ImsUtStub imsUtStub = sImsUtStubs.get(Integer.valueOf(phoneId));
            return imsUtStub;
        }
    }
    ...
    private class ResultHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case ImsUtStub.IMS_UT_EVENT_GET_CB /*{ENCODED_INT: 1000}*/:
                ...
                case ImsUtStub.IMS_UT_EVENT_GET_CF /*{ENCODED_INT: 1001}*/:
                    if (ImsUtStub.this.mListener != null) {
                        ...
                        if (ar2.exception == null) {
                            ...
                            if (ssConfig.isNeedIMSDereg()) {
                                ...
                                if (!enable || disableIMSDereg) {
                                    ...
                                    boolean unused = ImsUtStub.this.mIsNeedImsDereg = true;
                                } else {
                ...
                case ImsUtStub.IMS_UT_EVENT_GET_CW /*{ENCODED_INT: 1002}*/:
                    if (ImsUtStub.this.mListener != null) {
                    ...
                    return;
                case ImsUtStub.IMS_UT_EVENT_GET_CLIR /*{ENCODED_INT: 1003}*/:
                    if (ImsUtStub.this.mListener != null) {
                    ...
                    return;
                case ImsUtStub.IMS_UT_EVENT_GET_CLIP /*{ENCODED_INT: 1004}*/:
                case ImsUtStub.IMS_UT_EVENT_GET_COLR /*{ENCODED_INT: 1005}*/:
                case ImsUtStub.IMS_UT_EVENT_GET_COLP /*{ENCODED_INT: 1006}*/:
                    if (ImsUtStub.this.mListener != null) {
                    ...
                    return;
                case ImsUtStub.IMS_UT_EVENT_SET_CB /*{ENCODED_INT: 1007}*/:
                case ImsUtStub.IMS_UT_EVENT_SET_CF /*{ENCODED_INT: 1008}*/:
                    if (ImsUtStub.this.mListener != null) {
                            ...
                            if (ar6.exception == null && ssConfig.isNeedIMSDereg()) {
                                ...
                                if (enable2 && !disableIMSDereg2) {
                                    if (!ImsUtStub.this.mIsInVoLteCall) {
                                        ...
                                        Log.d(ImsUtStub.TAG, "During call and later do IMS dereg");
                                        boolean unused2 = ImsUtStub.this.mIsNeedImsDereg = true;
                                        break;
                                    }
                                } else {
                                    Log.d(ImsUtStub.TAG, "Skip IMS dereg.");
                    ...
                    break;
                case ImsUtStub.IMS_UT_EVENT_SET_CW /*{ENCODED_INT: 1009}*/:
                case ImsUtStub.IMS_UT_EVENT_SET_CLIR /*{ENCODED_INT: 1010}*/:
                case ImsUtStub.IMS_UT_EVENT_SET_CLIP /*{ENCODED_INT: 1011}*/:
                case ImsUtStub.IMS_UT_EVENT_SET_COLR /*{ENCODED_INT: 1012}*/:
                case ImsUtStub.IMS_UT_EVENT_SET_COLP /*{ENCODED_INT: 1013}*/:
                    break;
                case ImsUtStub.IMS_UT_EVENT_IMS_DEREG /*{ENCODED_INT: 1014}*/:
                    ImsUtStub.this.mImsService.deregisterImsWithCause(ImsUtStub.this.mPhoneId, 2);
                    return;
                default:
