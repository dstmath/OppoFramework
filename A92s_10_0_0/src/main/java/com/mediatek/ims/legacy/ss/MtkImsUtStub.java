...
public class MtkImsUtStub extends MtkImsUtImplBase {
    ...
    /* access modifiers changed from: private */
    public ImsUtStub mImsUtStub = null;
    /* access modifiers changed from: private */
    ...
    public static MtkImsUtStub getInstance(Context context, int phoneId, ImsService service) {
        synchronized (sMtkImsUtStubs) {
            if (sMtkImsUtStubs.containsKey(Integer.valueOf(phoneId))) {
                MtkImsUtStub m = sMtkImsUtStubs.get(Integer.valueOf(phoneId));
                return m;
            }
            sMtkImsUtStubs.put(Integer.valueOf(phoneId), new MtkImsUtStub(context, phoneId, service));
            MtkImsUtStub mtkImsUtStub = sMtkImsUtStubs.get(Integer.valueOf(phoneId));
            return mtkImsUtStub;
        }
    }
    ...
    private class ResultHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MtkImsUtStub.IMS_UT_EVENT_GET_CF_TIME_SLOT /*{ENCODED_INT: 1200}*/:
                    if (MtkImsUtStub.this.mListener != null) {
                        ...
                        if (ar.exception == null) {
                            ...
                            ImsUtStub access$200 = MtkImsUtStub.this.mImsUtStub;
                            ImsUtStub unused = MtkImsUtStub.this.mImsUtStub;
                            access$200.notifyUtConfigurationQueryFailed(msg, ImsUtStub.xcapExceptionToImsReasonInfo((XcapException) ar.exception, MtkImsUtStub.this.mPhoneId));
                            return;
                ...
                case MtkImsUtStub.IMS_UT_EVENT_SET_CF_TIME_SLOT /*{ENCODED_INT: 1201}*/:
                    if (MtkImsUtStub.this.mListener != null) {
                        ...
                        if (ar2.exception == null) {
                            ...
                            ImsUtStub access$2002 = MtkImsUtStub.this.mImsUtStub;
                            ImsUtStub unused2 = MtkImsUtStub.this.mImsUtStub;
                            access$2002.notifyUtConfigurationUpdateFailed(msg, ImsUtStub.xcapExceptionToImsReasonInfo((XcapException) ar2.exception, MtkImsUtStub.this.mPhoneId));
                            return;
                ...
                case MtkImsUtStub.IMS_UT_EVENT_SET_CB_WITH_PWD /*{ENCODED_INT: 1202}*/:
                    if (MtkImsUtStub.this.mListener != null) {
                        ...
                        if (ar3.exception == null) {
                            ...
                            ImsUtStub access$2003 = MtkImsUtStub.this.mImsUtStub;
                            ImsUtStub unused3 = MtkImsUtStub.this.mImsUtStub;
                            access$2003.notifyUtConfigurationUpdateFailed(msg, ImsUtStub.xcapExceptionToImsReasonInfo((XcapException) ar3.exception, MtkImsUtStub.this.mPhoneId));
                            return;
                ...
                case MtkImsUtStub.IMS_UT_EVENT_SETUP_XCAP_USER_AGENT_STRING /*{ENCODED_INT: 1203}*/:
                default:
                    Log.d(MtkImsUtStub.TAG, "Unknown Event: " + msg.what);
                    return;
                case MtkImsUtStub.IMS_UT_EVENT_GET_CF_WITH_CLASS /*{ENCODED_INT: 1204}*/:
                    if (MtkImsUtStub.this.mListener != null) {
                        ...
                        if (ar4.exception == null) {
                            ...
                            ImsUtStub access$2004 = MtkImsUtStub.this.mImsUtStub;
                            ImsUtStub unused4 = MtkImsUtStub.this.mImsUtStub;
                            access$2004.notifyUtConfigurationQueryFailed(msg, ImsUtStub.xcapExceptionToImsReasonInfo((XcapException) ar4.exception, MtkImsUtStub.this.mPhoneId));
                            return;
