...
public class MtkWapi {
    ...
    public static boolean setWapiCertAliasList(String aliases) {
        ...
        synchronized (getLock(supplicant)) {
            ...
            try {
                boolean checkStatusAndLogFailure = checkStatusAndLogFailure(supplicant, mMtkiface.setWapiCertAliasList(aliases), "setWapiCertAliasList");
    ...
    public static boolean setWapiCertAlias(SupplicantStaNetworkHal network, int supplicantNetworkId, String alias) {
        ...
        synchronized (getLock(network)) {
            try {
                ...
                boolean checkStatusAndLogFailure = checkStatusAndLogFailure(network, mtkIface.setWapiCertAlias(alias == null ? "NULL" : alias), "setWapiCertAlias");
                return checkStatusAndLogFailure;
            } catch (RemoteException e) {
