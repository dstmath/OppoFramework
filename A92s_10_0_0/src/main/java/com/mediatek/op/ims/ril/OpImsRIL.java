...
public final class OpImsRIL extends OpImsBaseCommands {
            ...
            if (i == 2) {
                ...
                if (i == 5) {
                    ...
                    if (((Long) msg.obj).longValue() == OpImsRIL.this.mRadioProxyCookie.get()) {
                        ...
                        IRadioOp unused = OpImsRIL.this.getRadioProxy(null);
                    }
                }
            } else if (msg.arg1 == OpImsRIL.this.mAckWlSequenceNum) {
                boolean unused2 = OpImsRIL.this.clearWakeLock(1);
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    public IRadioOp getRadioProxy(Message result) {
    ...
    static String requestToString(int request) {
        switch (request) {
            case MtkRILConstantsOp.RIL_REQUEST_DIAL_FROM:
                return "RIL_REQUEST_DIAL_FROM";
            case MtkRILConstantsOp.RIL_REQUEST_SEND_USSI_FROM:
                return "RIL_REQUEST_SEND_USSI_FROM";
            case MtkRILConstantsOp.RIL_REQUEST_CANCEL_USSI_FROM:
                return "RIL_REQUEST_CANCEL_USSI_FROM";
            case MtkRILConstantsOp.RIL_REQUEST_SET_EMERGENCY_CALL_CONFIG:
