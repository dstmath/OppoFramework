...
public class Oppo5GCellBlacklistMonitor {
    ...
    /* access modifiers changed from: private */
    public OppoFastRecovery mOppoFastRecovery;
    ...
    /* access modifiers changed from: private */
    public void setCellidToBlacklistInner(Message msg) {
        int cellid = msg.arg1;
    ...
    /* access modifiers changed from: private */
    public void updateCellidChangeInner(int oldCid, int newCid, boolean needStop) {
        ...
        } else if (!isCellidInBlacklist(newCid)) {
    ...
    /* access modifiers changed from: private */
    public void restoreNetworkTypeTimeout(Message msg) {
