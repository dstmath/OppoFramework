...
public class OppoLinkLatencyManagerService {
    ...
    private IBinder mBinder = new IOemLinkLatencyManager.Stub() {
        ...
        public boolean gameOptimizeExit() {
            ...
            try {
                ...
                int unused = OppoLinkLatencyManagerService.this.mPowerHandle = -1;
    ...
    public OemLinkLatencyInfo mCurrentStatus = new OemLinkLatencyInfo();
    private Phone mPhone = null;
    /* access modifiers changed from: private */
    public PowerHalMgr mPowerHalService = null;
    /* access modifiers changed from: private */
    public int mPowerHandle = -1;

    /* access modifiers changed from: private */
    public void setModemTAG(String pkgName) {
