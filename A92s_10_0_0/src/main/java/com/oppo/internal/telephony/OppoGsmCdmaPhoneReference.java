...
public class OppoGsmCdmaPhoneReference implements IOppoGsmCdmaPhone {
    ...
    public String LOG_TAG = "OppoGsmCdmaPhone";
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                if (i == 3) {
                    ...
                    int unused = OppoGsmCdmaPhoneReference.this.retrySaveConfig = 3;
                ...
                int unused2 = OppoGsmCdmaPhoneReference.this.retrySetConfig = 3;
    ...
    /* access modifiers changed from: private */
    public int retrySaveConfig = 3;
    /* access modifiers changed from: private */
    public int retrySetConfig = 3;
    ...
    public boolean handleCalloutControl() {
        logd("handleCalloutControl");
        if (OppoPolicyController.isCallOutEnable(this.mPhone)) {
            return false;
        }
        logd("ctmm vo block");
        return true;
    ...
    /* access modifiers changed from: private */
    public void setLteWifiConfig(boolean enabled) {
        String atCommand;
        if (enabled) {
    ...
    /* access modifiers changed from: private */
    public void saveLteWifiConfig(boolean enabled) {
        String atCommand;
        if (enabled) {
