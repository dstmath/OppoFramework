...
public class OppoTelephonyFactoryImpl extends OppoTelephonyFactory {
    public <T extends IOppoCommonFeature> T getFeature(T def, Object... vars) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$android$internal$telephony$common$OppoFeatureList$OppoIndex[def.index().ordinal()]) {
            case 1:
                return OppoFeatureManager.getTraceMonitor(getOppoPhone(vars));
            case 2:
                return OppoFeatureManager.getTraceMonitor(getOppoGsmCdmaPhone(vars));
            case 3:
                return OppoFeatureManager.getTraceMonitor(getOppoImsPhone(vars));
            case 4:
                return OppoFeatureManager.getTraceMonitor(getOppoNetworkManager(vars));
            case 5:
                return OppoFeatureManager.getTraceMonitor(getOppoServiceStateTracker(vars));
            case 6:
                return OppoFeatureManager.getTraceMonitor(getOppoNewNitzStateMachine(vars));
            case 7:
                return OppoFeatureManager.getTraceMonitor(getOppoCallManager(vars));
            case 8:
                return OppoFeatureManager.getTraceMonitor(getOppoCallTracker(vars));
            case 9:
                return OppoFeatureManager.getTraceMonitor(getOppoDataManager(vars));
            case 10:
                return OppoFeatureManager.getTraceMonitor(getOppoDcTracker(vars));
            case 11:
                return OppoFeatureManager.getTraceMonitor(getOppoSmsManager(vars));
            case 12:
                return OppoFeatureManager.getTraceMonitor(getOppoIccSmsInterfaceManager(vars));
            case 13:
                return OppoFeatureManager.getTraceMonitor(getOppoInboundSmsHandler(vars));
            case 14:
                return OppoFeatureManager.getTraceMonitor(getOppoSMSDispatcher(vars));
            case 15:
                return OppoFeatureManager.getTraceMonitor(getOppoSmsDispatchersController(vars));
            case 16:
                return OppoFeatureManager.getTraceMonitor(getOppoUiccManager(vars));
            case 17:
                return OppoFeatureManager.getTraceMonitor(getOppoSIMRecords(vars));
            case 18:
                return OppoFeatureManager.getTraceMonitor(getOppoRuimRecords(vars));
            case 19:
                return OppoFeatureManager.getTraceMonitor(getOppoSubscriptionController(vars));
            case 20:
                return OppoFeatureManager.getTraceMonitor(getOppoUiccController(vars));
            case NetworkDiagnoseUtils.RF_BAND21:
                return OppoFeatureManager.getTraceMonitor(getOppoAdnRecordCache(vars));
            case 22:
                return OppoFeatureManager.getTraceMonitor(getOppoIccPhoneBookInterfaceManager(vars));
            default:
