...
public class OppoTelephonyController {
    ...
    private final DisplayManager.DisplayListener mDisplayListener = new DisplayManager.DisplayListener() {
        ...
        public void onDisplayChanged(int displayId) {
            ...
            if (OppoTelephonyController.this.mScreenFirstState || OppoTelephonyController.this.mIsScreenOn != OppoTelephonyController.this.mScreenLastState) {
                boolean unused = OppoTelephonyController.this.mScreenFirstState = false;
                OppoTelephonyController oppoTelephonyController = OppoTelephonyController.this;
                boolean unused2 = oppoTelephonyController.mScreenLastState = oppoTelephonyController.mIsScreenOn;
    ...
    /* access modifiers changed from: private */
    public boolean mScreenFirstState = true;
    /* access modifiers changed from: private */
    public boolean mScreenLastState;
    ...
    /* access modifiers changed from: private */
    public void initFetureAfterDelay() {
    ...
    /* access modifiers changed from: private */
    public void notifyOemScreenChange(boolean isScreenOn) {
