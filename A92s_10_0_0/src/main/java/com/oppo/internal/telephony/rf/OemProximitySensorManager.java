...
public class OemProximitySensorManager {
    ...
    private static class ProximitySensorEventListener extends Handler implements SensorEventListener {
        ...
        /* access modifiers changed from: private */
        public boolean mIsHotspot24 = false;
        /* access modifiers changed from: private */
        public boolean mIsNormal24 = false;
        /* access modifiers changed from: private */
        public boolean mIsNormal5 = false;
        /* access modifiers changed from: private */
        public boolean mIsP2P5 = false;
        private volatile boolean mIsProximListen = false;
        private volatile boolean mIsTestCard = false;
        /* access modifiers changed from: private */
        public volatile int mLastAudioDeviceRoute;
        private PhoneState mLastCallState;
        /* access modifiers changed from: private */
        public volatile boolean mLastChargerPresent;
        private PhoneState mLastDataState;
        /* access modifiers changed from: private */
        public volatile boolean mLastHeadsetPresent;
        /* access modifiers changed from: private */
        public volatile boolean mLastOtgPresent;
        ...
        /* access modifiers changed from: private */
        public volatile boolean mLastUsbPresent;
        private volatile SwitchWifiSar mLastWifiSar;
        /* access modifiers changed from: private */
        public volatile int mLastWifiState = 0;
        ...
        protected class OemReceiver extends BroadcastReceiver {
                        ...
                        if (action.equals("android.hardware.usb.action.USB_STATE")) {
                            ...
                            if (mWifiinfo != null) {
                                ...
                                if (-1 != isWifiConnected) {
                                    boolean unused = ProximitySensorEventListener.this.mIsNormal24 = mWifiinfo.is24GHz();
                                    boolean unused2 = ProximitySensorEventListener.this.mIsNormal5 = mWifiinfo.is5GHz();
                                    if (OemConstant.SWITCH_LOG) {
                                    ...
                                    boolean unused3 = ProximitySensorEventListener.this.mIsNormal24 = false;
                                    boolean unused4 = ProximitySensorEventListener.this.mIsNormal5 = false;
                                }
                            } else {
                                boolean unused5 = ProximitySensorEventListener.this.mIsNormal24 = false;
                                boolean unused6 = ProximitySensorEventListener.this.mIsNormal5 = false;
                                if (OemConstant.SWITCH_LOG) {
                            ...
                            if (isconnected) {
                                if (apBand == 0 || apBand == 1) {
                                    int unused7 = ProximitySensorEventListener.this.mApBand = apBand;
                                } else {
                                    int unused8 = ProximitySensorEventListener.this.mApBand = -1;
                                }
                            }
                            if (OemConstant.SWITCH_LOG) {
                            ...
                            if (wifiSharingState == OemProximitySensorManager.WIFI_SHARING_STATE_ENABLED) {
                                boolean unused9 = ProximitySensorEventListener.this.mIsHotspot24 = true;
                            } else {
                                boolean unused10 = ProximitySensorEventListener.this.mIsHotspot24 = false;
                            }
                            if (OemConstant.SWITCH_LOG) {
                            ...
                            if (networkInfo == null || !networkInfo.isConnected()) {
                                boolean unused11 = ProximitySensorEventListener.this.mIsP2P5 = false;
                                boolean unused12 = ProximitySensorEventListener.this.mP2pStart = false;
                            } else {
                                boolean unused13 = ProximitySensorEventListener.this.mIsP2P5 = true;
                                boolean unused14 = ProximitySensorEventListener.this.mP2pStart = true;
                            }
                            if (OemConstant.SWITCH_LOG) {
            ...
            public void unregister(Context context) {
                ...
                if (!OemConstant.usePSensorForSarDetect(ProximitySensorEventListener.getContext()) && (ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 1) != 0) {
                    int unused = ProximitySensorEventListener.this.mLastAudioDeviceRoute = 0;
                }
                if ((ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 2) != 0) {
                    boolean unused2 = ProximitySensorEventListener.this.mLastUsbPresent = false;
                }
                if ((ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 16) != 0) {
                    boolean unused3 = ProximitySensorEventListener.this.mLastHeadsetPresent = false;
                }
                if ((ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 8) != 0) {
                    boolean unused4 = ProximitySensorEventListener.this.mLastChargerPresent = false;
                }
                if (!((ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 32) == 0 && (ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 64) == 0)) {
                    int unused5 = ProximitySensorEventListener.this.mLastWifiState = 0;
                }
        ...
        protected class OtgListener extends StorageEventListener {
            ...
            public void unregister(Context context) {
                if ((ProximitySensorEventListener.this.mSarConfigParser.getXmlScenariosBit() & 4) != 0) {
                    boolean unused = ProximitySensorEventListener.this.mLastOtgPresent = false;
                    if (OemConstant.SWITCH_LOG) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x002b, code lost:
            ...
            r1 = com.oppo.internal.telephony.rf.OemProximitySensorManager.TAG;
            android.telephony.Rlog.d(r1, "onCallStateChanged:" + r0 + ", processSwitch");
            processSwitch();
            processWifiSwitch();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x0025, code lost:
            r3.mListener.onScreenChange(r4);
            r0 = com.oppo.internal.telephony.rf.OemProximitySensorManager.TAG;
            android.telephony.Rlog.d(r0, "onScreenChanged:" + r4 + ", processSwitch");
            processSwitch();
            processWifiSwitch();
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:105:0x017c, code lost:
            return;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:108:0x0181, code lost:
            r0 = com.oppo.internal.telephony.rf.OemProximitySensorManager.TAG;
            android.telephony.Rlog.d(r0, "processSwitch, onSwitchChange:" + r8.mLastSwitchScene + " /testcard:" + r8.mIsTestCard);
            r8.mListener.onSwitchChange(r8.mLastSwitchScene);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:109:0x01aa, code lost:
            return;
         */
