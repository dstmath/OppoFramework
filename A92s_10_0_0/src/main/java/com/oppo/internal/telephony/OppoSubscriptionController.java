...
public class OppoSubscriptionController implements IOppoSubscriptionController {
    ...
    public int setSubState(int subId, int subStatus) {
        ...
        int result = contentResolver.update(uri, value, "_id=" + Long.toString((long) subId), null);
        logd("setSubState, Status:" + subStatus + ",subId:" + subId + ",result:" + result);
