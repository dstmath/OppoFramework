...
public class OppoNrStateUpdater {
    ...
    public String LOG_TAG = "OppoNrStateUpdater";
    ...
    /* access modifiers changed from: private */
    public boolean mIsSupportOptimizedNr = SystemProperties.getBoolean("persist.vendor.radio.support_optimized_nr", false);
    private boolean mModemResetSmoothEnabled = true;
    private int mModemResetSmoothTime = OppoServiceStateTracker.DELAYTIME_10S;
    /* access modifiers changed from: private */
    public int mNetworkMode = 33;
    ...
    public void updateNrConfig() {
        ...
        logd("updateNrConfig mIsSupportOptimizedNr: " + this.mIsSupportOptimizedNr + ", mCellIdCacheTimer: " + this.mCellIdCacheTimer + ", mCellIdListSize: " + this.mCellIdListSize + ", mNrStateSmoothDelay: " + this.mNrStateSmoothDelay + ", mModemResetSmoothEnabled: " + this.mModemResetSmoothEnabled + ", mModemResetSmoothTime: " + this.mModemResetSmoothTime);
    }
        ...
        SubscriptionManager.from(this.mPhone.getContext()).addOnSubscriptionsChangedListener(new SubscriptionManager.OnSubscriptionsChangedListener(this.mEventHandler.getLooper()) {
            ...
            public void onSubscriptionsChanged() {
                ...
                if (OppoNrStateUpdater.this.mPreviousSubId != subId) {
                    int unused = OppoNrStateUpdater.this.mPreviousSubId = subId;
                    String access$400 = OppoNrStateUpdater.this.LOG_TAG;
                    Rlog.d(access$400, "onSubscriptionsChanged subId:" + OppoNrStateUpdater.this.mPreviousSubId);
                    OppoNrStateUpdater oppoNrStateUpdater = OppoNrStateUpdater.this;
                    int unused2 = oppoNrStateUpdater.mNetworkMode = PhoneFactory.calculatePreferredNetworkType(oppoNrStateUpdater.mContext, subId);
    ...
    public class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoNrStateUpdater.EVENT_NR_STATE_CHANGED /*{ENCODED_INT: 201}*/:
                default:
                    return;
                case OppoNrStateUpdater.EVENT_NRSTATE_SMOOTH /*{ENCODED_INT: 202}*/:
                    if (!OppoNrStateUpdater.this.isOtherPhoneIncall()) {
                        int unused = OppoNrStateUpdater.this.mNrState = msg.arg1;
                    }
                    ...
                    return;
                case OppoNrStateUpdater.EVENT_ICC_CHANGED /*{ENCODED_INT: 203}*/:
                    ...
                    if (ar.result != null) {
                        ...
                        if (cardIndex.intValue() == OppoNrStateUpdater.this.mPhoneId && SubscriptionController.getInstance().getSimStateForSlotIndex(cardIndex.intValue()) == 1) {
                            ...
                            int unused2 = OppoNrStateUpdater.this.mNrState = -1;
                            return;
                        }
                        return;
                    }
                    ...
                    return;
                case OppoNrStateUpdater.EVENT_NETWORK_TYPE_CHANGED /*{ENCODED_INT: 204}*/:
                    AsyncResult ar2 = (AsyncResult) msg.obj;
                    if (ar2.result != null) {
                        int unused3 = OppoNrStateUpdater.this.mNetworkMode = ((Integer) ar2.result).intValue();
                        ...
                        if (OppoNrStateUpdater.this.mNetworkMode < 23 && OppoNrStateUpdater.this.mIsSupportOptimizedNr) {
                            int unused4 = OppoNrStateUpdater.this.mNrState = -1;
    ...
    private int getNrStateFromServiceState(ServiceState ss) {
        ...
        if (nri == null || (dsri = nri.getDataSpecificInfo()) == null || !dsri.isEnDcAvailable) {
            return -1;
        }
        if (dsri.isDcNrRestricted || !dsri.isNrAvailable) {
            return 1;
        }
        return 2;
    }
