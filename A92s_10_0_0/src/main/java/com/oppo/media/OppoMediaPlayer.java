...
public class OppoMediaPlayer {
    ...
    public boolean handleMediaPlayerError() {
        ...
        if (mChangeState >= 2) {
            try {
                ...
                closeFd();
                try {
                    if (this.mPlayer.getSurfaceHolder() != null) {
                        this.mPlayer.setDisplay(this.mPlayer.getSurfaceHolder());
                    }
    ...
    private void createOppoMediaPlayer() {
        if (!this.mNotUsingOppoMedia) {
            ...
            if (this.mPlayer.mOppoMediaPlayer == null || !this.isOppoCreate) {
                if (this.mPlayer.mOppoMediaPlayer == null) {
                    this.mPlayer.mOppoMediaPlayer = new OppoMediaPlayer();
                    this.mPlayer.mOppoMediaPlayer.setOuterPlayer(this.mPlayer);
                }
                this.isOppoCreate = true;
                if (this.mAudioSessionId >= 0) {
                    this.mPlayer.mOppoMediaPlayer.setAudioSessionId(this.mAudioSessionId);
                }
                if (this.mAudioStreamType >= 0) {
                    this.mPlayer.mOppoMediaPlayer.setAudioStreamType(this.mAudioStreamType);
                }
                if (this.mScreenOn) {
                    this.mPlayer.mOppoMediaPlayer.setScreenOnWhilePlaying(true);
                }
                this.mPlayer.mOppoMediaPlayer.setOnPreparedListener(new OnPreparedListener() {
                    ...
                    public void onPrepared(OppoMediaPlayer mp) {
                        if (OppoMediaPlayer.this.mPlayer.getOnPreparedListener() != null) {
                            OppoMediaPlayer oppoMediaPlayer = OppoMediaPlayer.this;
                            oppoMediaPlayer.mCurrentState = 8;
                            oppoMediaPlayer.mPlayer.getOnPreparedListener().onPrepared(OppoMediaPlayer.this.mPlayer);
                            if (OppoMediaPlayer.this.mDefaultPlayerStarted) {
                                Log.d(OppoMediaPlayer.TAG, "mDefaultPlayerStarted is true ,start !");
                                OppoMediaPlayer.this.mPlayer.start();
                                OppoMediaPlayer.this.mDefaultPlayerStarted = false;
                            }
                        }
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnBufferingUpdateListener(new OnBufferingUpdateListener() {
                    ...
                    public void onBufferingUpdate(OppoMediaPlayer mp, int percent) {
                        if (OppoMediaPlayer.this.mPlayer.getOnBufferingUpdateListener() != null) {
                            OppoMediaPlayer.this.mPlayer.getOnBufferingUpdateListener().onBufferingUpdate(OppoMediaPlayer.this.mPlayer, percent);
                        }
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
                    ...
                    public void onCompletion(OppoMediaPlayer mp) {
                        if (OppoMediaPlayer.this.mPlayer.getOnCompletionListener() != null) {
                            OppoMediaPlayer.this.mPlayer.getOnCompletionListener().onCompletion(OppoMediaPlayer.this.mPlayer);
                        }
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnErrorListener(new OnErrorListener() {
                    ...
                    public boolean onError(OppoMediaPlayer mp, int what, int extra) {
                        ...
                        if (OppoMediaPlayer.this.mPlayer.getOnErrorListener() == null) {
                            return true;
                        }
                        OppoMediaPlayer.this.mPlayer.getOnErrorListener().onError(OppoMediaPlayer.this.mPlayer, what, extra);
                        return true;
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnSeekCompleteListener(new OnSeekCompleteListener() {
                    ...
                    public void onSeekComplete(OppoMediaPlayer mp) {
                        if (OppoMediaPlayer.this.mPlayer.getOnSeekCompleteListener() != null) {
                            OppoMediaPlayer.this.mPlayer.getOnSeekCompleteListener().onSeekComplete(OppoMediaPlayer.this.mPlayer);
                        }
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnVideoSizeChangedListener(new OnVideoSizeChangedListener() {
                    ...
                    public void onVideoSizeChanged(OppoMediaPlayer mp, int width, int height) {
                        if (OppoMediaPlayer.this.mPlayer.getOnVideoSizeChangedListener() != null) {
                            OppoMediaPlayer.this.mPlayer.getOnVideoSizeChangedListener().onVideoSizeChanged(OppoMediaPlayer.this.mPlayer, width, height);
                        }
                    }
                });
                this.mPlayer.mOppoMediaPlayer.setOnInfoListener(new OnInfoListener() {
                    ...
                    public boolean onInfo(OppoMediaPlayer mp, int what, int extra) {
                        if (OppoMediaPlayer.this.mPlayer.getOnInfoListener() == null) {
                            return true;
                        }
                        OppoMediaPlayer.this.mPlayer.getOnInfoListener().onInfo(OppoMediaPlayer.this.mPlayer, what, extra);
                        return true;
                    }
                });
                return;
            }
            this.mPlayer.mOppoMediaPlayer.reset();
            this.mPlayer.mOppoMediaPlayer.isOppoCreate = true;
            Log.i(TAG, "mOppoMediaPlayer has exist, return.");
        }
    }

    public boolean handleError(Message msg, MediaPlayer mediaPlayer) {
        int i;
        ...
        if (this.isOppoCreate || handleMediaPlayerError()) {
            return true;
        }
        boolean was_handled = false;
        MediaPlayer.OnErrorListener onErrorListener = this.mPlayer.getOnErrorListener();
        if (onErrorListener != null) {
            was_handled = onErrorListener.onError(this.mPlayer, msg.arg1, msg.arg2);
        }
        MediaPlayer.OnCompletionListener onCompletionListener = this.mPlayer.getOnCompletionListener();
    ...
    public void setOuterPlayer(MediaPlayer player) {
        this.mPlayer = player;
    }
    ...
    public Parcel checkZenMode() {
        ...
        if (colorNotificationManager != null) {
            try {
                this.mInterceptFlag = colorNotificationManager.shouldInterceptSound(packageName, uid);
    ...
    public boolean startImplWithOppoIfNeeded() {
        if (this.mDebugLog) {
        ...
        if (!this.isOppoCreate) {
            ...
            if (this.mNeedSeeking) {
                ...
                this.mPlayer.seekTo(this.mSeekMs);
    ...
    public void releaseWithOppo() {
        ...
        closeFd();
        if (this.mPlayer.mOppoMediaPlayer != null) {
            this.mPlayer.mOppoMediaPlayer.release();
        }
    ...
    public MediaPlayer.TrackInfo[] getTrackInfoWithOppo() throws IllegalStateException {
        if (this.mDebugLog) {
        ...
        for (int i = 0; i < mtrackInfo.length; i++) {
            ...
            mParcel.setDataPosition(0);
            trackInfo1[i] = this.mPlayer.getTrackInfo(mParcel);
        }
        return trackInfo1;
    }
                ...
                if (i == 2) {
                    ...
                    if (i == 4) {
                        if (OppoMediaPlayer.this.mSeekPosition != OppoMediaPlayer.this.mCurrentPosition) {
                            ...
                            int unused = OppoMediaPlayer.this.mSeekPosition = -1;
                            OppoMediaPlayer oppoMediaPlayer = OppoMediaPlayer.this;
                            ...
                            int unused2 = oppoMediaPlayer2.mCurrentPosition = oppoMediaPlayer2.mSeekPosition = -1;
                        }
