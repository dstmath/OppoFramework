...
public interface INfcWalletAdapter extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INfcWalletAdapter {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        ...
                        boolean observerMode = setObserverMode(_arg03);
                        reply.writeNoException();
                        reply.writeInt(observerMode ? 1 : 0);
                        return true;
                    case TRANSACTION_setMuteTech /*{ENCODED_INT: 5}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean muteTech = setMuteTech(_arg04, _arg1, _arg2);
                        reply.writeNoException();
                        reply.writeInt(muteTech ? 1 : 0);
                        return true;
                    case TRANSACTION_rotateRfParameters /*{ENCODED_INT: 6}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg02 = true;
                        }
                        boolean rotateRfParameters = rotateRfParameters(_arg02);
                        reply.writeNoException();
        ...
        private static class Proxy implements INfcWalletAdapter {
