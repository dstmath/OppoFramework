...
public interface INfcSettingsCallback extends IInterface {
    void onRouteChanged() throws RemoteException;
    ...
    public static class Default implements INfcSettingsCallback {
        ...
        @Override // com.st.android.nfc_extensions.INfcSettingsCallback
        public void onRouteChanged() throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INfcSettingsCallback {
        ...
        static final int TRANSACTION_onRouteChanged = 2;
        ...
        private static class Proxy implements INfcSettingsCallback {
            ...
            public void onRouteChanged() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onRouteChanged();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
