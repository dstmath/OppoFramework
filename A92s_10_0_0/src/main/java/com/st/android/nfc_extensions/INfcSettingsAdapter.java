...
public interface INfcSettingsAdapter extends IInterface {
    ...
    int getAvailableSpaceForAid() throws RemoteException;

    List<DefaultRouteEntry> getDefaultUserRoutes() throws RemoteException;

    List<DefaultRouteEntry> getEffectiveRoutes() throws RemoteException;
    ...
    void setDefaultUserRoutes(List<DefaultRouteEntry> list) throws RemoteException;
    ...
    public static class Default implements INfcSettingsAdapter {
        ...
        @Override // com.st.android.nfc_extensions.INfcSettingsAdapter
        public void setDefaultUserRoutes(List<DefaultRouteEntry> list) throws RemoteException {
        }

        @Override // com.st.android.nfc_extensions.INfcSettingsAdapter
        public List<DefaultRouteEntry> getDefaultUserRoutes() throws RemoteException {
            return null;
        }

        @Override // com.st.android.nfc_extensions.INfcSettingsAdapter
        public List<DefaultRouteEntry> getEffectiveRoutes() throws RemoteException {
            return null;
        }

        @Override // com.st.android.nfc_extensions.INfcSettingsAdapter
        public int getAvailableSpaceForAid() throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements INfcSettingsAdapter {
        ...
        static final int TRANSACTION_getAvailableSpaceForAid = 20;
        static final int TRANSACTION_getDefaultUserRoutes = 18;
        static final int TRANSACTION_getEffectiveRoutes = 19;
        ...
        static final int TRANSACTION_setDefaultUserRoutes = 17;
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case TRANSACTION_testServiceEntryList /*{ENCODED_INT: 13}*/:
                        ...
                        return true;
                    case TRANSACTION_commitServiceEntryList /*{ENCODED_INT: 14}*/:
                        data.enforceInterface(DESCRIPTOR);
                        commitServiceEntryList(data.createTypedArrayList(ServiceEntry.CREATOR));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getNonAidBasedServiceEntryList /*{ENCODED_INT: 15}*/:
                        data.enforceInterface(DESCRIPTOR);
                        List<ServiceEntry> _result4 = getNonAidBasedServiceEntryList(data.readInt());
                        reply.writeNoException();
                        reply.writeTypedList(_result4);
                        return true;
                    case TRANSACTION_commitNonAidBasedServiceEntryList /*{ENCODED_INT: 16}*/:
                        data.enforceInterface(DESCRIPTOR);
                        commitNonAidBasedServiceEntryList(data.createTypedArrayList(ServiceEntry.CREATOR));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setDefaultUserRoutes /*{ENCODED_INT: 17}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setDefaultUserRoutes(data.createTypedArrayList(DefaultRouteEntry.CREATOR));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getDefaultUserRoutes /*{ENCODED_INT: 18}*/:
                        data.enforceInterface(DESCRIPTOR);
                        List<DefaultRouteEntry> _result5 = getDefaultUserRoutes();
                        reply.writeNoException();
                        reply.writeTypedList(_result5);
                        return true;
                    case TRANSACTION_getEffectiveRoutes /*{ENCODED_INT: 19}*/:
                        data.enforceInterface(DESCRIPTOR);
                        List<DefaultRouteEntry> _result6 = getEffectiveRoutes();
                        reply.writeNoException();
                        reply.writeTypedList(_result6);
                        return true;
                    case TRANSACTION_getAvailableSpaceForAid /*{ENCODED_INT: 20}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result7 = getAvailableSpaceForAid();
                        reply.writeNoException();
        ...
        private static class Proxy implements INfcSettingsAdapter {
            ...
            public boolean isSEConnected(int HostID) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isSEConnected, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void commitNonAidBasedServiceEntryList(List<ServiceEntry> proposal) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeTypedList(proposal);
                    if (this.mRemote.transact(Stub.TRANSACTION_commitNonAidBasedServiceEntryList, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            @Override // com.st.android.nfc_extensions.INfcSettingsAdapter
            public void setDefaultUserRoutes(List<DefaultRouteEntry> userRoutes) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeTypedList(userRoutes);
                    if (this.mRemote.transact(Stub.TRANSACTION_setDefaultUserRoutes, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().setDefaultUserRoutes(userRoutes);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public List<DefaultRouteEntry> getDefaultUserRoutes() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getDefaultUserRoutes, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getDefaultUserRoutes();
                    }
                    _reply.readException();
                    List<DefaultRouteEntry> _result = _reply.createTypedArrayList(DefaultRouteEntry.CREATOR);
                    _reply.recycle();
                    _data.recycle();
                    return _result;
                } finally {
            ...
            public List<DefaultRouteEntry> getEffectiveRoutes() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getEffectiveRoutes, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getEffectiveRoutes();
                    }
                    _reply.readException();
                    List<DefaultRouteEntry> _result = _reply.createTypedArrayList(DefaultRouteEntry.CREATOR);
                    _reply.recycle();
            ...
            public int getAvailableSpaceForAid() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getAvailableSpaceForAid, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getAvailableSpaceForAid();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
