...
public class MmTelFeatureConnection {
    ...
    private final IImsServiceFeatureCallback mListenerBinder = new IImsServiceFeatureCallback.Stub() {
        ...
        public void imsFeatureCreated(int slotId, int feature) {
            MmTelFeatureConnection.this.mExecutor.execute(new Runnable(slotId, feature) {
                /* class com.android.ims.$$Lambda$MmTelFeatureConnection$1$2oMo1vy7PK7RvBpj3WhQvVVnmLE */
                ...
                public final void run() {
                    MmTelFeatureConnection.AnonymousClass1.this.lambda$imsFeatureCreated$0$MmTelFeatureConnection$1(this.f$1, this.f$2);
                }
            });
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
            return;
         */
        public /* synthetic */ void lambda$imsFeatureCreated$0$MmTelFeatureConnection$1(int slotId, int feature) {
        ...
        public void imsFeatureRemoved(int slotId, int feature) {
            MmTelFeatureConnection.this.mExecutor.execute(new Runnable(slotId, feature) {
                /* class com.android.ims.$$Lambda$MmTelFeatureConnection$1$8CiyUe8f9BLYfCdaDu6JpOa_8 */
                private final /* synthetic */ int f$1;
                private final /* synthetic */ int f$2;
                ...
                public final void run() {
                    MmTelFeatureConnection.AnonymousClass1.this.lambda$imsFeatureRemoved$1$MmTelFeatureConnection$1(this.f$1, this.f$2);
                }
            });
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x004e, code lost:
            return;
         */
        public /* synthetic */ void lambda$imsFeatureRemoved$1$MmTelFeatureConnection$1(int slotId, int feature) {
            synchronized (MmTelFeatureConnection.this.mLock) {
                if (MmTelFeatureConnection.this.mSlotId == slotId) {
                    if (feature == 0) {
        ...
        public void imsStatusChanged(int slotId, int feature, int status) {
            MmTelFeatureConnection.this.mExecutor.execute(new Runnable(slotId, feature, status) {
                /* class com.android.ims.$$Lambda$MmTelFeatureConnection$1$0SEXZe5KpKdo80CWXCfIl6qWHdQ */
                private final /* synthetic */ int f$1;
                private final /* synthetic */ int f$2;
                ...
                public final void run() {
                    MmTelFeatureConnection.AnonymousClass1.this.lambda$imsStatusChanged$2$MmTelFeatureConnection$1(this.f$1, this.f$2, this.f$3);
                }
            });
        }

        public /* synthetic */ void lambda$imsStatusChanged$2$MmTelFeatureConnection$1(int slotId, int feature, int status) {
            synchronized (MmTelFeatureConnection.this.mLock) {
    ...
    public static abstract class CallbackAdapterManager<T extends IInterface> {
        ...
        /* access modifiers changed from: private */
        public final SparseArray<Set<T>> mCallbackSubscriptionMap = new SparseArray<>();
        /* access modifiers changed from: private */
        ...
        public CallbackAdapterManager(Context context, Object lock) {
            ...
            this.mSubChangedListener = new SubscriptionManager.OnSubscriptionsChangedListener() {
                ...
                public void onSubscriptionsChanged() {
                    SubscriptionManager manager = CallbackAdapterManager.this.mContext.getSystemService(SubscriptionManager.class);
                    if (manager == null) {
        ...
        public final void addCallback(T localCallback) {
            synchronized (this.mLock) {
                ...
                Log.i(TAG, "Local callback added: " + ((Object) localCallback));
        ...
        public final void removeCallback(T localCallback) {
            Log.i(TAG, "Local callback removed: " + ((Object) localCallback));
            synchronized (this.mLock) {
    ...
    private class ImsRegistrationCallbackAdapter extends CallbackAdapterManager<IImsRegistrationCallback> {
