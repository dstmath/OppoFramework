...
public class ImsManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.ims.ImsManager.setWfcMode(int, boolean):void
     arg types: [int, int]
     candidates:
      com.android.ims.ImsManager.setWfcMode(android.content.Context, int):void
      com.android.ims.ImsManager.setWfcMode(int, boolean):void */
    ...
    public int getWfcMode(boolean roaming) {
        ...
        if (!roaming) {
            ...
            if (getBooleanCarrierConfig("use_wfc_home_network_mode_in_roaming_network_bool")) {
                setting2 = getWfcMode(false);
            } else if (!getBooleanCarrierConfig("editable_wfc_roaming_mode_bool")) {
                setting2 = getIntCarrierConfig("carrier_default_wfc_ims_roaming_mode_int");
            } else {
                setting2 = getSettingFromSubscriptionManager("wfc_ims_roaming_mode", "carrier_default_wfc_ims_roaming_mode_int");
            }
