...
public class ImsVideoCallProviderWrapper extends Connection.VideoProvider {
    ...
    public ImsVideoCallProviderWrapper(IImsVideoCallProvider videoProvider) throws RemoteException {
        ...
        this.mDeathRecipient = new IBinder.DeathRecipient() {
            /* class com.android.ims.internal.ImsVideoCallProviderWrapper.AnonymousClass1 */
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) {
            /* class com.android.ims.internal.ImsVideoCallProviderWrapper.AnonymousClass2 */
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case ImsVideoCallProviderWrapper.MSG_HANDLE_CALL_SESSION_EVENT /*{ENCODED_INT: 3}*/:
                        ImsVideoCallProviderWrapper.this.handleCallSessionEvent(((Integer) msg.obj).intValue());
                        return;
                    case ImsVideoCallProviderWrapper.MSG_CHANGE_PEER_DIMENSIONS /*{ENCODED_INT: 4}*/:
                    ...
                    case ImsVideoCallProviderWrapper.MSG_CHANGE_CALL_DATA_USAGE /*{ENCODED_INT: 5}*/:
                        ...
                        return;
                    case ImsVideoCallProviderWrapper.MSG_CHANGE_CAMERA_CAPABILITIES /*{ENCODED_INT: 6}*/:
                        ImsVideoCallProviderWrapper.this.changeCameraCapabilities((VideoProfile.CameraCapabilities) msg.obj);
                        return;
                    case ImsVideoCallProviderWrapper.MSG_CHANGE_VIDEO_QUALITY /*{ENCODED_INT: 7}*/:
        ...
        if (isPauseRequest) {
            ...
            if (!this.mUseVideoPauseWorkaround || (!isTurnOffCameraRequest && !isTurnOnCameraRequest)) {
                ...
                if (!this.mVideoPauseTracker.shouldResumeVideoFor(source)) {
                    return new VideoProfile(toVideoState | MSG_CHANGE_PEER_DIMENSIONS, toProfile.getQuality());
                }
                return toProfile;
            }
