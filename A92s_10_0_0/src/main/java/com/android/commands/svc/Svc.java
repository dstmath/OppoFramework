...
public class Svc {
    public static final Command[] COMMANDS = {COMMAND_HELP, new PowerCommand(), new DataCommand(), new WifiCommand(), new UsbCommand(), new NfcCommand(), new BluetoothCommand(), new SystemServerCommand(), new OppoNfcCommand()};
