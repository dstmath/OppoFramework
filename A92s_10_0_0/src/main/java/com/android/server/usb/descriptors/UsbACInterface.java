...
public abstract class UsbACInterface extends UsbDescriptor {
    ...
    public void report(ReportCanvas canvas) {
        ...
        canvas.openList();
        canvas.writeListItem("Subclass: " + ReportCanvas.getHexString(subClass) + StringUtils.SPACE + subClassName);
        canvas.writeListItem("Subtype: " + ReportCanvas.getHexString(subtype) + StringUtils.SPACE + subTypeName);
        canvas.closeList();
    }
}
