    ...
    public void dump(DualDumpOutputStream dump, String idName, long id) {
        ...
        synchronized (this.mLock) {
            ...
            for (int activityNum = 0; activityNum < numDeviceAttachedActivities2; activityNum++) {
                ...
                DumpUtils.writeComponentName(dump, IColorAppStartupManager.TYPE_ACTIVITY, 1146756268033L, new ComponentName(deviceAttachedActivity.activityInfo.packageName, deviceAttachedActivity.activityInfo.name));
            ...
            while (activityNum2 < numAccessoryAttachedActivities) {
                ...
                DumpUtils.writeComponentName(dump, IColorAppStartupManager.TYPE_ACTIVITY, 1146756268033L, new ComponentName(accessoryAttachedActivity.activityInfo.packageName, accessoryAttachedActivity.activityInfo.name));
