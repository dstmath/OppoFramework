...
public class UsbPortManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.lang.String, android.hardware.usb.ParcelableUsbPort]
     candidates:
    ...
    private void updateContaminantNotification() {
        ...
        if (contaminantStatus == 3 && (i2 = this.mIsPortContaminatedNotificationId) != 52) {
            ...
            CharSequence title = r.getText(17041163);
            String channel = SystemNotificationChannels.ALERTS;
            CharSequence message = r.getText(17041162);
            ...
            if (contaminantStatus == 2) {
                ...
                CharSequence title2 = r.getText(17041165);
                String channel2 = SystemNotificationChannels.ALERTS;
                CharSequence message2 = r.getText(17041164);
                this.mNotificationManager.notifyAsUser(null, this.mIsPortContaminatedNotificationId, new Notification.Builder(this.mContext, channel2).setSmallIcon(17302831).setTicker(title2).setColor(this.mContext.getColor(17170460)).setContentTitle(title2).setContentText(message2).setVisibility(1).setStyle(new Notification.BigTextStyle().bigText(message2)).build(), UserHandle.ALL);
            }
        }
    }
    ...
    final class ServiceNotification extends IServiceNotification.Stub {
        ...
        public void onRegistration(String fqName, String name, boolean preexisting) {
            UsbPortManager.logAndPrint(4, null, "Usb hal service started " + fqName + StringUtils.SPACE + name);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{android.content.Intent.putExtra(java.lang.String, android.os.Parcelable):android.content.Intent}
     arg types: [java.lang.String, android.hardware.usb.UsbPortStatus]
     candidates:
      ClspMth{android.content.Intent.putExtra(java.lang.String, int):android.content.Intent}
      ClspMth{android.content.Intent.putExtra(java.lang.String, java.lang.String[]):android.content.Intent}
      ClspMth{android.content.Intent.putExtra(java.lang.String, int[]):android.content.Intent}
