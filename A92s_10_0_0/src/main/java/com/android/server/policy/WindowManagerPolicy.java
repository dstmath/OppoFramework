...
public interface WindowManagerPolicy extends WindowManagerPolicyConstants {
    ...
    default int getSubWindowLayerFromTypeLw(int type) {
        switch (type) {
            ...
            case 1002:
                return 2;
            case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_SYSTEM:
                return -1;
            case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_LOST_FOUND:
                return 3;
            default:
