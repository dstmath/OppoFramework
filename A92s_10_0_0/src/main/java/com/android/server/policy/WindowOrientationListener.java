...
public abstract class WindowOrientationListener {
    ...
    public static final boolean LOG = SystemProperties.getBoolean("debug.orientation.log", true);
    private static final String TAG = "WindowOrientationListener";
    private static final boolean USE_GRAVITY_SENSOR = false;
    final int MSG_DISABLE;
    ...
    private WindowOrientationListener(Context context, Handler handler, int rate) {
        ...
        this.MSG_ENABLE = 1001;
        this.MSG_DISABLE = 1002;
        this.switchHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                int i = msg.what;
                if (i != 1001 && i == 1002) {
                    WindowOrientationListener.this.doDisable();
                }
            }
        };
    ...
    public void sendDisable() {
        this.switchHandler.sendEmptyMessageDelayed(1002, 1000);
    }

    /* access modifiers changed from: package-private */
    public void sendEnable() {
        this.switchHandler.removeMessages(1002);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0021, code lost:
        if (com.mediatek.server.wm.WindowManagerDebugger.WMS_DEBUG_USER != false) goto L_0x0023;
     */
    ...
    final class AccelSensorJudge extends OrientationJudge {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:99:0x0385, code lost:
            if (com.mediatek.server.wm.WindowManagerDebugger.WMS_DEBUG_USER != false) goto L_0x0387;
         */
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            synchronized (WindowOrientationListener.this.mLock) {
                ...
                if (now >= then && now <= 1000000000 + then) {
                    if (x != OppoBrightUtils.MIN_LUX_LIMITI || y != OppoBrightUtils.MIN_LUX_LIMITI || z2 != OppoBrightUtils.MIN_LUX_LIMITI) {
        ...
        private boolean isSwingingLocked(long now, float tilt) {
            ...
            } while (this.mTiltHistory[i] + 20.0f > tilt);
            return true;
        }
        ...
        private float remainingMS(long now, long until) {
            return now >= until ? OppoBrightUtils.MIN_LUX_LIMITI : ((float) (until - now)) * 1.0E-6f;
        }
    }
    ...
    final class OrientationSensorJudge extends OrientationJudge {
        ...
        private Runnable mRotationEvaluator = new Runnable() {
            ...
            public void run() {
                ...
                if (WindowOrientationListener.LOG) {
                    Slog.v(WindowOrientationListener.TAG, "Runnable mRotationEvaluator newRotation : " + newRotation);
                }
                if (newRotation >= 0) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0023, code lost:
            if (com.android.server.policy.WindowOrientationListener.access$100() == false) goto L_0x0046;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0025, code lost:
            android.util.Slog.v(com.android.server.policy.WindowOrientationListener.TAG, "onSensorChanged mDesiredRotation = " + r4.mDesiredRotation + " newRotation = " + r1);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0046, code lost:
            if (r1 < 0) goto L_?;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0048, code lost:
            r4.this$0.onProposedRotationChanged(r1);
         */
        ...
        public void onSensorChanged(SensorEvent event) {
            synchronized (WindowOrientationListener.this.mLock) {
                ...
                if (this.mDesiredRotation != 4) {
                    if (this.mDesiredRotation != 5) {
                        int newRotation = evaluateRotationChangeLocked();
                    }
                }
                Slog.v(WindowOrientationListener.TAG, "onSensorChanged mDesiredRotation = " + this.mDesiredRotation);
                resetLocked(true);
            }
        }
