...
class OppoAppFrozen {
    ...
    public static final List<String> FILTER_LIST = Arrays.asList("com.oppo.launcher");
    private static final String ID_APP_FROZEN = "app_frozen_detect";
    private static final String TAG = "OppoAppFrozen";
    /* access modifiers changed from: private */
    public static boolean mHomeMsgSent = false;
    ...
    /* access modifiers changed from: private */
    public PhoneWindowManager mPwm;
    ...
    /* access modifiers changed from: private */
    public void uploadDcsKvEvent(String id, String act) {
