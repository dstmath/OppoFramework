...
public class OppoScreenOffGestureManager {
    ...
    PhoneStateListener listener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (state == 0) {
                boolean unused = OppoScreenOffGestureManager.this.mIsInOffHook = false;
            } else if (state == 1) {
                boolean unused2 = OppoScreenOffGestureManager.this.mIsInOffHook = true;
            } else if (state == 2) {
                boolean unused3 = OppoScreenOffGestureManager.this.mIsInOffHook = true;
            }
        }
    };
    ...
    public boolean mIsInOffHook = false;
