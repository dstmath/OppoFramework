...
public class OppoPhoneWindowManager extends PhoneWindowManager {
    ...
    public static final Uri KEY_OPEN_WALLET_CP_URI = Uri.parse("content://finshell.wallet.quickstart.flag.provider.open/CARD_BAG_FLAG");
    ...
    private static final String PHONE_DEVICE_NAME = "gpio-keys";
    ...
    /* access modifiers changed from: private */
    public volatile boolean mClearPowerKeyDownRecord = false;
    /* access modifiers changed from: private */
    public int mCntPhoneStateReg;
    /* access modifiers changed from: private */
    public ColorPowerKeyHandler mColorPowerKeyHandler = null;
    ...
    private final Runnable mHomeKeyLongPress = new Runnable() {
        ...
        public void run() {
            boolean unused = OppoPhoneWindowManager.this.mHomeConsumed = true;
    ...
    /* access modifiers changed from: private */
    public boolean mIsUpGestureMode = false;
    private ContentObserver mIsUpGestureModeSettingObserver = new ContentObserver(this.mHandler) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            boolean unused = oppoPhoneWindowManager.mIsUpGestureMode = z;
        }
    };
    private boolean mIsVolumeUpKeyUp = false;
    /* access modifiers changed from: private */
    public boolean mIsVolumeUpLongPressed = false;
    /* access modifiers changed from: private */
    public final ArrayList<String> mKeyLockIntentProcess = new ArrayList<>();
    ...
    /* access modifiers changed from: private */
    public final Map<Integer, Integer> mLaunchCameraSettingMap = new ArrayMap();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 16:
                    ...
                    return;
                case OppoPhoneWindowManager.MSG_ISCAMERAMODE /*{ENCODED_INT: 17}*/:
                    if (msg.arg1 == 1) {
                        isInGestureGuide = true;
                    }
                    OppoPhoneWindowManager.this.sendIsCameraModeIntent(isInGestureGuide);
                    return;
                case OppoPhoneWindowManager.MSG_SET_WALLPAPER_LAYER /*{ENCODED_INT: 18}*/:
                default:
                    return;
                case OppoPhoneWindowManager.MSG_ISINGESTUREGUIDE /*{ENCODED_INT: 19}*/:
                    if (msg.arg1 == 1) {
                        isInGestureGuide = true;
                    }
    ...
    BroadcastReceiver mOppoBaseReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (OppoPhoneWindowManager.ACTION_END_CALL.equals(action)) {
                ...
                boolean unused = OppoPhoneWindowManager.this.mStartSpeechEnabled = true;
                ...
                boolean unused2 = OppoPhoneWindowManager.this.mStartSpeechEnabled = false;
    ...
    /* access modifiers changed from: private */
    public OppoSafeDbReader mOppoSafeDbReader;
    /* access modifiers changed from: private */
    public boolean mPauseForChangingTheme = false;
    /* access modifiers changed from: private */
    public boolean mPhoneStateRegSucess = false;
    PhoneStateListener mPhoneStatelistener = new PhoneStateListener() {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (!OppoPhoneWindowManager.this.mPhoneStateRegSucess) {
                boolean unused = OppoPhoneWindowManager.this.mPhoneStateRegSucess = true;
    ...
    SensorEventListener mProximityListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            synchronized (OppoPhoneWindowManager.this.mObject) {
                ...
                boolean unused = oppoPhoneWindowManager.mProximitySensorActive = z;
                if (OppoPhoneWindowManager.this.mOppoDebug) {
    ...
    /* access modifiers changed from: private */
    public boolean mProximitySensorActive = true;
        ...
        public void onReceive(Context context, Intent intent) {
            if (BrightnessConstants.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
                ...
                if ("file".equals(SystemProperties.get("ro.crypto.type"))) {
                    OppoPhoneWindowManager oppoPhoneWindowManager = OppoPhoneWindowManager.this;
                    OppoSafeDbReader unused = oppoPhoneWindowManager.mOppoSafeDbReader = OppoSafeDbReader.getInstance(oppoPhoneWindowManager.mContext);
    ...
    /* access modifiers changed from: private */
    public AtomicBoolean mRecentsLongPressDetected = new AtomicBoolean(false);
    ...
    Runnable mResumeForChangingTheme = new Runnable() {
        ...
        public void run() {
            if (OppoPhoneWindowManager.this.mPauseForChangingTheme) {
                ...
                boolean unused = OppoPhoneWindowManager.this.mPauseForChangingTheme = false;
            }
    ...
    /* access modifiers changed from: private */
    public final Runnable mRunPhoneStateRegister = new Runnable() {
    ...
    /* access modifiers changed from: private */
    public boolean mStartSpeechEnabled = false;
    ...
    Runnable mUserUnlockRunnable = new Runnable() {
        ...
        public void run() {
            ...
            OppoPhoneWindowManager oppoPhoneWindowManager = OppoPhoneWindowManager.this;
            boolean unused = oppoPhoneWindowManager.mWalletPowerKeyEnabled = oppoPhoneWindowManager.checkSupportFlag(oppoPhoneWindowManager.mContext);
    ...
    private final Runnable mVolumeUpLongPress = new Runnable() {
        ...
        public void run() {
            ...
            boolean unused = OppoPhoneWindowManager.this.mIsVolumeUpLongPressed = true;
        }
    };
    private PowerManager.WakeLock mWakeLockVolumeUpLongPress;
    /* access modifiers changed from: private */
    public volatile boolean mWalletPowerKeyEnabled = false;
    ...
    public void init(Context context, IWindowManager windowManager, WindowManagerPolicy.WindowManagerFuncs windowManagerFuncs) {
        ...
        this.mIsBusinessCustom = this.mContext.getPackageManager().hasSystemFeature("oppo.business.custom");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x019c, code lost:
        if (com.android.server.policy.OppoPhoneWindowManager.PHONE_DEVICE_NAME.equals(r17.getDevice().getName()) == false) goto L_0x0200;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:110:0x019e, code lost:
        if (r0 != 1) goto L_0x0200;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:112:0x01a2, code lost:
        if (r16.mSuperPowerSaveMode == false) goto L_0x01a6;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:128:0x01e3, code lost:
        if ((r11 - r16.mLastVolumeUpTime) > 500) goto L_0x01fd;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:132:0x01f3, code lost:
        if (r5.isEmpty() == false) goto L_0x01f8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:135:0x01fd, code lost:
        r16.mLastVolumeUpTime = r11;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:136:0x0200, code lost:
        r4 = r0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:137:0x0202, code lost:
        r4 = r0;
     */
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        boolean interactive3 = (536870912 & policyFlags) != 0;
                ...
                synchronized (this.mLaunchCameraSettingMap) {
                    try {
                        if (this.mLaunchCameraSettingMap.containsKey(Integer.valueOf(this.mCurrentUserId))) {
                            ...
                            launchCameraSetting = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), QUICK_LAUNCH_CAMERA_KEY, 0, this.mCurrentUserId);
                            this.mLaunchCameraSettingMap.put(Integer.valueOf(this.mCurrentUserId), Integer.valueOf(launchCameraSetting));
                        }
                    } catch (Throwable th2) {
                        th = th2;
                        while (true) {
                ...
                if (down) {
                        ...
                        if (keyCode == mKeycodeRecentTask || keyCode == 3 || keyCode == 4) {
                            this.mHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    OppoPhoneWindowManager oppoPhoneWindowManager = OppoPhoneWindowManager.this;
                                    Toast unused = oppoPhoneWindowManager.mHitToast = Toast.makeText(oppoPhoneWindowManager.mContext, OppoPhoneWindowManager.this.mContext.getString(201590152, 1), 0);
                    ...
                    this.mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            OppoPhoneWindowManager oppoPhoneWindowManager = OppoPhoneWindowManager.this;
                            Toast unused = oppoPhoneWindowManager.mHitToast = Toast.makeText(oppoPhoneWindowManager.mContext, OppoPhoneWindowManager.this.mContext.getString(201590132), 0);
                            OppoPhoneWindowManager.this.mHitToast.show();
                        }
                    });
                }
            ...
            synchronized (OppoPhoneWindowManager.this.mKeyLockIntentProcess) {
                if (nMode != 0) {
                    ...
                    if ("com.android.individuationSettings:individuationSetting".equals(processName)) {
                        boolean unused = OppoPhoneWindowManager.this.mPauseForChangingTheme = true;
                    ...
                    if ("com.android.individuationSettings:individuationSetting".equals(processName)) {
                        ...
                        if (OppoPhoneWindowManager.this.mPauseForChangingTheme) {
                            boolean unused2 = OppoPhoneWindowManager.this.mPauseForChangingTheme = false;
                        }
                    }
                }
            }
    ...
    private class DisableBottomKeyModeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (mode == 0) {
                int unused = OppoPhoneWindowManager.this.mDisableBottomKeyMode = 0;
                Settings.System.putInt(OppoPhoneWindowManager.this.mContext.getContentResolver(), "disable_bottom_key_mode", 0);
            } else if (1 == mode) {
                int unused2 = OppoPhoneWindowManager.this.mDisableBottomKeyMode = 1;
                ...
                if (effectId != 10001) {
                    switch (effectId) {
                        ...
                        case 5:
                            ...
                            break;
                        case 10:
                        case WINDOW_LAYER_14 /*{ENCODED_INT: 14}*/:
                            if (this.mLinearmotorVibrator != null) {
                            ...
                            break;
                        case MSG_ISCAMERAMODE /*{ENCODED_INT: 17}*/:
                            if (this.mLinearmotorVibrator != null) {
    ...
    public class ColorPowerKeyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == OppoPhoneWindowManager.MSG_POWER_LONG_PRESS_FOR_SPEECH) {
                boolean unused = OppoPhoneWindowManager.this.mClearPowerKeyDownRecord = true;
                try {
                ...
                boolean unused2 = OppoPhoneWindowManager.this.mClearPowerKeyDownRecord = true;
    ...
    /* access modifiers changed from: private */
    public void sendIntercomAcquireRelaseUp(boolean acquire) {
        Intent intent = new Intent();
        intent.setAction("oppo.intent.action.LAUNCH_INTERCOM_CUSTOM");
        if (acquire) {
    ...
    private void registerSettingsForOppoLocked(ContentResolver resolver, ContentObserver observer) {
        ...
        resolver.registerContentObserver(Settings.System.getUriFor(SUPER_POWERSAVE_MODE_STATE), false, observer, -1);
    }
    ...
    /* access modifiers changed from: private */
    public void startSpeech(final KeyEvent event) {
        if (this.mOppoDebug) {
    ...
    private void sendSpeechMessage(KeyEvent event) {
        ...
        if (isUserSetupComplete() && Settings.Global.getInt(this.mContext.getContentResolver(), "oppo_show_device_locked", 0) == 0 && !isSpeechDisabled()) {
            this.mColorPowerKeyHandler.removeMessages(MSG_POWER_LONG_PRESS_FOR_SPEECH);
    ...
    private class WalletContentObserver extends ContentObserver {
                ...
                this.mContext.registerReceiverAsUser(new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        if (intent != null && intent.getData() != null && TextUtils.equals(intent.getData().getSchemeSpecificPart(), OppoPhoneWindowManager.WALLET_PACKAGE_NAME)) {
                            ...
                            boolean oldValue = OppoPhoneWindowManager.this.mWalletPowerKeyEnabled;
                            boolean unused = OppoPhoneWindowManager.this.mWalletPowerKeyEnabled = false;
                            if (oldValue) {
                                OppoPhoneWindowManager.this.updateFadeOffDuration(-1);
                            }
                        }
    ...
    /* access modifiers changed from: private */
    public IOppoPhoneWindowManagerInner getInner() {
