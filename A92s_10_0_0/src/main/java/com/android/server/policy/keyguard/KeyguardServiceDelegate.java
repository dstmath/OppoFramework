...
public class KeyguardServiceDelegate {
    ...
    public static MtkSystemServer sMtkSystemServer = MtkSystemServer.getInstance();
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mIsSystemRebooted;
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (KeyguardServiceDelegate.this.mKeyguardState.systemIsReady) {
                if (KeyguardServiceDelegate.this.mIsSystemRebooted) {
                    ...
                    boolean unused = KeyguardServiceDelegate.this.mIsSystemRebooted = false;
                }
    ...
    public KeyguardServiceDelegate(Context context, KeyguardStateMonitor.StateCallback callback) {
        ...
        this.mIsSystemRebooted = true;
    }

    public void bindService(Context context) {
        Intent intent = new Intent();
        ComponentName keyguardComponent = ComponentName.unflattenFromString(context.getApplicationContext().getResources().getString(17039747));
        intent.addFlags(256);
    ...
    public void requestKeyguard(String command) {
        KeyguardServiceWrapper keyguardServiceWrapper = this.mKeyguardService;
        if (keyguardServiceWrapper != null) {
            keyguardServiceWrapper.requestKeyguard(command);
        }
    }
