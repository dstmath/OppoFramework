...
class OppoEngineerPhoneWindowManagerHelper {
    ...
    /* access modifiers changed from: private */
    public int mPwkHardShutdownCount = -1;
    ...
    private class PwkMonitorHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case OppoEngineerPhoneWindowManagerHelper.MSG_PWK_PRESSED /*{ENCODED_INT: 100001}*/:
                    synchronized (OppoEngineerPhoneWindowManagerHelper.this.mLock) {
                        if (OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount == -1) {
                            ...
                            if (result == null || result.length <= 77) {
                                int unused = OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount = -1;
                            } else {
                                int unused2 = OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount = result[77];
                                if (OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount >= 127 || OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount < 0) {
                                    int unused3 = OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount = 0;
                                }
                            }
                        }
                        if (OppoEngineerPhoneWindowManagerHelper.this.mPwkHardShutdownCount != -1) {
                    ...
                    return;
                case OppoEngineerPhoneWindowManagerHelper.MSG_PWK_RELEASED /*{ENCODED_INT: 100002}*/:
