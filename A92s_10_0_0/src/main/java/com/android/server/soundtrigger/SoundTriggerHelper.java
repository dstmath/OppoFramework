...
public class SoundTriggerHelper implements SoundTrigger.StatusListener {
                    ...
                    if (modelData != null) {
                        if (modelData.isGenericModel()) {
                            if (!modelData.isModelLoaded()) {
                                ...
                                int modelState = this.mModule.getModelState(modelData.getHandle());
                                return modelState;
                            }
                        }
                    }
    ...
    private static class ModelData {
        ...
        public synchronized String toString() {
            return "Handle: " + this.mModelHandle + "\nModelState: " + stateToString() + StringUtils.LF + requestedToString() + StringUtils.LF + callbackToString() + StringUtils.LF + uuidToString() + StringUtils.LF + modelTypeToString();
        }
        ...
        public synchronized String modelTypeToString() {
            ...
            return "Model type: " + type + StringUtils.LF;
        }
    }
}
