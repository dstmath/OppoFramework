...
public class SystemGesturesPointerEventListener extends OppoBaseSystemGesturesPointerEventListener implements WindowManagerPolicyConstants.PointerEventListener {
    ...
    public void onConfigurationChanged() {
        this.mSwipeStartThreshold = this.mContext.getResources().getDimensionPixelSize(17105422);
        ...
        if (displayCutout != null && !displayCutout.getBoundingRectTop().isEmpty()) {
            this.mDisplayCutoutTouchableRegionSize = this.mContext.getResources().getDimensionPixelSize(17105140);
    ...
    private void captureDown(MotionEvent event, int pointerIndex) {
        ...
        if (i != -1) {
            ...
            setSystemGesturePointerPosition(this.screenWidth, this.mSwipeStartThreshold, this.mDownX[i], this.mDownY[i]);
        }
    }
