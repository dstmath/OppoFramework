...
public class ColorAppStoreTraffic implements IColorAppStoreTraffic {
    ...
    public List<ColorAppStartupMonitorInfo> mCollentTrackingMonitorList = new ArrayList();
    /* access modifiers changed from: private */
    public boolean mDynamicDebug = false;
    ...
    private class CollectJumpStoreTrackingRunnable implements Runnable {
    ...
    /* access modifiers changed from: private */
    public ColorAppStartupMonitorInfo getTrackingMonitorInfo(String callerPkg) {
    ...
    /* access modifiers changed from: private */
    public void saveTrackingFile(String content, boolean append) {
        if (content != null) {
    ...
    /* access modifiers changed from: private */
    public boolean isInTrackWhiteList(String callerPkg, String callerCpn, String calleePkg, String calleeCpn) {
    ...
    /* access modifiers changed from: private */
    public boolean isInTrackBlackList(String callerPkg, String callerCpn, String calleePkg, String calleeCpn) {
        boolean result = false;
                ...
                while (true) {
                    try {
                        ...
                        if (TextUtils.isEmpty(tag)) {
                            ...
                            trackingSwitch = trackingSwitch5;
                            trackingSwitch3 = str;
                        } else if (type != 2) {
                            jumpStoreFile = jumpStoreFile2;
                            trackingSwitch = trackingSwitch5;
                            trackingSwitch3 = null;
                        } else if ("trackMonitor".equals(tag)) {
                            jumpStoreFile = jumpStoreFile2;
                            try {
                                value = parser.getAttributeValue(null, "switch");
                                trackingSwitch2 = trackingSwitch5;
                            } catch (Exception e) {
                                trackingSwitch2 = trackingSwitch5;
                                if (stream != null) {
                                }
                            ...
                            try {
                                ...
                                if (!TextUtils.isEmpty(value)) {
                                    trackingSwitch4 = value;
                                } else {
                                    trackingSwitch4 = trackingSwitch2;
                                }
                            } catch (Exception e2) {
                                if (stream != null) {
                                }
                            ...
                            try {
                                ...
                                trackingSwitch2 = trackingSwitch4;
                                if (stream != null) {
                                }
                                if (!isUpdateSuccess) {
                                }
                        ...
                        trackingSwitch5 = trackingSwitch;
                    } catch (Exception e4) {
                        trackingSwitch2 = trackingSwitch5;
                        if (stream != null) {
                            stream.close();
