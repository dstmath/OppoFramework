...
public class PswOppoArmyControllerFeatrue implements IPswOppoArmyControllerFeatrue {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                if (PswOppoArmyControllerFeatrue.this.mDialogForDisallow == null) {
                    ...
                    AlertDialog unused = pswOppoArmyControllerFeatrue.mDialogForDisallow = new BaseErrorDialog(pswOppoArmyControllerFeatrue.mUiContext);
    ...
    public void systemReady() {
        new Thread(new Runnable() {
            ...
            public void run() {
                List unused = PswOppoArmyControllerFeatrue.this.mCustomizeList = PswOppoArmyControllerFeatrue.loadCustomizeWhiteList(PswOppoArmyControllerFeatrue.CUSTOMIZE_LIST_PATH);
                List unused2 = PswOppoArmyControllerFeatrue.this.mProtectAppList = PswOppoArmyControllerFeatrue.loadCustomizeWhiteList(PswOppoArmyControllerFeatrue.PROTECT_APP_LIST_PATH);
