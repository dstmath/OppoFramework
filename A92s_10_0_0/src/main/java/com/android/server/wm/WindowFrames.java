...
public class WindowFrames {
    ...
    public String getInsetsChangedInfo() {
        return "contentInsetsChanged=" + this.mContentInsetsChanged + StringUtils.SPACE + this.mContentInsets.toShortString() + " visibleInsetsChanged=" + this.mVisibleInsetsChanged + StringUtils.SPACE + this.mVisibleInsets.toShortString() + " stableInsetsChanged=" + this.mStableInsetsChanged + StringUtils.SPACE + this.mStableInsets.toShortString() + " outsetsChanged=" + this.mOutsetsChanged + StringUtils.SPACE + this.mOutsets.toShortString() + " displayCutoutChanged=" + this.mDisplayCutoutChanged;
    }
}
