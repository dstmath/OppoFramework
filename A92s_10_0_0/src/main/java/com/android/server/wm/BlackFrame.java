    ...
    class BlackSurface {
        ...
        BlackSurface(SurfaceControl.Transaction transaction, int layer2, int l, int t, int r, int b, DisplayContent dc) throws Surface.OutOfResourcesException {
            ...
            if (WindowManagerDebugConfig.SHOW_TRANSACTIONS || WindowManagerDebugConfig.SHOW_SURFACE_ALLOC) {
                Slog.i(WmsExt.TAG, "  BLACK " + this.surface + ": CREATE layer=" + layer2);
            }
        }
        ...
        public void clearMatrix(SurfaceControl.Transaction t) {
            t.setMatrix(this.surface, 1.0f, OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, 1.0f);
        }
    }
            ...
            while (true) {
                ...
                if (i < blackSurfaceArr.length) {
                    if (blackSurfaceArr[i] != null) {
                        ...
                        this.mBlackSurfaces[i].surface.remove();
