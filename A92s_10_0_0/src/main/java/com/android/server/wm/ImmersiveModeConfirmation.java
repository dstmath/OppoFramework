...
public class ImmersiveModeConfirmation {
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            this.mClingLayout = (ViewGroup) View.inflate(getContext(), 17367165, null);
            ((Button) this.mClingLayout.findViewById(16909188)).setOnClickListener(new View.OnClickListener() {
            ...
            if (ActivityManager.isHighEndGfx()) {
                ...
                postOnAnimation(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ValueAnimator unused = ClingWindowView.this.mColorAnim = ValueAnimator.ofObject(new ArgbEvaluator(), 0, Integer.MIN_VALUE);
