...
final class AccessibilityController {
    ...
    private static final class DisplayMagnifier {
            ...
            if ((transition == 1 || transition == 3) && magnifying) {
                if (!(type == 2 || type == 4 || type == 1005 || type == 2020 || type == 2024 || type == 2035 || type == 2038)) {
                    switch (type) {
                        ...
                        case 1001:
                        case 1002:
                        case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_RADIO:
                            break;
                        default:
                            switch (type) {
                                case 2001:
        ...
        public final class MagnifiedViewport {
            ...
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             ...
             arg types: [com.android.server.wm.-$$Lambda$AccessibilityController$DisplayMagnifier$MagnifiedViewport$ZNyFGy-UXiWV1D2yZGvH-9qN0AA, int]
             candidates:
            ...
            public /* synthetic */ void lambda$populateWindowsOnScreenLocked$0$AccessibilityController$DisplayMagnifier$MagnifiedViewport(SparseArray outWindows, WindowState w) {
                if (w.isOnScreen() && w.isVisibleLw() && w.mAttrs.alpha != OppoBrightUtils.MIN_LUX_LIMITI && !w.mWinAnimator.mEnterAnimationPending) {
                    this.mTempLayer++;
    ...
    public static final class WindowsForAccessibilityObserver {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
         arg types: [com.android.server.wm.-$$Lambda$AccessibilityController$WindowsForAccessibilityObserver$vRhBz0DqTZWNemKfoIyId7HacTk, int]
         candidates:
          com.android.server.wm.DisplayContent.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
          com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
          com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
         arg types: [com.android.server.wm.-$$Lambda$AccessibilityController$WindowsForAccessibilityObserver$B_IsvCwgODO-zAT2_hQ1EOsBsJg, int]
         candidates:
          com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
          com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
