...
public class Task extends WindowContainer<AppWindowToken> implements ConfigurationContainerListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:(com.android.server.wm.WindowContainer, int):void
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, com.android.server.wm.AppWindowToken, boolean]
     candidates:
      com.android.server.wm.Task.positionChildAt(int, com.android.server.wm.AppWindowToken, boolean):void
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, com.android.server.wm.Task, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.Task.positionChildAt(int, com.android.server.wm.AppWindowToken, boolean):void
     arg types: [int, com.android.server.wm.AppWindowToken, int]
     candidates:
      com.android.server.wm.Task.positionChildAt(int, com.android.server.wm.AppWindowToken, boolean):void
      MutableMD:(int, com.android.server.wm.WindowContainer, boolean):void
      com.android.server.wm.Task.positionChildAt(int, com.android.server.wm.AppWindowToken, boolean):void */
