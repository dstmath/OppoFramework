...
public class ColorWatermarkManager implements IColorWatermarkManager {
    ...
    public final Uri mAccessbilitySwitch = Settings.Secure.getUriFor(ACCESIBILITY_SWITCH);
    ColorTalkbackWatermark mColorTalkbackWatermark;
    /* access modifiers changed from: private */
    public Context mContext;
    private boolean mIsShowing = false;
    /* access modifiers changed from: private */
    public SwitchObserver mObserver;
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            SwitchObserver unused = colorWatermarkManager.mObserver = new SwitchObserver();
        }
    };
    /* access modifiers changed from: private */
    public final Uri mWatermarkSwitch = Settings.Secure.getUriFor(TALKBACK_WATERMARK_SWITCH);
