...
public abstract class ConfigurationContainer<E extends ConfigurationContainer> {
    ...
    public void onConfigurationChanged(Configuration newParentConfig) {
        ...
        if (this.mFullConfiguration.windowConfiguration.getWindowingMode() == WindowConfiguration.WINDOWING_MODE_ZOOM) {
            this.mFullConfiguration.orientation = 1;
        }
    ...
    public void onRequestedOverrideConfigurationChanged(Configuration overrideConfiguration) {
        ...
        if (overrideConfiguration.windowConfiguration.getWindowingMode() == WindowConfiguration.WINDOWING_MODE_ZOOM) {
            this.mRequestedOverrideConfiguration.orientation = 1;
        }
    ...
    public void onMergedOverrideConfigurationChanged() {
        ...
        if (this.mMergedOverrideConfiguration.windowConfiguration.getWindowingMode() == WindowConfiguration.WINDOWING_MODE_ZOOM) {
            this.mMergedOverrideConfiguration.orientation = 1;
        }
    ...
    public boolean inMultiWindowMode() {
        ...
        return (windowingMode == 1 || windowingMode == 0 || windowingMode == WindowConfiguration.WINDOWING_MODE_ZOOM) ? false : true;
    }
    ...
    public void dumpChildrenNames(PrintWriter pw, String prefix) {
        String childPrefix = prefix + StringUtils.SPACE;
        ...
        for (int i = getChildCount() + -1; i >= 0; i += -1) {
            E cc = getChildAt(i);
            pw.print(childPrefix + "#" + i + StringUtils.SPACE);
    ...
    public boolean inZoomWindowingMode() {
        return getWindowingMode() == WindowConfiguration.WINDOWING_MODE_ZOOM;
    }
}
