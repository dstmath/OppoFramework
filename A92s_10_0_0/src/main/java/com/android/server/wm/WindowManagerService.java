...
public class WindowManagerService extends OppoBaseWindowManagerService implements Watchdog.Monitor, WindowManagerPolicy.WindowManagerFuncs {
    ...
    /* access modifiers changed from: private */
    public void hideKeyguardLocked(boolean hide, boolean hideAnimator) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v120, resolved type: android.app.AppOpsManager} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v121, resolved type: android.app.AppOpsManager} */
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:146:0x031d */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r11v0, resolved type: android.view.InputChannel} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r11v1, resolved type: int} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v20, resolved type: com.android.server.wm.WindowState} */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:255:0x05bb, code lost:
        if (com.android.server.wm.WindowManagerDebugConfig.DEBUG_ADD_REMOVE != false) goto L_0x05c8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:318:0x06ca, code lost:
        if (r8.mCurrentFocus.mOwnerUid == r11) goto L_0x06f6;
     */
    public int addWindow(Session session, IWindow client, int seq, WindowManager.LayoutParams attrs, int viewVisibility, int displayId, Rect outFrame, Rect outContentInsets, Rect outStableInsets, Rect outOutsets, DisplayCutout.ParcelableWrapper outDisplayCutout, InputChannel outInputChannel, InsetsState outInsetsState) {
        ...
        char c;
        int type = displayId;
        int callingUid = outInputChannel;
        int[] appOp = new int[1];
        ...
        this.mColorWmsEx.getInterceptWindowAudioPids(this.mContext, session, attrs);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.android.server.wm.Session, android.view.IWindow, int]
     candidates:
      com.android.server.wm.WindowManagerService.windowForClientLocked(com.android.server.wm.Session, android.os.IBinder, boolean):com.android.server.wm.WindowState
      com.android.server.wm.WindowManagerService.windowForClientLocked(com.android.server.wm.Session, android.view.IWindow, boolean):com.android.server.wm.WindowState */
    /* access modifiers changed from: package-private */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowManagerService.windowForClientLocked(com.android.server.wm.Session, android.os.IBinder, boolean):com.android.server.wm.WindowState
     arg types: [com.android.server.wm.Session, android.os.IBinder, int]
     candidates:
      com.android.server.wm.WindowManagerService.windowForClientLocked(com.android.server.wm.Session, android.view.IWindow, boolean):com.android.server.wm.WindowState
      com.android.server.wm.WindowManagerService.windowForClientLocked(com.android.server.wm.Session, android.os.IBinder, boolean):com.android.server.wm.WindowState */
                                            ...
                                            if (!win.mRelayoutCalled) {
                                                ...
                                                if (!shouldRelayout) {
                                                    ...
                                                    try {
                                                        ...
                                                        sb2.append(")");
                                                        Slog.w("WindowManager", sb2.toString(), e);
                                                        Binder.restoreCallingIdentity(origId);
                                                        resetPriorityAfterLockedSection();
                                                        return 0;
                                                    } catch (Throwable th7) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.RootWindowContainer.positionChildAt(int, com.android.server.wm.DisplayContent, boolean):void
     arg types: [int, com.android.server.wm.DisplayContent, int]
     candidates:
      com.android.server.wm.RootWindowContainer.positionChildAt(int, com.android.server.wm.WindowContainer, boolean):void
                ...
                if (visible) {
                    try {
                        if (this.mCircularDisplayMask == null) {
                            this.mCircularDisplayMask = new CircularDisplayMask(getDefaultDisplayContentLocked(), (this.mPolicy.getWindowLayerFromTypeLw(2018) * 10000) + 10, this.mContext.getResources().getInteger(17694961), this.mContext.getResources().getDimensionPixelSize(17105046));
                        }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$Yf21B7QM1fRVFGIQy6MImYjka28, int]
     candidates:
    ...
    public boolean detectSafeMode() {
        ...
        if (SystemProperties.getInt("persist.sys.disable.safemode", 0) == 0) {
            try {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 2) {
                ...
                if (mode == 0) {
                    ...
                    float unused = windowManagerService3.mAnimatorDurationScaleSetting = Settings.Global.getFloat(windowManagerService3.mContext.getContentResolver(), "animator_duration_scale", WindowManagerService.this.mAnimatorDurationScaleSetting);
                    WindowManagerService.this.dispatchNewAnimatorScaleLocked(null);
                }
            } else if (i == 52) {
    ...
    public void stopFreezingDisplayLocked() {
        ...
        if (this.mDisplayFrozen) {
            ...
            if (!waitingForConfig && this.mAppsFreezingScreen <= 0 && this.mWindowsFreezingScreen != 1 && !this.mClientFreezingScreen && numOpeningApps <= 0) {
                ...
                OppoJunkRecorder.getInstance().reportJunkEvent("WINDOW_FREEZE", "N/A", sb.toString());
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$C4RecYWtrllidEGWyvVvRsY6lno, int]
     candidates:
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    /* access modifiers changed from: package-private */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$LbJzcX6LZWc_oRhCOhY74zWzL7Y, int]
     candidates:
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    /* access modifiers changed from: private */
            ...
            synchronized (this.mGlobalLock) {
                try {
                    ...
                    if (displayContent == null) {
                        ...
                        resetPriorityAfterLockedSection();
                        return false;
                    } else if (this.mDisplayWindowSettings.shouldShowImeLocked(displayContent) || this.mForceDesktopModeOnExternalDisplays) {
                        z = true;
                    }
                } finally {
                    resetPriorityAfterLockedSection();
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$nQHccAXNqWhpUTYdUQi4f3vYirA, int]
     candidates:
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    /* access modifiers changed from: package-private */
    ...
    /* access modifiers changed from: private */
    public void killAutoResolutionAPP() {
        try {
        ...
        public String getFocusWindowPkgName() {
            synchronized (WindowManagerService.this.mGlobalLock) {
                try {
                    ...
                    if (focus != null) {
                        String owningPackage = focus.getOwningPackage();
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$uRY35RJfT2AvURYxz9bruMxOdpY, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$YCQk4h3m_yFMR96IaNUQxgMkMVk, int]
     candidates:
      com.android.server.wm.DisplayContent.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$WindowManagerService$mxnGu6wgKmGTdVUX30qyNqEQwj8, int]
     candidates:
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    /* access modifiers changed from: package-private */
