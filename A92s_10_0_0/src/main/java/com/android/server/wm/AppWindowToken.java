...
public class AppWindowToken extends OppoBaseAppWindowToken implements WindowManagerService.AppFreezeListener, ConfigurationContainerListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.android.server.wm.-$$Lambda$AppWindowToken$4kocSW-ikaWAaHRKuROwZYlNZbA, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$2KrtdmjrY7Nagc4IRqzCk9gDuQU, int]
     candidates:
      com.android.server.wm.AppWindowToken.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    ...
    public boolean containsDismissKeyguardWindow() {
        ...
        for (int i = this.mChildren.size() - 1; i >= 0; i--) {
            if ((((WindowState) this.mChildren.get(i)).mAttrs.flags & DumpState.DUMP_CHANGES) != 0) {
                return !(this.mChildren.get(i) instanceof WindowState) || !this.mWmService.mColorWmsEx.execInterceptWindow(this.mWmService.mContext, (WindowState) this.mChildren.get(i));
            }
        }
        return false;
    }
    ...
    private Animation loadAnimation(WindowManager.LayoutParams lp, int transit, boolean enter, boolean isVoiceInteraction) {
        ...
        Animation a = getDisplayContent().mAppTransition.loadAnimation(lp, transit, enter2, displayConfig.uiMode, displayConfig.orientation, frame, displayFrame, insets, surfaceInsets, stableInsets, isVoiceInteraction, freeform, ((Task) getTask()).mTaskId);
        if (a == null && isActivityTypeHome() && !enter2) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
     arg types: [com.android.server.wm.-$$Lambda$AppWindowToken$GO_44j7HKFWrNpwWGQ4totlKXW8, int]
     candidates:
      com.android.server.wm.AppWindowToken.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.android.server.wm.-$$Lambda$AppWindowToken$fPUApbLk_vYcjY_mIHRDEOCqbZU, int]
     candidates:
      com.android.server.wm.WindowContainer.forAllWindows(java.util.function.Consumer<com.android.server.wm.WindowState>, boolean):void
      com.android.server.wm.AppWindowToken.forAllWindows(com.android.internal.util.ToBooleanFunction<com.android.server.wm.WindowState>, boolean):boolean */
