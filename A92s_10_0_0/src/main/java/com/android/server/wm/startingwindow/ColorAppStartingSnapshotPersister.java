...
public class ColorAppStartingSnapshotPersister {
            ...
            while (true) {
                ...
                synchronized (ColorAppStartingSnapshotPersister.this.mLock) {
                    ...
                    if (writeQueueEmpty || ColorAppStartingSnapshotPersister.this.mPaused) {
                        try {
                            boolean unused = ColorAppStartingSnapshotPersister.this.mQueueIdling = writeQueueEmpty;
                            ColorAppStartingSnapshotPersister.this.mLock.wait();
                            boolean unused2 = ColorAppStartingSnapshotPersister.this.mQueueIdling = false;
    ...
    /* access modifiers changed from: private */
    public void deleteSnapshot(int userId, String packageName) {
        try {
    ...
    /* access modifiers changed from: private */
    public void deleteAllSnapshotsForUser(int userId) {
        try {
    ...
    private class DeleteAllCacheForUserQueueItem extends WriteQueueItem {
        private final int mUserId;
