...
public class ActivityStack extends OppoBaseActivityStack {
    ...
    public final ArrayList<ActivityRecord> mLRUActivities = new ArrayList<>();
    ...
    private class ActivityStackHandler extends Handler {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.android.server.wm.ActivityStack.activityDestroyedLocked(android.os.IBinder, java.lang.String):void
         arg types: [android.view.IApplicationToken$Stub, java.lang.String]
         candidates:
          com.android.server.wm.ActivityStack.activityDestroyedLocked(com.android.server.wm.ActivityRecord, java.lang.String):void
          com.android.server.wm.ActivityStack.activityDestroyedLocked(android.os.IBinder, java.lang.String):void */
    ...
    public void findTaskLocked(ActivityRecord target, RootActivityContainer.FindTaskResult result) {
        ...
        int userId5 = UserHandle.getUserId(info.applicationInfo.uid);
        int i = 1;
        ...
        int taskNdx3 = activityStack.mTaskHistory.size() - 1;
        while (taskNdx3 >= 0) {
            TaskRecord task = activityStack.mTaskHistory.get(taskNdx3);
            if (task.voiceSession != null) {
                ...
                boolean isSkip = activityStack.shouldSkipMultiAppUser(task, r, userId5);
    ...
    /* JADX INFO: Multiple debug info for r0v27 'activityNdx'  int: [D('isTop' boolean), D('activityNdx' int)] */
        ...
        try {
            ...
            while (taskNdx >= 0) {
                try {
                    ...
                    int activityNdx3 = activities2.size() - i;
                    boolean resumeNextActivity2 = resumeNextActivity;
                    int configChanges3 = configChanges2;
                    while (activityNdx >= 0) {
                        try {
                            ActivityRecord r = activities2.get(activityNdx);
                            if (!r.finishing) {
                                boolean isTop = r == top2 ? i : false;
                                if (!aboveTop || isTop) {
                                    ...
                                    if (visibleIgnoringKeyguard) {
                                        behindFullscreenActivity3 = updateBehindFullscreen(!stackShouldBeVisible ? i : false, behindFullscreenActivity3, r);
                                    }
                                    if (reallyVisible) {
                                        try {
                                            if (ActivityTaskManagerDebugConfig.DEBUG_VISIBILITY) {
                    ...
                    if (getWindowingMode() == 5) {
                        behindFullscreenActivity3 = !stackShouldBeVisible ? true : z3;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:233:0x04b2  */
    /* JADX WARNING: Removed duplicated region for block: B:234:0x04b6  */
    /* JADX WARNING: Removed duplicated region for block: B:241:0x04d6  */
    /* JADX WARNING: Removed duplicated region for block: B:242:0x04db  */
    /* JADX WARNING: Removed duplicated region for block: B:250:0x0511  */
    /* JADX WARNING: Removed duplicated region for block: B:251:0x0514  */
    /* JADX WARNING: Removed duplicated region for block: B:254:0x051f  */
    /* JADX WARNING: Removed duplicated region for block: B:260:0x057d  */
    /* JADX WARNING: Removed duplicated region for block: B:265:0x0591  */
    /* JADX WARNING: Removed duplicated region for block: B:266:0x0596  */
    /* JADX WARNING: Removed duplicated region for block: B:268:0x0599  */
    /* JADX WARNING: Removed duplicated region for block: B:274:0x05ce  */
    /* JADX WARNING: Removed duplicated region for block: B:360:0x0831  */
    /* JADX WARNING: Removed duplicated region for block: B:363:0x0854  */
    /* JADX WARNING: Removed duplicated region for block: B:366:0x0871  */
    /* JADX WARNING: Removed duplicated region for block: B:367:0x0876  */
    /* JADX WARNING: Removed duplicated region for block: B:375:0x088e  */
    @GuardedBy({"mService"})
                    ...
                    if (prev.finishing) {
                        ...
                        if (this.mStackSupervisor.mNoAnimActivities.contains(prev)) {
                            ...
                            if (!(prev.getTaskRecord() == next.getTaskRecord() || (hypnus2 = mHyp) == null)) {
                                hypnus2.hypnusSetAction(11, (int) SystemService.PHASE_THIRD_PARTY_APPS_CAN_START);
                            }
                        }
                        prev.setVisibility(false);
                        anim = anim2;
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ClientTransactionItem):void
     arg types: [android.app.IApplicationThread, android.view.IApplicationToken$Stub, android.app.servertransaction.ActivityResultItem]
     candidates:
      com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ActivityLifecycleItem):void
      com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ClientTransactionItem):void */
    /* access modifiers changed from: package-private */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ActivityLifecycleItem):void
     arg types: [android.app.IApplicationThread, android.view.IApplicationToken$Stub, android.app.servertransaction.DestroyActivityItem]
     candidates:
      com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ClientTransactionItem):void
      com.android.server.wm.ClientLifecycleManager.scheduleTransaction(android.app.IApplicationThread, android.os.IBinder, android.app.servertransaction.ActivityLifecycleItem):void */
    /* access modifiers changed from: package-private */
