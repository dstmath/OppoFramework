...
public class RecentTasks {
    ...
    private boolean hasCompatibleActivityTypeAndWindowingMode(TaskRecord t1, TaskRecord t2) {
        ...
        return (activityType == otherActivityType || isUndefinedType || (otherActivityType == 0)) && (windowingMode == otherWindowingMode || isUndefinedMode || (otherWindowingMode == 0) || windowingMode == 5 || windowingMode == WindowConfiguration.WINDOWING_MODE_ZOOM || windowingMode == 4 || otherWindowingMode == 4 || otherWindowingMode == 3);
    }
}
