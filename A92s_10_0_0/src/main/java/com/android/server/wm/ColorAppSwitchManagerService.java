...
public class ColorAppSwitchManagerService implements ColorAppSwitchSettings.OnConfigChangedListener {
    ...
    public void onActivityPaused(ActivityRecord r, ActivityRecord nextResuming, boolean nextFirstStart) {
        if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
    ...
    /* access modifiers changed from: private */
    public void onActivityResumed(ActivityRecord r, boolean firstStart) {
        if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
