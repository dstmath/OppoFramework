...
public class TaskRecord extends ConfigurationContainer {
    ...
    public static final String TAG_RECENTS = (TAG + ActivityTaskManagerDebugConfig.POSTFIX_RECENTS);
    ...
    int mCallingUid;
    protected boolean mDiedInFreeform;
    final Rect mDisplayedBounds = new Rect();
    ActivityRecord mLastNextActivity;
    ...
    boolean mRootLockDeviceTask = false;
    ...
    public void removeWindowContainer() {
        ...
        if (task != null) {
            ...
            Slog.i(WmsExt.TAG, "removeTask: could not find taskId=" + this.taskId);
        }
    }
    ...
    public void setTaskDockedResizing(boolean resizing) {
        Task task = this.mTask;
        if (task == null) {
            Slog.w(WmsExt.TAG, "setTaskDockedResizing: taskId " + this.taskId + " not found.");
            return;
        }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wm.TaskRecord.reparent(com.android.server.wm.ActivityStack, int, int, boolean, boolean, boolean, java.lang.String):boolean
     arg types: [com.android.server.wm.ActivityStack, int, int, boolean, boolean, int, java.lang.String]
     candidates:
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r26v1, resolved type: com.android.server.wm.ActivityStackSupervisor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r26v2, resolved type: com.android.server.wm.ActivityStackSupervisor} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r26v3, resolved type: com.android.server.wm.ActivityStackSupervisor} */
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Removed duplicated region for block: B:100:0x0144 A[SYNTHETIC, Splitter:B:100:0x0144] */
    /* JADX WARNING: Removed duplicated region for block: B:106:0x015d A[SYNTHETIC, Splitter:B:106:0x015d] */
    /* JADX WARNING: Removed duplicated region for block: B:110:0x016a  */
    /* JADX WARNING: Removed duplicated region for block: B:121:0x01a6 A[Catch:{ all -> 0x019b }] */
    /* JADX WARNING: Removed duplicated region for block: B:123:0x01bb A[Catch:{ all -> 0x019b }] */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x01ca A[Catch:{ all -> 0x0292 }] */
    /* JADX WARNING: Removed duplicated region for block: B:128:0x01cc A[Catch:{ all -> 0x0292 }] */
    /* JADX WARNING: Removed duplicated region for block: B:131:0x01d4 A[Catch:{ all -> 0x0292 }] */
    /* JADX WARNING: Removed duplicated region for block: B:137:0x01e4  */
    /* JADX WARNING: Removed duplicated region for block: B:142:0x01f7  */
    /* JADX WARNING: Removed duplicated region for block: B:145:0x01fb  */
    /* JADX WARNING: Removed duplicated region for block: B:156:0x0225 A[ADDED_TO_REGION] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:184:0x027f  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x0290  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:86:0x0128 A[Catch:{ all -> 0x029c }] */
    /* JADX WARNING: Removed duplicated region for block: B:92:0x0132 A[Catch:{ all -> 0x029c }] */
    /* JADX WARNING: Removed duplicated region for block: B:96:0x0138 A[Catch:{ all -> 0x029c }] */
    /* JADX WARNING: Removed duplicated region for block: B:97:0x013a A[Catch:{ all -> 0x029c }] */
    public boolean reparent(ActivityStack preferredStack, int position, int moveStackMode, boolean animate, boolean deferResume, boolean schedulePictureInPictureModeChange, String reason) {
        ...
        WindowManagerService windowManager3;
        RootActivityContainer root;
        ...
        RootActivityContainer root2 = this.mService.mRootActivityContainer;
        WindowManagerService windowManager4 = this.mService.mWindowManager;
        ...
        if ((position == Integer.MAX_VALUE) && toStack.getResumedActivity() != null && toStack.topRunningActivityLocked() != null && !OppoFeatureCache.get(IColorSplitWindowManager.DEFAULT).isSwapToPrimaryStack(reason)) {
            toStack.startPausingLocked(false, false, null, false);
        }
        int toStackWindowingMode3 = toStack.getWindowingMode();
        ActivityRecord topActivity2 = getTopActivity();
        boolean mightReplaceWindow = topActivity2 != null && replaceWindowsOnTaskMove(getWindowingMode(), toStackWindowingMode3);
        if (mightReplaceWindow) {
            windowManager4.setWillReplaceWindow(topActivity2.appToken, animate);
        }
        windowManager4.deferSurfaceLayout();
        boolean kept = true;
        boolean isFreeform = sourceStack.inFreeformWindowingMode();
        if (isFreeform) {
            toStackWindowingMode = toStackWindowingMode3;
            nextStack = this.mService.mRootActivityContainer.getNextFocusableStack(sourceStack, true);
        } else {
            toStackWindowingMode = toStackWindowingMode3;
            nextStack = null;
        }
        try {
            ...
            if (r != null) {
                try {
                    if (root2.isTopDisplayFocusedStack(sourceStack) && topRunningActivityLocked() == r) {
                        wasFocused = true;
                        ...
                        if (r != null) {
                            try {
                                if (sourceStack.mPausingActivity == r) {
                                    ...
                                    if (r != null) {
                                        try {
                                            if (sourceStack.isTopStackOnDisplay() && sourceStack.topRunningActivityLocked() == r) {
                                                wasFront = true;
                                                int position2 = toStack.getAdjustedPositionForTask(this, position, null);
                                                Task task = this.mTask;
                                                ...
                                                task.reparent(taskStack, position2, z);
                                                if (moveStackMode == 0) {
                                                    z2 = true;
                                                    z2 = true;
                                                    z2 = true;
                                                    ...
                                                    sourceStack.removeTask(this, reason, moveStackToFront ? 2 : z2);
                                                    toStack.addTask(this, position2, false, reason);
                                                    ...
                                                    if (r != null) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (isFreeform && moveStackToFront && nextStack != null && !toStack.inFreeformWindowingMode()) {
                                                                this.mLastNextActivity = nextStack.getTopActivity();
                                                            }
                                                        } catch (Throwable th2) {
                                                            th = th2;
                                                    ...
                                                    boolean toStackSplitScreenPrimary = toStackWindowingMode2 == 3;
                                                    configBounds = getRequestedOverrideBounds();
                                                    if (toStackWindowingMode2 != 1) {
                                                        if (toStackWindowingMode2 != 4) {
                                                            if (toStackWindowingMode2 != 5) {
                                                                Rect bounds = (configBounds == null || configBounds.isEmpty()) ? null : getLaunchBounds();
                                                                if (bounds == null) {
                                                                    this.mService.mStackSupervisor.getLaunchParamsController().layoutTask(this, null);
                                                                    bounds = configBounds;
                                                                }
                                                                kept = resize(bounds, i, !mightReplaceWindow, deferResume);
                                                            } else if (toStackSplitScreenPrimary || toStackWindowingMode2 == i) {
                                                                if (toStackSplitScreenPrimary) {
                                                                    z3 = true;
                                                                    z3 = true;
                                                                    z3 = true;
                                                                    if (moveStackMode == 1 && !OppoFeatureCache.get(IColorSplitWindowManager.DEFAULT).isSwapToPrimaryStack(reason)) {
                                                                        this.mService.mStackSupervisor.moveRecentsStackToFront(reason);
                                                                    }
                                                                } else {
                                                                    z3 = true;
                                                                }
                                                                kept = resize(toStack.getRequestedOverrideBounds(), 0, !mightReplaceWindow ? z3 : false, deferResume);
                                                                windowManager3.continueSurfaceLayout();
                                                                if (!mightReplaceWindow) {
                                                                    windowManager3.scheduleClearWillReplaceWindows(topActivity.appToken, !kept ? z3 : false);
                                                                }
                                                                if (deferResume) {
                                                                    r11 = 0;
                                                                    root.ensureActivitiesVisible(null, 0, !mightReplaceWindow ? z3 : false);
                                                                    root.resumeFocusedStacksTopActivities();
                                                                } else {
                                                                    r11 = 0;
                                                                }
                                                                supervisor.handleNonResizableTaskIfNeeded(this, preferredStack.getWindowingMode(), r11, toStack);
                                                                return preferredStack != toStack ? z3 : r11;
                                                            }
                                                            z3 = true;
                                                            windowManager3.continueSurfaceLayout();
                                                            if (!mightReplaceWindow) {
                                                    ...
                                                    if (!Objects.equals(configBounds, toStack.getRequestedOverrideBounds())) {
                                                        kept = resize(toStack.getRequestedOverrideBounds(), 0, !mightReplaceWindow, deferResume);
                                                        z3 = true;
                                                        windowManager3.continueSurfaceLayout();
                                                        if (!mightReplaceWindow) {
                                                        }
                                    ...
                                    wasFront = false;
                                    int position22 = toStack.getAdjustedPositionForTask(this, position, null);
                                    Task task2 = this.mTask;
                                    TaskStack taskStack2 = toStack.getTaskStack();
                                    if (moveStackMode != 0) {
                                    }
                                    task2.reparent(taskStack2, position22, z);
                                    if (moveStackMode == 0) {
                                    }
                                    moveStackToFront = z2;
                                    sourceStack.removeTask(this, reason, moveStackToFront ? 2 : z2);
                                    toStack.addTask(this, position22, false, reason);
                                    if (schedulePictureInPictureModeChange) {
                                    }
                                    if (this.voiceSession != null) {
                                    }
                        ...
                        wasFront = false;
                        int position222 = toStack.getAdjustedPositionForTask(this, position, null);
                        Task task22 = this.mTask;
                        TaskStack taskStack22 = toStack.getTaskStack();
                        if (moveStackMode != 0) {
                        }
                        task22.reparent(taskStack22, position222, z);
                        if (moveStackMode == 0) {
                        }
                        moveStackToFront = z2;
                        sourceStack.removeTask(this, reason, moveStackToFront ? 2 : z2);
                        toStack.addTask(this, position222, false, reason);
                        if (schedulePictureInPictureModeChange) {
                        }
                        if (this.voiceSession != null) {
                        }
            ...
            wasFront = false;
            try {
                int position2222 = toStack.getAdjustedPositionForTask(this, position, null);
            } catch (Throwable th7) {
                th = th7;
                windowManager = windowManager4;
                windowManager.continueSurfaceLayout();
            ...
            try {
                Task task222 = this.mTask;
                TaskStack taskStack222 = toStack.getTaskStack();
                if (moveStackMode != 0) {
                }
            } catch (Throwable th8) {
                th = th8;
            ...
            try {
                task222.reparent(taskStack222, position2222, z);
                if (moveStackMode == 0) {
                }
                moveStackToFront = z2;
                sourceStack.removeTask(this, reason, moveStackToFront ? 2 : z2);
                toStack.addTask(this, position2222, false, reason);
                if (schedulePictureInPictureModeChange) {
                }
                if (this.voiceSession != null) {
                }
    ...
    public void cancelWindowTransition() {
        Task task = this.mTask;
        if (task == null) {
            Slog.w(WmsExt.TAG, "cancelWindowTransition: taskId " + this.taskId + " not found.");
            return;
        }
    ...
    private void setIntent(Intent _intent, ActivityInfo info) {
        ...
        if (info.targetActivity == null) {
            ...
            if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
                ...
                Slog.v(str, "Setting Intent of " + this + " to " + _intent);
            }
            this.intent = _intent;
            ...
            if (_intent != null) {
                ...
                if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
                    String str2 = TAG_TASKS;
                    Slog.v(str2, "Setting Intent of " + this + " to target " + targetIntent);
                }
    ...
    public void setStack(ActivityStack stack) {
        if (stack == null || stack.isInStackLocked(this)) {
            if (stack == null && inFreeformWindowingMode() && getChildCount() == 0) {
                if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
                    Slog.i(TAG, "setStack reset windowmode to fullscreen task = " + this);
                }
                setWindowingMode(1);
            }
    ...
    public ActivityRecord getTopActivity(boolean includeOverlays) {
        for (int i = this.mActivities.size() - 1; i >= 0; i--) {
            ActivityRecord r = this.mActivities.get(i);
            if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
                Slog.v(TAG, "i " + i + " r.finishing " + r.finishing + " r " + r);
            }
    ...
    public ActivityRecord topRunningActivityLocked() {
        ...
        try {
            for (int activityNdx = this.mActivities.size() - 1; activityNdx >= 0; activityNdx--) {
                ...
                if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
                    Slog.v(TAG, "TaskRecord topRunningActivityLocked activityNdx: " + activityNdx + " r " + r + StringUtils.SPACE + r.finishing);
                }
    ...
    public final void moveActivityToFrontLocked(ActivityRecord newTop) {
        if (ActivityTaskManagerDebugConfig.DEBUG_ADD_REMOVE) {
            ...
            Slog.i(str, "Removing and adding activity " + newTop + " to stack at top callers=" + Debug.getCallers(4));
        }
    ...
    public void addActivityAtIndex(int index, ActivityRecord r) {
        if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
            Slog.i(TAG, index + " addActivityAtIndex: r " + r + "  call by " + Debug.getCallers(8));
        }
        ...
        if (task == null || task == this) {
            ...
            final String tmpAffinity = this.affinity;
            if (this.mActivities.size() > 50 && tmpAffinity != null && "1".equals(SystemProperties.get("SPECIAL_OPPO_CONFIG", "0"))) {
                Slog.w(TAG, "force stop " + tmpAffinity + " which has too many activities");
                new Thread() {
                    /* class com.android.server.wm.TaskRecord.AnonymousClass1 */

                    public void run() {
                        try {
                            ActivityManager.getService().forceStopPackage(tmpAffinity, -1);
                        } catch (Exception e) {
                            Slog.w(TaskRecord.TAG, "can't force stop " + tmpAffinity + " which has too many activities", e);
                        }
                    }
                }.start();
            }
    ...
    public boolean removeActivity(ActivityRecord r) {
        if (ActivityTaskManagerDebugConfig.DEBUG_TASKS) {
            Slog.i(TAG, this + " removeActivity: r " + r + "  call by " + Debug.getCallers(8));
        }
    ...
    public void computeConfigResourceOverrides(Configuration inOutConfig, Configuration parentConfig, ActivityRecord.CompatDisplayInsets compatInsets) {
        ...
        if (density == OppoBrightUtils.MIN_LUX_LIMITI) {
        ...
        if (!(!insideParentBounds || windowingMode == 5 || windowingMode == WindowConfiguration.WINDOWING_MODE_ZOOM || (parentAppBounds = parentConfig.windowConfiguration.getAppBounds()) == null || parentAppBounds.isEmpty())) {
    ...
    public Rect getLaunchBounds() {
        ...
        int windowingMode = getWindowingMode();
        if (windowingMode == WindowConfiguration.WINDOWING_MODE_ZOOM) {
            return OppoFeatureCache.get(IColorZoomWindowManager.DEFAULT).getTaskBound();
        }
    ...
    public void dump(PrintWriter pw, String prefix) {
        ...
        pw.println(prefix + "mRootLockDeviceTask=" + this.mRootLockDeviceTask);
    }
    ...
    public void saveToXml(XmlSerializer out) throws IOException, XmlPullParserException {
        if (ActivityTaskManagerDebugConfig.DEBUG_RECENTS) {
            String str = TAG_RECENTS;
            Slog.i(str, "Saving task=" + this);
        }
        ...
        if (str2 != null) {
            out.attribute(null, ATTR_AFFINITY, str2);
            ...
            String str4 = this.rootAffinity;
            if (str4 != null) {
                if (str4 == null) {
                    str4 = "@";
                }
                out.attribute(null, ATTR_ROOT_AFFINITY, str4);
            }
        }
        ...
        out.attribute(null, ATTR_CALLING_PACKAGE, str5);
        ...
        while (activityNdx < numActivities) {
            ...
            if (r.info.persistableMode != 0 && r.isPersistable()) {
                if (((r.intent.getFlags() & DumpState.DUMP_FROZEN) | 8192) != 524288 || activityNdx <= 0) {
                    out.startTag(null, "activity");
                    r.saveToXml(out);
                    out.endTag(null, "activity");
                    activityNdx++;
                } else {
                    return;
                }
    ...
    static class TaskRecordFactory {
        ...
        /* access modifiers changed from: package-private */
        /* JADX WARNING: Removed duplicated region for block: B:191:0x0472 A[LOOP:2: B:190:0x0470->B:191:0x0472, LOOP_END] */
        /* JADX WARNING: Removed duplicated region for block: B:194:0x0482  */
        public TaskRecord restoreFromXml(XmlPullParser in, ActivityStackSupervisor stackSupervisor) throws IOException, XmlPullParserException {
                ...
                switch (c) {
                    ...
                    default:
                        if (!attrName.startsWith("task_description_")) {
                            taskDescription = taskDescription2;
                            intent = intent2;
                            Slog.w(TaskRecord.TAG, "TaskRecord: Unknown attribute=" + attrName);
                            break;
                        } else {
                            taskDescription = taskDescription2;
            ...
            if (effectiveUid2 <= 0) {
                ...
                Slog.w(TaskRecord.TAG, "Updating task #" + taskId + " for " + checkIntent + ": effectiveUid=" + effectiveUid3);
            ...
            if (persistTaskVersion < 1) {
                if (taskType == 1 && resizeMode2 == 2) {
                    ...
                    if (ActivityTaskManagerDebugConfig.DEBUG_RECENTS) {
                        Slog.d(TaskRecord.TAG_RECENTS, "Restored task=" + task);
                    }
                    return task;
                }
        ...
        public void handleUnknownTag(String name, XmlPullParser in) throws IOException, XmlPullParserException {
            Slog.e(TaskRecord.TAG, "restoreTask: Unexpected name=" + name);
