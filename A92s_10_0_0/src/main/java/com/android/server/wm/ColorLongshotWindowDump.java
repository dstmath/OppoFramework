...
public class ColorLongshotWindowDump {
    ...
    public static final boolean DBG = ColorLongshotDump.DBG;
    ...
    private class WindowDumpListener implements ColorWindowTraversalListener {
        ...
        public void printDetect(String msg, CharSequence windowName) {
            boolean access$100 = ColorLongshotWindowDump.DBG;
            ColorLog.d(access$100, ColorLongshotWindowDump.TAG, "            [Detected][" + msg + "] " + ((Object) windowName));
        }

        public void printWindow(String msg, CharSequence windowName) {
            boolean access$100 = ColorLongshotWindowDump.DBG;
            ColorLog.d(access$100, ColorLongshotWindowDump.TAG, " findWindow [" + msg + "] " + ((Object) windowName));
        }
        ...
        public boolean hasSystemDocorView(IWindow service) {
            ...
            try {
                ...
                boolean access$100 = ColorLongshotWindowDump.DBG;
                ColorLog.e(access$100, ColorLongshotWindowDump.TAG, "collect" + "Decor" + "Windows ERROR : " + Log.getStackTraceString(e));
                return ColorLongshotWindowDump.DBG;
            } catch (Exception e2) {
                boolean access$1002 = ColorLongshotWindowDump.DBG;
                ColorLog.e(access$1002, ColorLongshotWindowDump.TAG, "collect" + "Decor" + "Windows ERROR : " + Log.getStackTraceString(e2));
                return ColorLongshotWindowDump.DBG;
            }
        }
                ...
                try {
                    ...
                    if (window != null) {
                        try {
                            ...
                            e = e;
                            boolean access$100 = ColorLongshotWindowDump.DBG;
                            ColorLog.e(access$100, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                        } catch (Exception e2) {
                            e = e2;
                            boolean access$1002 = ColorLongshotWindowDump.DBG;
                            ColorLog.e(access$1002, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                        }
                        try {
                            windows.add(window);
                        } catch (RemoteException e3) {
                            e = e3;
                            boolean access$1003 = ColorLongshotWindowDump.DBG;
                            ColorLog.e(access$1003, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                        } catch (Exception e4) {
                            e = e4;
                            boolean access$10022 = ColorLongshotWindowDump.DBG;
                            ColorLog.e(access$10022, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                        }
                    }
                    boolean access$1004 = ColorLongshotWindowDump.DBG;
                    ...
                    try {
                        ...
                        sb.append(" : ");
                        sb.append(window);
                        ColorLog.d(access$1004, ColorLongshotWindowDump.TAG, sb.toString());
                    } catch (RemoteException e5) {
                        e = e5;
                    } catch (Exception e6) {
                        e = e6;
                        boolean access$100222 = ColorLongshotWindowDump.DBG;
                        ColorLog.e(access$100222, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                    }
                } catch (RemoteException e7) {
                    e = e7;
                    boolean access$10032 = ColorLongshotWindowDump.DBG;
                    ColorLog.e(access$10032, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                } catch (Exception e8) {
                    e = e8;
                    boolean access$1002222 = ColorLongshotWindowDump.DBG;
                    ColorLog.e(access$1002222, ColorLongshotWindowDump.TAG, "collect" + tag + "Windows ERROR : " + Log.getStackTraceString(e));
                }
            }
        }
    }
