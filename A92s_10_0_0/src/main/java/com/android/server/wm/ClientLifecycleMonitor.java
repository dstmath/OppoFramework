...
public class ClientLifecycleMonitor {
    ...
    private static class LazyHolder {
        ...
        public static final ClientLifecycleMonitor INSTANCE = new ClientLifecycleMonitor();
    ...
    public void doCheckLocked() {
        int index = 0;
        while (index < this.mWaitingMap.size()) {
    ...
    private void abort() {
        ...
        if (checkThread != null) {
            synchronized (checkThread) {
                boolean unused = this.mThread.mForceStop = true;
                this.mThread.notify();
            }
        }
    }
