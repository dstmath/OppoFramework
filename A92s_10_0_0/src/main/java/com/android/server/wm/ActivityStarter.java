...
class ActivityStarter extends OppoBaseActivityStarter {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v48, resolved type: com.android.server.wm.ActivityStartController} */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:352:0x097a  */
    ...
    public int startActivity(IApplicationThread caller, Intent intent, Intent ephemeralIntent, String resolvedType, ActivityInfo aInfo, ResolveInfo rInfo, IVoiceInteractionSession voiceSession, IVoiceInteractor voiceInteractor, IBinder resultTo, String resultWho, int requestCode, int callingPid, int callingUid, String callingPackage, int realCallingPid, int realCallingUid, int startFlags, SafeActivityOptions options, boolean ignoreTargetSecurity, boolean componentSpecified, ActivityRecord[] outActivity, TaskRecord inTask, boolean allowPendingRemoteAnimationRegistryLookup, PendingIntentRecord originatingPendingIntent, boolean allowBackgroundActivityStart) {
        ...
        if (caller != null) {
            ...
            if (callerApp7 != null) {
                int callingPid10 = callerApp7.getPid();
                callingUid2 = callerApp7.mInfo.uid;
                callingPid2 = callingPid10;
            } else {
        ...
        int userId7 = (aInfo == null || aInfo.applicationInfo == null) ? 0 : UserHandle.getUserId(aInfo.applicationInfo.uid);
                            ...
                            if (!OppoFeatureCache.get(IColorMultiAppManager.DEFAULT).startActivity(aInfo, intent, sourceRecord == null ? null : sourceRecord.mColorArEx, resultRecord3 == null ? null : resultRecord3.mColorArEx, callingPackage2, callingUid5)) {
                                ...
                                if (newIntent != null) {
                                    ...
                                    if (tmpAInfo != null) {
                                        ...
                                        if (aInfo4 != null) {
                                            ...
                                            if (this.mService.getPackageManagerInternalLocked().isPermissionsReviewRequired(aInfo4.packageName, userId3)) {
                                                ...
                                                if (voiceSession == null) {
                                                    ...
                                                    if (callerApp6 == null || !callerApp6.hasOverlayUi() || !ActivityThread.inCptWhiteList((int) CompatibilityHelper.FLOATING_WIN_START, callingPackage3)) {
                                                        skipCheck = false;
                                                    }
                                                ...
                                                activityStarter2.mController.doPendingActivityLaunches(r13);
                                                if (aInfo6 != null || aInfo6.packageName == null) {
                                                    userId6 = userId5;
                                                } else {
                                                    userId6 = userId5;
                                                    activityStarter2.mService.getOppoPackageManagerInternalLocked().autoUnfreezePackage(aInfo6.packageName, userId6, "app before start from AMS");
                                                }
                                                ...
                                                activityStarter2.mSupervisor.getActivityMetricsLogger().notifyActivityLaunched(res, outActivity[r13]);
                                                return res;
                                            }
                                            callerApp6 = callerApp5;
                                            aInfo7 = aInfo4;
                                            rInfo5 = rInfo3;
                                            callingPid9 = callingPid6;
                                            requestCode4 = requestCode3;
                                            userId4 = userId3;
                                            z4 = true;
                                            z5 = false;
                                        ...
                                        activityStarter2.mSupervisor.getActivityMetricsLogger().notifyActivityLaunched(res2, outActivity[r13]);
                                        return res2;
                                    }
                                    str8 = str6;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: Multiple debug info for r15v2 int: [D('callingUid' int), D('callingPid' int)] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{android.content.Intent.putExtra(java.lang.String, boolean):android.content.Intent}
     arg types: [java.lang.String, int]
     candidates:
                                    ...
                                    if (configuration != null) {
                                        try {
                                            if (this.mService.getGlobalConfiguration().diff(configuration) != 0) {
                                                ...
                                                if (!OppoFeatureCache.get(IColorIntentInterceptManager.DEFAULT).interceptSougouSiteIfNeeded(callingPackage, stack3, intent2)) {
                                                        ...
                                                        if ((aInfo2.applicationInfo.privateFlags & 2) != 0 && this.mService.mHasHeavyWeightFeature) {
                                                            if (aInfo2.processName.equals(aInfo2.applicationInfo.packageName)) {
                                                                ...
                                                                if (heavy == null) {
                                                                    ...
                                                                    realCallingUid4 = realCallingUid2;
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        IIntentSender target = activityTaskManagerService.getIntentSenderLocked(2, PackageManagerService.PLATFORM_PACKAGE_NAME, appCallingUid, userId3, null, null, 0, intentArr, new String[]{resolvedType}, 1342177280, null);
    ...
    private void sendNewTaskResultRequestIfNeeded() {
        ActivityStack sourceStack = this.mStartActivity.resultTo != null ? this.mStartActivity.resultTo.getActivityStack() : null;
        if (!(this.mStartActivity.packageName != null && "com.oppo.launcher".equals(this.mStartActivity.packageName)) && sourceStack != null) {
