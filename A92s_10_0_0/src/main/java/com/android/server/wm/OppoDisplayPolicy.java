...
public class OppoDisplayPolicy extends DisplayPolicy {
    ...
    public static ColorDisplayCompatUtils mDisplayCompatUtils = null;
    ...
    /* access modifiers changed from: private */
    public View mColorFullScreenWindow = null;
    /* access modifiers changed from: private */
    public View mColorFullScreenWindowLand = null;
    private View mColorSagAreaView = null;
    private Context mContext = null;
    private int mFloatAssistantDirection = 5;
    /* access modifiers changed from: private */
    public String mFoucsPackage = null;
    /* access modifiers changed from: private */
    public AlertDialog mFullscreenDialog;
    /* access modifiers changed from: private */
    public AlertDialog mFullscreenDialogLand;
        ...
        public void onReceive(Context context, Intent intent) {
            if ("android.intent.action.CLOSE_SYSTEM_DIALOGS".equals(intent.getAction())) {
                if (OppoDisplayPolicy.this.mFullscreenDialogLand != null) {
                    ...
                    AlertDialog unused = OppoDisplayPolicy.this.mFullscreenDialogLand = null;
                }
                if (OppoDisplayPolicy.this.mFullscreenDialog != null) {
                    OppoDisplayPolicy.this.mFullscreenDialog.dismiss();
                    AlertDialog unused2 = OppoDisplayPolicy.this.mFullscreenDialog = null;
                }
            }
        }
    };
    ...
    /* access modifiers changed from: private */
    public int mUid = ColorFreeformManagerService.FREEFORM_CALLER_UID;
    ...
    private class ColorThreeFingerHandler extends Handler implements IColorScreenshotHelper {
    ...
    private class ColorFloatAssistantHandler extends Handler implements IColorScreenshotHelper {
    ...
    /* access modifiers changed from: private */
    public void luncherFullScreenAPPForLand(String packageName, int uid) {
    ...
    /* access modifiers changed from: private */
    public void luncherFullScreenApp(String packageName, int uid) {
        ...
        try {
            ...
            this.mVchild.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (shouldShow) {
                        if (OppoDisplayPolicy.this.mFullscreenDialog != null) {
                            OppoDisplayPolicy.this.mFullscreenDialog.dismiss();
                            AlertDialog unused = OppoDisplayPolicy.this.mFullscreenDialog = null;
                        }
                        OppoDisplayPolicy oppoDisplayPolicy = OppoDisplayPolicy.this;
                        AlertDialog unused2 = oppoDisplayPolicy.mFullscreenDialog = oppoDisplayPolicy.createDialog(false);
                        return;
                    }
                    if (OppoDisplayPolicy.mDisplayCompatUtils != null) {
                        OppoDisplayPolicy.mDisplayCompatUtils.updateLocalAppsListForPkg(OppoDisplayPolicy.this.mFoucsPackage);
            ...
            this.mHchildLeft.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    OppoDisplayPolicy oppoDisplayPolicy2 = OppoDisplayPolicy.this;
                    AlertDialog unused2 = oppoDisplayPolicy2.mFullscreenDialogLand = oppoDisplayPolicy2.createDialog(true);
                }
            });
