...
public class ColorDirectWindowDump {
    ...
    public static final boolean DBG = ColorDirectUtils.DBG;
    ...
    private class WindowPrintListener implements ColorWindowTraversalListener {
        ...
        public void printWindow(String msg, CharSequence windowName) {
            boolean access$100 = ColorDirectWindowDump.DBG;
            ColorLog.d(access$100, ColorDirectWindowDump.TAG, " findWindow [" + msg + "] " + ((Object) windowName));
        }
