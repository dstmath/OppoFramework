...
public class RecentsAnimationController implements IBinder.DeathRecipient {
    ...
    private final IRecentsAnimationController mController = new IRecentsAnimationController.Stub() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0047, code lost:
            r2 = com.android.server.wm.RecentsAnimationController.access$600(r6.this$0);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
            r2.onAnimationFinished(r4, true, r8);
            r2 = com.android.server.wm.RecentsAnimationController.access$100(r6.this$0).mRoot.getDisplayContent(com.android.server.wm.RecentsAnimationController.access$000(r6.this$0));
         */
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x006d, code lost:
            if (r2.getPinnedStack() == null) goto L_0x0071;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x0074, code lost:
            r2.mBoundsAnimationController.setAnimationType(1);
         */
        ...
        public void setAnimationTargetsBehindSystemBars(boolean behindSystemBars) throws RemoteException {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                Slog.d(RecentsAnimationController.TAG, "setAnimationTargetsBehindSystemBars(" + behindSystemBars + ")");
            }
            long token = Binder.clearCallingIdentity();
            try {
                synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
        ...
        public void setInputConsumerEnabled(boolean enabled) {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                String access$200 = RecentsAnimationController.TAG;
                Slog.d(access$200, "setInputConsumerEnabled(" + enabled + "): mCanceled=" + RecentsAnimationController.this.mCanceled);
            }
            long token = Binder.clearCallingIdentity();
            try {
                synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
        ...
        public void setSplitScreenMinimized(boolean minimized) {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                String access$200 = RecentsAnimationController.TAG;
                Slog.d(access$200, "setSplitScreenMinimized(" + minimized + ")");
            }
            long token = Binder.clearCallingIdentity();
            try {
                synchronized (RecentsAnimationController.this.mService.getWindowManagerLock()) {
        ...
        public void hideCurrentInputMethod() {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                Slog.d(RecentsAnimationController.TAG, "hideCurrentInputMethod()");
            }
            long token = Binder.clearCallingIdentity();
            try {
        ...
        public void setCancelWithDeferredScreenshot(boolean screenshot) {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                String access$200 = RecentsAnimationController.TAG;
                Slog.d(access$200, "cleanupScreenshot(" + screenshot + ")");
            }
        ...
        public void cleanupScreenshot() {
            if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
                Slog.d(RecentsAnimationController.TAG, "cleanupScreenshot()");
            }
            synchronized (RecentsAnimationController.this.mLock) {
    ...
    public void initialize(DisplayContent dc, int targetActivityType, SparseBooleanArray recentTaskIds) {
        if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
            Slog.d(TAG, "initialize(): dc=" + dc + " targetActivityType=" + targetActivityType);
        }
    ...
    public void onTransitionStart() {
        if (WindowManagerDebugConfig.DEBUG_RECENTS_ANIMATIONS) {
            String str = TAG;
            Slog.d(str, "onTransitionStart(): mCanceled=" + this.mCanceled);
        }
