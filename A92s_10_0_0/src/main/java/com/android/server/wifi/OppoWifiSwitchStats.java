...
public class OppoWifiSwitchStats {
    ...
    /* access modifiers changed from: private */
    public Queue<String> mWifiSwitchCallerPkgs;
    ...
    /* access modifiers changed from: private */
    public void tryToEnableAgain(int expectedState, int reason) {
    ...
    /* access modifiers changed from: private */
    public void readFWStateAgain(HashMap<String, String> data) {
        this.mIsInBootStage = isBootStage();
    ...
    /* access modifiers changed from: private */
    public boolean isStateMatch(int expectedState, int realState) {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(OppoWifiSwitchStats.ACTION_CLEAR_WIFI_SWITCH_LOG_COUNT)) {
                ...
                if (wifiState == 4) {
                    ...
                    boolean unused = OppoWifiSwitchStats.this.mFwNotReady = false;
                    int unused2 = OppoWifiSwitchStats.this.mRetryCount = 0;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    boolean unused = OppoWifiSwitchStats.this.mIsLogging = false;
                ...
                case 6:
                    ...
                    if (OppoWifiSwitchStats.this.mIsRetry) {
                        ...
                        boolean unused2 = OppoWifiSwitchStats.this.mIsRetry = false;
                ...
                case 7:
                    ...
                    return;
                case 8:
                    boolean unused3 = OppoWifiSwitchStats.this.tryToStartScanonlyAgain();
                    return;
                case 9:
                default:
                    if (OppoWifiSwitchStats.DEBUG) {
    ...
    /* access modifiers changed from: private */
    public void setStatistics(HashMap<String, String> data, String eventId) {
        if (DEBUG) {
    ...
    /* access modifiers changed from: private */
    public HashMap<String, String> collectSysInfo(int reason, String pkg) {
        String str;
        int i;
    ...
    /* access modifiers changed from: private */
    public void tryToCollectLog(int reason) {
        if (this.mIsLogging) {
