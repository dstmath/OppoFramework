    ...
    public class KnownBandsChannelCollection extends ChannelHelper.ChannelCollection {
        ...
        public void addBand(int band) {
            ...
            for (int i = 0; i < bandChannels.length; i++) {
                try {
                    this.mChannels.add(Integer.valueOf(bandChannels[i].frequency));
                } catch (ClassCastException e) {
                    Log.e("KnownBandsChannelHelper", "error log: " + e);
                    Log.e("KnownBandsChannelHelper", "band = " + band + " frequency = " + bandChannels[i].frequency);
                }
            }
        }
