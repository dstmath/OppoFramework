...
public class OppoHotspotClientInfo {
    ...
    public HashMap<String, WifiDevice> mConnectedDeviceMap = new HashMap<>();
    /* access modifiers changed from: private */
    public HashMap<String, HotspotClient> mHtsptClientMap = new HashMap<>();
    /* access modifiers changed from: private */
    public HashMap<String, WifiDevice> mL2ConnectedDeviceMap = new HashMap<>();
    ...
    /* access modifiers changed from: private */
    public void sendConnectDevicesStateChangedBroadcast() {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:?, code lost:
        r3.close();
     */
    public boolean readDeviceInfoFromDnsmasq(WifiDevice device) {
        boolean result = false;
