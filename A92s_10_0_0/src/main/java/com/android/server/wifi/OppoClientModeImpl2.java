...
public class OppoClientModeImpl2 extends StateMachine {
    ...
    public HashMap<String, Integer> mApTriggerDisableCount = new HashMap<>();
    ...
    /* access modifiers changed from: private */
    public HashMap<String, Long> mDisableConnectDuring = new HashMap<>();
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public OppoWifiNetworkFactory mNetworkFactory;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public OppoClientModeImplUtil2 mOppoClientModeImplUtil;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public OppoWifiAssistantStateTraker2 mWifiNetworkStateTraker2;
    ...
    static /* synthetic */ int access$12208(OppoClientModeImpl2 x0) {
        int i = x0.mRoamFailCount;
        x0.mRoamFailCount = i + 1;
        return i;
    }

    static /* synthetic */ int access$12608(OppoClientModeImpl2 x0) {
        int i = x0.mCheckInetAccessSeq;
        x0.mCheckInetAccessSeq = i + 1;
        return i;
    }

    static /* synthetic */ int access$8608(OppoClientModeImpl2 x0) {
    ...
    public OppoClientModeImpl2(Context context, FrameworkFacade facade, Looper looper, UserManager userManager, WifiInjector wifiInjector, BackupManagerProxy backupManagerProxy, WifiCountryCode countryCode, WifiNative wifiNative, WrongPasswordNotifier wrongPasswordNotifier, SarManager sarManager, WifiTrafficPoller wifiTrafficPoller, LinkProbeManager linkProbeManager) {
        ...
        this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(WIFI_AUTO_CHANGE_ACCESS_POINT), true, new ContentObserver(getHandler()) {
            ...
            public void onChange(boolean selfChange) {
                ...
                boolean unused = oppoClientModeImpl2.mAutoSwitch = z;
            ...
            public void onChange(boolean selfChange) {
                if (OppoClientModeImpl2.this.mContext.getPackageManager().hasSystemFeature("oppo.common_center.wlan.assistant")) {
                    ...
                    if (isWlanAssistant) {
                        if (OppoClientModeImpl2.this.mWifiNetworkStateTraker2 == null) {
                            OppoClientModeImpl2 oppoClientModeImpl2 = OppoClientModeImpl2.this;
                            OppoWifiAssistantStateTraker2 unused = oppoClientModeImpl2.mWifiNetworkStateTraker2 = oppoClientModeImpl2.makeWifiNetworkStateTracker();
                            ...
                            boolean unused2 = oppoClientModeImpl22.mAutoSwitch = z;
                            OppoClientModeImpl2.this.mWifiNetworkStateTraker2.setAutoSwitch(OppoClientModeImpl2.this.mAutoSwitch);
                        }
                        ...
                        OppoWifiAssistantStateTraker2 unused3 = OppoClientModeImpl2.this.mWifiNetworkStateTraker2 = null;
                    }
                }
            }
        });
    ...
    class IpClientCallbacksImpl extends IpClientCallbacks {
        ...
        public void onIpClientCreated(IIpClient ipClient) {
            OppoClientModeImpl2 oppoClientModeImpl2 = OppoClientModeImpl2.this;
            IpClientManager unused = oppoClientModeImpl2.mIpClient = new IpClientManager(ipClient, oppoClientModeImpl2.getName());
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 69632:
                    if (((AsyncChannel) message.obj) == OppoClientModeImpl2.this.mWifiP2pChannel) {
                        if (message.arg1 != 0) {
                            ...
                            boolean unused = OppoClientModeImpl2.this.p2pSendMessage(69633);
                            break;
                        }
                    } else {
                ...
                case 69636:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_BLUETOOTH_ADAPTER_STATE_CHANGE /*{ENCODED_INT: 131103}*/:
                    OppoClientModeImpl2 oppoClientModeImpl2 = OppoClientModeImpl2.this;
                    if (message.arg1 != 0) {
                        disableOthers = true;
                    }
                    boolean unused2 = oppoClientModeImpl2.mBluetoothConnectionActive = disableOthers;
                    break;
                case OppoClientModeImpl2.CMD_ENABLE_NETWORK /*{ENCODED_INT: 131126}*/:
                    if (message.arg2 == 1) {
                        disableOthers = true;
                    }
                    boolean ok = OppoClientModeImpl2.this.mWifiConfigManager.enableNetwork(message.arg1, disableOthers, message.sendingUid);
                    if (!ok) {
                        int unused3 = OppoClientModeImpl2.this.mMessageHandlingStatus = -2;
                    }
                    OppoClientModeImpl2 oppoClientModeImpl22 = OppoClientModeImpl2.this;
                    int i = message.what;
                    if (ok) {
                    ...
                    oppoClientModeImpl22.replyToMessage(message, i, removeResult);
                    break;
                case OppoClientModeImpl2.CMD_GET_CONFIGURED_NETWORKS /*{ENCODED_INT: 131131}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mWifiConfigManager.getSavedNetworks(message.arg2));
                    break;
                case OppoClientModeImpl2.CMD_GET_SUPPORTED_FEATURES /*{ENCODED_INT: 131133}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, Long.valueOf(OppoClientModeImpl2.this.mWifiNative.getSupportedFeatureSet(OppoClientModeImpl2.this.mInterfaceName)));
                    break;
                case OppoClientModeImpl2.CMD_GET_PRIVILEGED_CONFIGURED_NETWORKS /*{ENCODED_INT: 131134}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mWifiConfigManager.getConfiguredNetworksWithPasswords());
                    break;
                case OppoClientModeImpl2.CMD_GET_LINK_LAYER_STATS /*{ENCODED_INT: 131135}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, null);
                    break;
                case OppoClientModeImpl2.CMD_SET_OPERATIONAL_MODE /*{ENCODED_INT: 131144}*/:
                    break;
                case OppoClientModeImpl2.CMD_DISCONNECT /*{ENCODED_INT: 131145}*/:
                case OppoClientModeImpl2.CMD_RECONNECT /*{ENCODED_INT: 131146}*/:
                case OppoClientModeImpl2.CMD_REASSOCIATE /*{ENCODED_INT: 131147}*/:
                case OppoClientModeImpl2.CMD_RSSI_POLL /*{ENCODED_INT: 131155}*/:
                case OppoClientModeImpl2.CMD_ONESHOT_RSSI_POLL /*{ENCODED_INT: 131156}*/:
                case OppoClientModeImpl2.CMD_ROAM_WATCHDOG_TIMER /*{ENCODED_INT: 131166}*/:
                case OppoClientModeImpl2.CMD_DISCONNECTING_WATCHDOG_TIMER /*{ENCODED_INT: 131168}*/:
                case OppoClientModeImpl2.CMD_DISABLE_EPHEMERAL_NETWORK /*{ENCODED_INT: 131170}*/:
                case OppoClientModeImpl2.CMD_TARGET_BSSID /*{ENCODED_INT: 131213}*/:
                case OppoClientModeImpl2.CMD_START_CONNECT /*{ENCODED_INT: 131215}*/:
                case OppoClientModeImpl2.CMD_UNWANTED_NETWORK /*{ENCODED_INT: 131216}*/:
                case OppoClientModeImpl2.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                case OppoClientModeImpl2.CMD_ASSOCIATED_BSSID /*{ENCODED_INT: 131219}*/:
                case OppoClientModeImpl2.CMD_PRE_DHCP_ACTION /*{ENCODED_INT: 131327}*/:
                case OppoClientModeImpl2.CMD_PRE_DHCP_ACTION_COMPLETE /*{ENCODED_INT: 131328}*/:
                case OppoClientModeImpl2.CMD_POST_DHCP_ACTION /*{ENCODED_INT: 131329}*/:
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
                case WifiMonitor.SUP_REQUEST_IDENTITY /*{ENCODED_INT: 147471}*/:
                case WifiMonitor.SUP_REQUEST_SIM_AUTH /*{ENCODED_INT: 147472}*/:
                    int unused4 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_SET_HIGH_PERF_MODE /*{ENCODED_INT: 131149}*/:
                    if (message.arg1 != 1) {
                ...
                case OppoClientModeImpl2.CMD_ENABLE_RSSI_POLL /*{ENCODED_INT: 131154}*/:
                    OppoClientModeImpl2 oppoClientModeImpl23 = OppoClientModeImpl2.this;
                    if (message.arg1 == 1) {
                        disableOthers = true;
                    }
                    boolean unused5 = oppoClientModeImpl23.mEnableRssiPolling = disableOthers;
                    break;
                case OppoClientModeImpl2.CMD_SET_SUSPEND_OPT_ENABLED /*{ENCODED_INT: 131158}*/:
                    if (message.arg1 != 1) {
                ...
                case OppoClientModeImpl2.CMD_SCREEN_STATE_CHANGED /*{ENCODED_INT: 131167}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_REMOVE_APP_CONFIGURATIONS /*{ENCODED_INT: 131169}*/:
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                case OppoClientModeImpl2.CMD_RESET_SIM_NETWORKS /*{ENCODED_INT: 131173}*/:
                    int unused6 = OppoClientModeImpl2.this.mMessageHandlingStatus = OppoClientModeImpl2.MESSAGE_HANDLING_STATUS_DEFERRED;
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                case OppoClientModeImpl2.CMD_QUERY_OSU_ICON /*{ENCODED_INT: 131176}*/:
                case OppoClientModeImpl2.CMD_MATCH_PROVIDER_NETWORK /*{ENCODED_INT: 131177}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what);
                    break;
                case OppoClientModeImpl2.CMD_ADD_OR_UPDATE_PASSPOINT_CONFIG /*{ENCODED_INT: 131178}*/:
                    ...
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, removeResult);
                    break;
                case OppoClientModeImpl2.CMD_REMOVE_PASSPOINT_CONFIG /*{ENCODED_INT: 131179}*/:
                    if (OppoClientModeImpl2.this.mPasspointManager.removeProvider((String) message.obj)) {
                        removeResult = 1;
                    }
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, removeResult);
                    break;
                case OppoClientModeImpl2.CMD_GET_PASSPOINT_CONFIGS /*{ENCODED_INT: 131180}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.getProviderConfigs());
                    break;
                case OppoClientModeImpl2.CMD_GET_MATCHING_OSU_PROVIDERS /*{ENCODED_INT: 131181}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, new HashMap());
                    break;
                case OppoClientModeImpl2.CMD_GET_MATCHING_PASSPOINT_CONFIGS_FOR_OSU_PROVIDERS /*{ENCODED_INT: 131182}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, new HashMap());
                    break;
                case OppoClientModeImpl2.CMD_GET_WIFI_CONFIGS_FOR_PASSPOINT_PROFILES /*{ENCODED_INT: 131184}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, new ArrayList());
                    break;
                case OppoClientModeImpl2.CMD_BOOT_COMPLETED /*{ENCODED_INT: 131206}*/:
                    OppoClientModeImpl2.this.registerNetworkFactory();
                    break;
                case OppoClientModeImpl2.CMD_INITIALIZE /*{ENCODED_INT: 131207}*/:
                    ...
                    oppoClientModeImpl25.replyToMessage(message, i2, removeResult);
                    break;
                case OppoClientModeImpl2.CMD_IP_CONFIGURATION_SUCCESSFUL /*{ENCODED_INT: 131210}*/:
                case OppoClientModeImpl2.CMD_IP_CONFIGURATION_LOST /*{ENCODED_INT: 131211}*/:
                case OppoClientModeImpl2.CMD_IP_REACHABILITY_LOST /*{ENCODED_INT: 131221}*/:
                    int unused7 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_UPDATE_LINKPROPERTIES /*{ENCODED_INT: 131212}*/:
                    OppoClientModeImpl2.this.updateLinkProperties((LinkProperties) message.obj);
                    break;
                case OppoClientModeImpl2.CMD_REMOVE_USER_CONFIGURATIONS /*{ENCODED_INT: 131224}*/:
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                case OppoClientModeImpl2.CMD_START_IP_PACKET_OFFLOAD /*{ENCODED_INT: 131232}*/:
                case OppoClientModeImpl2.CMD_STOP_IP_PACKET_OFFLOAD /*{ENCODED_INT: 131233}*/:
                case OppoClientModeImpl2.CMD_ADD_KEEPALIVE_PACKET_FILTER_TO_APF /*{ENCODED_INT: 131281}*/:
                case OppoClientModeImpl2.CMD_REMOVE_KEEPALIVE_PACKET_FILTER_FROM_APF /*{ENCODED_INT: 131282}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_RSSI_MONITORING_OFFLOAD /*{ENCODED_INT: 131234}*/:
                    int unused8 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_STOP_RSSI_MONITORING_OFFLOAD /*{ENCODED_INT: 131235}*/:
                    int unused9 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_GET_ALL_MATCHING_FQDNS_FOR_SCAN_RESULTS /*{ENCODED_INT: 131240}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, new HashMap());
                    break;
                case OppoClientModeImpl2.CMD_INSTALL_PACKET_FILTER /*{ENCODED_INT: 131274}*/:
                    OppoClientModeImpl2.this.mWifiNative.installPacketFilter(OppoClientModeImpl2.this.mInterfaceName, (byte[]) message.obj);
                    break;
                case OppoClientModeImpl2.CMD_SET_FALLBACK_PACKET_FILTERING /*{ENCODED_INT: 131275}*/:
                ...
                case OppoClientModeImpl2.CMD_USER_SWITCH /*{ENCODED_INT: 131277}*/:
                ...
                case OppoClientModeImpl2.CMD_USER_UNLOCK /*{ENCODED_INT: 131278}*/:
                    OppoClientModeImpl2.this.mWifiConfigManager.handleUserUnlock(message.arg1);
                    break;
                case OppoClientModeImpl2.CMD_USER_STOP /*{ENCODED_INT: 131279}*/:
                    OppoClientModeImpl2.this.mWifiConfigManager.handleUserStop(message.arg1);
                    break;
                case OppoClientModeImpl2.CMD_READ_PACKET_FILTER /*{ENCODED_INT: 131280}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_DIAGS_CONNECT_TIMEOUT /*{ENCODED_INT: 131324}*/:
                    OppoClientModeImpl2.this.mWifiDiagnostics.reportConnectionEvent((byte) 3);
                    break;
                case OppoClientModeImpl2.CMD_START_SUBSCRIPTION_PROVISIONING /*{ENCODED_INT: 131326}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, 0);
                    break;
                case OppoClientModeImpl2.CMD_START_SCAN /*{ENCODED_INT: 131479}*/:
                ...
                case WifiP2pServiceImpl.DISCONNECT_WIFI_REQUEST /*{ENCODED_INT: 143372}*/:
                    ...
                    boolean unused10 = oppoClientModeImpl26.mTemporarilyDisconnectWifi = disableOthers;
                    OppoClientModeImpl2.this.replyToMessage(message, WifiP2pServiceImpl.DISCONNECT_WIFI_RESPONSE);
                    break;
                case 151569:
                    OppoClientModeImpl2.this.replyToMessage(message, 151570, 2);
                    break;
                case 151572:
                    OppoClientModeImpl2.this.replyToMessage(message, 151574, 2);
                    break;
                default:
    ...
    class ConnectModeState extends State {
        ...
        public void enter() {
            ...
            if (OppoClientModeImpl2.this.mInterfaceName == null) {
                String unused = OppoClientModeImpl2.this.mInterfaceName = OppoWifiAssistantUtils.IFACE_NAME_WLAN1;
                if (OppoClientModeImpl2.this.mWifiNetworkStateTraker2 != null) {
                    OppoClientModeImpl2.this.mWifiNetworkStateTraker2.setInterfaceName(OppoClientModeImpl2.this.mInterfaceName);
                }
            }
            int unused2 = OppoClientModeImpl2.this.mOperationalMode = 1;
            ...
            boolean unused3 = OppoClientModeImpl2.this.setNetworkDetailedState(NetworkInfo.DetailedState.DISCONNECTED);
        ...
        public void exit() {
            int unused = OppoClientModeImpl2.this.mOperationalMode = 4;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:245:0x08de, code lost:
            if (com.android.server.wifi.OppoClientModeImpl2.access$7900(r6, com.android.server.wifi.OppoClientModeImpl2.access$3100(r6), r5) != false) goto L_0x08e0;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:254:0x094a, code lost:
            if (com.android.server.wifi.OppoClientModeImpl2.access$7900(r8, com.android.server.wifi.OppoClientModeImpl2.access$3100(r8), r7) != false) goto L_0x094c;
         */
        public boolean processMessage(Message message) {
            int uid;
            ...
            switch (message.what) {
                case OppoClientModeImpl2.CMD_BLUETOOTH_ADAPTER_STATE_CHANGE /*{ENCODED_INT: 131103}*/:
                    boolean unused = OppoClientModeImpl2.this.mBluetoothConnectionActive = message.arg1 != 0;
                    ...
                    break;
                case OppoClientModeImpl2.CMD_REMOVE_NETWORK /*{ENCODED_INT: 131125}*/:
                ...
                case OppoClientModeImpl2.CMD_GET_LINK_LAYER_STATS /*{ENCODED_INT: 131135}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.getWifiLinkLayerStats());
                    break;
                case OppoClientModeImpl2.CMD_REASSOCIATE /*{ENCODED_INT: 131147}*/:
                    OppoClientModeImpl2 oppoClientModeImpl2 = OppoClientModeImpl2.this;
                    long unused2 = oppoClientModeImpl2.mLastConnectAttemptTimestamp = oppoClientModeImpl2.mClock.getWallClockMillis();
                ...
                case OppoClientModeImpl2.CMD_SET_SUSPEND_OPT_ENABLED /*{ENCODED_INT: 131158}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_ENABLE_TDLS /*{ENCODED_INT: 131164}*/:
                    if (message.obj != null) {
                ...
                case OppoClientModeImpl2.CMD_ADD_OR_UPDATE_PASSPOINT_CONFIG /*{ENCODED_INT: 131178}*/:
                    ...
                    if (!OppoClientModeImpl2.this.mPasspointManager.addOrUpdateProvider(passpointConfig, bundle.getInt(OppoClientModeImpl2.EXTRA_UID), bundle.getString(OppoClientModeImpl2.EXTRA_PACKAGE_NAME))) {
                        OppoClientModeImpl2.this.replyToMessage(message, message.what, -1);
                        break;
                    } else {
                ...
                case OppoClientModeImpl2.CMD_GET_MATCHING_OSU_PROVIDERS /*{ENCODED_INT: 131181}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.getMatchingOsuProviders((List) message.obj));
                    break;
                case OppoClientModeImpl2.CMD_GET_MATCHING_PASSPOINT_CONFIGS_FOR_OSU_PROVIDERS /*{ENCODED_INT: 131182}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.getMatchingPasspointConfigsForOsuProviders((List) message.obj));
                    break;
                case OppoClientModeImpl2.CMD_GET_WIFI_CONFIGS_FOR_PASSPOINT_PROFILES /*{ENCODED_INT: 131184}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.getWifiConfigsForPasspointProfiles((List) message.obj));
                    break;
                case OppoClientModeImpl2.CMD_TARGET_BSSID /*{ENCODED_INT: 131213}*/:
                    if (message.obj != null) {
                        String unused3 = OppoClientModeImpl2.this.mTargetRoamBSSID = (String) message.obj;
                        break;
                    }
                    break;
                case OppoClientModeImpl2.CMD_START_CONNECT /*{ENCODED_INT: 131215}*/:
                    ...
                    if (config2 != null) {
                        ...
                        OppoClientModeImpl2.this.convertToQuotedSSID(config2);
                        int unused4 = OppoClientModeImpl2.this.mTargetNetworkId = netId2;
                        ...
                        if (tmpBssid != null) {
                            ...
                            if (bssidTmpReset.booleanValue()) {
                                boolean unused5 = OppoClientModeImpl2.this.setTargetBssid(config2, tmpBssid);
                            } else {
                                boolean unused6 = OppoClientModeImpl2.this.setTargetBssid(config2, bssid);
                            }
                            OppoClientModeImpl2 oppoClientModeImpl26 = OppoClientModeImpl2.this;
                            ...
                            if (!OppoClientModeImpl2.this.mWifiNative.connectToNetwork(OppoClientModeImpl2.this.mInterfaceName, config2)) {
                                ...
                                OppoClientModeImpl2.this.replyToMessage(message, 151554, 0);
                                break;
                            } else {
                                ...
                                long unused7 = oppoClientModeImpl27.mLastConnectAttemptTimestamp = oppoClientModeImpl27.mClock.getWallClockMillis();
                                WifiConfiguration unused8 = OppoClientModeImpl2.this.mTargetWifiConfiguration = config2;
                                boolean unused9 = OppoClientModeImpl2.this.mIsAutoRoaming = false;
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    int unused10 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_ASSOCIATED_BSSID /*{ENCODED_INT: 131219}*/:
                ...
                case OppoClientModeImpl2.CMD_STOP_IP_PACKET_OFFLOAD /*{ENCODED_INT: 131233}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_GET_ALL_MATCHING_FQDNS_FOR_SCAN_RESULTS /*{ENCODED_INT: 131240}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.getAllMatchingFqdnsForScanResults((List) message.obj));
                    break;
                case OppoClientModeImpl2.CMD_CONFIG_ND_OFFLOAD /*{ENCODED_INT: 131276}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_SUBSCRIPTION_PROVISIONING /*{ENCODED_INT: 131326}*/:
                    OppoClientModeImpl2.this.replyToMessage(message, message.what, OppoClientModeImpl2.this.mPasspointManager.startSubscriptionProvisioning(message.arg1, message.getData().getParcelable(OppoClientModeImpl2.EXTRA_OSU_PROVIDER), (IProvisioningCallback) message.obj) ? 1 : 0);
                    break;
                case OppoClientModeImpl2.CMD_TRIGGER_RESTORE_DELAY /*{ENCODED_INT: 131477}*/:
                ...
                case WifiP2pServiceImpl.DISCONNECT_WIFI_REQUEST /*{ENCODED_INT: 143372}*/:
                    if (message.arg1 != 1) {
                        ...
                        boolean unused11 = OppoClientModeImpl2.this.mTemporarilyDisconnectWifi = false;
                        break;
                    } else {
                        ...
                        boolean unused12 = OppoClientModeImpl2.this.mTemporarilyDisconnectWifi = true;
                        break;
                    }
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    if (OppoClientModeImpl2.this.mVerboseLoggingEnabled) {
                    ...
                    int unused13 = OppoClientModeImpl2.this.mLastNetworkId = message.arg1;
                    OppoClientModeImpl2.this.mWifiConfigManager.clearRecentFailureReason(OppoClientModeImpl2.this.mLastNetworkId);
                    String unused14 = OppoClientModeImpl2.this.mLastBssid = (String) message.obj;
                    int i2 = message.arg2;
                    if (OppoClientModeImpl2.this.mWifiNetworkStateTraker2 != null) {
                    ...
                    if (config3 == null) {
                        ...
                        long unused15 = OppoClientModeImpl2.this.mConnectionTimeStamp = System.currentTimeMillis();
                ...
                case WifiMonitor.SUP_REQUEST_IDENTITY /*{ENCODED_INT: 147471}*/:
                    ...
                    if (!identitySent) {
                        ...
                        String quotedSsid = OppoClientModeImpl2.this.convertToQuotedSSID(ssid);
                ...
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /*{ENCODED_INT: 147499}*/:
                    ...
                    boolean unused16 = OppoClientModeImpl2.this.mDidBlackListBSSID = false;
    ...
    public class WifiNetworkAgent extends NetworkAgent {
        ...
        public void networkStatus(int status, String redirectUrl) {
            if (this == OppoClientModeImpl2.this.mNetworkAgent && status != this.mLastNetworkStatus && TextUtils.isEmpty(redirectUrl)) {
                ...
                if (status == 2) {
                    ...
                    boolean unused = OppoClientModeImpl2.this.mNetworkDetectValid = false;
                    ...
                    boolean unused2 = OppoClientModeImpl2.this.mNetworkDetectValid = true;
        ...
        public void setSignalStrengthThresholds(int[] thresholds) {
            ...
            byte[] unused = OppoClientModeImpl2.this.mRssiRanges = rssiRange;
            OppoClientModeImpl2 oppoClientModeImpl23 = OppoClientModeImpl2.this;
    ...
    class L2ConnectedState extends State {
        ...
        public void enter() {
            OppoClientModeImpl2.this.mOppoClientModeImplUtil.resetSaeNetworkConsecutiveAssocRejectCounter();
            OppoClientModeImpl2.access$8608(OppoClientModeImpl2.this);
            ...
            if (OppoClientModeImpl2.this.mNetworkAgent != null) {
                ...
                boolean unused = OppoClientModeImpl2.this.setNetworkDetailedState(NetworkInfo.DetailedState.DISCONNECTED);
            }
            boolean unused2 = OppoClientModeImpl2.this.setNetworkDetailedState(NetworkInfo.DetailedState.CONNECTING);
            OppoClientModeImpl2 oppoClientModeImpl22 = OppoClientModeImpl2.this;
            ...
            synchronized (OppoClientModeImpl2.this.mNetworkAgentLock) {
                WifiNetworkAgent unused3 = OppoClientModeImpl2.this.mNetworkAgent = new WifiNetworkAgent(OppoClientModeImpl2.this.getHandler().getLooper(), OppoClientModeImpl2.this.mContext, "WifiNetworkAgent", OppoClientModeImpl2.this.mNetworkInfo, nc, OppoClientModeImpl2.this.mLinkProperties, 5, OppoClientModeImpl2.this.mNetworkMisc);
            }
            if (OppoClientModeImpl2.this.mNetworkAgent != null) {
        ...
        public void exit() {
            ...
            boolean unused = OppoClientModeImpl2.this.mIsAutoRoaming = false;
        }

        /* JADX INFO: Multiple debug info for r1v109 int: [D('currRssi' byte), D('slot' int)] */
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case OppoClientModeImpl2.CMD_ENABLE_RSSI_POLL /*{ENCODED_INT: 131154}*/:
                    ...
                    boolean unused = OppoClientModeImpl2.this.mEnableRssiPolling = message.arg1 == 1;
                    OppoClientModeImpl2.access$8608(OppoClientModeImpl2.this);
                    if (OppoClientModeImpl2.this.mEnableRssiPolling) {
                        int unused2 = OppoClientModeImpl2.this.mLastSignalLevel = -1;
                ...
                case OppoClientModeImpl2.CMD_RESET_SIM_NETWORKS /*{ENCODED_INT: 131173}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_IP_CONFIGURATION_SUCCESSFUL /*{ENCODED_INT: 131210}*/:
                    boolean unused3 = OppoClientModeImpl2.this.mIsAutoRoaming = false;
                ...
                case OppoClientModeImpl2.CMD_ASSOCIATED_BSSID /*{ENCODED_INT: 131219}*/:
                    if (((String) message.obj) != null) {
                        String unused4 = OppoClientModeImpl2.this.mLastBssid = (String) message.obj;
                        if (OppoClientModeImpl2.this.mLastBssid != null && (OppoClientModeImpl2.this.mWifiInfo.getBSSID() == null || !OppoClientModeImpl2.this.mLastBssid.equals(OppoClientModeImpl2.this.mWifiInfo.getBSSID()))) {
                            if (OppoClientModeImpl2.this.getCurrentState() == OppoClientModeImpl2.this.mConnectedState) {
                                boolean unused5 = OppoClientModeImpl2.this.mIsAutoRoaming = true;
                            }
                            OppoClientModeImpl2.this.mWifiInfo.setBSSID(OppoClientModeImpl2.this.mLastBssid);
                ...
                case OppoClientModeImpl2.CMD_NETWORK_STATUS /*{ENCODED_INT: 131220}*/:
                ...
                case OppoClientModeImpl2.CMD_START_IP_PACKET_OFFLOAD /*{ENCODED_INT: 131232}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_RSSI_MONITORING_OFFLOAD /*{ENCODED_INT: 131234}*/:
                case OppoClientModeImpl2.CMD_RSSI_THRESHOLD_BREACHED /*{ENCODED_INT: 131236}*/:
                    OppoClientModeImpl2.this.processRssiThreshold((byte) message.arg1, message.what, this.mRssiEventHandler);
                    break;
                case OppoClientModeImpl2.CMD_STOP_RSSI_MONITORING_OFFLOAD /*{ENCODED_INT: 131235}*/:
                    int unused6 = OppoClientModeImpl2.this.stopRssiMonitoringOffload();
                    break;
                case OppoClientModeImpl2.CMD_IPV4_PROVISIONING_SUCCESS /*{ENCODED_INT: 131272}*/:
                    if (OppoClientModeImpl2.this.mOppoDhcpRecord.isDoingSwitch()) {
                    ...
                    break;
                case OppoClientModeImpl2.CMD_IPV4_PROVISIONING_FAILURE /*{ENCODED_INT: 131273}*/:
                    if (OppoClientModeImpl2.this.mOppoDhcpRecord.isDoingSwitch()) {
                        OppoClientModeImpl2.this.mOppoDhcpRecord.setSwitchState(OppoDhcpRecord.SwitchState.DONE);
                    }
                ...
                case WifiP2pServiceImpl.DISCONNECT_WIFI_REQUEST /*{ENCODED_INT: 143372}*/:
                    if (message.arg1 == 1) {
                        OppoClientModeImpl2.this.mWifiMetrics.logStaEvent(15, 5);
                        OppoClientModeImpl2.this.mWifiNative.disconnect(OppoClientModeImpl2.this.mInterfaceName);
                        boolean unused7 = OppoClientModeImpl2.this.mTemporarilyDisconnectWifi = true;
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    ...
                    if (message.arg1 != -1) {
                        int unused8 = OppoClientModeImpl2.this.mLastNetworkId = message.arg1;
                    }
                    int unused9 = OppoClientModeImpl2.this.mLastNetworkId = message.arg1;
                    OppoClientModeImpl2.this.mWifiInfo.setNetworkId(OppoClientModeImpl2.this.mLastNetworkId);
                    OppoClientModeImpl2.this.mWifiInfo.setMacAddress(OppoClientModeImpl2.this.mWifiNative.getMacAddress(OppoClientModeImpl2.this.mInterfaceName));
                    if (OppoClientModeImpl2.this.mLastBssid != null && !OppoClientModeImpl2.this.mLastBssid.equals((String) message.obj) && OppoClientModeImpl2.this.getCurrentState() == OppoClientModeImpl2.this.mConnectedState) {
                        boolean unused10 = OppoClientModeImpl2.this.mIsAutoRoaming = true;
                    }
                    if (OppoClientModeImpl2.this.mWifiNetworkStateTraker2 != null) {
                        OppoClientModeImpl2.this.mWifiNetworkStateTraker2.sendMessage(WifiMonitor.NETWORK_CONNECTION_EVENT, OppoClientModeImpl2.this.mLastNetworkId, message.arg2, OppoClientModeImpl2.this.mLastBssid);
                        break;
                ...
                case 151572:
                    ...
                    if (counters == null) {
                        OppoClientModeImpl2.this.replyToMessage(message, 151574, 0);
                        break;
                    } else {
                        info.txgood = counters.txSucceeded;
                        info.txbad = counters.txFailed;
                        OppoClientModeImpl2.this.replyToMessage(message, 151573, info);
                        break;
                    }
                default:
                    handleStatus = false;
    ...
    class ObtainingIpState extends State {
        ...
        public void enter() {
            ...
            boolean unused = OppoClientModeImpl2.this.setNetworkDetailedState(NetworkInfo.DetailedState.OBTAINING_IPADDR);
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case OppoClientModeImpl2.CMD_SET_HIGH_PERF_MODE /*{ENCODED_INT: 131149}*/:
                    int unused = OppoClientModeImpl2.this.mMessageHandlingStatus = OppoClientModeImpl2.MESSAGE_HANDLING_STATUS_DEFERRED;
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                case OppoClientModeImpl2.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    int unused2 = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                    break;
                case OppoClientModeImpl2.CMD_START_SCAN /*{ENCODED_INT: 131479}*/:
                    if (OppoClientModeImpl2.this.mVerboseLoggingEnabled) {
                        OppoClientModeImpl2.this.logd("[1716726] Defer scan reques in mObtainingIpState");
                    }
                    int unused3 = OppoClientModeImpl2.this.mMessageHandlingStatus = OppoClientModeImpl2.MESSAGE_HANDLING_STATUS_DEFERRED;
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
                    OppoClientModeImpl2.this.reportConnectionAttemptEnd(6, 1, 0);
                    ...
                    break;
                case 151559:
                    int unused4 = OppoClientModeImpl2.this.mMessageHandlingStatus = OppoClientModeImpl2.MESSAGE_HANDLING_STATUS_DEFERRED;
                    OppoClientModeImpl2.this.deferMessage(message);
                    break;
                default:
                    handleStatus = false;
    ...
    class CaptiveState extends State {
        ...
        public void enter() {
            ...
            OppoClientModeImpl2 oppoClientModeImpl22 = OppoClientModeImpl2.this;
            int unused = oppoClientModeImpl22.mConnectedId = oppoClientModeImpl22.mLastNetworkId;
            if (OppoClientModeImpl2.this.mWifiNetworkStateTraker2 != null) {
            ...
            boolean unused2 = OppoClientModeImpl2.this.setNetworkDetailedState(NetworkInfo.DetailedState.CAPTIVE_PORTAL_CHECK);
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case OppoClientModeImpl2.CMD_SET_OPERATIONAL_MODE /*{ENCODED_INT: 131144}*/:
                    if (message.arg1 != 1) {
                        int unused = OppoClientModeImpl2.this.mOperationalMode = message.arg1;
                    }
                    return false;
                case OppoClientModeImpl2.CMD_START_CONNECT /*{ENCODED_INT: 131215}*/:
                ...
                case OppoClientModeImpl2.CMD_UNWANTED_NETWORK /*{ENCODED_INT: 131216}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    long unused2 = OppoClientModeImpl2.this.mLastDriverRoamAttempt = 0;
                    int netId = message.arg1;
                    ...
                    if (config != null) {
                        boolean unused3 = OppoClientModeImpl2.this.setTargetBssid(config, bssid);
                        int unused4 = OppoClientModeImpl2.this.mTargetNetworkId = netId;
                        OppoClientModeImpl2 oppoClientModeImpl24 = OppoClientModeImpl2.this;
                        ...
                        if (!OppoClientModeImpl2.this.mWifiNative.roamToNetwork(OppoClientModeImpl2.this.mInterfaceName, config)) {
                            ...
                            OppoClientModeImpl2.this.reportConnectionAttemptEnd(5, 1, 0);
                            OppoClientModeImpl2.this.replyToMessage(message, 151554, 0);
                            int unused5 = OppoClientModeImpl2.this.mMessageHandlingStatus = -2;
                            break;
                        } else {
                            OppoClientModeImpl2 oppoClientModeImpl27 = OppoClientModeImpl2.this;
                            long unused6 = oppoClientModeImpl27.mLastConnectAttemptTimestamp = oppoClientModeImpl27.mClock.getWallClockMillis();
                            WifiConfiguration unused7 = OppoClientModeImpl2.this.mTargetWifiConfiguration = config;
                            boolean unused8 = OppoClientModeImpl2.this.mIsAutoRoaming = true;
                ...
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
                    ...
                    if (OppoClientModeImpl2.this.mLastDriverRoamAttempt != 0) {
                        ...
                        long unused9 = OppoClientModeImpl2.this.mLastDriverRoamAttempt = 0;
                    }
            ...
            switch (message.what) {
                case OppoClientModeImpl2.CMD_ROAM_WATCHDOG_TIMER /*{ENCODED_INT: 131166}*/:
                    if (OppoClientModeImpl2.this.mRoamWatchdogCount == message.arg1) {
                        ...
                        OppoClientModeImpl2.access$12208(OppoClientModeImpl2.this);
                        OppoClientModeImpl2.this.handleNetworkDisconnect();
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    if (!this.mAssociated) {
                        int unused = OppoClientModeImpl2.this.mMessageHandlingStatus = -5;
                        break;
                    } else {
                        if (OppoClientModeImpl2.this.mVerboseLoggingEnabled) {
                        ...
                        int unused2 = OppoClientModeImpl2.this.mLastNetworkId = message.arg1;
                        String unused3 = OppoClientModeImpl2.this.mLastBssid = (String) message.obj;
                        OppoClientModeImpl2.this.mWifiInfo.setBSSID(OppoClientModeImpl2.this.mLastBssid);
                        OppoClientModeImpl2.this.mWifiInfo.setNetworkId(OppoClientModeImpl2.this.mLastNetworkId);
                        int i = message.arg2;
                        OppoClientModeImpl2 oppoClientModeImpl22 = OppoClientModeImpl2.this;
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /*{ENCODED_INT: 147462}*/:
                    ...
                    if (OppoClientModeImpl2.this.mLastSupplicantState != stateChangeResult.state) {
                        SupplicantState unused4 = OppoClientModeImpl2.this.mLastSupplicantState = stateChangeResult.state;
                    }
                    if (stateChangeResult.state == SupplicantState.ASSOCIATED || stateChangeResult.state == SupplicantState.FOUR_WAY_HANDSHAKE || stateChangeResult.state == SupplicantState.GROUP_HANDSHAKE || stateChangeResult.state == SupplicantState.COMPLETED) {
                        ...
                        if (stateChangeResult.BSSID != null) {
                            String unused5 = OppoClientModeImpl2.this.mTargetRoamBSSID = stateChangeResult.BSSID;
                            break;
                        }
                    }
                    break;
    ...
    class ConnectedState extends State {
        ...
        public void enter() {
            ...
            long unused = OppoClientModeImpl2.this.mLastConnectAttemptTimestamp = 0;
            WifiConfiguration unused2 = OppoClientModeImpl2.this.mTargetWifiConfiguration = null;
            OppoClientModeImpl2.this.mWifiScoreReport.reset();
            int unused3 = OppoClientModeImpl2.this.mLastSignalLevel = -1;
            ...
            OppoClientModeImpl2.access$12608(OppoClientModeImpl2.this);
            if (OppoClientModeImpl2.this.mIsAutoRoaming) {
                OppoClientModeImpl2 oppoClientModeImpl22 = OppoClientModeImpl2.this;
            ...
            boolean unused4 = OppoClientModeImpl2.this.mIsAutoRoaming = false;
            long unused5 = OppoClientModeImpl2.this.mLastDriverRoamAttempt = 0;
            int unused6 = OppoClientModeImpl2.this.mTargetNetworkId = -1;
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case OppoClientModeImpl2.CMD_UNWANTED_NETWORK /*{ENCODED_INT: 131216}*/:
                    ...
                    break;
                case OppoClientModeImpl2.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    long unused = OppoClientModeImpl2.this.mLastDriverRoamAttempt = 0;
                    int netId = message.arg1;
                    ScanResult candidate = (ScanResult) message.obj;
                    String bssid = "any";
                    if (candidate != null) {
                    ...
                    if (config2 == null) {
                        ...
                        boolean unused2 = OppoClientModeImpl2.this.setTargetBssid(config2, bssid);
                        int unused3 = OppoClientModeImpl2.this.mTargetNetworkId = netId;
                        ...
                        if (OppoClientModeImpl2.this.mWifiNative.roamToNetwork(OppoClientModeImpl2.this.mInterfaceName, config2)) {
                            OppoClientModeImpl2 oppoClientModeImpl24 = OppoClientModeImpl2.this;
                            long unused4 = oppoClientModeImpl24.mLastConnectAttemptTimestamp = oppoClientModeImpl24.mClock.getWallClockMillis();
                            WifiConfiguration unused5 = OppoClientModeImpl2.this.mTargetWifiConfiguration = config2;
                            boolean unused6 = OppoClientModeImpl2.this.mIsAutoRoaming = true;
                            ...
                            OppoClientModeImpl2.this.reportConnectionAttemptEnd(5, 1, 0);
                            OppoClientModeImpl2.this.replyToMessage(message, 151554, 0);
                            int unused7 = OppoClientModeImpl2.this.mMessageHandlingStatus = -2;
                        }
                    }
                    z = true;
                    break;
                case OppoClientModeImpl2.CMD_ASSOCIATED_BSSID /*{ENCODED_INT: 131219}*/:
                    OppoClientModeImpl2 oppoClientModeImpl26 = OppoClientModeImpl2.this;
                    long unused8 = oppoClientModeImpl26.mLastDriverRoamAttempt = oppoClientModeImpl26.mClock.getWallClockMillis();
                    handleStatus = false;
                    z = true;
                    break;
                case OppoClientModeImpl2.CMD_NETWORK_STATUS /*{ENCODED_INT: 131220}*/:
                    ...
                    z = true;
                    break;
                case OppoClientModeImpl2.CMD_ACCEPT_UNVALIDATED /*{ENCODED_INT: 131225}*/:
                    if (message.arg1 != 0) {
                        accept = true;
                    }
                    ...
                    z = true;
                    break;
                case OppoClientModeImpl2.CMD_CHECK_INTERNET_ACCESS /*{ENCODED_INT: 131480}*/:
    ...
    class DisconnectedState extends State {
        ...
        public void enter() {
            ...
            if (OppoClientModeImpl2.this.mTemporarilyDisconnectWifi) {
                boolean unused = OppoClientModeImpl2.this.p2pSendMessage(WifiP2pServiceImpl.DISCONNECT_WIFI_RESPONSE);
                return;
            }
            if (OppoClientModeImpl2.this.mVerboseLoggingEnabled) {
                OppoClientModeImpl2 oppoClientModeImpl2 = OppoClientModeImpl2.this;
            ...
            boolean unused2 = OppoClientModeImpl2.this.mIsAutoRoaming = false;
        }
            ...
            switch (message.what) {
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /*{ENCODED_INT: 147462}*/:
                    ...
                    if (stateChangeResult != null && stateChangeResult.state != null) {
                        ...
                        boolean unused = OppoClientModeImpl2.this.setNetworkDetailedState(WifiInfo.getDetailedStateOf(stateChangeResult.state));
                        handleStatus = false;
                        break;
                    } else {
                        return true;
    ...
    /* access modifiers changed from: private */
    public String getBestBssidForNetId(int netId) {
        String srConfigKey;
    ...
    /* access modifiers changed from: private */
    public OppoWifiAssistantStateTraker2 makeWifiNetworkStateTracker() {
