...
public class WifiAwareStateManager implements WifiAwareShellCommand.DelegatedShellCommand {
    ...
    class WifiAwareStateMachine extends StateMachine {
        ...
        /* JADX INFO: Multiple debug info for r2v6 int: [D('pubSubId' int), D('reason' int)] */
    ...
    public void onConfigCompletedLocal(Message completedCommand) {
        ...
        if (completedCommand.arg1 == 100) {
            ...
            WifiAwareClientState client = new WifiAwareClientState(this.mContext, clientId, uid, pid, data.getString(MESSAGE_BUNDLE_KEY_CALLING_PACKAGE), callback, data.getParcelable(MESSAGE_BUNDLE_KEY_CONFIG), notifyIdentityChange, SystemClock.elapsedRealtime(), this.mWifiPermissionsUtil);
            client.mDbg = this.mDbg;
