...
public class OppoSlaManager {
    ...
    /* access modifiers changed from: private */
    public static FileDescriptor mNlfd;
    ...
    /* access modifiers changed from: private */
    public static OppoSlaCallback sSlaCallback = null;
    ...
    /* access modifiers changed from: private */
    public boolean mCellEnabled;
    private boolean mCellQualityGood;
    private int mCellRtt0_100;
    private int mCellRtt100_200;
    private int mCellRtt200plus;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mCellRttRecord;
    /* access modifiers changed from: private */
    public int mCellScore;
    /* access modifiers changed from: private */
    public int mCellServiceState = -1;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mCellSpeedRecord;
    private int mCellSumRtt;
    private int mCellSumSpeed;
    /* access modifiers changed from: private */
    public Context mContext;
    /* access modifiers changed from: private */
    public boolean mDestoryScoket;
    /* access modifiers changed from: private */
    public int mDualStaActiveType;
    DualStaBuriedPoint mDualStaBuriedPoint;
    /* access modifiers changed from: private */
    public boolean mDualStaEnabled;
    private boolean mGameInFront;
    /* access modifiers changed from: private */
    public boolean mGameNetworkSwitched;
    /* access modifiers changed from: private */
    public Handler mHandler;
    /* access modifiers changed from: private */
    public int mKernelWorkMode;
    ...
    private String mMCC;
    /* access modifiers changed from: private */
    public boolean mMainWifiGood;
    private Thread mNetlinkThread = null;
    private PackageManagerService mPMS;
    /* access modifiers changed from: private */
    public HashMap<String, Integer> mPackagesAndUids;
    /* access modifiers changed from: private */
    public PhoneStateListener mPhoneStateListener;
    /* access modifiers changed from: private */
    public int mRecordIndex;
    /* access modifiers changed from: private */
    public Object mRttSpeedLock;
    /* access modifiers changed from: private */
    public boolean mScreenOn;
    private boolean mShowDialog;
    /* access modifiers changed from: private */
    public boolean mSlaEnabled;
    /* access modifiers changed from: private */
    public boolean mSlaEnabling;
    /* access modifiers changed from: private */
    public ArrayList<SlaGameStats> mSlaGameStats;
    private final INetd mSlaNetd;
    private HashMap<String, Integer> mSlaPackagesAndUids;
    /* access modifiers changed from: private */
    public boolean mSmartBWParamsSet;
    ...
    public int mUserId;
    /* access modifiers changed from: private */
    public boolean mUsingLTE;
    /* access modifiers changed from: private */
    public boolean mVpnConnected;
    /* access modifiers changed from: private */
    public boolean mWifi2Connected;
    ...
    /* access modifiers changed from: private */
    public WifiRomUpdateHelper mWifiRomUpdateHelper;
    private int mWifiRtt0_100;
    private int mWifiRtt100_200;
    private int mWifiRtt200plus;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mWifiRttRecord;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mWifiRttRecord2;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mWifiSpeedRecord;
    /* access modifiers changed from: private */
    public ArrayList<Integer> mWifiSpeedRecord2;
    private int mWifiSumRtt;
    private int mWifiSumSpeed;
    /* access modifiers changed from: private */
    public long mWlan0RxPkts;
    /* access modifiers changed from: private */
    public long mWlan0TxPkts;
    /* access modifiers changed from: private */
    public long mWlan1RxPkts;
    /* access modifiers changed from: private */
    public long mWlan1TxPkts;
        ...
        this.mPhoneStateListener = new PhoneStateListener() {
            ...
            public void onSignalStrengthsChanged(SignalStrength signalStrength) {
                ...
                if (OppoSlaManager.this.mUsingLTE) {
                    ...
                    if ((OppoSlaManager.this.mLteRsrp > OppoSlaManager.LTE_GOOD_RSSI && newRsrp < OppoSlaManager.LTE_BAD_RSSI) || (OppoSlaManager.this.mLteRsrp < OppoSlaManager.LTE_BAD_RSSI && newRsrp > OppoSlaManager.LTE_GOOD_RSSI)) {
                        int unused = OppoSlaManager.this.mLteRsrp = newRsrp;
            ...
            public void onServiceStateChanged(ServiceState state) {
                ...
                if (OppoSlaManager.this.mUsingLTE != usingLTE) {
                    boolean unused = OppoSlaManager.this.mUsingLTE = usingLTE;
                    OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(12);
                }
                if (OppoSlaManager.this.mCellServiceState != state.getState()) {
                    ...
                    int unused2 = OppoSlaManager.this.mCellServiceState = state.getState();
                }
                if (OppoSlaManager.mDebug) {
            ...
            switch (msg.what) {
                ...
                case 16:
                    ...
                    if (msg.arg1 == 1 || msg.arg1 == 0) {
                        ...
                        boolean unused = OppoSlaManager.this.sendToKernel(20, 1);
                        boolean unused2 = OppoSlaManager.this.mDualStaEnabled = false;
                    }
                    if (msg.arg1 == 2 || msg.arg1 == 0) {
                        OppoSlaManager.this.setOppoSlaDisable(2);
                        boolean unused3 = OppoSlaManager.this.sendToKernel(20, 2);
                        boolean unused4 = OppoSlaManager.this.mSlaEnabled = false;
                        return;
                    }
                    return;
                case 17:
                    ...
                    if (OppoSlaManager.this.mCellConnected) {
                        ...
                        boolean unused5 = oppoSlaManager2.mUsingLTE = start;
                ...
                case 20:
                    ...
                    boolean unused6 = OppoSlaManager.this.mSlaEnabling = false;
                    return;
                case 21:
                ...
                case 24:
                    ...
                    if (!OppoSlaManager.this.mSmartBWParamsSet) {
                        ...
                        boolean unused7 = oppoSlaManager3.mSmartBWParamsSet = oppoSlaManager3.sendToKernel(OppoSlaManager.OPPO_SMART_BW_SET_PARAMS, oppoSlaManager3.mWifiRomUpdateHelper.getSmartBWParams());
        ...
        this.mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals(OppoSlaManager.ACTION_NETWORK_CONTROL)) {
                    ...
                    boolean unused = OppoSlaManager.this.mScreenOn = true;
                    OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(11);
                } else if (action.equals("android.intent.action.SCREEN_OFF")) {
                    boolean unused2 = OppoSlaManager.this.mScreenOn = false;
                    OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(11);
                    ...
                    if (OppoSlaManager.this.mCellConnected != cellConnected) {
                        boolean unused3 = OppoSlaManager.this.mCellConnected = cellConnected;
                        OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(17);
                    }
                    int unused4 = OppoSlaManager.this.mCellScore = 50;
                    OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(12);
                } else if (action.equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                    NetworkInfo info = (NetworkInfo) intent.getParcelableExtra("networkInfo");
                    if (info != null && info.getType() == 17 && OppoSlaManager.this.mVpnConnected != (connected = info.isConnected())) {
                        boolean unused5 = OppoSlaManager.this.mVpnConnected = connected;
                        OppoSlaManager.this.mAsyncHandler.post(new Runnable() {
                    ...
                    int unused6 = OppoSlaManager.this.mUserId = intent.getIntExtra("android.intent.extra.user_handle", 0);
            ...
            public /* synthetic */ void lambda$onReceive$2$OppoSlaManager$4() {
                ...
                OppoSlaManager oppoSlaManager = OppoSlaManager.this;
                boolean unused = oppoSlaManager.sendToKernel(OppoSlaManager.OPPO_SLA_NOTIFY_VPN_CONNECTED, oppoSlaManager.mVpnConnected ? 1 : 0);
            }

            public /* synthetic */ void lambda$onReceive$3$OppoSlaManager$4() {
                boolean unused = OppoSlaManager.this.sendToKernel(OppoSlaManager.OPPO_SLA_SET_DEBUG, 1);
            }
        };
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.wifi.OppoSlaManager.sendToKernel(short, int):boolean
     arg types: [int, int]
     candidates:
      com.android.server.wifi.OppoSlaManager.sendToKernel(short, byte[]):boolean
      com.android.server.wifi.OppoSlaManager.sendToKernel(short, int[]):boolean
      com.android.server.wifi.OppoSlaManager.sendToKernel(short, int):boolean */
    /* access modifiers changed from: private */
    public void setOppoSlaEnable(int mode) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      com.android.server.wifi.OppoSlaManager.sendToKernel(short, int):boolean */
    /* access modifiers changed from: private */
    public void setOppoSlaDisable(int mode) {
        boolean result = false;
        if (2 == mode) {
            if (this.mSlaEnabled) {
    ...
    private boolean isNetAndSimSupported() {
        ...
        int length = slaEnabledMCC.length;
        int i = 0;
        while (i < length) {
            String mccFromXml = slaEnabledMCC[i];
    ...
    /* access modifiers changed from: private */
    public void setKingCardResult(int result) {
    ...
    private class SlaSwitchObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            if (OppoSlaManager.this.getSlaEnableState()) {
                ...
                OppoSlaManager oppoSlaManager = OppoSlaManager.this;
                boolean unused = oppoSlaManager.mUsingLTE = oppoSlaManager.mTelephonyManager.getNetworkType() == 13;
                OppoSlaManager.this.mTelephonyManager.listen(OppoSlaManager.this.mPhoneStateListener, OppoDataStallHelper.DATA_STALL_QCOM_HOST_SOFTAP_TX_TIMEOUT);
                OppoSlaManager.this.mAsyncHandler.sendEmptyMessage(12);
    ...
    public void sendPidAndListen() {
        if (!this.mWifiRomUpdateHelper.getBooleanValue("NETWORK_SLA_ENABLED", true)) {
            ...
            this.mNetlinkThread = new Thread() {
                ...
                /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r11v45, resolved type: android.os.Handler} */
                /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r15v9, resolved type: android.os.Handler} */
                ...
                public void run() {
                    ...
                    try {
                        ...
                        boolean result = OppoSlaManager.this.sendToKernel(18, 0);
                            ...
                            if (!(nlmsghdr == null || OppoSlaManager.sSlaCallback == null)) {
                                ...
                                if (s == 19) {
                                    ...
                                    if (enableMode == OppoSlaManager.INVALID_PARAM || activeType == OppoSlaManager.INVALID_PARAM) {
                                        ...
                                        if (1 == enableMode) {
                                            ...
                                            if (dualStaAppOnFocus) {
                                                ...
                                                int unused2 = OppoSlaManager.this.mDualStaActiveType = activeType;
                                    ...
                                    if (rtt == OppoSlaManager.INVALID_PARAM) {
                                        ...
                                        Handler access$1200 = OppoSlaManager.this.mHandler;
                                        Handler access$12002 = OppoSlaManager.this.mHandler;
                                        access$1200.sendMessage(access$12002.obtainMessage(1, "RTT=" + rtt));
                                    }
                                } else if (s == 38) {
                                    ...
                                    boolean unused3 = oppoSlaManager.mUsingLTE = z;
                                    if (OppoSlaManager.mDebug) {
                                    ...
                                    if (count == OppoSlaManager.INVALID_PARAM) {
                                        ...
                                        Handler access$12003 = OppoSlaManager.this.mHandler;
                                        Handler access$12004 = OppoSlaManager.this.mHandler;
                                        access$12003.sendMessage(access$12004.obtainMessage(1, "Rx Count=" + count));
                                    }
                                } else if (s == 29) {
                                    ...
                                    if (enabledMode == OppoSlaManager.INVALID_PARAM) {
                                        ...
                                        if (1 == enabledMode) {
                                            boolean unused4 = OppoSlaManager.this.mDualStaEnabled = true;
                                            ...
                                            boolean unused5 = OppoSlaManager.this.mSlaEnabled = true;
                                        ...
                                        if (appOnFocus) {
                                            if (2 != enabledMode) {
                                                ...
                                                boolean unused6 = OppoSlaManager.this.mDestoryScoket = true;
                                                boolean unused7 = OppoSlaManager.this.sendToKernel(OppoSlaManager.OPPO_SLA_WEIGHT_BY_WLAN_ASSIST, r4);
                                            }
                                        }
                                        Handler access$12005 = OppoSlaManager.this.mHandler;
                                        Handler access$12006 = OppoSlaManager.this.mHandler;
                                        access$12005.sendMessage(access$12006.obtainMessage(1, "OPPO_SLA_ENABLED Mode=" + enabledMode));
                                    }
                                } else if (s == 30) {
                                    ...
                                    if (disabledMode == OppoSlaManager.INVALID_PARAM) {
                                        ...
                                        if (1 == disabledMode) {
                                            boolean unused8 = OppoSlaManager.this.mDualStaEnabled = r4;
                                            int unused9 = OppoSlaManager.this.mDualStaActiveType = r4;
                                            ...
                                            boolean unused10 = OppoSlaManager.this.mSlaEnabled = r4;
                                        ...
                                        Handler access$12007 = OppoSlaManager.this.mHandler;
                                        Handler access$12008 = OppoSlaManager.this.mHandler;
                                        access$12007.sendMessage(access$12008.obtainMessage(1, "OPPO_SLA_DISABLED Mode=" + disabledMode));
                                    }
                                } else if (s == 34) {
                                    int i2 = 8;
                                    int[] data = new int[8];
                                    if (nlmsghdr.nlmsg_len < 48) {
                                        ...
                                        while (i3 < i2) {
                                            try {
                                                bytes.position((i3 * 4) + 16);
                                                data[i3] = bytes.getInt();
                                                i3++;
                                                i2 = 8;
                                            } catch (Exception e2) {
                                        ...
                                        synchronized (OppoSlaManager.this.mRttSpeedLock) {
                                            int unused11 = OppoSlaManager.this.mRecordIndex = (OppoSlaManager.this.mRecordIndex + 1) % 60;
                                        ...
                                        int unused12 = OppoSlaManager.this.mKernelWorkMode = data[6];
                                        boolean unused13 = OppoSlaManager.this.mMainWifiGood = data[7] > OppoSlaManager.this.mWifiRomUpdateHelper.getIntegerValue("OPPO_DUAL_STA_MAX_SPEED", Integer.valueOf(OppoSlaManager.MAIN_WIFI_GOOD_SPEED)).intValue() ? true : r4;
                                        long unused14 = OppoSlaManager.this.mWlan0RxPkts = bytes.getLong(48);
                                        long unused15 = OppoSlaManager.this.mWlan0TxPkts = bytes.getLong(56);
                                        long unused16 = OppoSlaManager.this.mWlan1RxPkts = bytes.getLong(64);
                                        long unused17 = OppoSlaManager.this.mWlan1TxPkts = bytes.getLong(72);
                                        ...
                                        synchronized (OppoSlaManager.this.mSlaGameStats) {
                                            if (gameType > 0) {
                                                if (gameType < OppoSlaManager.this.mSlaGameStats.size()) {
                                                    boolean unused18 = OppoSlaManager.this.mGameNetworkSwitched = true;
    ...
    /* access modifiers changed from: private */
    public int getIntParam(StructNlMsgHdr nlmsghdr, ByteBuffer bytes) {
    ...
    /* access modifiers changed from: private */
    public boolean sendToKernel(short type, int[] data) {
        if (mNlfd != null) {
            try {
    ...
    /* access modifiers changed from: private */
    public void sendSwitchStateToKernel() {
        boolean slaEnable = !isCellUsageExceeded() && getSlaEnableState() && isNetAndSimSupported();
        ? dualStaEnableState = getDualStaEnableState();
        int[] data = new int[2];
        data[0] = slaEnable ? 1 : 0;
        data[1] = dualStaEnableState;
        boolean result = sendToKernel((short) OPPO_SLA_NOTIFY_SWITCH_STATE, data);
        Log.d(TAG, "After sendSwitchStateToKernel:slaEnable=" + slaEnable + " dualStaEnable=" + ((boolean) dualStaEnableState) + " result=" + result);
    }
    ...
    /* access modifiers changed from: private */
    public void sendScreenStateToKernel(boolean screenState) {
    ...
    /* access modifiers changed from: private */
    public void sendWhiteListAppUid() {
        if (mNlfd == null) {
    ...
    /* access modifiers changed from: private */
    public void sendDownloadAppUid() {
        if (!isDualStaSupported()) {
            if (mDebug) {
                Log.d(TAG, "sendVideoAppUid isDualStaSupported() == false.");
            }
    ...
    /* access modifiers changed from: private */
    public void handleTopUidChanged(int uid, int impt) {
        int index;
        synchronized (mGameAppUids) {
    ...
    /* access modifiers changed from: private */
    public void handleNotifyShowDialog() {
    ...
    /* access modifiers changed from: private */
    public void handleGameStateChange(String pkgName, boolean start) {
        String[] gameApps = getSlaGameApps();
        if (gameApps != null && gameApps.length > 0) {
            int i = 1;
            while (i < gameApps.length) {
    ...
    /* access modifiers changed from: private */
    public void handleUpdateAppTraffic(StructNlMsgHdr nlmsghdr, ByteBuffer bytes) {
        String str;
        try {
    ...
    /* JADX INFO: Multiple debug info for r7v7 'traffic'  long: [D('traffic' long), D('uid' int)] */
    /* access modifiers changed from: private */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x026e  */
    /* JADX WARNING: Removed duplicated region for block: B:76:0x02a0  */
    public void handleUpdateGameAppStats(StructNlMsgHdr nlmsghdr, ByteBuffer bytes) {
        int gameNum;
        int gameNum2;
        ...
        try {
            ...
            int gameNum3 = mGameAppUids.size();
            if (mDebug) {
                Log.d(TAG, "handleUpdateGameAppStats gameNum=" + gameNum3);
            }
            int i = 1;
            while (i < gameNum3) {
    ...
    /* access modifiers changed from: private */
    public void clearSlaTrafficStats() {
    ...
    /* access modifiers changed from: private */
    public void showMyToast(String text, int cnt) {
    ...
    /* access modifiers changed from: private */
    public void updateSpeedAndRtt(int wifiSpeed, int wifiRtt, int wifiSpeed2, int wifiRtt2, int cellSpeed, int cellRtt) {
        ...
        if (this.mAsyncHandler != null) {
            this.mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(SIMSETTING_LOG_SWITCH_DB), false, new ContentObserver(this.mAsyncHandler) {
                ...
                public void onChange(boolean selfChange) {
                    ...
                    boolean unused = oppoSlaManager.sendToKernel(OppoSlaManager.OPPO_SLA_SET_DEBUG, i);
    ...
    public void maybeEnableDualSta() {
        ...
        Log.d(TAG, "maybeEnableSla switchState:" + switchState + " mDualStaEnabled:" + this.mDualStaEnabled + " mWifiConnected:" + this.mWifiConnected + " mWifi2Connected:" + this.mWifi2Connected);
