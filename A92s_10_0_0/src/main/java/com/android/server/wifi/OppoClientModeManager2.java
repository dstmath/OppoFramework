...
public class OppoClientModeManager2 implements ActiveModeManager {
    ...
    /* access modifiers changed from: private */
    public final OppoClientModeImpl2 mClientModeImpl;
    ...
    public class ClientModeStateMachine extends StateMachine {
        ...
        private class IdleState extends State {
            ...
            public void enter() {
                ...
                String unused = OppoClientModeManager2.this.mClientInterfaceName = null;
                boolean unused2 = OppoClientModeManager2.this.mIfaceIsUp = false;
            }
            ...
            public boolean processMessage(Message message) {
                ...
                String unused = OppoClientModeManager2.this.mClientInterfaceName = OppoClientModeManager2.this.mWifiNative.setupInterfaceForClientInConnectivityMode(ClientModeStateMachine.this.mWifiNativeInterfaceCallback);
        ...
        private class StartedState extends State {
            ...
            private void onUpChanged(boolean isUp) {
                if (isUp != OppoClientModeManager2.this.mIfaceIsUp) {
                    boolean unused = OppoClientModeManager2.this.mIfaceIsUp = isUp;
                    if (isUp) {
            ...
            public void enter() {
                ...
                boolean unused = OppoClientModeManager2.this.mIfaceIsUp = false;
