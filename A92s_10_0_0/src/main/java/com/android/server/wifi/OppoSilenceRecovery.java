...
public class OppoSilenceRecovery {
    ...
    /* access modifiers changed from: private */
    public PendingIntent mDetectIntent;
    /* access modifiers changed from: private */
    public Excecuter mExcecuter;
    /* access modifiers changed from: private */
    public Handler mHandler;
    /* access modifiers changed from: private */
    public long mLastScreenOff = 0;
    /* access modifiers changed from: private */
    public Boolean mNetWorkConnected = false;
    /* access modifiers changed from: private */
    public Boolean mOtherRequest = false;
    private PacketInfo mPktInfo;
    /* access modifiers changed from: private */
    public PendingIntent mRecoveryIntent;
    private PendingIntent mRecoveryIntentOther;
    /* access modifiers changed from: private */
    public int mResetAlarmCount = 0;
    /* access modifiers changed from: private */
        ...
        c.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.intent.action.SCREEN_ON")) {
                    boolean unused = OppoSilenceRecovery.this.mScreenOn = true;
                    long unused2 = OppoSilenceRecovery.this.mLastScreenOff = 0;
                } else if (action.equals("android.intent.action.SCREEN_OFF")) {
                    boolean unused3 = OppoSilenceRecovery.this.mScreenOn = false;
                    long unused4 = OppoSilenceRecovery.this.mLastScreenOff = System.currentTimeMillis();
                    ...
                    Boolean unused5 = OppoSilenceRecovery.this.mOtherRequest = true;
                    OppoSilenceRecovery.this.recoveryWifi();
                    ...
                    if (state == NetworkInfo.DetailedState.CONNECTED) {
                        Boolean unused6 = OppoSilenceRecovery.this.mNetWorkConnected = true;
                    } else if (state == NetworkInfo.DetailedState.DISCONNECTED) {
                        Boolean unused7 = OppoSilenceRecovery.this.mNetWorkConnected = false;
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 8) {
                    ...
                    if (result || OppoSilenceRecovery.this.netWorkCount == 0 || !OppoSilenceRecovery.this.mOtherRequest.booleanValue()) {
                        ...
                        int unused = OppoSilenceRecovery.this.netWorkCount = 3;
    ...
    /* access modifiers changed from: private */
    public void netWorkRestart(boolean enable) {
    ...
    private void executeMtkFwRecovey() {
        ...
        SystemProperties.set("oppo.wifi.sau.mtk.coredump.type", mRecoveryType);
        SystemProperties.set("oppo.wifi.sau.mtk.coredump", "1");
    ...
    public class Excecuter {
        ...
        public void resetRestartAlarm() {
            ...
            if (OppoSilenceRecovery.access$1608(OppoSilenceRecovery.this) >= 3) {
                ...
                int unused = OppoSilenceRecovery.this.mResetAlarmCount = 0;
                OppoSilenceRecovery.this.mAlarmManager.set(0, caculateTimeIntoMillis(1, getRandomHour(), getRandomMin()), OppoSilenceRecovery.this.mRecoveryIntent);
                return;
            }
