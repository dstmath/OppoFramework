...
public class OppoWifiP2pStats {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("oppo.intent.state.wfdconnectfail")) {
                String unused = OppoWifiP2pStats.this.mWfdConnectfailReasion = (String) intent.getExtra("wfd_connect_fail_extra", null);
            }
            if (OppoWifiP2pStats.this.mWfdConnectfailReasion == null) {
                String unused2 = OppoWifiP2pStats.this.mWfdConnectfailReasion = "WFD_FAIL_CONNECT_UNKOWN";
            }
    ...
    /* access modifiers changed from: private */
    public String mWfdConnectfailReasion = null;
    ...
    /* access modifiers changed from: private */
    public boolean canCollectWfdLog() {
    ...
    /* access modifiers changed from: private */
    public void tryToCollectLog(String reason) {
        if (this.mIsLogging) {
    ...
    private class WifiP2pStatsHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 3) {
                ...
                boolean unused = OppoWifiP2pStats.this.mIsLogging = false;
