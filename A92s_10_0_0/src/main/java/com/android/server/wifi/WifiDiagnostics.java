...
class WifiDiagnostics extends BaseWifiDiagnostics {
    ...
    public WifiDiagnostics(Context context, WifiInjector wifiInjector, WifiNative wifiNative, BuildProperties buildProperties, LastMileLogger lastMileLogger, Clock clock) {
        super(wifiNative);
        this.RING_BUFFER_BYTE_LIMIT_SMALL = context.getResources().getInteger(17694955) * 1024;
        this.RING_BUFFER_BYTE_LIMIT_LARGE = context.getResources().getInteger(17694956) * 1024;
        int[] fatalFirmwareAlertErrorCodeArray = context.getResources().getIntArray(17236091);
