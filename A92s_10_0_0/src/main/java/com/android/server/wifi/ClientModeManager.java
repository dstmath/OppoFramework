    ...
    public class ClientModeStateMachine extends StateMachine {
        ...
        private class IdleState extends State {
            ...
            public boolean processMessage(Message message) {
                ...
                String unused = ClientModeManager.this.mClientInterfaceName = ClientModeManager.this.mWifiNative.getClientInterfaceName();
                if (ClientModeManager.this.mClientInterfaceName != null) {
                    ...
                    String unused2 = ClientModeManager.this.mClientInterfaceName = ClientModeManager.this.mWifiNative.setupInterfaceForClientInConnectivityMode(ClientModeStateMachine.this.mWifiNativeInterfaceCallback);
                }
            ...
            public void exit() {
                ...
                if (ClientModeManager.this.mClientInterfaceName != null) {
                    ...
                    if (WifiInjector.getInstance().getActiveModeWarden().isClientIfaceNeedForceTearDown()) {
                        ...
                        ClientModeManager.this.mWifiNative.teardownInterface(ClientModeManager.this.mClientInterfaceName);
                        String unused3 = ClientModeManager.this.mClientInterfaceName = null;
                        boolean unused4 = ClientModeManager.this.mIfaceIsUp = false;
                    }
                }
