...
public class OppoWifiAssistantStateTraker extends StateMachine {
    ...
    /* access modifiers changed from: private */
    public boolean mCanTriggerData;
    /* access modifiers changed from: private */
    public String mCandidateKey;
    /* access modifiers changed from: private */
    public boolean mCaptivePortal;
    private int mChangeRssi;
    private int mChangeScore;
    /* access modifiers changed from: private */
    public boolean mChangedNetwork;
    /* access modifiers changed from: private */
    public boolean mChangedToData;
    /* access modifiers changed from: private */
    public boolean mClickDialogSwitch;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public String mConnectSSID;
    /* access modifiers changed from: private */
    public long mConnectTime;
    /* access modifiers changed from: private */
    public int mConnectedId;
    /* access modifiers changed from: private */
    public State mConnectedState;
    /* access modifiers changed from: private */
    public int mConnectingId;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mDataAutoSwitch;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public long mLastSwitchedToWifiTime;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public int mLinkDetectTimes;
    /* access modifiers changed from: private */
    public int mLinkInterval;
    /* access modifiers changed from: private */
    public double[] mLossArray;
    /* access modifiers changed from: private */
    public double mLossInit;
    /* access modifiers changed from: private */
    public int mLowTrafficeCount;
    /* access modifiers changed from: private */
    public int mLowTrafficeThreshold;
    ...
    /* access modifiers changed from: private */
    public boolean mResponseGotFromGateway;
    /* access modifiers changed from: private */
    public int mRoamdetectCount;
    /* access modifiers changed from: private */
    public int mRssiFetchToken;
    /* access modifiers changed from: private */
    public int mRxPktsLowCount;
    ...
    /* access modifiers changed from: private */
    public boolean mTriggerInter;
    /* access modifiers changed from: private */
    public boolean mTriggerScan;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public int mWlanIfIndex;
    /* access modifiers changed from: private */
    public int mWlanInvalidThreshold;
    ...
    public OppoWifiAssistantStateTraker(Context c, ClientModeImpl wsm, WifiConfigManager wcs, WifiNative wnt, SupplicantStateTracker wst, WifiRomUpdateHelper wruh, Handler t, ScanRequestProxy mSrp) {
        ...
        this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(WIFI_AUTO_CHANGE_NETWORK), true, new ContentObserver(getHandler()) {
            ...
            public void onChange(boolean selfChange) {
                ...
                boolean unused = oppoWifiAssistantStateTraker.mDataAutoSwitch = z;
        ...
        OppoSlaManager.setSlaCallback(new OppoSlaManager.OppoSlaCallback() {
            ...
            public void enableSla() {
                ...
                if (OppoWifiAssistantStateTraker.this.mInterResult) {
                    ...
                    boolean unused = OppoWifiAssistantStateTraker.this.mCanTriggerData = false;
                }
            }
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.net.wifi.STATE_CHANGE")) {
                    ...
                    if (networkInfo != null && networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                        ...
                        boolean unused = OppoWifiAssistantStateTraker.this.mWifiConnected = true;
                    }
                    ...
                    if (OppoWifiAssistantStateTraker.this.mChangedToData) {
                        int unused2 = OppoWifiAssistantStateTraker.this.mInterInteval = 120000;
                    } else {
                        int unused3 = OppoWifiAssistantStateTraker.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                    }
                    boolean unused4 = OppoWifiAssistantStateTraker.this.mScreenOn = true;
                    ...
                    int unused5 = OppoWifiAssistantStateTraker.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                    boolean unused6 = OppoWifiAssistantStateTraker.this.mScreenOn = false;
                    int unused7 = OppoWifiAssistantStateTraker.this.mLowTrafficeCount = 0;
                } else if (action.equals(OppoWifiAssistantStateTraker.WIFI_TO_DATA)) {
                    boolean unused8 = OppoWifiAssistantStateTraker.this.mChangedToData = intent.getBooleanExtra(OppoWifiAssistantStateTraker.EXTRA_WIFI_TO_DATA, false);
                    if (OppoWifiAssistantStateTraker.this.mChangedToData != OppoWifiAssistantStateTraker.this.mLastToData) {
                        if (!OppoWifiAssistantStateTraker.this.mChangedToData) {
                            ...
                            boolean unused9 = OppoWifiAssistantStateTraker.this.mCanTriggerData = true;
                            boolean unused10 = OppoWifiAssistantStateTraker.this.mChangedNetwork = false;
                            int unused11 = OppoWifiAssistantStateTraker.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                            ...
                            int unused12 = OppoWifiAssistantStateTraker.this.mInterInteval = 120000;
                            int unused13 = OppoWifiAssistantStateTraker.this.mTcpInterval = 5000;
                            ...
                            if (OppoWifiAssistantStateTraker.this.mClickDialogSwitch) {
                                boolean unused14 = OppoWifiAssistantStateTraker.this.mAutoSwithToData = false;
                            } else {
                                boolean unused15 = OppoWifiAssistantStateTraker.this.mAutoSwithToData = true;
                            }
                            boolean unused16 = OppoWifiAssistantStateTraker.this.mClickDialogSwitch = false;
                            OppoWifiAssistantStateTraker.this.detectSwitchDataFrequence();
                            if (OppoWifiAssistantStateTraker.this.mChangedNetwork) {
                                long unused17 = OppoWifiAssistantStateTraker.this.mAutoConnDataTime = System.currentTimeMillis();
                                long unused18 = OppoWifiAssistantStateTraker.this.mAutoConnWlanTime = 0;
                                long unused19 = OppoWifiAssistantStateTraker.this.mAutoDataToWlanTime = 0;
                        ...
                        boolean unused20 = oppoWifiAssistantStateTraker9.mLastToData = oppoWifiAssistantStateTraker9.mChangedToData;
                    }
                    ...
                    if (intent.getIntExtra("extra_connectivity_type", -1) == 1 && intent.getBooleanExtra("extra_is_captive_portal", false)) {
                        ...
                        if (curWifiInfo != null && netStateSsid != null && curWifiInfo.getSSID().equals(netStateSsid) && (netConf = OppoWifiAssistantStateTraker.this.getWifiConfig(netStateSsid, curWifiInfo.getBSSID())) != null && netConf.networkId == OppoWifiAssistantStateTraker.this.mConnectedId) {
                            boolean unused21 = OppoWifiAssistantStateTraker.this.mCaptivePortal = true;
                    ...
                    int unused22 = OppoWifiAssistantStateTraker.this.mDataScore = dataScore;
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case 131126:
                case 151553:
                    int unused = OppoWifiAssistantStateTraker.this.mConnectId = Integer.valueOf(msg.arg1).intValue();
                    int unused2 = OppoWifiAssistantStateTraker.this.mIsNewConfig = Integer.valueOf(msg.arg2).intValue();
                    ...
                    String unused3 = OppoWifiAssistantStateTraker.this.mConnectKey = config != null ? config.configKey(false) : null;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                    if (config != null) {
                        str = config.SSID;
                    }
                    String unused4 = oppoWifiAssistantStateTraker2.mConnectSSID = str;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker3 = OppoWifiAssistantStateTraker.this;
                ...
                case WifiMonitor.WRONG_KEY_EVENT /*{ENCODED_INT: 147648}*/:
                    ...
                    String unused5 = oppoWifiAssistantStateTraker5.mConnectingkey = str;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker6 = OppoWifiAssistantStateTraker.this;
                    ...
                    if (OppoWifiAssistantStateTraker.this.getIsOppoManuConnect()) {
                        int unused6 = OppoWifiAssistantStateTraker.this.mConnectId = -1;
                        break;
                    }
                    break;
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    int unused7 = OppoWifiAssistantStateTraker.this.mRoamdetectCount = 0;
                    int unused8 = OppoWifiAssistantStateTraker.this.mLastNetId = msg.arg1;
                    String unused9 = OppoWifiAssistantStateTraker.this.mLastBssid = (String) msg.obj;
                    ...
                    String unused10 = oppoWifiAssistantStateTraker7.mLastConfigkey = str;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker8 = OppoWifiAssistantStateTraker.this;
                ...
                case WifiMonitor.SUPPLICANT_STATE_CHANGE_EVENT /*{ENCODED_INT: 147462}*/:
                    ...
                    int unused11 = OppoWifiAssistantStateTraker.this.mConnectingId = stateReult.networkId;
                    ...
                    String unused12 = OppoWifiAssistantStateTraker.this.mConnectingkey = config3 != null ? config3.configKey(false) : null;
                    WifiInfo curWifiInfo = OppoWifiAssistantStateTraker.this.mWifiStateMachine.syncRequestConnectionInfo();
                ...
                case 200705:
                    int unused13 = OppoWifiAssistantStateTraker.this.mLastNetId = msg.arg1;
                    String unused14 = OppoWifiAssistantStateTraker.this.mLastBssid = (String) msg.obj;
                    ...
                    String unused15 = OppoWifiAssistantStateTraker.this.mLastConfigkey = config4 != null ? config4.configKey(false) : null;
                    if (msg.arg2 != 2) {
                        if (msg.arg2 == 0) {
                        ...
                        String unused16 = oppoWifiAssistantStateTraker11.mConnectSSID = str;
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker12 = OppoWifiAssistantStateTraker.this;
                ...
                case 200706:
                    ...
                    break;
                case 200712:
                    boolean unused17 = OppoWifiAssistantStateTraker.this.mIsScreenOn = true;
                    break;
                case 200713:
                    boolean unused18 = OppoWifiAssistantStateTraker.this.mIsScreenOn = false;
                    break;
            }
            return true;
        }
    ...
    class InitState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker.this.logD(getName());
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker = OppoWifiAssistantStateTraker.this;
            int unused = oppoWifiAssistantStateTraker.mWifiState = oppoWifiAssistantStateTraker.mWifiStateMachine.syncGetWifiState();
            int unused2 = OppoWifiAssistantStateTraker.this.mLastTxBad = 0;
            int unused3 = OppoWifiAssistantStateTraker.this.mLastTxGood = 0;
        }
    ...
    class DisconnectedState extends State {
        ...
        public void enter() {
            ...
            int unused = OppoWifiAssistantStateTraker.this.mLastNetId = -1;
            String unused2 = OppoWifiAssistantStateTraker.this.mLastBssid = " ";
            String unused3 = OppoWifiAssistantStateTraker.this.mUnavailableKey = " ";
            boolean unused4 = OppoWifiAssistantStateTraker.this.mAutoSwithToData = false;
            boolean unused5 = OppoWifiAssistantStateTraker.this.mInterResult = false;
            int unused6 = OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
            boolean unused7 = OppoWifiAssistantStateTraker.this.mInterChangeToInvalid = false;
            RssiPacketCountInfo unused8 = OppoWifiAssistantStateTraker.this.mLastPktInfo = null;
            int unused9 = OppoWifiAssistantStateTraker.this.mGotInternetResult = 0;
            long unused10 = OppoWifiAssistantStateTraker.this.mLastDetectInter = 0;
            int unused11 = OppoWifiAssistantStateTraker.this.mTrigScanCount = 0;
            long unused12 = OppoWifiAssistantStateTraker.this.mDTxPkts = 0;
            long unused13 = OppoWifiAssistantStateTraker.this.mdRxPkts = 0;
            boolean unused14 = OppoWifiAssistantStateTraker.this.mIsSoftAP = false;
            boolean unused15 = OppoWifiAssistantStateTraker.this.mCaptivePortal = false;
            boolean unused16 = OppoWifiAssistantStateTraker.this.mResponseGotFromGateway = false;
            boolean unused17 = OppoWifiAssistantStateTraker.this.mWifiConnected = false;
            boolean unused18 = OppoWifiAssistantStateTraker.this.mIsFirstPktCntFetchSucceed = true;
    ...
    class CompletedState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker.this.logD(getName());
            int unused = OppoWifiAssistantStateTraker.this.mGotInternetResult = 0;
        ...
        public boolean processMessage(Message msg) {
            ...
            int i = msg.what;
            if (i == 147459) {
                int unused = OppoWifiAssistantStateTraker.this.mRoamdetectCount = 0;
                String unused2 = OppoWifiAssistantStateTraker.this.mLastBssid = (String) msg.obj;
                if (OppoWifiAssistantStateTraker.this.mLastNetId != msg.arg1) {
                    int unused3 = OppoWifiAssistantStateTraker.this.mLastNetId = msg.arg1;
                    ...
                    String unused4 = OppoWifiAssistantStateTraker.this.mLastConfigkey = config != null ? config.configKey(false) : null;
                }
            } else if (i != 200705) {
                return false;
            } else {
                String unused5 = OppoWifiAssistantStateTraker.this.mLastBssid = (String) msg.obj;
                int unused6 = OppoWifiAssistantStateTraker.this.mLastNetId = msg.arg1;
                int completestate = msg.arg2;
                OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                oppoWifiAssistantStateTraker2.logD("cptst = " + completestate + ",msg.arg1= " + msg.arg1);
                WifiConfiguration config2 = OppoWifiAssistantStateTraker.this.mWifiConfigManager.getConfiguredNetwork(OppoWifiAssistantStateTraker.this.mLastNetId);
                if (config2 != null) {
                    String unused7 = OppoWifiAssistantStateTraker.this.mLastConfigkey = config2.configKey(false);
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker3 = OppoWifiAssistantStateTraker.this;
                    ...
                    if (completestate == 0) {
                        ...
                        String unused8 = OppoWifiAssistantStateTraker.this.mConnectSSID = config2.SSID;
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker6 = OppoWifiAssistantStateTraker.this;
                        oppoWifiAssistantStateTraker6.transitionTo(oppoWifiAssistantStateTraker6.mVerifyInternetState);
                    } else if (completestate == 2) {
                        String unused9 = OppoWifiAssistantStateTraker.this.mConnectSSID = config2.SSID;
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker7 = OppoWifiAssistantStateTraker.this;
    ...
    class VerifyInternetState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker.this.logD(getName());
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker = OppoWifiAssistantStateTraker.this;
            int unused = oppoWifiAssistantStateTraker.mConnectedId = oppoWifiAssistantStateTraker.mLastNetId;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
    ...
    class ConnectedState extends State {
        ...
        public void enter() {
            OppoWifiAssistantStateTraker.this.logD(getName());
            boolean unused = OppoWifiAssistantStateTraker.this.mWifiConnected = true;
            long unused2 = OppoWifiAssistantStateTraker.this.mConnectTime = System.currentTimeMillis();
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker = OppoWifiAssistantStateTraker.this;
            int unused3 = oppoWifiAssistantStateTraker.mConnectedId = oppoWifiAssistantStateTraker.mLastNetId;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
            ...
            if (OppoWifiAssistantStateTraker.this.mCandidateKey.equals(OppoWifiAssistantStateTraker.this.mLastConfigkey)) {
                OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker4 = OppoWifiAssistantStateTraker.this;
                long unused4 = oppoWifiAssistantStateTraker4.mAutoConnWlanTime = oppoWifiAssistantStateTraker4.mConnectTime;
                long unused5 = OppoWifiAssistantStateTraker.this.mAutoConnDataTime = 0;
                long unused6 = OppoWifiAssistantStateTraker.this.mAutoDataToWlanTime = 0;
                ...
                String unused7 = OppoWifiAssistantStateTraker.this.mCandidateKey = "";
            }
            int unused8 = OppoWifiAssistantStateTraker.this.mTcpStatistics = 0;
            int unused9 = OppoWifiAssistantStateTraker.this.mTcpInterval = OppoWiFiScanBlockPolicy.BACKGROUND_SCAN_RESULTS_INTERVAL;
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case 200705:
                    String unused = OppoWifiAssistantStateTraker.this.mLastBssid = (String) msg.obj;
                    int unused2 = OppoWifiAssistantStateTraker.this.mLastNetId = msg.arg1;
                    int connectedstate = msg.arg2;
                    WifiConfiguration config = OppoWifiAssistantStateTraker.this.mWifiConfigManager.getConfiguredNetwork(OppoWifiAssistantStateTraker.this.mLastNetId);
                    String unused3 = OppoWifiAssistantStateTraker.this.mLastConfigkey = config != null ? config.configKey(false) : null;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                ...
                case 200711:
                    if (OppoWifiAssistantStateTraker.this.needToDetectTcpStatus()) {
                        boolean unused4 = OppoWifiAssistantStateTraker.this.detectTcpStatus();
                        break;
                    }
                    break;
                case 200712:
                    boolean unused5 = OppoWifiAssistantStateTraker.this.mIsScreenOn = true;
                    break;
                default:
                    return false;
            }
    ...
    class NetworkMonitorState extends State {
        ...
        public void enter() {
            ...
            long unused = OppoWifiAssistantStateTraker.this.mLastTrigDataTime = System.currentTimeMillis();
            if (OppoWifiAssistantStateTraker.this.mInterfaceName != null) {
                OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                long unused2 = oppoWifiAssistantStateTraker2.mLastTxPkts = oppoWifiAssistantStateTraker2.mOppoSlaManager.getWlanTcpTxPackets(0);
                OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker3 = OppoWifiAssistantStateTraker.this;
                long unused3 = oppoWifiAssistantStateTraker3.mLastRxPkts = oppoWifiAssistantStateTraker3.mOppoSlaManager.getWlanTcpRxPackets(0);
            } else {
                long unused4 = OppoWifiAssistantStateTraker.this.mLastTxPkts = 0;
                long unused5 = OppoWifiAssistantStateTraker.this.mLastRxPkts = 0;
            }
            int unused6 = OppoWifiAssistantStateTraker.this.mRxPktsLowCount = 0;
            long unused7 = OppoWifiAssistantStateTraker.this.mDTxPkts = 0;
            long unused8 = OppoWifiAssistantStateTraker.this.mdRxPkts = 0;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker4 = OppoWifiAssistantStateTraker.this;
            int unused9 = oppoWifiAssistantStateTraker4.mLinkInterval = oppoWifiAssistantStateTraker4.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_GOOD_LINK_SAMPL_INTERVAL", 5000).intValue();
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker5 = OppoWifiAssistantStateTraker.this;
            int unused10 = oppoWifiAssistantStateTraker5.mTrafficInteval = oppoWifiAssistantStateTraker5.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_INVALID_TRAFFIC_SAMPL_INTERVAL", Integer.valueOf((int) OppoWiFiScanBlockPolicy.BACKGROUND_SCAN_RESULTS_INTERVAL)).intValue();
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker6 = OppoWifiAssistantStateTraker.this;
            int unused11 = oppoWifiAssistantStateTraker6.mLowTrafficeThreshold = oppoWifiAssistantStateTraker6.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_LOW_TRAFFICE_THRESHOLD", 10).intValue();
            int unused12 = OppoWifiAssistantStateTraker.this.mTcpInterval = 5000;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker7 = OppoWifiAssistantStateTraker.this;
            int unused13 = oppoWifiAssistantStateTraker7.mWlanInvalidThreshold = oppoWifiAssistantStateTraker7.getRomUpdateIntegerValue("OPPO_WIFI_ASSISTANT_WLAN_INVALID_THRESHOLD", 40).intValue();
            int unused14 = OppoWifiAssistantStateTraker.this.mRoamdetectCount = 0;
            boolean unused15 = OppoWifiAssistantStateTraker.this.mCanTriggerData = true;
            OppoWifiAssistantStateTraker.this.mAssistantUtils.resetTriggerData();
            boolean unused16 = OppoWifiAssistantStateTraker.this.mTriggerInter = false;
            boolean unused17 = OppoWifiAssistantStateTraker.this.mChangedNetwork = false;
            boolean unused18 = OppoWifiAssistantStateTraker.this.mClickDialogSwitch = false;
            int unused19 = OppoWifiAssistantStateTraker.this.mDetectInterCount = 0;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker8 = OppoWifiAssistantStateTraker.this;
            boolean unused20 = oppoWifiAssistantStateTraker8.mLastInternetResult = oppoWifiAssistantStateTraker8.mInterResult;
            int unused21 = OppoWifiAssistantStateTraker.this.mLinkDetectTimes = 0;
            int unused22 = OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
            boolean unused23 = OppoWifiAssistantStateTraker.this.mInterChangeToInvalid = false;
            long unused24 = OppoWifiAssistantStateTraker.this.mLastDetectInter = 0;
            int unused25 = OppoWifiAssistantStateTraker.this.mInternetStandoffTime = 0;
            int unused26 = OppoWifiAssistantStateTraker.this.mTrigScanCount = 0;
            int unused27 = OppoWifiAssistantStateTraker.this.mNetQulityGoodCount = 0;
            int unused28 = OppoWifiAssistantStateTraker.this.mLowTrafficeCount = 0;
            int unused29 = OppoWifiAssistantStateTraker.this.mOldTcpStatus = 0;
            ...
            int unused30 = OppoWifiAssistantStateTraker.this.mIndex = 0;
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker9 = OppoWifiAssistantStateTraker.this;
            VolumeWeightedEMA unused31 = oppoWifiAssistantStateTraker9.mCurrentLoss = new VolumeWeightedEMA(0.5d);
            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker10 = OppoWifiAssistantStateTraker.this;
            ...
            switch (msg.what) {
                case 151573:
                    ...
                    if (info != null) {
                        if (OppoWifiAssistantStateTraker.this.mWifiConnected) {
                            ...
                            RssiPacketCountInfo unused = OppoWifiAssistantStateTraker.this.mLastPktInfo = info;
                            break;
                        } else {
                ...
                case 200710:
                    ...
                    if (OppoWifiAssistantStateTraker.this.mChangedToData || !OppoWifiAssistantStateTraker.this.mInterResult) {
                        if (!OppoWifiAssistantStateTraker.this.mAutoSwitch || !OppoWifiAssistantStateTraker.this.mFeatureState || !OppoWifiAssistantStateTraker.this.getRomUpdateBooleanValue("OPPO_WIFI_ASSISTANT_FEATURE", true).booleanValue()) {
                            int unused2 = OppoWifiAssistantStateTraker.this.mInterInteval = WifiConnectivityManager.BSSID_BLACKLIST_EXPIRE_TIME_MS;
                        }
                        OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker3 = OppoWifiAssistantStateTraker.this;
                ...
                case OppoWifiAssistantStateTraker.EVENT_SHOW_ALERT /*{ENCODED_INT: 200719}*/:
                ...
                case OppoWifiAssistantStateTraker.EVENT_DISMISS_ALERT /*{ENCODED_INT: 200720}*/:
                    ...
                    break;
                case OppoWifiAssistantStateTraker.EVENT_DETECT_ALTERNATIVE /*{ENCODED_INT: 200721}*/:
                    String detectConfig = (String) msg.obj;
                    OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker9 = OppoWifiAssistantStateTraker.this;
                    oppoWifiAssistantStateTraker9.logD("decon:" + detectConfig);
                    OppoWifiAssistantRecord unused3 = OppoWifiAssistantStateTraker.this.findAvailableCandidate(OppoWifiAssistantStateTraker.this.mAssistantUtils.getNetworkRecord(detectConfig), 10, -127, false);
                    break;
                case OppoWifiAssistantStateTraker.CMD_SEND_LOW_QUALITY /*{ENCODED_INT: 200725}*/:
                    long unused4 = OppoWifiAssistantStateTraker.this.mLastTrigDataTime = System.currentTimeMillis();
                    OppoWifiAssistantStateTraker.this.mAssistantUtils.setupDataNetwork();
                    break;
                default:
                    return false;
    ...
    /* access modifiers changed from: private */
    public void resetOppoManuConnect() {
        if (OppoManuConnectManager.getInstance() != null) {
    ...
    /* access modifiers changed from: private */
    public void updateRecordCaptiveState(String configKey, boolean captive, boolean save) {
    ...
    /* JADX INFO: Multiple debug info for r5v27 int: [D('currentQuality' int), D('i' int)] */
    /* JADX INFO: Multiple debug info for r13v51 'now'  long: [D('dtotal' int), D('now' long)] */
    /* access modifiers changed from: private */
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:380:0x09b7, code lost:
        return;
     */
        ...
        if (mLastRecord != null && info != null) {
            if (info.rssi > WifiConfiguration.INVALID_RSSI) {
                ...
                for (int i2 = netQualityIndex; i2 < 4; i2++) {
                    if (score4 > mLastRecord.mNetQualitys[i2]) {
                        mLastRecord.mNetQualitys[i2] = score4;
                        mLastRecord.mScore = score4;
                    }
                }
                logD("updateRecordLinkQuality key:" + this.mLastConfigkey + ",rssi=" + rssi + " txbad=" + txbad + " txgood=" + txgood + ",dbad = " + dbad + ", dgood = " + dgood + ",dtotal= " + dtotal2 + ",badLossCount=" + badLossCount + ",loss=" + df.format(loss * 100.0d) + ",mLinkDetectTimes= " + this.mLinkDetectTimes + ",newTcpStatus:" + newTcpStatus + ",mIndex =" + this.mIndex + ",score= " + score4 + ",hls=" + mLastRecord.mIsHistoryLoss + ",mInterResult=" + this.mInterResult + ",mChangeScore=" + this.mChangeScore + ",mNetQulityGoodCount=" + this.mNetQulityGoodCount);
                ...
                broadcastInfotoTestapk("ssid:" + mLastRecord.mConfigkey + ",net:" + mLastRecord.mNetworkValid + ",currScore:" + score4 + ",score:" + currentQuality + ", rssi:" + rssi + ",loss:" + df.format(loss * 100.0d) + ",total:" + dtotal2 + ",tcp:" + newTcpStatus);
                ...
                if (currentQuality <= 79 - trigWlanSetectScore) {
                    if (score4 <= 79 - trigWlanSetectScore && this.mLastScanTime != 0 && now - this.mLastScanTime > STAIC_SCAN_RESULT_AGE && this.mTrigScanCount < 3 && !this.mTriggerScan) {
                    ...
                    if (!this.mTriggerScan) {
                        ...
                        if (score4 <= 79 - trigWlanSetectScore) {
                ...
                if (this.mChangedNetwork || currentQuality > 79 - wlanBadThreshold || score4 > 79 - wlanBadThreshold) {
                    if (this.mChangedNetwork && this.mChangedToData) {
                        ...
                        if (mLastRecord.mNetworkValid && !this.mLastInternetResult && this.mChangeRssi != 0 && rssi >= -72 && currentQuality >= 50 && score4 >= 50 && this.mChangeScore == 10) {
                            changeNetworkToWlan(mLastRecord, score4, true, false);
    ...
    /* access modifiers changed from: private */
    public void changeNetworkToWlan(OppoWifiAssistantRecord record, int quality, boolean dataToWlan, boolean keep) {
        if (this.mWifiStateMachine != null) {
            if (this.mAssistantUtils.isPrimaryWifi(this.mInterfaceName)) {
    ...
    public boolean sendParallelHttpProbes() {
        ...
        try {
            ...
            AnonymousClass1ProbeThread httpProbe1 = new Thread(url1, finalResult, latch) {
                ...
                /* Incorrect method signature, types: com.android.server.wifi.OppoWifiAssistantStateTraker, java.net.URL */
                {
            ...
            if (handler != null) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        long unused = OppoWifiAssistantStateTraker.this.mLastDetectInter = System.currentTimeMillis();
                        boolean unused2 = OppoWifiAssistantStateTraker.this.mInternetDetecting = true;
                        ...
                        boolean unused3 = OppoWifiAssistantStateTraker.this.mInternetDetecting = false;
                        if (dectConfig != null && !dectConfig.equals(OppoWifiAssistantStateTraker.this.mLastConfigkey)) {
                            return;
                        }
                        if (probeResult) {
                            boolean unused4 = OppoWifiAssistantStateTraker.this.mCaptivePortal = false;
                            int unused5 = OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
                            if (!OppoWifiAssistantStateTraker.this.mInterResult) {
                                OppoWifiAssistantStateTraker.this.sendMessageForNetChange(true);
                            }
                        } else if (!OppoWifiAssistantStateTraker.this.mInterResult || OppoWifiAssistantStateTraker.this.mLastPktInfo == null || OppoWifiAssistantStateTraker.this.mLastPktInfo.rssi < -75) {
                            int unused6 = OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
                        } else {
                            if (OppoWifiAssistantStateTraker.this.mInternetInvalidCount == 0) {
                                ...
                                int unused7 = OppoWifiAssistantStateTraker.this.mInternetInvalidCount = 0;
            ...
            if (str != null && str.equals(lastRecord.mConfigkey)) {
                ...
                if (getIsOppoManuConnect()) {
                    if (lastRecord.mNetworkValid) {
                        title2 = this.mContext.getResources().getString(201653641);
                    } else {
                        title2 = this.mContext.getResources().getString(201653642);
                    }
                    title = String.format(title2, ssid);
                    builder.setPositiveButton(201653542, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface d, int w) {
                            ...
                            boolean unused = OppoWifiAssistantStateTraker.this.mClickDialogSwitch = true;
                            OppoWifiAssistantStateTraker.this.mAssistantUtils.disableDualStaWithDelay(5000);
                            OppoWifiAssistantRecord unused2 = OppoWifiAssistantStateTraker.this.findAvailableCandidate(null, 0, -127, false);
                        }
                    });
                    ...
                    title = String.format(this.mContext.getResources().getString(201653644), ssid);
    ...
    public void showDialogForData(OppoWifiAssistantRecord lastRecord) {
        ...
        if (lastRecord == null) {
            ...
            if (lastRecord.mNetworkValid) {
                title = this.mContext.getResources().getString(201653645);
            } else {
                title = this.mContext.getResources().getString(201653643);
            }
            mDataAlertDialog.setTitle(String.format(title, ssid));
            ...
            synchronized (mDialogLock) {
                ...
                } else if (mDataAlertDialog.getDialog() != null) {
    ...
    private final class NetHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoWifiAssistantStateTraker.EVENT_UPDATE_NETWORK_STATE /*{ENCODED_INT: 200714}*/:
                        ...
                        if (updateWifiInfo != null && netStateSsid != null && updateWifiInfo.getSSID().equals(netStateSsid)) {
                            ...
                            if (netValid || !OppoWifiAssistantStateTraker.this.mWifiStateMachine.isDupDhcp()) {
                                if (OppoWifiAssistantStateTraker.this.mInterResult && !netValid) {
                                    boolean unused = OppoWifiAssistantStateTraker.this.mInterChangeToInvalid = true;
                                }
                                ...
                                if (netConf != null && netConf.networkId == OppoWifiAssistantStateTraker.this.mConnectedId) {
                                    ...
                                    boolean unused2 = OppoWifiAssistantStateTraker.this.mInterResult = netValid;
                                    if (netValid) {
                ...
                case OppoWifiAssistantStateTraker.EVENT_CONNECT_NETWORK /*{ENCODED_INT: 200715}*/:
                    if (OppoWifiAssistantStateTraker.this.mWifiStateMachine.syncRequestConnectionInfo() != null) {
                        ...
                        if (curLink != null && network != null && network.netId == netId) {
                            long unused3 = OppoWifiAssistantStateTraker.this.mLastSwitchedToWifiTime = System.currentTimeMillis();
                            removeMessages(OppoWifiAssistantStateTraker.CMD_SEND_LOW_QUALITY);
                            Network unused4 = OppoWifiAssistantStateTraker.this.mCurNetwork = network;
                            OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker2 = OppoWifiAssistantStateTraker.this;
                            boolean unused5 = oppoWifiAssistantStateTraker2.mIsSoftAP = oppoWifiAssistantStateTraker2.isSoftAp(curLink);
                            return;
                        }
                        return;
                    }
                    return;
                case OppoWifiAssistantStateTraker.EVENT_INTERNET_CHANGE /*{ENCODED_INT: 200722}*/:
                    ...
                    if (interResult) {
                        boolean unused6 = OppoWifiAssistantStateTraker.this.mInterChangeToInvalid = false;
                        ...
                        boolean unused7 = OppoWifiAssistantStateTraker.this.mInterChangeToInvalid = true;
                    }
                    OppoWifiAssistantStateTraker.this.updateRecordInternetStateAndTime(interConf, interResult, false);
                    boolean unused8 = OppoWifiAssistantStateTraker.this.mInterResult = interResult;
                    ...
                    return;
                case OppoWifiAssistantStateTraker.EVENT_CAPTIVE_PORTAL /*{ENCODED_INT: 200723}*/:
                    ...
                    return;
                case OppoWifiAssistantStateTraker.EVENT_SCAN_TIMEOUT /*{ENCODED_INT: 200724}*/:
                    boolean unused9 = OppoWifiAssistantStateTraker.this.mTriggerScan = false;
                    return;
                default:
                    return;
            }
    ...
    /* access modifiers changed from: private */
    public void sendWifiToDataBroadcast(boolean toData, int score) {
    ...
    private class DataStateObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            if (OppoWifiAssistantStateTraker.this.mTelephonyManager != null) {
                OppoWifiAssistantStateTraker oppoWifiAssistantStateTraker = OppoWifiAssistantStateTraker.this;
                boolean unused = oppoWifiAssistantStateTraker.mDataState = oppoWifiAssistantStateTraker.mTelephonyManager.getDataEnabled();
                ...
                if (!OppoWifiAssistantStateTraker.this.mDataState) {
                    ...
                    if (OppoWifiAssistantStateTraker.this.mChangedNetwork && OppoWifiAssistantStateTraker.this.mChangedToData) {
                        if (OppoWifiAssistantStateTraker.this.mAutoConnDataTime > 0 && disableData > 0 && disableData < 180000) {
                            ...
                            long unused2 = OppoWifiAssistantStateTraker.this.mAutoConnDataTime = 0;
                        }
                    ...
                    if (!OppoWifiAssistantStateTraker.this.mCanTriggerData) {
                        ...
                        boolean unused3 = OppoWifiAssistantStateTraker.this.mCanTriggerData = true;
                    }
                }
            }
        }
