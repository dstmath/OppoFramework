...
public class WifiVendorHal {
    ...
    private static final long[][] sChipFeatureCapabilityTranslation13 = {new long[]{1073741824, 4096}, new long[]{4294967296L, 8192}, new long[]{8589934592L, 268435456}};
    ...
    public void changeConfigForClientMode(String ifaceName, int typeIndex, boolean lowPrioritySta) {
        this.mHalDeviceManager.changeIfaceConfigForClientMode(ifaceName, typeIndex, lowPrioritySta);
    }
    ...
    public boolean flushRingBufferData() {
        synchronized (sLock) {
            ...
            try {
                boolean ok = ok(iWifiChipV13.flushRingBufferToFile());
                return ok;
            } catch (RemoteException e) {
                handleRemoteException(e);
                return false;
