    ...
    private boolean removeStaIface(Iface iface) {
        synchronized (this.mLock) {
            if (iface.name.equals(OppoWifiAssistantUtils.IFACE_NAME_WLAN1)) {
                ...
                boolean handleIfaceRemovalWhenVendorHalNotSupported2 = handleIfaceRemovalWhenVendorHalNotSupported(iface);
                return handleIfaceRemovalWhenVendorHalNotSupported2;
            }
        }
    }
