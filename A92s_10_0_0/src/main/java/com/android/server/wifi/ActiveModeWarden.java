...
public class ActiveModeWarden {
    ...
    /* access modifiers changed from: private */
    public boolean mForceTearDownFlag = true;
    /* access modifiers changed from: private */
    ...
    public class ModeStateMachine extends StateMachine {
        ...
        public boolean checkForAndHandleModeChange(Message message) {
            ...
            if (i == 0) {
                ...
                String unused = ActiveModeWarden.this.mNextState = this.mClientModeActiveState.getName();
                ...
                boolean unused2 = ActiveModeWarden.this.mForceTearDownFlag = false;
                ...
                String unused3 = ActiveModeWarden.this.mNextState = this.mScanOnlyModeActiveState.getName();
                Log.d(ActiveModeWarden.TAG, "WifiSpeedUp: Switching from " + getCurrentMode() + " to ScanOnlyMode");
                ActiveModeWarden.this.updateWifiStartInfo();
                boolean unused4 = ActiveModeWarden.this.mForceTearDownFlag = false;
                ...
                String unused5 = ActiveModeWarden.this.mNextState = this.mWifiDisabledState.getName();
                Log.d(ActiveModeWarden.TAG, "WifiSpeedUp: Switching from " + getCurrentMode() + " to WifiDisabled");
                ActiveModeWarden.this.updateWifiStartInfo();
                boolean unused6 = ActiveModeWarden.this.mForceTearDownFlag = false;
