...
public class OppoWifiAutoUpdate {
    ...
    /* access modifiers changed from: private */
    public OppoWifiUpdateData mCurUpdateData = null;
    /* access modifiers changed from: private */
    public DirectoryObserver mDirectoryObserver = null;
    /* access modifiers changed from: private */
    public Handler mHandler;
    private HandlerThread mHandlerThread = new HandlerThread(TAG);
    /* access modifiers changed from: private */
    public OppoWifiSauConfig mOppoWifiSauConfig = null;
    /* access modifiers changed from: private */
    public String mRecoveryMode = "none";
    /* access modifiers changed from: private */
    public String mRecoveryType = RECOVERY_TYPE_GENERAL;
    private String mSauConfigFilePath;
    private String mSauDirPath;
    /* access modifiers changed from: private */
    public String mSauFinishFilePath;
    /* access modifiers changed from: private */
    public int mSauStateMachine = 0;
    ...
    /* access modifiers changed from: private */
    public void wcnTriggerRecoveryAndWorks(String recoveryMode, String recoveryType) {
        if (DBG) {
    ...
    /* access modifiers changed from: private */
    public void wcnTriggerWifiObjUpdate(String updatePlatform, String objtype) {
        Log.d(TAG, "wcnTriggerWifiObjUpdate, updatePlatform = " + updatePlatform + " objtype = " + objtype);
        if ("mtk".equals(updatePlatform)) {
            SystemProperties.set("oppo.wifi.sau.mtk.objs.type", objtype);
            SystemProperties.set("oppo.wifi.sau.mtk.objs.update", "1");
        } else if ("qcom".equals(updatePlatform)) {
            SystemProperties.set("oppo.wifi.sau.qcom.objs.type", objtype);
            SystemProperties.set("oppo.wifi.sau.qcom.objs.update", "1");
        }
    }

    /* access modifiers changed from: private */
    public void wcnWifiObjUpdateCallBack(String updatePlatform, String recoverytype) {
        if ("mtk".equals(updatePlatform)) {
            String status = SystemProperties.get("oppo.sau.mtk.wifi.objs.status", "idle");
            ...
            SystemProperties.set("oppo.sau.mtk.wifi.objs.status", "idle");
        } else if ("qcom".equals(updatePlatform)) {
            String status2 = SystemProperties.get("oppo.sau.qcom.wifi.objs.status", "idle");
            Log.d(TAG, "sau updata qcom objs status = " + status2);
            ...
            SystemProperties.set("oppo.sau.qcom.wifi.objs.status", "idle");
        }
        wcnUpdateObjsProcess();
    }
            ...
            switch (msg.what) {
                case 1:
                    if (OppoWifiAutoUpdate.this.mSauStateMachine == 0) {
                        int unused = OppoWifiAutoUpdate.this.mSauStateMachine = 1;
                        ...
                        SystemProperties.set("oppo.wifi.sau.file.create", "1");
                        return;
                    }
                    Log.d(OppoWifiAutoUpdate.TAG, "wcn sau on going, assert ......");
                    return;
                case 2:
                    int unused2 = OppoWifiAutoUpdate.this.mSauStateMachine = 2;
                    OppoWifiAutoUpdate.this.wcnUpdateObjsPreProcess();
                    return;
                case 3:
                    int unused3 = OppoWifiAutoUpdate.this.mSauStateMachine = 3;
                    ...
                    return;
                case 4:
                    int unused4 = OppoWifiAutoUpdate.this.mSauStateMachine = 4;
                    ...
                    return;
                case 5:
                    int unused5 = OppoWifiAutoUpdate.this.mSauStateMachine = 5;
                    OppoWifiAutoUpdate.this.wcnUpdateObjsProcess();
                    return;
                case 6:
                    int unused6 = OppoWifiAutoUpdate.this.mSauStateMachine = 6;
