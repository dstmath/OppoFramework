...
public class HalDeviceManager {
    ...
    private final Map<Pair<String, Integer>, InterfaceCacheEntry> mInterfaceInfoCache = new ConcurrentHashMap();
    /* access modifiers changed from: private */
    ...
    private class WifiChipInfo {
        ...
        public String toString() {
            ...
            int[] access$300 = HalDeviceManager.IFACE_TYPES_BY_PRIORITY;
            for (int type : access$300) {
    ...
    public void changeIfaceConfigForClientMode(String ifaceName, int ifaceType, boolean lowPrioritySta) {
        InterfaceCacheEntry ifaceEntry = this.mInterfaceInfoCache.get(Pair.create(ifaceName, Integer.valueOf(IFACE_TYPES_BY_PRIORITY[ifaceType])));
        if (ifaceEntry != null) {
            ifaceEntry.isLowPriority = lowPrioritySta;
        } else {
            Log.e(TAG, "failed to change low priority");
        }
    }
    ...
    public class ServiceManagerDeathRecipient implements IHwBinder.DeathRecipient {
        ...
        public void serviceDied(long cookie) {
            HalDeviceManager.this.mEventHandler.post(new Runnable(cookie) {
                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$ServiceManagerDeathRecipient$U_1q7n0hMOoBOJLqN7VombSCp0 */
                ...
                public final void run() {
                    HalDeviceManager.ServiceManagerDeathRecipient.this.lambda$serviceDied$0$HalDeviceManager$ServiceManagerDeathRecipient(this.f$1);
                }
            });
        }

        public /* synthetic */ void lambda$serviceDied$0$HalDeviceManager$ServiceManagerDeathRecipient(long cookie) {
            Log.wtf(HalDeviceManager.TAG, "IServiceManager died: cookie=" + cookie);
            synchronized (HalDeviceManager.this.mLock) {
                IServiceManager unused = HalDeviceManager.this.mServiceManager = null;
            }
        }
    }
                    ...
                    while (it.hasNext()) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            for (int[] expandedIfaceCombo : expandedIfaceCombos) {
                                if (expandedIfaceCombo[0] > 0 && expandedIfaceCombo[1] > 0) {
                                    return true;
                                }
                            }
                        }
    ...
    public class WifiDeathRecipient implements IHwBinder.DeathRecipient {
        ...
        public void serviceDied(long cookie) {
            HalDeviceManager.this.mEventHandler.post(new Runnable(cookie) {
                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$WifiDeathRecipient$izwdRp0q_NiZzo8DpCrMuSyR3ow */
                private final /* synthetic */ long f$1;
                ...
                public final void run() {
                    HalDeviceManager.WifiDeathRecipient.this.lambda$serviceDied$0$HalDeviceManager$WifiDeathRecipient(this.f$1);
                }
            });
        }

        public /* synthetic */ void lambda$serviceDied$0$HalDeviceManager$WifiDeathRecipient(long cookie) {
            Log.e(HalDeviceManager.TAG, "IWifi HAL service died! Have a listener for it ... cookie=" + cookie);
            synchronized (HalDeviceManager.this.mLock) {
                IWifi unused = HalDeviceManager.this.mWifi = null;
                boolean unused2 = HalDeviceManager.this.mIsReady = false;
    ...
    private static /* synthetic */ void lambda$initIWifiChipDebugListeners$1(MutableBoolean statusOk, HidlSupport.Mutable chipIdsResp, WifiStatus status, ArrayList chipIds) {
    ...
    private static /* synthetic */ void lambda$initIWifiChipDebugListeners$2(MutableBoolean statusOk, HidlSupport.Mutable chipResp, WifiStatus status, IWifiChip chip) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            chipResp.value = chip;
            return;
        ...
        synchronized (this.mLock) {
            ...
            try {
                ...
                this.mWifi.getChipIds(new IWifi.getChipIdsCallback(statusOk, chipIdsResp) {
                    /* class com.android.server.wifi.$$Lambda$HalDeviceManager$6w16jB8pZLVU7YADJE0VvaaYitE */
                    ...
                    public final void onValues(WifiStatus wifiStatus, ArrayList arrayList) {
                        HalDeviceManager.lambda$getAllChipInfo$3(this.f$0, this.f$1, wifiStatus, arrayList);
                    }
                });
                if (!statusOk.value) {
                    return null;
                ...
                while (ifaceNamesResp.hasNext()) {
                    ...
                    this.mWifi.getChip(chipId.intValue(), new IWifi.getChipCallback(statusOk, chipResp) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$tjTUyYNORRpPEjxeLIKG9EEUQiY */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                        ...
                        public final void onValues(WifiStatus wifiStatus, IWifiChip iWifiChip) {
                            HalDeviceManager.lambda$getAllChipInfo$4(this.f$0, this.f$1, wifiStatus, iWifiChip);
                        }
                    });
                    if (!statusOk.value) {
                    ...
                    ((IWifiChip) chipResp.value).getAvailableModes(new IWifiChip.getAvailableModesCallback(statusOk, availableModesResp) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$1UDn8n9YAGvAmXDxz87KHqnpM4 */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                    ...
                    ((IWifiChip) chipResp.value).getMode(new IWifiChip.getModeCallback(statusOk, currentModeValidResp, currentModeResp) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$axIcBXpOAdZsSgEeHBmVXLjliA */
                        private final /* synthetic */ MutableBoolean f$0;
                        ...
                        public final void onValues(WifiStatus wifiStatus, int i) {
                            HalDeviceManager.lambda$getAllChipInfo$6(this.f$0, this.f$1, this.f$2, wifiStatus, i);
                        }
                    });
                    if (!statusOk.value) {
                        return wifiChipInfoArr;
                    ...
                    ((IWifiChip) chipResp.value).getStaIfaceNames(new IWifiChip.getStaIfaceNamesCallback(statusOk, ifaceNamesResp2) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$spuDlpQhwFKvvltFJ_1kakLmNQQ */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                    ...
                    while (it.hasNext()) {
                        ...
                        ((IWifiChip) chipResp.value).getStaIface(ifaceName, new IWifiChip.getStaIfaceCallback(statusOk, ifaceName, staIfaces, ifaceIndex) {
                            /* class com.android.server.wifi.$$Lambda$HalDeviceManager$E_Yiw8cTjDWNEBF471tK3UiZmUE */
                            private final /* synthetic */ MutableBoolean f$1;
                            ...
                            public final void onValues(WifiStatus wifiStatus, IWifiStaIface iWifiStaIface) {
                                HalDeviceManager.this.lambda$getAllChipInfo$8$HalDeviceManager(this.f$1, this.f$2, this.f$3, this.f$4, wifiStatus, iWifiStaIface);
                            }
                        });
                        if (!statusOk.value) {
                            return null;
                    ...
                    ((IWifiChip) chipResp.value).getApIfaceNames(new IWifiChip.getApIfaceNamesCallback(statusOk, ifaceNamesResp3) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$XIhbquoQ3_K7T7moKDH8FWJeYA */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                    ...
                    while (it2.hasNext()) {
                        ...
                        ((IWifiChip) chipResp.value).getApIface(ifaceName2, new IWifiChip.getApIfaceCallback(statusOk, ifaceName2, apIfaces, ifaceIndex) {
                            /* class com.android.server.wifi.$$Lambda$HalDeviceManager$L_kWw3ULQHr_a88xUfCOz369uS0 */
                            private final /* synthetic */ MutableBoolean f$1;
                            private final /* synthetic */ String f$2;
                            private final /* synthetic */ HalDeviceManager.WifiIfaceInfo[] f$3;
                            private final /* synthetic */ MutableInt f$4;
                            ...
                            public final void onValues(WifiStatus wifiStatus, IWifiApIface iWifiApIface) {
                                HalDeviceManager.this.lambda$getAllChipInfo$10$HalDeviceManager(this.f$1, this.f$2, this.f$3, this.f$4, wifiStatus, iWifiApIface);
                            }
                        });
                        if (!statusOk.value) {
                            return null;
                    ...
                    ((IWifiChip) chipResp.value).getP2pIfaceNames(new IWifiChip.getP2pIfaceNamesCallback(statusOk, ifaceNamesResp3) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$mmYeQbcWolMW27v2Kn7Z4h2iLM */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                    ...
                    while (it3.hasNext()) {
                        ...
                        ((IWifiChip) chipResp.value).getP2pIface(ifaceName3, new IWifiChip.getP2pIfaceCallback(statusOk, ifaceName3, p2pIfaces, ifaceIndex) {
                            /* class com.android.server.wifi.$$Lambda$HalDeviceManager$qaoL1BLdY4e8B30BsYdu_jBW_XQ */
                            private final /* synthetic */ MutableBoolean f$1;
                            private final /* synthetic */ String f$2;
                            private final /* synthetic */ HalDeviceManager.WifiIfaceInfo[] f$3;
                            private final /* synthetic */ MutableInt f$4;
                            ...
                            public final void onValues(WifiStatus wifiStatus, IWifiP2pIface iWifiP2pIface) {
                                HalDeviceManager.this.lambda$getAllChipInfo$12$HalDeviceManager(this.f$1, this.f$2, this.f$3, this.f$4, wifiStatus, iWifiP2pIface);
                            }
                        });
                        if (!statusOk.value) {
                            return null;
                    ...
                    ((IWifiChip) chipResp.value).getNanIfaceNames(new IWifiChip.getNanIfaceNamesCallback(statusOk, ifaceNamesResp3) {
                        /* class com.android.server.wifi.$$Lambda$HalDeviceManager$wxIKVkc_G9xfKqecPHsKjYpiUek */
                        private final /* synthetic */ MutableBoolean f$0;
                        private final /* synthetic */ HidlSupport.Mutable f$1;
                    ...
                    while (it4.hasNext()) {
                        ...
                        ((IWifiChip) chipResp.value).getNanIface(ifaceName4, new IWifiChip.getNanIfaceCallback(statusOk, ifaceName4, nanIfaces, ifaceIndex) {
                            /* class com.android.server.wifi.$$Lambda$HalDeviceManager$ga6h8brNknPoJQM4vr1ui22Q1E */
                            private final /* synthetic */ MutableBoolean f$1;
                            private final /* synthetic */ String f$2;
                            private final /* synthetic */ HalDeviceManager.WifiIfaceInfo[] f$3;
                            private final /* synthetic */ MutableInt f$4;
                            ...
                            public final void onValues(WifiStatus wifiStatus, IWifiNanIface iWifiNanIface) {
                                HalDeviceManager.this.lambda$getAllChipInfo$14$HalDeviceManager(this.f$1, this.f$2, this.f$3, this.f$4, wifiStatus, iWifiNanIface);
                            }
                        });
                        if (!statusOk.value) {
                            return null;
    ...
    static /* synthetic */ void lambda$getAllChipInfo$3(MutableBoolean statusOk, HidlSupport.Mutable chipIdsResp, WifiStatus status, ArrayList chipIds) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            chipIdsResp.value = chipIds;
            return;
    ...
    static /* synthetic */ void lambda$getAllChipInfo$4(MutableBoolean statusOk, HidlSupport.Mutable chipResp, WifiStatus status, IWifiChip chip) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            chipResp.value = chip;
            return;
    ...
    static /* synthetic */ void lambda$getAllChipInfo$5(MutableBoolean statusOk, HidlSupport.Mutable availableModesResp, WifiStatus status, ArrayList modes) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
    ...
    static /* synthetic */ void lambda$getAllChipInfo$6(MutableBoolean statusOk, MutableBoolean currentModeValidResp, MutableInt currentModeResp, WifiStatus status, int modeId) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
    ...
    static /* synthetic */ void lambda$getAllChipInfo$7(MutableBoolean statusOk, HidlSupport.Mutable ifaceNamesResp, WifiStatus status, ArrayList ifnames) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
    ...
    public /* synthetic */ void lambda$getAllChipInfo$8$HalDeviceManager(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] staIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiStaIface iface) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
    ...
    public /* synthetic */ void lambda$getAllChipInfo$10$HalDeviceManager(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] apIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiApIface iface) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            WifiIfaceInfo ifaceInfo = new WifiIfaceInfo();
            ifaceInfo.name = ifaceName;
    ...
    public /* synthetic */ void lambda$getAllChipInfo$12$HalDeviceManager(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] p2pIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiP2pIface iface) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            WifiIfaceInfo ifaceInfo = new WifiIfaceInfo();
            ifaceInfo.name = ifaceName;
    ...
    public /* synthetic */ void lambda$getAllChipInfo$14$HalDeviceManager(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] nanIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiNanIface iface) {
        statusOk.value = status.code == 0;
        if (statusOk.value) {
            WifiIfaceInfo ifaceInfo = new WifiIfaceInfo();
            ifaceInfo.name = ifaceName;
            ...
            try {
                if (this.mWifi == null) {
                    ...
                    if (status.code != 0) {
                        ...
                        OppoWifiSwitchStats wifiSwitchStats = OppoWifiSwitchStats.getInstanceOrNull();
                        if (wifiSwitchStats != null) {
                            wifiSwitchStats.informWifiTurnOffResult(6);
                        }
                    }
                    teardownInternal();
                }
    ...
    public class WifiEventCallback extends IWifiEventCallback.Stub {
        ...
        public void onStart() throws RemoteException {
            HalDeviceManager.this.mEventHandler.post($$Lambda$HalDeviceManager$WifiEventCallback$_i4o2132jDU7ZInjXnyCOhK1row.INSTANCE);
        }
        ...
        public void onStop() throws RemoteException {
            HalDeviceManager.this.mEventHandler.post($$Lambda$HalDeviceManager$WifiEventCallback$Z2vn7iq_LcTSEJAjxjhQ4fUbs.INSTANCE);
        }
        ...
        public void onFailure(WifiStatus status) throws RemoteException {
            HalDeviceManager.this.mEventHandler.post(new Runnable(status) {
                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$WifiEventCallback$sPBNqijXq6rJiZfPmeFTcgJEtsE */
                private final /* synthetic */ WifiStatus f$1;
                ...
                public final void run() {
                    HalDeviceManager.WifiEventCallback.this.lambda$onFailure$2$HalDeviceManager$WifiEventCallback(this.f$1);
                }
            });
        }

        public /* synthetic */ void lambda$onFailure$2$HalDeviceManager$WifiEventCallback(WifiStatus status) {
        ...
        if (chip != null) {
            ...
            try {
                chip.getId(new IWifiChip.getIdCallback(chipIdIfProvided, statusOk) {
                    /* class com.android.server.wifi.$$Lambda$HalDeviceManager$XzncbqoCXS8sP0hu9a10hRiTAk4 */
                    ...
                    public final void onValues(WifiStatus wifiStatus, int i) {
                        HalDeviceManager.lambda$getSupportedIfaceTypesInternal$15(this.f$0, this.f$1, wifiStatus, i);
                    }
                });
                if (!statusOk.value) {
                    return results;
    ...
    static /* synthetic */ void lambda$getSupportedIfaceTypesInternal$15(MutableInt chipIdIfProvided, MutableBoolean statusOk, WifiStatus status, int id) {
        if (status.code == 0) {
    ...
    private List<WifiIfaceInfo> selectInterfacesToDelete(int excessInterfaces, WifiIfaceInfo[] interfaces) {
        ...
        while (true) {
            ...
            synchronized (this.mLock) {
                cacheEntry = this.mInterfaceInfoCache.get(Pair.create(info.name, Integer.valueOf(getType(info.iface))));
            }
            if (cacheEntry == null) {
                    ...
                    if (ifaceCreationData.chipInfo.currentModeId == ifaceCreationData.chipModeId) {
                        ...
                        if (ifaceType != 0) {
                            ifaceCreationData.chipInfo.chip.createStaIface(new IWifiChip.createStaIfaceCallback(statusResp, ifaceResp) {
                                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$hd_Zf1g_PPiyzTcZQoo9vZEp9SA */
                                private final /* synthetic */ HidlSupport.Mutable f$0;
                                private final /* synthetic */ HidlSupport.Mutable f$1;
                                ...
                                public final void onValues(WifiStatus wifiStatus, IWifiStaIface iWifiStaIface) {
                                    HalDeviceManager.lambda$executeChipReconfiguration$16(this.f$0, this.f$1, wifiStatus, iWifiStaIface);
                                }
                            });
                        } else if (ifaceType == 1) {
                            ifaceCreationData.chipInfo.chip.createApIface(new IWifiChip.createApIfaceCallback(statusResp, ifaceResp) {
                                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$yeW_vMlE36ta0SUB1MsqHOABA */
                                private final /* synthetic */ HidlSupport.Mutable f$0;
                                private final /* synthetic */ HidlSupport.Mutable f$1;
                                ...
                                public final void onValues(WifiStatus wifiStatus, IWifiApIface iWifiApIface) {
                                    HalDeviceManager.lambda$executeChipReconfiguration$17(this.f$0, this.f$1, wifiStatus, iWifiApIface);
                                }
                            });
                        } else if (ifaceType == 2) {
                            ifaceCreationData.chipInfo.chip.createP2pIface(new IWifiChip.createP2pIfaceCallback(statusResp, ifaceResp) {
                                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$ifQi_DVTW516QzSBb_P6qBAE */
                                private final /* synthetic */ HidlSupport.Mutable f$0;
                                private final /* synthetic */ HidlSupport.Mutable f$1;
                                ...
                                public final void onValues(WifiStatus wifiStatus, IWifiP2pIface iWifiP2pIface) {
                                    HalDeviceManager.lambda$executeChipReconfiguration$18(this.f$0, this.f$1, wifiStatus, iWifiP2pIface);
                                }
                            });
                        } else if (ifaceType == 3) {
                            ifaceCreationData.chipInfo.chip.createNanIface(new IWifiChip.createNanIfaceCallback(statusResp, ifaceResp) {
                                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$bwqScSKBQ4Ja9Xf8pl9khllq7o */
                                private final /* synthetic */ HidlSupport.Mutable f$0;
                                private final /* synthetic */ HidlSupport.Mutable f$1;
                                ...
                                public final void onValues(WifiStatus wifiStatus, IWifiNanIface iWifiNanIface) {
                                    HalDeviceManager.lambda$executeChipReconfiguration$19(this.f$0, this.f$1, wifiStatus, iWifiNanIface);
                                }
                            });
                        }
    ...
    static /* synthetic */ void lambda$executeChipReconfiguration$16(HidlSupport.Mutable statusResp, HidlSupport.Mutable ifaceResp, WifiStatus status, IWifiStaIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$executeChipReconfiguration$17(HidlSupport.Mutable statusResp, HidlSupport.Mutable ifaceResp, WifiStatus status, IWifiApIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$executeChipReconfiguration$18(HidlSupport.Mutable statusResp, HidlSupport.Mutable ifaceResp, WifiStatus status, IWifiP2pIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$executeChipReconfiguration$19(HidlSupport.Mutable statusResp, HidlSupport.Mutable ifaceResp, WifiStatus status, IWifiNanIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }
                ...
                if (chipInfo.currentModeIdValid) {
                    ...
                    try {
                        chipInfo.chip.createRttController(null, new IWifiChip.createRttControllerCallback(rttResp) {
                            /* class com.android.server.wifi.$$Lambda$HalDeviceManager$YV8oujETIpv3rGbYkL9DWvXsnU0 */
                            private final /* synthetic */ HidlSupport.Mutable f$0;
                            ...
                            public final void onValues(WifiStatus wifiStatus, IWifiRttController iWifiRttController) {
                                HalDeviceManager.lambda$createRttControllerIfPossible$20(this.f$0, wifiStatus, iWifiRttController);
                            }
                        });
                    } catch (RemoteException e) {
    ...
    static /* synthetic */ void lambda$createRttControllerIfPossible$20(HidlSupport.Mutable rttResp, WifiStatus status, IWifiRttController rtt) {
        if (status.code == 0) {
            rttResp.value = rtt;
            return;
        }
    ...
    private static int getType(IWifiIface iface) {
        ...
        try {
            iface.getType(new IWifiIface.getTypeCallback(typeResp) {
                /* class com.android.server.wifi.$$Lambda$HalDeviceManager$Adozeaj9aliSeKW7ByyrhD_bHok */
                private final /* synthetic */ MutableInt f$0;
                ...
                public final void onValues(WifiStatus wifiStatus, int i) {
                    HalDeviceManager.lambda$getType$21(this.f$0, wifiStatus, i);
                }
            });
        } catch (RemoteException e) {
    ...
    static /* synthetic */ void lambda$getType$21(MutableInt typeResp, WifiStatus status, int type) {
        if (status.code == 0) {
            typeResp.value = type;
            return;
        }
