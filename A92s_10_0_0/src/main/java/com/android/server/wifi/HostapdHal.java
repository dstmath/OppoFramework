...
public class HostapdHal {
    ...
    public HostapdHal(Context context, Looper looper) {
        ...
        this.mEnableAcs = context.getResources().getBoolean(17891592);
        this.mEnableIeee80211AC = context.getResources().getBoolean(17891593);
        this.mAcsChannelRanges = toAcsChannelRanges(context.getResources().getString(17039779));
    ...
    private boolean linkToHostapdDeath(IHwBinder.DeathRecipient deathRecipient, long cookie) {
        synchronized (this.mLock) {
            if (this.mIHostapd == null) {
                return false;
            }
            try {
                if (this.mIHostapd.linkToDeath(deathRecipient, cookie)) {
                    return true;
                }
    ...
    public boolean addAccessPoint(String ifaceName, WifiConfiguration config, WifiNative.SoftApListener listener) {
        ...
        synchronized (this.mLock) {
            ...
            try {
                ...
                if (!MtkSoftApUtils.overwriteApChannelIfNeed(this.mContext, ifaceParams)) {
                    if (this.mEnableAcs) {
    ...
    public void terminate() {
        synchronized (this.mLock) {
            ...
            linkToHostapdDeath(new IHwBinder.DeathRecipient(waitForDeathCookie, waitForDeathLatch) {
                /* class com.android.server.wifi.$$Lambda$HostapdHal$oKXiQTFQmEsC0_vmGf5AxSSjglQ */
                ...
                public final void serviceDied(long j) {
                    HostapdHal.lambda$terminate$0(this.f$0, this.f$1, j);
                }
            }, waitForDeathCookie);
    ...
    static /* synthetic */ void lambda$terminate$0(long waitForDeathCookie, CountDownLatch waitForDeathLatch, long cookie) {
