...
public class WifiP2pServiceImpl extends IWifiP2pManager.Stub {
    ...
    /* access modifiers changed from: private */
    public int mFastConTriggeredNum = 0;
    /* access modifiers changed from: private */
    public int mFindTimes = 0;
    /* access modifiers changed from: private */
    public boolean mFoundTargetDevice = false;
    /* access modifiers changed from: private */
    public FrameworkFacade mFrameworkFacade;
    /* access modifiers changed from: private */
    public String mIntentToConnectPeer = "";
    /* access modifiers changed from: private */
    public IIpClient mIpClient;
    /* access modifiers changed from: private */
    public int mIpClientStartIndex = 0;
    /* access modifiers changed from: private */
    public boolean mIsExternalShareConnect = false;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public OppoWifiP2pConnectionHelper mOppoWifiP2pConnectionHelper;
    /* access modifiers changed from: private */
    public OppoWifiP2pNotifyService mOppoWifiP2pNotifyService;
    /* access modifiers changed from: private */
    public OppoWifiP2pStats mOppoWifiP2pStats;
    /* access modifiers changed from: private */
    public int mP2pConnectFreq = 0;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public OppoWifiDisplayUsageHelper mWifiDisplayUsageHelper = new OppoWifiDisplayUsageHelper();
    /* access modifiers changed from: private */
            ...
            switch (msg.what) {
                ...
                case 139277:
                    if (WifiP2pServiceImpl.this.mWifiInjector == null) {
                        WifiInjector unused = WifiP2pServiceImpl.this.mWifiInjector = WifiInjector.getInstance();
                    }
    ...
    public class P2pStateMachine extends StateMachine {
        ...
        /* access modifiers changed from: private */
        public WifiController mWifiController = WifiInjector.getInstance().getWifiController();
        /* access modifiers changed from: private */
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case 139358:
                        ...
                        p2pStateMachine10.replyToMessage(message, 139359, WifiP2pServiceImpl.this.mNetworkInfo);
                        break;
                    case 139360:
                    ...
                    case 139361:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            ...
                            p2pStateMachine11.replyToMessage(message, 139362, p2pStateMachine11.maybeEraseOwnDeviceAddress(WifiP2pServiceImpl.this.mThisDevice, message.sendingUid));
                            break;
                        } else {
                ...
                switch (message.what) {
                    case 139265:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, true)) {
                            if (WifiP2pServiceImpl.this.mDiscoveryBlocked && !OppoWifiP2pConnectionHelper.isNfcTriggered()) {
                                ...
                                boolean unused = WifiP2pServiceImpl.this.mFoundTargetDevice = false;
                                if (message.arg1 == 0) {
                    ...
                    case 139366:
                        ...
                        if (hVariables != null && WifiP2pServiceImpl.this.mOppoWifiP2pConnectionHelper != null) {
                            ...
                            P2pStateMachine.this.replyToMessage(message, 139369, new WifiP2pGroup(group));
                            break;
                        } else {
                            P2pStateMachine.this.replyToMessage(message, 139367, 0);
                            break;
                        }
                    case 139374:
                    ...
                    case WifiP2pServiceImpl.BLOCK_DISCOVERY /*{ENCODED_INT: 143375}*/:
                        ...
                        if (WifiP2pServiceImpl.this.mDiscoveryBlocked != blocked) {
                            boolean unused2 = WifiP2pServiceImpl.this.mDiscoveryBlocked = blocked;
                            if (blocked && WifiP2pServiceImpl.this.mDiscoveryStarted) {
                                P2pStateMachine.this.mWifiNative.p2pStopFind();
                                boolean unused3 = WifiP2pServiceImpl.this.mDiscoveryPostponed = true;
                            }
                    ...
                    case WifiP2pServiceImpl.REMOVE_CLIENT_INFO /*{ENCODED_INT: 143378}*/:
                        ...
                        break;
                    case WifiP2pServiceImpl.AUTO_ACCEPT_INVITATION_TIME_OUT /*{ENCODED_INT: 143379}*/:
                        ...
                        break;
                    case WifiP2pServiceImpl.P2P_FIND_SPECIAL_FREQ_TIME_OUT /*{ENCODED_INT: 143380}*/:
                        if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                        ...
                        if (!WifiP2pServiceImpl.this.mFoundTargetDevice && WifiP2pServiceImpl.this.mFindTimes < 5) {
                            ...
                            int unused5 = WifiP2pServiceImpl.this.mFindTimes = 0;
                            boolean unused6 = WifiP2pServiceImpl.this.mFoundTargetDevice = false;
                            break;
                        }
                    case WifiP2pServiceImpl.P2P_COUNTRYCODE_CHNAGED /*{ENCODED_INT: 143395}*/:
                        ...
                        if (message.obj != null) {
                            ...
                            if (!WifiP2pServiceImpl.this.mThisDevice.deviceAddress.equals(device.deviceAddress)) {
                                ...
                                if (!WifiP2pServiceImpl.this.mIntentToConnectPeer.isEmpty() && WifiP2pServiceImpl.this.mIntentToConnectPeer.equalsIgnoreCase(device.deviceAddress)) {
                                    ...
                                    boolean unused7 = WifiP2pServiceImpl.this.mFoundTargetDevice = true;
                                    String unused8 = WifiP2pServiceImpl.this.mIntentToConnectPeer = "";
                ...
                switch (message.what) {
                    ...
                    case 139271:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            ...
                            int unused2 = WifiP2pServiceImpl.this.mP2pConnectFreq = message.arg1;
                            if (WifiP2pServiceImpl.this.mP2pConnectFreq != 0) {
                                int unused3 = WifiP2pServiceImpl.this.mFindTimes = 0;
                                if (config != null) {
                                    String unused4 = WifiP2pServiceImpl.this.mIntentToConnectPeer = config.deviceAddress;
                            ...
                            if (P2pStateMachine.this.isConfigValidAsGroup(config)) {
                                ...
                                boolean unused6 = WifiP2pServiceImpl.this.mAutonomousGroup = false;
                                P2pStateMachine.this.mWifiNative.p2pStopFind();
                                ...
                                long unused7 = WifiP2pServiceImpl.this.mp2pStartedTime = System.currentTimeMillis();
                            }
                            if (!isConnectFailed) {
                                WifiP2pConfig unused8 = P2pStateMachine.this.mSavedPeerConfig = config;
                    ...
                    case 139277:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            boolean unused9 = WifiP2pServiceImpl.this.mAutonomousGroup = true;
                    ...
                    case WifiP2pMonitor.P2P_GO_NEGOTIATION_REQUEST_EVENT:
                        ...
                        if (!P2pStateMachine.this.isConfigInvalid(config3)) {
                            WifiP2pConfig unused10 = P2pStateMachine.this.mSavedPeerConfig = config3;
                            boolean unused11 = WifiP2pServiceImpl.this.mAutonomousGroup = false;
                            boolean unused12 = WifiP2pServiceImpl.this.mJoinExistingGroup = false;
                    ...
                    case WifiP2pMonitor.P2P_GROUP_STARTED_EVENT:
                        if (message.obj != null) {
                            P2pStateMachine.this.mWifiController.setP2pIsConnectingFlag(true);
                            WifiP2pGroup unused13 = P2pStateMachine.this.mGroup = (WifiP2pGroup) message.obj;
                            if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                P2pStateMachine p2pStateMachine18 = P2pStateMachine.this;
                            ...
                            if (P2pStateMachine.this.mGroup.getNetworkId() != -2) {
                                ...
                                boolean unused14 = WifiP2pServiceImpl.this.mAutonomousGroup = false;
                                P2pStateMachine.this.deferMessage(message);
                                P2pStateMachine p2pStateMachine20 = P2pStateMachine.this;
                    ...
                    case WifiP2pMonitor.P2P_INVITATION_RECEIVED_EVENT:
                        if (message.obj != null) {
                            ...
                            if (!P2pStateMachine.this.isConfigInvalid(config4)) {
                                WifiP2pConfig unused15 = P2pStateMachine.this.mSavedPeerConfig = config4;
                                ...
                                boolean unused17 = WifiP2pServiceImpl.this.mJoinExistingGroup = true;
                    ...
                    case WifiP2pMonitor.P2P_PROV_DISC_SHOW_PIN_EVENT:
                        if (message.obj != null) {
                            ...
                            if (device != null) {
                                WifiP2pConfig unused18 = P2pStateMachine.this.mSavedPeerConfig = new WifiP2pConfig();
                                P2pStateMachine.this.mSavedPeerConfig.wps.setup = 2;
        ...
        public class GroupNegotiationState extends State {
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pMonitor.P2P_GROUP_STARTED_EVENT:
                        if (message.obj != null) {
                            WifiP2pGroup unused = P2pStateMachine.this.mGroup = (WifiP2pGroup) message.obj;
                            if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                P2pStateMachine p2pStateMachine7 = P2pStateMachine.this;
                            ...
                            if (P2pStateMachine.this.mGroup.isGroupOwner()) {
                                ...
                                P2pStateMachine.this.mWifiNative.setP2pGroupIdle(P2pStateMachine.this.mGroup.getInterface(), 10);
                                boolean unused2 = WifiP2pServiceImpl.this.mIsExternalShareConnect = WifiP2pServiceImpl.this.isExternalShareConnect(P2pStateMachine.this.mGroup.getOwner().deviceAddress);
                        ...
                        if (status != P2pStatus.SUCCESS) {
                            ...
                            if (status != P2pStatus.UNKNOWN_P2P_GROUP) {
                                ...
                                if (netId >= 0) {
                                    ...
                                    P2pStateMachine p2pStateMachine17 = P2pStateMachine.this;
                                    boolean unused3 = p2pStateMachine17.removeClientFromList(netId, p2pStateMachine17.mSavedPeerConfig.deviceAddress, true);
                                }
                                P2pStateMachine.this.mSavedPeerConfig.netId = -2;
                                P2pStateMachine p2pStateMachine18 = P2pStateMachine.this;
        ...
        public class FrequencyConflictState extends State {
            ...
            public void enter() {
                ...
                if (WifiP2pServiceImpl.this.mOppoWifiP2pNotifyService != null) {
                    OppoWifiP2pNotifyService access$1500 = WifiP2pServiceImpl.this.mOppoWifiP2pNotifyService;
                    Context access$1300 = WifiP2pServiceImpl.this.mContext;
                    P2pStateMachine p2pStateMachine = P2pStateMachine.this;
                    this.mFrequencyConflictDialog = access$1500.notifyFrequencyConflict(access$1300, p2pStateMachine.getDeviceName(p2pStateMachine.mSavedPeerConfig.deviceAddress));
                }
            }
                        ...
                        if (message.obj != null) {
                            ...
                            if (deviceAddress == null) {
                                ...
                                if (P2pStateMachine.this.mGroup.removeClient(deviceAddress)) {
                                    if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                        P2pStateMachine p2pStateMachine19 = P2pStateMachine.this;
                                        p2pStateMachine19.logd("Removed client " + deviceAddress);
                                    }
                                    ...
                                    if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                        P2pStateMachine p2pStateMachine20 = P2pStateMachine.this;
                                        p2pStateMachine20.logd("Failed to remove client " + deviceAddress);
                                    }
                                    for (WifiP2pDevice c : P2pStateMachine.this.mGroup.getClientList()) {
                                        if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                            P2pStateMachine p2pStateMachine21 = P2pStateMachine.this;
                                            p2pStateMachine21.logd("client " + c.deviceAddress);
                                        }
                                    }
                                }
                                P2pStateMachine.this.sendPeersChangedBroadcast();
        ...
        public void notifyInvitationReceived() {
            ...
            if (WifiP2pServiceImpl.this.mOppoWifiP2pNotifyService != null) {
                ...
                access$1500.notifyInvitationReceived(access$1300, wifiP2pConfig, getDeviceName(wifiP2pConfig.deviceAddress), getName(), isExternalShareConnect);
            }
        }
    ...
    /* access modifiers changed from: private */
    public boolean isExternalShareConnect(String targetaddress) {
