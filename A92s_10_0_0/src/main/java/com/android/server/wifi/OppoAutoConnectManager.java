...
public class OppoAutoConnectManager {
    ...
    private static final String DEFAULT_OPERATOR_AP_SSID = "Swisscom_Auto_Login,Wi-Fi EAP Bouygues Telecom,TURKCELL";
    ...
    private final BroadcastReceiver mBroadcastReciever = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action == null) {
                ...
                boolean unused = OppoAutoConnectManager.this.mScreenOn = false;
            }
        }
    };
    ...
    /* access modifiers changed from: private */
    public HashMap<Integer, String> mEvtStrHashMap = new HashMap<>();
    ...
    /* access modifiers changed from: private */
    public int mLastManuReassociateToken = 0;
    ...
    /* access modifiers changed from: private */
    public boolean mWifiAssistantEnabled = true;
    /* access modifiers changed from: private */
    public boolean mWifiAssistantRomupdate = true;
    private boolean mWlanAssistConnect = true;

    public class OppoAutoConnectConfiguration {
        /* access modifiers changed from: private */
        public String mConfigKey = null;
        /* access modifiers changed from: private */
        public int mConituousDebounceDisconnectCount = 0;
        /* access modifiers changed from: private */
        public int mContinuousDisabledCount = 0;
        /* access modifiers changed from: private */
        public int mDisabledLevel = -127;
        /* access modifiers changed from: private */
        public int mDisabledReason = 0;
        /* access modifiers changed from: private */
        public long mDisabledUntilTime = System.currentTimeMillis();
        /* access modifiers changed from: private */
    ...
    private void clearLastConnectedConfiguration(String configKey) {
        ...
        if (oppoAutoConnectConfiguration == null) {
            ...
            String unused = this.mLastConnectedConfiguration.mConfigKey = null;
            String unused2 = this.mLastConnectedConfiguration.mPwd = null;
            int unused3 = this.mLastConnectedConfiguration.mDisabledReason = 0;
            int unused4 = this.mLastConnectedConfiguration.mConituousDebounceDisconnectCount = 0;
            int unused5 = this.mLastConnectedConfiguration.mContinuousDisabledCount = 0;
            int unused6 = this.mLastConnectedConfiguration.mDisabledLevel = -127;
            long unused7 = this.mLastConnectedConfiguration.mDisabledUntilTime = 0;
            long unused8 = this.mLastConnectedConfiguration.mLastConnectedTime = 0;
        }
    }
    ...
    /* JADX INFO: Multiple debug info for r2v1 int: [D('baseTime' long), D('integerMultiple' int)] */
    /* JADX INFO: Multiple debug info for r2v51 long: [D('assocRejectRetryTimeMin' int), D('keepDisabledUntilAdd' long)] */
    ...
    private long getKeepDisabledUntil(OppoAutoConnectConfiguration oppoAutoConnConf) {
        ...
        int wrongKeyExpBase3 = getWrongKeyExpBase();
        ...
        int access$300 = oppoAutoConnConf.mDisabledReason;
        if (access$300 != 0) {
            if (access$300 == 13) {
                ...
                if (continuousDisabledCount < wrongKeyStepCount) {
                    ...
                    wrongKeyExpBase = wrongKeyExpBase3;
                ...
                if (hashMap == null || hashMap.get(oppoAutoConnConf.mConfigKey) != null) {
                    ...
                    if (hashMap2 != null && hashMap2.get(oppoAutoConnConf.mConfigKey) != null) {
                        ...
                        if (unexpectDisconnectCount2 <= 30) {
                            i = unexpectDisconnectCount2;
                        }
                        unexpectDisconnectCount = i;
                ...
                wrongKeyExpBase = wrongKeyExpBase3;
            } else if (access$300 == 102) {
                authFailureExpBase = assocRejectExpBase;
                oppoAutoConnectManager = this;
                wrongKeyExpBase2 = wrongKeyExpBase3;
                rssiGood = wrongKeyStepCount;
                disabledLevel = wrongKeyRetryTimeMin;
            } else if (access$300 == 200) {
                authFailureExpBase = assocRejectExpBase;
                wrongKeyExpBase = wrongKeyExpBase3;
                rssiGood = wrongKeyStepCount;
                disabledLevel = wrongKeyRetryTimeMin;
    ...
    /* access modifiers changed from: private */
    public void handleManuConnect(int netId) {
    ...
    /* access modifiers changed from: private */
    public void handleUpdateNetworkDisabledCount(int netId, int reason) {
        ...
        if (!checkInterfaceNull()) {
            if (reason == 102 || reason == 11) {
                ...
                if (oppoAutoConnConf == null) {
                    ...
                    String unused = oppoAutoConnConf.mConfigKey = configKey;
                }
                int unused2 = oppoAutoConnConf.mDisabledLevel = getCurrentScanResultBestLevel(getScanResultList(), configKey);
                if (oppoAutoConnConf.mDisabledLevel == -127) {
                    int unused3 = oppoAutoConnConf.mDisabledLevel = RSSI_CAN_SCANNED;
                }
                if (oppoAutoConnConf.mDisabledReason != reason) {
                    int unused4 = oppoAutoConnConf.mContinuousDisabledCount = 1;
                } else {
                    OppoAutoConnectConfiguration.access$508(oppoAutoConnConf);
                }
                int unused5 = oppoAutoConnConf.mDisabledReason = reason;
                long unused6 = oppoAutoConnConf.mDisabledUntilTime = getKeepDisabledUntil(oppoAutoConnConf);
    ...
    /* access modifiers changed from: private */
    public void handleNetworkDisabled(int netId, int reason) {
    ...
    /* access modifiers changed from: private */
    public void handleNetworkDeleted(WifiConfiguration wConf) {
    ...
    /* access modifiers changed from: private */
    public void handleWifiConnectStateChanged(int state, int networkId) {
            ...
            if (state == 0) {
                ...
                if (oppoAutoConnectConfiguration != null && oppoAutoConnectConfiguration.mConfigKey != null) {
                    ...
                    if (currTime - this.mLastConnectedConfiguration.mLastConnectedTime <= ((long) continuousDebounceDisconnectIntervalTime)) {
                        ...
                        int unused = this.mLastConnectedConfiguration.mConituousDebounceDisconnectCount = 0;
                ...
                if (oacc.mConfigKey == null || !this.mLastConnectedConfiguration.mConfigKey.equals(configKey)) {
                    String unused2 = this.mLastConnectedConfiguration.mConfigKey = configKey;
                    int unused3 = this.mLastConnectedConfiguration.mConituousDebounceDisconnectCount = 0;
                }
                long unused4 = this.mLastConnectedConfiguration.mLastConnectedTime = System.currentTimeMillis();
                this.mSupplicantCompleted = true;
            } else if (state == 2) {
    ...
    /* access modifiers changed from: private */
    public void handleNetworkReSaved(WifiConfiguration oldConfig) {
        ...
        for (WifiConfiguration wc : wcList) {
            ...
            if (wcConfigKey != null) {
                ...
                while (true) {
                    ...
                    String srConfigKey = WifiConfiguration.configKey(it.next());
    ...
    private boolean isInOperatorArea() {
        if (isSingtelArea() || isSwisscomArea() || isBouygueArea() || isTurkcellArea()) {
            return true;
        }
        return false;
    }
    ...
    /* access modifiers changed from: private */
    public void handleDelayedManuReassociate() {
    ...
    /* access modifiers changed from: private */
    public String getFormatDateTime(long timeMillis) {
    ...
    /* access modifiers changed from: private */
    public void handleDebugDataShow() {
    ...
    /* access modifiers changed from: private */
    public void sendDebugDataShowEvt() {
        sendMessage(4);
    }
    ...
    private void listenForBroadcasts() {
        ...
        sContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(WIFI_AUTO_CHANGE_ACCESS_POINT), true, new ContentObserver(this.mHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                boolean unused = oppoAutoConnectManager.mWifiAssistantEnabled = z;
        ...
        sContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor(WIFI_ASSISTANT_ROMUPDATE), true, new ContentObserver(this.mHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                boolean unused = oppoAutoConnectManager.mWifiAssistantRomupdate = z;
        ...
        sContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getIntExtra("scan_enabled", 1) == 1) {
                    ...
                    List unused = OppoAutoConnectManager.this.mScanResultList = new ArrayList();
                }
            }
