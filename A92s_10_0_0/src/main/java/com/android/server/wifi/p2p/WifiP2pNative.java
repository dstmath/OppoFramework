...
public class WifiP2pNative {
    ...
    private final OppoSupplicantP2pIfaceHal mOppoSupplicantP2pIfaceHal = new OppoSupplicantP2pIfaceHal();
    ...
    public String setupInterface(HalDeviceManager.InterfaceDestroyedListener destroyedListener, Handler handler) {
        ...
        if (this.mIWifiP2pIface == null) {
            ...
            if (ifaceName == null) {
                ...
                this.mOppoSupplicantP2pIfaceHal.initialize();
                return ifaceName;
            }
        } else {
    ...
    public String getP2pInterfaceName() {
        IWifiP2pIface iWifiP2pIface = this.mIWifiP2pIface;
        if (iWifiP2pIface != null) {
            return HalDeviceManager.getName(iWifiP2pIface);
        }
        return null;
    }
    ...
    public String p2pConnect(WifiP2pConfig config, boolean joinExistingGroup, int freq) {
        return this.mOppoSupplicantP2pIfaceHal.connect(config, joinExistingGroup, freq);
    }

    public boolean p2pFind(int timeout, int freq) {
        return this.mOppoSupplicantP2pIfaceHal.find(timeout, freq);
    }

    public void setP2pChannelSetAt5G() {
        this.mOppoSupplicantP2pIfaceHal.setP2pChannel(1, 149);
    }

    public int addNetwork() {
        return this.mOppoSupplicantP2pIfaceHal.addP2pNetwork();
    }

    public boolean setNetworkVariable(int netId, String name, String value) {
        return this.mOppoSupplicantP2pIfaceHal.setNetworkVariable(netId, name, value);
    }

    public boolean setP2pBandLIst(OppoSoftapP2pBandControl.BandType type) {
        return this.mSupplicantP2pIfaceHal.setP2pBandLIst(type);
    }
}
