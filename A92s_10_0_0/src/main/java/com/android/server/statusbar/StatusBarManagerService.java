...
public class StatusBarManagerService extends IStatusBarService.Stub implements DisplayManager.DisplayListener {
    ...
    private final StatusBarManagerInternal mInternalService = new StatusBarManagerInternal() {
        ...
        public boolean showShutdownUi(boolean isReboot, String reason) {
            if (StatusBarManagerService.this.mContext.getResources().getBoolean(17891515) && StatusBarManagerService.this.mBar != null) {
                try {
    ...
    public String[] getStatusBarIcons() {
        return this.mContext.getResources().getStringArray(17236071);
    }
