...
class OppoAlarmWakeupDetection {
    ...
    private final List<String> ACTION_SYSTEMUI_NOT_RESTRICT_ALARM = Arrays.asList("com.android.dreams.alwaysondisplay.ACTION_AOD", "com.android.dreams.alwaysondisplay.ACTION_WAKE_AOD", "com.oppo.systemui.osfp.updateui", "com.android.systemui.aod.UPDATE_TIME", "com.android.systemui.aod.WAKEUP_TIME");
    ...
    public boolean isSyncAlarmWakeupFrequent = false;
    ...
    /* access modifiers changed from: private */
    public WorkerHandler mHandlerTimeout;
    /* access modifiers changed from: private */
    public ArrayList<AlarmWakeupRecord> mListFrequent = new ArrayList<>();
    private List<String> mListPkgAlarmWakeupThisTime = new ArrayList();
    private final Object mLock;
    /* access modifiers changed from: private */
    public ArrayList<AlarmWakeupRecord> mReportList = new ArrayList<>();
    /* access modifiers changed from: private */
    public boolean mScreenOffRecorded = false;
    public boolean mScreenOn = true;
    /* access modifiers changed from: private */
    public long mScreenoffElapsed;
    private OppoSysStateManager mSysState;
    /* access modifiers changed from: private */
    public PowerManager.WakeLock mWakeLockCheck;
    private PowerManager.WakeLock mWakeLockReport;
    /* access modifiers changed from: private */
    public long thresholdSeriousPerAlarm = THRESHOLD_SERIOUS_SEC_PER_ALARM;
    /* access modifiers changed from: private */
    public long thresholdSeriousPerWakeup = 300;
    /* access modifiers changed from: private */
    public long thresholdWarningPerWakeup = THRESHOLD_WARNNING_SEC_PER_WAKEUP;
    /* access modifiers changed from: private */
    public long thresholdWorstPerWakeup = THRESHOLD_WORST_SEC_PER_WAKEUP;
    ...
    /* access modifiers changed from: private */
    public void alarmWakeupHandle(Bundle data) {
        Object obj;
    ...
    private class AlarmDetectionReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.intent.action.SCREEN_ON")) {
                boolean unused = OppoAlarmWakeupDetection.this.mScreenOffRecorded = false;
                ...
                boolean unused2 = OppoAlarmWakeupDetection.this.isSyncAlarmWakeupFrequent = false;
                ...
                boolean unused3 = oppoAlarmWakeupDetection2.isSyncAlarmWakeupFrequent = false;
                OppoAlarmWakeupDetection.this.mReportList.clear();
                OppoAlarmWakeupDetection.this.mListFrequent.clear();
                OppoAlarmWakeupDetection.this.mWakeLockCheck.acquire(1000);
                long unused4 = OppoAlarmWakeupDetection.this.thresholdWarningPerWakeup = OppoGuardElfConfigUtil.getInstance().getThresholdWarningIntervalPerWakeup();
                long unused5 = OppoAlarmWakeupDetection.this.thresholdSeriousPerWakeup = OppoGuardElfConfigUtil.getInstance().getThresholdIntervalPerWakeup();
                long unused6 = OppoAlarmWakeupDetection.this.thresholdWorstPerWakeup = OppoGuardElfConfigUtil.getInstance().getThresholdWorstIntervalPerWakeup();
                long unused7 = OppoAlarmWakeupDetection.this.thresholdSeriousPerAlarm = OppoGuardElfConfigUtil.getInstance().getThresholdSeriousIntervalPerAlarm();
                OppoAlarmWakeupDetection.this.mHandlerTimeout.sendEmptyMessage(102);
                long unused8 = OppoAlarmWakeupDetection.this.mScreenoffElapsed = SystemClock.elapsedRealtime();
            }
        }
    }
