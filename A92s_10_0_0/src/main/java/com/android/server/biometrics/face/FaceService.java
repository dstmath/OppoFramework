...
public class FaceService extends BiometricServiceBase implements IRecognitionCallback, FacePowerManager.IPowerCallback, FaceSwitchHelper.ISwitchUpdateListener, Watchdog.Monitor {
    ...
    public static final long UNBLOCK_SCREEN_ON_DELAY = 0;
    ...
    /* access modifiers changed from: private */
    public final ConcurrentLinkedDeque<Runnable> mDaemonCallbackQueue = new ConcurrentLinkedDeque<>();
    /* access modifiers changed from: private */
    public BiometricServiceBase.DaemonWrapper mDaemonWrapper;
    /* access modifiers changed from: private */
    public final DcsUtil mDcsUtil;
    /* access modifiers changed from: private */
    public final Runnable mDecreaseFailedAttemptsRunnable;
    /* access modifiers changed from: private */
    public DisplayManagerInternal mDisplayManagerInternal;
    /* access modifiers changed from: private */
    public int mEnrollmentTotalTimes;
    /* access modifiers changed from: private */
    public int mFaceCloseEyeDetect;
    /* access modifiers changed from: private */
    public final boolean mFaceCloseEyeDetectSupport;
    private final FaceConstants mFaceConstants;
    /* access modifiers changed from: private */
    public boolean mFaceFingerprintCombineUnlockEnabled;
    ...
    /* access modifiers changed from: private */
    public boolean mFaceUnlockAutoWhenScreenOn;
    /* access modifiers changed from: private */
    public boolean mFaceUnlockEnabled;
    private final FaceUtils mFaceUtils;
    /* access modifiers changed from: private */
    public SparseIntArray mFailedAttempts;
    /* access modifiers changed from: private */
    public boolean mFingerPrintShowWhenScreenOff;
    /* access modifiers changed from: private */
    public boolean mFingerPrintUnlockEnabled;
    ...
    /* access modifiers changed from: private */
    public final HealthMonitor mHealthMonitor;
    ...
    /* access modifiers changed from: private */
    public final Runnable mResetFailedAttemptsRunnable;
    /* access modifiers changed from: private */
    public ServiceListenerImpl mServiceListenerImpl;
    ...
    public void unblockScreenOn(String reason) {
        ...
        Slog.d(TAG, "unblockScreenOn, currentClient = " + currentClient + ", mSupportPowerBlock = " + this.mSupportPowerBlock + ", isKeyguard = " + isKeyguard + ", mIsWakeUp = " + this.mIsWakeUp + ", reason = " + reason);
        if (this.mSupportPowerBlock) {
            if (isKeyguard && this.mIsWakeUp) {
                if (BiometricWakeupManagerService.UNBLOCK_SCREEN_ON_BY_AUTHENTICATE_SUCESS.equals(reason)) {
                    if (this.mFingerprintOpticalSupport && this.mFingerPrintUnlockEnabled && this.mFingerPrintShowWhenScreenOff) {
                        try {
                    ...
                    if (daemonWrapper != null) {
                        ((FaceDaemonWrapper) daemonWrapper).removeCameraTimeoutMessage();
                    }
    ...
    public void blockScreenOn() {
        ...
        if (!this.mIsScreenOff) {
            Slog.d(TAG, "do not blockScreenOn when screen on");
            return;
        }
        synchronized (this.mClientLock) {
            currentClient = getCurrentClient();
        ...
        Slog.d(TAG, "blockScreenOn, currentClient = " + currentClient + ", mSupportPowerBlock = " + this.mSupportPowerBlock + ", isKeyguard = " + isKeyguard + ", mIsWakeUp = " + this.mIsWakeUp + ", mWakeUpReason = " + this.mWakeUpReason);
    ...
    public final class FaceServiceWrapper extends IFaceService.Stub {
        ...
        public void resetFaceDaemon() {
            ...
            BiometricServiceBase.DaemonWrapper unused = FaceService.this.mDaemonWrapper = null;
            IBiometricsFace unused2 = FaceService.this.mDaemon = null;
        }
        ...
        public void enroll(IBinder token, byte[] cryptoToken, IFaceServiceReceiver receiver, String opPackageName, int[] disabledFeatures) {
            ...
            BiometricServiceBase.DaemonWrapper access$2500 = FaceService.this.mDaemonWrapper;
            long access$3400 = FaceService.this.mHalDeviceId;
            FaceService faceService = FaceService.this;
            BiometricServiceBase.EnrollClientImpl client = new BiometricServiceBase.EnrollClientImpl(context, access$2500, access$3400, token, faceService.mServiceListenerImpl = new ServiceListenerImpl(receiver), FaceService.this.mCurrentUserId, 0, cryptoToken, restricted, opPackageName, disabledFeatures) {
        ...
        public /* synthetic */ void lambda$cancelEnrollment$1$FaceService$FaceServiceWrapper(IBinder token) {
            ...
            if ((client instanceof EnrollClient) && client.getToken() == token) {
                Slog.v(FaceService.this.getTag(), "Cancelling enrollment");
        ...
        public void authenticate(final IBinder token, long opId, int userId, final IFaceServiceReceiver receiver, int flags, final String opPackageName) {
            ...
            BiometricServiceBase.DaemonWrapper access$2500 = FaceService.this.mDaemonWrapper;
            long access$4400 = FaceService.this.mHalDeviceId;
            FaceService faceService2 = FaceService.this;
            final BiometricServiceBase.AuthenticationClientImpl client = new FaceAuthClient(context, access$2500, access$4400, token, faceService2.mServiceListenerImpl = new ServiceListenerImpl(receiver), FaceService.this.mCurrentUserId, 0, opId, restricted, opPackageName, 0, false);
        ...
        /* access modifiers changed from: private */
        public void startAuthentication(BiometricServiceBase.AuthenticationClientImpl client, String opPackageName) {
            int errorCode;
            ...
            if (lockoutMode != 0) {
                ...
                if (!client.onError(FaceService.this.getHalDeviceId(), errorCode, 0)) {
                    Slog.w(FaceService.this.getTag(), "Cannot send permanent lockout message to client");
                    return;
                }
                return;
            }
            FaceService.this.mHandler.post(new Runnable(client) {
                /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$5U7RTK202jba5weQvX_mFYRVvhA */
                private final /* synthetic */ BiometricServiceBase.AuthenticationClientImpl f$1;
                ...
                public final void run() {
                    FaceService.FaceServiceWrapper.this.lambda$startAuthentication$2$FaceService$FaceServiceWrapper(this.f$1);
                }
            });
        }

        public /* synthetic */ void lambda$startAuthentication$2$FaceService$FaceServiceWrapper(BiometricServiceBase.AuthenticationClientImpl client) {
            FaceService.this.startClient(client, true);
        }
        ...
        public void cancelAuthenticationInternal(IBinder token, String opPackageName, int callingUid, int callingPid, int callingUserId, boolean fromClient) {
            if (!fromClient || FaceService.this.canUseBiometric(opPackageName, true, callingUid, callingPid, callingUserId)) {
                ...
                FaceService.this.mSubHandler.post(new Runnable(token, fromClient) {
                    /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$bKV2fNo7a2H__iifDKd7MghgXdE */
                    private final /* synthetic */ IBinder f$1;
                    ...
                    public final void run() {
                        FaceService.FaceServiceWrapper.this.lambda$cancelAuthenticationInternal$4$FaceService$FaceServiceWrapper(this.f$1, this.f$2);
                    }
                });
                return;
            }
        ...
        public /* synthetic */ void lambda$cancelAuthenticationInternal$4$FaceService$FaceServiceWrapper(IBinder token, boolean fromClient) {
            ClientMonitor client = FaceService.this.getCurrentClient();
            if (client instanceof AuthenticationClient) {
                if (client.getToken() == token || !fromClient) {
                    ...
                    FaceService.this.mHandler.post(new Runnable(client) {
                        /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$YTAdrPg49pHHnOW_ljO2vSnjAJs */
                        ...
                        public final void run() {
                            FaceService.FaceServiceWrapper.this.lambda$cancelAuthenticationInternal$3$FaceService$FaceServiceWrapper(this.f$1);
                        }
                    });
                    return;
                }
        ...
        public /* synthetic */ void lambda$cancelAuthenticationInternal$3$FaceService$FaceServiceWrapper(ClientMonitor client) {
        ...
        public void enumerate(IBinder token, int userId, IFaceServiceReceiver receiver) {
            ...
            FaceService.this.mHandler.post(new Runnable(new EnumerateClient(FaceService.this.getContext(), FaceService.this.getConstants(), FaceService.this.mDaemonWrapper, FaceService.this.mHalDeviceId, token, new ServiceListenerImpl(receiver), userId, userId, FaceService.this.isRestricted(), FaceService.this.getContext().getOpPackageName()) {
                ...
                /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$nKyOe3a6TOjbx58jMSrz3kYYEeE */
                ...
                public final void run() {
                    FaceService.FaceServiceWrapper.this.lambda$enumerate$5$FaceService$FaceServiceWrapper(this.f$1);
                }
            });
        }

        public /* synthetic */ void lambda$enumerate$5$FaceService$FaceServiceWrapper(EnumerateClient client) {
            FaceService.this.startClient(client, true);
        }
        ...
        public void setFeature(int feature, boolean enabled, byte[] token, IFaceServiceReceiver receiver) {
            ...
            FaceService.this.mHandler.post(new Runnable(feature, token, enabled, receiver) {
                /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$3luSRYWQDfyTCwvB5RtL6BjM8U */
                ...
                public final void run() {
                    FaceService.FaceServiceWrapper.this.lambda$setFeature$6$FaceService$FaceServiceWrapper(this.f$1, this.f$2, this.f$3, this.f$4);
                }
            });
        }

        public /* synthetic */ void lambda$setFeature$6$FaceService$FaceServiceWrapper(int feature, byte[] token, boolean enabled, IFaceServiceReceiver receiver) {
            FaceService faceService = FaceService.this;
            if (!faceService.hasEnrolledBiometrics(faceService.mCurrentUserId)) {
        ...
        public void getFeature(int feature, IFaceServiceReceiver receiver) {
            ...
            FaceService.this.mHandler.post(new Runnable(feature, receiver) {
                /* class com.android.server.biometrics.face.$$Lambda$FaceService$FaceServiceWrapper$t17Q2a2gsn9bi6Dls7qErL45iH0 */
                private final /* synthetic */ int f$1;
                ...
                public final void run() {
                    FaceService.FaceServiceWrapper.this.lambda$getFeature$7$FaceService$FaceServiceWrapper(this.f$1, this.f$2);
                }
            });
        }

        /* JADX INFO: finally extract failed */
        public /* synthetic */ void lambda$getFeature$7$FaceService$FaceServiceWrapper(int feature, IFaceServiceReceiver receiver) {
            FaceService faceService = FaceService.this;
            if (!faceService.hasEnrolledBiometrics(faceService.mCurrentUserId)) {
        ...
        public void notifyStopAuthenticationWhenWakeup(String reason) {
            ...
            if (FaceService.this.mDisplayManagerInternal.isBlockScreenOnByBiometrics() || ("FaceNotStartInKeyguard".equals(reason) && FaceService.this.mFaceUnlockEnabled)) {
    ...
    /* access modifiers changed from: private */
    public long getLockoutAttemptDeadline(String opPackageName, int userId) {
    ...
    /* access modifiers changed from: private */
    public void setLockoutAttemptDeadline(long deadline, int userId) {
        synchronized (this.mLockoutDeadlineLock) {
        ...
        synchronized (this.mClientLock) {
            ...
            if (currentClient != null && (currentClient instanceof AuthenticationClient)) {
                ...
                if (!isKeyguard(currentClient.getOwnerString()) || !this.mKeyguardManager.isKeyguardLocked()) {
                    if (!(authtoken == token || token == null || !operation.equals(HealthState.CANCEL_FACE))) {
    ...
    /* access modifiers changed from: private */
    public int startUpdateSettingSwitchStatus(int switchType, int on) {
    ...
    /* access modifiers changed from: private */
    public int startSetPreviewSurface(Surface surface) {
    ...
    /* access modifiers changed from: private */
    public void startWakeUp(String wakeupReason) {
    ...
    public void onWakeUp(final String wakeupReason) {
        Slog.d(TAG, "onWakeUp wakeupReason = " + wakeupReason);
        this.mIsWakeUp = true;
    ...
    public class ServiceListenerImpl implements BiometricServiceBase.ServiceListener {
        ...
        public void onAuthenticationSucceeded(long deviceId, BiometricAuthenticator.Identifier biometric, int userId) throws RemoteException {
            if (this.mFaceServiceReceiver != null) {
                if (biometric == null || (biometric instanceof Face)) {
                    Slog.d(FaceService.TAG, "Receiver onAuthenticationSucceeded");
        ...
        public void onAuthenticationFailed(long deviceId) throws RemoteException {
            if (this.mFaceServiceReceiver != null) {
                Slog.d(FaceService.TAG, "Receiver onAuthenticationFailed");
        ...
        /* access modifiers changed from: private */
        public boolean onProgressChanged(int progressInfo) {
            if (this.mFaceServiceReceiver == null) {
                return true;
            }
            try {
                Slog.d(FaceService.TAG, "Receiver onProgressChanged");
    ...
    public FaceService(Context context) {
        ...
        this.mListener = new Ilistener() {
            ...
            public void onSettingChanged(String settingName, boolean isOn) {
                ...
                if (FaceSettings.FACE_UNLOCK_SWITCH.equals(settingName)) {
                    boolean unused = FaceService.this.mFaceUnlockEnabled = isOn;
                    boolean unused2 = FaceService.this.mFaceUnlockAutoWhenScreenOn = isOn;
                } else if (FaceSettings.FACE_CLOSE_EYE_DETECT_SWITCH.equals(settingName) && FaceService.this.mFaceCloseEyeDetectSupport) {
                    int unused3 = FaceService.this.mFaceCloseEyeDetect = isOn ? 1 : 0;
                    FaceService faceService = FaceService.this;
                    int unused4 = faceService.startUpdateSettingSwitchStatus(1, faceService.mFaceCloseEyeDetect);
                } else if ("coloros_fingerprint_unlock_switch".equals(settingName)) {
                    boolean unused5 = FaceService.this.mFingerPrintUnlockEnabled = isOn;
                } else if ("show_fingerprint_when_screen_off".equals(settingName)) {
                    boolean unused6 = FaceService.this.mFingerPrintShowWhenScreenOff = isOn;
                } else if (FaceSettings.FACE_FINGERPRINT_COMBINATION_UNLOCK_SWITCH.equals(settingName)) {
                    boolean unused7 = FaceService.this.mFaceFingerprintCombineUnlockEnabled = isOn;
                }
            }
        };
        ...
        this.mHandleResultThread = new ServiceThread("FaceServiceHandleResult", -2, true);
    ...
    /* access modifiers changed from: private */
    public void dumpInternal(PrintWriter pw, String[] args) {
        String opt;
