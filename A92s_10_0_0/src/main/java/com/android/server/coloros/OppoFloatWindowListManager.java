...
public class OppoFloatWindowListManager {
    ...
    public static final List<String> mDefaultGrantBuildinApps = Arrays.asList("com.coloros.screenrecorder", "com.oppo.community", "com.oppo.reader", "com.coloros.colorfilestand", "com.coloros.flashnote", "com.coloros.favorite", "com.coloros.personalassistant");
    ...
    private void initialize() {
        ...
        this.mFloatWindowManagerHandler = new Handler(this.mHandlerThread.getLooper()) {
            /* class com.android.server.coloros.OppoFloatWindowListManager.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    public void grantFloatWindowPermission(String packageName) {
