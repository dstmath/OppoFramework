...
public class LinearmotorVibratorService extends ILinearmotorVibratorService.Stub {
    ...
    public void configureForRingerMode(int ringerMode) {
        try {
            ...
            if (ringerMode == 1) {
                try {
                    ...
                    e = e2;
                    Slog.e(TAG, "IllegalAccessException " + e.toString());
                } catch (InvocationTargetException e3) {
                    e = e3;
                    Slog.e(TAG, "InvocationTargetException " + e.getTargetException().toString());
                } catch (ClassNotFoundException e4) {
                    e = e4;
                    Slog.e(TAG, "ClassNotFoundException " + e.toString());
                }
            } else {
