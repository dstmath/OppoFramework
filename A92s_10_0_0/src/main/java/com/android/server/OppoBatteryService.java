...
public final class OppoBatteryService {
    ...
    public static final String TAG = OppoBatteryService.class.getSimpleName();
    ...
    /* access modifiers changed from: private */
    public OppoBaseBatteryService mBas;
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            String access$000 = OppoBatteryService.TAG;
            Slog.i(access$000, "action received : " + action);
    ...
    private class BatteryHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case OppoBatteryService.AC_PLUG_IN_EVENT /*{ENCODED_INT: 100000}*/:
                case OppoBatteryService.USB_PLUG_IN_EVENT /*{ENCODED_INT: 100001}*/:
                case OppoBatteryService.CHARGERID_UPDATED_EVENT /*{ENCODED_INT: 100002}*/:
                case OppoBatteryService.PLUG_OUT_EVENT /*{ENCODED_INT: 100003}*/:
                case OppoBatteryService.ENTER_FASTCHARGE_EVENT /*{ENCODED_INT: 100004}*/:
                    OppoBatteryService.this.writeCriticalLog((int[]) message.obj);
                    return;
                case OppoBatteryService.UPDATE_BATTERY_HISTORY_EVENT /*{ENCODED_INT: 100005}*/:
                    String history = (String) message.obj;
                    String access$0002 = OppoBatteryService.TAG;
                    Slog.i(access$0002, "new battery critical data : " + history);
                ...
                this.mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (OppoBaseBatteryService.DEBUG_PANIC) {
                            String access$000 = OppoBatteryService.TAG;
                            Slog.d(access$000, "send broadcast : oppo.intent.action.BATTERY_HW_STATUS : mBatteryHwStatus" + OppoBatteryService.this.mBatteryHwStatus);
                        }
            ...
            if (this.mActivityManagerInternal.isSystemReady()) {
                this.mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (OppoBaseBatteryService.DEBUG_PANIC) {
                            String access$000 = OppoBatteryService.TAG;
                            Slog.d(access$000, "send broadcast : oppo.intent.action.BATTERY_IC_STATUS : mBatteryIcStatus" + OppoBatteryService.this.mBatteryIcStatus);
                        }
            ...
            if (this.mActivityManagerInternal.isSystemReady()) {
                this.mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (OppoBaseBatteryService.DEBUG_PANIC) {
                            String access$000 = OppoBatteryService.TAG;
                            Slog.d(access$000, "send broadcast : oppo.intent.action.BATTERY_PLUGGED_CHANGED : mPlugType = " + plugType);
                        }
    ...
    private int[] getChargerCriticalLog() {
        return new int[]{this.mChargeFastCharger, this.mPrimalType, this.mPlugType, this.mBatteryTemperature, this.mBatteryLevel, this.mChargeridVoltage};
    }

    /* access modifiers changed from: private */
    public void writeCriticalLog(int[] parameter) {
