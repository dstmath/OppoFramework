...
public abstract class PermissionManagerServiceInternal extends PermissionManagerInternal {
    ...
    public abstract List<String> getWhitelistedRestrictedPermissions(PackageParser.Package packageR, int i, int i2);
    ...
    public abstract void setWhitelistedRestrictedPermissions(PackageParser.Package packageR, int[] iArr, List<String> list, int i, int i2, PermissionCallback permissionCallback);
