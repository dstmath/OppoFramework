...
public class ColorDexMetadataConfigHelper {
    ...
    private void initDefaultConfigValues() {
        ...
        synchronized (this.mConfigLock) {
            ...
            this.mTopAppNumber = DEFAULT_TOP_APP_NUMBER;
            ...
            this.mCompilePackageSetSize = 30;
    ...
    public void loadRomUpdateConfigXML() {
        boolean ret;
        Cursor cursor = null;
        String[] projection = {ColorStartingWindowRUSHelper.VERSION_NAME, COLUMN_NAME_XML};
        String xml = null;
        int version = 0;
        try {
            if (this.mContext != null) {
                ...
                if (cursor != null && cursor.getCount() > 0) {
                    int versioncolumnIndex = cursor.getColumnIndex(ColorStartingWindowRUSHelper.VERSION_NAME);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v0, resolved type: org.xmlpull.v1.XmlPullParser} */
            ...
            try {
                ...
                while (eventType != 1) {
                    if (2 == eventType) {
                        ...
                        if (tagName.equals(ColorStartingWindowRUSHelper.VERSION_NAME)) {
                            ...
                            if (parser.getAttributeCount() > 0) {
                                String attributeValue = parser.getAttributeValue(r2);
