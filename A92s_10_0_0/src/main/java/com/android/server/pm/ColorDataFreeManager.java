...
public class ColorDataFreeManager implements IColorDataFreeManager {
    ...
    public boolean startDataFree() {
        ...
        Slog.w(TAG, "data avaible size " + dataFreeSize + "M is less than " + 64 + "M, start datafree");
    ...
    public void oppoCreateFileInData() {
        ...
        if (!file.exists()) {
            ...
            } else if (dataAviSize > 64 || dataAviSize <= DATA_MIN_SIZE) {
