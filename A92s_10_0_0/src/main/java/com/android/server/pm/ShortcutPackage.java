...
public class ShortcutPackage extends ShortcutPackageItem {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.pm.ShortcutPackage.ensureNotImmutable(android.content.pm.ShortcutInfo, boolean):void
     arg types: [android.content.pm.ShortcutInfo, int]
     candidates:
      com.android.server.pm.ShortcutPackage.ensureNotImmutable(java.lang.String, boolean):void
      com.android.server.pm.ShortcutPackage.ensureNotImmutable(android.content.pm.ShortcutInfo, boolean):void */
