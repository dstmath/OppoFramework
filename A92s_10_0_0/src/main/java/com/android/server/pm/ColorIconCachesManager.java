...
public class ColorIconCachesManager implements IColorIconCachesManager {
    ...
    public static ConcurrentHashMap<String, Bitmap> mActivityIconsCache = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    public static ConcurrentHashMap<String, Bitmap> mAppIconsCache = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    public static ConcurrentHashMap<String, Bitmap> mAppIconsCacheCompress = new ConcurrentHashMap<>();
    ...
    private BroadcastReceiver mSkinChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("oppo.intent.action.SKIN_CHANGED".equals(action) || "oppo.intent.config.density.change".equals(action)) {
                ...
                boolean unused = ColorIconCachesManager.this.mThemeIconsChanged = false;
    ...
    /* access modifiers changed from: private */
    public boolean mThemeIconsChanged = false;
    private FileObserver mThemeIconsFileObserver = new FileObserver("/data/theme/icons", 1546) {
        ...
        public void onEvent(int event, String path) {
            ...
            if (8 == event || 512 == event || 1024 == event || 2 == event) {
                boolean unused = ColorIconCachesManager.this.mThemeIconsChanged = true;
            }
        }
    };
    ...
    public void cacheAppIconsData() {
        ...
        if (!this.mCacheSwitch) {
            ...
            try {
                ...
                Slog.e(TAG, "init appIconsCache failed!" + e5.getMessage());
                e5.printStackTrace();
            }
        }
    }
