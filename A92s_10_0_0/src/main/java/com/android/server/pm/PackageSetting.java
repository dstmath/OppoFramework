...
public final class PackageSetting extends PackageSettingBase {
    ...
    public String toString() {
        return "PackageSetting{" + Integer.toHexString(System.identityHashCode(this)) + StringUtils.SPACE + this.name + SliceClientPermissions.SliceAuthority.DELIMITER + this.appId + "}";
    }
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId, List<UserInfo> list) {
        ...
        PackageParser.Package packageR = this.pkg;
        if (packageR != null) {
            proto.write(1138166333444L, packageR.mVersionName);
