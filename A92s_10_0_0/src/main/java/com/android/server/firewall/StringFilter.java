...
abstract class StringFilter implements Filter {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.firewall.StringFilter.IsNullFilter.<init>(com.android.server.firewall.StringFilter$ValueProvider, boolean):void
     arg types: [com.android.server.firewall.StringFilter$ValueProvider, int]
     candidates:
      com.android.server.firewall.StringFilter.IsNullFilter.<init>(com.android.server.firewall.StringFilter$ValueProvider, java.lang.String):void
      com.android.server.firewall.StringFilter.IsNullFilter.<init>(com.android.server.firewall.StringFilter$ValueProvider, boolean):void */
