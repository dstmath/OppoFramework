...
public class ConditionProviders extends ManagedServices {
    ...
    private final ArraySet<String> mSystemConditionProviderNames = safeSet(PropConfig.getStringArray(this.mContext, "system.condition.providers", 17236072));
    ...
    public boolean subscribeIfNecessary(ComponentName component, Uri conditionId) {
        synchronized (this.mMutex) {
            ...
            if (r == null) {
                String str = this.TAG;
                Slog.w(str, "Unable to subscribe to " + component + StringUtils.SPACE + conditionId);
                return false;
    ...
    public void unsubscribeIfNecessary(ComponentName component, Uri conditionId) {
        synchronized (this.mMutex) {
            ...
            if (r == null) {
                String str = this.TAG;
                Slog.w(str, "Unable to unsubscribe to " + component + StringUtils.SPACE + conditionId);
            } else if (r.subscribed) {
                unsubscribeLocked(r);
            }
        }
