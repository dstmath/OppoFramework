...
public class NotificationShellCmd extends ShellCommand {
    ...
    /* JADX INFO: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.notification.NotificationRecord.dump(java.io.PrintWriter, java.lang.String, android.content.Context, boolean):void
     arg types: [java.io.PrintWriter, java.lang.String, android.content.Context, int]
     candidates:
      com.android.server.notification.NotificationRecord.dump(android.util.proto.ProtoOutputStream, long, boolean, int):void
      com.android.server.notification.NotificationRecord.dump(java.io.PrintWriter, java.lang.String, android.content.Context, boolean):void */
                    ...
                    case 17:
                        ...
                        if (hashCode != -1655966961) {
                            if (hashCode != -1618876223) {
                                if (hashCode == 1984153269 && peekNextArg.equals(IColorAppStartupManager.TYPE_SERVICE)) {
                                    c2 = 1;
                                    if (c2 != 0 || c2 == 1 || c2 == 2) {
                                    ...
                                    } else if (IColorAppStartupManager.TYPE_SERVICE.equals(intentKind)) {
                            ...
                            } else if (peekNextArg.equals("broadcast")) {
                                c2 = 0;
                                if (c2 != 0) {
                                }
                                intentKind = getNextArg();
                        ...
                        } else if (peekNextArg.equals(IColorAppStartupManager.TYPE_ACTIVITY)) {
                            c2 = 2;
                            if (c2 != 0) {
                            }
                            intentKind = getNextArg();
