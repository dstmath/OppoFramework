...
public class OppoNotificationManager {
    ...
    public static final Uri APP_ENCRYPT_SWITCH_CHANGED = Settings.Secure.getUriFor("access_control_lock_enabled");
    ...
    /* access modifiers changed from: private */
    public static final Uri DISTURB_FOR_GAME_SPACE_MODE_URI = Settings.Global.getUriFor(DISTURB_FOR_GAME_SPACE_MODE);
    private static final String EDGE_PANEL_TOGGLE = "edge_panel_toggle";
    /* access modifiers changed from: private */
    public static final Uri EDGE_PANEL_TOGGLE_URI = Settings.Secure.getUriFor(EDGE_PANEL_TOGGLE);
    ...
    /* access modifiers changed from: private */
    public static final Uri NO_DISTURB_FOR_SCREEN_ASSISTANT_URI = Settings.Secure.getUriFor(NO_DISTURB_FOR_SCREEN_ASSISTANT);
    ...
    /* access modifiers changed from: private */
    public static final Uri OPENID_TOGGLE_URI = Settings.Secure.getUriFor(OPENID_TOGGLE);
    ...
    /* access modifiers changed from: private */
    public static final Uri QS_NO_DISTURB_URI = Settings.Secure.getUriFor(QS_NO_DISTURB);
    ...
    /* access modifiers changed from: private */
    public static final Uri SETTING_KEY_BLOCK_BANNER_URI = Settings.Secure.getUriFor(SETTING_KEY_BLOCK_BANNER);
    private static final String SETTING_KEY_CHILDREN_MODE = "children_mode_on";
    /* access modifiers changed from: private */
    public static final Uri SETTING_KEY_CHILDREN_MODE_URI = Settings.Global.getUriFor(SETTING_KEY_CHILDREN_MODE);
    private static final String SETTING_KEY_SA_TOGGLE = "screen_assistant_toggle";
    /* access modifiers changed from: private */
    public static final Uri SETTING_KEY_SA_TOGGLE_URI = Settings.Secure.getUriFor(SETTING_KEY_SA_TOGGLE);
    ...
    /* access modifiers changed from: private */
    public static final Uri URI_DEEP_PROTECT_NOTIFICATION_CHANGED = Uri.withAppendedPath(Uri.parse(PRIVACY_PROTECT_URI), NOTIFICATION_ITEM_URI);
    /* access modifiers changed from: private */
    public static final Uri VIBRATE_WHEN_RINGING_URI = Settings.System.getUriFor("vibrate_when_ringing");
    ...
    /* access modifiers changed from: private */
    public boolean mBlockForEdgePanel;
    /* access modifiers changed from: private */
    public boolean mBlockedForQsNoDisturb;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mIsAppEncryptSwitchOn = false;
    /* access modifiers changed from: private */
    public boolean mIsChildrenModeEnable;
    private boolean mIsCtaVersion = false;
    /* access modifiers changed from: private */
    public boolean mIsEdgePanelToggle = false;
    /* access modifiers changed from: private */
    public boolean mIsNoDisturbForScreenAssistant;
    private boolean mIsReleaseVersion = false;
    /* access modifiers changed from: private */
    public boolean mIsScreenAssistantEnable;
            ...
            try {
                ...
                synchronized (this.mLock) {
                    if (hasKeepAliveList) {
                        try {
                            this.mKeepAliveAppWhiteList.clear();
                            this.mKeepAliveAppWhiteList.addAll(keepAliveList2);
                        } catch (Throwable th) {
                            th = th;
                            throw th;
                        }
                    }
                    if (hasGuidPkgList && this.mOpenID != null) {
                        this.mOpenID.setGuidList(guidList);
                    }
                    if (hasDuidPkgList && this.mOpenID != null) {
                        this.mOpenID.setColorDuidList(duidList);
                    }
                    if (hasApidPkgList && this.mOpenID != null) {
                        this.mOpenID.setApidList(apidList);
                    }
                    try {
                        ...
                        while (it.hasNext()) {
                            ...
                            try {
                                if (!this.mKeepAliveAppWhiteList.contains(key)) {
                                    ...
                                    this.mKeepAliveByNotificationMap.put(key, Integer.valueOf((int) NAVIGAION_NOTIFICATION_CLOSE));
                                } else {
                                    keepAliveList = keepAliveList2;
                                }
                                it = it;
                        ...
                        if (hasForceGroupList) {
                            this.mForceGroupList.clear();
                            this.mForceGroupList.addAll(forceGroupList);
                        }
                    } catch (Throwable th3) {
                        th = th3;
                        throw th;
    ...
    public int getNavigationMode(String pkg, int userId) {
        ...
        synchronized (this.mLock) {
            ...
            int intValue = this.mKeepAliveByNotificationMap.get(pkg).intValue();
            return intValue;
        }
    }
            ...
            if (userId == 0) {
                try {
                    if (this.mHidePkgList != null) {
                        if (!this.mHidePkgList.isEmpty()) {
                            boolean contains = this.mHidePkgList.contains(pkg);
                            return contains;
                        }
                    }
                } catch (Throwable th) {
                ...
                if (this.mHidePkgListMulti != null) {
                    if (!this.mHidePkgListMulti.isEmpty()) {
                        boolean contains2 = this.mHidePkgListMulti.contains(pkg);
                        return contains2;
                    }
                }
            }
    ...
    public class OppoSettingsObserver extends ContentObserver {
        ...
        public void update(Uri uri, int userId) {
            ...
            if (uri == null || OppoNotificationManager.VIBRATE_WHEN_RINGING_URI.equals(uri)) {
                boolean unused = OppoNotificationManager.this.mVibrateWhenRingingEnabled = Settings.System.getIntForUser(resolver, "vibrate_when_ringing", 0, -2) != 0;
            }
            if (uri == null || OppoNotificationManager.DISTURB_FOR_GAME_SPACE_MODE_URI.equals(uri)) {
                boolean unused2 = OppoNotificationManager.this.mGameSpaceMode = (Settings.Global.getInt(resolver, OppoNotificationManager.DISTURB_FOR_GAME_SPACE_MODE, 0) & 1) != 0;
            }
            if (uri == null || OppoNotificationManager.NO_DISTURB_FOR_SCREEN_ASSISTANT_URI.equals(uri)) {
                boolean unused3 = OppoNotificationManager.this.mIsNoDisturbForScreenAssistant = Settings.Secure.getIntForUser(resolver, OppoNotificationManager.NO_DISTURB_FOR_SCREEN_ASSISTANT, 0, -2) == 1;
            }
            if (uri == null || OppoNotificationManager.APP_ENCRYPT_SWITCH_CHANGED.equals(uri)) {
                boolean unused4 = OppoNotificationManager.this.mIsAppEncryptSwitchOn = Settings.Secure.getIntForUser(resolver, "access_control_lock_enabled", 0, -2) == 1;
            ...
            if (uri == null || OppoNotificationManager.SETTING_KEY_CHILDREN_MODE_URI.equals(uri)) {
                boolean unused5 = OppoNotificationManager.this.mIsChildrenModeEnable = Settings.Global.getInt(resolver, OppoNotificationManager.SETTING_KEY_CHILDREN_MODE, 0) == 1;
            }
            if (uri == null || OppoNotificationManager.SETTING_KEY_SA_TOGGLE_URI.equals(uri)) {
                ...
                boolean unused6 = oppoNotificationManager.mIsScreenAssistantEnable = Settings.Secure.getIntForUser(oppoNotificationManager.mContext.getContentResolver(), OppoNotificationManager.SETTING_KEY_SA_TOGGLE, 0, -2) == 1;
            }
            if (uri == null || OppoNotificationManager.EDGE_PANEL_TOGGLE_URI.equals(uri)) {
                ...
                boolean unused7 = oppoNotificationManager2.mIsEdgePanelToggle = Settings.Secure.getIntForUser(oppoNotificationManager2.mContext.getContentResolver(), OppoNotificationManager.EDGE_PANEL_TOGGLE, 0, -2) == 1;
            }
            if (uri == null || OppoNotificationManager.SETTING_KEY_BLOCK_BANNER_URI.equals(uri)) {
                boolean unused8 = OppoNotificationManager.this.mBlockForEdgePanel = Settings.Secure.getIntForUser(resolver, OppoNotificationManager.SETTING_KEY_BLOCK_BANNER, 0, -2) == 1;
            }
            if (uri == null || OppoNotificationManager.QS_NO_DISTURB_URI.equals(uri)) {
                ...
                boolean unused9 = oppoNotificationManager3.mBlockedForQsNoDisturb = z;
            }
    ...
    /* access modifiers changed from: private */
    public void updateAllUserOuidToggle(int userId) {
