...
public abstract class OppoBaseAlarmManagerService extends SystemService {
    ...
    private AlarmUpdateHelper.Callbacks mAlarmUpdateCallbacks = new AlarmUpdateHelper.Callbacks() {
    ...
    protected AlarmUpdateHelper mAlarmUpdateHelper = null;
    protected OppoAlarmWakeupDetection mAlarmWakeupDetection = null;
    IColorAlarmManagerServiceEx mColorAlarmEx = null;
    IColorAlarmManagerServiceInner mColorAlarmMSInner = null;
    private Context mContext = null;
    protected int mDelayAlarmMode = 0;
    private boolean mIsHighTemperatureProtectIn = false;
    protected volatile boolean mIsRestoring = false;
    private boolean mNetstateInteractive = true;
    protected boolean mOppoGuardElfFeature = false;
    protected ArrayList<AlarmManagerService.Alarm> mPendingImportantNonWakeupAlarms = new ArrayList<>();
    /* access modifiers changed from: private */
    public Intent mTimeTickIntentLocal = null;

    static class BaseBroadcastStats {
        long lastTimeWakeup;
    ...
    /* access modifiers changed from: protected */
    public void filterAlarmForHans(ArrayList<AlarmManagerService.Alarm> triggerList) {
        if (this.mColorAlarmMSInner != null) {
            for (int i = triggerList.size() - 1; i >= 0; i--) {
                ...
                if (!(alarm == null || alarm.operation == null)) {
                    ...
                    if (!OppoFeatureCache.get(IColorHansManager.DEFAULT).hansAlarmIfNeeded(action, alarm.creatorUid, alarm.sourcePackage)) {
                        ...
                        this.mColorAlarmMSInner.decrementAlarmCount(alarm.creatorUid, 1);
                    }
                }
            }
        }
    ...
    /* access modifiers changed from: private */
    public void sendNetStateChangedMessage(boolean stateChanged) {
