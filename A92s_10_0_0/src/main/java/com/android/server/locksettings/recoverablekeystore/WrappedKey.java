...
public class WrappedKey {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{javax.crypto.Cipher.init(int, java.security.Key):void throws java.security.InvalidKeyException}
     arg types: [int, android.security.keystore.AndroidKeyStoreSecretKey]
     candidates:
      ClspMth{javax.crypto.Cipher.init(int, java.security.cert.Certificate):void throws java.security.InvalidKeyException}
      ClspMth{javax.crypto.Cipher.init(int, java.security.Key):void throws java.security.InvalidKeyException} */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{javax.crypto.Cipher.init(int, java.security.Key, java.security.spec.AlgorithmParameterSpec):void throws java.security.InvalidAlgorithmParameterException, java.security.InvalidKeyException}
     arg types: [int, android.security.keystore.AndroidKeyStoreSecretKey, javax.crypto.spec.GCMParameterSpec]
     candidates:
      ClspMth{javax.crypto.Cipher.init(int, java.security.Key, java.security.AlgorithmParameters):void throws java.security.InvalidAlgorithmParameterException, java.security.InvalidKeyException}
      ClspMth{javax.crypto.Cipher.init(int, java.security.cert.Certificate, java.security.SecureRandom):void throws java.security.InvalidKeyException}
      ClspMth{javax.crypto.Cipher.init(int, java.security.Key, java.security.SecureRandom):void throws java.security.InvalidKeyException}
      ClspMth{javax.crypto.Cipher.init(int, java.security.Key, java.security.spec.AlgorithmParameterSpec):void throws java.security.InvalidAlgorithmParameterException, java.security.InvalidKeyException} */
