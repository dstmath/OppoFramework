...
class LockSettingsStorage {
    ...
    public static class CredentialHash {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.android.server.locksettings.LockSettingsStorage.CredentialHash.<init>(byte[], int, int, boolean):void
         arg types: [byte[], int, int, int]
         candidates:
          com.android.server.locksettings.LockSettingsStorage.CredentialHash.<init>(byte[], int, int, com.android.server.locksettings.LockSettingsStorage$1):void
          com.android.server.locksettings.LockSettingsStorage.CredentialHash.<init>(byte[], int, int, boolean):void */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0042, code lost:
        r12.mCache.putKeyValueIfUnchanged(r2.getString(0), r2.getString(1), r13, r1);
     */
    ...
    private static class Cache {
        ...
        public void setFetched(int userId) {
            put(2, "isFetched", TemperatureProvider.SWITCH_ON, userId);
        }
