...
public class LockSettingsService extends OppoBaseLockSettingsService {
    ...
    public static OppoLockSettingsServiceUtils mOppoLockSettingsServiceUtils = null;
    /* access modifiers changed from: private */
    public static SyntheticPasswordManager mSyntheticPasswordManager = null;
    ...
    public boolean getBoolean(String key, boolean defaultValue, int userId) {
        ...
        return value.equals("1") || value.equals(TemperatureProvider.SWITCH_ON);
    }
        ...
        synchronized (syntheticPasswordManager2) {
            try {
                if (!isSyntheticPasswordBasedCredentialLocked(userId)) {
                    ...
                    VerifyCredentialResponse verifyFrpCredential = this.mSpManager.verifyFrpCredential(getGateKeeperService(), userCredential2, credentialType, progressCallback);
    ...
    public class LockSettingsInner implements IOppoLockSettingsInner {
        ...
        public long getSyntheticPasswordHandle(int userId) {
            ...
            synchronized (LockSettingsService.this.mSpManager) {
                access$2000 = LockSettingsService.this.getSyntheticPasswordHandleLocked(userId);
            }
            return access$2000;
        }
        ...
        public boolean isSyntheticPasswordBasedCredential(int userId) {
            boolean access$2100;
            synchronized (LockSettingsService.this.mSpManager) {
                access$2100 = LockSettingsService.this.isSyntheticPasswordBasedCredentialLocked(userId);
            }
            return access$2100;
        }
    }
