...
public class LMServiceManager {
    ...
    /* access modifiers changed from: private */
    public static boolean GET_HASH = false;
    ...
    /* access modifiers changed from: private */
    public static ITelephony sTelManager = null;
    private IBinder mBinder = new ILMServiceManager.Stub() {
        ...
        public boolean enableMobileBoost() {
            ...
            try {
                if (SystemProperties.get("sys.oppo.nw.hongbao", "0").equals("1")) {
        ...
        public void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
            ...
            if (args.length == 1) {
                String cmd = args[0];
                if ("-d".equals(cmd)) {
                    boolean unused = LMServiceManager.this.mEnable = false;
                } else if ("-D".equals(cmd)) {
                    boolean unused2 = LMServiceManager.this.mEnable = true;
                } else {
                ...
                if (HealthState.DEBUG.equals(cmd2)) {
                    boolean unused3 = LMServiceManager.DEBUG = "1".equals(args[1]);
                    return;
                } else if ("hash".equals(cmd2)) {
                    boolean unused4 = LMServiceManager.GET_HASH = "1".equals(args[1]);
                    return;
                } else {
    ...
    /* access modifiers changed from: private */
    public LMServiceThreadHandler mHandler;
    /* access modifiers changed from: private */
    public boolean mInitialized = false;
    /* access modifiers changed from: private */
    public LuckyMoneyHelper mLMHelper = null;
    /* access modifiers changed from: private */
    public final Object mLock = new Object();
    /* access modifiers changed from: private */
    public long mMaintainTimeout = SystemClock.elapsedRealtime();
    /* access modifiers changed from: private */
    public SparseArray<Object> mPidArray = new SparseArray<>(0);
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public void enableBoostLocked(int pid, long timeout) {
        try {
    ...
    /* access modifiers changed from: private */
    public void disableBoostLocked(int pid) {
        try {
    ...
    /* access modifiers changed from: private */
    public void enableMaintainLocked() {
        if (DEBUG) {
            ...
            try {
                switch (msg.what) {
                    case 0:
                        ...
                        long unused = LMServiceManager.this.mMaintainTimeout = SystemClock.elapsedRealtime() + ((long) delayTimeout);
                        if (LMServiceManager.DEBUG) {
