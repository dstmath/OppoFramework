...
class OppoBatteryExternalStatsWorker implements OppoBatteryStatsImpl.ExternalStatsSync {
    ...
    /* access modifiers changed from: private */
    public final OppoBatteryStatsImpl mStats;
    private final Runnable mSyncTask = new Runnable() {
        ...
        public void run() {
            ...
            synchronized (OppoBatteryExternalStatsWorker.this) {
                ...
                int unused = OppoBatteryExternalStatsWorker.this.mUpdateFlags = 0;
                String unused2 = OppoBatteryExternalStatsWorker.this.mCurrentReason = null;
                OppoBatteryExternalStatsWorker.this.mUidsToRemove.clear();
                Future unused3 = OppoBatteryExternalStatsWorker.this.mCurrentFuture = null;
                boolean unused4 = OppoBatteryExternalStatsWorker.this.mUseLatestStates = true;
                if ((updateFlags & 31) != 0) {
            ...
            synchronized (OppoBatteryExternalStatsWorker.this) {
                long unused5 = OppoBatteryExternalStatsWorker.this.mLastCollectionTimeStamp = SystemClock.elapsedRealtime();
            }
        }
    };
    @GuardedBy({"mWorkerLock"})
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{java.util.concurrent.ScheduledExecutorService.schedule(java.lang.Runnable, long, java.util.concurrent.TimeUnit):java.util.concurrent.ScheduledFuture<?>}
     arg types: [com.android.internal.util.function.pooled.PooledRunnable, long, java.util.concurrent.TimeUnit]
     candidates:
      MutableMD:<V>:(java.util.concurrent.Callable, long, java.util.concurrent.TimeUnit):java.util.concurrent.ScheduledFuture
