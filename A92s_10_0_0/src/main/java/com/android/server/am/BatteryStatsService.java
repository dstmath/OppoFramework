...
public class BatteryStatsService extends IBatteryStats.Stub implements PowerManagerInternal.LowPowerModeListener, BatteryStatsImpl.PlatformIdleStateCallback, BatteryStatsImpl.RailEnergyDataCallback {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:290:0x051a */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:293:0x0526 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:331:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:344:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:339:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:338:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:336:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:334:0x0248 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:333:0x0248 */
