...
public final class ProcessList {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r15v6, resolved type: com.android.server.am.ProcessList} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r15v8, resolved type: com.android.server.am.ProcessRecord} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r15v9, resolved type: com.android.server.am.ProcessRecord} */
    ...
    public boolean startProcessLocked(ProcessRecord app, HostingRecord hostingRecord, boolean disableHiddenApiChecks, boolean mountExtStorageFull, String abiOverride) {
        ...
        try {
            ...
            try {
                ...
                if ("1".equals(genDebugInfoProperty) || TemperatureProvider.SWITCH_ON.equals(genDebugInfoProperty)) {
                    runtimeFlags2 |= 32;
                }
                String genMiniDebugInfoProperty = SystemProperties.get("dalvik.vm.minidebuginfo");
                if ("1".equals(genMiniDebugInfoProperty) || TemperatureProvider.SWITCH_ON.equals(genMiniDebugInfoProperty)) {
                    runtimeFlags2 |= 2048;
                }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.server.am.ProcessList.MyProcessMap.remove(java.lang.String, int):com.android.server.am.ProcessRecord
     arg types: [java.lang.String, int]
     candidates:
      com.android.server.am.ProcessList.MyProcessMap.remove(java.lang.String, int):java.lang.Object
      com.android.server.am.ProcessList.MyProcessMap.remove(java.lang.String, int):com.android.server.am.ProcessRecord */
    /* access modifiers changed from: package-private */
    @GuardedBy({"mService"})
    ...
    /* JADX INFO: Multiple debug info for r2v4 int: [D('nextIndex' int), D('index' int)] */
    /* access modifiers changed from: package-private */
