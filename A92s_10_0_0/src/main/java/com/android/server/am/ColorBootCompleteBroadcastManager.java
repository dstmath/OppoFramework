...
class ColorBootCompleteBroadcastManager {
    ...
    public boolean DEBUG = SystemProperties.getBoolean("persist.sys.assert.panic.bootcompleted.optimal.log", false);
    ...
    /* access modifiers changed from: private */
    public BrdRecord mBrdRecord = null;
    /* access modifiers changed from: private */
    public int mCheckCount = 0;
    /* access modifiers changed from: private */
    public final Runnable mCheckRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (ColorBootCompleteBroadcastManager.this.mCheckCount == 1) {
                ...
                if (ColorBootCompleteBroadcastManager.this.mBrdRecord != null) {
                    BrdRecord unused = ColorBootCompleteBroadcastManager.this.mBrdRecord = null;
    ...
    /* access modifiers changed from: private */
    public long mClearBrdRecordTime = 1200000;
    ...
    /* access modifiers changed from: private */
    public long mDispatchTimePeriod = ColorAppSwitchManager.INTERVAL;
    ...
    /* access modifiers changed from: private */
    public ArrayList<String> mNoDelayList = new ArrayList<>();
    /* access modifiers changed from: private */
    public int mQueueMaxNum = 20;
    /* access modifiers changed from: private */
    public long mShortDelayAppDispatchTime = ColorAppSwitchManager.INTERVAL;
    /* access modifiers changed from: private */
    public ArrayList<String> mShortDelayList = new ArrayList<>();
    /* access modifiers changed from: private */
    public long mSysAppDispatchTime = 60000;
    /* access modifiers changed from: private */
    public int mSysAppLoopCount = 0;
    /* access modifiers changed from: private */
    public ArrayList<String> mSysLongDelayList = new ArrayList<>();
    /* access modifiers changed from: private */
    public ArrayList<String> mSysShortDelayList = new ArrayList<>();
    /* access modifiers changed from: private */
    public long mThirdAppDispatchTime = ColorDeviceIdleHelper.ALARM_WINDOW_LENGTH;
    ...
    /* access modifiers changed from: private */
    public void enqueueOrderedBroadcast(List receivers) {
