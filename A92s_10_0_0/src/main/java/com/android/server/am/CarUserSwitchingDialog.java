...
final class CarUserSwitchingDialog extends UserSwitchingDialog {
    ...
    public void inflateContent() {
        ...
        if (bitmap != null) {
            ((ImageView) view.findViewById(16909537)).setImageDrawable(CircleFramedDrawable.getInstance(bitmap, res.getDimension(17104985)));
        }
        ((TextView) view.findViewById(16909536)).setText(res.getString(17039642));
        setView(view);
    }
    ...
    static class CircleFramedDrawable extends Drawable {
        ...
        public CircleFramedDrawable(Bitmap icon, int size) {
            ...
            int i2 = this.mSize;
            RectF circleRect = new RectF(OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, (float) i2, (float) i2);
            Path fillPath = new Path();
            fillPath.addArc(circleRect, OppoBrightUtils.MIN_LUX_LIMITI, 360.0f);
            ...
            int i4 = this.mSize;
            this.mDstRect = new RectF(OppoBrightUtils.MIN_LUX_LIMITI, OppoBrightUtils.MIN_LUX_LIMITI, (float) i4, (float) i4);
        }
