...
public class ColorMultiAppManagerService implements IColorMultiAppManager {
    ...
    private Runnable mUnlockedUserRunnable = new Runnable() {
        ...
        public /* synthetic */ void lambda$run$0$ColorMultiAppManagerService$1() {
            synchronized (ColorMultiAppManagerService.this.mAms) {
    ...
    public void createUser(UserInfo info) {
        ...
        if (this.mSupportMultiApp && (activityManagerService = this.mAms) != null && info != null) {
    ...
    private class CreateUserProgressListener extends IProgressListener.Stub {
    ...
    public String getAliasMultiApp(String pkgName) {
        ...
        try {
            label = (String) this.mAms.mContext.getPackageManager().getApplicationLabel(this.mAms.mContext.getPackageManager().getApplicationInfo(pkgName, 128));
