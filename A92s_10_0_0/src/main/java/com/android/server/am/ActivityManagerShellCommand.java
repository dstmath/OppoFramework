...
final class ActivityManagerShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            ...
            switch (c) {
                ...
                case WindowManagerService.H.WINDOW_REPLACEMENT_TIMEOUT /*{ENCODED_INT: 46}*/:
                ...
                case WindowManagerService.H.SET_HAS_OVERLAY_UI /*{ENCODED_INT: 58}*/:
                    return runSupportsMultiwindow(pw);
                case WindowManagerService.H.SET_RUNNING_REMOTE_ANIMATION /*{ENCODED_INT: 59}*/:
                    return runSupportsSplitScreenMultiwindow(pw);
                case WindowManagerService.H.ANIMATION_FAILSAFE /*{ENCODED_INT: 60}*/:
                    return runUpdateApplicationInfo(pw);
                case WindowManagerService.H.RECOMPUTE_FOCUS /*{ENCODED_INT: 61}*/:
                    return runNoHomeScreen(pw);
                case WindowManagerService.H.ON_POINTER_DOWN_OUTSIDE_FOCUS /*{ENCODED_INT: 62}*/:
    ...
    /* JADX DEBUG: Additional 14 move instruction added to help type inference */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v10, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v19, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v20, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v21, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v48, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v49, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v50, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v51, resolved type: android.app.ActivityOptions} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v52, resolved type: android.app.ActivityOptions} */
        ...
        try {
            ...
            while (true) {
                if (this.mStopOption) {
                    ...
                    try {
                        this.mInternal.mAtmInternal.startHomeActivity(0, "goHome");
                ...
                if (this.mWindowingMode != 0) {
                    if (options2 == null) {
                        options5 = ActivityOptions.makeBasic();
                    }
                    options5.setLaunchWindowingMode(this.mWindowingMode);
                    options4 = options5;
                }
                ActivityOptions options6 = options4;
                ActivityOptions options7 = options4;
                if (this.mActivityType != 0) {
                    if (options4 == null) {
                        options7 = ActivityOptions.makeBasic();
                    }
                    options7.setLaunchActivityType(this.mActivityType);
                    options6 = options7;
                }
                ActivityOptions options8 = options6;
                ActivityOptions options9 = options6;
                if (this.mTaskId != i4) {
                    if (options6 == null) {
                        options9 = ActivityOptions.makeBasic();
                    }
                    options9.setLaunchTaskId(this.mTaskId);
                    options8 = options9;
                    if (this.mIsTaskOverlay) {
                        options9.setTaskOverlay(r13, r13);
                        options8 = options9;
                    }
                }
                if (this.mIsLockTask) {
                    ...
                    options8.setLockTaskEnabled(r13);
                    options = options8;
                } else {
                    options = options8;
                }
    ...
    private static void addExtensionsForConfig(EGL10 egl, EGLDisplay display, EGLConfig config, int[] surfaceSize, int[] contextAttribs, Set<String> glExtensions) {
        ...
        if (context != EGL10.EGL_NO_CONTEXT) {
            ...
            if (!TextUtils.isEmpty(extensionList)) {
                for (String extension : extensionList.split(StringUtils.SPACE)) {
    ...
    public int runStackMoveTask(PrintWriter pw) throws RemoteException {
        ...
        if (TemperatureProvider.SWITCH_ON.equals(toTopStr)) {
            toTop = true;
        } else if (TemperatureProvider.SWITCH_OFF.equals(toTopStr)) {
            toTop = false;
        } else {
            PrintWriter errPrintWriter = getErrPrintWriter();
    ...
    public void setBoundsSide(Rect bounds, String side, int value) {
        ...
        if (hashCode != 98) {
            if (hashCode != 108) {
                ...
                } else if (side.equals(ActivityTaskManagerService.DUMP_RECENTS_SHORT_CMD)) {
                    c = 1;
                    if (c == 0) {
                    }
                }
    ...
    public int runNoHomeScreen(PrintWriter pw) throws RemoteException {
        ...
        pw.println(res.getBoolean(17891488));
        return 0;
    }
