...
public class OppoDCIMProtectManager {
    ...
    /* access modifiers changed from: private */
    public static Bundle sRecordedData = null;
    /* access modifiers changed from: private */
    public static int sRecordedMsgWhat = 0;
    ...
    /* access modifiers changed from: private */
    public Messenger mPermissioinDialogService;
    private ServiceConnection mServConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Messenger unused = OppoDCIMProtectManager.this.mPermissioinDialogService = new Messenger(service);
            if (OppoDCIMProtectManager.sRecordedMsgWhat != 0 && OppoDCIMProtectManager.sRecordedData != null) {
                ...
                int unused2 = OppoDCIMProtectManager.sRecordedMsgWhat = 0;
                Bundle unused3 = OppoDCIMProtectManager.sRecordedData = null;
            }
        }

        public void onServiceDisconnected(ComponentName name) {
            Log.d(OppoDCIMProtectManager.TAG, "onServiceDisconnected");
            Messenger unused = OppoDCIMProtectManager.this.mPermissioinDialogService = null;
            boolean unused2 = OppoDCIMProtectManager.this.bindPermissionDialogService();
        }
    };
