...
public final class OppoBatteryStatsService extends BatteryStatsService {
    ...
    public static String TAG = "OppoBatteryStatsService";
    ...
    private class OppoBatteryStatsInternalImpl extends OppoBatteryStatsInternal {
    ...
    /* access modifiers changed from: private */
    public void setThermalStateInternal(OppoThermalState thermalState) {
    ...
    /* access modifiers changed from: private */
    public void noteScreenBrightnessModeChangedInternal(boolean isAuto) {
