...
public class AssistDataRequester extends IAssistDataReceiver.Stub {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:82:0x00dd */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:80:0x00dd */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v6, resolved type: android.os.Bundle} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v7, resolved type: int} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v3, resolved type: java.util.ArrayList<android.os.Bundle>} */
    ...
    /* JADX WARN: Type inference failed for: r13v9, types: [android.os.Bundle, java.lang.Object] */
    ...
    private void requestData(List<IBinder> activityTokens, boolean requestAutofillData, boolean fetchData, boolean fetchScreenshot, boolean allowFetchData, boolean allowFetchScreenshot, int callingUid, String callingPackage) {
            ...
            if (this.mAppOpsManager.checkOpNoThrow(this.mRequestStructureAppOps, callingUid, callingPackage) == 0 && allowFetchData2) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        receiverExtras.putInt("count", numActivities2);
        ...
        if (fetchScreenshot) {
            if (this.mAppOpsManager.checkOpNoThrow(this.mRequestScreenshotAppOps, callingUid, callingPackage) == 0 && allowFetchScreenshot2) {
                ...
                dispatchAssistScreenshotReceived(bundle);
            } else {
                this.mAssistScreenshot.add(bundle);
            }
        }
        tryDispatchRequestComplete();
    }
    ...
    private void dispatchAssistDataReceived(Bundle data) {
        ...
        if (receiverExtras != null) {
            ...
            activityCount = receiverExtras.getInt("count");
        }
