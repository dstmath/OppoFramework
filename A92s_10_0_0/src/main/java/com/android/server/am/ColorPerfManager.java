...
public class ColorPerfManager implements IColorPerfManager {
    ...
    private static class ColorPerfManagerInstance {
        /* access modifiers changed from: private */
        public static final ColorPerfManager sInstance = new ColorPerfManager();
    ...
    /* access modifiers changed from: private */
    public void dumpPerfDataLocked(int checkedDumpType, Bundle bundle, ProcessRecord proc) {
                            ...
                            try {
                                if (file.exists()) {
                                    try {
                                        ...
                                        file2 = file;
                                        try {
                                            Slog.e(TAG, "dump proc heap get Exception: " + e);
                                            return;
                                        } catch (Throwable th) {
                                            th = th;
                                        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x001a, code lost:
        return r1;
     */
    public ProcessRecord findProcessLocked(int pid, int userId) {
    ...
    public boolean dumpProcPerfData(final Bundle bundle) {
        ...
        if (checkedDumpType != 0) {
            ...
            DumpThread.getHandler().post(new Runnable() {
                ...
                public void run() {
                    Trace.traceBegin(64, "dumpPerfDataLocked" + "_" + dumpType + "_" + pid + "_" + Binder.getCallingPid());
                    try {
                        synchronized (this) {
