...
public final class ColorActivityManagerTransactionHelper extends ColorActivityManagerCommonHelper implements IColorActivityManager {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        if (!checkCodeValid(code, 1, 1)) {
            ...
            switch (code) {
                ...
                case 10078:
                    data.enforceInterface("android.app.IActivityManager");
                    setHansController(IColorHansController.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 10079:
                    data.enforceInterface("android.app.IActivityManager");
    ...
    public void setHansController(IColorHansController controller) {
        this.mAms.enforceCallingPermission("oppo.permission.OPPO_COMPONENT_SAFE", "setHansController");
        ColorHansManager.getInstance().setHansController(controller);
    }
