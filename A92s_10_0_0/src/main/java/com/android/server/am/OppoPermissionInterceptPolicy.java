...
public class OppoPermissionInterceptPolicy {
    ...
    public static final boolean DEBUG = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, (boolean) DEBUG);
    ...
    /* access modifiers changed from: private */
    public static Boolean sAllowBackgroundRequest;
    public static boolean sAllowPermissionRecord;
    /* access modifiers changed from: private */
    public static Map<String, Integer> sBackgroundCameraSkipPkgs = new HashMap();
    /* access modifiers changed from: private */
    public static List<String> sBackgroundSkipList = new ArrayList();
    /* access modifiers changed from: private */
    public static List<String> sBackgroundSkipPermissions = new ArrayList();
    ...
    /* access modifiers changed from: private */
    public static boolean sIsExVersion = DEBUG;
    ...
    /* access modifiers changed from: private */
    public static boolean sIsSpecialCarrier = DEBUG;
    /* access modifiers changed from: private */
    public static LinkedList<PermissionCheckingMsg> sPermissionCheckMsgList = new LinkedList<>();
    private static OppoPermissionInterceptPolicy sPermissionInterceptPolicy;
    private static List<String> sPermissionsPrompt;
    /* access modifiers changed from: private */
    public static Bundle sRecordData = null;
    /* access modifiers changed from: private */
    public static int sRecordMsgCode = 0;
    ...
    /* access modifiers changed from: private */
    public static boolean sRejectChargeSms = DEBUG;
    /* access modifiers changed from: private */
    public static List<String> sRejectDialogPermissionList = new ArrayList();
    /* access modifiers changed from: private */
    public static List<String> sSMSConfirmSkipList = new ArrayList();
    ...
    /* access modifiers changed from: private */
    public ConcurrentHashMap<Integer, ContentProviderClient> mContentProviderMap = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public Messenger mDialogService;
    ...
    /* access modifiers changed from: private */
    public PermissionCheckingMsg mRecordPcm = null;
    private int[] mResultList = new int[DATA_NUM_THRESHOLD];
    /* access modifiers changed from: private */
    public CheckBox mSaveCheckBox;
    private ServiceConnection mServConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Messenger unused = OppoPermissionInterceptPolicy.this.mDialogService = new Messenger(service);
            if (OppoPermissionInterceptPolicy.sRecordMsgCode != 0 && OppoPermissionInterceptPolicy.sRecordData != null) {
                ...
                int unused2 = OppoPermissionInterceptPolicy.sRecordMsgCode = 0;
                Bundle unused3 = OppoPermissionInterceptPolicy.sRecordData = null;
            }
        }

        public void onServiceDisconnected(ComponentName name) {
            Log.d(OppoPermissionInterceptPolicy.TAG, "onServiceDisconnected");
            Messenger unused = OppoPermissionInterceptPolicy.this.mDialogService = null;
            OppoPermissionInterceptPolicy oppoPermissionInterceptPolicy = OppoPermissionInterceptPolicy.this;
            boolean unused2 = oppoPermissionInterceptPolicy.bindDialogService(oppoPermissionInterceptPolicy.mContext);
    ...
    /* access modifiers changed from: private */
    public String mSmsContent = null;
    /* access modifiers changed from: private */
    public String mSmsDestination = null;
                ...
                if (msg.what == 0) {
                    synchronized (OppoPermissionInterceptPolicy.sPermissionCheckMsgList) {
                        ...
                        if (OppoPermissionInterceptPolicy.sPermissionCheckMsgList.size() >= 1) {
                            ...
                            if (pcm != null) {
                                try {
                                    PermissionCheckingMsg unused = OppoPermissionInterceptPolicy.this.mRecordPcm = pcm;
                                    ...
                                    String unused2 = OppoPermissionInterceptPolicy.this.mCallNumber = null;
                                } catch (Exception e) {
    ...
    /* access modifiers changed from: private */
    public void changePermissionChoice(PackagePermission packagePermission, long permissionMask, int choice) {
    ...
    /* access modifiers changed from: private */
    public long getPermissionMask(String permission) {
        long mask = 0;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00ef, code lost:
        return r10;
     */
    public PackagePermission queryPackagePermissionsAsUser(String packageName, int userId) {
    ...
    /* access modifiers changed from: private */
    public void savePermissionChoiceAsUser(PackagePermission packagePermission, int userId) {
    ...
    /* access modifiers changed from: private */
    public void notifyWaitingApp(PermissionCheckingMsg pcm, int res) {
        try {
    ...
    /* access modifiers changed from: private */
    public void processPermission(PermissionCheckingMsg pcm, int res, boolean save) {
        String[] data;
    ...
    /* access modifiers changed from: private */
    public final void showWindow(final PermissionCheckingMsg pcm) {
        if (DEBUG) {
    ...
    /* access modifiers changed from: private */
    public boolean isChargeSmsByPkg(String packageName, String sms, String number) {
        boolean result = DEBUG;
    ...
    /* access modifiers changed from: private */
    public void sendNormalSmsStatisticAsUser(String pkgName, String permission, int userId) {
    ...
    /* access modifiers changed from: private */
    public void sendActionStatisticAsUser(String pkgName, String permission, boolean allowed, int userId) {
    ...
    /* access modifiers changed from: private */
    public boolean isEnabledInputMethod(Context context, String packageName) {
    ...
    /* access modifiers changed from: private */
    public void sendDialogMsg(int msgCode, Bundle data) {
    ...
    /* access modifiers changed from: private */
    public boolean bindDialogService(Context context) {
        try {
    ...
    /* access modifiers changed from: private */
    public void statisticsScreenOffPermissionRequest(String packageName, String permissionName, String permissionValue) {
        if (isForumVersion()) {
    ...
    /* access modifiers changed from: private */
    public boolean isDefaultSmsApp(Context context, String packageName) {
        boolean result = DEBUG;
    ...
    /* access modifiers changed from: private */
    public boolean isDefaultDialerApp(Context context, String packageName) {
        boolean result = DEBUG;
    ...
    private class UpdatePermissionRecord implements Runnable {
    ...
    private void startAppServiceIfNecessary() {
        if (this.mController == null) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "start record service err !");
            }
        }
    }

    /* access modifiers changed from: private */
    public void notifyPermissionRecordInfo(String[] packageNameList, String[] permissionNameList, long[] timeList, int[] resultList) {
        startAppServiceIfNecessary();
        if (this.mController != null) {
