...
public class BroadcastDispatcher {
    ...
    class Dumper {
        ...
        public void setLabel(String label) {
            this.mLabel = "  " + label + StringUtils.SPACE + this.mQueueName + " #";
            this.mOrdinal = 0;
        }
    ...
    public BroadcastDispatcher(BroadcastQueue queue, BroadcastConstants constants, Handler handler, ActivityManagerService service) {
        this.mQueue = queue;
    ...
    public void enqueueOrderedBroadcastLocked(BroadcastRecord r) {
        ...
        OppoFeatureCache.get(IColorBroadcastManager.DEFAULT).adjustQueueIfNecessary(this.mOrderedBroadcasts, r);
        if (ActivityManagerDebugConfig.DEBUG_BROADCAST) {
            Slog.v(TAG, "mOrderedBroadcasts add: " + r + " mOrderedBroadcasts " + this.mOrderedBroadcasts);
        }
    }
    ...
    public ArrayList<BroadcastRecord> getOrderedBroadcasts() {
        return this.mOrderedBroadcasts;
    }
}
