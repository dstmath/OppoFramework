...
public class ColorGameSpaceManager implements IColorGameSpaceManager {
    ...
    /* access modifiers changed from: private */
    public boolean mGameDockEnable = true;
    /* access modifiers changed from: private */
    public boolean mGameDockHide;
    ...
    /* access modifiers changed from: private */
    public boolean mInterceptGamepadKey;
    ...
    private Runnable mLongPressRunnable = new Runnable() {
        ...
        public void run() {
            boolean unused = ColorGameSpaceManager.this.mLongPress = true;
    ...
    /* access modifiers changed from: private */
    public void handleApplicationSwitchInner(String prePkgName, String nextPkgName, String prevActivity, String nextActivity, boolean isPreMultiApp, boolean isNextMultiApp, boolean isPreForFreeForm, boolean isNextForFreeForm) {
        if (this.mDynamicDebug) {
    ...
    /* access modifiers changed from: private */
    public void checkGameDockEnable(Context context, Intent intent, String action) {
    ...
    private void initGameDockState(Context context) {
        ...
        contentResolver.registerContentObserver(Settings.Global.getUriFor(GAME_DOCK_SWITCH_KEY), true, new ContentObserver(this.mGsHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                try {
                    ...
                    boolean unused = colorGameSpaceManager.mGameDockEnable = z;
        ...
        contentResolver.registerContentObserver(Settings.Global.getUriFor(GAME_DOCK_STATE_KEY), true, new ContentObserver(this.mGsHandler) {
            ...
            public void onChange(boolean selfChange) {
                super.onChange(selfChange);
                try {
                    boolean unused = ColorGameSpaceManager.this.mGameDockHide = Settings.Global.getInt(contentResolver, ColorGameSpaceManager.GAME_DOCK_STATE_KEY) == 0;
                    Slog.i("ColorGameSpaceManager", "GameDockEnable has changed. mGameDockEnable = " + ColorGameSpaceManager.this.mGameDockEnable);
                } catch (Settings.SettingNotFoundException e) {
                    Slog.e("ColorGameSpaceManager", "Settings.SettingNotFoundException for mGameDockEnable.");
                }
    ...
    /* access modifiers changed from: private */
    public void handleDefatultInputMethodAppId() {
    ...
    /* access modifiers changed from: private */
    public int getJoyStickAbleStatus() {
    ...
    /* access modifiers changed from: private */
    public void setJoyStickAbleStatus(int value) {
        String curStatus = SystemProperties.get(JOYSTICK_CONFIG_PROPERTY, "0");
        if (curStatus != null) {
    ...
    /* access modifiers changed from: private */
    public void startGameDockAction(String action) {
        try {
            ...
            if (uri != null) {
                try {
                    ...
                    if (uri.equals(Settings.System.getUriFor(ColorGameSpaceManager.SETTING_VALUE_INTERCEPT_KEY))) {
                        ...
                        boolean unused = colorGameSpaceManager.mInterceptGamepadKey = z;
