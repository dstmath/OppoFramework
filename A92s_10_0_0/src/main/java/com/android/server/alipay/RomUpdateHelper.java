...
public abstract class RomUpdateHelper<T extends UpdateInfo> {
    ...
    public T getNewerInfo() {
        return ((UpdateInfo) this.mUpdateInfoData).mVersion > ((UpdateInfo) this.mUpdateInfoSys).mVersion ? this.mUpdateInfoData : this.mUpdateInfoSys;
    }
