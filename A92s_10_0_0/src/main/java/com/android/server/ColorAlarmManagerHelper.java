...
public class ColorAlarmManagerHelper implements IColorAlarmManagerHelper {
    ...
    private final String COLUMN_NAME_1 = ColorStartingWindowRUSHelper.VERSION_NAME;
    ...
    private final List<String> PENDING_JOB_BLACK = Arrays.asList(new String[0]);
    ...
    /* access modifiers changed from: private */
    public AtomicBoolean sIsWhiteListInited = new AtomicBoolean();
    private ArrayList<String> sKeyList = new ArrayList<>();
    /* access modifiers changed from: private */
    public final Object sLock = new Object();
    /* access modifiers changed from: private */
    public boolean sOppoDebug = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, false);
    ...
    /* access modifiers changed from: private */
    public void addSparkCellBroadcast() {
    ...
    public boolean inPackageNameWhiteList(String pkgName) {
        synchronized (this.sLock) {
            if (this.sPkgWhiteList != null) {
                if (pkgName != null) {
                    boolean contains = this.sPkgWhiteList.contains(pkgName);
                    return contains;
                }
            }
            return false;
        ...
        synchronized (this.sLock) {
            if (this.mAcmeBlackConfig != null) {
                if (pkgName != null) {
                    ...
                    Integer num = arrayMap.get(pkgName + "_" + tag);
                    return num;
                }
            }
            return 0;
                                            ...
                                            if (!"AlignInterval".equals(strName) || !parseAlignInterval) {
                                                ...
                                                if ("AlignFirstDelay".equals(strName) && parseAlignFirstDelay) {
                                                    try {
                                                        ...
                                                        Log.w("ColorAlarmManagerHelper", "AlignFirstDelay excption.", e);
                                                    }
                                                    ...
                                                    if (!"AlignEnforcedWhiteArray".equals(strName) || !parseAlignEnforcedWhiteArray) {
                                                        if ("DeepSleepArray".equals(strName) && parseDeepSleepWhiteArray) {
                                                            ...
                                                            try {
                                                                ...
                                                                Log.w("ColorAlarmManagerHelper", "PendingJobCount excption.", e2);
                                                            }
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        Log.w("ColorAlarmManagerHelper", "AlignInterval excption.", e6);
                                                    } catch (Exception e7) {
                                                        e = e7;
    ...
    public void getDataFromProvider() {
        ...
        strAlarmWhiteList = null;
        strAlarmWhiteList = null;
        strAlarmWhiteList = null;
        try {
            cursor = this.sContext.getContentResolver().query(this.CONTENT_URI_WHITE_LIST, new String[]{ColorStartingWindowRUSHelper.VERSION_NAME, "xml"}, "filtername=\"sys_alarm_filterpackages_list\"", null, null);
            if (cursor != null && cursor.getCount() > 0) {
                cursor.getColumnIndex(ColorStartingWindowRUSHelper.VERSION_NAME);
    ...
    /* access modifiers changed from: private */
    public boolean isDeepSleepTrafficPkg(String pkg) {
        boolean match = false;
        if (pkg == null) {
            return false;
        }
