...
public final class BatteryService extends OppoBaseBatteryService {
            ...
            this.mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (BatteryService.this.mActivityManagerInternal.isSystemReady()) {
                        ...
                        Slog.v(access$800, "mHealthInfo.batteryLevel = " + BatteryService.this.mHealthInfo.batteryLevel + "shutdown because of low power");
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x017f, code lost:
        return;
     */
    ...
    private final class LocalService extends BatteryManagerInternal {
        ...
        public boolean isPowered(int plugTypeSet) {
            boolean access$1900;
            synchronized (BatteryService.this.mLock) {
                access$1900 = BatteryService.this.isPoweredLocked(plugTypeSet);
            }
            return access$1900;
        }
        ...
        public int getPlugType() {
            int access$2000;
            synchronized (BatteryService.this.mLock) {
                access$2000 = BatteryService.this.mPlugType;
            }
            return access$2000;
        }
        ...
        public boolean getBatteryLevelLow() {
            boolean access$2100;
            synchronized (BatteryService.this.mLock) {
                access$2100 = BatteryService.this.mBatteryLevelLow;
            }
            return access$2100;
        }
    ...
    public static final class HealthServiceWrapper {
        ...
        public interface IHealthSupplier {
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             method: android.hardware.health.V2_0.IHealth.getService(java.lang.String, boolean):android.hardware.health.V2_0.IHealth
             arg types: [java.lang.String, int]
             candidates:
              android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
              android.hardware.health.V2_0.IHealth.getService(java.lang.String, boolean):android.hardware.health.V2_0.IHealth */
