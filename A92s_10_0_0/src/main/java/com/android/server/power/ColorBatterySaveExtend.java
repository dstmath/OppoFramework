...
public class ColorBatterySaveExtend implements IColorBatterySaveExtend {
    ...
    public static boolean mOppoDebug = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, false);
    private static ColorBatterySaveExtend sColorBatterySaveExtend = null;
    /* access modifiers changed from: private */
    public IColorAppSwitchManager.ActivityChangedListener mActivityChangedListener = new IColorAppSwitchManager.ActivityChangedListener() {
    ...
    /* access modifiers changed from: private */
    public boolean mBatterySaveEnabled;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public void screenOffTimeSwitch(Context context, boolean enable) {
        if (!isClosedSuperFirewall(context.getPackageManager())) {
    ...
    /* access modifiers changed from: private */
    public boolean getHapticFeedbackEnable(Context context) {
    ...
    /* access modifiers changed from: private */
    public void setFeedbackChgByUser(Context context, boolean change) {
    ...
    /* access modifiers changed from: private */
    public void hypnusLowPowerModeOn(boolean enable) {
        if (this.mHyp == null) {
            this.mHyp = new Hypnus();
        }
        if (enable && !this.mHypnusLowPowerenabled) {
            this.mHyp.hypnusSetNotification(3, (int) NOTIF_TYPE_LOW_POWER_MODE_ON);
            this.mHypnusLowPowerenabled = true;
            if (mOppoDebug) {
                Log.d(TAG, "hypnusLowPowerModeOn enable");
            }
        } else if (!enable && this.mHypnusLowPowerenabled) {
            this.mHyp.hypnusSetNotification(3, (int) NOTIF_TYPE_LOW_POWER_MODE_OFF);
    ...
    private class FeedbackStateObserver extends ContentObserver {
