...
public class BatterySaverController extends OppoBaseBatterySaverController implements BatterySaverPolicy.BatterySaverPolicyListener {
    ...
    public class MyHandler extends Handler {
        ...
        public void dispatchMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                Plugin[] access$500 = BatterySaverController.this.mPlugins;
                int length = access$500.length;
                for (i2++; i2 < length; i2++) {
                    access$500[i2].onSystemReady(BatterySaverController.this);
                }
            }
        }
    }
    ...
    public void updateBatterySavingStats() {
        ...
        synchronized (this.mLock) {
            if (!this.mIsPluggedIn || !OppoFeatureCache.get(IColorBatterySaveExtend.DEFAULT).isClosedSuperFirewall(this.mContext.getPackageManager())) {
