...
public class ColorScreenOffOptimization implements IColorScreenOffOptimization {
    ...
    public boolean DEBUG_PANIC = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, false);
    ...
    /* access modifiers changed from: private */
    public IColorPowerManagerServiceInner mInner;
    /* access modifiers changed from: private */
    public boolean mIsMmiTesting = false;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            synchronized (ColorScreenOffOptimization.this.mLock) {
                if ("android.intent.action.USER_PRESENT".equals(intent.getAction())) {
                    ...
                    boolean unused = ColorScreenOffOptimization.this.mIsMmiTesting = true;
                } else if (ColorScreenOffOptimization.STOP_MMI_TEST_CMD.equals(intent.getAction())) {
                    boolean unused2 = ColorScreenOffOptimization.this.mIsMmiTesting = false;
                }
            }
        }
    }
