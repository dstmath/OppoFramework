...
public class BatteryIdleController extends StateController {
    ...
    /* access modifiers changed from: private */
    public int mIdleDelay = 300000;
    /* access modifiers changed from: private */
    public int mThresholdBattLow = 30;
    /* access modifiers changed from: private */
    public int mThresholdBattNormal = 70;
    ...
    public class BattIdleTracker extends BroadcastReceiver {
        ...
        private void battChangeHandle(Intent intent) {
            ...
            if (this.mPlugType != 0) {
                ...
                if (!this.mIsOnStablePower) {
                    if (oldPlugType == 0) {
                        this.mBatteryLevelPlugIn = this.mBatteryLevel;
                        int unused = BatteryIdleController.this.mThresholdBattLow = OppoGuardElfConfigUtil.getInstance().getThreshBattIdleLowLevel();
                        int unused2 = BatteryIdleController.this.mThresholdBattNormal = OppoGuardElfConfigUtil.getInstance().getThreshBattIdleNormalLevel();
        ...
        private void screenoffIdleAlarmHandle() {
            if (!this.mScreenOff || !this.mPluged) {
                ...
                int unused = BatteryIdleController.this.mIdleDelay = OppoGuardElfConfigUtil.getInstance().getThreshBattIdleDelay() * 1000;
