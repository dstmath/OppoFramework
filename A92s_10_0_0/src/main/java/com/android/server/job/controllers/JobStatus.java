...
public final class JobStatus extends OppoBaseJobStatus {
    static final int CONSTRAINTS_OF_INTEREST = -1811932145;
    ...
    private JobStatus(JobInfo job2, int callingUid2, int targetSdkVersion2, String sourcePackageName2, int sourceUserId2, int standbyBucket2, long heartbeat, String tag2, int numFailures2, long earliestRunTimeElapsedMillis2, long latestRunTimeElapsedMillis2, long lastSuccessfulRunTime, long lastFailedRunTime, int internalFlags) {
        ...
        if (!(sourceUserId2 == -1 || sourcePackageName2 == null)) {
            ...
            int requiredConstraints3 = (job2.getTriggerContentUris() != null ? requiredConstraints2 | CONSTRAINT_CONTENT_TRIGGER : requiredConstraints2) | initRequiredConstraints(job2);
            initColorDeepSleepHelper(this, job2);
            this.requiredConstraints = requiredConstraints3;
            this.mRequiredConstraintsOfInterest = requiredConstraints3 & CONSTRAINTS_OF_INTEREST;
        ...
        int requiredConstraints32 = (job2.getTriggerContentUris() != null ? requiredConstraints22 | CONSTRAINT_CONTENT_TRIGGER : requiredConstraints22) | initRequiredConstraints(job2);
        initColorDeepSleepHelper(this, job2);
        this.requiredConstraints = requiredConstraints32;
        this.mRequiredConstraintsOfInterest = requiredConstraints32 & CONSTRAINTS_OF_INTEREST;
        this.mReadyNotDozing = (job2.getFlags() & 1) == 0;
        this.mLastSuccessfulRunTime = lastSuccessfulRunTime;
        this.mLastFailedRunTime = lastFailedRunTime;
        this.mInternalFlags = internalFlags;
    ...
    @Override // com.android.server.job.controllers.OppoBaseJobStatus
    ...
    private boolean isReady(int satisfiedConstraints2) {
        if (!this.mReadyWithinQuota || !OppoFeatureCache.get(IColorDeepSleepHelper.DEFAULT).handleMatchDeepSleepRuleJob(this.mReadyDeadlineSatisfied, this.mReadyNotDozing) || !this.mReadyNotDozing || !this.mReadyNotRestrictedInBg) {
            return false;
        }
    ...
    public void dumpConstraints(PrintWriter pw, int constraints) {
        ...
        super.dumpConstraints(pw, constraints);
        if (constraints != 0) {
            pw.print(" [0x");
    ...
    /* access modifiers changed from: protected */
    @Override // com.android.server.job.controllers.OppoBaseJobStatus
    public int getRequiredConstraints() {
        return this.requiredConstraints;
    }

    /* access modifiers changed from: protected */
    @Override // com.android.server.job.controllers.OppoBaseJobStatus
    public boolean setOppoConstraintSatisfied(int constraint, boolean state) {
        return setConstraintSatisfied(constraint, state);
    }
    ...
    /* access modifiers changed from: protected */
    @Override // com.android.server.job.controllers.OppoBaseJobStatus
    public int getIntCcov() {
        return CONSTRAINTS_OF_INTEREST;
    }

    /* access modifiers changed from: protected */
    @Override // com.android.server.job.controllers.OppoBaseJobStatus
    public int getIntSocv() {
        return SOFT_OVERRIDE_CONSTRAINTS;
    }
}
