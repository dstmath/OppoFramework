...
public class ColorDeviceIdleHelper implements IColorDeviceIdleHelper {
    ...
    public static boolean sOppoDebug = SystemProperties.getBoolean(ColorAILog.OPPO_LOG_KEY, false);
    ...
    /* access modifiers changed from: private */
    public List<String> mCustomDozeWhiteList = new ArrayList();
    /* access modifiers changed from: private */
    public DeviceIdleController mDeviceIdleController;
    /* access modifiers changed from: private */
    public DeviceIdleStatistics mDeviceIdleStatistics;
    ...
    /* access modifiers changed from: private */
    public ArrayList<String> mWhiteListAll = new ArrayList<>();
    ...
    public void onMotionDetected(int state, int typeMotion) {
        ...
        data.putInt(OppoPermissionInterceptPolicy.COLUMN_STATE_STR, state);
    ...
    /* access modifiers changed from: private */
    public void reconfirmWhiteList(Bundle data) {
    ...
    public class DeviceIdleStatistics {
        ...
        public void onMotionDetected(Bundle data) {
            if (data != null) {
                int state = data.getInt(OppoPermissionInterceptPolicy.COLUMN_STATE_STR);
    ...
    public void enterDeepSleepQuickly() {
        ...
        if (iColorDeviceIdleControllerInner != null) {
            ...
            if (mIdleState == 0 && mIdleDeepEnabled) {
                ...
                this.mInner.setNextIdlePendingDelay((long) IDLE_PENDING_TIMEOUT);
