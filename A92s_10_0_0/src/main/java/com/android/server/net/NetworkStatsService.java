...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    /* access modifiers changed from: private */
    public NetworkStats internalGetIncrementForNetwork(NetworkTemplate template) {
        int i;
    ...
    /* access modifiers changed from: private */
    public void processPollBroadcast() {
    ...
    /* access modifiers changed from: private */
    public void processSetUidForeground(int uid, int uidFgValue) {
        synchronized (this.mStatsLock) {
            int set = 1;
            if (1 != uidFgValue) {
                set = 0;
    ...
    /* access modifiers changed from: private */
    public void removeMultiAppUid(int multiAppUid) {
        if (LOG_NET_STATS) {
