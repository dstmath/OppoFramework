...
public class OPPODnsSelfrecoveryEngine {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                if (action.equals(OPPODnsSelfrecoveryEngine.ACTION_SCREEN_ON)) {
                    ...
                    int unused = OPPODnsSelfrecoveryEngine.this.mTrigerType = 2;
    ...
    /* access modifiers changed from: private */
    public boolean isDnsRecoveryEngineEnable() {
    ...
    /* access modifiers changed from: private */
    public void setDnsStatistics(String eventId, String type) {
    ...
    /* access modifiers changed from: private */
    public void executeDNSSelfRecovery() {
