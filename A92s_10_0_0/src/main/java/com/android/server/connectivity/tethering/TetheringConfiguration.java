...
public class TetheringConfiguration {
    ...
    public TetheringConfiguration(Context ctx, SharedLog log, int id) {
        ...
        this.tetherableUsbRegexs = getResourceStringArray(res, 17236083);
        this.tetherableWifiRegexs = getResourceStringArray(res, 17236084);
        this.tetherableBluetoothRegexs = getResourceStringArray(res, 17236080);
        ...
        this.provisioningApp = getResourceStringArray(res, 17236046);
    ...
    private static Collection<Integer> getUpstreamIfaceTypes(Resources res, boolean dunRequired) {
        int[] ifaceTypes = res.getIntArray(17236082);
    ...
    private static String[] getLegacyDhcpRanges(Resources res) {
        String[] fromResource = getResourceStringArray(res, 17236081);
