...
public class KeepaliveTracker {
    ...
    public class KeepaliveInfo implements IBinder.DeathRecipient {
        ...
        public String toString() {
            return "KeepaliveInfo [ type=" + this.mType + " network=" + this.mNai.network + " startedState=" + startedStateString(this.mStartedState) + StringUtils.SPACE + IpUtils.addressAndPortToString(this.mPacket.srcAddress, this.mPacket.srcPort) + "->" + IpUtils.addressAndPortToString(this.mPacket.dstAddress, this.mPacket.dstPort) + " interval=" + this.mInterval + " uid=" + this.mUid + " pid=" + this.mPid + " privileged=" + this.mPrivileged + " packetData=" + HexDump.toHexString(this.mPacket.getPacket()) + " ]";
        }
