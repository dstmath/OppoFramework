...
public class PswServiceFactoryImpl extends PswServiceFactory {
    ...
    public <T extends IOppoCommonFeature> T getFeature(T def, Object... vars) {
        ...
        switch (AnonymousClass1.$SwitchMap$android$common$OppoFeatureList$OppoIndex[def.index().ordinal()]) {
            case 1:
                return OppoFeatureManager.getTraceMonitor(getPswSystemServerEx(vars));
            case 2:
                return OppoFeatureManager.getTraceMonitor(getPswActivityManagerServiceEx(vars));
            case 3:
                return OppoFeatureManager.getTraceMonitor(getPswActivityTaskManagerServiceEx(vars));
            case 4:
                return OppoFeatureManager.getTraceMonitor(getPswWindowManagerService(vars));
            case 5:
                return OppoFeatureManager.getTraceMonitor(getPswPackageManagerService(vars));
            case 6:
                return OppoFeatureManager.getTraceMonitor(getPswPowerManagerService(vars));
            case 7:
                return OppoFeatureManager.getTraceMonitor(getOppoLocationBlacklistUtil(vars));
            case 8:
                return OppoFeatureManager.getTraceMonitor(getNavigationStatusController(vars));
            case 9:
                return OppoFeatureManager.getTraceMonitor(getOppoGnssWhiteListProxy(vars));
            case 10:
                return OppoFeatureManager.getTraceMonitor(getOppoNlpProxy(vars));
            case 11:
                return OppoFeatureManager.getTraceMonitor(getOppoSuplController(vars));
            case 12:
                return OppoFeatureManager.getTraceMonitor(getGnssDiagnosticTool(vars));
            case 13:
                return OppoFeatureManager.getTraceMonitor(getOppoLbsCustomize(vars));
            case 14:
                return OppoFeatureManager.getTraceMonitor(getOppoLbsRepairer(vars));
            case 15:
                return OppoFeatureManager.getTraceMonitor(getOppoGnssDuration(vars));
            case 16:
                return OppoFeatureManager.getTraceMonitor(getFastNetworkLocation(vars));
            case 17:
                return OppoFeatureManager.getTraceMonitor(getOppoCoarseToFine(vars));
            case 18:
                return OppoFeatureManager.getTraceMonitor(getOppoLocationStatistics(vars));
            case 19:
                return OppoFeatureManager.getTraceMonitor(getPswFeatureAOD(vars));
            case 20:
                return OppoFeatureManager.getTraceMonitor(getOppoGatewayState(vars));
            case 21:
                return OppoFeatureManager.getTraceMonitor(getOppoIPConflictDetector(vars));
            case 22:
                return OppoFeatureManager.getTraceMonitor(getOPPODnsSelfrecoveryEngine(vars));
            case 23:
                return OppoFeatureManager.getTraceMonitor(getPswShutdownFeature(vars));
            case 24:
                return OppoFeatureManager.getTraceMonitor(getOppoBrightness(vars));
            case 25:
                return OppoFeatureManager.getTraceMonitor(getPswFeatureReduceBrightness(vars));
            case 26:
                return OppoFeatureManager.getTraceMonitor(getPswFeatureBrightness(vars));
            case 27:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getOppoUsbDeviceManagerFeature(vars));
            case 28:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getOppoVibratorFeature(vars));
            case 29:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getOppoStorageManagerFeature(vars));
            case 30:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswAlarmManagerFeature(vars));
            case 31:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswNewNetworkTimeUpdateServiceFeature(vars));
            case 32:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswActivityManagerDynamicLogConfigFeature(vars));
            case 33:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswOppoArmyControllerFeatrue(vars));
            case 34:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswOppoArmyServiceFeatrue(vars));
            case 35:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getPswOppoAmsUtilsFeatrue(vars));
            case 36:
                Slog.i(TAG, "get feature:" + def.index().name());
                return OppoFeatureManager.getTraceMonitor(getOppoScreenModeManagerFeature(vars));
            default:
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswGnssDuration.ordinal()] = 15;
            } catch (NoSuchFieldError e15) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswFastNetworkLocation.ordinal()] = 16;
            } catch (NoSuchFieldError e16) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswCoarseToFine.ordinal()] = 17;
            } catch (NoSuchFieldError e17) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswLocationStatistics.ordinal()] = 18;
            } catch (NoSuchFieldError e18) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswFeatureAOD.ordinal()] = 19;
            } catch (NoSuchFieldError e19) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoGatewayState.ordinal()] = 20;
            } catch (NoSuchFieldError e20) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoIPConflictDetector.ordinal()] = 21;
            } catch (NoSuchFieldError e21) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOPPODnsSelfrecoveryEngine.ordinal()] = 22;
            } catch (NoSuchFieldError e22) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswShutdownFeature.ordinal()] = 23;
            } catch (NoSuchFieldError e23) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoBrightness.ordinal()] = 24;
            } catch (NoSuchFieldError e24) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswFeatureReduceBrightness.ordinal()] = 25;
            } catch (NoSuchFieldError e25) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswFeatureBrightness.ordinal()] = 26;
            } catch (NoSuchFieldError e26) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoUsbDeviceFeature.ordinal()] = 27;
            } catch (NoSuchFieldError e27) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoVibratorFeature.ordinal()] = 28;
            } catch (NoSuchFieldError e28) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoStorageManagerFeature.ordinal()] = 29;
            } catch (NoSuchFieldError e29) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswAlarmManagerFeature.ordinal()] = 30;
            } catch (NoSuchFieldError e30) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswNewNetworkTimeUpdateServiceFeature.ordinal()] = 31;
            } catch (NoSuchFieldError e31) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswActivityManagerDynamicLogConfigFeature.ordinal()] = 32;
            } catch (NoSuchFieldError e32) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswOppoArmyControllerFeatrue.ordinal()] = 33;
            } catch (NoSuchFieldError e33) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswOppoArmyServiceFeatrue.ordinal()] = 34;
            } catch (NoSuchFieldError e34) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IPswOppoAmsUtilsFeatrue.ordinal()] = 35;
            } catch (NoSuchFieldError e35) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IOppoScreenModeManagerFeature.ordinal()] = 36;
