...
import com.android.server.notification.ColorNotificationListenerService;
...
public class StatsCompanionService extends IStatsCompanionService.Stub {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.lang.String, android.os.StatsDimensionsValue]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{java.time.Instant.minus(long, java.time.temporal.TemporalUnit):java.time.Instant}
     arg types: [int, java.time.temporal.ChronoUnit]
     candidates:
      ClspMth{java.time.Instant.minus(long, java.time.temporal.TemporalUnit):java.time.temporal.Temporal}
      ClspMth{java.time.Instant.minus(long, java.time.temporal.TemporalUnit):java.time.Instant} */
    ...
    public StatsLogEventWrapper[] pullData(int tagId) {
        ...
        switch (tagId) {
            case 10000:
                ...
                break;
            case OppoScreenOffGestureManager.MSG_SCREEN_TURNED_OFF:
            ...
            case 10018:
            case 10019:
            case ColorNotificationListenerService.REASON_COLOROS_FORCESTOP:
            case 10030:
            case 10038:
            case 10043:
            case 10045:
            ...
            case 10017:
                ...
                break;
            case ColorNotificationListenerService.REASON_COLOROS_BPMSUSPEND:
