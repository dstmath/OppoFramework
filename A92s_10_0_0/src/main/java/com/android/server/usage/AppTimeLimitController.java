        ...
        synchronized (this.mLock) {
            ...
            if (usageGroups != null) {
                if (!usageGroups.isEmpty()) {
                    ...
                    UsageStatsManagerInternal.AppUsageLimitData appUsageLimitData = new UsageStatsManagerInternal.AppUsageLimitData(smallestGroup.getTotaUsageLimit(), smallestGroup.getUsageRemaining());
                    return appUsageLimitData;
                }
            }
        }
    }
