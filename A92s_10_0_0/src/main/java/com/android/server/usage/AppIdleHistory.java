...
public class AppIdleHistory {
    ...
    private void writeScreenOnTime() {
        ...
        try {
            ...
            fos.write((Long.toString(this.mScreenOnDuration) + StringUtils.LF + Long.toString(this.mElapsedDuration) + StringUtils.LF).getBytes());
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0034 A[Catch:{ all -> 0x0106 }] */
