...
public class AppStandbyController {
    ...
    /* access modifiers changed from: private */
    public ArrayList<String> mGoogleRestrictList;
    /* access modifiers changed from: private */
    public ArrayMap<Pair<String, Integer>, Runnable> mGoogleRestrictRunnables;
    /* access modifiers changed from: private */
    public boolean mGoogleRestricted;
        ...
        this.mGoogleRestriction = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (restrict != AppStandbyController.this.mGoogleRestricted) {
                    ...
                    boolean unused = AppStandbyController.this.mGoogleRestricted = restrict;
        ...
        this.mUserSwitchReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if ("android.intent.action.USER_SWITCHED".equals(intent.getAction())) {
                    ...
                    if (userid != 0) {
                        int unused = AppStandbyController.this.mMultiUserid = userid;
                    }
    ...
    /* access modifiers changed from: private */
    public boolean matchGoogleRestrictRule(String pkg) {
