...
abstract class AmbientFilter {
    ...
    public boolean addValue(long time, float value) {
        if (value < OppoBrightUtils.MIN_LUX_LIMITI) {
            return false;
        }
    ...
    static class WeightedMovingAverageAmbientFilter extends AmbientFilter {
        ...
        public float filter(long time, RollingBuffer buffer) {
            ...
            float total = OppoBrightUtils.MIN_LUX_LIMITI;
            ...
            if (totalWeight == OppoBrightUtils.MIN_LUX_LIMITI) {
        ...
        private void validateArguments(float intercept) {
            if (Float.isNaN(intercept) || intercept < OppoBrightUtils.MIN_LUX_LIMITI) {
        ...
        private float[] getWeights(long time, RollingBuffer buffer) {
            ...
            float previousTime = OppoBrightUtils.MIN_LUX_LIMITI;
