...
public class DisplayModeDirector {
    ...
    public int[] getAllowedModes(int displayId) {
        synchronized (this.mLock) {
            ...
            if (modes != null) {
                if (defaultMode != null) {
                    int[] allowedModesLocked = getAllowedModesLocked(votes, modes, defaultMode);
                    return allowedModesLocked;
                }
            }
    ...
    private int[] getAllowedModesLocked(SparseArray<Vote> votes, Display.Mode[] modes, Display.Mode defaultMode) {
        for (int lowestConsideredPriority = 0; lowestConsideredPriority <= 3; lowestConsideredPriority++) {
            float minRefreshRate = OppoBrightUtils.MIN_LUX_LIMITI;
    ...
    public static final class Vote {
        ...
        public static Vote forSize(int width2, int height2) {
            return new Vote(width2, height2, OppoBrightUtils.MIN_LUX_LIMITI, Float.POSITIVE_INFINITY);
        }
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        private final boolean mDisableObserveLowPower = true;
        ...
        SettingsObserver(Context context, Handler handler) {
            super(handler);
            this.mContext = context;
            this.mDefaultPeakRefreshRate = (float) context.getResources().getInteger(17694779);
        }
        ...
        private void updateRefreshRateSettingLocked() {
            DisplayModeDirector.this.updateVoteLocked(0, Vote.forRefreshRates(OppoBrightUtils.MIN_LUX_LIMITI, Settings.System.getFloat(this.mContext.getContentResolver(), "peak_refresh_rate", this.mDefaultPeakRefreshRate)));
        }
