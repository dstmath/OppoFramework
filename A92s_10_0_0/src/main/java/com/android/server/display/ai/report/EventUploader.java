...
public class EventUploader {
    ...
    public final ArrayList<String> mEventCacheList = new ArrayList<>();
    private EventReceiver mEventReceiver;
    /* access modifiers changed from: private */
    public Calendar mLastCalendar = null;
    ...
    /* access modifiers changed from: private */
    public void uploadEvents(String reason) {
        int size;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.ACTION_SHUTDOWN".equals(action)) {
                ...
                if (EventUploader.this.mLastScreenOffTime != 0) {
                    ...
                    long unused = eventUploader.mScreenOffTime = eventUploader.mScreenOffTime + (SystemClock.elapsedRealtime() - EventUploader.this.mLastScreenOffTime);
                ...
                long unused2 = EventUploader.this.mLastScreenOffTime = SystemClock.elapsedRealtime();
                ...
                if (lastDay != 0 && day != lastDay) {
                    ...
                    Calendar unused3 = EventUploader.this.mLastCalendar = calendar;
                }
            }
        }
    }
