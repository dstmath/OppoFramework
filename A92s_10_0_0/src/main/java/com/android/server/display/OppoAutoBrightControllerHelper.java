...
public class OppoAutoBrightControllerHelper {
    ...
    /* access modifiers changed from: private */
    public long mAutoDurationTime = System.currentTimeMillis();
    /* access modifiers changed from: private */
    public long mAutoManulDurationTime = System.currentTimeMillis();
    ...
    /* access modifiers changed from: private */
    public DisplayAutoBrightnessHandler mHandler = null;
    /* access modifiers changed from: private */
    public float mLastAutoBrightness = 127.0f;
    /* access modifiers changed from: private */
    ...
    public final SensorEventListener mProximitySensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (this.mPrevProximityNear) {
                ...
                if (!OppoAutomaticBrightnessController.mProximityNear) {
                    long unused = OppoAutoBrightControllerHelper.this.mProximitySensorChangeTime = time;
                }
            }
    ...
    /* access modifiers changed from: private */
    public boolean mbStartTimer = false;
    /* access modifiers changed from: private */
    public Handler zeroHandler = new Handler() {
    ...
    public class DisplayAutoBrightnessHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case OppoAutoBrightControllerHelper.MSG_REPORT_AUTO_BRIGHTNESS /*{ENCODED_INT: 201}*/:
                    if (OppoAutoBrightControllerHelper.this.mReportMap == null) {
                        HashMap unused = OppoAutoBrightControllerHelper.this.mReportMap = new HashMap();
                    }
                    ...
                    long unused2 = OppoAutoBrightControllerHelper.this.mAutoDurationTime = System.currentTimeMillis();
                    OppoAutoBrightControllerHelper oppoAutoBrightControllerHelper = OppoAutoBrightControllerHelper.this;
                    float unused3 = oppoAutoBrightControllerHelper.mLastAutoBrightness = (float) oppoAutoBrightControllerHelper.mAutomaticBC.getAutomaticScreenBrightness();
                    OppoAutoBrightControllerHelper.this.mReportMap.clear();
                    return;
                case OppoAutoBrightControllerHelper.MSG_REPORT_AUTO_MANUL_BRIGHTNESS /*{ENCODED_INT: 202}*/:
                    if (OppoAutoBrightControllerHelper.this.mReportMap == null) {
                        HashMap unused4 = OppoAutoBrightControllerHelper.this.mReportMap = new HashMap();
                    }
                    ...
                    long unused5 = OppoAutoBrightControllerHelper.this.mAutoDurationTime = System.currentTimeMillis();
                    long unused6 = OppoAutoBrightControllerHelper.this.mAutoManulDurationTime = System.currentTimeMillis();
                    OppoAutoBrightControllerHelper oppoAutoBrightControllerHelper2 = OppoAutoBrightControllerHelper.this;
                    OppoBrightUtils unused7 = OppoAutoBrightControllerHelper.mOppoBrightUtils;
                    float unused8 = oppoAutoBrightControllerHelper2.mLastAutoBrightness = (float) OppoBrightUtils.mManualBrightness;
                    OppoAutoBrightControllerHelper.this.mReportMap.clear();
                    return;
                case OppoAutoBrightControllerHelper.MSG_UPDATE_BRIGHTNESS_AFTER_PROXIMITY /*{ENCODED_INT: 203}*/:
