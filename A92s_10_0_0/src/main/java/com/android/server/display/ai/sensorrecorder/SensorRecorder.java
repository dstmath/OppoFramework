...
public class SensorRecorder {
    ...
    private final BroadcastReceiver mActionReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (c == 0) {
                ...
                boolean unused = SensorRecorder.this.mOpenRecord = true;
            } else if (c == 1) {
                boolean unused2 = SensorRecorder.this.mOpenRecord = false;
                long unused3 = SensorRecorder.this.mLastTime = 0;
    ...
    public volatile boolean mIsStopPlay = true;
    /* access modifiers changed from: private */
    public long mLastTime = 0;
    private final ArrayList<LuxData> mLuxRecodeList = new ArrayList<>();
    /* access modifiers changed from: private */
    public boolean mOpenRecord;
    /* access modifiers changed from: private */
    public final ConcurrentLinkedQueue<Intent> mPlaybackIntentQueue = new ConcurrentLinkedQueue<>();
    /* access modifiers changed from: private */
    public SensorPlayback mSensorPlayback;
