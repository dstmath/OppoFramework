...
public class OppoSuplController implements IPswSuplController {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action != null) {
                if (action.equals(OppoSuplController.OPPO_LBS_CONFIG_UPDATE_ACTION)) {
                    ...
                    boolean unused = oppoSuplController.mPreDeviceInRegion = !oppoSuplController.mDeviceInRegion;
                    ...
                    boolean unused2 = OppoSuplController.this.mForTestEnabled = intent.getBooleanExtra(OppoSuplController.TEST_REGION_NAME, false);
                    int unused3 = OppoSuplController.this.mTestPhoneType = intent.getIntExtra(OppoSuplController.TEST_PHONE_TYPE, 0);
                    int unused4 = OppoSuplController.this.mTestSid = intent.getIntExtra(OppoSuplController.TEST_SID, 0);
                    int unused5 = OppoSuplController.this.mTestMcc = intent.getIntExtra(OppoSuplController.TEST_MCC, 0);
                    String unused6 = OppoSuplController.this.mTestImsi = intent.getStringExtra(OppoSuplController.TEST_IMSI);
    ...
    /* access modifiers changed from: private */
    public boolean mPreDeviceInRegion = (!this.mDeviceInRegion);
    ...
    /* access modifiers changed from: private */
    public String mTestImsi = null;
    /* access modifiers changed from: private */
    public int mTestMcc = 0;
    /* access modifiers changed from: private */
    public int mTestPhoneType = 0;
    /* access modifiers changed from: private */
    public int mTestSid = 0;
    private Handler.Callback m_handler_callback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            switch (msgID) {
                case OppoSuplController.MSG_UPDATE_SUPL_CONFIG /*{ENCODED_INT: 101}*/:
                    OppoSuplController.this.updateSuplConfig(msg.arg1 == 1);
                    break;
                case OppoSuplController.MSG_INSTALL_RIL_LISTENER /*{ENCODED_INT: 102}*/:
                    OppoSuplController.this.installRilListener();
                    break;
                case OppoSuplController.MSG_CELL_LOCATION_CHANGED /*{ENCODED_INT: 103}*/:
                    OppoSuplController.this.handleCellLocationChanged();
                    break;
                case OppoSuplController.MSG_SERVICE_STATE_CHANGED /*{ENCODED_INT: 104}*/:
                    OppoSuplController.this.handleServiceStateChanged(msg.arg1);
                    break;
                case OppoSuplController.MSG_SUPL_CONF_TEST /*{ENCODED_INT: 105}*/:
                    OppoSuplController.this.handleCellLocationChanged();
                    break;
                default:
    ...
    /* access modifiers changed from: private */
    public void updateSuplConfig(boolean needReadUpdateFile) {
    ...
    /* access modifiers changed from: private */
    public void installRilListener() {
    ...
    private void populateCountryList(HashMap<Integer, HashSet<Integer>> mapMccMnc, String configMccList) {
        ...
        try {
            ...
            loge("OsAgent: Error in reading configurations:" + e9.toString());
        } catch (NullPointerException e10) {
            loge("OsAgent: configMccList is null:" + e10.toString());
        }
    }
            ...
            if (phoneType != 0) {
                if (phoneType == 1) {
                    ...
                    if (iSid != 0) {
                        ...
                        while (true) {
                            if (it.hasNext()) {
                                if (it.next().contains(Integer.valueOf(iSid))) {
                                    deviceInRegulatedArea = 1 | 4;
                                    break;
                                }
                            } else {
    ...
    /* access modifiers changed from: private */
    public void handleServiceStateChanged(int service_state) {
    ...
    private class SuplServiceConfig {
