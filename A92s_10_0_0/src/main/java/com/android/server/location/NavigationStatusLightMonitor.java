...
public class NavigationStatusLightMonitor extends OppoNavigationStatusMonitor implements OppoMotionDetector.DeviceIdleCallback {
    ...
    private GpsStatus.Listener mGpsStatusListener = new GpsStatus.Listener() {
        ...
        public void onGpsStatusChanged(int event) {
            ...
            GpsStatus unused = navigationStatusLightMonitor.mGpsStatus = navigationStatusLightMonitor.mLocMgr.getGpsStatus(null);
        }
    };
    /* access modifiers changed from: private */
    public Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case NavigationStatusLightMonitor.MSG_START_MONITOR /*{ENCODED_INT: 101}*/:
                    ...
                    return;
                case NavigationStatusLightMonitor.MSG_STOP_MONITOR /*{ENCODED_INT: 102}*/:
                    removeMessages(NavigationStatusLightMonitor.MSG_DOING_MONITOR);
                    ...
                    return;
                case NavigationStatusLightMonitor.MSG_DOING_MONITOR /*{ENCODED_INT: 103}*/:
                    NavigationStatusLightMonitor.this.doMonitor();
                    sendEmptyMessageDelayed(NavigationStatusLightMonitor.MSG_DOING_MONITOR, 1000);
                    return;
                case NavigationStatusLightMonitor.MSG_ON_MOTION_MOVING /*{ENCODED_INT: 104}*/:
                    if (NavigationStatusLightMonitor.this.mMotionDetectorHasStart) {
                        NavigationStatusLightMonitor.this.printLog("Status now is not stationary, restart to navigate");
                        int unused3 = NavigationStatusLightMonitor.this.mCurrArStatus = 1;
                        NavigationStatusLightMonitor.this.mOppoMotionDetector.stopMotion();
                        boolean unused4 = NavigationStatusLightMonitor.this.mMotionDetectorHasStart = false;
                        return;
                    }
                    return;
                case NavigationStatusLightMonitor.MSG_ON_SENSOR_TRIGGER /*{ENCODED_INT: 105}*/:
    ...
    /* access modifiers changed from: private */
    public long mLastStationarySensorRegiterTime = DEFAULT_LONG_ZERO;
    /* access modifiers changed from: private */
    public LocationManager mLocMgr = null;
    /* access modifiers changed from: private */
    public boolean mMotionDetectorHasStart = false;
    private NavigationStatusListener mNavigationListener = null;
    /* access modifiers changed from: private */
    public OppoMotionDetector mOppoMotionDetector = null;
    private int mOutdoorTimer = 0;
    private String mPlatformRecord = null;
    /* access modifiers changed from: private */
    public boolean mSensorHasRegistered = false;
    /* access modifiers changed from: private */
    public SensorManager mSensorManager = null;
    /* access modifiers changed from: private */
    public Sensor mStationaryDetectSensor = null;
    /* access modifiers changed from: private */
    public StationaryListener mStationaryListener = new StationaryListener();
    ...
    /* access modifiers changed from: private */
    public void onStationaryTrigger() {
        this.mSensorHasRegistered = false;
    ...
    public final class StationaryListener extends TriggerEventListener {
        ...
        public boolean registerListener() {
            ...
            if (registerSuccess) {
                long unused = NavigationStatusLightMonitor.this.mLastStationarySensorRegiterTime = SystemClock.elapsedRealtime();
        ...
        public boolean unregisterListener() {
            ...
            if (unregisterSuccess) {
                long unused = NavigationStatusLightMonitor.this.mLastStationarySensorRegiterTime = NavigationStatusLightMonitor.DEFAULT_LONG_ZERO;
