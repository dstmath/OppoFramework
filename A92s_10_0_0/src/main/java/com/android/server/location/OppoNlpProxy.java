...
public class OppoNlpProxy implements IPswNlpProxy {
    ...
    public LocationController mActiveNpHandle = null;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(OppoNlpProxy.OPPO_LBS_CONFIG_UPDATE_ACTION)) {
                ...
                if (OppoNlpProxy.this.mNlpRoamingEnabled && !OppoNlpProxy.isExpROM() && !OppoNlpProxy.this.mDeviceInRegion) {
                    boolean unused = OppoNlpProxy.this.isChinaSimRomingAborad();
                }
    ...
    /* access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public boolean mDeviceInRegion = (true ^ isExpROM());
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mIsGmsRestrict = false;
    ...
    /* access modifiers changed from: private */
    public boolean mNlpRoamingEnabled = true;
    ...
    /* access modifiers changed from: private */
    public AbstractLocationProvider.LocationProviderManager mParentLocationProvider = null;
    ...
    /* access modifiers changed from: private */
    public HashMap<Integer, HashSet<Integer>> mRegionalNLPCountryList = new HashMap<>();
    /* access modifiers changed from: private */
    public ArrayList<Range<Integer>> mRegionalNLPSIDRanges = new ArrayList<>();
    ...
    /* access modifiers changed from: private */
    public int mSwitchToGms = -1;
    /* access modifiers changed from: private */
    public int mVisitGoogleState = -1;
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (msgID == OppoNlpProxy.MSG_INIT) {
                ...
                if (((Boolean) msg.obj).booleanValue()) {
                    int unused = OppoNlpProxy.this.mSwitchToGms = 1;
                } else {
                    int unused2 = OppoNlpProxy.this.mSwitchToGms = 0;
                }
                OppoNlpProxy.this.initServiceBinding();
    ...
    /* access modifiers changed from: private */
    public void initServiceBinding() {
    ...
    private void populateCountryList(HashMap<Integer, HashSet<Integer>> mapMccMnc, String configMccList) {
        ...
        try {
            ...
            loge("OsAgent: Input configMccList is null:" + e10.toString());
        }
    }

    /* access modifiers changed from: private */
    @GuardedBy({"mLock"})
    public void handleCellLocationCallback(boolean deviceInRegion) {
    ...
    /* access modifiers changed from: private */
    public boolean isChinaSimRomingAborad() {
        try {
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            if (OppoNetworkUtil.checkGoogleNetwork()) {
                                ...
                                int unused = OppoNlpProxy.this.mVisitGoogleState = 1;
                            ...
                            int unused2 = OppoNlpProxy.this.mVisitGoogleState = 0;
    ...
    /* access modifiers changed from: private */
    public void handleGoogleRestrictChanged() {
        tryGoogleAccess();
    }

    /* access modifiers changed from: private */
    public void rebindNlpOrGeocoder() {
        LocationController locationController;
    ...
    public class LocationController implements AbstractLocationProvider.LocationProviderManager {
            ...
            if ("network".equals(location.getProvider()) && OppoNlpProxy.this.reportLocationPreHandle(this.mNlpName, location)) {
                ...
                if (location.getExtras() != null) {
                    ...
                    if (nlpId != null && !OppoNlpProxy.this.mOppoNlpID.equals(nlpId)) {
                        String unused = OppoNlpProxy.this.mOppoNlpID = nlpId;
        ...
        public void onSetEnabled(boolean enabled) {
            ...
            boolean unused = OppoNlpProxy.this.mEnabled = enabled;
        }
                ...
                if (phoneType != 0) {
                    if (phoneType == 1) {
                        ...
                        if (iSid != 0) {
                            ...
                            while (true) {
                                if (it.hasNext()) {
                                    if (((Range) it.next()).contains(Integer.valueOf(iSid))) {
                                        deviceInRegulatedArea = 1 | 4;
                                        break;
                                    }
                                } else {
    ...
    /* access modifiers changed from: private */
    public int getMnc(int mncmccCombo, int digits) {
        int mnc = 0;
        if (digits == 6) {
    ...
    /* access modifiers changed from: private */
    public int getMcc(int mncmccCombo, int digits) {
        int mcc = 0;
        if (digits == 6) {
    ...
    /* access modifiers changed from: private */
    public void handleMessageForDelayChinaNlpReport() {
    ...
    /* access modifiers changed from: private */
    public boolean reportLocationPreHandle(String providerName, Location location) {
