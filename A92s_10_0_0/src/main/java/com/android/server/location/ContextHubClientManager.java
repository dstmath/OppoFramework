...
public class ContextHubClientManager {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v1, resolved type: java.util.concurrent.ConcurrentHashMap<java.lang.Short, com.android.server.location.ContextHubClientBroker>} */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0037, code lost:
        android.util.Log.d(com.android.server.location.ContextHubClientManager.TAG, r11 + " client with host endpoint ID " + ((int) r0.getHostEndPointId()));
     */
