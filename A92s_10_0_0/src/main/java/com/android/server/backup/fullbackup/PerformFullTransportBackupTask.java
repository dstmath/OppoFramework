...
public class PerformFullTransportBackupTask extends FullBackupTask implements BackupRestoreTask {
    ...
    /* JADX INFO: Multiple debug info for r6v29 'backoff'  long: [D('backoff' long), D('quota' long)] */
                                        ...
                                        try {
                                            ...
                                            if (backupPackageStatus == 0) {
                                                try {
                                                    ...
                                                    try {
                                                        this.mBackupRunner = new SinglePackageBackupRunner(enginePipes3[1], currentPackage2, this.mTransportClient, quota, this.mBackupRunnerOpToken, transport.getTransportFlags());
                                                ...
                                                try {
                                                    ...
                                                    if (preflightResult < 0) {
                                                        ...
                                                        if (backupPackageStatus4 == -1005) {
                                                            ...
                                                            Slog.w(TAG, "Package hit quota limit in-flight " + packageName3 + ": " + totalRead + " of " + quota);
