...
public class TransportManager {
    ...
    public ComponentName getCurrentTransportComponent() throws TransportNotRegisteredException {
        synchronized (this.mTransportLock) {
            ...
            ComponentName registeredTransportComponentOrThrowLocked = getRegisteredTransportComponentOrThrowLocked(this.mCurrentTransportName);
            return registeredTransportComponentOrThrowLocked;
        }
    }
