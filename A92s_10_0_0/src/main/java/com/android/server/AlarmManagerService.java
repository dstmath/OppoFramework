...
public class AlarmManagerService extends OppoBaseAlarmManagerService {
    ...
    static final class FilterStats extends OppoBaseAlarmManagerService.BaseFilterStats {
        long aggregateTime;
        int count;
        long lastTime;
        final BroadcastStats mBroadcastStats;
    ...
    public boolean setTimeImpl(long millis) {
        ...
        synchronized (this.mLock) {
            ...
            if (currentTzOffset != newTzOffset) {
                ...
                this.mInjector.setKernelTimezone(-(newTzOffset / OppoBrightUtils.SPECIAL_AMBIENT_LIGHT_HORIZON));
            }
        }
        return true;
    }
    ...
    public void setTimeZoneImpl(String tz) {
        if (!TextUtils.isEmpty(tz)) {
            ...
            synchronized (this) {
                ...
                this.mInjector.setKernelTimezone(-(zone.getOffset(this.mInjector.getCurrentTimeMillis()) / OppoBrightUtils.SPECIAL_AMBIENT_LIGHT_HORIZON));
            }
    ...
    /* JADX INFO: Multiple debug info for r7v6 'windowLength'  long: [D('interval' long), D('windowLength' long)] */
    /* access modifiers changed from: package-private */
    public void setImpl(int type, long triggerAtTime, long windowLength, long interval, PendingIntent operation, IAlarmListener directReceiver, String listenerTag, int flags, WorkSource workSource, AlarmManager.AlarmClockInfo alarmClock, int callingUid, String callingPackage) {
        ...
        if (!(operation == null && directReceiver == null) && (operation == null || directReceiver == null)) {
            ...
            if (interval2 > 0 && interval2 < minInterval) {
                Slog.w(TAG, "Suspiciously short interval " + interval2 + " millis; expanding to " + (minInterval / 1000) + " seconds");
                interval2 = minInterval;
            } else if (interval2 > this.mConstants.MAX_INTERVAL) {
                Slog.w(TAG, "Suspiciously long interval " + interval2 + " millis; clamping");
            ...
            if (schedulePoweroffAlarm(type, triggerAtTime2, interval2, operation, directReceiver, listenerTag, workSource, alarmClock, callingPackage)) {
                    ...
                    try {
                        ...
                        try {
                            if (this.mAlarmsPerUid.get(callingUid, 0) < this.mConstants.MAX_ALARMS_PER_UID || ActivityThread.inCptWhiteList((int) CompatibilityHelper.ALARM_COUNTS_EXCEED_WHITE_LIST, str)) {
                                obj = obj2;
                                setImplLocked(type2, triggerAtTime2, triggerElapsed, windowLength4, maxElapsed, windowLength5, operation, directReceiver, listenerTag, flags2, true, workSource, alarmClock, callingUid, callingPackage);
                                return;
                            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: com.android.server.AlarmManagerService} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: com.android.server.AlarmManagerService} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v5, resolved type: com.android.server.AlarmManagerService} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v6, resolved type: com.android.server.AlarmManagerService} */
            ...
            while (i3 < N2) {
                ...
                if ((alarm2.flags & 4) != 0) {
                    ...
                    if (lastTime >= 0 && j < minTime) {
                        ...
                        alarmManagerService3.setImplLocked(alarm2, r14, false);
                ...
                if (alarmManagerService3.isBackgroundRestricted(alarm2)) {
                    ...
                    if ((alarm2.flags & 2) != 0) {
                        EventLogTags.writeDeviceIdleWakeFromIdle(alarmManagerService3.mPendingIdleUntil != null ? r14 : 0, alarm2.statsTag);
                    }
                    ...
                    if (lastTimeChangeClockTime == 0 || nowRTC < expectedClockTime - 1000 || nowRTC > 1000 + expectedClockTime) {
                        ...
                        if (result == 65536) {
                            synchronized (AlarmManagerService.this.mLock) {
                                ...
                                AlarmManagerService.this.filterAlarmForHans(triggerList);
    ...
    class ClockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("android.intent.action.DATE_CHANGED")) {
                AlarmManagerService.this.mInjector.setKernelTimezone(-(TimeZone.getTimeZone(SystemProperties.get(AlarmManagerService.TIMEZONE_PROPERTY)).getOffset(AlarmManagerService.this.mInjector.getCurrentTimeMillis()) / OppoBrightUtils.SPECIAL_AMBIENT_LIGHT_HORIZON));
