...
public class OppoEngineerShell extends ShellCommand {
    ...
    public static final String TAG = OppoEngineerShell.class.getSimpleName();
                ...
                switch (c) {
                    ...
                    case 9:
                        ...
                        for (int i3 = 0; i3 < strings3.length; i3++) {
                            list3[i3] = Long.valueOf(strings3[i3]).longValue();
                        }
                    ...
                    case 10:
                        ...
                        int length = strings4.length;
                        for (i++; i < length; i++) {
                            list4.add(Long.valueOf(strings4[i]));
                        }
    ...
    private class WaitForResult implements Function<String, String> {
        ...
        public String apply(String serverName) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            try {
                LocalSocket unused = OppoEngineerShell.this.mLocalSocket = null;
                LocalServerSocket unused2 = OppoEngineerShell.this.mLocalServerSocket = new LocalServerSocket(serverName);
                    ...
                    public void run() {
                        if (OppoEngineerShell.this.mLocalServerSocket != null) {
                            ...
                            try {
                                ...
                                e3.printStackTrace();
                                LocalServerSocket unused = OppoEngineerShell.this.mLocalServerSocket = null;
                            }
                        }
                    }
                }, 10000);
                LocalSocket unused3 = OppoEngineerShell.this.mLocalSocket = OppoEngineerShell.this.mLocalServerSocket.accept();
                ...
                if (inputStream != null && (count = inputStream.read(buffer, 0, 128)) > 0) {
                    ...
                    String access$300 = OppoEngineerShell.TAG;
                    Slog.v(access$300, "Get command [" + command + "], size=" + count);
                ...
                String access$3002 = OppoEngineerShell.TAG;
                Slog.i(access$3002, "exception caught " + e5.getMessage());
                if (OppoEngineerShell.this.mLocalSocket != null) {
                    try {
                        OppoEngineerShell.this.mLocalSocket.shutdownInput();
                        OppoEngineerShell.this.mLocalSocket.shutdownOutput();
