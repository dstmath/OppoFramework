...
public class OppoEngineerConfig extends RomUpdateHelper {
    ...
    public static final String TAG = OppoEngineerConfig.class.getSimpleName();
    ...
    private class OppoEningeerConfigUpdateInfo extends RomUpdateHelper.UpdateInfo {
        ...
        private void parseComponentName(XmlPullParser parser, List<ComponentName> componentNameList) {
            ...
            String access$000 = OppoEngineerConfig.TAG;
            Slog.d(access$000, "parseComponentName, packageName = " + packageName + ", className = " + className);
        }
        ...
        private void parseShellCommand(XmlPullParser parser, List<String> commandList) {
            ...
            String access$000 = OppoEngineerConfig.TAG;
            Slog.d(access$000, "parseShellCommand, command = " + command);
        }
        ...
        private void parseEngineerOrder(XmlPullParser parser, List<String> orderList) {
            ...
            String access$000 = OppoEngineerConfig.TAG;
            Slog.d(access$000, "parseEngineerOrder, order = " + order);
        }
