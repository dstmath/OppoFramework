...
public class MediaFocusControl implements PlayerFocusEnforcer {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v22, resolved type: com.android.server.audio.FocusRequester} */
                    ...
                    if (this.mFocusPolicy == null) {
                        ...
                        try {
                            ...
                            if (focusGrantDelayed) {
                                ...
                                this.mFocusStack.push(nfr);
                                nfr.handleFocusGainFromRequest(r6);
