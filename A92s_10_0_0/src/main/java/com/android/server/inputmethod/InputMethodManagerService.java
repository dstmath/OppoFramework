...
public class InputMethodManagerService extends OppoBaseInputMethodManagerService implements ServiceConnection, Handler.Callback {
    ...
    String TAG = "InputMethodManagerService";
    ...
    private final class ImmsBroadcastReceiverForSystemUser extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.USER_ADDED".equals(action) || "android.intent.action.USER_REMOVED".equals(action)) {
                ...
                String str = InputMethodManagerService.this.TAG;
                Slog.w(str, "Unexpected intent " + intent);
            }
        }
    }
    ...
    final class MyPackageMonitor extends PackageMonitor {
        ...
        private boolean isChangingPackagesOfCurrentUserLocked() {
            ...
            if (InputMethodManagerService.DEBUG && !retval) {
                String str = InputMethodManagerService.this.TAG;
                Slog.d(str, "--- ignore this call back from a background user: " + userId);
            }
            return retval;
        }
                        ...
                        if (imi.getId().equals(curInputMethodId)) {
                            ...
                            while (i2 < length) {
                                if (!imi.getPackageName().equals(packages[i2])) {
                                    ...
                                    boolean unused = InputMethodManagerService.this.chooseNewDefaultIMELocked();
                                    return true;
                                }
                            }
                            continue;
                ...
                if (isChangingPackagesOfCurrentUserLocked()) {
                    if (shouldRebuildInputMethodListLocked()) {
                        ...
                        if (curInputMethodId != null) {
                            for (int i = 0; i < N; i++) {
                                ...
                                if (change2 == 2 || change2 == 3) {
                                    String str = InputMethodManagerService.this.TAG;
                                    Slog.i(str, "Input method uninstalled, disabling: " + imi.getComponent());
                        ...
                        if (curIm != null && ((change = isPackageDisappearing(curIm.getPackageName())) == 2 || change == 3)) {
                            ...
                            if (si == null) {
                                String str2 = InputMethodManagerService.this.TAG;
                                Slog.i(str2, "Current input method removed: " + curInputMethodId);
    ...
    private class HardKeyboardListener implements WindowManagerInternal.OnHardKeyboardStatusChangeListener {
        ...
        public void handleHardKeyboardStatusChange(boolean available) {
            if (InputMethodManagerService.DEBUG) {
                String str = InputMethodManagerService.this.TAG;
                Slog.w(str, "HardKeyboardStatusChanged: available=" + available);
            }
            synchronized (InputMethodManagerService.this.mMethodMap) {
                if (!(InputMethodManagerService.this.mSwitchingDialog == null || InputMethodManagerService.this.mSwitchingDialogTitleView == null || !InputMethodManagerService.this.mSwitchingDialog.isShowing())) {
                    InputMethodManagerService.this.mSwitchingDialogTitleView.findViewById(16908972).setVisibility(available ? 0 : 8);
                }
            }
        }
    }
    ...
    public static final class Lifecycle extends SystemService {
        ...
        public Lifecycle(Context context) {
            super(context);
            this.mService = ColorServiceFactory.getInstance().getColorInputMethodManagerService(context);
        }
    ...
    public void onUnlockUser(int userId) {
        synchronized (this.mMethodMap) {
            ...
            if (DEBUG) {
                String str = this.TAG;
                Slog.d(str, "onUnlockUser: userId=" + userId + " curUserId=" + currentUserId);
            }
    ...
    public InputMethodManagerService(Context context) {
        ...
        this.mSlotIme = this.mContext.getString(17041076);
        ...
        this.mImeSwitcherNotification = new Notification.Builder(this.mContext, SystemNotificationChannels.VIRTUAL_KEYBOARD).setSmallIcon(17302738).setWhen(0).setOngoing(true).addExtras(extras).setCategory("sys").setColor(this.mContext.getColor(17170460));
        ...
        this.mColorImmsEx = ColorServiceFactory.getInstance().getColorInputMethodManagerServiceEx(context, this);
    }
    ...
    private void resetDefaultImeLocked(Context context) {
        ...
        if (str == null || this.mMethodMap.get(str).isSystem()) {
            ...
            if (DEBUG) {
                ...
                Slog.i(str2, "Default found, using " + defIm.getId());
            }
    ...
    private void switchUserLocked(int newUserId) {
        if (DEBUG) {
            String str = this.TAG;
            Slog.d(str, "Switching user stage 1/3. newUserId=" + newUserId + " currentUserId=" + this.mSettings.getCurrentUserId());
        }
        ...
        if (DEBUG) {
            String str2 = this.TAG;
            Slog.d(str2, "Switching user stage 2/3. newUserId=" + newUserId + " defaultImiId=" + defaultImiId);
        }
        ...
        if (DEBUG) {
            ...
            Slog.d(str3, "Switching user stage 3/3. newUserId=" + newUserId + " selectedIme=" + this.mSettings.getSelectedInputMethod());
        }
    ...
    public void systemRunning(StatusBarManagerService statusBar) {
        synchronized (this.mMethodMap) {
            ...
            if (!this.mSystemReady) {
                ...
                this.mShowOngoingImeSwitcherForPhones = this.mRes.getBoolean(17891614);
    ...
    private boolean calledFromValidUserLocked() {
        ...
        if (DEBUG) {
            String str = this.TAG;
            Slog.d(str, "--- calledFromForegroundUserOrSystemProcess ? calling uid = " + uid + " system uid = " + 1000 + " calling userId = " + userId + ", foreground user id = " + this.mSettings.getCurrentUserId() + ", calling pid = " + Binder.getCallingPid() + InputMethodUtils.getApiCallStack());
        }
        if (uid == 1000 || userId == this.mSettings.getCurrentUserId()) {
            return true;
        }
        if ((!InputMethodSystemProperty.PER_PROFILE_IME_ENABLED && this.mSettings.isCurrentProfile(userId)) || OppoFeatureCache.get(IColorMultiAppManager.DEFAULT).isCurrentProfile(userId)) {
            return true;
        }
        ...
        String str2 = this.TAG;
        Slog.w(str2, "--- IPC called from background users. Ignore. callers=" + Debug.getCallers(10));
        return false;
    }
    ...
    private boolean calledWithValidTokenLocked(IBinder token) {
        ...
        } else if (token == this.mCurToken || onCalledWithValidTokenLocked(token)) {
            return true;
        } else {
            String str = this.TAG;
            Slog.e(str, "Ignoring " + Debug.getCaller() + " due to an invalid token. uid:" + Binder.getCallingUid() + " token:" + token);
            return false;
        }
    }
    ...
    public void unbindCurrentClientLocked(int unbindClientReason) {
        if (this.mCurClient != null) {
            if (DEBUG) {
                String str = this.TAG;
                Slog.v(str, "unbindCurrentInputLocked: client=" + this.mCurClient.client.asBinder());
            }
            if (this.mBoundToMethod) {
                this.mBoundToMethod = false;
    ...
    public InputBindResult startInputUncheckedLocked(ClientState cs, IInputContext inputContext, int missingMethods, EditorInfo attribute, int startInputFlags, int startInputReason) {
        ...
        if (!InputMethodUtils.checkIfPackageBelongsToUid(this.mAppOpsManager, cs.uid, attribute.packageName)) {
            Slog.e(this.TAG, "Rejecting this client as it reported an invalid package name. uid=" + cs.uid + " package=" + attribute.packageName);
            ...
            if (this.mCurClient != cs) {
                ...
                if (DEBUG) {
                    Slog.v(this.TAG, "switching to client: client=" + cs.client.asBinder() + " keyguard=" + this.mCurClientInKeyguard);
                }
            ...
            this.mCurClient = cs;
            this.mCurInputContext = getCorrectInputContext(inputContext);
            ...
            if (info != null) {
                ...
                this.mCurIntent.putExtra("android.intent.extra.client_label", 17040136);
                ...
                if (bindCurrentInputMethodServiceLocked(this.mCurIntent, this, IME_CONNECTION_BIND_FLAGS)) {
                    ...
                    try {
                        if (DEBUG) {
                            Slog.v(this.TAG, "Adding window token: " + this.mCurToken + " for display: " + this.mCurTokenDisplayId);
                        }
                ...
                Slog.w(this.TAG, "Failure connecting to input method service: " + this.mCurIntent);
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        synchronized (this.mMethodMap) {
            if (this.mCurIntent != null && name.equals(this.mCurIntent.getComponent())) {
                ...
                String str = this.TAG;
                Slog.d(str, "onServiceConnected:" + name + ", token:" + this.mCurToken);
                if (this.mCurToken == null) {
                    Slog.w(this.TAG, "Service connected without a token!");
                    unbindCurrentMethodLocked();
                    return;
                }
                if (DEBUG) {
                    String str2 = this.TAG;
                    Slog.v(str2, "Initiating attach with token: " + this.mCurToken);
                }
    ...
    public void unbindCurrentMethodLocked() {
        ...
        if (this.mCurToken != null) {
            try {
                if (DEBUG) {
                    String str = this.TAG;
                    Slog.v(str, "Removing window token: " + this.mCurToken + " for display: " + this.mCurTokenDisplayId);
                }
    ...
    public void requestClientSessionLocked(ClientState cs) {
        if (!cs.sessionRequested) {
            if (DEBUG) {
                String str = this.TAG;
                Slog.v(str, "Creating new session for client " + cs);
            }
    ...
    public void onServiceDisconnected(ComponentName name) {
        synchronized (this.mMethodMap) {
            if (DEBUG) {
                String str = this.TAG;
                Slog.v(str, "Service disconnected: " + name + " mCurIntent=" + this.mCurIntent);
            }
    ...
    public void updateSystemUiLocked(int vis, int backDisposition) {
        if (this.mCurToken != null) {
            if (DEBUG) {
                String str = this.TAG;
                Slog.d(str, "IME window vis: " + vis + " active: " + (vis & 1) + " inv: " + (vis & 4) + " displayId: " + this.mCurTokenDisplayId);
            }
            long ident = Binder.clearCallingIdentity();
            if (vis != 0) {
                try {
            ...
            if (imi != null && needsToShowImeSwitcher) {
                CharSequence title = this.mRes.getText(17040982);
                ...
                try {
                    if (this.mNotificationManager != null && !this.mIWindowManager.hasNavigationBar(0)) {
                        if (DEBUG) {
                            String str2 = this.TAG;
                            Slog.d(str2, "--- show notification: label =  " + ((Object) summary));
                        }
    ...
    public void updateInputMethodsFromSettingsLocked(boolean enabledMayChange) {
            ...
            for (int i = 0; i < enabled.size(); i++) {
                ...
                try {
                    ...
                    if (ai != null && ai.enabledSetting == 4) {
                        if (DEBUG) {
                            String str = this.TAG;
                            Slog.d(str, "Update state(" + imm.getId() + "): DISABLED_UNTIL_USED -> DEFAULT");
                        }
        ...
        if (!TextUtils.isEmpty(id)) {
            try {
                ...
                String str2 = this.TAG;
                Slog.w(str2, "Unknown input method from prefs: " + id, e2);
    ...
    public void updateKeyboardFromSettingsLocked() {
        ...
        if (alertDialog != null && this.mSwitchingDialogTitleView != null && alertDialog.isShowing()) {
            ((Switch) this.mSwitchingDialogTitleView.findViewById(16908973)).setChecked(this.mShowImeWithHardKeyboard);
        }
    }
        ...
        if (info == null) {
            ...
            if (subtypeCount > 0) {
                ...
                if (newSubtype == null || oldSubtype == null) {
                    String str = this.TAG;
                    Slog.w(str, "Illegal subtype state: old subtype = " + oldSubtype + ", new subtype = " + newSubtype);
                    ...
                    if (this.mCurMethod != null) {
                        try {
                            ...
                            Slog.w(this.TAG, "Failed to call changeInputMethodSubtype");
                        }
                    }
                }
            }
            ...
            try {
                if (this.mCurClient == null || client == null || this.mCurClient.client.asBinder() != client.asBinder()) {
                    ...
                    if (cs == null) {
                        ...
                        String str = this.TAG;
                        Slog.w(str, "Ignoring showSoftInput of uid " + uid + ": " + client);
                        return false;
                    }
                }
                if (DEBUG) {
    ...
    public boolean showCurrentInputLocked(int flags, ResultReceiver resultReceiver) {
        ...
        if (this.mCurMethod != null) {
            if (DEBUG) {
                String str = this.TAG;
                Slog.d(str, "showCurrentInputLocked: mCurToken=" + this.mCurToken);
            }
            ...
            Slog.w(this.TAG, "Force disconnect/connect to the IME in showCurrentInputLocked()");
            this.mContext.unbindService(this);
            ...
            String str2 = this.TAG;
            Slog.d(str2, "Can't show input: connection = " + this.mHaveConnection + ", time = " + ((this.mLastBindTime + 3000) - SystemClock.uptimeMillis()));
            return false;
        }
    }
            ...
            try {
                if (this.mCurClient == null || client == null || this.mCurClient.client.asBinder() != client.asBinder()) {
                    ...
                    if (cs == null) {
                        ...
                        if (DEBUG) {
                            String str = this.TAG;
                            Slog.w(str, "Ignoring hideSoftInput of uid " + uid + ": " + client);
                        }
                        return false;
                    }
                }
                ...
                if (ColorZoomWindowManagerHelper.getZoomWindowManager().shouldIgnoreInputShownForResult(uid, this.mCurTokenDisplayId)) {
                    zoomMode = true;
                }
                if (hideCurrentInputLocked(flags, resultReceiver) && !zoomMode) {
                    z = true;
                }
                Binder.restoreCallingIdentity(ident);
                return z;
    ...
    public InputBindResult startInputOrWindowGainedFocus(int startInputReason, IInputMethodClient client, IBinder windowToken, int startInputFlags, int softInputMode, int windowFlags, EditorInfo attribute, IInputContext inputContext, int missingMethods, int unverifiedTargetSdkVersion) {
        ...
        if (attribute == null || attribute.targetInputMethodUser == null || attribute.targetInputMethodUser.getIdentifier() == callingUserId) {
            ...
            if (!this.mUserManagerInternal.isUserRunning(userId2)) {
                String str = this.TAG;
                Slog.e(str, "User #" + userId2 + " is not running.");
        ...
        synchronized (arrayMap2) {
            try {
                ...
                try {
                    ...
                    String str2 = this.TAG;
                    Slog.wtf(str2, "InputBindResult is @NonNull. startInputReason=" + InputMethodDebug.startInputReasonToString(startInputReason) + " windowFlags=#" + Integer.toHexString(windowFlags) + " editorInfo=" + attribute);
                    return InputBindResult.NULL;
                } catch (Throwable th) {
                    th = th;
                    throw th;
    ...
    private InputBindResult startInputOrWindowGainedFocusInternalLocked(int startInputReason, IInputMethodClient client, IBinder windowToken, int startInputFlags, int softInputMode, int windowFlags, EditorInfo attribute, IInputContext inputContext, int missingMethods, int unverifiedTargetSdkVersion, int userId) {
        ...
        if (cs == null) {
            ...
            Slog.e(this.TAG, "startInputOrWindowGainedFocusInternal: display ID mismatch. from client:" + cs.selfReportedDisplayId + " from window:" + windowDisplayId);
            return InputBindResult.DISPLAY_ID_MISMATCH;
        } else if (!this.mWindowManagerInternal.isInputMethodClientFocus(cs.uid, cs.pid, cs.selfReportedDisplayId)) {
            if (DEBUG) {
                Slog.w(this.TAG, "Focus gain on non-focused client " + cs.client + " (uid=" + cs.uid + " pid=" + cs.pid + ")");
            }
            return InputBindResult.NOT_IME_TARGET_WINDOW;
        } else if (this.mSettings.isCurrentProfile(userId) || OppoFeatureCache.get(IColorMultiAppManager.DEFAULT).isCurrentProfile(userId)) {
            if (InputMethodSystemProperty.PER_PROFILE_IME_ENABLED && userId != this.mSettings.getCurrentUserId() && !OppoFeatureCache.get(IColorMultiAppManager.DEFAULT).isCurrentProfile(userId)) {
                switchUserLocked(userId);
            }
            if (DEBUG) {
                Slog.v(this.TAG, "IME PreRendering MASTER flag: " + DebugFlags.FLAG_PRE_RENDER_IME_VIEWS.value() + ", LowRam: " + this.mIsLowRam);
            }
            cs.shouldPreRenderIme = DebugFlags.FLAG_PRE_RENDER_IME_VIEWS.value() && !this.mIsLowRam;
            if (this.mCurFocusedWindow == windowToken) {
                if (DEBUG) {
                    Slog.w(this.TAG, "Window already focused, ignoring focus gain of: " + client + " attribute=" + attribute + ", token = " + windowToken);
                }
                if (attribute != null) {
        ...
        synchronized (this.mMethodMap) {
            if (calledFromValidUserLocked()) {
                if (!canShowInputMethodPickerLocked(client)) {
                    String str = this.TAG;
                    Slog.w(str, "Ignoring showInputMethodPickerFromClient of uid " + Binder.getCallingUid() + ": " + client);
                    return;
                }
    ...
    public boolean switchToPreviousInputMethod(IBinder token) {
        ...
        synchronized (this.mMethodMap) {
            try {
                ...
                if (DEBUG) {
                    String str = this.TAG;
                    Slog.d(str, "Switch to: " + lastImi.getId() + ", " + ((String) lastIme.second) + ", from: " + this.mCurMethodId + ", " + subtypeId);
                }
        ...
        if (!TextUtils.isEmpty(imiId) && subtypes != null) {
            ...
            for (InputMethodSubtype subtype : subtypes) {
                if (!toBeAdded.contains(subtype)) {
                    ...
                    Slog.w(this.TAG, "Duplicated subtype definition found: " + subtype.getLocale() + ", " + subtype.getMode());
                }
            }
            synchronized (this.mMethodMap) {
                if (calledFromValidUserLocked()) {
    ...
    private void setInputMethodWithSubtypeIdLocked(IBinder token, String id, int subtypeId) {
        if (token == null) {
            ...
            String str = this.TAG;
            Slog.w(str, "Ignoring setInputMethod of uid " + Binder.getCallingUid() + " token: " + token);
            return;
        }
        long ident = Binder.clearCallingIdentity();
        try {
    ...
    public void hideMySoftInput(IBinder token, int flags) {
        synchronized (this.mMethodMap) {
            if (calledWithValidTokenLocked(token)) {
                long ident = Binder.clearCallingIdentity();
                try {
                    if (!onHideMySoftInput(token, flags)) {
    ...
    public void showMySoftInput(IBinder token, int flags) {
        synchronized (this.mMethodMap) {
            if (calledWithValidTokenLocked(token)) {
                long ident = Binder.clearCallingIdentity();
                try {
                    if (!onShowMySoftInput(token, flags)) {
        ...
        if (sessionState != session) {
            if (!(sessionState == null || sessionState.session == null)) {
                try {
                    if (DEBUG) {
                        String str = this.TAG;
                        Slog.v(str, "Disabling: " + this.mEnabledSession);
                    }
            ...
            if (sessionState2 != null && sessionState2.session != null) {
                try {
                    if (DEBUG) {
                        String str2 = this.TAG;
                        Slog.v(str2, "Enabling: " + this.mEnabledSession);
                    }
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (i == 1) {
            ...
            if (i2 == 0) {
                ...
                Slog.e(this.TAG, "Unknown subtype picker mode = " + msg.arg1);
                return false;
            } else {
            ...
            switch (i) {
                ...
                case MSG_SHOW_SOFT_INPUT /*{ENCODED_INT: 1020}*/:
                    ...
                    try {
                        if (DEBUG) {
                            Slog.v(this.TAG, "Calling " + args2.arg1 + ".showSoftInput(" + msg.arg1 + ", " + args2.arg2 + ")");
                        }
                ...
                case MSG_HIDE_SOFT_INPUT /*{ENCODED_INT: 1030}*/:
                    ...
                    try {
                        if (DEBUG) {
                            Slog.v(this.TAG, "Calling " + args3.arg1 + ".hideSoftInput(0, " + args3.arg2 + ")");
                        }
                ...
                case MSG_INITIALIZE_IME /*{ENCODED_INT: 1040}*/:
                    ...
                    try {
                        if (DEBUG) {
                            Slog.v(this.TAG, "Sending attach of token: " + args4.arg2 + " for display: " + msg.arg1);
                        }
                ...
                case 3010:
                    ...
                    try {
                        ...
                        Slog.w(this.TAG, "Client died receiving input method " + args7.arg2);
                        if (res.channel != null) {
                            break;
                        }
                    } catch (Throwable th2) {
                ...
                case MSG_SET_ACTIVE /*{ENCODED_INT: 3020}*/:
                    try {
                        ...
                        Slog.w(this.TAG, "Got RemoteException sending setActive(false) notification to pid " + ((ClientState) msg.obj).pid + " uid " + ((ClientState) msg.obj).uid);
                    }
                    return true;
                ...
                case MSG_REPORT_FULLSCREEN_MODE /*{ENCODED_INT: 3045}*/:
                    ...
                    try {
                        ...
                        Slog.w(this.TAG, "Got RemoteException sending reportFullscreen(" + setVisible + ") notification to pid=" + clientState.pid + " uid=" + clientState.uid);
                    }
                    return true;
                case 3060:
                    ...
                    try {
                        ...
                        Slog.w(this.TAG, "Got RemoteException sending reportPreRendered(" + info + ") notification to pid=" + clientState2.pid + " uid=" + clientState2.uid);
                    }
                    args8.recycle();
                    return true;
                case 3070:
                    ...
                    try {
                        ...
                        Slog.w(this.TAG, "Got RemoteException sending applyImeVisibility(" + setVisible + ") notification to pid=" + clientState3.pid + " uid=" + clientState3.uid);
                    }
                    return true;
    ...
    public boolean chooseNewDefaultIMELocked() {
        ...
        if (DEBUG) {
            String str = this.TAG;
            Slog.d(str, "New default IME was selected: " + imi.getId());
        }
    ...
    /* access modifiers changed from: package-private */
    public void queryInputMethodServicesInternal(Context context, int userId, ArrayMap<String, List<InputMethodSubtype>> additionalSubtypeMap, ArrayMap<String, InputMethodInfo> methodMap, ArrayList<InputMethodInfo> methodList) {
        methodList.clear();
        methodMap.clear();
        List<ResolveInfo> services = context.getPackageManager().queryIntentServicesAsUser(new Intent("android.view.InputMethod"), 1073774720, userId);
        ...
        for (int i = 0; i < services.size(); i++) {
            ...
            if (!"android.permission.BIND_INPUT_METHOD".equals(si.permission)) {
                String str = this.TAG;
                Slog.w(str, "Skipping input method " + imeId + ": it does not require the permission " + "android.permission.BIND_INPUT_METHOD");
            } else if (!shouldBuildInputMethodList(imeId)) {
                if (DEBUG) {
                    String str2 = this.TAG;
                    Slog.d(str2, "Checking " + imeId);
                }
                try {
                    ...
                    if (!imi.isVrOnly()) {
                        ...
                        if (DEBUG) {
                            String str3 = this.TAG;
                            Slog.d(str3, "Found an input method " + imi);
                        }
                    }
                } catch (Exception e) {
                    String str4 = this.TAG;
                    Slog.wtf(str4, "Unable to load input method " + imeId, e);
                }
            }
        }
    }
    ...
    public void buildInputMethodListLocked(boolean resetDefaultEnabledIme) {
        if (DEBUG) {
            Slog.d(this.TAG, "--- re-buildInputMethodList reset = " + resetDefaultEnabledIme + " \n ------ caller=" + Debug.getCallers(10));
        }
        if (!this.mSystemReady) {
        ...
        List<ResolveInfo> allInputMethodServices = this.mContext.getPackageManager().queryIntentServicesAsUser(new Intent("android.view.InputMethod"), 1073742336, this.mSettings.getCurrentUserId());
        ...
        if (resetDefaultEnabledIme || reenableMinimumNonAuxSystemImes) {
            ...
            for (int i3 = 0; i3 < N3; i3++) {
                ...
                if (DEBUG) {
                    Slog.d(this.TAG, "--- enable ime = " + imi2);
                }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{android.view.ContextThemeWrapper.<init>(android.content.Context, int):void}
     arg types: [android.app.ContextImpl, int]
     candidates:
      ClspMth{android.view.ContextThemeWrapper.<init>(android.content.Context, android.content.res.Resources$Theme):void}
      ClspMth{android.view.ContextThemeWrapper.<init>(android.content.Context, int):void} */
    private void showInputMethodMenu(boolean showAuxSubtypes, int displayId) {
        ContextImpl contextImpl;
        int subtypeId;
        InputMethodSubtype currentSubtype;
        if (DEBUG) {
            Slog.v(this.TAG, "Show switching menu. showAuxSubtypes=" + showAuxSubtypes);
        }
        ...
        if (DEBUG) {
            Slog.v(this.TAG, "Current IME: " + lastInputMethodId);
        }
        synchronized (this.mMethodMap) {
            ...
            if (!imList.isEmpty()) {
                ...
                if (displayId == 0) {
                    contextImpl = currentThread.getSystemUiContext();
                } else {
                    contextImpl = currentThread.createSystemUiContext(displayId);
                }
                this.mDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper((Context) contextImpl, ColorServiceFactory.getInstance().getColorSystemThemeEx(16974371)));
                ...
                View tv = ((LayoutInflater) dialogContext.getSystemService(LayoutInflater.class)).inflate(getLayoutResIdForInputmethodWwitch(17367168), (ViewGroup) null);
                this.mDialogBuilder.setCustomTitle(tv);
                this.mSwitchingDialogTitleView = tv;
                this.mSwitchingDialogTitleView.findViewById(16908972).setVisibility(this.mWindowManagerInternal.isHardKeyboardAvailable() ? 0 : 8);
                            ...
                            if (!(InputMethodManagerService.this.mIms == null || InputMethodManagerService.this.mIms.length <= which || InputMethodManagerService.this.mSubtypeIds == null)) {
                                if (InputMethodManagerService.this.mSubtypeIds.length > which) {
                                    ...
                                    if (im != null) {
                                        ...
                                        if (!(im.getPackageName() == null || serviceInfo == null || serviceInfo.applicationInfo == null)) {
                                            OppoPackageManagerInternal oppoPackageManagerInt = (OppoPackageManagerInternal) LocalServices.getService(OppoPackageManagerInternal.class);
                                            long callingId = Binder.clearCallingIdentity();
                                            try {
                                                oppoPackageManagerInt.autoUnfreezePackage(serviceInfo.applicationInfo.packageName, 0, "set default inputmethod");
                                            } finally {
    ...
    public void hideInputMethodMenuLocked() {
        if (DEBUG) {
            Slog.v(this.TAG, "Hide switching menu");
        }
        AlertDialog alertDialog = this.mSwitchingDialog;
        if (alertDialog != null) {
            alertDialog.dismiss();
    ...
    public void resetSelectedInputMethodAndSubtypeLocked(String newDefaultIme) {
        ...
        if (!(imi == null || TextUtils.isEmpty(newDefaultIme) || (subtypeHashCode = this.mSettings.getLastSubtypeForInputMethodLocked(newDefaultIme)) == null)) {
            try {
                ...
                String str = this.TAG;
                Slog.w(str, "HashCode for subtype looks broken: " + subtypeHashCode, e);
            }
        }
    ...
    public IInputContentUriToken createInputContentUriToken(IBinder token, Uri contentUri, String packageName) {
        if (token == null) {
            ...
            synchronized (this.mMethodMap) {
                ...
                if (this.mCurToken != token) {
                    String str = this.TAG;
                    Slog.e(str, "Ignoring createInputContentUriToken mCurToken=" + this.mCurToken + " token=" + token);
                    return null;
                } else if (!TextUtils.equals(this.mCurAttribute.packageName, packageName)) {
                    String str2 = this.TAG;
                    Slog.e(str2, "Ignoring createInputContentUriToken mCurAttribute.packageName=" + this.mCurAttribute.packageName + " packageName=" + packageName);
                    return null;
                } else {
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        IInputMethod method;
        if (DumpUtils.checkDumpPermission(this.mContext, this.TAG, pw)) {
