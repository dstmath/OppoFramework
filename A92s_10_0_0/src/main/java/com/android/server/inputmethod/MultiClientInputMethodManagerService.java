    ...
    private static final class ApiCallbacks extends IInputMethodManager.Stub {
            ...
            if (editorInfo == null || packageNameVerified) {
                ...
                synchronized (obj3) {
                    try {
                        ...
                        if (clientInfo == null) {
                            try {
                                InputBindResult inputBindResult = InputBindResult.INVALID_CLIENT;
                            ...
                            Slog.e(MultiClientInputMethodManagerService.TAG, "Expected calling UID=" + clientInfo.mUid + " actual=" + callingUid);
                            InputBindResult inputBindResult2 = InputBindResult.INVALID_CLIENT;
                            ...
                            switch (data.mState) {
                                ...
                                case 4:
                                case 6:
                                    InputBindResult inputBindResult3 = InputBindResult.IME_NOT_CONNECTED;
                                ...
                                case 5:
                                    ...
                                    if (!checkFocus(clientInfo.mUid, clientInfo.mPid, clientInfo.mSelfReportedDisplayId)) {
                                        InputBindResult inputBindResult4 = InputBindResult.NOT_IME_TARGET_WINDOW;
                                    ...
                                    if (editorInfo == null) {
                                        ...
                                        InputBindResult inputBindResult5 = InputBindResult.NULL_EDITOR_INFO;
                                    ...
                                    if (i3 == 1 || i3 == 2) {
                                        ...
                                        InputBindResult inputBindResult6 = new InputBindResult(1, (IInputMethodSession) null, (InputChannel) null, data.mCurrentInputMethodInfo.getId(), clientInfo.mBindingSequence, (Matrix) null);
                                        ...
                                        clientInfo.mState = i;
                                        InputBindResult inputBindResult7 = new InputBindResult(0, clientInfo.mInputMethodSession, clientInfo.mWriteChannel.dup(), data.mCurrentInputMethodInfo.getId(), clientInfo.mBindingSequence, (Matrix) null);
                                        return inputBindResult7;
                                    } else if (i3 != 5) {
                                        return null;
                                    } else {
                                        Slog.e(MultiClientInputMethodManagerService.TAG, "The client is already unregistered.");
                                        InputBindResult inputBindResult8 = InputBindResult.INVALID_CLIENT;
                                        return inputBindResult8;
                                    }
                                default:
                                    Slog.wtf(MultiClientInputMethodManagerService.TAG, "Unexpected state=" + data.mState);
                                    InputBindResult inputBindResult9 = InputBindResult.IME_NOT_CONNECTED;
        ...
        public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            if (DumpUtils.checkDumpPermission(this.mContext, MultiClientInputMethodManagerService.TAG, pw)) {
                ...
                IndentingPrintWriter ipw = new IndentingPrintWriter(pw, StringUtils.SPACE);
