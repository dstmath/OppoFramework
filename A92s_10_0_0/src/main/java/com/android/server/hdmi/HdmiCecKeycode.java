...
final class HdmiCecKeycode {
    ...
    private static class KeycodeEntry {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: com.android.server.hdmi.HdmiCecKeycode.KeycodeEntry.<init>(int, int, boolean, byte[]):void
         arg types: [int, int, int, byte[]]
         candidates:
          com.android.server.hdmi.HdmiCecKeycode.KeycodeEntry.<init>(int, int, boolean, com.android.server.hdmi.HdmiCecKeycode$1):void
          com.android.server.hdmi.HdmiCecKeycode.KeycodeEntry.<init>(int, int, boolean, byte[]):void */
