...
public class ColorServiceFactoryImpl extends ColorServiceFactory {
    ...
    public <T extends IOppoCommonFeature> T getFeature(T def, Object... vars) {
        ...
        switch (AnonymousClass1.$SwitchMap$android$common$OppoFeatureList$OppoIndex[def.index().ordinal()]) {
            case 1:
                return OppoFeatureManager.getTraceMonitor(getColorSystemServerEx(vars));
            case 2:
                return OppoFeatureManager.getTraceMonitor(getColorActivityManagerServiceEx(vars));
            case 3:
                return OppoFeatureManager.getTraceMonitor(getColorActivityTaskManagerServiceEx(vars));
            case 4:
                return OppoFeatureManager.getTraceMonitor(getColorPackageManagerServiceEx(vars));
            case 5:
                return OppoFeatureManager.getTraceMonitor(getColorWindowManagerServiceEx(vars));
            case 6:
                return OppoFeatureManager.getTraceMonitor(getColorPowerManagerServiceEx(vars));
            case ColorStartingWindowRUSHelper.TASK_SNAPSHOT_BLACK_TOKEN_START_FROM_LAUNCHER /*{ENCODED_INT: 7}*/:
                return OppoFeatureManager.getTraceMonitor(getColorAlarmManagerServiceEx(vars));
            case ColorStartingWindowRUSHelper.SPLASH_SNAPSHOT_WHITE_THIRD_PARTY_APP /*{ENCODED_INT: 8}*/:
                return OppoFeatureManager.getTraceMonitor(getColorDeviceIdleControllerEx(vars));
            case ColorStartingWindowRUSHelper.FORCE_USE_COLOR_DRAWABLE_WHEN_SPLASH_WINDOW_TRANSLUCENT /*{ENCODED_INT: 9}*/:
                return OppoFeatureManager.getTraceMonitor(getColorJobSchedulerServiceEx(vars));
            case ColorStartingWindowRUSHelper.STARTING_WINDOW_EXIT_LONG_DURATION_PACKAGE /*{ENCODED_INT: 10}*/:
                return OppoFeatureManager.getTraceMonitor(getColorNotificationManagerServiceEx(vars));
            case ColorStartingWindowRUSHelper.SNAPSHOT_FORCE_CLEAR_WHEN_DIFF_ORIENTATION /*{ENCODED_INT: 11}*/:
                return OppoFeatureManager.getTraceMonitor(getColorOverlayManagerServiceEx(vars));
            case 12:
                return OppoFeatureManager.getTraceMonitor(getColorInputMethodManagerServiceEx(vars));
            case 13:
                return OppoFeatureManager.getTraceMonitor(getColorDisplayManagerServiceEx(vars));
            case 14:
                return OppoFeatureManager.getTraceMonitor(getColorNetworkPolicyManagerServiceEx(vars));
            case 15:
                return OppoFeatureManager.getTraceMonitor(getColorAccessControlManagerService(vars));
            case 16:
                return OppoFeatureManager.getTraceMonitor(getColorLockTaskController(vars));
            case 17:
                return OppoFeatureManager.getTraceMonitor(getColorAppStoreTraffic(vars));
            case 18:
                return OppoFeatureManager.getTraceMonitor(getColorAppPhoneManager(vars));
            case 19:
                return OppoFeatureManager.getTraceMonitor(getColorFullmodeManager(vars));
            case 20:
                return OppoFeatureManager.getTraceMonitor(getColorDataFreeManager(vars));
            case 21:
                return OppoFeatureManager.getTraceMonitor(getColorIconCachesManager(vars));
            case ColorHansManager.HansMainHandler.HANS_MSG_FREEZE_REPEAT_ACTION:
                return OppoFeatureManager.getTraceMonitor(getColorAppStartupManager(vars));
            case 23:
                return OppoFeatureManager.getTraceMonitor(getColorChildrenModeInstallManager(vars));
            case 24:
                return OppoFeatureManager.getTraceMonitor(getColorDynamicFeatureManager(vars));
            case 25:
                return OppoFeatureManager.getTraceMonitor(getColorAppCrashClearManager(vars));
            case OppoNotificationManager.SDK_INT_26:
                return OppoFeatureManager.getTraceMonitor(getColorAppSwitchManager(vars));
            case 27:
                return OppoFeatureManager.getTraceMonitor(getColorBroadcastStaticRegisterWhitelistManager(vars));
            case 28:
                return OppoFeatureManager.getTraceMonitor(getColorSellModeManager(vars));
            case 29:
                return OppoFeatureManager.getTraceMonitor(getColorAppInstallProgressManager(vars));
            case ColorHansManager.HansMainHandler.HANS_MSG_KILL_ABNORMAL_APP:
                return OppoFeatureManager.getTraceMonitor(getColorGameSpaceManager(vars));
            case 31:
                return OppoFeatureManager.getTraceMonitor(getColorScreenOffOptimization(vars));
            case 32:
                return OppoFeatureManager.getTraceMonitor(getColorSplitWindowManagerService(vars));
            case 33:
                return OppoFeatureManager.getTraceMonitor(getColorMultiAppManagerService(vars));
            case 34:
                return OppoFeatureManager.getTraceMonitor(getColorBatterySaveExtend(vars));
            case 35:
                return OppoFeatureManager.getTraceMonitor(getColorAppListInterceptManager(vars));
            case 36:
                return OppoFeatureManager.getTraceMonitor(getColorIntentInterceptManager(vars));
            case 37:
                return OppoFeatureManager.getTraceMonitor(getColorDeepSleepHelper(vars));
            case 38:
                return OppoFeatureManager.getTraceMonitor(getColorAppQuickFreezeManager(vars));
            case 39:
                return OppoFeatureManager.getTraceMonitor(getColorRuntimePermGrantPolicyManager(vars));
            case 40:
                return OppoFeatureManager.getTraceMonitor(getColorDefaultAppPolicyManager(vars));
            case 41:
                return OppoFeatureManager.getTraceMonitor(getColorDozeNetworkOptimization(vars));
            case 42:
                return OppoFeatureManager.getTraceMonitor(getColorClearDataProtectManager(vars));
            case 43:
                return OppoFeatureManager.getTraceMonitor(getColorGoogleAlarmRestrict(vars));
            case 44:
                return OppoFeatureManager.getTraceMonitor(getColorGoogleDozeRestrict(vars));
            case 45:
                return OppoFeatureManager.getTraceMonitor(getColorPackageInstallStatisticManager(vars));
            case 46:
                return OppoFeatureManager.getTraceMonitor(getColorAlarmManagerHelper(vars));
            case 47:
                return OppoFeatureManager.getTraceMonitor(getColorJobScheduleManager(vars));
            case 48:
                return OppoFeatureManager.getTraceMonitor(getColorSecurePayManager(vars));
            case 49:
                return OppoFeatureManager.getTraceMonitor(getColorPackageInstallInterceptManager(vars));
            case 50:
                return OppoFeatureManager.getTraceMonitor(getColorSensitivePermGrantPolicyManager(vars));
            case 51:
                return OppoFeatureManager.getTraceMonitor(getColorInstallThreadsControlManager(vars));
            case 52:
                return OppoFeatureManager.getTraceMonitor(getColorHansManager(vars));
            case 53:
                return OppoFeatureManager.getTraceMonitor(getColorCommonListManagerr(vars));
            case 54:
                return OppoFeatureManager.getTraceMonitor(getColorThirdPartyAppSignCheckManager(vars));
            case 55:
                return OppoFeatureManager.getTraceMonitor(getColorBroadcastManager(vars));
            case 56:
                return OppoFeatureManager.getTraceMonitor(getColorForbidUninstallAppManager(vars));
            case 57:
                return OppoFeatureManager.getTraceMonitor(getColorStrictModeManager(vars));
            case 58:
                return OppoFeatureManager.getTraceMonitor(getColorAbnormalAppManager(vars));
            case 59:
                return OppoFeatureManager.getTraceMonitor(getColorFastAppManager(vars));
            case 60:
                return OppoFeatureManager.getTraceMonitor(getColorAlarmAlignment(vars));
            case 61:
                return OppoFeatureManager.getTraceMonitor(getColorSecurityPermissionManager(vars));
            case 62:
                return OppoFeatureManager.getTraceMonitor(getColorAlarmTempWhitelist(vars));
            case 63:
                return OppoFeatureManager.getTraceMonitor(getColorDeviceIdleHelper(vars));
            case 64:
                return OppoFeatureManager.getTraceMonitor(getOppoDynamicLogManager(vars));
            case 65:
                return OppoFeatureManager.getTraceMonitor(getColorAIBrightManager(vars));
            case 66:
                return OppoFeatureManager.getTraceMonitor(getColorLanguageManager(vars));
            case 67:
                return OppoFeatureManager.getTraceMonitor(getColorExpDefaultBrowserManager(vars));
            case 68:
                return OppoFeatureManager.getTraceMonitor(getColorForbidHideOrDisableManager(vars));
            case 69:
                return OppoFeatureManager.getTraceMonitor(getColorLanguageEnableManager(vars));
            case 70:
                return OppoFeatureManager.getTraceMonitor(getColorPkgStartInfoManager(vars));
            case 71:
                return OppoFeatureManager.getTraceMonitor(getColorOtaManager(vars));
            case 72:
                return OppoFeatureManager.getTraceMonitor(getColorBreenoManager(vars));
            case 73:
                return OppoFeatureManager.getTraceMonitor(getColorFullScreenDisplayManager(vars));
            case 74:
                return OppoFeatureManager.getTraceMonitor(getColorRemovableAppManager(vars));
            case 75:
                return OppoFeatureManager.getTraceMonitor(getColorSystemAppProtectManager(vars));
            case 76:
                return OppoFeatureManager.getTraceMonitor(getColorSilentRebootManager(vars));
            case 77:
                return OppoFeatureManager.getTraceMonitor(getColorWakeLockCheck(vars));
            case 78:
                return OppoFeatureManager.getTraceMonitor(getColorAppChildrenSpaceManager(vars));
            case 79:
                return OppoFeatureManager.getTraceMonitor(getColorZoomWindowManagerService(vars));
            case 80:
                return OppoFeatureManager.getTraceMonitor(getColorPerfManager(vars));
            case 81:
                return OppoFeatureManager.getTraceMonitor(getColorAthenaAmManager(vars));
            case 82:
                return OppoFeatureManager.getTraceMonitor(getColorAthenaManager(vars));
            case 83:
                return OppoFeatureManager.getTraceMonitor(getColorWatermarkManager(vars));
            case 84:
                return OppoFeatureManager.getTraceMonitor(getColorEapManager(vars));
            case 85:
                return OppoFeatureManager.getTraceMonitor(getColorDexMetadataManager(vars));
            case 86:
                return OppoFeatureManager.getTraceMonitor(getColorBatteryIdleManager(vars));
            case 87:
                return OppoFeatureManager.getTraceMonitor(getColorStartingWindowManager(vars));
            case 88:
                return OppoFeatureManager.getTraceMonitor(getColorEdgeTouchManager(vars));
            case 89:
                return OppoFeatureManager.getTraceMonitor(getColorMergedProcessSplitManager(vars));
            default:
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorDynamicLogManager.ordinal()] = 64;
            } catch (NoSuchFieldError e64) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorAIBrightManager.ordinal()] = 65;
            } catch (NoSuchFieldError e65) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorLanguageManager.ordinal()] = 66;
            } catch (NoSuchFieldError e66) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorExpDefaultBrowserManager.ordinal()] = 67;
            } catch (NoSuchFieldError e67) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorForbidHideOrDisableManager.ordinal()] = 68;
            } catch (NoSuchFieldError e68) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorLanguageEnableManager.ordinal()] = 69;
            } catch (NoSuchFieldError e69) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorPkgStartInfoManager.ordinal()] = 70;
            } catch (NoSuchFieldError e70) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorOtaDataManager.ordinal()] = 71;
            } catch (NoSuchFieldError e71) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorBreenoManager.ordinal()] = 72;
            } catch (NoSuchFieldError e72) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorFullScreenDisplayManager.ordinal()] = 73;
            } catch (NoSuchFieldError e73) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorRemovableAppManager.ordinal()] = 74;
            } catch (NoSuchFieldError e74) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorSystemAppProtectManager.ordinal()] = 75;
            } catch (NoSuchFieldError e75) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorSilentRebootManager.ordinal()] = 76;
            } catch (NoSuchFieldError e76) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorWakeLockCheck.ordinal()] = 77;
            } catch (NoSuchFieldError e77) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorAppChildrenSpaceManager.ordinal()] = 78;
            } catch (NoSuchFieldError e78) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorZoomWindowManager.ordinal()] = 79;
            } catch (NoSuchFieldError e79) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorPerfManager.ordinal()] = 80;
            } catch (NoSuchFieldError e80) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorAthenaAmManager.ordinal()] = 81;
            } catch (NoSuchFieldError e81) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorAthenaManager.ordinal()] = 82;
            } catch (NoSuchFieldError e82) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorWatermarkManager.ordinal()] = 83;
            } catch (NoSuchFieldError e83) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorEapManager.ordinal()] = 84;
            } catch (NoSuchFieldError e84) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorDexMetadataManager.ordinal()] = 85;
            } catch (NoSuchFieldError e85) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IBatteryIdleController.ordinal()] = 86;
            } catch (NoSuchFieldError e86) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorStartingWindowManager.ordinal()] = 87;
            } catch (NoSuchFieldError e87) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorEdgeTouchManager.ordinal()] = 88;
            } catch (NoSuchFieldError e88) {
            }
            try {
                $SwitchMap$android$common$OppoFeatureList$OppoIndex[OppoFeatureList.OppoIndex.IColorMergedProcessSplitManager.ordinal()] = 89;
