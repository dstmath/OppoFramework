...
public class AccessibilityManagerService extends IAccessibilityManager.Stub implements AbstractAccessibilityServiceConnection.SystemSupport {
    ...
    /* access modifiers changed from: private */
    public static final ComponentName sDirectAccessibilityServiceComponentName = new ComponentName("com.coloros.colordirectservice", "com.coloros.colordirectservice.ColorTextAccessibilityService");
    ...
    public long addClient(IAccessibilityManagerClient callback, int userId) {
        ...
        synchronized (this.mLock) {
            ...
            if (this.mSecurityPolicy.isCallerInteractingAcrossUsers(userId)) {
                ...
                long of = IntPair.of(userState2.getClientState(), client.mLastSentRelevantEventTypes);
                return of;
            }
            int i = 0;
            ...
            long of2 = IntPair.of(i, client.mLastSentRelevantEventTypes);
            return of2;
        }
    }
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:43:0x001e */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:42:0x001e */
        ...
        if (DumpUtils.checkDumpPermission(this.mContext, LOG_TAG, pw)) {
            synchronized (this.mLock) {
                ...
                for (int i = 0; i < userCount; i++) {
                    ...
                    pw.append((CharSequence) "}");
                    pw.println();
                    pw.append((CharSequence) "     Bound services:{");
                    int serviceCount = userState.mBoundServices.size();
                    ...
                    pw.println("}");
                    pw.append((CharSequence) "     Enabled services:{");
                    Iterator<ComponentName> it = userState.mEnabledServices.iterator();
                    if (it.hasNext()) {
                    ...
                    pw.println("}");
                    pw.append((CharSequence) "     Binding services:{");
                ...
                if (!(windowType == 2014 || windowType == 2017 || windowType == 2024)) {
                    ...
                    if (!(windowType == 2036 || windowType == 2038 || windowType == 2019 || windowType == 2020)) {
                        switch (windowType) {
                            ...
                            case 1001:
                            case 1002:
                            case OppoUsageService.IntergrateReserveManager.WRITE_OPPORESEVE2_TYPE_RADIO /*{ENCODED_INT: 1003}*/:
                                break;
                            default:
                                switch (windowType) {
                                    case 2000:
