...
public class MagnificationController {
    ...
    public final class DisplayMagnification implements WindowManagerInternal.MagnificationCallbacks {
        ...
        public float getCenterX() {
            return (((((float) this.mMagnificationBounds.width()) / 2.0f) + ((float) this.mMagnificationBounds.left)) - getOffsetX()) / getScale();
        }

        /* access modifiers changed from: package-private */
        @GuardedBy({"mLock"})
        public float getCenterY() {
            return (((((float) this.mMagnificationBounds.height()) / 2.0f) + ((float) this.mMagnificationBounds.top)) - getOffsetY()) / getScale();
        }
        ...
        public boolean updateMagnificationSpecLocked(float scale, float centerX, float centerY) {
            ...
            boolean changed2 = changed | updateCurrentSpecWithOffsetsLocked(((((float) this.mMagnificationBounds.width()) / 2.0f) + ((float) this.mMagnificationBounds.left)) - (centerX * normScale), ((((float) this.mMagnificationBounds.height()) / 2.0f) + ((float) this.mMagnificationBounds.top)) - (centerY * normScale));
            if (changed2) {
                onMagnificationChangedLocked();
            }
            return changed2;
    ...
    public boolean isRegistered(int displayId) {
        synchronized (this.mLock) {
            ...
            boolean isRegistered = display.isRegistered();
            return isRegistered;
        }
    }
    ...
    public boolean isMagnifying(int displayId) {
        synchronized (this.mLock) {
            ...
            boolean isMagnifying = display.isMagnifying();
            return isMagnifying;
        }
    }
    ...
    public boolean magnificationRegionContains(int displayId, float x, float y) {
        synchronized (this.mLock) {
            ...
            boolean magnificationRegionContains = display.magnificationRegionContains(x, y);
            return magnificationRegionContains;
        }
    }
    ...
    public float getOffsetX(int displayId) {
        synchronized (this.mLock) {
            ...
            float offsetX = display.getOffsetX();
            return offsetX;
        }
    }
    ...
    public float getCenterX(int displayId) {
        synchronized (this.mLock) {
            ...
            float centerX = display.getCenterX();
            return centerX;
        }
    }
    ...
    public float getOffsetY(int displayId) {
        synchronized (this.mLock) {
            ...
            float offsetY = display.getOffsetY();
            return offsetY;
        }
    }
    ...
    public float getCenterY(int displayId) {
        synchronized (this.mLock) {
            ...
            float centerY = display.getCenterY();
            return centerY;
        }
    }
    ...
    public boolean reset(int displayId, boolean animate) {
        synchronized (this.mLock) {
            ...
            boolean reset = display.reset(animate);
            return reset;
        }
    }
    ...
    public boolean setScale(int displayId, float scale, float pivotX, float pivotY, boolean animate, int id) {
        synchronized (this.mLock) {
            ...
            boolean scale2 = display.setScale(scale, pivotX, pivotY, animate, id);
            return scale2;
        }
    }
    ...
    public boolean setCenter(int displayId, float centerX, float centerY, boolean animate, int id) {
        synchronized (this.mLock) {
            ...
            boolean scaleAndCenter = display.setScaleAndCenter(Float.NaN, centerX, centerY, animate, id);
    ...
    public boolean setScaleAndCenter(int displayId, float scale, float centerX, float centerY, boolean animate, int id) {
        synchronized (this.mLock) {
            ...
            boolean scaleAndCenter = display.setScaleAndCenter(scale, centerX, centerY, animate, id);
            return scaleAndCenter;
        }
    }
    ...
    public int getIdOfLastServiceToMagnify(int displayId) {
        synchronized (this.mLock) {
            ...
            int idOfLastServiceToMagnify = display.getIdOfLastServiceToMagnify();
            return idOfLastServiceToMagnify;
        }
    }
    ...
    public static class SpecAnimationBridge implements ValueAnimator.AnimatorUpdateListener {
        ...
        private SpecAnimationBridge(ControllerContext ctx, Object lock, int displayId) {
            ...
            this.mValueAnimator.setFloatValues(OppoBrightUtils.MIN_LUX_LIMITI, 1.0f);
                ...
                if (enabled != this.mEnabled) {
                    ...
                    if (!this.mEnabled) {
                        ...
                        if (OppoScreenDragUtil.isNormalState()) {
                            this.mControllerCtx.getWindowManager().setMagnificationSpec(this.mDisplayId, tempSpec);
                        }
                    }
                }
            }
