    ...
    private void startTrackingPackageChanges() {
        new PackageMonitor() {
            ...
            public void onPackageRemoved(String packageName, int uid) {
                ...
                synchronized (AbstractMasterSystemService.this.mLock) {
                    int userId = getChangingUserId();
                    S service = AbstractMasterSystemService.this.peekServiceForUserLocked(userId);
                    if (!(service == null || (componentName = service.getServiceComponentName()) == null || !packageName.equals(componentName.getPackageName()))) {
            ...
            private String getActiveServicePackageNameLocked() {
                ...
                S service = AbstractMasterSystemService.this.peekServiceForUserLocked(getChangingUserId());
                if (service == null || (serviceComponent = service.getServiceComponentName()) == null) {
                    return null;
                }
