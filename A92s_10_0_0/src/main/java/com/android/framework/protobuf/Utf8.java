            ...
            while (inIx < inLimit) {
                ...
                if (c4 < c && outIx < outLimit2) {
                    ...
                    if (c4 >= 55296 && 57343 >= c4) {
                        ...
                        str = str4;
                        long outIx3 = outIx + 1;
                        UNSAFE.putByte(out, outIx, (byte) ((c4 >>> 12) | 480));
                ...
                while (inIx < inLimit) {
                    ...
                    if (c4 < c && outIx < outLimit2) {
                        ...
                        if ((c4 < 55296 || 57343 < c4) && outIx <= outLimit2 - 3) {
                            long outIx5 = outIx + 1;
                            UNSAFE.putByte(outIx, (byte) ((c4 >>> 12) | 480));
                            long outIx6 = outIx5 + 1;
        ...
        private static Unsafe getUnsafe() {
            ...
            try {
                unsafe = (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() {
                    /* class com.android.framework.protobuf.Utf8.UnsafeProcessor.AnonymousClass1 */
