...
public final class CodedInputStream {
            ...
            if (b >= 0) {
                ...
                if (x2 < 0) {
                    ...
                    if (x3 >= 0) {
                        ...
                        int pos5 = pos + 1;
                        int x4 = (buffer2[pos] << OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO1) ^ x3;
                        if (x4 < 0) {
                            x = -2080896 ^ x4;
                            pos = pos5;
                        } else {
            ...
            if (b >= 0) {
                ...
                if (y < 0) {
                    ...
                    if (y2 >= 0) {
                        ...
                        pos3 = pos4 + 1;
                        int y3 = (buffer2[pos4] << OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO1) ^ y2;
                        if (y3 < 0) {
                            x = (long) (-2080896 ^ y3);
                        } else {
                            long x2 = (long) y3;
    ...
    public int readRawLittleEndian32() throws IOException {
        ...
        return (buffer2[pos] & 255) | ((buffer2[pos + 1] & 255) << 8) | ((buffer2[pos + 2] & 255) << 16) | ((buffer2[pos + 3] & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP);
    }
