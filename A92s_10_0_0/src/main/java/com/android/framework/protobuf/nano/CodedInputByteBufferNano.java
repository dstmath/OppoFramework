...
public final class CodedInputByteBufferNano {
    ...
    public int readRawVarint32() throws IOException {
        ...
        if (tmp4 >= 0) {
            return result3 | (tmp4 << OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO1);
        }
        int result4 = result3 | ((tmp4 & Byte.MAX_VALUE) << OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO1);
