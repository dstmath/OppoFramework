...
public class ArrayUtils {
    ...
    public static <T> T[] concatElements(Class<T> kind, T[] a, T[] b) {
        ...
        T[] res = (Object[]) Array.newInstance((Class<?>) kind, an + bn);
        if (an > 0) {
    ...
    public static <T> T[] appendElement(Class<T> kind, T[] array, T element, boolean allowDuplicates) {
        ...
        if (array == null) {
            ...
            result = (Object[]) Array.newInstance((Class<?>) kind, 1);
        } else if (!allowDuplicates && contains(array, element)) {
            return array;
        } else {
            end = array.length;
            result = (Object[]) Array.newInstance((Class<?>) kind, end + 1);
    ...
    public static <T> T[] removeElement(Class<T> kind, T[] array, T element) {
        ...
        while (i < length) {
            if (!Objects.equals(array[i], element)) {
                ...
                T[] result = (Object[]) Array.newInstance((Class<?>) kind, length - 1);
