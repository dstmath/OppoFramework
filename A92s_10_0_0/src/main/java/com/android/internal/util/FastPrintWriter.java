...
public class FastPrintWriter extends PrintWriter {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.util.FastPrintWriter.<init>(java.io.OutputStream, boolean, int):void
     arg types: [java.io.OutputStream, int, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [com.android.internal.util.FastPrintWriter$DummyWriter, int]
     candidates:
    ...
    /* JADX INFO: Multiple debug info for r1v0 int: [D('end' int), D('pos' int)] */
    ...
    @Override // java.io.PrintWriter, java.io.PrintWriter, java.io.PrintWriter, java.lang.Appendable, java.io.Writer, java.io.Writer
