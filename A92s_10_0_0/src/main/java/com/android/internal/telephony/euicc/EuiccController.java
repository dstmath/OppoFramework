...
public class EuiccController extends IEuiccController.Stub {
    ...
    public void continueOperation(int cardId, Intent resolutionIntent, Bundle resolutionExtras) {
        if (callerCanWriteEmbeddedSubscriptions()) {
            ...
            try {
                ...
                if (op != null) {
                    op.continueOperation(cardId, resolutionExtras, (PendingIntent) resolutionIntent.getParcelableExtra("android.telephony.euicc.extra.EMBEDDED_SUBSCRIPTION_RESOLUTION_CALLBACK_INTENT"));
                    return;
                }
    ...
    /* access modifiers changed from: private */
    public boolean checkCarrierPrivilegeInMetadata(DownloadableSubscription subscription, String callingPackage) {
