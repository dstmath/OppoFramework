...
public abstract class InboundSmsHandler extends AbstractInboundSmsHandler {
    ...
    /* access modifiers changed from: private */
    public LocalLog mLocalLog = new LocalLog(64);
    ...
    /* JADX INFO: Multiple debug info for r6v2 com.android.internal.telephony.InboundSmsHandler$SmsBroadcastReceiver: [D('pduList' java.util.List<byte[]>), D('resultReceiver' com.android.internal.telephony.InboundSmsHandler$SmsBroadcastReceiver)] */
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:122:0x035c  */
    /* JADX WARNING: Removed duplicated region for block: B:125:0x0364  */
        ...
        try {
            ...
            if (pduList2.size() == 0) {
                ...
                if (this.mUserManager.isUserUnlocked()) {
                    ...
                    if (destPort == messageCount || !oemDealWithCtImsSms(pdus, format, this.mContext)) {
    ...
    private static String replaceFormFeeds(String s) {
        return s == null ? PhoneConfigurationManager.SSSS : s.replace(12, 10);
    }
