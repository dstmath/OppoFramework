...
public class PhoneSwitcher extends Handler {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 103:
                ...
                return;
            case EVENT_RELEASE_NETWORK /*{ENCODED_INT: 104}*/:
                onReleaseNetwork((NetworkRequest) msg.obj);
                return;
            case EVENT_EMERGENCY_TOGGLE /*{ENCODED_INT: 105}*/:
            ...
            case EVENT_OPPT_DATA_SUB_CHANGED /*{ENCODED_INT: 107}*/:
                ...
                return;
            case EVENT_RADIO_AVAILABLE /*{ENCODED_INT: 108}*/:
    ...
    /* access modifiers changed from: private */
    public void onPhoneCapabilityChangedInternal(PhoneCapability capability) {
    ...
    /* access modifiers changed from: private */
    public void logDataSwitchEvent(int subId, int state, int reason) {
