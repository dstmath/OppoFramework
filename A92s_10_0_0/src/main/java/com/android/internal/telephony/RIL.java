...
public class RIL extends BaseCommands implements CommandsInterface {
                ...
                synchronized (RIL.this.mRequestList) {
                    if (msg.arg1 == RIL.this.mWlSequenceNum && RIL.this.clearWakeLock(0)) {
                        ...
                        for (int i2 = 0; i2 < count; i2++) {
                            ...
                            Rlog.d(RIL.RILJ_LOG_TAG, i2 + ": [" + rr.mSerial + "] " + RIL.requestToString(rr.mRequest));
                        }
                    }
                }
            } else if (i != 4) {
    ...
    final class RadioProxyDeathRecipient implements IHwBinder.DeathRecipient {
        ...
        public void serviceDied(long cookie) {
            ...
            RIL.this.mRilHandler.sendMessageDelayed(RIL.this.mRilHandler.obtainMessage(6, Long.valueOf(cookie)), 1000);
        }
    }
    ...
    public synchronized IRadio getRadioProxy(Message result) {
        if (!this.mIsMobileNetworkSupported) {
            ...
            if (this.mDisabledRadioServices.contains(this.mPhoneId)) {
                ...
                try {
                    this.mRadioProxy = IRadio.getService(HIDL_SERVICE_NAME[this.mPhoneId.intValue()], isGetHidlServiceSync());
                    ...
                    try {
                        ...
                        this.mRadioProxy = null;
                        riljLoge("RadioProxy getService/setResponseFunctions: " + e2);
                    }
                }
                if (this.mRadioProxy != null) {
                    if (android.hardware.radio.V1_4.IRadio.castFrom(this.mRadioProxy) != null) {
                        this.mRadioProxy = android.hardware.radio.V1_4.IRadio.castFrom(this.mRadioProxy);
                        this.mRadioVersion = RADIO_HAL_VERSION_1_4;
                    } else if (android.hardware.radio.V1_3.IRadio.castFrom(this.mRadioProxy) != null) {
                        this.mRadioProxy = android.hardware.radio.V1_3.IRadio.castFrom(this.mRadioProxy);
                        this.mRadioVersion = RADIO_HAL_VERSION_1_3;
                    } else if (android.hardware.radio.V1_2.IRadio.castFrom(this.mRadioProxy) != null) {
                        this.mRadioProxy = android.hardware.radio.V1_2.IRadio.castFrom(this.mRadioProxy);
                        this.mRadioVersion = RADIO_HAL_VERSION_1_2;
                    } else if (android.hardware.radio.V1_1.IRadio.castFrom(this.mRadioProxy) != null) {
                        this.mRadioProxy = android.hardware.radio.V1_1.IRadio.castFrom(this.mRadioProxy);
            ...
            if (this.mRadioProxy == null) {
                ...
                this.mRilHandler.sendMessageDelayed(this.mRilHandler.obtainMessage(6, Long.valueOf(this.mRadioProxyCookie.get())), 1000);
            }
            return this.mRadioProxy;
        }
    }
        ...
        if (!this.mIsMobileNetworkSupported) {
            ...
            try {
                if (this.mDisabledOemHookServices.contains(this.mPhoneId)) {
                    ...
                    this.mOemHookProxy = IOemHook.getService(HIDL_SERVICE_NAME[this.mPhoneId.intValue()], isGetHidlServiceSync());
                ...
                this.mOemHookProxy = null;
                riljLoge("OemHookProxy getService/setResponseFunctions: " + e2);
            }
    ...
    @Override // com.android.internal.telephony.CommandsInterface, com.android.internal.telephony.BaseCommands
    ...
    /* access modifiers changed from: protected */
    public RILRequest obtainRequest(int request, Message result, WorkSource workSource) {
    ...
    /* access modifiers changed from: protected */
    public void handleRadioProxyExceptionForRR(RILRequest rr, String caller, Exception e) {
        riljLoge(caller + ": " + e);
    ...
    /* JADX INFO: Multiple debug info for r10v3 'rr'  com.android.internal.telephony.RILRequest: [D('dnses' java.util.ArrayList<java.lang.String>), D('rr' com.android.internal.telephony.RILRequest)] */
    @Override // com.android.internal.telephony.CommandsInterface
        ...
        if (radioProxy != null) {
            ...
            if (this.mRadioVersion.greaterOrEqual(RADIO_HAL_VERSION_1_4)) {
                try {
                    ...
                    riljLog(((String) rr2.serialString()) + "> " + requestToString(rr2.mRequest) + ",accessNetworkType=" + AccessNetworkConstants.AccessNetworkType.toString(accessNetworkType) + ",isRoaming=" + isRoaming + ",allowRoaming=" + allowRoaming + "," + dataProfile + ",addresses=" + addresses + ",dnses=" + dnses);
                    try {
    ...
    public void sendTerminalResponse(String contents, Message result) {
        ...
        if (radioProxy != null) {
            ...
            sb.append(" contents = ");
            sb.append(Build.IS_DEBUGGABLE ? contents : censoredTerminalResponse(contents));
            riljLog(sb.toString());
            try {
    ...
    protected static int convertToHalRadioAccessFamily(int networkTypeBitmask) {
        int raf = 0;
        if ((((long) networkTypeBitmask) & 32768) != 0) {
            raf = 0 | InboundSmsTracker.DEST_PORT_FLAG_NO_PORT;
        }
    ...
    public void reportStkServiceIsRunning(Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(AbstractCallTracker.EVENT_ACCEPT_COMPLETE, result, this.mRILDefaultWorkSource);
            riljLog(rr.serialString() + "> " + requestToString(rr.mRequest));
            try {
    ...
    public void getCellInfoList(Message result, WorkSource workSource) {
        ...
        if (radioProxy != null) {
            ...
            int getCellUid = Binder.getCallingUid();
            int getCellPid = Binder.getCallingPid();
            String getCellPackage = this.mContext.getPackageManager().getNameForUid(getCellUid);
            ((IOppoNetworkManager) OppoTelephonyFactory.getInstance().getFeature(IOppoNetworkManager.DEFAULT, new Object[0])).oppoCountGetCellInfo(getCellUid, getCellPid, getCellPackage);
            riljLog("[POWERSTATE] getCell Uid: " + getCellUid + ", Pid: " + getCellPid + ", Package: " + getCellPackage);
        }
    }
    ...
    public void getImsRegistrationState(Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_APN_TYPE_CONFLICT, result, this.mRILDefaultWorkSource);
            riljLog(rr.serialString() + "> " + requestToString(rr.mRequest));
            try {
    ...
    public void sendImsGsmSms(String smscPdu, String pdu, int retry, int messageRef, Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_INVALID_PCSCF_ADDR, result, this.mRILDefaultWorkSource);
            riljLog(rr.serialString() + "> " + requestToString(rr.mRequest));
    ...
    public void iccOpenLogicalChannel(String aid, int p2, Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_EMM_ACCESS_BARRED, result, this.mRILDefaultWorkSource);
            if (Build.IS_DEBUGGABLE) {
    ...
    public void iccCloseLogicalChannel(int channel, Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_EMERGENCY_IFACE_ONLY, result, this.mRILDefaultWorkSource);
    ...
    public void iccTransmitApduLogicalChannel(int channel, int cla, int instruction, int p1, int p2, int p3, String data, Message result) {
        if (channel > 0) {
            IRadio radioProxy = getRadioProxy(result);
            if (radioProxy != null) {
                RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IFACE_MISMATCH, result, this.mRILDefaultWorkSource);
                if (Build.IS_DEBUGGABLE) {
    ...
    public void nvReadItem(int itemID, Message result, WorkSource workSource) {
        ...
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_COMPANION_IFACE_IN_USE, result, workSource2);
    ...
    public void nvWriteCdmaPrl(byte[] preferredRoamingList, Message result) {
        IRadio radioProxy = getRadioProxy(result);
        if (radioProxy != null) {
            RILRequest rr = obtainRequest(TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IFACE_AND_POL_FAMILY_MISMATCH, result, this.mRILDefaultWorkSource);
    ...
    public RadioCapability makeStaticRadioCapability() {
        int raf = 0;
        String rafString = this.mContext.getResources().getString(17039766);
        if (!TextUtils.isEmpty(rafString)) {
            raf = RadioAccessFamily.rafTypeFromString(rafString);
        }
        RadioCapability rc = new RadioCapability(this.mPhoneId.intValue(), 0, 0, raf, PhoneConfigurationManager.SSSS, 1);
        riljLog("Faking RIL_REQUEST_GET_RADIO_CAPABILITY response using " + raf);
        return rc;
    }

    /* JADX INFO: Multiple debug info for r0v10 java.lang.String: [D('hwcfgs' java.util.ArrayList<com.android.internal.telephony.HardwareConfig>), D('s' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v13 java.lang.String: [D('cinfo' com.android.internal.telephony.CallForwardInfo[]), D('s' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v16 java.lang.String: [D('cells' java.util.ArrayList<android.telephony.NeighboringCellInfo>), D('s' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v19 java.lang.String: [D('calls' java.util.ArrayList<com.android.internal.telephony.DriverCall>), D('s' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v22 java.lang.String: [D('strings' java.lang.String[]), D('s' java.lang.String)] */
    /* JADX INFO: Multiple debug info for r0v25 java.lang.String: [D('intArray' int[]), D('s' java.lang.String)] */
    @UnsupportedAppUsage
    protected static String retToString(int req, Object ret) {
        int i;
        if (ret == null || req == 11 || req == 100 || req == 115 || req == 117 || req == 38 || req == 39) {
    ...
    protected static String requestToString(int request) {
        ...
        switch (request) {
            ...
            case TelephonyProto.RilErrno.RIL_E_NETWORK_NOT_READY /*{ENCODED_INT: 61}*/:
                return "SCREEN_STATE";
            case TelephonyProto.RilErrno.RIL_E_NOT_PROVISIONED /*{ENCODED_INT: 62}*/:
            ...
            case TelephonyProto.RilErrno.RIL_E_INVALID_RESPONSE /*{ENCODED_INT: 67}*/:
            ...
            case RadioNVItems.RIL_NV_LTE_BAND_ENABLE_25 /*{ENCODED_INT: 71}*/:
                return "REQUEST_STK_HANDLE_CALL_SETUP_REQUESTED_FROM_SIM";
            case RadioNVItems.RIL_NV_LTE_BAND_ENABLE_26 /*{ENCODED_INT: 72}*/:
                return "REQUEST_EXPLICIT_CALL_TRANSFER";
            case RadioNVItems.RIL_NV_LTE_BAND_ENABLE_41 /*{ENCODED_INT: 73}*/:
                return "REQUEST_SET_PREFERRED_NETWORK_TYPE";
            case RadioNVItems.RIL_NV_LTE_SCAN_PRIORITY_25 /*{ENCODED_INT: 74}*/:
                return "REQUEST_GET_PREFERRED_NETWORK_TYPE";
            case RadioNVItems.RIL_NV_LTE_SCAN_PRIORITY_26 /*{ENCODED_INT: 75}*/:
                return "REQUEST_GET_NEIGHBORING_CELL_IDS";
            case RadioNVItems.RIL_NV_LTE_SCAN_PRIORITY_41 /*{ENCODED_INT: 76}*/:
                return "REQUEST_SET_LOCATION_UPDATES";
            case 77:
                return "RIL_REQUEST_CDMA_SET_SUBSCRIPTION_SOURCE";
            case RadioNVItems.RIL_NV_LTE_HIDDEN_BAND_PRIORITY_26 /*{ENCODED_INT: 78}*/:
                return "RIL_REQUEST_CDMA_SET_ROAMING_PREFERENCE";
            case 79:
                return "RIL_REQUEST_CDMA_QUERY_ROAMING_PREFERENCE";
            case RadioNVItems.RIL_NV_LTE_NEXT_SCAN /*{ENCODED_INT: 80}*/:
                return "RIL_REQUEST_SET_TTY_MODE";
            case 81:
                return "RIL_REQUEST_QUERY_TTY_MODE";
            case RadioNVItems.RIL_NV_LTE_BSR_MAX_TIME /*{ENCODED_INT: 82}*/:
            ...
            case AbstractCallTracker.EVENT_ACCEPT_COMPLETE:
            ...
            case PhoneSwitcher.EVENT_PRECISE_CALL_STATE_CHANGED /*{ENCODED_INT: 109}*/:
            ...
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_INVALID_PCSCF_ADDR /*{ENCODED_INT: 113}*/:
                return "RIL_REQUEST_IMS_SEND_SMS";
            case 114:
                return "RIL_REQUEST_SIM_TRANSMIT_APDU_BASIC";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_EMM_ACCESS_BARRED /*{ENCODED_INT: 115}*/:
                return "RIL_REQUEST_SIM_OPEN_CHANNEL";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_EMERGENCY_IFACE_ONLY /*{ENCODED_INT: 116}*/:
                return "RIL_REQUEST_SIM_CLOSE_CHANNEL";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IFACE_MISMATCH /*{ENCODED_INT: 117}*/:
                return "RIL_REQUEST_SIM_TRANSMIT_APDU_CHANNEL";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_COMPANION_IFACE_IN_USE /*{ENCODED_INT: 118}*/:
                return "RIL_REQUEST_NV_READ_ITEM";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IP_ADDRESS_MISMATCH /*{ENCODED_INT: 119}*/:
                return "RIL_REQUEST_NV_WRITE_ITEM";
            case TelephonyProto.TelephonyEvent.RilSetupDataCallResponse.RilDataCallFailCause.PDP_FAIL_IFACE_AND_POL_FAMILY_MISMATCH /*{ENCODED_INT: 120}*/:
                    ...
                    default:
                        switch (request) {
                            ...
                            default:
                                ...
                                try {
                                    return (String) Class.forName("com.mediatek.internal.telephony.MtkRIL").getDeclaredMethod("requestToStringEx", Integer.class).invoke(null, Integer.valueOf(request));
                                } catch (Exception e) {
                                    return "<unknown request>";
                                }
                        }
    ...
    protected static String responseToString(int request) {
        ...
        switch (request) {
            ...
            case CharacterSets.UTF_16 /*{ENCODED_INT: 1015}*/:
            ...
            default:
                switch (request) {
                    ...
                    default:
                        ...
                        try {
                            return (String) Class.forName("com.mediatek.internal.telephony.MtkRIL").getDeclaredMethod("responseToStringEx", Integer.class).invoke(null, Integer.valueOf(request));
                        } catch (Exception e) {
                            return "<unknown response>";
                        }
                }
    ...
    public void riljLog(String msg) {
        Rlog.d(RILJ_LOG_TAG, msg + " [SUB" + this.mPhoneId + "]");
    }
    ...
    public void unsljLog(int response) {
        ...
        ((IOppoNetworkManager) OppoTelephonyFactory.getInstance().getFeature(IOppoNetworkManager.DEFAULT, new Object[0])).oppoCountUnsolMsg(response);
    }
    ...
    /* JADX INFO: Multiple debug info for r0v30 int: [D('mtu' int), D('result' android.hardware.radio.V1_0.SetupDataCallResult)] */
    @VisibleForTesting
            ...
            for (String address : addresses2) {
                ...
                if (!address2.isEmpty()) {
                    try {
                        ...
                        Rlog.e(RILJ_LOG_TAG, "Unknown address: " + address2, e);
                    }
                }
            }
        }
