...
public class EuiccCard extends UiccCard {
    ...
    public void loadEidAndNotifyRegistrants() {
        getEid(new AsyncResultCallback<String>() {
            ...
            public void onException(Throwable e) {
                ...
                String unused = EuiccCard.this.mEid = PhoneConfigurationManager.SSSS;
                String unused2 = EuiccCard.this.mCardId = PhoneConfigurationManager.SSSS;
    ...
    public /* synthetic */ void lambda$authenticateServer$32$EuiccCard(String matchingId, byte[] serverSigned1, byte[] serverSignature1, byte[] euiccCiPkIdToBeUsed, byte[] serverCertificate, RequestBuilder requestBuilder) throws EuiccCardException, TagNotFoundException, InvalidAsn1DataException {
        ...
        String[] devCapsStrings = getResources().getStringArray(17236073);
    ...
    private RequestProvider newRequestProvider(ApduRequestBuilder builder) {
        return new RequestProvider(builder) {
            /* class com.android.internal.telephony.uicc.euicc.$$Lambda$EuiccCard$SiGT87lDw1xXD_7PyidTGv5wxfQ */
            ...
            public final void buildRequest(byte[] bArr, RequestBuilder requestBuilder) {
                EuiccCard.this.lambda$newRequestProvider$49$EuiccCard(this.f$1, bArr, requestBuilder);
            }
        };
    }

    public /* synthetic */ void lambda$newRequestProvider$49$EuiccCard(ApduRequestBuilder builder, byte[] selectResponse, RequestBuilder requestBuilder) throws Throwable {
