...
public class DataServiceManager extends Handler {
    ...
    private final class CellularDataServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            IDataService unused = DataServiceManager.this.mIDataService = IDataService.Stub.asInterface(service);
            DataServiceManager dataServiceManager = DataServiceManager.this;
            DataServiceManagerDeathRecipient unused2 = dataServiceManager.mDeathRecipient = new DataServiceManagerDeathRecipient();
            boolean unused3 = DataServiceManager.this.mBound = true;
            try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            String unused3 = DataServiceManager.this.mTargetBindingPackageName = null;
        }
    }
    ...
    private void bindDataService() {
        ...
        if (TextUtils.isEmpty(className)) {
            ...
            intent = new Intent("android.telephony.data.DataService").setComponent(new ComponentName(packageName, className));
        }
    ...
    private String getDataServiceClassName(int transportType) {
        ...
        if (transportType != 1) {
            if (transportType == 2) {
                className = this.mIwlanDataServiceClassName;
            } else {
                throw new IllegalStateException("Transport type not WWAN or WLAN. type=" + transportType);
            }
        }
        PersistableBundle b = this.mCarrierConfigManager.getConfigForSubId(this.mPhone.getSubId());
        if (b == null || TextUtils.isEmpty(b.getString(null))) {
            return className;
        }
        return b.getString(null, className);
    }
    ...
    public void setIwlanDataServiceClassName(String iwlanDataServiceClass) {
        ...
        this.mIwlanDataServiceClassName = iwlanDataServiceClass;
    }
}
