...
public class RadioResponse extends IRadioResponse.Stub {
    ...
    public static void responseStringArrayList(RIL ril, RadioResponseInfo responseInfo, ArrayList<String> strings) {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:15:0x0064 */
        ...
        if (rr != null) {
            ...
            if (numServiceCategories == 0) {
                ...
                while (j < configs.size()) {
                    ...
                    ret[i2 + 2] = configs.get(j).selected;
                    j++;
                    i2 += 3;
                }
            }
    ...
    public void responseCellInfoList_1_2(RadioResponseInfo responseInfo, ArrayList<android.hardware.radio.V1_2.CellInfo> cellInfo) {
        RILRequest rr = this.mRil.processResponse(responseInfo);
        if (rr != null) {
