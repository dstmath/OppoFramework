...
public interface ISub extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISub {
        ...
        static final int TRANSACTION_getOperatorNumericForData = 56;
        ...
        static final int TRANSACTION_getSubState = 54;
        ...
        static final int TRANSACTION_isUsimWithCsim = 55;
        ...
        static final int TRANSACTION_setSubState = 53;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 39:
                        ...
                        int[] _result32 = getActiveSubIdList(_arg04);
                        reply.writeNoException();
                    ...
                    case 53:
                        data.enforceInterface(DESCRIPTOR);
                        int _result38 = setSubState(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result38);
                        return true;
                    case 54:
                        data.enforceInterface(DESCRIPTOR);
                        int _result39 = getSubState(data.readInt());
                        reply.writeNoException();
                    ...
                    case 56:
                        data.enforceInterface(DESCRIPTOR);
                        String _result40 = getOperatorNumericForData(data.readInt());
                        reply.writeNoException();
            ...
            public int setSubState(int subId, int subStatus) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(53, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setSubState(subId, subStatus);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
