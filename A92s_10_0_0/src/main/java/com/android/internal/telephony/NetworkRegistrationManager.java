...
public class NetworkRegistrationManager extends Handler {
    ...
    private class NetworkServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            INetworkService unused = NetworkRegistrationManager.this.mINetworkService = INetworkService.Stub.asInterface(service);
            NetworkRegistrationManager networkRegistrationManager2 = NetworkRegistrationManager.this;
            RegManagerDeathRecipient unused2 = networkRegistrationManager2.mDeathRecipient = new RegManagerDeathRecipient(name);
            try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            String unused = NetworkRegistrationManager.this.mTargetBindingPackageName = null;
    ...
    private void bindService() {
        ...
        if (TextUtils.isEmpty(packageName)) {
            ...
            if (TextUtils.isEmpty(className)) {
                ...
                intent = new Intent("android.telephony.NetworkService").setComponent(new ComponentName(packageName, className));
            }
            ComponentName cm = this.mINetworkService;
    ...
    private String getClassName() {
        ...
        if (i != 1) {
            if (i == 2) {
                className = this.mIwlanNetworkServiceClassName;
            } else {
                throw new IllegalStateException("Transport type not WWAN or WLAN. type=" + this.mTransportType);
            }
        }
    ...
    public void setIwlanNetworkServiceClassName(String iwlanNetworkServiceClass) {
        ...
        this.mIwlanNetworkServiceClassName = iwlanNetworkServiceClass;
    }
