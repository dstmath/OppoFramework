...
public final class SmsApplication {
    ...
    private static Collection<SmsApplicationData> getApplicationCollectionInternal(Context context, int userId) {
        ...
        List<ResolveInfo> smsReceivers = packageManager.queryBroadcastReceiversAsUser(new Intent("android.provider.Telephony.SMS_DELIVER"), 786432, userId);
        ...
        for (ResolveInfo resolveInfo2 : packageManager.queryBroadcastReceiversAsUser(intent2, 786432, userId)) {
            ...
            if (!(activityInfo2 == null || !Manifest.permission.BROADCAST_WAP_PUSH.equals(activityInfo2.permission) || (smsApplicationData4 = receivers.get(activityInfo2.packageName)) == null)) {
                String unused = smsApplicationData4.mMmsReceiverClass = activityInfo2.name;
            }
        }
        for (ResolveInfo resolveInfo3 : packageManager.queryIntentServicesAsUser(new Intent(TelephonyManager.ACTION_RESPOND_VIA_MESSAGE, Uri.fromParts(SCHEME_SMSTO, "", null)), 786432, userId)) {
            ...
            if (serviceInfo != null && Manifest.permission.SEND_RESPOND_VIA_MESSAGE.equals(serviceInfo.permission)) {
                ...
                if (smsApplicationData6 != null) {
                    String unused2 = smsApplicationData6.mRespondViaMessageClass = serviceInfo.name;
                }
            }
        }
        for (ResolveInfo resolveInfo4 : packageManager.queryIntentActivitiesAsUser(new Intent(Intent.ACTION_SENDTO, Uri.fromParts(SCHEME_SMSTO, "", null)), 786432, userId)) {
            ...
            if (!(activityInfo3 == null || (smsApplicationData3 = receivers.get(activityInfo3.packageName)) == null)) {
                String unused3 = smsApplicationData3.mSendToClass = activityInfo3.name;
            }
        }
        for (ResolveInfo resolveInfo5 : packageManager.queryBroadcastReceiversAsUser(new Intent("android.provider.action.DEFAULT_SMS_PACKAGE_CHANGED"), 786432, userId)) {
            ...
            if (!(activityInfo4 == null || (smsApplicationData2 = receivers.get(activityInfo4.packageName)) == null)) {
                String unused4 = smsApplicationData2.mSmsAppChangedReceiverClass = activityInfo4.name;
            }
        }
        for (ResolveInfo resolveInfo6 : packageManager.queryBroadcastReceiversAsUser(new Intent("android.provider.action.EXTERNAL_PROVIDER_CHANGE"), 786432, userId)) {
            ...
            if (!(activityInfo5 == null || (smsApplicationData = receivers.get(activityInfo5.packageName)) == null)) {
                String unused5 = smsApplicationData.mProviderChangedReceiverClass = activityInfo5.name;
            }
        }
        Intent intent3 = new Intent("android.provider.Telephony.SIM_FULL");
        for (ResolveInfo resolveInfo7 : packageManager.queryBroadcastReceiversAsUser(intent3, 786432, userId)) {
            ...
            if (activityInfo6 != null) {
                ...
                if (smsApplicationData7 != null) {
                    intent = intent3;
                    String unused6 = smsApplicationData7.mSimFullReceiverClass = activityInfo6.name;
                } else {
                    intent = intent3;
                }
                intent3 = intent;
    ...
    public static SmsApplicationData getApplication(Context context, boolean updateIfNeeded, int userId) {
    ...
    private static void defaultSmsAppChanged(Context context) {
        ...
        OppoSmsApplication.oemAssignExclusiveSmsPermissionsToSystemApp(context, packageManager, appOps);
        String[] packagesOfPhone = packageManager.getPackagesForUid(1001);
        for (String pkgName : packagesOfPhone) {
            int[] iArr = DEFAULT_APP_EXCLUSIVE_APPOPS;
            for (int appop : iArr) {
                if (appOps.checkOp(appop, 1001, pkgName) != 0) {
                    appOps.setUidMode(appop, 1001, 0);
                }
            }
        }
        OppoSmsApplication.oemAssignExclusiveSmsPermissionsToNonSystemApp(context, packageManager, appOps);
    }
    ...
    private static void setDefaultApplicationInternal(String packageName, Context context, int userId) {
        ...
        if (packageName == null || oldPackageName == null || !packageName.equals(oldPackageName)) {
            ...
            if (applicationData != null) {
                ...
                if (oldPackageName != null && !"com.android.mms".equals(oldPackageName)) {
                    try {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.content.Intent.putExtra(java.lang.String, boolean):android.content.Intent
     arg types: [java.lang.String, int]
     candidates:
      android.content.Intent.putExtra(java.lang.String, byte):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, char):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, double):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, float):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, int):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, long):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, android.os.Bundle):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, android.os.IBinder):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, android.os.Parcelable):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, java.io.Serializable):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, java.lang.CharSequence):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, java.lang.String):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, short):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, byte[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, char[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, double[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, float[]):android.content.Intent
      ...
      android.content.Intent.putExtra(java.lang.String, java.lang.String[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, short[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, boolean[]):android.content.Intent
      android.content.Intent.putExtra(java.lang.String, boolean):android.content.Intent */
    ...
    public static void assignExclusiveSmsPermissionsToSystemAppPublic(Context context, PackageManager packageManager, AppOpsManager appOps, String packageName) {
        assignExclusiveSmsPermissionsToSystemApp(context, packageManager, appOps, packageName);
    }
    ...
    public static void setExclusiveAppopsPublic(String pkg, AppOpsManager appOpsManager, int uid, int mode) {
        setExclusiveAppops(pkg, appOpsManager, uid, mode);
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [android.content.Context, android.os.Looper, android.os.UserHandle, int]
     candidates:
    ...
    private static void replacePreferredActivity(PackageManager packageManager, ComponentName componentName, int userId, String scheme) {
        List<ResolveInfo> resolveInfoList = packageManager.queryIntentActivitiesAsUser(new Intent(Intent.ACTION_SENDTO, Uri.fromParts(scheme, "", null)), OppoBaseNotificationChannel.USER_LOCKED_OPUSH, userId);
    ...
    public static boolean shouldWriteMessageForPackage(String packageName, Context context) {
        ...
        if (!OppoSmsApplication.shouldWriteMessageForPackage(packageName)) {
            return false;
        }
