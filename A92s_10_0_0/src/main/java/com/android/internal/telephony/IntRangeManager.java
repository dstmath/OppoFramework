            ...
            while (true) {
                ...
                if (endId <= range.mEndId) {
                    ...
                    if (crLength == 1) {
                        ...
                        if (cr.mStartId == i && cr.mEndId == endId && cr.mClient.equals(obj)) {
                        ...
                        while (crIndex < crLength) {
                            ...
                            if (cr2.mStartId != i || cr2.mEndId != endId || !cr2.mClient.equals(obj)) {
                                ...
                                if (crIndex == 0) {
                                    int nextStartId = clients.get(r10).mStartId;
