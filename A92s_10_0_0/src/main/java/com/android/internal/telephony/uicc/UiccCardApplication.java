...
public class UiccCardApplication {
    ...
    protected RegistrantList mNetworkLockedRegistrants;
    @UnsupportedAppUsage
        ...
        this.mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (UiccCardApplication.this.mDestroyed) {
                    ...
                    uiccCardApplication.loge("Received message " + msg + "[" + msg.what + "] while being destroyed. Ignoring.");
                    return;
                }
                switch (msg.what) {
                    case 1:
                    ...
                    default:
                        ...
                        uiccCardApplication2.loge("Unknown Event " + msg.what);
                        return;
                }
            }
        };
    ...
    public void update(IccCardApplicationStatus as, Context c, CommandsInterface ci) {
        synchronized (this.mLock) {
            ...
            if (this.mPersoSubState != oldPersoSubState && (this.mPersoSubState == IccCardApplicationStatus.PersoSubState.PERSOSUBSTATE_SIM_NETWORK || supportExtendedMeLockCategory())) {
    ...
    /* access modifiers changed from: protected */
    public void notifyReadyRegistrantsIfNeeded(Registrant r) {
    ...
    /* access modifiers changed from: protected */
    public void notifyPinLockedRegistrantsIfNeeded(Registrant r) {
        if (!this.mDestroyed) {
    ...
    /* access modifiers changed from: protected */
    public void notifyPinLockStatus() {
    }
