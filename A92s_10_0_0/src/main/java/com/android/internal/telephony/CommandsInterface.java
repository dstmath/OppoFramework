...
public interface CommandsInterface {
    ...
    void registerForPsWifiStateChanged(Handler handler, int i, Object obj);
    ...
    void registerForSmlDeviceLockInfoChanged(Handler handler, int i, Object obj);
    ...
    void unregisterForPsWifiStateChanged(Handler handler);
    ...
    void unregisterForSmlDeviceLockInfoChanged(Handler handler);
