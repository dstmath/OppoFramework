    ...
    public void resolveSubscriptionCarrierId(String simState) {
        ...
        if (hashCode != -2044189691) {
            if (hashCode != -1830845986) {
                if (hashCode == 1924388665 && simState.equals("ABSENT")) {
                    c = 0;
                    if (c != 0 || c == 1) {
                        handleSimAbsent();
                    } else if (c == 2) {
            ...
            } else if (simState.equals("CARD_IO_ERROR")) {
                c = 1;
                if (c != 0) {
                }
                handleSimAbsent();
    ...
    private void matchSubscriptionCarrier() {
        ...
        if (maxScore == -1) {
            ...
            if (maxRule == maxRuleParent && maxRule.mParentCid != -1) {
                ...
                int unused = maxRuleParent.mCid = maxRuleParent.mParentCid;
                String unused2 = maxRuleParent.mName = getCarrierNameFromId(maxRuleParent.mCid);
            }
