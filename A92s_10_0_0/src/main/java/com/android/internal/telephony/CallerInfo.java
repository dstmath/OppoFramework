...
public class CallerInfo {
    ...
    public static CallerInfo getCallerInfo(Context context, Uri contactRef, Cursor cursor) {
        ...
        try {
            ...
            Method m = clazz.getDeclaredMethod("getCallerInfo", Context.class, Uri.class, Cursor.class);
    ...
    public static CallerInfo getCallerInfo(Context context, String number, int subId) {
        try {
            Class clazz = Class.forName(EXTENSION_CLASS_NAME);
            Method m = clazz.getDeclaredMethod("getCallerInfo", Context.class, String.class, Integer.TYPE);
            Object[] params = {context, number, Integer.valueOf(subId)};
            Rlog.d(TAG, "invoke redirect to " + clazz.getName() + "." + m.getName() + "(subId=" + subId + ")");
            return (CallerInfo) m.invoke(null, params);
        } catch (Exception e) {
            e.printStackTrace();
            Rlog.d(TAG, "getCallerInfo invoke redirect fails. Use AOSP instead.");
