...
public class RadioIndication extends IRadioIndication.Stub {
    ...
    public void radioStateChanged(int indicationType, int radioState) {
        ...
        RIL ril = this.mRil;
        ril.unsljLogMore(1000, "radioStateChanged: " + state);
    ...
    public void keepaliveStatus(int indicationType, KeepaliveStatus halStatus) {
        this.mRil.processIndication(indicationType);
        RIL ril = this.mRil;
        ril.unsljLogRet(1050, "handle=" + halStatus.sessionHandle + " code=" + halStatus.code);
        this.mRil.mNattKeepaliveStatusRegistrants.notifyRegistrants(new AsyncResult((Object) null, new com.android.internal.telephony.dataconnection.KeepaliveStatus(halStatus.sessionHandle, halStatus.code), (Throwable) null));
    }
    ...
    private int convertConnectionStatusFromCellConnectionStatus(int status) {
        ...
        return com.android.internal.telephony.dataconnection.KeepaliveStatus.INVALID_HANDLE;
    }
