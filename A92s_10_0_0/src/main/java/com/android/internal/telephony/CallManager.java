        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 106:
                    ...
                    return;
                case CallManager.EVENT_IN_CALL_VOICE_PRIVACY_OFF /*{ENCODED_INT: 107}*/:
                    CallManager.this.mInCallVoicePrivacyOffRegistrants.notifyRegistrants((AsyncResult) msg.obj);
                    return;
                case CallManager.EVENT_CALL_WAITING /*{ENCODED_INT: 108}*/:
                ...
                case 109:
                    ...
                    return;
                case CallManager.EVENT_SIGNAL_INFO /*{ENCODED_INT: 110}*/:
