    ...
    public void handleMessage(Message msg) {
        ...
        if (i == 1) {
            ...
            if (ar2.exception != null || ar2.result == null) {
                ...
                sb.append(" due to ");
                String errorMsg2 = sb.toString();
                if (ar2.exception instanceof CommandException) {
                    errorMsg = errorMsg2 + "error code : " + ((CommandException) ar2.exception).getCommandError();
                } else {
                    errorMsg = errorMsg2 + "unknown exception : " + ar2.exception.getMessage();
                }
                if (this.mAIDInUse == 0) {
