...
public class PhoneConfigurationManager {
    ...
    public PhoneCapability mStaticCapability = getDefaultCapability();
    ...
    private final class MainThreadHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1 || i == 5) {
                ...
                PhoneCapability unused = PhoneConfigurationManager.this.mStaticCapability = (PhoneCapability) ar4.result;
    ...
    /* access modifiers changed from: private */
    public void setMultiSimProperties(int numOfSims) {
