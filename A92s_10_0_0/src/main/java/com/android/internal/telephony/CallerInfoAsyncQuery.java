...
public class CallerInfoAsyncQuery {
    ...
    public class CallerInfoAsyncQueryHandler extends AsyncQueryHandler {
        ...
        protected class CallerInfoWorkerHandler extends AsyncQueryHandler.WorkerHandler {
            ...
            @Override // android.os.Handler, android.content.AsyncQueryHandler.WorkerHandler
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, Uri contactRef, OnQueryCompleteListener listener, Object cookie) {
        try {
            ...
            Method m = clazz.getDeclaredMethod("startQuery", Integer.TYPE, Context.class, Uri.class, OnQueryCompleteListener.class, Object.class);
            Object[] params = {Integer.valueOf(token), context, contactRef, listener, cookie};
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, String number, OnQueryCompleteListener listener, Object cookie, int subId) {
        try {
            Class clazz = Class.forName(EXTENSION_CLASS_NAME);
            Method m = clazz.getDeclaredMethod("startQuery", Integer.TYPE, Context.class, String.class, OnQueryCompleteListener.class, Object.class, Integer.TYPE);
            Object[] params = {Integer.valueOf(token), context, number, listener, cookie, Integer.valueOf(subId)};
            Rlog.d(LOG_TAG, "invoke redirect to " + clazz.getName() + "." + m.getName() + "(subId=" + subId + ")");
            return (CallerInfoAsyncQuery) m.invoke(null, params);
        } catch (Exception e) {
            e.printStackTrace();
            Rlog.d(LOG_TAG, "startQuery invoke redirect fails. Use AOSP instead.");
    ...
    public void release() {
        ...
        callerInfoAsyncQueryHandler.mContext = null;
        callerInfoAsyncQueryHandler.mQueryUri = null;
        callerInfoAsyncQueryHandler.mCallerInfo = null;
        this.mHandler = null;
    }
