...
public class ImsPhone extends ImsPhoneBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.telephony.imsphone.ImsPhone.<init>(android.content.Context, com.android.internal.telephony.PhoneNotifier, com.android.internal.telephony.Phone, boolean):void
     arg types: [android.content.Context, com.android.internal.telephony.PhoneNotifier, com.android.internal.telephony.Phone, int]
     candidates:
      com.android.internal.telephony.imsphone.ImsPhone.<init>(java.lang.String, android.content.Context, com.android.internal.telephony.PhoneNotifier, boolean):void
      com.android.internal.telephony.imsphone.ImsPhone.<init>(android.content.Context, com.android.internal.telephony.PhoneNotifier, com.android.internal.telephony.Phone, boolean):void */
    ...
    private void processWfcDisconnectForNotification(ImsReasonInfo imsReasonInfo) {
        ...
        if (wfcOperatorErrorCodes != null) {
            String[] wfcOperatorErrorAlertMessages = this.mContext.getResources().getStringArray(17236127);
            String[] wfcOperatorErrorNotificationMessages = this.mContext.getResources().getStringArray(17236128);
            int i = 0;
