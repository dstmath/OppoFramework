...
public class CarrierServicesSmsFilter {
    ...
    public static final int FILTER_COMPLETE_TIMEOUT_MS = 30000;
    /* access modifiers changed from: private */
    public final CallbackTimeoutHandler mCallbackTimeoutHandler = new CallbackTimeoutHandler();
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public FilterAggregator mFilterAggregator;
    /* access modifiers changed from: private */
    ...
    public CarrierServicesSmsFilter(Context context, Phone phone, byte[][] pdus, int destPort, String pduFormat, CarrierServicesSmsFilterCallbackInterface carrierServicesSmsFilterCallback, String logTag, LocalLog localLog) {
        ...
        try {
            DBG = "true".equalsIgnoreCase(SystemProperties.get("persist.sys.assert.panic", "false"));
        } catch (Exception e) {
            DBG = true;
        }
    }
    ...
    public boolean filter() {
        return oemFilter(null);
    }

    public boolean oemFilter(String number) {
        ...
        AbstractInboundSmsHandler.romFilter(number, this.mContext, smsFilterPackages);
        ...
        callbackTimeoutHandler.sendMessageDelayed(callbackTimeoutHandler.obtainMessage(1), 30000);
    ...
    private final class CarrierSmsFilter extends CarrierMessagingServiceManager {
        ...
        public void filterSms(String carrierPackageName, CarrierSmsFilterCallback smsFilterCallback) {
            if (CarrierServicesSmsFilter.DBG) {
                CarrierServicesSmsFilter carrierServicesSmsFilter = CarrierServicesSmsFilter.this;
                carrierServicesSmsFilter.log("filterSms-carrierPackageName=" + carrierPackageName);
            }
    ...
    public final class FilterAggregator {
        /* access modifiers changed from: private */
        public final Set<CarrierSmsFilterCallback> mCallbacks;
        ...
        public void onFilterComplete(int result) {
            synchronized (this.mFilterLock) {
                ...
                combine(result);
                if (CarrierServicesSmsFilter.DBG) {
                    CarrierServicesSmsFilter.this.log("onFilterComplete, mNumPendingFilters=" + this.mNumPendingFilters + " mFilterResult=" + this.mFilterResult);
                }
        ...
        /* access modifiers changed from: private */
        public void addToCallbacks(CarrierSmsFilterCallback callback) {
    ...
    public final class CallbackTimeoutHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                CarrierServicesSmsFilter.this.mLocalLog.log("CarrierServicesSmsFilter: onFilterComplete timeout: not called before 30000 milliseconds.");
