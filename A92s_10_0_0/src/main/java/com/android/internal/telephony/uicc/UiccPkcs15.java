...
public class UiccPkcs15 extends Handler {
    ...
    private class FileHandler extends Handler {
        ...
        private void readBinary() {
            if (UiccPkcs15.this.mChannelId >= 0) {
                UiccPkcs15.this.mUiccProfile.iccTransmitApduLogicalChannel(UiccPkcs15.this.mChannelId, 0, PduHeaders.ADDITIONAL_HEADERS, 0, 0, 0, PhoneConfigurationManager.SSSS, obtainMessage(102));
            } else {
                UiccPkcs15.log("EF based");
            }
        }
    ...
    private class Pkcs15Selector extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (ar.exception != null || ar.result == null) {
                ...
                int unused = UiccPkcs15.this.mChannelId = ((int[]) ar.result)[0];
