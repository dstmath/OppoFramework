...
public class GsmAlphabet {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.telephony.GsmAlphabet.countGsmSeptets(char, boolean):int
     arg types: [char, int]
     candidates:
      com.android.internal.telephony.GsmAlphabet.countGsmSeptets(java.lang.CharSequence, boolean):com.android.internal.telephony.GsmAlphabet$TextEncodingDetails
      com.android.internal.telephony.GsmAlphabet.countGsmSeptets(char, boolean):int */
