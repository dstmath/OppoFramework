...
public class TelephonyNetworkFactory extends NetworkFactory {
    ...
    /* access modifiers changed from: private */
    public void onDataHandoverNeeded(int apnType, int targetTransport, TransportManager.HandoverParams handoverParams) {
    ...
    /* access modifiers changed from: private */
    public void onDataHandoverSetupCompleted(NetworkRequest networkRequest, boolean success, int targetTransport, TransportManager.HandoverParams handoverParams) {
        int originTransport;
