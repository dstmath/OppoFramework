...
public interface RILConstants {
    ...
    public static final int PREFERRED_NETWORK_MODE_NON_DDS;
    ...
    public static final int RIL_UNSOL_OEM_KEY_LOG_ERROR_MSG = 1054;
    public static final int RIL_UNSOL_OEM_LTE_CPHY_CA = 1053;
    ...
    static {
        int i = 0;
        if (WifiEnterpriseConfig.ENGINE_ENABLE.equals(SystemProperties.get("ro.boot.opt_c2k_support"))) {
            i = 7;
        }
        PREFERRED_NETWORK_MODE_NON_DDS = i;
    }
}
