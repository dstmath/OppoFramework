...
public class EuiccConnector extends StateMachine implements ServiceConnection {
    ...
    public void getEuiccProfileInfoList(int cardId, GetEuiccProfileInfoListCommandCallback callback) {
        sendMessage(103, cardId, 0, callback);
    }
    ...
    public void getDefaultDownloadableSubscriptionList(int cardId, boolean forceDeactivateSim, GetDefaultListCommandCallback callback) {
        ...
        request.mForceDeactivateSim = forceDeactivateSim;
        request.mCallback = callback;
        sendMessage(CMD_GET_DEFAULT_DOWNLOADABLE_SUBSCRIPTION_LIST, cardId, 0, request);
    }

    @VisibleForTesting(visibility = VisibleForTesting.Visibility.PACKAGE)
    public void getEuiccInfo(int cardId, GetEuiccInfoCommandCallback callback) {
        sendMessage(CMD_GET_EUICC_INFO, cardId, 0, callback);
    }
    ...
    public void updateSubscriptionNickname(int cardId, String iccid, String nickname, UpdateNicknameCommandCallback callback) {
        ...
        request.mCallback = callback;
        sendMessage(CMD_UPDATE_SUBSCRIPTION_NICKNAME, cardId, 0, request);
    }
    ...
    private class UnavailableState extends State {
        ...
        public boolean processMessage(Message message) {
            if (message.what == 1) {
                ...
                ServiceInfo unused = euiccConnector.mSelectedComponent = euiccConnector.findBestComponent();
                ...
                try {
                    switch (message.what) {
                        ...
                        case 103:
                            ...
                            break;
                        case EuiccConnector.CMD_GET_DEFAULT_DOWNLOADABLE_SUBSCRIPTION_LIST /*{ENCODED_INT: 104}*/:
                            ...
                            break;
                        case EuiccConnector.CMD_GET_EUICC_INFO /*{ENCODED_INT: 105}*/:
                        ...
                        case 106:
                            ...
                            break;
                        case EuiccConnector.CMD_SWITCH_TO_SUBSCRIPTION /*{ENCODED_INT: 107}*/:
                            ...
                            break;
                        case EuiccConnector.CMD_UPDATE_SUBSCRIPTION_NICKNAME /*{ENCODED_INT: 108}*/:
                        ...
                        case 109:
                            ...
                            break;
                        case EuiccConnector.CMD_RETAIN_SUBSCRIPTIONS /*{ENCODED_INT: 110}*/:
    ...
    public static BaseEuiccCommandCallback getCallback(Message message) {
        switch (message.what) {
            case 100:
            case 103:
            case CMD_GET_EUICC_INFO /*{ENCODED_INT: 105}*/:
            case 109:
            case CMD_RETAIN_SUBSCRIPTIONS /*{ENCODED_INT: 110}*/:
            case 111:
            case 112:
            ...
            case CMD_GET_DEFAULT_DOWNLOADABLE_SUBSCRIPTION_LIST /*{ENCODED_INT: 104}*/:
                return ((GetDefaultListRequest) message.obj).mCallback;
            case 106:
                return ((DeleteRequest) message.obj).mCallback;
            case CMD_SWITCH_TO_SUBSCRIPTION /*{ENCODED_INT: 107}*/:
                return ((SwitchRequest) message.obj).mCallback;
            case CMD_UPDATE_SUBSCRIPTION_NICKNAME /*{ENCODED_INT: 108}*/:
    ...
    /* access modifiers changed from: private */
    public int getSlotIdFromCardId(int cardId) {
