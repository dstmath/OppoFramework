...
public class SmsMessage extends SmsMessageBase {
    ...
    public static SubmitPdu getSubmitPdu(String scAddress, String destinationAddress, String message, boolean statusReportRequested, byte[] header, int encoding, int languageTable, int languageShiftTable, int validityPeriod) {
        ...
        if (encoding2 == 1) {
            if ((userData[0] & 255) > 160) {
                Rlog.e(LOG_TAG, "Message too long (" + ((int) (userData[0] & 255)) + " septets)");
                return null;
            }
            bo.write(0);
        } else if ((userData[0] & 255) > 140) {
            Rlog.e(LOG_TAG, "Message too long (" + ((int) (userData[0] & 255)) + " bytes)");
            return null;
        } else {
            bo.write(8);
        }
    ...
    public static SubmitPdu getSubmitPdu(String scAddress, String destinationAddress, int destinationPort, byte[] data, boolean statusReportRequested) {
        SubmitPdu retOem = OppoSmsMessage.oemGetSubmitPdu(scAddress, destinationAddress, destinationPort, data, statusReportRequested);
        if (retOem != null) {
            return retOem;
        }
    ...
    public static ByteArrayOutputStream getSubmitPduHeadPublic(String scAddress, String destinationAddress, byte mtiByte, boolean statusReportRequested, SubmitPdu ret) {
    ...
    protected static class PduParser {
        ...
        public String getUserDataOem8bit(int byteCount) {
            String ret = OppoSmsMessage.getUserDataOem8bit(this.mUserData, this.mPdu, this.mCur, byteCount);
            if (ret == null) {
                return null;
            }
            this.mCur += byteCount;
    ...
    public static GsmAlphabet.TextEncodingDetails calculateLengthOem(CharSequence msgBody, boolean use7bitOnly, int encodingType) {
        return OppoSmsMessage.calculateLengthOem(msgBody, use7bitOnly, encodingType);
    }
    ...
    /* access modifiers changed from: protected */
    public void parseSmsSubmit(PduParser p, int firstByte) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:115:0x0246, code lost:
        if (r17.mMessageBody != null) goto L_0x027b;
     */
    ...
    protected static SmsHeader makeSmsHeader() {
        try {
            SmsHeader header = (SmsHeader) Class.forName("com.mediatek.internal.telephony.MtkSmsHeader").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
