...
public class SmsMessage extends SmsMessageBase {
    ...
    public static final int PRIORITY_EMERGENCY_PUBLIC = 3;
    private static final int PRIORITY_INTERACTIVE = 1;
    public static final int PRIORITY_INTERACTIVE_PUBLIC = 1;
    private static final int PRIORITY_NORMAL = 0;
    public static final int PRIORITY_NORMAL_PUBLIC = 0;
    private static final int PRIORITY_URGENT = 2;
    public static final int PRIORITY_URGENT_PUBLIC = 2;
    private static final int RETURN_ACK = 1;
    public static final int RETURN_ACK_PUBLIC = 1;
    private static final int RETURN_NO_ACK = 0;
    public static final int RETURN_NO_ACK_PUBLIC = 0;
    ...
    public boolean isStatusReportMessage() {
        BearerData bearerData = this.mBearerData;
        return bearerData != null && bearerData.messageType == 4;
    }
    ...
    public static GsmAlphabet.TextEncodingDetails calculateLengthOem(CharSequence messageBody, boolean use7bitOnly, boolean isEntireMsg, int encodingType) {
        return OppoSmsMessage.calculateLengthOem(messageBody, use7bitOnly, isEntireMsg, encodingType);
    }
    ...
    public void parseSms() {
        ...
        BearerData bearerData = this.mBearerData;
        if (bearerData != null) {
            this.mMessageRef = bearerData.messageId;
    ...
    public void decodeSmsDisplayAddress(SmsAddress addr) {
    ...
    public SmsConstants.MessageClass getMessageClass() {
        BearerData bearerData = this.mBearerData;
        if (bearerData == null || bearerData.displayMode != 0) {
    ...
    public int getNumOfVoicemails() {
        BearerData bearerData = this.mBearerData;
        if (bearerData != null) {
            return bearerData.numberOfMessages;
        }
        return 0;
    }
    ...
    public ArrayList<CdmaSmsCbProgramData> getSmsCbProgramData() {
        BearerData bearerData = this.mBearerData;
        if (bearerData != null) {
            return bearerData.serviceCategoryProgramData;
        }
        return null;
    }
    ...
    public BearerData onDecodeBroadcastSms() {
        return BearerData.decode(this.mEnvelope.bearerData, this.mEnvelope.serviceCategory);
    }
}
