...
public class ImsPhoneConnection extends Connection implements ImsVideoCallProviderWrapper.ImsVideoProviderWrapperCallback {
    ...
    public ImsPhoneConnection(Phone phone, ImsCall imsCall, ImsPhoneCallTracker ct, ImsPhoneCall parent, boolean isUnknown) {
        ...
        if (phone.getContext().getResources().getBoolean(17891569)) {
    ...
    /* access modifiers changed from: protected */
    public void fetchDtmfToneDelay(Phone phone) {
    ...
    public boolean updateMediaCapabilities(ImsCall imsCall) {
        ...
        try {
            ...
            if (remoteCallProfile != null) {
                capabilities = applyVideoRingtoneCapabilities(remoteCallProfile, applyRemoteCallCapabilities(remoteCallProfile, capabilities));
            }
    ...
    /* access modifiers changed from: protected */
    public int getAudioQualityFromCallProfile(ImsCallProfile localCallProfile, ImsCallProfile remoteCallProfile) {
    ...
    public int calNumberPresentation(ImsCallProfile callProfile) {
        return ImsCallProfile.OIRToPresentation(callProfile.getCallExtraInt("oir"));
    }

    /* access modifiers changed from: protected */
    public boolean needUpdateAddress(String address) {
        return !equalsBaseDialString(this.mAddress, address);
    }
