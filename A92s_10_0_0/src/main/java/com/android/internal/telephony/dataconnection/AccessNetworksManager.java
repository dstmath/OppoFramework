...
public class AccessNetworksManager extends Handler {
    ...
    public static final int[] SUPPORTED_APN_TYPES = {17, 2, 32, 64, 128, 4, 512};
    ...
    private final class QualifiedNetworksServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            IQualifiedNetworksService unused = AccessNetworksManager.this.mIQualifiedNetworksService = IQualifiedNetworksService.Stub.asInterface(service);
            AccessNetworksManager accessNetworksManager = AccessNetworksManager.this;
            AccessNetworksManagerDeathRecipient unused2 = accessNetworksManager.mDeathRecipient = new AccessNetworksManagerDeathRecipient();
            try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            String unused = AccessNetworksManager.this.mTargetBindingPackageName = null;
        }
    }
    ...
    public final class QualifiedNetworksServiceCallback extends IQualifiedNetworksServiceCallback.Stub {
        ...
        public void onQualifiedNetworkTypesChanged(int apnTypes, int[] qualifiedNetworkTypes) {
            ...
            int[] access$800 = AccessNetworksManager.SUPPORTED_APN_TYPES;
            for (int supportedApnType : access$800) {
    ...
    private void bindQualifiedNetworksService() {
        ...
        if (TextUtils.isEmpty(packageName)) {
            ...
            if (TextUtils.isEmpty(className)) {
                ...
                intent = new Intent("android.telephony.data.QualifiedNetworksService").setComponent(new ComponentName(packageName, className));
            }
            ComponentName cm = this.mIQualifiedNetworksService;
            if (cm != null && cm.asBinder().isBinderAlive()) {
                try {
    ...
    private String getQualifiedNetworksServiceClassName() {
        if (this.mCarrierConfigManager.getConfigForSubId(this.mPhone.getSubId()) == null || TextUtils.isEmpty(null)) {
            return null;
        }
        return null;
    }
