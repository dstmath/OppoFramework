...
public class GsmMmiCode extends Handler implements MmiCode {
    ...
    protected static boolean isTwoDigitShortCode(Context context, String dialString) {
        ...
        if (dialString == 0 || dialString.length() > 2) {
            return false;
        }
        if (sTwoDigitNumberPattern == null) {
            sTwoDigitNumberPattern = context.getResources().getStringArray(17236086);
        }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String}
     arg types: [java.lang.String, android.text.TextDirectionHeuristic, int]
     candidates:
      ClspMth{android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence}
      ClspMth{android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String} */
    /* access modifiers changed from: protected */
