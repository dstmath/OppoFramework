...
public class DataConnection extends StateMachine {
    ...
    public void notifyDisconnectCompleted(DisconnectParams dp, boolean sendAll) {
        ...
        if (sendAll) {
            if (reason == null) {
                reason = DataFailCause.toString((int) InboundSmsTracker.DEST_PORT_FLAG_NO_PORT);
            }
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case InboundSmsTracker.DEST_PORT_FLAG_3GPP2:
                    ...
                    break;
                case DataConnection.EVENT_DISCONNECT /*{ENCODED_INT: 262148}*/:
                case DataConnection.EVENT_DISCONNECT_ALL /*{ENCODED_INT: 262150}*/:
                case DataConnection.EVENT_REEVALUATE_RESTRICTED_STATE /*{ENCODED_INT: 262169}*/:
                    ...
                    break;
                case DataConnection.EVENT_TEAR_DOWN_NOW /*{ENCODED_INT: 262152}*/:
                    ...
                    break;
                case DataConnection.EVENT_LOST_CONNECTION /*{ENCODED_INT: 262153}*/:
                    ...
                    break;
                case DataConnection.EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED /*{ENCODED_INT: 262155}*/:
                    ...
                    break;
                case DataConnection.EVENT_DATA_CONNECTION_ROAM_ON /*{ENCODED_INT: 262156}*/:
                case DataConnection.EVENT_DATA_CONNECTION_ROAM_OFF /*{ENCODED_INT: 262157}*/:
                case DataConnection.EVENT_DATA_CONNECTION_OVERRIDE_CHANGED /*{ENCODED_INT: 262161}*/:
                    DataConnection.this.updateNetworkInfo();
                    if (DataConnection.this.mNetworkAgent != null) {
                        DataConnection.this.mNetworkAgent.sendNetworkCapabilities(DataConnection.this.getNetworkCapabilities(), DataConnection.this);
                        DataConnection.this.mNetworkAgent.sendNetworkInfo(DataConnection.this.mNetworkInfo, DataConnection.this);
                    ...
                    break;
                case DataConnection.EVENT_KEEPALIVE_START_REQUEST /*{ENCODED_INT: 262165}*/:
                case DataConnection.EVENT_KEEPALIVE_STOP_REQUEST /*{ENCODED_INT: 262166}*/:
                    if (DataConnection.this.mNetworkAgent != null) {
                        DataConnection.this.mNetworkAgent.onSocketKeepaliveEvent(msg.arg1, -20);
                        break;
                    }
                    break;
                case DataConnection.EVENT_RESET /*{ENCODED_INT: 262168}*/:
            ...
            switch (msg.what) {
                case InboundSmsTracker.DEST_PORT_FLAG_3GPP2:
                    ...
                    if (DataConnection.this.mSubId == -1) {
                        int unused = DataConnection.this.mSubId = cp.mSubId;
                    }
                    DataConnection dataConnection3 = DataConnection.this;
    ...
    protected class DcActiveState extends State {
        ...
        /* JADX INFO: Multiple debug info for r0v48 int: [D('ar' android.os.AsyncResult), D('slotId' int)] */
        public boolean processMessage(Message msg) {
            switch (msg.what) {
                case InboundSmsTracker.DEST_PORT_FLAG_3GPP2:
                    ConnectionParams cp = (ConnectionParams) msg.obj;
                    ...
                    return true;
                case DataConnection.EVENT_SETUP_DATA_CONNECTION_DONE /*{ENCODED_INT: 262145}*/:
                case 262146:
                case DataConnection.EVENT_DEACTIVATE_DONE /*{ENCODED_INT: 262147}*/:
                case DataConnection.EVENT_RIL_CONNECTED /*{ENCODED_INT: 262149}*/:
                case DataConnection.EVENT_DATA_STATE_CHANGED /*{ENCODED_INT: 262151}*/:
                case DataConnection.EVENT_TEAR_DOWN_NOW /*{ENCODED_INT: 262152}*/:
                case 262154:
                case DataConnection.EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED /*{ENCODED_INT: 262155}*/:
                case DataConnection.EVENT_RESET /*{ENCODED_INT: 262168}*/:
                ...
                case DataConnection.EVENT_DATA_CONNECTION_OVERRIDE_CHANGED /*{ENCODED_INT: 262161}*/:
                    ...
                    return true;
                case DataConnection.EVENT_BW_REFRESH_RESPONSE /*{ENCODED_INT: 262158}*/:
                    ...
                    return true;
                case DataConnection.EVENT_DATA_CONNECTION_VOICE_CALL_STARTED /*{ENCODED_INT: 262159}*/:
                case DataConnection.EVENT_DATA_CONNECTION_VOICE_CALL_ENDED /*{ENCODED_INT: 262160}*/:
                    DataConnection.this.updateNetworkInfo();
                    DataConnection.this.updateNetworkInfoSuspendState();
                    if (DataConnection.this.mNetworkAgent != null) {
                        DataConnection.this.mNetworkAgent.sendNetworkCapabilities(DataConnection.this.getNetworkCapabilities(), DataConnection.this);
                    ...
                    return true;
                case DataConnection.EVENT_KEEPALIVE_STATUS /*{ENCODED_INT: 262162}*/:
                    ...
                    return true;
                case DataConnection.EVENT_KEEPALIVE_STARTED /*{ENCODED_INT: 262163}*/:
                    ...
                    return true;
                case DataConnection.EVENT_KEEPALIVE_STOPPED /*{ENCODED_INT: 262164}*/:
                ...
                case DataConnection.EVENT_KEEPALIVE_STOP_REQUEST /*{ENCODED_INT: 262166}*/:
                    ...
                    return true;
                case DataConnection.EVENT_LINK_CAPACITY_CHANGED /*{ENCODED_INT: 262167}*/:
                ...
                case DataConnection.EVENT_REEVALUATE_RESTRICTED_STATE /*{ENCODED_INT: 262169}*/:
                    ...
                    return true;
                case DataConnection.EVENT_REEVALUATE_DATA_CONNECTION_PROPERTIES /*{ENCODED_INT: 262170}*/:
