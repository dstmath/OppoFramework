...
public class PhoneConstants {
    ...
    public static final String CFU_QUERY_TYPE_DEF_VALUE;
    ...
    static {
        ...
        if (!SystemProperties.get("persist.sys.nw_lab_test", str).equals(WifiEnterpriseConfig.ENGINE_ENABLE)) {
            str = WifiEnterpriseConfig.ENGINE_ENABLE;
        }
        CFU_QUERY_TYPE_DEF_VALUE = str;
    }
}
