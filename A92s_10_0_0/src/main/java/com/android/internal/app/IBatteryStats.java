            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 28:
                        ...
                        noteChangeWakelockFromSource(_arg02, _arg17, _arg23, _arg3, _arg4, _arg5, data.readInt(), data.readString(), data.readString(), data.readInt(), data.readInt() != 0);
                        reply.writeNoException();
                        return true;
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 31:
                        ...
                        noteLongPartialWakelockStartFromSource(_arg022, _arg18, _arg2);
                        reply.writeNoException();
                        return true;
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 33:
                        ...
                        noteLongPartialWakelockFinishFromSource(_arg023, _arg19, _arg22);
                        reply.writeNoException();
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 48:
                        ...
                        notePhoneDataConnectionState(_arg024, _arg16);
                        reply.writeNoException();
                        return true;
                    case 49:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 56:
                        ...
                        noteWifiSupplicantStateChanged(_arg025, _arg15);
                        reply.writeNoException();
                        return true;
                    case 57:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 77:
                        ...
                        noteBleScanStarted(_arg015, _arg14);
                        reply.writeNoException();
                        return true;
                    case 78:
                        data.enforceInterface(DESCRIPTOR);
