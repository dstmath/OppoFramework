...
public class ChooserActivity extends ResolverActivity {
    ...
    @Override // com.android.internal.app.ResolverActivity, com.android.internal.app.ColorBaseResolverActivity, android.app.Activity
    public void onCreate(Bundle savedInstanceState) {
        ...
        Parcelable bundle = intent.getParcelableExtra(ActivityTaskManager.EXTRA_OPTIONS);
    ...
    private void loadFileUriIntoView(Uri uri, View parent) {
        ...
        ((TextView) parent.findViewById(R.id.content_preview_filename)).setText(fileInfo.name);
    ...
    @Override // com.android.internal.app.ResolverActivity, com.android.internal.app.ColorBaseResolverActivity
    ...
    public void startSelected(int which, boolean always, boolean filtered) {
        ResolverActivity.TargetInfo targetInfo = null;
        ChooserListAdapter chooserListAdapter = this.mChooserListAdapter;
        if (chooserListAdapter != null) {
            targetInfo = chooserListAdapter.targetInfoForPosition(which, filtered);
        ...
        ChooserListAdapter chooserListAdapter2 = this.mChooserListAdapter;
        if (chooserListAdapter2 != null) {
            ...
            int positionTargetType = chooserListAdapter2.getPositionTargetType(which);
    ...
    public ResolverActivity.ResolveListAdapter createAdapter(Context context, List<Intent> payloadIntents, Intent[] initialIntents, List<ResolveInfo> rList, int launchedFromUid, boolean filterLastUsed) {
        if (this.iColorResolverManager == null) {
        ...
        return this.iColorResolverManager.createAdapter(this, payloadIntents, initialIntents, rList, launchedFromUid, filterLastUsed, createListController());
    }
    ...
    public class ChooserListAdapter extends ResolverActivity.ResolveListAdapter {
        ...
        public void notifyDataSetChanged() {
            if (!ChooserActivity.this.mListViewDataChanged) {
                ...
                boolean unused = ChooserActivity.this.mListViewDataChanged = true;
            }
        }
        ...
        public void refreshListView() {
            ...
            boolean unused = ChooserActivity.this.mListViewDataChanged = false;
        }
    ...
    public class ChooserRowAdapter extends BaseAdapter {
        ...
        /* JADX INFO: Multiple debug info for r0v0 int: [D('count' int), D('countSum' int)] */
