...
public class AlertController extends ColorBaseAlertController {
    ...
    public static final AlertController create(Context context, DialogInterface di, Window window) {
        ...
        a.recycle();
        return controllerType != 1 ? ((IColorAlertControllerEuclidManager) OppoFeatureCache.getOrCreate(IColorAlertControllerEuclidManager.DEFAULT, new Object[0])).getAlertController(context, di, window) : new MicroAlertController(context, di, window);
    }
    ...
    private void setupView() {
        ...
        if (!hasCustomPanel) {
            ...
            if (content != null) {
                ...
                content.setScrollIndicators((hasTopPanel2 ? 1 : 0) | (hasButtonPanel ? 2 : 0), 3);
            } else {
                hasTopPanel = hasTopPanel2;
            }
        } else {
    ...
    public static class AlertParams extends ColorBaseAlertController.BaseAlertParams {
        @UnsupportedAppUsage
        public ListAdapter mAdapter;
        @UnsupportedAppUsage
        ...
        @Override // com.android.internal.app.ColorBaseAlertController.BaseAlertParams
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (needHookAdapter(this.mIsSingleChoice, this.mIsMultiChoice, this.mSummaries)) {
                adapter = getHookAdapter(this.mContext, this.mTitle, this.mMessage, this.mItems, this.mSummaries);
            ...
            ListAdapter unused = dialog.mAdapter = adapter;
            ...
            ((IColorAlertControllerEuclidManager) OppoFeatureCache.getOrCreate(IColorAlertControllerEuclidManager.DEFAULT, new Object[0])).setListStyle(listView, this.mIsSingleChoice, this.mIsMultiChoice);
    ...
    private static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View target = ((IColorAlertControllerEuclidManager) OppoFeatureCache.getOrCreate(IColorAlertControllerEuclidManager.DEFAULT, new Object[0])).getConvertView(superConvertView, position, getCount());
            return target == null ? superConvertView : target;
        }
    }

    @Override // com.android.internal.app.ColorBaseAlertController
    ...
    /* access modifiers changed from: protected */
    @Override // com.android.internal.app.ColorBaseAlertController
    public void setupViewWrapper() {
        setupView();
    }

    /* access modifiers changed from: protected */
    @Override // com.android.internal.app.ColorBaseAlertController
    public int selectContentViewWrapper() {
