...
public abstract class AbstractMultiplePendingRequestsRemoteService<S extends AbstractMultiplePendingRequestsRemoteService<S, I>, I extends IInterface> extends AbstractRemoteService<S, I> {
    ...
    public void dump(String prefix, PrintWriter pw) {
        ...
        pw.append((CharSequence) prefix).append((CharSequence) "initialCapacity=").append((CharSequence) String.valueOf(this.mInitialCapacity)).println();
        ArrayList<AbstractRemoteService.BasePendingRequest<S, I>> arrayList = this.mPendingRequests;
        pw.append((CharSequence) prefix).append((CharSequence) "pendingRequests=").append((CharSequence) String.valueOf(arrayList == null ? 0 : arrayList.size())).println();
    }
