...
public interface ITelecomService extends IInterface {
    ...
    String colorInteractWithTelecomService(int i, String str) throws RemoteException;
    ...
    void oppoCancelMissedCallsNotification(String str, Bundle bundle) throws RemoteException;
    ...
    public static class Default implements ITelecomService {
        ...
        @Override // com.android.internal.telecom.ITelecomService
        public String colorInteractWithTelecomService(int command, String ext) throws RemoteException {
            return null;
        }
        ...
        @Override // com.android.internal.telecom.ITelecomService
        public void oppoCancelMissedCallsNotification(String callingPackage, Bundle extras) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements ITelecomService {
        ...
        static final int TRANSACTION_addNewOutgoingCall = 58;
        ...
        static final int TRANSACTION_colorInteractWithTelecomService = 57;
        ...
        static final int TRANSACTION_oppoCancelMissedCallsNotification = 59;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 57:
                    return "colorInteractWithTelecomService";
                case 58:
                    return "addNewOutgoingCall";
                case 59:
                    return "oppoCancelMissedCallsNotification";
                default:
                    return null;
            }
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        showInCallScreen(_arg019, data.readString());
                    ...
                    case 5:
                        ...
                        List<PhoneAccountHandle> _result3 = getCallCapablePhoneAccounts(_arg020, data.readString());
                        reply.writeNoException();
                    ...
                    case 42:
                        ...
                        boolean enablePhoneAccount = enablePhoneAccount(_arg013, _arg16);
                        reply.writeNoException();
                    ...
                    case 54:
                        ...
                        addOrRemoveTestCallCompanionApp(_arg021, _arg15);
                        reply.writeNoException();
                        return true;
                    case 55:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 57:
                        data.enforceInterface(DESCRIPTOR);
                        String _result23 = colorInteractWithTelecomService(data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 59:
                        ...
                        oppoCancelMissedCallsNotification(_arg022, _arg14);
                        reply.writeNoException();
                        return true;
                    default:
        ...
        private static class Proxy implements ITelecomService {
            ...
            public String colorInteractWithTelecomService(int command, String ext) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(57, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().colorInteractWithTelecomService(command, ext);
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public void oppoCancelMissedCallsNotification(String callingPackage, Bundle extras) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoCancelMissedCallsNotification(callingPackage, extras);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
