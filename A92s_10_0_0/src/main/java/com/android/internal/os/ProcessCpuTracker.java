...
public class ProcessCpuTracker {
    ...
    /* JADX INFO: Multiple debug info for r4v12 long[]: [D('procStats' long[]), D('uptime' long)] */
    ...
    private int[] collectStats(String statsFile, int parentPid, boolean first, int[] curPids, ArrayList<Stats> allProcs) {
        ...
        try {
            ...
            int tempMaxCpuThousandths4 = 0;
            int tempMaxCpuThousandths5 = -1;
            String tempMaxCpuProName5 = "null";
            while (true) {
                if (tempMaxCpuThousandths4 >= NP2) {
                    tempMaxCpuProName = tempMaxCpuProName5;
                    NS = NS4;
                    pids = pids4;
                    i = tempMaxCpuThousandths5;
                    break;
                }
                int pid2 = pids4[tempMaxCpuThousandths4];
                if (pid2 < 0) {
                    tempMaxCpuProName = tempMaxCpuProName5;
                    i = tempMaxCpuThousandths5;
                    NS = NS4;
                ...
                if (st2 == null || st2.pid != pid2) {
                    ...
                    pids2 = pids4;
                    NP = NP2;
                    tempMaxCpuThousandths = tempMaxCpuThousandths4;
                    int tempMaxCpuThousandths6 = tempMaxCpuThousandths5;
                    if (st2 != null) {
                        pid = pid2;
                        if (st2.pid > pid) {
                            arrayList = allProcs;
                            ...
                            tempMaxCpuThousandths5 = tempMaxCpuThousandths6;
                    ...
                    if (st2.interesting) {
                        ...
                        if (!Process.readProcFile(st2.statFile.toString(), PROCESS_STATS_FORMAT, null, procStats2, null)) {
                            ...
                            tempMaxCpuThousandths3 = tempMaxCpuThousandths4;
                            i3 = tempMaxCpuThousandths5;
                        } else {
                    ...
                    arrayList = allProcs;
                    NS4 = NS2;
                    tempMaxCpuThousandths5 = i3;
                    curStatsIndex2 = curStatsIndex;
                    tempMaxCpuProName5 = tempMaxCpuProName3;
                }
                tempMaxCpuThousandths4 = tempMaxCpuThousandths + 1;
                i5 = i2;
                pids4 = pids2;
                NP2 = NP;
                z2 = false;
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.util.FastPrintWriter.<init>(java.io.Writer, boolean, int):void
     arg types: [java.io.StringWriter, int, int]
     candidates:
      com.android.internal.util.FastPrintWriter.<init>(java.io.OutputStream, boolean, int):void
      com.android.internal.util.FastPrintWriter.<init>(java.io.Writer, boolean, int):void */
