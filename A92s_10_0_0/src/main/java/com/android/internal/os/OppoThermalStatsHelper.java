...
class OppoThermalStatsHelper {
    ...
    /* access modifiers changed from: private */
    public String mCpuFreqValuesNeedUpload;
    ...
    /* access modifiers changed from: private */
    public HeatReasonDetails mHeatReasonDetails = new HeatReasonDetails();
    ...
    /* access modifiers changed from: private */
    public PackageManager mPackageManger;
    /* access modifiers changed from: private */
    public PowerManager mPowerManager;
    int mPreHeatThreshold = 400;
    /* access modifiers changed from: private */
    public ThermalReceiver mReceiver = null;
    boolean mRecordThermalHistory;
    private int mScreenBrightness;
    private long mSimpleTopProInterVal = 120000;
    private String mSimpleTopProcesses;
    /* access modifiers changed from: private */
    public String mSimpleTopProcessesNeedUpload = "invalid";
    /* access modifiers changed from: private */
    public boolean mStartAnalizyHeat = false;
    private final OppoBaseBatteryStatsImpl mStats;
    /* access modifiers changed from: private */
    public File mSystemDir = null;
    ...
    /* access modifiers changed from: private */
    public final File mThermalRecFile;
    ...
    /* access modifiers changed from: private */
    public PendingIntent mWakeupIntent;
    ...
    public class HeatReasonDetails {
        ...
        /* access modifiers changed from: private */
        public boolean mIsUploadHeat = false;
        ...
        public void uploadHeatEvent() {
            if (hasCode()) {
                ...
                new Thread(new Runnable() {
                    ...
                    /* JADX WARNING: Code restructure failed: missing block: B:81:0x0344, code lost:
                        return;
                     */
                    public void run() {
                            ...
                            if (!HeatReasonDetails.this.mIsUploadHeat) {
                                if (!HeatReasonDetails.this.mUpLoadMap.isEmpty()) {
                                    if (HeatReasonDetails.this.mUpLoadMap.containsKey("heatReason")) {
                                        ...
                                        ThermalStatistics.onCommon(OppoThermalStatsHelper.this.mContext, OppoThermalStatsHelper.THERMAL_TAG, OppoThermalStatsHelper.THERMAL_HEAT_EVENT, HeatReasonDetails.this.mUpLoadMap, false);
                                        int timeOut = 0;
                                        boolean isUploadLog = false;
                                        while (ThermalStatistics.getOnCommon() && timeOut < 50) {
                                            try {
                                                Thread.sleep(100);
                                                timeOut++;
                                            } catch (InterruptedException e) {
                                                Slog.w(OppoThermalStatsHelper.TAG, "sleep 100 ms is Interrupted because of " + e);
                                            }
                                        }
                                        OppoThermalStatsHelper.this.writeThermalRecFile();
                                        Intent intent = new Intent("oppo.intent.action.ACTION_THERMAL_SCENE");
                                        if (HeatReasonDetails.this.mUpLoadMap.containsKey("heatReason")) {
                                            intent.putExtra("reason", HeatReasonDetails.this.mUpLoadMap.get("heatReason"));
                                        } else {
                                            intent.putExtra("reason", "9999");
                                        }
                                        if (HeatReasonDetails.this.mUpLoadMap.containsKey("current")) {
                                            ...
                                            intent.putExtra("current", "9999");
                                        }
                                        if (HeatReasonDetails.this.mUpLoadMap.containsKey("maxPhoneTemp")) {
                                            intent.putExtra("temp", HeatReasonDetails.this.mUpLoadMap.get("maxPhoneTemp"));
                                        } else {
                                            intent.putExtra("temp", "9999");
                                        }
                                        if (HeatReasonDetails.this.mUpLoadMap.containsKey("maxBatTemp")) {
                                            intent.putExtra("batTemp", HeatReasonDetails.this.mUpLoadMap.get("maxBatTemp"));
                                        } else {
                                            intent.putExtra("batTemp", "9999");
                                        }
                                        if (HeatReasonDetails.this.mUpLoadMap.containsKey("cpuLoading")) {
                                            intent.putExtra("cpuloading", HeatReasonDetails.this.mUpLoadMap.get("cpuloading"));
                                        } else {
                                            intent.putExtra("cpuloading", "9999");
                                        }
                                        intent.putExtra("package", HeatReasonDetails.this.getMaxTopCpuProc());
                                        if (OppoThermalStatsHelper.this.mThermalUploadLog || (OppoThermalStatsHelper.this.mThermalUploadErrLog && (HeatReasonDetails.this.getHeatReson() == 1 || HeatReasonDetails.this.getHeatReson() == 2))) {
                                            isUploadLog = true;
                                        }
                                        intent.putExtra("uploadLog", isUploadLog);
                                        intent.setPackage("com.oppo.oppopowermonitor");
                                        if (!OppoThermalStatsHelper.this.mThermalCaptureLog || OppoThermalStatsHelper.this.mGlobalMaxPhoneTemp < OppoThermalStatsHelper.this.mThermalCaptureLogThreshold) {
                                            Slog.d(OppoThermalStatsHelper.TAG, "CaptureLog=" + OppoThermalStatsHelper.this.mThermalCaptureLog + " ,skip capture log");
                                        } else {
                                            if (OppoThermalStatsHelper.this.mContext != null) {
                                                OppoThermalStatsHelper.this.mContext.sendBroadcastAsUser(intent, UserHandle.CURRENT);
                                            }
                                            boolean unused = HeatReasonDetails.this.mIsUploadHeat = true;
                                        }
                                        Map<String, String> stampMap = OppoThermalStatsHelper.this.getStampThermalHeat(HeatReasonDetails.this.mUpLoadMap);
                                        try {
                                            for (Map.Entry<String, String> entry : stampMap.entrySet()) {
                                                Slog.i(OppoThermalStatsHelper.TAG, "uploadStampHeat " + entry.getKey() + SettingsStringUtil.DELIMITER + entry.getValue());
                                            }
                                        } catch (Exception exception) {
                                            exception.printStackTrace();
                                        }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(int, boolean, boolean):void
     arg types: [int, boolean, int]
     candidates:
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(byte, boolean, boolean):void
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(long, boolean, boolean):void
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(java.lang.String, boolean, boolean):void
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(boolean, boolean, boolean):void
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(int, boolean, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(long, boolean, boolean):void
     ...
     candidates:
      ...
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(long, boolean, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(java.lang.String, boolean, boolean):void
     ...
     candidates:
      ...
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(java.lang.String, boolean, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(boolean, boolean, boolean):void
     ...
     candidates:
      ...
      com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(boolean, boolean, boolean):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.os.OppoThermalStatsHelper.addThermalDetalToStringBuilder(byte, boolean, boolean):void
    ...
    private void collectMoinitAppMap(OppoBaseBatteryStats.ThermalItem cur, OppoBaseBatteryStats.ThermalItem last) {
        ...
        long tempTime3;
        long tempTime4;
        if (this.mThermalMonitorApp.contains(last.foreProc)) {
            ...
            if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--Time")) {
                try {
                    tempTime5 = this.mTempMonitorAppMap.get(last.foreProc + "--Time").longValue();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            this.mTempMonitorAppMap.put(last.foreProc + "--Time", Long.valueOf(deltaTime + tempTime));
            if (last.flashlightOn) {
                tempTime = 0;
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--FlashOn")) {
                    try {
                        tempTime = this.mTempMonitorAppMap.get(last.foreProc + "--FlashOn").longValue();
                    } catch (Exception e2) {
                        e2.printStackTrace();
                    }
                }
                this.mTempMonitorAppMap.put(last.foreProc + "--FlashOn", Long.valueOf(deltaTime + tempTime));
            }
            if (last.chargePlug != 0) {
                long tempTime6 = 0;
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--Charge")) {
                    try {
                        tempTime6 = this.mTempMonitorAppMap.get(last.foreProc + "--Charge").longValue();
                    } catch (Exception e3) {
                        e3.printStackTrace();
                    }
                }
                this.mTempMonitorAppMap.put(last.foreProc + "--Charge", Long.valueOf(deltaTime + tempTime));
            }
            ...
            if (last.connectNetType == 0) {
                ...
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--NetMobile")) {
                    try {
                        tempTime7 = this.mTempMonitorAppMap.get(last.foreProc + "--NetMobile").longValue();
                    } catch (Exception e10) {
                        e10.printStackTrace();
                    }
                }
                this.mTempMonitorAppMap.put(last.foreProc + "--NetMobile", Long.valueOf(tempTime7 + deltaTime));
            }
            if (last.connectNetType == 1) {
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--NetWifi")) {
                    try {
                        tempTime4 = this.mTempMonitorAppMap.get(last.foreProc + "--NetWifi").longValue();
                    } catch (Exception e11) {
                        e11.printStackTrace();
                    }
                    this.mTempMonitorAppMap.put(last.foreProc + "--NetWifi", Long.valueOf(tempTime4 + deltaTime));
                }
                tempTime4 = 0;
                this.mTempMonitorAppMap.put(last.foreProc + "--NetWifi", Long.valueOf(tempTime4 + deltaTime));
            }
            if (last.connectNetType == -1) {
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--NetNone")) {
                    try {
                        tempTime3 = this.mTempMonitorAppMap.get(last.foreProc + "--NetNone").longValue();
                    } catch (Exception e12) {
                        e12.printStackTrace();
                    }
                    this.mTempMonitorAppMap.put(last.foreProc + "--NetNone", Long.valueOf(tempTime3 + deltaTime));
                }
                tempTime3 = 0;
                this.mTempMonitorAppMap.put(last.foreProc + "--NetNone", Long.valueOf(tempTime3 + deltaTime));
            }
            if (last.isAutoBrightness) {
                if (this.mTempMonitorAppMap.containsKey(last.foreProc + "--AutoBrightness")) {
                    try {
                        tempTime2 = this.mTempMonitorAppMap.get(last.foreProc + "--AutoBrightness").longValue();
                    } catch (Exception e13) {
                        e13.printStackTrace();
                    }
                    this.mTempMonitorAppMap.put(last.foreProc + "--AutoBrightness", Long.valueOf(tempTime2 + deltaTime));
                }
                tempTime2 = 0;
                this.mTempMonitorAppMap.put(last.foreProc + "--AutoBrightness", Long.valueOf(tempTime2 + deltaTime));
            }
            ...
            public void run() {
                if (OppoThermalStatsHelper.this.mContext != null && OppoThermalStatsHelper.this.mThermalFeatureOn) {
                    if (OppoThermalStatsHelper.this.mReceiver == null) {
                        OppoThermalStatsHelper oppoThermalStatsHelper = OppoThermalStatsHelper.this;
                        ThermalReceiver unused = oppoThermalStatsHelper.mReceiver = new ThermalReceiver();
                    ...
                    if (OppoThermalStatsHelper.this.mAlarmManager == null || OppoThermalStatsHelper.this.mWakeupIntent == null) {
                        ...
                        AlarmManager unused2 = oppoThermalStatsHelper2.mAlarmManager = (AlarmManager) oppoThermalStatsHelper2.mContext.getSystemService("alarm");
                        OppoThermalStatsHelper oppoThermalStatsHelper3 = OppoThermalStatsHelper.this;
                        PendingIntent unused3 = oppoThermalStatsHelper3.mWakeupIntent = PendingIntent.getBroadcast(oppoThermalStatsHelper3.mContext, 0, new Intent(OppoThermalStatsHelper.ALARM_WAKEUP), 0);
                    } else {
                    ...
                    if (OppoThermalStatsHelper.this.mPowerManager == null || OppoThermalStatsHelper.this.mWakeLock == null) {
                        ...
                        PowerManager unused4 = oppoThermalStatsHelper4.mPowerManager = (PowerManager) oppoThermalStatsHelper4.mContext.getSystemService(Context.POWER_SERVICE);
                        OppoThermalStatsHelper oppoThermalStatsHelper5 = OppoThermalStatsHelper.this;
                        PowerManager.WakeLock unused5 = oppoThermalStatsHelper5.mWakeLock = oppoThermalStatsHelper5.mPowerManager.newWakeLock(1, OppoThermalStatsHelper.WAKELOCK_KEY);
                    ...
                    if (OppoThermalStatsHelper.this.mPackageManger == null) {
                        ...
                        PackageManager unused6 = oppoThermalStatsHelper6.mPackageManger = oppoThermalStatsHelper6.mContext.getPackageManager();
                    }
    ...
    public void backupThermalStatsFile() {
        BackgroundThread.getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                OppoThermalStatsHelper oppoThermalStatsHelper = OppoThermalStatsHelper.this;
                File access$900 = oppoThermalStatsHelper.mThermalRecFile;
                boolean unused = oppoThermalStatsHelper.copyFile(access$900, new File(OppoThermalStatsHelper.this.mSystemDir + "/thermal/dcs/" + OppoThermalStatsHelper.this.mThermalRecFile.getName()));
    ...
    /* access modifiers changed from: private */
    public Map<String, String> getStampThermalHeat(Map<String, String> mHeatMap) {
        Map<String, String> stampMap = new HashMap<>();
    ...
    public static class ThermalStatistics {
        ...
        /* access modifiers changed from: private */
        public static int appId = 20139;
        /* access modifiers changed from: private */
        public static boolean mIsOnCommon = false;
                ...
                case 59:
                    synchronized (OppoThermalStatsHelper.this.mLock) {
                        ...
                        if (OppoThermalStatsHelper.this.mHeatReasonDetails.analizyHeatRecItem(thermaldumpStart, pos)) {
                            ...
                            boolean unused = OppoThermalStatsHelper.this.mStartAnalizyHeat = false;
                        }
                    }
                    return;
                case 60:
