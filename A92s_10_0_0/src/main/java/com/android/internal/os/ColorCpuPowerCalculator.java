...
public class ColorCpuPowerCalculator {
    ...
    /* JADX INFO: Multiple debug info for r24v1 double: [D('cpuPowerMah' double), D('cpuBgPowerMah' double)] */
    ...
    public void calculateApps(SparseArray<ArrayMap<String, BatterySipper>> listSippers, BatteryStats.Uid u, long rawRealtimeUs, long rawUptimeUs, int statsType) {
        ...
        if (uidSippers == null) {
            ...
            if (cpuClusterTimes2 == null) {
                ...
                double cpuBgPowerMah4 = cpuPowerMaUs2 / 3.6E9d;
                ...
                calculatePkgPower(processStats, uidSippers, appHighestDrain2, statsType, cpuPowerMah2, cpuBgPowerMah4, totalCpuTime);
            } else {
                cpuBgPowerMah = cpuBgPowerMah2;
            }
            cpuPowerMaUs = cpuPowerMaUs5;
            ...
            double cpuBgPowerMah42 = cpuPowerMaUs2 / 3.6E9d;
            ...
            calculatePkgPower(processStats2, uidSippers, appHighestDrain2, statsType, cpuPowerMah22, cpuBgPowerMah42, totalCpuTime2);
        }
    }
