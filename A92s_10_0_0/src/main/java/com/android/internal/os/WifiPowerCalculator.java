...
public class WifiPowerCalculator extends PowerCalculator {
    ...
    public void calculateApp(BatterySipper app, BatteryStats.Uid u, long rawRealtimeUs, long rawUptimeUs, int statsType) {
        ...
        if (counter != null) {
            ...
            app.wifiBgTtafficBytes = u.getNetworkActivityBytes(8, statsType) + u.getNetworkActivityBytes(9, statsType);
            if (app.wifiRxBytes + app.wifiTxBytes > 0) {
                app.wifiBgPowerMah = (app.wifiPowerMah * ((double) app.wifiBgTtafficBytes)) / ((double) (app.wifiRxBytes + app.wifiTxBytes));
            }
        }
    }
