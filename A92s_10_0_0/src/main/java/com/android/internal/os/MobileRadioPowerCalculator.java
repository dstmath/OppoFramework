...
public class MobileRadioPowerCalculator extends PowerCalculator {
    ...
    public void calculateApp(BatterySipper app, BatteryStats.Uid u, long rawRealtimeUs, long rawUptimeUs, int statsType) {
        ...
        app.mobileBgTtafficBytes = u.getNetworkActivityBytes(6, statsType) + u.getNetworkActivityBytes(7, statsType);
        if (app.mobileRxBytes + app.mobileTxBytes > 0) {
            app.mobileRadioBgPowerMah = (app.mobileRadioPowerMah * ((double) app.mobileBgTtafficBytes)) / ((double) (app.mobileRxBytes + app.mobileTxBytes));
        }
    }
