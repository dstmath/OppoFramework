...
public class WatchHeaderListView extends ListView {
    ...
    @Override // android.view.ViewGroup, android.widget.AdapterView, android.view.ViewManager
    ...
    /* access modifiers changed from: protected */
    @Override // android.view.ViewGroup, android.view.View, android.widget.ListView
    ...
    public <T extends View> T findViewByPredicateTraversal(Predicate<View> predicate, View childToSkip) {
        ...
        if (v != null || (view = this.mTopPanel) == null || view == childToSkip || view.isRootNamespace()) {
            return v;
        }
