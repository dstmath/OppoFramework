...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.widget.GridLayoutManager.measureChild(android.view.View, int, boolean):void
     arg types: [android.view.View, int, int]
     candidates:
      com.android.internal.widget.RecyclerView.LayoutManager.measureChild(android.view.View, int, int):void
      com.android.internal.widget.GridLayoutManager.measureChild(android.view.View, int, boolean):void */
    /* access modifiers changed from: package-private */
    @Override // com.android.internal.widget.LinearLayoutManager
