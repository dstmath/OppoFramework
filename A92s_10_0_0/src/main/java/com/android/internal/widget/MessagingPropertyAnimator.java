...
public class MessagingPropertyAnimator implements View.OnLayoutChangeListener {
    ...
    private static boolean isFirstLayout(View view) {
        Boolean tag = (Boolean) view.getTag(16909425);
        if (tag == null) {
            return true;
        }
    ...
    private static void setFirstLayout(View view, boolean first) {
        view.setTagInternal(16909425, Boolean.valueOf(first));
    }

    private static void setLayoutTop(View view, int top) {
        view.setTagInternal(16909426, Integer.valueOf(top));
    }

    public static int getLayoutTop(View view) {
        Integer tag = (Integer) view.getTag(16909426);
        if (tag == null) {
            return getTop(view);
        }
        return tag.intValue();
    ...
    public static int getTop(View v) {
        Integer tag = (Integer) v.getTag(16909428);
        if (tag == null) {
            return v.getTop();
        }
        return tag.intValue();
    ...
    public static void setTop(View v, int value) {
        v.setTagInternal(16909428, Integer.valueOf(value));
    ...
    private static void startTopAnimation(final View v, int start, int end, Interpolator interpolator) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909427);
        if (existing != null) {
            existing.cancel();
        }
        ...
        v.setTagInternal(16909427, animator);
        animator.start();
    }
    ...
    public static void fadeIn(final View v) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909424);
        if (existing != null) {
            existing.cancel();
        }
        ...
        v.setTagInternal(16909424, animator);
        animator.start();
    }
    ...
    public static void fadeOut(final View view, final Runnable endAction) {
        ObjectAnimator existing = (ObjectAnimator) view.getTag(16909424);
        if (existing != null) {
            existing.cancel();
        }
        ...
        view.setTagInternal(16909424, animator);
        animator.start();
    }
    ...
    public static boolean isAnimatingTranslation(View v) {
        return v.getTag(16909427) != null;
    }

    public static boolean isAnimatingAlpha(View v) {
        return v.getTag(16909424) != null;
    }
