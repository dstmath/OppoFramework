...
public class DefaultItemAnimator extends SimpleItemAnimator {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable mover = new Runnable() {
                    /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass1 */
            ...
            if (changesPending) {
                ...
                Runnable changer = new Runnable() {
                    /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass2 */
            ...
            if (additionsPending) {
                ...
                Runnable adder = new Runnable() {
                    /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass3 */
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
            /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass4 */
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass5 */
    ...
    public boolean animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        int fromX2 = (int) (((float) fromX) + holder.itemView.getTranslationX());
        int fromY2 = (int) (((float) fromY) + holder.itemView.getTranslationY());
        resetAnimation(holder);
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass6 */
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass7 */
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() {
                /* class com.android.internal.widget.DefaultItemAnimator.AnonymousClass8 */
