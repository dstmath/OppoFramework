...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, com.android.internal.widget.ActionBarView, int]
     candidates:
    ...
    /* JADX INFO: Multiple debug info for r3v8 int: [D('centeredEnd' int), D('lp' android.view.ViewGroup$LayoutParams)] */
    /* access modifiers changed from: protected */
