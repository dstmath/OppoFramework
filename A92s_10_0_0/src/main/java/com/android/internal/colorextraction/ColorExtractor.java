...
public class ColorExtractor implements WallpaperManager.OnColorsChangedListener {
    ...
    public ColorExtractor(Context context, ExtractionType extractionType, boolean immediately) {
        this(context, extractionType, immediately, (WallpaperManager) context.getSystemService(WallpaperManager.class));
    }
    ...
    public static class GradientColors {
        ...
        public int hashCode() {
            return (((this.mMainColor * 31) + this.mSecondaryColor) * 31) + (!this.mSupportsDarkText);
        }
