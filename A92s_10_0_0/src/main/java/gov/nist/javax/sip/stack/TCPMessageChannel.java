...
public class TCPMessageChannel extends MessageChannel implements SIPMessageListener, Runnable, RawMessageChannel {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: gov.nist.javax.sip.stack.TCPMessageChannel.sendMessage(byte[], boolean):void
     arg types: [byte[], int]
     candidates:
      gov.nist.javax.sip.stack.MessageChannel.sendMessage(gov.nist.javax.sip.message.SIPMessage, javax.sip.address.Hop):void
      gov.nist.javax.sip.stack.TCPMessageChannel.sendMessage(byte[], boolean):void */
    @Override // gov.nist.javax.sip.stack.MessageChannel
