...
public class UDPMessageChannel extends MessageChannel implements ParseExceptionListener, Runnable, RawMessageChannel {
    ...
    public Hashtable<String, PingBackTimerTask> pingBackRecord = new Hashtable<>();
    ...
    public class PingBackTimerTask extends TimerTask {
        ...
        public PingBackTimerTask(String ipAddress2, int port2) {
            ...
            access$000.put(ipAddress2 + Separators.COLON + port2, this);
        }

        public void run() {
            Hashtable access$000 = UDPMessageChannel.this.pingBackRecord;
            access$000.remove(this.ipAddress + Separators.COLON + this.port);
        }
    ...
    /* JADX INFO: Multiple debug info for r0v4 boolean: [D('retval' boolean), D('that' gov.nist.javax.sip.stack.UDPMessageChannel)] */
