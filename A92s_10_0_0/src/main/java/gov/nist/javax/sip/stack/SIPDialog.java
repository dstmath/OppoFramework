...
public class SIPDialog implements Dialog, DialogExt {
    ...
    /* access modifiers changed from: private */
    public transient Set<SIPDialogEventListener> eventListeners;
    ...
    /* access modifiers changed from: private */
    public transient int reInviteWaitTime;
    ...
    /* access modifiers changed from: private */
    public Semaphore timerTaskLock;
    ...
    class LingerTimer extends SIPStackTimerTask implements Serializable {
        ...
        public void runTask() {
            ...
            Semaphore unused = SIPDialog.this.timerTaskLock = null;
    ...
    public class DialogDeleteIfNoAckSentTask extends SIPStackTimerTask implements Serializable {
        ...
        public void runTask() {
            if (SIPDialog.this.highestSequenceNumberAcknowledged < this.seqno) {
                DialogDeleteIfNoAckSentTask unused = SIPDialog.this.dialogDeleteIfNoAckSentTask = null;
