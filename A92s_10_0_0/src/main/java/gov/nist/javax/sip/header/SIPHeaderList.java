...
public abstract class SIPHeaderList<HDR extends SIPHeader> extends SIPHeader implements List<HDR>, Header {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:(int, gov.nist.javax.sip.header.SIPHeader):void throws java.lang.IndexOutOfBoundsException
     arg types: [int, HDR]
     candidates:
      gov.nist.javax.sip.header.SIPHeaderList.add(int, java.lang.Object):void
      MutableMD:(gov.nist.javax.sip.header.SIPHeader, boolean):void
      MutableMD:(int, java.lang.Object):void
      MutableMD:(int, gov.nist.javax.sip.header.SIPHeader):void throws java.lang.IndexOutOfBoundsException */
    @Override // java.util.List
    public /* bridge */ /* synthetic */ void add(int i, Object obj) {
        add(i, (SIPHeader) ((SIPHeader) obj));
    }

    @Override // java.util.List, java.util.Collection
    public /* bridge */ /* synthetic */ boolean add(Object obj) {
        return add((SIPHeader) ((SIPHeader) obj));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:(int, gov.nist.javax.sip.header.SIPHeader):gov.nist.javax.sip.header.SIPHeader
     arg types: [int, HDR]
     candidates:
      gov.nist.javax.sip.header.SIPHeaderList.set(int, java.lang.Object):java.lang.Object
      MutableMD:(int, java.lang.Object):java.lang.Object
      MutableMD:(int, gov.nist.javax.sip.header.SIPHeader):gov.nist.javax.sip.header.SIPHeader */
    @Override // java.util.List
    public /* bridge */ /* synthetic */ Object set(int i, Object obj) {
        return set(i, (SIPHeader) ((SIPHeader) obj));
    }
