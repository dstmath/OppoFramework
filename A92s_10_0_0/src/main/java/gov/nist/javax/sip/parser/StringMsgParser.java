...
public class StringMsgParser {
    ...
    public SIPMessage parseSIPMessage(byte[] msgBuffer) throws ParseException {
        ...
        while (true) {
            ...
            try {
                String currentLine = trimEndOfLine(new String(msgBuffer, i, i - i, "UTF-8"));
    ...
    public SIPMessage parseSIPMessage(String msgString) throws ParseException {
        ...
        do {
            try {
                ...
                currentLine = trimEndOfLine(msgString.substring(i, i));
                if (currentLine.length() == 0) {
        ...
        if (!firstLine.startsWith(SIPConstants.SIP_VERSION_STRING)) {
            ...
            try {
                ...
                if (parseExceptionListener2 != null) {
                    parseExceptionListener2.handleException(ex, message, RequestLine.class, firstLine, this.rawStringMessage);
                } else {
                    throw ex;
                }
            }
            ...
            try {
                ...
                ParseExceptionListener parseExceptionListener3 = this.parseExceptionListener;
                if (parseExceptionListener3 != null) {
                    parseExceptionListener3.handleException(ex2, message, StatusLine.class, firstLine, this.rawStringMessage);
                } else {
                    throw ex2;
                }
            }
            ...
            try {
                try {
                    ...
                    if (this.parseExceptionListener != null) {
                        Class headerClass2 = NameMap.getClassFromName(Lexer.getHeaderName(header));
    ...
    public static void main(String[] args) throws ParseException {
        ...
        for (int i = 0; i < 20; i++) {
            new Thread(new Runnable(messages) {
                /* class gov.nist.javax.sip.parser.StringMsgParser.AnonymousClass1ParserThread */
                String[] messages;
