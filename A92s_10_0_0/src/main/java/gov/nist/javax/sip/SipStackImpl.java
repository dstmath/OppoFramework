...
public class SipStackImpl extends SIPTransactionStack implements SipStack, SipStackExt {
    ...
    public boolean isAutomaticDialogSupportEnabled() {
        return ((SIPTransactionStack) this).isAutomaticDialogSupportEnabled;
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        ((SIPTransactionStack) this).isAutomaticDialogSupportEnabled = configurationProperties.getProperty("javax.sip.AUTOMATIC_DIALOG_SUPPORT", "on").equalsIgnoreCase("on");
                        ((SIPTransactionStack) this).isAutomaticDialogErrorHandlingEnabled = configurationProperties.getProperty("gov.nist.javax.sip.AUTOMATIC_DIALOG_ERROR_HANDLING", "true").equals(Boolean.TRUE.toString());
                        if (((SIPTransactionStack) this).isAutomaticDialogSupportEnabled) {
                            ((SIPTransactionStack) this).isAutomaticDialogErrorHandlingEnabled = true;
                        }
                        if (configurationProperties.getProperty("gov.nist.javax.sip.MAX_LISTENER_RESPONSE_TIME") != null) {
                            ((SIPTransactionStack) this).maxListenerResponseTime = Integer.parseInt(configurationProperties.getProperty("gov.nist.javax.sip.MAX_LISTENER_RESPONSE_TIME"));
                            if (((SIPTransactionStack) this).maxListenerResponseTime <= 0) {
                            ...
                            ((SIPTransactionStack) this).maxListenerResponseTime = -1;
                        }
                        ...
                        ((SIPTransactionStack) this).cacheServerConnections = z;
                        ...
                        if (flag != null && "false".equalsIgnoreCase(flag.trim())) {
                            ((SIPTransactionStack) this).cacheServerConnections = false;
                        }
                        ((SIPTransactionStack) this).cacheClientConnections = true;
                        ...
                        if (cacheflag != null && "false".equalsIgnoreCase(cacheflag.trim())) {
                            ((SIPTransactionStack) this).cacheClientConnections = false;
                        }
                        ...
                        if (readTimeout != null) {
                            try {
                                ...
                                if (rt >= 100) {
                                    try {
                                        ((SIPTransactionStack) this).readTimeout = rt;
                                        ...
                                        ((SIPTransactionStack) this).rfc2543Supported = configurationProperties.getProperty("gov.nist.javax.sip.RFC_2543_SUPPORT_ENABLED", "true").equalsIgnoreCase("true");
                                        ((SIPTransactionStack) this).cancelClientTransactionChecked = configurationProperties.getProperty("gov.nist.javax.sip.CANCEL_CLIENT_TRANSACTION_CHECKED", "true").equalsIgnoreCase("true");
                                        ((SIPTransactionStack) this).logStackTraceOnMessageSend = configurationProperties.getProperty("gov.nist.javax.sip.LOG_STACK_TRACE_ON_MESSAGE_SEND", "false").equalsIgnoreCase("true");
                                        if (isLoggingEnabled()) {
                                        }
                                        ...
                                        ((SIPTransactionStack) this).stackDoesCongestionControl = Boolean.parseBoolean(configurationProperties.getProperty("gov.nist.javax.sip.CONGESTION_CONTROL_ENABLED", Boolean.TRUE.toString()));
                                        ((SIPTransactionStack) this).isBackToBackUserAgent = Boolean.parseBoolean(configurationProperties.getProperty("gov.nist.javax.sip.IS_BACK_TO_BACK_USER_AGENT", Boolean.FALSE.toString()));
                                        ((SIPTransactionStack) this).checkBranchId = Boolean.parseBoolean(configurationProperties.getProperty("gov.nist.javax.sip.REJECT_STRAY_RESPONSES", Boolean.FALSE.toString()));
                                        ((SIPTransactionStack) this).isDialogTerminatedEventDeliveredForNullDialog = Boolean.parseBoolean(configurationProperties.getProperty("gov.nist.javax.sip.DELIVER_TERMINATED_EVENT_FOR_NULL_DIALOG", Boolean.FALSE.toString()));
                                        ((SIPTransactionStack) this).maxForkTime = Integer.parseInt(configurationProperties.getProperty("gov.nist.javax.sip.MAX_FORK_TIME_SECONDS", "0"));
                                    }
                                } else {
                                    try {
                        ...
                        if (maxMsgSize == null) {
                            try {
                                ((SIPTransactionStack) this).maxMessageSize = new Integer(maxMsgSize).intValue();
                                if (((SIPTransactionStack) this).maxMessageSize < 4096) {
                                    try {
                                        ((SIPTransactionStack) this).maxMessageSize = 4096;
                            ...
                            ((SIPTransactionStack) this).maxMessageSize = 0;
                        }
    ...
    public ListeningPoint createListeningPoint(int port, String transport) throws TransportNotSupportedException, InvalidArgumentException {
        if (((SIPTransactionStack) this).stackAddress != null) {
            return createListeningPoint(((SIPTransactionStack) this).stackAddress, port, transport);
        }
    ...
    public LogRecordFactory getLogRecordFactory() {
        return ((SIPTransactionStack) this).logRecordFactory;
    }
    ...
    public void setIsBackToBackUserAgent(boolean flag) {
        ((SIPTransactionStack) this).isBackToBackUserAgent = flag;
    }

    public boolean isBackToBackUserAgent() {
        return ((SIPTransactionStack) this).isBackToBackUserAgent;
    }

    public boolean isAutomaticDialogErrorHandlingEnabled() {
        return ((SIPTransactionStack) this).isAutomaticDialogErrorHandlingEnabled;
    }
