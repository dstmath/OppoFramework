...
public final class TLSMessageChannel extends MessageChannel implements SIPMessageListener, Runnable, RawMessageChannel {
    ...
    protected TLSMessageChannel(Socket sock, SIPTransactionStack sipStack2, TLSMessageProcessor msgProcessor) throws IOException {
        ...
        ((MessageChannel) this).messageProcessor = msgProcessor;
        this.mythread.start();
    }
    ...
    protected TLSMessageChannel(InetAddress inetAddr, int port, SIPTransactionStack sipStack2, TLSMessageProcessor messageProcessor) throws IOException {
        ...
        ((MessageChannel) this).messageProcessor = messageProcessor;
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: gov.nist.javax.sip.stack.TLSMessageChannel.sendMessage(byte[], boolean):void
     arg types: [byte[], int]
     candidates:
      gov.nist.javax.sip.stack.MessageChannel.sendMessage(gov.nist.javax.sip.message.SIPMessage, javax.sip.address.Hop):void
      gov.nist.javax.sip.stack.TLSMessageChannel.sendMessage(byte[], boolean):void */
