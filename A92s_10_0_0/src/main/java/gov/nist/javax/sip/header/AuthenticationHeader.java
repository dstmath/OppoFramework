...
public abstract class AuthenticationHeader extends ParametersHeader {
    ...
    public void setParameter(String name, String value) throws ParseException {
        NameValue nv = ((ParametersHeader) this).parameters.getNameValue(name.toLowerCase());
        if (nv == null) {
    ...
    public void setChallenge(Challenge challenge) {
        ...
        ((ParametersHeader) this).parameters = challenge.authParams;
    }
    ...
    public void setURI(URI uri) {
        if (uri != null) {
            ...
            nv.setQuotedValue();
            ((ParametersHeader) this).parameters.set(nv);
            return;
        }
