...
public class SIPObjectList extends GenericObjectList {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: gov.nist.core.GenericObjectList.concatenate(gov.nist.core.GenericObjectList, boolean):void
     arg types: [gov.nist.javax.sip.header.SIPObjectList, boolean]
     candidates:
      gov.nist.javax.sip.header.SIPObjectList.concatenate(gov.nist.javax.sip.header.SIPObjectList, boolean):void
      gov.nist.core.GenericObjectList.concatenate(gov.nist.core.GenericObjectList, boolean):void */
