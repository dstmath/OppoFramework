...
public interface IRadioIndicationOp extends vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@1.2::IRadioIndicationOp";

    @Override // vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp
    IHwBinder asBinder();
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp
     arg types: [java.lang.String, boolean]
     candidates:
      vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp
      vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp */
    @Override // vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp
    ...
    public static final class Proxy implements IRadioIndicationOp {
        ...
        @Override // vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp, vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@1.2::IRadioIndicationOp]@Proxy";
            }
        }
        ...
        public void onSimMeLockEvent(int type, int eventId) throws RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp.kInterfaceName);
        ...
        @Override // vendor.mediatek.hardware.radio_op.V1_2.IRadioIndicationOp
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndicationOp {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioIndicationOp.kInterfaceName, vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{105, Byte.MAX_VALUE, -58, 126, -5, -109, -122, 85, -125, -108, -59, -13, 120, 46, 26, 112, -65, 21, -120, -24, -31, 96, 70, -108, -79, 45, -26, 46, -46, -89, -70, -59}, new byte[]{64, 56, 121, 67, 122, 63, -127, 9, -116, -1, 52, 55, -100, 36, 0, 23, -55, -122, 124, 100, 126, 75, 107, 96, 58, 101, -124, 118, -87, -42, -9, -40}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                _hidl_request.enforceInterface(vendor.mediatek.hardware.radio_op.V1_1.IRadioIndicationOp.kInterfaceName);
