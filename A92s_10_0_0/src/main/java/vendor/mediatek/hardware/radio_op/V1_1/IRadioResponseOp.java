...
public interface IRadioResponseOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@1.1::IRadioResponseOp";
    ...
    public static final class Proxy implements IRadioResponseOp {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@1.1::IRadioResponseOp]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponseOp {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-103, -71, 7, 6, 75, 112, 20, -121, -36, -65, 71, -71, -60, 45, -72, 113, 24, 61, 105, -107, -64, -73, -50, -23, 44, 101, -22, 101, -68, -29, -45, -60}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
