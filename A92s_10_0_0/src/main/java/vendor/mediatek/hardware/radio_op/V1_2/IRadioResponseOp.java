...
public interface IRadioResponseOp extends vendor.mediatek.hardware.radio_op.V1_1.IRadioResponseOp {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.mediatek.hardware.radio_op.V1_2.IRadioResponseOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_2.IRadioResponseOp
     arg types: [java.lang.String, boolean]
     candidates:
      vendor.mediatek.hardware.radio_op.V1_1.IRadioResponseOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_1.IRadioResponseOp
      vendor.mediatek.hardware.radio_op.V1_2.IRadioResponseOp.getService(java.lang.String, boolean):vendor.mediatek.hardware.radio_op.V1_2.IRadioResponseOp */
    @Override // vendor.mediatek.hardware.radio_op.V1_1.IRadioResponseOp
