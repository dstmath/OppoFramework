...
public interface IRadioResponseOp extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.radio_op@2.0::IRadioResponseOp";
    ...
    void setIncomingVirtualLineResponse(RadioResponseInfo radioResponseInfo) throws RemoteException;
    ...
    static default IRadioResponseOp asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default IRadioResponseOp castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IRadioResponseOp getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IRadioResponseOp getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default IRadioResponseOp getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IRadioResponseOp getService() throws RemoteException {
    ...
    public static final class Proxy implements IRadioResponseOp {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.radio_op@2.0::IRadioResponseOp]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponseOp {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioResponseOp.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-69, -127, 103, 8, 122, -68, -32, 107, 9, -124, 56, 117, -76, -37, 99, 14, -124, 107, -77, 116, -65, 38, -79, -116, 45, -92, -20, 17, -44, -17, -124, 57}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 6:
                    ...
                    sendRsuRequestResponse(info2, rri);
                    return;
                case 7:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
