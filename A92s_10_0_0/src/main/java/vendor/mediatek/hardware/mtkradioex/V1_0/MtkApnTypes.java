...
public final class MtkApnTypes {
    ...
    public static final int BIP = 16384;
    ...
    public static final int MTKALL = 65535;
    public static final int NONE = 0;
    public static final int RCS = 8192;
    public static final int SUPL = 4;
    public static final int VSIM = 32768;
    public static final int WAP = 2048;
    public static final int XCAP = 4096;
