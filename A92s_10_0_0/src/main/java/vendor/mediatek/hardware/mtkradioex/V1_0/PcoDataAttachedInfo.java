...
public final class PcoDataAttachedInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.apnName.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
        this.bearerProto = _hidl_blob.getString(_hidl_offset + 24);
        parcel.readEmbeddedBuffer((long) (this.bearerProto.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 24 + 0, false);
