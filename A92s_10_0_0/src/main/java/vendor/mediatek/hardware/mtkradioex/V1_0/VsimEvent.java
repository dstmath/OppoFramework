...
public final class VsimEvent {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != VsimEvent.class) {
            return false;
        }
        VsimEvent other = (VsimEvent) otherObject;
        if (this.transactionId == other.transactionId && this.eventId == other.eventId && this.simType == other.simType) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<VsimEvent> readVectorFromParcel(HwParcel parcel) {
        ArrayList<VsimEvent> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 12), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            VsimEvent _hidl_vec_element = new VsimEvent();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.eventId = _hidl_blob.getInt32(4 + _hidl_offset);
        this.simType = _hidl_blob.getInt32(8 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<VsimEvent> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(8 + _hidl_offset, this.simType);
    }
}
