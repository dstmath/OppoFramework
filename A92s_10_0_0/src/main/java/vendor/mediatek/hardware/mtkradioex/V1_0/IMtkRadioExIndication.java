...
public interface IMtkRadioExIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::IMtkRadioExIndication";
    ...
    void smlDeviceLockInfoChangedInd(int i, ArrayList<Integer> arrayList) throws RemoteException;

    void smlEncryptedSerialIdInd(int i, ArrayList<String> arrayList) throws RemoteException;
    ...
    public static final class Proxy implements IMtkRadioExIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::IMtkRadioExIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioExIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IMtkRadioExIndication.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-80, -26, -22, -12, -41, 48, -121, -37, -45, -44, 36, 100, -100, -57, -37, -35, -127, -3, 93, 73, 34, 52, -127, -65, 51, 9, -111, 40, -124, 6, 120, 126}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
