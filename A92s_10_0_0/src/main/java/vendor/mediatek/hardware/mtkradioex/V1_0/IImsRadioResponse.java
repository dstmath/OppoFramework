...
public interface IImsRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::IImsRadioResponse";
    ...
    public static final class Proxy implements IImsRadioResponse {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V1_0.IImsRadioResponse
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::IImsRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IImsRadioResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{117, 78, -95, 10, -17, 43, -107, 75, -81, 116, 43, 26, -75, -72, -61, -11, -98, 65, -21, -16, -86, -115, -70, 98, -28, 34, -10, -107, 61, -99, -12, -72}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
