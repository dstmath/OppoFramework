...
public interface ISmartRatSwitchRadioIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.4::ISmartRatSwitchRadioIndication";
    ...
    static default ISmartRatSwitchRadioIndication asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof ISmartRatSwitchRadioIndication)) {
            return (ISmartRatSwitchRadioIndication) iface;
        }
    ...
    static default ISmartRatSwitchRadioIndication castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ISmartRatSwitchRadioIndication getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ISmartRatSwitchRadioIndication getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ISmartRatSwitchRadioIndication getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ISmartRatSwitchRadioIndication getService() throws RemoteException {
    ...
    public static final class Proxy implements ISmartRatSwitchRadioIndication {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V1_4.ISmartRatSwitchRadioIndication
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.4::ISmartRatSwitchRadioIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISmartRatSwitchRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-17, -54, -76, 48, 21, -90, -10, -31, 96, -126, -77, -51, 24, 24, 41, -109, -10, -33, -46, 70, 109, -5, 84, -29, 19, -69, -64, 67, 99, 82, -15, -106}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                smartRatSwitchInd(_hidl_request.readInt32(), _hidl_request.readInt32());
                ...
                _hidl_request.enforceInterface(ISmartRatSwitchRadioIndication.kInterfaceName);
                codecActiveInd(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readBool());
                ...
                _hidl_request.enforceInterface(ISmartRatSwitchRadioIndication.kInterfaceName);
                codecFpsInd(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                ...
                _hidl_request.enforceInterface(ISmartRatSwitchRadioIndication.kInterfaceName);
                codecResolutionInd(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                ...
                _hidl_request.enforceInterface(ISmartRatSwitchRadioIndication.kInterfaceName);
                codecEmptyInd(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readBool());
            }
        }
    }
}
