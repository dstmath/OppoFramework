...
public interface ICapRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::ICapRadioResponse";
    ...
    static default ICapRadioResponse asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default ICapRadioResponse castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default ICapRadioResponse getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default ICapRadioResponse getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default ICapRadioResponse getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default ICapRadioResponse getService() throws RemoteException {
    ...
    public static final class Proxy implements ICapRadioResponse {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V1_0.ICapRadioResponse
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::ICapRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ICapRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ICapRadioResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-75, 95, -14, -56, -46, 31, 63, -71, -59, -73, -49, BipUtils.TCP_STATUS_LISTEN, -41, 114, 101, 3, -88, 15, 18, -97, 84, -110, -110, -118, -1, -35, -115, -79, -103, -78, -34, 24}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
