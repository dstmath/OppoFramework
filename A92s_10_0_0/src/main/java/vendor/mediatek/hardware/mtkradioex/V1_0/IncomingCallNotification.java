...
public final class IncomingCallNotification {
    ...
    public static final ArrayList<IncomingCallNotification> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * MtkCharacterSets.ISO_8859_16), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            IncomingCallNotification _hidl_vec_element = new IncomingCallNotification();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * MtkCharacterSets.ISO_8859_16));
    ...
    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob((int) MtkCharacterSets.ISO_8859_16);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IncomingCallNotification> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * MtkCharacterSets.ISO_8859_16);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * MtkCharacterSets.ISO_8859_16));
        }
