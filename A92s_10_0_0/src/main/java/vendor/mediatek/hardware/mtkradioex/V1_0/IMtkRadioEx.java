...
public interface IMtkRadioEx extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::IMtkRadioEx";
    ...
    public static final class Proxy implements IMtkRadioEx {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::IMtkRadioEx]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMtkRadioEx {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IMtkRadioEx.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{84, -101, 80, -62, -7, -41, 77, -21, 46, 80, -102, -88, -106, -90, 34, 84, 61, -88, 19, 92, 101, 85, -88, -70, -56, 37, -94, -118, -63, 46, -58, 49}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
