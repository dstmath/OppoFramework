...
public interface IMwiRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::IMwiRadioResponse";
    ...
    static default IMwiRadioResponse asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default IMwiRadioResponse castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IMwiRadioResponse getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IMwiRadioResponse getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default IMwiRadioResponse getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IMwiRadioResponse getService() throws RemoteException {
    ...
    public static final class Proxy implements IMwiRadioResponse {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V1_0.IMwiRadioResponse
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::IMwiRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMwiRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IMwiRadioResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-115, -34, -12, -94, -33, 41, 55, -18, 37, -7, 90, -28, -55, 39, -66, 86, 40, -86, -113, 38, 34, 79, 58, -101, 120, 45, 21, 43, -116, 24, -59, 38}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
