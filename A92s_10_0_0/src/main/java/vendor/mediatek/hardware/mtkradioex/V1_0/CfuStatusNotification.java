...
public final class CfuStatusNotification {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != CfuStatusNotification.class) {
            return false;
        }
        CfuStatusNotification other = (CfuStatusNotification) otherObject;
        if (this.status == other.status && this.lineId == other.lineId) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<CfuStatusNotification> readVectorFromParcel(HwParcel parcel) {
        ArrayList<CfuStatusNotification> _hidl_vec = new ArrayList<>();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 8), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            CfuStatusNotification _hidl_vec_element = new CfuStatusNotification();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.lineId = _hidl_blob.getInt32(4 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CfuStatusNotification> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(4 + _hidl_offset, this.lineId);
    }
}
