...
public interface IMwiRadioIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@1.0::IMwiRadioIndication";
    ...
    static default IMwiRadioIndication asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IMwiRadioIndication)) {
            return (IMwiRadioIndication) iface;
        }
    ...
    static default IMwiRadioIndication castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IMwiRadioIndication getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IMwiRadioIndication getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static default IMwiRadioIndication getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IMwiRadioIndication getService() throws RemoteException {
    ...
    public static final class Proxy implements IMwiRadioIndication {
        ...
        @Override // vendor.mediatek.hardware.mtkradioex.V1_0.IMwiRadioIndication
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@1.0::IMwiRadioIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMwiRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-109, 100, -107, 35, BipUtils.TCP_STATUS_ESTABLISHED, -71, 95, 120, -116, -63, 17, 54, 106, 26, 21, 92, 15, 36, 80, 84, -85, -2, -112, -13, 116, 61, 4, -21, -14, 20, 89, 30}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    onWifiMonitoringThreshouldChanged(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 2:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWifiPdnActivate(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 3:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWfcPdnError(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 4:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onPdnHandover(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 5:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWifiRoveout(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 6:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onLocationRequest(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 7:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWfcPdnStateChanged(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 8:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onNattKeepAliveChanged(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 9:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWifiPingRequest(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
                    return;
                case 10:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWifiPdnOOS(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                case 11:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    _hidl_request.enforceInterface(IMwiRadioIndication.kInterfaceName);
                    onWifiLock(_hidl_request.readInt32(), _hidl_request.readStringVector());
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:
