...
public interface ISupplicant extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.wifi.supplicant@2.0::ISupplicant";
    ...
    void getInterface(ISupplicant.IfaceInfo ifaceInfo, getInterfaceCallback getinterfacecallback) throws RemoteException;
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant.getService(java.lang.String, boolean):vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant
     ...
     candidates:
      ...
      vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant.getService(java.lang.String, boolean):vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant */
    @Override // android.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements ISupplicant {
        ...
        @Override // vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.wifi.supplicant@2.0::ISupplicant]@Proxy";
            }
        }
        ...
        @Override // vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant
        ...
        @Override // vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant
        public void getInterface(ISupplicant.IfaceInfo ifaceInfo, getInterfaceCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicant.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicant {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-106, -81, 35, -52, 113, 114, -118, 123, -112, 2, 34, -39, -124, Byte.MIN_VALUE, -33, -34, 2, 84, -20, -10, -105, 10, -22, 54, 6, -37, -8, 38, 22, 116, -21, -30}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getInterface(ifaceInfo, new getInterfaceCallback() {
                    /* class vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicant.Stub.AnonymousClass1 */
