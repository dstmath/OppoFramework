...
public interface IHostapd extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService(java.lang.String, boolean):vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd
     ...
     candidates:
      ...
      vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd.getService(java.lang.String, boolean):vendor.mediatek.hardware.wifi.hostapd.V2_0.IHostapd */
    @Override // android.hidl.base.V1_0.IBase
