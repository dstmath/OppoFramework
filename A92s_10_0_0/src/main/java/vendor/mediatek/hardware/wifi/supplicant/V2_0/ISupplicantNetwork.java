...
public interface ISupplicantNetwork extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.wifi.supplicant@2.0::ISupplicantNetwork";
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicantNetwork.getService(java.lang.String, boolean):vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicantNetwork
    ...
    public static final class Proxy implements ISupplicantNetwork {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.wifi.supplicant@2.0::ISupplicantNetwork]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantNetwork {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-62, 67, 11, -90, -19, -102, 81, 62, -120, 64, 40, -49, -24, -54, 59, 75, 93, 9, -45, 101, 113, 23, -121, 44, 1, -54, 48, -76, -90, 120, 9, 75}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getId(new getIdCallback() {
                    /* class vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicantNetwork.Stub.AnonymousClass1 */
                ...
                getInterfaceName(new getInterfaceNameCallback() {
                    /* class vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicantNetwork.Stub.AnonymousClass2 */
                ...
                getType(new getTypeCallback() {
                    /* class vendor.mediatek.hardware.wifi.supplicant.V2_0.ISupplicantNetwork.Stub.AnonymousClass3 */
