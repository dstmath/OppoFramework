...
public interface ITransmessge extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.oppo.usage.transmessage.V1_0.ITransmessge.getService(java.lang.String, boolean):vendor.oppo.usage.transmessage.V1_0.ITransmessge
     ...
     candidates:
      ...
      vendor.oppo.usage.transmessage.V1_0.ITransmessge.getService(java.lang.String, boolean):vendor.oppo.usage.transmessage.V1_0.ITransmessge */
    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITransmessge getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements ITransmessge {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{73, 110, -92, -33, 110, -32, -9, 111, 123, -96, -103, 77, -10, -14, 6, -111, -6, 95, -105, -39, 75, -104, -42, -51, 68, UsbDescriptor.DESCRIPTORTYPE_REPORT, -109, 106, -69, -99, -55, -90}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
