...
public interface IBiometricsFace extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFace.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFace
     ...
     candidates:
      ...
      vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFace.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFace */
    @Override // android.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case FaceAcquiredInfo.NOT_DETECTED:
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.TOO_MUCH_MOTION:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.RECALIBRATE:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.TOO_DIFFERENT:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.TOO_SIMILAR:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.PAN_TOO_EXTREME:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.TILT_TOO_EXTREME:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.ROLL_TOO_EXTREME:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
                ...
                case FaceAcquiredInfo.START:
                    ...
                    _hidl_reply.send();
                    return;
                case FaceAcquiredInfo.SENSOR_DIRTY:
                    if ((_hidl_flags & 1) == 0) {
                        _hidl_is_oneway2 = false;
                    }
                    if (_hidl_is_oneway2) {
