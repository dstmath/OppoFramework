...
public interface IAuthenticatorCallback extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IAuthenticatorCallback.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IAuthenticatorCallback
     ...
     candidates:
      ...
      vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IAuthenticatorCallback.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IAuthenticatorCallback */
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IAuthenticatorCallback getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IAuthenticatorCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{98, -37, 57, -86, -90, -104, 61, -1, -85, UsbACInterface.ACI_SAMPLE_RATE_CONVERTER, -72, -62, 115, 115, -38, -90, 117, -76, UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, -113, -112, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, 126, -114, 75, 108, -104, -122, 81, -34, 75, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
