...
public interface IBiometricsFaceClientCallback extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
     ...
     candidates:
      ...
      vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback */
    @Override // android.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements IBiometricsFaceClientCallback {
        ...
        @Override // vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.oppo.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onAuthenticated(long deviceId, int faceId, int userId, int retryTimes, ArrayList<Byte> token) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            _hidl_request.writeInt32(faceId);
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFaceClientCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-106, -47, 66, -37, -8, -58, -37, 47, 24, 28, 92, -97, -87, 114, -121, 103, 104, -75, 99, Byte.MAX_VALUE, 92, 88, 7, -71, -106, -67, 38, -108, 116, 91, 115, 75}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    _hidl_request.enforceInterface(IBiometricsFaceClientCallback.kInterfaceName);
                    onAuthenticated(_hidl_request.readInt64(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt8Vector());
                    return;
                case 3:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 9:
                    ...
                    return;
                case FaceAcquiredInfo.POOR_GAZE:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    }
                    if (!_hidl_is_oneway) {
                    ...
                    return;
                case FaceAcquiredInfo.NOT_DETECTED:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    }
                    if (!_hidl_is_oneway) {
