...
public interface IFingerprintPay extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IFingerprintPay.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IFingerprintPay
     ...
     candidates:
      ...
      vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IFingerprintPay.getService(java.lang.String, boolean):vendor.oppo.hardware.biometrics.fingerprintpay.V1_0.IFingerprintPay */
    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IFingerprintPay getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IFingerprintPay {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{109, 71, -34, 80, 103, UsbASFormat.EXT_FORMAT_TYPE_III, -16, 122, -14, -33, 39, -41, -55, -82, 58, UsbDescriptor.DESCRIPTORTYPE_BOS, 14, 110, 25, -5, -102, 116, -74, 126, -22, -7, 70, 68, -6, 45, 51, 3}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
