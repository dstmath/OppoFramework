...
public class MediaRecorder implements AudioRouting, AudioRecordingMonitor, AudioRecordingMonitorClient, MicrophoneDirection {
    ...
    public static final String toLogFriendlyAudioSource(int source) {
        switch (source) {
            ...
            default:
                switch (source) {
                    case AudioSource.ECHO_REFERENCE /*{ENCODED_INT: 1997}*/:
                        return "ECHO_REFERENCE";
                    case AudioSource.RADIO_TUNER /*{ENCODED_INT: 1998}*/:
                        return "RADIO_TUNER";
                    case 1999:
                        return "HOTWORD";
                    default:
    ...
    public void prepare() throws IllegalStateException, IOException {
        ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(152, Os.getuid());
        if ("off".equals(SystemProperties.get("oppo.camera.hypnus.contrl", Camera.Parameters.FLASH_MODE_ON))) {
    ...
    private static void postEventFromNative(Object mediarecorder_ref, int what, int arg1, int arg2, Object obj) {
        ...
        if (mr != null && mr.mEventHandler != null) {
            if (what == 2 && arg1 == 1999) {
                ...
                OnInfoListener onInfoListener = mr.mOnCameraReleasedListener;
                if (onInfoListener != null) {
                    onInfoListener.onInfo(mr, 1999, 0);
                    return;
                }
                return;
            }
