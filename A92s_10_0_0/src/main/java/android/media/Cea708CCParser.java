...
class Cea708CCParser {
    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            ...
            case 144:
                int pos8 = pos + 2;
                emitCaptionEvent(new CaptionEvent(12, new CaptionPenAttr(data[pos] & 3, (data[pos] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, (data[pos] & 240) >> 4, 7 & data[pos + 1], (data[pos + 1] & 56) >> 3, (data[pos + 1] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, (data[pos + 1] & 128) != 0)));
                return pos8;
            case 145:
                int pos9 = pos + 1;
                int pos10 = pos9 + 1;
                int pos11 = pos10 + 1;
                emitCaptionEvent(new CaptionEvent(13, new CaptionPenColor(new CaptionColor((data[pos] & 192) >> 6, (data[pos] & 48) >> 4, (data[pos] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, data[pos] & 3), new CaptionColor((data[pos9] & 192) >> 6, (data[pos9] & 48) >> 4, (data[pos9] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, data[pos9] & 3), new CaptionColor(0, (data[pos10] & 48) >> 4, (12 & data[pos10]) >> 2, data[pos10] & 3))));
                return pos11;
            case 146:
                int pos12 = pos + 2;
            ...
            case 151:
                int pos13 = pos + 4;
                emitCaptionEvent(new CaptionEvent(15, new CaptionWindowAttr(new CaptionColor((data[pos] & 192) >> 6, (data[pos] & 48) >> 4, (data[pos] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, data[pos] & 3), new CaptionColor(0, (data[pos + 1] & 48) >> 4, (data[pos + 1] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, data[pos + 1] & 3), ((data[pos + 2] & 128) >> 5) | ((data[pos + 1] & 192) >> 6), (data[pos + 2] & BluetoothHidDevice.SUBCLASS1_KEYBOARD) != 0, (data[pos + 2] & 48) >> 4, (data[pos + 2] & OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF) >> 2, data[pos + 2] & 3, (12 & data[pos + 3]) >> 2, (data[pos + 3] & 240) >> 4, 3 & data[pos + 3])));
                return pos13;
            case 152:
            case 153:
            case 154:
            ...
            case 159:
                int pos14 = pos + 6;
                emitCaptionEvent(new CaptionEvent(16, new CaptionWindow(i - 152, (data[pos] & 32) != 0, (data[pos] & 16) != 0, (data[pos] & 8) != 0, data[pos] & 7, (data[pos + 1] & 128) != 0, data[pos + 1] & 127, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3)));
                return pos14;
        }
        return pos;
    }
