...
public class AudioTrack extends PlayerBase implements AudioRouting, VolumeAutomation {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.media.AudioTrack.<init>(android.media.AudioAttributes, android.media.AudioFormat, int, int, int, boolean):void
     arg types: [android.media.AudioAttributes, android.media.AudioFormat, int, int, int, int]
     candidates:
      android.media.AudioTrack.<init>(int, int, int, int, int, int):void
      android.media.AudioTrack.<init>(android.media.AudioAttributes, android.media.AudioFormat, int, int, int, boolean):void */
    ...
    public static class Builder {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:33:0x00d6 A[Catch:{ IllegalArgumentException -> 0x00df }, RETURN] */
    ...
    public static int getMinBufferSize(int sampleRateInHz, int channelConfig, int audioFormat) {
        ...
        if (sampleRateInHz == 0) {
            try {
                String value = OppoAtlasManager.getInstance(null).getParameters("get_listinfo_bypid=at-sampleRate=" + Binder.getCallingPid());
                if (value != null) {
                    int sampleRate = Integer.parseInt(value);
                    Log.d(TAG, "getMinBufferSize sampleRate:" + sampleRate);
                    if (sampleRate > 0) {
                ...
                if (channelConfig != 4) {
                    if (channelConfig != 12) {
                        ...
                        if (!AudioFormat.isPublicEncoding(audioFormat)) {
                            ...
                            OppoAtlasManager.getInstance(null).setEvent(257, "EventID,4,sampleRateInHz," + sampleRateInHz + ",pid," + Binder.getCallingPid());
                            StringBuilder sb = new StringBuilder();
                            sb.append("getMinBufferSize(): ");
                            sb.append(sampleRateInHz);
                            sb.append(" Hz is not a supported sample rate.");
                            loge(sb.toString());
                            return -2;
                        } else {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.media.AudioTrack.addOnRoutingChangedListener(android.media.AudioRouting$OnRoutingChangedListener, android.os.Handler):void
     arg types: [android.media.AudioTrack$OnRoutingChangedListener, android.os.Handler]
     candidates:
      ...
      android.media.AudioTrack.addOnRoutingChangedListener(android.media.AudioRouting$OnRoutingChangedListener, android.os.Handler):void */
    @Deprecated
                    ...
                    synchronized (AudioTrack.this.mPlayStateLock) {
                        if (AudioTrack.this.mPlayState == 4) {
                            if (AudioTrack.this.mOffloadEosPending) {
                                ...
                                int unused = AudioTrack.this.mPlayState = 3;
                            } else {
                                ByteBuffer unused2 = AudioTrack.this.mAvSyncHeader = null;
                                int unused3 = AudioTrack.this.mAvSyncBytesRemaining = 0;
                                int unused4 = AudioTrack.this.mPlayState = 1;
                            }
                            boolean unused5 = AudioTrack.this.mOffloadEosPending = false;
