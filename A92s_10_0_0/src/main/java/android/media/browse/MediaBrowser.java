                ...
                public void run() {
                    if (MediaBrowser.this.mState != 0) {
                        ...
                        if (MediaBrowser.this.mServiceBinder != null) {
                            ...
                            MediaServiceConnection unused2 = mediaBrowser.mServiceConnection = new MediaServiceConnection();
                            boolean bound = false;
                            try {
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                if (MediaBrowser.this.isCurrent(callback, "onConnect")) {
                    ...
                    String unused = MediaBrowser.this.mRootId = root;
                    MediaSession.Token unused2 = MediaBrowser.this.mMediaSessionToken = session;
                    Bundle unused3 = MediaBrowser.this.mExtras = extra;
