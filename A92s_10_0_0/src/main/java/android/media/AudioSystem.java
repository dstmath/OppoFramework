...
public class AudioSystem {
    ...
    public static int[] DEFAULT_STREAM_VOLUME = {5, 14, 14, 10, 12, 11, 8, 16, 12, 12, 11};
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0026, code lost:
        r0.onRecordingConfigurationChanged(r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, "");
     */
    ...
    public static String getInputDeviceName(int device) {
        switch (device) {
            case DEVICE_IN_COMMUNICATION /*{ENCODED_INT: -2147483647}*/:
                return DEVICE_IN_COMMUNICATION_NAME;
            case DEVICE_IN_AMBIENT /*{ENCODED_INT: -2147483646}*/:
            ...
            case DEVICE_IN_REMOTE_SUBMIX /*{ENCODED_INT: -2147483392}*/:
                return "remote_submix";
            case -2147483136:
                return "analog_dock";
            case -2147482624:
            ...
            case -2147418112:
                return "spdif";
            case DEVICE_IN_BLUETOOTH_A2DP /*{ENCODED_INT: -2147352576}*/:
                return "bt_a2dp";
            case -2147221504:
                return DEVICE_IN_LOOPBACK_NAME;
            case DEVICE_IN_IP /*{ENCODED_INT: -2146959360}*/:
                return "ip";
            case DEVICE_IN_BUS /*{ENCODED_INT: -2146435072}*/:
                return "bus";
            case DEVICE_IN_PROXY /*{ENCODED_INT: -2130706432}*/:
                return "proxy";
            case DEVICE_IN_USB_HEADSET /*{ENCODED_INT: -2113929216}*/:
                return "usb_headset";
            case DEVICE_IN_BLUETOOTH_BLE /*{ENCODED_INT: -2080374784}*/:
