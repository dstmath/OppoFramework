...
public final class MediaCodecInfo {
    ...
    public static final class CodecCapabilities {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.media.MediaCodecInfo.CodecCapabilities.<init>(android.media.MediaCodecInfo$CodecProfileLevel[], int[], boolean, android.media.MediaFormat, android.media.MediaFormat):void
         arg types: [android.media.MediaCodecInfo$CodecProfileLevel[], int[], int, android.media.MediaFormat, android.media.MediaFormat]
         candidates:
          android.media.MediaCodecInfo.CodecCapabilities.<init>(android.media.MediaCodecInfo$CodecProfileLevel[], int[], boolean, java.util.Map<java.lang.String, java.lang.Object>, java.util.Map<java.lang.String, java.lang.Object>):void
          android.media.MediaCodecInfo.CodecCapabilities.<init>(android.media.MediaCodecInfo$CodecProfileLevel[], int[], boolean, android.media.MediaFormat, android.media.MediaFormat):void */
    ...
    public static final class AudioCapabilities {
        ...
        private void applyLevelLimits() {
            ...
            Integer valueOf = Integer.valueOf((int) OppoRecorder.NWAV_SAMPLERATE);
            if (equalsIgnoreCase) {
                sampleRates = new int[]{OppoRecorder.NWAV_SAMPLERATE, 11025, 12000, OppoRecorder.NWAV_BYTES_P_SEC, 22050, 24000, 32000, OppoRecorder.HWAV_SAMPLERATE, 48000};
                bitRates = Range.create(valueOf, 320000);
                maxChannels = 2;
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_AMR_NB)) {
                sampleRates = new int[]{8000};
                bitRates = Range.create(4750, Integer.valueOf((int) OppoRecorder.HAMR_BITRATE));
                maxChannels = 1;
                ...
                sampleRates = new int[]{7350, OppoRecorder.NWAV_SAMPLERATE, 11025, 12000, OppoRecorder.NWAV_BYTES_P_SEC, 22050, 24000, 32000, OppoRecorder.HWAV_SAMPLERATE, 48000, 64000, OppoRecorder.HWAV_BYTES_P_SEC, 96000};
                ...
                bitRates = Range.create(Integer.valueOf((int) OppoTelephonyConstant.POLL_DORMANT_MILLIS), 510000);
                sampleRates = new int[]{OppoRecorder.NWAV_SAMPLERATE, 12000, OppoRecorder.NWAV_BYTES_P_SEC, 24000, 48000};
                maxChannels = 255;
                ...
                sampleRates = new int[]{OppoRecorder.HWAV_SAMPLERATE, 48000, 96000, AudioFormat.SAMPLE_RATE_HZ_MAX};
                bitRates = Range.create(Integer.valueOf((int) OppoRecorder.NWAV_BYTES_P_SEC), 2688000);
                maxChannels = 24;
            } else {
    ...
    public static final class VideoCapabilities {
        ...
        private boolean supports(Integer width, Integer height, Number rate) {
            ...
            if (!ok2 || rate == null || rate.intValue() == 0) {
                return ok2;
            }
        ...
        /* JADX INFO: Multiple debug info for r0v48 android.util.Range<java.lang.Integer>: [D('widths' android.util.Range<java.lang.Integer>), D('heights' android.util.Range<java.lang.Integer>)] */
        /* JADX WARNING: Removed duplicated region for block: B:26:0x017d A[SYNTHETIC, Splitter:B:26:0x017d] */
        /* JADX WARNING: Removed duplicated region for block: B:31:0x01ae  */
        /* JADX WARNING: Removed duplicated region for block: B:34:0x01bd A[SYNTHETIC, Splitter:B:34:0x01bd] */
        /* JADX WARNING: Removed duplicated region for block: B:39:0x01eb  */
        /* JADX WARNING: Removed duplicated region for block: B:42:0x0259  */
        /* JADX WARNING: Removed duplicated region for block: B:66:0x02fe  */
        /* JADX WARNING: Removed duplicated region for block: B:68:0x030a  */
        /* JADX WARNING: Removed duplicated region for block: B:70:0x0316  */
        /* JADX WARNING: Removed duplicated region for block: B:72:0x0322  */
        /* JADX WARNING: Removed duplicated region for block: B:74:0x0341  */
        /* JADX WARNING: Removed duplicated region for block: B:76:0x0361  */
        /* JADX WARNING: Removed duplicated region for block: B:78:0x037f  */
        /* JADX WARNING: Removed duplicated region for block: B:80:0x038b  */
        /* JADX WARNING: Removed duplicated region for block: B:82:0x0397  */
        private void parseFromInfo(MediaFormat info) {
            ...
            CodecCapabilities codecCapabilities = this.mParent;
            if (codecCapabilities != null && codecCapabilities.getMimeType().equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AVC) && widths3 != null && widths3.getLower().intValue() == 64) {
                String result = OppoAtlasManager.getInstance(null).getParameters("get_listinfo_byname=codec-size=" + ActivityThread.currentOpPackageName());
                if (result != null && result.equals("true")) {
                    Pair<Range<Integer>, Range<Integer>> sizeRanges_temp = Pair.create(Range.create(64, 3840), Range.create(64, 2160));
                    if (sizeRanges_temp != null) {
                        widths3 = sizeRanges_temp.first;
                        heights4 = sizeRanges_temp.second;
                    }
                }
            }
                ...
                for (int maxDPBBlocks2 = profileLevels3.length; i4 < maxDPBBlocks2; maxDPBBlocks2 = maxDPBBlocks2) {
                    ...
                    if (!(i6 == 1 || i6 == 2)) {
                        if (i6 != 4) {
                            if (i6 != 8) {
                                if (i6 == 16) {
                                    BR5 = BR4 * OppoCommonConstants.PSW_LAST_MESSAGE;
                                } else if (!(i6 == 32 || i6 == 64)) {
                                    if (i6 != 65536) {
                                        if (i6 != 524288) {
                                            ...
                                            if (i18 != 1 && i18 != 2) {
                                                switch (i18) {
                                                    ...
                                                    case 32:
                                                        FR = 30.0d;
                                                        FS5 = 245760;
                                                        BR7 = OppoCommonConstants.PSW_LAST_MESSAGE;
                                                        break;
                                                    case 64:
                                                    case 128:
                                                        FR = 30.0d;
                                                        FS5 = 552960;
                                                        BR7 = OppoTelephonyConstant.POLL_DORMANT_MILLIS;
                                                        break;
                                                    case 256:
                                                    case 512:
                                                        FR = 33.75d;
