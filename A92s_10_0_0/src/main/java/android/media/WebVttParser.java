        ...
        public void parse(String line) {
            if (line.length() != 0) {
                if (line.equals("NOTE") || line.startsWith("NOTE ")) {
                    ...
                    Phase unused = webVttParser.mPhase = webVttParser.mParseCueText;
                }
                ...
                Phase unused3 = webVttParser2.mPhase = webVttParser2.mParseCueTime;
                if (line.contains("-->")) {
    ...
    public final Phase mParseCueText = new Phase() {
        ...
        public void parse(String line) {
            if (line.length() == 0) {
                ...
                WebVttParser webVttParser = WebVttParser.this;
                Phase unused = webVttParser.mPhase = webVttParser.mParseCueId;
    ...
    public final Phase mParseCueTime = new Phase() {
        ...
        public void parse(String line) {
            ...
            if (arrowAt2 < 0) {
                ...
                WebVttParser webVttParser = WebVttParser.this;
                Phase unused2 = webVttParser.mPhase = webVttParser.mParseCueId;
                return;
            }
            int i2 = 0;
            ...
            WebVttParser webVttParser2 = WebVttParser.this;
            Phase unused3 = webVttParser2.mPhase = webVttParser2.mParseCueText;
        }
    };
    /* access modifiers changed from: private */
    public final Phase mParseHeader = new Phase() {
        ...
        public void parse(String line) {
            if (line.length() == 0) {
                ...
                WebVttParser webVttParser2 = WebVttParser.this;
                Phase unused2 = webVttParser2.mPhase = webVttParser2.mParseCueTime;
                WebVttParser.this.mPhase.parse(line);
            } else {
    ...
    private final Phase mParseStart = new Phase() {
        ...
        public void parse(String line) {
            ...
            if (line.equals("WEBVTT") || line.startsWith("WEBVTT ") || line.startsWith("WEBVTT\t")) {
                WebVttParser webVttParser = WebVttParser.this;
                Phase unused = webVttParser.mPhase = webVttParser.mParseHeader;
                return;
            }
            WebVttParser.this.log_warning("Not a WEBVTT header", line);
            WebVttParser webVttParser2 = WebVttParser.this;
            Phase unused2 = webVttParser2.mPhase = webVttParser2.mSkipRest;
        }
    };
    /* access modifiers changed from: private */
