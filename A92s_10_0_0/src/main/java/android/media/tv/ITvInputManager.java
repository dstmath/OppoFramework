            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 9:
                        ...
                        setParentalControlsEnabled(_arg05, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 17:
                        ...
                        setSurface(_arg06, _arg1, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 20:
                        ...
                        tune(_arg07, _arg12, _arg2, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setCaptionEnabled(_arg08, _arg19, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 23:
                        ...
                        sendAppPrivateCommand(_arg09, _arg110, _arg22, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        createOverlayView(_arg010, _arg111, _arg23, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        relayoutOverlayView(_arg011, _arg13, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 28:
                        ...
                        timeShiftPlay(_arg012, _arg14, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 32:
                        ...
                        timeShiftSetPlaybackParams(_arg013, _arg15, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        timeShiftEnablePositionTracking(_arg014, _arg18, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        startRecording(_arg015, _arg16, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        ITvInputHardwareCallback _arg112 = ITvInputHardwareCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg24 = TvInputInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg24 = null;
                        }
                        ITvInputHardware _result7 = acquireTvInputHardware(_arg016, _arg112, _arg24, data.readInt());
                        reply.writeNoException();
                    ...
                    case 40:
                        ...
                        boolean captureFrame = captureFrame(_arg017, _arg17, _arg25, data.readInt());
                        reply.writeNoException();
