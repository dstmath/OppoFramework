    ...
    public TvView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mSurfaceHolderCallback = new SurfaceHolder.Callback() {
            ...
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             method: android.media.tv.TvView.access$302(android.media.tv.TvView, boolean):boolean
             arg types: [android.media.tv.TvView, int]
             candidates:
              android.view.ViewGroup.access$302(android.view.ViewGroup, boolean):boolean
              android.media.tv.TvView.access$302(android.media.tv.TvView, boolean):boolean */
