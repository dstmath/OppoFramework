...
public class TvStreamConfig implements Parcelable {
    ...
    public static final class Builder {
        ...
        public TvStreamConfig build() {
            ...
            int unused = config.mStreamId = this.mStreamId.intValue();
            int unused2 = config.mType = this.mType.intValue();
            int unused3 = config.mMaxWidth = this.mMaxWidth.intValue();
            int unused4 = config.mMaxHeight = this.mMaxHeight.intValue();
            int unused5 = config.mGeneration = this.mGeneration.intValue();
            return config;
        }
    }
