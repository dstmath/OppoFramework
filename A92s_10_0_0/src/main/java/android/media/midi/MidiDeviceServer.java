...
public final class MidiDeviceServer implements Closeable {
    ...
    /* access modifiers changed from: private */
    public final HashMap<MidiInputPort, PortClient> mInputPortClients;
    /* access modifiers changed from: private */
    public final int mInputPortCount;
    private final MidiDispatcher.MidiReceiverFailureHandler mInputPortFailureHandler;
    /* access modifiers changed from: private */
    public final boolean[] mInputPortOpen;
    /* access modifiers changed from: private */
    public final MidiOutputPort[] mInputPortOutputPorts;
    /* access modifiers changed from: private */
    public final MidiReceiver[] mInputPortReceivers;
    /* access modifiers changed from: private */
    public final CopyOnWriteArrayList<MidiInputPort> mInputPorts;
    private boolean mIsClosed;
    private final IMidiManager mMidiManager;
    /* access modifiers changed from: private */
    public final int mOutputPortCount;
    /* access modifiers changed from: private */
    public MidiDispatcher[] mOutputPortDispatchers;
    /* access modifiers changed from: private */
    public final int[] mOutputPortOpenCount;
    /* access modifiers changed from: private */
    public final HashMap<IBinder, PortClient> mPortClients;
        ...
        this.mServer = new IMidiDeviceServer.Stub() {
            ...
            public void setDeviceInfo(MidiDeviceInfo deviceInfo) {
                if (Binder.getCallingUid() != 1000) {
                    ...
                    MidiDeviceInfo unused = MidiDeviceServer.this.mDeviceInfo = deviceInfo;
                } else {
