...
public class MediaPlayer extends PlayerBase implements SubtitleController.Listener, VolumeAutomation, AudioRouting {
    ...
    public MediaPlayer() {
        ...
        if (this.mOppoMediaPlayer == null) {
            ...
            this.mOppoMediaPlayer.setOuterPlayer(this);
        }
    ...
    public void prepare() throws IOException, IllegalStateException {
        if (!this.mOppoMediaPlayer.prepareWithOppoIfNeeded()) {
            try {
                ...
                e.printStackTrace();
                if (!this.mOppoMediaPlayer.handleMediaPlayerError()) {
    ...
    public void startImpl() {
        if (!this.mOppoMediaPlayer.startImplWithOppoIfNeeded()) {
            baseStart();
            stayAwake(true);
            _start();
        }
    ...
    public void release() {
        this.mOppoMediaPlayer.releaseWithOppo();
        this.mContext = null;
        baseRelease();
        stayAwake(false);
        updateSurfaceScreenOn();
    ...
    public TrackInfo[] getTrackInfo() throws IllegalStateException {
        ...
        if (this.mOppoMediaPlayer.isOppoCreate()) {
            return this.mOppoMediaPlayer.getTrackInfoWithOppo();
        }
        ...
        if (this.mSubtitleController == null && ActivityThread.currentApplication() != null) {
            ...
            new Handler(thread.getLooper()).post(new Runnable() {
                ...
                public void run() {
                    ...
                    SubtitleController unused = mediaPlayer.mSubtitleController = new SubtitleController(context, timeProvider, mediaPlayer);
    ...
    public class EventHandler extends Handler {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x008e, code lost:
            ...
            r4.recycle();
            android.media.MediaPlayer.access$2700(r17.this$0).onSubtitleData(r17.mMediaPlayer, r5);
         */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v2, resolved type: android.media.MediaDrm} */
        ...
        private Map<UUID, byte[]> parsePSSH(byte[] pssh, int psshsize) {
            ...
            while (len > 0) {
                ...
                if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                    datalen = ((subset[3] & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP) | ((subset[2] & 255) << 16) | ((subset[1] & 255) << 8) | (subset[0] & 255);
                } else {
                    datalen = ((subset[0] & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP) | ((subset[1] & 255) << 16) | ((subset[2] & 255) << 8) | (subset[3] & 255);
                }
                int i3 = i2 + 4;
                int len3 = len2 - 4;
                if (len3 < datalen) {
