...
public final class AmrInputStream extends InputStream {
    ...
    public AmrInputStream(InputStream inputStream) {
        ...
        format.setInteger(MediaFormat.KEY_SAMPLE_RATE, OppoRecorder.NWAV_SAMPLERATE);
        format.setInteger(MediaFormat.KEY_CHANNEL_COUNT, 1);
        format.setInteger(MediaFormat.KEY_BIT_RATE, OppoRecorder.HAMR_BITRATE);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.media.MediaCodec.releaseOutputBuffer(int, boolean):void
     arg types: [int, int]
     candidates:
