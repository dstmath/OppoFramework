...
public class TestMethod {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.test.suitebuilder.TestMethod.<init>(java.lang.String, java.lang.Class<? extends junit.framework.TestCase>):void
     arg types: [java.lang.String, java.lang.Class<?>]
     candidates:
      android.test.suitebuilder.TestMethod.<init>(java.lang.reflect.Method, java.lang.Class<? extends junit.framework.TestCase>):void
      android.test.suitebuilder.TestMethod.<init>(java.lang.String, java.lang.Class<? extends junit.framework.TestCase>):void */
    ...
    private TestCase instantiateTest(Class testCaseClass, String testName) throws InvocationTargetException, IllegalAccessException, InstantiationException {
        ...
        while (i < length) {
            ...
            if (noargsConstructor(params)) {
                TestCase test = constructor.newInstance(new Object[0]);
                test.setName(testName);
                return test;
            } else if (singleStringConstructor(params)) {
                return constructor.newInstance(testName);
            } else {
                i++;
            }
        }
