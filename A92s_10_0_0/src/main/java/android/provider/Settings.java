...
import android.provider.OppoSettings;
...
public final class Settings {
    ...
    public static class NameValueCache {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x00ac, code lost:
            if (android.provider.Settings.isInSystemServer() == false) goto L_0x00e3;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:56:0x00b6, code lost:
            if (android.os.Binder.getCallingUid() == android.os.Process.myUid()) goto L_0x00e3;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:59:?, code lost:
            r0 = r21.call(r24.getPackageName(), android.provider.Settings.ContentProviderHolder.access$000(r23.mProviderHolder).getAuthority(), r23.mCallGetCommand, r25, r16);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:64:0x00e3, code lost:
            r2 = r21.call(r24.getPackageName(), android.provider.Settings.ContentProviderHolder.access$000(r23.mProviderHolder).getAuthority(), r23.mCallGetCommand, r25, r16);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:76:0x0128, code lost:
            if (r23.mGenerationTracker == null) goto L_0x012f;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:80:0x013d, code lost:
            if (r23.mGenerationTracker == null) goto L_0x014c;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:82:0x0145, code lost:
            if (r13 != r23.mGenerationTracker.getCurrentGeneration()) goto L_0x014c;
         */
        ...
        public String getStringForUser(ContentResolver cr, String name, int userHandle) {
                ...
                synchronized (this) {
                    if (this.mGenerationTracker != null) {
                        if (this.mGenerationTracker.isGenerationChanged()) {
                            ...
                            String str2 = this.mValues.get(name);
                            return str2;
                        }
                        if (this.mGenerationTracker != null) {
            ...
            if (cp == null) {
                Log.w(Settings.TAG, "Can't get provider for " + this.mUri);
                return null;
            }
    ...
    public static final class System extends NameValueTable implements OppoSettings.Mtk_System, OppoSettings.Qcom_System, OppoSettings.Oppo_System {
        ...
        private static final SettingsValidators.Validator SCREEN_AUTO_BRIGHTNESS_ADJ_VALIDATOR = new SettingsValidators.InclusiveFloatRangeValidator(-1.0f, 2047.0f);
        ...
        private static final SettingsValidators.Validator SCREEN_BRIGHTNESS_VALIDATOR = new SettingsValidators.InclusiveIntegerRangeValidator(0, 2047);
        ...
        public static int getIntForUser(ContentResolver cr, String name, int def, int userHandle) {
            ...
            try {
                if (MAX_BRIGHTNESS == 0 && SCREEN_BRIGHTNESS.equals(name)) {
                    MAX_BRIGHTNESS = SystemProperties.getInt("sys.oppo.multibrightness", 0);
                }
                return (!SCREEN_BRIGHTNESS.equals(name) || MAX_BRIGHTNESS <= 255) ? v != null ? Integer.parseInt(v) : def : v != null ? Math.round((float) ((Integer.parseInt(v) * 256) / (MAX_BRIGHTNESS + 1))) : def;
            } catch (NumberFormatException e) {
                return def;
            }
        }
        ...
        public static int getIntForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            ...
            try {
                ...
                if (!SCREEN_BRIGHTNESS.equals(name) || MAX_BRIGHTNESS <= 255) {
        ...
        public static boolean putIntForUser(ContentResolver cr, String name, int value, int userHandle) {
            ...
            if (SCREEN_BRIGHTNESS.equals(name) && (i = MAX_BRIGHTNESS) > 255) {
                value = Math.round((float) (((i + 1) * value) / 256));
            }
    ...
    public static final class Secure extends NameValueTable implements OppoSettings.Mtk_Secure {
        ...
        private static final SettingsValidators.Validator ACCESSIBILITY_CAPTIONING_EDGE_TYPE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE, "2"});
        ...
        private static final SettingsValidators.Validator ACCESSIBILITY_CAPTIONING_PRESET_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{CallerInfo.UNKNOWN_NUMBER, WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE, "2", "3", "4"});
        @UnsupportedAppUsage
        ...
        private static final SettingsValidators.Validator ACCESSIBILITY_DISPLAY_DALTONIZER_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{CallerInfo.UNKNOWN_NUMBER, WifiEnterpriseConfig.ENGINE_DISABLE, "11", "12", "13"});
        ...
        private static final SettingsValidators.Validator INCALL_POWER_BUTTON_BEHAVIOR_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_ENABLE, "2"});
        ...
        private static final SettingsValidators.Validator NAVIGATION_MODE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE, "2"});
        @Deprecated
        public static final String NETWORK_PREFERENCE = "network_preference";
        @UnsupportedAppUsage
        ...
        private static final SettingsValidators.Validator PREFERRED_TTY_MODE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE, "2", "3"});
        ...
        private static final SettingsValidators.Validator VR_DISPLAY_MODE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
    ...
    public static final class Global extends NameValueTable implements OppoSettings.Mtk_Global, OppoSettings.Qcom_Global {
        ...
        private static final SettingsValidators.Validator AUTOMATIC_POWER_SAVE_MODE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
        public static final String AUTO_TIME = "auto_time";
        private static final SettingsValidators.Validator AUTO_TIME_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String AUTO_TIME_ZONE = "auto_time_zone";
        private static final SettingsValidators.Validator AUTO_TIME_ZONE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final SettingsValidators.Validator ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
        ...
        private static final SettingsValidators.Validator LOW_POWER_MODE_STICKY_AUTO_DISABLE_ENABLED_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
        ...
        private static final SettingsValidators.Validator NETWORK_RECOMMENDATIONS_ENABLED_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{CallerInfo.UNKNOWN_NUMBER, WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
