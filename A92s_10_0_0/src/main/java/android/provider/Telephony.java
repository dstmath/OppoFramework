...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static Uri addGroupMessageToUri(ContentResolver resolver, Uri uri, String address, String body, String subject, Long date, boolean read, boolean deliveryReport, long threadId, String dest) {
            ...
            values.put("oppo_mass", (Integer) 1);
        ...
        public static final class Inbox implements BaseColumns, TextBasedSmsColumns {
            ...
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             method: android.provider.Telephony.Sms.addMessageToUri(int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean):android.net.Uri
             arg types: [int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, int]
             candidates:
              android.provider.Telephony.Sms.addMessageToUri(android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean, long):android.net.Uri
              android.provider.Telephony.Sms.addMessageToUri(int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean):android.net.Uri */
            @UnsupportedAppUsage
        ...
        public static final class Sent implements BaseColumns, TextBasedSmsColumns {
            ...
            /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
             method: android.provider.Telephony.Sms.addMessageToUri(int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean):android.net.Uri
             arg types: [int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, int, int]
             candidates:
              android.provider.Telephony.Sms.addMessageToUri(android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean, long):android.net.Uri
              android.provider.Telephony.Sms.addMessageToUri(int, android.content.ContentResolver, android.net.Uri, java.lang.String, java.lang.String, java.lang.String, java.lang.Long, boolean, boolean):android.net.Uri */
            @UnsupportedAppUsage
        ...
        public static final class GroupMsg implements BaseColumns, TextBasedSmsColumns {
            ...
            public static Uri addMessage(ContentResolver resolver, String[] address, int vMsgId, int vType, long threadId) {
                ...
                try {
                    resolver.applyBatch("sms", operationList);
                    return null;
    ...
    public interface RcsColumns {
        ...
        public interface RcsCanonicalAddressHelper {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:22:0x0058, code lost:
                throw r4;
             */
            static default long getOrCreateCanonicalAddressId(ContentResolver contentResolver, String canonicalAddress) {
                ...
                Cursor cursor = contentResolver.query(uriBuilder.build(), null, null, null);
                if (cursor != null) {
                    if (cursor.moveToFirst()) {
