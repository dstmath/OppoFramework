...
public class OppoSettingsSearchUtils {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.provider.OppoSettingsSearchUtils.calculateHightlight(android.widget.ListView, java.lang.String, int, boolean, int):void
     arg types: [android.widget.ListView, java.lang.String, ?, int, int]
     candidates:
      android.provider.OppoSettingsSearchUtils.calculateHightlight(android.preference.PreferenceScreen, android.widget.ListView, java.lang.String, int, int):void
      android.provider.OppoSettingsSearchUtils.calculateHightlight(android.widget.ListView, java.lang.String, int, boolean, int):void */
