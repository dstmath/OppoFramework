...
class GLLogWrapper extends GLWrapperBase {
    ...
    private String toString(int n, ShortBuffer buf) {
        ...
        builder.append("{\n");
        for (int i = 0; i < n; i++) {
            builder.append(" [" + i + "] = " + ((int) buf.get(i)) + 10);
        }
        builder.append("}");
        return builder.toString();
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.opengl.GLLogWrapper.arg(java.lang.String, int):void
     arg types: [java.lang.String, short]
     candidates:
      android.opengl.GLLogWrapper.arg(java.lang.String, float):void
      android.opengl.GLLogWrapper.arg(java.lang.String, java.lang.String):void
      android.opengl.GLLogWrapper.arg(java.lang.String, boolean):void
      android.opengl.GLLogWrapper.arg(java.lang.String, int):void */
    @Override // javax.microedition.khronos.opengles.GL11Ext
    ...
    public void glBufferData(int target, int size, Buffer data, int usage) {
        ...
        arg(DumpHeapActivity.KEY_SIZE, size);
        arg("data", data.toString());
        arg(OppoUsageManager.SERVICE_NAME, usage);
        end();
    ...
    @Override // javax.microedition.khronos.opengles.GL11Ext, javax.microedition.khronos.opengles.GL11
