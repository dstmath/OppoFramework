...
public interface IWifiNanIfaceEventCallback extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.getService(java.lang.String, boolean):android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback
