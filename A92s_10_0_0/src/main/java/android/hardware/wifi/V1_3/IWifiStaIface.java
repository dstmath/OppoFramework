...
public interface IWifiStaIface extends android.hardware.wifi.V1_2.IWifiStaIface {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.wifi.V1_3.IWifiStaIface.getService(java.lang.String, boolean):android.hardware.wifi.V1_3.IWifiStaIface
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.wifi.V1_2.IWifiStaIface.getService(java.lang.String, boolean):android.hardware.wifi.V1_2.IWifiStaIface
      android.hardware.wifi.V1_0.IWifiStaIface.getService(java.lang.String, boolean):android.hardware.wifi.V1_0.IWifiStaIface
      android.hardware.wifi.V1_0.IWifiIface.getService(java.lang.String, boolean):android.hardware.wifi.V1_0.IWifiIface
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.wifi.V1_3.IWifiStaIface.getService(java.lang.String, boolean):android.hardware.wifi.V1_3.IWifiStaIface */
    @Override // android.hardware.wifi.V1_2.IWifiStaIface, android.hardware.wifi.V1_0.IWifiIface, android.hardware.wifi.V1_0.IWifiStaIface, android.hidl.base.V1_0.IBase
