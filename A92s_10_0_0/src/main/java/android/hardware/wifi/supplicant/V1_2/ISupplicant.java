...
public interface ISupplicant extends android.hardware.wifi.supplicant.V1_1.ISupplicant {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.wifi.supplicant.V1_2.ISupplicant.getService(java.lang.String, boolean):android.hardware.wifi.supplicant.V1_2.ISupplicant
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.wifi.supplicant.V1_1.ISupplicant.getService(java.lang.String, boolean):android.hardware.wifi.supplicant.V1_1.ISupplicant
      android.hardware.wifi.supplicant.V1_0.ISupplicant.getService(java.lang.String, boolean):android.hardware.wifi.supplicant.V1_0.ISupplicant
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.wifi.supplicant.V1_2.ISupplicant.getService(java.lang.String, boolean):android.hardware.wifi.supplicant.V1_2.ISupplicant */
    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
