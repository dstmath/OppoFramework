...
public interface IHostapd extends android.hardware.wifi.hostapd.V1_0.IHostapd {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.wifi.hostapd.V1_1.IHostapd.getService(java.lang.String, boolean):android.hardware.wifi.hostapd.V1_1.IHostapd
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.wifi.hostapd.V1_0.IHostapd.getService(java.lang.String, boolean):android.hardware.wifi.hostapd.V1_0.IHostapd
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.wifi.hostapd.V1_1.IHostapd.getService(java.lang.String, boolean):android.hardware.wifi.hostapd.V1_1.IHostapd */
    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
