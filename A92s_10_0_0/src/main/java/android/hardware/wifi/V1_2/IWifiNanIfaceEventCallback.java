...
public interface IWifiNanIfaceEventCallback extends android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback.getService(java.lang.String, boolean):android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback.getService(java.lang.String, boolean):android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback.getService(java.lang.String, boolean):android.hardware.wifi.V1_2.IWifiNanIfaceEventCallback */
    @Override // android.hardware.wifi.V1_0.IWifiNanIfaceEventCallback, android.hidl.base.V1_0.IBase
