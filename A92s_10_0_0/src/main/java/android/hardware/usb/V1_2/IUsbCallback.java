...
public interface IUsbCallback extends android.hardware.usb.V1_1.IUsbCallback {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.usb.V1_2.IUsbCallback.getService(java.lang.String, boolean):android.hardware.usb.V1_2.IUsbCallback
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.usb.V1_1.IUsbCallback.getService(java.lang.String, boolean):android.hardware.usb.V1_1.IUsbCallback
      android.hardware.usb.V1_0.IUsbCallback.getService(java.lang.String, boolean):android.hardware.usb.V1_0.IUsbCallback
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.usb.V1_2.IUsbCallback.getService(java.lang.String, boolean):android.hardware.usb.V1_2.IUsbCallback */
    @Override // android.hardware.usb.V1_1.IUsbCallback, android.hardware.usb.V1_0.IUsbCallback, android.hidl.base.V1_0.IBase
