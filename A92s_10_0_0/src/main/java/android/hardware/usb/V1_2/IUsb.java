...
public interface IUsb extends android.hardware.usb.V1_1.IUsb {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.usb.V1_2.IUsb.getService(java.lang.String, boolean):android.hardware.usb.V1_2.IUsb
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.usb.V1_1.IUsb.getService(java.lang.String, boolean):android.hardware.usb.V1_1.IUsb
      android.hardware.usb.V1_0.IUsb.getService(java.lang.String, boolean):android.hardware.usb.V1_0.IUsb
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hardware.usb.V1_2.IUsb.getService(java.lang.String, boolean):android.hardware.usb.V1_2.IUsb */
    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
