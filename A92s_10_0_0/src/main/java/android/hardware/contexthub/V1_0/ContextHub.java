...
public final class ContextHub {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f0vendor = _hidl_blob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.f0vendor.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
