...
public final class PhysicalSensor {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f1vendor = _hidl_blob.getString(_hidl_offset + 40);
        parcel.readEmbeddedBuffer((long) (this.f1vendor.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 40 + 0, false);
