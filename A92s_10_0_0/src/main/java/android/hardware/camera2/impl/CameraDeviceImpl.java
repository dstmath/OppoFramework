...
public class CameraDeviceImpl extends CameraDevice implements IBinder.DeathRecipient {
    private static final int CAMERA_TIME_HYPNUS_500 = 500;
    ...
    private final Runnable mCallOnClosed = new Runnable() {
        ...
        public void run() {
            ...
            if (!this.mClosedOnce) {
                ...
                long unused = CameraDeviceImpl.this.mDisconnectTime = System.currentTimeMillis();
                CameraDeviceImpl cameraDeviceImpl = CameraDeviceImpl.this;
                cameraDeviceImpl.addInfo(cameraDeviceImpl.mDisconnectTime);
                return;
            }
    ...
    private final Runnable mCallOnOpened = new Runnable() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x001a, code lost:
            r2.onOpened(r4.this$0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001f, code lost:
            android.hardware.camera2.impl.CameraDeviceImpl.access$200(r4.this$0).onOpened(r4.this$0);
            android.hardware.camera2.impl.CameraDeviceImpl.access$302(r4.this$0, java.lang.System.currentTimeMillis());
            android.hardware.camera2.impl.CameraDeviceImpl.access$400(r4.this$0, 0);
         */
    ...
    /* access modifiers changed from: private */
    public void addInfo(long disconnectTime) {
    ...
    public int captureBurst(List<CaptureRequest> requests, CaptureCallback callback, Executor executor) throws CameraAccessException {
        ...
        String str = this.TAG;
        Log.d(str, "mHypnusCtrl is " + this.mHypnusCtrl);
        if (sHM == null) {
            sHM = HypnusManager.getHypnusManager();
        }
        HypnusManager hypnusManager = sHM;
        if (hypnusManager != null && this.mHypnusCtrl) {
            hypnusManager.hypnusSetSignatureAction(15, 500, Hypnus.getLocalSignature());
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0089, code lost:
        r0 = new android.hardware.camera2.impl.CameraDeviceImpl.AnonymousClass10(r23);
        r15 = android.os.Binder.clearCallingIdentity();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:37:?, code lost:
        r14.getExecutor().execute(r0);
     */
            ...
            synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                if (CameraDeviceImpl.this.mRemoteDevice != null) {
                    if (errorCode == 0) {
                        ...
                        String access$700 = CameraDeviceImpl.this.TAG;
                        Log.e(access$700, "Unknown error from camera device: " + errorCode);
                ...
                if (CameraDeviceImpl.this.mRemoteDevice != null) {
                    if (CameraDeviceImpl.this.mRepeatingRequestId != -1) {
                        ...
                        if (CameraDeviceImpl.this.mRepeatingRequestId == repeatingRequestId) {
                            ...
                            int[] unused2 = CameraDeviceImpl.this.mRepeatingRequestTypes = null;
                        }
                    }
                }
            }
                            ...
                            try {
                                resultDispatch = new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (holder.hasBatchedOutputs()) {
                                            for (int i = 0; i < holder.getRequestCount(); i++) {
                                                resultCopy.set(CaptureResult.SENSOR_TIMESTAMP, Long.valueOf(sensorTimestamp - ((((long) (subsequenceId - i)) * 1000000000) / ((long) ((Integer) fpsRange.getUpper()).intValue()))));
