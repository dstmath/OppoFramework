...
public class RequestThreadManager {
    ...
    /* access modifiers changed from: private */
    public final FpsCounter mPrevCounter = new FpsCounter("Incoming Preview");
    ...
    /* access modifiers changed from: private */
    public final FpsCounter mRequestCounter = new FpsCounter("Incoming Requests");
    private final Handler.Callback mRequestHandlerCb = new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            RequestQueue.RequestQueueEntry nextBurst2;
            Handler handler;
            char c;
            ...
            if (i == 1) {
                ...
                RequestQueue.RequestQueueEntry nextBurst3 = RequestThreadManager.this.mRequestQueue.getNext();
                if (nextBurst3 == null) {
                    try {
                        if (!RequestThreadManager.this.mCaptureCollector.waitForEmpty(4000, TimeUnit.MILLISECONDS)) {
                        ...
                        synchronized (RequestThreadManager.this.mIdleLock) {
                            nextBurst3 = RequestThreadManager.this.mRequestQueue.getNext();
                            if (nextBurst3 == null) {
                ...
                List<RequestHolder> requests2 = burstHolder.produceRequestHolders(nextBurst.getFrameNumber().longValue());
                ...
                try {
                    ...
                    Log.e(RequestThreadManager.this.TAG, "Interrupted while waiting for requests to complete: ", e15);
                    RequestThreadManager.this.mDeviceState.setError(1);
                }
                if (RequestThreadManager.this.mGLThreadManager != null) {
    ...
    public void configureOutputs(Collection<Pair<Surface, Size>> outputs) {
        ...
        if (DEBUG) {
            if (outputs == null) {
                ...
                outputsStr = outputs.size() + " surfaces";
            }
