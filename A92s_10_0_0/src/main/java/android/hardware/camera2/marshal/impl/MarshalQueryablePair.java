...
public class MarshalQueryablePair<T1, T2> implements MarshalQueryable<Pair<T1, T2>> {
    ...
    private class MarshalerPair extends Marshaler<Pair<T1, T2>> {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: MutableMD:(android.util.Pair, java.nio.ByteBuffer):void
         arg types: [android.util.Pair<T1, T2>, java.nio.ByteBuffer]
         candidates:
          android.hardware.camera2.marshal.impl.MarshalQueryablePair.MarshalerPair.marshal(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(android.util.Pair, java.nio.ByteBuffer):void */
        @Override // android.hardware.camera2.marshal.Marshaler
