...
public class MarshalQueryableEnum<T extends Enum<T>> implements MarshalQueryable<T> {
    ...
    private class MarshalerEnum extends Marshaler<T> {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: MutableMD:(java.lang.Enum, java.nio.ByteBuffer):void
         arg types: [T, java.nio.ByteBuffer]
         candidates:
          android.hardware.camera2.marshal.impl.MarshalQueryableEnum.MarshalerEnum.marshal(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(java.lang.Enum, java.nio.ByteBuffer):void */
        @Override // android.hardware.camera2.marshal.Marshaler
        public /* bridge */ /* synthetic */ void marshal(Object obj, ByteBuffer byteBuffer) {
            marshal((Enum) ((Enum) obj), byteBuffer);
        }
