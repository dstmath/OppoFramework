...
public class MarshalQueryableRange<T extends Comparable<? super T>> implements MarshalQueryable<Range<T>> {
    ...
    private class MarshalerRange extends Marshaler<Range<T>> {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: MutableMD:(android.util.Range, java.nio.ByteBuffer):void
         arg types: [android.util.Range<T>, java.nio.ByteBuffer]
         candidates:
          android.hardware.camera2.marshal.impl.MarshalQueryableRange.MarshalerRange.marshal(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(java.lang.Object, java.nio.ByteBuffer):void
          MutableMD:(android.util.Range, java.nio.ByteBuffer):void */
        @Override // android.hardware.camera2.marshal.Marshaler
