...
public interface IMediaCasService extends android.hardware.cas.V1_0.IMediaCasService {
    ...
    @Override // android.os.IHwInterface, android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.cas.V1_1.IMediaCasService.getService(java.lang.String, boolean):android.hardware.cas.V1_1.IMediaCasService
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.cas.V1_0.IMediaCasService.getService(java.lang.String, boolean):android.hardware.cas.V1_0.IMediaCasService
      android.internal.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.internal.hidl.base.V1_0.IBase
      android.hardware.cas.V1_1.IMediaCasService.getService(java.lang.String, boolean):android.hardware.cas.V1_1.IMediaCasService */
    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    static default IMediaCasService getService() throws RemoteException {
    ...
    public static final class Proxy implements IMediaCasService {
        ...
        @Override // android.os.IHwInterface, android.hardware.cas.V1_0.IMediaCasService, android.hardware.cas.V1_1.IMediaCasService, android.internal.hidl.base.V1_0.IBase
        ...
        @Override // android.hardware.cas.V1_0.IMediaCasService, android.hardware.cas.V1_1.IMediaCasService, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IMediaCasService {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-33, -6, -51, -66, OppoBaseBatteryStats.ThermalItem.CMD_AUDIOONOFF, -49, -124, 67, 1, 61, -27, -67, -59, 106, -125, 71, -102, -39, 121, -44, -111, -98, -47, 90, 85, -123, 83, -97, 70, 9, 31, 7}, new byte[]{-122, -70, -100, 3, -105, -117, 121, -89, 66, -23, MidiConstants.STATUS_NOTE_ON, 66, OppoBaseBatteryStats.ThermalItem.CMD_AUDIOONOFF, -59, -50, MidiConstants.STATUS_CHANNEL_PRESSURE, 103, 61, 37, -87, 57, -8, 37, 114, -103, 107, -17, -110, 98, 30, 32, OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, OppoBaseBatteryStats.ThermalItem.CMD_RESET, -109, 36, -72, 59, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, android.hardware.cas.V1_0.IMediaCasService, android.hardware.cas.V1_1.IMediaCasService, android.internal.hidl.base.V1_0.IBase
