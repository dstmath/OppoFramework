...
public interface ICas extends android.hardware.cas.V1_0.ICas {
    ...
    @Override // android.os.IHwInterface, android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.cas.V1_1.ICas.getService(java.lang.String, boolean):android.hardware.cas.V1_1.ICas
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.cas.V1_0.ICas.getService(java.lang.String, boolean):android.hardware.cas.V1_0.ICas
      android.internal.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.internal.hidl.base.V1_0.IBase
      android.hardware.cas.V1_1.ICas.getService(java.lang.String, boolean):android.hardware.cas.V1_1.ICas */
    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    static default ICas getService() throws RemoteException {
    ...
    public static final class Proxy implements ICas {
        ...
        @Override // android.hardware.cas.V1_1.ICas, android.os.IHwInterface, android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements ICas {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{68, -56, -119, 84, -77, -62, 1, -78, 111, 100, -4, -37, 111, 39, Byte.MIN_VALUE, 36, -85, 58, -82, -122, 74, -98, 30, -57, 14, -118, 116, 39, 74, -23, -42, -86}, new byte[]{14, 101, 107, -95, -70, -63, OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO, 97, -95, 112, -106, -17, 117, 43, 105, -46, 75, 0, OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF, -126, 14, -11, 101, 47, 1, 80, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, -7, 115, 29, 84, -62}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, OppoBaseBatteryStats.ThermalItem.CMD_RESET, -109, 36, -72, 59, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -54, 76}));
        }
        ...
        @Override // android.hardware.cas.V1_1.ICas, android.os.IHwBinder, android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    int _hidl_out_status = setPrivateData(_hidl_request.readInt8Vector());
                ...
                case 2:
                    ...
                    openSession(new ICas.openSessionCallback() {
                        /* class android.hardware.cas.V1_1.ICas.Stub.AnonymousClass1 */
                ...
                case 3:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status2 = closeSession(_hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status3 = setSessionPrivateData(_hidl_request.readInt8Vector(), _hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 5:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status4 = processEcm(_hidl_request.readInt8Vector(), _hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 6:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status5 = processEmm(_hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 7:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status6 = sendEvent(_hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 8:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status7 = provision(_hidl_request.readString());
                    _hidl_reply.writeStatus(0);
                ...
                case 9:
                    ...
                    _hidl_request.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    int _hidl_out_status8 = refreshEntitlements(_hidl_request.readInt32(), _hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
                ...
                case 11:
                    ...
                    int _hidl_out_status10 = sendSessionEvent(_hidl_request.readInt8Vector(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt8Vector());
                    _hidl_reply.writeStatus(0);
