...
public interface ICas extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.cas.V1_0.ICas.getService(java.lang.String, boolean):android.hardware.cas.V1_0.ICas
            ...
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    openSession(new openSessionCallback() {
                        /* class android.hardware.cas.V1_0.ICas.Stub.AnonymousClass1 */
