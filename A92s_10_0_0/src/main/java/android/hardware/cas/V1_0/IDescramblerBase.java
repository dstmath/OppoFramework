...
public interface IDescramblerBase extends IBase {
    ...
    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.cas.V1_0.IDescramblerBase.getService(java.lang.String, boolean):android.hardware.cas.V1_0.IDescramblerBase
     ...
     candidates:
      ...
      android.hardware.cas.V1_0.IDescramblerBase.getService(java.lang.String, boolean):android.hardware.cas.V1_0.IDescramblerBase */
    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.internal.hidl.base.V1_0.IBase
    static default IDescramblerBase getService() throws RemoteException {
    ...
    public static final class Proxy implements IDescramblerBase {
        ...
        @Override // android.os.IHwInterface, android.hardware.cas.V1_0.IDescramblerBase, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IDescramblerBase {
        ...
        @Override // android.hardware.cas.V1_0.IDescramblerBase, android.os.IHwBinder, android.internal.hidl.base.V1_0.IBase
