...
public interface IMediaCasService extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.cas.V1_0.IMediaCasService.getService(java.lang.String, boolean):android.hardware.cas.V1_0.IMediaCasService
    ...
    public static abstract class Stub extends HwBinder implements IMediaCasService {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-122, -70, -100, 3, -105, -117, 121, -89, 66, -23, MidiConstants.STATUS_NOTE_ON, 66, OppoBaseBatteryStats.ThermalItem.CMD_AUDIOONOFF, -59, -50, MidiConstants.STATUS_CHANNEL_PRESSURE, 103, 61, 37, -87, 57, -8, 37, 114, -103, 107, -17, -110, 98, 30, 32, OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, OppoBaseBatteryStats.ThermalItem.CMD_RESET, -109, 36, -72, 59, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                if (_hidl_code == 3) {
                    ...
                    _hidl_request.enforceInterface(IMediaCasService.kInterfaceName);
                    boolean _hidl_out_result = isDescramblerSupported(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                ...
                _hidl_request.enforceInterface(IMediaCasService.kInterfaceName);
                boolean _hidl_out_result2 = isSystemIdSupported(_hidl_request.readInt32());
                _hidl_reply.writeStatus(0);
