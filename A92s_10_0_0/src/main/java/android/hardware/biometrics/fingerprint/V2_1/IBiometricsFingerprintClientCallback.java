...
public interface IBiometricsFingerprintClientCallback extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.getService(java.lang.String, boolean):android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback
     ...
     candidates:
      ...
      android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback.getService(java.lang.String, boolean):android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback */
    @Override // android.hidl.base.V1_0.IBase
