...
public class FaceManager implements BiometricAuthenticator, BiometricFaceConstants {
    ...
    private IFaceServiceReceiver mServiceReceiver = new IFaceServiceReceiver.Stub() {
        ...
        public void onEnrollResult(long deviceId, int faceId, int remaining) {
            if (FaceManager.DEBUG) {
                Slog.d(FaceManager.TAG, "onEnrollResult!");
            }
        ...
        public void onAcquired(long deviceId, int acquireInfo, int vendorCode) {
            if (FaceManager.DEBUG) {
                Slog.d(FaceManager.TAG, "onAcquired and acquireInfo = " + acquireInfo);
            }
        ...
        public void onAuthenticationSucceeded(long deviceId, Face face, int userId) {
            if (FaceManager.DEBUG) {
                Slog.d(FaceManager.TAG, "onAuthenticationSucceeded!");
            }
        ...
        public void onAuthenticationFailed(long deviceId) {
            if (FaceManager.DEBUG) {
                Slog.d(FaceManager.TAG, "onAuthenticationFailed!");
            }
        ...
        public void onError(long deviceId, int error, int vendorCode) {
            if (FaceManager.DEBUG) {
                Slog.d(FaceManager.TAG, "onError!");
            }
    ...
    public void notifyStopAuthenticationWhenWakeup(String reason) {
        ...
        if (iFaceService != null) {
            try {
                iFaceService.notifyStopAuthenticationWhenWakeup(reason);
            } catch (Exception e) {
    ...
    public void sendErrorResult(long deviceId, int errMsgId, int vendorCode) {
        if (DEBUG) {
            Slog.d(TAG, "sendErrorResult and errMsgId = " + errMsgId);
        }
    ...
    public void sendAcquiredResult(long deviceId, int acquireInfo, int vendorCode) {
        if (DEBUG) {
            Slog.d(TAG, "sendAcquiredResult and acquireInfo = " + acquireInfo);
        }
        AuthenticationCallback authenticationCallback = this.mAuthenticationCallback;
        if (authenticationCallback != null) {
    ...
    /* access modifiers changed from: private */
    public void sendProgressResult(long deviceId, int progressInfo) {
        if (DEBUG) {
