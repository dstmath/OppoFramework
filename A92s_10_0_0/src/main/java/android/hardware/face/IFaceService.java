...
public interface IFaceService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFaceService {
        ...
        static final int TRANSACTION_getEnrollmentTotalTimes = 26;
        static final int TRANSACTION_getFaceProcessMemory = 33;
        static final int TRANSACTION_getFailedAttempts = 28;
        static final int TRANSACTION_getFeature = 21;
        static final int TRANSACTION_getLockoutAttemptDeadline = 27;
        static final int TRANSACTION_getPreviewHeight = 30;
        static final int TRANSACTION_getPreviewWidth = 29;
        static final int TRANSACTION_hasEnrolledFaces = 14;
        static final int TRANSACTION_isHardwareDetected = 11;
        static final int TRANSACTION_notifyFirstUnlockWhenBoot = 25;
        static final int TRANSACTION_notifyStopAuthenticationWhenWakeup = 31;
        ...
        static final int TRANSACTION_resetFaceDaemon = 32;
        ...
        static final int TRANSACTION_setPreviewFrame = 23;
        static final int TRANSACTION_setPreviewSurface = 24;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 25:
                    return "notifyFirstUnlockWhenBoot";
                case 26:
                ...
                case 31:
                    return "notifyStopAuthenticationWhenWakeup";
                case 32:
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 20:
                        ...
                        setFeature(_arg02, _arg13, data.createByteArray(), IFaceServiceReceiver.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 24:
                        ...
                        int _result5 = setPreviewSurface(_arg04, _arg12);
                        reply.writeNoException();
                    ...
                    case 25:
                        ...
                        notifyFirstUnlockWhenBoot(_arg0);
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 27:
                        data.enforceInterface(DESCRIPTOR);
                        long _result7 = getLockoutAttemptDeadline(data.readString());
                        reply.writeNoException();
                        reply.writeLong(_result7);
                        return true;
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = getFailedAttempts(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result8);
                        return true;
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        int _result9 = getPreviewWidth();
                        reply.writeNoException();
                        reply.writeInt(_result9);
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                        int _result10 = getPreviewHeight();
                        reply.writeNoException();
                    ...
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        int _result11 = getFaceProcessMemory();
                        reply.writeNoException();
        ...
        private static class Proxy implements IFaceService {
            ...
            public void setPreviewFrame(IBinder token, Rect rect) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setPreviewFrame(token, rect);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public int setPreviewSurface(IBinder token, Surface surface) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(24, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setPreviewSurface(token, surface);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public void notifyFirstUnlockWhenBoot(boolean isFirstUnlockInPasswordOnlyMode) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(isFirstUnlockInPasswordOnlyMode ? 1 : 0);
                    ...
                    Stub.getDefaultImpl().notifyFirstUnlockWhenBoot(isFirstUnlockInPasswordOnlyMode);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public int getPreviewWidth() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(29, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getPreviewWidth();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public int getPreviewHeight() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(30, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getPreviewHeight();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
            ...
            public void notifyStopAuthenticationWhenWakeup(String reason) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().notifyStopAuthenticationWhenWakeup(reason);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void resetFaceDaemon() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().resetFaceDaemon();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public int getFaceProcessMemory() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(33, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getFaceProcessMemory();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
