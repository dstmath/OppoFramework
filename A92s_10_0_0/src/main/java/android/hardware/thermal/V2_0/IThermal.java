...
public interface IThermal extends android.hardware.thermal.V1_0.IThermal {
    ...
    @Override // android.os.IHwInterface, android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.thermal.V2_0.IThermal.getService(java.lang.String, boolean):android.hardware.thermal.V2_0.IThermal
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.thermal.V1_0.IThermal.getService(java.lang.String, boolean):android.hardware.thermal.V1_0.IThermal
      android.internal.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.internal.hidl.base.V1_0.IBase
      android.hardware.thermal.V2_0.IThermal.getService(java.lang.String, boolean):android.hardware.thermal.V2_0.IThermal */
    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal getService(boolean retry) throws RemoteException {
        return getService(PhoneConstants.APN_TYPE_DEFAULT, retry);
    }

    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase
    static default IThermal getService() throws RemoteException {
    ...
    public static final class Proxy implements IThermal {
        ...
        @Override // android.os.IHwInterface, android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase, android.hardware.thermal.V2_0.IThermal
        ...
        @Override // android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase, android.hardware.thermal.V2_0.IThermal
    ...
    public static abstract class Stub extends HwBinder implements IThermal {
        ...
        @Override // android.os.IHwBinder, android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase, android.hardware.thermal.V2_0.IThermal
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getTemperatures(new IThermal.getTemperaturesCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass1 */
                ...
                case 2:
                    ...
                    getCpuUsages(new IThermal.getCpuUsagesCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass2 */
                ...
                case 3:
                    ...
                    getCoolingDevices(new IThermal.getCoolingDevicesCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass3 */
                ...
                case 4:
                    ...
                    getCurrentTemperatures(_hidl_request.readBool(), _hidl_request.readInt32(), new getCurrentTemperaturesCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass4 */
                ...
                case 5:
                    ...
                    getTemperatureThresholds(_hidl_request.readBool(), _hidl_request.readInt32(), new getTemperatureThresholdsCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass5 */
                ...
                case 8:
                    ...
                    getCurrentCoolingDevices(_hidl_request.readBool(), _hidl_request.readInt32(), new getCurrentCoolingDevicesCallback() {
                        /* class android.hardware.thermal.V2_0.IThermal.Stub.AnonymousClass6 */
