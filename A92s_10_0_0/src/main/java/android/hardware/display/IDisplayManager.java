...
public interface IDisplayManager extends IInterface {
    ...
    void setRotateState(boolean z) throws RemoteException;
    ...
    public static class Default implements IDisplayManager {
        ...
        @Override // android.hardware.display.IDisplayManager
        public void setRotateState(boolean isStart) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IDisplayManager {
        ...
        static final int TRANSACTION_setRotateState = 30;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 15:
                        ...
                        int _result4 = createVirtualDisplay(_arg03, _arg13, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 17:
                        ...
                        setVirtualDisplaySurface(_arg04, _arg1);
                        reply.writeNoException();
                        return true;
                    case 18:
                        data.enforceInterface("android.hardware.display.IDisplayManager");
                    ...
                    case 19:
                        data.enforceInterface("android.hardware.display.IDisplayManager");
                        IVirtualDisplayCallback _arg05 = IVirtualDisplayCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg12 = true;
                        }
                        setVirtualDisplayState(_arg05, _arg12);
                        reply.writeNoException();
                        return true;
                    case 20:
                        data.enforceInterface("android.hardware.display.IDisplayManager");
                ...
                reply.writeString("android.hardware.display.IDisplayManager");
                return true;
            }
        }
        ...
        private static class Proxy implements IDisplayManager {
            ...
            public void setRotateState(boolean isStart) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setRotateState(isStart);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
