...
public interface IInputManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputManager {
        ...
        static final int TRANSACTION_dumpInputDispatcher = 19;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        String _result9 = dumpInputDispatcher();
                        reply.writeNoException();
                    ...
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                        InputMonitor _result11 = monitorGestureInput(data.readString(), data.readInt());
                        reply.writeNoException();
                        if (_result11 != null) {
                            reply.writeInt(1);
            ...
            public String dumpInputDispatcher() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(19, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().dumpInputDispatcher();
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
