            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 10:
                        ...
                        sendKeyEvent(_arg06, _arg1, _arg2);
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        sendVolumeKeyEvent(_arg07, _arg12, _arg22);
                        reply.writeNoException();
                        return true;
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 16:
                        ...
                        setSystemAudioMode(_arg05, IHdmiControlCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 29:
                        ...
                        sendVendorCommand(_arg08, _arg13, _arg23, _arg32);
                        reply.writeNoException();
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 40:
                        ...
                        reportAudioStatus(_arg09, _arg14, _arg24, _arg3);
                        reply.writeNoException();
                        return true;
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
