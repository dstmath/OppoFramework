...
public class FingerprintManager implements BiometricAuthenticator, BiometricFingerprintConstants, IOppoFingerprintManagerEx {
    ...
    /* access modifiers changed from: private */
    public void sendEngineeringInfo(EngineeringInfo info) {
    ...
    /* access modifiers changed from: private */
    public void sendTouchDownEvent(long deviceId, int fingerId, int groupId) {
    ...
    /* access modifiers changed from: private */
    public void sendTouchUpEvent(long deviceId, int fingerId, int groupId) {
    ...
    /* access modifiers changed from: private */
    public void sendImageInfo(OppoFingerprintManagerEx.FingerprintImageInfoBase info) {
        AuthenticationCallback authenticationCallback = this.mAuthenticationCallback;
        if (authenticationCallback != null) {
    ...
    /* access modifiers changed from: private */
    public void sendRemovedResult(long deviceId, int fingerId, int groupId, int remaining) {
