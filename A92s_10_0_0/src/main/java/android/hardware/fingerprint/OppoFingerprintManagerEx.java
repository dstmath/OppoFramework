...
public class OppoFingerprintManagerEx {
    ...
    public static abstract class FingerprintInputCallbackEx extends FingerprintManager.FingerprintInputCallback {
    }

    public static abstract class MonitorEventCallbackEx extends FingerprintManager.MonitorEventCallback {
    }
