...
public interface ISapCallback extends IBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.radio.V1_0.ISapCallback.getService(java.lang.String, boolean):android.hardware.radio.V1_0.ISapCallback
     ...
     candidates:
      ...
      android.hardware.radio.V1_0.ISapCallback.getService(java.lang.String, boolean):android.hardware.radio.V1_0.ISapCallback */
    @Override // android.internal.hidl.base.V1_0.IBase
    ...
    public static final class Proxy implements ISapCallback {
        ...
        @Override // android.os.IHwInterface, android.hardware.radio.V1_0.ISapCallback, android.internal.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements ISapCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-47, -125, -28, 6, -17, 8, -105, -33, 33, OppoBaseBatteryStats.ThermalItem.CMD_THERMALRATIO3, -87, -35, -29, -124, -24, -26, -22, 79, -90, -85, 28, Byte.MAX_VALUE, 111, 40, -26, 91, -121, 1, OppoBaseBatteryStats.ThermalItem.CMD_TOPPROCINFO, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -55, -22}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, OppoBaseBatteryStats.ThermalItem.CMD_RESET, -109, 36, -72, 59, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, android.hardware.radio.V1_0.ISapCallback, android.internal.hidl.base.V1_0.IBase
