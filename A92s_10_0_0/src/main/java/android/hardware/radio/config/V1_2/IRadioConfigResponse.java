...
public interface IRadioConfigResponse extends android.hardware.radio.config.V1_1.IRadioConfigResponse {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.radio.config.V1_2.IRadioConfigResponse.getService(java.lang.String, boolean):android.hardware.radio.config.V1_2.IRadioConfigResponse
     arg types: [java.lang.String, boolean]
     candidates:
      android.hardware.radio.config.V1_1.IRadioConfigResponse.getService(java.lang.String, boolean):android.hardware.radio.config.V1_1.IRadioConfigResponse
      android.hardware.radio.config.V1_0.IRadioConfigResponse.getService(java.lang.String, boolean):android.hardware.radio.config.V1_0.IRadioConfigResponse
      android.hardware.radio.config.V1_2.IRadioConfigResponse.getService(java.lang.String, boolean):android.hardware.radio.config.V1_2.IRadioConfigResponse */
    @Override // android.hardware.radio.config.V1_0.IRadioConfigResponse, android.hardware.radio.config.V1_1.IRadioConfigResponse
    ...
    public static final class Proxy implements IRadioConfigResponse {
        ...
        @Override // android.hardware.radio.config.V1_2.IRadioConfigResponse, android.hardware.radio.config.V1_0.IRadioConfigResponse, android.hardware.radio.config.V1_1.IRadioConfigResponse
        ...
        public void getPhoneCapabilityResponse(RadioResponseInfo info, PhoneCapability phoneCapability) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName);
            info.writeToParcel(_hidl_request);
        ...
        public void getSimSlotsStatusResponse_1_2(RadioResponseInfo info, ArrayList<SimSlotStatus> slotStatus) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IRadioConfigResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IRadioConfigResponse.kInterfaceName, android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName, android.hardware.radio.config.V1_0.IRadioConfigResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    _hidl_request.enforceInterface(android.hardware.radio.config.V1_1.IRadioConfigResponse.kInterfaceName);
                ...
                case 7:
                    ...
                    getSimSlotsStatusResponse_1_2(info7, SimSlotStatus.readVectorFromParcel(_hidl_request));
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:
