...
public interface IRadioConfigIndication extends android.hardware.radio.config.V1_0.IRadioConfigIndication {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.radio.config.V1_1.IRadioConfigIndication.getService(java.lang.String, boolean):android.hardware.radio.config.V1_1.IRadioConfigIndication
