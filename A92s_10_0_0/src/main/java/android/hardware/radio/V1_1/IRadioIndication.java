...
public interface IRadioIndication extends android.hardware.radio.V1_0.IRadioIndication {
    ...
    @Override // android.os.IHwInterface, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.radio.V1_1.IRadioIndication.getService(java.lang.String, boolean):android.hardware.radio.V1_1.IRadioIndication
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-4, -59, -56, -56, -117, -123, -87, -10, 63, -70, 103, -39, -26, 116, -38, 70, 108, 114, -87, -116, -94, -121, MidiConstants.STATUS_SONG_SELECT, 67, -5, 87, 33, MidiConstants.STATUS_CHANNEL_PRESSURE, -104, 113, 63, -122}, new byte[]{92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 29, Byte.MIN_VALUE, -120, -42, -36, -55, 2, 14, 82, -46, -59}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, OppoBaseBatteryStats.ThermalItem.CMD_RESET, -109, 36, -72, 59, OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP, -54, 76}));
        }
        ...
        @Override // android.os.IHwBinder, android.hardware.radio.V1_0.IRadioIndication, android.hardware.radio.V1_1.IRadioIndication, android.internal.hidl.base.V1_0.IBase
