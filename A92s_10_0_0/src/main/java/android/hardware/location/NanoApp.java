...
public class NanoApp implements Parcelable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hardware.location.NanoApp.<init>(long, byte[]):void
     arg types: [int, ?[OBJECT, ARRAY]]
     candidates:
      android.hardware.location.NanoApp.<init>(int, byte[]):void
      android.hardware.location.NanoApp.<init>(android.os.Parcel, android.hardware.location.NanoApp$1):void
      android.hardware.location.NanoApp.<init>(long, byte[]):void */
    public NanoApp() {
        this(0L, (byte[]) null);
