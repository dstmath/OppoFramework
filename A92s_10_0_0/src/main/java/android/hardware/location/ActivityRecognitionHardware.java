    ...
    public class SinkList extends RemoteCallbackList<IActivityRecognitionHardwareSink> {
        ...
        private void disableActivityEventIfEnabled(int activityType, int eventType) {
            if (ActivityRecognitionHardware.this.mSupportedActivitiesEnabledEvents[activityType][eventType] == 1) {
                ...
                Log.e(ActivityRecognitionHardware.TAG, String.format("DisableActivityEvent: activityType=%d, eventType=%d, result=%d", Integer.valueOf(activityType), Integer.valueOf(eventType), Integer.valueOf(result)));
            }
        }
    }
}
