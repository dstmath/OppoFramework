...
public final class GestureUtils {
    ...
    /* JADX INFO: Multiple debug info for r4v2 float[]: [D('rect' android.graphics.RectF), D('strokepoints' float[])] */
    /* JADX INFO: Multiple debug info for r3v3 int: [D('stroke' android.gesture.GestureStroke), D('size' int)] */
    /* JADX INFO: Multiple debug info for r5v2 float[]: [D('pts' float[]), D('gestureWidth' float)] */
