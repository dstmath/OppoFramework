...
public interface IServiceManager extends android.hidl.manager.V1_1.IServiceManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.hidl.manager.V1_2.IServiceManager.getService(java.lang.String, boolean):android.hidl.manager.V1_2.IServiceManager
     arg types: [java.lang.String, boolean]
     candidates:
      android.hidl.manager.V1_1.IServiceManager.getService(java.lang.String, boolean):android.hidl.manager.V1_1.IServiceManager
      android.hidl.manager.V1_0.IServiceManager.getService(java.lang.String, boolean):android.hidl.manager.V1_0.IServiceManager
      android.hidl.base.V1_0.IBase.getService(java.lang.String, boolean):android.hidl.base.V1_0.IBase
      android.hidl.manager.V1_2.IServiceManager.getService(java.lang.String, boolean):android.hidl.manager.V1_2.IServiceManager */
    @Override // android.hidl.manager.V1_1.IServiceManager, android.hidl.manager.V1_0.IServiceManager, android.hidl.base.V1_0.IBase
