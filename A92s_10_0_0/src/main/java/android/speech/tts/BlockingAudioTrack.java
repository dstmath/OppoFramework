...
class BlockingAudioTrack {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.speech.tts.BlockingAudioTrack.clip(float, float, float):float
     arg types: [float, int, int]
     candidates:
      android.speech.tts.BlockingAudioTrack.clip(long, long, long):long
      android.speech.tts.BlockingAudioTrack.clip(float, float, float):float */
