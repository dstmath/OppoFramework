            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        ILocationListener _arg111 = ILocationListener.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg2 = PendingIntent.CREATOR.createFromParcel(data);
                        } else {
                            _arg2 = null;
                        }
                        requestLocationUpdates(_arg0, _arg111, _arg2, data.readString());
                    ...
                    case 9:
                        ...
                        String _result2 = getFromLocation(_arg011, _arg112, _arg25, _arg3, arrayList);
                        reply.writeNoException();
                    ...
                    case 10:
                        ...
                        double _arg113 = data.readDouble();
                        ...
                        String _result3 = getFromLocationName(_arg012, _arg113, _arg26, _arg32, _arg4, _arg5, _arg6, arrayList2);
                        reply.writeNoException();
                    ...
                    case 23:
                        ...
                        boolean startGnssBatch = startGnssBatch(_arg013, _arg17, data.readString());
                        reply.writeNoException();
                    ...
                    case 28:
                        ...
                        List<String> _result9 = getProviders(_arg07, _arg110);
                        reply.writeNoException();
                    ...
                    case 41:
                        ...
                        setTestProviderEnabled(_arg016, _arg18, data.readString());
                        reply.writeNoException();
                        return true;
                    case 42:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 44:
                        ...
                        setTestProviderStatus(_arg017, _arg114, _arg23, data.readLong(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean sendExtraCommand = sendExtraCommand(_arg018, _arg115, _arg24);
                        reply.writeNoException();
                    ...
                    case 51:
                        ...
                        LocAppsOp _arg116 = new LocAppsOp();
                        getLocAppsOp(_arg019, _arg116);
                        reply.writeNoException();
                        reply.writeInt(1);
