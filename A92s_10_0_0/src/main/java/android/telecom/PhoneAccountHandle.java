...
public final class PhoneAccountHandle extends OppoBasePhoneAccountHandle implements Parcelable {
    ...
    @Override // android.os.Parcelable, android.telecom.OppoBasePhoneAccountHandle
