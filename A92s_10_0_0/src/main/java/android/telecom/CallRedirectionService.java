...
public abstract class CallRedirectionService extends Service {
    ...
    public ICallRedirectionAdapter mCallRedirectionAdapter;
    /* access modifiers changed from: private */
    public final Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                try {
                    ICallRedirectionAdapter unused = CallRedirectionService.this.mCallRedirectionAdapter = (ICallRedirectionAdapter) args.arg1;
