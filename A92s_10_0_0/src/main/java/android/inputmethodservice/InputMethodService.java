...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private IColorInputMethodServiceUtils mColorInputMethodServiceUtils;
    ...
    public /* synthetic */ void lambda$new$0$InputMethodService(ViewTreeObserver.InternalInsetsInfo info) {
        ...
        this.mColorInputMethodServiceUtils.onComputeRaise(this.mTmpInsets, getWindow());
    ...
    public void onCreate() {
        ...
        this.mColorInputMethodServiceUtils = (IColorInputMethodServiceUtils) ColorFrameworkFactory.getInstance().getFeature(IColorInputMethodServiceUtils.DEFAULT, new Object[0]);
        this.mColorInputMethodServiceUtils.init(this);
    }
    ...
    public void resetStateForNewConfiguration() {
        ...
        this.mColorInputMethodServiceUtils.updateColorNavigationGuardColorDelay(this.mWindow);
    }
    ...
    public boolean onEvaluateFullscreenMode() {
        ...
        if ((editorInfo == null || (editorInfo.imeOptions & 33554432) == 0) && !this.mColorInputMethodServiceUtils.getDockSide()) {
            return true;
        }
        return false;
    }
    ...
    public void setInputView(View view) {
        ...
        this.mColorInputMethodServiceUtils.updateColorNavigationGuardColor(getWindow());
    }
    ...
    public void showWindow(boolean showInput) {
        ...
        if ((previousImeWindowStatus & 1) == 0) {
            ...
            this.mWindow.show();
            this.mColorInputMethodServiceUtils.updateColorNavigationGuardColor(this.mWindow);
        }
    ...
    public void hideWindow() {
        ...
        if (this.mDecorViewVisible) {
            ...
            this.mColorInputMethodServiceUtils.uploadData(this.mStartTime);
        }
        updateFullscreenMode();
    }
    ...
    /* access modifiers changed from: protected */
    @Override // android.app.Service, android.inputmethodservice.AbstractInputMethodService
