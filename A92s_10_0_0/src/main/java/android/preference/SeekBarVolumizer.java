...
public class SeekBarVolumizer implements SeekBar.OnSeekBarChangeListener, Handler.Callback {
    ...
    public int getVolumeGroupIdForLegacyStreamType(int streamType) {
        ...
        return AudioManager.getAudioProductStrategies().stream().map($$Lambda$SeekBarVolumizer$ezNr2aLs33rVlzIsAVW8OXqqpIs.INSTANCE).filter($$Lambda$SeekBarVolumizer$pv25SFjgAtIix6Vp68yZJoqvQ.INSTANCE).findFirst().orElse(-1).intValue();
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AudioManager.VOLUME_CHANGED_ACTION.equals(action)) {
                ...
                if (SeekBarVolumizer.this.mNotificationOrRing) {
                    ...
                    int unused = seekBarVolumizer.mRingerMode = seekBarVolumizer.mAudioManager.getRingerModeInternal();
                }
                ...
                int unused2 = seekBarVolumizer2.mZenMode = seekBarVolumizer2.mNotificationManager.getZenMode();
                SeekBarVolumizer.this.updateSlider();
                ...
                NotificationManager.Policy unused3 = seekBarVolumizer3.mNotificationPolicy = seekBarVolumizer3.mNotificationManager.getConsolidatedNotificationPolicy();
                SeekBarVolumizer seekBarVolumizer4 = SeekBarVolumizer.this;
                boolean z = false;
                boolean unused4 = seekBarVolumizer4.mAllowAlarms = (seekBarVolumizer4.mNotificationPolicy.priorityCategories & 32) != 0;
                SeekBarVolumizer seekBarVolumizer5 = SeekBarVolumizer.this;
                if ((seekBarVolumizer5.mNotificationPolicy.priorityCategories & 64) != 0) {
                    z = true;
                }
                boolean unused5 = seekBarVolumizer5.mAllowMedia = z;
                SeekBarVolumizer seekBarVolumizer6 = SeekBarVolumizer.this;
                boolean unused6 = seekBarVolumizer6.mAllowRinger = !ZenModeConfig.areAllPriorityOnlyNotificationZenSoundsMuted(seekBarVolumizer6.mNotificationPolicy);
                SeekBarVolumizer.this.updateSlider();
            }
        }
