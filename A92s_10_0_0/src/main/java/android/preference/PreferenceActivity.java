        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                if (header != null && header.fragment != null) {
                    ...
                    Header mappedHeader2 = preferenceActivity2.findBestMatchingHeader(preferenceActivity2.mCurHeader, PreferenceActivity.this.mHeaders);
    ...
    public void loadHeadersFromResource(int resid, List<Header> target) {
        ...
        try {
            try {
                ...
                if ("preference-headers".equals(nodeName2)) {
                                        ...
                                        if (type3 != 3) {
                                            if (type3 != 4) {
                                                ...
                                                if (innerNodeName.equals("extra")) {
                                                    getResources().parseBundleExtra("extra", attrs, curBundle2);
                ...
                throw new RuntimeException("XML document must start with <preference-headers> tag; found" + nodeName2 + " at " + parser.getPositionDescription());
