...
public abstract class OppoSmsMessage implements IOppoSmsMessageEx {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.CharSequence, boolean, int):int[]
     arg types: [java.lang.String, boolean, int]
     candidates:
      android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.String, boolean, int):int[]
      android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.CharSequence, boolean, int):int[] */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.CharSequence, boolean, int, int):int[]
     arg types: [java.lang.String, boolean, int, int]
     candidates:
      android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.String, boolean, int, int):int[]
      android.telephony.OppoSmsMessage.calculateLengthOem(java.lang.CharSequence, boolean, int, int):int[] */
