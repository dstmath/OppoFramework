...
public class PhoneNumberUtils {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.PhoneNumberUtils.compare(java.lang.String, java.lang.String, boolean):boolean
     arg types: [java.lang.String, java.lang.String, int]
     candidates:
      android.telephony.PhoneNumberUtils.compare(android.content.Context, java.lang.String, java.lang.String):boolean
      android.telephony.PhoneNumberUtils.compare(java.lang.String, java.lang.String, boolean):boolean */
    ...
    public static boolean compareLoosely(String a, String b) {
        ...
        int effectiveALen = MIN_MATCH;
        if (matched < effectiveALen) {
            int effectiveALen2 = a.length() - numNonDialableCharsInA;
            return effectiveALen2 == b.length() - numNonDialableCharsInB && effectiveALen2 == matched;
        } else if (matched >= effectiveALen && (ia < 0 || ib < 0)) {
            return true;
        } else {
    ...
    private static void internalCalledPartyBCDFragmentToString(StringBuilder sb, byte[] bytes, int offset, int length, int bcdExtType) {
        ...
        char c2;
        int i = offset;
        while (i < length + offset && (c = bcdToChar((byte) (bytes[i] & 15), bcdExtType)) != 0) {
            sb.append(c);
    ...
    public static byte[] numberToCalledPartyBCD(String number, int bcdExtType) {
        String number2 = OppoTelephonyFunction.stripSeparators(number);
        if (number2 == null) {
            return null;
        }
        return numberToCalledPartyBCDHelper(number2, false, bcdExtType);
    }
    ...
    private static int getMinMatch() {
        Class<?> cls = sMtkPhoneNumberUtils;
        if (cls == null) {
            return 7;
        }
        try {
            return ((Integer) cls.getMethod("getMinMatch", new Class[0]).invoke(null, new Object[0])).intValue();
        } catch (Exception e) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.PhoneNumberUtils.isEmergencyNumberInternal(int, java.lang.String, boolean):boolean
     arg types: [int, java.lang.String, int]
     candidates:
      android.telephony.PhoneNumberUtils.isEmergencyNumberInternal(java.lang.String, java.lang.String, boolean):boolean
      android.telephony.PhoneNumberUtils.isEmergencyNumberInternal(int, java.lang.String, boolean):boolean */
    @UnsupportedAppUsage
    @Deprecated
    ...
    public static String cdmaCheckAndProcessPlusCode(String dialStr) {
        ...
        if (cls != null) {
            try {
                return (String) cls.getMethod("cdmaCheckAndProcessPlusCode", String.class).invoke(null, dialStr);
            } catch (Exception e) {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:11:0x0026 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:10:0x0026 */
    ...
    private static String splitAtNonNumerics(CharSequence number) {
        ...
        while (true) {
            ...
            ? r3 = WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER;
            if (i >= length) {
                return sb.toString().replaceAll(" +", r3).trim();
            }
            if (is12Key(number.charAt(i))) {
                r3 = Character.valueOf(number.charAt(i));
            }
            sb.append(r3);
            i++;
        }
