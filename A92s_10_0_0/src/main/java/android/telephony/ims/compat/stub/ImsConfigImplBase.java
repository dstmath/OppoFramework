...
public class ImsConfigImplBase {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.ims.compat.stub.ImsConfigImplBase.ImsConfigStub.updateCachedValue(int, int, boolean):void
     arg types: [int, int, int]
     candidates:
      android.telephony.ims.compat.stub.ImsConfigImplBase.ImsConfigStub.updateCachedValue(int, java.lang.String, boolean):void
      android.telephony.ims.compat.stub.ImsConfigImplBase.ImsConfigStub.updateCachedValue(int, int, boolean):void */
    public final void notifyProvisionedValueChanged(int item, int value) {
        this.mImsConfigStub.updateCachedValue(item, value, true);
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.ims.compat.stub.ImsConfigImplBase.ImsConfigStub.updateCachedValue(int, java.lang.String, boolean):void
