...
public class ImsRegistrationImplBase {
    ...
    private final IImsRegistration mBinder = new IImsRegistration.Stub() {
        /* class android.telephony.ims.stub.ImsRegistrationImplBase.AnonymousClass1 */
    ...
    public final void onRegistered(int imsRadioTech) {
        ...
        this.mCallbacks.broadcast(new Consumer(imsRadioTech) {
            /* class android.telephony.ims.stub.$$Lambda$ImsRegistrationImplBase$cWwTXSDskbWPbsDJYIDUBMnE */
    ...
    public final void onRegistering(int imsRadioTech) {
        ...
        this.mCallbacks.broadcast(new Consumer(imsRadioTech) {
            /* class android.telephony.ims.stub.$$Lambda$ImsRegistrationImplBase$sbjuTvWbrOSWMR74UInSZEIQB0 */
            private final /* synthetic */ int f$0;
    ...
    public final void onDeregistered(ImsReasonInfo info) {
        ...
        this.mCallbacks.broadcast(new Consumer() {
            /* class android.telephony.ims.stub.$$Lambda$ImsRegistrationImplBase$s7PspXVbCf1Q_WSzodP2glP9TjI */
    ...
    public final void onTechnologyChangeFailed(int imsRadioTech, ImsReasonInfo info) {
        this.mCallbacks.broadcast(new Consumer(imsRadioTech, info) {
            /* class android.telephony.ims.stub.$$Lambda$ImsRegistrationImplBase$wDtW65cPmn_jF6dfimhBTfdg1kI */
            private final /* synthetic */ int f$0;
    ...
    public final void onSubscriberAssociatedUriChanged(Uri[] uris) {
        this.mCallbacks.broadcast(new Consumer(uris) {
            /* class android.telephony.ims.stub.$$Lambda$ImsRegistrationImplBase$wwtkoeOtGwMjG5I0ZTfjNpGUs */
