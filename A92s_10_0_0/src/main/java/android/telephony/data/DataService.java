...
public abstract class DataService extends Service {
    ...
    public class DataServiceHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            DataServiceCallback dataServiceCallback2 = null;
            switch (message.what) {
                case 1:
                ...
                case 5:
                    if (serviceProvider != null) {
                        ...
                        int i4 = deactivateDataCallRequest.cid;
                        int i5 = deactivateDataCallRequest.reason;
                        ...
                        serviceProvider.deactivateDataCall(i4, i5, dataServiceCallback2);
                        return;
                    }
                    return;
                case 6:
                    if (serviceProvider != null) {
                        ...
                        boolean z3 = setInitialAttachApnRequest.isRoaming;
                        if (setInitialAttachApnRequest.callback != null) {
                            dataServiceCallback2 = new DataServiceCallback(setInitialAttachApnRequest.callback);
                        }
                        serviceProvider.setInitialAttachApn(dataProfile2, z3, dataServiceCallback2);
                        return;
                    }
                    return;
                case 7:
                    if (serviceProvider != null) {
                        ...
                        boolean z4 = setDataProfileRequest.isRoaming;
                        if (setDataProfileRequest.callback != null) {
                            dataServiceCallback2 = new DataServiceCallback(setDataProfileRequest.callback);
                        }
                        serviceProvider.setDataProfile(list, z4, dataServiceCallback2);
                        return;
                    }
                    return;
                case 8:
