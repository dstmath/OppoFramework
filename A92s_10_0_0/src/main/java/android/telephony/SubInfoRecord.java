...
public class SubInfoRecord implements Parcelable {
    public static final Parcelable.Creator<SubInfoRecord> CREATOR = new Parcelable.Creator<SubInfoRecord>() {
        ...
        public SubInfoRecord createFromParcel(Parcel source) {
            return new SubInfoRecord(source.readInt(), source.readString(), source.readInt(), source.readCharSequence(), source.readCharSequence(), source.readInt(), source.readInt(), source.readString(), source.readInt(), Bitmap.CREATOR.createFromParcel(source), source.readInt(), source.readInt(), source.readString());
        }
    ...
    public SubInfoRecord(int id, String iccId2, int simSlotIndex, CharSequence displayName2, CharSequence carrierName, int nameSource, int iconTint, String number, int roaming, Bitmap icon, int mcc, int mnc, String countryIso) {
        this.mId = id;
        this.mIccId = iccId2;
        this.mSimSlotIndex = simSlotIndex;
        this.mDisplayName = displayName2;
        ...
        if (displayName2 == null) {
            ...
            this.displayName = displayName2.toString();
        }
    }
