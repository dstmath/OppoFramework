    ...
    public static int singleRafTypeFromString(String rafString) {
        ...
        switch (rafString.hashCode()) {
            ...
            case -908593671:
                ...
                c = 65535;
                break;
            case IColorWindowManagerConstans.BaseLayoutParams.TYPE_SYSTEM_ONSCREEN_FINGERPRINT /*{ENCODED_INT: 2315}*/:
                ...
                c = 65535;
                break;
            case PreciseDisconnectCause.EPDG_TUNNEL_ESTABLISH_FAILURE:
