...
public class MbmsDownloadSession implements AutoCloseable {
    ...
    public static final String LOG_TAG = MbmsDownloadSession.class.getSimpleName();
    @SystemApi
    ...
    /* access modifiers changed from: private */
    public final InternalDownloadSessionCallback mInternalCallback;
    ...
    /* access modifiers changed from: private */
    public AtomicReference<IMbmsDownloadService> mService = new AtomicReference<>(null);
    /* access modifiers changed from: private */
