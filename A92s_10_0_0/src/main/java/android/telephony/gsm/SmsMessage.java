...
public class SmsMessage {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.gsm.SmsMessage.calculateLength(java.lang.CharSequence, boolean):int[]
     arg types: [java.lang.String, boolean]
     candidates:
      android.telephony.gsm.SmsMessage.calculateLength(java.lang.String, boolean):int[]
      android.telephony.gsm.SmsMessage.calculateLength(java.lang.CharSequence, boolean):int[] */
    @Deprecated
