...
public class SmsCbMessage implements Parcelable {
    public static final Parcelable.Creator<SmsCbMessage> CREATOR = new Parcelable.Creator<SmsCbMessage>() {
        /* class android.telephony.SmsCbMessage.AnonymousClass1 */
    ...
    public SmsCbMessage(Parcel in) {
        ...
        if (type == 67) {
            ...
            this.mCmasWarningInfo = makeSmsCbCmasInfo(in);
        } else if (type != 69) {
            this.mEtwsWarningInfo = null;
    ...
    private SmsCbCmasInfo makeSmsCbCmasInfo(Parcel in) {
        ...
        try {
            return (SmsCbCmasInfo) Class.forName("mediatek.telephony.MtkSmsCbCmasInfo").getConstructor(Parcel.class).newInstance(in);
        } catch (Exception e) {
            return new SmsCbCmasInfo(in);
        }
    }
