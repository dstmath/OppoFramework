...
public class SmsMessage extends OppoSmsMessage {
    ...
    public static ArrayList<String> fragmentText(String text, int subId) {
        ...
        if (ted != null) {
            Rlog.d(LOG_TAG, "subId=" + subId + " isCdma=" + isCdma + " codeUnitSize=" + ted.codeUnitSize);
        }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.SmsMessage.calculateLength(java.lang.CharSequence, boolean):int[]
     arg types: [java.lang.String, boolean]
     candidates:
      android.telephony.SmsMessage.calculateLength(java.lang.String, boolean):int[]
      android.telephony.SmsMessage.calculateLength(java.lang.CharSequence, boolean):int[] */
    public static int[] calculateLength(String messageBody, boolean use7bitOnly) {
        return calculateLength((CharSequence) messageBody, use7bitOnly);
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.telephony.SmsMessage.calculateLength(java.lang.CharSequence, boolean, int):int[]
     arg types: [java.lang.String, boolean, int]
     candidates:
      android.telephony.SmsMessage.calculateLength(java.lang.String, boolean, int):int[]
      android.telephony.SmsMessage.calculateLength(java.lang.CharSequence, boolean, int):int[] */
    ...
    public static boolean useCdmaFormatForMoSmsPublic() {
    ...
    public static boolean useCdmaFormatForMoSmsPublic(int subId) {
        return useCdmaFormatForMoSms(subId);
    }
    ...
    @Override // android.telephony.IOppoSmsMessageEx, android.telephony.OppoSmsMessage
