...
public final class SmsManager extends OppoSmsManager {
    ...
    @Override // android.telephony.OppoSmsManager
    ...
    private void resolveSubscriptionForOperation(final SubscriptionResolverResult resolverResult) {
        ...
        boolean isSmsSimPickActivityNeeded2 = checkSimPickActivityNeeded(isSmsSimPickActivityNeeded);
        Rlog.d(TAG, "smspick=" + isSmsSimPickActivityNeeded2 + " subId=" + subId);
        if (!isSmsSimPickActivityNeeded2) {
    ...
    @Override // android.telephony.OppoSmsManager
    public void sendMultipartTextMessagePublic(String destinationAddress, String scAddress, ArrayList<String> parts, ArrayList<PendingIntent> sentIntents, ArrayList<PendingIntent> deliveryIntents, int priority, boolean expectMore, int validityPeriod) {
        sendMultipartTextMessage(destinationAddress, scAddress, parts, sentIntents, deliveryIntents, priority, expectMore, validityPeriod);
    }

    /* access modifiers changed from: protected */
    @Override // android.telephony.OppoSmsManager
    public void notifySmsErrorNoDefaultSetPublic(Context context, List<PendingIntent> pendingIntents) {
        notifySmsErrorNoDefaultSetPublic(context, pendingIntents);
    }

    /* access modifiers changed from: protected */
    @Override // android.telephony.OppoSmsManager
    public void notifySmsErrorNoDefaultSetPublic(Context context, PendingIntent pendingIntent) {
        notifySmsErrorNoDefaultSetPublic(context, pendingIntent);
    }

    /* access modifiers changed from: package-private */
    @Override // android.telephony.OppoSmsManager
    public void resolveSubscriptionForOperationPublic(SubscriptionResolverResult resolverResult) {
        resolveSubscriptionForOperation(resolverResult);
    }

    /* access modifiers changed from: protected */
    @Override // android.telephony.OppoSmsManager
    public void notifySmsGenericErrorPublic(PendingIntent pendingIntent) {
        notifySmsGenericError(pendingIntent);
    }

    /* access modifiers changed from: protected */
    @Override // android.telephony.OppoSmsManager
    public void notifySmsGenericErrorPublic(List<PendingIntent> pendingIntents) {
        notifySmsGenericError(pendingIntents);
    }

    /* access modifiers changed from: protected */
    @Override // android.telephony.OppoSmsManager
    public int getSubscriptionIdOem() {
        return this.mSubId;
    }
                    ...
                    Binder.withCleanCallingIdentity(new FunctionalUtils.ThrowingRunnable(executor, callback, msgs) {
                        ...
                        public final void runOrThrow() {
                            this.f$0.execute(new Runnable(this.f$2) {
                                /* class android.telephony.$$Lambda$SmsManager$9$MaxGOTcrGGV8QvZI0NSA6WUbKA */
    ...
    public static Bundle getMmsConfig(BaseBundle config) {
        ...
        filtered.putBoolean(CONFIG_GROUP_CHAT_DEFAULTS_TO_MMS, config.getBoolean(CONFIG_GROUP_CHAT_DEFAULTS_TO_MMS));
        return filtered;
    }
    ...
    private boolean checkSimPickActivityNeeded(boolean needed) {
        ...
        if (SystemProperties.get("ro.vendor.mtk_telephony_add_on_policy", WifiEnterpriseConfig.ENGINE_DISABLE).equals(WifiEnterpriseConfig.ENGINE_DISABLE)) {
            try {
                Class<?> clazz = Class.forName("mediatek.telephony.MtkSmsManager");
                if (clazz != null) {
                    Method clazzMethod = clazz.getDeclaredMethod("checkSimPickActivityNeeded", Boolean.TYPE);
                    if (clazzMethod != null) {
                        result = ((Boolean) clazzMethod.invoke(null, Boolean.valueOf(result))).booleanValue();
                    } else {
