...
public abstract class PackageManager {
    ...
    public abstract int callInstalldCmd(String str, String str2);
    ...
    public static String installStatusToString(int status) {
        ...
        switch (status) {
            ...
            case INSTALL_FAILED_DUPLICATE_PERMISSION /*{ENCODED_INT: -112}*/:
                return "INSTALL_FAILED_DUPLICATE_PERMISSION";
            case INSTALL_FAILED_USER_RESTRICTED /*{ENCODED_INT: -111}*/:
                return "INSTALL_FAILED_USER_RESTRICTED";
            case -110:
                return "INSTALL_FAILED_INTERNAL_ERROR";
            case INSTALL_PARSE_FAILED_MANIFEST_EMPTY /*{ENCODED_INT: -109}*/:
                return "INSTALL_PARSE_FAILED_MANIFEST_EMPTY";
            case INSTALL_PARSE_FAILED_MANIFEST_MALFORMED /*{ENCODED_INT: -108}*/:
                return "INSTALL_PARSE_FAILED_MANIFEST_MALFORMED";
            case INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID /*{ENCODED_INT: -107}*/:
                return "INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID";
            case INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME /*{ENCODED_INT: -106}*/:
                return "INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME";
            case INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING /*{ENCODED_INT: -105}*/:
                return "INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING";
            case INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES /*{ENCODED_INT: -104}*/:
                return "INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES";
            case INSTALL_PARSE_FAILED_NO_CERTIFICATES /*{ENCODED_INT: -103}*/:
                return "INSTALL_PARSE_FAILED_NO_CERTIFICATES";
            case INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION /*{ENCODED_INT: -102}*/:
    ...
    public boolean setInterceptRuleInfos(List<ColorRuleInfo> list) {
        return false;
    }
    ...
    public void clearCachedIconForActivity(ComponentName activityName) throws NameNotFoundException {
    }
