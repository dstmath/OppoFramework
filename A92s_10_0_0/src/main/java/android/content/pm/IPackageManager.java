...
public interface IPackageManager extends IInterface {
    ...
    int callInstalldCmd(String str, String str2) throws RemoteException;
    ...
    public static class Default implements IPackageManager {
        ...
        @Override // android.content.pm.IPackageManager
        public boolean inPmsWhiteList(int type, String verifyStr, List<String> list) throws RemoteException {
            return false;
        }
        ...
        @Override // android.content.pm.IPackageManager
        public int callInstalldCmd(String path, String cmd) throws RemoteException {
            return 0;
        }
    ...
    public static abstract class Stub extends Binder implements IPackageManager {
        ...
        static final int TRANSACTION_callInstalldCmd = 220;
        static final int TRANSACTION_canForwardTo = 47;
        static final int TRANSACTION_canRequestPackageInstalls = 188;
        ...
        static final int TRANSACTION_deletePreloadsFileCache = 189;
        ...
        static final int TRANSACTION_getAppPredictionServicePackageName = 202;
        ...
        static final int TRANSACTION_getArtManager = 194;
        static final int TRANSACTION_getAttentionServicePackageName = 200;
        ...
        static final int TRANSACTION_getCptListByType = 219;
        static final int TRANSACTION_getDeclaredSharedLibraries = 187;
        ...
        static final int TRANSACTION_getHarmfulAppWarning = 196;
        static final int TRANSACTION_getHomeActivities = 91;
        static final int TRANSACTION_getIncidentReportApproverPackageName = 204;
        static final int TRANSACTION_getInstallLocation = 133;
        static final int TRANSACTION_getInstallReason = 185;
        static final int TRANSACTION_getInstalledApplications = 56;
        static final int TRANSACTION_getInstalledModules = 207;
        static final int TRANSACTION_getInstalledPackages = 54;
        static final int TRANSACTION_getInstallerPackageName = 68;
        static final int TRANSACTION_getInstantAppAndroidId = 193;
        static final int TRANSACTION_getInstantAppCookie = 173;
        static final int TRANSACTION_getInstantAppIcon = 175;
        static final int TRANSACTION_getInstantAppInstallerComponent = 192;
        static final int TRANSACTION_getInstantAppResolverComponent = 190;
        static final int TRANSACTION_getInstantAppResolverSettingsComponent = 191;
        ...
        static final int TRANSACTION_getModuleInfo = 208;
        ...
        static final int TRANSACTION_getOppoSystemAvailableFeatures = 214;
        ...
        static final int TRANSACTION_getSystemCaptionsServicePackageName = 203;
        static final int TRANSACTION_getSystemSharedLibraryNames = 107;
        static final int TRANSACTION_getSystemTextClassifierPackageName = 199;
        ...
        static final int TRANSACTION_getWellbeingPackageName = 201;
        ...
        static final int TRANSACTION_hasSigningCertificate = 197;
        static final int TRANSACTION_hasSystemFeature = 109;
        static final int TRANSACTION_hasSystemUidErrors = 113;
        static final int TRANSACTION_hasUidSigningCertificate = 198;
        static final int TRANSACTION_inCptWhiteList = 183;
        static final int TRANSACTION_inPmsWhiteList = 216;
        static final int TRANSACTION_installExistingPackageAsUser = 134;
        static final int TRANSACTION_isClosedSuperFirewall = 212;
        static final int TRANSACTION_isDeviceUpgrading = 147;
        static final int TRANSACTION_isFirstBoot = 145;
        static final int TRANSACTION_isFullFunctionMode = 211;
        ...
        static final int TRANSACTION_isPackageStateProtected = 205;
        ...
        static final int TRANSACTION_isSystemDataApp = 215;
        static final int TRANSACTION_isUidPrivileged = 43;
        static final int TRANSACTION_loadRegionFeature = 213;
        ...
        static final int TRANSACTION_notifyPackagesReplacedReceived = 217;
        ...
        static final int TRANSACTION_sendCptUpload = 184;
        static final int TRANSACTION_sendDeviceCustomizationReadyBroadcast = 206;
        static final int TRANSACTION_sendMapCommonDcsUpload = 218;
        ...
        static final int TRANSACTION_setHarmfulAppWarning = 195;
        ...
        static final int TRANSACTION_setRuntimePermissionsVersion = 210;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 211:
                    return "isFullFunctionMode";
                case 212:
                    return "isClosedSuperFirewall";
                case 213:
                    return "loadRegionFeature";
                case 214:
                    return "getOppoSystemAvailableFeatures";
                case 215:
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 49:
                        ...
                        Intent[] _arg115 = (Intent[]) data.createTypedArray(Intent.CREATOR);
                        ...
                        ParceledListSlice _result33 = queryIntentActivityOptions(_arg012, _arg115, _arg24, _arg3, data.readString(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        if (_result33 != null) {
                            reply.writeInt(1);
                    ...
                    case 71:
                        ...
                        setLastChosenActivity(_arg020, _arg116, _arg25, _arg32, _arg42, _arg5);
                        reply.writeNoException();
                        return true;
                    case 72:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        addPreferredActivity(_arg021, _arg117, _arg26, _arg33, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 73:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        ComponentName[] _arg27 = (ComponentName[]) data.createTypedArray(ComponentName.CREATOR);
                        if (data.readInt() != 0) {
                            _arg34 = ComponentName.CREATOR.createFromParcel(data);
                        } else {
                            _arg34 = null;
                        }
                        replacePreferredActivity(_arg022, _arg118, _arg27, _arg34, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 74:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 81:
                        ...
                        String[] _result50 = setPackagesSuspendedAsUser(_arg031, _arg119, _arg2, _arg35, _arg4, data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 99:
                        ...
                        setPackageStoppedState(_arg032, _arg114, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 100:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 101:
                        ...
                        freeStorage(_arg033, _arg120, _arg28, _arg36);
                        reply.writeNoException();
                        return true;
                    case 102:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 118:
                        ...
                        registerDexModule(_arg034, _arg121, _arg23, IDexModuleRegisterCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    case 119:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 120:
                        ...
                        boolean performDexOptSecondary = performDexOptSecondary(_arg035, _arg122, _arg22);
                        reply.writeNoException();
                    ...
                    case 148:
                        ...
                        setPermissionEnforced(_arg036, _arg113);
                        reply.writeNoException();
                        return true;
                    case 149:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 151:
                        ...
                        boolean applicationHiddenSettingAsUser = setApplicationHiddenSettingAsUser(_arg037, _arg112, data.readInt());
                        reply.writeNoException();
                    ...
                    case 153:
                        ...
                        setSystemAppHiddenUntilInstalled(_arg038, _arg111);
                        reply.writeNoException();
                        return true;
                    case 154:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean systemAppInstallState = setSystemAppInstallState(_arg039, _arg110, data.readInt());
                        reply.writeNoException();
                    ...
                    case 156:
                        ...
                        boolean blockUninstallForUser = setBlockUninstallForUser(_arg040, _arg19, data.readInt());
                        reply.writeNoException();
                    ...
                    case 177:
                        ...
                        boolean requiredForSystemUser = setRequiredForSystemUser(_arg043, _arg18);
                        reply.writeNoException();
                    ...
                    case 178:
                        ...
                        setUpdateAvailable(_arg044, _arg17);
                        reply.writeNoException();
                        return true;
                    case 179:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 183:
                        data.enforceInterface(DESCRIPTOR);
                        boolean inCptWhiteList = inCptWhiteList(data.readInt(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(inCptWhiteList ? 1 : 0);
                        return true;
                    case 184:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 207:
                        data.enforceInterface(DESCRIPTOR);
                        List<ModuleInfo> _result96 = getInstalledModules(data.readInt());
                        reply.writeNoException();
                        reply.writeTypedList(_result96);
                        return true;
                    case 208:
                        data.enforceInterface(DESCRIPTOR);
                        ModuleInfo _result97 = getModuleInfo(data.readString(), data.readInt());
                        reply.writeNoException();
                        if (_result97 != null) {
                            reply.writeInt(1);
                    ...
                    case 209:
                        data.enforceInterface(DESCRIPTOR);
                        int _result98 = getRuntimePermissionsVersion(data.readInt());
                        reply.writeNoException();
                    ...
                    case 211:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isFullFunctionMode = isFullFunctionMode();
                        reply.writeNoException();
                        reply.writeInt(isFullFunctionMode ? 1 : 0);
                        return true;
                    case 212:
                        data.enforceInterface(DESCRIPTOR);
                        boolean isClosedSuperFirewall = isClosedSuperFirewall();
                        reply.writeNoException();
                        reply.writeInt(isClosedSuperFirewall ? 1 : 0);
                        return true;
                    case 213:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 214:
                        data.enforceInterface(DESCRIPTOR);
                        FeatureInfo[] _result99 = getOppoSystemAvailableFeatures();
                        reply.writeNoException();
                    ...
                    case 218:
                        data.enforceInterface(DESCRIPTOR);
                        sendMapCommonDcsUpload(data.readString(), data.readString(), data.readHashMap(getClass().getClassLoader()));
                        reply.writeNoException();
                        return true;
                    case 219:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _result100 = getCptListByType(data.readInt());
                        reply.writeNoException();
                        reply.writeStringList(_result100);
                        return true;
                    case 220:
                        data.enforceInterface(DESCRIPTOR);
                        int _result101 = callInstalldCmd(data.readString(), data.readString());
                        reply.writeNoException();
        ...
        private static class Proxy implements IPackageManager {
            ...
            public boolean inCptWhiteList(int type, String verifyStr) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(183, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().inCptWhiteList(type, verifyStr);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void sendCptUpload(String pkgName, String point) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().sendCptUpload(pkgName, point);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean isFullFunctionMode() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(211, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isFullFunctionMode();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean isClosedSuperFirewall() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(212, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isClosedSuperFirewall();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean loadRegionFeature(String name) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(213, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().loadRegionFeature(name);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public FeatureInfo[] getOppoSystemAvailableFeatures() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(214, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getOppoSystemAvailableFeatures();
                    }
                    _reply.readException();
            ...
            public boolean isSystemDataApp(String packageName) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(215, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isSystemDataApp(packageName);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean inPmsWhiteList(int type, String verifyStr, List<String> defaultList) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(216, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().inPmsWhiteList(type, verifyStr, defaultList);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void sendMapCommonDcsUpload(String logTag, String eventId, Map map) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().sendMapCommonDcsUpload(logTag, eventId, map);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public List<String> getCptListByType(int tag) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(219, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCptListByType(tag);
                    }
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    _reply.recycle();
            ...
            public int callInstalldCmd(String path, String cmd) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(220, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().callInstalldCmd(path, cmd);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    _reply.recycle();
