...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    private OppoApplicationInfoEx.OverrideDensityChangedListener mChangingListener;
    private int mHiddenApiPolicy;
    public OppoApplicationInfoEx mOppoApplicationInfoEx;
    ...
    public float newappscale;
    public int oppoPrivateFlags;
    ...
    public void dump(Printer pw, String prefix, int dumpFlags) {
        ...
        if ((dumpFlags & 1) != 0) {
            ...
            String str2 = "true";
            sb.append(hasRtlSupport() ? str2 : "false");
    ...
    public ApplicationInfo() {
        ...
        this.mOppoApplicationInfoEx = null;
        this.mChangingListener = new OppoApplicationInfoEx.OverrideDensityChangedListener() {
            /* class android.content.pm.ApplicationInfo.AnonymousClass2 */

            @Override // android.content.pm.OppoApplicationInfoEx.OverrideDensityChangedListener
            public void onOverrideDensityChanged(int newValue) {
                ApplicationInfo.this.overrideDensity = newValue;
            }
        };
        this.mOppoApplicationInfoEx = new OppoApplicationInfoEx();
        this.mOppoApplicationInfoEx.setOverrideDensityChangedListener(this.mChangingListener);
    }

    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "Changwei.Li@ROM.SDK : Modify for display compat", property = OppoHook.OppoRomType.ROM)
    public ApplicationInfo(ApplicationInfo orig) {
        ...
        OppoApplicationInfoEx oppoApplicationInfoEx = orig.mOppoApplicationInfoEx;
        if (oppoApplicationInfoEx != null) {
            this.mOppoApplicationInfoEx = new OppoApplicationInfoEx(oppoApplicationInfoEx);
            this.mOppoApplicationInfoEx.setOverrideDensityChangedListener(this.mChangingListener);
        }
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        OppoApplicationInfoEx oppoApplicationInfoEx = this.mOppoApplicationInfoEx;
        if (oppoApplicationInfoEx != null) {
            oppoApplicationInfoEx.writeToParcel(dest, parcelableFlags);
        }
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.mOppoApplicationInfoEx = new OppoApplicationInfoEx(source);
        this.mOppoApplicationInfoEx.setOverrideDensityChangedListener(this.mChangingListener);
    ...
    private boolean isAllowedToUseHiddenApis() {
        OppoApplicationInfoEx oppoApplicationInfoEx;
        if (isSignedWithPlatformKey()) {
            return true;
        }
        if (!SystemProperties.getBoolean("persist.sys.assert.hide", true) && (oppoApplicationInfoEx = this.mOppoApplicationInfoEx) != null && oppoApplicationInfoEx.isSignedWithOppoKey()) {
            return true;
        }
