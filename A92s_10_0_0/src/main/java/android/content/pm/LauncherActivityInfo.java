...
public class LauncherActivityInfo {
    ...
    public Drawable getIcon(int density) {
        ...
        Drawable icon = null;
        if (!(((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).isColorIcons() || density == 0 || iconRes == 0)) {
            try {
    ...
    public Drawable getBadgedIcon(int density) {
        return ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).getBadgedIcon(this, density, this.mPm, this.mUser, this.mActivityInfo);
    }
}
