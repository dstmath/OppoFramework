...
public class PackageParser extends ColorBasePackageParser {
    ...
    private boolean packageCacheIsValid(File packageFile, byte[] bytes) {
        boolean isValid = true;
        Parcel p = Parcel.obtain();
        p.unmarshall(bytes, 0, bytes.length);
        p.setDataPosition(0);
        int dataSize = p.dataSize();
        int poolPosition = p.readInt();
        if (poolPosition <= 0 || poolPosition > dataSize) {
            Slog.w(TAG, "The package cache of " + packageFile.getAbsolutePath() + " is bad, poolPosition = " + poolPosition + " dataSize = " + dataSize);
            isValid = false;
        }
        p.recycle();
        return isValid;
    ...
    private Package getCachedResult(File packageFile, int flags) {
        ...
        try {
            ...
            if (!packageCacheIsValid(packageFile, bytes)) {
                return null;
            }
    ...
    private Package parseBaseApk(File apkFile, AssetManager assets, int flags) throws PackageParserException {
        ...
        try {
            ...
            if (cookie != 0) {
                ...
                Package pkg = parseBaseApk(apkPath, new Resources(assets, this.mMetrics, null), parser, flags, outError);
                if (pkg != null) {
    ...
    private static Pair<String, String> parsePackageSplitNames(XmlPullParser parser, AttributeSet attrs) throws IOException, XmlPullParserException, PackageParserException {
        ...
        if (type != 2) {
            ...
            if ("android".equals(packageName) || (error = ColorBasePackageParser.hookNameError(packageName, validateName(packageName, true, true))) == null) {
    ...
    /* JADX INFO: Multiple debug info for r22v13 'supportsXLargeScreens'  int: [D('supportsXLargeScreens' int), D('resizeable' int)] */
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x028b, code lost:
        return null;
     */
    private Package parseBaseApkCommon(Package pkg, Set<String> acceptedTags, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        this.mParseInstrumentationArgs = null;
        TypedArray sa2 = res.obtainAttributes(parser, R.styleable.AndroidManifest);
        String str2 = sa2.getNonConfigurationString(0, 0);
        int i = 1;
        if (str2 != null && str2.length() > 0) {
            String nameError = ColorBasePackageParser.hookNameError(pkg.packageName, validateName(str2, true, false));
        ...
        int targetSandboxVersion3 = sa2.getInteger(7, 1);
        pkg.applicationInfo.targetSandboxVersion = targetSandboxVersion3;
        if ((flags & 8) != 0) {
            pkg.applicationInfo.flags |= 262144;
        }
        if (sa2.getBoolean(6, false)) {
        ...
        while (true) {
            ...
            if (type != i) {
                if (type == 3 && parser.getDepth() <= outerDepth2) {
                    ...
                    supportsXLargeScreens2 = resizeable;
                    ...
                    if (set == null || set.contains(tagName)) {
                        if (!tagName.equals(TAG_APPLICATION)) {
                            ...
                            if (tagName.equals("overlay")) {
                                TypedArray sa4 = res.obtainAttributes(parser, R.styleable.AndroidManifestResourceOverlay);
                                pkg.mOverlayTarget = sa4.getString(1);
                                pkg.mOverlayTargetName = sa4.getString(3);
                                pkg.mOverlayCategory = sa4.getString(2);
                                pkg.mOverlayPriority = sa4.getInt(0, 0);
                                pkg.mOverlayIsStatic = sa4.getBoolean(4, false);
                                String propName = sa4.getString(5);
                                String propValue = sa4.getString(6);
                                sa4.recycle();
                                if (pkg.mOverlayTarget == null) {
                                    ...
                                    supportsLargeScreens3 = resizeable;
                                    supportsLargeScreens4 = anyDensity5;
                                ...
                                if (tagName.equals(TAG_KEY_SETS)) {
                                    ...
                                    if (tagName.equals("permission")) {
                                        ...
                                        if (tagName.equals(TAG_USES_PERMISSION_SDK_M)) {
                                            ...
                                            TypedArray sa5 = res.obtainAttributes(parser, R.styleable.AndroidManifestUsesConfiguration);
                                            cPref.reqTouchScreen = sa5.getInt(0, 0);
                                            cPref.reqKeyboardType = sa5.getInt(1, 0);
                                            if (sa5.getBoolean(2, false)) {
                                                cPref.reqInputFeatures |= 1;
                                            }
                                            cPref.reqNavigation = sa5.getInt(3, 0);
                                            if (sa5.getBoolean(4, false)) {
                                            ...
                                            while (true) {
                                                int type2 = parser.next();
                                                if (type2 != 1) {
                                                    if (type2 == 3 && parser.getDepth() <= innerDepth) {
                                                        break;
                                            ...
                                            if (tagName.equals(TAG_USES_SDK)) {
                                                if (SDK_VERSION > 0) {
                                                    TypedArray sa6 = res.obtainAttributes(parser, R.styleable.AndroidManifestUsesSdk);
                                                    int minVers = 1;
                                                    String minCode = null;
                                                    int targetVers = 0;
                                                    String targetCode = null;
                                                    TypedValue val = sa6.peekValue(0);
                                                    if (val != null) {
                                                    ...
                                                    TypedValue val2 = sa6.peekValue(1);
                                                    if (val2 == null) {
                                                        targetVers = minVers;
                                                        targetCode = minCode;
                                                ...
                                                TypedArray sa7 = res.obtainAttributes(parser, R.styleable.AndroidManifestSupportsScreens);
                                                pkg.applicationInfo.requiresSmallestWidthDp = sa7.getInteger(6, 0);
                                                pkg.applicationInfo.compatibleWidthLimitDp = sa7.getInteger(7, 0);
                                                pkg.applicationInfo.largestWidthLimitDp = sa7.getInteger(8, 0);
                                                int supportsSmallScreens4 = sa7.getInteger(1, supportsSmallScreens2);
                                                int supportsNormalScreens4 = sa7.getInteger(2, supportsNormalScreens3);
                                                supportsLargeScreens2 = sa7.getInteger(3, supportsLargeScreens2);
                                                int supportsXLargeScreens6 = sa7.getInteger(5, supportsXLargeScreens5);
                                                supportsLargeScreens3 = sa7.getInteger(4, resizeable);
                                                supportsLargeScreens4 = sa7.getInteger(0, anyDensity5);
                                                sa7.recycle();
                                                XmlUtils.skipCurrentTag(parser);
                                                sa3 = sa7;
                                                ...
                                                if (tagName.equals(TAG_PROTECTED_BROADCAST)) {
                                                    TypedArray sa8 = res.obtainAttributes(parser, R.styleable.AndroidManifestProtectedBroadcast);
                                                    String name = sa8.getNonResourceString(0);
                                                    sa8.recycle();
                                                    if (name != null) {
                                                    ...
                                                    anyDensity4 = supportsLargeScreens4;
                                                    targetSandboxVersion = 1;
                                                } else if (tagName.equals(TAG_ORIGINAL_PACKAGE)) {
                                                    TypedArray sa9 = res.obtainAttributes(parser, R.styleable.AndroidManifestOriginalPackage);
                                                    String orig = sa9.getNonConfigurationString(0, 0);
                                                    ...
                                                    TypedArray sa10 = res.obtainAttributes(parser, R.styleable.AndroidManifestOriginalPackage);
                                                    String name2 = sa10.getNonConfigurationString(0, 0);
                                                    sa10.recycle();
                                                    if (name2 != null) {
                                                    ...
                                                    XmlUtils.skipCurrentTag(parser);
                                                    anyDensity2 = supportsLargeScreens4;
                                                    targetSandboxVersion = 1;
                                                    ...
                                                    if (tagName.equals(TAG_RESTRICT_UPDATE)) {
                                                        if ((flags & 16) != 0) {
                                                            TypedArray sa11 = res.obtainAttributes(parser, R.styleable.AndroidManifestRestrictUpdate);
                                                            String hash = sa11.getNonConfigurationString(0, 0);
                                                            sa11.recycle();
                                                            ...
                                                            if (hash != null) {
                                                                ...
                                                                int i2 = 0;
                                                                while (i2 < hashLength) {
                                                                    hashBytes[i2 / 2] = (byte) ((Character.digit(hash.charAt(i2), 16) << 4) + Character.digit(hash.charAt(i2 + 1), 16));
                                                                    i2 += 2;
                                                                    sa11 = sa11;
                                                                }
                                                                sa = sa11;
                                                        ...
                                                        supportsNormalScreens3 = supportsNormalScreens2;
                                                        supportsLargeScreens3 = supportsXLargeScreens3;
                                                        supportsLargeScreens4 = anyDensity2;
                                                        sa3 = sa;
                                                        foundApp3 = foundApp2;
                                                        supportsXLargeScreens5 = supportsXLargeScreens4;
                                                    } else {
                                ...
                                supportsNormalScreens3 = supportsNormalScreens2;
                                supportsLargeScreens3 = supportsXLargeScreens3;
                                supportsLargeScreens4 = anyDensity4;
                                foundApp3 = foundApp2;
                                supportsXLargeScreens5 = supportsXLargeScreens4;
                            }
                        } else if (foundApp3) {
                            ...
                            supportsSmallScreens3 = supportsSmallScreens3;
                            targetSandboxVersion = 1;
                            supportsLargeScreens2 = supportsLargeScreens5;
                            supportsLargeScreens3 = resizeable;
                            supportsLargeScreens4 = anyDensity5;
                        ...
                        resizeable = supportsLargeScreens3;
                        str2 = str;
                        outerDepth2 = outerDepth;
                        targetSandboxVersion3 = targetSandboxVersion2;
                        i = targetSandboxVersion;
                        anyDensity5 = supportsLargeScreens4;
                    } else {
                ...
                supportsNormalScreens3 = supportsNormalScreens2;
                outerDepth2 = outerDepth;
                resizeable = supportsXLargeScreens3;
                targetSandboxVersion3 = targetSandboxVersion2;
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:276:0x068a, code lost:
        return false;
     */
    @UnsupportedAppUsage
    private boolean parseBaseApplication(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError) throws XmlPullParserException, IOException {
        ...
        String pkgName4 = packageR.applicationInfo.packageName;
        ...
        if (restrictedAccountType != null && restrictedAccountType.length() > 0) {
            packageR.mRestrictedAccountType = restrictedAccountType;
        }
        ...
        packageR.baseHardwareAccelerated = sa.getBoolean(23, packageR.applicationInfo.targetSdkVersion >= 14);
        ...
        if (packageR.parentPackage == null && sa.getBoolean(15, false)) {
            ai3.flags |= 256;
        }
        if (sa.getBoolean(24, false)) {
            ai3.flags |= 1048576;
        }
        if (sa.getBoolean(36, packageR.applicationInfo.targetSdkVersion < 28)) {
            ai3.flags |= 134217728;
        }
        ...
        if (sa.getBoolean(55, packageR.applicationInfo.targetSdkVersion >= 29)) {
            ai3.privateFlags |= 134217728;
        }
        if (sa.getBoolean(56, packageR.applicationInfo.targetSdkVersion < 29)) {
        ...
        String str5 = sa.getNonConfigurationString(6, 0);
        ai3.permission = (str5 == null || str5.length() <= 0) ? null : str5.intern();
            ...
            if (type != z) {
                ...
                if (type == 3) {
                    ...
                    if (tagName.equals("activity")) {
                        innerDepth = innerDepth2;
                        Activity a = parseActivity(owner, res, parser, flags, outError, cachedArgs, false, packageR.baseHardwareAccelerated);
                        if (a == null) {
                            packageParser3.mParseError = PackageManager.INSTALL_PARSE_FAILED_MANIFEST_MALFORMED;
                            return false;
                        }
                        boolean z3 = a.order != 0 ? z : false;
                        ...
                        if (tagName.equals(IncidentManager.URI_PARAM_RECEIVER_CLASS)) {
                            ...
                            if (tagName.equals("service")) {
                                ...
                                xmlResourceParser = parser;
                                strArr2 = outError;
                                Bundle parseMetaData = packageParser2.parseMetaData(res, xmlResourceParser, packageR.mAppMetaData, strArr2);
                                ...
                                if (tagName.equals("static-library")) {
                                    ...
                                    if (tagName.equals("library")) {
                                        ...
                                        if (!packageParser2.parseUsesStaticLibrary(packageR, res, xmlResourceParser, strArr2)) {
                                            return false;
                                        }
                                        ...
                                        if (res.obtainAttributes(xmlResourceParser, R.styleable.AndroidManifestProfileable).getBoolean(0, false)) {
        ...
        if (TextUtils.isEmpty(packageR.staticSharedLibName)) {
            packageR.activities.add(packageParser.generateAppDetailsHiddenActivity(packageR, flags, strArr, packageR.baseHardwareAccelerated));
        }
        if (hasActivityOrder) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v20, resolved type: android.content.res.TypedArray} */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: Multiple debug info for r0v18 android.content.pm.ComponentInfo: [D('a' android.content.pm.PackageParser$Activity), D('parsedComponent' android.content.pm.ComponentInfo)] */
    ...
    private boolean parseSplitApplication(Package owner, Resources res, XmlResourceParser parser, int flags, int splitIndex, String[] outError) throws XmlPullParserException, IOException {
        ...
        TypedArray sa = resources2.obtainAttributes(attributeSet, R.styleable.AndroidManifestApplication);
        int i2 = 1;
        int i3 = 4;
        if (sa.getBoolean(7, true)) {
                            ...
                            if (tagName.equals("service")) {
                                ...
                                if (parser.getName().equals("meta-data")) {
                                    ...
                                    if (tagName.equals("uses-static-library")) {
                                        ...
                                        String lname = sa2.getNonResourceString(r15);
    ...
    private Activity parseActivity(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs, boolean receiver, boolean hardwareAccelerated) throws XmlPullParserException, IOException {
        ...
        a.info.taskAffinity = buildTaskAffinityName(packageR.applicationInfo.packageName, packageR.applicationInfo.taskAffinity, sa.getNonConfigurationString(8, 1024), strArr);
                ...
                if (type == 3 && parser.getDepth() <= outerDepth) {
                    ...
                    if (parser.getName().equals("intent-filter")) {
                        ...
                        if (intent4.countActions() == 0) {
                            ...
                            intent = intent4;
                            packageR.preferredActivityFilters.add(intent);
                        }
                        if (visibleToEphemeral) {
                            visibility = 1;
    ...
    private void setMaxAspectRatio(Package owner) {
        ...
        hookDispCompat(owner, maxAspectRatio);
    ...
    private Activity parseActivityAlias(Package owner, Resources res, XmlResourceParser parser, int flags, String[] outError, CachedComponentArgs cachedArgs) throws XmlPullParserException, IOException {
        ...
        XmlResourceParser xmlResourceParser = parser;
        String[] strArr = outError;
        TypedArray sa = resources.obtainAttributes(xmlResourceParser, R.styleable.AndroidManifestActivityAlias);
        ...
        sa.recycle();
        hookActivityAliasTheme(a, resources, xmlResourceParser, target);
        if (strArr[0] != null) {
            return null;
        }
        int outerDepth = parser.getDepth();
    ...
    public static abstract class Component<II extends IntentInfo> {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParsePackageItemArgs, android.content.pm.PackageItemInfo):void
         arg types: [android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo]
         candidates:
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParsePackageItemArgs, android.content.pm.PackageItemInfo):void */
    ...
    private static void updateApplicationInfo(ApplicationInfo ai, int flags, PackageUserState state) {
        ...
        if (ai.mOppoApplicationInfoEx != null) {
            ai.mOppoApplicationInfoEx.oppoFreezeState = state.oppoFreezeState;
        }
    }
    ...
    public static ApplicationInfo generateApplicationInfo(Package p, int flags, PackageUserState state, int userId) {
        ...
        int userId2 = ColorMultiAppManager.getInstance().fixApplicationInfo(userId, p);
        if (copyNeeded(flags, p, state, null, userId2) || ((32768 & flags) != 0 && state.enabled == 4)) {
            ApplicationInfo ai = new ApplicationInfo(p.applicationInfo);
            ai.initForUser(userId2);
            if ((flags & 128) != 0) {
    ...
    public static final class Activity extends Component<ActivityIntentInfo> implements Parcelable {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void
         arg types: [android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ActivityInfo]
         candidates:
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParsePackageItemArgs, android.content.pm.PackageItemInfo):void
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void */
    ...
    public static final class Service extends Component<ServiceIntentInfo> implements Parcelable {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void
         arg types: [android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ServiceInfo]
         candidates:
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParsePackageItemArgs, android.content.pm.PackageItemInfo):void
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void */
    ...
    public static final class Provider extends Component<ProviderIntentInfo> implements Parcelable {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void
         arg types: [android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ProviderInfo]
         candidates:
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParsePackageItemArgs, android.content.pm.PackageItemInfo):void
          android.content.pm.PackageParser.Component.<init>(android.content.pm.PackageParser$ParseComponentArgs, android.content.pm.ComponentInfo):void */
