...
public interface IPackageManagerNative extends IInterface {
    ...
    void sendArrayCommonDcsUpload(String str, String str2, int i, String[] strArr) throws RemoteException;
    ...
    public static class Default implements IPackageManagerNative {
        ...
        @Override // android.content.pm.IPackageManagerNative
        public void sendArrayCommonDcsUpload(String logTag, String eventID, int pair, String[] data) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IPackageManagerNative {
        ...
        static final int TRANSACTION_sendArrayCommonDcsUpload = 8;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 8:
                    return "sendArrayCommonDcsUpload";
                default:
                    return null;
            }
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
                        sendArrayCommonDcsUpload(data.readString(), data.readString(), data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        return true;
                    default:
        ...
        private static class Proxy implements IPackageManagerNative {
            ...
            public void sendArrayCommonDcsUpload(String logTag, String eventID, int pair, String[] data) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().sendArrayCommonDcsUpload(logTag, eventID, pair, data);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
