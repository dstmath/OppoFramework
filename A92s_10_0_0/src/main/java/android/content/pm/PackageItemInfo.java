...
public class PackageItemInfo {
    ...
    public Drawable loadIcon(PackageManager pm, boolean isConvertEnable) {
        return ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).loadPackageItemIcon(this, pm, getApplicationInfo(), isConvertEnable);
    }
}
