...
public class ResolveInfo extends ColorBaseResolveInfo implements Parcelable {
    public static final Parcelable.Creator<ResolveInfo> CREATOR = new Parcelable.Creator<ResolveInfo>() {
        /* class android.content.pm.ResolveInfo.AnonymousClass1 */
    ...
    public Drawable loadIcon(PackageManager pm) {
        ...
        if (!(this.resolvePackageName == null || this.iconResourceId == 0)) {
            dr = ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).loadResolveIcon(this, pm, this.resolvePackageName, this.iconResourceId, null, false);
        }
        ComponentInfo ci = getComponentInfo();
        if (dr == null && this.iconResourceId != 0) {
            dr = ((IColorThemeManager) OppoFeatureCache.getOrCreate(IColorThemeManager.DEFAULT, new Object[0])).loadResolveIcon(this, pm, ci.packageName, this.iconResourceId, ci.applicationInfo, false);
        }
        if (dr != null) {
