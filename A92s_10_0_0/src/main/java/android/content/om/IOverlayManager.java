...
public interface IOverlayManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOverlayManager {
        ...
        public static IOverlayManager asInterface(IBinder obj) {
            ...
            IInterface iin = obj.queryLocalInterface("android.content.om.IOverlayManager");
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        boolean enabledExclusive = setEnabledExclusive(_arg02, _arg12, data.readInt());
                        reply.writeNoException();
                ...
                reply.writeString("android.content.om.IOverlayManager");
                return true;
            }
        }
        ...
        private static class Proxy implements IOverlayManager {
            ...
            public Map getAllOverlays(int userId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("android.content.om.IOverlayManager");
