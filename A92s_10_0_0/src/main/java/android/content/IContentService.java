            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 12:
                        ...
                        setSyncAutomatically(_arg011, _arg16, _arg213);
                        reply.writeNoException();
                        return true;
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setSyncAutomaticallyAsUser(_arg012, _arg17, _arg214, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 21:
                        ...
                        setMasterSyncAutomatically(_arg026);
                        reply.writeNoException();
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        putCache(_arg027, _arg1, _arg212, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        Bundle _result11 = getCache(_arg028, _arg12, data.readInt());
                        reply.writeNoException();
                        if (_result11 != null) {
                            reply.writeInt(1);
