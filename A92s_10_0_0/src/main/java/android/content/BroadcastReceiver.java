...
public abstract class BroadcastReceiver {
                ...
                if (!this.mFinished) {
                    ...
                    try {
                        ...
                        if (this.mOrderedHint) {
                            ...
                            new OppoActivityManager().finishNotOrderReceiver(this.mToken, this.mHasCode, 0, null, null, false);
                        }
    ...
    public final PendingResult goAsync() {
        if (ActivityThread.DEBUG_BROADCAST) {
            Slog.i(ActivityThread.TAG, "goAsync " + this.mPendingResult + " this " + this + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + Debug.getCallers(4));
        }
