...
public final class ApkAssets {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.content.res.ApkAssets.<init>(java.lang.String, boolean, boolean, boolean):void
     arg types: [java.lang.String, int, int, int]
     candidates:
      android.content.res.ApkAssets.<init>(java.io.FileDescriptor, java.lang.String, boolean, boolean):void
      android.content.res.ApkAssets.<init>(java.lang.String, boolean, boolean, boolean):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.content.res.ApkAssets.<init>(java.lang.String, boolean, boolean, boolean):void
     arg types: [java.lang.String, boolean, boolean, int]
     candidates:
      android.content.res.ApkAssets.<init>(java.io.FileDescriptor, java.lang.String, boolean, boolean):void
      android.content.res.ApkAssets.<init>(java.lang.String, boolean, boolean, boolean):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.content.res.StringBlock.<init>(long, boolean):void
     arg types: [long, int]
     candidates:
      android.content.res.StringBlock.<init>(byte[], boolean):void
      android.content.res.StringBlock.<init>(long, boolean):void */
