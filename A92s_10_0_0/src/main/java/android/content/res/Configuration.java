...
public final class Configuration extends ColorBaseConfiguration implements Parcelable, Comparable<Configuration> {
    ...
    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "YaoJun.Luo@ROM.SDK : Modify for rom theme", property = OppoHook.OppoRomType.ROM)
    public Configuration() {
        this.windowConfiguration = new WindowConfiguration();
        this.mOppoExtraConfiguration = new OppoExtraConfiguration();
        unset();
    }
    ...
    public void setTo(Configuration o) {
        ...
        this.mOppoExtraConfiguration.setTo(o.mOppoExtraConfiguration);
    }
    ...
    public String toString() {
        ...
        sb.append(this.mOppoExtraConfiguration.toString());
        sb.append('}');
        return sb.toString();
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.proto.ProtoOutputStream.write(long, float):void
     arg types: [int, float]
     candidates:
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:107:0x036f */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:64:0x0233 */
    /* JADX DEBUG: Additional 3 move instruction added to help type inference */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v0, resolved type: android.content.res.Configuration} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v1, resolved type: android.content.res.Configuration} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v3, resolved type: android.content.res.Configuration} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v4, resolved type: android.content.res.Configuration} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v11, resolved type: java.lang.StringBuilder} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v26, resolved type: java.util.Locale$Builder} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v7, resolved type: java.lang.StringBuilder} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v37, resolved type: java.util.Locale$Builder} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v16, resolved type: android.content.res.Configuration} */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: Multiple debug info for r10v1 java.lang.String: [D('variant' java.lang.String), D('country' java.lang.String), D('language' java.lang.String)] */
    /* JADX WARN: Type inference failed for: r1v6 */
    /* JADX WARN: Type inference failed for: r1v7, types: [android.content.res.Configuration] */
    /* JADX WARN: Type inference failed for: r1v10, types: [java.lang.String] */
    /* JADX WARN: Type inference failed for: r1v13 */
    /* JADX WARN: Type inference failed for: r1v14 */
    /* JADX WARN: Type inference failed for: r1v15 */
    /* JADX WARN: Type inference failed for: r1v18 */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x03e0  */
    /* JADX WARNING: Removed duplicated region for block: B:94:0x02f8 A[SYNTHETIC, Splitter:B:94:0x02f8] */
    /* JADX WARNING: Removed duplicated region for block: B:96:0x031b A[Catch:{ IllformedLocaleException -> 0x031f }] */
    public void readFromProto(ProtoInputStream protoInputStream, long fieldId) throws IOException {
        ...
        String str11 = ";script-";
        String str12 = "Repeated locale (";
        String str13 = ";variant-";
                ...
                try {
                    switch (protoInputStream.getFieldNumber()) {
                        case 1:
                            ...
                            str4 = str13;
                            str3 = str14;
                            script.fontScale = protoInputStream2.readFloat(1108101562369L);
                            break;
                        case 2:
                            str = language2;
                            token2 = token3;
                            ...
                            str4 = str13;
                            str3 = str14;
                            script.mcc = protoInputStream2.readInt(1155346202626L);
                            break;
                        case 3:
                            str = language2;
                            token2 = token3;
                            ...
                            script = this;
                            ((Configuration) script).mnc = protoInputStream2.readInt(1155346202627L);
                            break;
                        case 4:
                            try {
                                ...
                                while (protoInputStream.nextField() != -1) {
                                    try {
                                        try {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            Slog.e(TAG, "readFromProto error building locale with: language-" + language + str7 + country + str8 + variant + str6 + ((String) script));
                                                            throw wtme;
                                                        }
                                                        throw wtme;
                                                    } catch (Throwable th3) {
                                                        ...
                                                        if (list.size() > 0) {
                                                            script.setLocales(new LocaleList((Locale[]) list.toArray(new Locale[list.size()])));
                                                        }
                                            ...
                                            str6 = str11;
                                            protoInputStream2.end(localeToken);
                                            Locale locale22 = new Locale.Builder().setLanguage(language).setRegion(country).setVariant(variant).setScript(script).build();
                                            inListIndex = list.indexOf(locale22);
                                            if (inListIndex != -1) {
                                                try {
                                                    Slog.wtf(TAG, str5 + list.get(inListIndex) + ") found when trying to add: " + locale22.toString());
                                        ...
                                        str7 = str14;
                                        protoInputStream2.end(localeToken);
                                        Locale locale222 = new Locale.Builder().setLanguage(language).setRegion(country).setVariant(variant).setScript(script).build();
                                        inListIndex = list.indexOf(locale222);
                                        if (inListIndex != -1) {
                                        }
                                        throw wtme;
                                    }
                            ...
                            try {
                                protoInputStream2.end(localeToken);
                                try {
                                    Locale locale3 = new Locale.Builder().setLanguage(language).setRegion(country).setVariant(variant).setScript(script).build();
                                    ...
                                    if (inListIndex2 != -1) {
                                        ...
                                        try {
                                            ...
                                            sb2.append("readFromProto error building locale with: language-");
                                            sb2.append(language);
                                            str3 = str14;
                                            sb2.append(str3);
                                            sb2.append(country);
                                    ...
                                    sb22.append("readFromProto error building locale with: language-");
                        ...
                        case 5:
                            script.screenLayout = protoInputStream2.readInt(1155346202629L);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 6:
                            script.colorMode = protoInputStream2.readInt(1155346202630L);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 7:
                            script.touchscreen = protoInputStream2.readInt(ConfigurationProto.TOUCHSCREEN);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 8:
                            script.keyboard = protoInputStream2.readInt(1155346202632L);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 9:
                            script.keyboardHidden = protoInputStream2.readInt(ConfigurationProto.KEYBOARD_HIDDEN);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 10:
                            script.hardKeyboardHidden = protoInputStream2.readInt(ConfigurationProto.HARD_KEYBOARD_HIDDEN);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 11:
                            script.navigation = protoInputStream2.readInt(ConfigurationProto.NAVIGATION);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 12:
                            script.navigationHidden = protoInputStream2.readInt(ConfigurationProto.NAVIGATION_HIDDEN);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 13:
                            script.orientation = protoInputStream2.readInt(ConfigurationProto.ORIENTATION);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 14:
                            script.uiMode = protoInputStream2.readInt(ConfigurationProto.UI_MODE);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 15:
                            script.screenWidthDp = protoInputStream2.readInt(ConfigurationProto.SCREEN_WIDTH_DP);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 16:
                            script.screenHeightDp = protoInputStream2.readInt(ConfigurationProto.SCREEN_HEIGHT_DP);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 17:
                            script.smallestScreenWidthDp = protoInputStream2.readInt(ConfigurationProto.SMALLEST_SCREEN_WIDTH_DP);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                            ...
                            break;
                        case 18:
                            script.densityDpi = protoInputStream2.readInt(ConfigurationProto.DENSITY_DPI);
                            str = language2;
                            token2 = token3;
                            str2 = str11;
                            str4 = str13;
                        ...
                        case 19:
                            try {
                                script.windowConfiguration.readFromProto(protoInputStream2, 1146756268051L);
                                str = language2;
                                token2 = token3;
                                str2 = str11;
                                str4 = str13;
    ...
    public void setToDefaults() {
        ...
        this.mOppoExtraConfiguration.setToDefaults();
    }
    ...
    public int updateFrom(Configuration delta) {
        ...
        return changed | this.mOppoExtraConfiguration.updateFrom(delta.mOppoExtraConfiguration);
    }
    ...
    public int diff(Configuration delta, boolean compareUndefined, boolean publicOnly) {
        ...
        return changed | this.mOppoExtraConfiguration.diff(delta.mOppoExtraConfiguration);
    }

    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "YaoJun.Luo@ROM.SDK : Modify for rom theme", property = OppoHook.OppoRomType.ROM)
    public static boolean needNewResources(int configChanges, int interestingChanges) {
        return (configChanges & ((Integer.MIN_VALUE | interestingChanges) | 1073741824)) != 0 || OppoExtraConfiguration.needNewResources(configChanges) || OppoExtraConfiguration.needAccessNewResources(configChanges);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        this.mOppoExtraConfiguration.writeToParcel(dest, flags);
    }
    ...
    public void readFromParcel(Parcel source) {
        ...
        this.mOppoExtraConfiguration.readFromParcel(source);
    }
    ...
    public int compareTo(Configuration that) {
        ...
        return this.mOppoExtraConfiguration.compareTo(that.mOppoExtraConfiguration);
    }
