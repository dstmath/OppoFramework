...
public abstract class ContentProviderNative extends Binder implements IContentProvider {
    ...
    public static IContentProvider asInterface(IBinder obj) {
        ...
        if (((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).isInstance(obj)) {
            return new ContentProviderProxy(obj);
        }
        if (((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).checkNeedReplace("contentprovider")) {
            return new ContentProviderProxy(((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).getOrCreateFakeBinder(obj, "contentprovider"));
        }
        return new ContentProviderProxy(obj);
    }
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        if (code == 1) {
            ...
            ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction_SetContentProviderAction(url, 1, Binder.getCallingUid());
            ...
            ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction_SetContentProviderAction(url2, 3, Binder.getCallingUid());
            Uri out = insert(callingPkg2, url2, ContentValues.CREATOR.createFromParcel(data));
            reply.writeNoException();
            ...
            ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction_SetContentProviderAction(url3, 4, Binder.getCallingUid());
            int count = delete(callingPkg3, url3, selection, selectionArgs);
            reply.writeNoException();
                ...
                default:
                    switch (code) {
                        case 20:
                            ...
                            ContentProviderResult[] results = applyBatch(callingPkg4, authority, operations);
                            reply.writeNoException();
            ...
            ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction_SetContentProviderAction(url4, 10, Binder.getCallingUid());
            int count3 = update(callingPkg5, url4, values, selection2, selectionArgs2);
            reply.writeNoException();
