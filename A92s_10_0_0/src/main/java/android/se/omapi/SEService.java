    ...
    public SEService(Context context, Executor executor, OnConnectedListener listener) {
        ...
        this.mConnection = new ServiceConnection() {
            ...
            public synchronized void onServiceConnected(ComponentName className, IBinder service) {
                ISmartcardService unused = SEService.this.mSmartcardService = ISmartcardService.Stub.asInterface(service);
            ...
            public void onServiceDisconnected(ComponentName className) {
                ISmartcardService unused = SEService.this.mSmartcardService = null;
