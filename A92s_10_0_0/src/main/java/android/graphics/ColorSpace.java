        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, TransferParameters function, int id) {
            ...
            if (function.e == 0.0d && function.f == 0.0d) {
                ...
                r5 = new DoubleUnaryOperator() {
                    ...
                    public final double applyAsDouble(double d) {
                        return ColorSpace.rcpResponse(d, ColorSpace.Rgb.TransferParameters.this.a, ColorSpace.Rgb.TransferParameters.this.b, ColorSpace.Rgb.TransferParameters.this.c, ColorSpace.Rgb.TransferParameters.this.d, ColorSpace.Rgb.TransferParameters.this.e, ColorSpace.Rgb.TransferParameters.this.f, ColorSpace.Rgb.TransferParameters.this.g);
                    }
                };
            }
            if (function.e == 0.0d && function.f == 0.0d) {
                ...
                r6 = new DoubleUnaryOperator() {
                    ...
                    public final double applyAsDouble(double d) {
                        return ColorSpace.response(d, ColorSpace.Rgb.TransferParameters.this.a, ColorSpace.Rgb.TransferParameters.this.b, ColorSpace.Rgb.TransferParameters.this.c, ColorSpace.Rgb.TransferParameters.this.d, ColorSpace.Rgb.TransferParameters.this.e, ColorSpace.Rgb.TransferParameters.this.f, ColorSpace.Rgb.TransferParameters.this.g);
                    }
                };
            }
        }
