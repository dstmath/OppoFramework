...
public class AnimatedStateListDrawable extends StateListDrawable {
        ...
        while (true) {
            ...
            if (type != 1) {
                ...
                if (type == 2 && depth <= innerDepth) {
                    ...
                    } else if (parser.getName().equals(ELEMENT_TRANSITION) && !this.mNoTranstion) {
    ...
    private int parseItem(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        if (!(impl == null || !impl.isHasDrawables() || (loadArray = impl.getLoadArrary()) == null || (load = loadArray.get(resourceId)) == null)) {
            this.mNoTranstion = load.booleanValue();
        }
    ...
    static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        /* access modifiers changed from: package-private */
        @Override // android.graphics.drawable.StateListDrawable.StateListState, android.graphics.drawable.DrawableContainer.DrawableContainerState
        public void mutate() {
