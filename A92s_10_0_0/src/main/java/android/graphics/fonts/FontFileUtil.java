...
public class FontFileUtil {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:64:0x0046 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:66:0x0041 */
    /* JADX DEBUG: Additional 1 move instruction added to help type inference */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v1, resolved type: short} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v2, resolved type: short} */
