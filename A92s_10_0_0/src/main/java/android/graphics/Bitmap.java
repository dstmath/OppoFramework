...
public final class Bitmap extends OppoBaseBitmap implements Parcelable {
    ...
    public static final class Config extends Enum<Config> {
        ...
        public static final Config ALPHA_8 = new Config("ALPHA_8", 0, 1);
        @Deprecated
        public static final Config ARGB_4444 = new Config("ARGB_4444", 2, 4);
        public static final Config ARGB_8888 = new Config("ARGB_8888", 3, 5);
        public static final Config HARDWARE = new Config("HARDWARE", 5, 7);
        public static final Config RGBA_F16 = new Config("RGBA_F16", 4, 6);
        public static final Config RGB_565 = new Config("RGB_565", 1, 3);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.graphics.Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config, boolean):android.graphics.Bitmap
     arg types: [int, int, android.graphics.Bitmap$Config, int]
     candidates:
      android.graphics.Bitmap.createBitmap(android.graphics.Picture, int, int, android.graphics.Bitmap$Config):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(android.util.DisplayMetrics, int, int, android.graphics.Bitmap$Config):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(int[], int, int, android.graphics.Bitmap$Config):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config, boolean):android.graphics.Bitmap */
    public static Bitmap createBitmap(int width, int height, Config config) {
        return createBitmap(width, height, config, true);
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.graphics.Bitmap.createBitmap(android.util.DisplayMetrics, int, int, android.graphics.Bitmap$Config, boolean):android.graphics.Bitmap
     arg types: [android.util.DisplayMetrics, int, int, android.graphics.Bitmap$Config, int]
     candidates:
      android.graphics.Bitmap.createBitmap(int, int, android.graphics.Bitmap$Config, boolean, android.graphics.ColorSpace):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(android.graphics.Bitmap, int, int, int, int):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(android.util.DisplayMetrics, int[], int, int, android.graphics.Bitmap$Config):android.graphics.Bitmap
      android.graphics.Bitmap.createBitmap(android.util.DisplayMetrics, int, int, android.graphics.Bitmap$Config, boolean):android.graphics.Bitmap */
