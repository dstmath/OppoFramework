...
public class Canvas extends BaseCanvas {
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "XiaoKang.Feng@ROM.SDK, 2017/08/20 : Add for adjustNavigationBarColor", property = OppoHook.OppoRomType.ROM)
    ...
    public Canvas(Bitmap bitmap) {
        if (bitmap.isMutable()) {
            ...
            setIsCanvasBaseBitmap(bitmap, true);
            return;
        }
    ...
    @Override // android.graphics.BaseCanvas, android.graphics.OppoBaseBaseCanvas
    ...
    public void setBitmap(Bitmap bitmap) {
        if (!isHardwareAccelerated()) {
            ...
            this.mBitmap = bitmap;
            setIsCanvasBaseBitmap(this.mBitmap, true);
            return;
        }
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_METHOD, note = "XiaoKang.Feng@ROM.SDK, 2017/08/20 : Add for adjustNavigationBarColor", property = OppoHook.OppoRomType.ROM)
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_METHOD, note = "JianHui.Yu@ROM.SDK, 2018-10-03 : Add for Upgrade to Android 9.0", property = OppoHook.OppoRomType.ROM)
    public static int getCompatibilityVersion() {
        return sCompatiblityVersion;
    }
}
