...
public class SweepGradient extends Shader {
    ...
    public Shader getDarkModeShader() {
        Shader copy = ((IColorDarkModeManager) OppoFeatureCache.getOrCreate(IColorDarkModeManager.DEFAULT, new Object[0])).getDarkModeSweepGradient(this.mCx, this.mCy, convertColors(this.mColorLongs), this.mPositions, this.mColor0, this.mColor1);
