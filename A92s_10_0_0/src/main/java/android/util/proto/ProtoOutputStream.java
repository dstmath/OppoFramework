...
public final class ProtoOutputStream extends ProtoStream {
                            ...
                            default:
                                switch (i) {
                                    case 525:
                                        ...
                                        return;
                                    case MetricsProto.MetricsEvent.DIALOG_SUPPORT_DISCLAIMER /*{ENCODED_INT: 526}*/:
                                        writeRepeatedEnumImpl(id, (int) val);
                                        return;
                                    case MetricsProto.MetricsEvent.DIALOG_SUPPORT_PHONE /*{ENCODED_INT: 527}*/:
    ...
    @Override // android.util.proto.ProtoStream
