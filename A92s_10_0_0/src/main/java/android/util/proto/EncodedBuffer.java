...
public final class EncodedBuffer {
    ...
    public int readRawFixed32() {
        return (readRawByte() & 255) | ((readRawByte() & 255) << 8) | ((readRawByte() & 255) << 16) | ((readRawByte() & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP);
    }
    ...
    public int getRawFixed32At(int pos) {
        ...
        return (this.mBuffers.get(pos / this.mChunkSize)[pos % i] & 255) | ((this.mBuffers.get((pos + 1) / i)[(pos + 1) % i2] & 255) << 8) | ((this.mBuffers.get((pos + 2) / i2)[(pos + 2) % i3] & 255) << 16) | ((this.mBuffers.get((pos + 3) / i3)[(pos + 3) % this.mChunkSize] & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP);
    }
