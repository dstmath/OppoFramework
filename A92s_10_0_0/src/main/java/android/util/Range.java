...
public final class Range<T extends Comparable<? super T>> {
    ...
    public Range(T lower, T upper) {
        this.mLower = Preconditions.checkNotNull(lower, "lower must not be null");
        this.mUpper = Preconditions.checkNotNull(upper, "upper must not be null");
    ...
    public boolean contains(T value) {
        ...
        return (value.compareTo(this.mLower) >= 0) && (value.compareTo(this.mUpper) <= 0);
    }
