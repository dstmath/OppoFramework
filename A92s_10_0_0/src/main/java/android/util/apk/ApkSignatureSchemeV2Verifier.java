...
public class ApkSignatureSchemeV2Verifier {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.lang.String, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner
     arg types: [java.lang.String, int]
     candidates:
      android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.io.RandomAccessFile, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner
      android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.lang.String, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner */
                        ...
                        while (certificates.hasRemaining()) {
                            ...
                            try {
                                try {
                                    ...
                                    e = e5;
                                    throw new SecurityException("Failed to decode certificate #" + certificateCount3, e);
                                }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.io.RandomAccessFile, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner
     arg types: [java.io.RandomAccessFile, int]
     candidates:
      android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.lang.String, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner
      android.util.apk.ApkSignatureSchemeV2Verifier.verify(java.io.RandomAccessFile, boolean):android.util.apk.ApkSignatureSchemeV2Verifier$VerifiedSigner */
