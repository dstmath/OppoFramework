...
public class ApkSignatureSchemeV3Verifier {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.apk.ApkSignatureSchemeV3Verifier.verify(java.lang.String, boolean):android.util.apk.ApkSignatureSchemeV3Verifier$VerifiedSigner
     arg types: [java.lang.String, int]
     candidates:
      android.util.apk.ApkSignatureSchemeV3Verifier.verify(java.io.RandomAccessFile, boolean):android.util.apk.ApkSignatureSchemeV3Verifier$VerifiedSigner
      android.util.apk.ApkSignatureSchemeV3Verifier.verify(java.lang.String, boolean):android.util.apk.ApkSignatureSchemeV3Verifier$VerifiedSigner */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.apk.ApkSignatureSchemeV3Verifier.verify(java.io.RandomAccessFile, boolean):android.util.apk.ApkSignatureSchemeV3Verifier$VerifiedSigner
