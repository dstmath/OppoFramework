...
public final class OppoSafeDbReader {
    ...
    /* access modifiers changed from: private */
    public Uri uri = Uri.parse("content://com.color.provider.SafeProvider/pp_float_window");
    ...
    class SafePPWindowObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            boolean unused = OppoSafeDbReader.this.getData();
