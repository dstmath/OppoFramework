                ...
                if (i != 1) {
                    if (i == 2 && offset + 1 <= len2) {
                        ...
                        if (v != -1) {
                            ...
                            int op5 = op4 + 1;
                            output[op4] = alphabet2[(v >> 12) & 63];
                            int op6 = op5 + 1;
                            output[op5] = alphabet2[(v >> 6) & 63];
                            op3 = op6 + 1;
                            output[op6] = alphabet2[v & 63];
                            count3--;
                            if (count3 == 0) {
                                if (this.do_cr) {
                                    output[op3] = OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF;
                                    op3++;
                                }
                                output[op3] = 10;
                                count3 = 19;
                        ...
                        while (p + 3 <= len2) {
                            ...
                            if (count2 == 0) {
                                if (this.do_cr) {
                                    output[op] = OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF;
                                    op++;
                                }
                                output[op] = 10;
                                count2 = 19;
                        ...
                        if (finish) {
                            ...
                            if (p - p5 == len2 - 1) {
                                ...
                                if (this.do_newline) {
                                    if (this.do_cr) {
                                        output[op8] = OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF;
                                        op8++;
                                    }
                                    output[op8] = 10;
                                    op8++;
                                ...
                                int op11 = op10 + 1;
                                output[op10] = alphabet2[(v4 >> 6) & 63];
                                int op12 = op11 + 1;
                                output[op11] = alphabet2[v4 & 63];
                                if (this.do_padding) {
                                    op2 = op12 + 1;
                                    output[op12] = 61;
                                } else {
                                ...
                                if (this.do_newline) {
                                    if (this.do_cr) {
                                        output[op2] = OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF;
                                        op2++;
                                    }
                                    output[op2] = 10;
                                    op2++;
