...
public final class StrictJarFile {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.jar.StrictJarFile.<init>(java.lang.String, boolean, boolean):void
     arg types: [java.lang.String, int, int]
     candidates:
      android.util.jar.StrictJarFile.<init>(java.io.FileDescriptor, boolean, boolean):void
      android.util.jar.StrictJarFile.<init>(java.lang.String, boolean, boolean):void */
    public StrictJarFile(String fileName) throws IOException, SecurityException {
        this(fileName, true, true);
    }

    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.util.jar.StrictJarFile.<init>(java.io.FileDescriptor, boolean, boolean):void
     arg types: [java.io.FileDescriptor, int, int]
     candidates:
      android.util.jar.StrictJarFile.<init>(java.lang.String, boolean, boolean):void
      android.util.jar.StrictJarFile.<init>(java.io.FileDescriptor, boolean, boolean):void */
