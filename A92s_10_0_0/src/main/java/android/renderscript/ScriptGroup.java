    ...
    public static final class Closure extends BaseObj {
        ...
        Closure(RenderScript rs, Script.KernelID kernelID, Type returnType, Object[] args, Map<Script.FieldID, Object> globals) {
            ...
            while (i < args.length) {
                ...
                i++;
                depFieldIDs = depFieldIDs;
                depClosures = depClosures;
                sizes = sizes;
                values = values;
                fieldIDs = fieldIDs;
                numValues = numValues;
            ...
            for (Map.Entry<Script.FieldID, Object> entry : globals.entrySet()) {
                ...
                fieldIDs[i2] = fieldID.getID(rs);
                retrieveValueAndDependenceInfo(rs, i2, fieldID, obj, values, sizes, depClosures, depFieldIDs);
                i2++;
            }
        ...
        Closure(RenderScript rs, Script.InvokeID invokeID, Object[] args, Map<Script.FieldID, Object> globals) {
            ...
            for (Map.Entry<Script.FieldID, Object> entry : globals.entrySet()) {
                ...
                retrieveValueAndDependenceInfo(rs, i, fieldID, obj, values, sizes, jArr, depFieldIDs);
                i++;
                depFieldIDs = depFieldIDs;
                sizes = sizes;
            }
    ...
    public static final class Input {
        ...
        public void set(Object value) {
            ...
            for (Pair<Closure, Integer> p : this.mArgIndex) {
                p.first.setArg(p.second.intValue(), value);
            }
            for (Pair<Closure, Script.FieldID> p2 : this.mFieldID) {
                p2.first.setGlobal(p2.second, value);
            }
        }
