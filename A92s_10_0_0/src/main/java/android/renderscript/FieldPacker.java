...
public class FieldPacker {
    ...
    public int subI32() {
        ...
        int i = this.mPos - 1;
        this.mPos = i;
        int v = (bArr[i] & 255) << OppoBaseBatteryStats.ThermalItem.CMD_ENVITEMP;
        int i2 = this.mPos - 1;
        this.mPos = i2;
    ...
    public long subI64() {
        ...
        int i2 = this.mPos - 1;
        this.mPos = i2;
        long v2 = v | ((((long) bArr[i2]) & 255) << 48);
        int i3 = this.mPos - 1;
        this.mPos = i3;
        long v3 = v2 | ((((long) bArr[i3]) & 255) << 40);
        int i4 = this.mPos - 1;
        this.mPos = i4;
        long v4 = v3 | ((((long) bArr[i4]) & 255) << 32);
        int i5 = this.mPos - 1;
        this.mPos = i5;
        long v5 = v4 | ((((long) bArr[i5]) & 255) << 24);
        int i6 = this.mPos - 1;
        this.mPos = i6;
        long v6 = v5 | ((((long) bArr[i6]) & 255) << 16);
        int i7 = this.mPos - 1;
        this.mPos = i7;
        int i8 = this.mPos - 1;
        this.mPos = i8;
        return v6 | ((((long) bArr[i7]) & 255) << 8) | (((long) bArr[i8]) & 255);
    }
