...
public final class SQLiteConnectionPool implements Closeable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x006a, code lost:
        r24.setOnCancelListener(new android.database.sqlite.SQLiteConnectionPool.AnonymousClass1(r21));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:?, code lost:
        java.util.concurrent.locks.LockSupport.parkNanos(r21, r3 * android.util.TimeUtils.NANOS_PER_MS);
    ...
    /* JADX INFO: Multiple debug info for r5v1 android.database.sqlite.SQLiteConnectionPool$ConnectionWaiter: [D('ex' java.lang.RuntimeException), D('successor' android.database.sqlite.SQLiteConnectionPool$ConnectionWaiter)] */
    @GuardedBy({"mLock"})
    ...
    private SQLiteConnection tryAcquireNonPrimaryConnectionLocked(String sql, int connectionFlags) {
        ...
        int oldConfigFlags = this.mConfiguration.openFlags;
        if ((connectionFlags & 1) != 0 && this.mConfiguration.path.contains("contacts2")) {
            SQLiteDatabaseConfiguration sQLiteDatabaseConfiguration = this.mConfiguration;
            sQLiteDatabaseConfiguration.openFlags = 1 | sQLiteDatabaseConfiguration.openFlags;
        }
        ...
        if (this.mConfiguration.openFlags != oldConfigFlags) {
            this.mConfiguration.openFlags = oldConfigFlags;
        }
        return connection3;
    }
