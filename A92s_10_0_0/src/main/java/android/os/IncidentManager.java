...
public class IncidentManager {
    ...
    private IIncidentManager getIIncidentManagerLocked() throws RemoteException {
        ...
        synchronized (this.mLock) {
            ...
            IIncidentManager iIncidentManager3 = this.mIncidentService;
            return iIncidentManager3;
        }
    }
    ...
    private IIncidentCompanion getCompanionServiceLocked() throws RemoteException {
        ...
        synchronized (this) {
            ...
            IIncidentCompanion iIncidentCompanion3 = this.mCompanionService;
            return iIncidentCompanion3;
        }
    }
