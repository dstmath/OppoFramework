...
public interface INetworkManagementService extends IInterface {
    ...
    void removeUidsLocked(int[] iArr) throws RemoteException;
    ...
    public static class Default implements INetworkManagementService {
        ...
        @Override // android.os.INetworkManagementService
        public void removeUidsLocked(int[] uids) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INetworkManagementService {
        ...
        static final int TRANSACTION_removeUidsLocked = 75;
        ...
        static final int TRANSACTION_setFirewallUidRuleForNetworkType = 76;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        setInterfaceConfig(_arg06, _arg1);
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 9:
                        ...
                        setInterfaceIpv6PrivacyExtensions(_arg07, _arg15);
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 44:
                        ...
                        setUidMeteredNetworkBlacklist(_arg010, _arg19);
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setUidMeteredNetworkWhitelist(_arg011, _arg18);
                        reply.writeNoException();
                        return true;
                    case 46:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        boolean dataSaverModeEnabled = setDataSaverModeEnabled(_arg04);
                        reply.writeNoException();
                    ...
                    case 53:
                        ...
                        setFirewallInterfaceRule(_arg012, _arg17);
                        reply.writeNoException();
                        return true;
                    case 54:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 56:
                        ...
                        setFirewallChainEnabled(_arg013, _arg16);
                        reply.writeNoException();
                        return true;
                    case 57:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 64:
                        ...
                        addLegacyRouteForNetId(_arg014, _arg14, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 65:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 75:
                        data.enforceInterface(DESCRIPTOR);
                        removeUidsLocked(data.createIntArray());
                        reply.writeNoException();
                        return true;
                    case 76:
                        data.enforceInterface(DESCRIPTOR);
                        setFirewallUidRuleForNetworkType(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 77:
                        data.enforceInterface(DESCRIPTOR);
                        String _result11 = executeShellToSetIptables(data.readString());
                        reply.writeNoException();
                        reply.writeString(_result11);
                        return true;
                    case 78:
                        data.enforceInterface(DESCRIPTOR);
                        boolean networkRestriction = setNetworkRestriction(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(networkRestriction ? 1 : 0);
                        return true;
                    case 79:
                        data.enforceInterface(DESCRIPTOR);
                        boolean addNetworkRestriction = addNetworkRestriction(data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        reply.writeInt(addNetworkRestriction ? 1 : 0);
                        return true;
                    case 80:
                        data.enforceInterface(DESCRIPTOR);
                        boolean removeNetworkRestriction = removeNetworkRestriction(data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        reply.writeInt(removeNetworkRestriction ? 1 : 0);
                        return true;
                    case 81:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements INetworkManagementService {
            ...
            public void removeUidsLocked(int[] uids) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().removeUidsLocked(uids);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setFirewallUidRuleForNetworkType(int type, int uid, int rule) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setFirewallUidRuleForNetworkType(type, uid, rule);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean setNetworkRestriction(int pattern) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(78, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setNetworkRestriction(pattern);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean addNetworkRestriction(int pattern, String[] list) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(79, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().addNetworkRestriction(pattern, list);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean removeNetworkRestriction(int pattern, String[] list) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(80, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().removeNetworkRestriction(pattern, list);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
