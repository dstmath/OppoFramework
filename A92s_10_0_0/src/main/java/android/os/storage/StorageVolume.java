...
public final class StorageVolume extends OppoBaseStorageVolume {
    ...
    private StorageVolume(Parcel in) {
        ...
        super.initFromParcel(in);
    }

    public StorageVolume(String id, File path, File internalPath, String description, boolean primary, boolean removable, boolean emulated, boolean allowMassStorage, long maxFileSize, UserHandle owner, String fsUuid, String state, int readonlyType) {
        this(id, path, internalPath, description, primary, removable, emulated, allowMassStorage, maxFileSize, owner, fsUuid, state);
        super.setReadOnlyType(readonlyType);
    }
    ...
    @Override // android.os.storage.OppoBaseStorageVolume
    ...
    @Override // android.os.storage.OppoBaseStorageVolume, android.os.Parcelable
