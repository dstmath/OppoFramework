            ...
            if (code == 1) {
                ...
                switch (code) {
                    case 22:
                        ...
                        mountObb(_arg0, _arg13, _arg22, _arg3, _arg4, _arg5);
                        reply.writeNoException();
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        String _result4 = getMountedObbPath(data.readString());
                        reply.writeNoException();
                    ...
                    default:
                        switch (code) {
                            case 27:
                                data.enforceInterface(DESCRIPTOR);
                                int _result5 = decryptStorage(data.readString());
                                reply.writeNoException();
                                reply.writeInt(_result5);
                                return true;
                            case 28:
                                data.enforceInterface(DESCRIPTOR);
                                int _result6 = encryptStorage(data.readInt(), data.readString());
                                reply.writeNoException();
                                reply.writeInt(_result6);
                                return true;
                            case 29:
                                data.enforceInterface(DESCRIPTOR);
                                int _result7 = changeEncryptionPassword(data.readInt(), data.readString());
                                reply.writeNoException();
                                reply.writeInt(_result7);
                                return true;
                            case 30:
                                data.enforceInterface(DESCRIPTOR);
                                StorageVolume[] _result8 = getVolumeList(data.readInt(), data.readString(), data.readInt());
                                reply.writeNoException();
                                ...
                                switch (code) {
                                    ...
                                    default:
                                        switch (code) {
                                            ...
                                            case 46:
                                                data.enforceInterface(DESCRIPTOR);
                                                VolumeInfo[] _result13 = getVolumes(data.readInt());
                                                reply.writeNoException();
                                                reply.writeTypedArray(_result13, 1);
                                                return true;
                                            case 47:
                                                data.enforceInterface(DESCRIPTOR);
                                                VolumeRecord[] _result14 = getVolumeRecords(data.readInt());
                                                reply.writeNoException();
                                            ...
                                            case 62:
                                                ...
                                                createUserKey(_arg03, _arg14, _arg2);
                                                reply.writeNoException();
                                                return true;
                                            case 63:
                                                data.enforceInterface(DESCRIPTOR);
                                            ...
                                            default:
                                                switch (code) {
                                                    ...
                                                    case 75:
                                                        data.enforceInterface(DESCRIPTOR);
                                                        ParcelFileDescriptor _result17 = openProxyFileDescriptor(data.readInt(), data.readInt(), data.readInt());
                                                        reply.writeNoException();
                                                        if (_result17 != null) {
                                                            reply.writeInt(1);
                                                    ...
                                                    case 76:
                                                        data.enforceInterface(DESCRIPTOR);
                                                        long _result18 = getCacheQuotaBytes(data.readString(), data.readInt());
                                                        reply.writeNoException();
                                                        reply.writeLong(_result18);
                                                        return true;
                                                    case 77:
                                                        data.enforceInterface(DESCRIPTOR);
                                                        long _result19 = getCacheSizeBytes(data.readString(), data.readInt());
                                                        reply.writeNoException();
                                                        reply.writeLong(_result19);
                                                        return true;
                                                    case 78:
                                                        data.enforceInterface(DESCRIPTOR);
                                                        long _result20 = getAllocatableBytes(data.readString(), data.readInt(), data.readString());
                                                        reply.writeNoException();
