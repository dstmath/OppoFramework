...
public class VolumeInfo extends OppoBaseVolumeInfo {
    ...
    @Override // android.os.storage.OppoBaseVolumeInfo
    ...
    @Override // android.os.Parcelable, android.os.storage.OppoBaseVolumeInfo
