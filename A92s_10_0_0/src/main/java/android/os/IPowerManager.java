            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        acquireWakeLock(_arg07, _arg13, _arg23, _arg3, _arg4, data.readString());
                    ...
                    case 6:
                        ...
                        updateWakeLockWorkSource(_arg08, _arg1, data.readString());
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface("android.os.IPowerManager");
                    ...
                    case 16:
                        ...
                        boolean dynamicPowerSaveHint = setDynamicPowerSaveHint(_arg06, data.readInt());
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        boolean adaptivePowerSaveEnabled = setAdaptivePowerSaveEnabled(_arg05);
                        reply.writeNoException();
                    ...
                    case 42:
                        ...
                        setAttentionLight(_arg04, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 43:
                        data.enforceInterface("android.os.IPowerManager");
