...
public final class StrictMode {
    ...
    public static final class ViolationInfo implements Parcelable {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.os.StrictMode.ViolationInfo.<init>(android.os.Parcel, boolean):void
         arg types: [android.os.Parcel, int]
         candidates:
          android.os.StrictMode.ViolationInfo.<init>(android.os.strictmode.Violation, int):void
          android.os.StrictMode.ViolationInfo.<init>(android.os.Parcel, boolean):void */
