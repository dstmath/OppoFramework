...
public abstract class VibrationEffect implements Parcelable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.os.VibrationEffect.get(int, boolean):android.os.VibrationEffect
     arg types: [int, int]
     candidates:
      android.os.VibrationEffect.get(android.net.Uri, android.content.Context):android.os.VibrationEffect
      android.os.VibrationEffect.get(int, boolean):android.os.VibrationEffect */
