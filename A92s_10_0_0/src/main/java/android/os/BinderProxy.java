...
public final class BinderProxy implements IBinder {
                ...
                if (Build.IS_DEBUGGABLE && totalSize >= 20000) {
                    ...
                    if (totalUnclearedSize >= 20000) {
                        ...
                        if (ActivityThread.isSystem()) {
                            String profName = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()).replaceAll(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER, Session.SESSION_SEPARATION_CHAR_CHILD).replaceAll(SettingsStringUtil.DELIMITER, NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
                            try {
    ...
    private static class NoImagePreloadHolder {
        ...
        public static final NativeAllocationRegistry sRegistry = new NativeAllocationRegistry(BinderProxy.class.getClassLoader(), sNativeFinalizer, 3000);
