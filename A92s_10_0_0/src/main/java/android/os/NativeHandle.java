...
public final class NativeHandle implements Closeable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.os.NativeHandle.<init>(java.io.FileDescriptor[], int[], boolean):void
     arg types: [java.io.FileDescriptor[], int[], int]
     candidates:
      android.os.NativeHandle.<init>(int[], int[], boolean):void
      android.os.NativeHandle.<init>(java.io.FileDescriptor[], int[], boolean):void */
    public NativeHandle() {
