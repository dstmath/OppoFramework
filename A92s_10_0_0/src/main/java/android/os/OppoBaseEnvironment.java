...
public class OppoBaseEnvironment {
    private static final String COTA_ENABLE = SystemProperties.get("sys.cotaimg.verify", WifiEnterpriseConfig.ENGINE_DISABLE);
    ...
    public static File getResourceDirectory() {
        if (COTA_ENABLE.equals(WifiEnterpriseConfig.ENGINE_ENABLE)) {
