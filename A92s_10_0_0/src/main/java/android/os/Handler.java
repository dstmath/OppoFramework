...
public class Handler {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.os.Handler.<init>(android.os.Handler$Callback, boolean):void
     arg types: [?[OBJECT, ARRAY], int]
     candidates:
      android.os.Handler.<init>(android.os.Looper, android.os.Handler$Callback):void
      android.os.Handler.<init>(android.os.Handler$Callback, boolean):void */
    public Handler() {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.os.Handler.<init>(android.os.Handler$Callback, boolean):void
     arg types: [android.os.Handler$Callback, int]
     candidates:
      android.os.Handler.<init>(android.os.Looper, android.os.Handler$Callback):void
      android.os.Handler.<init>(android.os.Handler$Callback, boolean):void */
