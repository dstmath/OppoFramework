...
public final class MtpObjectInfo {
    ...
    public static class Builder {
        ...
        public Builder setCompressedSize(long value) {
            int unused = this.mObjectInfo.mCompressedSize = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }
        ...
        public Builder setImagePixDepth(long value) {
            int unused = this.mObjectInfo.mImagePixDepth = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }

        public Builder setImagePixHeight(long value) {
            int unused = this.mObjectInfo.mImagePixHeight = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }

        public Builder setImagePixWidth(long value) {
            int unused = this.mObjectInfo.mImagePixWidth = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }
        ...
        public Builder setSequenceNumber(long value) {
            int unused = this.mObjectInfo.mSequenceNumber = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }
        ...
        public Builder setThumbCompressedSize(long value) {
            int unused = this.mObjectInfo.mThumbCompressedSize = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }
        ...
        public Builder setThumbPixHeight(long value) {
            int unused = this.mObjectInfo.mThumbPixHeight = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }

        public Builder setThumbPixWidth(long value) {
            int unused = this.mObjectInfo.mThumbPixWidth = MtpObjectInfo.longToUint32(value, "value");
            return this;
        }
