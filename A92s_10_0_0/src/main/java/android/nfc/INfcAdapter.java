...
public interface INfcAdapter extends IInterface {
    ...
    public static class Default implements INfcAdapter {
        ...
        @Override // android.nfc.INfcAdapter
        public boolean setABFListenTechMask(int techMask) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements INfcAdapter {
        ...
        static final int TRANSACTION_getCplc = 30;
        ...
        static final int TRANSACTION_setABFListenTechMask = 29;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        boolean aBFListenTechMask = setABFListenTechMask(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(aBFListenTechMask ? 1 : 0);
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                        String _result8 = getCplc();
                        reply.writeNoException();
        ...
        private static class Proxy implements INfcAdapter {
            ...
            public boolean setABFListenTechMask(int techMask) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(techMask);
                    boolean _result = false;
                    if (!this.mRemote.transact(29, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setABFListenTechMask(techMask);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
