...
public final class Choreographer {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        ...
        android.view.animation.AnimationUtils.lockAnimationClock(r11 / android.util.TimeUtils.NANOS_PER_MS);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:67:0x01c2, code lost:
        if (android.view.Choreographer.DEBUG_FRAMES == false) goto L_0x0201;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:68:0x01c4, code lost:
        r2 = java.lang.System.nanoTime();
        android.util.Log.d(android.view.Choreographer.TAG, "Frame " + r24 + ": Finished, took " + (((float) (r2 - r7)) * 1.0E-6f) + " ms, latency " + (((float) (r7 - r11)) * 1.0E-6f) + " ms.");
     */
                ...
                if (!this.mFrameScheduled) {
                    ...
                    if (jitterNanos >= this.mFrameIntervalNanos) {
                        ...
                        if (skippedFrames >= ((long) this.SKIPPED_FRAME_WARNING_LIMIT)) {
                            ...
                            if (skippedFrames >= 15 && SystemProperties.getBoolean("debug.track_frame_skip", false) && !FrameSkipReporter.checkDuplicate(startNanos, jitterNanos)) {
                                FrameSkipReporter.report(skippedFrames);
                            }
                        }
