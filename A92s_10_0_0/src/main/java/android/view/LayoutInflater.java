...
public abstract class LayoutInflater {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:46:0x00a4 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:28:0x0077 */
    /* JADX DEBUG: Additional 7 move instruction added to help type inference */
                ...
                try {
                    ...
                    if (!TAG_MERGE.equals(name)) {
                        ...
                        try {
                            ...
                            e = e3;
                            InflateException ie3 = new InflateException(e.getMessage(), e);
                            ie3.setStackTrace(EMPTY_STACK_TRACE);
                            throw ie3;
                        } catch (Exception e4) {
                            e = e4;
                            r10 = c3;
                            InflateException ie22 = new InflateException(getParserStateDescription(inflaterContext, attrs) + ": " + e.getMessage(), e);
                    ...
                    e = e5;
                    InflateException ie32 = new InflateException(e.getMessage(), e);
                    ie32.setStackTrace(EMPTY_STACK_TRACE);
                    throw ie32;
                } catch (Exception e6) {
                    e = e6;
                    r10 = 1;
                    InflateException ie222 = new InflateException(getParserStateDescription(inflaterContext, attrs) + ": " + e.getMessage(), e);
    ...
    public final View createView(Context viewContext, String name, String prefix, AttributeSet attrs) throws ClassNotFoundException, InflateException {
        ...
        try {
            ...
            if (constructor == null) {
                ...
                Class<? extends View> clazz2 = Class.forName(str4, false, this.mContext.getClassLoader()).asSubclass(View.class);
                ...
                if (allowedState == null) {
                    ...
                    Class<? extends View> clazz3 = Class.forName(str3, false, this.mContext.getClassLoader()).asSubclass(View.class);
            ...
            sb3.append(clazz == null ? MediaStore.UNKNOWN_STRING : clazz.getName());
                ...
                try {
                    if (-1 == name.indexOf(46)) {
                        if (Trace.isTagEnabled(8)) {
                            Trace.traceBegin(8, "onCreateView:" + name);
                        }
    ...
    public final View tryCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mFactory2 != null) {
            if (Trace.isTagEnabled(8)) {
                Trace.traceBegin(8, "createView by " + this.mFactory2 + "-:" + name);
            }
            ...
            if (Trace.isTagEnabled(8)) {
                Trace.traceBegin(8, "createView by " + this.mFactory + "-:" + name);
            }
        ...
        if (view == null && this.mPrivateFactory != null) {
            if (Trace.isTagEnabled(8)) {
                Trace.traceBegin(8, "createView by " + this.mPrivateFactory + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + name);
            }
        ...
        private final Handler mHandler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(Message msg) {
                ...
                if (BlinkLayout.this.mBlink) {
                    ...
                    boolean unused = blinkLayout.mBlinkState = !blinkLayout.mBlinkState;
