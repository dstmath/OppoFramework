...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_SYSTEM_FINGERPRINT_KEYMODE = 289;
    ...
    public static final boolean isSystemKey(int keyCode) {
        if (keyCode == 2 || keyCode == 3 || keyCode == 4 || keyCode == 5 || keyCode == 6 || keyCode == 79 || keyCode == 80 || keyCode == 82 || keyCode == 130 || keyCode == 164 || keyCode == 289 || keyCode == 126 || keyCode == 127) {
            return true;
        }
        switch (keyCode) {
            case 24:
