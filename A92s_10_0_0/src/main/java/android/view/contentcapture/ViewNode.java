...
public final class ViewNode extends AssistStructure.ViewNode {
    ...
    public static final class ViewStructureImpl extends ViewStructure {
        ...
        public void setVisibility(int visibility) {
            ...
            long unused = viewNode.mFlags = (viewNode.mFlags & -13) | (((long) visibility) & ViewNode.FLAGS_VISIBILITY_MASK);
        }

        @Override // android.view.ViewStructure
        public void setAssistBlocked(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -1025) | (state ? 1024 : 0);
        }

        @Override // android.view.ViewStructure
        public void setEnabled(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -2049) | (state ? 0 : 2048);
        }

        @Override // android.view.ViewStructure
        public void setClickable(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -4097) | (state ? 4096 : 0);
        }

        @Override // android.view.ViewStructure
        public void setLongClickable(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -8193) | (state ? 8192 : 0);
        }

        @Override // android.view.ViewStructure
        public void setContextClickable(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -16385) | (state ? 16384 : 0);
        }

        @Override // android.view.ViewStructure
        public void setFocusable(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -32769) | (state ? 32768 : 0);
        }

        @Override // android.view.ViewStructure
        public void setFocused(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -65537) | (state ? 65536 : 0);
        }

        @Override // android.view.ViewStructure
        public void setAccessibilityFocused(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -131073) | (state ? 131072 : 0);
        }

        @Override // android.view.ViewStructure
        public void setCheckable(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -262145) | (state ? 262144 : 0);
        }

        @Override // android.view.ViewStructure
        public void setChecked(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -524289) | (state ? 524288 : 0);
        }

        @Override // android.view.ViewStructure
        public void setSelected(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -1048577) | (state ? 1048576 : 0);
        }

        @Override // android.view.ViewStructure
        public void setActivated(boolean state) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -2097153) | (state ? 2097152 : 0);
        }

        @Override // android.view.ViewStructure
        public void setOpaque(boolean opaque) {
            ViewNode viewNode = this.mNode;
            long unused = viewNode.mFlags = (viewNode.mFlags & -4194305) | (opaque ? 4194304 : 0);
        }
