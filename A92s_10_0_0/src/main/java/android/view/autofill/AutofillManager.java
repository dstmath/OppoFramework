...
public final class AutofillManager {
    ...
    private void notifyViewVisibilityChangedInternal(View view, int virtualId, boolean isVisible, boolean virtual) {
        ...
        synchronized (this.mLock) {
            ...
            } else if (this.mEnabled && isActiveLocked()) {
                if (virtual) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.view.autofill.AutofillManager.requestHideFillUi(android.view.autofill.AutofillId, boolean):void
     arg types: [android.view.autofill.AutofillId, int]
     candidates:
      android.view.autofill.AutofillManager.requestHideFillUi(android.view.autofill.AutofillId, android.view.View):void
      android.view.autofill.AutofillManager.requestHideFillUi(android.view.autofill.AutofillId, boolean):void */
