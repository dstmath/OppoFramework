...
public class View extends OppoBaseView implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    private static final String BOOST_VIEW_WECHAT = "com.tencent.mm.ui.q$20";
    ...
    private static final String[] FORCE_HARDWARE_LIST = {"com.tencent.mm/com.tencent.mm.ui.chatting.gallery.ImageGalleryUI", "com.tencent.mm/com.tencent.mm.plugin.sns.ui.SnsBrowseUI", "com.tencent.mm/com.tencent.mm.plugin.sns.ui.SnsUploadBrowseUI"};
    ...
    private static volatile int sCurrentPid = 0;
    ...
    private static volatile boolean sIsNeedToHardDraw = false;
    private static int sNextAccessibilityViewId;
    private static final AtomicInteger sNextGeneratedId = new AtomicInteger(1);
    protected static boolean sPreserveMarginParamsInLayoutParamConversion;
    private static boolean sShouldCheckTouchBoost = false;
    ...
    protected boolean mIgnoreOnDescendantInvalidated;
    ...
    public View(Context context) {
        ...
        this.mViewHooks = (IColorViewHooks) ColorFrameworkFactory.getInstance().getFeature(IColorViewHooks.DEFAULT, this, this.mResources);
        ...
        if (this.mContext.getPackageName() != null && this.mContext.getPackageName().equals(LMManager.MM_PACKAGENAME)) {
            sShouldCheckTouchBoost = true;
        }
        int pid = Binder.getCallingPid();
        if (pid != sCurrentPid) {
            Log.d(VIEW_LOG_TAG, "pid changed  current pid ==" + sCurrentPid + "   pid == " + pid);
            try {
                if (WifiEnterpriseConfig.ENGINE_ENABLE.equals(OppoAtlasManager.getInstance(null).getParameters("get_listinfo_bypid=hardware-draw-white-list=" + pid))) {
                    sIsNeedToHardDraw = true;
                } else {
                    sIsNeedToHardDraw = false;
                }
            } catch (NullPointerException e) {
                Log.e(VIEW_LOG_TAG, "OppoMultimediaService getParameters failed");
            }
            sCurrentPid = pid;
        }
        if (CLASS_NAME_SPECIAL_VIEW_01.equals(getClass().getName())) {
    ...
    /* JADX INFO: Multiple debug info for r1v2 int: [D('targetSdkVersion' int), D('leftPadding' int)] */
    /* JADX INFO: Multiple debug info for r16v1 int: [D('viewFlagMasks' int), D('viewFlagValues' int)] */
    /* JADX INFO: Multiple debug info for r15v33 int: [D('numHints' int), D('rightPaddingDefined' boolean)] */
    /* JADX WARNING: Code restructure failed: missing block: B:199:0x071a, code lost:
        if (r1 >= 14) goto L_0x08aa;
     */
    public View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        for (int N = a.getIndexCount(); i < N; N = N) {
            ...
            if (attr != 109) {
                ...
                if (leftPadding3 >= 23 || (this instanceof FrameLayout)) {
                    ...
                    boolean unused = foregroundInfo.mInsidePadding = a.getBoolean(attr, foregroundInfo.mInsidePadding);
                }
            }
            padding2 = padding2;
            rightPaddingDefined3 = rightPaddingDefined;
        ...
        if (padding2 >= 0) {
            ...
            rightPadding = padding2;
            rightPadding2 = paddingHorizontal;
        } else {
            padding = padding2;
    ...
    public final boolean debugDraw() {
        ...
        return DEBUG_DRAW || ((attachInfo = this.mAttachInfo) != null && attachInfo.mDebugLayout) || debugWebViewDraw();
    }
    ...
    public boolean performClick() {
        ...
        if (li == null || li.mOnClickListener == null) {
            ...
            if (packageName != null && !packageName.isEmpty() && ((packageName.startsWith("com.qiyi.video") || packageName.startsWith("tv.danmaku.bili") || packageName.startsWith(LMManager.MM_PACKAGENAME)) && (liStr = li.mOnClickListener.toString()) != null && !liStr.isEmpty())) {
                if (liStr.startsWith(BOOST_VIEW_IQIYI) || liStr.startsWith(BOOST_VIEW_BILIBILI)) {
                    Log.d(VIEW_LOG_TAG, "Boost view " + li.mOnClickListener);
                    hypnusSetAction(13, 1000);
                }
                if (liStr.startsWith(BOOST_VIEW_WECHAT)) {
                    Log.d(VIEW_LOG_TAG, "Boost view " + li.mOnClickListener);
                    hypnusSetAction(13, OppoCommonConstants.PSW_LAST_MESSAGE);
                }
            }
            playSoundEffect(0);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v19, resolved type: com.color.util.ColorReflectDataUtils} */
    /* JADX WARN: Multi-variable type inference failed */
    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "XiaoKang.Feng@ROM.SDK, 2018-02-10 : modify WeiChat AccessibilityNodeInfo", property = OppoHook.OppoRomType.ROM)
    public AccessibilityNodeInfo createAccessibilityNodeInfo() {
        ...
        if (info != null && AccessibilityManager.getInstance(this.mContext).isEnabled() && AccessibilityManager.getInstance(this.mContext).isColorDirectEnabled()) {
            info.setRealClassName(getClass().getName());
            if (TextUtils.isEmpty(info.getText()) && TextUtils.isEmpty(info.getContentDescription())) {
                if (!this.mHasInit) {
                    this.mFieldText = ColorReflectDataUtils.getInstance().getTextField(this.mContext, getClass());
                    this.mHasInit = true;
                }
                try {
                    if (this.mFieldText != null) {
                        info.setContentDescription((CharSequence) this.mFieldText.get(this));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public boolean isImportantForAccessibility() {
        ...
        if (mode == 1 || isActionableForAccessibility() || hasListenersForAccessibility() || getAccessibilityNodeProvider() != null || getAccessibilityLiveRegion() != 0 || isAccessibilityPane() || AccessibilityManager.getInstance(this.mContext).isColorDirectEnabled()) {
            return true;
        }
        return false;
    }
    ...
    public void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (foregroundInfo != null) {
            boolean unused = foregroundInfo.mBoundsChanged = true;
        }
        AttachInfo ai = this.mAttachInfo;
        if (ai != null) {
            ...
            if ((i & 48) == 48 || ((invalidateCache && (i & 32768) == 32768) || (this.mPrivateFlags & Integer.MIN_VALUE) != Integer.MIN_VALUE || (fullInvalidate && isOpaque() != this.mLastIsOpaque))) {
                ...
                if (p != null && ai != null && l < r && t < b) {
                    ...
                    if (this.mIgnoreOnDescendantInvalidated && (p instanceof ViewGroup)) {
                        ((ViewGroup) p).mIgnoreOnDescendantInvalidated = true;
                    }
    ...
    /* JADX INFO: Multiple debug info for r5v1 int: [D('rightMask' int), D('canScrollLeft' boolean)] */
    private void onDrawScrollIndicators(Canvas c) {
        ...
        if ((this.mPrivateFlags3 & SCROLL_INDICATORS_PFLAG3_MASK) != 0 && (dr = this.mScrollIndicatorDrawable) != null) {
            ...
            if ((this.mPrivateFlags3 != false && (rightRtl | true)) && canScrollHorizontally(1)) {
    ...
    public void assignParent(ViewParent parent) {
        if (parent == null && isDebugVersion()) {
            this.mAssignNullStack = "mParent:" + this.mParent + " parent:" + parent + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + Debug.getCallers(8);
        }
        if (this.mParent == null) {
            this.mParent = parent;
        } else if (parent == null) {
    ...
    public void oppoAssignParent(ViewParent parent) {
        assignParent(parent);
    }
    ...
    public boolean isDebugVersion() {
        if (mDebugVersion == -1) {
            mDebugVersion = WifiEnterpriseConfig.ENGINE_ENABLE.equals(SystemProperties.get("SPECIAL_OPPO_CONFIG")) ? 1 : 0;
        }
    ...
    private boolean hasRtlSupport() {
        return ((IColorTextViewRTLUtilForUG) OppoFeatureCache.getOrCreate(IColorTextViewRTLUtilForUG.DEFAULT, new Object[0])).hasRtlSupportForView(this.mContext);
    }
    ...
    public void setLayerType(int layerType, Paint paint) {
        ...
        int layerType2 = ((IColorDarkModeManager) OppoFeatureCache.getOrCreate(IColorDarkModeManager.DEFAULT, new Object[0])).ensureLayerTypeWhenDarkMode(this.mContext, layerType);
        if (sShouldCheckTouchBoost && layerType2 == 1) {
            Context context = this.mContext;
            if ((context instanceof Activity) && (win = ((Activity) context).getWindow()) != null && shouldForceLayerHardware(win.getAttributes().getTitle())) {
                this.mPendingLayerType = 2;
            }
        }
        if (!this.mRenderNode.setLayerType(layerType2)) {
            setLayerPaint(paint);
            return;
        }
        if (layerType2 != 1) {
    ...
    public RenderNode updateDisplayListIfDirty() {
        ...
        if ((this.mPrivateFlags & 32768) != 0 && renderNode.hasDisplayList() && !this.mRecreateDisplayList) {
            ...
            if (Trace.isTagEnabled(8)) {
                Trace.traceBegin(8, "HWUI:" + getClass().getName());
            }
            if (true == sIsNeedToHardDraw) {
                layerType = 2;
            }
    ...
    public void buildDrawingCache(boolean autoScale) {
        ...
        try {
            if ("SnsCommentShowAbLayout".equals(getClass().getSimpleName())) {
                hypnusSetAction(13, 100);
            } else if ("MultiTouchImageView".equals(getClass().getSimpleName())) {
                hypnusSetAction(13, 30);
            }
    ...
    /* JADX INFO: Multiple debug info for r0v23 float: [D('clear' boolean), D('scale' float)] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:125:0x0230  */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x0234  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:163:0x0347  */
    /* JADX WARNING: Removed duplicated region for block: B:179:0x0389  */
    /* JADX WARNING: Removed duplicated region for block: B:186:0x03cd  */
    /* JADX WARNING: Removed duplicated region for block: B:192:0x03fd  */
    ...
    public boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        AttachInfo attachInfo = this.mAttachInfo;
        boolean drawingWithRenderNode = attachInfo != null && attachInfo.mHardwareAccelerated && hardwareAcceleratedCanvas;
        boolean more2 = false;
        ...
        AttachInfo attachInfo2 = this.mAttachInfo;
        boolean scalingRequired2 = attachInfo2 != null && attachInfo2.mScalingRequired;
        if (ViewDebugManager.DEBUG_DRAW) {
            Log.d(VIEW_LOG_TAG, "view draw1, this =" + this + ", drawingWithRenderNode = " + drawingWithRenderNode + ", childHasIdentityMatrix = " + childHasIdentityMatrix + ", scalingRequired = " + scalingRequired2);
        }
        ...
        if (a2 != null) {
            ...
            more2 = applyLegacyAnimation(parent, drawingTime, a, scalingRequired2);
        ...
        if (concatMatrix2 || (parentFlags & 2049) != 1 || !canvas.quickReject((float) this.mLeft, (float) this.mTop, (float) this.mRight, (float) this.mBottom, Canvas.EdgeType.BW) || (this.mPrivateFlags & 64) != 0) {
            ...
            boolean drawingWithDrawingCache2 = cache != null && !drawingWithRenderNode;
            ...
            if (offsetForScroll) {
                ...
                if (scalingRequired) {
                    ...
                    if (transformToApply == null || alpha < 1.0f) {
                        cache3 = cache;
                    } else if (!hasIdentityMatrix()) {
                        cache3 = cache;
                        ...
                        drawingWithDrawingCache = drawingWithDrawingCache2;
                        ...
                        if (ViewDebugManager.DEBUG_DRAW) {
                            ...
                            sb.append(drawingWithDrawingCache);
                            sb.append(", with render node = ");
                            sb.append(drawingWithRenderNode);
                            sb.append(", cache=");
                            sb.append(cache2 == null ? "Null" : "withCache");
                        ...
                        if (a != null && !more) {
                            ...
                            viewGroup.finishAnimatingView(this, a);
                        }
        ...
        if (ViewDebugManager.DEBUG_DRAW) {
            Log.d(str, "view draw1 quickReject, this =" + this);
        }
        return more2;
    }
    ...
    /* JADX INFO: Multiple debug info for r9v2 android.view.View$ScrollabilityCache: [D('offsetRequired' boolean), D('scrollabilityCache' android.view.View$ScrollabilityCache)] */
    /* JADX INFO: Multiple debug info for r6v1 int: [D('drawLeft' boolean), D('length' int)] */
    /* JADX INFO: Multiple debug info for r15v2 android.graphics.Shader: [D('topFadeStrength' float), D('fade' android.graphics.Shader)] */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: ClspMth{java.lang.Math.max(float, float):float}
     arg types: [int, float]
     candidates:
    ...
    public void draw(Canvas canvas) {
        ...
        if (ViewDebugManager.DEBUG_SYSTRACE_DRAW) {
            Trace.traceBegin(8, "draw:" + getClass().getName());
        }
        ...
        if (verticalEdges || horizontalEdges) {
            ...
            int right4 = (((this.mRight + left3) - this.mLeft) - this.mPaddingRight) - paddingLeft;
            int top = this.mScrollY + getFadeTop(offsetRequired);
            int bottom3 = top + getFadeHeight(offsetRequired);
            if (offsetRequired) {
                privateFlags = right4 + getRightPaddingOffset();
            ...
            if (verticalEdges) {
                if (top + length2 > right - length2) {
                    length2 = (right - top) / 2;
                }
            }
            if (!horizontalEdges || left3 + length2 <= privateFlags - length2) {
                length = length2;
            } else {
                length = (privateFlags - left3) / 2;
            }
            if (verticalEdges) {
                topFadeStrength = Math.max(0.0f, Math.min(1.0f, getTopFadingEdgeStrength()));
                drawTop = topFadeStrength * fadeHeight2 > 1.0f;
            ...
            if (solidColor == 0) {
                if (drawTop) {
                    topSaveCount3 = canvas.saveUnclippedLayer(left3, top, privateFlags, top + length);
                }
                if (drawBottom) {
                    topSaveCount2 = topSaveCount3;
                    bottomSaveCount2 = canvas.saveUnclippedLayer(left3, right - length, privateFlags, right);
                } else {
                    topSaveCount2 = topSaveCount3;
                }
                if (drawLeft) {
                    leftSaveCount4 = canvas.saveUnclippedLayer(left3, top, left3 + length, right);
                }
                if (drawRight) {
                    leftSaveCount2 = leftSaveCount4;
                    topSaveCount = topSaveCount2;
                    leftSaveCount = saveCount2;
                    saveCount = bottomSaveCount2;
                    bottomSaveCount = canvas.saveUnclippedLayer(privateFlags - length, top, privateFlags, right);
                } else {
                    leftSaveCount2 = leftSaveCount4;
                    topSaveCount = topSaveCount2;
                    leftSaveCount = saveCount2;
            ...
            if (ViewDebugManager.DEBUG_SYSTRACE_DRAW) {
                left = left3;
                bottom = right;
                Trace.traceBegin(8, "onDraw:" + getClass().getName());
            } else {
                left = left3;
                bottom = right;
            }
            ...
            dispatchDraw(canvas);
            Paint p3 = scrollabilityCache.paint;
            ...
            if (drawRight) {
                ...
                p3.setShader(fade);
                if (solidColor == 0) {
                    canvas.restoreUnclippedLayer(bottomSaveCount, p3);
                    p = p3;
                    ...
                    right2 = privateFlags;
                    right3 = leftSaveCount2;
                    canvas.drawRect((float) (privateFlags - length), (float) top, (float) privateFlags, (float) bottom, p);
                }
            } else {
                p = p3;
                fadeHeight = fadeHeight2;
            ...
            if (drawLeft) {
                ...
                if (solidColor == 0) {
                    ...
                    p = p;
                    canvas.drawRect((float) left2, (float) rightSaveCount, (float) (left2 + length), (float) bottom2, p);
                }
            }
            if (drawBottom) {
                ...
                if (solidColor == 0) {
                    ...
                    p2 = p;
                    leftSaveCount3 = right2;
                } else {
                    leftSaveCount3 = right2;
                    p2 = p;
                    canvas.drawRect((float) left2, (float) (bottom2 - length), (float) right2, (float) bottom2, p);
                }
            } else {
                p2 = p;
                leftSaveCount3 = right2;
            ...
            if (drawTop) {
                ...
                p2.setShader(fade);
                if (solidColor == 0) {
                    canvas.restoreUnclippedLayer(topSaveCount, p2);
                } else {
                    canvas.drawRect((float) left2, (float) rightSaveCount, (float) leftSaveCount3, (float) (rightSaveCount + length), p2);
                }
            }
        ...
        onDraw(canvas);
        ViewDebugManager.getInstance().debugOnDrawDone(this, logTime2);
        if (ViewDebugManager.DEBUG_SYSTRACE_DRAW) {
            Trace.traceEnd(8);
        }
        dispatchDraw(canvas);
    ...
    /* JADX INFO: Multiple debug info for r1v1 int: [D('scrollX' int), D('renderNode' android.graphics.RenderNode)] */
    @UnsupportedAppUsage
    ...
    public boolean setFrame(int left, int top, int right, int bottom) {
        ...
        if (ViewDebugManager.DEBUG_LAYOUT) {
            Log.d(VIEW_LOG_TAG, this + " View.setFrame(" + left + SmsManager.REGEX_PREFIX_DELIMITER + top + SmsManager.REGEX_PREFIX_DELIMITER + right + SmsManager.REGEX_PREFIX_DELIMITER + bottom + ")");
        }
    ...
    private void applyForegroundTint() {
        ...
        if (foregroundInfo != null && foregroundInfo.mDrawable != null && this.mForegroundInfo.mTintInfo != null) {
            ...
            if (tintInfo.mHasTintList || tintInfo.mHasTintMode) {
                ...
                Drawable unused = foregroundInfo2.mDrawable = foregroundInfo2.mDrawable.mutate();
                if (tintInfo.mHasTintList) {
    ...
    public void requestLayout() {
        ...
        if (viewParent != null && !viewParent.isLayoutRequested()) {
            try {
                ...
                if (isDebugVersion()) {
                    Log.e(VIEW_LOG_TAG, "mAssignNullStack:" + this.mAssignNullStack);
                }
                throw e;
            }
        }
        ...
        if (attachInfo == null) {
            ...
            try {
                ...
                try {
                    ...
                    float f = (float) shadowSize.x;
                    float f2 = (float) shadowSize.y;
                    float f3 = (float) shadowTouchPoint.x;
                    float f4 = (float) shadowTouchPoint.y;
                    surface = surface2;
                    session = session2;
                    str = VIEW_LOG_TAG;
                    try {
    ...
    private final class CheckForLongPress implements Runnable {
        ...
        public void run() {
            if (this.mOriginalPressedState == View.this.isPressed() && View.this.mParent != null && this.mOriginalWindowAttachCount == View.this.mWindowAttachCount) {
                ...
                } else if (View.this.performLongClick(this.mX, this.mY)) {
        ...
        if (this.mAnimator == null) {
            if (shouldBoostAnimation()) {
                this.mAnimator = new ViewPropertyAnimator(this) {
                    /* class android.view.View.AnonymousClass15 */

                    @Override // android.view.ViewPropertyAnimator
                    public void start() {
                        long duration = getDuration();
                        View.this.hypnusSetAction(11, duration > 1000 ? 1000 : (int) duration);
                        super.start();
                    }
                };
            } else {
    ...
    private static class ScrollabilityCache implements Runnable {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.graphics.LinearGradient.<init>(float, float, float, float, int, int, android.graphics.Shader$TileMode):void
    ...
    private boolean shouldForceLayerHardware(CharSequence title) {
        for (String t : FORCE_HARDWARE_LIST) {
            if (t.equals(title)) {
                return true;
            }
        }
    ...
    public void adjustLayerType(int width, int height) {
        if (this.mPendingLayerType == 2) {
            ...
            if (i == 1) {
                ...
                this.mPendingLayerType = 0;
            } else if (i == 2 && width * height > this.mForceHWSize) {
    ...
    public void hypnusSetAction(int action, int timeout) {
        ...
        mHM.hypnusSetSignatureAction(action, timeout, Hypnus.getLocalSignature());
    }
    ...
    @Override // android.view.OppoBaseView
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "XiaoKang.Feng@Plf.SDK, 2017-08-20 : Add for adjustNavigationBarColor", property = OppoHook.OppoRomType.ROM)
    public Bitmap getColorCustomDrawingCache(Rect clip, int viewTop) {
        ...
        try {
            ...
            if (width > 0) {
                if (height > 0) {
                    Bitmap colorCustomBitmap = Bitmap.createBitmap(this.mResources.getDisplayMetrics(), width, height, Bitmap.Config.ARGB_8888);
    ...
    /* access modifiers changed from: protected */
    @Override // android.view.OppoBaseView
    public void setValueScrollX(int value) {
        this.mScrollX = value;
    }

    /* access modifiers changed from: protected */
    @Override // android.view.OppoBaseView
    public void setValueScrollY(int value) {
        this.mScrollY = value;
    }
    ...
    public ArrayList<String> getScreenModeViewList() {
        ...
        return viewRoot.getScreenModeViewList();
    }
    ...
    public boolean isScreenModeViewListEmpty() {
        ...
        return viewRoot.isScreenModeViewListEmpty();
    }
    ...
    public boolean containInScreenModeViewList(String viewClassNameWithHash) {
        ...
        return viewRoot.containInScreenModeViewList(viewClassNameWithHash);
    }
    ...
    public void addViewToScreenModeViewList(String viewClassNameWithHash) {
        ViewRootImpl viewRoot = getViewRootImpl();
        if (viewRoot != null) {
            viewRoot.addViewToScreenModeViewList(viewClassNameWithHash);
        }
    }
    ...
    public void removeViewFromScreenModeViewList(String viewClassNameWithHash) {
        ViewRootImpl viewRoot = getViewRootImpl();
        if (viewRoot != null) {
            viewRoot.removeViewFromScreenModeViewList(viewClassNameWithHash);
        }
    }
}
