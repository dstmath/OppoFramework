...
public final class ViewRootImpl implements ViewParent, View.AttachInfo.Callbacks, ThreadedRenderer.DrawCallbacks, IColorBaseViewRoot {
    ...
    /* access modifiers changed from: private */
    public final int mNoncompatDensity;
    int mOrigWindowType;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:159:0x049f, code lost:
        return;
     */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.content.res.Resources.getValue(int, android.util.TypedValue, boolean):void
     arg types: [int, android.util.TypedValue, int]
     candidates:
      android.content.res.Resources.getValue(java.lang.String, android.util.TypedValue, boolean):void
      android.content.res.Resources.getValue(int, android.util.TypedValue, boolean):void */
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:343:0x0751 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:348:0x077d */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:353:0x07a9 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:369:0x0816 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:373:0x083f */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:390:0x0875 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:408:0x08ad */
    /* JADX DEBUG: Additional 55 move instruction added to help type inference */
    ...
    /* JADX WARN: Type inference failed for: r2v112, types: [android.view.DisplayCutout$ParcelableWrapper, java.lang.Object] */
                                                ...
                                                if ((host.mPrivateFlags & 512) != 0) {
                                                    ...
                                                    if (!this.mTransparentRegion.equals(this.mPreviousTransparentRegion)) {
                                                        ...
                                                        try {
                                                            ...
                                                            Log.e(this.mTag, "Exception in " + this + " when set transparent region.", e);
                                                        }
                                                    }
                                                }
                                                if (DBG) {
                                            ...
                                            if (computesInternalInsets) {
                                                ...
                                                if (insetsPending2 || !this.mLastGivenInsets.equals(insets)) {
                                                    ...
                                                    try {
                                                        ...
                                                        Log.e(this.mTag, "RemoteException happens when setInsets, mWindow = " + this.mWindow + ", contentInsets = " + visibleInsets2 + ", visibleInsets = " + visibleInsets + ", touchableRegion = " + touchableRegion + ", this = " + this, e2);
                                                    }
                                                }
                                            }
                                                    ...
                                                    try {
                                                        if (this.mAttachInfo.mThreadedRenderer.pause()) {
                                                            try {
                                                                ...
                                                                th = th;
                                                                insetsPending2 = insetsPending3;
                                                                relayoutResult4 = surfaceGenerationId;
                                                                while (true) {
                                                                    break;
                                                                }
                                                                throw th;
    ...
    abstract class InputStage {
        ...
        public void onDeliverToNext(QueuedInputEvent q) {
            ...
            if (ViewRootImpl.DEBUG_INPUT_STAGES || InputLog.DEBUG) {
                String access$700 = ViewRootImpl.this.mTag;
                Log.v(access$700, "Done with " + getClass().getSimpleName() + ". " + q);
            }
        ...
        public boolean shouldDropInputEvent(QueuedInputEvent q) {
            if (ViewRootImpl.this.mView == null || !ViewRootImpl.this.mAdded) {
                String access$700 = ViewRootImpl.this.mTag;
                Slog.w(access$700, "Dropping event due to root view being removed: " + q.mEvent);
                return true;
                ...
                if (ViewRootImpl.isTerminalInputEvent(q.mEvent)) {
                    q.mEvent.cancel();
                    if (ViewRootImpl.DEBUG_PANIC) {
                        String access$7002 = ViewRootImpl.this.mTag;
                        Slog.w(access$7002, "Cancelling event due to no window focus: " + q.mEvent + ", hasFocus:" + ViewRootImpl.this.mAttachInfo.mHasWindowFocus + ", mStopped:" + ViewRootImpl.this.mStopped + ", mPausedForTransition:" + ViewRootImpl.this.mPausedForTransition);
                    }
                    return false;
                }
                if (ViewRootImpl.DEBUG_PANIC) {
                    String access$7003 = ViewRootImpl.this.mTag;
                    Slog.w(access$7003, "Dropping event due to no window focus: " + q.mEvent + ", hasFocus:" + ViewRootImpl.this.mAttachInfo.mHasWindowFocus + ", mStopped:" + ViewRootImpl.this.mStopped + ", mPausedForTransition:" + ViewRootImpl.this.mPausedForTransition);
                }
                return true;
            }
        }
    ...
    final class ImeInputStage extends AsyncInputStage implements InputMethodManager.FinishedInputEventCallback {
        ...
        public int onProcess(QueuedInputEvent q) {
            ...
            if (ViewRootImpl.DEBUG_IMF) {
                String access$700 = ViewRootImpl.this.mTag;
                Log.v(access$700, "Sending input event to IME: " + event);
            }
        ...
        public void onFinishedInputEvent(Object token, boolean handled) {
            ...
            if (ViewRootImpl.DEBUG_IMF) {
                String access$700 = ViewRootImpl.this.mTag;
                Log.d(access$700, "IME finishedEvent: handled = " + handled + ", event = " + q + ", viewAncestor = " + this);
            }
            if (handled) {
                finish(q, true);
            } else {
    ...
    final class ViewPostImeInputStage extends InputStage {
        ...
        private int processKeyEvent(QueuedInputEvent q) {
            ...
            if (InputLog.DEBUG) {
                String access$700 = ViewRootImpl.this.mTag;
                InputLog.d(access$700, " processKeyEvent, " + event);
            }
            if (ViewRootImpl.this.mUnhandledKeyManager.preViewDispatch(event)) {
                if (ViewDebugManager.DEBUG_ENG) {
                    String access$7002 = ViewRootImpl.this.mTag;
                    Log.v(access$7002, "App handle dispatchUnique event = " + event + ", mView = " + ViewRootImpl.this.mView + ", this = " + this);
                }
                return 1;
            } else if (ViewRootImpl.this.mView.dispatchKeyEvent(event)) {
                if (InputLog.DEBUG) {
                    String access$7003 = ViewRootImpl.this.mTag;
                    InputLog.d(access$7003, event.getKeyCode() + " was FINISH_HANDLED by  mView ");
                }
                return 1;
            } else if (shouldDropInputEvent(q)) {
                return 2;
    ...
    final class SyntheticJoystickHandler extends Handler {
        ...
        public void process(MotionEvent event) {
            ...
            if (actionMasked == 2) {
                ...
                String access$700 = ViewRootImpl.this.mTag;
                Log.w(access$700, "Unexpected action: " + event.getActionMasked());
            } else {
                cancel();
            }
        }
        ...
        final class JoystickAxesState {
            ...
            public void updateStateForAxis(MotionEvent event, long time, int axis, float value) {
                ...
                if (isXAxis(axis)) {
                    ...
                    String access$700 = ViewRootImpl.this.mTag;
                    Log.e(access$700, "Unexpected axis " + axis + " in updateStateForAxis!");
                    return;
                }
            ...
            private int joystickAxisAndStateToKeycode(int axis, int state) {
                ...
                String access$700 = ViewRootImpl.this.mTag;
                Log.e(access$700, "Unknown axis " + axis + " or direction " + state);
                return 0;
            }
