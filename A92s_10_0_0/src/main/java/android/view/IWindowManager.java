...
public interface IWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowManager {
        ...
        static final int TRANSACTION_enableScreenIfNeeded = 70;
        ...
        static final int TRANSACTION_freezeDisplayRotation = 51;
        static final int TRANSACTION_freezeRotation = 48;
        ...
        static final int TRANSACTION_getDefaultDisplayRotation = 44;
        static final int TRANSACTION_getDockedStackSide = 73;
        static final int TRANSACTION_getFocusedWindowIgnoreHomeMenuKey = 113;
        static final int TRANSACTION_getFreeformStackBounds = 95;
        static final int TRANSACTION_getImeBgColorFromAdaptation = 111;
        static final int TRANSACTION_getInitialDisplayDensity = 9;
        static final int TRANSACTION_getInitialDisplaySize = 5;
        static final int TRANSACTION_getNavBarColorFromAdaptation = 109;
        static final int TRANSACTION_getNavBarPosition = 67;
        static final int TRANSACTION_getPreferredOptionsPanelGravity = 47;
        static final int TRANSACTION_getRemoveContentMode = 98;
        static final int TRANSACTION_getStableInsets = 79;
        static final int TRANSACTION_getStatusBarColorFromAdaptation = 110;
        static final int TRANSACTION_getTypedWindowLayer = 112;
        static final int TRANSACTION_getWindowContentFrameStats = 72;
        static final int TRANSACTION_getWindowingMode = 96;
        static final int TRANSACTION_hasNavigationBar = 66;
        static final int TRANSACTION_injectInputAfterTransactionsApplied = 106;
        static final int TRANSACTION_isActivityNeedPalette = 108;
        static final int TRANSACTION_isDisplayRotationFrozen = 53;
        static final int TRANSACTION_isInFreeformMode = 94;
        static final int TRANSACTION_isKeyguardLocked = 28;
        static final int TRANSACTION_isKeyguardSecure = 29;
        static final int TRANSACTION_isRotationFrozen = 50;
        static final int TRANSACTION_isSafeModeEnabled = 69;
        static final int TRANSACTION_isViewServerRunning = 3;
        static final int TRANSACTION_isWindowTraceEnabled = 89;
        ...
        static final int TRANSACTION_registerDockedStackListener = 75;
        static final int TRANSACTION_registerOppoWindowStateObserver = 92;
        static final int TRANSACTION_registerPinnedStackListener = 76;
        static final int TRANSACTION_registerShortcutKey = 81;
        static final int TRANSACTION_registerSystemGestureExclusionListener = 57;
        static final int TRANSACTION_registerWallpaperVisibilityListener = 55;
        static final int TRANSACTION_removeRotationWatcher = 46;
        static final int TRANSACTION_removeWindowToken = 17;
        static final int TRANSACTION_requestAppKeyboardShortcuts = 78;
        static final int TRANSACTION_requestAssistScreenshot = 59;
        static final int TRANSACTION_requestUserActivityNotification = 90;
        static final int TRANSACTION_screenshotWallpaper = 54;
        static final int TRANSACTION_setAnimationScale = 35;
        static final int TRANSACTION_setAnimationScales = 36;
        static final int TRANSACTION_setDockedStackDividerTouchRegion = 74;
        static final int TRANSACTION_setEventDispatching = 15;
        static final int TRANSACTION_setForceShowSystemBars = 61;
        ...
        static final int TRANSACTION_setForwardedInsets = 80;
        static final int TRANSACTION_setInTouchMode = 38;
        static final int TRANSACTION_setNavBarVirtualKeyHapticFeedbackEnabled = 65;
        static final int TRANSACTION_setOverscan = 14;
        static final int TRANSACTION_setPipVisibility = 63;
        static final int TRANSACTION_setRecentsVisibility = 62;
        static final int TRANSACTION_setRemoveContentMode = 99;
        static final int TRANSACTION_setResizeDimLayer = 77;
        static final int TRANSACTION_setRotationLockForBootAnimation = 43;
        static final int TRANSACTION_setShelfHeight = 64;
        static final int TRANSACTION_setShouldShowIme = 105;
        static final int TRANSACTION_setShouldShowSystemDecors = 103;
        ...
        static final int TRANSACTION_shouldShowIme = 104;
        ...
        static final int TRANSACTION_statusBarVisibilityChanged = 60;
        ...
        static final int TRANSACTION_thawDisplayRotation = 52;
        static final int TRANSACTION_thawRotation = 49;
        static final int TRANSACTION_unregisterDisplayFoldListener = 86;
        static final int TRANSACTION_unregisterOppoWindowStateObserver = 93;
        static final int TRANSACTION_unregisterSystemGestureExclusionListener = 58;
        static final int TRANSACTION_unregisterWallpaperVisibilityListener = 56;
        static final int TRANSACTION_updateRotation = 42;
        static final int TRANSACTION_watchRotation = 45;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        getInitialDisplaySize(_arg016, _arg18);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 6:
                        ...
                        getBaseDisplaySize(_arg017, _arg19);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 18:
                        ...
                        prepareAppTransition(_arg018, _arg17);
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface("android.view.IWindowManager");
                        ...
                        overridePendingAppTransitionMultiThumbFuture(_arg019, _arg110, _arg2, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 20:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 30:
                        data.enforceInterface("android.view.IWindowManager");
                        IKeyguardDismissCallback _arg020 = IKeyguardDismissCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg1 = TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(data);
                        } else {
                            _arg1 = null;
                        }
                        dismissKeyguard(_arg020, _arg1);
                        reply.writeNoException();
                        return true;
                    case 31:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 39:
                        ...
                        showStrictModeViolation(_arg013);
                        reply.writeNoException();
                        return true;
                    case 40:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 43:
                        ...
                        setRotationLockForBootAnimation(_arg012);
                        reply.writeNoException();
                        return true;
                    case 44:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 79:
                        ...
                        getStableInsets(_arg022, _arg111);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 80:
                        ...
                        setForwardedInsets(_arg023, _arg12);
                        reply.writeNoException();
                        return true;
                    case 81:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 82:
                        ...
                        createInputConsumer(_arg024, _arg112, _arg22, _arg3);
                        reply.writeNoException();
                        reply.writeInt(1);
                    ...
                    case 95:
                        data.enforceInterface("android.view.IWindowManager");
                        Rect _arg025 = new Rect();
                        getFreeformStackBounds(_arg025);
                        reply.writeNoException();
                        reply.writeInt(1);
                        _arg025.writeToParcel(reply, 1);
                        return true;
                    case 96:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 101:
                        ...
                        setShouldShowWithInsecureKeyguard(_arg026, _arg15);
                        reply.writeNoException();
                        return true;
                    case 102:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 103:
                        ...
                        setShouldShowSystemDecors(_arg027, _arg14);
                        reply.writeNoException();
                        return true;
                    case 104:
                        data.enforceInterface("android.view.IWindowManager");
                    ...
                    case 105:
                        ...
                        setShouldShowIme(_arg028, _arg13);
                        reply.writeNoException();
                        return true;
                    case 106:
                        data.enforceInterface("android.view.IWindowManager");
