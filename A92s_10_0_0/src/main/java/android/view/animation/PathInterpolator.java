...
public class PathInterpolator extends BaseInterpolator implements NativeInterpolatorFactory {
    ...
    /* JADX INFO: Multiple debug info for r4v7 float: [D('componentIndex' int), D('fraction' float)] */
    /* JADX INFO: Multiple debug info for r6v1 float: [D('componentIndex' int), D('x' float)] */
