...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    public final float getX(int pointerIndex) {
        try {
            ...
            Log.d(TAG, "MotionEvent is IllegalArgumentException " + e);
            return 0.0f;
        }
    }
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_METHOD, note = "Jun.Zhang@ROM.Framework,2014.09.01:Add for drag screen", property = OppoHook.OppoRomType.OPPO)
