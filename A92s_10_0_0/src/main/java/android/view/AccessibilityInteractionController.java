...
public final class AccessibilityInteractionController {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v2, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v6, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v10, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v11, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v13, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r17v14, resolved type: java.util.ArrayList<android.view.accessibility.AccessibilityNodeInfo>} */
    ...
    public void findAccessibilityNodeInfosByTextUiThread(Message message) {
        ...
        infos = null;
        infos = null;
        ArrayList<AccessibilityNodeInfo> infos2 = null;
        try {
            if (this.mViewRootImpl.mView == null) {
                                            ...
                                            if (isShown(foundView)) {
                                                ...
                                                if (provider2 != null) {
                                                    ...
                                                    if (infosFromProvider != null) {
                                                        infos3.addAll(infosFromProvider);
                                                    }
                                                } else {
                                                    foundViews = foundViews2;
                                                    infos3.add(foundView.createAccessibilityNodeInfo());
                                                }
                                            } else {
                                                root = root2;
                                                foundViews = foundViews2;
