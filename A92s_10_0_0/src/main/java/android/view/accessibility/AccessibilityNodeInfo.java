...
public class AccessibilityNodeInfo implements Parcelable, IOppoAccessibilityNodeInfoEx {
    ...
    public static final class TouchDelegateInfo implements Parcelable {
        ...
        private int mConnectionId;
        /* access modifiers changed from: private */
        public ArrayMap<Region, Long> mTargetMap;
    ...
    @Override // android.view.accessibility.IOppoAccessibilityNodeInfoEx
    public CharSequence getRealClassName() {
        if (hasExtras()) {
            return getExtras().getCharSequence("realClassName");
        }
        return null;
    }

    public void setRealClassName(CharSequence className) {
