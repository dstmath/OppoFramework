...
public class ColorLongshotViewDump {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:59:0x0148 A[ExcHandler: all (th java.lang.Throwable), PHI: r7 r9 
      ...
      PHI: (r9v9 'preorderedList' java.util.ArrayList<android.view.View>) = (r9v10 'preorderedList' java.util.ArrayList<android.view.View>), (r9v14 'preorderedList' java.util.ArrayList<android.view.View>), (r9v15 'preorderedList' java.util.ArrayList<android.view.View>) binds: [B:39:0x00ce, B:9:0x0066, B:10:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:9:0x0066] */
    ...
    private static final class ViewNode {
        ...
        public void disableOverScroll() {
            ...
            if (root != null) {
                ...
                boolean access$100 = ColorLongshotViewDump.DBG;
                ColorLog.d(access$100, ColorLongshotViewDump.TAG, "disableOverScroll : " + this.mOverScrollMode);
        ...
        public void resetOverScroll() {
            ...
            if (root != null) {
                ...
                if (this.mOverScrollMode >= 0) {
                    boolean access$100 = ColorLongshotViewDump.DBG;
                    ColorLog.d(access$100, ColorLongshotViewDump.TAG, "resetOverScroll : " + this.mOverScrollMode);
