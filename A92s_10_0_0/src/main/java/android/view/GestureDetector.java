...
public class GestureDetector {
    ...
    /* JADX INFO: Multiple debug info for r4v30 int: [D('deltaX' int), D('distance' int)] */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (i2 == 0) {
            ...
            if (i2 != 2) {
                ...
                if (this.mIsDoubleTapping) {
                    ...
                    if (Math.abs(scrollX) >= 1.0f || Math.abs(scrollY) >= 1.0f) {
                        recordGestureClassification(5);
                        boolean handled5 = this.mListener.onScroll(this.mCurrentDownEvent, ev, scrollX, scrollY);
                        this.mLastFocusX = focusX;
                        this.mLastFocusY = focusY;
                        handled = handled5;
                    } else {
            ...
            if (this.mIsDoubleTapping) {
                recordGestureClassification(2);
                handled3 = false | this.mDoubleTapListener.onDoubleTapEvent(ev);
            } else {
