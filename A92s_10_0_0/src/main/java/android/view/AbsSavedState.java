...
public abstract class AbsSavedState implements Parcelable {
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.view.AbsSavedState.2.createFromParcel(android.os.Parcel, java.lang.ClassLoader):android.view.AbsSavedState
         arg types: [android.os.Parcel, ?[OBJECT, ARRAY]]
         candidates:
          android.view.AbsSavedState.2.createFromParcel(android.os.Parcel, java.lang.ClassLoader):android.view.AbsSavedState
          MutableMD:(android.os.Parcel, java.lang.ClassLoader):java.lang.Object
          android.view.AbsSavedState.2.createFromParcel(android.os.Parcel, java.lang.ClassLoader):android.view.AbsSavedState */
