...
public class TransitionInflater {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.transition.Transition.excludeTarget(int, boolean):android.transition.Transition
     arg types: [int, int]
     candidates:
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.transition.Transition.excludeTarget(java.lang.String, boolean):android.transition.Transition
     ...
     candidates:
      ...
      android.transition.Transition.excludeTarget(java.lang.String, boolean):android.transition.Transition */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.transition.Transition.excludeTarget(java.lang.Class, boolean):android.transition.Transition
