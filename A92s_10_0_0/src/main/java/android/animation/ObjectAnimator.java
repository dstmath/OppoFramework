...
public final class ObjectAnimator extends ValueAnimator {
    ...
    public String getPropertyName() {
        ...
        for (int i = 0; i < this.mValues.length; i++) {
            if (i == 0) {
                ...
                propertyName = propertyName2 + SmsManager.REGEX_PREFIX_DELIMITER;
            }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:<V>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, java.lang.Object[]):android.animation.PropertyValuesHolder VARARG
     arg types: [java.lang.String, android.animation.TypeConverter<T, int[]>, android.animation.TypeEvaluator<T>, T[]]
     candidates:
      MutableMD:<T>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, android.animation.Keyframe[]):android.animation.PropertyValuesHolder VARARG
      MutableMD:<V>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, java.lang.Object[]):android.animation.PropertyValuesHolder VARARG */
    @SafeVarargs
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:<V>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, java.lang.Object[]):android.animation.PropertyValuesHolder VARARG
     arg types: [java.lang.String, android.animation.TypeConverter<T, float[]>, android.animation.TypeEvaluator<T>, T[]]
     candidates:
      MutableMD:<T>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, android.animation.Keyframe[]):android.animation.PropertyValuesHolder VARARG
      MutableMD:<V>:(java.lang.String, android.animation.TypeConverter, android.animation.TypeEvaluator, java.lang.Object[]):android.animation.PropertyValuesHolder VARARG */
    @SafeVarargs
