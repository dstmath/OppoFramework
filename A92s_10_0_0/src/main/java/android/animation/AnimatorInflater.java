...
public class AnimatorInflater {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v0, resolved type: android.content.res.ConfigurationBoundResourceCache<android.animation.Animator>} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v0, resolved type: android.content.res.ConfigurationBoundResourceCache<android.animation.StateListAnimator>} */
    /* JADX WARN: Multi-variable type inference failed */
