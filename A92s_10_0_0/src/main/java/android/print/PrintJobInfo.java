...
public final class PrintJobInfo implements Parcelable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.android.internal.util.Preconditions.checkArgumentInRange(float, float, float, java.lang.String):float
     arg types: [float, int, int, java.lang.String]
     candidates:
      com.android.internal.util.Preconditions.checkArgumentInRange(int, int, int, java.lang.String):int
      com.android.internal.util.Preconditions.checkArgumentInRange(long, long, long, java.lang.String):long
      com.android.internal.util.Preconditions.checkArgumentInRange(float, float, float, java.lang.String):float */
