...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_FOOLSCAP = new MediaSize("NA_FOOLSCAP", "android", R.string.mediasize_na_foolscap, OppoRecorder.NWAV_SAMPLERATE, 13000);
        public static final MediaSize NA_GOVT_LETTER = new MediaSize("NA_GOVT_LETTER", "android", R.string.mediasize_na_gvrnmt_letter, OppoRecorder.NWAV_SAMPLERATE, 10500);
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", "android", R.string.mediasize_na_index_3x5, OppoCommonConstants.PSW_LAST_MESSAGE, 5000);
        public static final MediaSize NA_INDEX_4X6 = new MediaSize("NA_INDEX_4X6", "android", R.string.mediasize_na_index_4x6, 4000, OppoTelephonyConstant.POLL_DORMANT_MILLIS);
        public static final MediaSize NA_INDEX_5X8 = new MediaSize("NA_INDEX_5X8", "android", R.string.mediasize_na_index_5x8, 5000, OppoRecorder.NWAV_SAMPLERATE);
        public static final MediaSize NA_JUNIOR_LEGAL = new MediaSize("NA_JUNIOR_LEGAL", "android", R.string.mediasize_na_junior_legal, OppoRecorder.NWAV_SAMPLERATE, 5000);
        ...
        public static final MediaSize NA_QUARTO = new MediaSize("NA_QUARTO", "android", R.string.mediasize_na_quarto, OppoRecorder.NWAV_SAMPLERATE, 10000);
