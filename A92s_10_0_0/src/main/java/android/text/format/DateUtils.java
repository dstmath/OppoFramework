...
public class DateUtils {
    ...
    public static String formatElapsedTime(StringBuilder recycle, long elapsedSeconds) {
        ...
        initFormatStrings();
        if (hours > 0) {
            return f.format(sElapsedFormatHMMSS, Long.valueOf(hours), Long.valueOf(minutes), Long.valueOf(elapsedSeconds2)).toString();
        }
        return f.format(sElapsedFormatMMSS, Long.valueOf(minutes), Long.valueOf(elapsedSeconds2)).toString();
    }
    ...
    public static CharSequence getRelativeTimeSpanString(Context c, long millis, boolean withPreposition) {
        ...
        synchronized (DateUtils.class) {
            ...
            if (span < 86400000 && sNowTime.weekDay == sThenTime.weekDay) {
                ...
                result = formatDateRange(c, millis, millis, OppoBaseNotificationChannel.USER_SUPPORT_NUM_BADGE);
                flags = R.string.preposition_for_date;
            }
            if (withPreposition) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.format.DateUtils.getRelativeTimeSpanString(android.content.Context, long, boolean):java.lang.CharSequence
     arg types: [android.content.Context, long, int]
     candidates:
      android.text.format.DateUtils.getRelativeTimeSpanString(long, long, long):java.lang.CharSequence
      android.text.format.DateUtils.getRelativeTimeSpanString(android.content.Context, long, boolean):java.lang.CharSequence */
