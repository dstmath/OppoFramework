...
public class TextUtils {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.SpannableStringBuilder.delete(int, int):android.text.SpannableStringBuilder
     arg types: [int, int]
     candidates:
      android.text.SpannableStringBuilder.delete(int, int):android.text.Editable
      android.text.Editable.delete(int, int):android.text.Editable
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.SpannableStringBuilder.append(java.lang.CharSequence, int, int):android.text.SpannableStringBuilder
     arg types: [java.lang.CharSequence, int, int]
     candidates:
      android.text.SpannableStringBuilder.append(java.lang.CharSequence, int, int):android.text.Editable
      android.text.SpannableStringBuilder.append(java.lang.CharSequence, java.lang.Object, int):android.text.SpannableStringBuilder
      android.text.SpannableStringBuilder.append(java.lang.CharSequence, int, int):java.lang.Appendable
      ...
      ClspMth{java.lang.Appendable.append(java.lang.CharSequence, int, int):java.lang.Appendable throws java.io.IOException}
      android.text.SpannableStringBuilder.append(java.lang.CharSequence, int, int):android.text.SpannableStringBuilder */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence, int, int):android.text.SpannableStringBuilder
     arg types: [int, java.lang.CharSequence, int, int]
     candidates:
      android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence, int, int):android.text.Editable
      android.text.Editable.insert(int, java.lang.CharSequence, int, int):android.text.Editable
      android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence, int, int):android.text.SpannableStringBuilder */
    ...
    public static <T> T[] removeEmptySpans(T[] spans, Spanned spanned, Class<T> klass) {
        ...
        for (int i = 0; i < spans.length; i++) {
            ...
            if (spanned.getSpanStart(span) == spanned.getSpanEnd(span)) {
                if (copy == null) {
                    copy = (Object[]) Array.newInstance((Class<?>) klass, spans.length - 1);
        ...
        T[] result = (Object[]) Array.newInstance((Class<?>) klass, count);
