...
public class DigitsKeyListener extends NumberKeyListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.method.DigitsKeyListener.getInstance(boolean, boolean):android.text.method.DigitsKeyListener
     arg types: [int, int]
     candidates:
      android.text.method.DigitsKeyListener.getInstance(java.util.Locale, android.text.method.DigitsKeyListener):android.text.method.DigitsKeyListener
