...
public abstract class BaseKeyListener extends MetaKeyKeyListener implements KeyListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.graphics.Paint.getTextRunCursor(java.lang.CharSequence, int, int, boolean, int, int):int
     arg types: [java.lang.CharSequence, int, int, int, int, int]
     candidates:
      android.graphics.Paint.getTextRunCursor(java.lang.String, int, int, boolean, int, int):int
      android.graphics.Paint.getTextRunCursor(char[], int, int, boolean, int, int):int
      android.graphics.Paint.getTextRunCursor(java.lang.CharSequence, int, int, boolean, int, int):int */
