...
public class StaticLayout extends Layout {
    ...
    /* JADX INFO: Multiple debug info for r1v11 'source'  java.lang.CharSequence: [D('source' java.lang.CharSequence), D('paraEnd' int)] */
    ...
    /* JADX INFO: Multiple debug info for r49v3 int: [D('fmAscent' int), D('fmDescent' int), D('fmBottom' int)] */
    ...
    /* JADX INFO: Multiple debug info for r3v39 float[]: [D('descents' float[]), D('ascents' float[])] */
    ...
    public void generate(Builder b, boolean includepad, boolean trackpad) {
        ...
        Spanned spanned4 = source3 instanceof Spanned ? (Spanned) source3 : null;
        ...
        if (bufEnd != bufStart && source.charAt(bufEnd - 1) != 10) {
            return;
        }
