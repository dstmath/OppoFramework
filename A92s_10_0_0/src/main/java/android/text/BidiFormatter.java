...
public final class BidiFormatter {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence
     arg types: [java.lang.String, android.text.TextDirectionHeuristic, boolean]
     candidates:
      android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String
      android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String
     arg types: [java.lang.String, android.text.TextDirectionHeuristic, int]
     candidates:
      android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence
      android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence
     arg types: [java.lang.CharSequence, android.text.TextDirectionHeuristic, int]
     candidates:
      android.text.BidiFormatter.unicodeWrap(java.lang.String, android.text.TextDirectionHeuristic, boolean):java.lang.String
      android.text.BidiFormatter.unicodeWrap(java.lang.CharSequence, android.text.TextDirectionHeuristic, boolean):java.lang.CharSequence */
    ...
    public static class DirectionalityEstimator {
        ...
        public static byte getDirectionality(int codePoint) {
            if (Emoji.isNewEmoji(codePoint)) {
                return OppoBaseBatteryStats.ThermalItem.CMD_GPSONOFF;
            }
        ...
        private byte skipTagForward() {
            ...
            while (true) {
                ...
                if (i < this.length) {
                    ...
                    char c = this.lastChar;
                    if (c == '>') {
                        return OppoBaseBatteryStats.ThermalItem.CMD_VIDEOONOFF;
                    }
                    if (c == '\"' || c == '\'') {
