...
abstract class SpannableStringInternal {
        ...
        while (i2 < spanCount) {
            ...
            if (spanStart <= queryEnd && spanEnd >= i && ((spanStart == spanEnd || i == queryEnd || !(spanStart == queryEnd || spanEnd == i)) && (kind == null || kind == Object.class || kind.isInstance(spans[i2])))) {
                if (count == 0) {
                    ...
                    if (count == 1) {
                        ret = (Object[]) Array.newInstance((Class<?>) kind, (spanCount - i2) + 1);
                        ret[0] = ret1;
                    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.SpannableStringInternal.copySpans(android.text.Spanned, int, int, boolean):void
     arg types: [android.text.Spanned, int, int, int]
     candidates:
      android.text.SpannableStringInternal.copySpans(android.text.SpannableStringInternal, int, int, boolean):void
      android.text.SpannableStringInternal.copySpans(android.text.Spanned, int, int, boolean):void */
    @UnsupportedAppUsage
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.text.SpannableStringInternal.copySpans(android.text.SpannableStringInternal, int, int, boolean):void
     arg types: [android.text.SpannableStringInternal, int, int, int]
     candidates:
      android.text.SpannableStringInternal.copySpans(android.text.Spanned, int, int, boolean):void
      android.text.SpannableStringInternal.copySpans(android.text.SpannableStringInternal, int, int, boolean):void */
    @UnsupportedAppUsage
