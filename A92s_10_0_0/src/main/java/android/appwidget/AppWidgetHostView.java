...
public class AppWidgetHostView extends FrameLayout {
    ...
    private class ViewApplyListener implements RemoteViews.OnViewAppliedListener {
        ...
        public void onError(Exception e) {
            if (this.mIsReapply) {
                ...
                CancellationSignal unused = appWidgetHostView.mLastExecutionSignal = remoteViews.applyAsync(context, appWidgetHostView2, appWidgetHostView2.mAsyncExecutor, new ViewApplyListener(this.mViews, this.mLayoutId, false), AppWidgetHostView.this.mOnClickHandler);
                return;
            }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, android.appwidget.AppWidgetHostView, int]
     candidates:
