...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, boolean):void
     arg types: [android.content.Context, int, ?[OBJECT, ARRAY], int]
     candidates:
      android.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, int):void
      android.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, boolean):void */
    ...
    @Override // android.widget.Adapter, android.widget.BaseAdapter, android.widget.CursorAdapter
    public boolean hasStableIds() {
        return false;
    }

    @Override // android.widget.CursorFilter.CursorFilterClient, android.widget.CursorAdapter
    ...
    @Override // android.widget.CursorAdapter, android.widget.ResourceCursorAdapter
    ...
    @Override // android.widget.SpinnerAdapter, android.widget.BaseAdapter, android.widget.CursorAdapter
