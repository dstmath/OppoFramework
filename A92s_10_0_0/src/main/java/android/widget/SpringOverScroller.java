...
public class SpringOverScroller extends OverScroller {
    ...
    public static OverScroller newInstance(Context context, boolean isScrollView) {
        ...
        boolean unused = s.mScrollerX.mIsScrollView = isScrollView;
        boolean unused2 = s.mScrollerY.mIsScrollView = isScrollView;
        return scroller;
    }
    ...
    public void setFlingFriction(float friction) {
        float unused = this.mScrollerX.mFlingFriction = friction;
        float unused2 = this.mScrollerY.mFlingFriction = friction;
    }
