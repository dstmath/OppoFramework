...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, android.widget.SearchView, int]
     candidates:
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mOnItemClickListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                boolean unused = SearchView.this.onItemClicked(position, 0, null);
            }
        };
    ...
    static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class android.widget.SearchView.SavedState.AnonymousClass1 */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.widget.AutoCompleteTextView.setText(java.lang.CharSequence, boolean):void
     arg types: [java.lang.CharSequence, int]
     candidates:
      android.widget.EditText.setText(java.lang.CharSequence, android.widget.TextView$BufferType):void
      android.widget.TextView.setText(int, android.widget.TextView$BufferType):void
      android.widget.TextView.setText(java.lang.CharSequence, android.widget.TextView$BufferType):void
      android.widget.AutoCompleteTextView.setText(java.lang.CharSequence, boolean):void */
    @UnsupportedAppUsage(maxTargetSdk = 28, trackingBug = 115609023)
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        final Runnable mRunShowSoftInputIfNecessary = new Runnable() {
            /* class android.widget.$$Lambda$SearchView$SearchAutoComplete$qdPU54FiW6QTzCbsg7P4cSs3cJ8 */
        ...
        @Override // android.widget.TextView, android.view.View, android.widget.AutoCompleteTextView
        public void onWindowFocusChanged(boolean hasWindowFocus) {
            super.onWindowFocusChanged(hasWindowFocus);
