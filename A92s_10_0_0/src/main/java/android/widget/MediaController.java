...
public class MediaController extends FrameLayout {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.widget.MediaController.<init>(android.content.Context, boolean):void
     arg types: [android.content.Context, int]
     candidates:
      android.widget.MediaController.<init>(android.content.Context, android.util.AttributeSet):void
      android.widget.MediaController.<init>(android.content.Context, boolean):void */
