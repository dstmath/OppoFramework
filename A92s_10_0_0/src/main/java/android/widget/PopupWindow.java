...
public class PopupWindow {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.widget.PopupWindow.<init>(android.view.View, int, int, boolean):void
     arg types: [android.view.View, int, int, int]
     candidates:
      android.widget.PopupWindow.<init>(android.content.Context, android.util.AttributeSet, int, int):void
      android.widget.PopupWindow.<init>(android.view.View, int, int, boolean):void */
    ...
    private void preparePopup(WindowManager.LayoutParams p) {
        ...
        ((IColorDarkModeManager) OppoFeatureCache.getOrCreate(IColorDarkModeManager.DEFAULT, new Object[0])).changeUsageForceDarkAlgorithmType(this.mDecorView, 2);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.widget.PopupWindow.update(int, int, int, int, boolean):void
