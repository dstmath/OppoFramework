...
public class QuickContactBadge extends ImageView implements View.OnClickListener {
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        public void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if (token != 0) {
                if (token != 1) {
                    if (token != 2) {
                        ...
                        Uri unused = QuickContactBadge.this.mContactUri = lookupUri;
                ...
                Uri unused2 = QuickContactBadge.this.mContactUri = lookupUri;
                QuickContactBadge.this.onContactUriChanged();
                if (!trigger) {
                }
                if (createUri != null) {
            ...
            Uri unused3 = QuickContactBadge.this.mContactUri = lookupUri;
            QuickContactBadge.this.onContactUriChanged();
            if (!trigger) {
            }
            if (createUri != null) {
