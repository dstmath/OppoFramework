...
public final class Magnifier {
    ...
    static Builder createBuilderWithOldMagnifierDefaults(View view) {
        ...
        int unused = params.mWidth = ((IColorMagnifierHooks) OppoFeatureCache.getOrCreate(IColorMagnifierHooks.DEFAULT, new Object[0])).getMagnifierWidth(a, context);
        int unused2 = params.mHeight = ((IColorMagnifierHooks) OppoFeatureCache.getOrCreate(IColorMagnifierHooks.DEFAULT, new Object[0])).getMagnifierHeight(a, context);
    ...
    private static float getDeviceDefaultDialogCornerRadius(Context context) {
        ...
        float dialogCornerRadius = ((IColorMagnifierHooks) OppoFeatureCache.getOrCreate(IColorMagnifierHooks.DEFAULT, new Object[0])).getMagnifierCornerRadius(ta, context);
        ta.recycle();
    ...
    public void setOnOperationCompleteCallback(Callback callback) {
        ...
        if (internalPopupWindow != null) {
            Callback unused = internalPopupWindow.mCallback = callback;
        }
    }
