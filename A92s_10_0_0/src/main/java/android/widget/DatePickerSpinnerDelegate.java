...
class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [int, android.widget.DatePicker, int]
     candidates:
    ...
    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "JiFeng.Tan@ROM.SDK : Modify for google code bug 1009285", property = OppoHook.OppoRomType.ROM)
