...
public class Editor {
    ...
    @OppoHook(level = OppoHook.OppoHookType.NEW_FIELD, note = "Jianhua.Lin@ROM.SDK : Add for textActionMode", property = OppoHook.OppoRomType.ROM)
    ...
    /* JADX INFO: Multiple debug info for r6v7 int: [D('selectionEnd' int), D('urlSpan' android.text.style.URLSpan)] */
    /* access modifiers changed from: package-private */
    ...
    /* JADX INFO: Multiple debug info for r12v2 int: [D('suggestionStart' int), D('i' int)] */
    ...
    public class SuggestionHelper {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.text.SpannableStringBuilder.replace(int, int, java.lang.CharSequence):android.text.SpannableStringBuilder
         arg types: [int, int, java.lang.String]
         candidates:
          android.text.SpannableStringBuilder.replace(int, int, java.lang.CharSequence):android.text.Editable
          android.text.Editable.replace(int, int, java.lang.CharSequence):android.text.Editable
          android.text.SpannableStringBuilder.replace(int, int, java.lang.CharSequence):android.text.SpannableStringBuilder */
    ...
    private final class SuggestionsPopupWindow extends PinnedPopupWindow implements AdapterView.OnItemClickListener {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence):android.text.SpannableStringBuilder
         arg types: [int, java.lang.String]
         candidates:
          android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence):android.text.Editable
          android.text.Editable.insert(int, java.lang.CharSequence):android.text.Editable
          android.text.SpannableStringBuilder.insert(int, java.lang.CharSequence):android.text.SpannableStringBuilder */
    ...
    private class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        private void updateSelectAllItem(Menu menu) {
            ...
            boolean canSelect = Editor.this.mTextView.canSelectText() && !Editor.this.mTextView.hasPasswordTransformationMethod() && Editor.this.mTextView.getSelectionStart() == Editor.this.mTextView.getSelectionEnd();
        ...
        @OppoHook(level = OppoHook.OppoHookType.NEW_METHOD, note = "Jianhua.Lin@ROM.SDK : Add for oppo style", property = OppoHook.OppoRomType.ROM)
    ...
    public final class SelectionHandleView extends HandleView {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:123:0x01cd, code lost:
            if (r8 < r23.mPrevLine) goto L_0x01d2;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:71:0x0130, code lost:
            if (android.widget.Editor.access$300(r23.this$0).canScrollHorizontally(r15 ? -1 : 1) != false) goto L_0x0132;
         */
        @Override // android.widget.Editor.HandleView
        public void updatePosition(float x, float y, boolean fromTouchScreen) {
            boolean isExpanding;
                ...
                if ((!rtlAtCurrentOffset || atRtl) && (rtlAtCurrentOffset || !atRtl)) {
                    if (!this.mLanguageDirectionChanged || isLvlBoundary) {
                        ...
                        if (isExpanding2) {
                            ...
                            if ((!this.mInWord || (!isStartHandle() ? currLine > this.mPrevLine : currLine < this.mPrevLine)) && atRtl == isAtRtlRun(layout, wordBoundary)) {
                                ...
                                if (isStartHandle()) {
                                    ...
                                    offsetThresholdToSnap = ((wordBoundary - wordStart) / 2) + wordStart;
                                }
                                if (isStartHandle()) {
    ...
    class SelectionModifierCursorController implements CursorController {
        ...
        @OppoHook(level = OppoHook.OppoHookType.NEW_METHOD, note = "Jianhua.Lin@ROM.SDK : Add for textActionMode", property = OppoHook.OppoRomType.ROM)
    ...
    static final class ProcessTextIntentActionsHandler {
        ...
        /* JADX INFO: Multiple debug info for r0v4 int: [D('actionId' int), D('i' int)] */
