...
public class LinearLayout extends ViewGroup {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        @Override // android.view.ViewGroup.LayoutParams, android.view.ViewGroup.MarginLayoutParams
        @UnsupportedAppUsage
    ...
    /* JADX INFO: Multiple debug info for r2v2 int: [D('largestChildWidth' int), D('alternativeMaxHeight' int)] */
    /* JADX INFO: Multiple debug info for r3v33 int: [D('maxHeight' int), D('totalLength' int)] */
    /* access modifiers changed from: package-private */
    ...
    public void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i3 < count2) {
            ...
            if (child == null) {
                ...
                weightedMaxHeight2 = childState4;
            ...
            i3++;
            childState4 = weightedMaxHeight2;
                ...
                while (i4 < count2) {
                    ...
                    if (child2 == null) {
                        ...
                        if (isExactly) {
                            ...
                            i = i4;
                            int totalLength3 = this.mTotalLength;
                            this.mTotalLength = Math.max(totalLength3, totalLength3 + largestChildWidth4 + lp3.leftMargin + lp3.rightMargin + getNextLocationOffset(child2));
                        }
                    }
                    i4 = i + 1;
        ...
        if (skippedMeasure) {
            ...
            setMeasuredDimension(widthSizeAndState | (-16777216 & childState3), resolveSizeAndState(Math.max(maxHeight + this.mPaddingTop + this.mPaddingBottom, getSuggestedMinimumHeight()), widthMode3, childState3 << 16));
            if (!matchHeight) {
        ...
        int i6 = 0;
        childState3 = childState;
        float remainingWeightSum3 = remainingWeightSum2;
        int childHeightMeasureSpec = remainingExcess;
        ...
        while (i6 < count2) {
            ...
            if (child4 != null) {
                ...
                if (child4.getVisibility() == 8) {
                    ...
                    if (childWeight > 0.0f) {
                        widthSizeAndState2 = widthSizeAndState3;
                        int share = (int) ((((float) childHeightMeasureSpec) * childWeight) / remainingWeightSum3);
                        int remainingExcess6 = childHeightMeasureSpec - share;
                        float remainingWeightSum4 = remainingWeightSum3 - childWeight;
                        ...
                        childHeightMeasureSpec = remainingExcess6;
                        remainingWeightSum3 = remainingWeightSum4;
                    } else {
                        largestChildWidth = largestChildWidth4;
                        widthMode4 = widthMode2;
                        widthSizeAndState2 = widthSizeAndState3;
                    ...
                    if (isExactly) {
                        ...
                        remainingExcess2 = childHeightMeasureSpec;
                    } else {
                        int totalLength4 = this.mTotalLength;
                        remainingExcess2 = childHeightMeasureSpec;
                    ...
                    if (allFillParent2) {
                        ...
                        if (lp4.height == -1) {
                            ...
                            childHeightMeasureSpec = remainingExcess2;
                            alternativeMaxHeight8 = alternativeMaxHeight2;
                            remainingWeightSum3 = remainingWeightSum;
                        }
                    } else {
                        alternativeMaxHeight2 = alternativeMaxHeight9;
                    }
    ...
    @OppoHook(level = OppoHook.OppoHookType.CHANGE_CODE, note = "Yujun.Feng@ROM.SDK, 2017-08-10 : modify for rtl bug", property = OppoHook.OppoRomType.ROM)
        ...
        while (i2 < count2) {
            ...
            if (child == null) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    childLeft32 += this.mDividerWidth;
                    i2 += getChildrenSkipCount(child, childIndex);
