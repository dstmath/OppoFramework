...
public class SpellChecker implements SpellCheckerSession.SpellCheckerSessionListener {
    ...
    /* JADX INFO: Multiple debug info for r0v2 boolean: [D('codePoint' int), D('haveWordBoundariesChanged' boolean)] */
    /* JADX INFO: Multiple debug info for r0v5 boolean: [D('codePoint' int), D('haveWordBoundariesChanged' boolean)] */
