...
public class OppoOverScroller extends OverScroller {
    ...
    /* access modifiers changed from: private */
    public static int sOverscrollDistance;
    ...
    public void setEnableScrollList(boolean flag) {
        boolean unused = this.mScrollerX.mIsScrollList = flag;
        boolean unused2 = this.mScrollerY.mIsScrollList = flag;
    }
    ...
    public static OverScroller newInstance(Context context, boolean isScrollList) {
        ...
        boolean unused = mOppoScroller.mScrollerX.mIsScrollList = isScrollList;
        boolean unused2 = mOppoScroller.mScrollerY.mIsScrollList = isScrollList;
        return mScroller;
    }
    ...
    public final void oppoForceFinished(boolean finished) {
        boolean unused = this.mScrollerX.mFinished = finished;
        boolean unused2 = this.mScrollerY.mFinished = finished;
    }
    ...
    public void setFlingFriction(float friction) {
        float unused = this.mScrollerX.mOrigamiFriction = friction;
        float unused2 = this.mScrollerY.mOrigamiFriction = friction;
    }
    ...
    static class OppoSplineOverScroller {
        ...
        /* access modifiers changed from: private */
        public boolean mIsScrollList = false;
        private double mLastDetla = 0.0d;
        private int mLastPosition;
        private double mLastVelocity;
        private int mOppoCount = 1;
        /* access modifiers changed from: private */
        public float mOrigamiFriction = 2.05f;
        private int mOver;
