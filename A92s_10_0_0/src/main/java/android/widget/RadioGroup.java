...
public class RadioGroup extends LinearLayout {
    ...
    private class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.widget.RadioGroup.access$302(android.widget.RadioGroup, boolean):boolean
         arg types: [android.widget.RadioGroup, int]
         candidates:
          android.view.ViewGroup.access$302(android.view.ViewGroup, boolean):boolean
          android.widget.RadioGroup.access$302(android.widget.RadioGroup, boolean):boolean */
