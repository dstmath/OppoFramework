...
public class RelativeLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r4v2 android.view.View[]: [D('width' int), D('views' android.view.View[])] */
                ...
                while (i6 < count3) {
                    ...
                    if (child5.getVisibility() != 8) {
                        ...
                        if (rules2[13] != 0) {
                            ...
                            isWrapContentHeight = isWrapContentHeight2;
                            int unused3 = params4.mTop = (height2 - this.mPaddingBottom) - childHeight;
