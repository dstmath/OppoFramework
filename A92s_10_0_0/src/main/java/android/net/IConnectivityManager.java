...
public interface IConnectivityManager extends IInterface {
    ...
    boolean measureDataState(int i) throws RemoteException;

    boolean oppoExecuteIPtableCmd(String str, String str2) throws RemoteException;
    ...
    void setAlreadyUpdated(boolean z) throws RemoteException;
    ...
    void setTelephonyPowerLost(double d) throws RemoteException;

    void setTelephonyPowerState(String str) throws RemoteException;
    ...
    boolean shouldKeepCelluarNetwork(boolean z) throws RemoteException;
    ...
    void updateDataNetworkConfig(String str, String str2) throws RemoteException;
    ...
    public static class Default implements IConnectivityManager {
        ...
        @Override // android.net.IConnectivityManager
        public void setTelephonyPowerState(String powerState) throws RemoteException {
        }

        @Override // android.net.IConnectivityManager
        public void setAlreadyUpdated(boolean alreadyUpdated) throws RemoteException {
        }

        @Override // android.net.IConnectivityManager
        public void setTelephonyPowerLost(double powerLost) throws RemoteException {
        }

        @Override // android.net.IConnectivityManager
        public boolean measureDataState(int siganlLevel) throws RemoteException {
            return false;
        }
        ...
        @Override // android.net.IConnectivityManager
        public boolean shouldKeepCelluarNetwork(boolean keep) throws RemoteException {
            return false;
        }

        @Override // android.net.IConnectivityManager
        public void updateDataNetworkConfig(String name, String value) throws RemoteException {
        }
        ...
        @Override // android.net.IConnectivityManager
        public boolean oppoExecuteIPtableCmd(String cmd, String dstPort) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IConnectivityManager {
        ...
        static final int TRANSACTION_getCacheAge = 102;
        static final int TRANSACTION_getCaptivePortalServerUrl = 82;
        static final int TRANSACTION_getCelluarNetworkRequest = 98;
        static final int TRANSACTION_getConnectionOwnerUid = 84;
        static final int TRANSACTION_getCurrentTimeMillis = 103;
        ...
        static final int TRANSACTION_getTelephonyPowerLost = 93;
        static final int TRANSACTION_getTelephonyPowerState = 91;
        ...
        static final int TRANSACTION_hasCache = 101;
        static final int TRANSACTION_isActiveNetworkMetered = 18;
        static final int TRANSACTION_isAlreadyUpdated = 92;
        ...
        static final int TRANSACTION_measureDataState = 97;
        static final int TRANSACTION_oppoExecuteIPtableCmd = 104;
        ...
        static final int TRANSACTION_readArpFile = 105;
        ...
        static final int TRANSACTION_setAlreadyUpdated = 95;
        ...
        static final int TRANSACTION_setTelephonyPowerLost = 96;
        static final int TRANSACTION_setTelephonyPowerState = 94;
        ...
        static final int TRANSACTION_shouldKeepCelluarNetwork = 99;
        ...
        static final int TRANSACTION_updateDataNetworkConfig = 100;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 24:
                        ...
                        startTethering(_arg035, _arg1, _arg22, data.readString());
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 33:
                        ...
                        int _result27 = setUsbTethering(_arg034, data.readString());
                        reply.writeNoException();
                    ...
                    case 35:
                        ...
                        reportNetworkConnectivity(_arg04, _arg19);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 40:
                        ...
                        setVpnPackageAuthorization(_arg036, _arg110, _arg27);
                        reply.writeNoException();
                        return true;
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 47:
                        ...
                        boolean alwaysOnVpnPackage = setAlwaysOnVpnPackage(_arg037, _arg111, _arg26, data.createStringArrayList());
                        reply.writeNoException();
                    ...
                    case 53:
                        ...
                        setProvisioningNotificationVisible(_arg033, data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 54:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 65:
                        ...
                        setAcceptUnvalidated(_arg019, _arg112, _arg25);
                        reply.writeNoException();
                        return true;
                    case 66:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setAcceptPartialConnectivity(_arg020, _arg113, _arg24);
                        reply.writeNoException();
                        return true;
                    case 67:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 87:
                        ...
                        getLatestTetheringEntitlementResult(_arg038, _arg18, _arg23, data.readString());
                        reply.writeNoException();
                        return true;
                    case 88:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 91:
                        data.enforceInterface(DESCRIPTOR);
                        String _result49 = getTelephonyPowerState();
                        reply.writeNoException();
                    ...
                    case 92:
                        ...
                        reply.writeNoException();
                        reply.writeInt(isAlreadyUpdated ? 1 : 0);
                        return true;
                    case 93:
                        data.enforceInterface(DESCRIPTOR);
                        double _result50 = getTelephonyPowerLost();
                        reply.writeNoException();
                        reply.writeDouble(_result50);
                        return true;
                    case 94:
                        data.enforceInterface(DESCRIPTOR);
                        setTelephonyPowerState(data.readString());
                        reply.writeNoException();
                        return true;
                    case 95:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setAlreadyUpdated(_arg031);
                        reply.writeNoException();
                        return true;
                    case 96:
                        data.enforceInterface(DESCRIPTOR);
                        setTelephonyPowerLost(data.readDouble());
                        reply.writeNoException();
                        return true;
                    case 97:
                        data.enforceInterface(DESCRIPTOR);
                        boolean measureDataState = measureDataState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(measureDataState ? 1 : 0);
                        return true;
                    case 98:
                        data.enforceInterface(DESCRIPTOR);
                        NetworkRequest _result51 = getCelluarNetworkRequest();
                        reply.writeNoException();
                        if (_result51 != null) {
                            reply.writeInt(1);
                    ...
                    case 99:
                        ...
                        boolean shouldKeepCelluarNetwork = shouldKeepCelluarNetwork(_arg030);
                        reply.writeNoException();
                        reply.writeInt(shouldKeepCelluarNetwork ? 1 : 0);
                        return true;
                    case 100:
                        data.enforceInterface(DESCRIPTOR);
                        updateDataNetworkConfig(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 101:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        reply.writeNoException();
                        reply.writeInt(hasCache ? 1 : 0);
                        return true;
                    case 102:
                        data.enforceInterface(DESCRIPTOR);
                        long _result52 = getCacheAge();
                        reply.writeNoException();
                        reply.writeLong(_result52);
                        return true;
                    case 103:
                        data.enforceInterface(DESCRIPTOR);
                        long _result53 = getCurrentTimeMillis();
                        reply.writeNoException();
                        reply.writeLong(_result53);
                        return true;
                    case 104:
                        data.enforceInterface(DESCRIPTOR);
                        boolean oppoExecuteIPtableCmd = oppoExecuteIPtableCmd(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(oppoExecuteIPtableCmd ? 1 : 0);
                        return true;
                    case 105:
                        data.enforceInterface(DESCRIPTOR);
                        List<String> _result54 = readArpFile();
                        reply.writeNoException();
        ...
        private static class Proxy implements IConnectivityManager {
            ...
            public String getTelephonyPowerState() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(91, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getTelephonyPowerState();
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public boolean isAlreadyUpdated() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(92, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isAlreadyUpdated();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public double getTelephonyPowerLost() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(93, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getTelephonyPowerLost();
                    }
                    _reply.readException();
            ...
            public void setTelephonyPowerState(String powerState) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setTelephonyPowerState(powerState);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setAlreadyUpdated(boolean alreadyUpdated) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(alreadyUpdated ? 1 : 0);
                    ...
                    Stub.getDefaultImpl().setAlreadyUpdated(alreadyUpdated);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setTelephonyPowerLost(double powerLost) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setTelephonyPowerLost(powerLost);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean measureDataState(int siganlLevel) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(siganlLevel);
                    boolean _result = false;
                    if (!this.mRemote.transact(97, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().measureDataState(siganlLevel);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public NetworkRequest getCelluarNetworkRequest() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(98, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCelluarNetworkRequest();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = NetworkRequest.CREATOR.createFromParcel(_reply);
            ...
            public boolean shouldKeepCelluarNetwork(boolean keep) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(99, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().shouldKeepCelluarNetwork(keep);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public void updateDataNetworkConfig(String name, String value) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().updateDataNetworkConfig(name, value);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean hasCache() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(101, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().hasCache();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public long getCacheAge() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(102, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCacheAge();
                    }
                    _reply.readException();
            ...
            public long getCurrentTimeMillis() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(103, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getCurrentTimeMillis();
                    }
                    _reply.readException();
                    long _result = _reply.readLong();
                    _reply.recycle();
            ...
            public boolean oppoExecuteIPtableCmd(String cmd, String dstPort) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(104, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().oppoExecuteIPtableCmd(cmd, dstPort);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public List<String> readArpFile() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(105, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().readArpFile();
                    }
                    _reply.readException();
                    List<String> _result = _reply.createStringArrayList();
                    _reply.recycle();
