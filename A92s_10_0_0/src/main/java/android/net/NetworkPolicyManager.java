...
public class NetworkPolicyManager {
    ...
    public void factoryReset(String subscriber) {
        try {
            ...
            OppoNetworkingControlManager oppoNetworkingControlManager = (OppoNetworkingControlManager) this.mContext.getSystemService("networking_control");
            if (oppoNetworkingControlManager != null) {
                oppoNetworkingControlManager.factoryReset();
            }
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
