...
public final class ResponderConfig implements Parcelable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.net.wifi.rtt.ResponderConfig.<init>(android.net.MacAddress, int, boolean, int, int, int, int, int):void
     arg types: [android.net.MacAddress, int, int, int, ?, int, int, int]
     candidates:
      android.net.wifi.rtt.ResponderConfig.<init>(android.net.wifi.aware.PeerHandle, int, boolean, int, int, int, int, int):void
      android.net.wifi.rtt.ResponderConfig.<init>(android.net.MacAddress, int, boolean, int, int, int, int, int):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.net.wifi.rtt.ResponderConfig.<init>(android.net.wifi.aware.PeerHandle, int, boolean, int, int, int, int, int):void
     arg types: [android.net.wifi.aware.PeerHandle, int, int, int, ?, int, int, int]
     candidates:
      android.net.wifi.rtt.ResponderConfig.<init>(android.net.MacAddress, int, boolean, int, int, int, int, int):void
      android.net.wifi.rtt.ResponderConfig.<init>(android.net.wifi.aware.PeerHandle, int, boolean, int, int, int, int, int):void */
