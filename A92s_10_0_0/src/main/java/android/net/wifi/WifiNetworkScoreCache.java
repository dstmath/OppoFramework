...
public class WifiNetworkScoreCache extends INetworkScoreCache.Stub {
    ...
    public final void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        writer.println(String.format("WifiNetworkScoreCache (%s/%d)", this.mContext.getPackageName(), Integer.valueOf(Process.myUid())));
    ...
    public static abstract class CacheListener {
        ...
        public void post(final List<ScoredNetwork> updatedNetworks) {
            this.mHandler.post(new Runnable() {
                /* class android.net.wifi.WifiNetworkScoreCache.CacheListener.AnonymousClass1 */
