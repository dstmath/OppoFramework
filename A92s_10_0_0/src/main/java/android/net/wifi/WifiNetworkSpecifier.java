...
public final class WifiNetworkSpecifier extends NetworkSpecifier implements Parcelable {
    ...
    public static final class Builder {
        ...
        private void validateSecurityParams() {
            int i = 0;
            int numSecurityTypes = 0 + (this.mIsEnhancedOpen ? 1 : 0) + (!TextUtils.isEmpty(this.mWpa2PskPassphrase)) + (!TextUtils.isEmpty(this.mWpa3SaePassphrase)) + (this.mWpa2EnterpriseConfig != null ? 1 : 0);
