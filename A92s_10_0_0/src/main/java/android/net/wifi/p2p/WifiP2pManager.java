...
public class WifiP2pManager {
    ...
    public static final int ADD_PERSISTENT_GROUP = 139366;
    public static final int ADD_PERSISTENT_GROUP_FAILED = 139367;
    public static final int ADD_PERSISTENT_GROUP_SUCCEEDED = 139368;
    ...
    public static final int RESPONSE_ADD_PERSISTENT_GROUP = 139369;
    ...
    public static final int SET_FREQ_BAND_TYPE = 139374;
    public static final int SET_FREQ_BAND_TYPE_FAILED = 139376;
    public static final int SET_FREQ_BAND_TYPE_SUCCESS = 139375;
    ...
    public static final int SET_P2P_CHANNEL_2G_ONLY = 1;
    public static final int SET_P2P_CHANNEL_5G_ONLY = 2;
    public static final int SET_P2P_CHANNEL_ALL = 3;
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    case AsyncChannel.CMD_CHANNEL_DISCONNECTED /*{ENCODED_INT: 69636}*/:
                        ...
                        return;
                    case WifiP2pManager.DISCOVER_PEERS_FAILED /*{ENCODED_INT: 139266}*/:
                    case WifiP2pManager.STOP_DISCOVERY_FAILED /*{ENCODED_INT: 139269}*/:
                    case WifiP2pManager.CONNECT_FAILED /*{ENCODED_INT: 139272}*/:
                    case WifiP2pManager.CANCEL_CONNECT_FAILED /*{ENCODED_INT: 139275}*/:
                    case WifiP2pManager.CREATE_GROUP_FAILED /*{ENCODED_INT: 139278}*/:
                    case WifiP2pManager.REMOVE_GROUP_FAILED /*{ENCODED_INT: 139281}*/:
                    case WifiP2pManager.ADD_LOCAL_SERVICE_FAILED /*{ENCODED_INT: 139293}*/:
                    case WifiP2pManager.REMOVE_LOCAL_SERVICE_FAILED /*{ENCODED_INT: 139296}*/:
                    case WifiP2pManager.CLEAR_LOCAL_SERVICES_FAILED /*{ENCODED_INT: 139299}*/:
                    case WifiP2pManager.ADD_SERVICE_REQUEST_FAILED /*{ENCODED_INT: 139302}*/:
                    case WifiP2pManager.REMOVE_SERVICE_REQUEST_FAILED /*{ENCODED_INT: 139305}*/:
                    case WifiP2pManager.CLEAR_SERVICE_REQUESTS_FAILED /*{ENCODED_INT: 139308}*/:
                    case WifiP2pManager.DISCOVER_SERVICES_FAILED /*{ENCODED_INT: 139311}*/:
                    case WifiP2pManager.SET_DEVICE_NAME_FAILED /*{ENCODED_INT: 139316}*/:
                    case WifiP2pManager.DELETE_PERSISTENT_GROUP_FAILED /*{ENCODED_INT: 139319}*/:
                    case WifiP2pManager.SET_WFD_INFO_FAILED /*{ENCODED_INT: 139324}*/:
                    case WifiP2pManager.START_WPS_FAILED /*{ENCODED_INT: 139327}*/:
                    case WifiP2pManager.START_LISTEN_FAILED /*{ENCODED_INT: 139330}*/:
                    case WifiP2pManager.STOP_LISTEN_FAILED /*{ENCODED_INT: 139333}*/:
                    case WifiP2pManager.SET_CHANNEL_FAILED /*{ENCODED_INT: 139336}*/:
                    case WifiP2pManager.REPORT_NFC_HANDOVER_FAILED /*{ENCODED_INT: 139345}*/:
                    case WifiP2pManager.FACTORY_RESET_FAILED /*{ENCODED_INT: 139347}*/:
                    case WifiP2pManager.SET_ONGOING_PEER_CONFIG_FAILED /*{ENCODED_INT: 139352}*/:
                    case WifiP2pManager.SET_FREQ_BAND_TYPE_FAILED /*{ENCODED_INT: 139376}*/:
                        if (listener != null) {
                            ((ActionListener) listener).onFailure(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.DISCOVER_PEERS_SUCCEEDED /*{ENCODED_INT: 139267}*/:
                    case WifiP2pManager.STOP_DISCOVERY_SUCCEEDED /*{ENCODED_INT: 139270}*/:
                    case WifiP2pManager.CONNECT_SUCCEEDED /*{ENCODED_INT: 139273}*/:
                    case WifiP2pManager.CANCEL_CONNECT_SUCCEEDED /*{ENCODED_INT: 139276}*/:
                    case WifiP2pManager.CREATE_GROUP_SUCCEEDED /*{ENCODED_INT: 139279}*/:
                    case WifiP2pManager.REMOVE_GROUP_SUCCEEDED /*{ENCODED_INT: 139282}*/:
                    case WifiP2pManager.ADD_LOCAL_SERVICE_SUCCEEDED /*{ENCODED_INT: 139294}*/:
                    case WifiP2pManager.REMOVE_LOCAL_SERVICE_SUCCEEDED /*{ENCODED_INT: 139297}*/:
                    case WifiP2pManager.CLEAR_LOCAL_SERVICES_SUCCEEDED /*{ENCODED_INT: 139300}*/:
                    case WifiP2pManager.ADD_SERVICE_REQUEST_SUCCEEDED /*{ENCODED_INT: 139303}*/:
                    case WifiP2pManager.REMOVE_SERVICE_REQUEST_SUCCEEDED /*{ENCODED_INT: 139306}*/:
                    case WifiP2pManager.CLEAR_SERVICE_REQUESTS_SUCCEEDED /*{ENCODED_INT: 139309}*/:
                    case WifiP2pManager.DISCOVER_SERVICES_SUCCEEDED /*{ENCODED_INT: 139312}*/:
                    case WifiP2pManager.SET_DEVICE_NAME_SUCCEEDED /*{ENCODED_INT: 139317}*/:
                    case WifiP2pManager.DELETE_PERSISTENT_GROUP_SUCCEEDED /*{ENCODED_INT: 139320}*/:
                    case WifiP2pManager.SET_WFD_INFO_SUCCEEDED /*{ENCODED_INT: 139325}*/:
                    case WifiP2pManager.START_WPS_SUCCEEDED /*{ENCODED_INT: 139328}*/:
                    case WifiP2pManager.START_LISTEN_SUCCEEDED /*{ENCODED_INT: 139331}*/:
                    case WifiP2pManager.STOP_LISTEN_SUCCEEDED /*{ENCODED_INT: 139334}*/:
                    case WifiP2pManager.SET_CHANNEL_SUCCEEDED /*{ENCODED_INT: 139337}*/:
                    case WifiP2pManager.REPORT_NFC_HANDOVER_SUCCEEDED /*{ENCODED_INT: 139344}*/:
                    case WifiP2pManager.FACTORY_RESET_SUCCEEDED /*{ENCODED_INT: 139348}*/:
                    case WifiP2pManager.SET_ONGOING_PEER_CONFIG_SUCCEEDED /*{ENCODED_INT: 139353}*/:
                    case WifiP2pManager.SET_FREQ_BAND_TYPE_SUCCESS /*{ENCODED_INT: 139375}*/:
                        if (listener != null) {
                            ((ActionListener) listener).onSuccess();
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_PEERS /*{ENCODED_INT: 139284}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_CONNECTION_INFO /*{ENCODED_INT: 139286}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_GROUP_INFO /*{ENCODED_INT: 139288}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_SERVICE /*{ENCODED_INT: 139314}*/:
                        Channel.this.handleServiceResponse((WifiP2pServiceResponse) message.obj);
                        return;
                    case WifiP2pManager.RESPONSE_PERSISTENT_GROUP_INFO /*{ENCODED_INT: 139322}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_GET_HANDOVER_MESSAGE /*{ENCODED_INT: 139341}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_ONGOING_PEER_CONFIG /*{ENCODED_INT: 139350}*/:
                        ...
                        return;
                    case WifiP2pManager.RESPONSE_P2P_STATE /*{ENCODED_INT: 139355}*/:
                        if (listener != null) {
                            ((P2pStateListener) listener).onP2pStateAvailable(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_DISCOVERY_STATE /*{ENCODED_INT: 139357}*/:
                        if (listener != null) {
                            ((DiscoveryStateListener) listener).onDiscoveryStateAvailable(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_NETWORK_INFO /*{ENCODED_INT: 139359}*/:
                        if (listener != null) {
                            ((NetworkInfoListener) listener).onNetworkInfoAvailable((NetworkInfo) message.obj);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_DEVICE_INFO /*{ENCODED_INT: 139362}*/:
                        if (listener != null) {
                            ((DeviceInfoListener) listener).onDeviceInfoAvailable((WifiP2pDevice) message.obj);
                            return;
                        }
                        return;
                    case WifiP2pManager.ADD_PERSISTENT_GROUP_FAILED /*{ENCODED_INT: 139367}*/:
                        if (listener != null) {
                            ((ActionListener) listener).onFailure(message.arg1);
                            return;
                        }
                        return;
                    case WifiP2pManager.RESPONSE_ADD_PERSISTENT_GROUP /*{ENCODED_INT: 139369}*/:
    ...
    public void discoverPeers(Channel c, int freq, ActionListener listener) {
        checkChannel(c);
        c.mAsyncChannel.sendMessage(DISCOVER_PEERS, freq, c.putListener(listener));
    }

    public void connect(Channel c, WifiP2pConfig config, int freq, ActionListener listener) {
        checkChannel(c);
        checkP2pConfig(config);
        c.mAsyncChannel.sendMessage(CONNECT, freq, c.putListener(listener), config);
    }
    ...
    public void setWifiP2pBandType(Channel c, int bandtype, ActionListener listener) {
        checkChannel(c);
        Bundle p2pbandtype = new Bundle();
        p2pbandtype.putInt("p2pbandtype", bandtype);
        c.mAsyncChannel.sendMessage(SET_FREQ_BAND_TYPE, 0, c.putListener(listener), p2pbandtype);
    }
}
