...
public class NetworkPolicy implements Parcelable, Comparable<NetworkPolicy> {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.net.NetworkPolicy.<init>(android.net.NetworkTemplate, int, java.lang.String, long, long, long, long, boolean, boolean):void
     arg types: [android.net.NetworkTemplate, int, java.lang.String, long, long, int, int, boolean, int]
     candidates:
      android.net.NetworkPolicy.<init>(android.net.NetworkTemplate, android.util.RecurrenceRule, long, long, long, long, long, boolean, boolean):void
      android.net.NetworkPolicy.<init>(android.net.NetworkTemplate, int, java.lang.String, long, long, long, long, boolean, boolean):void */
    @Deprecated
