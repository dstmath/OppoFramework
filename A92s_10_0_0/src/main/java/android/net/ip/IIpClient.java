...
public interface IIpClient extends IInterface {
    ...
    void onDADetectorResult(int i) throws RemoteException;

    void onGWDetectorResult(int i) throws RemoteException;
    ...
    void setNetworkValidState(int i) throws RemoteException;
    ...
    public static class Default implements IIpClient {
        ...
        @Override // android.net.ip.IIpClient
        public void setNetworkValidState(int netValid) throws RemoteException {
        }

        @Override // android.net.ip.IIpClient
        public void onDADetectorResult(int result) throws RemoteException {
        }

        @Override // android.net.ip.IIpClient
        public void onGWDetectorResult(int result) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IIpClient {
        ...
        static final int TRANSACTION_onDADetectorResult = 15;
        static final int TRANSACTION_onGWDetectorResult = 16;
        ...
        static final int TRANSACTION_setNetworkValidState = 14;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                        setNetworkValidState(data.readInt());
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        onDADetectorResult(data.readInt());
                        return true;
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                        onGWDetectorResult(data.readInt());
                        return true;
                    default:
        ...
        private static class Proxy implements IIpClient {
            ...
            public void setNetworkValidState(int netValid) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(netValid);
                    if (this.mRemote.transact(14, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        _data.recycle();
                    } else {
                        Stub.getDefaultImpl().setNetworkValidState(netValid);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onDADetectorResult(int result) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(15, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onDADetectorResult(result);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onGWDetectorResult(int result) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(16, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onGWDetectorResult(result);
                    }
                } finally {
                    _data.recycle();
                }
