...
public class IpServer extends StateMachine {
    ...
    private boolean configureIPv4(boolean enabled) {
        ...
        if (i == 1) {
            ...
            ipAsString = OppoIpServerHelper.getWifiSharingIfaceAddr();
            prefixLen = 24;
        }
        try {
    ...
    class BaseServingState extends State {
        ...
        public void enter() {
            ...
            try {
                ...
                SharedLog access$300 = IpServer.this.mLog;
                access$300.e("Error Tethering: " + e);
        ...
        public void exit() {
            try {
                ...
                SharedLog access$300 = IpServer.this.mLog;
                access$300.e("Failed to untether interface: " + e);
            }
                    ...
                    if (newUpstreamIfaceSet == null) {
                        ...
                        for (String ifname : added) {
                            try {
                                ...
                                SharedLog access$300 = IpServer.this.mLog;
                                access$300.e("Exception enabling NAT: " + e);
                                cleanupUpstream();
