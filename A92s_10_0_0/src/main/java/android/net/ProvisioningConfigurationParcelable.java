...
public class ProvisioningConfigurationParcelable implements Parcelable {
    ...
    public DhcpResultsParcelable dhcpResult;
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        if (this.dhcpResult != null) {
            _aidl_parcel.writeInt(1);
            this.dhcpResult.writeToParcel(_aidl_parcel, 0);
        } else {
            _aidl_parcel.writeInt(0);
        }
        _aidl_parcel.writeInt(this.startType);
        ...
        if (_aidl_parcelable_size >= 0) {
            try {
                ...
                if (_aidl_parcel.dataPosition() - _aidl_start_pos < _aidl_parcelable_size) {
                    ...
                    if (_aidl_parcel.readInt() != 0) {
                        this.dhcpResult = DhcpResultsParcelable.CREATOR.createFromParcel(_aidl_parcel);
                    } else {
                        this.dhcpResult = null;
                    }
                    if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
                        return;
                    }
                    this.startType = _aidl_parcel.readInt();
                    if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
                    } else {
                        _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
