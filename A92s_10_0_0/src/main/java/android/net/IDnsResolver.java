...
public interface IDnsResolver extends IInterface {
    ...
    void resolveFlushCacheForNet(int i) throws RemoteException;
    ...
    public static class Default implements IDnsResolver {
        ...
        @Override // android.net.IDnsResolver
        public void resolveFlushCacheForNet(int netId) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IDnsResolver {
        ...
        static final int TRANSACTION_resolveFlushCacheForNet = 10;
        static final int TRANSACTION_setLogSeverity = 11;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                        resolveFlushCacheForNet(data.readInt());
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IDnsResolver {
            ...
            public void resolveFlushCacheForNet(int netId) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().resolveFlushCacheForNet(netId);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
