...
public class SipAudioCall {
    ...
    /* access modifiers changed from: private */
    public boolean mHold = DONT_RELEASE_SOCKET;
    /* access modifiers changed from: private */
    public boolean mInCall = DONT_RELEASE_SOCKET;
    /* access modifiers changed from: private */
    public Listener mListener;
    private SipProfile mLocalProfile;
    private boolean mMuted = DONT_RELEASE_SOCKET;
    /* access modifiers changed from: private */
    public String mPeerSd;
    private long mSessionId = System.currentTimeMillis();
    /* access modifiers changed from: private */
    public SipSession mSipSession;
    /* access modifiers changed from: private */
    public SipSession mTransferringSession;
    ...
    private SipSession.Listener createListener() {
        return new SipSession.Listener() {
            ...
            public void onCallEstablished(SipSession session, String sessionDescription) {
                String unused = SipAudioCall.this.mPeerSd = sessionDescription;
                SipAudioCall sipAudioCall = SipAudioCall.this;
            ...
            public void onCallEnded(SipSession session) {
                ...
                if (session == SipAudioCall.this.mTransferringSession) {
                    SipSession unused = SipAudioCall.this.mTransferringSession = null;
            ...
            public void onCallChangeFailed(SipSession session, int errorCode, String message) {
                ...
                int unused = SipAudioCall.this.mErrorCode = errorCode;
                String unused2 = SipAudioCall.this.mErrorMessage = message;
                Listener listener = SipAudioCall.this.mListener;
                if (listener != null) {
                    try {
            ...
            public void onCallTransferring(SipSession newSession, String sessionDescription) {
                ...
                SipSession unused = SipAudioCall.this.mTransferringSession = newSession;
    ...
    public AudioGroup getAudioGroup() {
        synchronized (this) {
            ...
            AudioGroup group = this.mAudioStream == null ? null : this.mAudioStream.getGroup();
        }
    }
