...
public interface ISipSessionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISipSessionListener {
            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        onCalling(ISipSession.Stub.asInterface(data.readStrongBinder()));
                    ...
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                        onRingingBack(ISipSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 4:
                        data.enforceInterface(DESCRIPTOR);
                        onCallEstablished(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readString());
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                        onCallEnded(ISipSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                        onCallBusy(ISipSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                        onCallTransferring(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readString());
                        reply.writeNoException();
                        return true;
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
                        onError(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 9:
                        data.enforceInterface(DESCRIPTOR);
                        onCallChangeFailed(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 10:
                        data.enforceInterface(DESCRIPTOR);
                        onRegistering(ISipSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_onRegistrationDone /*{ENCODED_INT: 11}*/:
                        data.enforceInterface(DESCRIPTOR);
                        onRegistrationDone(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_onRegistrationFailed /*{ENCODED_INT: 12}*/:
                        data.enforceInterface(DESCRIPTOR);
                        onRegistrationFailed(ISipSession.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_onRegistrationTimeout /*{ENCODED_INT: 13}*/:
                        data.enforceInterface(DESCRIPTOR);
                        onRegistrationTimeout(ISipSession.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    default:
        ...
        private static class Proxy implements ISipSessionListener {
            ...
            public void onCalling(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCalling(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRinging(ISipSession session, SipProfile caller, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onRinging(session, caller, sessionDescription);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRingingBack(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onRingingBack(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onCallEstablished(ISipSession session, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCallEstablished(session, sessionDescription);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onCallEnded(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCallEnded(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onCallBusy(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCallBusy(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onCallTransferring(ISipSession newSession, String sessionDescription) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCallTransferring(newSession, sessionDescription);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onError(ISipSession session, int errorCode, String errorMessage) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onError(session, errorCode, errorMessage);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onCallChangeFailed(ISipSession session, int errorCode, String errorMessage) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCallChangeFailed(session, errorCode, errorMessage);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRegistering(ISipSession session) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onRegistering(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRegistrationDone(ISipSession session, int duration) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_onRegistrationDone, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().onRegistrationDone(session, duration);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRegistrationFailed(ISipSession session, int errorCode, String errorMessage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(errorCode);
                    _data.writeString(errorMessage);
                    if (this.mRemote.transact(Stub.TRANSACTION_onRegistrationFailed, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().onRegistrationFailed(session, errorCode, errorMessage);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onRegistrationTimeout(ISipSession session) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(session != null ? session.asBinder() : null);
                    if (this.mRemote.transact(Stub.TRANSACTION_onRegistrationTimeout, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().onRegistrationTimeout(session);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(ISipSessionListener impl) {
