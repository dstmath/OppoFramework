...
public final class SipSession {
    ...
    public static class State {
        ...
        public static String toString(int state) {
            switch (state) {
                ...
                case INCOMING_CALL_ANSWERING /*{ENCODED_INT: 4}*/:
                    return "INCOMING_CALL_ANSWERING";
                case OUTGOING_CALL /*{ENCODED_INT: 5}*/:
                    return "OUTGOING_CALL";
                case OUTGOING_CALL_RING_BACK /*{ENCODED_INT: 6}*/:
                    return "OUTGOING_CALL_RING_BACK";
                case OUTGOING_CALL_CANCELING /*{ENCODED_INT: 7}*/:
                    return "OUTGOING_CALL_CANCELING";
                case IN_CALL /*{ENCODED_INT: 8}*/:
                    return "IN_CALL";
                case PINGING /*{ENCODED_INT: 9}*/:
                    return "PINGING";
                default:
                    return "NOT_DEFINED";
            }
    ...
    public ISipSession getRealSession() {
        return this.mSession;
    }

    private ISipSessionListener createListener() {
        return new ISipSessionListener.Stub() {
            /* class android.net.sip.SipSession.AnonymousClass1 */
