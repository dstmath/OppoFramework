...
public interface INetworkMonitor extends IInterface {
    ...
    void notifyPrepareCaptiveResponse(int i) throws RemoteException;
    ...
    public static class Default implements INetworkMonitor {
        ...
        @Override // android.net.INetworkMonitor
        public void notifyPrepareCaptiveResponse(int returnCode) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements INetworkMonitor {
        ...
        static final int TRANSACTION_notifyPrepareCaptiveResponse = 12;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                        notifyPrepareCaptiveResponse(data.readInt());
                        return true;
                    default:
            ...
            public void notifyPrepareCaptiveResponse(int returnCode) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(12, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().notifyPrepareCaptiveResponse(returnCode);
                    }
                } finally {
                    _data.recycle();
                }
