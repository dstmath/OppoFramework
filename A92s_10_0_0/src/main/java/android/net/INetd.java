...
public interface INetd extends IInterface {
    ...
    public static final int NETWORK_TYPE_MOBILEDATA_MTK = 1;
    public static final int NETWORK_TYPE_MOBILEDATA_QCOM = 2;
    ...
    boolean addNetworkRestrictionRule(int i, String[] strArr) throws RemoteException;
    ...
    void destroySockets(int i, int i2) throws RemoteException;

    String execIptablesCmd(String str, String str2) throws RemoteException;
    ...
    void oppoExecuteIPtableCmd(String str, String str2) throws RemoteException;

    void oppoLimitSpeedDisable() throws RemoteException;

    void oppoLimitSpeedEnable() throws RemoteException;

    boolean oppoLimitSpeedIsEnable() throws RemoteException;

    void oppoLimitSpeedSetRule(int i, int i2) throws RemoteException;

    void oppoLimitSpeedSetWhiteList(int[] iArr) throws RemoteException;

    void oppoLimitSpeedetFrontUid(int i) throws RemoteException;

    void oppoSetUidRuleForNetworkType(int i, int i2, int i3) throws RemoteException;
    ...
    boolean removeNetworkRestrictionRule(int i, String[] strArr) throws RemoteException;

    void setIPv6AddrGenMode(String str, int i) throws RemoteException;

    void setIPv6DnsConfiguation(int i, boolean z, int i2, int i3) throws RemoteException;

    boolean setNetworkRestrictionMode(int i) throws RemoteException;

    boolean setOppoSlaDisable() throws RemoteException;

    boolean setOppoSlaEnable() throws RemoteException;

    void setOppoSlaIfaceDown(String str, String str2) throws RemoteException;

    void setOppoSlaIfaceUp(String str, String str2, String str3, String str4, String str5) throws RemoteException;
    ...
    public static class Default implements INetd {
        ...
        @Override // android.net.INetd
        public void setIPv6DnsConfiguation(int netId, boolean enableSimpleIpv6Query, int ipv6Retries, int ipv6Timeout) throws RemoteException {
        }

        @Override // android.net.INetd
        public boolean setOppoSlaEnable() throws RemoteException {
            return false;
        }

        @Override // android.net.INetd
        public boolean setOppoSlaDisable() throws RemoteException {
            return false;
        }

        @Override // android.net.INetd
        public void setOppoSlaIfaceUp(String netowrkType, String ifaceName, String ipAddr, String ipMask, String dns) throws RemoteException {
        }

        @Override // android.net.INetd
        public void setOppoSlaIfaceDown(String netowrkType, String ifaceName) throws RemoteException {
        }

        @Override // android.net.INetd
        public void destroySockets(int uid, int socketType) throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoLimitSpeedEnable() throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoLimitSpeedDisable() throws RemoteException {
        }

        @Override // android.net.INetd
        public boolean oppoLimitSpeedIsEnable() throws RemoteException {
            return false;
        }

        @Override // android.net.INetd
        public void oppoLimitSpeedSetRule(int uid, int limitspeed) throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoLimitSpeedSetWhiteList(int[] uids) throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoLimitSpeedetFrontUid(int uid) throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoSetUidRuleForNetworkType(int type, int uid, int rule) throws RemoteException {
        }

        @Override // android.net.INetd
        public void oppoExecuteIPtableCmd(String cmd, String dstPort) throws RemoteException {
        }

        @Override // android.net.INetd
        public String execIptablesCmd(String table, String cmd) throws RemoteException {
            return null;
        }

        @Override // android.net.INetd
        public boolean setNetworkRestrictionMode(int pattern) throws RemoteException {
            return false;
        }

        @Override // android.net.INetd
        public boolean addNetworkRestrictionRule(int pattern, String[] iplist) throws RemoteException {
            return false;
        }

        @Override // android.net.INetd
        public boolean removeNetworkRestrictionRule(int pattern, String[] iplist) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements INetd {
        ...
        static final int TRANSACTION_addNetworkRestrictionRule = 111;
        ...
        static final int TRANSACTION_destroySockets = 100;
        static final int TRANSACTION_execIptablesCmd = 109;
        ...
        static final int TRANSACTION_oppoExecuteIPtableCmd = 108;
        static final int TRANSACTION_oppoLimitSpeedDisable = 102;
        static final int TRANSACTION_oppoLimitSpeedEnable = 101;
        static final int TRANSACTION_oppoLimitSpeedIsEnable = 103;
        static final int TRANSACTION_oppoLimitSpeedSetRule = 104;
        static final int TRANSACTION_oppoLimitSpeedSetWhiteList = 105;
        static final int TRANSACTION_oppoLimitSpeedetFrontUid = 106;
        static final int TRANSACTION_oppoSetUidRuleForNetworkType = 107;
        static final int TRANSACTION_registerUnsolicitedEventListener = 90;
        static final int TRANSACTION_removeNetworkRestrictionAll = 113;
        static final int TRANSACTION_removeNetworkRestrictionRule = 112;
        static final int TRANSACTION_setIPv6AddrGenMode = 33;
        static final int TRANSACTION_setIPv6DnsConfiguation = 95;
        static final int TRANSACTION_setNetworkRestrictionMode = 110;
        static final int TRANSACTION_setOppoSlaDisable = 97;
        static final int TRANSACTION_setOppoSlaEnable = 96;
        static final int TRANSACTION_setOppoSlaIfaceDown = 99;
        static final int TRANSACTION_setOppoSlaIfaceUp = 98;
            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case 5:
                        ...
                        networkCreateVpn(_arg08, _arg16);
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 79:
                        ...
                        firewallEnableChildChain(_arg09, _arg15);
                        reply.writeNoException();
                        return true;
                    case 80:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 83:
                        ...
                        interfaceSetIPv6PrivacyExtensions(_arg010, _arg14);
                        reply.writeNoException();
                        return true;
                    case 84:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 85:
                        ...
                        interfaceSetEnableIPv6(_arg011, _arg13);
                        reply.writeNoException();
                        return true;
                    case 86:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getOemNetd /*{ENCODED_INT: 94}*/:
                        ...
                        return true;
                    case TRANSACTION_setIPv6DnsConfiguation /*{ENCODED_INT: 95}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _arg012 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg12 = true;
                        }
                        setIPv6DnsConfiguation(_arg012, _arg12, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 96:
                        data.enforceInterface(DESCRIPTOR);
                        boolean oppoSlaEnable = setOppoSlaEnable();
                        reply.writeNoException();
                        reply.writeInt(oppoSlaEnable ? 1 : 0);
                        return true;
                    case 97:
                        data.enforceInterface(DESCRIPTOR);
                        boolean oppoSlaDisable = setOppoSlaDisable();
                        reply.writeNoException();
                        reply.writeInt(oppoSlaDisable ? 1 : 0);
                        return true;
                    case 98:
                        data.enforceInterface(DESCRIPTOR);
                        setOppoSlaIfaceUp(data.readString(), data.readString(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 99:
                        data.enforceInterface(DESCRIPTOR);
                        setOppoSlaIfaceDown(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 100:
                        data.enforceInterface(DESCRIPTOR);
                        destroySockets(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 101:
                        data.enforceInterface(DESCRIPTOR);
                        oppoLimitSpeedEnable();
                        reply.writeNoException();
                        return true;
                    case 102:
                        data.enforceInterface(DESCRIPTOR);
                        oppoLimitSpeedDisable();
                        reply.writeNoException();
                        return true;
                    case 103:
                        data.enforceInterface(DESCRIPTOR);
                        boolean oppoLimitSpeedIsEnable = oppoLimitSpeedIsEnable();
                        reply.writeNoException();
                        reply.writeInt(oppoLimitSpeedIsEnable ? 1 : 0);
                        return true;
                    case 104:
                        data.enforceInterface(DESCRIPTOR);
                        oppoLimitSpeedSetRule(data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 105:
                        data.enforceInterface(DESCRIPTOR);
                        oppoLimitSpeedSetWhiteList(data.createIntArray());
                        reply.writeNoException();
                        return true;
                    case 106:
                        data.enforceInterface(DESCRIPTOR);
                        oppoLimitSpeedetFrontUid(data.readInt());
                        reply.writeNoException();
                        return true;
                    case 107:
                        data.enforceInterface(DESCRIPTOR);
                        oppoSetUidRuleForNetworkType(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 108:
                        data.enforceInterface(DESCRIPTOR);
                        oppoExecuteIPtableCmd(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case 109:
                        data.enforceInterface(DESCRIPTOR);
                        String _result12 = execIptablesCmd(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeString(_result12);
                        return true;
                    case TRANSACTION_setNetworkRestrictionMode /*{ENCODED_INT: 110}*/:
                        data.enforceInterface(DESCRIPTOR);
                        boolean networkRestrictionMode = setNetworkRestrictionMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(networkRestrictionMode ? 1 : 0);
                        return true;
                    case 111:
                        data.enforceInterface(DESCRIPTOR);
                        boolean addNetworkRestrictionRule = addNetworkRestrictionRule(data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        reply.writeInt(addNetworkRestrictionRule ? 1 : 0);
                        return true;
                    case 112:
                        data.enforceInterface(DESCRIPTOR);
                        boolean removeNetworkRestrictionRule = removeNetworkRestrictionRule(data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        reply.writeInt(removeNetworkRestrictionRule ? 1 : 0);
                        return true;
                    case 113:
                        data.enforceInterface(DESCRIPTOR);
                        boolean removeNetworkRestrictionAll = removeNetworkRestrictionAll(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(removeNetworkRestrictionAll ? 1 : 0);
                        return true;
                    default:
        ...
        private static class Proxy implements INetd {
            ...
            public void setIPv6DnsConfiguation(int netId, boolean enableSimpleIpv6Query, int ipv6Retries, int ipv6Timeout) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(netId);
                    _data.writeInt(enableSimpleIpv6Query ? 1 : 0);
                    _data.writeInt(ipv6Retries);
                    _data.writeInt(ipv6Timeout);
                    if (this.mRemote.transact(Stub.TRANSACTION_setIPv6DnsConfiguation, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
                    }
                    Stub.getDefaultImpl().setIPv6DnsConfiguation(netId, enableSimpleIpv6Query, ipv6Retries, ipv6Timeout);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean setOppoSlaEnable() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(96, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setOppoSlaEnable();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean setOppoSlaDisable() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(97, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setOppoSlaDisable();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void setOppoSlaIfaceUp(String netowrkType, String ifaceName, String ipAddr, String ipMask, String dns) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(netowrkType);
                    _data.writeString(ifaceName);
                    _data.writeString(ipAddr);
                    _data.writeString(ipMask);
                    ...
                    Stub.getDefaultImpl().setOppoSlaIfaceUp(netowrkType, ifaceName, ipAddr, ipMask, dns);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void setOppoSlaIfaceDown(String netowrkType, String ifaceName) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setOppoSlaIfaceDown(netowrkType, ifaceName);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void destroySockets(int uid, int socketType) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().destroySockets(uid, socketType);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoLimitSpeedEnable() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoLimitSpeedEnable();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoLimitSpeedDisable() throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoLimitSpeedDisable();
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public boolean oppoLimitSpeedIsEnable() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(103, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().oppoLimitSpeedIsEnable();
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public void oppoLimitSpeedSetRule(int uid, int limitspeed) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoLimitSpeedSetRule(uid, limitspeed);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoLimitSpeedSetWhiteList(int[] uids) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoLimitSpeedSetWhiteList(uids);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoLimitSpeedetFrontUid(int uid) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoLimitSpeedetFrontUid(uid);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoSetUidRuleForNetworkType(int type, int uid, int rule) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoSetUidRuleForNetworkType(type, uid, rule);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void oppoExecuteIPtableCmd(String cmd, String dstPort) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().oppoExecuteIPtableCmd(cmd, dstPort);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public String execIptablesCmd(String table, String cmd) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(109, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().execIptablesCmd(table, cmd);
                    }
                    _reply.readException();
                    String _result = _reply.readString();
                    _reply.recycle();
            ...
            public boolean setNetworkRestrictionMode(int pattern) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_setNetworkRestrictionMode, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setNetworkRestrictionMode(pattern);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean addNetworkRestrictionRule(int pattern, String[] iplist) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(pattern);
                    _data.writeStringArray(iplist);
                    boolean _result = false;
                    if (!this.mRemote.transact(111, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().addNetworkRestrictionRule(pattern, iplist);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean removeNetworkRestrictionRule(int pattern, String[] iplist) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(112, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().removeNetworkRestrictionRule(pattern, iplist);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
            ...
            public boolean removeNetworkRestrictionAll(int pattern) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(113, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().removeNetworkRestrictionAll(pattern);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
