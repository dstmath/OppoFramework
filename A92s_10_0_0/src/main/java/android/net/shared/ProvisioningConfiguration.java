...
public class ProvisioningConfiguration {
    ...
    public DhcpResults mDhcpResult;
    ...
    public static class Builder {
        ...
        public Builder withDhcpResult(DhcpResults dhcpResult) {
            this.mConfig.mDhcpResult = dhcpResult;
            return this;
        }

        public Builder withStartType(int startType) {
            this.mConfig.mStartType = startType;
            return this;
        }
    ...
    public ProvisioningConfiguration(ProvisioningConfiguration other) {
        ...
        this.mDhcpResult = other.mDhcpResult;
    ...
    public ProvisioningConfigurationParcelable toStableParcelable() {
        ...
        p.dhcpResult = IpConfigurationParcelableUtil.toStableParcelable(this.mDhcpResult);
        p.startType = this.mStartType;
        return p;
    }
    ...
    public static ProvisioningConfiguration fromStableParcelable(ProvisioningConfigurationParcelable p) {
        ...
        config.mDhcpResult = IpConfigurationParcelableUtil.fromStableParcelable(p.dhcpResult);
        config.mStartType = p.startType;
        return config;
    }
