    ...
    public class InternalCallback extends ILowpanInterfaceListener.Stub {
        ...
        public void onReceiveFromCommissioner(byte[] packet) {
            LowpanCommissioningSession.this.mHandler.post(new Runnable(packet) {
                /* class android.net.lowpan.$$Lambda$LowpanCommissioningSession$InternalCallback$TrrmDykqIWeXNdgrXO7t2rqCTo */
                ...
                public final void run() {
                    LowpanCommissioningSession.InternalCallback.this.lambda$onReceiveFromCommissioner$0$LowpanCommissioningSession$InternalCallback(this.f$1);
                }
            });
        }
        ...
        if (!this.mIsClosed) {
            ...
            if (this.mCallback != null) {
                this.mHandler.post(new Runnable() {
                    /* class android.net.lowpan.$$Lambda$LowpanCommissioningSession$jqpliUqe7YuWqkG33P8PNe7Ag */
