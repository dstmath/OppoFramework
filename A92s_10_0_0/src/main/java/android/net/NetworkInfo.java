...
public class NetworkInfo implements Parcelable {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: MutableMD:(android.net.NetworkInfo$DetailedState, android.net.NetworkInfo$State):V
     ...
     candidates:
      ...
      MutableMD:(android.net.NetworkInfo$DetailedState, android.net.NetworkInfo$State):V
      MutableMD:(android.net.NetworkInfo$DetailedState, android.net.NetworkInfo$State):V
      MutableMD:(android.net.NetworkInfo$DetailedState, android.net.NetworkInfo$State):V */
    static {
