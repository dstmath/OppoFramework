...
public final class BluetoothDevice implements Parcelable {
    ...
    public int getBatteryLevel() {
        ...
        try {
            ...
            Log.e(TAG, "NullPointerException for getBatteryLevel() of device (" + getAddress() + ")", npe);
            return -1;
        }
    }
    ...
    public boolean createBond() {
        ...
        try {
            ...
            sb.append("createBond(): called by: ");
    ...
    public boolean fetchUuidsWithSdp() {
        ...
        try {
            ...
            Log.e(TAG, "NullPointerException for fetchUuidsWithSdp()", npe);
            return false;
        }
    }
