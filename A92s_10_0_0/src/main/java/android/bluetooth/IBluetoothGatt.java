        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                        IScannerCallback _arg07 = IScannerCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg1 = WorkSource.CREATOR.createFromParcel(data);
                        } else {
                            _arg1 = null;
                        }
                        registerScanner(_arg07, _arg1);
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 4:
                        ...
                        startScan(_arg08, _arg12, data.createTypedArrayList(ScanFilter.CREATOR), data.readArrayList(getClass().getClassLoader()), data.readString());
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 12:
                        ...
                        enableAdvertisingSet(_arg09, _arg24, data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 13:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setAdvertisingData(_arg010, _arg15);
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setScanResponseData(_arg011, _arg16);
                        reply.writeNoException();
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setAdvertisingParameters(_arg012, _arg17);
                        reply.writeNoException();
                        return true;
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setPeriodicAdvertisingParameters(_arg013, _arg18);
                        reply.writeNoException();
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setPeriodicAdvertisingData(_arg014, _arg19);
                        reply.writeNoException();
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        setPeriodicAdvertisingEnable(_arg015, _arg24);
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 29:
                        ...
                        discoverServiceByUuid(_arg016, _arg111, _arg22);
                        reply.writeNoException();
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 31:
                        ...
                        readUsingCharacteristicUuid(_arg017, _arg112, _arg23, data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 35:
                        ...
                        registerForNotification(_arg018, _arg113, _arg25, _arg24);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 37:
                        ...
                        endReliableWrite(_arg019, _arg114, _arg24);
                        reply.writeNoException();
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 44:
                        ...
                        serverConnect(_arg020, _arg115, _arg24, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
