...
public final class BluetoothAdapter {
    ...
    /* access modifiers changed from: private */
    public static final IBluetoothMetadataListener sBluetoothMetadataListener = new IBluetoothMetadataListener.Stub() {
    ...
    /* access modifiers changed from: private */
    public static final Map<BluetoothDevice, List<Pair<OnMetadataChangedListener, Executor>>> sMetadataListeners = new HashMap();
    ...
    public int getState() {
        ...
        try {
            ...
            Log.e(TAG, "getState occurs RemoteException");
        } catch (Throwable th) {
            this.mServiceLock.readLock().unlock();
            throw th;
        }
    ...
    public boolean startDiscovery() {
        ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(117, Binder.getCallingUid());
    ...
    public boolean cancelDiscovery() {
        ((IColorAntiVirusBehaviorManager) OppoFeatureCache.getOrCreate(IColorAntiVirusBehaviorManager.DEFAULT, new Object[0])).setAction(118, Binder.getCallingUid());
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.bluetooth.BluetoothServerSocket.<init>(int, boolean, boolean, int):void
     arg types: [int, int, int, int]
     candidates:
      android.bluetooth.BluetoothServerSocket.<init>(int, boolean, boolean, android.os.ParcelUuid):void
      android.bluetooth.BluetoothServerSocket.<init>(int, boolean, boolean, int):void */
            ...
            synchronized (sMetadataListeners) {
                ...
                if (listenerList == null) {
                    ...
                    public final boolean test(Object obj) {
                        return ((Pair) obj).first.equals(BluetoothAdapter.OnMetadataChangedListener.this);
                    }
                })) {
