...
public final class NotificationChannel extends OppoBaseNotificationChannel implements Parcelable {
    ...
    public static final int[] LOCKABLE_FIELDS = {1, 2, 4, 8, 16, 32, 128, 256, 65537, 65538, OppoBaseNotificationChannel.USER_LOCKED_OPUSH, 65540, OppoBaseNotificationChannel.USER_LOCKED_MAX_MESSAGES, OppoBaseNotificationChannel.USER_SUPPORT_NUM_BADGE, OppoBaseNotificationChannel.USER_BADGE_OPTION, OppoBaseNotificationChannel.USER_LOCKED_CHANGEABLE_FOLD, OppoBaseNotificationChannel.USER_LOCKED_CHANGEABLE_SHOW_ICON};
    ...
    @Override // android.os.Parcelable, android.app.OppoBaseNotificationChannel
    ...
    @Override // android.app.OppoBaseNotificationChannel
    @SystemApi
    ...
    private void writeXml(XmlSerializer out, boolean forBackup, Context context) throws IOException {
        ...
        if (getAudioAttributes() != null) {
            out.attribute(null, "usage", Integer.toString(getAudioAttributes().getUsage()));
    ...
    public JSONObject toJson() throws JSONException {
        ...
        if (getAudioAttributes() != null) {
            record.put("usage", Integer.toString(getAudioAttributes().getUsage()));
    ...
    private static AudioAttributes safeAudioAttributes(XmlPullParser parser) {
        int usage = safeInt(parser, "usage", 5);
