...
public class DownloadManager {
    ...
    public static class Request {
        ...
        /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
         method: android.content.ContentValues.put(java.lang.String, java.lang.Boolean):void
    ...
    public Uri getUriForDownloadedFile(long id) {
        ...
        try {
            ...
            if (!cursor.moveToFirst() || 8 != cursor.getInt(cursor.getColumnIndexOrThrow("status"))) {
                ...
                Uri fixUriWhenGetUriForDownloadedFile = OppoDownloadManagerHelper.fixUriWhenGetUriForDownloadedFile(cursor, id);
                cursor.close();
                return fixUriWhenGetUriForDownloadedFile;
            } else {
