...
public interface IAlarmManager extends IInterface {
    ...
    void setHighTemp(boolean z) throws RemoteException;
    ...
    public static class Default implements IAlarmManager {
        ...
        @Override // android.app.IAlarmManager
        public void setHighTemp(boolean highTemp) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IAlarmManager {
        ...
        static final int TRANSACTION_setHighTemp = 9;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        set(_arg03, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10);
                    ...
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                        cancelPoweroffAlarm(data.readString());
                        reply.writeNoException();
                        return true;
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IAlarmManager {
            ...
            public void setHighTemp(boolean highTemp) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setHighTemp(highTemp);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
