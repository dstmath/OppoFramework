            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        ParcelFileDescriptor _result = setWallpaper(_arg05, _arg1, _arg2, _arg3, _arg4, data.readInt(), IWallpaperManagerCallback.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    ...
                    case 4:
                        ...
                        ParcelFileDescriptor _result2 = getWallpaper(_arg06, _arg12, _arg22, _arg32, data.readInt());
                        reply.writeNoException();
                        if (_result2 != null) {
                            reply.writeInt(1);
                    ...
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                        WallpaperColors _result8 = getWallpaperColors(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        if (_result8 != null) {
                            reply.writeInt(1);
                    ...
                    case 22:
                        ...
                        setInAmbientMode(_arg04, data.readLong());
                        return true;
                    default:
