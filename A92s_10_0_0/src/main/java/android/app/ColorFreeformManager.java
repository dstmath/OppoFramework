        ...
        synchronized (this.mConfigListeners) {
            ...
            try {
                if (this.mOAms != null) {
                    ...
                    boolean addFreeformConfigChangedListener = this.mOAms.addFreeformConfigChangedListener(delegate);
            ...
            if (delegate != null) {
                try {
                    if (this.mOAms != null) {
                        ...
                        boolean removeFreeformConfigChangedListener = this.mOAms.removeFreeformConfigChangedListener(delegate);
