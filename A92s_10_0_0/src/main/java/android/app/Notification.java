...
import android.app.ColorBaseNotification;
...
public class Notification implements Parcelable {
    ...
    public void setAllPendingIntents(ArraySet<PendingIntent> allPendingIntents2) {
        synchronized (this.mAllPendingIntentsLock) {
            this.allPendingIntents = allPendingIntents2;
        }
    }
    ...
    public static class Builder extends ColorBaseNotification.Builder {
        ...
        private boolean bindLargeIcon(RemoteViews contentView, StandardTemplateParams p) {
            if (this.mN.mLargeIcon == null && this.mN.largeIcon != null) {
                Notification notification = this.mN;
                Icon unused = notification.mLargeIcon = Icon.createWithBitmap(notification.largeIcon);
            }
        ...
        public String loadHeaderAppName() {
            String oppoAppName = oppoLoadMultiHeaderAppName();
            if (!TextUtils.isEmpty(oppoAppName)) {
                return oppoAppName;
            }
        ...
        private void bindSmallIcon(RemoteViews contentView, StandardTemplateParams p) {
            if (this.mN.mSmallIcon == null && this.mN.icon != 0) {
                Notification notification = this.mN;
                Icon unused = notification.mSmallIcon = Icon.createWithResource(this.mContext, notification.icon);
            }
        ...
        private RemoteViews makePublicView(boolean ambient) {
            ...
            RemoteViews view = applyStandardTemplate(getBaseLayoutResource(), null);
            view.setBoolean(R.id.notification_header, "setExpandOnlyOnButton", true);
            Notification notification = this.mN;
            notification.extras = savedBundle;
            Icon unused2 = notification.mLargeIcon = largeIcon;
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView, StandardTemplateParams p) {
            ...
            contentView.setInt(R.id.notification_header, "setOriginalIconColor", colorable ? color : 1);
        }
