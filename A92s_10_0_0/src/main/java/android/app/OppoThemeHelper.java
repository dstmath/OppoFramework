                        ...
                        if (!sPreLoading || needUpdateTheme(exConfig)) {
                                ...
                                if (!isThirdPart) {
                                    ...
                                    if (index >= 0) {
                                        try {
                                            ...
                                            e = e4;
                                            drawable2 = drawable2;
                                            Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e);
                                            if (drawable2 != null) {
                                            }
                                            return drawable2;
                                        }
                            ...
                            if (drawable2 != null) {
                                try {
                                    ...
                                    Log.w(TAG, "getDrawable. Failure retrieving resources for " + applicationinfo2.packageName + ": " + e5.getMessage());
                                } catch (RuntimeException e6) {
                                    Log.w(TAG, "getDrawable. Failure retrieving icon 0x" + Integer.toHexString(id) + " in package " + packageName, e6);
                                }
                            }
                        }
