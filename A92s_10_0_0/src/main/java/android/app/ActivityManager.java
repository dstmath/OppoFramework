...
public class ActivityManager {
    ...
    public static class TaskSnapshot extends ColorBaseTaskSnapshot implements Parcelable {
    ...
    public static int checkComponentPermission(String permission, int uid, int owningUid, boolean exported) {
        ...
        if (permission.equals(Manifest.permission.GRANT_RUNTIME_PERMISSIONS)) {
    ...
    public List<ApplicationInfo> getAllTopAppInfo() {
        try {
            return ActivityManagerNative.getDefault().getAllTopAppInfo();
        } catch (RemoteException e) {
            Log.w(TAG, "getAllTopAppInfo failed.");
            return null;
        }
    }
    ...
    public void detectExceptionsForOIDT(int type, String pkgName, String pkgVersion, String reason) {
        try {
            ActivityManagerNative.getDefault().detectExceptionsForOIDT(type, pkgName, pkgVersion, reason);
        } catch (RemoteException e) {
            Log.w(TAG, "getAllTopAppInfo failed.");
        }
    }
