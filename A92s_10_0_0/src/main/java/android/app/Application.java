...
public class Application extends ContextWrapper implements ComponentCallbacks2 {
    ...
    public void onCreate() {
        ((IColorCommonInjector) OppoFeatureCache.getOrCreate(IColorCommonInjector.DEFAULT, new Object[0])).onCreateForApplication(this);
    }
    ...
    public final void attach(Context context) {
        ...
        ((IColorDarkModeManager) OppoFeatureCache.getOrCreate(IColorDarkModeManager.DEFAULT, new Object[0])).initDarkModeStatus(this);
    }
