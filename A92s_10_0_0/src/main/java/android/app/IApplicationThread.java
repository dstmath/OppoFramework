...
public interface IApplicationThread extends IInterface {
    ...
    void openActivityLog(boolean z) throws RemoteException;

    void oppoScheduleReceiver(Intent intent, ActivityInfo activityInfo, CompatibilityInfo compatibilityInfo, int i, String str, Bundle bundle, boolean z, int i2, int i3, int i4) throws RemoteException;
    ...
    public static class Default implements IApplicationThread {
        ...
        @Override // android.app.IApplicationThread
        public void oppoScheduleReceiver(Intent intent, ActivityInfo info, CompatibilityInfo compatInfo, int resultCode, String data, Bundle extras, boolean sync, int sendingUser, int processState, int hasCode) throws RemoteException {
        }
        ...
        @Override // android.app.IApplicationThread
        public void openActivityLog(boolean on) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IApplicationThread {
        ...
        static final int TRANSACTION_dumpMessage = 53;
        static final int TRANSACTION_dumpProvider = 35;
        static final int TRANSACTION_dumpService = 13;
        static final int TRANSACTION_enableActivityThreadLog = 54;
        ...
        static final int TRANSACTION_openActivityLog = 59;
        ...
        static final int TRANSACTION_scheduleOnNewActivityOptions = 21;
        ...
        static final int TRANSACTION_scheduleSleeping = 16;
        ...
        static final int TRANSACTION_setDynamicalLogEnable = 58;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        oppoScheduleReceiver(_arg02, _arg12, _arg22, _arg35, _arg46, _arg52, data.readInt() != 0, data.readInt(), data.readInt(), data.readInt());
                        return true;
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        scheduleCreateService(_arg018, _arg13, _arg23, data.readInt());
                        return true;
                    case 4:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 5:
                        ...
                        List<ProviderInfo> _arg26 = data.createTypedArrayList(ProviderInfo.CREATOR);
                        if (data.readInt() != 0) {
                        ...
                        bindApplication(_arg019, _arg14, _arg26, _arg3, _arg4, _arg53, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg017, _arg132, _arg142, _arg152, _arg16, _arg172, _arg18, _arg19);
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 11:
                        ...
                        scheduleBindService(_arg021, _arg17, _arg017, data.readInt());
                        return true;
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 14:
                        ...
                        scheduleRegisteredReceiver(_arg023, _arg111, _arg27, _arg36, _arg42, data.readInt() != 0, data.readInt() != 0, data.readInt(), data.readInt());
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        scheduleLowMemory();
                    ...
                    case 16:
                        ...
                        scheduleSleeping(_arg024, _arg017);
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        profilerControl(_arg017, _arg112, data.readInt());
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 19:
                        ...
                        scheduleCreateBackupAgent(_arg04, _arg113, data.readInt(), data.readInt());
                        return true;
                    case 20:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        scheduleDestroyBackupAgent(_arg05, _arg114, data.readInt());
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 25:
                        ...
                        dumpHeap(_arg026, _arg119, _arg28, _arg37, _arg43, _arg54);
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        dumpActivity(_arg06, data.readStrongBinder(), data.readString(), data.createStringArray());
                        return true;
                    case 27:
                        data.enforceInterface(DESCRIPTOR);
                        clearDnsCache();
                    ...
                    case 32:
                        ...
                        dumpMemInfo(_arg08, _arg117, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.createStringArray());
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        dumpMemInfoProto(_arg09, _arg118, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.createStringArray());
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        dumpGfxInfo(_arg010, data.createStringArray());
                        return true;
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        dumpProvider(_arg011, data.readStrongBinder(), data.createStringArray());
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        dumpDbInfo(_arg012, data.createStringArray());
                        return true;
                    case 37:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 39:
                        ...
                        scheduleTranslucentConversionComplete(_arg028, _arg017);
                        return true;
                    case 40:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 41:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg013 = ProviderInfo.CREATOR.createFromParcel(data);
                        } else {
                            _arg013 = null;
                        }
                    ...
                    case 54:
                        ...
                        enableActivityThreadLog(_arg017);
                        return true;
                    case 55:
                        data.enforceInterface(DESCRIPTOR);
                        IBinder _arg029 = data.readStrongBinder();
                        IVoiceInteractor _arg120 = IVoiceInteractor.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg24 = RemoteCallback.CREATOR.createFromParcel(data);
                        } else {
                            _arg24 = null;
                        }
                        if (data.readInt() != 0) {
                        ...
                        requestDirectActions(_arg029, _arg120, _arg24, _arg32);
                        return true;
                    case 56:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        performDirectAction(_arg030, _arg121, _arg25, _arg33, _arg44);
                        return true;
                    case 57:
                        data.enforceInterface(DESCRIPTOR);
                        getBroadcastState(data.readInt());
                        return true;
                    case 58:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
        ...
        private static class Proxy implements IApplicationThread {
            ...
            public void oppoScheduleReceiver(Intent intent, ActivityInfo info, CompatibilityInfo compatInfo, int resultCode, String data, Bundle extras, boolean sync, int sendingUser, int processState, int hasCode) throws RemoteException {
                ...
                try {
                    ...
                    _data2.writeString(data);
                    if (extras != null) {
                        _data2.writeInt(1);
                        extras.writeToParcel(_data2, 0);
                    } else {
                        _data2.writeInt(0);
                    }
                    if (sync) {
                    ...
                    _data2.writeInt(i);
                    _data2.writeInt(sendingUser);
                    _data2.writeInt(processState);
                    _data2.writeInt(hasCode);
                    ...
                    _data = _data2;
                    try {
                        Stub.getDefaultImpl().oppoScheduleReceiver(intent, info, compatInfo, resultCode, data, extras, sync, sendingUser, processState, hasCode);
                        _data.recycle();
                    } catch (Throwable th2) {
                        th = th2;
                        _data.recycle();
            ...
            public void bindApplication(String packageName, ApplicationInfo info, List<ProviderInfo> providers, ComponentName testName, ProfilerInfo profilerInfo, Bundle testArguments, IInstrumentationWatcher testWatcher, IUiAutomationConnection uiAutomationConnection, int debugMode, boolean enableBinderTracking, boolean trackAllocation, boolean restrictedBackupMode, boolean persistent, Configuration config, CompatibilityInfo compatInfo, Map services, Bundle coreSettings, String buildSerial, AutofillOptions autofillOptions, ContentCaptureOptions contentCaptureOptions) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(5, _data2, null, 1) || Stub.getDefaultImpl() == null) {
                        _data2.recycle();
                        return;
                    }
                    _data = _data2;
            ...
            public void openActivityLog(boolean on) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(59, _data, null, 1) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().openActivityLog(on);
                    }
                } finally {
                    _data.recycle();
                }
