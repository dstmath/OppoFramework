...
public abstract class OppoBaseApplicationPackageManager extends PackageManager {
    ...
    public static HashMap<String, Bitmap> mActivityIconsCache = new HashMap<>();
    /* access modifiers changed from: private */
    public static HashMap<String, Bitmap> mAppIconsCache = new HashMap<>();
    /* access modifiers changed from: private */
    public static boolean mIconCacheDirty = false;
