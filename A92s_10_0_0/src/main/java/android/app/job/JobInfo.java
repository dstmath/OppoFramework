...
public class JobInfo extends OppoBaseJobInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel out, int flags2) {
        ...
        writeToParcelJobInfo(out, flags2);
    }
    ...
    public static final class Builder extends OppoBaseJobInfo.BaseBuilder {
        /* access modifiers changed from: private */
