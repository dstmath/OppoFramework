...
abstract class ActivityTransitionCoordinator extends ResultReceiver {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.transition.TransitionSet.excludeTarget(android.view.View, boolean):android.transition.Transition
     arg types: [android.view.View, int]
     candidates:
      android.transition.TransitionSet.excludeTarget(int, boolean):android.transition.Transition
      android.transition.TransitionSet.excludeTarget(java.lang.Class, boolean):android.transition.Transition
      android.transition.TransitionSet.excludeTarget(java.lang.String, boolean):android.transition.Transition
      android.transition.Transition.excludeTarget(int, boolean):android.transition.Transition
      android.transition.Transition.excludeTarget(java.lang.Class, boolean):android.transition.Transition
      android.transition.Transition.excludeTarget(java.lang.String, boolean):android.transition.Transition
