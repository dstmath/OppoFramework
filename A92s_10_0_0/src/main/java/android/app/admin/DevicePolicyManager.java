...
public class DevicePolicyManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.app.admin.DevicePolicyManager.installKeyPair(android.content.ComponentName, java.security.PrivateKey, java.security.cert.Certificate[], java.lang.String, boolean):boolean
     arg types: [android.content.ComponentName, java.security.PrivateKey, java.security.cert.Certificate[], java.lang.String, int]
     candidates:
      android.app.admin.DevicePolicyManager.installKeyPair(android.content.ComponentName, java.security.PrivateKey, java.security.cert.Certificate[], java.lang.String, int):boolean
      android.app.admin.DevicePolicyManager.installKeyPair(android.content.ComponentName, java.security.PrivateKey, java.security.cert.Certificate[], java.lang.String, boolean):boolean */
    ...
    public void executeCallback(int errorCode, String errorMessage, Executor executor, InstallSystemUpdateCallback callback) {
