...
public class PasswordMetrics implements Parcelable {
    ...
    public static PasswordMetrics getTargetQualityMetrics(int complexityLevel, int targetQuality) {
        ...
        PasswordMetrics[] access$100 = targetBucket.mMetrics;
        for (PasswordMetrics metrics : access$100) {
    ...
    public int determineComplexity() {
        PasswordComplexityBucket[] access$400 = PasswordComplexityBucket.BUCKETS;
        for (PasswordComplexityBucket bucket : access$400) {
