...
public class ColorExSystemServiceHelper {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: android.app.ColorExSystemServiceHelper.checkColorExSystemService(boolean, java.lang.String):boolean
     arg types: [int, java.lang.String]
     candidates:
      android.app.ColorExSystemServiceHelper.checkColorExSystemService(android.os.Handler, java.lang.String):boolean
      android.app.ColorExSystemServiceHelper.checkColorExSystemService(boolean, android.content.Intent):boolean
      android.app.ColorExSystemServiceHelper.checkColorExSystemService(boolean, java.lang.String):boolean */
