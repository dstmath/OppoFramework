...
public class AttributeView extends ScrollView {
    ...
    public static final String TAG = AttributeView.class.getSimpleName();
    /* access modifiers changed from: private */
    public Object mAttribute = null;
    /* access modifiers changed from: private */
        ...
        if (this.mClass.getSuperclass() != null) {
            ...
            textView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    String access$100 = AttributeView.TAG;
                    Logger.i(access$100, "Attribute = \n" + info);
                    return true;
                }
            });
    ...
    private void addArrayTextView() {
        ...
        if (this.mClass.isArray()) {
            for (final int i = 0; i < Array.getLength(this.mAttribute); i++) {
                ...
                sb.append(arrayItem);
                if (arrayItem != null) {
                    str = WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + arrayItem.getClass().getSimpleName();
                } else {
                    str = "";
                }
                sb.append(str);
        ...
        if (!this.mClass.isArray()) {
            ...
            for (final int i = 0; i < fields.length; i++) {
                ...
                try {
                    ...
                    sb.append(value);
                    if (value != null) {
                        str = WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + value.getClass().getSimpleName();
                    } else {
                        str = "";
                    }
                    sb.append(str);
