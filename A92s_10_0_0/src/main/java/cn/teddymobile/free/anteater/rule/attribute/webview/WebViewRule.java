                ...
                public void run() {
                    try {
                        ...
                        if (result instanceof String) {
                            String unused = WebViewHandler.this.mTitle = (String) result;
                            latch.countDown();
                            return;
                        }
                    } catch (Exception e) {
                    }
                    String unused2 = WebViewHandler.this.mTitle = null;
                    latch.countDown();
                }
            });
            try {
            ...
            post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Object result = method.invoke(webView, new Object[0]);
                        if (result instanceof String) {
                            String unused = WebViewHandler.this.mUrl = (String) result;
                            latch.countDown();
                            return;
                        }
                    } catch (Exception e) {
                    }
                    String unused2 = WebViewHandler.this.mUrl = null;
                    latch.countDown();
                }
            });
            try {
