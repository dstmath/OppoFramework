...
public final class SEService {
    ...
    /* access modifiers changed from: private */
    public volatile ISmartcardService mSecureElementService;
        ...
        if (context != null) {
            ...
            this.mConnection = new ServiceConnection() {
                ...
                public synchronized void onServiceConnected(ComponentName className, IBinder service) {
                    ISmartcardService unused = SEService.this.mSecureElementService = ISmartcardService.Stub.asInterface(service);
                ...
                public void onServiceDisconnected(ComponentName className) {
                    ISmartcardService unused = SEService.this.mSecureElementService = null;
