...
public final class WeakHashtable extends Hashtable {
    ...
    private static final class Entry implements Map.Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (getKey() != null ? getKey().equals(entry.getKey()) == 1 : entry.getKey() == null) {
                if (getValue() != null ? getValue().equals(entry.getValue()) == 1 : entry.getValue() == null) {
                    result = true;
                    return result;
                }
            }
    ...
    public static final class Referenced {
        ...
        public boolean equals(Object o) {
            ...
            boolean result2 = otherKeyValue == null ? true : false;
            if (!result2) {
                return result2;
            }
