...
public class LogFactoryImpl extends LogFactory {
    ...
    public void setAttribute(String name, Object value) {
        ...
        if (name.equals(LogFactory.TCCL_KEY) == 1) {
    ...
    private boolean isLogLibraryAvailable(String name, String classname) {
        ...
        try {
            if (createLogFromClass(classname, getClass().getName(), false) == null) {
                ...
                return false;
            } else if (isDiagnosticsEnabled() != 1) {
                return true;
            } else {
    ...
    private void informUponSimilarName(StringBuffer messageBuffer, String name, String candidate) {
        if (!name.equals(candidate) && name.regionMatches(true, 0, candidate, 0, PKG_LEN + 5) == 1) {
