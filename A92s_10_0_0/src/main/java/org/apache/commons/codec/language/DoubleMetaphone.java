...
public class DoubleMetaphone implements StringEncoder {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:69:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:95:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:94:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:93:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:91:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:90:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:88:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:87:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:86:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:84:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:81:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:79:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:78:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:77:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:75:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:74:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:73:0x0019 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:72:0x0019 */
    ...
    public String doubleMetaphone(String value, boolean alternate) {
        ...
        boolean isSilentStart = isSilentStart(value2);
        DoubleMetaphoneResult result = new DoubleMetaphoneResult(getMaxCodeLen());
        int index = isSilentStart;
        while (!result.isComplete() && index <= value2.length() - 1) {
            int index2 = index == true ? 1 : 0;
            int index3 = index == true ? 1 : 0;
            int index4 = index == true ? 1 : 0;
            int index5 = index == true ? 1 : 0;
            int index6 = index == true ? 1 : 0;
            int index7 = index == true ? 1 : 0;
            int index8 = index == true ? 1 : 0;
            int index9 = index == true ? 1 : 0;
            int index10 = index == true ? 1 : 0;
            int index11 = index == true ? 1 : 0;
            int index12 = index == true ? 1 : 0;
            int index13 = index == true ? 1 : 0;
            int index14 = index == true ? 1 : 0;
            int index15 = index == true ? 1 : 0;
            int index16 = index == true ? 1 : 0;
            int index17 = index == true ? 1 : 0;
            int index18 = index == true ? 1 : 0;
            int index19 = index == true ? 1 : 0;
            int index20 = index == true ? 1 : 0;
            int index21 = index == true ? 1 : 0;
            int index22 = index == true ? 1 : 0;
            int index23 = index == true ? 1 : 0;
            int index24 = index == true ? 1 : 0;
            int index25 = index == true ? 1 : 0;
            int index26 = index == true ? 1 : 0;
            int index27 = index == true ? 1 : 0;
            char charAt = value2.charAt(index2);
            if (charAt == 199) {
                result.append('S');
                index++;
            } else if (charAt != 209) {
