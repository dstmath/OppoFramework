...
public final class CharArrayBuffer {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:27:0x002c */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:26:0x002c */
