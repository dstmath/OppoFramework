...
public class Parser extends DefaultHandler implements ScanHandler, XMLReader, LexicalHandler {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: org.ccil.cowan.tagsoup.Parser} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: org.ccil.cowan.tagsoup.Parser} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: org.ccil.cowan.tagsoup.Parser} */
    /* JADX WARN: Multi-variable type inference failed */
    public void setEntityResolver(EntityResolver resolver) {
        this.theEntityResolver = resolver == 0 ? this : resolver;
    }
    ...
    public void setDTDHandler(DTDHandler handler) {
        this.theDTDHandler = handler == 0 ? this : handler;
    }
    ...
    public void setContentHandler(ContentHandler handler) {
        this.theContentHandler = handler == 0 ? this : handler;
    }
    ...
    public void setErrorHandler(ErrorHandler handler) {
        this.theErrorHandler = handler == 0 ? this : handler;
    }
