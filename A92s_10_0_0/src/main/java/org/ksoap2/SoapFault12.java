...
public class SoapFault12 extends SoapFault {
    ...
    private void parseSelf(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        while (parser.nextTag() == 2) {
            ...
            } else if (name.toLowerCase().equals(OppoWiFiSauXml.WifiUpdateObjXmlUtil.XML_TAG_REASON.toLowerCase())) {
    ...
    public void write(XmlSerializer xw) throws IOException {
        ...
        xw.startTag(SoapEnvelope.ENV2003, OppoWiFiSauXml.WifiUpdateObjXmlUtil.XML_TAG_REASON);
        this.Reason.write(xw);
        xw.endTag(SoapEnvelope.ENV2003, OppoWiFiSauXml.WifiUpdateObjXmlUtil.XML_TAG_REASON);
        if (this.Node != null) {
